; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/impls/plex/ftn-custom/zplexfluent.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/impls/plex/ftn-custom/zplexfluent.c"
...
@__func__.dmplexcreatefluentfromfile_ = private unnamed_addr constant [28 x i8] c"dmplexcreatefluentfromfile_\00", align 1
@.str = private unnamed_addr constant [96 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/impls/plex/ftn-custom/zplexfluent.c\00", align 1
@PetscTrFree = external local_unnamed_addr global i32 (i8*, i32, i8*, i8*)*, align 8

; Function Attrs: nounwind uwtable
define void @dmplexcreatefluentfromfile_(i32* nocapture readonly %0, i8* %1, i32* nocapture readonly %2, %struct._p_DM** %3, i32* nocapture %4, i64 %5) local_unnamed_addr #0 !dbg !20 {
  %7 = alloca i8*, align 8
...
20:                                               ; preds = %12, %15
  ...
  %22 = call i32 (i32, i32, i32, i8*, i8*, i64, i8*, ...) @PetscMallocA(i32 1, i32 0, i32 16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__func__.dmplexcreatefluentfromfile_, i64 0, i64 0), i8* getelementptr inbounds ([96 x i8], [96 x i8]* @.str, i64 0, i64 0), i64 %21, i8* nonnull %8) #4, !dbg !55
...
28:                                               ; preds = %24, %11
  ...
  %34 = call i32 @DMPlexCreateFluentFromFile(%struct.ompi_communicator_t* %31, i8* %32, i32 %33, %struct._p_DM** %3) #4, !dbg !70
...
39:                                               ; preds = %28
  ...
  %41 = call i32 %40(i8* %36, i32 18, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__func__.dmplexcreatefluentfromfile_, i64 0, i64 0), i8* getelementptr inbounds ([96 x i8], [96 x i8]* @.str, i64 0, i64 0)) #4, !dbg !75
...
declare !dbg !89 i32 @DMPlexCreateFluentFromFile(%struct.ompi_communicator_t*, i8*, i32, %struct._p_DM**) local_unnamed_addr #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/impls/plex/ftn-custom/zplexfluent.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3}
...
!20 = distinct !DISubprogram(name: "dmplexcreatefluentfromfile_", scope: !21, file: !21, line: 12, type: !22, scopeLine: 13, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !35)
!21 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/dm/impls/plex/ftn-custom/zplexfluent.c", directory: "/home/users/ndemeye/xSDK")
...
!66 = !DILocation(line: 17, column: 51, scope: !20)
!67 = !DILocation(line: 17, column: 38, scope: !20)
!68 = !DILocation(line: 17, column: 61, scope: !20)
!69 = !DILocation(line: 17, column: 71, scope: !20)
!70 = !DILocation(line: 17, column: 11, scope: !20)
!71 = !DILocation(line: 17, column: 9, scope: !20)
!72 = !DILocation(line: 17, column: 93, scope: !73)
!73 = distinct !DILexicalBlock(scope: !20, file: !21, line: 17, column: 93)
!74 = !DILocation(line: 17, column: 93, scope: !20)
...
!88 = !{!25, !26, !83, !12}
!89 = !DISubprogram(name: "DMPlexCreateFluentFromFile", scope: !90, file: !90, line: 179, type: !91, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !85)

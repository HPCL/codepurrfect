; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sell/seq/ftn-custom/zsellf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sell/seq/ftn-custom/zsellf.c"
...
@.str.1 = private unnamed_addr constant [96 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sell/seq/ftn-custom/zsellf.c\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"Use PETSC_NULL_INTEGER\00", align 1

; Function Attrs: nounwind uwtable
define void @matcreateseqsell_(%struct.ompi_communicator_t** nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture readonly %2, i32* nocapture readonly %3, i32* %4, %struct._p_Mat** %5, i32* nocapture %6) local_unnamed_addr #0 !dbg !30 {
...
35:                                               ; preds = %23, %7
  ...
  %43 = tail call i32 @MatCreateSeqSELL(%struct.ompi_communicator_t* %39, i32 %40, i32 %41, i32 %42, i32* %36, %struct._p_Mat** %5) #3, !dbg !72
  br label %44, !dbg !73
...
declare !dbg !81 i32 @MatCreateSeqSELL(%struct.ompi_communicator_t*, i32, i32, i32, i32*, %struct._p_Mat**) local_unnamed_addr #1

declare !dbg !87 %struct.ompi_communicator_t* @MPI_Comm_f2c(i32) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define void @matseqsellsetpreallocation_(%struct._p_Mat** nocapture readonly %0, i32* nocapture readonly %1, i32* %2, i32* nocapture %3) local_unnamed_addr #0 !dbg !90 {
...
30:                                               ; preds = %20, %8
  %31 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 20, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 62, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0)) #3, !dbg !104
  br label %37, !dbg !104
...
32:                                               ; preds = %20, %4
  ...
  %36 = tail call i32 @MatSeqSELLSetPreallocation(%struct._p_Mat* %34, i32 %35, i32* %33) #3, !dbg !108
  br label %37, !dbg !109
...
declare !dbg !110 i32 @MatSeqSELLSetPreallocation(%struct._p_Mat*, i32, i32*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sell/seq/ftn-custom/zsellf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3}
...
!30 = distinct !DISubprogram(name: "matcreateseqsell_", scope: !31, file: !31, line: 12, type: !32, scopeLine: 13, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !45)
!31 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sell/seq/ftn-custom/zsellf.c", directory: "/home/users/ndemeye/xSDK")
...
!49 = !DILocalVariable(name: "maxrlenrow", arg: 4, scope: !30, file: !31, line: 12, type: !35)
!50 = !DILocalVariable(name: "rlen", arg: 5, scope: !30, file: !31, line: 12, type: !35)
...
!65 = !DILocation(line: 15, column: 41, scope: !30)
!66 = !{!67, !67, i64 0}
!67 = !{!"int", !58, i64 0}
!68 = !DILocation(line: 15, column: 28, scope: !30)
!69 = !DILocation(line: 15, column: 61, scope: !30)
!70 = !DILocation(line: 15, column: 64, scope: !30)
!71 = !DILocation(line: 15, column: 67, scope: !30)
...
!80 = !{}
!81 = !DISubprogram(name: "MatCreateSeqSELL", scope: !40, file: !40, line: 295, type: !82, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !80)
...
!89 = !{!20, !23}
!90 = distinct !DISubprogram(name: "matseqsellsetpreallocation_", scope: !31, file: !31, line: 18, type: !91, scopeLine: 19, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !93)
!91 = !DISubroutineType(types: !92)
!92 = !{null, !38, !35, !35, !43}
!93 = !{!94, !95, !96, !97}
!94 = !DILocalVariable(name: "mat", arg: 1, scope: !90, file: !31, line: 18, type: !38)
!95 = !DILocalVariable(name: "maxrlenrow", arg: 2, scope: !90, file: !31, line: 18, type: !35)
!96 = !DILocalVariable(name: "rlen", arg: 3, scope: !90, file: !31, line: 18, type: !35)
...
!106 = !DILocation(line: 21, column: 38, scope: !90)
!107 = !DILocation(line: 21, column: 43, scope: !90)
!108 = !DILocation(line: 21, column: 11, scope: !90)
!109 = !DILocation(line: 22, column: 1, scope: !90)
!110 = !DISubprogram(name: "MatSeqSELLSetPreallocation", scope: !40, file: !40, line: 297, type: !111, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !80)

; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sbaij/seq/ftn-custom/zsbaijf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sbaij/seq/ftn-custom/zsbaijf.c"
...
@.str.1 = private unnamed_addr constant [98 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sbaij/seq/ftn-custom/zsbaijf.c\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"Use PETSC_NULL_INTEGER\00", align 1

; Function Attrs: nounwind uwtable
define void @matcreateseqsbaij_(%struct.ompi_communicator_t** nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture readonly %2, i32* nocapture readonly %3, i32* nocapture readonly %4, i32* %5, %struct._p_Mat** %6, i32* nocapture %7) local_unnamed_addr #0 !dbg !30 {
...
36:                                               ; preds = %24, %8
  ...
  %45 = tail call i32 @MatCreateSeqSBAIJ(%struct.ompi_communicator_t* %40, i32 %41, i32 %42, i32 %43, i32 %44, i32* %37, %struct._p_Mat** %6) #3, !dbg !74
  br label %46, !dbg !75
...
declare !dbg !83 i32 @MatCreateSeqSBAIJ(%struct.ompi_communicator_t*, i32, i32, i32, i32, i32*, %struct._p_Mat**) local_unnamed_addr #1

declare !dbg !89 %struct.ompi_communicator_t* @MPI_Comm_f2c(i32) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define void @matseqsbaijsetpreallocation_(%struct._p_Mat** nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture readonly %2, i32* %3, i32* nocapture %4) local_unnamed_addr #0 !dbg !92 {
...
31:                                               ; preds = %21, %9
  %32 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 20, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 62, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0)) #3, !dbg !107
  br label %39, !dbg !107
...
33:                                               ; preds = %21, %5
  ...
  %38 = tail call i32 @MatSeqSBAIJSetPreallocation(%struct._p_Mat* %35, i32 %36, i32 %37, i32* %34) #3, !dbg !112
  br label %39, !dbg !113
...
declare !dbg !114 i32 @MatSeqSBAIJSetPreallocation(%struct._p_Mat*, i32, i32, i32*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sbaij/seq/ftn-custom/zsbaijf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3}
...
!30 = distinct !DISubprogram(name: "matcreateseqsbaij_", scope: !31, file: !31, line: 12, type: !32, scopeLine: 13, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !45)
!31 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/mat/impls/sbaij/seq/ftn-custom/zsbaijf.c", directory: "/home/users/ndemeye/xSDK")
...
!66 = !DILocation(line: 15, column: 42, scope: !30)
!67 = !{!68, !68, i64 0}
!68 = !{!"int", !59, i64 0}
!69 = !DILocation(line: 15, column: 29, scope: !30)
!70 = !DILocation(line: 15, column: 62, scope: !30)
!71 = !DILocation(line: 15, column: 66, scope: !30)
!72 = !DILocation(line: 15, column: 69, scope: !30)
!73 = !DILocation(line: 15, column: 72, scope: !30)
...
!82 = !{}
!83 = !DISubprogram(name: "MatCreateSeqSBAIJ", scope: !40, file: !40, line: 317, type: !84, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)
...
!91 = !{!20, !23}
!92 = distinct !DISubprogram(name: "matseqsbaijsetpreallocation_", scope: !31, file: !31, line: 18, type: !93, scopeLine: 19, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !95)
...
!109 = !DILocation(line: 21, column: 39, scope: !92)
!110 = !DILocation(line: 21, column: 44, scope: !92)
!111 = !DILocation(line: 21, column: 48, scope: !92)
!112 = !DILocation(line: 21, column: 11, scope: !92)
!113 = !DILocation(line: 22, column: 1, scope: !92)
!114 = !DISubprogram(name: "MatSeqSBAIJSetPreallocation", scope: !40, file: !40, line: 1113, type: !115, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !82)

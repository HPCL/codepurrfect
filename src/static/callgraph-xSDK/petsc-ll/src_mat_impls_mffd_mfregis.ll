; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/mffd/mfregis.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/mffd/mfregis.c"
...
%struct._MFOps = type { i32 (%struct._p_MatMFFD*, %struct._p_Vec*, %struct._p_Vec*, double*, i32*)*, i32 (%struct._p_MatMFFD*, %struct._p_PetscViewer*)*, {}*, i32 (%struct._p_PetscOptionItems*, %struct._p_MatMFFD*)* }
%struct._p_Mat = type opaque
%struct._p_Vec = type opaque

@petscstack = external local_unnamed_addr global %struct.PetscStack*, align 8
@__func__.MatMFFDRegisterAll = private unnamed_addr constant [19 x i8] c"MatMFFDRegisterAll\00", align 1
@.str = private unnamed_addr constant [82 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/mffd/mfregis.c\00", align 1
@MatMFFDRegisterAllCalled = external local_unnamed_addr global i32, align 4
@.str.1 = private unnamed_addr constant [31 x i8] c"Invalid stack size %d, pop %s\0A\00", align 1
@.str.2 = private unnamed_addr constant [42 x i8] c"Invalid stack: push from %s, pop from %s\0A\00", align 1
@.str.3 = private unnamed_addr constant [3 x i8] c"ds\00", align 1
@ompi_mpi_comm_self = external global %struct.ompi_predefined_communicator_t, align 1
@.str.4 = private unnamed_addr constant [2 x i8] c" \00", align 1
@.str.5 = private unnamed_addr constant [3 x i8] c"wp\00", align 1

; Function Attrs: nounwind uwtable
define i32 @MatMFFDRegisterAll() local_unnamed_addr #0 !dbg !45 {
...
7:                                                ; preds = %3
  ...
  store i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0), i8** %9, align 8, !dbg !73, !tbaa !61
  ...
  store i8* getelementptr inbounds ([82 x i8], [82 x i8]* @.str, i64 0, i64 0), i8** %14, align 8, !dbg !73, !tbaa !61
  ...
  store i32 21, i32* %19, align 4, !dbg !73, !tbaa !75
...
24:                                               ; preds = %3, %7
  ...
  %34 = load i32, i32* @MatMFFDRegisterAllCalled, align 4, !dbg !77, !tbaa !79
  %35 = icmp eq i32 %34, 0, !dbg !77
  br i1 %35, label %95, label %39, !dbg !80

36:                                               ; preds = %0
  %37 = load i32, i32* @MatMFFDRegisterAllCalled, align 4, !dbg !77, !tbaa !79
...
47:                                               ; preds = %43
  %48 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 %41, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0)), !dbg !93
  br label %164, !dbg !93
...
61:                                               ; preds = %56
  ...
  %64 = icmp eq i8* %63, getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0), !dbg !99
  br i1 %64, label %70, label %65, !dbg !102

65:                                               ; preds = %61
  %66 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i64 0, i64 0), i8* %63, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0)), !dbg !103
...
95:                                               ; preds = %36, %24
  store i32 1, i32* @MatMFFDRegisterAllCalled, align 4, !dbg !105, !tbaa !79
  %96 = tail call i32 @MatMFFDRegister(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 (%struct._p_MatMFFD*)* nonnull @MatCreateMFFD_DS) #4, !dbg !106
...
98:                                               ; preds = %95
  %99 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 25, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0), i8* getelementptr inbounds ([82 x i8], [82 x i8]* @.str, i64 0, i64 0), i32 %96, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4, !dbg !109
  br label %164

100:                                              ; preds = %95
  %101 = tail call i32 @MatMFFDRegister(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), i32 (%struct._p_MatMFFD*)* nonnull @MatCreateMFFD_WP) #4, !dbg !113
...
103:                                              ; preds = %100
  %104 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 26, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0), i8* getelementptr inbounds ([82 x i8], [82 x i8]* @.str, i64 0, i64 0), i32 %101, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4, !dbg !115
  br label %164
...
116:                                              ; preds = %112
  %117 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 %110, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0)), !dbg !131
...
130:                                              ; preds = %125
  ...
  %133 = icmp eq i8* %132, getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0), !dbg !137
  br i1 %133, label %139, label %134, !dbg !140

134:                                              ; preds = %130
  %135 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i64 0, i64 0), i8* %132, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.MatMFFDRegisterAll, i64 0, i64 0)), !dbg !141
...
declare !dbg !144 i32 @MatMFFDRegister(i8*, i32 (%struct._p_MatMFFD*)*) local_unnamed_addr #2

declare i32 @MatCreateMFFD_DS(%struct._p_MatMFFD*) #2

declare !dbg !418 i32 @PetscError(%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) local_unnamed_addr #2

declare i32 @MatCreateMFFD_WP(%struct._p_MatMFFD*) #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/mat/impls/mffd/mfregis.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3, !9, !24}
...
!45 = distinct !DISubprogram(name: "MatMFFDRegisterAll", scope: !46, file: !46, line: 17, type: !47, scopeLine: 18, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !51)
!46 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/mat/impls/mffd/mfregis.c", directory: "/home/users/ndemeye/xSDK")
!47 = !DISubroutineType(types: !48)
!48 = !{!49}
!49 = !DIDerivedType(tag: DW_TAG_typedef, name: "PetscErrorCode", file: !4, line: 14, baseType: !50)
!50 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!51 = !{!52, !53, !55}
!52 = !DILocalVariable(name: "ierr", scope: !45, file: !46, line: 19, type: !49)
!53 = !DILocalVariable(name: "ierr__", scope: !54, file: !46, line: 25, type: !49)
!54 = distinct !DILexicalBlock(scope: !45, file: !46, line: 25, column: 55)
!55 = !DILocalVariable(name: "ierr__", scope: !56, file: !46, line: 26, type: !49)
!56 = distinct !DILexicalBlock(scope: !45, file: !46, line: 26, column: 55)
!57 = !DILocation(line: 21, column: 3, scope: !58)
!58 = distinct !DILexicalBlock(scope: !59, file: !46, line: 21, column: 3)
!59 = distinct !DILexicalBlock(scope: !60, file: !46, line: 21, column: 3)
!60 = distinct !DILexicalBlock(scope: !45, file: !46, line: 21, column: 3)
!61 = !{!62, !62, i64 0}
!62 = !{!"any pointer", !63, i64 0}
!63 = !{!"omnipotent char", !64, i64 0}
!64 = !{!"Simple C/C++ TBAA"}
!65 = !DILocation(line: 21, column: 3, scope: !59)
!66 = !DILocation(line: 21, column: 3, scope: !67)
!67 = distinct !DILexicalBlock(scope: !68, file: !46, line: 21, column: 3)
!68 = distinct !DILexicalBlock(scope: !58, file: !46, line: 21, column: 3)
!69 = !{!70, !71, i64 1536}
!70 = !{!"", !63, i64 0, !63, i64 512, !63, i64 1024, !63, i64 1280, !71, i64 1536, !71, i64 1540, !63, i64 1544}
!71 = !{!"int", !63, i64 0}
!72 = !DILocation(line: 21, column: 3, scope: !68)
!73 = !DILocation(line: 21, column: 3, scope: !74)
!74 = distinct !DILexicalBlock(scope: !67, file: !46, line: 21, column: 3)
!75 = !{!71, !71, i64 0}
!76 = !{!70, !71, i64 1540}
!77 = !DILocation(line: 22, column: 7, scope: !78)
!78 = distinct !DILexicalBlock(scope: !45, file: !46, line: 22, column: 7)
!79 = !{!63, !63, i64 0}
!80 = !DILocation(line: 22, column: 7, scope: !45)
!81 = !DILocation(line: 22, column: 33, scope: !82)
!82 = distinct !DILexicalBlock(scope: !83, file: !46, line: 22, column: 33)
!83 = distinct !DILexicalBlock(scope: !84, file: !46, line: 22, column: 33)
!84 = distinct !DILexicalBlock(scope: !85, file: !46, line: 22, column: 33)
!85 = distinct !DILexicalBlock(scope: !86, file: !46, line: 22, column: 33)
!86 = distinct !DILexicalBlock(scope: !78, file: !46, line: 22, column: 33)
!87 = !DILocation(line: 22, column: 33, scope: !83)
!88 = !DILocation(line: 22, column: 33, scope: !89)
!89 = distinct !DILexicalBlock(scope: !90, file: !46, line: 22, column: 33)
!90 = distinct !DILexicalBlock(scope: !82, file: !46, line: 22, column: 33)
!91 = !{!70, !63, i64 1544}
!92 = !DILocation(line: 22, column: 33, scope: !90)
!93 = !DILocation(line: 22, column: 33, scope: !94)
!94 = distinct !DILexicalBlock(scope: !89, file: !46, line: 22, column: 33)
!95 = !DILocation(line: 22, column: 33, scope: !96)
!96 = distinct !DILexicalBlock(scope: !82, file: !46, line: 22, column: 33)
!97 = !DILocation(line: 22, column: 33, scope: !98)
!98 = distinct !DILexicalBlock(scope: !96, file: !46, line: 22, column: 33)
!99 = !DILocation(line: 22, column: 33, scope: !100)
!100 = distinct !DILexicalBlock(scope: !101, file: !46, line: 22, column: 33)
!101 = distinct !DILexicalBlock(scope: !98, file: !46, line: 22, column: 33)
!102 = !DILocation(line: 22, column: 33, scope: !101)
!103 = !DILocation(line: 22, column: 33, scope: !104)
!104 = distinct !DILexicalBlock(scope: !100, file: !46, line: 22, column: 33)
!105 = !DILocation(line: 23, column: 28, scope: !45)
!106 = !DILocation(line: 25, column: 10, scope: !45)
!107 = !DILocation(line: 0, scope: !45)
!108 = !DILocation(line: 0, scope: !54)
!109 = !DILocation(line: 25, column: 55, scope: !110)
!110 = distinct !DILexicalBlock(scope: !54, file: !46, line: 25, column: 55)
!111 = !DILocation(line: 25, column: 55, scope: !54)
!112 = !{!"branch_weights", i32 2000, i32 1}
!113 = !DILocation(line: 26, column: 10, scope: !45)
!114 = !DILocation(line: 0, scope: !56)
!115 = !DILocation(line: 26, column: 55, scope: !116)
!116 = distinct !DILexicalBlock(scope: !56, file: !46, line: 26, column: 55)
!117 = !DILocation(line: 26, column: 55, scope: !56)
!118 = !DILocation(line: 27, column: 3, scope: !119)
!119 = distinct !DILexicalBlock(scope: !120, file: !46, line: 27, column: 3)
!120 = distinct !DILexicalBlock(scope: !121, file: !46, line: 27, column: 3)
!121 = distinct !DILexicalBlock(scope: !45, file: !46, line: 27, column: 3)
!122 = !DILocation(line: 27, column: 3, scope: !120)
!123 = !DILocation(line: 27, column: 3, scope: !124)
!124 = distinct !DILexicalBlock(scope: !125, file: !46, line: 27, column: 3)
!125 = distinct !DILexicalBlock(scope: !119, file: !46, line: 27, column: 3)
!126 = !DILocation(line: 27, column: 3, scope: !125)
!127 = !DILocation(line: 27, column: 3, scope: !128)
!128 = distinct !DILexicalBlock(scope: !129, file: !46, line: 27, column: 3)
!129 = distinct !DILexicalBlock(scope: !124, file: !46, line: 27, column: 3)
!130 = !DILocation(line: 27, column: 3, scope: !129)
!131 = !DILocation(line: 27, column: 3, scope: !132)
!132 = distinct !DILexicalBlock(scope: !128, file: !46, line: 27, column: 3)
!133 = !DILocation(line: 27, column: 3, scope: !134)
!134 = distinct !DILexicalBlock(scope: !124, file: !46, line: 27, column: 3)
!135 = !DILocation(line: 27, column: 3, scope: !136)
!136 = distinct !DILexicalBlock(scope: !134, file: !46, line: 27, column: 3)
!137 = !DILocation(line: 27, column: 3, scope: !138)
!138 = distinct !DILexicalBlock(scope: !139, file: !46, line: 27, column: 3)
!139 = distinct !DILexicalBlock(scope: !136, file: !46, line: 27, column: 3)
!140 = !DILocation(line: 27, column: 3, scope: !139)
!141 = !DILocation(line: 27, column: 3, scope: !142)
!142 = distinct !DILexicalBlock(scope: !138, file: !46, line: 27, column: 3)
!143 = !DILocation(line: 28, column: 1, scope: !45)
!144 = !DISubprogram(name: "MatMFFDRegister", scope: !145, file: !145, line: 1812, type: !146, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !417)
!145 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/include/petscmat.h", directory: "/home/users/ndemeye/xSDK")
...
!152 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_p_MatMFFD", file: !153, line: 30, size: 5888, elements: !154)
!153 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/include/../src/mat/impls/mffd/mffdimpl.h", directory: "/home/users/ndemeye/xSDK")
!154 = !{!155, !356, !382, !383, !384, !385, !386, !387, !388, !389, !393, !394, !395, !399, !400, !404, !405, !406, !407, !408, !412, !416}
!155 = !DIDerivedType(tag: DW_TAG_member, name: "hdr", scope: !152, file: !153, line: 31, baseType: !156, size: 4480)
...
!356 = !DIDerivedType(tag: DW_TAG_member, name: "ops", scope: !152, file: !153, line: 31, baseType: !357, size: 256, offset: 4480)
!357 = !DICompositeType(tag: DW_TAG_array_type, baseType: !358, size: 256, elements: !207)
!358 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_MFOps", file: !153, line: 22, size: 256, elements: !359)
!359 = !{!360, !370, !374, !378}
!360 = !DIDerivedType(tag: DW_TAG_member, name: "compute", scope: !358, file: !153, line: 23, baseType: !361, size: 64)
!361 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !362, size: 64)
!362 = !DISubroutineType(types: !363)
!363 = !{!49, !364, !365, !365, !273, !369}
!364 = !DIDerivedType(tag: DW_TAG_typedef, name: "MatMFFD", file: !145, line: 1798, baseType: !151)
...
!369 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !326, size: 64)
!370 = !DIDerivedType(tag: DW_TAG_member, name: "view", scope: !358, file: !153, line: 24, baseType: !371, size: 64, offset: 64)
!371 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !372, size: 64)
!372 = !DISubroutineType(types: !373)
!373 = !{!49, !364, !178}
!374 = !DIDerivedType(tag: DW_TAG_member, name: "destroy", scope: !358, file: !153, line: 25, baseType: !375, size: 64, offset: 128)
!375 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !376, size: 64)
!376 = !DISubroutineType(types: !377)
!377 = !{!49, !364}
!378 = !DIDerivedType(tag: DW_TAG_member, name: "setfromoptions", scope: !358, file: !153, line: 26, baseType: !379, size: 64, offset: 192)
!379 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !380, size: 64)
!380 = !DISubroutineType(types: !381)
!381 = !{!49, !302, !364}
!382 = !DIDerivedType(tag: DW_TAG_member, name: "w", scope: !152, file: !153, line: 32, baseType: !365, size: 64, offset: 4736)
!383 = !DIDerivedType(tag: DW_TAG_member, name: "error_rel", scope: !152, file: !153, line: 33, baseType: !265, size: 64, offset: 4800)
!384 = !DIDerivedType(tag: DW_TAG_member, name: "currenth", scope: !152, file: !153, line: 34, baseType: !274, size: 64, offset: 4864)
!385 = !DIDerivedType(tag: DW_TAG_member, name: "historyh", scope: !152, file: !153, line: 35, baseType: !273, size: 64, offset: 4928)
!386 = !DIDerivedType(tag: DW_TAG_member, name: "ncurrenth", scope: !152, file: !153, line: 36, baseType: !211, size: 32, offset: 4992)
!387 = !DIDerivedType(tag: DW_TAG_member, name: "maxcurrenth", scope: !152, file: !153, line: 36, baseType: !211, size: 32, offset: 5024)
!388 = !DIDerivedType(tag: DW_TAG_member, name: "hctx", scope: !152, file: !153, line: 37, baseType: !38, size: 64, offset: 5056)
!389 = !DIDerivedType(tag: DW_TAG_member, name: "mat", scope: !152, file: !153, line: 38, baseType: !390, size: 64, offset: 5120)
!390 = !DIDerivedType(tag: DW_TAG_typedef, name: "Mat", file: !145, line: 16, baseType: !391)
!391 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !392, size: 64)
!392 = !DICompositeType(tag: DW_TAG_structure_type, name: "_p_Mat", file: !145, line: 16, flags: DIFlagFwdDecl)
!393 = !DIDerivedType(tag: DW_TAG_member, name: "recomputeperiod", scope: !152, file: !153, line: 39, baseType: !211, size: 32, offset: 5184)
!394 = !DIDerivedType(tag: DW_TAG_member, name: "count", scope: !152, file: !153, line: 40, baseType: !211, size: 32, offset: 5216)
!395 = !DIDerivedType(tag: DW_TAG_member, name: "checkh", scope: !152, file: !153, line: 41, baseType: !396, size: 64, offset: 5248)
!396 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !397, size: 64)
!397 = !DISubroutineType(types: !398)
!398 = !{!49, !38, !365, !365, !273}
!399 = !DIDerivedType(tag: DW_TAG_member, name: "checkhctx", scope: !152, file: !153, line: 42, baseType: !38, size: 64, offset: 5312)
!400 = !DIDerivedType(tag: DW_TAG_member, name: "func", scope: !152, file: !153, line: 44, baseType: !401, size: 64, offset: 5376)
!401 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !402, size: 64)
!402 = !DISubroutineType(types: !403)
!403 = !{!49, !38, !365, !365}
!404 = !DIDerivedType(tag: DW_TAG_member, name: "funcctx", scope: !152, file: !153, line: 45, baseType: !38, size: 64, offset: 5440)
!405 = !DIDerivedType(tag: DW_TAG_member, name: "current_f", scope: !152, file: !153, line: 46, baseType: !365, size: 64, offset: 5504)
!406 = !DIDerivedType(tag: DW_TAG_member, name: "current_f_allocated", scope: !152, file: !153, line: 47, baseType: !326, size: 32, offset: 5568)
!407 = !DIDerivedType(tag: DW_TAG_member, name: "current_u", scope: !152, file: !153, line: 48, baseType: !365, size: 64, offset: 5632)
!408 = !DIDerivedType(tag: DW_TAG_member, name: "funci", scope: !152, file: !153, line: 50, baseType: !409, size: 64, offset: 5696)
!409 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !410, size: 64)
!410 = !DISubroutineType(types: !411)
!411 = !{!49, !38, !211, !365, !273}
!412 = !DIDerivedType(tag: DW_TAG_member, name: "funcisetbase", scope: !152, file: !153, line: 51, baseType: !413, size: 64, offset: 5760)
!413 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !414, size: 64)
!414 = !DISubroutineType(types: !415)
!415 = !{!49, !38, !365}
!416 = !DIDerivedType(tag: DW_TAG_member, name: "ctx", scope: !152, file: !153, line: 53, baseType: !38, size: 64, offset: 5824)
!417 = !{}
!418 = !DISubprogram(name: "PetscError", scope: !25, file: !25, line: 668, type: !419, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !417)
!419 = !DISubroutineType(types: !420)
!420 = !{!49, !36, !50, !31, !31, !50, !24, !31, null}

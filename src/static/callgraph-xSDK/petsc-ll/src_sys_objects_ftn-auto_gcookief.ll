; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/gcookief.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/gcookief.c"
...
define void @petscobjectgetclassid_(%struct._p_PetscObject* nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture %2) local_unnamed_addr #0 !dbg !246 {
  call void @llvm.dbg.value(metadata %struct._p_PetscObject* %0, metadata !252, metadata !DIExpression()), !dbg !255
  call void @llvm.dbg.value(metadata i32* %1, metadata !253, metadata !DIExpression()), !dbg !255
  ...
  %7 = bitcast i32* %1 to i64*, !dbg !262
  %8 = load i64, i64* %7, align 8, !dbg !262, !tbaa !257
  %9 = inttoptr i64 %8 to i32*, !dbg !263
  %10 = tail call i32 @PetscObjectGetClassId(%struct._p_PetscObject* %6, i32* %9) #3, !dbg !264
  store i32 %10, i32* %2, align 4, !dbg !265, !tbaa !266
  ret void, !dbg !268
}

declare !dbg !269 i32 @PetscObjectGetClassId(%struct._p_PetscObject*, i32*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/gcookief.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3, !9}
...
!239 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !31, size: 64)
...
!246 = distinct !DISubprogram(name: "petscobjectgetclassid_", scope: !247, file: !247, line: 42, type: !248, scopeLine: 43, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !251)
!247 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/gcookief.c", directory: "/home/users/ndemeye/xSDK")
!248 = !DISubroutineType(types: !249)
!249 = !{null, !25, !239, !250}
!250 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !32, size: 64)
!251 = !{!252, !253, !254}
!252 = !DILocalVariable(name: "obj", arg: 1, scope: !246, file: !247, line: 42, type: !25)
!253 = !DILocalVariable(name: "classid", arg: 2, scope: !246, file: !247, line: 42, type: !239)
!254 = !DILocalVariable(name: "__ierr", arg: 3, scope: !246, file: !247, line: 42, type: !250)
!255 = !DILocation(line: 0, scope: !246)
!256 = !DILocation(line: 45, column: 15, scope: !246)
!257 = !{!258, !258, i64 0}
!258 = !{!"long", !259, i64 0}
!259 = !{!"omnipotent char", !260, i64 0}
!260 = !{!"Simple C/C++ TBAA"}
!261 = !DILocation(line: 45, column: 2, scope: !246)
!262 = !DILocation(line: 46, column: 18, scope: !246)
!263 = !DILocation(line: 46, column: 2, scope: !246)
!264 = !DILocation(line: 44, column: 11, scope: !246)
!265 = !DILocation(line: 44, column: 9, scope: !246)
!266 = !{!267, !267, i64 0}
!267 = !{!"int", !259, i64 0}
!268 = !DILocation(line: 47, column: 1, scope: !246)
!269 = !DISubprogram(name: "PetscObjectGetClassId", scope: !270, file: !270, line: 1459, type: !271, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !273)

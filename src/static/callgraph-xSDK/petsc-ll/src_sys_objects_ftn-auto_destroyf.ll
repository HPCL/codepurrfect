; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/destroyf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/destroyf.c"
...
define void @petscobjectdestroy_(%struct._p_PetscObject** %0, i32* nocapture %1) local_unnamed_addr #0 !dbg !30 {
  call void @llvm.dbg.value(metadata %struct._p_PetscObject** %0, metadata !245, metadata !DIExpression()), !dbg !247
  call void @llvm.dbg.value(metadata i32* %1, metadata !246, metadata !DIExpression()), !dbg !247
  %3 = tail call i32 @PetscObjectDestroy(%struct._p_PetscObject** %0) #3, !dbg !248
  store i32 %3, i32* %1, align 4, !dbg !249, !tbaa !250
  ret void, !dbg !254
}

declare !dbg !255 i32 @PetscObjectDestroy(%struct._p_PetscObject**) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/destroyf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3, !9}
...
!30 = distinct !DISubprogram(name: "petscobjectdestroy_", scope: !31, file: !31, line: 42, type: !32, scopeLine: 43, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !244)
!31 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-auto/destroyf.c", directory: "/home/users/ndemeye/xSDK")
...
!244 = !{!245, !246}
!245 = !DILocalVariable(name: "obj", arg: 1, scope: !30, file: !31, line: 42, type: !34)
!246 = !DILocalVariable(name: "__ierr", arg: 2, scope: !30, file: !31, line: 42, type: !243)
!247 = !DILocation(line: 0, scope: !30)
!248 = !DILocation(line: 44, column: 11, scope: !30)
!249 = !DILocation(line: 44, column: 9, scope: !30)
!250 = !{!251, !251, i64 0}
!251 = !{!"int", !252, i64 0}
!252 = !{!"omnipotent char", !253, i64 0}
!253 = !{!"Simple C/C++ TBAA"}
!254 = !DILocation(line: 45, column: 1, scope: !30)
!255 = !DISubprogram(name: "PetscObjectDestroy", scope: !256, file: !256, line: 1457, type: !257, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !260)
!256 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/include/petscsys.h", directory: "/home/users/ndemeye/xSDK")
!257 = !DISubroutineType(types: !258)
!258 = !{!42, !259}
!259 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !36, size: 64)
!260 = !{}

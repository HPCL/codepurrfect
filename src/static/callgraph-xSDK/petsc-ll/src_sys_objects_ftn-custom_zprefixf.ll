; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-custom/zprefixf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-custom/zprefixf.c"
...
@__func__.petscobjectsetoptionsprefix_ = private unnamed_addr constant [29 x i8] c"petscobjectsetoptionsprefix_\00", align 1
@.str = private unnamed_addr constant [91 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-custom/zprefixf.c\00", align 1
@PetscTrFree = external local_unnamed_addr global i32 (i8*, i32, i8*, i8*)*, align 8

; Function Attrs: nounwind uwtable
define void @petscobjectsetoptionsprefix_(%struct._p_PetscObject** nocapture readonly %0, i8* %1, i32* nocapture %2, i64 %3) local_unnamed_addr #0 !dbg !35 {
  %5 = alloca i8*, align 8
...
18:                                               ; preds = %10, %13
  ...
  %20 = call i32 (i32, i32, i32, i8*, i8*, i64, i8*, ...) @PetscMallocA(i32 1, i32 0, i32 13, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__func__.petscobjectsetoptionsprefix_, i64 0, i64 0), i8* getelementptr inbounds ([91 x i8], [91 x i8]* @.str, i64 0, i64 0), i64 %19, i8* nonnull %6) #4, !dbg !263
...
28:                                               ; preds = %26, %9
  ...
  %32 = call i32 @PetscObjectSetOptionsPrefix(%struct._p_PetscObject* %31, i8* %29) #4, !dbg !276
...
37:                                               ; preds = %28
  ...
  %39 = call i32 %38(i8* %34, i32 15, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__func__.petscobjectsetoptionsprefix_, i64 0, i64 0), i8* getelementptr inbounds ([91 x i8], [91 x i8]* @.str, i64 0, i64 0)) #4, !dbg !281
...
declare !dbg !292 i32 @PetscObjectSetOptionsPrefix(%struct._p_PetscObject*, i8*) local_unnamed_addr #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-custom/zprefixf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3, !9}
...
!35 = distinct !DISubprogram(name: "petscobjectsetoptionsprefix_", scope: !36, file: !36, line: 9, type: !37, scopeLine: 10, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !245)
!36 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/sys/objects/ftn-custom/zprefixf.c", directory: "/home/users/ndemeye/xSDK")
...
!247 = !DILocalVariable(name: "prefix", arg: 2, scope: !35, file: !36, line: 9, type: !129)
...
!250 = !DILocalVariable(name: "t", scope: !35, file: !36, line: 11, type: !129)
...
!274 = !DILocation(line: 14, column: 44, scope: !35)
!275 = !DILocation(line: 14, column: 39, scope: !35)
!276 = !DILocation(line: 14, column: 11, scope: !35)
!277 = !DILocation(line: 14, column: 9, scope: !35)
!278 = !DILocation(line: 14, column: 51, scope: !279)
!279 = distinct !DILexicalBlock(scope: !35, file: !36, line: 14, column: 51)
!280 = !DILocation(line: 14, column: 51, scope: !35)
...
!291 = !{!47, !129, !79, !27}
!292 = !DISubprogram(name: "PetscObjectSetOptionsPrefix", scope: !285, file: !285, line: 1496, type: !293, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !288)

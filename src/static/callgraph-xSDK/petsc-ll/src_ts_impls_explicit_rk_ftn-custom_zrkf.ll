; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/explicit/rk/ftn-custom/zrkf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/explicit/rk/ftn-custom/zrkf.c"
...
@__func__.tsrksettype_ = private unnamed_addr constant [13 x i8] c"tsrksettype_\00", align 1
@.str = private unnamed_addr constant [96 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/explicit/rk/ftn-custom/zrkf.c\00", align 1
@PetscTrFree = external local_unnamed_addr global i32 (i8*, i32, i8*, i8*)*, align 8

; Function Attrs: nounwind uwtable
define void @tsrksettype_(%struct._p_TS** nocapture readonly %0, i8* %1, i32* nocapture %2, i64 %3) local_unnamed_addr #0 !dbg !20 {
  %5 = alloca i8*, align 8
...
18:                                               ; preds = %10, %13
  ...
  %20 = call i32 (i32, i32, i32, i8*, i8*, i64, i8*, ...) @PetscMallocA(i32 1, i32 0, i32 15, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__func__.tsrksettype_, i64 0, i64 0), i8* getelementptr inbounds ([96 x i8], [96 x i8]* @.str, i64 0, i64 0), i64 %19, i8* nonnull %6) #4, !dbg !52
...
28:                                               ; preds = %26, %9
  ...
  %32 = call i32 @TSRKSetType(%struct._p_TS* %31, i8* %29) #4, !dbg !65
...
37:                                               ; preds = %28
  ...
  %39 = call i32 %38(i8* %34, i32 17, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__func__.tsrksettype_, i64 0, i64 0), i8* getelementptr inbounds ([96 x i8], [96 x i8]* @.str, i64 0, i64 0)) #4, !dbg !70
...
declare !dbg !83 i32 @TSRKSetType(%struct._p_TS*, i8*) local_unnamed_addr #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/explicit/rk/ftn-custom/zrkf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3}
...
!20 = distinct !DISubprogram(name: "tsrksettype_", scope: !21, file: !21, line: 11, type: !22, scopeLine: 12, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !34)
!21 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/ts/impls/explicit/rk/ftn-custom/zrkf.c", directory: "/home/users/ndemeye/xSDK")
...
!34 = !{!35, !36, !37, !38, !39}
!35 = !DILocalVariable(name: "ts", arg: 1, scope: !20, file: !21, line: 11, type: !24)
!36 = !DILocalVariable(name: "type", arg: 2, scope: !20, file: !21, line: 11, type: !29)
...
!63 = !DILocation(line: 16, column: 27, scope: !20)
!64 = !DILocation(line: 16, column: 23, scope: !20)
!65 = !DILocation(line: 16, column: 11, scope: !20)
!66 = !DILocation(line: 16, column: 9, scope: !20)
!67 = !DILocation(line: 16, column: 34, scope: !68)
!68 = distinct !DILexicalBlock(scope: !20, file: !21, line: 16, column: 34)
!69 = !DILocation(line: 16, column: 34, scope: !20)
...
!82 = !{!33, !29, !77, !12}
!83 = !DISubprogram(name: "TSRKSetType", scope: !26, file: !26, line: 841, type: !84, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !79)

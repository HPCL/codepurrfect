; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/arkimex/ftn-custom/zarkimexf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/arkimex/ftn-custom/zarkimexf.c"
...
@__func__.tsarkimexsettype_ = private unnamed_addr constant [18 x i8] c"tsarkimexsettype_\00", align 1
@.str = private unnamed_addr constant [97 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/arkimex/ftn-custom/zarkimexf.c\00", align 1
@PetscTrFree = external local_unnamed_addr global i32 (i8*, i32, i8*, i8*)*, align 8

; Function Attrs: nounwind uwtable
define void @tsarkimexsettype_(%struct._p_TS** nocapture readonly %0, i8* %1, i32* nocapture %2, i64 %3) local_unnamed_addr #0 !dbg !20 {
  %5 = alloca i8*, align 8
  call void @llvm.dbg.value(metadata %struct._p_TS** %0, metadata !35, metadata !DIExpression()), !dbg !40
...
18:                                               ; preds = %10, %13
  ...
  %20 = call i32 (i32, i32, i32, i8*, i8*, i64, i8*, ...) @PetscMallocA(i32 1, i32 0, i32 16, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__func__.tsarkimexsettype_, i64 0, i64 0), i8* getelementptr inbounds ([97 x i8], [97 x i8]* @.str, i64 0, i64 0), i64 %19, i8* nonnull %6) #5, !dbg !52
...
28:                                               ; preds = %26, %9
  ...
  %31 = load %struct._p_TS*, %struct._p_TS** %0, align 8, !dbg !64, !tbaa !45
  call void @llvm.dbg.value(metadata i8* %29, metadata !39, metadata !DIExpression()), !dbg !40
  %32 = call i32 @TSARKIMEXSetType(%struct._p_TS* %31, i8* %29) #5, !dbg !65
...
37:                                               ; preds = %28
  ...
  %39 = call i32 %38(i8* %34, i32 18, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__func__.tsarkimexsettype_, i64 0, i64 0), i8* getelementptr inbounds ([97 x i8], [97 x i8]* @.str, i64 0, i64 0)) #5, !dbg !70
...
declare !dbg !83 i32 @TSARKIMEXSetType(%struct._p_TS*, i8*) local_unnamed_addr #2

; Function Attrs: argmemonly nofree nosync nounwind willreturn mustprogress
declare void @llvm.lifetime.end.p0i8(i64 immarg, i8* nocapture) #1

; Function Attrs: nounwind uwtable
define void @tsarkimexgettype_(%struct._p_TS** nocapture readonly %0, i8* %1, i32* nocapture %2, i64 %3) local_unnamed_addr #0 !dbg !86 {
  %5 = alloca i8*, align 8
  call void @llvm.dbg.value(metadata %struct._p_TS** %0, metadata !88, metadata !DIExpression()), !dbg !96
  ...
  %7 = load %struct._p_TS*, %struct._p_TS** %0, align 8, !dbg !98, !tbaa !45
  call void @llvm.dbg.value(metadata i8** %5, metadata !92, metadata !DIExpression(DW_OP_deref)), !dbg !96
  %8 = call i32 @TSARKIMEXGetType(%struct._p_TS* %7, i8** nonnull %5) #5, !dbg !99
...
declare !dbg !116 i32 @TSARKIMEXGetType(%struct._p_TS*, i8**) local_unnamed_addr #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/impls/arkimex/ftn-custom/zarkimexf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3}
...
!20 = distinct !DISubprogram(name: "tsarkimexsettype_", scope: !21, file: !21, line: 12, type: !22, scopeLine: 13, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !34)
!21 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/ts/impls/arkimex/ftn-custom/zarkimexf.c", directory: "/home/users/ndemeye/xSDK")
!22 = !DISubroutineType(types: !23)
!23 = !{null, !24, !29, !31, !10}
!24 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !25, size: 64)
!25 = !DIDerivedType(tag: DW_TAG_typedef, name: "TS", file: !26, line: 17, baseType: !27)
!26 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/include/petscts.h", directory: "/home/users/ndemeye/xSDK")
!27 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !28, size: 64)
!28 = !DICompositeType(tag: DW_TAG_structure_type, name: "_p_TS", file: !26, line: 17, flags: DIFlagFwdDecl)
...
!34 = !{!35, !36, !37, !38, !39}
!35 = !DILocalVariable(name: "ts", arg: 1, scope: !20, file: !21, line: 12, type: !24)
...
!63 = !DILocation(line: 17, column: 32, scope: !20)
!64 = !DILocation(line: 17, column: 28, scope: !20)
!65 = !DILocation(line: 17, column: 11, scope: !20)
!66 = !DILocation(line: 17, column: 9, scope: !20)
!67 = !DILocation(line: 17, column: 39, scope: !68)
!68 = distinct !DILexicalBlock(scope: !20, file: !21, line: 17, column: 39)
!69 = !DILocation(line: 17, column: 39, scope: !20)
!70 = !DILocation(line: 18, column: 3, scope: !71)
!71 = distinct !DILexicalBlock(scope: !20, file: !21, line: 18, column: 3)
!72 = !DILocation(line: 19, column: 1, scope: !20)
...
!82 = !{!33, !29, !77, !12}
!83 = !DISubprogram(name: "TSARKIMEXSetType", scope: !26, file: !26, line: 924, type: !84, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !79)
!84 = !DISubroutineType(types: !85)
!85 = !{!33, !27, !77}
!86 = distinct !DISubprogram(name: "tsarkimexgettype_", scope: !21, file: !21, line: 21, type: !22, scopeLine: 22, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !87)
!87 = !{!88, !89, !90, !91, !92, !93}
!88 = !DILocalVariable(name: "ts", arg: 1, scope: !86, file: !21, line: 21, type: !24)
!89 = !DILocalVariable(name: "name", arg: 2, scope: !86, file: !21, line: 21, type: !29)
!90 = !DILocalVariable(name: "ierr", arg: 3, scope: !86, file: !21, line: 21, type: !31)
!91 = !DILocalVariable(name: "len", arg: 4, scope: !86, file: !21, line: 21, type: !10)
!92 = !DILocalVariable(name: "tname", scope: !86, file: !21, line: 23, type: !77)
!93 = !DILocalVariable(name: "__i", scope: !94, file: !21, line: 27, type: !10)
!94 = distinct !DILexicalBlock(scope: !95, file: !21, line: 27, column: 3)
!95 = distinct !DILexicalBlock(scope: !86, file: !21, line: 27, column: 3)
!96 = !DILocation(line: 0, scope: !86)
!97 = !DILocation(line: 23, column: 3, scope: !86)
!98 = !DILocation(line: 25, column: 28, scope: !86)
!99 = !DILocation(line: 25, column: 11, scope: !86)
!100 = !DILocation(line: 25, column: 9, scope: !86)
!101 = !DILocation(line: 26, column: 29, scope: !86)
!102 = !DILocation(line: 26, column: 11, scope: !86)
!103 = !DILocation(line: 26, column: 9, scope: !86)
!104 = !DILocation(line: 0, scope: !94)
!105 = !DILocation(line: 27, column: 3, scope: !106)
!106 = distinct !DILexicalBlock(scope: !107, file: !21, line: 27, column: 3)
!107 = distinct !DILexicalBlock(scope: !94, file: !21, line: 27, column: 3)
!108 = !DILocation(line: 27, column: 3, scope: !107)
!109 = distinct !{!109, !108, !108, !56}
!110 = !DILocation(line: 0, scope: !107)
!111 = !DILocation(line: 27, column: 3, scope: !112)
!112 = distinct !DILexicalBlock(scope: !113, file: !21, line: 27, column: 3)
!113 = distinct !DILexicalBlock(scope: !94, file: !21, line: 27, column: 3)
!114 = !DILocation(line: 27, column: 3, scope: !113)
!115 = !DILocation(line: 28, column: 1, scope: !86)
!116 = !DISubprogram(name: "TSARKIMEXGetType", scope: !26, file: !26, line: 923, type: !117, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !79)

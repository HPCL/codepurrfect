; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/vec/is/section/interface/ftn-custom/zsectionf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/vec/is/section/interface/ftn-custom/zsectionf.c"
...
@__func__.petscsectionviewfromoptions_ = private unnamed_addr constant [29 x i8] c"petscsectionviewfromoptions_\00", align 1
@.str = private unnamed_addr constant [105 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/vec/is/section/interface/ftn-custom/zsectionf.c\00", align 1
...
define void @petscsectionviewfromoptions_(%struct._p_PetscSection** nocapture readonly %0, %struct._p_PetscObject* %1, i8* %2, i32* nocapture %3, i64 %4) local_unnamed_addr #0 !dbg !51 {
  %6 = alloca i8*, align 8
  call void @llvm.dbg.value(metadata %struct._p_PetscSection** %0, metadata !260, metadata !DIExpression()), !dbg !266
...
19:                                               ; preds = %11, %14
  ...
  %21 = call i32 (i32, i32, i32, i8*, i8*, i64, i8*, ...) @PetscMallocA(i32 1, i32 0, i32 15, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__func__.petscsectionviewfromoptions_, i64 0, i64 0), i8* getelementptr inbounds ([105 x i8], [105 x i8]* @.str, i64 0, i64 0), i64 %20, i8* nonnull %7) #4, !dbg !278
...
58:                                               ; preds = %48, %32
  %59 = call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 16, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([105 x i8], [105 x i8]* @.str, i64 0, i64 0), i32 62, i32 0, i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str.2, i64 0, i64 0)) #4, !dbg !294
  br label %74, !dbg !294
...
60:                                               ; preds = %48, %27
  ...
  %62 = load %struct._p_PetscSection*, %struct._p_PetscSection** %0, align 8, !dbg !296, !tbaa !271
  ...
  %64 = call i32 @PetscSectionViewFromOptions(%struct._p_PetscSection* %62, %struct._p_PetscObject* %61, i8* %63) #4, !dbg !298
...
69:                                               ; preds = %60
  ...
  %71 = call i32 %70(i8* %66, i32 18, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__func__.petscsectionviewfromoptions_, i64 0, i64 0), i8* getelementptr inbounds ([105 x i8], [105 x i8]* @.str, i64 0, i64 0)) #4, !dbg !303
...
declare !dbg !317 i32 @PetscSectionViewFromOptions(%struct._p_PetscSection*, %struct._p_PetscObject*, i8*) local_unnamed_addr #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/vec/is/section/interface/ftn-custom/zsectionf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3, !9, !24}
...
!51 = distinct !DISubprogram(name: "petscsectionviewfromoptions_", scope: !52, file: !52, line: 11, type: !53, scopeLine: 12, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !259)
!52 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/vec/is/section/interface/ftn-custom/zsectionf.c", directory: "/home/users/ndemeye/xSDK")
!53 = !DISubroutineType(types: !54)
!54 = !{null, !55, !60, !143, !258, !31}
!55 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !56, size: 64)
!56 = !DIDerivedType(tag: DW_TAG_typedef, name: "PetscSection", file: !57, line: 18, baseType: !58)
!57 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/include/petscsectiontypes.h", directory: "/home/users/ndemeye/xSDK")
!58 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !59, size: 64)
!59 = !DICompositeType(tag: DW_TAG_structure_type, name: "_p_PetscSection", file: !57, line: 18, flags: DIFlagFwdDecl)
...
!260 = !DILocalVariable(name: "ao", arg: 1, scope: !51, file: !52, line: 11, type: !55)
!261 = !DILocalVariable(name: "obj", arg: 2, scope: !51, file: !52, line: 11, type: !60)
!262 = !DILocalVariable(name: "type", arg: 3, scope: !51, file: !52, line: 11, type: !143)
!263 = !DILocalVariable(name: "ierr", arg: 4, scope: !51, file: !52, line: 11, type: !258)
!264 = !DILocalVariable(name: "len", arg: 5, scope: !51, file: !52, line: 11, type: !31)
!265 = !DILocalVariable(name: "t", scope: !51, file: !52, line: 13, type: !143)
!266 = !DILocation(line: 0, scope: !51)
!267 = !DILocation(line: 13, column: 3, scope: !51)
!268 = !DILocation(line: 15, column: 3, scope: !269)
!269 = distinct !DILexicalBlock(scope: !270, file: !52, line: 15, column: 3)
!270 = distinct !DILexicalBlock(scope: !51, file: !52, line: 15, column: 3)
!271 = !{!272, !272, i64 0}
!272 = !{!"any pointer", !273, i64 0}
!273 = !{!"omnipotent char", !274, i64 0}
!274 = !{!"Simple C/C++ TBAA"}
!275 = !DILocation(line: 15, column: 3, scope: !270)
!276 = !DILocation(line: 15, column: 3, scope: !277)
!277 = distinct !DILexicalBlock(scope: !269, file: !52, line: 15, column: 3)
!278 = !DILocation(line: 15, column: 3, scope: !279)
!279 = distinct !DILexicalBlock(scope: !269, file: !52, line: 15, column: 3)
!280 = !{!273, !273, i64 0}
!281 = distinct !{!281, !278, !278, !282}
!282 = !{!"llvm.loop.mustprogress"}
!283 = !{!284, !284, i64 0}
!284 = !{!"int", !273, i64 0}
!285 = !DILocation(line: 15, column: 3, scope: !286)
!286 = distinct !DILexicalBlock(scope: !279, file: !52, line: 15, column: 3)
!287 = !DILocation(line: 15, column: 3, scope: !288)
!288 = distinct !DILexicalBlock(scope: !279, file: !52, line: 15, column: 3)
!289 = !DILocation(line: 16, column: 3, scope: !290)
!290 = distinct !DILexicalBlock(scope: !51, file: !52, line: 16, column: 3)
!291 = !DILocation(line: 16, column: 3, scope: !51)
!292 = !DILocation(line: 16, column: 3, scope: !293)
!293 = distinct !DILexicalBlock(scope: !290, file: !52, line: 16, column: 3)
!294 = !DILocation(line: 16, column: 3, scope: !295)
!295 = distinct !DILexicalBlock(scope: !293, file: !52, line: 16, column: 3)
!296 = !DILocation(line: 17, column: 39, scope: !51)
!297 = !DILocation(line: 17, column: 47, scope: !51)
!298 = !DILocation(line: 17, column: 11, scope: !51)
!299 = !DILocation(line: 17, column: 9, scope: !51)
!300 = !DILocation(line: 17, column: 54, scope: !301)
!301 = distinct !DILexicalBlock(scope: !51, file: !52, line: 17, column: 54)
!302 = !DILocation(line: 17, column: 54, scope: !51)
!303 = !DILocation(line: 18, column: 3, scope: !304)
!304 = distinct !DILexicalBlock(scope: !51, file: !52, line: 18, column: 3)
!305 = !DILocation(line: 19, column: 1, scope: !51)
...
!317 = !DISubprogram(name: "PetscSectionViewFromOptions", scope: !318, file: !318, line: 59, type: !319, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !310)
!318 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/include/petscsection.h", directory: "/home/users/ndemeye/xSDK")

; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/interface/ftn-custom/ztsregf.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/interface/ftn-custom/ztsregf.c"
...
@__func__.tssettype_ = private unnamed_addr constant [11 x i8] c"tssettype_\00", align 1
@.str = private unnamed_addr constant [91 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/interface/ftn-custom/ztsregf.c\00", align 1
@PetscTrFree = external local_unnamed_addr global i32 (i8*, i32, i8*, i8*)*, align 8

; Function Attrs: nounwind uwtable
define void @tssettype_(%struct._p_TS** nocapture readonly %0, i8* %1, i32* nocapture %2, i64 %3) local_unnamed_addr #0 !dbg !20 {
  %5 = alloca i8*, align 8
...
18:                                               ; preds = %10, %13
  ...
  %20 = call i32 (i32, i32, i32, i8*, i8*, i64, i8*, ...) @PetscMallocA(i32 1, i32 0, i32 16, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__func__.tssettype_, i64 0, i64 0), i8* getelementptr inbounds ([91 x i8], [91 x i8]* @.str, i64 0, i64 0), i64 %19, i8* nonnull %6) #5, !dbg !52
...
28:                                               ; preds = %26, %9
  ...
  %32 = call i32 @TSSetType(%struct._p_TS* %31, i8* %29) #5, !dbg !65
...
37:                                               ; preds = %28
  ...
  %39 = call i32 %38(i8* %34, i32 18, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__func__.tssettype_, i64 0, i64 0), i8* getelementptr inbounds ([91 x i8], [91 x i8]* @.str, i64 0, i64 0)) #5, !dbg !70
...
declare !dbg !83 i32 @TSSetType(%struct._p_TS*, i8*) local_unnamed_addr #2

; Function Attrs: argmemonly nofree nosync nounwind willreturn mustprogress
declare void @llvm.lifetime.end.p0i8(i64 immarg, i8* nocapture) #1

; Function Attrs: nounwind uwtable
define void @tsgettype_(%struct._p_TS** nocapture readonly %0, i8* %1, i32* nocapture %2, i64 %3) local_unnamed_addr #0 !dbg !86 {
  %5 = alloca i8*, align 8
  ...
  %8 = call i32 @TSGetType(%struct._p_TS* %7, i8** nonnull %5) #5, !dbg !99
...
declare !dbg !116 i32 @TSGetType(%struct._p_TS*, i8**) local_unnamed_addr #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ts/interface/ftn-custom/ztsregf.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3}
...
!20 = distinct !DISubprogram(name: "tssettype_", scope: !21, file: !21, line: 12, type: !22, scopeLine: 13, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !34)
!21 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/ts/interface/ftn-custom/ztsregf.c", directory: "/home/users/ndemeye/xSDK")
...
!67 = !DILocation(line: 17, column: 32, scope: !68)
!68 = distinct !DILexicalBlock(scope: !20, file: !21, line: 17, column: 32)
!69 = !DILocation(line: 17, column: 32, scope: !20)
...
!82 = !{!33, !29, !77, !12}
!83 = !DISubprogram(name: "TSSetType", scope: !26, file: !26, line: 593, type: !84, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !79)
!84 = !DISubroutineType(types: !85)
!85 = !{!33, !27, !77}
!86 = distinct !DISubprogram(name: "tsgettype_", scope: !21, file: !21, line: 21, type: !22, scopeLine: 22, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !87)
...
!98 = !DILocation(line: 25, column: 21, scope: !86)
...
!116 = !DISubprogram(name: "TSGetType", scope: !26, file: !26, line: 592, type: !117, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !79)

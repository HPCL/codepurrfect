; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ksp/pc/impls/composite/ftn-custom/zcompositef.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ksp/pc/impls/composite/ftn-custom/zcompositef.c"
...
@__func__.pccompositeaddpctype_ = private unnamed_addr constant [22 x i8] c"pccompositeaddpctype_\00", align 1
@.str = private unnamed_addr constant [105 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ksp/pc/impls/composite/ftn-custom/zcompositef.c\00", align 1
@PetscTrFree = external local_unnamed_addr global i32 (i8*, i32, i8*, i8*)*, align 8

; Function Attrs: nounwind uwtable
define void @pccompositeaddpctype_(%struct._p_PC** nocapture readonly %0, i8* %1, i32* nocapture %2, i64 %3) local_unnamed_addr #0 !dbg !20 {
  %5 = alloca i8*, align 8
...
18:                                               ; preds = %10, %13
  ...
  %20 = call i32 (i32, i32, i32, i8*, i8*, i64, i8*, ...) @PetscMallocA(i32 1, i32 0, i32 14, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__func__.pccompositeaddpctype_, i64 0, i64 0), i8* getelementptr inbounds ([105 x i8], [105 x i8]* @.str, i64 0, i64 0), i64 %19, i8* nonnull %6) #4, !dbg !52
...
28:                                               ; preds = %26, %9
  ...
  %32 = call i32 @PCCompositeAddPCType(%struct._p_PC* %31, i8* %29) #4, !dbg !65
...
37:                                               ; preds = %28
  ...
  %39 = call i32 %38(i8* %34, i32 16, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__func__.pccompositeaddpctype_, i64 0, i64 0), i8* getelementptr inbounds ([105 x i8], [105 x i8]* @.str, i64 0, i64 0)) #4, !dbg !70
...
declare !dbg !83 i32 @PCCompositeAddPCType(%struct._p_PC*, i8*) local_unnamed_addr #2
...
!1 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/ksp/pc/impls/composite/ftn-custom/zcompositef.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!2 = !{!3}
...
!20 = distinct !DISubprogram(name: "pccompositeaddpctype_", scope: !21, file: !21, line: 10, type: !22, scopeLine: 11, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !34)
!21 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/ksp/pc/impls/composite/ftn-custom/zcompositef.c", directory: "/home/users/ndemeye/xSDK")
...
!63 = !DILocation(line: 15, column: 36, scope: !20)
!64 = !DILocation(line: 15, column: 32, scope: !20)
!65 = !DILocation(line: 15, column: 11, scope: !20)
!66 = !DILocation(line: 15, column: 9, scope: !20)
!67 = !DILocation(line: 15, column: 43, scope: !68)
!68 = distinct !DILexicalBlock(scope: !20, file: !21, line: 15, column: 43)
!69 = !DILocation(line: 15, column: 43, scope: !20)
...
!82 = !{!33, !29, !77, !12}
!83 = !DISubprogram(name: "PCCompositeAddPCType", scope: !84, file: !84, line: 222, type: !85, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !79)

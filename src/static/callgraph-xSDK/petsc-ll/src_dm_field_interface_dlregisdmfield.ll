; ModuleID = '/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/field/interface/dlregisdmfield.c'
source_filename = "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/field/interface/dlregisdmfield.c"
...
@__func__.DMFieldInitializePackage = private unnamed_addr constant [25 x i8] c"DMFieldInitializePackage\00", align 1
@.str = private unnamed_addr constant [93 x i8] c"/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/field/interface/dlregisdmfield.c\00", align 1
@DMFieldPackageInitialized = internal unnamed_addr global i1 false, align 4, !dbg !0
@.str.1 = private unnamed_addr constant [31 x i8] c"Invalid stack size %d, pop %s\0A\00", align 1
@.str.2 = private unnamed_addr constant [42 x i8] c"Invalid stack: push from %s, pop from %s\0A\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"Field over DM\00", align 1
@DMFIELD_CLASSID = global i32 0, align 4, !dbg !27
@ompi_mpi_comm_self = external global %struct.ompi_predefined_communicator_t, align 1
@.str.4 = private unnamed_addr constant [2 x i8] c" \00", align 1
@__func__.DMFieldFinalizePackage = private unnamed_addr constant [23 x i8] c"DMFieldFinalizePackage\00", align 1
@DMFieldList = external global %struct._n_PetscFunctionList*, align 8
@DMFieldRegisterAllCalled = local_unnamed_addr global i32 0, align 4, !dbg !32

; Function Attrs: nounwind uwtable
define i32 @DMFieldInitializePackage() local_unnamed_addr #0 !dbg !42 {
...
7:                                                ; preds = %3
  ...
  store i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0), i8** %9, align 8, !dbg !70, !tbaa !58
  ...
  store i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i64 0, i64 0), i8** %14, align 8, !dbg !70, !tbaa !58
...
24:                                               ; preds = %3, %7
  ...
  %34 = load i1, i1* @DMFieldPackageInitialized, align 4, !dbg !74
  br i1 %34, label %37, label %93, !dbg !76

35:                                               ; preds = %0
  %36 = load i1, i1* @DMFieldPackageInitialized, align 4, !dbg !74
...
45:                                               ; preds = %41
  %46 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 %39, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0)), !dbg !89
  br label %167, !dbg !89
...
59:                                               ; preds = %54
  ...
  %62 = icmp eq i8* %61, getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0), !dbg !95
  br i1 %62, label %68, label %63, !dbg !98

63:                                               ; preds = %59
  %64 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i64 0, i64 0), i8* %61, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0)), !dbg !99
...
93:                                               ; preds = %35, %24
  store i1 true, i1* @DMFieldPackageInitialized, align 4, !dbg !101
  %94 = tail call i32 @PetscClassIdRegister(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0), i32* nonnull @DMFIELD_CLASSID) #4, !dbg !102
...
96:                                               ; preds = %93
  %97 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 26, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i64 0, i64 0), i32 %94, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4, !dbg !105
  br label %167

98:                                               ; preds = %93
  %99 = tail call i32 @DMFieldRegisterAll() #4, !dbg !109
...
101:                                              ; preds = %98
  %102 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 27, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i64 0, i64 0), i32 %99, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4, !dbg !111
  br label %167

103:                                              ; preds = %98
  %104 = tail call i32 @PetscRegisterFinalize(i32 ()* nonnull @DMFieldFinalizePackage) #4, !dbg !114
...
106:                                              ; preds = %103
  %107 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 28, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i64 0, i64 0), i32 %104, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4, !dbg !116
  br label %167
...
119:                                              ; preds = %115
  %120 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 %113, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0)), !dbg !132
...
133:                                              ; preds = %128
  ...
  %136 = icmp eq i8* %135, getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0), !dbg !138
  br i1 %136, label %142, label %137, !dbg !141

137:                                              ; preds = %133
  %138 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i64 0, i64 0), i8* %135, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.DMFieldInitializePackage, i64 0, i64 0)), !dbg !142
...
declare !dbg !154 i32 @DMFieldRegisterAll() local_unnamed_addr #2

declare !dbg !158 i32 @PetscRegisterFinalize(i32 ()*) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define i32 @DMFieldFinalizePackage() #0 !dbg !162 {
...
7:                                                ; preds = %3
  ...
  store i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__func__.DMFieldFinalizePackage, i64 0, i64 0), i8** %9, align 8, !dbg !176, !tbaa !58
  ...
  store i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i64 0, i64 0), i8** %14, align 8, !dbg !176, !tbaa !58
...
34:                                               ; preds = %24, %0
  %35 = tail call i32 @PetscFunctionListDestroy(%struct._n_PetscFunctionList** nonnull @DMFieldList) #4, !dbg !178
...
37:                                               ; preds = %34
  %38 = tail call i32 (%struct.ompi_communicator_t*, i32, i8*, i8*, i32, i32, i8*, ...) @PetscError(%struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_self to %struct.ompi_communicator_t*), i32 46, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__func__.DMFieldFinalizePackage, i64 0, i64 0), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i64 0, i64 0), i32 %35, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4, !dbg !181
  br label %98

39:                                               ; preds = %34
  store i1 false, i1* @DMFieldPackageInitialized, align 4, !dbg !184
  store i32 0, i32* @DMFieldRegisterAllCalled, align 4, !dbg !185, !tbaa !186
...
50:                                               ; preds = %46
  %51 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 %44, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__func__.DMFieldFinalizePackage, i64 0, i64 0)), !dbg !200
  br label %98, !dbg !200
...
64:                                               ; preds = %59
  ...
  %67 = icmp eq i8* %66, getelementptr inbounds ([23 x i8], [23 x i8]* @__func__.DMFieldFinalizePackage, i64 0, i64 0), !dbg !206
  br i1 %67, label %73, label %68, !dbg !209

68:                                               ; preds = %64
  %69 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i64 0, i64 0), i8* %66, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__func__.DMFieldFinalizePackage, i64 0, i64 0)), !dbg !210
...
!1 = distinct !DIGlobalVariable(name: "DMFieldPackageInitialized", scope: !2, file: !29, line: 5, type: !34, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "/home/users/ndemeye/xSDK/hpc-apps/petsc/petsc-3.15.0/src/dm/field/interface/dlregisdmfield.c", directory: "/home/users/ndemeye/xSDK/code-analysis/src/static/callgraph-xSDK")
!4 = !{!5, !11}
...
!28 = distinct !DIGlobalVariable(name: "DMFIELD_CLASSID", scope: !2, file: !29, line: 3, type: !30, isLocal: false, isDefinition: true)
!29 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/src/dm/field/interface/dlregisdmfield.c", directory: "/home/users/ndemeye/xSDK")
!30 = !DIDerivedType(tag: DW_TAG_typedef, name: "PetscClassId", file: !6, line: 32, baseType: !31)
!31 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!32 = !DIGlobalVariableExpression(var: !33, expr: !DIExpression())
!33 = distinct !DIGlobalVariable(name: "DMFieldRegisterAllCalled", scope: !2, file: !29, line: 7, type: !34, isLocal: false, isDefinition: true)
...
!42 = distinct !DISubprogram(name: "DMFieldInitializePackage", scope: !29, file: !29, line: 18, type: !43, scopeLine: 19, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !46)
...
!49 = distinct !DILexicalBlock(scope: !42, file: !29, line: 26, column: 65)
!50 = !DILocalVariable(name: "ierr__", scope: !51, file: !29, line: 27, type: !45)
!51 = distinct !DILexicalBlock(scope: !42, file: !29, line: 27, column: 31)
!52 = !DILocalVariable(name: "ierr__", scope: !53, file: !29, line: 28, type: !45)
!53 = distinct !DILexicalBlock(scope: !42, file: !29, line: 28, column: 56)
...
!77 = !DILocation(line: 23, column: 34, scope: !78)
!78 = distinct !DILexicalBlock(scope: !79, file: !29, line: 23, column: 34)
!79 = distinct !DILexicalBlock(scope: !80, file: !29, line: 23, column: 34)
!80 = distinct !DILexicalBlock(scope: !81, file: !29, line: 23, column: 34)
!81 = distinct !DILexicalBlock(scope: !82, file: !29, line: 23, column: 34)
!82 = distinct !DILexicalBlock(scope: !75, file: !29, line: 23, column: 34)
!83 = !DILocation(line: 23, column: 34, scope: !79)
!84 = !DILocation(line: 23, column: 34, scope: !85)
!85 = distinct !DILexicalBlock(scope: !86, file: !29, line: 23, column: 34)
!86 = distinct !DILexicalBlock(scope: !78, file: !29, line: 23, column: 34)
!87 = !{!67, !60, i64 1544}
!88 = !DILocation(line: 23, column: 34, scope: !86)
!89 = !DILocation(line: 23, column: 34, scope: !90)
!90 = distinct !DILexicalBlock(scope: !85, file: !29, line: 23, column: 34)
!91 = !DILocation(line: 23, column: 34, scope: !92)
!92 = distinct !DILexicalBlock(scope: !78, file: !29, line: 23, column: 34)
!93 = !DILocation(line: 23, column: 34, scope: !94)
!94 = distinct !DILexicalBlock(scope: !92, file: !29, line: 23, column: 34)
!95 = !DILocation(line: 23, column: 34, scope: !96)
!96 = distinct !DILexicalBlock(scope: !97, file: !29, line: 23, column: 34)
!97 = distinct !DILexicalBlock(scope: !94, file: !29, line: 23, column: 34)
!98 = !DILocation(line: 23, column: 34, scope: !97)
!99 = !DILocation(line: 23, column: 34, scope: !100)
!100 = distinct !DILexicalBlock(scope: !96, file: !29, line: 23, column: 34)
!101 = !DILocation(line: 24, column: 29, scope: !42)
!102 = !DILocation(line: 26, column: 10, scope: !42)
!103 = !DILocation(line: 0, scope: !42)
!104 = !DILocation(line: 0, scope: !49)
!105 = !DILocation(line: 26, column: 65, scope: !106)
!106 = distinct !DILexicalBlock(scope: !49, file: !29, line: 26, column: 65)
!107 = !DILocation(line: 26, column: 65, scope: !49)
!108 = !{!"branch_weights", i32 2000, i32 1}
!109 = !DILocation(line: 27, column: 10, scope: !42)
!110 = !DILocation(line: 0, scope: !51)
!111 = !DILocation(line: 27, column: 31, scope: !112)
!112 = distinct !DILexicalBlock(scope: !51, file: !29, line: 27, column: 31)
!113 = !DILocation(line: 27, column: 31, scope: !51)
!114 = !DILocation(line: 28, column: 10, scope: !42)
!115 = !DILocation(line: 0, scope: !53)
!116 = !DILocation(line: 28, column: 56, scope: !117)
!117 = distinct !DILexicalBlock(scope: !53, file: !29, line: 28, column: 56)
!118 = !DILocation(line: 28, column: 56, scope: !53)
...
!154 = !DISubprogram(name: "DMFieldRegisterAll", scope: !155, file: !155, line: 8, type: !156, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !150)
!155 = !DIFile(filename: "hpc-apps/petsc/petsc-3.15.0/include/petsc/private/dmfieldimpl.h", directory: "/home/users/ndemeye/xSDK")
...
!162 = distinct !DISubprogram(name: "DMFieldFinalizePackage", scope: !29, file: !29, line: 41, type: !43, scopeLine: 42, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !163)
!163 = !{!164, !165}
...
!166 = distinct !DILexicalBlock(scope: !162, file: !29, line: 46, column: 49)
...
!181 = !DILocation(line: 46, column: 49, scope: !182)
!182 = distinct !DILexicalBlock(scope: !166, file: !29, line: 46, column: 49)
!183 = !DILocation(line: 46, column: 49, scope: !166)
!184 = !DILocation(line: 47, column: 29, scope: !162)
!185 = !DILocation(line: 48, column: 29, scope: !162)
!186 = !{!60, !60, i64 0}

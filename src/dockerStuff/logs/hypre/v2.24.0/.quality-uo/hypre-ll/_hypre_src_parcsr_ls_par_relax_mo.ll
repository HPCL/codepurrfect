...
92:                                               ; preds = %87, %140
  %93 = phi i64 [ 0, %87 ], [ %144, %140 ]
  %94 = phi double [ %82, %87 ], [ %96, %140 ]
  ...
  %97 = fcmp olt double %96, 0x3CB0000000000000
...
100:                                              ; preds = %98
  %101 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %29, %struct.hypre_ParVector_struct* %25) #8
  br label %114

102:                                              ; preds = %98
  %103 = fdiv double %96, %94
  br i1 %83, label %104, label %114

104:                                              ; preds = %102, %104
  %105 = phi i64 [ %112, %104 ], [ 0, %102 ]
  %106 = getelementptr inbounds double, double* %42, i64 %105
  %107 = load double, double* %106, align 8, !tbaa !18
  %108 = getelementptr inbounds double, double* %46, i64 %105
  %109 = load double, double* %108, align 8, !tbaa !18
  %110 = fmul double %103, %109
  %111 = fadd double %107, %110
  store double %111, double* %108, align 8, !tbaa !18
  %112 = add nuw nsw i64 %105, 1
  %113 = icmp eq i64 %112, %89
  br i1 %113, label %114, label %104, !llvm.loop !31

114:                                              ; preds = %104, %102, %100
  %115 = phi double [ 1.000000e+00, %100 ], [ %103, %102 ], [ %103, %104 ]
  br i1 %76, label %138, label %116

116:                                              ; preds = %114
  br i1 %84, label %117, label %127

117:                                              ; preds = %116, %117
  %118 = phi i64 [ %125, %117 ], [ 0, %116 ]
  %119 = getelementptr inbounds double, double* %50, i64 %118
  %120 = load double, double* %119, align 8, !tbaa !18
  %121 = getelementptr inbounds double, double* %46, i64 %118
  %122 = load double, double* %121, align 8, !tbaa !18
  %123 = fmul double %120, %122
  %124 = getelementptr inbounds double, double* %54, i64 %118
  store double %123, double* %124, align 8, !tbaa !18
  %125 = add nuw nsw i64 %118, 1
  %126 = icmp eq i64 %125, %90
  br i1 %126, label %127, label %117, !llvm.loop !32

127:                                              ; preds = %117, %116
  %128 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %37, double 0.000000e+00, %struct.hypre_ParVector_struct* %29) #8
  br i1 %85, label %129, label %140

129:                                              ; preds = %127, %129
  %130 = phi i64 [ %136, %129 ], [ 0, %127 ]
  %131 = getelementptr inbounds double, double* %50, i64 %130
  %132 = load double, double* %131, align 8, !tbaa !18
  %133 = getelementptr inbounds double, double* %42, i64 %130
  %134 = load double, double* %133, align 8, !tbaa !18
  %135 = fmul double %132, %134
  store double %135, double* %133, align 8, !tbaa !18
  %136 = add nuw nsw i64 %130, 1
  %137 = icmp eq i64 %136, %91
  br i1 %137, label %140, label %129, !llvm.loop !33

138:                                              ; preds = %114
  %139 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %25, double 0.000000e+00, %struct.hypre_ParVector_struct* %29) #8
  br label %140

140:                                              ; preds = %129, %127, %138
  %141 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %29, %struct.hypre_ParVector_struct* %25) #8
  %142 = fdiv double %96, %141
  %143 = fdiv double 1.000000e+00, %142
  %144 = add nuw nsw i64 %93, 1
  %145 = getelementptr inbounds double, double* %58, i64 %144
  store double %143, double* %145, align 8, !tbaa !18
  %146 = getelementptr inbounds double, double* %58, i64 %93
  %147 = load double, double* %146, align 8, !tbaa !18
  %148 = fmul double %115, %147
  %149 = fadd double %143, %148
  store double %149, double* %146, align 8, !tbaa !18
  %150 = getelementptr inbounds double, double* %60, i64 %144
  store double %143, double* %150, align 8, !tbaa !18
  %151 = call double @sqrt(double %115) #8
  %152 = getelementptr inbounds double, double* %60, i64 %93
  %153 = load double, double* %152, align 8, !tbaa !18
  %154 = fmul double %151, %153
  store double %154, double* %152, align 8, !tbaa !18
  %155 = fneg double %142
  %156 = call i32 @hypre_ParVectorAxpy(double %155, %struct.hypre_ParVector_struct* %29, %struct.hypre_ParVector_struct* %21) #8
  %157 = icmp eq i64 %144, %88
  br i1 %157, label %160, label %92, !llvm.loop !34

158:                                              ; preds = %92
  %159 = trunc i64 %93 to i32
  br label %160

160:                                              ; preds = %158, %140, %81
  %161 = phi i32 [ 0, %81 ], [ %159, %158 ], [ %17, %140 ]
  store i32 %161, i32* %6, align 4, !tbaa !17
  %162 = call i32 @hypre_LINPACKcgtql1(i32* nonnull %6, double* %58, double* %60, i32* nonnull %7)
  %163 = add nsw i32 %161, -1
  %164 = sext i32 %163 to i64
  %165 = getelementptr inbounds double, double* %58, i64 %164
  %166 = load double, double* %165, align 8, !tbaa !18
  %167 = load double, double* %58, align 8, !tbaa !18
  call void @hypre_Free(i8* %57, i32 0) #8
  call void @hypre_Free(i8* %59, i32 0) #8
  %168 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %21) #8
  %169 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %29) #8
  %170 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %25) #8
  %171 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %33) #8
  %172 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %37) #8
  store double %166, double* %3, align 8, !tbaa !18
  store double %167, double* %4, align 8, !tbaa !18

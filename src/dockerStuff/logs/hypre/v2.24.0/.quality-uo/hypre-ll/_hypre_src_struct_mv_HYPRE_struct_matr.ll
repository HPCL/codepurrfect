...
@.str = private unnamed_addr constant [43 x i8] c"/hypre/src/struct_mv/HYPRE_struct_matrix.c\00", align 1
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructMatrixRead(i32 %0, i8* %1, i32* %2, %struct.hypre_StructMatrix_struct** %3) local_unnamed_addr #0 {
  %5 = icmp eq %struct.hypre_StructMatrix_struct** %3, null
  br i1 %5, label %6, label %7

6:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 403, i32 36, i8* null) #4
  br label %9

7:                                                ; preds = %4
  %8 = call %struct.hypre_StructMatrix_struct* @hypre_StructMatrixRead(i32 %0, i8* %1, i32* %2) #4
  store %struct.hypre_StructMatrix_struct* %8, %struct.hypre_StructMatrix_struct** %3, align 8, !tbaa !3
  br label %9
...
declare dso_local %struct.hypre_StructMatrix_struct* @hypre_StructMatrixRead(i32, i8*, i32*) local_unnamed_addr #1

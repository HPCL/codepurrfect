...
@.str.3 = private unnamed_addr constant [45 x i8] c"/hypre/src/sstruct_mv/HYPRE_sstruct_vector.c\00", align 1
@.str.4 = private unnamed_addr constant [15 x i8] c"SStructVector\0A\00", align 1
@.str.5 = private unnamed_addr constant [28 x i8] c"\0AData - (Part %d, Var %d):\0A\00", align 1
@.str.6 = private unnamed_addr constant [2 x i8] c"r\00", align 1
@.str.7 = private unnamed_addr constant [33 x i8] c"Error: can't open input file %s\0A\00", align 1
...
define dso_local i32 @HYPRE_SStructVectorCreate(i32 %0, %struct.hypre_SStructGrid_struct* %1, %struct.hypre_SStructVector_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_MAlloc(i64 96, i32 0) #6
  ...
  %12 = call i32 @hypre_SStructGridRef(%struct.hypre_SStructGrid_struct* %1, %struct.hypre_SStructGrid_struct** nonnull %11) #6
...
27:                                               ; preds = %25, %27
  ...
  %35 = call i32 @hypre_SStructPVectorCreate(i32 %33, %struct.hypre_SStructPGrid* %31, %struct.hypre_SStructPVector** %34) #6
...
10:                                               ; preds = %3
  ...
  %13 = call i32 @HYPRE_SStructGridDestroy(%struct.hypre_SStructGrid_struct* %12) #6
...
21:                                               ; preds = %19, %21
  ...
  %25 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %24) #6
...
28:                                               ; preds = %21, %10
  ...
  call void @hypre_Free(i8* %29, i32 0) #6
  ...
  %32 = call i32 @HYPRE_IJVectorDestroy(%struct.hypre_IJVector_struct* %31) #6
...
define dso_local i32 @HYPRE_SStructVectorInitialize(%struct.hypre_SStructVector_struct* %0) local_unnamed_addr #0 {
  ...
  %10 = call i32 @hypre_SStructVectorInitializeShell(%struct.hypre_SStructVector_struct* %0) #6
  ...
  %14 = call i8* @hypre_CAlloc(i64 %13, i64 8, i32 1) #6
...
44:                                               ; preds = %42, %61
  ...
  %54 = call i32 @hypre_StructVectorInitializeData(%struct.hypre_StructVector_struct* %48, double* %53) #6
...
59:                                               ; preds = %44
  %60 = call i32 @hypre_StructVectorClearGhostValues(%struct.hypre_StructVector_struct* %48) #6
  br label %61
...
86:                                               ; preds = %76, %79
  ...
  %90 = call i32 @HYPRE_IJVectorCreate(i32 %9, i32 %87, i32 %88, %struct.hypre_IJVector_struct** nonnull %89) #6
  %91 = load %struct.hypre_IJVector_struct*, %struct.hypre_IJVector_struct** %89, align 8, !tbaa !29
  %92 = call i32 @HYPRE_IJVectorSetObjectType(%struct.hypre_IJVector_struct* %91, i32 5555) #6
  %93 = call i32 @HYPRE_IJVectorInitialize(%struct.hypre_IJVector_struct* %91) #6
...
define dso_local i32 @HYPRE_SStructVectorSetValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* %2, i32 %3, double* %4) local_unnamed_addr #0 {
  ...
  %16 = call i32 @hypre_CopyToCleanIndex(i32* %2, i32 %8, i32* nonnull %15) #6
...
20:                                               ; preds = %5
  %21 = call i32 @hypre_SStructPVectorSetValues(%struct.hypre_SStructPVector* %13, i32* nonnull %15, i32 %3, double* %4, i32 0) #6
  br label %22
...
20:                                               ; preds = %5
  %21 = call i32 @hypre_SStructPVectorSetValues(%struct.hypre_SStructPVector* %13, i32* nonnull %15, i32 %3, double* %4, i32 1) #6
  br label %22
...
46:                                               ; preds = %36, %34
  ...
  %53 = call i32 @hypre_CopyToCleanIndex(i32* nonnull %26, i32 %49, i32* nonnull %29) #6
...
57:                                               ; preds = %46
  ...
  %59 = call i32 @hypre_SStructPVectorSetValues(%struct.hypre_SStructPVector* %52, i32* nonnull %29, i32 %48, double* %58, i32 1) #6
  br label %60
...
20:                                               ; preds = %5
  %21 = call i32 @hypre_SStructPVectorGetValues(%struct.hypre_SStructPVector* %13, i32* nonnull %15, i32 %3, double* %4) #6
  br label %22
...
define dso_local i32 @HYPRE_SStructVectorGetFEMValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* nocapture readonly %2, double* %3) local_unnamed_addr #0 {
  ...
  %29 = call i32 @hypre_SetIndex(i32* nonnull %28, i32 0) #6
  %30 = icmp sgt i32 %7, 0
...
47:                                               ; preds = %37, %35
  ...
  %51 = call i32 @hypre_SStructPVectorGetValues(%struct.hypre_SStructPVector* %14, i32* nonnull %28, i32 %49, double* %50) #6
...
define dso_local i32 @HYPRE_SStructVectorSetBoxValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* nocapture readonly %2, i32* nocapture readonly %3, i32 %4, double* %5) local_unnamed_addr #0 {
  ...
  %14 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %13) #6
  %15 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %13) #6
...
33:                                               ; preds = %19, %6
  %34 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %11, %struct.hypre_Box_struct* %14, i32 %4, %struct.hypre_Box_struct* %15, double* %5, i32 0) #6
  %35 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %14) #6
  %36 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %15) #6
...
define dso_local i32 @HYPRE_SStructVectorSetBoxValues2(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* nocapture readonly %2, i32* nocapture readonly %3, i32 %4, i32* nocapture readonly %5, i32* nocapture readonly %6, double* %7) local_unnamed_addr #0 {
  ...
  %16 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %15) #6
  %17 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %15) #6
  %18 = icmp sgt i32 %15, 0
...
37:                                               ; preds = %21, %8
  %38 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %13, %struct.hypre_Box_struct* %16, i32 %4, %struct.hypre_Box_struct* %17, double* %7, i32 0) #6
  %39 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %16) #6
  %40 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %17) #6
...
33:                                               ; preds = %19, %6
  %34 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %11, %struct.hypre_Box_struct* %14, i32 %4, %struct.hypre_Box_struct* %15, double* %5, i32 1) #6
  %35 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %14) #6
  %36 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %15) #6
  %37 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %37
...
37:                                               ; preds = %21, %8
  %38 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %13, %struct.hypre_Box_struct* %16, i32 %4, %struct.hypre_Box_struct* %17, double* %7, i32 1) #6
  %39 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %16) #6
  %40 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %17) #6
  %41 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %41
...
33:                                               ; preds = %19, %6
  %34 = call i32 @hypre_SStructPVectorGetBoxValues(%struct.hypre_SStructPVector* %11, %struct.hypre_Box_struct* %14, i32 %4, %struct.hypre_Box_struct* %15, double* %5) #6
  %35 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %14) #6
  %36 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %15) #6
  %37 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %37
...
37:                                               ; preds = %21, %8
  %38 = call i32 @hypre_SStructPVectorGetBoxValues(%struct.hypre_SStructPVector* %13, %struct.hypre_Box_struct* %16, i32 %4, %struct.hypre_Box_struct* %17, double* %7) #6
  %39 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %16) #6
  %40 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %17) #6
  %41 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %41
...
25:                                               ; preds = %18, %25
  ...
  %30 = call i32 @hypre_SStructPVectorAccumulate(%struct.hypre_SStructPVector* %29) #6
...
38:                                               ; preds = %23, %38
  ...
  %75 = call i32 @hypre_CommPkgCreate(%struct.hypre_CommInfo_struct* %43, %struct.hypre_BoxArray_struct* %70, %struct.hypre_BoxArray_struct* %72, i32 1, i32** null, i32 1, i32 %74, %struct.hypre_CommPkg_struct** nonnull %2) #6
  ...
  %81 = call i32 @hypre_InitializeCommunication(%struct.hypre_CommPkg_struct* %76, double* %78, double* %80, i32 1, i32 0, %struct.hypre_CommHandle_struct** nonnull %3) #6
  %82 = load %struct.hypre_CommHandle_struct*, %struct.hypre_CommHandle_struct** %3, align 8, !tbaa !16
  %83 = call i32 @hypre_FinalizeCommunication(%struct.hypre_CommHandle_struct* %82) #6
  %84 = load %struct.hypre_CommPkg_struct*, %struct.hypre_CommPkg_struct** %2, align 8, !tbaa !16
  %85 = call i32 @hypre_CommPkgDestroy(%struct.hypre_CommPkg_struct* %84) #6
...
88:                                               ; preds = %36, %88
  ...
  %93 = call i32 @hypre_SStructPVectorAssemble(%struct.hypre_SStructPVector* %92) #6
  %94 = add nuw nsw i64 %89, 1
  %95 = icmp eq i64 %94, %37
  br i1 %95, label %96, label %88, !llvm.loop !75

96:                                               ; preds = %88, %33
  %97 = call i32 @HYPRE_IJVectorAssemble(%struct.hypre_IJVector_struct* %9) #6
  ...
  %100 = call i32 @HYPRE_IJVectorGetObject(%struct.hypre_IJVector_struct* %9, i8** nonnull %99) #6
...
104:                                              ; preds = %96
  %105 = call i32 @hypre_SStructVectorParConvert(%struct.hypre_SStructVector_struct* %0, %struct.hypre_ParVector_struct** nonnull %98) #6
  br label %106
...
17:                                               ; preds = %1
  ...
  %20 = call i32 @hypre_SStructVectorParRestore(%struct.hypre_SStructVector_struct* %0, %struct.hypre_ParVector_struct* %19) #6
  br label %21
...
31:                                               ; preds = %24, %31
  ...
  %36 = call i32 @hypre_SStructPVectorGather(%struct.hypre_SStructPVector* %35) #6
...
39:                                               ; preds = %29, %39
  ...
  %76 = call i32 @hypre_CommPkgCreate(%struct.hypre_CommInfo_struct* %44, %struct.hypre_BoxArray_struct* %71, %struct.hypre_BoxArray_struct* %73, i32 1, i32** null, i32 0, i32 %75, %struct.hypre_CommPkg_struct** nonnull %2) #6
  ...
  %82 = call i32 @hypre_InitializeCommunication(%struct.hypre_CommPkg_struct* %77, double* %79, double* %81, i32 0, i32 0, %struct.hypre_CommHandle_struct** nonnull %3) #6
  %83 = load %struct.hypre_CommHandle_struct*, %struct.hypre_CommHandle_struct** %3, align 8, !tbaa !16
  %84 = call i32 @hypre_FinalizeCommunication(%struct.hypre_CommHandle_struct* %83) #6
  %85 = load %struct.hypre_CommPkg_struct*, %struct.hypre_CommPkg_struct** %2, align 8, !tbaa !16
  %86 = call i32 @hypre_CommPkgDestroy(%struct.hypre_CommPkg_struct* %85) #6
...
9:                                                ; preds = %7, %9
  ...
  %13 = load %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %12, align 8, !tbaa !16
  %14 = call i32 @hypre_SStructPVectorSetConstantValues(%struct.hypre_SStructPVector* %13, double %1) #6
...
define dso_local i32 @HYPRE_SStructVectorPrint(i8* %0, %struct.hypre_SStructVector_struct* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
  ...
  %6 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %1, i64 0, i32 0
  %7 = load i32, i32* %6, align 8, !tbaa !3
  %8 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %1, i64 0, i32 4
  %9 = load i32, i32* %8, align 4, !tbaa !14
  %10 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %1, i64 0, i32 2
  %11 = load %struct.hypre_SStructGrid_struct*, %struct.hypre_SStructGrid_struct** %10, align 8, !tbaa !27
  %12 = bitcast i32* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %12) #6
  %13 = getelementptr inbounds [255 x i8], [255 x i8]* %5, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 255, i8* nonnull %13) #6
  %14 = call i32 @hypre_MPI_Comm_rank(i32 %7, i32* nonnull %4) #6
  %15 = load i32, i32* %4, align 4, !tbaa !26
  %16 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* nonnull %13, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* %0, i32 %15) #6
  %17 = call %struct._IO_FILE* @fopen(i8* nonnull %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  %18 = icmp eq %struct._IO_FILE* %17, null
  br i1 %18, label %19, label %21

19:                                               ; preds = %3
  %20 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* nonnull %13) #6
  call void @hypre_error_handler(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.3, i64 0, i64 0), i32 818, i32 12, i8* null) #6
  br label %55

21:                                               ; preds = %3
  %22 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %17, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0)) #6
  %23 = call i32 @hypre_SStructGridPrint(%struct._IO_FILE* nonnull %17, %struct.hypre_SStructGrid_struct* %11) #6
  %24 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %1, i64 0, i32 5
  %25 = icmp sgt i32 %9, 0
...
28:                                               ; preds = %26, %50
  %29 = phi i64 [ 0, %26 ], [ %51, %50 ]
  %30 = load %struct.hypre_SStructPVector**, %struct.hypre_SStructPVector*** %24, align 8, !tbaa !22
  %31 = getelementptr inbounds %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %30, i64 %29
  %32 = load %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %31, align 8, !tbaa !16
  %33 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %32, i64 0, i32 2
  %34 = load i32, i32* %33, align 8, !tbaa !34
  %35 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %32, i64 0, i32 3
...
40:                                               ; preds = %37, %40
  ...
  %42 = load %struct.hypre_StructVector_struct**, %struct.hypre_StructVector_struct*** %35, align 8, !tbaa !37
  %43 = getelementptr inbounds %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %42, i64 %41
  %44 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %43, align 8, !tbaa !16
  %45 = trunc i64 %41 to i32
  %46 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %17, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5, i64 0, i64 0), i32 %39, i32 %45) #6
  %47 = call i32 @hypre_StructVectorPrintData(%struct._IO_FILE* nonnull %17, %struct.hypre_StructVector_struct* %44, i32 %2) #6
  %48 = add nuw nsw i64 %41, 1
  %49 = icmp eq i64 %48, %38
  br i1 %49, label %50, label %40, !llvm.loop !81

50:                                               ; preds = %40, %28
  %51 = add nuw nsw i64 %29, 1
  %52 = icmp eq i64 %51, %27
  br i1 %52, label %53, label %28, !llvm.loop !82

53:                                               ; preds = %50, %21
  %54 = call i32 @fclose(%struct._IO_FILE* nonnull %17)
  br label %55

55:                                               ; preds = %53, %19
  %56 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  call void @llvm.lifetime.end.p0i8(i64 255, i8* nonnull %13) #6
...
declare dso_local i32 @hypre_StructVectorPrintData(%struct._IO_FILE*, %struct.hypre_StructVector_struct*, i32) local_unnamed_addr #2

; Function Attrs: nofree nounwind
declare dso_local noundef i32 @fclose(%struct._IO_FILE* nocapture noundef) local_unnamed_addr #4

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_SStructVectorRead(i32 %0, i8* %1, %struct.hypre_SStructVector_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = alloca %struct.hypre_SStructVector_struct*, align 8
  %5 = alloca %struct.hypre_SStructGrid_struct*, align 8
  %6 = alloca [255 x i8], align 16
  %7 = alloca i32, align 4
  %8 = alloca i32, align 4
  %9 = alloca i32, align 4
  %10 = bitcast %struct.hypre_SStructVector_struct** %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %10) #6
  %11 = bitcast %struct.hypre_SStructGrid_struct** %5 to i8*
  ...
  %16 = call i32 @hypre_MPI_Comm_rank(i32 %0, i32* nonnull %9) #6
  %17 = load i32, i32* %9, align 4, !tbaa !26
  %18 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* nonnull %12, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* %1, i32 %17) #6
  %19 = call %struct._IO_FILE* @fopen(i8* nonnull %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0))
  %20 = icmp eq %struct._IO_FILE* %19, null
  br i1 %20, label %21, label %23

21:                                               ; preds = %3
  %22 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.7, i64 0, i64 0), i8* nonnull %12) #6
  call void @hypre_error_handler(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.3, i64 0, i64 0), i32 874, i32 20, i8* null) #6
  br label %69

23:                                               ; preds = %3
  %24 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* nonnull %19, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0)) #6
  %25 = call i32 @hypre_SStructGridRead(i32 %0, %struct._IO_FILE* nonnull %19, %struct.hypre_SStructGrid_struct** nonnull %5) #6
  %26 = load %struct.hypre_SStructGrid_struct*, %struct.hypre_SStructGrid_struct** %5, align 8, !tbaa !16
  %27 = call i32 @HYPRE_SStructVectorCreate(i32 %0, %struct.hypre_SStructGrid_struct* %26, %struct.hypre_SStructVector_struct** nonnull %4)
  %28 = load %struct.hypre_SStructVector_struct*, %struct.hypre_SStructVector_struct** %4, align 8, !tbaa !16
  %29 = call i32 @HYPRE_SStructVectorInitialize(%struct.hypre_SStructVector_struct* %28)
  %30 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %28, i64 0, i32 4
  %31 = load i32, i32* %30, align 4, !tbaa !14
  %32 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %28, i64 0, i32 5
...
36:                                               ; preds = %34, %61
  %37 = phi i64 [ 0, %34 ], [ %62, %61 ]
  %38 = load %struct.hypre_SStructPVector**, %struct.hypre_SStructPVector*** %32, align 8, !tbaa !22
  %39 = getelementptr inbounds %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %38, i64 %37
  %40 = load %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %39, align 8, !tbaa !16
  %41 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %40, i64 0, i32 2
  %42 = load i32, i32* %41, align 8, !tbaa !34
  %43 = icmp sgt i32 %42, 0
  br i1 %43, label %44, label %61

44:                                               ; preds = %36, %44
  %45 = phi i32 [ %59, %44 ], [ 0, %36 ]
  %46 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* nonnull %19, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5, i64 0, i64 0), i32* nonnull %7, i32* nonnull %8) #6
  %47 = load %struct.hypre_SStructPVector**, %struct.hypre_SStructPVector*** %32, align 8, !tbaa !22
  %48 = load i32, i32* %7, align 4, !tbaa !26
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %47, i64 %49
  %51 = load %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %50, align 8, !tbaa !16
  %52 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %51, i64 0, i32 3
  %53 = load %struct.hypre_StructVector_struct**, %struct.hypre_StructVector_struct*** %52, align 8, !tbaa !37
  %54 = load i32, i32* %8, align 4, !tbaa !26
  %55 = sext i32 %54 to i64
  %56 = getelementptr inbounds %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %53, i64 %55
  %57 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %56, align 8, !tbaa !16
  %58 = call i32 @hypre_StructVectorReadData(%struct._IO_FILE* nonnull %19, %struct.hypre_StructVector_struct* %57) #6
  %59 = add nuw nsw i32 %45, 1
  %60 = icmp eq i32 %59, %42
  br i1 %60, label %61, label %44, !llvm.loop !83

61:                                               ; preds = %44, %36
  %62 = add nuw nsw i64 %37, 1
  %63 = icmp eq i64 %62, %35
  br i1 %63, label %64, label %36, !llvm.loop !84

64:                                               ; preds = %61, %23
  %65 = call i32 @fclose(%struct._IO_FILE* nonnull %19)
  %66 = call i32 @HYPRE_SStructVectorAssemble(%struct.hypre_SStructVector_struct* %28)
  %67 = load %struct.hypre_SStructGrid_struct*, %struct.hypre_SStructGrid_struct** %5, align 8, !tbaa !16
  %68 = call i32 @HYPRE_SStructGridDestroy(%struct.hypre_SStructGrid_struct* %67) #6
  store %struct.hypre_SStructVector_struct* %28, %struct.hypre_SStructVector_struct** %2, align 8, !tbaa !16
  br label %69

69:                                               ; preds = %64, %21
  %70 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
...
declare dso_local i32 @hypre_StructVectorReadData(%struct._IO_FILE*, %struct.hypre_StructVector_struct*) local_unnamed_addr #2
...
define dso_local i32 @HYPRE_SStructVectorCopy(%struct.hypre_SStructVector_struct* %0, %struct.hypre_SStructVector_struct* %1) local_unnamed_addr #0 {
  %3 = call i32 @hypre_SStructCopy(%struct.hypre_SStructVector_struct* %0, %struct.hypre_SStructVector_struct* %1) #6
  %4 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %4
}
...
define dso_local i32 @HYPRE_SStructVectorScale(double %0, %struct.hypre_SStructVector_struct* %1) local_unnamed_addr #0 {
  %3 = call i32 @hypre_SStructScale(double %0, %struct.hypre_SStructVector_struct* %1) #6
  %4 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %4
}
...
define dso_local i32 @HYPRE_SStructInnerProd(%struct.hypre_SStructVector_struct* %0, %struct.hypre_SStructVector_struct* %1, double* %2) local_unnamed_addr #0 {
  %4 = call i32 @hypre_SStructInnerProd(%struct.hypre_SStructVector_struct* %0, %struct.hypre_SStructVector_struct* %1, double* %2) #6
...
define dso_local i32 @HYPRE_SStructAxpy(double %0, %struct.hypre_SStructVector_struct* %1, %struct.hypre_SStructVector_struct* %2) local_unnamed_addr #0 {
  %4 = call i32 @hypre_SStructAxpy(double %0, %struct.hypre_SStructVector_struct* %1, %struct.hypre_SStructVector_struct* %2) #6
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %5
}
...
!45 = !{!10, !5, i64 144}
!46 = !{!47, !8, i64 16}
!47 = !{!"hypre_IJVector_struct", !5, i64 0, !6, i64 4, !5, i64 12, !8, i64 16, !8, i64 24, !8, i64 32, !5, i64 40, !5, i64 44, !5, i64 48}
!48 = !{!49, !8, i64 32}
!49 = !{!"hypre_ParVector_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 24, !8, i64 32, !5, i64 40, !8, i64 48}
!50 = !{!51, !8, i64 0}

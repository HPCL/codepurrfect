...
define dso_local i32 @hypre_ParCSRMatrix_dof_func_offd(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32* nocapture readonly %2, i32** nocapture %3) local_unnamed_addr #0 {
  ...
  %6 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %5, align 8, !tbaa !7
...
14:                                               ; preds = %4
  ...
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 4, i32 0) #3
  %17 = bitcast i32** %3 to i8**
  store i8* %16, i8** %17, align 8, !tbaa !3
  br label %18

18:                                               ; preds = %14, %4
  %19 = icmp eq %struct._hypre_ParCSRCommPkg* %6, null
  br i1 %19, label %20, label %23

20:                                               ; preds = %18
  %21 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) #3
  %22 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %5, align 8, !tbaa !7
  br label %23

23:                                               ; preds = %20, %18
  %24 = phi %struct._hypre_ParCSRCommPkg* [ %6, %18 ], [ %22, %20 ]
  %25 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %24, i64 0, i32 1
  %26 = load i32, i32* %25, align 4, !tbaa !14
  br i1 %12, label %27, label %78

27:                                               ; preds = %23
  %28 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %24, i64 0, i32 3
  %29 = load i32*, i32** %28, align 8, !tbaa !16
  %30 = sext i32 %26 to i64
  %31 = getelementptr inbounds i32, i32* %29, i64 %30
  %32 = load i32, i32* %31, align 4, !tbaa !17
  %33 = sext i32 %32 to i64
  %34 = call i8* @hypre_CAlloc(i64 %33, i64 4, i32 0) #3
  %35 = bitcast i8* %34 to i32*
  %36 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %24, i64 0, i32 4
...
73:                                               ; preds = %43, %27
  ...
  %76 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %24, i8* %34, i8* %75) #3
...
define dso_local void @hypre_BoomerAMGJacobiInterp_1(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct** nocapture %1, %struct.hypre_ParCSRMatrix_struct* nocapture readnone %2, i32* nocapture readonly %3, i32 %4, double %5, double %6, i32* %7, i32* %8, double %9) local_unnamed_addr #0 {
  ...
  %14 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %13, i64 0, i32 8
  ...
  %19 = call i8* @hypre_CAlloc(i64 %18, i64 4, i32 0) #3
...
37:                                               ; preds = %30, %10
  ...
  %42 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %39) #3
  %43 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %1, align 8, !tbaa !3
  %44 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %43) #3
  call void @hypre_BoomerAMGTruncateInterp(%struct.hypre_ParCSRMatrix_struct* %41, double %5, double %6, i32* %3)
  %45 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %41) #3
  store %struct.hypre_ParCSRMatrix_struct* %41, %struct.hypre_ParCSRMatrix_struct** %1, align 8, !tbaa !3
  call void @hypre_Free(i8* %19, i32 0) #3
...
define dso_local void @hypre_BoomerAMGTruncateInterp(%struct.hypre_ParCSRMatrix_struct* %0, double %1, double %2, i32* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %7 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 9
  %8 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %7, align 8, !tbaa !11
  %9 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %6, i64 0, i32 9
  ...
  %21 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %6, i64 0, i32 3
  %22 = load i32, i32* %21, align 8, !tbaa !24
  %23 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %8, i64 0, i32 3
  %24 = load i32, i32* %23, align 8, !tbaa !24
  %25 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %6, i64 0, i32 5
  %26 = load i32, i32* %25, align 8, !tbaa !30
  %27 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %8, i64 0, i32 5
...
32:                                               ; preds = %72, %61
  ...
  br i1 %35, label %84, label %36, !llvm.loop !31
...
49:                                               ; preds = %46, %49
  ...
  %54 = load double, double* %53, align 8, !tbaa !32
  ...
  br i1 %60, label %61, label %49, !llvm.loop !33
...
72:                                               ; preds = %69, %72
  ...
  br i1 %83, label %32, label %72, !llvm.loop !34
...
84:                                               ; preds = %32, %4
  ...
  %102 = call i8* @hypre_CAlloc(i64 %101, i64 4, i32 0) #3
...
134:                                              ; preds = %132, %163
  ...
  %141 = load double, double* %140, align 8, !tbaa !32
...
153:                                              ; preds = %149, %145, %134
  ...
  store double %141, double* %159, align 8, !tbaa !32
...
163:                                              ; preds = %153, %161
  ...
  br i1 %170, label %134, label %171, !llvm.loop !35
...
184:                                              ; preds = %182, %213
  ...
  %191 = load double, double* %190, align 8, !tbaa !32
...
203:                                              ; preds = %199, %195, %184
  ...
  store double %191, double* %209, align 8, !tbaa !32
...
213:                                              ; preds = %203, %211
  ...
  br i1 %220, label %184, label %221, !llvm.loop !36
...
241:                                              ; preds = %238, %241
  ...
  store double %245, double* %243, align 8, !tbaa !32
  %246 = add nsw i64 %242, 1
  %247 = icmp eq i64 %246, %240
  br i1 %247, label %248, label %241, !llvm.loop !37
...
258:                                              ; preds = %255, %258
  ...
  store double %262, double* %260, align 8, !tbaa !32
  %263 = add nsw i64 %259, 1
  %264 = icmp eq i64 %263, %257
  br i1 %264, label %265, label %258, !llvm.loop !38

265:                                              ; preds = %258, %249, %248
  %266 = icmp eq i64 %127, %109
  br i1 %266, label %110, label %119, !llvm.loop !39
...
278:                                              ; preds = %267, %274
  ...
  br i1 %280, label %281, label %267, !llvm.loop !40

281:                                              ; preds = %278, %110
  call void @hypre_Free(i8* %98, i32 0) #3
...
284:                                              ; preds = %283, %281
  store i32 %111, i32* %25, align 8, !tbaa !30
  store i32 %112, i32* %27, align 8, !tbaa !30
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !4, i64 96}
!8 = !{!"hypre_ParCSRMatrix_struct", !9, i64 0, !9, i64 4, !9, i64 8, !9, i64 12, !9, i64 16, !9, i64 20, !9, i64 24, !9, i64 28, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !4, i64 72, !5, i64 80, !5, i64 88, !4, i64 96, !4, i64 104, !9, i64 112, !9, i64 116, !10, i64 120, !4, i64 128, !4, i64 136, !9, i64 144, !4, i64 152, !9, i64 160, !4, i64 168, !9, i64 176, !4, i64 184, !4, i64 192}
!9 = !{!"int", !5, i64 0}
!10 = !{!"double", !5, i64 0}
!11 = !{!8, !4, i64 40}
!12 = !{!13, !9, i64 28}
!13 = !{!"", !4, i64 0, !4, i64 8, !4, i64 16, !9, i64 24, !9, i64 28, !9, i64 32, !4, i64 40, !4, i64 48, !9, i64 56, !4, i64 64, !4, i64 72, !9, i64 80, !5, i64 84}
!14 = !{!15, !9, i64 4}
!15 = !{!"_hypre_ParCSRCommPkg", !9, i64 0, !9, i64 4, !4, i64 8, !4, i64 16, !4, i64 24, !4, i64 32, !9, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !4, i64 72}
!16 = !{!15, !4, i64 16}
!17 = !{!9, !9, i64 0}

...
148:                                              ; preds = %143, %141
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 176, i32 1, i8* null) #4
  br label %323
...
297:                                              ; preds = %292
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 332, i32 256, i8* null) #4
  br label %298
...
102:                                              ; preds = %3, %381
  %103 = phi i32 [ undef, %3 ], [ %389, %381 ]
  %104 = phi double [ undef, %3 ], [ %388, %381 ]
  %105 = phi i32 [ 0, %3 ], [ %387, %381 ]
  %106 = phi double [ undef, %3 ], [ %386, %381 ]
  %107 = phi i32 [ 0, %3 ], [ %385, %381 ]
  %108 = phi i32 [ 0, %3 ], [ %384, %381 ]
  %109 = phi i32 [ 1, %3 ], [ %382, %381 ]
  switch i32 %109, label %367 [
    i32 3, label %110
    i32 1, label %141
  ]
...
175:                                              ; preds = %163, %172
  ...
  br i1 %180, label %333, label %163, !llvm.loop !69
...
199:                                              ; preds = %187, %196
  ...
  br i1 %204, label %333, label %187, !llvm.loop !70
...
205:                                              ; preds = %158, %205
  ...
  br i1 %215, label %333, label %205, !llvm.loop !71
...
291:                                              ; preds = %141
  ...
  %301 = sext i32 %142 to i64
  %302 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %62, i64 %301
  %303 = call i32 @hypre_MGRAddVectorR(%struct.hypre_IntArray* %300, i32 -1, double 1.000000e+00, %struct.hypre_ParVector_struct* %53, double 0.000000e+00, %struct.hypre_ParVector_struct** %302) #4
  %304 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %59, i64 %301
  %305 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %304, align 8, !tbaa !36
  %306 = call i32 @hypre_ParVectorSetConstantValues(%struct.hypre_ParVector_struct* %305, double 0.000000e+00) #4
  %307 = load %struct.hypre_Solver_struct***, %struct.hypre_Solver_struct**** %87, align 8, !tbaa !73
  %308 = getelementptr inbounds %struct.hypre_Solver_struct**, %struct.hypre_Solver_struct*** %307, i64 %143
  %309 = bitcast %struct.hypre_Solver_struct*** %308 to i8**
  %310 = load i8*, i8** %309, align 8, !tbaa !36
  %311 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %68, i64 %143
  %312 = bitcast %struct.hypre_ParCSRMatrix_struct** %311 to i8**
  %313 = load i8*, i8** %312, align 8, !tbaa !36
  %314 = bitcast %struct.hypre_ParVector_struct** %302 to i8**
  %315 = load i8*, i8** %314, align 8, !tbaa !36
  %316 = bitcast %struct.hypre_ParVector_struct** %304 to i8**
  %317 = load i8*, i8** %316, align 8, !tbaa !36
  %318 = call i32 %65(i8* %310, i8* %313, i8* %315, i8* %317) #4
  %319 = load %struct.hypre_IntArray*, %struct.hypre_IntArray** %299, align 8, !tbaa !36
  %320 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %304, align 8, !tbaa !36
  %321 = call i32 @hypre_MGRAddVectorP(%struct.hypre_IntArray* %319, i32 -1, double 1.000000e+00, %struct.hypre_ParVector_struct* %320, double 1.000000e+00, %struct.hypre_ParVector_struct** nonnull %294) #4
  br label %333

322:                                              ; preds = %146, %322
  %323 = phi i32 [ %331, %322 ], [ 0, %146 ]
  %324 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %147, align 8, !tbaa !36
  %325 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %148, align 8, !tbaa !36
  %326 = load %struct.hypre_IntArray*, %struct.hypre_IntArray** %149, align 8, !tbaa !36
  %327 = getelementptr inbounds %struct.hypre_IntArray, %struct.hypre_IntArray* %326, i64 0, i32 0
  %328 = load i32*, i32** %327, align 8, !tbaa !65
  %329 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %150, align 8, !tbaa !36
  %330 = call i32 @hypre_BoomerAMGRelax(%struct.hypre_ParCSRMatrix_struct* %324, %struct.hypre_ParVector_struct* %325, i32* %328, i32 %41, i32 -1, double %44, double %47, double* null, %struct.hypre_ParVector_struct* %329, %struct.hypre_ParVector_struct* %53, %struct.hypre_ParVector_struct* %56) #4
  %331 = add nuw nsw i32 %323, 1
  %332 = icmp eq i32 %331, %38
  br i1 %332, label %333, label %322, !llvm.loop !74

333:                                              ; preds = %199, %175, %205, %322, %181, %152, %158, %146, %286, %291
  %334 = phi double [ %287, %286 ], [ %106, %291 ], [ %106, %146 ], [ %106, %158 ], [ %106, %152 ], [ %106, %181 ], [ %106, %322 ], [ %106, %205 ], [ %106, %175 ], [ %106, %199 ]
  %335 = phi i32 [ %105, %286 ], [ %105, %291 ], [ %105, %146 ], [ %105, %158 ], [ %105, %152 ], [ %105, %181 ], [ %330, %322 ], [ %213, %205 ], [ %105, %175 ], [ %105, %199 ]
  %336 = phi double [ %288, %286 ], [ %104, %291 ], [ %104, %146 ], [ %104, %158 ], [ %104, %152 ], [ %104, %181 ], [ %104, %322 ], [ %104, %205 ], [ %104, %175 ], [ %104, %199 ]
  %337 = phi i32 [ %289, %286 ], [ %103, %291 ], [ %103, %146 ], [ %103, %158 ], [ %103, %152 ], [ %103, %181 ], [ %103, %322 ], [ %103, %205 ], [ %103, %175 ], [ %103, %199 ]
  %338 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %14, i64 %143
  %339 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %338, align 8, !tbaa !36
  %340 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %2, i64 %143
  %341 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %340, align 8, !tbaa !36
  %342 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %1, i64 %143
  %343 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %342, align 8, !tbaa !36
  %344 = call i32 @hypre_ParCSRMatrixMatvecOutOfPlace(double -1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %339, %struct.hypre_ParVector_struct* %341, double 1.000000e+00, %struct.hypre_ParVector_struct* %343, %struct.hypre_ParVector_struct* %53) #4
  %345 = getelementptr inbounds i32, i32* %80, i64 %143
  %346 = load i32, i32* %345, align 4, !tbaa !33
  %347 = and i32 %346, -2
  %348 = icmp eq i32 %347, 4
  %349 = select i1 %348, i32 1, i32 %107
  %350 = icmp eq i32 %349, 0
  %351 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %17, i64 %143
  %352 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %351, align 8, !tbaa !36
  %353 = sext i32 %142 to i64
  %354 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %1, i64 %353
  %355 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %354, align 8, !tbaa !36
  br i1 %350, label %358, label %356

356:                                              ; preds = %333
  %357 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %352, %struct.hypre_ParVector_struct* %53, double 0.000000e+00, %struct.hypre_ParVector_struct* %355) #4
  br label %360

358:                                              ; preds = %333
  %359 = call i32 @hypre_ParCSRMatrixMatvecT(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %352, %struct.hypre_ParVector_struct* %53, double 0.000000e+00, %struct.hypre_ParVector_struct* %355) #4
  br label %360

360:                                              ; preds = %358, %356
  %361 = sext i32 %142 to i64
  %362 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %2, i64 %361
  %363 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %362, align 8, !tbaa !36
  %364 = call i32 @hypre_ParVectorSetConstantValues(%struct.hypre_ParVector_struct* %363, double 0.000000e+00) #4
  %365 = icmp eq i32 %142, %71
  %366 = select i1 %365, i32 3, i32 1
  br label %381

367:                                              ; preds = %102
  %368 = icmp eq i32 %108, 0
  br i1 %368, label %381, label %369

369:                                              ; preds = %367
  %370 = add nsw i32 %108, -1
  %371 = sext i32 %370 to i64
  %372 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %20, i64 %371
  %373 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %372, align 8, !tbaa !36
  %374 = sext i32 %108 to i64
  %375 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %2, i64 %374
  %376 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %375, align 8, !tbaa !36
  %377 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %2, i64 %371
  %378 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %377, align 8, !tbaa !36
  %379 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %373, %struct.hypre_ParVector_struct* %376, double 1.000000e+00, %struct.hypre_ParVector_struct* %378) #4
  %380 = icmp eq i32 %105, 0
  br i1 %380, label %381, label %390

381:                                              ; preds = %369, %360, %367, %130, %133
  %382 = phi i32 [ 2, %133 ], [ 2, %130 ], [ %366, %360 ], [ 2, %367 ], [ 2, %369 ]
  %383 = phi i1 [ false, %133 ], [ false, %130 ], [ false, %360 ], [ true, %367 ], [ false, %369 ]
  %384 = phi i32 [ %108, %133 ], [ %108, %130 ], [ %142, %360 ], [ 0, %367 ], [ %370, %369 ]
  %385 = phi i32 [ %107, %133 ], [ %107, %130 ], [ %349, %360 ], [ %107, %367 ], [ %107, %369 ]
  %386 = phi double [ %106, %133 ], [ %106, %130 ], [ %334, %360 ], [ %106, %367 ], [ %106, %369 ]
  %387 = phi i32 [ %105, %133 ], [ %105, %130 ], [ %335, %360 ], [ %105, %367 ], [ 0, %369 ]
  %388 = phi double [ %104, %133 ], [ %104, %130 ], [ %336, %360 ], [ %104, %367 ], [ %104, %369 ]
  %389 = phi i32 [ %103, %133 ], [ %103, %130 ], [ %337, %360 ], [ %103, %367 ], [ %103, %369 ]
  br i1 %383, label %390, label %102, !llvm.loop !75

390:                                              ; preds = %381, %369, %286
  %391 = phi i32 [ %289, %286 ], [ %105, %369 ], [ %387, %381 ]
...
define dso_local i32 @hypre_MGRFrelaxVcycle(i8* %0, %struct.hypre_ParVector_struct* %1, %struct.hypre_ParVector_struct* %2) local_unnamed_addr #0 {
  ...
  %23 = getelementptr inbounds i8, i8* %0, i64 752
  ...
  %26 = getelementptr inbounds i8, i8* %0, i64 800
...
declare dso_local i32 @hypre_MGRAddVectorR(%struct.hypre_IntArray*, i32, double, %struct.hypre_ParVector_struct*, double, %struct.hypre_ParVector_struct**) local_unnamed_addr #2

declare dso_local i32 @hypre_MGRAddVectorP(%struct.hypre_IntArray*, i32, double, %struct.hypre_ParVector_struct*, double, %struct.hypre_ParVector_struct**) local_unnamed_addr #2

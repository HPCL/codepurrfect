...
define dso_local void @StoredRowsDestroy(%struct.StoredRows* %0) local_unnamed_addr #0 {
  ...
  store i32** null, i32*** %7, align 8, !tbaa !16
  ...
  call void @hypre_Free(i8* %12, i32 0) #3
...
define dso_local i32* @StoredRowsAllocInd(%struct.StoredRows* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %5 = shl i32 %1, 2
  %6 = call i8* @MemAlloc(%struct.Mem* %4, i32 %5) #3
...
12:                                               ; preds = %5
  ...
  %18 = shl nsw i64 %17, 2
  %19 = call i8* @hypre_ReAlloc(i8* %16, i64 %18, i32 0) #3
  ...
  %23 = shl nsw i64 %17, 3
  %24 = call i8* @hypre_ReAlloc(i8* %22, i64 %23, i32 0) #3
  ...
  %28 = call i8* @hypre_ReAlloc(i8* %27, i64 %23, i32 0) #3
...
9:                                                ; preds = %5
  ...
  call void @MatrixGetRow(%struct.Matrix* %11, i32 %1, i32* %2, i32** %3, double** %4) #3
  br label %27

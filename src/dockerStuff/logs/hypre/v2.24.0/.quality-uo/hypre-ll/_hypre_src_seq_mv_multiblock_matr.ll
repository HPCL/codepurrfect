...
define dso_local %struct.hypre_MultiblockMatrix* @hypre_MultiblockMatrixCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 24, i32 0) #5
...
8:                                                ; preds = %3, %8
  ...
  call void @hypre_Free(i8* %12, i32 0) #5
...
19:                                               ; preds = %8, %3
  ...
  call void @hypre_Free(i8* %22, i32 0) #5
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %6, i32 0) #5

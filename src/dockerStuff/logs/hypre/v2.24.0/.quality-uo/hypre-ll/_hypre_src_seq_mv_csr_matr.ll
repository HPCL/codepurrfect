...
27:                                               ; preds = %25, %1
  %28 = load i32, i32* @hypre__global_error, align 4, !tbaa !21
  ret i32 %28
}
...
14:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 178, i32 1, i8* getelementptr inbounds ([75 x i8], [75 x i8]* @.str.1, i64 0, i64 0)) #9
  br label %73
...
define dso_local i32 @hypre_CSRMatrixSetRownnzHost(%struct.hypre_CSRMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %6 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 10
...
12:                                               ; preds = %10, %12
  ...
  %18 = getelementptr inbounds i32, i32* %5, i64 %13
  %19 = load i32, i32* %18, align 4, !tbaa !21
  %20 = icmp sgt i32 %17, %19
  %21 = zext i1 %20 to i32
  %22 = add nuw nsw i32 %14, %21
  %23 = icmp eq i64 %15, %11
  br i1 %23, label %24, label %12, !llvm.loop !23

24:                                               ; preds = %12, %1
  %25 = phi i32 [ 0, %1 ], [ %22, %12 ]
  %26 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 11
  store i32 %25, i32* %26, align 8, !tbaa !9
  call void @hypre_Free(i8* %8, i32 0) #9
  %27 = icmp eq i32 %25, 0
  %28 = icmp eq i32 %25, %3
...
31:                                               ; preds = %24
  ...
  %33 = call i8* @hypre_CAlloc(i64 %32, i64 4, i32 0) #9
...
38:                                               ; preds = %36, %52
  %39 = phi i64 [ 0, %36 ], [ %41, %52 ]
  %40 = phi i32 [ 0, %36 ], [ %53, %52 ]
  %41 = add nuw nsw i64 %39, 1
  %42 = getelementptr inbounds i32, i32* %5, i64 %41
  %43 = load i32, i32* %42, align 4, !tbaa !21
  %44 = getelementptr inbounds i32, i32* %5, i64 %39
...
52:                                               ; preds = %38, %47
  ...
  %54 = icmp eq i64 %41, %37
  br i1 %54, label %55, label %38, !llvm.loop !26

55:                                               ; preds = %52, %31
  store i8* %33, i8** %7, align 8, !tbaa !17
  br label %56

56:                                               ; preds = %55, %30
  %57 = load i32, i32* @hypre__global_error, align 4, !tbaa !21
  ret i32 %57
}
...
37:                                               ; preds = %51, %35
  %38 = phi i64 [ 0, %35 ], [ %40, %51 ]
  %39 = phi i32 [ 0, %35 ], [ %52, %51 ]
  %40 = add nuw nsw i64 %38, 1
  %41 = getelementptr inbounds i32, i32* %5, i64 %40
  %42 = load i32, i32* %41, align 4, !tbaa !21
  %43 = getelementptr inbounds i32, i32* %5, i64 %38
...
51:                                               ; preds = %46, %37
  %52 = phi i32 [ %47, %46 ], [ %39, %37 ]
  %53 = icmp eq i64 %40, %36
  br i1 %53, label %54, label %37, !llvm.loop !26
...
55:                                               ; preds = %30, %54
  %56 = load i32, i32* @hypre__global_error, align 4, !tbaa !21
  ret i32 %56
}
...
13:                                               ; preds = %1, %13
  ...
  %17 = load i32, i32* %15, align 4, !tbaa !21
  %18 = add nsw i32 %17, -1
  store i32 %18, i32* %15, align 4, !tbaa !21
...
87:                                               ; preds = %85, %87
  ...
  %93 = add nsw i32 %92, -1
  store i32 %93, i32* %90, align 4, !tbaa !21
...
100:                                              ; preds = %98, %82
  ...
  %103 = load i32, i32* %2, align 4, !tbaa !21
...
108:                                              ; preds = %100, %108
  ...
  %113 = load i32, i32* %2, align 4, !tbaa !21
...
119:                                              ; preds = %108, %100
  %120 = call i32 @fclose(%struct._IO_FILE* %4)
  store i32 %27, i32* %50, align 8, !tbaa !11
  %121 = getelementptr inbounds i8, i8* %28, i64 28
  %122 = bitcast i8* %121 to i32*
  store i32 %101, i32* %122, align 4, !tbaa !10
  %123 = load i32, i32* %47, align 8, !tbaa !3
  %124 = load i32*, i32** %65, align 8, !tbaa !16
  %125 = getelementptr inbounds i8, i8* %28, i64 72
...
132:                                              ; preds = %132, %130
  ...
  %138 = getelementptr inbounds i32, i32* %124, i64 %133
  %139 = load i32, i32* %138, align 4, !tbaa !21
  %140 = icmp sgt i32 %137, %139
  %141 = zext i1 %140 to i32
  %142 = add nuw nsw i32 %134, %141
  %143 = icmp eq i64 %135, %131
  br i1 %143, label %144, label %132, !llvm.loop !23

144:                                              ; preds = %132, %119
  %145 = phi i32 [ 0, %119 ], [ %142, %132 ]
  %146 = getelementptr inbounds i8, i8* %28, i64 80
  %147 = bitcast i8* %146 to i32*
  store i32 %145, i32* %147, align 8, !tbaa !9
  call void @hypre_Free(i8* %128, i32 0) #9
  %148 = icmp eq i32 %145, 0
  %149 = icmp eq i32 %145, %123
  %150 = select i1 %148, i1 true, i1 %149
  br i1 %150, label %151, label %152

151:                                              ; preds = %144
  store i32* null, i32** %126, align 8, !tbaa !17
  br label %176

152:                                              ; preds = %144
  %153 = zext i32 %145 to i64
  %154 = call i8* @hypre_CAlloc(i64 %153, i64 4, i32 0) #9
  %155 = bitcast i8* %154 to i32*
  br i1 %129, label %156, label %175
...
158:                                              ; preds = %172, %156
  %159 = phi i64 [ 0, %156 ], [ %161, %172 ]
  %160 = phi i32 [ 0, %156 ], [ %173, %172 ]
  %161 = add nuw nsw i64 %159, 1
  %162 = getelementptr inbounds i32, i32* %124, i64 %161
  %163 = load i32, i32* %162, align 4, !tbaa !21
  %164 = getelementptr inbounds i32, i32* %124, i64 %159
...
172:                                              ; preds = %167, %158
  %173 = phi i32 [ %168, %167 ], [ %160, %158 ]
  %174 = icmp eq i64 %161, %157
  br i1 %174, label %175, label %158, !llvm.loop !26

175:                                              ; preds = %172, %152
  store i8* %154, i8** %127, align 8, !tbaa !17
  br label %176

176:                                              ; preds = %151, %175
  %177 = bitcast i8* %28 to %struct.hypre_CSRMatrix*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #9
  ret %struct.hypre_CSRMatrix* %177
}
...
30:                                               ; preds = %17, %30
  ...
  %37 = load i32, i32* %19, align 4, !tbaa !21
...
44:                                               ; preds = %40
  %45 = load i32, i32* %42, align 4, !tbaa !21
...
47:                                               ; preds = %44, %47
  ...
  %53 = load i32, i32* %42, align 4, !tbaa !21
...
19:                                               ; preds = %5
  %20 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !22
  br label %21
...
62:                                               ; preds = %58, %60
  %63 = add nsw i64 %52, 1
  %64 = load i32, i32* %42, align 4, !tbaa !21
...
define dso_local i32 @hypre_CSRMatrixPrintHB(%struct.hypre_CSRMatrix* %0, i8* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %6 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %3, align 8, !tbaa !22
...
29:                                               ; preds = %32, %2
  %30 = load i32, i32* %18, align 4, !tbaa !21
...
40:                                               ; preds = %29, %40
  ...
  %47 = load i32, i32* %18, align 4, !tbaa !21
...
52:                                               ; preds = %50
  %53 = load i32, i32* %18, align 4, !tbaa !21
...
55:                                               ; preds = %52, %55
  ...
  %61 = load i32, i32* %18, align 4, !tbaa !21
...
66:                                               ; preds = %55, %52, %64
  ...
  %68 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %3, align 8, !tbaa !22
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_CSRMatrixCopy(%struct.hypre_CSRMatrix* nocapture readonly %0, %struct.hypre_CSRMatrix* nocapture %1, i32 %2) local_unnamed_addr #0 {
  %4 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 3
  %5 = load i32, i32* %4, align 8, !tbaa !3
  %6 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 5
  %7 = load i32, i32* %6, align 8, !tbaa !11
  ...
  %14 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 10
  %15 = load i32*, i32** %14, align 8, !tbaa !17
  %16 = bitcast %struct.hypre_CSRMatrix* %1 to i8**
  ...
  %20 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1, i64 0, i32 2
  %21 = load i32*, i32** %20, align 8, !tbaa !20
  %22 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1, i64 0, i32 10
  ...
  %30 = shl nsw i64 %29, 2
  call void @hypre_Memcpy(i8* %17, i8* %9, i64 %30, i32 %27, i32 %25) #9
  %31 = icmp eq i32* %15, null
  br i1 %31, label %50, label %32

32:                                               ; preds = %3
  %33 = icmp eq i32* %23, null
  br i1 %33, label %34, label %42

34:                                               ; preds = %32
  %35 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 11
  %36 = load i32, i32* %35, align 8, !tbaa !9
  %37 = sext i32 %36 to i64
  %38 = shl nsw i64 %37, 2
  %39 = call i8* @hypre_MAlloc(i64 %38, i32 0) #9
...
42:                                               ; preds = %34, %32
  %43 = phi i32* [ %23, %32 ], [ %40, %34 ]
  %44 = bitcast i32* %43 to i8*
  %45 = bitcast i32* %15 to i8*
  %46 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 11
  %47 = load i32, i32* %46, align 8, !tbaa !9
  %48 = sext i32 %47 to i64
  %49 = shl nsw i64 %48, 2
  call void @hypre_Memcpy(i8* %44, i8* nonnull %45, i64 %49, i32 0, i32 0) #9
  br label %50

50:                                               ; preds = %42, %3
  %51 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 11
  %52 = load i32, i32* %51, align 8, !tbaa !9
  %53 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1, i64 0, i32 11
  store i32 %52, i32* %53, align 8, !tbaa !9
  %54 = icmp ne i32* %11, null
  %55 = icmp ne i32* %19, null
...
57:                                               ; preds = %50
  ...
  %61 = shl nsw i64 %60, 2
  call void @hypre_Memcpy(i8* nonnull %58, i8* nonnull %59, i64 %61, i32 %27, i32 %25) #9
  br label %62

62:                                               ; preds = %57, %50
  %63 = icmp ne i32* %13, null
  %64 = icmp ne i32* %21, null
...
66:                                               ; preds = %62
  ...
  %70 = shl nsw i64 %69, 2
  call void @hypre_Memcpy(i8* nonnull %67, i8* nonnull %68, i64 %70, i32 %27, i32 %25) #9
  br label %71
...
73:                                               ; preds = %71
  %74 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 9
  %75 = bitcast double** %74 to i8**
  %76 = load i8*, i8** %75, align 8, !tbaa !18
  %77 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1, i64 0, i32 9
  %78 = bitcast double** %77 to i8**
  %79 = load i8*, i8** %78, align 8, !tbaa !18
  %80 = sext i32 %7 to i64
  %81 = shl nsw i64 %80, 3
  call void @hypre_Memcpy(i8* %79, i8* %76, i64 %81, i32 %27, i32 %25) #9
  br label %82

82:                                               ; preds = %73, %71
  %83 = load i32, i32* @hypre__global_error, align 4, !tbaa !21
  ret i32 %83
}
...
52:                                               ; preds = %49
  ...
  store i32 %37, i32* %53, align 4, !tbaa !21
  %54 = add nsw i32 %37, 1
  br label %55
...
67:                                               ; preds = %62
  %68 = load i32*, i32** %4, align 8, !tbaa !22
...
245:                                              ; preds = %235, %241
  ...
  store i32 0, i32* %246, align 4, !tbaa !21
...
267:                                              ; preds = %263, %267
  ...
  store i32 %271, i32* %272, align 4, !tbaa !21
...
331:                                              ; preds = %327
  %332 = load i32, i32* %294, align 4, !tbaa !21
...
337:                                              ; preds = %331, %333
  ...
  store i32 %338, i32* %340, align 4, !tbaa !21
...
342:                                              ; preds = %327, %337
  ...
  %345 = load i32, i32* %282, align 4, !tbaa !21
...
348:                                              ; preds = %342, %278
  ...
  store i32 %351, i32* %352, align 4, !tbaa !21

...
57:                                               ; preds = %48, %35
  ...
  call void @hypre_Free(i8* %69, i32 0) #8
...
125:                                              ; preds = %123
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %149, i8* nonnull align 16 %40, i64 %133, i1 false) #8
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %153, i8* nonnull align 16 %41, i64 %140, i1 false) #8
...
179:                                              ; preds = %117, %170, %105
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %205, i8* nonnull align 16 %40, i64 %189, i1 false) #8
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %209, i8* nonnull align 16 %41, i64 %196, i1 false) #8
...
246:                                              ; preds = %244
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %270, i8* nonnull align 16 %219, i64 %254, i1 false) #8
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %274, i8* nonnull align 16 %220, i64 %261, i1 false) #8
...
300:                                              ; preds = %238, %291, %212
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %326, i8* nonnull align 16 %219, i64 %310, i1 false) #8
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %330, i8* nonnull align 16 %220, i64 %317, i1 false) #8
...
237:                                              ; preds = %231, %189
  ...
  call void @hypre_Free(i8* %153, i32 0) #8
...
254:                                              ; preds = %244, %237
  ...
  call void @hypre_Free(i8* %47, i32 0) #8
...
61:                                               ; preds = %48, %61
  ...
  %64 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %34, i8* %52, double* %63) #8
...
109:                                              ; preds = %100, %53
  ...
  call void @hypre_Free(i8* %111, i32 0) #8
  br label %112

; ModuleID = '/hypre/src/struct_ls/smg_setup_restrict.c'
source_filename = "/hypre/src/struct_ls/smg_setup_restrict.c"
...
define dso_local noalias %struct.hypre_StructMatrix_struct* @hypre_SMGCreateRestrictOp(%struct.hypre_StructMatrix_struct* nocapture readnone %0, %struct.hypre_StructGrid_struct* nocapture readnone %1, i32 %2) local_unnamed_addr #0 {
  ret %struct.hypre_StructMatrix_struct* null
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local i32 @hypre_SMGSetupRestrictOp(%struct.hypre_StructMatrix_struct* nocapture readnone %0, %struct.hypre_StructMatrix_struct* nocapture readnone %1, %struct.hypre_StructVector_struct* nocapture readnone %2, i32 %3, i32* nocapture readnone %4, i32* nocapture readnone %5) local_unnamed_addr #1 {

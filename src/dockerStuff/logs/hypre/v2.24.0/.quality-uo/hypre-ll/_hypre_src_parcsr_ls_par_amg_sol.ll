...
24:                                               ; preds = %20, %4
  ...
  %59 = getelementptr inbounds i8, i8* %0, i64 504
  %60 = bitcast i8* %59 to i32*
  %61 = load i32, i32* %60, align 8, !tbaa !26
  %62 = getelementptr inbounds i8, i8* %0, i64 480
  ...
  %65 = getelementptr inbounds i8, i8* %0, i64 752
...
117:                                              ; preds = %112, %110
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 201, i32 1, i8* null) #4
  br label %338
...
139:                                              ; preds = %134, %126
  %140 = getelementptr inbounds i8, i8* %0, i64 776
  ...
  %153 = getelementptr inbounds i8, i8* %0, i64 832
  %154 = bitcast i8* %153 to double*
  %155 = getelementptr inbounds i8, i8* %0, i64 820
  %156 = bitcast i8* %155 to i32*
  %157 = getelementptr inbounds i8, i8* %0, i64 824
...
223:                                              ; preds = %218
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 325, i32 256, i8* null) #4
  br label %224
...
235:                                              ; preds = %233
  ...
  %239 = call i8* @hypre_CAlloc(i64 %236, i64 8, i32 0) #4
  %240 = bitcast i8* %239 to double*
  %241 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 20
...
254:                                              ; preds = %249, %254
  ...
  %258 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %257, i64 0, i32 15
...
268:                                              ; preds = %254, %248
  ...
  %270 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %269, i64 0, i32 16
...
275:                                              ; preds = %252, %275
  ...
  %279 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %278, i64 0, i32 19
...
315:                                              ; preds = %306
  %316 = getelementptr inbounds i8, i8* %0, i64 776
...
337:                                              ; preds = %332, %321
  call void @hypre_Free(i8* %237, i32 0) #4
  call void @hypre_Free(i8* %239, i32 0) #4
  br label %338
...
!39 = !{!4, !5, i64 4}
!40 = !{!41, !5, i64 92}
!41 = !{!"", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !6, i64 56, !6, i64 64, !8, i64 72, !8, i64 80, !5, i64 88, !5, i64 92, !9, i64 96, !8, i64 104, !8, i64 112, !5, i64 120, !8, i64 128}
!42 = !{!41, !5, i64 4}

...
37:                                               ; preds = %5
  ...
  call void @hypre_memcpy_idx(i32* %35, i32* nonnull %31, i64 %39) #4
  br label %40
...
143:                                              ; preds = %138
  ...
  %155 = call i32 @hypre_MPI_Irecv(i8* %150, i32 %141, i32 1275070475, i32 %152, i32 %131, i32 %153, i32* %154) #4
...
200:                                              ; preds = %197, %189, %177
  ...
  %206 = call i32 @hypre_MPI_Send(i8* %115, i32 %201, i32 1275070475, i32 %204, i32 %131, i32 %205) #4
...
214:                                              ; preds = %209
  ...
  %216 = call i32 @hypre_MPI_Wait(i32* %215, %struct.MPI_Status* nonnull %6) #4
  br label %217
...
265:                                              ; preds = %126, %106
  ...
  call void @hypre_memcpy_idx(i32* %275, i32* %271, i64 %277) #4
...
377:                                              ; preds = %372
  ...
  %389 = call i32 @hypre_MPI_Irecv(i8* %384, i32 %375, i32 1275070475, i32 %386, i32 %366, i32 %387, i32* %388) #4
...
434:                                              ; preds = %431, %423, %411
  ...
  %440 = call i32 @hypre_MPI_Send(i8* %301, i32 %435, i32 1275070475, i32 %438, i32 %366, i32 %439) #4
...
448:                                              ; preds = %443
  ...
  %450 = call i32 @hypre_MPI_Wait(i32* %449, %struct.MPI_Status* nonnull %6) #4
  br label %451
...
509:                                              ; preds = %499, %459
  call void @hypre_Free(i8* %110, i32 0) #4
...
define dso_local i32 @hypre_SetUpLUFactor(%struct.distdef* nocapture readonly %0, %struct.factormatdef* %1, i32 %2, %struct.hypre_PilutSolverGlobals* %3) local_unnamed_addr #0 {
  ...
  %9 = add nsw i32 %8, 1
  %10 = call i32* @hypre_idx_malloc(i32 %9, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0)) #4
  %11 = getelementptr inbounds %struct.distdef, %struct.distdef* %0, i64 0, i32 0
  %12 = load i32, i32* %11, align 8, !tbaa !73
  %13 = call i32* @hypre_idx_malloc(i32 %12, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i64 0, i64 0)) #4
  %14 = load i32, i32* %11, align 8, !tbaa !73
  %15 = call i32* @hypre_idx_malloc_init(i32 %14, i32 -1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2, i64 0, i64 0)) #4
  ...
  %17 = call double* @hypre_fp_malloc(i32 %16, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.3, i64 0, i64 0)) #4
  ...
  call void @hypre_Free(i8* %19, i32 0) #4
...
106:                                              ; preds = %100, %9
  ...
  call void @hypre_sincsort_fast(i32 %107, i32* %4) #4
  ...
  %112 = call i32 @hypre_GlobalSEMax(i32 %109, i32 %111) #4
...
113:                                              ; preds = %106
  ...
  %115 = call double* @hypre_fp_malloc_init(i32 %112, double 0.000000e+00, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.4, i64 0, i64 0)) #4
...
117:                                              ; preds = %106
  ...
  %119 = call double* @hypre_fp_malloc_init(i32 %112, double 0.000000e+00, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.5, i64 0, i64 0)) #4
...
171:                                              ; preds = %161, %137
  ...
  %175 = getelementptr inbounds %struct.hypre_PilutSolverGlobals, %struct.hypre_PilutSolverGlobals* %8, i64 0, i32 26
  ...
  %179 = call i32 @hypre_MPI_Alltoall(i8* %174, i32 1, i32 1275069445, i8* nonnull %176, i32 1, i32 1275069445, i32 %178) #4
...
182:                                              ; preds = %171, %195
  ...
  %186 = getelementptr inbounds %struct.hypre_PilutSolverGlobals, %struct.hypre_PilutSolverGlobals* %8, i64 0, i32 26, i64 %183
  %187 = load i32, i32* %186, align 4, !tbaa !33
...
202:                                              ; preds = %195, %171
  ...
  %207 = call i32* @hypre_idx_malloc(i32 %206, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.6, i64 0, i64 0)) #4
  %208 = getelementptr inbounds %struct.cphasedef, %struct.cphasedef* %55, i64 0, i32 4
  store i32* %207, i32** %208, align 8, !tbaa !88
  %209 = call i32* @hypre_idx_malloc(i32 %203, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.7, i64 0, i64 0)) #4
  %210 = getelementptr inbounds %struct.cphasedef, %struct.cphasedef* %55, i64 0, i32 1
  store i32* %209, i32** %210, align 8, !tbaa !89
  %211 = call i32* @hypre_idx_malloc(i32 %206, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.8, i64 0, i64 0)) #4
  ...
  %214 = call i32 @hypre_GlobalSEMax(i32 %204, i32 %213) #4
  %215 = call i32* @hypre_idx_malloc(i32 %214, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.9, i64 0, i64 0)) #4
  %216 = getelementptr inbounds %struct.cphasedef, %struct.cphasedef* %55, i64 0, i32 3
  store i32* %215, i32** %216, align 8, !tbaa !91
  %217 = call i32* @hypre_idx_malloc(i32 %172, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.10, i64 0, i64 0)) #4
  %218 = getelementptr inbounds %struct.cphasedef, %struct.cphasedef* %55, i64 0, i32 6
  store i32* %217, i32** %218, align 8, !tbaa !92
  %219 = call i32* @hypre_idx_malloc(i32 %172, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.10, i64 0, i64 0)) #4
  %220 = getelementptr inbounds %struct.cphasedef, %struct.cphasedef* %55, i64 0, i32 5
  store i32* %219, i32** %220, align 8, !tbaa !93
  %221 = shl i32 %172, 3
  %222 = add i32 %221, 8
  %223 = call i8* @hypre_mymalloc(i32 %222, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.11, i64 0, i64 0)) #4
...
234:                                              ; preds = %202, %247
  ...
  %237 = getelementptr inbounds %struct.hypre_PilutSolverGlobals, %struct.hypre_PilutSolverGlobals* %8, i64 0, i32 26, i64 %235
...
286:                                              ; preds = %281, %286
  ...
  %301 = call i32 @hypre_MPI_Irecv(i8* %292, i32 %296, i32 1275069445, i32 %298, i32 10, i32 %299, i32* %300) #4
...
310:                                              ; preds = %303
  ...
  %316 = call i32 @hypre_MPI_Send(i8* %313, i32 %308, i32 1275069445, i32 %315, i32 10, i32 %314) #4
...
352:                                              ; preds = %346, %352
  ...
  %355 = call i32 @hypre_MPI_Wait(i32* %354, %struct.MPI_Status* nonnull %10) #4
...
358:                                              ; preds = %350, %358
  ...
  call void @hypre_CheckBounds(i32 %360, i32 %362, i32 %363, %struct.hypre_PilutSolverGlobals* %8) #4
...
380:                                              ; preds = %375, %380
  ...
  call void @hypre_sincsort_fast(i32 %387, i32* %389) #4
...
391:                                              ; preds = %378, %391
  ...
  call void @hypre_sdecsort_fast(i32 %398, i32* %400) #4
...
409:                                              ; preds = %404, %409
  ...
  call void @hypre_CheckBounds(i32 0, i32 %412, i32 %413, %struct.hypre_PilutSolverGlobals* %8) #4
...
432:                                              ; preds = %426
  ...
  %439 = call i32 @hypre_MPI_Irecv(i8* %435, i32 %430, i32 1275069445, i32 %438, i32 11, i32 %436, i32* %437) #4
...
451:                                              ; preds = %424, %451
  ...
  %465 = call i32 @hypre_MPI_Send(i8* %457, i32 %461, i32 1275069445, i32 %463, i32 11, i32 %464) #4
...
476:                                              ; preds = %471
  ...
  %478 = call i32 @hypre_MPI_Wait(i32* %477, %struct.MPI_Status* nonnull %10) #4
  br label %479
...
526:                                              ; preds = %513, %499
  ...
  %528 = call i32* @hypre_idx_malloc(i32 %527, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.12, i64 0, i64 0)) #4
  %529 = getelementptr inbounds %struct.cphasedef, %struct.cphasedef* %55, i64 0, i32 7
  store i32* %528, i32** %529, align 8, !tbaa !111
  %530 = call i32* @hypre_idx_malloc(i32 %18, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.13, i64 0, i64 0)) #4
  %531 = load i32*, i32** %208, align 8, !tbaa !88
  %532 = add nsw i32 %229, 1
  %533 = sext i32 %532 to i64
  call void @hypre_memcpy_idx(i32* %531, i32* nonnull %211, i64 %533) #4
...
620:                                              ; preds = %612, %553, %586
  ...
  %624 = call i32 @hypre_MPI_Send(i8* %539, i32 %18, i32 1275069445, i32 %622, i32 12, i32 %623) #4
...
629:                                              ; preds = %627
  ...
  call void @hypre_Free(i8* nonnull %630, i32 0) #4
  br label %631

631:                                              ; preds = %629, %627
  %632 = call i32 @hypre_MPI_Type_vector(i32 %18, i32 1, i32 %336, i32 1275069445, i32* nonnull %11) #4
  %633 = call i32 @hypre_MPI_Type_commit(i32* nonnull %11) #4
...
637:                                              ; preds = %635, %637
  ...
  %646 = call i32 @hypre_MPI_Recv(i8* %641, i32 1, i32 %642, i32 %644, i32 12, i32 %645, %struct.MPI_Status* nonnull %10) #4
  %647 = add nuw nsw i64 %638, 1
  %648 = icmp eq i64 %647, %636
  br i1 %648, label %649, label %637, !llvm.loop !117

649:                                              ; preds = %637, %631
  %650 = call i32 @hypre_MPI_Type_free(i32* nonnull %11) #4
  %651 = load i32, i32* %16, align 4, !tbaa !9
  %652 = add nsw i32 %651, 1
  %653 = call i32* @hypre_idx_malloc(i32 %652, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.14, i64 0, i64 0)) #4
  %654 = load i32, i32* %16, align 4, !tbaa !9
  %655 = mul nsw i32 %654, %2
  %656 = call i32* @hypre_idx_malloc(i32 %655, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.15, i64 0, i64 0)) #4
  %657 = load i32, i32* %16, align 4, !tbaa !9
  %658 = mul nsw i32 %657, %2
  %659 = call double* @hypre_fp_malloc(i32 %658, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.16, i64 0, i64 0)) #4
...
743:                                              ; preds = %730, %710
  ...
  call void @hypre_Free(i8* %278, i32 0) #4

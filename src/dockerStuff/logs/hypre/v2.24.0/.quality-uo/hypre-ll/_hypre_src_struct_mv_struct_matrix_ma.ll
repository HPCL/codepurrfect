...
define dso_local %struct.hypre_StructMatrix_struct* @hypre_StructMatrixCreateMask(%struct.hypre_StructMatrix_struct* nocapture readonly %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_CAlloc(i64 1, i64 160, i32 0) #3
  ...
  %30 = call i8* @hypre_CAlloc(i64 %29, i64 12, i32 0) #3
...
45:                                               ; preds = %35, %3
  ...
  %84 = call i8* @hypre_CAlloc(i64 %83, i64 8, i32 0) #3
  %85 = bitcast i8* %84 to i32**
  %86 = shl nsw i64 %29, 3
  %87 = call i8* @hypre_MAlloc(i64 %86, i32 0) #3
...
91:                                               ; preds = %45
  ...
  %94 = shl nsw i64 %93, 2
  %95 = call i8* @hypre_MAlloc(i64 %94, i32 0) #3

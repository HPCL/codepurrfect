...
51:                                               ; preds = %40, %5
  ...
  %53 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %0, i8* %27, i8* %52) #9
  %54 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %53) #9
...
80:                                               ; preds = %69, %51
  ...
  %84 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %1, i8* %27, i8* %83) #9
  %85 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %84) #9
...
53:                                               ; preds = %41, %6
  ...
  %55 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct._hypre_ParCSRCommPkg* %0, i8* %28, i8* %54) #9
  %56 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %55) #9
...
83:                                               ; preds = %71, %53
  ...
  %87 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct._hypre_ParCSRCommPkg* %1, i8* %28, i8* %86) #9
  %88 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %87) #9
  call void @hypre_Free(i8* %28, i32 0) #9
...
define dso_local i32 @hypre_exchange_marker(%struct._hypre_ParCSRCommPkg* %0, i32* nocapture readonly %1, i32* %2) local_unnamed_addr #0 {
  ...
  %13 = call i8* @hypre_CAlloc(i64 %12, i64 4, i32 0) #9
...
33:                                               ; preds = %22, %3
  ...
  %35 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %0, i8* %13, i8* %34) #9
  %36 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %35) #9
...
define dso_local i32 @hypre_exchange_interp_data(i32** nocapture %0, i32** nocapture %1, %struct.hypre_CSRMatrix** nocapture %2, i32* nocapture %3, %struct.hypre_CSRMatrix** nocapture %4, %struct._hypre_ParCSRCommPkg** %5, %struct.hypre_ParCSRMatrix_struct* %6, i32* %7, %struct.hypre_ParCSRMatrix_struct* %8, i32 %9, i32* nocapture readonly %10, i32 %11) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 16
  ...
  %20 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 9
  ...
  %24 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 12
  %25 = load i32*, i32** %24, align 8, !tbaa !34
  %26 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 4
  ...
  %44 = call i8* @hypre_CAlloc(i64 %43, i64 4, i32 0) #9
...
62:                                               ; preds = %51, %12
  %63 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %17, i8* %44, i8* %33) #9
  %64 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %63) #9
  call void @hypre_Free(i8* %44, i32 0) #9
  ...
  %68 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixExtractBExt_Overlap(%struct.hypre_ParCSRMatrix_struct* %6, %struct.hypre_ParCSRMatrix_struct* %6, i32 1, %struct.hypre_ParCSRCommHandle** nonnull %13, %struct.hypre_ParCSRCommHandle** nonnull %14, i32* %7, i32* %67, i32 %11, i32 %11) #9
  ...
  %77 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixExtractBExt_Overlap(%struct.hypre_ParCSRMatrix_struct* %8, %struct.hypre_ParCSRMatrix_struct* %6, i32 0, %struct.hypre_ParCSRCommHandle** nonnull %15, %struct.hypre_ParCSRCommHandle** null, i32* %7, i32* %76, i32 %11, i32 0) #9
  ...
  %85 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %82) #9
  ...
  %89 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %86) #9
  call void @hypre_Free(i8* %88, i32 0) #9
...
126:                                              ; preds = %118
  %127 = call i32 @hypre_BigBinarySearch(i32* %25, i32 %122, i32 %74) #9
...
158:                                              ; preds = %150
  %159 = call i32 @hypre_BigBinarySearch(i32* %25, i32 %154, i32 %74) #9
...
180:                                              ; preds = %177
  ...
  call void @hypre_BigQsort0(i32* %99, i32 0, i32 %181) #9
...
231:                                              ; preds = %227
  %232 = call i32 @hypre_BigBinarySearch(i32* %99, i32 %225, i32 %203) #9
...
262:                                              ; preds = %258
  %263 = call i32 @hypre_BigBinarySearch(i32* %99, i32 %256, i32 %203) #9
...
278:                                              ; preds = %276
  ...
  %284 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 5
  %285 = load i32, i32* %284, align 4, !tbaa !51
  ...
  %288 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 15, i64 0
  %289 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 24
  %290 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %289, align 8, !tbaa !52
  %291 = call i32 @hypre_ParCSRFindExtendCommPkg(i32 %281, i32 %283, i32 %285, i32 %287, i32* nonnull %288, %struct.hypre_IJAssumedPart* %290, i32 %203, i32* %99, %struct._hypre_ParCSRCommPkg** %5) #9
  %292 = load i8*, i8** %34, align 8, !tbaa !37
  %293 = load i32, i32* %3, align 4, !tbaa !12
  %294 = sext i32 %293 to i64
  %295 = shl nsw i64 %294, 2
  %296 = call i8* @hypre_ReAlloc(i8* %292, i64 %295, i32 0) #9
  %297 = bitcast i8* %296 to i32*
  store i8* %296, i8** %34, align 8, !tbaa !37
  %298 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %5, align 8, !tbaa !37
  %299 = getelementptr inbounds i32, i32* %297, i64 %91
  %300 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %298, i64 0, i32 1
  %301 = load i32, i32* %300, align 4, !tbaa !3
  %302 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %298, i64 0, i32 3
  %303 = load i32*, i32** %302, align 8, !tbaa !11
  %304 = load i32, i32* %303, align 4, !tbaa !12
  %305 = sext i32 %301 to i64
  %306 = getelementptr inbounds i32, i32* %303, i64 %305
  %307 = load i32, i32* %306, align 4, !tbaa !12
  %308 = sext i32 %307 to i64
  %309 = call i8* @hypre_CAlloc(i64 %308, i64 4, i32 0) #9
  %310 = bitcast i8* %309 to i32*
  %311 = icmp slt i32 %304, %307
  br i1 %311, label %312, label %327

312:                                              ; preds = %278
  %313 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %298, i64 0, i32 4
  %314 = load i32*, i32** %313, align 8, !tbaa !13
  %315 = sext i32 %304 to i64
  br label %316

316:                                              ; preds = %316, %312
  %317 = phi i64 [ %315, %312 ], [ %325, %316 ]
  ...
  %323 = sub nsw i64 %317, %315
  %324 = getelementptr inbounds i32, i32* %310, i64 %323
  store i32 %322, i32* %324, align 4, !tbaa !12
  %325 = add nsw i64 %317, 1
  %326 = icmp eq i64 %325, %308
  br i1 %326, label %327, label %316, !llvm.loop !26

327:                                              ; preds = %316, %278
  %328 = bitcast i32* %299 to i8*
  %329 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %298, i8* %309, i8* %328) #9
  %330 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %329) #9
  call void @hypre_Free(i8* %309, i32 0) #9
  %331 = icmp sgt i32 %9, 1
  br i1 %331, label %332, label %343

332:                                              ; preds = %327
  %333 = load i32, i32* %3, align 4, !tbaa !12
  %334 = icmp sgt i32 %333, 0
  br i1 %334, label %335, label %339

335:                                              ; preds = %332
  %336 = sext i32 %333 to i64
  %337 = call i8* @hypre_CAlloc(i64 %336, i64 4, i32 0) #9
  %338 = bitcast i32** %1 to i8**
  store i8* %337, i8** %338, align 8, !tbaa !37
  br label %339

339:                                              ; preds = %335, %332
  %340 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %5, align 8, !tbaa !37
  %341 = load i32*, i32** %1, align 8, !tbaa !37
  %342 = call i32 @hypre_alt_insert_new_nodes(%struct._hypre_ParCSRCommPkg* %17, %struct._hypre_ParCSRCommPkg* %340, i32* %10, i32 undef, i32* %341)
  br label %343

343:                                              ; preds = %339, %327
  call void @hypre_Free(i8* %98, i32 0) #9
  %344 = load %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %14, align 8, !tbaa !37
  %345 = getelementptr inbounds %struct.hypre_ParCSRCommHandle, %struct.hypre_ParCSRCommHandle* %344, i64 0, i32 5
  %346 = load i8*, i8** %345, align 8, !tbaa !40
  %347 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %344) #9
  call void @hypre_Free(i8* %346, i32 0) #9
  br label %348

348:                                              ; preds = %276, %343
  %349 = load i32, i32* @hypre__global_error, align 4, !tbaa !12
...
define dso_local void @hypre_build_interp_colmap(%struct.hypre_ParCSRMatrix_struct* nocapture %0, i32 %1, i32* nocapture readonly %2, i32* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %10 = alloca %struct.hypre_UnorderedBigIntMap, align 8
  %11 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 8
  %12 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %11, align 8, !tbaa !30
  ...
  %16 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %15, align 8, !tbaa !31
  ...
  store i32* null, i32** %5, align 8, !tbaa !37
...
27:                                               ; preds = %4
  ...
  %29 = shl nsw i64 %28, 2
  %30 = call i8* @hypre_MAlloc(i64 %29, i32 0) #9
  %31 = bitcast i8* %30 to i32*
  br label %32

32:                                               ; preds = %27, %4
  %33 = phi i32* [ %31, %27 ], [ null, %4 ]
  %34 = call i8* @hypre_MAlloc(i64 8, i32 0) #9
...
55:                                               ; preds = %45, %53
  ...
  br i1 %57, label %58, label %45, !llvm.loop !54
...
58:                                               ; preds = %55, %41
  ...
  call void @hypre_GetSimpleThreadPartition(i32* nonnull %7, i32* nonnull %8, i32 %1) #9
  ...
  %63 = load i32, i32* %8, align 4, !tbaa !12
...
76:                                               ; preds = %68, %73
  ...
  br i1 %78, label %79, label %68, !llvm.loop !55

79:                                               ; preds = %76, %58
  call void @hypre_prefix_sum(i32* nonnull %9, i32* nonnull %6, i32* %35) #9
  %80 = load i32, i32* %6, align 4, !tbaa !12
  %81 = icmp eq i32 %80, 0
...
82:                                               ; preds = %79
  ...
  %84 = shl nsw i64 %83, 2
  %85 = call i8* @hypre_MAlloc(i64 %84, i32 0) #9
  %86 = bitcast i32** %5 to i8**
  store i8* %85, i8** %86, align 8, !tbaa !37
  br label %87

87:                                               ; preds = %82, %79
  %88 = load i32, i32* %7, align 4, !tbaa !12
  %89 = load i32*, i32** %5, align 8
  %90 = load i32, i32* %8, align 4, !tbaa !12
...
99:                                               ; preds = %94
  %100 = getelementptr inbounds i32, i32* %3, i64 %95
  %101 = load i32, i32* %100, align 4, !tbaa !12
  %102 = load i32, i32* %9, align 4, !tbaa !12
  %103 = add nsw i32 %102, 1
  store i32 %103, i32* %9, align 4, !tbaa !12
  %104 = sext i32 %102 to i64
  %105 = getelementptr inbounds i32, i32* %89, i64 %104
  store i32 %101, i32* %105, align 4, !tbaa !12
  br label %106

106:                                              ; preds = %94, %99
  %107 = add nsw i64 %95, 1
  %108 = load i32, i32* %8, align 4, !tbaa !12
  %109 = sext i32 %108 to i64
  %110 = icmp slt i64 %107, %109
  br i1 %110, label %94, label %111, !llvm.loop !56
...
111:                                              ; preds = %106, %87
  ...
  %112 = bitcast %struct.hypre_UnorderedBigIntMap* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %112) #9
  %113 = load i32*, i32** %5, align 8, !tbaa !37
  %114 = load i32, i32* %6, align 4, !tbaa !12
  call void @hypre_big_sort_and_create_inverse_map(i32* %113, i32 %114, i32** nonnull %5, %struct.hypre_UnorderedBigIntMap* nonnull %10) #9
  %115 = getelementptr inbounds %struct.hypre_UnorderedBigIntMap, %struct.hypre_UnorderedBigIntMap* %10, i64 0, i32 2
  %116 = getelementptr inbounds %struct.hypre_UnorderedBigIntMap, %struct.hypre_UnorderedBigIntMap* %10, i64 0, i32 1
...
120:                                              ; preds = %118, %204
  %121 = phi i64 [ 0, %118 ], [ %207, %204 ]
  %122 = getelementptr inbounds i32, i32* %3, i64 %121
  %123 = load i32, i32* %122, align 4, !tbaa !12
  %124 = mul i32 %123, -1028477379
  %125 = add i32 %124, 1073741824
  %126 = call i32 @llvm.fshl.i32(i32 %125, i32 %125, i32 17) #9
  %127 = mul i32 %126, 668265263
  %128 = lshr i32 %127, 15
  %129 = xor i32 %128, %127
  %130 = mul i32 %129, -2048144777
  %131 = lshr i32 %130, 13
  %132 = xor i32 %131, %130
  %133 = mul i32 %132, -1028477379
  %134 = lshr i32 %133, 16
  %135 = xor i32 %134, %133
  %136 = load volatile %struct.hypre_BigHopscotchBucket*, %struct.hypre_BigHopscotchBucket** %115, align 8, !tbaa !57
  %137 = load volatile i32, i32* %116, align 4, !tbaa !59
  %138 = and i32 %135, %137
  %139 = sext i32 %138 to i64
  %140 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %136, i64 %139
  %141 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %140, i64 0, i32 0
  %142 = load volatile i32, i32* %141, align 4, !tbaa !60
...
143:                                              ; preds = %120
  %144 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %136, i64 %139, i32 1
  %145 = load volatile i32, i32* %144, align 4, !tbaa !62
  %146 = icmp eq i32 %135, %145
  br i1 %146, label %147, label %204

147:                                              ; preds = %143
  %148 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %136, i64 %139, i32 2
  %149 = load volatile i32, i32* %148, align 4, !tbaa !63
  %150 = icmp eq i32 %149, %123
  br i1 %150, label %151, label %204

151:                                              ; preds = %147
  %152 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %136, i64 %139, i32 3
  br label %201

153:                                              ; preds = %120, %175
  %154 = phi i32 [ %177, %175 ], [ %142, %120 ]
  %155 = phi i32 [ %178, %175 ], [ undef, %120 ]
  %156 = icmp eq i32 %154, 0
  br i1 %156, label %179, label %157

157:                                              ; preds = %153
  %158 = call i32 @llvm.cttz.i32(i32 %154, i1 true) #9, !range !64
  %159 = zext i32 %158 to i64
  %160 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %140, i64 %159
  %161 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %160, i64 0, i32 1
  %162 = load volatile i32, i32* %161, align 4, !tbaa !62
  %163 = icmp eq i32 %135, %162
  br i1 %163, label %164, label %171

164:                                              ; preds = %157
  %165 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %160, i64 0, i32 2
  %166 = load volatile i32, i32* %165, align 4, !tbaa !63
  %167 = icmp eq i32 %166, %123
  br i1 %167, label %168, label %171

168:                                              ; preds = %164
  %169 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %160, i64 0, i32 3
  %170 = load volatile i32, i32* %169, align 4, !tbaa !65
  br label %175
...
175:                                              ; preds = %171, %168
  %176 = phi i1 [ true, %171 ], [ false, %168 ]
  %177 = phi i32 [ %174, %171 ], [ %154, %168 ]
  %178 = phi i32 [ %155, %171 ], [ %170, %168 ]
  br i1 %176, label %153, label %204, !llvm.loop !66

179:                                              ; preds = %153
  %180 = load volatile %struct.hypre_BigHopscotchBucket*, %struct.hypre_BigHopscotchBucket** %115, align 8, !tbaa !57
  %181 = load volatile i32, i32* %116, align 4, !tbaa !59
  %182 = and i32 %181, %135
  %183 = sext i32 %182 to i64
  %184 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %180, i64 %183
  br label %185

185:                                              ; preds = %197, %179
  %186 = phi i32 [ 0, %179 ], [ %198, %197 ]
  %187 = phi %struct.hypre_BigHopscotchBucket* [ %184, %179 ], [ %199, %197 ]
  %188 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %187, i64 0, i32 1
  %189 = load volatile i32, i32* %188, align 4, !tbaa !62
  %190 = icmp eq i32 %135, %189
  br i1 %190, label %191, label %197

191:                                              ; preds = %185
  %192 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %187, i64 0, i32 2
  %193 = load volatile i32, i32* %192, align 4, !tbaa !63
  %194 = icmp eq i32 %193, %123
  br i1 %194, label %195, label %197

195:                                              ; preds = %191
  %196 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %187, i64 0, i32 3
  br label %201

197:                                              ; preds = %191, %185
  %198 = add nuw nsw i32 %186, 1
  %199 = getelementptr inbounds %struct.hypre_BigHopscotchBucket, %struct.hypre_BigHopscotchBucket* %187, i64 1
  %200 = icmp eq i32 %198, 32
  br i1 %200, label %204, label %185, !llvm.loop !67

201:                                              ; preds = %195, %151
  %202 = phi i32* [ %152, %151 ], [ %196, %195 ]
  %203 = load volatile i32, i32* %202, align 4, !tbaa !65
  br label %204

204:                                              ; preds = %175, %197, %201, %120, %143, %147
  %205 = phi i32 [ -1, %120 ], [ -1, %147 ], [ -1, %143 ], [ %203, %201 ], [ -1, %197 ], [ %178, %175 ]
  %206 = getelementptr inbounds i32, i32* %33, i64 %121
  store i32 %205, i32* %206, align 4, !tbaa !12
  %207 = add nuw nsw i64 %121, 1
  %208 = icmp eq i64 %207, %119
  br i1 %208, label %209, label %120, !llvm.loop !68

209:                                              ; preds = %204, %111
  %210 = load i32, i32* %6, align 4, !tbaa !12
  %211 = icmp eq i32 %210, 0
  br i1 %211, label %213, label %212

212:                                              ; preds = %209
  call void @hypre_UnorderedBigIntMapDestroy(%struct.hypre_UnorderedBigIntMap* nonnull %10) #9
  br label %213
...
215:                                              ; preds = %213
  %216 = zext i32 %21 to i64
  br label %217

217:                                              ; preds = %215, %217
  %218 = phi i64 [ 0, %215 ], [ %224, %217 ]
  ...
  store i32 %223, i32* %219, align 4, !tbaa !12
  %224 = add nuw nsw i64 %218, 1
  %225 = icmp eq i64 %224, %216
  br i1 %225, label %226, label %217, !llvm.loop !69

226:                                              ; preds = %217, %213
  %227 = bitcast i32* %33 to i8*
  call void @hypre_Free(i8* %227, i32 0) #9
  call void @hypre_Free(i8* %34, i32 0) #9
  %228 = load i32, i32* %6, align 4, !tbaa !12
  %229 = icmp eq i32 %228, 0
  br i1 %229, label %235, label %230

230:                                              ; preds = %226
  %231 = load i32*, i32** %5, align 8, !tbaa !37
  %232 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 12
  store i32* %231, i32** %232, align 8, !tbaa !34
  %233 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %15, align 8, !tbaa !31
  %234 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %233, i64 0, i32 4
  store i32 %228, i32* %234, align 4, !tbaa !32
  br label %235
...
declare dso_local void @hypre_big_sort_and_create_inverse_map(i32*, i32, i32**, %struct.hypre_UnorderedBigIntMap*) local_unnamed_addr #2

declare dso_local void @hypre_UnorderedBigIntMapDestroy(%struct.hypre_UnorderedBigIntMap*) local_unnamed_addr #2
...
!39 = !{!33, !8, i64 16}
!40 = !{!41, !8, i64 24}
!41 = !{!"", !8, i64 0, !6, i64 8, !6, i64 12, !5, i64 16, !5, i64 20, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64}
...
!57 = !{!58, !8, i64 8}
!58 = !{!"", !5, i64 0, !5, i64 4, !8, i64 8}
!59 = !{!58, !5, i64 4}
!60 = !{!61, !5, i64 0}
!61 = !{!"", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12}
!62 = !{!61, !5, i64 4}
!63 = !{!61, !5, i64 8}
!64 = !{i32 0, i32 33}
!65 = !{!61, !5, i64 12}

...
define dso_local i32 @hypre_SysPFMGSetup(i8* %0, %struct.hypre_SStructMatrix_struct* nocapture readonly %1, %struct.hypre_SStructVector_struct* nocapture readonly %2, %struct.hypre_SStructVector_struct* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %51 = shl nsw i64 %50, 3
  %52 = call i8* @hypre_MAlloc(i64 %51, i32 0) #4
...
57:                                               ; preds = %55, %57
  ...
  %59 = call i8* @hypre_MAlloc(i64 24, i32 0) #4
...
128:                                              ; preds = %123, %118, %64
  %129 = call i8* @hypre_CAlloc(i64 3, i64 8, i32 0) #4
  %130 = bitcast i8* %129 to double*
  %131 = call i8* @hypre_CAlloc(i64 3, i64 8, i32 0) #4
...
184:                                              ; preds = %181, %128
  ...
  call void @hypre_Free(i8* %131, i32 0) #4
  br label %186
...
186:                                              ; preds = %184, %123
  ...
  %190 = call i8* @hypre_MAlloc(i64 %189, i32 0) #4
  ...
  %192 = call i8* @hypre_MAlloc(i64 %189, i32 0) #4
  ...
  %195 = call i8* @hypre_MAlloc(i64 %194, i32 0) #4
  %196 = bitcast i8* %195 to i32*
  %197 = call i8* @hypre_MAlloc(i64 %194, i32 0) #4
  %198 = bitcast i8* %197 to i32*
  %199 = call i8* @hypre_CAlloc(i64 %188, i64 8, i32 0) #4
...
385:                                              ; preds = %383, %385
  ...
  call void @hypre_Free(i8* %389, i32 0) #4
...
502:                                              ; preds = %489, %482
  ...
  %519 = call i8* @hypre_MAlloc(i64 %415, i32 0) #4
  %520 = bitcast i8* %519 to i8**
  %521 = call i8* @hypre_MAlloc(i64 %415, i32 0) #4
  %522 = bitcast i8* %521 to i8**
  %523 = call i8* @hypre_MAlloc(i64 %415, i32 0) #4
  %524 = bitcast i8* %523 to i8**
  %525 = call i8* @hypre_MAlloc(i64 %415, i32 0) #4
...
647:                                              ; preds = %634, %622, %586
  call void @hypre_Free(i8* %199, i32 0) #4
...
define dso_local i32 @hypre_SysStructCoarsen(%struct.hypre_SStructPGrid* nocapture readonly %0, i32* %1, i32* %2, i32 %3, %struct.hypre_SStructPGrid** nocapture %4) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_MAlloc(i64 200, i32 0) #4
  ...
  %24 = shl nsw i64 %23, 2
  %25 = call i8* @hypre_MAlloc(i64 %24, i32 0) #4
...
!13 = !{!4, !5, i64 60}
!14 = !{!15, !9, i64 32}
!15 = !{!"hypre_SStructMatrix_struct", !5, i64 0, !5, i64 4, !9, i64 8, !9, i64 16, !5, i64 24, !9, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !5, i64 64, !9, i64 72, !9, i64 80, !5, i64 88, !9, i64 96, !9, i64 104, !9, i64 112, !9, i64 120, !9, i64 128, !9, i64 136, !5, i64 144, !5, i64 148, !5, i64 152, !5, i64 156}
!16 = !{!9, !9, i64 0}
!17 = !{!18, !9, i64 24}

...
define dso_local i32 @hypre_ParCSRBlockMatrixMatvec(double %0, %struct.hypre_ParCSRBlockMatrix* %1, %struct.hypre_ParVector_struct* nocapture readonly %2, double %3, %struct.hypre_ParVector_struct* nocapture readonly %4) local_unnamed_addr #0 {
  ...
  %23 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %22, i64 0, i32 4
  ...
  %27 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %26, i64 0, i32 6
...
46:                                               ; preds = %5
  ...
  %52 = icmp eq %struct._hypre_ParCSRCommPkg* %16, null
  br i1 %52, label %53, label %56

53:                                               ; preds = %46
  %54 = call i32 @hypre_BlockMatvecCommPkgCreate(%struct.hypre_ParCSRBlockMatrix* %1) #3
  %55 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %15, align 8, !tbaa !10
  br label %56

56:                                               ; preds = %53, %46
  %57 = phi %struct._hypre_ParCSRCommPkg* [ %16, %46 ], [ %55, %53 ]
  %58 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %57, i64 0, i32 1
  %59 = load i32, i32* %58, align 4, !tbaa !24
  %60 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %57, i64 0, i32 3
  ...
  %69 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %57, i64 0, i32 4
...
117:                                              ; preds = %75, %56
  %118 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 1, i32 %24, %struct._hypre_ParCSRCommPkg* %57, i8* %67, i8* %51) #3
  br label %119
...
define dso_local i32 @hypre_ParCSRBlockMatrixMatvecT(double %0, %struct.hypre_ParCSRBlockMatrix* %1, %struct.hypre_ParVector_struct* nocapture readonly %2, double %3, %struct.hypre_ParVector_struct* nocapture readonly %4) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %9, i64 0, i32 4
  ...
  %26 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %11, i64 0, i32 6
  ...
  %37 = icmp eq %struct._hypre_ParCSRCommPkg* %7, null
  br i1 %37, label %38, label %41

38:                                               ; preds = %5
  %39 = call i32 @hypre_BlockMatvecCommPkgCreate(%struct.hypre_ParCSRBlockMatrix* %1) #3
  %40 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %6, align 8, !tbaa !10
  br label %41

41:                                               ; preds = %38, %5
  %42 = phi %struct._hypre_ParCSRCommPkg* [ %7, %5 ], [ %40, %38 ]
  %43 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 1
  %44 = load i32, i32* %43, align 4, !tbaa !24
  %45 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 3
  ...
  %52 = call i8* @hypre_CAlloc(i64 %51, i64 8, i32 0) #3
...
61:                                               ; preds = %59, %41
  %62 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 2, i32 %17, %struct._hypre_ParCSRCommPkg* %42, i8* %55, i8* %52) #3
  ...
  %65 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 4
...
!13 = !{!4, !8, i64 32}
!14 = !{!15, !5, i64 32}
!15 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !5, i64 36, !5, i64 40, !5, i64 44, !5, i64 48}
!16 = !{!4, !8, i64 40}
!17 = !{!15, !5, i64 40}
!18 = !{!19, !8, i64 32}
!19 = !{!"hypre_ParVector_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 24, !8, i64 32, !5, i64 40, !8, i64 48}
!20 = !{!19, !5, i64 4}
!21 = !{!22, !8, i64 0}
!22 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}
!23 = !{!5, !5, i64 0}
!24 = !{!25, !5, i64 4}

...
@.str = private unnamed_addr constant [15 x i8] c"lgmres.out.log\00", align 1
...
139:                                              ; preds = %134
  store i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i8** %136, align 8, !tbaa !56
  br label %140
...
140:                                              ; preds = %133, %134
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 438, i32 1, i8* null) #9
  br label %836
...
157:                                              ; preds = %150, %151
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 465, i32 1, i8* null) #9
  br label %836
...
811:                                              ; preds = %807
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 918, i32 256, i8* null) #9
  br label %812

...
; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local i32 @hypre_SeqVectorElmdivpy(%struct.hypre_Vector* nocapture readonly %0, %struct.hypre_Vector* nocapture readonly %1, %struct.hypre_Vector* nocapture readonly %2) local_unnamed_addr #5 {
...
15:                                               ; preds = %13, %15
  ...
  %19 = getelementptr inbounds double, double* %7, i64 %16
  %20 = load double, double* %19, align 8, !tbaa !22
  %21 = fdiv double %18, %20
  %22 = getelementptr inbounds double, double* %9, i64 %16
  %23 = load double, double* %22, align 8, !tbaa !22
  %24 = fadd double %23, %21
  store double %24, double* %22, align 8, !tbaa !22
  %25 = add nuw nsw i64 %16, 1
  %26 = icmp eq i64 %25, %14
  br i1 %26, label %27, label %15, !llvm.loop !32

27:                                               ; preds = %15, %3
  %28 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
  ret i32 %28
}

; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local i32 @hypre_SeqVectorElmdivpyMarked(%struct.hypre_Vector* nocapture readonly %0, %struct.hypre_Vector* nocapture readonly %1, %struct.hypre_Vector* nocapture readonly %2, i32* nocapture readonly %3, i32 %4) local_unnamed_addr #5 {
  %6 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %0, i64 0, i32 0
  %7 = load double*, double** %6, align 8, !tbaa !3
  %8 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %1, i64 0, i32 0
  %9 = load double*, double** %8, align 8, !tbaa !3
  %10 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %2, i64 0, i32 0
  %11 = load double*, double** %10, align 8, !tbaa !3
  %12 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %1, i64 0, i32 1
...
22:                                               ; preds = %17
  ...
  %25 = getelementptr inbounds double, double* %9, i64 %18
  %26 = load double, double* %25, align 8, !tbaa !22
  %27 = fdiv double %24, %26
  %28 = getelementptr inbounds double, double* %11, i64 %18
...
31:                                               ; preds = %17, %22
  ...
  br i1 %33, label %34, label %17, !llvm.loop !33
...
16:                                               ; preds = %13, %16
  ...
  br i1 %26, label %27, label %16, !llvm.loop !34
...
!12 = !{!4, !8, i64 12}
!13 = !{!14, !6, i64 4}
!14 = !{!"", !8, i64 0, !6, i64 4, !6, i64 8, !6, i64 12, !5, i64 16, !5, i64 24}
!15 = !{!4, !6, i64 16}
!16 = !{!4, !8, i64 28}
!17 = !{!4, !8, i64 32}
!18 = !{!8, !8, i64 0}

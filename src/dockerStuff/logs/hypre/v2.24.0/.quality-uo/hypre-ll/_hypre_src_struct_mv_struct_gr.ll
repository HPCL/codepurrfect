...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_StructGridGetMaxBoxSize(%struct.hypre_StructGrid_struct* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %0, i64 0, i32 2
  %3 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %2, align 8, !tbaa !10
  %4 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %3, i64 0, i32 1
  %5 = load i32, i32* %4, align 8, !tbaa !23
  %6 = icmp sgt i32 %5, 0
...
7:                                                ; preds = %1, %18
  %8 = phi i64 [ %20, %18 ], [ 0, %1 ]
  %9 = phi i32 [ %19, %18 ], [ 0, %1 ]
  %10 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %2, align 8, !tbaa !10
  %11 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %10, i64 0, i32 0
  %12 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %11, align 8, !tbaa !32
  %13 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %12, i64 %8
  %14 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %13) #8
  %15 = icmp slt i32 %9, %14
  br i1 %15, label %16, label %18

16:                                               ; preds = %7
  %17 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %13) #8
  br label %18
...
18:                                               ; preds = %7, %16
  ...
  br i1 %23, label %7, label %24, !llvm.loop !62

24:                                               ; preds = %18, %1
  %25 = phi i32 [ 0, %1 ], [ %19, %18 ]
  ret i32 %25
}

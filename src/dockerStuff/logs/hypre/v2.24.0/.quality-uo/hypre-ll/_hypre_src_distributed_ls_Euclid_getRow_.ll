...
define dso_local void @EuclidGetRow(i8* %0, i32 %1, i32* %2, i32** %3, double** %4) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 23, i32 1) #4
...
9:                                                ; preds = %5
  ...
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 29) #4
  br label %13
...
define dso_local void @EuclidRestoreRow(i8* %0, i32 %1, i32* %2, i32** %3, double** %4) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 38, i32 1) #4
  %6 = bitcast i8* %0 to %struct.hypre_ParCSRMatrix_struct*
...
9:                                                ; preds = %5
  %10 = add nsw i32 %1, 1
  %11 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.2, i64 0, i64 0), i32 %10, i32 %7) #4
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 44) #4
  br label %13
...
define dso_local void @EuclidGetDimensions(i8* %0, i32* nocapture %1, i32* nocapture %2, i32* nocapture %3) local_unnamed_addr #0 {
  ...
  call void @dh_StartFunc(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 53, i32 1) #4
...
define dso_local void @PrintMatUsingGetRow(i8* %0, i32 %1, i32 %2, i32* readonly %3, i32* readonly %4, i8* %5) local_unnamed_addr #0 {
  ...
  call void @dh_StartFunc(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 285, i32 1) #4
...
26:                                               ; preds = %14
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 293) #4
...
58:                                               ; preds = %52
  ...
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 309) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %12) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #4
  br label %175
...
71:                                               ; preds = %67, %70
  %72 = load i8, i8* @errFlag_dh, align 1, !tbaa !9, !range !11
  %73 = icmp eq i8 %72, 0
...
80:                                               ; preds = %71
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 315) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %12) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #4
  br label %175
...
103:                                              ; preds = %98, %102
  %104 = load i8, i8* @errFlag_dh, align 1, !tbaa !9, !range !11
  %105 = icmp eq i8 %104, 0
  br i1 %105, label %158, label %106

106:                                              ; preds = %103
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 319) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %12) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #4
  br label %175
...
126:                                              ; preds = %117
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 322) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %12) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #4
  br label %175
...
127:                                              ; preds = %123, %127
  ...
  br i1 %144, label %127, label %145, !llvm.loop !18
...
154:                                              ; preds = %149, %153
  %155 = load i8, i8* @errFlag_dh, align 1, !tbaa !9, !range !11
...
158:                                              ; preds = %103, %154
  ...
  br i1 %160, label %161, label %60, !llvm.loop !19
...
163:                                              ; preds = %46, %161
  ...
  br i1 %166, label %46, label %167, !llvm.loop !20
...
168:                                              ; preds = %167
  ...
  %171 = load i8, i8* @errFlag_dh, align 1, !tbaa !9, !range !11
  %172 = icmp eq i8 %171, 0
  br i1 %172, label %174, label %173

173:                                              ; preds = %168
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 335) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %12) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #4
  br label %175
...
define dso_local void @Euclid_dhInputHypreMat(%struct._mpi_interface_dh* nocapture %0, %struct.hypre_ParCSRMatrix_struct* %1) local_unnamed_addr #0 {
  ...
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  call void @dh_StartFunc(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.13, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 349, i32 1) #4
...
17:                                               ; preds = %2
  ...
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.13, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), i32 357) #4
  br label %30
...
19:                                               ; preds = %2
  ...
  store %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParCSRMatrix_struct** %29, align 8, !tbaa !24
  br label %30
...
!21 = !{!22, !4, i64 24}
!22 = !{!"_mpi_interface_dh", !10, i64 0, !16, i64 8, !16, i64 16, !4, i64 24, !4, i64 28, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !10, i64 72, !8, i64 80, !8, i64 88, !4, i64 96, !4, i64 100, !5, i64 104, !5, i64 124, !4, i64 144, !16, i64 152, !16, i64 160, !16, i64 168, !16, i64 176, !16, i64 184, !16, i64 192, !8, i64 200, !8, i64 208, !5, i64 216, !4, i64 236, !16, i64 240, !16, i64 248, !4, i64 256, !4, i64 260, !4, i64 264, !4, i64 268, !5, i64 272, !5, i64 352, !10, i64 432, !10, i64 433}
!23 = !{!22, !4, i64 28}
!24 = !{!22, !8, i64 40}

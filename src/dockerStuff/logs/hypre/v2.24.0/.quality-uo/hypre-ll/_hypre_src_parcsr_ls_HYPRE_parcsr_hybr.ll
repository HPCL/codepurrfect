...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRHybridSetAggInterpType(%struct.hypre_Solver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %4 = call i32 @hypre_AMGHybridSetAggInterpType(i8* %3, i32 %1) #2
  ret i32 %4
}

declare dso_local i32 @hypre_AMGHybridSetAggInterpType(i8*, i32) local_unnamed_addr #1

...
define dso_local i32 @hypre_BoomerAMGSolveT(i8* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %3) local_unnamed_addr #0 {
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 848
  %14 = bitcast i8* %13 to i32*
  %15 = load i32, i32* %14, align 8, !tbaa !10
  %16 = getelementptr inbounds i8, i8* %0, i64 816
...
20:                                               ; preds = %4
  %21 = getelementptr inbounds i8, i8* %0, i64 840
...
24:                                               ; preds = %20, %4
  ...
  %57 = getelementptr inbounds i8, i8* %0, i64 752
...
118:                                              ; preds = %113, %102
  %119 = getelementptr inbounds i8, i8* %0, i64 776
  %120 = bitcast i8* %119 to double*
  %121 = getelementptr inbounds i8, i8* %0, i64 832
  %122 = bitcast i8* %121 to double*
  %123 = getelementptr inbounds i8, i8* %0, i64 820
...
194:                                              ; preds = %192, %166
  ...
  %197 = getelementptr inbounds i8, i8* %0, i64 776
...
define dso_local i32 @hypre_BoomerAMGCycleT(i8* nocapture %0, %struct.hypre_ParVector_struct** nocapture readonly %1, %struct.hypre_ParVector_struct** nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 752
  ...
  %37 = getelementptr inbounds i8, i8* %0, i64 776
  ...
  %47 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %46, i64 0, i32 20
...
52:                                               ; preds = %50, %52
  ...
  %56 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %55, i64 0, i32 20
...
78:                                               ; preds = %65, %196
  ...
  %80 = phi i32 [ 0, %65 ], [ %198, %196 ]
  %81 = phi i32 [ 0, %65 ], [ %197, %196 ]
  %82 = phi double [ %39, %65 ], [ %148, %196 ]
...
147:                                              ; preds = %113, %78
  %148 = phi double [ %82, %78 ], [ %139, %113 ]
  %149 = phi i32 [ %79, %78 ], [ %125, %113 ]
  %150 = sext i32 %81 to i64
...
196:                                              ; preds = %182, %184, %157
  ...
  %198 = phi i32 [ %181, %157 ], [ %195, %184 ], [ %80, %182 ]
...
!51 = !{!49, !5, i64 24}
!52 = !{!53, !5, i64 8}
!53 = !{!"hypre_ParVector_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 24, !8, i64 32, !5, i64 40, !8, i64 48}
!54 = !{!53, !8, i64 32}
!55 = !{!56, !8, i64 0}

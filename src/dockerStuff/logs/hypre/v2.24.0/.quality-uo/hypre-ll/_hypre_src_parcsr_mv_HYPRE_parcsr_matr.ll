...
7:                                                ; preds = %2
  ...
  %10 = call i32 @hypre_MPI_Comm_size(i32 %9, i32* nonnull %3) #3
  %11 = load i32, i32* %3, align 4, !tbaa !7
  %12 = add nsw i32 %11, 1
  %13 = sext i32 %12 to i64
  %14 = call i8* @hypre_CAlloc(i64 %13, i64 4, i32 0) #3
...
18:                                               ; preds = %7, %18
  %19 = phi i64 [ %23, %18 ], [ 0, %7 ]
  %20 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 14, i64 %19
  %21 = load i32, i32* %20, align 4, !tbaa !7
  %22 = getelementptr inbounds i32, i32* %15, i64 %19
  store i32 %21, i32* %22, align 4, !tbaa !7
  %23 = add nuw nsw i64 %19, 1
  %24 = load i32, i32* %3, align 4, !tbaa !7
  %25 = sext i32 %24 to i64
  %26 = icmp slt i64 %19, %25
  br i1 %26, label %18, label %27, !llvm.loop !14

27:                                               ; preds = %18, %7
  %28 = bitcast i32** %1 to i8**
  store i8* %14, i8** %28, align 8, !tbaa !3
  br label %29

29:                                               ; preds = %27, %6
  %30 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRMatrixGetGlobalRowPartitioning(%struct.hypre_ParCSRMatrix_struct* readonly %0, i32 %1, i32** nocapture %2) local_unnamed_addr #0 {
...
9:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 178, i32 12, i8* null) #3
...
22:                                               ; preds = %11
  ...
  %24 = add nsw i32 %23, 1
  %25 = sext i32 %24 to i64
  %26 = call i8* @hypre_CAlloc(i64 %25, i64 4, i32 0) #3
  %27 = bitcast i8* %26 to i32*
  br label %28

28:                                               ; preds = %11, %22
  %29 = phi i32* [ %27, %22 ], [ null, %11 ]
  %30 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 4
...
33:                                               ; preds = %28
  %34 = call i32 @hypre_MPI_Allgather(i8* nonnull %16, i32 1, i32 1275069445, i8* %32, i32 1, i32 1275069445, i32 %13) #3
  br label %37

35:                                               ; preds = %28
  %36 = call i32 @hypre_MPI_Gather(i8* nonnull %16, i32 1, i32 1275069445, i8* %32, i32 1, i32 1275069445, i32 0, i32 %13) #3
  br label %37
...
47:                                               ; preds = %37, %41
  store i32* %29, i32** %2, align 8, !tbaa !3
  %48 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
...
6:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 229, i32 12, i8* null) #3
  br label %29
...
18:                                               ; preds = %7, %18
  %19 = phi i64 [ %23, %18 ], [ 0, %7 ]
  %20 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15, i64 %19
  %21 = load i32, i32* %20, align 4, !tbaa !7
  %22 = getelementptr inbounds i32, i32* %15, i64 %19
  store i32 %21, i32* %22, align 4, !tbaa !7
  %23 = add nuw nsw i64 %19, 1
  ...
  %25 = sext i32 %24 to i64
  %26 = icmp slt i64 %19, %25
  br i1 %26, label %18, label %27, !llvm.loop !18
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 276, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 298, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 320, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 348, i32 44, i8* null) #3
  br label %11
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 372, i32 28, i8* null) #3
  br label %9

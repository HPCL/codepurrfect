...
13:                                               ; preds = %11
  ...
  %17 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 16
  %18 = bitcast i32** %17 to i8**
  store i8* %16, i8** %18, align 8, !tbaa !29
  %19 = sext i32 %6 to i64
  %20 = call i8* @hypre_CAlloc(i64 %19, i64 4, i32 0) #3
  %21 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 17
  %22 = bitcast i32** %21 to i8**
  store i8* %20, i8** %22, align 8, !tbaa !30
  %23 = call i8* @hypre_CAlloc(i64 %19, i64 8, i32 0) #3
  %24 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 18
  %25 = bitcast double** %24 to i8**
  store i8* %23, i8** %25, align 8, !tbaa !31
  br label %26

26:                                               ; preds = %13, %11
  %27 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 3
  %28 = load i32, i32* %27, align 4, !tbaa !12
  %29 = icmp eq i32 %28, 0
  br i1 %29, label %161, label %30

30:                                               ; preds = %26
  %31 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 6
  %32 = load i32*, i32** %31, align 8, !tbaa !11
  %33 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 4
  %34 = load i32*, i32** %33, align 8, !tbaa !15
  %35 = sext i32 %4 to i64
  %36 = call i8* @hypre_CAlloc(i64 %35, i64 8, i32 0) #3
  %37 = bitcast i8* %36 to i32**
  %38 = call i8* @hypre_CAlloc(i64 %35, i64 8, i32 0) #3
...
65:                                               ; preds = %63, %76
  %66 = phi i64 [ 0, %63 ], [ %78, %76 ]
  %67 = phi i32 [ 0, %63 ], [ %77, %76 ]
  %68 = getelementptr inbounds i32, i32* %32, i64 %66
...
76:                                               ; preds = %65, %71
  %77 = phi i32 [ %72, %71 ], [ %67, %65 ]
  %78 = add nuw nsw i64 %66, 1
  %79 = icmp eq i64 %78, %64
  br i1 %79, label %80, label %65, !llvm.loop !39

80:                                               ; preds = %76, %58
  %81 = phi i32 [ 0, %58 ], [ %77, %76 ]
  %82 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 1
  store i32 %81, i32* %82, align 4, !tbaa !9
  %83 = bitcast i32** %33 to i8**
  store i8* %60, i8** %83, align 8, !tbaa !15
  br label %84

84:                                               ; preds = %55, %80, %30
  %85 = phi i32* [ %61, %80 ], [ %34, %55 ], [ %34, %30 ]
  %86 = phi i32 [ %81, %80 ], [ %56, %55 ], [ undef, %30 ]
  %87 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 5
  %88 = load i32*, i32** %87, align 8, !tbaa !24
  %89 = icmp eq i32* %88, null
  br i1 %89, label %90, label %93

90:                                               ; preds = %84
  %91 = call i8* @hypre_CAlloc(i64 %35, i64 4, i32 0) #3
  %92 = bitcast i32** %87 to i8**
  store i8* %91, i8** %92, align 8, !tbaa !24
  br label %93

93:                                               ; preds = %90, %84
  br i1 %40, label %137, label %94
...
104:                                              ; preds = %98, %104
  ...
  %113 = getelementptr inbounds i32*, i32** %37, i64 %108
  %114 = bitcast i32** %113 to i8**
  store i8* %112, i8** %114, align 8, !tbaa !13
  %115 = load i32, i32* %109, align 4, !tbaa !14
  %116 = sext i32 %115 to i64
  %117 = call i8* @hypre_CAlloc(i64 %116, i64 8, i32 0) #3
  %118 = getelementptr inbounds double*, double** %39, i64 %108
  %119 = bitcast double** %118 to i8**
  store i8* %117, i8** %119, align 8, !tbaa !13
  %120 = add nuw nsw i64 %105, 1
  %121 = icmp eq i64 %120, %99
  br i1 %121, label %156, label %104, !llvm.loop !40

122:                                              ; preds = %102, %122
  %123 = phi i64 [ 0, %102 ], [ %135, %122 ]
  ...
  %128 = getelementptr inbounds i32*, i32** %37, i64 %123
  %129 = bitcast i32** %128 to i8**
  store i8* %127, i8** %129, align 8, !tbaa !13
  %130 = load i32, i32* %124, align 4, !tbaa !14
  %131 = sext i32 %130 to i64
  %132 = call i8* @hypre_CAlloc(i64 %131, i64 8, i32 0) #3
  %133 = getelementptr inbounds double*, double** %39, i64 %123
  %134 = bitcast double** %133 to i8**
  store i8* %132, i8** %134, align 8, !tbaa !13
  %135 = add nuw nsw i64 %123, 1
  %136 = icmp eq i64 %135, %103
  br i1 %136, label %156, label %122, !llvm.loop !41

137:                                              ; preds = %93
  %138 = call i8* @hypre_CAlloc(i64 %35, i64 4, i32 0) #3
...
143:                                              ; preds = %141, %143
  ...
  store i32 30, i32* %145, align 4, !tbaa !14
  %146 = call i8* @hypre_CAlloc(i64 30, i64 4, i32 0) #3
  %147 = getelementptr inbounds i32*, i32** %37, i64 %144
  %148 = bitcast i32** %147 to i8**
  store i8* %146, i8** %148, align 8, !tbaa !13
  %149 = call i8* @hypre_CAlloc(i64 30, i64 8, i32 0) #3
  %150 = getelementptr inbounds double*, double** %39, i64 %144
  %151 = bitcast double** %150 to i8**
  store i8* %149, i8** %151, align 8, !tbaa !13
...
154:                                              ; preds = %143, %137
  ...
  store i8* %138, i8** %155, align 8, !tbaa !11
  br label %156

156:                                              ; preds = %104, %122, %96, %100, %154
  %157 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 9
  %158 = bitcast i32*** %157 to i8**
  store i8* %36, i8** %158, align 8, !tbaa !16
  %159 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 10
  %160 = bitcast double*** %159 to i8**
  store i8* %38, i8** %160, align 8, !tbaa !21
  br label %169

161:                                              ; preds = %26
  %162 = sext i32 %4 to i64
  %163 = call i8* @hypre_CAlloc(i64 %162, i64 4, i32 0) #3
  %164 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 11
  %165 = bitcast i32** %164 to i8**
  store i8* %163, i8** %165, align 8, !tbaa !25
  %166 = call i8* @hypre_CAlloc(i64 %162, i64 4, i32 0) #3
  %167 = getelementptr inbounds %struct.hypre_AuxParCSRMatrix, %struct.hypre_AuxParCSRMatrix* %0, i64 0, i32 12
  %168 = bitcast i32** %167 to i8**
  store i8* %166, i8** %168, align 8, !tbaa !26
  br label %169

169:                                              ; preds = %161, %156
  %170 = load i32, i32* @hypre__global_error, align 4, !tbaa !14
  br label %171

171:                                              ; preds = %9, %2, %169
  %172 = phi i32 [ %170, %169 ], [ -1, %2 ], [ 0, %9 ]
  ret i32 %172
}

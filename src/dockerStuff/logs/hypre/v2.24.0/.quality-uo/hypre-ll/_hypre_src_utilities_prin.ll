; ModuleID = '/hypre/src/utilities/printf.c'
source_filename = "/hypre/src/utilities/printf.c"
...
define dso_local i32 @new_format(i8* nocapture readonly %0, i8** nocapture %1) local_unnamed_addr #0 {
  ...
  %6 = or i32 %5, 1
  %7 = sext i32 %6 to i64
  %8 = call i8* @hypre_MAlloc(i64 %7, i32 0) #9
  br label %9
...
define dso_local i32 @hypre_fprintf(%struct._IO_FILE* nocapture %0, i8* nocapture readonly %1, ...) local_unnamed_addr #0 {
  ...
  call void @hypre_Free(i8* %9, i32 0) #9
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_ParPrintf(i32 %0, i8* nocapture readonly %1, ...) local_unnamed_addr #0 {
  %3 = alloca i32, align 4
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  %5 = alloca i8*, align 8
  %6 = bitcast i32* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %6) #9
  %7 = call i32 @hypre_MPI_Comm_rank(i32 %0, i32* nonnull %3) #9
  %8 = icmp eq i32 %7, 0
...
12:                                               ; preds = %9
  ...
  %16 = call i32 @new_format(i8* %1, i8** nonnull %5)
  %17 = load i8*, i8** %5, align 8, !tbaa !9
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !9, !noalias !17
  %19 = call i32 @vfprintf(%struct._IO_FILE* %18, i8* %17, %struct.__va_list_tag* nonnull %15) #9

...
39:                                               ; preds = %36
  %40 = bitcast i32** %0 to %struct.hypre_Solver_struct**
  %41 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %40, align 8, !tbaa !7
  %42 = bitcast i32** %2 to %struct.hypre_Solver_struct**
  %43 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %42, align 8, !tbaa !7
  %44 = call i32 @HYPRE_ParCSRCGNRSetPrecond(%struct.hypre_Solver_struct* %41, i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* nonnull @HYPRE_EuclidSolve, i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* nonnull @HYPRE_EuclidSolve, i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* nonnull @HYPRE_EuclidSetup, %struct.hypre_Solver_struct* %43) #2
  br label %45

45:                                               ; preds = %36, %39
  %46 = phi i32 [ %44, %39 ], [ -1, %36 ]

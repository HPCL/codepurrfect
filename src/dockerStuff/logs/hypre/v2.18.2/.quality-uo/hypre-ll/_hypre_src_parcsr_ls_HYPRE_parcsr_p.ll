...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str, i64 0, i64 0), i32 21, i32 20, i8* null) #4
  br label %9
...
define dso_local i32 @HYPRE_ParCSRPCGGetResidual(%struct.hypre_Solver_struct* %0, %struct.hypre_ParVector_struct** %1) local_unnamed_addr #0 {
  ...
  %4 = call i32 @HYPRE_PCGGetResidual(%struct.hypre_Solver_struct* %0, i8* %3) #4
  ret i32 %4
}
...
!11 = !{!12, !4, i64 0}
!12 = !{!"", !4, i64 0, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !8, i64 32}
!13 = !{!14, !4, i64 32}
...
!15 = !{!"double", !5, i64 0}
!16 = !{!17, !4, i64 64}
!17 = !{!"", !4, i64 0, !4, i64 8, !4, i64 16, !8, i64 24, !8, i64 28, !8, i64 32, !4, i64 40, !4, i64 48, !8, i64 56, !4, i64 64, !4, i64 72, !8, i64 80, !8, i64 84}
!18 = !{!17, !4, i64 0}
!19 = !{!12, !8, i64 8}
!20 = !{!15, !15, i64 0}

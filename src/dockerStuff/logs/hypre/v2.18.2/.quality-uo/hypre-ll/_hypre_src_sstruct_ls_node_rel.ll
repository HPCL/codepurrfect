...
87:                                               ; preds = %84, %42
  %88 = shl nsw i64 %45, 3
  %89 = call i8* @hypre_MAlloc(i64 %88, i32 0) #7
  %90 = call i8* @hypre_MAlloc(i64 %88, i32 0) #7
  %91 = call i8* @hypre_MAlloc(i64 %88, i32 0) #7
  %92 = mul nsw i32 %44, %44
  %93 = zext i32 %92 to i64
  %94 = shl nuw nsw i64 %93, 3
  %95 = call i8* @hypre_MAlloc(i64 %94, i32 0) #7

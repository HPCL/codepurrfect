...
92:                                               ; preds = %90, %65
  %93 = getelementptr inbounds i8, i8* %0, i64 1432
...
99:                                               ; preds = %97, %92
  %100 = getelementptr inbounds i8, i8* %0, i64 1440
...
define dso_local i8* @hypre_MGRCreateFrelaxVcycleData() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 1568, i32 1) #9
  ...
  store double* null, double** %8, align 8, !tbaa !80
  %9 = getelementptr inbounds i8, i8* %1, i64 1432
  %10 = getelementptr inbounds i8, i8* %1, i64 728
  %11 = bitcast i8* %10 to %struct.hypre_ParVector_struct**
  store %struct.hypre_ParVector_struct* null, %struct.hypre_ParVector_struct** %11, align 8, !tbaa !84
  %12 = getelementptr inbounds i8, i8* %1, i64 1408
  %13 = bitcast i8* %12 to i32*
  ...
  store i32 67108864, i32* %13, align 8, !tbaa !73
  %14 = getelementptr inbounds i8, i8* %1, i64 440
  %15 = bitcast i8* %14 to i32*
  store i32 0, i32* %15, align 8, !tbaa !71
  %16 = bitcast i8* %1 to i32*
  store i32 10, i32* %16, align 8, !tbaa !85
  ret i8* %1
}

...
declare dso_local void @hypre_Free(i8*, i32) local_unnamed_addr #4
...
define dso_local i32 @hypre_APGetAllBoxesInRegions(%struct.hypre_BoxArray_struct* nocapture readonly %0, %struct.hypre_BoxArray_struct* nocapture readonly %1, i32** nocapture %2, double** nocapture %3, i32 %4) local_unnamed_addr #3 {
  ...
  %15 = call i8* @hypre_CAlloc(i64 %14, i64 4, i32 1) #10
  %16 = bitcast i32** %6 to i8**
  store i8* %15, i8** %16, align 8, !tbaa !15
  %17 = shl nsw i32 %13, 1
  %18 = sext i32 %17 to i64
  %19 = call i8* @hypre_CAlloc(i64 %18, i64 8, i32 1) #10
  %20 = bitcast double** %7 to i8**
  store i8* %19, i8** %20, align 8, !tbaa !15
  %21 = call i8* @hypre_CAlloc(i64 %18, i64 8, i32 1) #10
...
58:                                               ; preds = %46, %39
  ...
  call void @hypre_Free(i8* %21, i32 1) #10
...
define dso_local i32 @hypre_APShrinkRegions(%struct.hypre_BoxArray_struct* nocapture readonly %0, %struct.hypre_BoxArray_struct* nocapture readonly %1, i32 %2) local_unnamed_addr #3 {
  ...
  %18 = sext i32 %17 to i64
  %19 = call i8* @hypre_CAlloc(i64 %18, i64 4, i32 1) #10
  %20 = bitcast i8* %19 to i32*
  %21 = call i8* @hypre_CAlloc(i64 %18, i64 4, i32 1) #10
...
209:                                              ; preds = %205, %171
  call void @hypre_Free(i8* %21, i32 1) #10
  call void @hypre_Free(i8* %19, i32 1) #10
...
define dso_local i32 @hypre_APPruneRegions(%struct.hypre_BoxArray_struct* %0, i32** nocapture %1, double** nocapture %2) local_unnamed_addr #3 {
  ...
  %8 = sext i32 %7 to i64
  %9 = call i8* @hypre_CAlloc(i64 %8, i64 4, i32 1) #10
...
72:                                               ; preds = %58, %33, %29
  call void @hypre_Free(i8* %9, i32 1) #10
...
20:                                               ; preds = %7
  ...
  %22 = call i8* @hypre_CAlloc(i64 %21, i64 8, i32 1) #10
  %23 = bitcast i8* %22 to double*
  %24 = call i8* @hypre_CAlloc(i64 %21, i64 4, i32 1) #10
  %25 = bitcast i8* %24 to i32*
  %26 = call i8* @hypre_CAlloc(i64 %21, i64 4, i32 1) #10
...
111:                                              ; preds = %108, %107
  ...
  call void @hypre_Free(i8* %24, i32 1) #10
  call void @hypre_Free(i8* %26, i32 1) #10
...
41:                                               ; preds = %11
  ...
  %43 = call i8* @hypre_MAlloc(i64 88, i32 1) #10
  ...
  %51 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #10
...
65:                                               ; preds = %62
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 815, i32 1, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0)) #10
  br label %66
...
131:                                              ; preds = %129
  ...
  %135 = call i8* @hypre_ReAlloc(i8* %132, i64 %134, i32 1) #10
  ...
  %140 = call i8* @hypre_ReAlloc(i8* %136, i64 %139, i32 1) #10
...
166:                                              ; preds = %160
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 972, i32 1, i8* null) #10
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 975, i32 1, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.2, i64 0, i64 0)) #10
  br label %167
...
172:                                              ; preds = %167, %156
  ...
  %175 = call i8* @hypre_MAlloc(i64 88, i32 1) #10
  ...
  %184 = call i8* @hypre_CAlloc(i64 %183, i64 12, i32 1) #10
  ...
  %190 = call i8* @hypre_CAlloc(i64 %189, i64 4, i32 1) #10
...
263:                                              ; preds = %261, %205
  ...
  call void @hypre_Free(i8* %265, i32 1) #10
  store i32* null, i32** %15, align 8, !tbaa !15
...
326:                                              ; preds = %318, %288
  ...
  %330 = call i8* @hypre_CAlloc(i64 %329, i64 4, i32 1) #10
...
500:                                              ; preds = %492, %340
  ...
  %510 = call i8* @hypre_ReAlloc(i8* %507, i64 %509, i32 1) #10
  ...
  %517 = call i8* @hypre_CAlloc(i64 %516, i64 4, i32 1) #10
  %518 = bitcast i8* %517 to i32*
  %519 = load i32, i32* %12, align 4, !tbaa !3
  %520 = sext i32 %519 to i64
  %521 = call i8* @hypre_CAlloc(i64 %520, i64 4, i32 1) #10
  %522 = bitcast i8* %521 to i32*
  %523 = load i32, i32* %12, align 4, !tbaa !3
  %524 = sext i32 %523 to i64
  %525 = call i8* @hypre_CAlloc(i64 %524, i64 4, i32 1) #10
...
719:                                              ; preds = %715, %656
  ...
  call void @hypre_Free(i8* %723, i32 1) #10
  %724 = bitcast i32* %607 to i8*
  call void @hypre_Free(i8* %724, i32 1) #10
  %725 = bitcast i32* %608 to i8*
  call void @hypre_Free(i8* %725, i32 1) #10
  ...
  call void @hypre_Free(i8* %620, i32 1) #10
  store i32* null, i32** %19, align 8, !tbaa !15
  call void @hypre_Free(i8* %623, i32 1) #10
  %750 = load i8*, i8** %748, align 8, !tbaa !15
  call void @hypre_Free(i8* %750, i32 1) #10
  store i32* null, i32** %22, align 8, !tbaa !15
  %751 = bitcast i32** %23 to i8**
  %752 = load i8*, i8** %751, align 8, !tbaa !15
  call void @hypre_Free(i8* %752, i32 1) #10
  store i32* null, i32** %23, align 8, !tbaa !15
  call void @hypre_Free(i8* %615, i32 1) #10
...
declare dso_local i8* @hypre_ReAlloc(i8*, i64, i32) local_unnamed_addr #4
...
define dso_local i32 @hypre_StructAssumedPartitionGetProcsFromBox(%struct.hypre_StructAssumedPart* nocapture readonly %0, %struct.hypre_Box_struct* %1, i32* nocapture %2, i32* nocapture %3, i32** nocapture %4) local_unnamed_addr #3 {
  ...
  %36 = call i8* @hypre_CAlloc(i64 %35, i64 4, i32 1) #10
...
293:                                              ; preds = %289
  ...
  %298 = call i8* @hypre_ReAlloc(i8* %295, i64 %297, i32 1) #10
...
355:                                              ; preds = %351
  ...
  %359 = call i8* @hypre_ReAlloc(i8* %356, i64 %358, i32 1) #10
...
385:                                              ; preds = %381, %361, %347
  ...
  call void @hypre_Free(i8* %36, i32 1) #10
  %391 = bitcast i32* %348 to i8*
  call void @hypre_Free(i8* %391, i32 1) #10
...
32:                                               ; preds = %7
  ...
  %35 = shl nsw i64 %34, 2
  %36 = call i8* @hypre_ReAlloc(i8* %33, i64 %35, i32 1) #10
  %37 = bitcast i8* %36 to i32*
  %38 = bitcast i32* %21 to i8*
  %39 = call i8* @hypre_ReAlloc(i8* %38, i64 %35, i32 1) #10
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* nonnull %25, i32 1) #10
  br label %26

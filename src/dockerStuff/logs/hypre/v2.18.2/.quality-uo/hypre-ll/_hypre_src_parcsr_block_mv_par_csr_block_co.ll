...
define dso_local %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 %0, i32 %1, %struct._hypre_ParCSRCommPkg* %2, i8* %3, i8* %4) local_unnamed_addr #0 {
  ...
  %20 = call i8* @hypre_CAlloc(i64 %19, i64 4, i32 1) #3
...
138:                                              ; preds = %116, %65, %89, %38, %5
  %139 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #3
...
define dso_local i32 @hypre_ParCSRBlockMatrixCreateAssumedPartition(%struct.hypre_ParCSRBlockMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %13 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #3
  ...
  %24 = call i8* @hypre_MAlloc(i64 40, i32 1) #3
  ...
  %29 = shl nsw i64 %28, 2
  %30 = call i8* @hypre_MAlloc(i64 %29, i32 1) #3
  ...
  %35 = shl nsw i64 %34, 2
  %36 = call i8* @hypre_MAlloc(i64 %35, i32 1) #3
...
7:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %10, i32 1) #3
  ...
  call void @hypre_Free(i8* %13, i32 1) #3
  ...
  call void @hypre_Free(i8* %16, i32 1) #3
...
20:                                               ; preds = %7, %1
  ...
  call void @hypre_Free(i8* %21, i32 1) #3
  ret i32 0
}
...
!22 = !{!23, !8, i64 0}
!23 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64}
!24 = !{!23, !8, i64 24}
!25 = !{!23, !8, i64 32}
!26 = !{!23, !5, i64 56}
!27 = !{!23, !8, i64 64}

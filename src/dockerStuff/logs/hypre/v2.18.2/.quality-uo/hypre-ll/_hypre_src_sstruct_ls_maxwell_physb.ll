...
define dso_local i32 @hypre_Maxwell_PhysBdy(%struct.hypre_SStructGrid_struct** nocapture readonly %0, i32 %1, i32* %2, i32*** nocapture %3, i32** nocapture %4) local_unnamed_addr #0 {
  ...
  %46 = shl nsw i64 %41, 3
  %47 = call i8* @hypre_MAlloc(i64 %46, i32 1) #6
...
52:                                               ; preds = %50, %52
  ...
  %94 = call i8* @hypre_CAlloc(i64 %93, i64 4, i32 1) #6
...
101:                                              ; preds = %99
  %102 = call i8* @hypre_CAlloc(i64 %41, i64 8, i32 1) #6
  %103 = bitcast i8* %102 to i32**
  %104 = call i8* @hypre_CAlloc(i64 %41, i64 8, i32 1) #6
...
117:                                              ; preds = %112, %115
  ...
  %131 = call i8* @hypre_CAlloc(i64 %130, i64 4, i32 1) #6
...
182:                                              ; preds = %115, %106
  %183 = call i8* @hypre_MAlloc(i64 %46, i32 1) #6
  %184 = bitcast i8* %183 to %struct.hypre_BoxArrayArray_struct****
  %185 = call i8* @hypre_CAlloc(i64 %41, i64 4, i32 1) #6
...
276:                                              ; preds = %216, %539
  ...
  %306 = call i8* @hypre_MAlloc(i64 %305, i32 1) #6
...
330:                                              ; preds = %314, %349
  ...
  %332 = call i8* @hypre_MAlloc(i64 %311, i32 1) #6
...
549:                                              ; preds = %544
  ...
  call void @hypre_Free(i8* nonnull %550, i32 1) #6
...
556:                                              ; preds = %551
  ...
  call void @hypre_Free(i8* nonnull %557, i32 1) #6
...
561:                                              ; preds = %560
  ...
  call void @hypre_Free(i8* %562, i32 1) #6
  %563 = bitcast i32** %107 to i8*
  call void @hypre_Free(i8* %563, i32 1) #6
  br label %564

564:                                              ; preds = %561, %560
  %565 = call i8* @hypre_MAlloc(i64 %46, i32 1) #6
  %566 = bitcast i8* %565 to i32**
  %567 = shl nsw i64 %41, 2
  %568 = call i8* @hypre_MAlloc(i64 %567, i32 1) #6
...
609:                                              ; preds = %585, %899
  ...
  %628 = call i8* @hypre_MAlloc(i64 %627, i32 1) #6
...
793:                                              ; preds = %779, %609
  ...
  call void @hypre_Free(i8* %797, i32 1) #6
...
857:                                              ; preds = %844, %836
  ...
  %861 = call i8* @hypre_MAlloc(i64 %860, i32 1) #6
...
899:                                              ; preds = %892, %857, %896
  call void @hypre_Free(i8* %628, i32 1) #6
...
905:                                              ; preds = %899, %564
  ...
  call void @hypre_Free(i8* %44, i32 1) #6
  call void @hypre_Free(i8* %42, i32 1) #6
  call void @hypre_Free(i8* %183, i32 1) #6
  call void @hypre_Free(i8* %185, i32 1) #6

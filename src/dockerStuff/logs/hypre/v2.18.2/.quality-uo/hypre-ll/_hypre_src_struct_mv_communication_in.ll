...
define dso_local i32 @hypre_CommInfoCreate(%struct.hypre_BoxArrayArray_struct* %0, %struct.hypre_BoxArrayArray_struct* %1, i32** %2, i32** %3, i32** %4, i32** %5, %struct.hypre_BoxArrayArray_struct* %6, %struct.hypre_BoxArrayArray_struct* %7, i32 %8, %struct.hypre_CommInfo_struct** nocapture %9) local_unnamed_addr #0 {
  %11 = call i8* @hypre_MAlloc(i64 152, i32 1) #8
...
define dso_local i32 @hypre_CommInfoProjectRecv(%struct.hypre_CommInfo_struct* %0, i32* %1, i32* %2) local_unnamed_addr #0 {
  ...
  %6 = call i32 @hypre_ProjectBoxArrayArray(%struct.hypre_BoxArrayArray_struct* %5, i32* %1, i32* %2) #8
  %7 = getelementptr inbounds %struct.hypre_CommInfo_struct, %struct.hypre_CommInfo_struct* %0, i64 0, i32 7, i64 0
  %8 = call i32 @hypre_CopyIndex(i32* %2, i32* nonnull %7) #8
...
19:                                               ; preds = %12, %1
  ...
  call void @hypre_Free(i8* %20, i32 1) #8
...
35:                                               ; preds = %28, %24
  ...
  call void @hypre_Free(i8* nonnull %36, i32 1) #8
  br label %37
...
48:                                               ; preds = %46, %48
  ...
  call void @hypre_Free(i8* %52, i32 1) #8
...
55:                                               ; preds = %48, %44
  ...
  call void @hypre_Free(i8* nonnull %56, i32 1) #8
  br label %57
...
91:                                               ; preds = %84, %80
  ...
  call void @hypre_Free(i8* nonnull %92, i32 1) #8
  br label %93
...
111:                                              ; preds = %104, %100
  ...
  call void @hypre_Free(i8* nonnull %112, i32 1) #8
  br label %113
...
define dso_local i32 @hypre_CreateCommInfoFromStencil(%struct.hypre_StructGrid_struct* nocapture readonly %0, %struct.hypre_StructStencil_struct* nocapture readonly %1, %struct.hypre_CommInfo_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %62 = call i8* @hypre_CAlloc(i64 %61, i64 4, i32 1) #8
...
264:                                              ; preds = %259, %74
  ...
  %268 = call i8* @hypre_CAlloc(i64 %267, i64 8, i32 1) #8
  %269 = bitcast i8* %268 to i32**
  %270 = call i8* @hypre_CAlloc(i64 %267, i64 8, i32 1) #8
  %271 = bitcast i8* %270 to i32**
  %272 = call i8* @hypre_CAlloc(i64 %267, i64 8, i32 1) #8
  %273 = bitcast i8* %272 to i32**
  %274 = call %struct.hypre_BoxArrayArray_struct* @hypre_BoxArrayArrayCreate(i32 %47, i32 %22) #8
  %275 = call i8* @hypre_CAlloc(i64 %267, i64 8, i32 1) #8
  ...
  %287 = call i8* @hypre_CAlloc(i64 30, i64 4, i32 1) #8
  %288 = bitcast i8* %287 to i32*
  %289 = call i8* @hypre_CAlloc(i64 30, i64 4, i32 1) #8
  %290 = bitcast i8* %289 to i32*
  %291 = call i8* @hypre_CAlloc(i64 30, i64 4, i32 1) #8
  ...
  %296 = call i8* @hypre_CAlloc(i64 %295, i64 4, i32 1) #8
  %297 = bitcast i8* %296 to i32*
  %298 = call i8* @hypre_CAlloc(i64 %295, i64 8, i32 1) #8
  %299 = bitcast i8* %298 to %struct.hypre_Box_struct**
  %300 = call i8* @hypre_CAlloc(i64 %295, i64 28, i32 1) #8
...
393:                                              ; preds = %378
  ...
  %398 = call i8* @hypre_ReAlloc(i8* %395, i64 %397, i32 1) #8
  %399 = bitcast i8* %398 to i32*
  %400 = bitcast i32* %381 to i8*
  %401 = call i8* @hypre_ReAlloc(i8* %400, i64 %397, i32 1) #8
  %402 = bitcast i8* %401 to i32*
  %403 = bitcast i32* %382 to i8*
  %404 = call i8* @hypre_ReAlloc(i8* %403, i64 %397, i32 1) #8
...
456:                                              ; preds = %450, %406
  ...
  call void @hypre_Free(i8* %459, i32 1) #8
...
714:                                              ; preds = %711, %264
  ...
  %734 = call i8* @hypre_MAlloc(i64 152, i32 1) #8
...
define dso_local i32 @hypre_CreateCommInfoFromNumGhost(%struct.hypre_StructGrid_struct* nocapture readonly %0, i32* nocapture readonly %1, %struct.hypre_CommInfo_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %17 = call i8* @hypre_CAlloc(i64 %16, i64 12, i32 1) #8
...
30:                                               ; preds = %16, %29, %28
  ...
  %48 = call i8* @hypre_CAlloc(i64 %47, i64 8, i32 1) #8
  %49 = bitcast i8* %48 to i32**
  %50 = load i32, i32* %43, align 8, !tbaa !39
  %51 = sext i32 %50 to i64
  %52 = call i8* @hypre_CAlloc(i64 %51, i64 8, i32 1) #8
...
59:                                               ; preds = %30, %115
  ...
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 4, i32 1) #8

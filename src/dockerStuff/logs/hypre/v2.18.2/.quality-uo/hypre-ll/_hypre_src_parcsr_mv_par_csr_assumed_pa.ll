...
46:                                               ; preds = %32, %44, %37, %7
  ...
  %48 = call i8* @hypre_MAlloc(i64 60, i32 1) #3
...
107:                                              ; preds = %105
  ...
  %113 = call i8* @hypre_ReAlloc(i8* %109, i64 %112, i32 1) #3
...
161:                                              ; preds = %130
  ...
  %167 = call i8* @hypre_ReAlloc(i8* %163, i64 %166, i32 1) #3
...
188:                                              ; preds = %182, %46
  ...
  %192 = call i8* @hypre_CAlloc(i64 %191, i64 4, i32 1) #3
  %193 = bitcast i8* %192 to i32*
  %194 = call i8* @hypre_CAlloc(i64 %191, i64 20, i32 1) #3
...
272:                                              ; preds = %266
  ...
  %277 = call i8* @hypre_ReAlloc(i8* %274, i64 %276, i32 1) #3
  ...
  %282 = call i8* @hypre_ReAlloc(i8* %278, i64 %281, i32 1) #3
  ...
  %287 = call i8* @hypre_ReAlloc(i8* %283, i64 %286, i32 1) #3
...
312:                                              ; preds = %288, %250
  ...
  %320 = call i8* @hypre_CAlloc(i64 %319, i64 4, i32 1) #3
...
338:                                              ; preds = %327, %312
  ...
  call void @hypre_Free(i8* %194, i32 1) #3
  call void @hypre_Free(i8* %192, i32 1) #3
  call void @hypre_Free(i8* %320, i32 1) #3
  %345 = bitcast i32* %190 to i8*
  call void @hypre_Free(i8* %345, i32 1) #3
...
define dso_local %struct.hypre_IJAssumedPart* @hypre_AssumedPartitionCreate(i32 %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  ...
  %9 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #3
  ...
  %35 = call i8* @hypre_MAlloc(i64 40, i32 1) #3
  ...
  %40 = shl nsw i64 %39, 2
  %41 = call i8* @hypre_MAlloc(i64 %40, i32 1) #3
  ...
  %46 = shl nsw i64 %45, 2
  %47 = call i8* @hypre_MAlloc(i64 %46, i32 1) #3
  %48 = getelementptr inbounds i8, i8* %9, i64 32
  %49 = bitcast i8* %48 to i8**
  store i8* %47, i8** %49, align 8, !tbaa !18
  %50 = load i32, i32* %6, align 4, !tbaa !3
  %51 = call i32 @hypre_LocateAssummedPartition(i32 %0, i32 %2, i32 %3, i32 0, i32 %1, %struct.hypre_IJAssumedPart* %10, i32 %50)
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %7) #3
...
define dso_local i32 @hypre_ParCSRMatrixCreateAssumedPartition(%struct.hypre_ParCSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %18 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 25
...
5:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %17, i32 1) #3
...
define dso_local i32 @hypre_ParVectorCreateAssumedPartition(%struct.hypre_ParVector_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %14 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #3
  ...
  %40 = call i8* @hypre_MAlloc(i64 40, i32 1) #3
  ...
  %45 = shl nsw i64 %44, 2
  %46 = call i8* @hypre_MAlloc(i64 %45, i32 1) #3
  ...
  %51 = shl nsw i64 %50, 2
  %52 = call i8* @hypre_MAlloc(i64 %51, i32 1) #3
...
!25 = !{!8, !9, i64 40}
!26 = !{!27, !4, i64 8}
!27 = !{!"hypre_ParCSRMatrix_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !9, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !9, i64 72, !9, i64 80, !9, i64 88, !9, i64 96, !9, i64 104, !4, i64 112, !4, i64 116, !4, i64 120, !4, i64 124, !28, i64 128, !9, i64 136, !9, i64 144, !4, i64 152, !9, i64 160, !4, i64 168, !9, i64 176, !4, i64 184, !9, i64 192, !9, i64 200}
!28 = !{!"double", !5, i64 0}
!29 = !{!27, !4, i64 0}
!30 = !{!27, !9, i64 160}
!31 = !{!32, !4, i64 4}

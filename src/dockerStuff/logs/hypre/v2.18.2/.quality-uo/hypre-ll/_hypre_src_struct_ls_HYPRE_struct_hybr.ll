...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructHybridSetRecomputeResidual(%struct.hypre_StructSolver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to i8*
  %4 = call i32 @hypre_HybridSetRecomputeResidual(i8* %3, i32 %1) #2
  ret i32 %4
}

declare dso_local i32 @hypre_HybridSetRecomputeResidual(i8*, i32) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructHybridGetRecomputeResidual(%struct.hypre_StructSolver_struct* %0, i32* %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to i8*
  %4 = call i32 @hypre_HybridGetRecomputeResidual(i8* %3, i32* %1) #2
  ret i32 %4
}

declare dso_local i32 @hypre_HybridGetRecomputeResidual(i8*, i32*) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructHybridSetRecomputeResidualP(%struct.hypre_StructSolver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to i8*
  %4 = call i32 @hypre_HybridSetRecomputeResidualP(i8* %3, i32 %1) #2
  ret i32 %4
}

declare dso_local i32 @hypre_HybridSetRecomputeResidualP(i8*, i32) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructHybridGetRecomputeResidualP(%struct.hypre_StructSolver_struct* %0, i32* %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to i8*
  %4 = call i32 @hypre_HybridGetRecomputeResidualP(i8* %3, i32* %1) #2
  ret i32 %4
}

declare dso_local i32 @hypre_HybridGetRecomputeResidualP(i8*, i32*) local_unnamed_addr #1

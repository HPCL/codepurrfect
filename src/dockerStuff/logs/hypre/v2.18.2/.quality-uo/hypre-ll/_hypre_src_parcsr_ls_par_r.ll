...
define dso_local i32 @hypre_BoomerAMGBuildCoarseOperatorKT(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParCSRMatrix_struct* %2, i32 %3, %struct.hypre_ParCSRMatrix_struct** nocapture %4) local_unnamed_addr #0 {
  ...
  %30 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 7
  ...
  %38 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 8
  ...
  %60 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 11
  ...
  %68 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 4
  ...
  %74 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 14
...
145:                                              ; preds = %137, %118
  ...
  %153 = call i8* @hypre_MAlloc(i64 %152, i32 1) #4
  %154 = bitcast i8* %153 to i32*
  %155 = call i8* @hypre_MAlloc(i64 %152, i32 1) #4
  ...
  %158 = call i8* @hypre_MAlloc(i64 16, i32 1) #4
...
203:                                              ; preds = %200
  ...
  %205 = call i8* @hypre_CAlloc(i64 %204, i64 4, i32 1) #4
  %206 = bitcast i8* %205 to i32*
  %207 = load i32, i32* %6, align 4, !tbaa !3
  %208 = sext i32 %207 to i64
  %209 = call i8* @hypre_CAlloc(i64 %208, i64 8, i32 1) #4
...
216:                                              ; preds = %211
  ...
  %218 = call i8* @hypre_CAlloc(i64 %217, i64 4, i32 1) #4
  %219 = bitcast i8* %218 to i32*
  %220 = load i32, i32* %7, align 4, !tbaa !3
  %221 = sext i32 %220 to i64
  %222 = call i8* @hypre_CAlloc(i64 %221, i64 4, i32 1) #4
  %223 = bitcast i8* %222 to i32*
  %224 = load i32, i32* %7, align 4, !tbaa !3
  %225 = sext i32 %224 to i64
  %226 = call i8* @hypre_CAlloc(i64 %225, i64 8, i32 1) #4
...
361:                                              ; preds = %358
  ...
  %363 = call i8* @hypre_CAlloc(i64 %362, i64 4, i32 1) #4
...
399:                                              ; preds = %396
  ...
  call void @hypre_Free(i8* %400, i32 1) #4
  br label %401
...
402:                                              ; preds = %401
  ...
  %404 = call i8* @hypre_CAlloc(i64 %403, i64 4, i32 1) #4
...
427:                                              ; preds = %418, %423, %402, %401
  ...
  %429 = call i8* @hypre_CAlloc(i64 1, i64 8, i32 1) #4
  %430 = bitcast i8* %429 to i32**
  %431 = call i8* @hypre_CAlloc(i64 1, i64 8, i32 1) #4
  %432 = bitcast i8* %431 to i32**
  br i1 %108, label %1080, label %433

433:                                              ; preds = %427
  %434 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #4
...
444:                                              ; preds = %433
  ...
  %448 = call i8* @hypre_CAlloc(i64 %447, i64 4, i32 1) #4
...
450:                                              ; preds = %433, %444
  ...
  %452 = call i8* @hypre_CAlloc(i64 %438, i64 4, i32 1) #4
...
662:                                              ; preds = %471, %468
  ...
  %666 = call i8* @hypre_CAlloc(i64 %665, i64 4, i32 1) #4
  %667 = bitcast i8* %666 to i32*
  %668 = sext i32 %663 to i64
  %669 = call i8* @hypre_CAlloc(i64 %668, i64 8, i32 1) #4
  %670 = bitcast i8* %669 to double*
  %671 = call i8* @hypre_CAlloc(i64 %668, i64 4, i32 1) #4
...
1071:                                             ; preds = %1068, %1069
  ...
  store i32 1, i32* %1074, align 4, !tbaa !64
  ...
  call void @hypre_Free(i8* %434, i32 1) #4
  br label %1080
...
1109:                                             ; preds = %1107, %1101
  ...
  %1113 = call i8* @hypre_MAlloc(i64 %1112, i32 2) #4
  %1114 = bitcast i8* %1113 to i32*
  %1115 = call i8* @hypre_MAlloc(i64 %1112, i32 2) #4
...
1119:                                             ; preds = %1109
  ...
  %1122 = call i8* @hypre_CAlloc(i64 %1121, i64 4, i32 1) #4
...
1188:                                             ; preds = %1185
  ...
  %1190 = call i8* @hypre_CAlloc(i64 %1189, i64 4, i32 1) #4
...
1204:                                             ; preds = %1197, %1192
  call void @hypre_Free(i8* %1122, i32 1) #4
  br label %1205
...
1208:                                             ; preds = %1205
  ...
  %1211 = call i8* @hypre_MAlloc(i64 %1210, i32 1) #4
...
1236:                                             ; preds = %1234
  ...
  %1239 = call i8* @hypre_MAlloc(i64 %1238, i32 1) #4
...
1283:                                             ; preds = %1279, %1262
  %1284 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #4
  %1285 = bitcast i8* %1284 to i32*
  %1286 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #4
  %1287 = bitcast i8* %1286 to i32*
  %1288 = add nsw i32 %1206, %71
  %1289 = sext i32 %1288 to i64
  %1290 = call i8* @hypre_CAlloc(i64 %1289, i64 4, i32 1) #4
  %1291 = bitcast i8* %429 to i8**
  store i8* %1290, i8** %1291, align 8, !tbaa !28
  %1292 = sext i32 %131 to i64
  %1293 = call i8* @hypre_CAlloc(i64 %1292, i64 4, i32 1) #4
...
1606:                                             ; preds = %1598
  ...
  %1608 = call i8* @hypre_CAlloc(i64 %1607, i64 8, i32 2) #4
  %1609 = bitcast i8* %1608 to double*
  %1610 = call i8* @hypre_CAlloc(i64 %1607, i64 4, i32 2) #4
...
1616:                                             ; preds = %1612
  ...
  %1618 = call i8* @hypre_CAlloc(i64 %1617, i64 8, i32 2) #4
  %1619 = bitcast i8* %1618 to double*
  %1620 = call i8* @hypre_CAlloc(i64 %1617, i64 4, i32 2) #4
...
1627:                                             ; preds = %1622
  ...
  call void @hypre_Free(i8* %1628, i32 1) #4
  br label %1629
...
1629:                                             ; preds = %1627, %1622
  ...
  %1634 = call i8* @hypre_MAlloc(i64 %1633, i32 1) #4
  %1635 = bitcast i8* %1634 to double*
  %1636 = shl nsw i64 %1632, 2
  %1637 = call i8* @hypre_MAlloc(i64 %1636, i32 1) #4
...
1640:                                             ; preds = %1629
  ...
  %1643 = call i8* @hypre_MAlloc(i64 %1642, i32 1) #4
  %1644 = bitcast i8* %1643 to double*
  %1645 = shl nsw i64 %1641, 2
  %1646 = call i8* @hypre_MAlloc(i64 %1645, i32 1) #4
...
2103:                                             ; preds = %1679, %1675
  ...
  call void @hypre_Free(i8* %2104, i32 1) #4
  store i32* null, i32** %430, align 8, !tbaa !28
  %2105 = load i8*, i8** %1295, align 8, !tbaa !28
  call void @hypre_Free(i8* %2105, i32 1) #4
  store i32* null, i32** %432, align 8, !tbaa !28
  %2106 = sext i32 %1630 to i64
  %2107 = call i8* @hypre_CAlloc(i64 %2106, i64 4, i32 1) #4
...
2135:                                             ; preds = %2132
  ...
  %2137 = call i8* @hypre_CAlloc(i64 %2136, i64 4, i32 1) #4
...
2173:                                             ; preds = %2171, %2132
  ...
  %2179 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2176, i64 0, i32 7
...
2185:                                             ; preds = %2182, %2173
  %2186 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2176, i64 0, i32 8
...
2190:                                             ; preds = %2185
  ...
  %2193 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2176, i64 0, i32 11
...
2202:                                             ; preds = %2199
  %2203 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 9
...
2209:                                             ; preds = %2207
  %2210 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 10
...
2217:                                             ; preds = %2214, %2215
  call void @hypre_Free(i8* %429, i32 1) #4
  call void @hypre_Free(i8* %431, i32 1) #4
  call void @hypre_Free(i8* %153, i32 1) #4
  call void @hypre_Free(i8* %155, i32 1) #4
  call void @hypre_Free(i8* %1284, i32 1) #4
  call void @hypre_Free(i8* %1286, i32 1) #4
...
2218:                                             ; preds = %2217
  ...
  call void @hypre_Free(i8* %2220, i32 1) #4
  br label %2221
...
2222:                                             ; preds = %2221
  ...
  call void @hypre_Free(i8* %2223, i32 1) #4
...
2228:                                             ; preds = %2225
  ...
  call void @hypre_Free(i8* %2229, i32 1) #4
...
2234:                                             ; preds = %2231
  ...
  call void @hypre_Free(i8* %2235, i32 1) #4
  %2236 = bitcast i32* %230 to i8*
  call void @hypre_Free(i8* %2236, i32 1) #4
  br label %2237

2237:                                             ; preds = %2234, %2231
  call void @hypre_Free(i8* %1634, i32 1) #4
  call void @hypre_Free(i8* %1637, i32 1) #4
  br i1 %1639, label %2239, label %2238

2238:                                             ; preds = %2237
  call void @hypre_Free(i8* %1652, i32 1) #4
  call void @hypre_Free(i8* %1651, i32 1) #4
  br label %2239
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !4, i64 0}
!8 = !{!"hypre_ParCSRMatrix_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !9, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !9, i64 72, !9, i64 80, !9, i64 88, !9, i64 96, !9, i64 104, !4, i64 112, !4, i64 116, !4, i64 120, !4, i64 124, !10, i64 128, !9, i64 136, !9, i64 144, !4, i64 152, !9, i64 160, !4, i64 168, !9, i64 176, !4, i64 184, !9, i64 192, !9, i64 200}
!9 = !{!"any pointer", !5, i64 0}
!10 = !{!"double", !5, i64 0}
!11 = !{!8, !9, i64 32}
!12 = !{!8, !9, i64 40}
!13 = !{!14, !4, i64 28}
!14 = !{!"", !9, i64 0, !9, i64 8, !9, i64 16, !4, i64 24, !4, i64 28, !4, i64 32, !9, i64 40, !9, i64 48, !4, i64 56, !9, i64 64, !9, i64 72, !4, i64 80, !4, i64 84}
!15 = !{!14, !4, i64 24}
!16 = !{!8, !9, i64 96}
!17 = !{!14, !9, i64 64}
!18 = !{!14, !9, i64 0}

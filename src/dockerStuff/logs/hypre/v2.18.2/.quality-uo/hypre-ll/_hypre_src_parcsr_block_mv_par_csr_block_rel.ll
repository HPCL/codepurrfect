...
1875:                                             ; preds = %70
  ...
  %1879 = icmp eq i32 %36, 0
  br i1 %1879, label %1959, label %1880

1880:                                             ; preds = %1875
  %1881 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixToCSRMatrixAll(%struct.hypre_ParCSRMatrix_struct* %1876) #5
  %1882 = call %struct.hypre_Vector* @hypre_ParVectorToVectorAll(%struct.hypre_ParVector_struct* %1) #5
  %1883 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1881, i64 0, i32 0
  %1884 = load i32*, i32** %1883, align 8, !tbaa !124
  %1885 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1881, i64 0, i32 1
  %1886 = load i32*, i32** %1885, align 8, !tbaa !126
  %1887 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1881, i64 0, i32 9
  %1888 = load double*, double** %1887, align 8, !tbaa !127
  %1889 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %1882, i64 0, i32 0
...
1956:                                             ; preds = %1953, %1930
  ...
  %1957 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %1881) #5
  %1958 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %1882) #5
  br label %1959

1959:                                             ; preds = %1956, %1875
  %1960 = phi i32 [ %1931, %1956 ], [ 0, %1875 ]
  %1961 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %1876) #5
  br label %1962

1962:                                             ; preds = %1870, %1873, %915, %918, %369, %372, %70, %1959
  %1963 = phi i32 [ 0, %70 ], [ %1960, %1959 ], [ 0, %1873 ], [ 0, %1870 ], [ 0, %918 ], [ 0, %915 ], [ 0, %372 ], [ 0, %369 ]
...
!26 = !{!25, !12, i64 32}
!27 = !{!28, !12, i64 0}
!28 = !{!"", !12, i64 0, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28, !4, i64 32}
!29 = !{!30, !4, i64 4}
...
!122 = !{!123, !4, i64 4}
!123 = !{!"hypre_ParCSRMatrix_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !12, i64 32, !12, i64 40, !12, i64 48, !12, i64 56, !12, i64 64, !12, i64 72, !12, i64 80, !12, i64 88, !12, i64 96, !12, i64 104, !4, i64 112, !4, i64 116, !4, i64 120, !4, i64 124, !13, i64 128, !12, i64 136, !12, i64 144, !4, i64 152, !12, i64 160, !4, i64 168, !12, i64 176, !4, i64 184, !12, i64 192, !12, i64 200}
!124 = !{!125, !12, i64 0}
!125 = !{!"", !12, i64 0, !12, i64 8, !12, i64 16, !4, i64 24, !4, i64 28, !4, i64 32, !12, i64 40, !12, i64 48, !4, i64 56, !12, i64 64, !12, i64 72, !4, i64 80, !4, i64 84}
!126 = !{!125, !12, i64 8}
!127 = !{!125, !12, i64 64}

...
56:                                               ; preds = %54, %7
  ...
  %58 = call i32* @hypre_idx_malloc_init(i32 %57, i32 -1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0)) #7
...
64:                                               ; preds = %62, %56
  ...
  %66 = call i32* @hypre_idx_malloc_init(i32 %65, i32 -1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0)) #7
...
72:                                               ; preds = %70, %64
  ...
  %74 = call i32* @hypre_idx_malloc(i32 %73, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i64 0, i64 0)) #7
...
80:                                               ; preds = %78, %72
  ...
  %82 = call double* @hypre_fp_malloc(i32 %81, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0)) #7
  ...
  %93 = call i32 @hypre_MPI_Allreduce(i8* %89, i8* %86, i32 %90, i32 1275069445, i32 1476395015, i32 %92) #7
  call void @hypre_Free(i8* %89) #7
  store i32* null, i32** %11, align 8, !tbaa !33
  %94 = load i32, i32* %21, align 4, !tbaa !13
  %95 = sext i32 %94 to i64
  %96 = shl nsw i64 %95, 2
  %97 = call i8* @hypre_MAlloc(i64 %96) #7
  ...
  call void @hypre_memcpy_int(i32* %98, i32* %101, i64 %103) #7
...
115:                                              ; preds = %113, %296
  ...
  %125 = call i32 @HYPRE_DistributedMatrixGetRow(i8* %1, i32 %124, i32* nonnull %8, i32** nonnull %9, double** nonnull %10) #7
...
200:                                              ; preds = %190, %187
  ...
  %203 = call i32 @HYPRE_DistributedMatrixRestoreRow(i8* %1, i32 %202, i32* nonnull %8, i32** nonnull %9, double** nonnull %10) #7
...
208:                                              ; preds = %200, %229
  %209 = call i32 @hypre_ExtractMinLR(%struct.hypre_PilutSolverGlobals* %6) #7
...
301:                                              ; preds = %296, %80
  ...
  %303 = call i32* @hypre_idx_malloc(i32 %108, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.4, i64 0, i64 0)) #7
  %304 = getelementptr inbounds %struct.reducematdef, %struct.reducematdef* %3, i64 0, i32 0
  store i32* %303, i32** %304, align 8, !tbaa !44
  %305 = call i32* @hypre_idx_malloc(i32 %108, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5, i64 0, i64 0)) #7
  %306 = getelementptr inbounds %struct.reducematdef, %struct.reducematdef* %3, i64 0, i32 1
  store i32* %305, i32** %306, align 8, !tbaa !46
  %307 = shl i32 %108, 3
  %308 = call i8* @hypre_mymalloc(i32 %307, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.6, i64 0, i64 0)) #7
  ...
  %311 = call i8* @hypre_mymalloc(i32 %307, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.7, i64 0, i64 0)) #7
...
323:                                              ; preds = %321, %512
  ...
  %333 = call i32 @HYPRE_DistributedMatrixGetRow(i8* %1, i32 %332, i32* nonnull %8, i32** nonnull %9, double** nonnull %10) #7
...
411:                                              ; preds = %401, %398
  ...
  %414 = call i32 @HYPRE_DistributedMatrixRestoreRow(i8* %1, i32 %413, i32* nonnull %8, i32** nonnull %9, double** nonnull %10) #7
...
418:                                              ; preds = %411, %439
  %419 = call i32 @hypre_ExtractMinLR(%struct.hypre_PilutSolverGlobals* %6) #7
...
465:                                              ; preds = %459
  ...
  call void @hypre_CheckBounds(i32 %466, i32 %454, i32 %467, %struct.hypre_PilutSolverGlobals* %6) #7
...
define dso_local i32 @hypre_FindStructuralUnion(i8* %0, i32** nocapture %1, %struct.hypre_PilutSolverGlobals* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %11 = call i8* @hypre_CAlloc(i64 %10, i64 4) #7
...
18:                                               ; preds = %3, %44
  ...
  %22 = call i32 @HYPRE_DistributedMatrixGetRow(i8* %0, i32 %21, i32* nonnull %4, i32** nonnull %5, double** null) #7
...
44:                                               ; preds = %39, %18
  ...
  %47 = call i32 @HYPRE_DistributedMatrixRestoreRow(i8* %0, i32 %46, i32* nonnull %4, i32** nonnull %5, double** null) #7
...
define dso_local i32 @hypre_ExchangeStructuralUnions(%struct.distdef* nocapture readnone %0, i32** nocapture %1, %struct.hypre_PilutSolverGlobals* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %14 = call i32 @hypre_MPI_Allreduce(i8* %10, i8* %7, i32 %11, i32 1275069445, i32 1476395015, i32 %13) #7
  %15 = load i8*, i8** %9, align 8, !tbaa !33
  call void @hypre_Free(i8* %15) #7
  ...
  %19 = shl nsw i64 %18, 2
  %20 = call i8* @hypre_MAlloc(i64 %19) #7
  ...
  call void @hypre_memcpy_int(i32* %21, i32* %25, i64 %27) #7
...
33:                                               ; preds = %18
  ...
  %37 = call i32 @HYPRE_DistributedMatrixGetRow(i8* %1, i32 %36, i32* nonnull %7, i32** nonnull %8, double** nonnull %9) #7
...
67:                                               ; preds = %61, %33
  ...
  %73 = call i32 @HYPRE_DistributedMatrixRestoreRow(i8* %1, i32 %72, i32* nonnull %7, i32** nonnull %8, double** nonnull %9) #7
...
38:                                               ; preds = %26
  %39 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([44 x i8], [44 x i8]* @.str.8, i64 0, i64 0), i32 %2)
  br label %40
...
162:                                              ; preds = %83, %160, %155, %145
  ...
  %165 = call i32 @hypre_DoubleQuickSplit(double* nonnull %53, i32* nonnull %47, i32 %164, i32 %0) #7
...
197:                                              ; preds = %182, %162
  ...
  %205 = call i32 @hypre_DoubleQuickSplit(double* %200, i32* %202, i32 %204, i32 %0) #7
...
178:                                              ; preds = %69, %176, %171, %165, %161, %153
  ...
  %188 = call i32 @hypre_DoubleQuickSplit(double* nonnull %183, i32* nonnull %186, i32 %187, i32 %0) #7
...
220:                                              ; preds = %205, %178
  ...
  %230 = call i32* @hypre_idx_malloc(i32 %225, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.9, i64 0, i64 0)) #7
  ...
  %234 = call double* @hypre_fp_malloc(i32 %225, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.10, i64 0, i64 0)) #7

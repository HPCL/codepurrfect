...
define dso_local i32 @HYPRE_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %0, i32* nocapture readonly %1, i32* nocapture readonly %2, double* %3) local_unnamed_addr #0 {
  ...
  %10 = call i32 @hypre_SetIndex(i32* nonnull %9, i32 0) #3
  %11 = getelementptr inbounds [3 x i32], [3 x i32]* %6, i64 0, i64 0
  %12 = call i32 @hypre_SetIndex(i32* nonnull %11, i32 0) #3
  %13 = getelementptr inbounds %struct.hypre_StructVector_struct, %struct.hypre_StructVector_struct* %0, i64 0, i32 1
  %14 = load %struct.hypre_StructGrid_struct*, %struct.hypre_StructGrid_struct** %13, align 8, !tbaa !11
...
18:                                               ; preds = %4, %18
  ...
  %22 = getelementptr inbounds [3 x i32], [3 x i32]* %5, i64 0, i64 %19
  store i32 %21, i32* %22, align 4, !tbaa !7
  %23 = getelementptr inbounds i32, i32* %2, i64 %19
  %24 = load i32, i32* %23, align 4, !tbaa !7
  %25 = getelementptr inbounds [3 x i32], [3 x i32]* %6, i64 0, i64 %19
  store i32 %24, i32* %25, align 4, !tbaa !7
  %26 = add nuw nsw i64 %19, 1
  %27 = load i32, i32* %15, align 4, !tbaa !13
  %28 = sext i32 %27 to i64
  %29 = icmp slt i64 %26, %28
  br i1 %29, label %18, label %30, !llvm.loop !18

30:                                               ; preds = %18, %4
  %31 = phi i32 [ %16, %4 ], [ %27, %18 ]
  %32 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %31) #3
  %33 = call i32 @hypre_BoxSetExtents(%struct.hypre_Box_struct* %32, i32* nonnull %9, i32* nonnull %11) #3
  %34 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %0, %struct.hypre_Box_struct* %32, %struct.hypre_Box_struct* %32, double* %3, i32 0, i32 -1, i32 0) #3
  %35 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %32) #3
  %36 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
...
18:                                               ; preds = %4, %18
  ...
  %28 = sext i32 %27 to i64
  %29 = icmp slt i64 %26, %28
  br i1 %29, label %18, label %30, !llvm.loop !20

30:                                               ; preds = %18, %4
  %31 = phi i32 [ %16, %4 ], [ %27, %18 ]
  %32 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %31) #3
  %33 = call i32 @hypre_BoxSetExtents(%struct.hypre_Box_struct* %32, i32* nonnull %9, i32* nonnull %11) #3
  %34 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %0, %struct.hypre_Box_struct* %32, %struct.hypre_Box_struct* %32, double* %3, i32 1, i32 -1, i32 0) #3
  %35 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %32) #3
  %36 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %8) #3
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %7) #3
...
18:                                               ; preds = %4, %18
  ...
  %28 = sext i32 %27 to i64
  %29 = icmp slt i64 %26, %28
  br i1 %29, label %18, label %30, !llvm.loop !22

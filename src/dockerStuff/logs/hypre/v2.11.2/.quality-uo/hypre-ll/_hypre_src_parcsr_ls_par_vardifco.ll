...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateVarDifConv(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, double %10, %struct.hypre_ParVector_struct** nocapture %11) local_unnamed_addr #0 {
  ...
  %34 = call i8* @hypre_CAlloc(i64 %33, i64 4) #4
...
95:                                               ; preds = %44, %12
  ...
  %131 = call i8* @hypre_CAlloc(i64 %130, i64 4) #4
  %132 = bitcast i8* %131 to i32*
  %133 = call i8* @hypre_CAlloc(i64 %130, i64 4) #4
  %134 = bitcast i8* %133 to i32*
  %135 = sext i32 %128 to i64
  %136 = call i8* @hypre_CAlloc(i64 %135, i64 8) #4
...
312:                                              ; preds = %300
  ...
  %316 = call i8* @hypre_CAlloc(i64 %315, i64 4) #4
...
906:                                              ; preds = %903, %880, %866
  %907 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %0, i32 %26, i32* nonnull %35) #4
  %908 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %907, i64 0, i32 6
  %909 = bitcast %struct.hypre_Vector** %908 to i8***
  %910 = load i8**, i8*** %909, align 8, !tbaa !25
  store i8* %136, i8** %910, align 8, !tbaa !27
  %911 = load i32, i32* %17, align 4, !tbaa !3
  %912 = sext i32 %911 to i64
  %913 = getelementptr inbounds i32, i32* %35, i64 %912
  %914 = load i32, i32* %913, align 4, !tbaa !3
  %915 = add nsw i32 %911, 1
  %916 = sext i32 %915 to i64
  %917 = getelementptr inbounds i32, i32* %35, i64 %916
  %918 = load i32, i32* %917, align 4, !tbaa !3
  call void @hypre_Free(i8* %34) #4
  %919 = call i8* @hypre_CAlloc(i64 2, i64 4) #4
  %920 = bitcast i8* %919 to i32*
  store i32 %914, i32* %920, align 4, !tbaa !3
  %921 = getelementptr inbounds i8, i8* %919, i64 4
  %922 = bitcast i8* %921 to i32*
  store i32 %918, i32* %922, align 4, !tbaa !3
  %923 = load i32, i32* %301, align 4, !tbaa !3
  %924 = getelementptr inbounds i32, i32* %134, i64 %135
  %925 = load i32, i32* %924, align 4, !tbaa !3
  %926 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %0, i32 %26, i32 %26, i32* nonnull %920, i32* nonnull %920, i32 %167, i32 %923, i32 %925) #4
  %927 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %926, i64 0, i32 11
  %928 = bitcast i32** %927 to i8**
  store i8* %169, i8** %928, align 8, !tbaa !29
  %929 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %926, i64 0, i32 7
  %930 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %929, align 8, !tbaa !31
  %931 = bitcast %struct.hypre_CSRMatrix* %930 to i8**
  store i8* %131, i8** %931, align 8, !tbaa !32
  %932 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %930, i64 0, i32 1
  %933 = bitcast i32** %932 to i8**
  store i8* %304, i8** %933, align 8, !tbaa !34
  %934 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %930, i64 0, i32 6
  %935 = bitcast double** %934 to i8**
  store i8* %308, i8** %935, align 8, !tbaa !35
  %936 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %926, i64 0, i32 8
  %937 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %936, align 8, !tbaa !36
  %938 = bitcast %struct.hypre_CSRMatrix* %937 to i8**
  store i8* %133, i8** %938, align 8, !tbaa !32
  %939 = icmp eq i32 %167, 0
  br i1 %939, label %943, label %940

940:                                              ; preds = %906
  %941 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %937, i64 0, i32 1
  store i32* %324, i32** %941, align 8, !tbaa !34
  %942 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %937, i64 0, i32 6
  store double* %323, double** %942, align 8, !tbaa !35
  br label %943

943:                                              ; preds = %940, %906
  %944 = bitcast i32** %13 to i8**
  %945 = load i8*, i8** %944, align 8, !tbaa !12
  call void @hypre_Free(i8* %945) #4
  store i32* null, i32** %13, align 8, !tbaa !12
  %946 = bitcast i32** %14 to i8**
  %947 = load i8*, i8** %946, align 8, !tbaa !12
  call void @hypre_Free(i8* %947) #4
  store i32* null, i32** %14, align 8, !tbaa !12
  %948 = bitcast i32** %15 to i8**
  %949 = load i8*, i8** %948, align 8, !tbaa !12
  call void @hypre_Free(i8* %949) #4
  store i32* null, i32** %15, align 8, !tbaa !12
  store %struct.hypre_ParVector_struct* %907, %struct.hypre_ParVector_struct** %11, align 8, !tbaa !12
  ...
  ret %struct.hypre_ParCSRMatrix_struct* %926
}
...
!27 = !{!28, !13, i64 0}
!28 = !{!"", !13, i64 0, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28}
!29 = !{!30, !13, i64 64}
!30 = !{!"hypre_ParCSRMatrix_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !13, i64 32, !13, i64 40, !13, i64 48, !13, i64 56, !13, i64 64, !13, i64 72, !13, i64 80, !13, i64 88, !13, i64 96, !4, i64 104, !4, i64 108, !4, i64 112, !4, i64 116, !20, i64 120, !13, i64 128, !13, i64 136, !4, i64 144, !13, i64 152}
!31 = !{!30, !13, i64 32}
!32 = !{!33, !13, i64 0}
!33 = !{!"", !13, i64 0, !13, i64 8, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28, !13, i64 32, !13, i64 40, !4, i64 48}
!34 = !{!33, !13, i64 8}
!35 = !{!33, !13, i64 32}
!36 = !{!30, !13, i64 40}

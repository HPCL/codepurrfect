...
define dso_local i32 @hypre_ParCSRMatrixClone(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct** nocapture %1, i32 %2) local_unnamed_addr #0 {
  ...
  %25 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %5, i32 %17, i32 %17, i32* %15, i32* %15, i32 %19, i32 %22, i32 %24) #8
  %26 = call i32 @hypre_ParCSRMatrixSetRowStartsOwner(%struct.hypre_ParCSRMatrix_struct* %25, i32 0) #8
  %27 = call i32 @hypre_ParCSRMatrixInitialize(%struct.hypre_ParCSRMatrix_struct* %25) #8
  %28 = call i32 @hypre_ParCSRMatrixCopy(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %25, i32 %2) #8
...
71:                                               ; preds = %68, %6
  ...
  %82 = call i8* @hypre_CAlloc(i64 %81, i64 8) #8
  %83 = bitcast i8* %82 to double*
  %84 = mul nsw i32 %73, %0
  %85 = sext i32 %84 to i64
  %86 = call i8* @hypre_CAlloc(i64 %85, i64 8) #8
...
132:                                              ; preds = %103, %95
  ...
  %134 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %8, i8* %82, i8* %133) #8
  %135 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %134) #8
...
142:                                              ; preds = %140
  ...
  %144 = call i8* @hypre_CAlloc(i64 %143, i64 4) #8
  ...
  %150 = call i8* @hypre_CAlloc(i64 %149, i64 4) #8
...
189:                                              ; preds = %159, %142
  %190 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %8, i8* %150, i8* %144) #8
  %191 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %190) #8
  call void @hypre_Free(i8* %150) #8
  br label %192
...
73:                                               ; preds = %71, %1
  %74 = call i32 @hypre_MPI_Allreduce(i8* nonnull %20, i8* nonnull %21, i32 1, i32 1275070475, i32 1476395010, i32 %5) #8
...
41:                                               ; preds = %39, %2
  ...
  %47 = call i8* @hypre_CAlloc(i64 %42, i64 4) #8
  %48 = bitcast i8* %47 to i32*
  %49 = call i8* @hypre_CAlloc(i64 %42, i64 8) #8
...
113:                                              ; preds = %111, %88
  ...
  %115 = call i8* @hypre_CAlloc(i64 %44, i64 4) #8
  %116 = bitcast i8* %115 to i32*
  %117 = call i8* @hypre_CAlloc(i64 %114, i64 4) #8
  %118 = bitcast i8* %117 to i32*
  %119 = call i8* @hypre_CAlloc(i64 %114, i64 8) #8
...
158:                                              ; preds = %124, %113
  ...
  call void @hypre_Free(i8* %162) #8
  %163 = bitcast i32* %16 to i8*
  call void @hypre_Free(i8* %163) #8
  %164 = bitcast double* %18 to i8*
  call void @hypre_Free(i8* %164) #8
...
define dso_local i32 @hypre_BoomerAMGCreateSmoothVecs(i8* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, i32 %2, i32 %3, double** nocapture %4) local_unnamed_addr #0 {
  ...
  %18 = getelementptr inbounds i8, i8* %0, i64 668
  %19 = bitcast i8* %18 to i32*
  %20 = load i32, i32* %19, align 4, !tbaa !53
  %21 = getelementptr inbounds i8, i8* %0, i64 964
...
25:                                               ; preds = %5
  %26 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %1) #8
  br label %27
...
29:                                               ; preds = %27
  %30 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @.str, i64 0, i64 0), i32 %2, i32 %20)
  br label %31
...
46:                                               ; preds = %36, %31
  ...
  %54 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %7, i32 %13, i32* %17) #8
  %55 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %54, i32 0) #8
  %56 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %54) #8
...
65:                                               ; preds = %58, %46
  %66 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %7, i32 %13, i32* %17) #8
  %67 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %66, i32 0) #8
  %68 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %66) #8
...
77:                                               ; preds = %70, %65
  %78 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %7, i32 %13, i32* %17) #8
  %79 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %78, i32 0) #8
  %80 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %78) #8
  ...
  %86 = sext i32 %85 to i64
  %87 = call i8* @hypre_CAlloc(i64 %86, i64 8) #8
...
99:                                               ; preds = %95, %131
  %100 = phi i32 [ %133, %131 ], [ 0, %95 ]
  %101 = phi double* [ %132, %131 ], [ %96, %95 ]
...
103:                                              ; preds = %99, %103
  %104 = phi i64 [ %110, %103 ], [ 0, %99 ]
  %105 = call i32 @rand() #8
  %106 = sitofp i32 %105 to double
  %107 = fdiv double %106, 0x41DFFFFFFFC00000
  %108 = fadd double %107, -5.000000e-01
  %109 = getelementptr inbounds double, double* %84, i64 %104
  store double %108, double* %109, align 8, !tbaa !22
  %110 = add nuw nsw i64 %104, 1
  %111 = icmp eq i64 %110, %97
  br i1 %111, label %102, label %103, !llvm.loop !65

112:                                              ; preds = %120, %102
  br i1 %93, label %123, label %131

113:                                              ; preds = %102, %120
  %114 = phi i32 [ %121, %120 ], [ 0, %102 ]
  br i1 %89, label %115, label %118

115:                                              ; preds = %113
  %116 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %91, align 8, !tbaa !18
  %117 = call i32 @HYPRE_SchwarzSolve(%struct.hypre_Solver_struct* %116, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %54, %struct.hypre_ParVector_struct* %78) #8
  br label %120

118:                                              ; preds = %113
  %119 = call i32 @hypre_BoomerAMGRelax(%struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %54, i32* null, i32 %53, i32 0, double 1.000000e+00, double 1.000000e+00, double* null, %struct.hypre_ParVector_struct* %78, %struct.hypre_ParVector_struct* %66, %struct.hypre_ParVector_struct* null) #8
  br label %120

120:                                              ; preds = %115, %118
  %121 = add nuw nsw i32 %114, 1
  %122 = icmp eq i32 %121, %49
  br i1 %122, label %112, label %113, !llvm.loop !66

123:                                              ; preds = %112, %123
  %124 = phi i64 [ %129, %123 ], [ 0, %112 ]
  %125 = phi double* [ %128, %123 ], [ %101, %112 ]
  %126 = getelementptr inbounds double, double* %84, i64 %124
  %127 = load double, double* %126, align 8, !tbaa !22
  %128 = getelementptr inbounds double, double* %125, i64 1
  store double %127, double* %125, align 8, !tbaa !22
  %129 = add nuw nsw i64 %124, 1
  %130 = icmp eq i64 %129, %98
  br i1 %130, label %131, label %123, !llvm.loop !67

131:                                              ; preds = %123, %112
  %132 = phi double* [ %101, %112 ], [ %128, %123 ]
  %133 = add nuw nsw i32 %100, 1
  %134 = icmp eq i32 %133, %20
  br i1 %134, label %135, label %99, !llvm.loop !68

135:                                              ; preds = %131, %77
  %136 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %54) #8
  %137 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %66) #8
  %138 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %78) #8
  %139 = bitcast double** %4 to i8**
  store i8* %87, i8** %139, align 8, !tbaa !18
  ret i32 0
}
...
define dso_local i32 @hypre_BoomerAMGCreateSmoothDirs(i8* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, double* nocapture %2, double %3, i32 %4, i32* nocapture readonly %5, %struct.hypre_ParCSRMatrix_struct** nocapture %6) local_unnamed_addr #0 {
  %8 = getelementptr inbounds i8, i8* %0, i64 964
  ...
  %31 = load i32, i32* %30, align 4, !tbaa !17
  %32 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %12, i32 %24, i32 %24, i32* %22, i32* %22, i32 %26, i32 %29, i32 %31) #8
  %33 = call i32 @hypre_ParCSRMatrixSetRowStartsOwner(%struct.hypre_ParCSRMatrix_struct* %32, i32 0) #8
  %34 = call i32 @hypre_ParCSRMatrixInitialize(%struct.hypre_ParCSRMatrix_struct* %32) #8
  %35 = call i32 @hypre_ParCSRMatrixCopy(%struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParCSRMatrix_struct* %32, i32 0) #8
  %36 = getelementptr inbounds i8, i8* %0, i64 668
...
42:                                               ; preds = %7
  %43 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0), double %40)
  br label %44
...
define dso_local i32 @hypre_BoomerAMGNormalizeVecs(i32 %0, i32 %1, double* nocapture %2) local_unnamed_addr #5 {
  %4 = icmp sgt i32 %0, 0
...
19:                                               ; preds = %7
  ...
  %20 = call i8* @hypre_CAlloc(i64 128000, i64 8) #8
  %21 = bitcast i8* %20 to double*
  %22 = load i32, i32* %8, align 4, !tbaa !17
  %23 = load i32, i32* %9, align 4, !tbaa !17
  %24 = mul nsw i32 %23, %22
  %25 = sext i32 %24 to i64
  %26 = call i8* @hypre_CAlloc(i64 %25, i64 8) #8
...
79:                                               ; preds = %70, %57
  ...
  %81 = call i32 @hypre_dgels(i8* nonnull %13, i32* nonnull %8, i32* nonnull %9, i32* nonnull %14, double* %27, i32* nonnull %8, double* %63, i32* nonnull %12, double* %21, i32* nonnull %10, i32* nonnull %11) #8
  %82 = load i32, i32* %11, align 4, !tbaa !17
  %83 = icmp eq i32 %82, 0
  br i1 %83, label %85, label %84

84:                                               ; preds = %79
  call void @hypre_error_handler(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i64 0, i64 0), i32 746, i32 1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i64 0, i64 0)) #8
  br label %85
...
define dso_local i32 @hypre_BoomerAMGBuildInterpLS(%struct.hypre_ParCSRMatrix_struct* nocapture readnone %0, i32* nocapture readonly %1, %struct.hypre_ParCSRMatrix_struct* %2, i32* %3, i32 %4, i32* nocapture readonly %5, i32 %6, double %7, i32 %8, double* nocapture readonly %9, %struct.hypre_ParCSRMatrix_struct** nocapture %10) local_unnamed_addr #0 {
  ...
  %33 = call i32 @hypre_MPI_Comm_size(i32 %16, i32* nonnull %13) #8
  %34 = call i32 @hypre_MPI_Comm_rank(i32 %16, i32* nonnull %12) #8
...
44:                                               ; preds = %11
  %45 = call double @time_getWallclockSeconds() #8
  br label %46

46:                                               ; preds = %44, %11
  %47 = phi double [ %45, %44 ], [ undef, %11 ]
  %48 = sext i32 %28 to i64
  %49 = call i8* @hypre_CAlloc(i64 %48, i64 4) #8
  %50 = icmp sgt i32 %4, 1
  %51 = icmp ne i32 %28, 0
...
53:                                               ; preds = %46
  %54 = call i8* @hypre_CAlloc(i64 %48, i64 4) #8
  br label %55
...
58:                                               ; preds = %55
  %59 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %2) #8
...
110:                                              ; preds = %80, %61
  %111 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %62, i8* %71, i8* %49) #8
  %112 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %111) #8
...
151:                                              ; preds = %121, %113
  %152 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %62, i8* %71, i8* %56) #8
  %153 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %152) #8
  br label %154
...
155:                                              ; preds = %154
  %156 = call double @time_getWallclockSeconds() #8
  %157 = fsub double %156, %47
  %158 = load i32, i32* %12, align 4, !tbaa !17
  %159 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([48 x i8], [48 x i8]* @.str.4, i64 0, i64 0), i32 %158, double %157)
...
163:                                              ; preds = %161
  %164 = call double @time_getWallclockSeconds() #8
  br label %165
...
169:                                              ; preds = %165
  %170 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixExtractBExt(%struct.hypre_ParCSRMatrix_struct* %2, %struct.hypre_ParCSRMatrix_struct* %2, i32 1) #8
  br label %171
...
173:                                              ; preds = %171
  %174 = call double @time_getWallclockSeconds() #8
  %175 = fsub double %174, %166
  %176 = load i32, i32* %12, align 4, !tbaa !17
  %177 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @.str.5, i64 0, i64 0), i32 %176, double %175)
  %178 = call i32 @fflush(%struct._IO_FILE* null)
  br label %179

179:                                              ; preds = %173, %171
  %180 = phi double [ %175, %173 ], [ %166, %171 ]
  %181 = call i8* @hypre_CAlloc(i64 1, i64 4) #8
  %182 = bitcast i8* %181 to i32*
  %183 = call i8* @hypre_CAlloc(i64 1, i64 4) #8
  %184 = bitcast i8* %183 to i32*
  %185 = call i8* @hypre_CAlloc(i64 1, i64 4) #8
  %186 = bitcast i8* %185 to i32*
  %187 = sext i32 %30 to i64
  %188 = call i8* @hypre_CAlloc(i64 %187, i64 4) #8
...
238:                                              ; preds = %235, %194
  ...
  %243 = call i8* @hypre_CAlloc(i64 %242, i64 4) #8
  %244 = bitcast i8* %243 to i32*
  %245 = sext i32 %239 to i64
  %246 = call i8* @hypre_CAlloc(i64 %245, i64 4) #8
  %247 = bitcast i8* %246 to i32*
  %248 = call i8* @hypre_CAlloc(i64 %245, i64 8) #8
  %249 = bitcast i8* %248 to double*
  %250 = getelementptr inbounds i32, i32* %244, i64 %187
  store i32 %239, i32* %250, align 4, !tbaa !17
  %251 = call i8* @hypre_CAlloc(i64 %242, i64 4) #8
  %252 = bitcast i8* %251 to i32*
  %253 = sext i32 %240 to i64
  %254 = call i8* @hypre_CAlloc(i64 %253, i64 4) #8
  %255 = bitcast i8* %254 to i32*
  %256 = call i8* @hypre_CAlloc(i64 %253, i64 8) #8
  br i1 %43, label %257, label %263

257:                                              ; preds = %238
  %258 = call double @time_getWallclockSeconds() #8
  %259 = fsub double %258, %180
  %260 = load i32, i32* %12, align 4, !tbaa !17
  %261 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([48 x i8], [48 x i8]* @.str.6, i64 0, i64 0), i32 %260, double %259)
...
265:                                              ; preds = %263
  %266 = call double @time_getWallclockSeconds() #8
  br label %267

267:                                              ; preds = %265, %263
  %268 = phi double [ %266, %265 ], [ %264, %263 ]
  %269 = call i8* @hypre_CAlloc(i64 %48, i64 4) #8
...
319:                                              ; preds = %289, %274
  %320 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %62, i8* %71, i8* %269) #8
  %321 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %320) #8
  br i1 %43, label %322, label %329

322:                                              ; preds = %319
  %323 = call double @time_getWallclockSeconds() #8
  %324 = fsub double %323, %268
  %325 = load i32, i32* %12, align 4, !tbaa !17
  %326 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([48 x i8], [48 x i8]* @.str.7, i64 0, i64 0), i32 %325, double %324)
  %327 = call i32 @fflush(%struct._IO_FILE* null)
  %328 = call double @time_getWallclockSeconds() #8
  br label %329
...
360:                                              ; preds = %346
  call void @llvm.lifetime.start.p0i8(i64 4000, i8* nonnull %334) #8
...
396:                                              ; preds = %389, %360
  ...
  call void @llvm.lifetime.end.p0i8(i64 4000, i8* nonnull %334) #8
  br label %404
...
410:                                              ; preds = %408, %333
  ...
  %421 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %16, i32 %415, i32 %42, i32* %417, i32* %3, i32 0, i32 %418, i32 %420) #8
...
438:                                              ; preds = %410
  ...
  %440 = call i32 @hypre_BoomerAMGInterpTruncation(%struct.hypre_ParCSRMatrix_struct* %421, double %7, i32 0) #8
...
449:                                              ; preds = %445
  ...
  %451 = call i8* @hypre_CAlloc(i64 %450, i64 4) #8
...
463:                                              ; preds = %456, %449
  ...
  call void @hypre_qsort0(i32* %452, i32 0, i32 %464) #8
...
485:                                              ; preds = %480, %463
  ...
  %488 = call i8* @hypre_CAlloc(i64 %487, i64 4) #8
...
504:                                              ; preds = %495, %504
  ...
  %508 = call i32 @hypre_BinarySearch(i32* %489, i32 %507, i32 %486) #8
...
519:                                              ; preds = %516, %512
  %520 = call i32 @hypre_GetCommPkgRTFromCommPkgA(%struct.hypre_ParCSRMatrix_struct* %421, %struct.hypre_ParCSRMatrix_struct* %2, i32* %270) #8
  ...
  call void @hypre_Free(i8* %188) #8
  call void @hypre_Free(i8* %269) #8
  call void @hypre_Free(i8* %181) #8
  call void @hypre_Free(i8* %183) #8
  call void @hypre_Free(i8* %185) #8
  %521 = load i32, i32* %13, align 4, !tbaa !17
  %522 = icmp sgt i32 %521, 1
  br i1 %522, label %523, label %525

523:                                              ; preds = %519
  %524 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %172) #8
  br label %525
...
define dso_local i32 @hypre_BoomerAMGBuildInterpGSMG(%struct.hypre_ParCSRMatrix_struct* nocapture readnone %0, i32* nocapture readonly %1, %struct.hypre_ParCSRMatrix_struct* %2, i32* %3, i32 %4, i32* nocapture readonly %5, i32 %6, double %7, %struct.hypre_ParCSRMatrix_struct** nocapture %8) local_unnamed_addr #0 {
  ...
  %43 = call i32 @hypre_MPI_Comm_size(i32 %13, i32* nonnull %11) #8
  %44 = call i32 @hypre_MPI_Comm_rank(i32 %13, i32* nonnull %10) #8
  %45 = load i32, i32* %3, align 4, !tbaa !17
  %46 = icmp eq i32 %6, 4
  br i1 %46, label %47, label %49

47:                                               ; preds = %9
  %48 = call double @time_getWallclockSeconds() #8
  br label %49

49:                                               ; preds = %47, %9
  %50 = phi double [ %48, %47 ], [ undef, %9 ]
  %51 = sext i32 %33 to i64
  %52 = call i8* @hypre_CAlloc(i64 %51, i64 4) #8
...
57:                                               ; preds = %49
  %58 = call i8* @hypre_CAlloc(i64 %51, i64 4) #8
  br label %59
...
62:                                               ; preds = %59
  %63 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %2) #8
...
65:                                               ; preds = %62, %59
  ...
  %75 = call i8* @hypre_CAlloc(i64 %74, i64 4) #8
...
114:                                              ; preds = %84, %65
  %115 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %66, i8* %75, i8* %52) #8
  %116 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %115) #8
...
155:                                              ; preds = %125, %117
  %156 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %66, i8* %75, i8* %60) #8
  %157 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %156) #8
  br label %158
...
159:                                              ; preds = %158
  %160 = call double @time_getWallclockSeconds() #8
  %161 = fsub double %160, %50
  %162 = load i32, i32* %10, align 4, !tbaa !17
  %163 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([48 x i8], [48 x i8]* @.str.4, i64 0, i64 0), i32 %162, double %161)
...
167:                                              ; preds = %165
  %168 = call double @time_getWallclockSeconds() #8
  br label %169
...
173:                                              ; preds = %169
  %174 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixExtractBExt(%struct.hypre_ParCSRMatrix_struct* %2, %struct.hypre_ParCSRMatrix_struct* %2, i32 1) #8
...
186:                                              ; preds = %181
  %187 = call double @time_getWallclockSeconds() #8
  %188 = fsub double %187, %170
  %189 = load i32, i32* %10, align 4, !tbaa !17
  %190 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @.str.5, i64 0, i64 0), i32 %189, double %188)
  %191 = call i32 @fflush(%struct._IO_FILE* null)
  br label %192

192:                                              ; preds = %186, %181
  %193 = phi double [ %188, %186 ], [ %170, %181 ]
  %194 = call i8* @hypre_CAlloc(i64 1, i64 4) #8
  %195 = bitcast i8* %194 to i32*
  %196 = call i8* @hypre_CAlloc(i64 1, i64 4) #8
  %197 = bitcast i8* %196 to i32*
  %198 = call i8* @hypre_CAlloc(i64 1, i64 4) #8
  %199 = bitcast i8* %198 to i32*
  %200 = sext i32 %37 to i64
  %201 = call i8* @hypre_CAlloc(i64 %200, i64 4) #8
...
278:                                              ; preds = %275, %207
  ...
  %283 = call i8* @hypre_CAlloc(i64 %282, i64 4) #8
  %284 = bitcast i8* %283 to i32*
  %285 = sext i32 %279 to i64
  %286 = call i8* @hypre_CAlloc(i64 %285, i64 4) #8
  %287 = bitcast i8* %286 to i32*
  %288 = call i8* @hypre_CAlloc(i64 %285, i64 8) #8
  %289 = bitcast i8* %288 to double*
  %290 = getelementptr inbounds i32, i32* %284, i64 %200
  store i32 %279, i32* %290, align 4, !tbaa !17
  %291 = call i8* @hypre_CAlloc(i64 %282, i64 4) #8
  %292 = bitcast i8* %291 to i32*
  %293 = sext i32 %280 to i64
  %294 = call i8* @hypre_CAlloc(i64 %293, i64 4) #8
  %295 = bitcast i8* %294 to i32*
  %296 = call i8* @hypre_CAlloc(i64 %293, i64 8) #8
  %297 = bitcast i8* %296 to double*
  br i1 %46, label %298, label %304

298:                                              ; preds = %278
  %299 = call double @time_getWallclockSeconds() #8
  %300 = fsub double %299, %193
  %301 = load i32, i32* %10, align 4, !tbaa !17
  %302 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([48 x i8], [48 x i8]* @.str.6, i64 0, i64 0), i32 %301, double %300)
...
306:                                              ; preds = %304
  %307 = call double @time_getWallclockSeconds() #8
  br label %308

308:                                              ; preds = %306, %304
  %309 = phi double [ %307, %306 ], [ %305, %304 ]
  %310 = call i8* @hypre_CAlloc(i64 %51, i64 4) #8
...
360:                                              ; preds = %330, %315
  %361 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %66, i8* %75, i8* %310) #8
  %362 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %361) #8
  br i1 %46, label %363, label %370

363:                                              ; preds = %360
  %364 = call double @time_getWallclockSeconds() #8
  %365 = fsub double %364, %309
  %366 = load i32, i32* %10, align 4, !tbaa !17
  %367 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([48 x i8], [48 x i8]* @.str.7, i64 0, i64 0), i32 %366, double %365)
  %368 = call i32 @fflush(%struct._IO_FILE* null)
  %369 = call double @time_getWallclockSeconds() #8
  br label %370
...
381:                                              ; preds = %374, %370
  %382 = call i8* @hypre_CAlloc(i64 %200, i64 4) #8
  %383 = bitcast i8* %382 to i32*
  %384 = call i8* @hypre_CAlloc(i64 %51, i64 4) #8
...
681:                                              ; preds = %667
  %682 = call i32 @hypre_BinarySearch(i32* %35, i32 %671, i32 %33) #8
...
725:                                              ; preds = %712
  %726 = call i32 @hypre_BinarySearch(i32* %35, i32 %715, i32 %33) #8
...
812:                                              ; preds = %805, %395
  ...
  %820 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %13, i32 %814, i32 0, i32* %816, i32* nonnull %3, i32 0, i32 %817, i32 %819) #8
...
837:                                              ; preds = %812
  ...
  %839 = call i32 @hypre_BoomerAMGInterpTruncation(%struct.hypre_ParCSRMatrix_struct* %820, double %7, i32 0) #8
...
848:                                              ; preds = %844
  ...
  %850 = call i8* @hypre_CAlloc(i64 %849, i64 4) #8
...
862:                                              ; preds = %855, %848
  ...
  call void @hypre_qsort0(i32* %851, i32 0, i32 %863) #8
...
884:                                              ; preds = %879, %862
  ...
  %887 = call i8* @hypre_CAlloc(i64 %886, i64 4) #8
...
903:                                              ; preds = %894, %903
  ...
  %907 = call i32 @hypre_BinarySearch(i32* %888, i32 %906, i32 %885) #8
...
918:                                              ; preds = %915, %911
  %919 = call i32 @hypre_GetCommPkgRTFromCommPkgA(%struct.hypre_ParCSRMatrix_struct* %820, %struct.hypre_ParCSRMatrix_struct* %2, i32* %311) #8
  ...
  call void @hypre_Free(i8* %60) #8
  call void @hypre_Free(i8* %75) #8
  call void @hypre_Free(i8* %201) #8
  call void @hypre_Free(i8* %310) #8
  call void @hypre_Free(i8* %194) #8
...
922:                                              ; preds = %918
  %923 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %185) #8
  br label %924

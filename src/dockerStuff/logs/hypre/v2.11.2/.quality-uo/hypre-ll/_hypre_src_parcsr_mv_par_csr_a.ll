...
define dso_local void @hypre_ParAat_RowSizes(i32** nocapture %0, i32** nocapture %1, i32* nocapture %2, i32* nocapture readonly %3, i32* nocapture readonly %4, i32* nocapture readonly %5, i32* nocapture readonly %6, i32* nocapture readonly %7, i32* nocapture readonly %8, i32* nocapture readonly %9, i32* nocapture readonly %10, i32* nocapture %11, i32* nocapture %12, i32 %13, i32 %14, i32 %15, i32 %16, i32 %17) local_unnamed_addr #0 {
  ...
  %21 = call i8* @hypre_CAlloc(i64 %20, i64 4) #4
  %22 = bitcast i32** %0 to i8**
  store i8* %21, i8** %22, align 8, !tbaa !3
  %23 = call i8* @hypre_CAlloc(i64 %20, i64 4) #4
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRAAt(%struct.hypre_ParCSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %34 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %14, i64 0, i32 2
  %35 = load i32, i32* %34, align 8, !tbaa !34
  %36 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %22, i64 0, i32 3
...
51:                                               ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i64 0, i64 0), i32 377, i32 1, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i64 0, i64 0)) #4
  br label %622
...
60:                                               ; preds = %58, %54
  ...
  %81 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %76, i64 0, i32 6
  ...
  %88 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %83, i64 0, i32 6
  ...
  %104 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %100, i64 0, i32 1
  store i32* %103, i32** %104, align 8, !tbaa !30
  %105 = load double*, double** %5, align 8, !tbaa !3
  %106 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %100, i64 0, i32 6
  ...
  %108 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %100, i64 0, i32 2
...
110:                                              ; preds = %60, %52
  ...
  %118 = call i8* @hypre_CAlloc(i64 %117, i64 4) #4
...
127:                                              ; preds = %121, %110
  ...
  %132 = call i8* @hypre_CAlloc(i64 %131, i64 8) #4
  %133 = bitcast i8* %132 to double*
  %134 = call i8* @hypre_CAlloc(i64 %131, i64 4) #4
...
138:                                              ; preds = %127
  ...
  %140 = call i8* @hypre_CAlloc(i64 %139, i64 8) #4
  %141 = bitcast i8* %140 to double*
  %142 = call i8* @hypre_CAlloc(i64 %139, i64 4) #4
...
175:                                              ; preds = %161, %525
  ...
  store double 0.000000e+00, double* %181, align 8, !tbaa !48
...
193:                                              ; preds = %191, %279
  ...
  %200 = load double, double* %199, align 8, !tbaa !48
...
202:                                              ; preds = %272, %206
  ...
  br i1 %205, label %279, label %206, !llvm.loop !49
...
238:                                              ; preds = %231
  ...
  %240 = load double, double* %239, align 8, !tbaa !48
...
249:                                              ; preds = %246
  ...
  store double %241, double* %251, align 8, !tbaa !48
...
254:                                              ; preds = %246
  ...
  %257 = load double, double* %256, align 8, !tbaa !48
  %258 = fadd double %241, %257
  store double %258, double* %256, align 8, !tbaa !48
  br label %272
...
262:                                              ; preds = %259
  ...
  store double %241, double* %264, align 8, !tbaa !48
...
267:                                              ; preds = %259
  ...
  %270 = load double, double* %269, align 8, !tbaa !48
  %271 = fadd double %241, %270
  store double %271, double* %269, align 8, !tbaa !48
  br label %272
...
272:                                              ; preds = %231, %262, %267, %249, %254
  ...
  br i1 %278, label %231, label %202, !llvm.loop !50
...
279:                                              ; preds = %202, %193
  ...
  br i1 %285, label %193, label %286, !llvm.loop !51
...
298:                                              ; preds = %296, %386
  ...
  %305 = load double, double* %304, align 8, !tbaa !48
...
308:                                              ; preds = %379, %312
  ...
  br i1 %311, label %386, label %312, !llvm.loop !52
...
345:                                              ; preds = %337
  ...
  %347 = load double, double* %346, align 8, !tbaa !48
...
356:                                              ; preds = %353
  ...
  store double %348, double* %358, align 8, !tbaa !48
...
361:                                              ; preds = %353
  ...
  %364 = load double, double* %363, align 8, !tbaa !48
  %365 = fadd double %348, %364
  store double %365, double* %363, align 8, !tbaa !48
  br label %379
...
369:                                              ; preds = %366
  ...
  store double %348, double* %371, align 8, !tbaa !48
...
374:                                              ; preds = %366
  ...
  %377 = load double, double* %376, align 8, !tbaa !48
  %378 = fadd double %348, %377
  store double %378, double* %376, align 8, !tbaa !48
  br label %379
...
379:                                              ; preds = %337, %369, %374, %356, %361
  ...
  br i1 %385, label %337, label %308, !llvm.loop !53
...
386:                                              ; preds = %308, %298
  ...
  br i1 %392, label %298, label %393, !llvm.loop !54
...
401:                                              ; preds = %399, %452
  ...
  %407 = load double, double* %406, align 8, !tbaa !48
  br i1 %158, label %411, label %452

408:                                              ; preds = %446, %411
  %409 = phi i32 [ %413, %411 ], [ %447, %446 ]
  %410 = icmp eq i64 %416, %165
  br i1 %410, label %452, label %411, !llvm.loop !55
...
430:                                              ; preds = %424
  ...
  %432 = load double, double* %431, align 8, !tbaa !48
...
436:                                              ; preds = %430
  ...
  store double %433, double* %438, align 8, !tbaa !48
...
441:                                              ; preds = %430
  ...
  %444 = load double, double* %443, align 8, !tbaa !48
  %445 = fadd double %433, %444
  store double %445, double* %443, align 8, !tbaa !48
  br label %446
...
446:                                              ; preds = %424, %441, %436
  ...
  br i1 %451, label %424, label %408, !llvm.loop !56
...
452:                                              ; preds = %408, %401
  ...
  br i1 %457, label %401, label %458, !llvm.loop !57
...
468:                                              ; preds = %466, %519
  ...
  %474 = load double, double* %473, align 8, !tbaa !48
  br i1 %159, label %478, label %519

475:                                              ; preds = %513, %478
  %476 = phi i32 [ %480, %478 ], [ %514, %513 ]
  %477 = icmp eq i64 %483, %166
  br i1 %477, label %519, label %478, !llvm.loop !58
...
497:                                              ; preds = %491
  ...
  %499 = load double, double* %498, align 8, !tbaa !48
...
503:                                              ; preds = %497
  ...
  store double %500, double* %505, align 8, !tbaa !48
...
508:                                              ; preds = %497
  ...
  %511 = load double, double* %510, align 8, !tbaa !48
  %512 = fadd double %500, %511
  store double %512, double* %510, align 8, !tbaa !48
  br label %513
...
513:                                              ; preds = %491, %508, %503
  ...
  br i1 %518, label %491, label %475, !llvm.loop !59
...
519:                                              ; preds = %475, %468
  ...
  br i1 %524, label %468, label %525, !llvm.loop !60

525:                                              ; preds = %519, %460, %458
  %526 = phi i32 [ %459, %458 ], [ %459, %460 ], [ %520, %519 ]
  %527 = icmp eq i64 %187, %162
  br i1 %527, label %167, label %175, !llvm.loop !61
...
537:                                              ; preds = %530, %537
  ...
  br i1 %544, label %532, label %537, !llvm.loop !62
...
553:                                              ; preds = %545, %551
  ...
  br i1 %556, label %557, label %545, !llvm.loop !63
...
560:                                              ; preds = %557
  ...
  %565 = call i8* @hypre_CAlloc(i64 %564, i64 4) #4
...
571:                                              ; preds = %569, %571
  ...
  br i1 %586, label %587, label %571, !llvm.loop !64

587:                                              ; preds = %571, %560
  %588 = bitcast i32* %145 to i8*
  call void @hypre_Free(i8* %588) #4
  br label %589
...
589:                                              ; preds = %587, %557
  ...
  %597 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %596, i64 0, i32 6
...
603:                                              ; preds = %589
  ...
  %606 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %605, i64 0, i32 6
...
define dso_local %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixExtractAExt(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32 %1, i32** %2) local_unnamed_addr #0 {
  ...
  %32 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %27, i64 0, i32 6
  ...
  %40 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %35, i64 0, i32 6
  ...
  %58 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %54, i64 0, i32 1
...
60:                                               ; preds = %3
  ...
  %62 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %54, i64 0, i32 6
...
!26 = !{!24, !4, i64 32}
!27 = !{!28, !4, i64 32}
!28 = !{!"", !4, i64 0, !4, i64 8, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !4, i64 32, !4, i64 40, !8, i64 48}
!29 = !{!28, !4, i64 0}
!30 = !{!28, !4, i64 8}
!31 = !{!24, !4, i64 40}
!32 = !{!24, !4, i64 64}

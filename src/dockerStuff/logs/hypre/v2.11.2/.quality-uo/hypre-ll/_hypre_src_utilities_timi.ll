...
4:                                                ; preds = %1
  %5 = call i8* @hypre_CAlloc(i64 1, i64 80) #9
...
32:                                               ; preds = %26
  ...
  %36 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %0, i8* noundef nonnull dereferenceable(1) %35) #10
  %37 = icmp eq i32 %36, 0
...
65:                                               ; preds = %62
  ...
  %86 = call i8* @hypre_CAlloc(i64 %79, i64 8) #9
  ...
  %90 = call i8* @hypre_CAlloc(i64 %79, i64 8) #9
  ...
  %94 = call i8* @hypre_CAlloc(i64 %79, i64 4) #9
  ...
  %98 = call i8* @hypre_CAlloc(i64 %79, i64 4) #9
...
144:                                              ; preds = %108, %65
  ...
  call void @hypre_Free(i8* %145) #9
  %146 = bitcast double* %69 to i8*
  call void @hypre_Free(i8* %146) #9
  %147 = bitcast double* %71 to i8*
  call void @hypre_Free(i8* %147) #9
  %148 = bitcast i8** %73 to i8*
  call void @hypre_Free(i8* %148) #9
  %149 = bitcast i32* %75 to i8*
  call void @hypre_Free(i8* %149) #9
  %150 = bitcast i32* %77 to i8*
  call void @hypre_Free(i8* %150) #9
  br label %151

151:                                              ; preds = %144, %62
  %152 = call i8* @hypre_CAlloc(i64 80, i64 1) #9
  ...
  %163 = call i8* @strncpy(i8* noundef nonnull dereferenceable(1) %162, i8* noundef nonnull dereferenceable(1) %0, i64 79) #9
...
4:                                                ; preds = %1
  ...
  %8 = fadd double %7, %5
  store double %8, double* %6, align 8, !tbaa !26
  br label %9
...
11:                                               ; preds = %4
  %12 = call double @time_getWallclockSeconds() #9
  ...
  store double %16, double* %14, align 8, !tbaa !27
  %17 = call double @time_getCPUSeconds() #9
  ...
  store double %21, double* %19, align 8, !tbaa !28
  ...
  %29 = load double, double* %19, align 8, !tbaa !28
  ...
  %36 = load double, double* %35, align 8, !tbaa !26
  ...
  %42 = call double @time_getWallclockSeconds() #9
  ...
  store double %46, double* %44, align 8, !tbaa !27
  %47 = call double @time_getCPUSeconds() #9
  %48 = load %struct.hypre_TimingType*, %struct.hypre_TimingType** @hypre_global_timing, align 8, !tbaa !3
  ...
  store double %51, double* %49, align 8, !tbaa !28
  br label %52
...
12:                                               ; preds = %4
  %13 = call double @time_getWallclockSeconds() #9
  ...
  store double %17, double* %15, align 8, !tbaa !27
  %18 = call double @time_getCPUSeconds() #9
  ...
  %21 = load double, double* %20, align 8, !tbaa !28
  %22 = fadd double %18, %21
  store double %22, double* %20, align 8, !tbaa !28
  ...
  %30 = load double, double* %20, align 8, !tbaa !28
  ...
  %43 = call double @time_getWallclockSeconds() #9
  ...
  store double %47, double* %45, align 8, !tbaa !27
  %48 = call double @time_getCPUSeconds() #9
  ...
  store double %52, double* %50, align 8, !tbaa !28
  br label %53
...
15:                                               ; preds = %2
  %16 = call i32 @hypre_MPI_Comm_rank(i32 %1, i32* nonnull %7) #9
  %17 = load i32, i32* %7, align 4, !tbaa !12
  %18 = icmp eq i32 %17, 0
  br i1 %18, label %19, label %23

19:                                               ; preds = %15
  %20 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([46 x i8], [46 x i8]* @str.6, i64 0, i64 0))
  %21 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %0)
  %22 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([46 x i8], [46 x i8]* @str.6, i64 0, i64 0))
  br label %23
...
36:                                               ; preds = %28
  ...
  %45 = call i32 @hypre_MPI_Allreduce(i8* nonnull %8, i8* nonnull %10, i32 1, i32 1275070475, i32 1476395009, i32 %1) #9
  %46 = call i32 @hypre_MPI_Allreduce(i8* nonnull %9, i8* nonnull %11, i32 1, i32 1275070475, i32 1476395009, i32 %1) #9
...
49:                                               ; preds = %36
  ...
  %55 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %54)
  %56 = load double, double* %5, align 8, !tbaa !22
  %57 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i64 0, i64 0), double %56)
...
68:                                               ; preds = %49, %60
  ...
  %70 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i64 0, i64 0), double %69)
  %71 = load double, double* %6, align 8, !tbaa !22
  %72 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4, i64 0, i64 0), double %71)
...
83:                                               ; preds = %68, %75
  ...
  %85 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5, i64 0, i64 0), double %84)
  br label %86
...
86:                                               ; preds = %28, %83, %36
  ...
  br i1 %92, label %28, label %93, !llvm.loop !30

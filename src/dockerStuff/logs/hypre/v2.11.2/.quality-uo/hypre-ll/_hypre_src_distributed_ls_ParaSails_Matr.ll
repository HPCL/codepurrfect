...
define dso_local %struct.Matrix* @MatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  ...
  %10 = call noalias align 16 dereferenceable_or_null(152) i8* @malloc(i64 152) #12
  ...
  %31 = call i32 @hypre_MPI_Comm_rank(i32 %0, i32* nonnull %6) #12
  %32 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %7) #12
  %33 = load %struct.Mem*, %struct.Mem** %16, align 16, !tbaa !12
  %34 = load i32, i32* %7, align 4, !tbaa !3
  %35 = shl i32 %34, 2
  %36 = call i8* @MemAlloc(%struct.Mem* %33, i32 %35) #12
  ...
  %41 = shl i32 %40, 2
  %42 = call i8* @MemAlloc(%struct.Mem* %39, i32 %41) #12
  ...
  %47 = call i32 @hypre_MPI_Allgather(i8* nonnull %45, i32 1, i32 1275069445, i8* %46, i32 1, i32 1275069445, i32 %0) #12
  %48 = bitcast i32* %5 to i8*
  %49 = call i32 @hypre_MPI_Allgather(i8* nonnull %48, i32 1, i32 1275069445, i8* %42, i32 1, i32 1275069445, i32 %0) #12
...
define dso_local %struct.Matrix* @MatrixCreateLocal(i32 %0, i32 %1) local_unnamed_addr #0 {
  %3 = call noalias align 16 dereferenceable_or_null(152) i8* @malloc(i64 152) #12
...
12:                                               ; preds = %1, %12
  ...
  %16 = call i32 @hypre_MPI_Request_free(i32* %15) #12
...
26:                                               ; preds = %6, %26
  ...
  %30 = call i32 @hypre_MPI_Request_free(i32* %29) #12
...
39:                                               ; preds = %21, %39
  ...
  %43 = call i32 @hypre_MPI_Request_free(i32* %42) #12
...
48:                                               ; preds = %35, %48
  ...
  %52 = call i32 @hypre_MPI_Request_free(i32* %51) #12
...
87:                                               ; preds = %57
  call void @NumberingDestroy(%struct.numbering* nonnull %85) #12
  br label %88
...
define dso_local void @MatrixSetRow(%struct.Matrix* nocapture readonly %0, i32 %1, i32 %2, i32* readonly %3, double* readonly %4) local_unnamed_addr #0 {
  ...
  %18 = call i8* @MemAlloc(%struct.Mem* %14, i32 %17) #12
  ...
  %26 = call i8* @MemAlloc(%struct.Mem* %23, i32 %25) #12
...
define dso_local i32 @MatrixRowPe(%struct.Matrix* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %11 = call i32 @hypre_MPI_Comm_size(i32 %10, i32* nonnull %3) #12
...
28:                                               ; preds = %25, %2
  %29 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 %1)
  %30 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %31 = call i64 @fwrite(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i64 11, i64 1, %struct._IO_FILE* %30) #13
  %32 = call i32 @fflush(%struct._IO_FILE* null)
  %33 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #12
  br label %36
...
25:                                               ; preds = %17, %1
  ...
  %28 = call i32 @hypre_MPI_Allreduce(i8* nonnull %4, i8* nonnull %5, i32 1, i32 1275069445, i32 1476395011, i32 %27) #12
...
define dso_local void @MatrixPrint(%struct.Matrix* nocapture readonly %0, i8* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %9 = call i32 @hypre_MPI_Comm_rank(i32 %8, i32* nonnull %3) #12
  %10 = load i32, i32* %7, align 8, !tbaa !7
  %11 = call i32 @hypre_MPI_Comm_size(i32 %10, i32* nonnull %4) #12
...
20:                                               ; preds = %2, %74
  ...
  %23 = call i32 @hypre_MPI_Barrier(i32 %22) #12
...
48:                                               ; preds = %45, %48
  ...
  %62 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %29, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i64 0, i64 0), i32 %51, i32 %59, double %61)
...
define dso_local void @MatrixRead(%struct.Matrix* %0, i8* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %27 = call i32 @hypre_MPI_Comm_rank(i32 %26, i32* nonnull %23) #12
  %28 = call double @hypre_MPI_Wtime() #12
...
32:                                               ; preds = %2
  ...
  call void @llvm.lifetime.start.p0i8(i64 4000, i8* nonnull %40) #12
  %41 = bitcast [1000 x double]* %19 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8000, i8* nonnull %41) #12
  ...
  %45 = call i32 @hypre_MPI_Comm_size(i32 %31, i32* nonnull %12) #12
  %46 = load i32, i32* %25, align 8, !tbaa !7
  %47 = call i32 @hypre_MPI_Comm_rank(i32 %46, i32* nonnull %11) #12
  %48 = call %struct._IO_FILE* @fopen(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0)) #12
  %49 = call i8* @fgets(i8* nonnull %42, i32 100, %struct._IO_FILE* %48) #12
  %50 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* nonnull %42, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.10, i64 0, i64 0), i32* nonnull %13) #12
  %51 = call i64 @ftell(%struct._IO_FILE* %48) #12
  %52 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #12
...
65:                                               ; preds = %56
  %66 = call i32 @hypre_MPI_Wait(i32* nonnull %21, %struct.MPI_Status* nonnull %22) #12
  store i64 %57, i64* %17, align 8, !tbaa !45
  %67 = call i32 @hypre_MPI_Isend(i8* nonnull %39, i32 1, i32 1275070471, i32 %58, i32 0, i32 %31, i32* nonnull %21) #12
  %68 = add nsw i32 %58, 1
  br label %69

69:                                               ; preds = %65, %56
  %70 = phi i32 [ %68, %65 ], [ %58, %56 ]
  %71 = call i64 @ftell(%struct._IO_FILE* %48) #12
  %72 = load i32, i32* %14, align 4, !tbaa !3
  %73 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #12
...
76:                                               ; preds = %69
  ...
  %78 = call i64 @fwrite(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.12, i64 0, i64 0), i64 35, i64 1, %struct._IO_FILE* %77) #14
  %79 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %80 = call i64 @fwrite(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i64 11, i64 1, %struct._IO_FILE* %79) #14
  %81 = call i32 @fflush(%struct._IO_FILE* null) #12
  %82 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #12
  br label %83
...
86:                                               ; preds = %83, %32
  call void @rewind(%struct._IO_FILE* %48) #12
  %87 = call i8* @fgets(i8* nonnull %42, i32 100, %struct._IO_FILE* %48) #12
  %88 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* nonnull %42, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.10, i64 0, i64 0), i32* nonnull %13) #12
  %89 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #12
...
107:                                              ; preds = %105
  ...
  %117 = call i8* @MemAlloc(%struct.Mem* %113, i32 %116) #12
  ...
  %124 = call i8* @MemAlloc(%struct.Mem* %121, i32 %123) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %131, i8* nonnull align 16 %40, i64 %115, i1 false) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %135, i8* nonnull align 16 %41, i64 %122, i1 false) #12
...
141:                                              ; preds = %137
  ...
  %143 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %142, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.13, i64 0, i64 0), i32 1000) #14
  %144 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %145 = call i64 @fwrite(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.14, i64 0, i64 0), i64 44, i64 1, %struct._IO_FILE* %144) #14
  %146 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %147 = call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.15, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %146) #14
  %148 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %149 = call i64 @fwrite(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i64 11, i64 1, %struct._IO_FILE* %148) #14
  %150 = call i32 @fflush(%struct._IO_FILE* null) #12
  %151 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #12
  br label %152
...
152:                                              ; preds = %141, %137
  ...
  %159 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #12
...
161:                                              ; preds = %99, %152, %86
  ...
  %173 = call i8* @MemAlloc(%struct.Mem* %169, i32 %172) #12
  ...
  %180 = call i8* @MemAlloc(%struct.Mem* %177, i32 %179) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %187, i8* nonnull align 16 %40, i64 %171, i1 false) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %191, i8* nonnull align 16 %41, i64 %178, i1 false) #12
  %192 = call i32 @fclose(%struct._IO_FILE* %48) #12
  %193 = call i32 @hypre_MPI_Wait(i32* nonnull %21, %struct.MPI_Status* nonnull %22) #12
  ...
  call void @llvm.lifetime.end.p0i8(i64 8000, i8* nonnull %41) #12
  call void @llvm.lifetime.end.p0i8(i64 4000, i8* nonnull %40) #12
...
194:                                              ; preds = %2
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %195) #12
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %200) #12
  %201 = bitcast [1000 x i32]* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4000, i8* nonnull %201) #12
  %202 = bitcast [1000 x double]* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8000, i8* nonnull %202) #12
  %203 = call %struct._IO_FILE* @fopen(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0)) #12
  %204 = load i32, i32* %25, align 8, !tbaa !7
  %205 = call i32 @hypre_MPI_Comm_rank(i32 %204, i32* nonnull %4) #12
  %206 = call i32 @hypre_MPI_Recv(i8* nonnull %200, i32 1, i32 1275070471, i32 0, i32 0, i32 %31, %struct.MPI_Status* nonnull %3) #12
  %207 = call double @hypre_MPI_Wtime() #12
  %208 = load i64, i64* %8, align 8, !tbaa !45
  %209 = call i32 @fseek(%struct._IO_FILE* %203, i64 %208, i32 0) #12
  %210 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %203, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %5, i32* nonnull %6, double* nonnull %7) #12
...
228:                                              ; preds = %226
  ...
  %238 = call i8* @MemAlloc(%struct.Mem* %234, i32 %237) #12
  ...
  %245 = call i8* @MemAlloc(%struct.Mem* %242, i32 %244) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %252, i8* nonnull align 16 %201, i64 %236, i1 false) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %256, i8* nonnull align 16 %202, i64 %243, i1 false) #12
...
262:                                              ; preds = %258
  ...
  %264 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %263, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.13, i64 0, i64 0), i32 1000) #14
  %265 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %266 = call i64 @fwrite(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.14, i64 0, i64 0), i64 44, i64 1, %struct._IO_FILE* %265) #14
  %267 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %268 = call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.15, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %267) #14
  %269 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %270 = call i64 @fwrite(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i64 11, i64 1, %struct._IO_FILE* %269) #14
  %271 = call i32 @fflush(%struct._IO_FILE* null) #12
  %272 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #12
  br label %273
...
273:                                              ; preds = %262, %258
  ...
  %280 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %203, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %5, i32* nonnull %6, double* nonnull %7) #12
...
282:                                              ; preds = %220, %273, %194
  ...
  %294 = call i8* @MemAlloc(%struct.Mem* %290, i32 %293) #12
  ...
  %301 = call i8* @MemAlloc(%struct.Mem* %298, i32 %300) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %308, i8* nonnull align 16 %201, i64 %292, i1 false) #12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %312, i8* nonnull align 16 %202, i64 %299, i1 false) #12
  %313 = call i32 @fclose(%struct._IO_FILE* %203) #12
  %314 = call double @hypre_MPI_Wtime() #12
  %315 = load i32, i32* %4, align 4, !tbaa !3
  %316 = fsub double %314, %207
  %317 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([29 x i8], [29 x i8]* @.str.16, i64 0, i64 0), i32 %315, double %316) #12
  call void @llvm.lifetime.end.p0i8(i64 8000, i8* nonnull %202) #12
  call void @llvm.lifetime.end.p0i8(i64 4000, i8* nonnull %201) #12
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %200) #12
  ...
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %195) #12
  br label %318

318:                                              ; preds = %282, %161
  %319 = call double @hypre_MPI_Wtime() #12
  %320 = load i32, i32* %23, align 4, !tbaa !3
  %321 = fsub double %319, %28
  %322 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([33 x i8], [33 x i8]* @.str.5, i64 0, i64 0), i32 %320, double %321)
...
define dso_local void @MatrixComplete(%struct.Matrix* %0) local_unnamed_addr #0 {
  ...
  %34 = call noalias align 16 i8* @calloc(i64 %16, i64 4) #12
  %35 = bitcast i8* %34 to i32*
  %36 = call noalias align 16 i8* @calloc(i64 %16, i64 4) #12
  %37 = bitcast i8* %36 to i32*
  %38 = call %struct.numbering* @NumberingCreate(%struct.Matrix* %0, i32 300000) #12
  ...
  %57 = add nsw i32 %56, 1
  %58 = call i32 @hypre_MPI_Comm_rank(i32 %51, i32* nonnull %4) #12
...
72:                                               ; preds = %98, %70
  ...
  %77 = call i32 @MatrixRowPe(%struct.Matrix* %0, i32 %76) #12
  %78 = sext i32 %77 to i64
  %79 = add nsw i64 %74, 1
  %80 = call i64 @llvm.smax.i64(i64 %79, i64 %71) #12
  %81 = add nsw i64 %80, -1
  br label %82
...
98:                                               ; preds = %93, %86, %82
  ...
  %103 = call i32 @hypre_MPI_Isend(i8* nonnull %101, i32 %102, i32 1275069445, i32 %77, i32 444, i32 %51, i32* nonnull %5) #12
  %104 = call i32 @hypre_MPI_Request_free(i32* nonnull %5) #12
  ...
  %115 = call i32 @hypre_MPI_Recv_init(i8* %110, i32 %102, i32 1275070475, i32 %77, i32 555, i32 %51, i32* %114) #12
  ...
  %123 = call i32 @hypre_MPI_Send_init(i8* %118, i32 %102, i32 1275070475, i32 %77, i32 666, i32 %51, i32* %122) #12
...
127:                                              ; preds = %98, %1
  ...
  %129 = call i32 @hypre_MPI_Alltoall(i8* %34, i32 1, i32 1275069445, i8* %36, i32 1, i32 1275069445, i32 %128) #12
  ...
  %133 = call i32 @hypre_MPI_Comm_rank(i32 %132, i32* nonnull %2) #12
  %134 = call i32 @hypre_MPI_Comm_size(i32 %132, i32* nonnull %3) #12
  %135 = load i32, i32* %3, align 4, !tbaa !3
  %136 = sext i32 %135 to i64
  %137 = shl nsw i64 %136, 2
  %138 = call noalias align 16 i8* @malloc(i64 %137) #12
...
157:                                              ; preds = %156, %127
  ...
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %160, i8 0, i64 16, i1 false) #12
...
163:                                              ; preds = %157
  ...
  %166 = call noalias align 16 i8* @malloc(i64 %165) #12
  %167 = bitcast double** %158 to i8**
  store i8* %166, i8** %167, align 8, !tbaa !32
  %168 = shl nsw i64 %164, 2
  %169 = call noalias align 16 i8* @malloc(i64 %168) #12
...
179:                                              ; preds = %173
  ...
  %188 = call i32 @hypre_MPI_Irecv(i8* %183, i32 %177, i32 1275069445, i32 %187, i32 444, i32 %132, i32* %186) #12
  ...
  %197 = call i32 @hypre_MPI_Send_init(i8* %191, i32 %192, i32 1275070475, i32 %187, i32 555, i32 %132, i32* %196) #12
  ...
  %206 = call i32 @hypre_MPI_Recv_init(i8* %200, i32 %201, i32 1275070475, i32 %187, i32 666, i32 %132, i32* %205) #12
...
217:                                              ; preds = %211, %171
  ...
  %219 = call i32 @hypre_MPI_Waitall(i32 %218, i32* %139, %struct.MPI_Status* %142) #12
...
240:                                              ; preds = %234, %240
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %248, i32 %244, i32* %247, i32* %247) #12
...
define dso_local void @RhsRead(double* %0, %struct.Matrix* nocapture readonly %1, i8* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %10) #12
  ...
  %18 = call i32 @hypre_MPI_Comm_size(i32 %17, i32* nonnull %6) #12
  %19 = load i32, i32* %16, align 8, !tbaa !7
  %20 = call i32 @hypre_MPI_Comm_rank(i32 %19, i32* nonnull %5) #12
...
28:                                               ; preds = %3
  ...
  %32 = call i32 @hypre_MPI_Recv(i8* %30, i32 %29, i32 1275070475, i32 0, i32 0, i32 %31, %struct.MPI_Status* nonnull %4) #12
  br label %103
...
33:                                               ; preds = %3
  ...
  %36 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* nonnull %14, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i64 0, i64 0), i32* nonnull %7, i32* nonnull %9) #12
  %37 = icmp eq i32 %36, 1
...
52:                                               ; preds = %39, %52
  ...
  %55 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %34, i8* %43, double* %54) #12
...
85:                                               ; preds = %81, %85
  ...
  %88 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %34, i8* %51, double* %87) #12
...
91:                                               ; preds = %85, %77
  ...
  %95 = call i32 @hypre_MPI_Send(i8* %92, i32 %69, i32 1275070475, i32 %94, i32 0, i32 %93) #12
...
103:                                              ; preds = %100, %28
  ...
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %10) #12
  ret void
}
...
27:                                               ; preds = %17, %3
  ...
  %32 = call i32 @hypre_MPI_Startall(i32 %29, i32* %31) #12
  ...
  %37 = call i32 @hypre_MPI_Startall(i32 %34, i32* %36) #12
  %38 = icmp slt i32 %5, %7
...
52:                                               ; preds = %45, %27
  ...
  %57 = call i32 @hypre_MPI_Waitall(i32 %53, i32* %54, %struct.MPI_Status* %56) #12
...
103:                                              ; preds = %98, %52
  ...
  %107 = call i32 @hypre_MPI_Waitall(i32 %104, i32* %105, %struct.MPI_Status* %106) #12
  ret void
}
...
define dso_local void @MatrixMatvecTrans(%struct.Matrix* nocapture readonly %0, double* nocapture readonly %1, double* nocapture %2) local_unnamed_addr #0 {
  ...
  %14 = call i32 @hypre_MPI_Startall(i32 %11, i32* %13) #12
...
73:                                               ; preds = %70, %28
  ...
  %78 = call i32 @hypre_MPI_Startall(i32 %75, i32* %77) #12
  %79 = icmp slt i32 %8, 0
...
93:                                               ; preds = %86, %73
  ...
  %98 = call i32 @hypre_MPI_Waitall(i32 %94, i32* %95, %struct.MPI_Status* %97) #12
...
120:                                              ; preds = %108, %93
  ...
  %124 = call i32 @hypre_MPI_Waitall(i32 %121, i32* %122, %struct.MPI_Status* %123) #12
  ret void
}

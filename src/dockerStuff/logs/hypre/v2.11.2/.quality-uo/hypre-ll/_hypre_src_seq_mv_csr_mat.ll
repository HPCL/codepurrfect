...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRMatrixAdd(%struct.hypre_CSRMatrix* nocapture readonly %0, %struct.hypre_CSRMatrix* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %13 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1, i64 0, i32 6
...
22:                                               ; preds = %2
  %23 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1, i64 0, i32 3
  %24 = load i32, i32* %23, align 4, !tbaa !12
  %25 = icmp eq i32 %12, %24
  br i1 %25, label %27, label %26

26:                                               ; preds = %22, %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i32 57, i32 1, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0)) #6
  br label %191

27:                                               ; preds = %22
  %28 = sext i32 %12 to i64
  %29 = call i8* @hypre_CAlloc(i64 %28, i64 4) #6
...
99:                                               ; preds = %95, %39
  ...
  %106 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %101, i64 0, i32 6
...
24:                                               ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i32 167, i32 1, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0)) #6
  br label %206
...
25:                                               ; preds = %2
  ...
  %29 = call i8* @hypre_CAlloc(i64 %28, i64 4) #6
  %30 = bitcast i8* %29 to i32*
  %31 = call i8* @hypre_CAlloc(i64 1, i64 4) #6
...
44:                                               ; preds = %99, %55
  ...
  br i1 %46, label %105, label %47, !llvm.loop !24
...
93:                                               ; preds = %81, %91
  ...
  br i1 %98, label %81, label %99, !llvm.loop !25
...
99:                                               ; preds = %93, %66
  ...
  br i1 %104, label %66, label %44, !llvm.loop !26
...
105:                                              ; preds = %44, %40
  ...
  %115 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %110, i64 0, i32 6
...
126:                                              ; preds = %199, %141
  ...
  br i1 %128, label %205, label %129, !llvm.loop !27
...
193:                                              ; preds = %179, %187
  ...
  br i1 %198, label %168, label %199, !llvm.loop !28
...
199:                                              ; preds = %193, %151
  ...
  br i1 %204, label %151, label %126, !llvm.loop !29
...
32:                                               ; preds = %29
  ...
  %40 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %34, i64 0, i32 6
...
75:                                               ; preds = %58, %66
  ...
  br i1 %81, label %58, label %82, !llvm.loop !32
...
84:                                               ; preds = %82, %45
  ...
  br i1 %88, label %89, label %45, !llvm.loop !33
...
define dso_local i32 @hypre_CSRMatrixTranspose(%struct.hypre_CSRMatrix* %0, %struct.hypre_CSRMatrix** nocapture %1, i32 %2) local_unnamed_addr #0 {
  %4 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 6
...
32:                                               ; preds = %47, %35
  ...
  br i1 %34, label %56, label %35, !llvm.loop !34
...
47:                                               ; preds = %44, %47
  ...
  br i1 %55, label %32, label %47, !llvm.loop !35
...
59:                                               ; preds = %56, %21
  ...
  store %struct.hypre_CSRMatrix* %61, %struct.hypre_CSRMatrix** %1, align 8, !tbaa !36
  %62 = icmp eq i32 %60, 0
...
65:                                               ; preds = %59
  ...
  %69 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %1, align 8, !tbaa !36
...
73:                                               ; preds = %65
  %74 = call i8* @hypre_CAlloc(i64 %66, i64 8) #6
  %75 = bitcast i8* %74 to double*
  %76 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %1, align 8, !tbaa !36
  %77 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %76, i64 0, i32 6
...
79:                                               ; preds = %73, %65
  ...
  %82 = sext i32 %81 to i64
  %83 = shl nsw i64 %82, 2
  %84 = call i8* @hypre_MAlloc(i64 %83) #6
...
104:                                              ; preds = %97, %104
  ...
  br i1 %115, label %104, label %99, !llvm.loop !37
...
116:                                              ; preds = %101, %116
  ...
  br i1 %123, label %124, label %116, !llvm.loop !38
...
132:                                              ; preds = %145, %134
  ...
  br i1 %133, label %134, label %189, !llvm.loop !39
...
145:                                              ; preds = %142, %145
  ...
  br i1 %161, label %145, label %132, !llvm.loop !40

162:                                              ; preds = %175, %164
  %163 = icmp sgt i64 %166, %131
  br i1 %163, label %164, label %189, !llvm.loop !41
...
175:                                              ; preds = %172, %175
  ...
  br i1 %188, label %175, label %162, !llvm.loop !42

189:                                              ; preds = %132, %162, %126, %129
  %190 = bitcast %struct.hypre_CSRMatrix** %1 to i8***
  %191 = load i8**, i8*** %190, align 8, !tbaa !36
  store i8* %84, i8** %191, align 8, !tbaa !9
  %192 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %1, align 8, !tbaa !36
...
11:                                               ; preds = %9
  %12 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 6
...
49:                                               ; preds = %46
  ...
  br i1 %54, label %34, label %46, !llvm.loop !43
...
55:                                               ; preds = %17, %34, %40
  ...
  br i1 %59, label %60, label %17, !llvm.loop !44
...
define dso_local double @hypre_CSRMatrixSumElts(%struct.hypre_CSRMatrix* nocapture readonly %0) local_unnamed_addr #5 {
  %2 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 6

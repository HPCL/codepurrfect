...
831:                                              ; preds = %818, %896
  %832 = phi i32 [ %879, %896 ], [ %802, %818 ]
  %833 = phi i32 [ %897, %896 ], [ 0, %818 ]
  %834 = phi i32 [ %882, %896 ], [ %817, %818 ]
...
838:                                              ; preds = %844
  %839 = trunc i64 %861 to i32
  %840 = trunc i64 %860 to i32
  br label %841

841:                                              ; preds = %838, %831
  %842 = phi i32 [ %834, %831 ], [ %839, %838 ]
  %843 = phi i32 [ %832, %831 ], [ %840, %838 ]
  br label %864

844:                                              ; preds = %835, %844
  %845 = phi i64 [ %837, %835 ], [ %861, %844 ]
  %846 = phi i64 [ %836, %835 ], [ %860, %844 ]
  %847 = phi i32 [ 0, %835 ], [ %862, %844 ]
  %848 = getelementptr inbounds double, double* %495, i64 %846
  %849 = load double, double* %848, align 8, !tbaa !40
  %850 = getelementptr inbounds double, double* %504, i64 %845
  %851 = load double, double* %850, align 8, !tbaa !40
  %852 = fmul double %849, %851
  %853 = getelementptr inbounds double, double* %494, i64 %846
  %854 = load double, double* %853, align 8, !tbaa !40
  %855 = getelementptr inbounds double, double* %507, i64 %845
  %856 = load double, double* %855, align 8, !tbaa !40
  %857 = fmul double %854, %856
  %858 = fadd double %852, %857
  %859 = getelementptr inbounds double, double* %501, i64 %845

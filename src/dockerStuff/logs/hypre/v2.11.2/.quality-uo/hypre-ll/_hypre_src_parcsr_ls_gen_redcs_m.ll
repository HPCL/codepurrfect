...
28:                                               ; preds = %3
  ...
  %31 = call i8* @hypre_CAlloc(i64 %30, i64 4) #5
...
40:                                               ; preds = %28
  ...
  %43 = call i8* @hypre_CAlloc(i64 %42, i64 4) #5
  %44 = bitcast i8* %43 to i32*
  %45 = call i8* @hypre_CAlloc(i64 1, i64 4) #5
...
54:                                               ; preds = %53, %47
  ...
  call void @hypre_Free(i8* %45) #5
  call void @hypre_Free(i8* %43) #5
  br label %62

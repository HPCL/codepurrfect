...
define dso_local void @hypre_SortKeyValueNodesDec(%struct.KeyValueType* %0, i32 %1) local_unnamed_addr #6 {
  ...
  call void @hypre_tex_qsort(i8* %3, i32 %1, i32 8, i32 (i8*, i8*)* nonnull @hypre_DecKeyValueCmp) #10
  ret void
}

declare dso_local void @hypre_tex_qsort(i8*, i32, i32, i32 (i8*, i8*)*) local_unnamed_addr #7
...
define dso_local void @hypre_sincsort(i32 %0, i32* %1) local_unnamed_addr #6 {
  ...
  call void @hypre_tex_qsort(i8* %3, i32 %0, i32 4, i32 (i8*, i8*)* nonnull @incshort) #10
  ret void
}
...
define dso_local void @hypre_sdecsort(i32 %0, i32* %1) local_unnamed_addr #6 {
  %3 = bitcast i32* %1 to i8*
  call void @hypre_tex_qsort(i8* %3, i32 %0, i32 4, i32 (i8*, i8*)* nonnull @decshort) #10
  ret void
}

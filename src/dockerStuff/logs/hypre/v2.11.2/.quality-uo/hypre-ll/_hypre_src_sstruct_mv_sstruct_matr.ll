...
90:                                               ; preds = %87, %90
  ...
  br i1 %94, label %95, label %90, !llvm.loop !118
...
225:                                              ; preds = %224, %225
  ...
  br i1 %232, label %233, label %225, !llvm.loop !119
...
245:                                              ; preds = %239, %245
  ...
  br i1 %271, label %272, label %245, !llvm.loop !120
...
284:                                              ; preds = %278, %284
  ...
  br i1 %310, label %311, label %284, !llvm.loop !121
...
322:                                              ; preds = %319, %322
  ...
  br i1 %332, label %320, label %322, !llvm.loop !122
...
339:                                              ; preds = %320, %339
  ...
  br i1 %349, label %333, label %339, !llvm.loop !123
...
401:                                              ; preds = %401, %360
  ...
  br i1 %408, label %401, label %410, !llvm.loop !126
...
433:                                              ; preds = %422, %410
  ...
  br i1 %435, label %436, label %350, !llvm.loop !127
...
436:                                              ; preds = %433, %333, %311
  ...
  br i1 %442, label %199, label %443, !llvm.loop !128
...
443:                                              ; preds = %436, %185
  ...
  br i1 %447, label %448, label %185, !llvm.loop !129
...
457:                                              ; preds = %450, %455, %453
  ...
  br i1 %461, label %172, label %462, !llvm.loop !130
...
485:                                              ; preds = %476, %485
  ...
  br i1 %492, label %493, label %485, !llvm.loop !131
...
493:                                              ; preds = %485, %468
  ...
  %502 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %73, i64 0, i32 0, i64 0
  %503 = sext i32 %5 to i64
  %504 = icmp sgt i32 %497, 0
  %505 = icmp sgt i32 %494, 0
  br i1 %498, label %506, label %512

506:                                              ; preds = %493
  %507 = getelementptr inbounds [4 x i32], [4 x i32]* %31, i64 0, i64 1
  %508 = bitcast i32* %507 to i8*
  %509 = add i32 %34, -1
  %510 = zext i32 %509 to i64
  %511 = shl nuw nsw i64 %510, 2
  call void @llvm.memset.p0i8.i64(i8* nonnull align 4 %508, i8 0, i64 %511, i1 false)
  br label %512

512:                                              ; preds = %506, %493
  store i32 0, i32* %499, align 4, !tbaa !10
  br i1 %505, label %513, label %565

513:                                              ; preds = %512
  %514 = getelementptr inbounds [3 x i32], [3 x i32]* %14, i64 0, i64 1
  %515 = bitcast i32* %514 to i8*
  %516 = getelementptr inbounds [4 x i32], [4 x i32]* %31, i64 0, i64 1
...
521:                                              ; preds = %513, %562
  %522 = phi double* [ %525, %562 ], [ %7, %513 ]
  %523 = phi i32 [ %563, %562 ], [ 0, %513 ]
  br i1 %504, label %526, label %524

524:                                              ; preds = %530, %521
  %525 = phi double* [ %522, %521 ], [ %533, %530 ]
  br label %536

526:                                              ; preds = %521, %530
  %527 = phi double* [ %533, %530 ], [ %522, %521 ]
  %528 = phi i32 [ %534, %530 ], [ 0, %521 ]
  store i32 %528, i32* %500, align 4, !tbaa !10
  br i1 %501, label %529, label %530

529:                                              ; preds = %526
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 %515, i8* nonnull align 4 %517, i64 %520, i1 false)
  br label %530

530:                                              ; preds = %529, %526
  %531 = call i32 @hypre_AddIndexes(i32* nonnull %500, i32* %502, i32 %34, i32* nonnull %500) #9
  %532 = call i32 @hypre_SStructUMatrixSetValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* nonnull %500, i32 %4, i32 %5, i32* nonnull %6, double* %527, i32 %8)
  %533 = getelementptr inbounds double, double* %527, i64 %503
  %534 = add nuw nsw i32 %528, 1
  %535 = icmp eq i32 %534, %497
  br i1 %535, label %524, label %526, !llvm.loop !132

536:                                              ; preds = %536, %524
  %537 = phi i64 [ %544, %536 ], [ 1, %524 ]
  %538 = getelementptr inbounds [4 x i32], [4 x i32]* %31, i64 0, i64 %537
  %539 = load i32, i32* %538, align 4, !tbaa !10
  %540 = add nsw i32 %539, 2
  %541 = getelementptr inbounds [4 x i32], [4 x i32]* %32, i64 0, i64 %537
  %542 = load i32, i32* %541, align 4, !tbaa !10
  %543 = icmp sgt i32 %540, %542
  %544 = add nuw i64 %537, 1
  br i1 %543, label %536, label %545, !llvm.loop !133

545:                                              ; preds = %536
  %546 = trunc i64 %537 to i32
  %547 = and i64 %537, 4294967295
  %548 = getelementptr inbounds [4 x i32], [4 x i32]* %31, i64 0, i64 %547
  %549 = add nsw i32 %539, 1
  store i32 %549, i32* %548, align 4, !tbaa !10
  %550 = icmp ugt i32 %546, 1
  br i1 %550, label %551, label %562

551:                                              ; preds = %545
  %552 = add i64 %537, 4294967295
  %553 = and i64 %552, 4294967295
  %554 = call i32 @llvm.smin.i32(i32 %546, i32 2)
  %555 = sub i32 %546, %554
  %556 = zext i32 %555 to i64
  %557 = sub nsw i64 %553, %556
  %558 = getelementptr [4 x i32], [4 x i32]* %31, i64 0, i64 %557
  %559 = bitcast i32* %558 to i8*
  %560 = shl nuw nsw i64 %556, 2
  %561 = add nuw nsw i64 %560, 4
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 4 dereferenceable(1) %559, i8 0, i64 %561, i1 false)
  br label %562

562:                                              ; preds = %551, %545
  %563 = add nuw nsw i32 %523, 1
  %564 = icmp eq i32 %563, %494
  br i1 %564, label %565, label %521, !llvm.loop !134
...
566:                                              ; preds = %565, %462
  %567 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %72) #9
  %568 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %73) #9
  %569 = load i32, i32* @hypre__global_error, align 4, !tbaa !10

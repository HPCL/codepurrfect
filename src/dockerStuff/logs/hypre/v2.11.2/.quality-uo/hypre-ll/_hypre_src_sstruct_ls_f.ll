...
define dso_local i8* @hypre_FACCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 288) #6
...
3:                                                ; preds = %1
  ...
  %17 = call i32 @HYPRE_SStructGraphDestroy(%struct.hypre_SStructGraph_struct* %16) #6
  %18 = load %struct.hypre_SStructMatrix_struct*, %struct.hypre_SStructMatrix_struct** %13, align 8, !tbaa !24
  %19 = call i32 @HYPRE_SStructMatrixDestroy(%struct.hypre_SStructMatrix_struct* %18) #6
...
50:                                               ; preds = %3, %111
  ...
  %55 = call i32 @HYPRE_SStructMatrixDestroy(%struct.hypre_SStructMatrix_struct* %54) #6
  ...
  %59 = call i32 @HYPRE_SStructVectorDestroy(%struct.hypre_SStructVector_struct* %58) #6
  ...
  %63 = call i32 @HYPRE_SStructVectorDestroy(%struct.hypre_SStructVector_struct* %62) #6
  ...
  %67 = call i32 @HYPRE_SStructVectorDestroy(%struct.hypre_SStructVector_struct* %66) #6
  ...
  %71 = call i32 @HYPRE_SStructVectorDestroy(%struct.hypre_SStructVector_struct* %70) #6
  ...
  %75 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %74) #6
  ...
  %79 = call i32 @HYPRE_SStructGraphDestroy(%struct.hypre_SStructGraph_struct* %78) #6
...
97:                                               ; preds = %50
  ...
  %101 = call i32 @hypre_FacSemiRestrictDestroy2(i8* %100) #6
  br label %102
...
106:                                              ; preds = %102
  ...
  %110 = call i32 @hypre_FacSemiInterpDestroy2(i8* %109) #6
  br label %111
...
116:                                              ; preds = %111, %3
  ...
  %120 = call i32 @hypre_SStructMatvecDestroy(i8* %119) #6
  ...
  %176 = call i32 @HYPRE_SStructVectorDestroy(%struct.hypre_SStructVector_struct* %175) #6
...
192:                                              ; preds = %116
  ...
  %196 = call i32 @HYPRE_SStructPCGDestroy(%struct.hypre_SStructSolver_struct* %195) #6
  br label %197
...
197:                                              ; preds = %116, %192
  ...
  %202 = call i32 @HYPRE_SStructSysPFMGDestroy(%struct.hypre_SStructSolver_struct* %201) #6
  br label %203
...
define dso_local i32 @hypre_FACSetPLevels(i8* nocapture %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  %4 = sext i32 %1 to i64
  %5 = call i8* @hypre_CAlloc(i64 %4, i64 4) #6
...
define dso_local i32 @hypre_FACSetPRefinements(i8* nocapture %0, i32 %1, [3 x i32]* %2) local_unnamed_addr #0 {
  %4 = sext i32 %1 to i64
  %5 = mul nsw i64 %4, 12
  %6 = call i8* @hypre_MAlloc(i64 %5) #6
...
11:                                               ; preds = %9, %11
  ...
  %15 = call i32 @hypre_CopyIndex(i32* %13, i32* %14) #6
...
define dso_local i32 @hypre_FACPrintLogging(i8* nocapture readonly %0, i32 %1) local_unnamed_addr #4 {
  %3 = getelementptr inbounds i8, i8* %0, i64 252
  %4 = bitcast i8* %3 to i32*
  %5 = load i32, i32* %4, align 4, !tbaa !56
...
22:                                               ; preds = %20, %22
  ...
  %27 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i64 0, i64 0), i32 %26, double %25)
  %28 = getelementptr inbounds double, double* %14, i64 %23
  %29 = load double, double* %28, align 8, !tbaa !57
  %30 = trunc i64 %23 to i32
  %31 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0), i32 %30, double %29)

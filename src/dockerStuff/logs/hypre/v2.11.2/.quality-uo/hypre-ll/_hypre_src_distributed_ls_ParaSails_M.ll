...
define dso_local noalias %struct.Mem* @MemCreate() local_unnamed_addr #0 {
  %1 = call noalias align 16 dereferenceable_or_null(8232) i8* @malloc(i64 8232) #9
...
13:                                               ; preds = %9
  %14 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @.str, i64 0, i64 0), i32 1024)
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !10
  %16 = call i64 @fwrite(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i64 11, i64 1, %struct._IO_FILE* %15) #10
  %17 = call i32 @fflush(%struct._IO_FILE* null)
  %18 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #9
  br label %19
...
26:                                               ; preds = %19
  %27 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([40 x i8], [40 x i8]* @.str.2, i64 0, i64 0), i32 %21)
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !10
  %29 = call i64 @fwrite(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i64 11, i64 1, %struct._IO_FILE* %28) #10
  %30 = call i32 @fflush(%struct._IO_FILE* null)
  %31 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #9
  br label %32
...
define dso_local void @MemStat(%struct.Mem* nocapture readonly %0, %struct._IO_FILE* nocapture %1, i8* %2) local_unnamed_addr #6 {
  %4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0), i8* %2)
  %5 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 0
  %6 = load i32, i32* %5, align 8, !tbaa !3
  %7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i64 0, i64 0), i32 %6)
  %8 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 4
  %9 = load i32, i32* %8, align 8, !tbaa !18
  %10 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i64 0, i64 0), i32 %9)
  %11 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 2
  %12 = load i64, i64* %11, align 8, !tbaa !16
  %13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.6, i64 0, i64 0), i64 %12)
  %14 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 3
  %15 = load i64, i64* %14, align 8, !tbaa !17
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i64 %15)
...
19:                                               ; preds = %3
  ...
  %24 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), double %23)
  br label %25

25:                                               ; preds = %19, %3
  %26 = call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.9, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %1)

...
102:                                              ; preds = %97
  ...
  %105 = call i8* %104(i8* %1, i8* %3) #11
  store i8* %105, i8** %99, align 8, !tbaa !39
  br label %106

106:                                              ; preds = %102, %97
  %107 = call i32 %14(i8* %17, i8* %1, i8* %2, i8* %3) #11
...
122:                                              ; preds = %117
  ...
  %127 = call i8* %124(i64 %126, i64 8) #11
...
140:                                              ; preds = %133, %134
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 401, i32 1, i8* null) #11
  br label %835
...
157:                                              ; preds = %150, %151
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 426, i32 1, i8* null) #11
  br label %835
...
810:                                              ; preds = %806
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 850, i32 256, i8* null) #11
  br label %811

...
168:                                              ; preds = %154, %214
  ...
  invoke void @_ZN10MLI_VectorC1EPvPKcP19MLI_Function_Struct(%class.MLI_Vector* nonnull align 8 dereferenceable(120) %180, i8* %164, i8* nonnull %20, %struct.MLI_Function_Struct* null)
...
181:                                              ; preds = %168
  ...
  invoke void @_ZN10MLI_VectorC1EPvPKcP19MLI_Function_Struct(%class.MLI_Vector* nonnull align 8 dereferenceable(120) %183, i8* %165, i8* nonnull %20, %struct.MLI_Function_Struct* null)

...
define dso_local i32 @hypre_dlacpy(i8* %0, i32* nocapture readonly %1, i32* nocapture readonly %2, double* nocapture readonly %3, i32* nocapture readonly %4, double* nocapture %5, i32* nocapture readonly %6) local_unnamed_addr #0 {
  ...
  %16 = call i64 @hypre_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  %17 = icmp eq i64 %16, 0
...
28:                                               ; preds = %21, %50
  ...
  %33 = mul nsw i64 %29, %23
  %34 = mul nsw i64 %29, %24
...
53:                                               ; preds = %7
  %54 = call i64 @hypre_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
  %55 = icmp eq i64 %54, 0

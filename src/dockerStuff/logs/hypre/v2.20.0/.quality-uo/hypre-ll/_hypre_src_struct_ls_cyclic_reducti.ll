...
define dso_local i8* @hypre_CyclicReductionCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 128, i32 0) #8
...
13:                                               ; preds = %3
  %14 = call i8* @hypre_CAlloc(i64 3, i64 12, i32 0) #8
...
27:                                               ; preds = %3
  %28 = call i8* @hypre_CAlloc(i64 2, i64 12, i32 0) #8
...
define dso_local i32 @hypre_CyclicReductionSetup(i8* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructVector_struct* nocapture readnone %2, %struct.hypre_StructVector_struct* %3) local_unnamed_addr #0 {
  ...
  %49 = shl nsw i64 %48, 3
  %50 = call i8* @hypre_MAlloc(i64 %49, i32 0) #8
...
178:                                              ; preds = %176, %168
  ...
  %181 = call i8* @hypre_MAlloc(i64 %117, i32 0) #8
  %182 = bitcast i8* %181 to %struct.hypre_StructMatrix_struct**
  %183 = call i8* @hypre_MAlloc(i64 %117, i32 0) #8
...
223:                                              ; preds = %197, %178
  ...
  %226 = call i8* @hypre_CAlloc(i64 %225, i64 8, i32 1) #8
  %227 = load i32, i32* %6, align 4, !tbaa !13
  %228 = sext i32 %227 to i64
  %229 = call i8* @hypre_CAlloc(i64 %228, i64 8, i32 0) #8
...
305:                                              ; preds = %295, %267
  ...
  %308 = call i8* @hypre_MAlloc(i64 %307, i32 0) #8
  %309 = bitcast i8* %308 to %struct.hypre_ComputePkg_struct**
  %310 = call i8* @hypre_MAlloc(i64 %307, i32 0) #8
...
66:                                               ; preds = %64, %3
  ...
  call void @hypre_Free(i8* %93, i32 0) #8
...
!13 = !{!5, !5, i64 0}
!14 = !{!15, !8, i64 8}
!15 = !{!"hypre_StructMatrix_struct", !5, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !8, i64 88, !5, i64 96, !5, i64 100, !8, i64 104, !6, i64 112, !5, i64 136, !8, i64 144, !5, i64 152}
!16 = !{!17, !5, i64 4}

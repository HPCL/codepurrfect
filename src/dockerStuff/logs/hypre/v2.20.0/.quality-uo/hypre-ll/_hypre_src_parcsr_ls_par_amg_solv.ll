...
define dso_local i32 @hypre_BoomerAMGSolveT(i8* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %3) local_unnamed_addr #0 {
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 792
  %14 = bitcast i8* %13 to i32*
  %15 = load i32, i32* %14, align 8, !tbaa !10
  %16 = getelementptr inbounds i8, i8* %0, i64 760
...
20:                                               ; preds = %4
  %21 = getelementptr inbounds i8, i8* %0, i64 784
...
24:                                               ; preds = %20, %4
  ...
  %26 = getelementptr inbounds i8, i8* %0, i64 456
  ...
  %35 = getelementptr inbounds i8, i8* %0, i64 400
  ...
  %57 = getelementptr inbounds i8, i8* %0, i64 696
...
118:                                              ; preds = %113, %102
  %119 = getelementptr inbounds i8, i8* %0, i64 720
  %120 = bitcast i8* %119 to double*
  %121 = getelementptr inbounds i8, i8* %0, i64 776
  %122 = bitcast i8* %121 to double*
  %123 = getelementptr inbounds i8, i8* %0, i64 764
...
194:                                              ; preds = %192, %166
  ...
  %197 = getelementptr inbounds i8, i8* %0, i64 720
...
define dso_local i32 @hypre_BoomerAMGCycleT(i8* nocapture %0, %struct.hypre_ParVector_struct** nocapture readonly %1, %struct.hypre_ParVector_struct** nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %7 = getelementptr inbounds i8, i8* %0, i64 408
  ...
  %10 = getelementptr inbounds i8, i8* %0, i64 416
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 696
  ...
  %16 = getelementptr inbounds i8, i8* %0, i64 456
  %17 = bitcast i8* %16 to i32*
  ...
  %37 = getelementptr inbounds i8, i8* %0, i64 720

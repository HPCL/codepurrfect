...
define dso_local i32 @hypre_ParCSRMatrixMatvecOutOfPlace(double %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readonly %2, double %3, %struct.hypre_ParVector_struct* nocapture readonly %4, %struct.hypre_ParVector_struct* nocapture readonly %5) local_unnamed_addr #0 {
  %7 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 15
...
53:                                               ; preds = %50, %47
  ...
  %57 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %54, i64 0, i32 3
  %58 = sext i32 %30 to i64
  %59 = call i8* @hypre_CAlloc(i64 %58, i64 8, i32 0) #3
  %60 = bitcast i8* %59 to %struct.hypre_ParCSRCommHandle**
  %61 = call i32 @hypre_SeqVectorInitialize_v2(%struct.hypre_Vector* %48, i32 1) #3
  %62 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %48, i64 0, i32 0
  %63 = load double*, double** %62, align 8, !tbaa !22
  %64 = call i8* @hypre_CAlloc(i64 %58, i64 8, i32 0) #3
...
73:                                               ; preds = %70
  ...
  %75 = load i32*, i32** %57, align 8, !tbaa !25
...
83:                                               ; preds = %68, %83
  %84 = phi i64 [ 0, %68 ], [ %93, %83 ]
  %85 = load i32*, i32** %57, align 8, !tbaa !25
  %86 = getelementptr inbounds i32, i32* %85, i64 %66
  %87 = load i32, i32* %86, align 4, !tbaa !26
  %88 = sext i32 %87 to i64
  %89 = shl nsw i64 %88, 3
  %90 = call i8* @hypre_MAlloc(i64 %89, i32 1) #3
  %91 = getelementptr inbounds double*, double** %65, i64 %84
  %92 = bitcast double** %91 to i8**
  store i8* %90, i8** %92, align 8, !tbaa !27
  %93 = add nuw nsw i64 %84, 1
  %94 = icmp eq i64 %93, %69
  br i1 %94, label %70, label %83, !llvm.loop !28
...
99:                                               ; preds = %73, %119
  %100 = phi i64 [ 0, %73 ], [ %120, %119 ]
  %101 = getelementptr inbounds double*, double** %65, i64 %100
  %102 = load double*, double** %101, align 8, !tbaa !27
  %103 = trunc i64 %100 to i32
  %104 = mul nsw i32 %34, %103
  %105 = sext i32 %104 to i64
  br i1 %79, label %106, label %119

106:                                              ; preds = %99
  %107 = load i32*, i32** %71, align 8, !tbaa !31
  br label %108

108:                                              ; preds = %106, %108
  %109 = phi i64 [ %80, %106 ], [ %117, %108 ]
  ...
  %116 = getelementptr inbounds double, double* %102, i64 %109
  store double %115, double* %116, align 8, !tbaa !32
  %117 = add nsw i64 %109, 1
  %118 = icmp eq i64 %117, %82
  br i1 %118, label %119, label %108, !llvm.loop !33

119:                                              ; preds = %108, %99
  %120 = add nuw nsw i64 %100, 1
  %121 = icmp eq i64 %120, %81
  br i1 %121, label %95, label %99, !llvm.loop !34

122:                                              ; preds = %97, %122
  %123 = phi i64 [ 0, %97 ], [ %134, %122 ]
  %124 = getelementptr inbounds double*, double** %65, i64 %123
  %125 = bitcast double** %124 to i8**
  %126 = load i8*, i8** %125, align 8, !tbaa !27
  %127 = trunc i64 %123 to i32
  %128 = mul nsw i32 %32, %127
  %129 = sext i32 %128 to i64
  %130 = getelementptr inbounds double, double* %63, i64 %129
  %131 = bitcast double* %130 to i8*
  %132 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate_v2(i32 1, %struct._hypre_ParCSRCommPkg* %54, i32 1, i8* %126, i32 1, i8* %131) #3
  %133 = getelementptr inbounds %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %60, i64 %123
  store %struct.hypre_ParCSRCommHandle* %132, %struct.hypre_ParCSRCommHandle** %133, align 8, !tbaa !27
  %134 = add nuw nsw i64 %123, 1
  %135 = icmp eq i64 %134, %98
  br i1 %135, label %136, label %122, !llvm.loop !35

136:                                              ; preds = %122, %95
  %137 = call i32 @hypre_CSRMatrixMatvecOutOfPlace(double %0, %struct.hypre_CSRMatrix* %10, %struct.hypre_Vector* %14, double %3, %struct.hypre_Vector* %16, %struct.hypre_Vector* %18, i32 0) #3
...
141:                                              ; preds = %139, %141
  ...
  %143 = getelementptr inbounds %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %60, i64 %142
  %144 = load %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %143, align 8, !tbaa !27
  %145 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %144) #3
  store %struct.hypre_ParCSRCommHandle* null, %struct.hypre_ParCSRCommHandle** %143, align 8, !tbaa !27
  %146 = add nuw nsw i64 %142, 1
  %147 = icmp eq i64 %146, %140
  br i1 %147, label %148, label %141, !llvm.loop !36

148:                                              ; preds = %141, %136
  call void @hypre_Free(i8* %59, i32 0) #3
  %149 = icmp eq i32 %32, 0
  br i1 %149, label %152, label %150

150:                                              ; preds = %148
  %151 = call i32 @hypre_CSRMatrixMatvec(double %0, %struct.hypre_CSRMatrix* %12, %struct.hypre_Vector* %48, double 1.000000e+00, %struct.hypre_Vector* %18) #3
  br label %152

152:                                              ; preds = %150, %148
  %153 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %48) #3
...
157:                                              ; preds = %155, %157
  ...
  %159 = getelementptr inbounds double*, double** %65, i64 %158
  %160 = bitcast double** %159 to i8**
  %161 = load i8*, i8** %160, align 8, !tbaa !27
  call void @hypre_Free(i8* %161, i32 1) #3
  store double* null, double** %159, align 8, !tbaa !27
  %162 = add nuw nsw i64 %158, 1
  %163 = icmp eq i64 %162, %156
  br i1 %163, label %164, label %157, !llvm.loop !37

164:                                              ; preds = %157, %152
  %165 = select i1 %41, i32 %38, i32 12
  %166 = select i1 %41, i32 %38, i32 13
  %167 = select i1 %37, i32 %165, i32 %166
  call void @hypre_Free(i8* %64, i32 0) #3
  ret i32 %167
}
...
define dso_local i32 @hypre_ParCSRMatrixMatvecT(double %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readonly %2, double %3, %struct.hypre_ParVector_struct* nocapture readonly %4) local_unnamed_addr #0 {
  ...
  %12 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 9
  %13 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %12, align 8, !tbaa !38
  %14 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 10
...
51:                                               ; preds = %48, %45
  ...
  %58 = bitcast i8* %57 to %struct.hypre_ParCSRCommHandle**
  %59 = call i32 @hypre_SeqVectorInitialize_v2(%struct.hypre_Vector* %46, i32 1) #3
  %60 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %46, i64 0, i32 0
  %61 = load double*, double** %60, align 8, !tbaa !22
  %62 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #3
...
92:                                               ; preds = %90, %92
  ...
  %97 = getelementptr inbounds double, double* %61, i64 %96
  %98 = bitcast double* %97 to i8*
  %99 = getelementptr inbounds double*, double** %63, i64 %93
  ...
  %103 = getelementptr inbounds %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %58, i64 %93
...
116:                                              ; preds = %114, %116
  ...
  %118 = getelementptr inbounds %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %58, i64 %117
...
123:                                              ; preds = %116, %112
  call void @hypre_Free(i8* %57, i32 0) #3
...
126:                                              ; preds = %123
  ...
  %128 = load i32*, i32** %55, align 8, !tbaa !25
...
136:                                              ; preds = %126, %158
  %137 = phi i64 [ 0, %126 ], [ %159, %158 ]
  %138 = getelementptr inbounds double*, double** %63, i64 %137
  %139 = load double*, double** %138, align 8, !tbaa !27
  %140 = trunc i64 %137 to i32
  %141 = mul nsw i32 %33, %140
  %142 = sext i32 %141 to i64
  br i1 %132, label %143, label %158

143:                                              ; preds = %136
  %144 = load i32*, i32** %124, align 8, !tbaa !31
  br label %145

145:                                              ; preds = %143, %145
  %146 = phi i64 [ %133, %143 ], [ %156, %145 ]
  %147 = getelementptr inbounds double, double* %139, i64 %146
  %148 = load double, double* %147, align 8, !tbaa !32
  %149 = getelementptr inbounds i32, i32* %144, i64 %146
  %150 = load i32, i32* %149, align 4, !tbaa !26
  %151 = sext i32 %150 to i64
  %152 = add nsw i64 %151, %142
  %153 = getelementptr inbounds double, double* %35, i64 %152
  ...
  br i1 %157, label %158, label %145, !llvm.loop !43

158:                                              ; preds = %145, %136
  %159 = add nuw nsw i64 %137, 1
  %160 = icmp eq i64 %159, %134
  br i1 %160, label %161, label %136, !llvm.loop !44

161:                                              ; preds = %158, %123
  %162 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %46) #3
  %163 = icmp sgt i32 %29, 0
  br i1 %163, label %164, label %173

164:                                              ; preds = %161
  %165 = zext i32 %29 to i64
  br label %166

166:                                              ; preds = %164, %166
  %167 = phi i64 [ 0, %164 ], [ %171, %166 ]
  %168 = getelementptr inbounds double*, double** %63, i64 %167
  %169 = bitcast double** %168 to i8**
  %170 = load i8*, i8** %169, align 8, !tbaa !27
  call void @hypre_Free(i8* %170, i32 1) #3
  store double* null, double** %168, align 8, !tbaa !27
  %171 = add nuw nsw i64 %167, 1
  %172 = icmp eq i64 %171, %165
  br i1 %172, label %173, label %166, !llvm.loop !45

173:                                              ; preds = %166, %161
  %174 = select i1 %39, i32 %38, i32 2
  %175 = select i1 %39, i32 %38, i32 3
  %176 = select i1 %36, i32 %174, i32 %175
...
define dso_local i32 @hypre_ParCSRMatrixMatvec_FF(double %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readonly %2, double %3, %struct.hypre_ParVector_struct* nocapture readonly %4, i32* %5, i32 %6) local_unnamed_addr #0 {
  ...
  %11 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 15

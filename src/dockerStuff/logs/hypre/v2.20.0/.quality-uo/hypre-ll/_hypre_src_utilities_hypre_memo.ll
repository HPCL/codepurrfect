...
7:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 43, i32 2, i8* getelementptr inbounds ([118 x i8], [118 x i8]* @.str.3, i64 0, i64 0)) #10
...
13:                                               ; preds = %10
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 35, i32 2, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.5, i64 0, i64 0)) #10

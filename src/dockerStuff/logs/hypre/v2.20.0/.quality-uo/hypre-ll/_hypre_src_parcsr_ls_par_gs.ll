...
define dso_local i32 @hypre_BoomerAMGCreateSmoothVecs(i8* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, i32 %2, i32 %3, double** nocapture %4) local_unnamed_addr #0 {
  ...
  %18 = getelementptr inbounds i8, i8* %0, i64 756
  %19 = bitcast i8* %18 to i32*
  %20 = load i32, i32* %19, align 4, !tbaa !52
  %21 = getelementptr inbounds i8, i8* %0, i64 1052
...
31:                                               ; preds = %29, %27
  %32 = getelementptr inbounds i8, i8* %0, i64 500
...
36:                                               ; preds = %31
  %37 = getelementptr inbounds i8, i8* %0, i64 504
  %38 = bitcast i8* %37 to i32*
  %39 = load i32, i32* %38, align 8, !tbaa !56
  %40 = getelementptr inbounds i8, i8* %0, i64 512
  ...
  %43 = getelementptr inbounds i8, i8* %0, i64 520
...
define dso_local i32 @hypre_BoomerAMGCreateSmoothDirs(i8* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, double* nocapture %2, double %3, i32 %4, i32* nocapture readonly %5, %struct.hypre_ParCSRMatrix_struct** nocapture %6) local_unnamed_addr #0 {
  %8 = getelementptr inbounds i8, i8* %0, i64 1052
  ...
  %12 = getelementptr inbounds i8, i8* %0, i64 756
...
735:                                              ; preds = %728, %318
  ...
  %738 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 14
  ...
  %758 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %743, i64 0, i32 18

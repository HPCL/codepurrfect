...
define dso_local %struct.utilities_FortranMatrix* @utilities_FortranMatrixCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_MAlloc(i64 32, i32 0) #12
...
13:                                               ; preds = %11, %7, %3
  ...
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 0) #12
...
define dso_local void @utilities_FortranMatrixWrap(double* %0, i32 %1, i32 %2, i32 %3, %struct.utilities_FortranMatrix* nocapture %4) local_unnamed_addr #3 {
...
define dso_local i32 @utilities_FortranMatrixGlobalHeight(%struct.utilities_FortranMatrix* nocapture readonly %0) local_unnamed_addr #4 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local i32 @utilities_FortranMatrixHeight(%struct.utilities_FortranMatrix* nocapture readonly %0) local_unnamed_addr #4 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local i32 @utilities_FortranMatrixWidth(%struct.utilities_FortranMatrix* nocapture readonly %0) local_unnamed_addr #4 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local double @utilities_FortranMatrixValue(%struct.utilities_FortranMatrix* nocapture readonly %0, i32 %1, i32 %2) local_unnamed_addr #4 {
  %4 = add nsw i32 %1, -1
  %5 = add nsw i32 %2, -1
  %6 = getelementptr inbounds %struct.utilities_FortranMatrix, %struct.utilities_FortranMatrix* %0, i64 0, i32 0
  %7 = load i32, i32* %6, align 8, !tbaa !3
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local double* @utilities_FortranMatrixValuePtr(%struct.utilities_FortranMatrix* nocapture readonly %0, i32 %1, i32 %2) local_unnamed_addr #4 {
  %4 = add nsw i32 %1, -1
  %5 = add nsw i32 %2, -1
  %6 = getelementptr inbounds %struct.utilities_FortranMatrix, %struct.utilities_FortranMatrix* %0, i64 0, i32 0
  %7 = load i32, i32* %6, align 8, !tbaa !3
...
; Function Attrs: mustprogress nounwind uwtable willreturn
define dso_local void @utilities_FortranMatrixSelectBlock(%struct.utilities_FortranMatrix* nocapture readonly %0, i32 %1, i32 %2, i32 %3, i32 %4, %struct.utilities_FortranMatrix* nocapture %5) local_unnamed_addr #3 {
...
define dso_local void @utilities_FortranMatrixUpperInv(%struct.utilities_FortranMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %3 = load i32, i32* %2, align 4, !tbaa !9
  %4 = sext i32 %3 to i64
  %5 = call i8* @hypre_CAlloc(i64 %4, i64 8, i32 0) #12
...
5:                                                ; preds = %2
  ...
  %9 = load i32, i32* %8, align 8, !tbaa !10
  %10 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %7) #12
  %11 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %9) #12
  %12 = getelementptr inbounds %struct.utilities_FortranMatrix, %struct.utilities_FortranMatrix* %0, i64 0, i32 0
  %13 = load i32, i32* %12, align 8, !tbaa !3
  %14 = sub nsw i32 %13, %7
  %15 = icmp sgt i32 %7, 0
...
24:                                               ; preds = %21, %24
  ...
  %27 = load double, double* %25, align 8, !tbaa !17
  %28 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %3, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), double %27) #12

...
234:                                              ; preds = %230
  ...
  %236 = call i8* @hypre_CAlloc(i64 %235, i64 4, i32 0) #7
  %237 = bitcast i8* %236 to i32*
  %238 = call i8* @hypre_CAlloc(i64 %235, i64 8, i32 0) #7
...
244:                                              ; preds = %240
  ...
  %246 = call i8* @hypre_CAlloc(i64 %245, i64 4, i32 0) #7
  %247 = bitcast i8* %246 to i32*
  %248 = call i8* @hypre_CAlloc(i64 %245, i64 8, i32 0) #7
...
304:                                              ; preds = %301
  ...
  %307 = call i8* @hypre_CAlloc(i64 %306, i64 4, i32 0) #7
...
364:                                              ; preds = %361
  ...
  %366 = call i8* @hypre_CAlloc(i64 %365, i64 4, i32 0) #7
...
381:                                              ; preds = %380
  ...
  call void @hypre_Free(i8* %382, i32 0) #7
  br label %383
...
441:                                              ; preds = %427, %404
  ...
  %446 = call i8* @hypre_CAlloc(i64 %445, i64 4, i32 0) #7
...
472:                                              ; preds = %451, %441
  ...
  call void @hypre_Free(i8* %446, i32 0) #7
...
554:                                              ; preds = %542
  ...
  call void @hypre_Free(i8* %555, i32 0) #7
  %556 = sext i32 %552 to i64
  %557 = call i8* @hypre_CAlloc(i64 %556, i64 4, i32 0) #7
...
651:                                              ; preds = %641
  ...
  call void @hypre_Free(i8* %652, i32 0) #7
...
741:                                              ; preds = %731
  ...
  call void @hypre_Free(i8* %743, i32 0) #7
  %744 = sext i32 %739 to i64
  %745 = call i8* @hypre_CAlloc(i64 %744, i64 4, i32 0) #7
  %746 = bitcast i8* %745 to i32*
  %747 = call i8* @hypre_CAlloc(i64 %744, i64 8, i32 0) #7
...
1111:                                             ; preds = %1102
  ...
  call void @hypre_Free(i8* %1112, i32 0) #7
  %1113 = sext i32 %1109 to i64
  %1114 = call i8* @hypre_CAlloc(i64 %1113, i64 4, i32 0) #7
...
1141:                                             ; preds = %1137
  ...
  call void @hypre_Free(i8* %1143, i32 0) #7
  %1144 = sext i32 %1139 to i64
  %1145 = call i8* @hypre_CAlloc(i64 %1144, i64 4, i32 0) #7
  %1146 = bitcast i8* %1145 to i32*
  %1147 = call i8* @hypre_CAlloc(i64 %1144, i64 8, i32 0) #7
...
1201:                                             ; preds = %1191
  ...
  call void @hypre_Free(i8* %1203, i32 0) #7
  %1204 = sext i32 %1199 to i64
  %1205 = call i8* @hypre_CAlloc(i64 %1204, i64 4, i32 0) #7
  %1206 = bitcast i8* %1205 to i32*
  %1207 = call i8* @hypre_CAlloc(i64 %1204, i64 8, i32 0) #7
...
1448:                                             ; preds = %1439, %1429
  ...
  call void @hypre_Free(i8* %186, i32 0) #7
...
1455:                                             ; preds = %1448
  ...
  call void @hypre_Free(i8* %1457, i32 0) #7
  br label %1458
...
1459:                                             ; preds = %1458
  ...
  call void @hypre_Free(i8* %1461, i32 0) #7
  br label %1462

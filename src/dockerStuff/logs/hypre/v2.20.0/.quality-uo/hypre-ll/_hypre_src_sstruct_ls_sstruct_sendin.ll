...
define dso_local %struct.hypre_SStructSendInfoData* @hypre_SStructSendInfo(%struct.hypre_StructGrid_struct* nocapture readonly %0, %struct.hypre_BoxManager* %1, i32* %2) local_unnamed_addr #0 {
  ...
  %31 = call i8* @hypre_CAlloc(i64 1, i64 32, i32 0) #3
  ...
  %44 = call i8* @hypre_CAlloc(i64 %43, i64 8, i32 0) #3
...
81:                                               ; preds = %65, %55
  ...
  %84 = call i8* @hypre_CAlloc(i64 %83, i64 4, i32 0) #3
  %85 = getelementptr inbounds i32*, i32** %41, i64 %56
  %86 = bitcast i32** %85 to i8**
  store i8* %84, i8** %86, align 8, !tbaa !15
  %87 = call i8* @hypre_CAlloc(i64 %83, i64 4, i32 0) #3
...
21:                                               ; preds = %15
  ...
  call void @hypre_Free(i8* nonnull %22, i32 0) #3
...
30:                                               ; preds = %25
  ...
  call void @hypre_Free(i8* nonnull %31, i32 0) #3
...
39:                                               ; preds = %34, %9
  ...
  call void @hypre_Free(i8* %42, i32 0) #3
...
46:                                               ; preds = %39, %1
  ...
  call void @hypre_Free(i8* %47, i32 0) #3
  ret i32 0
}

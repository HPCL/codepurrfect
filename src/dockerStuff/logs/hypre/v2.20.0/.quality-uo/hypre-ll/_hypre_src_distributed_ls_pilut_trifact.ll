...
106:                                              ; preds = %96, %54
  ...
  %110 = call i8* @hypre_CAlloc(i64 %109, i64 4, i32 0) #5
...
509:                                              ; preds = %499, %459
  call void @hypre_Free(i8* %110, i32 0) #5
...
define dso_local i32 @hypre_SetUpLUFactor(%struct.distdef* nocapture readonly %0, %struct.factormatdef* %1, i32 %2, %struct.hypre_PilutSolverGlobals* %3) local_unnamed_addr #0 {
  ...
  call void @hypre_Free(i8* %20, i32 0) #5
  %21 = bitcast i32* %15 to i8*
  call void @hypre_Free(i8* %21, i32 0) #5
...
275:                                              ; preds = %265, %253
  ...
  %277 = sext i32 %276 to i64
  %278 = call i8* @hypre_CAlloc(i64 %277, i64 4, i32 0) #5
...
502:                                              ; preds = %486, %502
  ...
  %505 = load i32, i32* %504, align 4, !tbaa !33
  %506 = sext i32 %505 to i64
  %507 = getelementptr inbounds i32, i32* %5, i64 %506
  %508 = load i32, i32* %16, align 4, !tbaa !9
  %509 = trunc i64 %503 to i32
  %510 = add nsw i32 %508, %509
  store i32 %510, i32* %507, align 4, !tbaa !33
...
710:                                              ; preds = %702
  ...
  call void @hypre_Free(i8* %712, i32 0) #5
  ...
  call void @hypre_Free(i8* %716, i32 0) #5
...
743:                                              ; preds = %730, %710
  ...
  call void @hypre_Free(i8* %278, i32 0) #5

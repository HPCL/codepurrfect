...
10:                                               ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 39, i32 20, i8* null) #4
  br label %51
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 133, i32 12, i8* null) #4
  br label %13
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 159, i32 12, i8* null) #4
  br label %7
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 177, i32 12, i8* null) #4
  br label %7
...
10:                                               ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 283, i32 12, i8* null) #4
  br label %38
...
15:                                               ; preds = %13, %15
  ...
  br i1 %23, label %24, label %15, !llvm.loop !28
...
define dso_local i32 @hypre_ParVectorMassInnerProd(%struct.hypre_ParVector_struct* nocapture readonly %0, %struct.hypre_ParVector_struct** nocapture readonly %1, i32 %2, i32 %3, double* %4) local_unnamed_addr #0 {
  ...
  %11 = shl nsw i64 %10, 3
  %12 = call i8* @hypre_MAlloc(i64 %11, i32 0) #4
...
26:                                               ; preds = %17, %5
  %27 = call i8* @hypre_CAlloc(i64 %10, i64 8, i32 0) #4
  ...
  call void @hypre_Free(i8* %27, i32 0) #4
...
21:                                               ; preds = %19, %21
  ...
  br i1 %29, label %30, label %21, !llvm.loop !32

30:                                               ; preds = %21, %7
  %31 = shl nsw i32 %3, 1
  %32 = sext i32 %31 to i64
  %33 = call i8* @hypre_CAlloc(i64 %32, i64 8, i32 0) #4
  %34 = bitcast i8* %33 to double*
  %35 = call i8* @hypre_CAlloc(i64 %32, i64 8, i32 0) #4
...
44:                                               ; preds = %41, %44
  ...
  store double %47, double* %48, align 8, !tbaa !29
  ...
  store double %51, double* %52, align 8, !tbaa !29
...
55:                                               ; preds = %44, %30
  ...
  call void @hypre_Free(i8* %33, i32 0) #4
  call void @hypre_Free(i8* %35, i32 0) #4
...
22:                                               ; preds = %3
  ...
  %30 = load i32, i32* %29, align 4, !tbaa !35
...
127:                                              ; preds = %124, %127
  ...
  br i1 %145, label %127, label %146, !llvm.loop !36
...
148:                                              ; preds = %146, %116
  ...
  br i1 %152, label %116, label %153, !llvm.loop !37
...
173:                                              ; preds = %169, %173
  ...
  store double %176, double* %177, align 8, !tbaa !29
  %178 = add nuw nsw i64 %174, 1
  %179 = icmp eq i64 %178, %172
  br i1 %179, label %196, label %173, !llvm.loop !38
...
184:                                              ; preds = %180, %184
  ...
  store double %188, double* %190, align 8, !tbaa !29
  %191 = add nuw nsw i64 %185, 1
  %192 = icmp eq i64 %191, %167
  br i1 %192, label %193, label %184, !llvm.loop !39

193:                                              ; preds = %184, %180
  %194 = add nuw nsw i64 %181, 1
  %195 = icmp eq i64 %194, %166
  br i1 %195, label %196, label %180, !llvm.loop !40
...
199:                                              ; preds = %98, %199
  ...
  br i1 %208, label %199, label %209, !llvm.loop !41
...
47:                                               ; preds = %45, %41
  ...
  %55 = load i32, i32* %51, align 4, !tbaa !44
  %56 = add nsw i32 %55, 1
  ...
  store i8* %58, i8** %61, align 8, !tbaa !46
  ...
  store i32 10, i32* %62, align 8, !tbaa !47
  ...
  store %struct.hypre_ProcListElements* %10, %struct.hypre_ProcListElements** %69, align 8, !tbaa !52
...
106:                                              ; preds = %96, %106
  ...
  br i1 %113, label %99, label %106, !llvm.loop !53
...
114:                                              ; preds = %103, %114
  ...
  br i1 %125, label %114, label %228, !llvm.loop !54

126:                                              ; preds = %76
  %127 = load i8*, i8** %61, align 8, !tbaa !46
  call void @hypre_Free(i8* %127, i32 0) #4
  store i32* null, i32** %60, align 8, !tbaa !46
  %128 = load i8*, i8** %54, align 8, !tbaa !45
  call void @hypre_Free(i8* %128, i32 0) #4
  store i32* null, i32** %53, align 8, !tbaa !45
  %129 = load i8*, i8** %65, align 8, !tbaa !48
  call void @hypre_Free(i8* %129, i32 0) #4
  store i32* null, i32** %64, align 8, !tbaa !48
...
139:                                              ; preds = %47
  %140 = load i32, i32* %50, align 8, !tbaa !42
...
153:                                              ; preds = %151, %153
  ...
  br i1 %163, label %164, label %153, !llvm.loop !55
...
182:                                              ; preds = %172, %182
  ...
  br i1 %189, label %175, label %182, !llvm.loop !56
...
190:                                              ; preds = %179, %190
  ...
  br i1 %201, label %190, label %202, !llvm.loop !57
...
215:                                              ; preds = %211, %215
  ...
  br i1 %224, label %225, label %215, !llvm.loop !58
...
228:                                              ; preds = %114, %99, %225
  ...
  %233 = load i8*, i8** %61, align 8, !tbaa !46
  call void @hypre_Free(i8* %233, i32 0) #4
  store i32* null, i32** %60, align 8, !tbaa !46
  %234 = load i8*, i8** %54, align 8, !tbaa !45
  call void @hypre_Free(i8* %234, i32 0) #4
  store i32* null, i32** %53, align 8, !tbaa !45
  %235 = load i8*, i8** %65, align 8, !tbaa !48
...
275:                                              ; preds = %265, %275
  ...
  br i1 %291, label %267, label %275, !llvm.loop !59
...
292:                                              ; preds = %273, %292
  ...
  br i1 %301, label %302, label %292, !llvm.loop !60
...
define dso_local i32 @hypre_FillResponseParToVectorAll(i8* nocapture readonly %0, i32 %1, i32 %2, i8* nocapture readonly %3, i32 %4, i8** nocapture readnone %5, i32* nocapture %6) #0 {
  ...
  %13 = load %struct.hypre_ProcListElements*, %struct.hypre_ProcListElements** %12, align 8, !tbaa !52
...
20:                                               ; preds = %7
  ...
  store i32 %21, i32* %17, align 4, !tbaa !44
  ...
  store i8* %27, i8** %23, align 8, !tbaa !45
  ...
  %31 = load i32, i32* %17, align 4, !tbaa !44
  %32 = add nsw i32 %31, 1
  %33 = sext i32 %32 to i64
  %34 = shl nsw i64 %33, 2
  %35 = call i8* @hypre_ReAlloc(i8* %30, i64 %34, i32 0) #4
  store i8* %35, i8** %29, align 8, !tbaa !46
  br label %36

36:                                               ; preds = %20, %7
  %37 = load i32, i32* %15, align 8, !tbaa !42
...
50:                                               ; preds = %36
  ...
  store i8* %59, i8** %55, align 8, !tbaa !48
  store i32 %53, i32* %46, align 8, !tbaa !47
  br label %60
...
67:                                               ; preds = %62, %67
  ...
  br i1 %75, label %76, label %67, !llvm.loop !61
...
78:                                               ; preds = %76, %60
  ...
  %80 = load i32*, i32** %38, align 8, !tbaa !46
  %81 = add nsw i32 %37, 1
  %82 = sext i32 %81 to i64
  %83 = getelementptr inbounds i32, i32* %80, i64 %82
  store i32 %79, i32* %83, align 4, !tbaa !7
  %84 = load i32, i32* %15, align 8, !tbaa !42
  %85 = add nsw i32 %84, 1
  store i32 %85, i32* %15, align 8, !tbaa !42
...
11:                                               ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1051, i32 12, i8* null) #4
  br label %69
...
32:                                               ; preds = %25
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1069, i32 1, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.7, i64 0, i64 0)) #4
  br label %69
...
38:                                               ; preds = %33, %38
  ...
  %45 = icmp eq i64 %39, 0
  br i1 %45, label %38, label %46, !llvm.loop !62
...
55:                                               ; preds = %52, %55
  ...
  %59 = load double, double* %58, align 8, !tbaa !29
  ...
  br i1 %66, label %55, label %67, !llvm.loop !63
...
21:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1137, i32 1, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.7, i64 0, i64 0)) #4
  br label %74
...
27:                                               ; preds = %22, %27
  ...
  %32 = icmp eq i64 %28, 0
  br i1 %32, label %27, label %33, !llvm.loop !64
...
48:                                               ; preds = %39, %40
  ...
  %51 = load double*, double** %50, align 8, !tbaa !34
...
57:                                               ; preds = %48, %57
  ...
  br i1 %66, label %57, label %67, !llvm.loop !65
...
73:                                               ; preds = %67
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1192, i32 1, i8* null) #4
  br label %74
...
16:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1299, i32 1, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.14, i64 0, i64 0)) #4
  br label %65
...
23:                                               ; preds = %29
  ...
  br i1 %24, label %25, label %29, !llvm.loop !67
...
37:                                               ; preds = %29
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1310, i32 1, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.15, i64 0, i64 0)) #4
  br label %65
...
38:                                               ; preds = %27, %38
  ...
  store double %45, double* %46, align 8, !tbaa !29
  %47 = add nuw nsw i64 %39, 1
  %48 = icmp eq i64 %47, %28
  br i1 %48, label %65, label %38, !llvm.loop !68
...
57:                                               ; preds = %49
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1327, i32 20, i8* null) #4
  br label %65
...
58:                                               ; preds = %55, %58
  ...
  store double %61, double* %62, align 8, !tbaa !29
  %63 = add nuw nsw i64 %59, 1
  %64 = icmp eq i64 %63, %56
  br i1 %64, label %65, label %58, !llvm.loop !69
...
!42 = !{!43, !8, i64 0}
!43 = !{!"", !8, i64 0, !8, i64 4, !4, i64 8, !4, i64 16, !8, i64 24, !4, i64 32, !4, i64 40, !4, i64 48}
!44 = !{!43, !8, i64 4}
!45 = !{!43, !4, i64 8}
!46 = !{!43, !4, i64 16}
!47 = !{!43, !8, i64 24}
!48 = !{!43, !4, i64 32}
!49 = !{!50, !4, i64 0}
!50 = !{!"", !4, i64 0, !8, i64 8, !8, i64 12, !4, i64 16, !4, i64 24}
!51 = !{!50, !4, i64 16}
!52 = !{!50, !4, i64 24}

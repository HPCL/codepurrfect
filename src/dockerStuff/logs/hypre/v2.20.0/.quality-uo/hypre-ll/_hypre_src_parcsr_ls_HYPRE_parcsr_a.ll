...
define dso_local i32 @HYPRE_BoomerAMGSetCoarsenCutFactor(%struct.hypre_Solver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %4 = call i32 @hypre_BoomerAMGSetCoarsenCutFactor(i8* %3, i32 %1) #2
  ret i32 %4
}
...
define dso_local i32 @HYPRE_BoomerAMGGetCoarsenCutFactor(%struct.hypre_Solver_struct* %0, i32* %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %4 = call i32 @hypre_BoomerAMGGetCoarsenCutFactor(i8* %3, i32* %1) #2
  ret i32 %4
}
...
define dso_local i32 @HYPRE_BoomerAMGInitGridRelaxation(i32** nocapture %0, i32** nocapture %1, i32*** nocapture %2, i32 %3, double** nocapture %4, i32 %5) local_unnamed_addr #0 {
  %7 = call i8* @hypre_CAlloc(i64 4, i64 4, i32 0) #2
  %8 = bitcast i32** %0 to i8**
  store i8* %7, i8** %8, align 8, !tbaa !3
  %9 = call i8* @hypre_CAlloc(i64 4, i64 4, i32 0) #2
  %10 = bitcast i32** %1 to i8**
  store i8* %9, i8** %10, align 8, !tbaa !3
  %11 = call i8* @hypre_CAlloc(i64 4, i64 8, i32 0) #2
  %12 = bitcast i32*** %2 to i8**
  store i8* %11, i8** %12, align 8, !tbaa !3
  %13 = sext i32 %5 to i64
  %14 = call i8* @hypre_CAlloc(i64 %13, i64 8, i32 0) #2
...
21:                                               ; preds = %6
  ...
  %22 = call i8* @hypre_CAlloc(i64 4, i64 4, i32 0) #2
  ...
  %31 = call i8* @hypre_CAlloc(i64 4, i64 4, i32 0) #2
  ...
  %43 = call i8* @hypre_CAlloc(i64 4, i64 4, i32 0) #2
...
53:                                               ; preds = %6
  ...
  store i32 3, i32* %18, align 4, !tbaa !7
  %54 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #2
  ...
  %61 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #2
  ...
  %69 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #2
...
75:                                               ; preds = %53, %21
  ...
  %78 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 0) #2
...
define dso_local i32 @HYPRE_BoomerAMGGetGridHierarchy(%struct.hypre_Solver_struct* %0, i32* %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %4 = call i32 @hypre_BoomerAMGGetGridHierarchy(i8* %3, i32* %1) #2
  ret i32 %4
}
...
define dso_local i32 @HYPRE_BoomerAMGSetCpointsToKeep(%struct.hypre_Solver_struct* %0, i32 %1, i32 %2, i32* %3) local_unnamed_addr #0 {
  %5 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %6 = call i32 @hypre_BoomerAMGSetCPoints(i8* %5, i32 %1, i32 %2, i32* %3) #2
  ret i32 %6
}
...
define dso_local i32 @HYPRE_BoomerAMGSetFPoints(%struct.hypre_Solver_struct* %0, i32 %1, i32* %2) local_unnamed_addr #0 {
  %4 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %5 = call i32 @hypre_BoomerAMGSetFPoints(i8* %4, i32 0, i32 %1, i32* %2) #2
  ret i32 %5
}
...
define dso_local i32 @HYPRE_BoomerAMGSetIsolatedFPoints(%struct.hypre_Solver_struct* %0, i32 %1, i32* %2) local_unnamed_addr #0 {
  %4 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %5 = call i32 @hypre_BoomerAMGSetFPoints(i8* %4, i32 1, i32 %1, i32* %2) #2
  ret i32 %5
}

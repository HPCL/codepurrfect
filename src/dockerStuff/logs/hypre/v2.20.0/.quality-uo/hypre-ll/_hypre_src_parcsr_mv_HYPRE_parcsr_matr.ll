...
6:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 234, i32 12, i8* null) #3
  %7 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
  br label %35
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 279, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 301, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 323, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 351, i32 44, i8* null) #3
  br label %11
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 375, i32 28, i8* null) #3
  br label %9

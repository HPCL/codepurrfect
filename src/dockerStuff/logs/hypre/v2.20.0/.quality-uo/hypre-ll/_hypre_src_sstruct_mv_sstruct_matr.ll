...
define dso_local i32 @hypre_SStructUMatrixInitialize(%struct.hypre_SStructMatrix_struct* nocapture %0) local_unnamed_addr #1 {
  ...
  %14 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 18
...
350:                                              ; preds = %346, %317
  ...
  %357 = call i8* @hypre_CAlloc(i64 %353, i64 4, i32 1) #8
  ...
  %360 = call i8* @hypre_CAlloc(i64 %353, i64 8, i32 1) #8
  %361 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 14
  %362 = bitcast double** %361 to i8**
  store i8* %360, i8** %362, align 8, !tbaa !110
  %363 = call i32 @HYPRE_IJMatrixInitialize(%struct.hypre_IJMatrix_struct* %13) #8
  %364 = load i32, i32* @hypre__global_error, align 4, !tbaa !10
...
define dso_local i32 @hypre_SStructUMatrixSetValues(%struct.hypre_SStructMatrix_struct* nocapture readonly %0, i32 %1, i32* %2, i32 %3, i32 %4, i32* nocapture readonly %5, double* %6, i32 %7) local_unnamed_addr #1 {
  ...
  %47 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 18
...
58:                                               ; preds = %54
  ...
  %63 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 13
  %64 = load i32*, i32** %63, align 8, !tbaa !109
  %65 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 14
...
define dso_local i32 @hypre_SStructUMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* nocapture readonly %0, i32 %1, %struct.hypre_Box_struct* %2, i32 %3, i32 %4, i32* nocapture readonly %5, %struct.hypre_Box_struct* %6, double* %7, i32 %8) local_unnamed_addr #1 {
  ...
  %71 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 18
...
186:                                              ; preds = %183, %186
  ...
  br i1 %193, label %185, label %186, !llvm.loop !118
...
232:                                              ; preds = %231, %232
  ...
  br i1 %239, label %240, label %232, !llvm.loop !119
...
252:                                              ; preds = %246, %252
  ...
  br i1 %278, label %279, label %252, !llvm.loop !120
...
291:                                              ; preds = %285, %291
  ...
  br i1 %317, label %318, label %291, !llvm.loop !121
...
329:                                              ; preds = %326, %329
  ...
  br i1 %339, label %327, label %329, !llvm.loop !122
...
345:                                              ; preds = %327, %345
  ...
  br i1 %355, label %340, label %345, !llvm.loop !123
...
400:                                              ; preds = %384, %374
  ...
  br i1 %411, label %363, label %369, !llvm.loop !125
...
412:                                              ; preds = %412, %366
  ...
  br i1 %419, label %412, label %421, !llvm.loop !126
...
444:                                              ; preds = %433, %421
  ...
  br i1 %446, label %447, label %356, !llvm.loop !127
...
447:                                              ; preds = %444, %340, %318
  ...
  br i1 %451, label %207, label %452, !llvm.loop !128
...
452:                                              ; preds = %447, %194
  ...
  br i1 %455, label %456, label %194, !llvm.loop !129
...
464:                                              ; preds = %457, %462, %460
  ...
  br i1 %468, label %168, label %469, !llvm.loop !130
...
492:                                              ; preds = %483, %492
  ...
  br i1 %499, label %500, label %492, !llvm.loop !131
...
537:                                              ; preds = %536, %533
  ...
  br i1 %542, label %531, label %533, !llvm.loop !132
...
543:                                              ; preds = %543, %531
  ...
  br i1 %550, label %543, label %552, !llvm.loop !133
...
569:                                              ; preds = %558, %552
  ...
  br i1 %571, label %572, label %528, !llvm.loop !134
...
95:                                               ; preds = %93, %95
  ...
  br i1 %103, label %104, label %95, !llvm.loop !140
...
259:                                              ; preds = %258
  ...
  %270 = load i32, i32* %269, align 4, !tbaa !141
  ...
  %273 = load i32, i32* %272, align 4, !tbaa !141
...
283:                                              ; preds = %275
  ...
  %287 = call i8* @hypre_ReAlloc(i8* %250, i64 %286, i32 0) #8
...
293:                                              ; preds = %292, %293
  ...
  br i1 %300, label %301, label %293, !llvm.loop !143
...
313:                                              ; preds = %307, %313
  ...
  br i1 %339, label %340, label %313, !llvm.loop !144
...
352:                                              ; preds = %346, %352
  ...
  br i1 %378, label %379, label %352, !llvm.loop !145
...
390:                                              ; preds = %387, %390
  ...
  br i1 %400, label %388, label %390, !llvm.loop !146
...
406:                                              ; preds = %388, %406
  ...
  br i1 %416, label %401, label %406, !llvm.loop !147
...
430:                                              ; preds = %421, %430
  ...
  %437 = load double, double* %436, align 8, !tbaa !112
  %438 = getelementptr inbounds double, double* %288, i64 %431
  store double %437, double* %438, align 8, !tbaa !112
  %439 = add i64 %431, %405
  %440 = add i64 %432, %404
  %441 = add nuw nsw i32 %433, 1
  %442 = icmp eq i32 %441, %381
  br i1 %442, label %424, label %430, !llvm.loop !148
...
443:                                              ; preds = %443, %427
  ...
  br i1 %450, label %443, label %452, !llvm.loop !149
...
475:                                              ; preds = %464, %452
  ...
  br i1 %477, label %478, label %417, !llvm.loop !150
...
486:                                              ; preds = %485, %486
  ...
  br i1 %493, label %494, label %486, !llvm.loop !151
...
506:                                              ; preds = %500, %506
  ...
  br i1 %532, label %533, label %506, !llvm.loop !152
...
545:                                              ; preds = %539, %545
  ...
  br i1 %571, label %572, label %545, !llvm.loop !153
...
583:                                              ; preds = %580, %583
  ...
  br i1 %593, label %581, label %583, !llvm.loop !154
...
599:                                              ; preds = %581, %599
  ...
  br i1 %609, label %594, label %599, !llvm.loop !155
...
636:                                              ; preds = %636, %620
  ...
  br i1 %643, label %636, label %645, !llvm.loop !157
...
668:                                              ; preds = %657, %645
  ...
  br i1 %670, label %671, label %610, !llvm.loop !158
...
672:                                              ; preds = %275, %671, %478, %259, %258
  ...
  br i1 %677, label %248, label %678, !llvm.loop !159

678:                                              ; preds = %672, %238
  %679 = phi i8* [ %230, %238 ], [ %673, %672 ]
  %680 = load i8*, i8** %160, align 8, !tbaa !9
  call void @hypre_Free(i8* %680, i32 0) #8
  store %struct.hypre_BoxManEntry_struct** null, %struct.hypre_BoxManEntry_struct*** %12, align 8, !tbaa !9
  br label %681
...
681:                                              ; preds = %228, %678
  ...
  br i1 %686, label %228, label %687, !llvm.loop !160

687:                                              ; preds = %681, %199
  %688 = phi i8* [ %201, %199 ], [ %682, %681 ]
  %689 = load i8*, i8** %161, align 8, !tbaa !9
  call void @hypre_Free(i8* %689, i32 0) #8
  ...
  br i1 %691, label %692, label %199, !llvm.loop !161
...
692:                                              ; preds = %687, %9
  ...
  call void @hypre_Free(i8* %693, i32 0) #8
...
define dso_local i32 @hypre_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* nocapture readonly %0, i32 %1, %struct.hypre_Box_struct* %2, i32 %3, i32 %4, i32* nocapture readonly %5, %struct.hypre_Box_struct* %6, double* %7, i32 %8) local_unnamed_addr #1 {
  ...
  %27 = load i32*, i32** %26, align 8, !tbaa !137
  %28 = icmp sgt i32 %4, 0
...
65:                                               ; preds = %61, %57, %53
  ...
  br i1 %69, label %70, label %40, !llvm.loop !138
...
74:                                               ; preds = %70
  ...
  %76 = load %struct.hypre_SStructPMatrix**, %struct.hypre_SStructPMatrix*** %75, align 8, !tbaa !139
...
!78 = !{!79, !5, i64 4}
!79 = !{!"hypre_SStructMatrix_struct", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !5, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !5, i64 112, !5, i64 116, !5, i64 120, !5, i64 124}
!80 = !{!79, !8, i64 48}
!81 = !{!79, !5, i64 124}
!82 = !{!79, !8, i64 8}
!83 = !{!84, !8, i64 8}

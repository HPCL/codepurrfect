...
define dso_local i32 @hypre_PFMG2BuildRAPSym(%struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6) local_unnamed_addr #0 {
  ...
  %26 = icmp eq i32 %11, 5
  %27 = load i32, i32* %25, align 8, !tbaa !25
  %28 = icmp sgt i32 %27, 0
  br i1 %28, label %29, label %60

29:                                               ; preds = %7, %55
  %30 = phi i64 [ %56, %55 ], [ 0, %7 ]
  %31 = phi i64 [ %37, %55 ], [ 0, %7 ]
  %32 = getelementptr inbounds i32, i32* %21, i64 %30
...
36:                                               ; preds = %36, %29
  %37 = phi i64 [ %41, %36 ], [ %35, %29 ]
  %38 = getelementptr inbounds i32, i32* %15, i64 %37
  %39 = load i32, i32* %38, align 4, !tbaa !9
  %40 = icmp eq i32 %39, %33
  %41 = add i64 %37, 1
  br i1 %40, label %42, label %36, !llvm.loop !27

42:                                               ; preds = %36
  %43 = trunc i64 %37 to i32
  %44 = trunc i64 %30 to i32
  br i1 %26, label %45, label %50

45:                                               ; preds = %42
  br i1 %24, label %46, label %48

46:                                               ; preds = %45
  %47 = call i32 @hypre_PFMG2BuildRAPSym_onebox_FSS5_CC1(i32 %44, i32 %43, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %55

48:                                               ; preds = %45
  %49 = call i32 @hypre_PFMG2BuildRAPSym_onebox_FSS5_CC0(i32 %44, i32 %43, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %55
...
51:                                               ; preds = %50
  %52 = call i32 @hypre_PFMG2BuildRAPSym_onebox_FSS9_CC1(i32 %44, i32 %43, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %55

53:                                               ; preds = %50
  %54 = call i32 @hypre_PFMG2BuildRAPSym_onebox_FSS9_CC0(i32 %44, i32 %43, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %55

55:                                               ; preds = %48, %46, %53, %51
  %56 = add nuw nsw i64 %30, 1
  %57 = load i32, i32* %25, align 8, !tbaa !25
  %58 = sext i32 %57 to i64
  %59 = icmp slt i64 %56, %58
  br i1 %59, label %29, label %60, !llvm.loop !28

60:                                               ; preds = %55, %7
  %61 = load i32, i32* @hypre__global_error, align 4, !tbaa !9
  ret i32 %61
}

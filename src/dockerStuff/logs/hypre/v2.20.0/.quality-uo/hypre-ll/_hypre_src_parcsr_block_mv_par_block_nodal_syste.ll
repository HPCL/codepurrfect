...
354:                                              ; preds = %345, %315
  ...
  %364 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %355, i64 0, i32 11
  %365 = bitcast i32** %364 to i8**
  store i8* %264, i8** %365, align 8, !tbaa !58
  %366 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %355, i64 0, i32 15

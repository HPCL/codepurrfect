...
define dso_local void @Mem_dhCreate(%struct._mem_dh** nocapture %0) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0), i32 38, i32 1) #6
  %2 = call noalias align 16 dereferenceable_or_null(40) i8* @malloc(i64 40) #6
  %3 = load i8, i8* @errFlag_dh, align 1, !tbaa !3, !range !7
  %4 = icmp eq i8 %3, 0
  br i1 %4, label %6, label %5

5:                                                ; preds = %1
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0), i32 39) #6
  br label %8
...
define dso_local void @Mem_dhDestroy(%struct._mem_dh* nocapture %0) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0), i32 54, i32 1) #6
  %2 = load %struct._parser_dh*, %struct._parser_dh** @parser_dh, align 8, !tbaa !8
  %3 = call zeroext i1 @Parser_dhHasSwitch(%struct._parser_dh* %2, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0)) #6
...
8:                                                ; preds = %4
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0), i32 56) #6
  br label %11
...
5:                                                ; preds = %3
  call void @setError_dh(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0), i32 125) #6
  br label %32
...
10:                                               ; preds = %6
  %11 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.9, i64 0, i64 0)) #6
  %12 = getelementptr inbounds %struct._mem_dh, %struct._mem_dh* %0, i64 0, i32 3
  %13 = load double, double* %12, align 8, !tbaa !12
  %14 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.10, i64 0, i64 0), double %13) #6
  %15 = getelementptr inbounds %struct._mem_dh, %struct._mem_dh* %0, i64 0, i32 4
  %16 = load double, double* %15, align 8, !tbaa !15
  %17 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.11, i64 0, i64 0), double %16) #6
  ...
  %21 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.12, i64 0, i64 0), double %20) #6
  ...
  %25 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.13, i64 0, i64 0), double %24) #6
  ...
  %29 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str.14, i64 0, i64 0), double %28) #6
  %30 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.15, i64 0, i64 0)) #6
  %31 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %1, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.16, i64 0, i64 0)) #6
  br label %32
...
define dso_local noalias i8* @Mem_dhMalloc(%struct._mem_dh* nocapture %0, i64 %1) local_unnamed_addr #0 {
  %3 = add i64 %1, 32
  %4 = call noalias align 16 i8* @malloc(i64 %3) #6
  %5 = icmp eq i8* %4, null
...
6:                                                ; preds = %2
  ...
  %10 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([64 x i8], [64 x i8]* @.str.5, i64 0, i64 0), double %8, i32 %9) #6
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0), i32 78) #6
  br label %29
...
11:                                               ; preds = %2
  ...
  store double %14, double* %15, align 16, !tbaa !19
  ...
  store double %21, double* %19, align 8, !tbaa !17
  ...
  store double %24, double* %22, align 8, !tbaa !16
  ...
  store double %28, double* %25, align 8, !tbaa !18
  br label %29
...
define dso_local void @Mem_dhFree(%struct._mem_dh* nocapture readnone %0, i8* nocapture %1) local_unnamed_addr #4 {

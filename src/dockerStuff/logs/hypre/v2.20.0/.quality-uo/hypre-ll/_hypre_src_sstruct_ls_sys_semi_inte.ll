; ModuleID = '/hypre/src/sstruct_ls/sys_semi_interp.c'
source_filename = "/hypre/src/sstruct_ls/sys_semi_interp.c"
...
define dso_local i32 @hypre_SysSemiInterpCreate(i8** nocapture %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 16, i32 0) #2
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SysSemiInterpSetup(i8* nocapture %0, %struct.hypre_SStructPMatrix* nocapture readonly %1, i32 %2, %struct.hypre_SStructPVector* nocapture readonly %3, %struct.hypre_SStructPVector* nocapture readonly %4, i32* %5, i32* %6, i32* %7) local_unnamed_addr #0 {
  %9 = getelementptr inbounds %struct.hypre_SStructPMatrix, %struct.hypre_SStructPMatrix* %1, i64 0, i32 3
  %10 = load i32, i32* %9, align 8, !tbaa !9
  %11 = sext i32 %10 to i64
  %12 = call i8* @hypre_CAlloc(i64 %11, i64 8, i32 0) #2
  %13 = bitcast i8* %12 to i8**
  %14 = getelementptr inbounds %struct.hypre_SStructPMatrix, %struct.hypre_SStructPMatrix* %1, i64 0, i32 6
  %15 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %3, i64 0, i32 3
  %16 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %4, i64 0, i32 3
...
20:                                               ; preds = %18, %20
  ...
  %33 = call i8* @hypre_SemiInterpCreate() #2
  %34 = getelementptr inbounds i8*, i8** %13, i64 %21
  store i8* %33, i8** %34, align 8, !tbaa !3
  %35 = call i32 @hypre_SemiInterpSetup(i8* %33, %struct.hypre_StructMatrix_struct* %26, i32 %2, %struct.hypre_StructVector_struct* %29, %struct.hypre_StructVector_struct* %32, i32* %5, i32* %6, i32* %7) #2
...
declare dso_local i8* @hypre_SemiInterpCreate() local_unnamed_addr #1

declare dso_local i32 @hypre_SemiInterpSetup(i8*, %struct.hypre_StructMatrix_struct*, i32, %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct*, i32*, i32*, i32*) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SysSemiInterp(i8* nocapture readonly %0, %struct.hypre_SStructPMatrix* nocapture readonly %1, %struct.hypre_SStructPVector* nocapture readonly %2, %struct.hypre_SStructPVector* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %12 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %3, i64 0, i32 3
  %13 = icmp sgt i32 %9, 0
...
16:                                               ; preds = %14, %16
  ...
  %31 = call i32 @hypre_SemiInterp(i8* %19, %struct.hypre_StructMatrix_struct* %24, %struct.hypre_StructVector_struct* %27, %struct.hypre_StructVector_struct* %30) #2
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SysSemiInterpDestroy(i8* %0) local_unnamed_addr #0 {
  %2 = icmp eq i8* %0, null
...
17:                                               ; preds = %12
  %18 = call i32 @hypre_SemiInterpDestroy(i8* nonnull %15) #2
  br label %19
...
22:                                               ; preds = %19, %3
  ...
  call void @hypre_Free(i8* %23, i32 0) #2
  call void @hypre_Free(i8* nonnull %0, i32 0) #2
  br label %24

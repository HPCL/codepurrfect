...
define dso_local void @PCG_ParaSails(%struct.Matrix* %0, %struct.ParaSails* %1, double* %2, double* %3, double %4, i32 %5) local_unnamed_addr #0 {
  ...
  %71 = call i32 @hypre_MPI_Comm_rank(i32 %70, i32* nonnull %61) #5
  ...
  %76 = call double @hypre_ddot(i32* nonnull %57, double* %2, i32* nonnull %60, double* %2, i32* nonnull %60) #5
  store double %76, double* %58, align 8, !tbaa !12
  %77 = call i32 @hypre_MPI_Allreduce(i8* nonnull %73, i8* nonnull %74, i32 1, i32 1275070475, i32 1476395011, i32 %70) #5
...
82:                                               ; preds = %6
  ...
  %85 = call i32 @hypre_dcopy(i32* nonnull %55, double* %2, i32* nonnull %56, double* %3, i32* nonnull %56) #5
...
86:                                               ; preds = %6
  ...
  %88 = shl nsw i64 %87, 3
  %89 = call i8* @hypre_MAlloc(i64 %88, i32 0) #5
  %90 = bitcast i8* %89 to double*
  %91 = call i8* @hypre_MAlloc(i64 %88, i32 0) #5
  %92 = bitcast i8* %91 to double*
  %93 = call i8* @hypre_MAlloc(i64 %88, i32 0) #5
  %94 = bitcast i8* %93 to double*
  call void @MatrixMatvec(%struct.Matrix* %0, double* %3, double* %94) #5
  ...
  %98 = call i32 @hypre_dscal(i32* nonnull %52, double* nonnull %53, double* %94, i32* nonnull %54) #5
  ...
  %102 = call i32 @hypre_daxpy(i32* nonnull %49, double* nonnull %50, double* %2, i32* nonnull %51, double* %94, i32* nonnull %51) #5
...
104:                                              ; preds = %86
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %94, double* %90) #5
  br label %109
...
105:                                              ; preds = %86
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %107) #5
  store i32 1, i32* %48, align 4, !tbaa !11
  %108 = call i32 @hypre_dcopy(i32* nonnull %47, double* %94, i32* nonnull %48, double* %90, i32* nonnull %48) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %107) #5
...
109:                                              ; preds = %105, %104
  ...
  %114 = call double @hypre_ddot(i32* nonnull %43, double* %94, i32* nonnull %46, double* %90, i32* nonnull %46) #5
  store double %114, double* %44, align 8, !tbaa !12
  %115 = call i32 @hypre_MPI_Allreduce(i8* nonnull %111, i8* nonnull %112, i32 1, i32 1275070475, i32 1476395011, i32 %70) #5
...
144:                                              ; preds = %109, %176
  ...
  call void @MatrixMatvec(%struct.Matrix* %0, double* %90, double* %92) #5
  ...
  %148 = call double @hypre_ddot(i32* nonnull %39, double* %92, i32* nonnull %42, double* %90, i32* nonnull %42) #5
  store double %148, double* %40, align 8, !tbaa !12
  %149 = call i32 @hypre_MPI_Allreduce(i8* nonnull %118, i8* nonnull %119, i32 1, i32 1275070475, i32 1476395011, i32 %70) #5
  ...
  %152 = call i32 @hypre_daxpy(i32* nonnull %36, double* nonnull %37, double* %90, i32* nonnull %38, double* %3, i32* nonnull %38) #5
  ...
  %154 = call i32 @hypre_daxpy(i32* nonnull %33, double* nonnull %34, double* %92, i32* nonnull %35, double* %94, i32* nonnull %35) #5
...
155:                                              ; preds = %144
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %94, double* %92) #5
  br label %158

156:                                              ; preds = %144
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %127)
  store i32 %68, i32* %31, align 4, !tbaa !11
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %128) #5
  store i32 1, i32* %32, align 4, !tbaa !11
  %157 = call i32 @hypre_dcopy(i32* nonnull %31, double* %94, i32* nonnull %32, double* %92, i32* nonnull %32) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %128) #5
...
158:                                              ; preds = %156, %155
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %132) #5
  store i32 1, i32* %30, align 4, !tbaa !11
  %159 = call double @hypre_ddot(i32* nonnull %27, double* %94, i32* nonnull %30, double* %92, i32* nonnull %30) #5
  store double %159, double* %28, align 8, !tbaa !12
  %160 = call i32 @hypre_MPI_Allreduce(i8* nonnull %130, i8* nonnull %131, i32 1, i32 1275070475, i32 1476395011, i32 %70) #5
  %161 = load double, double* %29, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %132) #5
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %136) #5
  store i32 1, i32* %26, align 4, !tbaa !11
  %162 = call double @hypre_ddot(i32* nonnull %23, double* %94, i32* nonnull %26, double* %94, i32* nonnull %26) #5
  store double %162, double* %24, align 8, !tbaa !12
  %163 = call i32 @hypre_MPI_Allreduce(i8* nonnull %134, i8* nonnull %135, i32 1, i32 1275070475, i32 1476395011, i32 %70) #5
  %164 = load double, double* %25, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %136) #5
...
174:                                              ; preds = %171
  %175 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str, i64 0, i64 0)) #5
  br label %182
...
176:                                              ; preds = %166
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %139) #5
  store i32 1, i32* %22, align 4, !tbaa !11
  %178 = call i32 @hypre_dscal(i32* nonnull %20, double* nonnull %21, double* %90, i32* nonnull %22) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %139) #5
  ...
  %179 = call i32 @hypre_daxpy(i32* nonnull %17, double* nonnull %18, double* %92, i32* nonnull %19, double* %90, i32* nonnull %19) #5
...
182:                                              ; preds = %176, %158, %109, %171, %174
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %186) #5
  store i32 1, i32* %16, align 4, !tbaa !11
  %187 = call i32 @hypre_dscal(i32* nonnull %14, double* nonnull %15, double* %94, i32* nonnull %16) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %186) #5
  ...
  %191 = call i32 @hypre_daxpy(i32* nonnull %11, double* nonnull %12, double* %2, i32* nonnull %13, double* %94, i32* nonnull %13) #5
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %193) #5
  %194 = bitcast double* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %194) #5
  %195 = bitcast i32* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %195) #5
  store i32 1, i32* %10, align 4, !tbaa !11
  %196 = call double @hypre_ddot(i32* nonnull %7, double* %94, i32* nonnull %10, double* %94, i32* nonnull %10) #5
  store double %196, double* %8, align 8, !tbaa !12
  %197 = call i32 @hypre_MPI_Allreduce(i8* nonnull %193, i8* nonnull %194, i32 1, i32 1275070475, i32 1476395011, i32 %70) #5
  %198 = load double, double* %9, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %195) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %194) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %193) #5
...
201:                                              ; preds = %182
  ...
  %203 = call double @sqrt(double %202) #5
  %204 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.1, i64 0, i64 0), i32 %183, double %203) #5
  br label %205

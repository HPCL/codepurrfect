...
define dso_local %struct.numbering* @NumberingCreate(%struct.Matrix* %0, i32 %1) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 40, i32 0) #5
  ...
  %27 = shl nsw i64 %26, 2
  %28 = call i8* @hypre_MAlloc(i64 %27, i32 0) #5
  ...
  %32 = shl nsw i32 %1, 1
  %33 = or i32 %32, 1
  %34 = call %struct.Hash* @HashCreate(i32 %33) #5
...
55:                                               ; preds = %41, %112
  ...
  call void @MatrixGetRow(%struct.Matrix* %0, i32 %56, i32* nonnull %3, i32** nonnull %4, double** nonnull %5) #5
...
71:                                               ; preds = %68, %60
  ...
  %73 = call i32 @HashLookup(%struct.Hash* %72, i32 %65) #5
  %74 = icmp eq i32 %73, -1
...
78:                                               ; preds = %75
  ...
  %84 = shl nsw i64 %83, 2
  %85 = call i8* @hypre_ReAlloc(i8* %80, i64 %84, i32 0) #5
  store i8* %85, i8** %31, align 8, !tbaa !16
  %86 = load i32, i32* %10, align 8, !tbaa !3
  %87 = shl nsw i32 %86, 1
  %88 = or i32 %87, 1
  %89 = call %struct.Hash* @HashCreate(i32 %88) #5
  %90 = load %struct.Hash*, %struct.Hash** %36, align 8, !tbaa !17
  call void @HashRehash(%struct.Hash* %90, %struct.Hash* %89) #5
  %91 = load %struct.Hash*, %struct.Hash** %36, align 8, !tbaa !17
  call void @HashDestroy(%struct.Hash* %91) #5
...
92:                                               ; preds = %78, %75
  ...
  call void @HashInsert(%struct.Hash* %93, i32 %96, i32 %62) #5
...
119:                                              ; preds = %112, %41
  ...
  call void @hypre_shell_sort(i32 %120, i32* %124) #5
  %125 = load %struct.Hash*, %struct.Hash** %36, align 8, !tbaa !17
  call void @HashReset(%struct.Hash* %125) #5
...
127:                                              ; preds = %119, %127
  ...
  call void @HashInsert(%struct.Hash* %129, i32 %135, i32 %132) #5
...
define dso_local %struct.numbering* @NumberingCreateCopy(%struct.numbering* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_MAlloc(i64 40, i32 0) #5
  ...
  %25 = shl nsw i64 %24, 2
  %26 = call i8* @hypre_MAlloc(i64 %25, i32 0) #5
  ...
  %34 = shl nsw i64 %33, 2
  call void @hypre_Memcpy(i8* %26, i8* %31, i64 %34, i32 0, i32 0) #5
  %35 = load i32, i32* %6, align 8, !tbaa !3
  %36 = shl nsw i32 %35, 1
  %37 = or i32 %36, 1
  %38 = call %struct.Hash* @HashCreate(i32 %37) #5
  ...
  call void @HashRehash(%struct.Hash* %42, %struct.Hash* %38) #5
...
define dso_local void @NumberingDestroy(%struct.numbering* nocapture %0) local_unnamed_addr #0 {
  ...
  call void @HashDestroy(%struct.Hash* %6) #5
...
define dso_local void @NumberingLocalToGlobal(%struct.numbering* nocapture readonly %0, i32 %1, i32* nocapture readonly %2, i32* nocapture %3) local_unnamed_addr #4 {
  %5 = icmp sgt i32 %1, 0
...
26:                                               ; preds = %23, %17
  ...
  %28 = call i32 @HashLookup(%struct.Hash* %27, i32 %20) #5
  %29 = icmp eq i32 %28, -1
...
36:                                               ; preds = %30
  ...
  %41 = shl nsw i64 %40, 2
  %42 = call align 16 i8* @realloc(i8* %38, i64 %41) #5
  store i8* %42, i8** %12, align 8, !tbaa !16
  %43 = load i32, i32* %10, align 8, !tbaa !3
  %44 = shl nsw i32 %43, 1
  %45 = or i32 %44, 1
  %46 = call %struct.Hash* @HashCreate(i32 %45) #5
  %47 = load %struct.Hash*, %struct.Hash** %7, align 8, !tbaa !17
  call void @HashRehash(%struct.Hash* %47, %struct.Hash* %46) #5
  %48 = load %struct.Hash*, %struct.Hash** %7, align 8, !tbaa !17
  call void @HashDestroy(%struct.Hash* %48) #5
...
49:                                               ; preds = %36, %30
  ...
  call void @HashInsert(%struct.Hash* %50, i32 %51, i32 %52) #5

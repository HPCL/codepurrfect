...
define dso_local i32 @hypre_seqAMGSetup(%struct.hypre_ParAMGData* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  ...
  %10 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 70
  ...
  %19 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 76
  %20 = load i32**, i32*** %19, align 8, !tbaa !13
  %21 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 62
  %22 = load i32, i32* %21, align 4, !tbaa !14
  %23 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 38
  ...
  %43 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %30, i64 0, i32 9
  %44 = load double*, double** %43, align 8, !tbaa !22
  %45 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %32, i64 0, i32 9
  %46 = load double*, double** %45, align 8, !tbaa !22
  %47 = bitcast i32* %8 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %47) #5
  %48 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %30, i64 0, i32 3
...
56:                                               ; preds = %3
  %57 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 39
  store i32 1, i32* %57, align 8, !tbaa !26
  ...
  %63 = call i8* @hypre_CAlloc(i64 %62, i64 4, i32 0) #5
...
74:                                               ; preds = %70
  ...
  %77 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 6
  ...
  %81 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 2
  ...
  %85 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 18
  ...
  %89 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 20
  ...
  %93 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 7
  ...
  %97 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 19
  %98 = load i32, i32* %97, align 8, !tbaa !32
  %99 = call i32 @HYPRE_BoomerAMGSetPMaxElmts(%struct.hypre_Solver_struct* %96, i32 %98) #5
  %100 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 50
...
106:                                              ; preds = %103, %74
  ...
  %108 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 48
  ...
  %112 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 52
  ...
  %115 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 51
...
155:                                              ; preds = %136, %128
  ...
  %166 = call i8* @hypre_CAlloc(i64 %163, i64 8, i32 0) #5
...
233:                                              ; preds = %172, %155
  ...
  %237 = call i8* @hypre_CAlloc(i64 %236, i64 4, i32 0) #5
...
262:                                              ; preds = %254
  ...
  %265 = call i8* @hypre_CAlloc(i64 %264, i64 4, i32 1) #5
  %266 = bitcast i8* %265 to i32*
  %267 = call i8* @hypre_CAlloc(i64 %264, i64 4, i32 1) #5
...
320:                                              ; preds = %316
  ...
  %324 = call i8* @hypre_CAlloc(i64 %323, i64 4, i32 0) #5
...
402:                                              ; preds = %385, %371
  ...
  %408 = call i8* @hypre_CAlloc(i64 %407, i64 4, i32 1) #5
  %409 = call i8* @hypre_CAlloc(i64 %407, i64 8, i32 1) #5
  br label %410
...
421:                                              ; preds = %418, %415
  ...
  call void @hypre_Free(i8* %237, i32 0) #5
  call void @hypre_Free(i8* %132, i32 0) #5
  call void @hypre_Free(i8* %164, i32 0) #5
...
425:                                              ; preds = %421
  ...
  call void @hypre_Free(i8* %426, i32 0) #5
  %427 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #5
  ...
  %452 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 149
  store %struct.hypre_Solver_struct* %451, %struct.hypre_Solver_struct** %452, align 8, !tbaa !51
  %453 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 150
  store %struct.hypre_ParCSRMatrix_struct* %431, %struct.hypre_ParCSRMatrix_struct** %453, align 8, !tbaa !52
  %454 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 151
  store %struct.hypre_ParVector_struct* %442, %struct.hypre_ParVector_struct** %454, align 8, !tbaa !53
  %455 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 152
...
456:                                              ; preds = %421, %425
  ...
  %458 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 153
...
define dso_local i32 @hypre_seqAMGCycle(%struct.hypre_ParAMGData* nocapture readonly %0, i32 %1, %struct.hypre_ParVector_struct** nocapture readonly %2, %struct.hypre_ParVector_struct** nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 153
  %9 = load i32, i32* %8, align 8, !tbaa !55
  %10 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 149
  %11 = bitcast %struct.hypre_Solver_struct** %10 to i8**
  %12 = load i8*, i8** %11, align 8, !tbaa !51
  %13 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 150
  %14 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %13, align 8, !tbaa !52
  %15 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 151
  %16 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %15, align 8, !tbaa !53
  %17 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 152
...
!49 = !{!50, !7, i64 44}
!50 = !{!"hypre_ParVector_struct", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !9, i64 16, !7, i64 24, !9, i64 32, !7, i64 40, !7, i64 44, !9, i64 48}
!51 = !{!4, !9, i64 1392}
!52 = !{!4, !9, i64 1400}
!53 = !{!4, !9, i64 1408}
!54 = !{!4, !9, i64 1416}
...
!57 = !{!50, !9, i64 32}
!58 = !{!59, !9, i64 0}
!59 = !{!"", !9, i64 0, !7, i64 8, !7, i64 12, !5, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !7, i64 32}
!60 = !{!59, !7, i64 8}

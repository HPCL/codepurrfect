...
define dso_local %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %0) local_unnamed_addr #2 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 28) #6
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* nonnull %4) #6
  br label %5
...
define dso_local %struct.hypre_Box_struct* @hypre_BoxDuplicate(%struct.hypre_Box_struct* nocapture readonly %0) local_unnamed_addr #2 {
  ...
  %4 = call i8* @hypre_CAlloc(i64 1, i64 28) #6
...
define dso_local %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 %0, i32 %1) local_unnamed_addr #2 {
  %3 = call i8* @hypre_MAlloc(i64 24) #6
  %4 = sext i32 %0 to i64
  %5 = call i8* @hypre_CAlloc(i64 %4, i64 28) #6
...
6:                                                ; preds = %2
  ...
  %14 = call i8* @hypre_ReAlloc(i8* %11, i64 %13) #6
...
define dso_local %struct.hypre_BoxArray_struct* @hypre_BoxArrayDuplicate(%struct.hypre_BoxArray_struct* nocapture readonly %0) local_unnamed_addr #2 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 24) #6
  %7 = sext i32 %3 to i64
  %8 = call i8* @hypre_CAlloc(i64 %7, i64 28) #6
...
9:                                                ; preds = %2
  ...
  %17 = call i8* @hypre_ReAlloc(i8* %14, i64 %16) #6
...
11:                                               ; preds = %2
  ...
  %19 = call i8* @hypre_ReAlloc(i8* %16, i64 %18) #6
...
define dso_local %struct.hypre_BoxArrayArray_struct* @hypre_BoxArrayArrayCreate(i32 %0, i32 %1) local_unnamed_addr #2 {
  %3 = call i8* @hypre_CAlloc(i64 1, i64 16) #6
  %4 = sext i32 %0 to i64
  %5 = call i8* @hypre_CAlloc(i64 %4, i64 8) #6
...
11:                                               ; preds = %9, %11
  ...
  %13 = call i8* @hypre_MAlloc(i64 24) #6
  %14 = call i8* @hypre_CAlloc(i64 0, i64 28) #6
...
24:                                               ; preds = %19, %3
  ...
  call void @hypre_Free(i8* nonnull %28) #6
  br label %29
...
define dso_local %struct.hypre_BoxArrayArray_struct* @hypre_BoxArrayArrayDuplicate(%struct.hypre_BoxArrayArray_struct* nocapture readonly %0) local_unnamed_addr #2 {
  ...
  %6 = call i8* @hypre_CAlloc(i64 1, i64 16) #6
  %7 = sext i32 %3 to i64
  %8 = call i8* @hypre_CAlloc(i64 %7, i64 8) #6
...
14:                                               ; preds = %14, %12
  ...
  %16 = call i8* @hypre_MAlloc(i64 24) #6
  %17 = call i8* @hypre_CAlloc(i64 0, i64 28) #6

...
77:                                               ; preds = %75, %70
  %78 = call i32 (i8*, i8*, i8*, i8*, ...) %9(i8* %12, i8* %1, i8* %2, i8* %3) #9
...
define dso_local i32 @hypre_BiCGSSolve(i8* nocapture %0, i8* %1, i8* %2, i8* %3) local_unnamed_addr #0 {
  ...
  %43 = bitcast i8* %42 to i32 (i32*, i8*, i8*, i8*, ...)**
  %44 = load i32 (i32*, i8*, i8*, i8*, ...)*, i32 (i32*, i8*, i8*, i8*, ...)** %43, align 8, !tbaa !12
...
92:                                               ; preds = %78, %124
  ...
  %103 = call i32 (i32*, i8*, i8*, i8*, ...) %44(i32* %47, i8* %1, i8* %29, i8* %38) #9
  ...
  %111 = call i32 (i32*, i8*, i8*, i8*, ...) %44(i32* %47, i8* %1, i8* %35, i8* %38) #9
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_BiCGSSetPrecond(i8* nocapture %0, i32 (...)* %1, i32 (...)* %2, i8* %3) local_unnamed_addr #5 {

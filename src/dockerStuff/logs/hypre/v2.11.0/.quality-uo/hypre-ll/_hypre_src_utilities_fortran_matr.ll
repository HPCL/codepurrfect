...
define dso_local noalias %struct.utilities_FortranMatrix* @utilities_FortranMatrixCreate() local_unnamed_addr #0 {
  %1 = call noalias align 16 dereferenceable_or_null(40) i8* @malloc(i64 40) #13
...
13:                                               ; preds = %11, %7, %3
  %14 = mul nsw i64 %1, %0
  %15 = call noalias align 16 i8* @calloc(i64 %14, i64 8) #13
...
18:                                               ; preds = %15
  %19 = bitcast double* %16 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %19, i8 0, i64 %14, i1 false) #13
  %20 = getelementptr double, double* %16, i64 %3
  br label %21
...
36:                                               ; preds = %30, %1
  ...
  %38 = call double @sqrt(double %37) #13
  ret double %38
}
...
define dso_local void @utilities_FortranMatrixUpperInv(%struct.utilities_FortranMatrix* nocapture readonly %0) local_unnamed_addr #10 {
  %2 = getelementptr inbounds %struct.utilities_FortranMatrix, %struct.utilities_FortranMatrix* %0, i64 0, i32 1
  %3 = load i64, i64* %2, align 8, !tbaa !12
  %4 = call noalias align 16 i8* @calloc(i64 %3, i64 8) #13
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @utilities_FortranMatrixPrint(%struct.utilities_FortranMatrix* nocapture readonly %0, i8* nocapture readonly %1) local_unnamed_addr #8 {
...
5:                                                ; preds = %2
  ...
  %9 = load i64, i64* %8, align 8, !tbaa !13
  %10 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* nonnull %3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i64 %7)
  %11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* nonnull %3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i64 %9)
  %12 = getelementptr inbounds %struct.utilities_FortranMatrix, %struct.utilities_FortranMatrix* %0, i64 0, i32 0
  %13 = load i64, i64* %12, align 8, !tbaa !11
  %14 = sub nsw i64 %13, %7
  %15 = icmp sgt i64 %7, 0
...
23:                                               ; preds = %20, %23
  ...
  %26 = load double, double* %24, align 8, !tbaa !18
  %27 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* nonnull %3, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), double %26)

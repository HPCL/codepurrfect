...
define dso_local void @hypre_my_abort(i32 %0, %struct.hypre_PilutSolverGlobals* nocapture readonly %1) local_unnamed_addr #5 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 %4, i32 %0)
  ...
  %10 = call i32 @hypre_MPI_Abort(i32 %9, i32 %0) #12
  ret void
}
...
declare dso_local i32 @hypre_MPI_Abort(i32, i32) local_unnamed_addr #6

; Function Attrs: nounwind uwtable
define dso_local noalias i32* @hypre_idx_malloc(i32 %0, i8* %1) local_unnamed_addr #5 {
  %3 = icmp eq i32 %0, 0
...
; Function Attrs: nounwind uwtable
define dso_local noalias i32* @hypre_idx_malloc_init(i32 %0, i32 %1, i8* %2) local_unnamed_addr #5 {
  %4 = icmp eq i32 %0, 0
...
5:                                                ; preds = %3
  %6 = sext i32 %0 to i64
  %7 = shl nsw i64 %6, 2
  %8 = call noalias align 16 i8* @malloc(i64 %7) #12
...
; Function Attrs: nounwind uwtable
define dso_local noalias double* @hypre_fp_malloc(i32 %0, i8* %1) local_unnamed_addr #5 {
  %3 = icmp eq i32 %0, 0
  br i1 %3, label %11, label %4
...
; Function Attrs: nounwind uwtable
define dso_local noalias double* @hypre_fp_malloc_init(i32 %0, double %1, i8* %2) local_unnamed_addr #5 {
  %4 = icmp eq i32 %0, 0
  br i1 %4, label %21, label %5
...
; Function Attrs: nounwind uwtable
define dso_local noalias i8* @hypre_mymalloc(i32 %0, i8* %1) local_unnamed_addr #5 {
  %3 = icmp eq i32 %0, 0
  br i1 %3, label %9, label %4

4:                                                ; preds = %2
  %5 = sext i32 %0 to i64
  %6 = call noalias align 16 i8* @malloc(i64 %5) #12
  %7 = icmp eq i8* %6, null
...
5:                                                ; preds = %3, %5
  ...
  %9 = getelementptr inbounds double, double* %0, i64 %6
  store double %8, double* %9, align 8, !tbaa !16
...
; Function Attrs: nofree nounwind
declare noundef i32 @fputc(i32 noundef, %struct._IO_FILE* nocapture noundef) local_unnamed_addr #11

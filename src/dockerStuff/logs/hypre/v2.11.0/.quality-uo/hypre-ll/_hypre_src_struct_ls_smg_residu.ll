...
define dso_local i8* @hypre_SMGResidualCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 80) #7
...
define dso_local i32 @hypre_SMGResidualSetup(i8* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructVector_struct* %2, %struct.hypre_StructVector_struct* %3, %struct.hypre_StructVector_struct* %4) local_unnamed_addr #0 {
  ...
  %45 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %1, i64 0, i32 14
...
define dso_local i32 @hypre_SMGResidual(i8* %0, %struct.hypre_StructMatrix_struct* nocapture readonly %1, %struct.hypre_StructVector_struct* nocapture readonly %2, %struct.hypre_StructVector_struct* nocapture readonly %3, %struct.hypre_StructVector_struct* nocapture readonly %4) local_unnamed_addr #0 {
  ...
  %77 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %1, i64 0, i32 6
  %78 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %1, i64 0, i32 9
...
112:                                              ; preds = %5, %735
  %113 = phi %struct.hypre_BoxArrayArray_struct* [ undef, %5 ], [ %373, %735 ]
  %114 = phi i32 [ 0, %5 ], [ %736, %735 ]
...
288:                                              ; preds = %286
  %289 = sext i32 %167 to i64
  %290 = sext i32 %211 to i64
  br label %302
...
302:                                              ; preds = %288, %360
  %303 = phi i32 [ %343, %360 ], [ %272, %288 ]
  %304 = phi i32 [ %346, %360 ], [ %287, %288 ]
...
410:                                              ; preds = %378, %725
  ...
  br i1 %98, label %415, label %725

415:                                              ; preds = %410, %722
  %416 = phi i64 [ %723, %722 ], [ 0, %410 ]
  %417 = load double*, double** %77, align 8, !tbaa !56
  %418 = load i32**, i32*** %78, align 8, !tbaa !57
  %419 = getelementptr inbounds i32*, i32** %418, i64 %379
  %420 = load i32*, i32** %419, align 8, !tbaa !15
  %421 = getelementptr inbounds i32, i32* %420, i64 %416
  %422 = load i32, i32* %421, align 4, !tbaa !9
  %423 = sext i32 %422 to i64
  %424 = load double*, double** %79, align 8, !tbaa !30
  %425 = load i32*, i32** %80, align 8, !tbaa !36
  %426 = getelementptr inbounds i32, i32* %425, i64 %379
  %427 = load i32, i32* %426, align 4, !tbaa !9
  %428 = sext i32 %427 to i64
  %429 = getelementptr inbounds [3 x i32], [3 x i32]* %45, i64 %416, i64 0
  %430 = call i32 @hypre_BoxOffsetDistance(%struct.hypre_Box_struct* %390, i32* %429) #7
...
629:                                              ; preds = %635, %614
  %630 = phi i32 [ %581, %614 ], [ %643, %635 ]
  br i1 %588, label %631, label %722

631:                                              ; preds = %629
  %632 = sext i32 %456 to i64
  %633 = sext i32 %498 to i64
  %634 = sext i32 %540 to i64
  br label %646

635:                                              ; preds = %616, %635
  %636 = phi i64 [ 1, %616 ], [ %644, %635 ]
  %637 = phi i32 [ %581, %616 ], [ %643, %635 ]
  %638 = getelementptr inbounds [4 x i32], [4 x i32]* %18, i64 0, i64 %636
  %639 = load i32, i32* %638, align 4, !tbaa !9
  %640 = getelementptr inbounds [3 x i32], [3 x i32]* %28, i64 0, i64 %636
  %641 = load i32, i32* %640, align 4, !tbaa !9
  %642 = mul nsw i32 %641, %639
  %643 = add nsw i32 %642, %637
  %644 = add nuw nsw i64 %636, 1
  %645 = icmp eq i64 %644, %617
  br i1 %645, label %629, label %635, !llvm.loop !64

646:                                              ; preds = %631, %719
  %647 = phi i32 [ %699, %719 ], [ %600, %631 ]
  %648 = phi i32 [ %702, %719 ], [ %615, %631 ]
  %649 = phi i32 [ %720, %719 ], [ 0, %631 ]
  %650 = phi i32 [ %705, %719 ], [ %630, %631 ]
  br i1 %587, label %651, label %659
...
655:                                              ; preds = %663
  %656 = trunc i64 %681 to i32
  %657 = trunc i64 %680 to i32
  %658 = trunc i64 %679 to i32
  br label %659

659:                                              ; preds = %655, %646
  %660 = phi i32 [ %650, %646 ], [ %656, %655 ]
  %661 = phi i32 [ %648, %646 ], [ %657, %655 ]
  %662 = phi i32 [ %647, %646 ], [ %658, %655 ]
  br label %684

663:                                              ; preds = %651, %663
  %664 = phi i64 [ %654, %651 ], [ %681, %663 ]
  %665 = phi i64 [ %653, %651 ], [ %680, %663 ]
  %666 = phi i64 [ %652, %651 ], [ %679, %663 ]
  %667 = phi i32 [ 0, %651 ], [ %682, %663 ]
  %668 = add nsw i64 %666, %423
  %669 = getelementptr inbounds double, double* %417, i64 %668
  %670 = load double, double* %669, align 8, !tbaa !45
  %671 = add nsw i64 %432, %665
  %672 = getelementptr inbounds double, double* %424, i64 %671
  %673 = load double, double* %672, align 8, !tbaa !45
  %674 = fmul double %670, %673
  %675 = add nsw i64 %664, %399
  %676 = getelementptr inbounds double, double* %395, i64 %675
  %677 = load double, double* %676, align 8, !tbaa !45
  %678 = fsub double %677, %674
  store double %678, double* %676, align 8, !tbaa !45
  %679 = add i64 %666, %632
  %680 = add i64 %665, %633
  %681 = add i64 %664, %634
  %682 = add nuw nsw i32 %667, 1
  %683 = icmp eq i32 %682, %582
  br i1 %683, label %655, label %663, !llvm.loop !65

684:                                              ; preds = %684, %659
  %685 = phi i64 [ %692, %684 ], [ 1, %659 ]
  %686 = getelementptr inbounds [4 x i32], [4 x i32]* %18, i64 0, i64 %685
  %687 = load i32, i32* %686, align 4, !tbaa !9
  %688 = add nsw i32 %687, 2
  %689 = getelementptr inbounds [4 x i32], [4 x i32]* %19, i64 0, i64 %685
  %690 = load i32, i32* %689, align 4, !tbaa !9
  %691 = icmp sgt i32 %688, %690
  %692 = add nuw i64 %685, 1
  br i1 %691, label %684, label %693, !llvm.loop !66

693:                                              ; preds = %684
  %694 = trunc i64 %685 to i32
  %695 = and i64 %685, 4294967295
  %696 = getelementptr inbounds [4 x i32], [4 x i32]* %18, i64 0, i64 %695
  %697 = getelementptr inbounds [4 x i32], [4 x i32]* %22, i64 0, i64 %695
  %698 = load i32, i32* %697, align 4, !tbaa !9
  %699 = add nsw i32 %698, %662
  %700 = getelementptr inbounds [4 x i32], [4 x i32]* %26, i64 0, i64 %695
  %701 = load i32, i32* %700, align 4, !tbaa !9
  %702 = add nsw i32 %701, %661
  %703 = getelementptr inbounds [4 x i32], [4 x i32]* %30, i64 0, i64 %695
  %704 = load i32, i32* %703, align 4, !tbaa !9
  %705 = add nsw i32 %704, %660
  %706 = add nsw i32 %687, 1
  store i32 %706, i32* %696, align 4, !tbaa !9
  %707 = icmp ugt i32 %694, 1
  br i1 %707, label %708, label %719

708:                                              ; preds = %693
  %709 = add i64 %685, 4294967295
  %710 = and i64 %709, 4294967295
  %711 = call i32 @llvm.smin.i32(i32 %694, i32 2)
  %712 = sub i32 %694, %711
  %713 = zext i32 %712 to i64
  %714 = sub nsw i64 %710, %713
  %715 = getelementptr [4 x i32], [4 x i32]* %18, i64 0, i64 %714
  %716 = bitcast i32* %715 to i8*
  %717 = shl nuw nsw i64 %713, 2
  %718 = add nuw nsw i64 %717, 4
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 4 dereferenceable(1) %716, i8 0, i64 %718, i1 false)
  br label %719

719:                                              ; preds = %708, %693
  %720 = add nuw nsw i32 %649, 1
  %721 = icmp eq i32 %720, %453
  br i1 %721, label %722, label %646, !llvm.loop !67

722:                                              ; preds = %719, %629, %579
  ...
  %723 = add nuw nsw i64 %416, 1
  %724 = icmp eq i64 %723, %111
  br i1 %724, label %725, label %415, !llvm.loop !68

725:                                              ; preds = %722, %410
  %726 = add nuw nsw i64 %411, 1
  %727 = load i32, i32* %400, align 8, !tbaa !33
  %728 = sext i32 %727 to i64
  %729 = icmp slt i64 %726, %728
  br i1 %729, label %410, label %730, !llvm.loop !69

730:                                              ; preds = %725, %378
  %731 = add nuw nsw i64 %379, 1
  %732 = load i32, i32* %374, align 8, !tbaa !52
  %733 = sext i32 %732 to i64
  %734 = icmp slt i64 %731, %733
  br i1 %734, label %378, label %735, !llvm.loop !70

735:                                              ; preds = %730, %372
  %736 = add nuw nsw i32 %114, 1
  %737 = icmp eq i32 %114, 0
  br i1 %737, label %112, label %738, !llvm.loop !71

738:                                              ; preds = %735
  %739 = load i32, i32* @hypre__global_error, align 4, !tbaa !9
...
!9 = !{!8, !8, i64 0}
!10 = !{!11, !7, i64 8}
!11 = !{!"hypre_StructMatrix_struct", !8, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !8, i64 32, !7, i64 40, !7, i64 48, !8, i64 56, !8, i64 60, !7, i64 64, !8, i64 72, !8, i64 76, !7, i64 80, !5, i64 88, !8, i64 112, !7, i64 120, !8, i64 128}
!12 = !{!11, !7, i64 24}
!13 = !{!14, !7, i64 8}

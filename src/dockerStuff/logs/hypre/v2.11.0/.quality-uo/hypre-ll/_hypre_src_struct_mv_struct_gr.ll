...
37:                                               ; preds = %31, %3
  %38 = getelementptr inbounds i8, i8* %4, i64 88
  %39 = bitcast i8* %38 to [6 x i32]*
  %40 = icmp sgt i32 %1, 0
...
43:                                               ; preds = %41, %43
  ...
  %46 = getelementptr inbounds [6 x i32], [6 x i32]* %39, i64 0, i64 %45
  store i32 1, i32* %46, align 4, !tbaa !17
  %47 = or i64 %45, 1
  %48 = getelementptr inbounds [6 x i32], [6 x i32]* %39, i64 0, i64 %47
...
51:                                               ; preds = %43, %37
  %52 = bitcast %struct.hypre_StructGrid_struct** %2 to i8**
  store i8* %4, i8** %52, align 8, !tbaa !21
  %53 = load i32, i32* @hypre__global_error, align 4, !tbaa !17
  ret i32 %53
}
...
define dso_local i32 @hypre_StructGridRead(i32 %0, %struct._IO_FILE* %1, %struct.hypre_StructGrid_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %9 = alloca i32, align 4
  %10 = bitcast %struct.hypre_StructGrid_struct** %4 to i8*
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %15) #11
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* nonnull %7) #11
  %17 = load i32, i32* %7, align 4, !tbaa !17
  %18 = call i32 @hypre_StructGridCreate(i32 %0, i32 %17, %struct.hypre_StructGrid_struct** nonnull %4)
  %19 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* nonnull %8) #11
  %20 = getelementptr inbounds [3 x i32], [3 x i32]* %5, i64 0, i64 0
  %21 = getelementptr inbounds [3 x i32], [3 x i32]* %6, i64 0, i64 0
  %22 = load %struct.hypre_StructGrid_struct*, %struct.hypre_StructGrid_struct** %4, align 8
  %23 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %22, i64 0, i32 1
  %24 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %22, i64 0, i32 2
  %25 = load i32, i32* %8, align 4, !tbaa !17
  %26 = icmp sgt i32 %25, 0
  br i1 %26, label %27, label %63

27:                                               ; preds = %3, %52
  %28 = phi i32 [ %60, %52 ], [ 0, %3 ]
  %29 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* nonnull %9, i32* nonnull %20) #11
...
32:                                               ; preds = %27, %32
  ...
  %35 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* nonnull %34) #11
  %36 = add nuw nsw i64 %33, 1
  %37 = load i32, i32* %7, align 4, !tbaa !17
  %38 = sext i32 %37 to i64
  %39 = icmp slt i64 %36, %38
  br i1 %39, label %32, label %40, !llvm.loop !57

40:                                               ; preds = %32, %27
  %41 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i32* nonnull %21) #11
  %42 = load i32, i32* %7, align 4, !tbaa !17
  %43 = icmp sgt i32 %42, 1
  br i1 %43, label %44, label %52

44:                                               ; preds = %40, %44
  %45 = phi i64 [ %48, %44 ], [ 1, %40 ]
  %46 = getelementptr inbounds [3 x i32], [3 x i32]* %6, i64 0, i64 %45
  %47 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* nonnull %46) #11
  %48 = add nuw nsw i64 %45, 1
  %49 = load i32, i32* %7, align 4, !tbaa !17
  %50 = sext i32 %49 to i64
  %51 = icmp slt i64 %48, %50
  br i1 %51, label %44, label %52, !llvm.loop !58

52:                                               ; preds = %44, %40
  %53 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0)) #11
  %54 = load i32, i32* %23, align 4, !tbaa !9
  %55 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %54) #11
  %56 = call i32 @hypre_BoxSetExtents(%struct.hypre_Box_struct* %55, i32* nonnull %20, i32* nonnull %21) #11
  %57 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %24, align 8, !tbaa !10
  %58 = call i32 @hypre_AppendBox(%struct.hypre_Box_struct* %55, %struct.hypre_BoxArray_struct* %57) #11
  %59 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %55) #11
  %60 = add nuw nsw i32 %28, 1
  %61 = load i32, i32* %8, align 4, !tbaa !17
  %62 = icmp slt i32 %60, %61
  br i1 %62, label %27, label %63, !llvm.loop !59

63:                                               ; preds = %52, %3
  %64 = load %struct.hypre_StructGrid_struct*, %struct.hypre_StructGrid_struct** %4, align 8, !tbaa !21
  %65 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.8, i64 0, i64 0)) #11
  %66 = load i32, i32* %7, align 4, !tbaa !17
  %67 = icmp sgt i32 %66, 0
  br i1 %67, label %68, label %76

68:                                               ; preds = %63, %68
  %69 = phi i64 [ %72, %68 ], [ 0, %63 ]
  %70 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %64, i64 0, i32 8, i64 %69
  %71 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i64 0, i64 0), i32* nonnull %70) #11
  %72 = add nuw nsw i64 %69, 1
  %73 = load i32, i32* %7, align 4, !tbaa !17
  %74 = sext i32 %73 to i64
  %75 = icmp slt i64 %72, %74
  br i1 %75, label %68, label %76, !llvm.loop !60

76:                                               ; preds = %68, %63
  %77 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0)) #11
  %78 = call i32 @hypre_StructGridAssemble(%struct.hypre_StructGrid_struct* %64)
  store %struct.hypre_StructGrid_struct* %64, %struct.hypre_StructGrid_struct** %2, align 8, !tbaa !21
  %79 = load i32, i32* @hypre__global_error, align 4, !tbaa !17
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %15) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %14) #11

...
9:                                                ; preds = %7, %9
  ...
  %14 = call i32 @rand() #5
  %15 = call i32 @hypre_StructVectorSetRandomValues(%struct.hypre_StructVector_struct* %13, i32 %14) #5
...
declare dso_local i32 @hypre_StructVectorSetRandomValues(%struct.hypre_StructVector_struct*, i32) local_unnamed_addr #2
...
21:                                               ; preds = %21, %19
  ...
  %26 = call i32 @rand() #5
  %27 = call i32 @hypre_StructVectorSetRandomValues(%struct.hypre_StructVector_struct* %25, i32 %26) #5
...
23:                                               ; preds = %23, %21
  ...
  %28 = call i32 @rand() #5
  %29 = call i32 @hypre_StructVectorSetRandomValues(%struct.hypre_StructVector_struct* %27, i32 %28) #5
...
define dso_local i32 @HYPRE_SStructSetupInterpreter(%struct.mv_InterfaceInterpreter* %0) local_unnamed_addr #3 {
...
declare dso_local i8* @hypre_SStructKrylovCreateVector(i8*) #2

declare dso_local i32 @hypre_SStructKrylovDestroyVector(i8*) #2

declare dso_local double @hypre_SStructKrylovInnerProd(i8*, i8*) #2

declare dso_local i32 @hypre_SStructKrylovCopyVector(i8*, i8*) #2

declare dso_local i32 @hypre_SStructKrylovClearVector(i8*) #2

declare dso_local i32 @hypre_SStructKrylovScaleVector(double, i8*) #2

declare dso_local i32 @hypre_SStructKrylovAxpy(double, i8*, i8*) #2
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @HYPRE_SStructSetupMatvec(%struct.HYPRE_MatvecFunctions* nocapture %0) local_unnamed_addr #3 {
...
declare dso_local i8* @hypre_SStructKrylovMatvecCreate(i8*, i8*) #2

declare dso_local i32 @hypre_SStructKrylovMatvec(i8*, double, i8*, i8*, double, i8*) #2

declare dso_local i32 @hypre_SStructKrylovMatvecDestroy(i8*) #2

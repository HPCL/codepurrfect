...
220:                                              ; preds = %218
  %221 = sext i32 %99 to i64
  %222 = sext i32 %143 to i64
  br label %234
...
234:                                              ; preds = %220, %292
  %235 = phi i32 [ %275, %292 ], [ %204, %220 ]
  %236 = phi i32 [ %278, %292 ], [ %219, %220 ]
...
241:                                              ; preds = %247
  %242 = trunc i64 %257 to i32
  %243 = trunc i64 %256 to i32
  br label %244
...
240:                                              ; preds = %226, %298
  %241 = phi i32 [ %281, %298 ], [ %210, %226 ]
  %242 = phi i32 [ %284, %298 ], [ %225, %226 ]
...
247:                                              ; preds = %253
  %248 = trunc i64 %263 to i32
  %249 = trunc i64 %262 to i32
  br label %250

...
define dso_local i8* @hypre_FGMRESCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 144) #10
...
13:                                               ; preds = %8
  ...
  call void @hypre_Free(i8* nonnull %14) #10
...
56:                                               ; preds = %54, %49
  %57 = call i32 (i8*, i8*, i8*, i8*, ...) %12(i8* %15, i8* %1, i8* %2, i8* %3) #10
...
67:                                               ; preds = %62
  ...
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 8) #10
...
define dso_local i32 @hypre_FGMRESSolve(i8* nocapture %0, i8* %1, i8* %2, i8* %3) local_unnamed_addr #0 {
  ...
  %31 = bitcast i8* %30 to i32 (i32*, i8*, i8*, i8*, ...)**
  %32 = load i32 (i32*, i8*, i8*, i8*, ...)*, i32 (i32*, i8*, i8*, i8*, ...)** %31, align 8, !tbaa !13
  %33 = getelementptr inbounds i8, i8* %0, i64 96
  %34 = bitcast i8* %33 to i32**
  %35 = load i32*, i32** %34, align 8, !tbaa !15
  %36 = getelementptr inbounds i8, i8* %0, i64 108
  ...
  %45 = getelementptr inbounds i8, i8* %0, i64 136
...
52:                                               ; preds = %4
  %53 = load double*, double** %40, align 8, !tbaa !18
  br label %54

54:                                               ; preds = %52, %4
  %55 = phi double* [ %53, %52 ], [ %41, %4 ]
  %56 = add nsw i32 %9, 1
  %57 = sext i32 %56 to i64
  %58 = call i8* @hypre_CAlloc(i64 %57, i64 8) #10
  %59 = bitcast i8* %58 to double*
  %60 = sext i32 %9 to i64
  %61 = call i8* @hypre_CAlloc(i64 %60, i64 8) #10
  %62 = bitcast i8* %61 to double*
  %63 = call i8* @hypre_CAlloc(i64 %60, i64 8) #10
  %64 = bitcast i8* %63 to double*
  %65 = call i8* @hypre_CAlloc(i64 %57, i64 8) #10
...
71:                                               ; preds = %68, %71
  ...
  %73 = call i8* @hypre_CAlloc(i64 %60, i64 8) #10
  %74 = getelementptr inbounds double*, double** %66, i64 %72
  %75 = bitcast double** %74 to i8**
  store i8* %73, i8** %75, align 8, !tbaa !23
  %76 = add nuw nsw i64 %72, 1
  %77 = icmp eq i64 %76, %70
  br i1 %77, label %78, label %71, !llvm.loop !32

78:                                               ; preds = %71, %54
  %79 = load i8*, i8** %26, align 8, !tbaa !23
  %80 = call i32 @hypre_ParKrylovCopyVector(i8* %2, i8* %79) #10
  %81 = load i8*, i8** %26, align 8, !tbaa !23
  %82 = call i32 @hypre_ParKrylovMatvec(i8* %20, double -1.000000e+00, i8* %1, i8* %3, double 1.000000e+00, i8* %81) #10
  %83 = load i8*, i8** %26, align 8, !tbaa !23
  %84 = call double @hypre_ParKrylovInnerProd(i8* %83, i8* %83) #10
  %85 = call double @sqrt(double %84) #10
  %86 = call double @hypre_ParKrylovInnerProd(i8* %2, i8* %2) #10
  %87 = call double @sqrt(double %86) #10
  br i1 %51, label %88, label %98

88:                                               ; preds = %78
  store double %85, double* %55, align 8, !tbaa !33
  %89 = load i32, i32* %5, align 4, !tbaa !34
  %90 = icmp eq i32 %89, 0
  br i1 %90, label %91, label %98

91:                                               ; preds = %88
  %92 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @.str.1, i64 0, i64 0), double %87)
...
96:                                               ; preds = %94, %91
  %97 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @.str.3, i64 0, i64 0), double %85)
  br label %98
...
98:                                               ; preds = %88, %96, %78
  ...
  %103 = select i1 %102, double %101, double %17
  %104 = icmp ne i32 %44, 0
  %105 = icmp ne i32 (...)* %47, null
  %106 = select i1 %104, i1 %105, i1 false
  %107 = bitcast i32 (...)* %47 to i32 (i32*, double, ...)*
...
111:                                              ; preds = %340, %98
  %112 = phi i32 [ 0, %98 ], [ %280, %340 ]
  %113 = phi double [ %85, %98 ], [ %347, %340 ]
  %114 = icmp slt i32 %112, %11
  br i1 %114, label %115, label %355

115:                                              ; preds = %111
  store double %113, double* %59, align 8, !tbaa !33
  %116 = fcmp oeq double %113, 0.000000e+00
  br i1 %116, label %386, label %117

117:                                              ; preds = %115
  %118 = fcmp ole double %113, %103
...
121:                                              ; preds = %117
  ...
  %126 = fcmp ugt double %125, %103
  br i1 %126, label %133, label %127

127:                                              ; preds = %121
  %128 = load i32, i32* %5, align 4
  %129 = icmp eq i32 %128, 0
  %130 = select i1 %51, i1 %129, i1 false
...
144:                                              ; preds = %142, %268
  ...
  br i1 %106, label %154, label %157

154:                                              ; preds = %144
  %155 = fdiv double %148, %87
  %156 = call i32 (i32*, double, ...) %107(i32* %35, double %155) #10
  br label %157
...
157:                                              ; preds = %154, %144
  ...
  %161 = call i32 (i32*, i8*, i8*, i8*, ...) %32(i32* %35, i8* %1, i8* %159, i8* %160) #10
...
166:                                              ; preds = %157, %166
  ...
  %172 = getelementptr inbounds double*, double** %66, i64 %167
...
181:                                              ; preds = %166
  ...
  %185 = getelementptr inbounds double*, double** %66, i64 %149
...
195:                                              ; preds = %193, %195
  ...
  %198 = getelementptr inbounds double*, double** %66, i64 %197
  ...
  %202 = getelementptr inbounds double, double* %62, i64 %197
  %203 = load double, double* %202, align 8, !tbaa !33
  %204 = fmul double %201, %203
  %205 = getelementptr inbounds double, double* %64, i64 %197
  %206 = load double, double* %205, align 8, !tbaa !33
  %207 = getelementptr inbounds double*, double** %66, i64 %196
...
221:                                              ; preds = %195, %193
  %222 = getelementptr inbounds double*, double** %66, i64 %145
  ...
  %239 = getelementptr inbounds double, double* %62, i64 %145
  ...
  %244 = getelementptr inbounds double, double* %64, i64 %145
  store double %243, double* %244, align 8, !tbaa !33
  %245 = fneg double %243
  %246 = getelementptr inbounds double, double* %59, i64 %145
  %247 = load double, double* %246, align 8, !tbaa !33
  %248 = fmul double %247, %245
  %249 = getelementptr inbounds double, double* %59, i64 %149
  ...
  br i1 %51, label %261, label %268

261:                                              ; preds = %221
  %262 = getelementptr inbounds double, double* %55, i64 %150
...
278:                                              ; preds = %275, %133
  ...
  %283 = getelementptr inbounds double, double* %59, i64 %282
  %284 = load double, double* %283, align 8, !tbaa !33
  %285 = getelementptr inbounds double*, double** %66, i64 %282
...
300:                                              ; preds = %291, %322
  ...
  %304 = getelementptr inbounds double, double* %59, i64 %301
...
308:                                              ; preds = %300
  %309 = getelementptr inbounds double*, double** %66, i64 %301
...
311:                                              ; preds = %308, %311
  ...
  %316 = getelementptr inbounds double, double* %59, i64 %312
...
322:                                              ; preds = %311, %300
  ...
  %324 = getelementptr inbounds double*, double** %66, i64 %301
...
331:                                              ; preds = %298, %331
  ...
  %333 = getelementptr inbounds double, double* %59, i64 %332
...
340:                                              ; preds = %331, %296
  ...
  %348 = fcmp ugt double %347, %103
  br i1 %348, label %111, label %349, !llvm.loop !41

349:                                              ; preds = %340
  %350 = load i32, i32* %5, align 4
  %351 = icmp eq i32 %350, 0
  %352 = select i1 %51, i1 %351, i1 false
...
355:                                              ; preds = %111, %349, %353, %127, %131
  ...
  br i1 %99, label %360, label %364

360:                                              ; preds = %355
  %361 = fdiv double %357, %87
...
364:                                              ; preds = %360, %355
  %365 = fcmp oeq double %87, 0.000000e+00
...
369:                                              ; preds = %366, %364
  ...
  %371 = fcmp ogt double %357, %103
  %372 = select i1 %370, i1 %371, i1 false
  %373 = zext i1 %372 to i32
  call void @hypre_Free(i8* %61) #10
  call void @hypre_Free(i8* %63) #10
  call void @hypre_Free(i8* %58) #10
...
378:                                              ; preds = %375, %378
  ...
  %380 = getelementptr inbounds double*, double** %66, i64 %379
  %381 = bitcast double** %380 to i8**
  %382 = load i8*, i8** %381, align 8, !tbaa !23
  call void @hypre_Free(i8* %382) #10
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_FGMRESSetPrecond(i8* nocapture %0, i32 (...)* %1, i32 (...)* %2, i8* %3) local_unnamed_addr #6 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_FGMRESUpdatePrecondTolerance(i8* nocapture %0, i32 (...)* %1) local_unnamed_addr #6 {

...
define dso_local i32 @hypre_SStructPVectorCreate(i32 %0, %struct.hypre_SStructPGrid* %1, %struct.hypre_SStructPVector** nocapture %2) local_unnamed_addr #1 {
  %4 = call i8* @hypre_MAlloc(i64 64) #9
  ...
  %13 = shl nsw i64 %12, 3
  %14 = call i8* @hypre_MAlloc(i64 %13) #9
...
20:                                               ; preds = %18, %20
  ...
  %28 = call %struct.hypre_StructVector_struct* @hypre_StructVectorCreate(i32 %0, %struct.hypre_StructGrid_struct* %27) #9
...
32:                                               ; preds = %20, %3
  ...
  %35 = call i8* @hypre_MAlloc(i64 %13) #9
  %36 = icmp sgt i32 %9, 0
...
21:                                               ; preds = %19, %21
  ...
  %25 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %24) #9
  ...
  %28 = call i32 @hypre_CommPkgDestroy(%struct.hypre_CommPkg_struct* %27) #9
  %29 = add nuw nsw i64 %22, 1
  %30 = icmp eq i64 %29, %20
  br i1 %30, label %31, label %21, !llvm.loop !23

31:                                               ; preds = %21, %8
  call void @hypre_Free(i8* %17) #9
  %32 = bitcast %struct.hypre_StructVector_struct** %12 to i8*
  call void @hypre_Free(i8* %32) #9
...
12:                                               ; preds = %10, %23
  ...
  %17 = call i32 @hypre_StructVectorInitialize(%struct.hypre_StructVector_struct* %16) #9
...
21:                                               ; preds = %12
  %22 = call i32 @hypre_StructVectorClearGhostValues(%struct.hypre_StructVector_struct* %16) #9
  br label %23
...
define dso_local i32 @hypre_SStructPVectorSetValues(%struct.hypre_SStructPVector* nocapture readonly %0, i32* %1, i32 %2, double* %3, i32 %4) local_unnamed_addr #1 {
  ...
  %16 = call i32 @hypre_StructVectorSetValues(%struct.hypre_StructVector_struct* %11, i32* %1, double* %3, i32 %4, i32 -1, i32 0) #9
  %17 = icmp eq i32 %4, 0
...
33:                                               ; preds = %18, %29
  ...
  %37 = call i32 @hypre_IndexInBox(i32* %1, %struct.hypre_Box_struct* %36) #9
  %38 = icmp eq i32 %37, 0
...
40:                                               ; preds = %29, %18
  ...
  %42 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %15) #9
  ...
  %48 = call i32 @hypre_SStructVariableGetOffset(i32 %46, i32 %15, i32* nonnull %47) #9
...
52:                                               ; preds = %40, %63
  ...
  %56 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %55, %struct.hypre_Box_struct* %42) #9
  %57 = call i32 @hypre_BoxGrowByIndex(%struct.hypre_Box_struct* %42, i32* nonnull %47) #9
  %58 = call i32 @hypre_IndexInBox(i32* %1, %struct.hypre_Box_struct* %42) #9
  %59 = icmp eq i32 %58, 0
  br i1 %59, label %63, label %60

60:                                               ; preds = %52
  %61 = trunc i64 %53 to i32
  %62 = call i32 @hypre_StructVectorSetValues(%struct.hypre_StructVector_struct* %11, i32* %1, double* %3, i32 %4, i32 %61, i32 1) #9
  br label %68
...
68:                                               ; preds = %63, %40, %60
  %69 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %42) #9
  br label %70
...
79:                                               ; preds = %71, %88
  ...
  %83 = call i32 @hypre_IndexInBox(i32* %1, %struct.hypre_Box_struct* %82) #9
  %84 = icmp eq i32 %83, 0
  br i1 %84, label %85, label %88

85:                                               ; preds = %79
  %86 = trunc i64 %80 to i32
  %87 = call i32 @hypre_StructVectorClearValues(%struct.hypre_StructVector_struct* %11, i32* %1, i32 %86, i32 1) #9
  br label %88
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* nocapture readonly %0, i32* %1, i32* %2, i32 %3, double* %4, i32 %5) local_unnamed_addr #1 {
  ...
  %17 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %16) #9
  %18 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %17, i64 0, i32 0, i64 0
  %19 = call i32 @hypre_CopyIndex(i32* %1, i32* %18) #9
  %20 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %17, i64 0, i32 1, i64 0
  %21 = call i32 @hypre_CopyIndex(i32* %2, i32* nonnull %20) #9
  %22 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* %17, %struct.hypre_Box_struct* %17, double* %4, i32 %5, i32 -1, i32 0) #9
  %23 = icmp eq i32 %5, 0
  br i1 %23, label %85, label %24

24:                                               ; preds = %6
  %25 = getelementptr inbounds %struct.hypre_SStructPVector, %struct.hypre_SStructPVector* %0, i64 0, i32 1
  %26 = load %struct.hypre_SStructPGrid*, %struct.hypre_SStructPGrid** %25, align 8, !tbaa !12
  %27 = bitcast [3 x i32]* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %27) #9
  %28 = getelementptr inbounds %struct.hypre_SStructPGrid, %struct.hypre_SStructPGrid* %26, i64 0, i32 3
  ...
  %33 = call i32 @hypre_SStructVariableGetOffset(i32 %31, i32 %16, i32* nonnull %32) #9
  %34 = load %struct.hypre_StructGrid_struct*, %struct.hypre_StructGrid_struct** %13, align 8, !tbaa !26
  %35 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %34, i64 0, i32 2
  %36 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %35, align 8, !tbaa !30
  %37 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 1, i32 %16) #9
  %38 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 2, i32 %16) #9
  %39 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 0, i32 %16) #9
  %40 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %38, i64 0, i32 0
  %41 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %40, align 8, !tbaa !34
  %42 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %41, i64 1
  %43 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %37, i64 0, i32 0
  %44 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %43, align 8, !tbaa !34
  %45 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %17, %struct.hypre_Box_struct* %44) #9
  %46 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %37, i32 1) #9
  %47 = call i32 @hypre_SubtractBoxArrays(%struct.hypre_BoxArray_struct* %37, %struct.hypre_BoxArray_struct* %36, %struct.hypre_BoxArray_struct* %39) #9
  %48 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %38, i32 0) #9
  %49 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %36, i64 0, i32 1
  %50 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %36, i64 0, i32 0
  %51 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %37, i64 0, i32 1
  %52 = load i32, i32* %49, align 8, !tbaa !31
  %53 = icmp sgt i32 %52, 0
  br i1 %53, label %54, label %81

54:                                               ; preds = %24, %76
  %55 = phi i64 [ %77, %76 ], [ 0, %24 ]
  %56 = call i32 @hypre_SubtractBoxArrays(%struct.hypre_BoxArray_struct* %37, %struct.hypre_BoxArray_struct* %38, %struct.hypre_BoxArray_struct* %39) #9
  %57 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %38, i32 1) #9
  %58 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %50, align 8, !tbaa !34
  %59 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %58, i64 %55
  %60 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %59, %struct.hypre_Box_struct* %41) #9
  %61 = call i32 @hypre_BoxGrowByIndex(%struct.hypre_Box_struct* %41, i32* nonnull %32) #9
  %62 = load i32, i32* %51, align 8, !tbaa !31
...
66:                                               ; preds = %64, %66
  ...
  %68 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %43, align 8, !tbaa !34
  %69 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %68, i64 %67
  %70 = call i32 @hypre_IntersectBoxes(%struct.hypre_Box_struct* %69, %struct.hypre_Box_struct* %41, %struct.hypre_Box_struct* nonnull %42) #9
  %71 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* nonnull %42, %struct.hypre_Box_struct* %17, double* %4, i32 %5, i32 %65, i32 1) #9
  %72 = add nuw nsw i64 %67, 1
  %73 = load i32, i32* %51, align 8, !tbaa !31
  %74 = sext i32 %73 to i64
  %75 = icmp slt i64 %72, %74
  br i1 %75, label %66, label %76, !llvm.loop !37

76:                                               ; preds = %66, %54
  %77 = add nuw nsw i64 %55, 1
  %78 = load i32, i32* %49, align 8, !tbaa !31
  %79 = sext i32 %78 to i64
  %80 = icmp slt i64 %77, %79
  br i1 %80, label %54, label %81, !llvm.loop !38

81:                                               ; preds = %76, %24
  %82 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %37) #9
  %83 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %38) #9
  %84 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %39) #9
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %27) #9
  br label %122

85:                                               ; preds = %6
  %86 = load %struct.hypre_StructGrid_struct*, %struct.hypre_StructGrid_struct** %13, align 8, !tbaa !26
  %87 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %86, i64 0, i32 2
  %88 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %87, align 8, !tbaa !30
  %89 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 0, i32 %16) #9
  %90 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %88, i64 0, i32 1
  %91 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %88, i64 0, i32 0
  %92 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %89, i64 0, i32 1
  %93 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %89, i64 0, i32 0
  %94 = load i32, i32* %90, align 8, !tbaa !31
  %95 = icmp sgt i32 %94, 0
  br i1 %95, label %96, label %120

96:                                               ; preds = %85, %115
  %97 = phi i64 [ %116, %115 ], [ 0, %85 ]
  %98 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %91, align 8, !tbaa !34
  %99 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %98, i64 %97
  %100 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %89, i32 0) #9
  %101 = call i32 @hypre_SubtractBoxes(%struct.hypre_Box_struct* %17, %struct.hypre_Box_struct* %99, %struct.hypre_BoxArray_struct* %89) #9
  %102 = load i32, i32* %92, align 8, !tbaa !31
...
106:                                              ; preds = %104, %106
  %107 = phi i64 [ %111, %106 ], [ 0, %104 ]
  %108 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %93, align 8, !tbaa !34
  %109 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %108, i64 %107
  %110 = call i32 @hypre_StructVectorClearBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* %109, i32 %105, i32 1) #9
  %111 = add nuw nsw i64 %107, 1
  %112 = load i32, i32* %92, align 8, !tbaa !31
  %113 = sext i32 %112 to i64
  %114 = icmp slt i64 %111, %113
  br i1 %114, label %106, label %115, !llvm.loop !39

115:                                              ; preds = %106, %96
  %116 = add nuw nsw i64 %97, 1
  %117 = load i32, i32* %90, align 8, !tbaa !31
  %118 = sext i32 %117 to i64
  %119 = icmp slt i64 %116, %118
  br i1 %119, label %96, label %120, !llvm.loop !40

120:                                              ; preds = %115, %85
  %121 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %89) #9
  br label %122

122:                                              ; preds = %120, %81
  %123 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %17) #9
  %124 = load i32, i32* @hypre__global_error, align 4, !tbaa !10
  ret i32 %124
}
...
40:                                               ; preds = %35
  ...
  %45 = call i32 @hypre_SStructVariableGetOffset(i32 %38, i32 %19, i32* nonnull %28) #9
...
56:                                               ; preds = %46, %40
  %57 = call i32 @hypre_CreateCommInfoFromNumGhost(%struct.hypre_StructGrid_struct* %44, i32* nonnull %30, %struct.hypre_CommInfo_struct** nonnull %2) #9
  ...
  %60 = call i32 @hypre_CommPkgDestroy(%struct.hypre_CommPkg_struct* %59) #9
  ...
  %67 = call i32 @hypre_CommPkgCreate(%struct.hypre_CommInfo_struct* %61, %struct.hypre_BoxArray_struct* %64, %struct.hypre_BoxArray_struct* %64, i32 1, i32** null, i32 0, i32 %66, %struct.hypre_CommPkg_struct** nonnull %58) #9
  ...
  %74 = call i32 @hypre_CommPkgCreate(%struct.hypre_CommInfo_struct* %68, %struct.hypre_BoxArray_struct* %71, %struct.hypre_BoxArray_struct* %71, i32 1, i32** null, i32 1, i32 %73, %struct.hypre_CommPkg_struct** nonnull %3) #9
  ...
  %79 = call i32 @hypre_InitializeCommunication(%struct.hypre_CommPkg_struct* %75, double* %78, double* %78, i32 1, i32 0, %struct.hypre_CommHandle_struct** nonnull %4) #9
  %80 = load %struct.hypre_CommHandle_struct*, %struct.hypre_CommHandle_struct** %4, align 8, !tbaa !9
  %81 = call i32 @hypre_FinalizeCommunication(%struct.hypre_CommHandle_struct* %80) #9
  %82 = load %struct.hypre_CommInfo_struct*, %struct.hypre_CommInfo_struct** %2, align 8, !tbaa !9
  %83 = call i32 @hypre_CommInfoDestroy(%struct.hypre_CommInfo_struct* %82) #9
  %84 = load %struct.hypre_CommPkg_struct*, %struct.hypre_CommPkg_struct** %3, align 8, !tbaa !9
  %85 = call i32 @hypre_CommPkgDestroy(%struct.hypre_CommPkg_struct* %84) #9
  br label %86
...
10:                                               ; preds = %8, %10
  ...
  %14 = call i32 @hypre_StructVectorClearGhostValues(%struct.hypre_StructVector_struct* %13) #9
  %15 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %12, align 8, !tbaa !9
  %16 = call i32 @hypre_StructVectorAssemble(%struct.hypre_StructVector_struct* %15) #9
...
18:                                               ; preds = %13
  ...
  %23 = call i32 @hypre_InitializeCommunication(%struct.hypre_CommPkg_struct* nonnull %16, double* %22, double* %22, i32 0, i32 0, %struct.hypre_CommHandle_struct** nonnull %2) #9
  %24 = load %struct.hypre_CommHandle_struct*, %struct.hypre_CommHandle_struct** %2, align 8, !tbaa !9
  %25 = call i32 @hypre_FinalizeCommunication(%struct.hypre_CommHandle_struct* %24) #9
  br label %26
...
define dso_local i32 @hypre_SStructPVectorGetValues(%struct.hypre_SStructPVector* nocapture readonly %0, i32* %1, i32 %2, double* %3) local_unnamed_addr #1 {
  ...
  %23 = call i32 @hypre_StructVectorSetValues(%struct.hypre_StructVector_struct* %11, i32* %1, double* %3, i32 -1, i32 -1, i32 0) #9
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SStructPVectorGetBoxValues(%struct.hypre_SStructPVector* nocapture readonly %0, i32* %1, i32* %2, i32 %3, double* %4) local_unnamed_addr #1 {
  ...
  %22 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %14, i64 0, i32 1
  %23 = load i32, i32* %22, align 4, !tbaa !28
  %24 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %23) #9
  %25 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %24, i64 0, i32 0, i64 0
  %26 = call i32 @hypre_CopyIndex(i32* %1, i32* %25) #9
  %27 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %24, i64 0, i32 1, i64 0
  %28 = call i32 @hypre_CopyIndex(i32* %2, i32* nonnull %27) #9
  %29 = getelementptr inbounds %struct.hypre_StructGrid_struct, %struct.hypre_StructGrid_struct* %14, i64 0, i32 2
  %30 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %29, align 8, !tbaa !30
  store %struct.hypre_BoxArray_struct* %21, %struct.hypre_BoxArray_struct** %29, align 8, !tbaa !30
  %31 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* %24, %struct.hypre_Box_struct* %24, double* %4, i32 -1, i32 -1, i32 0) #9
  store %struct.hypre_BoxArray_struct* %30, %struct.hypre_BoxArray_struct** %29, align 8, !tbaa !30
  %32 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %24) #9
  %33 = load i32, i32* @hypre__global_error, align 4, !tbaa !10
  ret i32 %33
}
...
9:                                                ; preds = %7, %9
  ...
  %13 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %12, align 8, !tbaa !9
  %14 = call i32 @hypre_StructVectorSetConstantValues(%struct.hypre_StructVector_struct* %13, double %1) #9
...
12:                                               ; preds = %10, %12
  ...
  %15 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %7, i8* nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* %0, i32 %14) #9
  ...
  %19 = call i32 @hypre_StructVectorPrint(i8* nonnull %7, %struct.hypre_StructVector_struct* %18, i32 %2) #9
...
20:                                               ; preds = %20, %18
  ...
  %24 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %23, align 8, !tbaa !9
  %25 = call i32 @hypre_StructVectorSetConstantValues(%struct.hypre_StructVector_struct* %24, double %1) #9
...
define dso_local i32 @hypre_SStructVectorParConvert(%struct.hypre_SStructVector_struct* nocapture readonly %0, %struct.hypre_ParVector_struct** nocapture %1) local_unnamed_addr #1 {
  ...
  %18 = call i32 @hypre_SetIndex(i32* nonnull %17, i32 1) #9
...
79:                                               ; preds = %62, %311
  ...
  %94 = call i32 @hypre_BoxGetSize(%struct.hypre_Box_struct* %83, i32* nonnull %28) #9
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %29) #9
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %30) #9
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %31) #9
...
156:                                              ; preds = %129, %111
  ...
  %158 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %88, i32* %84) #9
...
199:                                              ; preds = %172, %156
  ...
  %201 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %83, i32* nonnull %84) #9
...
235:                                              ; preds = %233
  %236 = sext i32 %115 to i64
  %237 = sext i32 %159 to i64
...
250:                                              ; preds = %235, %308
  %251 = phi i32 [ %291, %308 ], [ %219, %235 ]
  %252 = phi i32 [ %294, %308 ], [ %234, %235 ]
...
257:                                              ; preds = %263
  %258 = trunc i64 %273 to i32
  %259 = trunc i64 %272 to i32
  br label %260
...
311:                                              ; preds = %308, %233, %199
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %31) #9
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %30) #9
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %29) #9
  %312 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %83) #9
...
define dso_local i32 @hypre_SStructVectorRestore(%struct.hypre_SStructVector_struct* nocapture readnone %0, %struct.hypre_ParVector_struct* nocapture readnone %1) local_unnamed_addr #5 {
...
18:                                               ; preds = %2
  ...
  %20 = call i32 @hypre_SetIndex(i32* nonnull %19, i32 1) #9
...
81:                                               ; preds = %64, %313
  ...
  %96 = call i32 @hypre_BoxGetSize(%struct.hypre_Box_struct* %85, i32* nonnull %30) #9
...
158:                                              ; preds = %131, %113
  ...
  %160 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %90, i32* %86) #9
...
201:                                              ; preds = %174, %158
  ...
  %203 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %85, i32* nonnull %86) #9
...
237:                                              ; preds = %235
  %238 = sext i32 %117 to i64
  %239 = sext i32 %161 to i64
...
252:                                              ; preds = %237, %310
  %253 = phi i32 [ %293, %310 ], [ %221, %237 ]
  %254 = phi i32 [ %296, %310 ], [ %236, %237 ]
...
259:                                              ; preds = %265
  %260 = trunc i64 %275 to i32
  %261 = trunc i64 %274 to i32
  br label %262
...
313:                                              ; preds = %310, %235, %201
  ...
  %314 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %85) #9
...
define dso_local i32 @hypre_SStructPVectorInitializeShell(%struct.hypre_SStructPVector* nocapture %0) local_unnamed_addr #1 {
  ...
  %3 = load i32, i32* %2, align 8, !tbaa !15
  %4 = sext i32 %3 to i64
  %5 = call i8* @hypre_CAlloc(i64 %4, i64 4) #9
...
11:                                               ; preds = %9, %11
  ...
  %16 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %15, align 8, !tbaa !9
  %17 = call i32 @hypre_StructVectorInitializeShell(%struct.hypre_StructVector_struct* %16) #9
...
26:                                               ; preds = %26, %24
  ...
  %32 = call i32 @hypre_StructVectorInitializeShell(%struct.hypre_StructVector_struct* %31) #9
...
19:                                               ; preds = %17, %19
  ...
  %24 = call i32 @hypre_StructVectorClearGhostValues(%struct.hypre_StructVector_struct* %23) #9
...
!59 = !{!60, !8, i64 0}
!60 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28}
!61 = !{!27, !8, i64 40}
!62 = !{!52, !5, i64 4}

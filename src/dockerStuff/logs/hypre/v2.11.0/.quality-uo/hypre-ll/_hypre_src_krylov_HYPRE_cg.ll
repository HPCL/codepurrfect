...
define dso_local i32 @HYPRE_CGNRSetPrecond(%struct.hypre_Solver_struct* %0, i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %1, i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %2, i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %3, %struct.hypre_Solver_struct* %4) local_unnamed_addr #0 {
  ...
  %7 = bitcast i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %1 to i32 (...)*
  %8 = bitcast i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %2 to i32 (...)*
  %9 = bitcast i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %3 to i32 (...)*
  %10 = bitcast %struct.hypre_Solver_struct* %4 to i8*
  %11 = call i32 @hypre_CGNRSetPrecond(i8* %6, i32 (...)* %7, i32 (...)* %8, i32 (...)* %9, i8* %10) #2
  ret i32 %11
}

declare dso_local i32 @hypre_CGNRSetPrecond(i8*, i32 (...)*, i32 (...)*, i32 (...)*, i8*) local_unnamed_addr #1

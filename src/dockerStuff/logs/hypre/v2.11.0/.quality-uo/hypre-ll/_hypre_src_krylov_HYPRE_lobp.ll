...
define dso_local i32 @lobpcg_initialize(%struct.lobpcg_Data* nocapture %0) local_unnamed_addr #0 {
  ...
  store double 0.000000e+00, double* %3, align 8, !tbaa !11
...
29:                                               ; preds = %24
  ...
  %34 = bitcast i32 (...)* %10 to i32 (i8*, i8*, i8*, i8*, ...)*
  br i1 %33, label %35, label %37

35:                                               ; preds = %29
  %36 = call i32 (i8*, i8*, i8*, i8*, ...) %34(i8* %13, i8* %1, i8* %2, i8* %3) #6
  br label %39

37:                                               ; preds = %29
  %38 = call i32 (i8*, i8*, i8*, i8*, ...) %34(i8* %13, i8* nonnull %32, i8* %2, i8* %3) #6
  br label %39
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @hypre_LOBPCGSetPrecond(i8* nocapture %0, i32 (...)* %1, i32 (...)* %2, i8* %3) local_unnamed_addr #3 {
...
define dso_local void @hypre_LOBPCGPreconditioner(i8* nocapture readonly %0, i8* %1, i8* %2) #0 {
  ...
  %6 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %5, align 8, !tbaa !39
...
11:                                               ; preds = %3
  ...
  %13 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %12, align 8, !tbaa !40
...
20:                                               ; preds = %15
  ...
  %22 = load i32 (i8*)*, i32 (i8*)** %21, align 8, !tbaa !42
...
24:                                               ; preds = %15
  ...
  %26 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** %25, align 8, !tbaa !40
...
36:                                               ; preds = %28
  ...
  %40 = bitcast i32 (...)* %9 to i32 (i8*, i8*, i8*, i8*, ...)*
  %41 = call i32 (i8*, i8*, i8*, i8*, ...) %40(i8* %35, i8* %39, i8* %1, i8* %2) #6
  br label %45

42:                                               ; preds = %28
  %43 = bitcast i32 (...)* %9 to i32 (i8*, i8*, i8*, i8*, ...)*
  %44 = call i32 (i8*, i8*, i8*, i8*, ...) %43(i8* %35, i8* nonnull %31, i8* %1, i8* %2) #6
  br label %45
...
define dso_local void @hypre_LOBPCGOperatorA(i8* nocapture readonly %0, i8* %1, i8* %2) #0 {
  ...
  %11 = load i32 (i8*, double, i8*, i8*, double, i8*)*, i32 (i8*, double, i8*, i8*, double, i8*)** %10, align 8, !tbaa !43
...
8:                                                ; preds = %3
  ...
  %11 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %10, align 8, !tbaa !39
...
15:                                               ; preds = %3
  ...
  %23 = load i32 (i8*, double, i8*, i8*, double, i8*)*, i32 (i8*, double, i8*, i8*, double, i8*)** %22, align 8, !tbaa !43
...
define dso_local void @hypre_LOBPCGMultiPreconditioner(i8* %0, i8* %1, i8* %2) #0 {
  ...
  %8 = load void (void (i8*, i8*, i8*)*, i8*, i8*, i8*)*, void (void (i8*, i8*, i8*)*, i8*, i8*, i8*)** %7, align 8, !tbaa !44
...
define dso_local i32 @hypre_LOBPCGSolve(i8* %0, %struct.mv_MultiVector* %1, %struct.mv_MultiVector* %2, double* %3) local_unnamed_addr #0 {
  ...
  %22 = load %struct.utilities_FortranMatrix*, %struct.utilities_FortranMatrix** %21, align 8, !tbaa !45
  %23 = getelementptr inbounds i8, i8* %0, i64 40
  %24 = bitcast i8* %23 to %struct.utilities_FortranMatrix**
  %25 = load %struct.utilities_FortranMatrix*, %struct.utilities_FortranMatrix** %24, align 8, !tbaa !46
  %26 = getelementptr inbounds i8, i8* %0, i64 48
  %27 = bitcast i8* %26 to %struct.utilities_FortranMatrix**
  %28 = load %struct.utilities_FortranMatrix*, %struct.utilities_FortranMatrix** %27, align 8, !tbaa !47
  %29 = sext i32 %18 to i64
  %30 = add nsw i32 %14, 1
  %31 = sext i32 %30 to i64
  call void @utilities_FortranMatrixAllocateData(i64 %29, i64 %31, %struct.utilities_FortranMatrix* %22) #6
  call void @utilities_FortranMatrixAllocateData(i64 %29, i64 1, %struct.utilities_FortranMatrix* %25) #6
  call void @utilities_FortranMatrixAllocateData(i64 %29, i64 %31, %struct.utilities_FortranMatrix* %28) #6
  %32 = icmp eq i32 (...)* %8, null
  %33 = select i1 %32, void (i8*, i8*, i8*)* null, void (i8*, i8*, i8*)* @hypre_LOBPCGMultiPreconditioner
  %34 = icmp eq i8* %11, null
  %35 = select i1 %34, void (i8*, i8*, i8*)* null, void (i8*, i8*, i8*)* @hypre_LOBPCGMultiOperatorB
  %36 = getelementptr inbounds %struct.lobpcg_BLASLAPACKFunctions, %struct.lobpcg_BLASLAPACKFunctions* %5, i64 0, i32 1
  store i32 (i32*, i8*, i8*, i32*, double*, i32*, double*, i32*, double*, double*, i32*, i32*)* @dsygv_interface, i32 (i32*, i8*, i8*, i32*, double*, i32*, double*, i32*, double*, double*, i32*, i32*)** %36, align 8, !tbaa !48
  %37 = getelementptr inbounds %struct.lobpcg_BLASLAPACKFunctions, %struct.lobpcg_BLASLAPACKFunctions* %5, i64 0, i32 0
  store i32 (i8*, i32*, double*, i32*, i32*)* @dpotrf_interface, i32 (i8*, i32*, double*, i32*, i32*)** %37, align 8, !tbaa !49
  %38 = getelementptr inbounds i8, i8* %0, i64 28
  %39 = bitcast i8* %38 to i32*
  %40 = call double* @utilities_FortranMatrixValues(%struct.utilities_FortranMatrix* %22) #6
  %41 = call i64 @utilities_FortranMatrixGlobalHeight(%struct.utilities_FortranMatrix* %22) #6
  %42 = trunc i64 %41 to i32
  %43 = call double* @utilities_FortranMatrixValues(%struct.utilities_FortranMatrix* %25) #6
  %44 = call double* @utilities_FortranMatrixValues(%struct.utilities_FortranMatrix* %28) #6
  %45 = call i64 @utilities_FortranMatrixGlobalHeight(%struct.utilities_FortranMatrix* %28) #6
  %46 = trunc i64 %45 to i32
  %47 = bitcast i8* %0 to double*
  %48 = load double, double* %47, align 8
  %49 = getelementptr inbounds i8, i8* %0, i64 8
  %50 = bitcast i8* %49 to double*
  %51 = load double, double* %50, align 8
  %52 = call i32 @lobpcg_solve(%struct.mv_MultiVector* %2, i8* %0, void (i8*, i8*, i8*)* nonnull @hypre_LOBPCGMultiOperatorA, i8* %0, void (i8*, i8*, i8*)* %35, i8* %0, void (i8*, i8*, i8*)* %33, %struct.mv_MultiVector* %1, %struct.lobpcg_BLASLAPACKFunctions* nonnull byval(%struct.lobpcg_BLASLAPACKFunctions) align 8 %5, double %48, double %51, i32 %14, i32 %17, i32* nonnull %39, double* %3, double* %40, i32 %42, double* %43, double* %44, i32 %46) #6
  %53 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
...
declare dso_local void @utilities_FortranMatrixAllocateData(i64, i64, %struct.utilities_FortranMatrix*) local_unnamed_addr #1
...
declare dso_local i64 @utilities_FortranMatrixGlobalHeight(%struct.utilities_FortranMatrix*) local_unnamed_addr #1
...
define dso_local %struct.utilities_FortranMatrix* @hypre_LOBPCGEigenvaluesHistory(i8* nocapture readonly %0) local_unnamed_addr #4 {
  ...
  %3 = bitcast i8* %2 to %struct.utilities_FortranMatrix**
  %4 = load %struct.utilities_FortranMatrix*, %struct.utilities_FortranMatrix** %3, align 8, !tbaa !45
  ret %struct.utilities_FortranMatrix* %4
}
...
define dso_local i32 @HYPRE_LOBPCGCreate(%struct.mv_InterfaceInterpreter* %0, %struct.HYPRE_MatvecFunctions* %1, %struct.hypre_Solver_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_CAlloc(i64 1, i64 144) #6
  ...
  store %struct.mv_InterfaceInterpreter* %0, %struct.mv_InterfaceInterpreter** %7, align 8, !tbaa !39
  ...
  store i8* %4, i8** %29, align 8, !tbaa !36
...
33:                                               ; preds = %28
  ...
  %38 = bitcast i32 (...)* %14 to i32 (i8*, i8*, i8*, i8*, ...)*
  br i1 %37, label %39, label %41

39:                                               ; preds = %33
  %40 = call i32 (i8*, i8*, i8*, i8*, ...) %38(i8* %17, i8* %6, i8* %7, i8* %8) #6
  br label %43

41:                                               ; preds = %33
  %42 = call i32 (i8*, i8*, i8*, i8*, ...) %38(i8* %17, i8* nonnull %36, i8* %7, i8* %8) #6
  br label %43
...
define dso_local i32 @HYPRE_LOBPCGSetPrecond(%struct.hypre_Solver_struct* nocapture %0, i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %1, i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %2, %struct.hypre_Solver_struct* %3) local_unnamed_addr #3 {
  ...
  store i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)* %1, i32 (%struct.hypre_Solver_struct*, %struct.hypre_Matrix_struct*, %struct.hypre_Vector_struct*, %struct.hypre_Vector_struct*)** %7, align 8, !tbaa !37
...
define dso_local i32 @HYPRE_LOBPCGGetPrecond(%struct.hypre_Solver_struct* nocapture readonly %0, %struct.hypre_Solver_struct** nocapture %1) local_unnamed_addr #3 {
  ...
  store %struct.hypre_Solver_struct* %6, %struct.hypre_Solver_struct** %1, align 8, !tbaa !36
...
define dso_local %struct.utilities_FortranMatrix* @HYPRE_LOBPCGEigenvaluesHistory(%struct.hypre_Solver_struct* nocapture readonly %0) local_unnamed_addr #4 {
  ...
  %4 = bitcast i8* %3 to %struct.utilities_FortranMatrix**
  %5 = load %struct.utilities_FortranMatrix*, %struct.utilities_FortranMatrix** %4, align 8, !tbaa !45
  ret %struct.utilities_FortranMatrix* %5
}
...
define dso_local void @lobpcg_MultiVectorByMultiVector(%struct.mv_MultiVector* %0, %struct.mv_MultiVector* %1, %struct.utilities_FortranMatrix* %2) local_unnamed_addr #0 {
  %4 = call i64 @utilities_FortranMatrixGlobalHeight(%struct.utilities_FortranMatrix* %2) #6
  %5 = trunc i64 %4 to i32
  %6 = call i64 @utilities_FortranMatrixHeight(%struct.utilities_FortranMatrix* %2) #6
  %7 = trunc i64 %6 to i32
  %8 = call i64 @utilities_FortranMatrixWidth(%struct.utilities_FortranMatrix* %2) #6
  %9 = trunc i64 %8 to i32
  %10 = call double* @utilities_FortranMatrixValues(%struct.utilities_FortranMatrix* %2) #6
  call void @mv_MultiVectorByMultiVector(%struct.mv_MultiVector* %0, %struct.mv_MultiVector* %1, i32 %5, i32 %7, i32 %9, double* %10) #6
  ret void
}
...
declare dso_local i64 @utilities_FortranMatrixHeight(%struct.utilities_FortranMatrix*) local_unnamed_addr #1

declare dso_local i64 @utilities_FortranMatrixWidth(%struct.utilities_FortranMatrix*) local_unnamed_addr #1
...
!39 = !{!19, !10, i64 56}
!40 = !{!41, !10, i64 24}
!41 = !{!"", !10, i64 0, !10, i64 8, !10, i64 16, !10, i64 24, !10, i64 32, !10, i64 40, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !10, i64 88, !10, i64 96, !10, i64 104, !10, i64 112, !10, i64 120, !10, i64 128, !10, i64 136, !10, i64 144, !10, i64 152, !10, i64 160, !10, i64 168, !10, i64 176, !10, i64 184, !10, i64 192}
!42 = !{!41, !10, i64 32}
!43 = !{!23, !10, i64 8}
!44 = !{!41, !10, i64 192}
!45 = !{!19, !10, i64 32}

...
define dso_local i32 @hypre_FacSemiRestrictCreate2(i8** nocapture %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 64) #6
...
104:                                              ; preds = %101, %62
  ...
  %125 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
...
234:                                              ; preds = %231, %142
  ...
  %238 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %239 = bitcast i8* %238 to %struct.hypre_CommPkg_struct**
  %240 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %241 = bitcast i8* %240 to %struct.hypre_BoxArrayArray_struct**
  %242 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %243 = bitcast i8* %242 to %struct.hypre_BoxArrayArray_struct**
  %244 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %245 = bitcast i8* %244 to i32***
  %246 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %247 = bitcast i8* %246 to %struct.hypre_BoxArrayArray_struct**
  %248 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %249 = bitcast i8* %248 to i32***
  %250 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
...
266:                                              ; preds = %264, %435
  ...
  %300 = call i8* @hypre_CAlloc(i64 %299, i64 8) #6
  ...
  %305 = call i8* @hypre_CAlloc(i64 %304, i64 8) #6
...
341:                                              ; preds = %321, %311
  ...
  %345 = call i8* @hypre_CAlloc(i64 %344, i64 4) #6
  ...
  %349 = call i8* @hypre_CAlloc(i64 %344, i64 4) #6
  ...
  %354 = call i8* @hypre_CAlloc(i64 %353, i64 4) #6
...
438:                                              ; preds = %435, %234
  ...
  %445 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %446 = bitcast i8* %445 to %struct.hypre_BoxArrayArray_struct**
  %447 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
  %448 = bitcast i8* %447 to i32***
  %449 = call i8* @hypre_CAlloc(i64 %124, i64 8) #6
...
469:                                              ; preds = %462, %586
  ...
  %492 = call i8* @hypre_CAlloc(i64 %491, i64 8) #6
  ...
  %497 = call i8* @hypre_CAlloc(i64 %496, i64 8) #6
...
529:                                              ; preds = %513, %503
  ...
  %532 = call i8* @hypre_CAlloc(i64 %531, i64 4) #6
  ...
  %536 = call i8* @hypre_CAlloc(i64 %531, i64 4) #6
...
629:                                              ; preds = %589, %464
  call void @hypre_Free(i8* %246) #6
  call void @hypre_Free(i8* %445) #6
  call void @hypre_Free(i8* %248) #6
  call void @hypre_Free(i8* %447) #6
  call void @hypre_Free(i8* %250) #6
...
97:                                               ; preds = %91, %87
  ...
  %100 = call i8* @hypre_CAlloc(i64 %99, i64 8) #6
...
122:                                              ; preds = %113
  ...
  %128 = call i8* @hypre_MAlloc(i64 %125) #6
...
142:                                              ; preds = %113
  %143 = call i8* @hypre_MAlloc(i64 8) #6
  %144 = bitcast i8* %143 to double***
  %145 = call i8* @hypre_MAlloc(i64 8) #6
  %146 = bitcast i8* %145 to double***
  %147 = call i8* @hypre_MAlloc(i64 8) #6
  %148 = bitcast i8* %143 to i8**
  store i8* %147, i8** %148, align 8, !tbaa !3
  %149 = call i8* @hypre_MAlloc(i64 8) #6
...
252:                                              ; preds = %151, %252
  ...
  %257 = call i8* @hypre_MAlloc(i64 %256) #6
...
538:                                              ; preds = %525, %697
  %539 = phi i32 [ %683, %697 ], [ %522, %525 ]
  %540 = phi i32 [ %680, %697 ], [ %509, %525 ]
  %541 = phi i32 [ %698, %697 ], [ 0, %525 ]
...
555:                                              ; preds = %553, %538
  %556 = phi i32 [ %540, %538 ], [ %554, %553 ]
  %557 = phi i32 [ %539, %538 ], [ %662, %553 ]
  br label %665

558:                                              ; preds = %548, %660
  %559 = phi i64 [ %552, %548 ], [ %661, %660 ]
  %560 = phi i32 [ %539, %548 ], [ %662, %660 ]
  %561 = phi i32 [ 0, %548 ], [ %663, %660 ]
...
660:                                              ; preds = %657, %589
  %661 = add i64 %559, %526
  %662 = add nsw i32 %560, %464
  %663 = add nuw nsw i32 %561, 1
...
970:                                              ; preds = %956, %1032
  %971 = phi i32 [ %1033, %1032 ], [ 0, %956 ]
  %972 = phi i32 [ %1018, %1032 ], [ %955, %956 ]
  %973 = phi i32 [ %1015, %1032 ], [ %942, %956 ]
...
984:                                              ; preds = %981, %970
  %985 = phi i32 [ %973, %970 ], [ %982, %981 ]
  %986 = phi i32 [ %972, %970 ], [ %983, %981 ]
  br label %1000
...
1051:                                             ; preds = %1048, %1051
  ...
  call void @hypre_Free(i8* %1055) #6
...
1064:                                             ; preds = %1061, %1064
  ...
  call void @hypre_Free(i8* %1068) #6
  ...
  call void @hypre_Free(i8* %1071) #6
...
!33 = !{!11, !4, i64 8}
!34 = !{!35, !4, i64 112}
!35 = !{!"hypre_SStructGrid_struct", !9, i64 0, !9, i64 4, !9, i64 8, !4, i64 16, !4, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !9, i64 72, !9, i64 76, !4, i64 80, !4, i64 88, !4, i64 96, !4, i64 104, !4, i64 112, !4, i64 120, !9, i64 128, !9, i64 132, !9, i64 136, !9, i64 140, !9, i64 144, !9, i64 148}
!36 = !{!37, !4, i64 0}

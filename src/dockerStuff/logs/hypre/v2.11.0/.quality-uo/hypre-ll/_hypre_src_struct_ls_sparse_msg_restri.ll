...
386:                                              ; preds = %384
  %387 = sext i32 %212 to i64
  %388 = sext i32 %254 to i64
  br label %400
...
400:                                              ; preds = %386, %482
  %401 = phi i32 [ %462, %482 ], [ %355, %386 ]
  %402 = phi i32 [ %465, %482 ], [ %370, %386 ]
  %403 = phi i32 [ %468, %482 ], [ %385, %386 ]
...
409:                                              ; preds = %417
  %410 = trunc i64 %444 to i32
  %411 = trunc i64 %443 to i32
  %412 = trunc i64 %442 to i32
  br label %413

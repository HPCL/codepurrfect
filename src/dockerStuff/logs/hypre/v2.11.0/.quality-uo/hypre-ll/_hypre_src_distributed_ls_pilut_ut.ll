...
define dso_local void @hypre_PrintIdxVal(i32 %0, i32* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #3 {
  %4 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %0)
  %5 = icmp sgt i32 %0, 0
...
8:                                                ; preds = %6, %8
  ...
  %14 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), i32 %11, double %13)
...
define dso_local void @hypre_SortKeyValueNodesDec(%struct.KeyValueType* %0, i32 %1) local_unnamed_addr #6 {
  %3 = bitcast %struct.KeyValueType* %0 to i8*
  call void @hypre_tex_qsort(i8* %3, i32 %1, i32 8, i32 (...)* bitcast (i32 (i8*, i8*)* @hypre_DecKeyValueCmp to i32 (...)*)) #10
  ret void
}

declare dso_local void @hypre_tex_qsort(i8*, i32, i32, i32 (...)*) local_unnamed_addr #7

; Function Attrs: nofree norecurse nosync nounwind readonly uwtable
define dso_local i32 @hypre_sasum(i32 %0, i32* nocapture readonly %1) local_unnamed_addr #8 {
  %3 = icmp sgt i32 %0, 0
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_sincsort(i32 %0, i32* %1) local_unnamed_addr #6 {
  %3 = bitcast i32* %1 to i8*
  call void @hypre_tex_qsort(i8* %3, i32 %0, i32 4, i32 (...)* bitcast (i32 (i8*, i8*)* @incshort to i32 (...)*)) #10
  ret void
}
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_sdecsort(i32 %0, i32* %1) local_unnamed_addr #6 {
  %3 = bitcast i32* %1 to i8*
  call void @hypre_tex_qsort(i8* %3, i32 %0, i32 4, i32 (...)* bitcast (i32 (i8*, i8*)* @decshort to i32 (...)*)) #10
  ret void
}

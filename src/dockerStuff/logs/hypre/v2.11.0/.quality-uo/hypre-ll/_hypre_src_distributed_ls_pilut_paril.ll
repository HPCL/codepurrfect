...
167:                                              ; preds = %165, %6
  ...
  call void @hypre_Free(i8* %172) #10
  ...
  call void @hypre_Free(i8* %178) #10
  ...
  call void @hypre_Free(i8* %181) #10
  ...
  call void @hypre_Free(i8* %184) #10
  ...
  call void @hypre_Free(i8* %187) #10
  ...
  call void @hypre_Free(i8* %190) #10
  ...
  call void @hypre_Free(i8* %193) #10
  ...
  call void @hypre_Free(i8* %196) #10
  ...
  call void @hypre_Free(i8* %199) #10
  ...
  call void @hypre_Free(i8* %202) #10
  ...
  call void @hypre_Free(i8* %205) #10
  ...
  call void @hypre_Free(i8* %208) #10
  ...
  call void @hypre_Free(i8* %211) #10
  ...
  call void @hypre_Free(i8* %217) #10
  ...
  call void @hypre_Free(i8* %220) #10
  ...
  call void @hypre_Free(i8* %224) #10
  %225 = bitcast i32* %53 to i8*
  call void @hypre_Free(i8* %225) #10
  ...
  call void @hypre_Free(i8* %228) #10
...
74:                                               ; preds = %72, %66
  ...
  %108 = call i8* @hypre_CAlloc(i64 %107, i64 8) #10
...
226:                                              ; preds = %219, %195
  ...
  %231 = call i8* @hypre_CAlloc(i64 %230, i64 4) #10
...
299:                                              ; preds = %293, %273
  call void @hypre_Free(i8* %231) #10
...
define dso_local void @hypre_SendFactoredRows(%struct.factormatdef* nocapture readonly %0, %struct.comminfodef* nocapture readonly %1, i32* nocapture readonly %2, i32 %3, %struct.hypre_PilutSolverGlobals* %4) local_unnamed_addr #0 {
  ...
  %38 = call i8* @hypre_CAlloc(i64 %37, i64 4) #10
  %39 = bitcast i8* %38 to i32*
  %40 = call i8* @hypre_CAlloc(i64 %37, i64 4) #10
...
16:                                               ; preds = %8
  ...
  call void @hypre_Free(i8* %17) #10
  %18 = bitcast double* %6 to i8*
  call void @hypre_Free(i8* %18) #10
...
18:                                               ; preds = %7
  %19 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([44 x i8], [44 x i8]* @.str.8, i64 0, i64 0), i32 %0)
  br label %20

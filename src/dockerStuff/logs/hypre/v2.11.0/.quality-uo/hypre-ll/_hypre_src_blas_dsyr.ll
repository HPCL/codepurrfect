...
define dso_local i32 @hypre_dsyr2k(i8* %0, i8* %1, i32* nocapture readonly %2, i32* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, i32* nocapture readonly %6, double* nocapture readonly %7, i32* nocapture readonly %8, double* nocapture readonly %9, double* nocapture %10, i32* nocapture readonly %11) local_unnamed_addr #0 {
  ...
  %25 = call i64 @hypre_lsame_(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  %26 = icmp eq i64 %25, 0
  %27 = select i1 %26, i32* %3, i32* %2
  %28 = load i32, i32* %27, align 4, !tbaa !3
  store i32 %28, i32* @hypre_dsyr2k.nrowa, align 4, !tbaa !3
  %29 = call i64 @hypre_lsame_(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
...
31:                                               ; preds = %12
  %32 = call i64 @hypre_lsame_(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #3
  %33 = icmp eq i64 %32, 0
  br i1 %33, label %63, label %34

34:                                               ; preds = %31, %12
  %35 = call i64 @hypre_lsame_(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  %36 = icmp eq i64 %35, 0
  br i1 %36, label %37, label %43

37:                                               ; preds = %34
  %38 = call i64 @hypre_lsame_(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #3
  %39 = icmp eq i64 %38, 0
  br i1 %39, label %40, label %43

40:                                               ; preds = %37
  %41 = call i64 @hypre_lsame_(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #3
  %42 = icmp eq i64 %41, 0
...
68:                                               ; preds = %65
  %69 = call i32 @hypre_xerbla_(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0), i32* nonnull @hypre_dsyr2k.info) #3
  br label %530
...
180:                                              ; preds = %82
  %181 = call i64 @hypre_lsame_(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3

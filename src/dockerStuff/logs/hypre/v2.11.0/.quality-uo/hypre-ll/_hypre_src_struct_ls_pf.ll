...
31:                                               ; preds = %49, %22
  %32 = getelementptr inbounds i8, i8* %0, i64 232
  %33 = bitcast i8* %32 to i8***
  %34 = getelementptr inbounds i8, i8* %0, i64 240
...
44:                                               ; preds = %38
  ...
  %48 = call i32 @hypre_PFMGRelaxDestroy(i8* %47) #6
  br label %49
...
49:                                               ; preds = %44, %38
  ...
  %53 = call i32 @hypre_StructMatvecDestroy(i8* %52) #6
...
73:                                               ; preds = %58, %31
  ...
  %86 = getelementptr inbounds i8, i8* %0, i64 240
  ...
  %90 = getelementptr inbounds i8, i8* %0, i64 192
  ...
  %94 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %93) #6
  ...
  %99 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %98) #6
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 534, i32 12, i8* null) #6
  br label %30

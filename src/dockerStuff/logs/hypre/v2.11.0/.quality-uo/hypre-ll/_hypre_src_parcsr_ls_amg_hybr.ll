...
@str = private unnamed_addr constant [45 x i8] c" Warning! Invalid cycle! num_sweeps not set!\00", align 1
@str.5 = private unnamed_addr constant [45 x i8] c" Warning! Invalid cycle! Relax type not set!\00", align 1
@str.6 = private unnamed_addr constant [47 x i8] c" Warning! Invalid level! Relax weight not set!\00", align 1
@str.7 = private unnamed_addr constant [47 x i8] c" Warning! Invalid level! Outer weight not set!\00", align 1

; Function Attrs: nounwind uwtable
define dso_local i8* @hypre_AMGHybridCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 256) #5
  ...
  store i32 6, i32* %45, align 8, !tbaa !30
  %46 = getelementptr inbounds i8, i8* %1, i64 164
  %47 = bitcast i8* %46 to i32*
  store i32 0, i32* %47, align 4, !tbaa !31
  ...
  store i32 1, i32* %51, align 4, !tbaa !33
...
14:                                               ; preds = %3
  %15 = call i32 @hypre_BoomerAMGDestroy(i8* nonnull %12) #5
  br label %16
...
17:                                               ; preds = %16
  %18 = call i32 @hypre_PCGDestroy(i8* %9) #5
  br label %23

19:                                               ; preds = %16
  %20 = call i32 @hypre_GMRESDestroy(i8* %9) #5
  br label %23

21:                                               ; preds = %16
  %22 = call i32 @hypre_BiCGSTABDestroy(i8* %9) #5
  br label %23
...
28:                                               ; preds = %23
  ...
  call void @hypre_Free(i8* nonnull %29) #5
...
35:                                               ; preds = %30
  ...
  call void @hypre_Free(i8* nonnull %36) #5
...
60:                                               ; preds = %55
  ...
  call void @hypre_Free(i8* nonnull %61) #5
...
67:                                               ; preds = %62
  ...
  call void @hypre_Free(i8* nonnull %68) #5
...
74:                                               ; preds = %69
  ...
  call void @hypre_Free(i8* nonnull %75) #5
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 222, i32 12, i8* null) #5
  br label %12
...
9:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 227, i32 20, i8* null) #5
  br label %12
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 246, i32 12, i8* null) #5
  br label %13
...
9:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 251, i32 20, i8* null) #5
  br label %13
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 269, i32 12, i8* null) #5
  br label %13
...
9:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 274, i32 20, i8* null) #5
  br label %13
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 294, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 299, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 319, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 324, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 344, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 364, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 384, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 389, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 429, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 449, i32 12, i8* null) #5
  br label %8
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_AMGHybridSetPrecond(i8* %0, i32 (...)* %1, i32 (...)* %2, i8* %3) local_unnamed_addr #0 {
  %5 = icmp eq i8* %0, null
  br i1 %5, label %6, label %7

6:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 471, i32 12, i8* null) #5
  br label %16
...
7:                                                ; preds = %4
  ...
  store i32 (...)* %2, i32 (...)** %13, align 8, !tbaa !55
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 494, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 514, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 534, i32 12, i8* null) #5
  br label %13
...
9:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 539, i32 20, i8* null) #5
  br label %13
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 559, i32 12, i8* null) #5
  br label %13
...
9:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 564, i32 20, i8* null) #5
  br label %13
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 584, i32 12, i8* null) #5
  br label %13
...
9:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 589, i32 20, i8* null) #5
  br label %13
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 610, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 616, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 639, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 644, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 664, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 684, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 704, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 709, i32 20, i8* null) #5
  br label %11
...
8:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 734, i32 20, i8* null) #5
  br label %12
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 756, i32 12, i8* null) #5
  br label %25
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 761, i32 20, i8* null) #5
  br label %25
...
13:                                               ; preds = %8
  %14 = call i8* @hypre_CAlloc(i64 4, i64 4) #5
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 791, i32 12, i8* null) #5
  br label %38
...
8:                                                ; preds = %6
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 796, i32 20, i8* null) #5
  br label %38
...
17:                                               ; preds = %12
  %18 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @str, i64 0, i64 0))
  br label %19

19:                                               ; preds = %17, %12
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 803, i32 28, i8* null) #5
  br label %38
...
25:                                               ; preds = %20
  %26 = call i8* @hypre_CAlloc(i64 4, i64 4) #5
  %27 = bitcast i8* %26 to i32*
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 834, i32 12, i8* null) #5
  br label %22
...
10:                                               ; preds = %5
  %11 = call i8* @hypre_CAlloc(i64 4, i64 4) #5
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 862, i32 12, i8* null) #5
  br label %38
...
14:                                               ; preds = %9
  %15 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @str.5, i64 0, i64 0))
  br label %16

16:                                               ; preds = %14, %9
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 870, i32 28, i8* null) #5
  br label %38
...
22:                                               ; preds = %17
  %23 = call i8* @hypre_CAlloc(i64 4, i64 4) #5
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 899, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 919, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 924, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 944, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 949, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 969, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 974, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 994, i32 12, i8* null) #5
  br label %16
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 999, i32 20, i8* null) #5
  br label %16
...
13:                                               ; preds = %8
  ...
  call void @hypre_Free(i8* nonnull %14) #5
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1021, i32 12, i8* null) #5
  br label %16
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1026, i32 20, i8* null) #5
  br label %16
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1048, i32 12, i8* null) #5
  br label %16
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1053, i32 20, i8* null) #5
  br label %16
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1075, i32 12, i8* null) #5
  br label %16
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1080, i32 20, i8* null) #5
  br label %16
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1102, i32 12, i8* null) #5
  br label %16
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1107, i32 20, i8* null) #5
  br label %16
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1131, i32 12, i8* null) #5
  br label %28
...
13:                                               ; preds = %5
  ...
  %15 = call i8* @hypre_CAlloc(i64 %14, i64 8) #5
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1162, i32 12, i8* null) #5
  br label %42
...
16:                                               ; preds = %11
  %17 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], [47 x i8]* @str.6, i64 0, i64 0))
  br label %18

18:                                               ; preds = %16, %11
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1171, i32 28, i8* null) #5
  br label %42
...
24:                                               ; preds = %19
  ...
  %26 = call i8* @hypre_CAlloc(i64 %25, i64 8) #5
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1200, i32 12, i8* null) #5
  br label %28
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1231, i32 12, i8* null) #5
  br label %42
...
16:                                               ; preds = %11
  %17 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], [47 x i8]* @str.7, i64 0, i64 0))
  br label %18

18:                                               ; preds = %16, %11
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1240, i32 28, i8* null) #5
  br label %42
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1267, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1272, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1292, i32 12, i8* null) #5
  br label %16
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1297, i32 20, i8* null) #5
  br label %16
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1318, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1323, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1343, i32 12, i8* null) #5
  br label %11
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1348, i32 20, i8* null) #5
  br label %11
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1368, i32 12, i8* null) #5
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1388, i32 12, i8* null) #5
  br label %13
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1408, i32 12, i8* null) #5
  br label %9
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1428, i32 12, i8* null) #5
  br label %9
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1448, i32 12, i8* null) #5
  br label %9
...
6:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1470, i32 12, i8* null) #5
  br label %7
...
15:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1561, i32 12, i8* null) #5
  br label %468
...
125:                                              ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1611, i32 28, i8* null) #5
  br label %468
...
131:                                              ; preds = %126
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1617, i32 20, i8* null) #5
  br label %468
...
134:                                              ; preds = %132
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1622, i32 36, i8* null) #5
  br label %468
...
153:                                              ; preds = %152
  %154 = call i32 @hypre_BoomerAMGDestroy(i8* nonnull %144) #5
...
158:                                              ; preds = %156
  %159 = call %struct.hypre_PCGFunctions* @hypre_PCGFunctionsCreate(i8* (i64, i64)* nonnull @hypre_CAlloc, i32 (i8*)* nonnull @hypre_ParKrylovFree, i32 (i8*, i32*, i32*)* nonnull @hypre_ParKrylovCommInfo, i8* (i8*)* nonnull @hypre_ParKrylovCreateVector, i32 (i8*)* nonnull @hypre_ParKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_ParKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_ParKrylovMatvec, i32 (i8*)* nonnull @hypre_ParKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_ParKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_ParKrylovCopyVector, i32 (i8*)* nonnull @hypre_ParKrylovClearVector, i32 (double, i8*)* nonnull @hypre_ParKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_ParKrylovAxpy, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentity) #5
  %160 = call i8* @hypre_PCGCreate(%struct.hypre_PCGFunctions* %159) #5
  %161 = call i32 @hypre_PCGSetMaxIter(i8* %160, i32 %27) #5
  %162 = call i32 @hypre_PCGSetTol(i8* %160, double %18) #5
  %163 = call i32 @hypre_PCGSetAbsoluteTol(i8* %160, double %21) #5
  %164 = call i32 @hypre_PCGSetTwoNorm(i8* %160, i32 %33) #5
  %165 = call i32 @hypre_PCGSetStopCrit(i8* %160, i32 %36) #5
  %166 = call i32 @hypre_PCGSetRelChange(i8* %160, i32 %39) #5
  %167 = call i32 @hypre_PCGSetLogging(i8* %160, i32 %42) #5
  %168 = call i32 @hypre_PCGSetPrintLevel(i8* %160, i32 %138) #5
  br label %169

169:                                              ; preds = %158, %156
  %170 = phi i8* [ %160, %158 ], [ %141, %156 ]
  %171 = call i32 @hypre_PCGSetConvergenceFactorTol(i8* %170, double %24) #5
  %172 = call i32 @hypre_PCGSetPrecond(i8* %170, i32 (...)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScale to i32 (...)*), i32 (...)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScaleSetup to i32 (...)*), i8* null) #5
  ...
  %176 = call i32 @hypre_PCGSetup(i8* %170, i8* nonnull %173, i8* nonnull %174, i8* nonnull %175) #5
  store i8* %170, i8** %140, align 8, !tbaa !42
  %177 = call i32 @hypre_PCGSolve(i8* %170, i8* nonnull %173, i8* nonnull %174, i8* nonnull %175) #5
  %178 = call i32 @hypre_PCGGetNumIterations(i8* %170, i32* nonnull %5) #5
  %179 = load i32, i32* %5, align 4, !tbaa !53
  store i32 %179, i32* %146, align 8, !tbaa !65
  %180 = call i32 @hypre_PCGGetFinalRelativeResidualNorm(i8* %170, double* nonnull %8) #5
  %181 = call i32 @hypre_PCGGetConverged(i8* %170, i32* nonnull %7) #5
  br label %232
...
184:                                              ; preds = %182
  %185 = call %struct.hypre_GMRESFunctions* @hypre_GMRESFunctionsCreate(i8* (i64, i64)* nonnull @hypre_CAlloc, i32 (i8*)* nonnull @hypre_ParKrylovFree, i32 (i8*, i32*, i32*)* nonnull @hypre_ParKrylovCommInfo, i8* (i8*)* nonnull @hypre_ParKrylovCreateVector, i8* (i32, i8*)* nonnull @hypre_ParKrylovCreateVectorArray, i32 (i8*)* nonnull @hypre_ParKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_ParKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_ParKrylovMatvec, i32 (i8*)* nonnull @hypre_ParKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_ParKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_ParKrylovCopyVector, i32 (i8*)* nonnull @hypre_ParKrylovClearVector, i32 (double, i8*)* nonnull @hypre_ParKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_ParKrylovAxpy, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentity) #5
  %186 = call i8* @hypre_GMRESCreate(%struct.hypre_GMRESFunctions* %185) #5
  %187 = call i32 @hypre_GMRESSetMaxIter(i8* %186, i32 %27) #5
  %188 = call i32 @hypre_GMRESSetTol(i8* %186, double %18) #5
  %189 = call i32 @hypre_GMRESSetAbsoluteTol(i8* %186, double %21) #5
  %190 = call i32 @hypre_GMRESSetKDim(i8* %186, i32 %54) #5
  %191 = call i32 @hypre_GMRESSetStopCrit(i8* %186, i32 %36) #5
  %192 = call i32 @hypre_GMRESSetRelChange(i8* %186, i32 %39) #5
  %193 = call i32 @hypre_GMRESSetLogging(i8* %186, i32 %42) #5
  %194 = call i32 @hypre_GMRESSetPrintLevel(i8* %186, i32 %138) #5
  br label %195

195:                                              ; preds = %184, %182
  %196 = phi i8* [ %186, %184 ], [ %141, %182 ]
  %197 = call i32 @hypre_GMRESSetConvergenceFactorTol(i8* %196, double %24) #5
  %198 = call i32 @hypre_GMRESSetPrecond(i8* %196, i32 (...)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScale to i32 (...)*), i32 (...)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScaleSetup to i32 (...)*), i8* null) #5
  ...
  %202 = call i32 @hypre_GMRESSetup(i8* %196, i8* nonnull %199, i8* nonnull %200, i8* nonnull %201) #5
  store i8* %196, i8** %140, align 8, !tbaa !42
  %203 = call i32 @hypre_GMRESSolve(i8* %196, i8* nonnull %199, i8* nonnull %200, i8* nonnull %201) #5
  %204 = call i32 @hypre_GMRESGetNumIterations(i8* %196, i32* nonnull %5) #5
  %205 = load i32, i32* %5, align 4, !tbaa !53
  store i32 %205, i32* %146, align 8, !tbaa !65
  %206 = call i32 @hypre_GMRESGetFinalRelativeResidualNorm(i8* %196, double* nonnull %8) #5
  %207 = call i32 @hypre_GMRESGetConverged(i8* %196, i32* nonnull %7) #5
  br label %232
...
210:                                              ; preds = %208
  %211 = call %struct.hypre_BiCGSTABFunctions* @hypre_BiCGSTABFunctionsCreate(i8* (i8*)* nonnull @hypre_ParKrylovCreateVector, i32 (i8*)* nonnull @hypre_ParKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_ParKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_ParKrylovMatvec, i32 (i8*)* nonnull @hypre_ParKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_ParKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_ParKrylovCopyVector, i32 (i8*)* nonnull @hypre_ParKrylovClearVector, i32 (double, i8*)* nonnull @hypre_ParKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_ParKrylovAxpy, i32 (i8*, i32*, i32*)* nonnull @hypre_ParKrylovCommInfo, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentity) #5
  %212 = call i8* @hypre_BiCGSTABCreate(%struct.hypre_BiCGSTABFunctions* %211) #5
  %213 = call i32 @hypre_BiCGSTABSetMaxIter(i8* %212, i32 %27) #5
  %214 = call i32 @hypre_BiCGSTABSetTol(i8* %212, double %18) #5
  %215 = call i32 @hypre_BiCGSTABSetAbsoluteTol(i8* %212, double %21) #5
  %216 = call i32 @hypre_BiCGSTABSetStopCrit(i8* %212, i32 %36) #5
  %217 = call i32 @hypre_BiCGSTABSetLogging(i8* %212, i32 %42) #5
  %218 = call i32 @hypre_BiCGSTABSetPrintLevel(i8* %212, i32 %138) #5
  br label %219

219:                                              ; preds = %210, %208
  %220 = phi i8* [ %212, %210 ], [ %141, %208 ]
  %221 = call i32 @hypre_BiCGSTABSetConvergenceFactorTol(i8* %220, double %24) #5
  %222 = call i32 @hypre_BiCGSTABSetPrecond(i8* %220, i32 (...)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScale to i32 (...)*), i32 (...)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScaleSetup to i32 (...)*), i8* null) #5
  ...
  %226 = call i32 @hypre_BiCGSTABSetup(i8* %220, i8* nonnull %223, i8* nonnull %224, i8* nonnull %225) #5
  store i8* %220, i8** %140, align 8, !tbaa !42
  %227 = call i32 @hypre_BiCGSTABSolve(i8* %220, i8* nonnull %223, i8* nonnull %224, i8* nonnull %225) #5
  %228 = call i32 @hypre_BiCGSTABGetNumIterations(i8* %220, i32* nonnull %5) #5
  %229 = load i32, i32* %5, align 4, !tbaa !53
  store i32 %229, i32* %146, align 8, !tbaa !65
  %230 = call i32 @hypre_BiCGSTABGetFinalRelativeResidualNorm(i8* %220, double* nonnull %8) #5
  %231 = call i32 @hypre_BiCGSTABGetConverged(i8* %220, i32* nonnull %7) #5
  br label %232
...
244:                                              ; preds = %242
  %245 = call i32 @hypre_PCGSetMaxIter(i8* %233, i32 %30) #5
  %246 = call i32 @hypre_PCGSetConvergenceFactorTol(i8* %233, double 0.000000e+00) #5
  br label %254
...
248:                                              ; preds = %247
  %249 = call i32 @hypre_GMRESSetMaxIter(i8* %233, i32 %30) #5
  %250 = call i32 @hypre_GMRESSetConvergenceFactorTol(i8* %233, double 0.000000e+00) #5
  br label %254

251:                                              ; preds = %247
  %252 = call i32 @hypre_BiCGSTABSetMaxIter(i8* %233, i32 %30) #5
  %253 = call i32 @hypre_BiCGSTABSetConvergenceFactorTol(i8* %233, double 0.000000e+00) #5
  br label %254
...
257:                                              ; preds = %254
  %258 = call i8* @hypre_BoomerAMGCreate() #5
  %259 = call i32 @hypre_BoomerAMGSetMaxIter(i8* %258, i32 1) #5
  %260 = call i32 @hypre_BoomerAMGSetTol(i8* %258, double 0.000000e+00) #5
  %261 = call i32 @hypre_BoomerAMGSetCoarsenType(i8* %258, i32 %75) #5
  %262 = call i32 @hypre_BoomerAMGSetInterpType(i8* %258, i32 %78) #5
  %263 = call i32 @hypre_BoomerAMGSetSetupType(i8* %258, i32 %48) #5
  %264 = call i32 @hypre_BoomerAMGSetMeasureType(i8* %258, i32 %72) #5
  %265 = call i32 @hypre_BoomerAMGSetStrongThreshold(i8* %258, double %57) #5
  %266 = call i32 @hypre_BoomerAMGSetTruncFactor(i8* %258, double %63) #5
  %267 = call i32 @hypre_BoomerAMGSetPMaxElmts(i8* %258, i32 %66) #5
  %268 = call i32 @hypre_BoomerAMGSetCycleType(i8* %258, i32 %81) #5
  %269 = call i32 @hypre_BoomerAMGSetPrintLevel(i8* %258, i32 %136) #5
  %270 = call i32 @hypre_BoomerAMGSetMaxLevels(i8* %258, i32 %69) #5
  %271 = call i32 @hypre_BoomerAMGSetMaxRowSum(i8* %258, double %60) #5
  %272 = call i32 @hypre_BoomerAMGSetMaxCoarseSize(i8* %258, i32 %111) #5
  %273 = call i32 @hypre_BoomerAMGSetMinCoarseSize(i8* %258, i32 %114) #5
  %274 = call i32 @hypre_BoomerAMGSetSeqThreshold(i8* %258, i32 %117) #5
  %275 = call i32 @hypre_BoomerAMGSetAggNumLevels(i8* %258, i32 %87) #5
  %276 = call i32 @hypre_BoomerAMGSetNumPaths(i8* %258, i32 %84) #5
  %277 = call i32 @hypre_BoomerAMGSetNumFunctions(i8* %258, i32 %90) #5
  %278 = call i32 @hypre_BoomerAMGSetNodal(i8* %258, i32 %93) #5
  %279 = icmp eq i32* %99, null
  br i1 %279, label %304, label %280

280:                                              ; preds = %257
  %281 = call i8* @hypre_CAlloc(i64 4, i64 4) #5
  %282 = bitcast i8* %281 to i32*
  br label %283

283:                                              ; preds = %280, %283
  %284 = phi i64 [ 0, %280 ], [ %288, %283 ]
  %285 = getelementptr inbounds i32, i32* %99, i64 %284
  %286 = load i32, i32* %285, align 4, !tbaa !53
  %287 = getelementptr inbounds i32, i32* %282, i64 %284
  store i32 %286, i32* %287, align 4, !tbaa !53
  %288 = add nuw nsw i64 %284, 1
  %289 = icmp eq i64 %288, 4
  br i1 %289, label %290, label %283, !llvm.loop !72

290:                                              ; preds = %283
  br i1 %243, label %291, label %302

291:                                              ; preds = %290
  %292 = getelementptr inbounds i32, i32* %99, i64 1
  %293 = load i32, i32* %292, align 4, !tbaa !53
  %294 = icmp eq i32 %293, 3
  br i1 %294, label %295, label %302

295:                                              ; preds = %291
  %296 = getelementptr inbounds i32, i32* %99, i64 2
  %297 = load i32, i32* %296, align 4, !tbaa !53
  %298 = icmp eq i32 %297, 3
  br i1 %298, label %299, label %302

299:                                              ; preds = %295
  %300 = getelementptr inbounds i8, i8* %281, i64 8
  %301 = bitcast i8* %300 to i32*
  store i32 4, i32* %301, align 4, !tbaa !53
  br label %302

302:                                              ; preds = %299, %295, %291, %290
  %303 = call i32 @hypre_BoomerAMGSetGridRelaxType(i8* %258, i32* %282) #5
  br label %304

304:                                              ; preds = %302, %257
  %305 = icmp eq double* %105, null
  br i1 %305, label %322, label %306

306:                                              ; preds = %304
  %307 = sext i32 %69 to i64
  %308 = call i8* @hypre_CAlloc(i64 %307, i64 8) #5
  %309 = bitcast i8* %308 to double*
  %310 = icmp sgt i32 %69, 0
...
313:                                              ; preds = %311, %313
  ...
  %315 = getelementptr inbounds double, double* %105, i64 %314
  %316 = load double, double* %315, align 8, !tbaa !60
  %317 = getelementptr inbounds double, double* %309, i64 %314
  store double %316, double* %317, align 8, !tbaa !60
  %318 = add nuw nsw i64 %314, 1
  %319 = icmp eq i64 %318, %312
  br i1 %319, label %320, label %313, !llvm.loop !73

320:                                              ; preds = %313, %306
  %321 = call i32 @hypre_BoomerAMGSetRelaxWeight(i8* %258, double* %309) #5
  br label %322

322:                                              ; preds = %320, %304
  %323 = icmp eq double* %108, null
  br i1 %323, label %340, label %324

324:                                              ; preds = %322
  %325 = sext i32 %69 to i64
  %326 = call i8* @hypre_CAlloc(i64 %325, i64 8) #5
  %327 = bitcast i8* %326 to double*
  %328 = icmp sgt i32 %69, 0
  br i1 %328, label %329, label %338

329:                                              ; preds = %324
  %330 = zext i32 %69 to i64
  br label %331

331:                                              ; preds = %329, %331
  %332 = phi i64 [ 0, %329 ], [ %336, %331 ]
  %333 = getelementptr inbounds double, double* %108, i64 %332
  %334 = load double, double* %333, align 8, !tbaa !60
  %335 = getelementptr inbounds double, double* %327, i64 %332
  store double %334, double* %335, align 8, !tbaa !60
  %336 = add nuw nsw i64 %332, 1
  %337 = icmp eq i64 %336, %330
  br i1 %337, label %338, label %331, !llvm.loop !74

338:                                              ; preds = %331, %324
  %339 = call i32 @hypre_BoomerAMGSetOmega(i8* %258, double* %327) #5
  br label %340

340:                                              ; preds = %338, %322
  %341 = icmp eq i32* %96, null
  br i1 %341, label %386, label %342

342:                                              ; preds = %340
  %343 = call i8* @hypre_CAlloc(i64 4, i64 4) #5
  %344 = bitcast i8* %343 to i32*
  br label %345

345:                                              ; preds = %342, %345
  %346 = phi i64 [ 0, %342 ], [ %350, %345 ]
  %347 = getelementptr inbounds i32, i32* %96, i64 %346
  %348 = load i32, i32* %347, align 4, !tbaa !53
  %349 = getelementptr inbounds i32, i32* %344, i64 %346
  store i32 %348, i32* %349, align 4, !tbaa !53
  %350 = add nuw nsw i64 %346, 1
  %351 = icmp eq i64 %350, 4
  br i1 %351, label %352, label %345, !llvm.loop !75

352:                                              ; preds = %345
  %353 = call i32 @hypre_BoomerAMGSetNumGridSweeps(i8* %258, i32* %344) #5
  %354 = icmp eq i32** %102, null
  br i1 %354, label %386, label %355

355:                                              ; preds = %352
  %356 = call i8* @hypre_CAlloc(i64 4, i64 8) #5
  %357 = bitcast i8* %356 to i32**
  br label %358

358:                                              ; preds = %355, %381
  %359 = phi i64 [ 0, %355 ], [ %382, %381 ]
  %360 = getelementptr inbounds i32, i32* %96, i64 %359
  %361 = load i32, i32* %360, align 4, !tbaa !53
  %362 = sext i32 %361 to i64
  %363 = call i8* @hypre_CAlloc(i64 %362, i64 4) #5
  %364 = getelementptr inbounds i32*, i32** %357, i64 %359
  %365 = bitcast i32** %364 to i8**
  store i8* %363, i8** %365, align 8, !tbaa !47
  %366 = load i32, i32* %360, align 4, !tbaa !53
  %367 = icmp sgt i32 %366, 0
  br i1 %367, label %368, label %381

368:                                              ; preds = %358
  %369 = getelementptr inbounds i32*, i32** %102, i64 %359
  %370 = load i32*, i32** %369, align 8, !tbaa !47
  %371 = load i32*, i32** %364, align 8, !tbaa !47
  br label %372

372:                                              ; preds = %368, %372
  %373 = phi i64 [ 0, %368 ], [ %377, %372 ]
  %374 = getelementptr inbounds i32, i32* %370, i64 %373
  %375 = load i32, i32* %374, align 4, !tbaa !53
  %376 = getelementptr inbounds i32, i32* %371, i64 %373
  store i32 %375, i32* %376, align 4, !tbaa !53
  %377 = add nuw nsw i64 %373, 1
  %378 = load i32, i32* %360, align 4, !tbaa !53
  %379 = sext i32 %378 to i64
  %380 = icmp slt i64 %377, %379
  br i1 %380, label %372, label %381, !llvm.loop !76

381:                                              ; preds = %372, %358
  %382 = add nuw nsw i64 %359, 1
  %383 = icmp eq i64 %382, 4
  br i1 %383, label %384, label %358, !llvm.loop !77

384:                                              ; preds = %381
  %385 = call i32 @hypre_BoomerAMGSetGridRelaxPoints(i8* %258, i32** %357) #5
  br label %386

386:                                              ; preds = %352, %384, %340
  %387 = icmp eq i32* %120, null
  br i1 %387, label %404, label %388

388:                                              ; preds = %386
  %389 = sext i32 %129 to i64
  %390 = call i8* @hypre_CAlloc(i64 %389, i64 4) #5
  %391 = bitcast i8* %390 to i32*
  %392 = icmp sgt i32 %129, 0
  br i1 %392, label %393, label %402

393:                                              ; preds = %388
  %394 = zext i32 %129 to i64
  br label %395

395:                                              ; preds = %393, %395
  %396 = phi i64 [ 0, %393 ], [ %400, %395 ]
  %397 = getelementptr inbounds i32, i32* %120, i64 %396
  %398 = load i32, i32* %397, align 4, !tbaa !53
  %399 = getelementptr inbounds i32, i32* %391, i64 %396
  store i32 %398, i32* %399, align 4, !tbaa !53
  %400 = add nuw nsw i64 %396, 1
  %401 = icmp eq i64 %400, %394
  br i1 %401, label %402, label %395, !llvm.loop !78

402:                                              ; preds = %395, %388
  %403 = call i32 @hypre_BoomerAMGSetDofFunc(i8* %258, i32* %391) #5
  br label %404

404:                                              ; preds = %402, %386
  %405 = getelementptr inbounds i8, i8* %0, i64 64
  %406 = bitcast i8* %405 to i32 (...)**
  store i32 (...)* bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSetup to i32 (...)*), i32 (...)** %406, align 8, !tbaa !55
  %407 = getelementptr inbounds i8, i8* %0, i64 56
  %408 = bitcast i8* %407 to i32 (...)**
  store i32 (...)* bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSolve to i32 (...)*), i32 (...)** %408, align 8, !tbaa !54
  store i8* %258, i8** %143, align 8, !tbaa !43
  br label %418

409:                                              ; preds = %254
  %410 = load i8*, i8** %143, align 8, !tbaa !43
  %411 = getelementptr inbounds i8, i8* %0, i64 56
  %412 = bitcast i8* %411 to i32 (...)**
  %413 = load i32 (...)*, i32 (...)** %412, align 8, !tbaa !54
  %414 = getelementptr inbounds i8, i8* %0, i64 64
  %415 = bitcast i8* %414 to i32 (...)**
  %416 = load i32 (...)*, i32 (...)** %415, align 8, !tbaa !55
  %417 = call i32 @hypre_BoomerAMGSetSetupType(i8* %410, i32 %48) #5
  br label %418

418:                                              ; preds = %409, %404
  %419 = phi i8* [ %258, %404 ], [ %410, %409 ]
  %420 = phi i32 (...)* [ bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSetup to i32 (...)*), %404 ], [ %416, %409 ]
  %421 = phi i32 (...)* [ bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSolve to i32 (...)*), %404 ], [ %413, %409 ]
  br i1 %243, label %422, label %437

422:                                              ; preds = %418
  %423 = call i32 @hypre_PCGSetPrecond(i8* %233, i32 (...)* %421, i32 (...)* %420, i8* %419) #5
  %424 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to i8*
  %425 = bitcast %struct.hypre_ParVector_struct* %2 to i8*
  %426 = bitcast %struct.hypre_ParVector_struct* %3 to i8*
  %427 = call i32 @hypre_PCGSetup(i8* %233, i8* nonnull %424, i8* nonnull %425, i8* nonnull %426) #5
  %428 = call i32 @hypre_PCGSolve(i8* %233, i8* nonnull %424, i8* nonnull %425, i8* nonnull %426) #5
  %429 = call i32 @hypre_PCGGetNumIterations(i8* %233, i32* nonnull %6) #5
  %430 = load i32, i32* %6, align 4, !tbaa !53
  store i32 %430, i32* %148, align 4, !tbaa !66
  %431 = icmp eq i32 %42, 0
  br i1 %431, label %468, label %432

432:                                              ; preds = %422
  %433 = call i32 @hypre_PCGGetFinalRelativeResidualNorm(i8* %233, double* nonnull %8) #5
  %434 = load double, double* %8, align 8, !tbaa !60
  %435 = getelementptr inbounds i8, i8* %0, i64 96
  %436 = bitcast i8* %435 to double*
  store double %434, double* %436, align 8, !tbaa !67
  br label %468

437:                                              ; preds = %418
  switch i32 %51, label %468 [
    i32 2, label %438
    i32 3, label %453
  ]

438:                                              ; preds = %437
  %439 = call i32 @hypre_GMRESSetPrecond(i8* %233, i32 (...)* %421, i32 (...)* %420, i8* %419) #5
  ...
  %443 = call i32 @hypre_GMRESSetup(i8* %233, i8* nonnull %440, i8* nonnull %441, i8* nonnull %442) #5
  %444 = call i32 @hypre_GMRESSolve(i8* %233, i8* nonnull %440, i8* nonnull %441, i8* nonnull %442) #5
  %445 = call i32 @hypre_GMRESGetNumIterations(i8* %233, i32* nonnull %6) #5
  %446 = load i32, i32* %6, align 4, !tbaa !53
  store i32 %446, i32* %148, align 4, !tbaa !66
  %447 = icmp eq i32 %42, 0
  br i1 %447, label %468, label %448

448:                                              ; preds = %438
  %449 = call i32 @hypre_GMRESGetFinalRelativeResidualNorm(i8* %233, double* nonnull %8) #5
  %450 = load double, double* %8, align 8, !tbaa !60
  %451 = getelementptr inbounds i8, i8* %0, i64 96
  %452 = bitcast i8* %451 to double*
  store double %450, double* %452, align 8, !tbaa !67
  br label %468

453:                                              ; preds = %437
  %454 = call i32 @hypre_BiCGSTABSetPrecond(i8* %233, i32 (...)* %421, i32 (...)* %420, i8* %419) #5
  %455 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to i8*
  %456 = bitcast %struct.hypre_ParVector_struct* %2 to i8*
  %457 = bitcast %struct.hypre_ParVector_struct* %3 to i8*
  %458 = call i32 @hypre_BiCGSTABSetup(i8* %233, i8* nonnull %455, i8* nonnull %456, i8* nonnull %457) #5
  %459 = call i32 @hypre_BiCGSTABSolve(i8* %233, i8* nonnull %455, i8* nonnull %456, i8* nonnull %457) #5
  %460 = call i32 @hypre_BiCGSTABGetNumIterations(i8* %233, i32* nonnull %6) #5
  %461 = load i32, i32* %6, align 4, !tbaa !53
  store i32 %461, i32* %148, align 4, !tbaa !66
  %462 = icmp eq i32 %42, 0
  br i1 %462, label %468, label %463

463:                                              ; preds = %453
  %464 = call i32 @hypre_BiCGSTABGetFinalRelativeResidualNorm(i8* %233, double* nonnull %8) #5
  %465 = load double, double* %8, align 8, !tbaa !60
  %466 = getelementptr inbounds i8, i8* %0, i64 96
  %467 = bitcast i8* %466 to double*
  store double %465, double* %467, align 8, !tbaa !67
  br label %468

468:                                              ; preds = %238, %236, %448, %438, %453, %463, %422, %432, %437, %134, %131, %125, %15
  %469 = load i32, i32* @hypre__global_error, align 4, !tbaa !53

...
480:                                              ; preds = %470
  ...
  invoke void @_ZN10MLI_VectorC1EPvPcP19MLI_Function_Struct(%class.MLI_Vector* nonnull align 8 dereferenceable(120) %482, i8* %245, i8* nonnull %9, %struct.MLI_Function_Struct* null)
...
483:                                              ; preds = %480
  ...
  invoke void @_ZN10MLI_VectorC1EPvPcP19MLI_Function_Struct(%class.MLI_Vector* nonnull align 8 dereferenceable(120) %485, i8* %246, i8* nonnull %9, %struct.MLI_Function_Struct* null)

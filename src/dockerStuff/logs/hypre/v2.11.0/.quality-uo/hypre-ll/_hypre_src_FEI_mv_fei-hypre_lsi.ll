...
47:                                               ; preds = %45, %40
  %48 = call i32 (i8*, i8*, i8*, i8*, ...) %7(i8* %10, i8* %1, i8* %2, i8* %3) #9
  ret i32 %48
}
...
71:                                               ; preds = %69, %4
  ...
  %78 = bitcast i32 (...)* %38 to i32 (i32*, i8*, i8*, i8*, ...)*
  %79 = getelementptr inbounds [2 x double], [2 x double]* %7, i64 0, i64 0
  %80 = bitcast i32 (...)* %38 to i32 (i32*, i8*, i8*, i8*, ...)*
  %81 = getelementptr inbounds [2 x double], [2 x double]* %7, i64 0, i64 1
  %82 = getelementptr inbounds [2 x double], [2 x double]* %8, i64 0, i64 0
  %83 = getelementptr inbounds [2 x double], [2 x double]* %8, i64 0, i64 1
  br label %84

84:                                               ; preds = %71, %148
  %85 = phi i32 [ 0, %71 ], [ %137, %148 ]
  %86 = phi i32 [ 0, %71 ], [ %151, %148 ]
  %87 = phi double [ undef, %71 ], [ %136, %148 ]
  %88 = phi double [ undef, %71 ], [ %135, %148 ]
  %89 = phi double [ %57, %71 ], [ %142, %148 ]
  %90 = fcmp ogt double %89, %76
  %91 = icmp slt i32 %85, %14
  %92 = select i1 %90, i1 %91, i1 false
  br i1 %92, label %93, label %134

93:                                               ; preds = %84, %130
  %94 = phi i32 [ %97, %130 ], [ %85, %84 ]
  %95 = phi double [ %106, %130 ], [ %87, %84 ]
  %96 = phi double [ %123, %130 ], [ %88, %84 ]
  %97 = add nsw i32 %94, 1
  %98 = icmp eq i32 %94, 0
  br i1 %98, label %99, label %102

99:                                               ; preds = %93
  %100 = call i32 (i32*, i8*, i8*, i8*, ...) %78(i32* %41, i8* %1, i8* %26, i8* %32) #9
  %101 = call double @hypre_ParKrylovInnerProd(i8* %26, i8* %32) #9
  br label %104

102:                                              ; preds = %93
  %103 = fdiv double %96, %95
  br label %104

104:                                              ; preds = %102, %99
  %105 = phi double [ 0.000000e+00, %99 ], [ %103, %102 ]
  %106 = phi double [ %101, %99 ], [ %96, %102 ]
  %107 = call i32 @hypre_ParKrylovScaleVector(double %105, i8* %29) #9
  %108 = call i32 @hypre_ParKrylovAxpy(double 1.000000e+00, i8* %32, i8* %29) #9
  %109 = call i32 @hypre_ParKrylovMatvec(i8* %23, double 1.000000e+00, i8* %1, i8* %29, double 0.000000e+00, i8* %35) #9
  %110 = call double @hypre_ParKrylovInnerProd(i8* %29, i8* %35) #9
  %111 = fdiv double %106, %110
  %112 = fcmp oeq double %110, 0.000000e+00
  br i1 %112, label %113, label %115

113:                                              ; preds = %104
  %114 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @str, i64 0, i64 0))
  br label %165

115:                                              ; preds = %104
  %116 = call i32 @hypre_ParKrylovAxpy(double %111, i8* %29, i8* %3) #9
  %117 = fneg double %111
  %118 = call i32 @hypre_ParKrylovAxpy(double %117, i8* %35, i8* %26) #9
  %119 = call double @hypre_SeqVectorInnerProd(%struct.hypre_Vector* %47, %struct.hypre_Vector* %47) #9
  store double %119, double* %79, align 16, !tbaa !26
  %120 = call i32 (i32*, i8*, i8*, i8*, ...) %80(i32* %41, i8* %1, i8* %26, i8* %32) #9
  %121 = call double @hypre_SeqVectorInnerProd(%struct.hypre_Vector* %47, %struct.hypre_Vector* %50) #9
  store double %121, double* %81, align 8, !tbaa !26
  %122 = call i32 @MPI_Allreduce(i8* nonnull %11, i8* nonnull %12, i32 2, i32 1275070475, i32 1476395011, i32 %52) #9
  %123 = load double, double* %83, align 8, !tbaa !26
  %124 = load double, double* %82, align 16, !tbaa !26
...
128:                                              ; preds = %115
  %129 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([48 x i8], [48 x i8]* @.str.4, i64 0, i64 0), i32 %97, double %125, double %76)
  br label %130

130:                                              ; preds = %128, %115
  %131 = fcmp ogt double %125, %76
  %132 = icmp slt i32 %97, %14
  %133 = select i1 %131, i1 %132, i1 false
  br i1 %133, label %93, label %134, !llvm.loop !27

134:                                              ; preds = %130, %84
  %135 = phi double [ %88, %84 ], [ %123, %130 ]
  %136 = phi double [ %87, %84 ], [ %106, %130 ]
  %137 = phi i32 [ %85, %84 ], [ %97, %130 ]
  %138 = phi i1 [ %91, %84 ], [ %132, %130 ]
  %139 = call i32 @hypre_ParKrylovCopyVector(i8* %2, i8* %26) #9
  %140 = call i32 @hypre_ParKrylovMatvec(i8* %23, double -1.000000e+00, i8* %1, i8* %3, double 1.000000e+00, i8* %26) #9
  %141 = call double @hypre_ParKrylovInnerProd(i8* %26, i8* %26) #9
  %142 = call double @sqrt(double %141) #9
  %143 = load i32, i32* %5, align 4
  %144 = icmp eq i32 %143, 0
  %145 = select i1 %60, i1 %144, i1 false
  br i1 %145, label %146, label %148

146:                                              ; preds = %134
  %147 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5, i64 0, i64 0), double %142)
  br label %148

148:                                              ; preds = %146, %134
  %149 = fcmp uge double %142, %76
  %150 = select i1 %149, i1 %138, i1 false
  %151 = select i1 %150, i32 %86, i32 1
  %152 = icmp eq i32 %151, 0
  br i1 %152, label %84, label %153, !llvm.loop !30

153:                                              ; preds = %148
  %154 = icmp sge i32 %137, %14
  %155 = zext i1 %154 to i32
  %156 = getelementptr inbounds i8, i8* %0, i64 16
  %157 = bitcast i8* %156 to double*
  store double %142, double* %157, align 8, !tbaa !31
  %158 = getelementptr inbounds i8, i8* %0, i64 96
  %159 = bitcast i8* %158 to i32*
  store i32 %137, i32* %159, align 8, !tbaa !32
  %160 = load i32, i32* %5, align 4
  %161 = icmp eq i32 %160, 0
  %162 = select i1 %60, i1 %161, i1 false
  br i1 %162, label %163, label %165

163:                                              ; preds = %153
  %164 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @.str.6, i64 0, i64 0), i32 %137)
  br label %165

165:                                              ; preds = %153, %163, %113
  %166 = phi i32 [ 2, %113 ], [ %155, %163 ], [ %155, %153 ]
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_LSICGSetPrecond(i8* nocapture %0, i32 (...)* %1, i32 (...)* %2, i8* %3) local_unnamed_addr #5 {

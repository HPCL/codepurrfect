...
define dso_local i32 @hypre_dsygv(i32* %0, i8* %1, i8* %2, i32* %3, double* %4, i32* %5, double* %6, i32* %7, double* %8, double* %9, i32* %10, i32* %11) local_unnamed_addr #0 {
  ...
  %15 = call i64 @hypre_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  store i64 %15, i64* @hypre_dsygv.wantz, align 8, !tbaa !3
  %16 = call i64 @hypre_lsame(i8* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
...
26:                                               ; preds = %23
  %27 = call i64 @hypre_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #3
  %28 = icmp eq i64 %27, 0
...
32:                                               ; preds = %29
  %33 = call i64 @hypre_lsame(i8* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #3
  %34 = icmp eq i64 %33, 0
...
70:                                               ; preds = %67
  ...
  %72 = call i32 @hypre_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0), i32* nonnull %13) #3
  br label %112

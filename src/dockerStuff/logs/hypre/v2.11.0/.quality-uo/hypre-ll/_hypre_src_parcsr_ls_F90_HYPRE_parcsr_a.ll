...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_boomeramgsetscommpkgswitc_(i32** nocapture readonly %0, double* nocapture readonly %1, i32* nocapture %2) local_unnamed_addr #0 {
  %4 = bitcast i32** %0 to %struct.hypre_Solver_struct**
  %5 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %4, align 8, !tbaa !7
  %6 = load double, double* %1, align 8, !tbaa !9
  %7 = call i32 @HYPRE_BoomerAMGSetSCommPkgSwitch(%struct.hypre_Solver_struct* %5, double %6) #2
  store i32 %7, i32* %2, align 4, !tbaa !3
  ret void
}

declare dso_local i32 @HYPRE_BoomerAMGSetSCommPkgSwitch(%struct.hypre_Solver_struct*, double) local_unnamed_addr #1
...
define dso_local void @hypre_boomeramginitgridrelaxatn_(i32** nocapture %0, i32** nocapture %1, i32** nocapture %2, i32* nocapture readonly %3, i32** nocapture %4, i32* nocapture readonly %5, i32* nocapture %6) local_unnamed_addr #0 {
  %8 = call i8* @hypre_CAlloc(i64 1, i64 8) #2
  %9 = bitcast i32** %0 to i8**
  store i8* %8, i8** %9, align 8, !tbaa !7
  %10 = call i8* @hypre_CAlloc(i64 1, i64 8) #2
  %11 = bitcast i32** %1 to i8**
  store i8* %10, i8** %11, align 8, !tbaa !7
  %12 = call i8* @hypre_CAlloc(i64 1, i64 8) #2
  %13 = bitcast i32** %2 to i8**
  store i8* %12, i8** %13, align 8, !tbaa !7
  %14 = call i8* @hypre_CAlloc(i64 1, i64 8) #2
...
define dso_local void @hypre_boomeramgfingridrelaxatn_(i32** nocapture readonly %0, i32** nocapture readonly %1, i32** nocapture readonly %2, i32** nocapture readonly %3, i32* nocapture %4) local_unnamed_addr #0 {
  ...
  call void @hypre_Free(i8* %7) #2
  call void @hypre_Free(i8* %9) #2
  call void @hypre_Free(i8* %11) #2
  call void @hypre_Free(i8* %13) #2
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_boomeramgsetaggtruncfactor_(i32** nocapture readonly %0, double* nocapture readonly %1, i32* nocapture %2) local_unnamed_addr #0 {
  %4 = bitcast i32** %0 to %struct.hypre_Solver_struct**
  %5 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %4, align 8, !tbaa !7
  %6 = load double, double* %1, align 8, !tbaa !9
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_boomeramgsetaggptruncftr_(i32** nocapture readonly %0, double* nocapture readonly %1, i32* nocapture %2) local_unnamed_addr #0 {
  %4 = bitcast i32** %0 to %struct.hypre_Solver_struct**
  %5 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %4, align 8, !tbaa !7
  %6 = load double, double* %1, align 8, !tbaa !9
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_boomeramgsetaggp12maxelmts_(i32** nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture %2) local_unnamed_addr #0 {
  %4 = bitcast i32** %0 to %struct.hypre_Solver_struct**
  %5 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %4, align 8, !tbaa !7
  %6 = load i32, i32* %1, align 4, !tbaa !3

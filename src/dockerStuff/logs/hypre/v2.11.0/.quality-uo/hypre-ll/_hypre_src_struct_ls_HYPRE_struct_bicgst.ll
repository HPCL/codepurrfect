; ModuleID = '/hypre/src/struct_ls/HYPRE_struct_bicgstab.c'
source_filename = "/hypre/src/struct_ls/HYPRE_struct_bicgstab.c"
...
define dso_local i32 @HYPRE_StructBiCGSTABCreate(i32 %0, %struct.hypre_StructSolver_struct** nocapture %1) local_unnamed_addr #0 {
  %3 = call %struct.hypre_BiCGSTABFunctions* @hypre_BiCGSTABFunctionsCreate(i8* (i8*)* nonnull @hypre_StructKrylovCreateVector, i32 (i8*)* nonnull @hypre_StructKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_StructKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_StructKrylovMatvec, i32 (i8*)* nonnull @hypre_StructKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_StructKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_StructKrylovCopyVector, i32 (i8*)* nonnull @hypre_StructKrylovClearVector, i32 (double, i8*)* nonnull @hypre_StructKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_StructKrylovAxpy, i32 (i8*, i32*, i32*)* nonnull @hypre_StructKrylovCommInfo, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_StructKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_StructKrylovIdentity) #2
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABDestroy(%struct.hypre_StructSolver_struct* %0) local_unnamed_addr #0 {
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABSetup(%struct.hypre_StructSolver_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructVector_struct* %2, %struct.hypre_StructVector_struct* %3) local_unnamed_addr #0 {
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABSolve(%struct.hypre_StructSolver_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructVector_struct* %2, %struct.hypre_StructVector_struct* %3) local_unnamed_addr #0 {
  %5 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
  %6 = bitcast %struct.hypre_StructMatrix_struct* %1 to %struct.hypre_Matrix_struct*
  %7 = bitcast %struct.hypre_StructVector_struct* %2 to %struct.hypre_Vector_struct*
  %8 = bitcast %struct.hypre_StructVector_struct* %3 to %struct.hypre_Vector_struct*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABSetTol(%struct.hypre_StructSolver_struct* %0, double %1) local_unnamed_addr #0 {
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABSetAbsoluteTol(%struct.hypre_StructSolver_struct* %0, double %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABSetMaxIter(%struct.hypre_StructSolver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABSetLogging(%struct.hypre_StructSolver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABSetPrintLevel(%struct.hypre_StructSolver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABGetNumIterations(%struct.hypre_StructSolver_struct* %0, i32* %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABGetFinalRelativeResidualNorm(%struct.hypre_StructSolver_struct* %0, double* %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_StructBiCGSTABGetResidual(%struct.hypre_StructSolver_struct* %0, i8** %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_StructSolver_struct* %0 to %struct.hypre_Solver_struct*
  %4 = call i32 @HYPRE_BiCGSTABGetResidual(%struct.hypre_Solver_struct* %3, i8** %1) #2
  ret i32 %4
}

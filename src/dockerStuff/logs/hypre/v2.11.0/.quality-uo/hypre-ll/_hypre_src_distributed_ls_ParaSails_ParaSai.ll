...
@str = private unnamed_addr constant [54 x i8] c"Hypre-ParaSails detected a problem.  The input matrix\00", align 1
@str.20 = private unnamed_addr constant [59 x i8] c"may not be full-rank, or if you are using the SPD version,\00", align 1
@str.21 = private unnamed_addr constant [47 x i8] c"the input matrix may not be positive definite.\00", align 1
@str.22 = private unnamed_addr constant [54 x i8] c"This error is being returned to the calling function.\00", align 1
@str.23 = private unnamed_addr constant [50 x i8] c"** ParaSails Setup Pattern Statistics ***********\00", align 1
@str.25 = private unnamed_addr constant [50 x i8] c"** ParaSails Setup Values Statistics ************\00", align 1
@str.27 = private unnamed_addr constant [34 x i8] c"Setup (pattern and values) times:\00", align 1
@str.28 = private unnamed_addr constant [50 x i8] c"*************************************************\00", align 1
...
define dso_local i32 @FindNumReplies(i32 %0, i32* %1) local_unnamed_addr #0 {
  ...
  %7 = call i32 @hypre_MPI_Comm_rank(i32 %0, i32* nonnull %4) #11
  %8 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %3) #11
  %9 = load i32, i32* %3, align 4, !tbaa !3
  %10 = sext i32 %9 to i64
  %11 = shl nsw i64 %10, 2
  %12 = call noalias align 16 i8* @malloc(i64 %11) #11
  %13 = bitcast i8* %12 to i32*
  %14 = bitcast i32* %1 to i8*
  %15 = call i32 @hypre_MPI_Allreduce(i8* %14, i8* %12, i32 %9, i32 1275069445, i32 1476395011, i32 %0) #11
...
define dso_local noalias %struct.ParaSails* @ParaSailsCreate(i32 %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  ...
  %8 = call noalias align 16 dereferenceable_or_null(112) i8* @malloc(i64 112) #11
  ...
  %19 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %7) #11
  %20 = load i32, i32* %7, align 4, !tbaa !3
  %21 = sext i32 %20 to i64
  %22 = shl nsw i64 %21, 2
  %23 = call noalias align 16 i8* @malloc(i64 %22) #11
  %24 = getelementptr inbounds %struct.ParaSails, %struct.ParaSails* %9, i64 0, i32 13
  %25 = bitcast i32** %24 to i8**
  store i8* %23, i8** %25, align 16, !tbaa !16
  %26 = call noalias align 16 i8* @malloc(i64 %22) #11
  %27 = getelementptr inbounds %struct.ParaSails, %struct.ParaSails* %9, i64 0, i32 14
  %28 = bitcast i32** %27 to i8**
  store i8* %26, i8** %28, align 8, !tbaa !17
  %29 = bitcast i32* %5 to i8*
  %30 = call i32 @hypre_MPI_Allgather(i8* nonnull %29, i32 1, i32 1275069445, i8* %23, i32 1, i32 1275069445, i32 %0) #11
  %31 = bitcast i32* %6 to i8*
  %32 = call i32 @hypre_MPI_Allgather(i8* nonnull %31, i32 1, i32 1275069445, i8* %26, i32 1, i32 1275069445, i32 %0) #11
...
7:                                                ; preds = %3
  call void @NumberingDestroy(%struct.numbering* nonnull %5) #11
  br label %8
...
12:                                               ; preds = %8
  call void @MatrixDestroy(%struct.Matrix* nonnull %10) #11
  br label %13
...
define dso_local void @ParaSailsSetupPattern(%struct.ParaSails* nocapture %0, %struct.Matrix* %1, double %2, i32 %3) local_unnamed_addr #0 {
  ...
  %18 = call double @hypre_MPI_Wtime() #11
...
24:                                               ; preds = %4
  call void @NumberingDestroy(%struct.numbering* nonnull %22) #11
  br label %25
...
25:                                               ; preds = %24, %4
  ...
  %28 = call %struct.numbering* @NumberingCreateCopy(%struct.numbering* %27) #11
...
32:                                               ; preds = %25
  call void @MatrixDestroy(%struct.Matrix* nonnull %30) #11
  br label %33
...
33:                                               ; preds = %32, %25
  ...
  %40 = call %struct.Matrix* @MatrixCreate(i32 %35, i32 %37, i32 %39) #11
  store %struct.Matrix* %40, %struct.Matrix** %29, align 8, !tbaa !19
  %41 = load %struct.numbering*, %struct.numbering** %26, align 8, !tbaa !20
  %42 = call %struct.DiagScale* @DiagScaleCreate(%struct.Matrix* %1, %struct.numbering* %41) #11
...
49:                                               ; preds = %45, %33
  ...
  %51 = call %struct.PrunedRows* @PrunedRowsCreate(%struct.Matrix* %1, i32 300000, %struct.DiagScale* %42, double %50) #11
  ...
  %60 = call i32 @hypre_MPI_Comm_size(i32 %52, i32* nonnull %17) #11
  ...
  %67 = call noalias align 16 i8* @malloc(i64 %66) #11
  %68 = bitcast i8* %67 to %struct.MPI_Status*
  %69 = call %struct.RowPatt* @RowPattCreate(i32 300000) #11
...
76:                                               ; preds = %49, %76
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %51, i32 %77, i32* nonnull %13, i32** nonnull %14) #11
  %78 = load i32, i32* %13, align 4, !tbaa !3
  %79 = load i32*, i32** %14, align 8, !tbaa !24
  %80 = load i32, i32* %72, align 4, !tbaa !25
  call void @RowPattMergeExt(%struct.RowPatt* %69, i32 %78, i32* %79, i32 %80) #11
...
86:                                               ; preds = %76, %49
  %87 = call noalias align 16 dereferenceable_or_null(40) i8* @malloc(i64 40) #11
...
94:                                               ; preds = %86, %157
  ...
  %98 = call %struct.Mem* (...) @MemCreate() #11
  call void @RowPattPrevLevel(%struct.RowPatt* %69, i32* nonnull %13, i32** nonnull %14) #11
  %99 = load i32, i32* %13, align 4, !tbaa !3
  %100 = load i32*, i32** %14, align 8, !tbaa !24
  call void @NumberingLocalToGlobal(%struct.numbering* %53, i32 %99, i32* %100, i32* %100) #11
  %101 = load i32, i32* %17, align 4, !tbaa !3
  %102 = sext i32 %101 to i64
  %103 = call noalias align 16 i8* @calloc(i64 %102, i64 4) #11
  %104 = bitcast i8* %103 to i32*
  %105 = load i32, i32* %13, align 4, !tbaa !3
  %106 = load i32*, i32** %14, align 8, !tbaa !24
  call fastcc void @SendRequests(i32 %52, i32 221, %struct.Matrix* %1, i32 %105, i32* %106, i32* nonnull %15, i32* %104) #11
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %89) #11
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %90) #11
  %107 = call i32 @hypre_MPI_Comm_rank(i32 %52, i32* nonnull %12) #11
  %108 = call i32 @hypre_MPI_Comm_size(i32 %52, i32* nonnull %11) #11
  %109 = load i32, i32* %11, align 4, !tbaa !3
  %110 = sext i32 %109 to i64
  %111 = shl nsw i64 %110, 2
  %112 = call noalias align 16 i8* @malloc(i64 %111) #11
  %113 = bitcast i8* %112 to i32*
  %114 = call i32 @hypre_MPI_Allreduce(i8* %103, i8* %112, i32 %109, i32 1275069445, i32 1476395011, i32 %52) #11
...
127:                                              ; preds = %143, %120
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %91) #11
  %131 = call i32 @hypre_MPI_Probe(i32 -2, i32 221, i32 %52, %struct.MPI_Status* nonnull %10) #11
  %132 = load i32, i32* %92, align 4, !tbaa !30
  %133 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %10, i32 1275069445, i32* nonnull %16) #11
...
143:                                              ; preds = %136, %127
  ...
  %148 = call i32 @hypre_MPI_Recv(i8* %146, i32 %147, i32 1275069445, i32 %132, i32 221, i32 %52, %struct.MPI_Status* nonnull %10) #11
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %91) #11
  %149 = load i32, i32* %16, align 4, !tbaa !3
  %150 = getelementptr inbounds i32, i32* %65, i64 %128
  call fastcc void @SendReplyPrunedRows(i32 %52, %struct.numbering* %53, i32 %132, i32* %145, i32 %149, %struct.PrunedRows* %51, %struct.Mem* %98, i32* %150) #11
...
153:                                              ; preds = %122, %153
  ...
  call fastcc void @ReceiveReplyPrunedRows(i32 %52, %struct.numbering* %53, %struct.PrunedRows* %51, %struct.RowPatt* %69) #11
  %155 = add nuw nsw i32 %154, 1
  %156 = icmp eq i32 %155, %125
  br i1 %156, label %157, label %153, !llvm.loop !33

157:                                              ; preds = %153, %122
  %158 = call i32 @hypre_MPI_Waitall(i32 %118, i32* %65, %struct.MPI_Status* %68) #11
  call void @MemDestroy(%struct.Mem* %98) #11
...
161:                                              ; preds = %157, %86
  ...
  call void @RowPattDestroy(%struct.RowPatt* %69) #11
  ...
  %177 = call i32 @hypre_MPI_Comm_size(i32 %176, i32* nonnull %9) #11
  store double 0.000000e+00, double* %169, align 8, !tbaa !36
  %178 = call %struct.RowPatt* @RowPattCreate(i32 300000) #11
...
187:                                              ; preds = %161, %240
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %51, i32 %189, i32* nonnull %5, i32** nonnull %6) #11
  %190 = load i32, i32* %5, align 4, !tbaa !3
  %191 = load i32*, i32** %6, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %178, i32 %190, i32* %191) #11
  br i1 %181, label %210, label %192

192:                                              ; preds = %187, %207
  %193 = phi i32 [ %208, %207 ], [ 1, %187 ]
  call void @RowPattPrevLevel(%struct.RowPatt* %178, i32* nonnull %7, i32** nonnull %8) #11
...
196:                                              ; preds = %192, %196
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %51, i32 %200, i32* nonnull %5, i32** nonnull %6) #11
  %201 = load i32, i32* %5, align 4, !tbaa !3
  %202 = load i32*, i32** %6, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %178, i32 %201, i32* %202) #11
...
210:                                              ; preds = %207, %187
  call void @RowPattGet(%struct.RowPatt* %178, i32* nonnull %5, i32** nonnull %6) #11
  call void @RowPattReset(%struct.RowPatt* %178) #11
...
240:                                              ; preds = %238, %210
  ...
  call void @MatrixSetRow(%struct.Matrix* %168, i32 %242, i32 %243, i32* %244, double* null) #11
...
257:                                              ; preds = %240, %161
  call void @RowPattDestroy(%struct.RowPatt* %178) #11
  ...
  call void @DiagScaleDestroy(%struct.DiagScale* %42) #11
  call void @PrunedRowsDestroy(%struct.PrunedRows* %51) #11
  %258 = call double @hypre_MPI_Wtime() #11
...
define internal fastcc double @SelectThresh(i32 %0, %struct.Matrix* %1, %struct.DiagScale* %2, double %3) unnamed_addr #0 {
  ...
  %17 = call noalias align 16 dereferenceable_or_null(80) i8* @malloc(i64 80) #11
...
24:                                               ; preds = %4, %67
  ...
  call void @MatrixGetRow(%struct.Matrix* %1, i32 %27, i32* nonnull %5, i32** nonnull %6, double** nonnull %8) #11
...
30:                                               ; preds = %24
  ...
  %34 = shl nsw i64 %33, 3
  %35 = call noalias align 16 i8* @malloc(i64 %34) #11
...
37:                                               ; preds = %30, %24
  ...
  %40 = call double @DiagScaleGet(%struct.DiagScale* %2, i32 %27) #11
...
43:                                               ; preds = %37, %43
  ...
  %55 = call double @DiagScaleGet(%struct.DiagScale* %2, i32 %54) #11
...
67:                                               ; preds = %43, %37
  ...
  %72 = add nsw i32 %71, 1
  %73 = add nsw i32 %68, -1
  %74 = call double @randomized_select(double* %38, i32 0, i32 %73, i32 %72) #11
...
82:                                               ; preds = %67, %4
  ...
  %84 = call i32 @hypre_MPI_Allreduce(i8* nonnull %15, i8* nonnull %16, i32 1, i32 1275070475, i32 1476395011, i32 %0) #11
  %85 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %7) #11
...
define dso_local void @ParaSailsSetupPatternExt(%struct.ParaSails* nocapture %0, %struct.Matrix* %1, double %2, double %3, i32 %4) local_unnamed_addr #0 {
  ...
  %29 = call double @hypre_MPI_Wtime() #11
...
37:                                               ; preds = %5
  call void @NumberingDestroy(%struct.numbering* nonnull %35) #11
  br label %38
...
38:                                               ; preds = %37, %5
  ...
  %41 = call %struct.numbering* @NumberingCreateCopy(%struct.numbering* %40) #11
...
45:                                               ; preds = %38
  call void @MatrixDestroy(%struct.Matrix* nonnull %43) #11
  br label %46
...
46:                                               ; preds = %45, %38
  ...
  %53 = call %struct.Matrix* @MatrixCreate(i32 %48, i32 %50, i32 %52) #11
  store %struct.Matrix* %53, %struct.Matrix** %42, align 8, !tbaa !19
  %54 = load %struct.numbering*, %struct.numbering** %39, align 8, !tbaa !20
  %55 = call %struct.DiagScale* @DiagScaleCreate(%struct.Matrix* %1, %struct.numbering* %54) #11
...
62:                                               ; preds = %58, %46
  %63 = call %struct.PrunedRows* @PrunedRowsCreate(%struct.Matrix* %1, i32 300000, %struct.DiagScale* %55, double %2) #11
  %64 = call %struct.PrunedRows* @PrunedRowsCreate(%struct.Matrix* %1, i32 300000, %struct.DiagScale* %55, double %3) #11
  ...
  %73 = call i32 @hypre_MPI_Comm_size(i32 %65, i32* nonnull %28) #11
  ...
  %80 = call noalias align 16 i8* @malloc(i64 %79) #11
  %81 = bitcast i8* %80 to %struct.MPI_Status*
  %82 = call %struct.RowPatt* @RowPattCreate(i32 300000) #11
...
89:                                               ; preds = %62, %89
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %63, i32 %90, i32* nonnull %24, i32** nonnull %25) #11
  %91 = load i32, i32* %24, align 4, !tbaa !3
  %92 = load i32*, i32** %25, align 8, !tbaa !24
  %93 = load i32, i32* %85, align 4, !tbaa !25
  call void @RowPattMergeExt(%struct.RowPatt* %82, i32 %91, i32* %92, i32 %93) #11
...
99:                                               ; preds = %89, %62
  %100 = call noalias align 16 dereferenceable_or_null(40) i8* @malloc(i64 40) #11
...
107:                                              ; preds = %99, %170
  ...
  %111 = call %struct.Mem* (...) @MemCreate() #11
  call void @RowPattPrevLevel(%struct.RowPatt* %82, i32* nonnull %24, i32** nonnull %25) #11
  %112 = load i32, i32* %24, align 4, !tbaa !3
  %113 = load i32*, i32** %25, align 8, !tbaa !24
  call void @NumberingLocalToGlobal(%struct.numbering* %66, i32 %112, i32* %113, i32* %113) #11
  %114 = load i32, i32* %28, align 4, !tbaa !3
  %115 = sext i32 %114 to i64
  %116 = call noalias align 16 i8* @calloc(i64 %115, i64 4) #11
  %117 = bitcast i8* %116 to i32*
  %118 = load i32, i32* %24, align 4, !tbaa !3
  %119 = load i32*, i32** %25, align 8, !tbaa !24
  call fastcc void @SendRequests(i32 %65, i32 221, %struct.Matrix* %1, i32 %118, i32* %119, i32* nonnull %26, i32* %117) #11
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %102) #11
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %103) #11
  %120 = call i32 @hypre_MPI_Comm_rank(i32 %65, i32* nonnull %23) #11
  %121 = call i32 @hypre_MPI_Comm_size(i32 %65, i32* nonnull %22) #11
  %122 = load i32, i32* %22, align 4, !tbaa !3
  %123 = sext i32 %122 to i64
  %124 = shl nsw i64 %123, 2
  %125 = call noalias align 16 i8* @malloc(i64 %124) #11
  %126 = bitcast i8* %125 to i32*
  %127 = call i32 @hypre_MPI_Allreduce(i8* %116, i8* %125, i32 %122, i32 1275069445, i32 1476395011, i32 %65) #11
...
140:                                              ; preds = %156, %133
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %104) #11
  %144 = call i32 @hypre_MPI_Probe(i32 -2, i32 221, i32 %65, %struct.MPI_Status* nonnull %21) #11
  %145 = load i32, i32* %105, align 4, !tbaa !30
  %146 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %21, i32 1275069445, i32* nonnull %27) #11
...
149:                                              ; preds = %140
  ...
  %154 = call noalias align 16 i8* @malloc(i64 %153) #11
...
156:                                              ; preds = %149, %140
  ...
  %161 = call i32 @hypre_MPI_Recv(i8* %159, i32 %160, i32 1275069445, i32 %145, i32 221, i32 %65, %struct.MPI_Status* nonnull %21) #11
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %104) #11
  %162 = load i32, i32* %27, align 4, !tbaa !3
  %163 = getelementptr inbounds i32, i32* %78, i64 %141
  call fastcc void @SendReplyPrunedRows(i32 %65, %struct.numbering* %66, i32 %145, i32* %158, i32 %162, %struct.PrunedRows* %64, %struct.Mem* %111, i32* %163) #11
...
166:                                              ; preds = %135, %166
  ...
  call fastcc void @ReceiveReplyPrunedRows(i32 %65, %struct.numbering* %66, %struct.PrunedRows* %64, %struct.RowPatt* %82) #11
  %168 = add nuw nsw i32 %167, 1
  %169 = icmp eq i32 %168, %138
  br i1 %169, label %170, label %166, !llvm.loop !49

170:                                              ; preds = %166, %135
  %171 = call i32 @hypre_MPI_Waitall(i32 %131, i32* %78, %struct.MPI_Status* %81) #11
  call void @MemDestroy(%struct.Mem* %111) #11
...
174:                                              ; preds = %170, %99
  ...
  call void @RowPattDestroy(%struct.RowPatt* %82) #11
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %184) #11
  %185 = call i32 @hypre_MPI_Comm_size(i32 %177, i32* nonnull %18) #11
  %186 = load i32, i32* %18, align 4, !tbaa !3
  %187 = sext i32 %186 to i64
  %188 = shl nsw i64 %187, 2
  %189 = call noalias align 16 i8* @malloc(i64 %188) #11
  %190 = bitcast i8* %189 to i32*
  %191 = mul nsw i64 %187, 20
  %192 = call noalias align 16 i8* @malloc(i64 %191) #11
  %193 = call %struct.RowPatt* @RowPattCreate(i32 300000) #11
...
202:                                              ; preds = %174, %202
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %64, i32 %203, i32* nonnull %14, i32** nonnull %15) #11
  %204 = load i32, i32* %14, align 4, !tbaa !3
  %205 = load i32*, i32** %15, align 8, !tbaa !24
  %206 = load i32, i32* %194, align 4, !tbaa !25
  call void @RowPattMergeExt(%struct.RowPatt* %193, i32 %204, i32* %205, i32 %206) #11
...
212:                                              ; preds = %198, %228
  ...
  call void @RowPattPrevLevel(%struct.RowPatt* %193, i32* nonnull %19, i32** nonnull %20) #11
...
216:                                              ; preds = %212, %216
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %64, i32 %220, i32* nonnull %14, i32** nonnull %15) #11
  %221 = load i32, i32* %14, align 4, !tbaa !3
  %222 = load i32*, i32** %15, align 8, !tbaa !24
  %223 = load i32, i32* %194, align 4, !tbaa !25
  call void @RowPattMergeExt(%struct.RowPatt* %193, i32 %221, i32* %222, i32 %223) #11
...
231:                                              ; preds = %228, %198
  %232 = call noalias align 16 dereferenceable_or_null(40) i8* @malloc(i64 40) #11
  %233 = bitcast i8* %232 to i32*
  %234 = call %struct.Mem* (...) @MemCreate() #11
  call void @RowPattGet(%struct.RowPatt* %193, i32* nonnull %14, i32** nonnull %15) #11
  %235 = load i32, i32* %14, align 4, !tbaa !3
  %236 = load i32*, i32** %15, align 8, !tbaa !24
  call void @NumberingLocalToGlobal(%struct.numbering* %178, i32 %235, i32* %236, i32* %236) #11
  %237 = load i32, i32* %18, align 4, !tbaa !3
  %238 = sext i32 %237 to i64
  %239 = call noalias align 16 i8* @calloc(i64 %238, i64 4) #11
  %240 = bitcast i8* %239 to i32*
  %241 = load i32, i32* %14, align 4, !tbaa !3
  %242 = load i32*, i32** %15, align 8, !tbaa !24
  call fastcc void @SendRequests(i32 %177, i32 221, %struct.Matrix* %1, i32 %241, i32* %242, i32* nonnull %16, i32* %240) #11
  %243 = bitcast i32* %12 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %243) #11
  %244 = bitcast i32* %13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %244) #11
  %245 = call i32 @hypre_MPI_Comm_rank(i32 %177, i32* nonnull %13) #11
  %246 = call i32 @hypre_MPI_Comm_size(i32 %177, i32* nonnull %12) #11
  %247 = load i32, i32* %12, align 4, !tbaa !3
  %248 = sext i32 %247 to i64
  %249 = shl nsw i64 %248, 2
  %250 = call noalias align 16 i8* @malloc(i64 %249) #11
  %251 = bitcast i8* %250 to i32*
  %252 = call i32 @hypre_MPI_Allreduce(i8* %239, i8* %250, i32 %247, i32 1275069445, i32 1476395011, i32 %177) #11
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %244) #11
...
266:                                              ; preds = %282, %260
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %257) #11
  %270 = call i32 @hypre_MPI_Probe(i32 -2, i32 221, i32 %177, %struct.MPI_Status* nonnull %11) #11
  %271 = load i32, i32* %258, align 4, !tbaa !30
  %272 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %11, i32 1275069445, i32* nonnull %17) #11
...
275:                                              ; preds = %266
  ...
  %280 = call noalias align 16 i8* @malloc(i64 %279) #11
...
282:                                              ; preds = %275, %266
  ...
  %287 = call i32 @hypre_MPI_Recv(i8* %285, i32 %286, i32 1275069445, i32 %271, i32 221, i32 %177, %struct.MPI_Status* nonnull %11) #11
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %257) #11
  %288 = load i32, i32* %17, align 4, !tbaa !3
  %289 = getelementptr inbounds i32, i32* %190, i64 %267
  call fastcc void @SendReplyPrunedRows(i32 %177, %struct.numbering* %178, i32 %271, i32* %284, i32 %288, %struct.PrunedRows* %63, %struct.Mem* %234, i32* %289) #11
...
292:                                              ; preds = %262, %292
  ...
  call fastcc void @ReceiveReplyPrunedRows(i32 %177, %struct.numbering* %178, %struct.PrunedRows* %63, %struct.RowPatt* %193) #11
...
296:                                              ; preds = %292, %262
  ...
  %298 = call i32 @hypre_MPI_Waitall(i32 %256, i32* %190, %struct.MPI_Status* %297) #11
  call void @MemDestroy(%struct.Mem* %234) #11
  call void @RowPattDestroy(%struct.RowPatt* %193) #11
  %299 = bitcast i32* %263 to i8*
  call void @free(i8* %299) #11
  call void @free(i8* %189) #11
  call void @free(i8* %192) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %184) #11
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %306) #11
  %307 = bitcast i32** %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %307) #11
  %308 = bitcast i32* %8 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %308) #11
  %309 = bitcast i32** %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %309) #11
  %310 = bitcast i32* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %310) #11
  %311 = getelementptr inbounds %struct.Matrix, %struct.Matrix* %304, i64 0, i32 0
  %312 = load i32, i32* %311, align 8, !tbaa !35
  %313 = call i32 @hypre_MPI_Comm_size(i32 %312, i32* nonnull %10) #11
  store double 0.000000e+00, double* %305, align 8, !tbaa !36
  %314 = call %struct.RowPatt* @RowPattCreate(i32 300000) #11
  %315 = call %struct.RowPatt* @RowPattCreate(i32 300000) #11
...
325:                                              ; preds = %296, %415
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %63, i32 %327, i32* nonnull %6, i32** nonnull %7) #11
  %328 = load i32, i32* %6, align 4, !tbaa !3
  %329 = load i32*, i32** %7, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %314, i32 %328, i32* %329) #11
  br i1 %318, label %348, label %330

330:                                              ; preds = %325, %345
  %331 = phi i32 [ %346, %345 ], [ 0, %325 ]
  call void @RowPattPrevLevel(%struct.RowPatt* %314, i32* nonnull %8, i32** nonnull %9) #11
...
334:                                              ; preds = %330, %334
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %64, i32 %338, i32* nonnull %6, i32** nonnull %7) #11
  %339 = load i32, i32* %6, align 4, !tbaa !3
  %340 = load i32*, i32** %7, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %314, i32 %339, i32* %340) #11
...
348:                                              ; preds = %345, %325
  call void @PrunedRowsGet(%struct.PrunedRows* %64, i32 %327, i32* nonnull %6, i32** nonnull %7) #11
  %349 = load i32, i32* %6, align 4, !tbaa !3
  %350 = load i32*, i32** %7, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %315, i32 %349, i32* %350) #11
  br i1 %319, label %369, label %351

351:                                              ; preds = %348, %366
  %352 = phi i32 [ %367, %366 ], [ 1, %348 ]
  call void @RowPattPrevLevel(%struct.RowPatt* %315, i32* nonnull %8, i32** nonnull %9) #11
...
355:                                              ; preds = %351, %355
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %64, i32 %359, i32* nonnull %6, i32** nonnull %7) #11
  %360 = load i32, i32* %6, align 4, !tbaa !3
  %361 = load i32*, i32** %7, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %315, i32 %360, i32* %361) #11
...
369:                                              ; preds = %366, %348
  call void @RowPattGet(%struct.RowPatt* %315, i32* nonnull %8, i32** nonnull %9) #11
...
372:                                              ; preds = %369, %372
  ...
  call void @PrunedRowsGet(%struct.PrunedRows* %63, i32 %376, i32* nonnull %6, i32** nonnull %7) #11
  %377 = load i32, i32* %6, align 4, !tbaa !3
  %378 = load i32*, i32** %7, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %315, i32 %377, i32* %378) #11
...
383:                                              ; preds = %372, %369
  call void @RowPattGet(%struct.RowPatt* %315, i32* nonnull %6, i32** nonnull %7) #11
  %384 = load i32, i32* %6, align 4, !tbaa !3
  %385 = load i32*, i32** %7, align 8, !tbaa !24
  call void @RowPattMerge(%struct.RowPatt* %314, i32 %384, i32* %385) #11
  call void @RowPattGet(%struct.RowPatt* %314, i32* nonnull %6, i32** nonnull %7) #11
  call void @RowPattReset(%struct.RowPatt* %314) #11
  call void @RowPattReset(%struct.RowPatt* %315) #11
...
415:                                              ; preds = %413, %383
  ...
  call void @MatrixSetRow(%struct.Matrix* %304, i32 %417, i32 %418, i32* %419, double* null) #11
...
432:                                              ; preds = %415, %296
  call void @RowPattDestroy(%struct.RowPatt* %314) #11
  call void @RowPattDestroy(%struct.RowPatt* %315) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %310) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %309) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %308) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %307) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %306) #11
  call void @DiagScaleDestroy(%struct.DiagScale* %55) #11
  call void @PrunedRowsDestroy(%struct.PrunedRows* %63) #11
  call void @PrunedRowsDestroy(%struct.PrunedRows* %64) #11
  %433 = call double @hypre_MPI_Wtime() #11
...
define dso_local i32 @ParaSailsSetupValues(%struct.ParaSails* nocapture %0, %struct.Matrix* %1, double %2) local_unnamed_addr #0 {
  ...
  %46 = call double @hypre_MPI_Wtime() #11
...
56:                                               ; preds = %52
  call void @NumberingDestroy(%struct.numbering* nonnull %54) #11
  br label %57
...
57:                                               ; preds = %56, %52
  ...
  %60 = call %struct.numbering* @NumberingCreateCopy(%struct.numbering* %59) #11
...
67:                                               ; preds = %57, %67
  ...
  call void @MatrixGetRow(%struct.Matrix* %68, i32 %69, i32* nonnull %34, i32** nonnull %35, double** nonnull %36) #11
  ...
  call void @NumberingLocalToGlobal(%struct.numbering* %72, i32 %73, i32* %74, i32* %74) #11
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %75, i32 %76, i32* %77, i32* %77) #11
...
86:                                               ; preds = %67, %57, %3
  ...
  %95 = call %struct.LoadBal* @LoadBalDonate(i32 %87, %struct.Matrix* %88, %struct.numbering* %90, double %92, double %94) #11
  %96 = call %struct.StoredRows* @StoredRowsCreate(%struct.Matrix* %1, i32 300000) #11
  ...
  %106 = call %struct.Mem* (...) @MemCreate() #11
  %107 = call i32 @hypre_MPI_Comm_size(i32 %97, i32* nonnull %33) #11
  %108 = call %struct.RowPatt* @RowPattCreate(i32 300000) #11
...
120:                                              ; preds = %86, %120
  ...
  call void @MatrixGetRow(%struct.Matrix* %98, i32 %123, i32* nonnull %28, i32** nonnull %29, double** nonnull %30) #11
  %124 = load i32, i32* %28, align 4, !tbaa !3
  %125 = load i32*, i32** %29, align 8, !tbaa !24
  %126 = load i32, i32* %112, align 4, !tbaa !25
  call void @RowPattMergeExt(%struct.RowPatt* %108, i32 %124, i32* %125, i32 %126) #11
...
140:                                              ; preds = %130, %140
  ...
  call void @MatrixGetRow(%struct.Matrix* %141, i32 %142, i32* nonnull %28, i32** nonnull %29, double** nonnull %30) #11
  %143 = load i32, i32* %28, align 4, !tbaa !3
  %144 = load i32*, i32** %29, align 8, !tbaa !24
  %145 = load i32, i32* %112, align 4, !tbaa !25
  call void @RowPattMergeExt(%struct.RowPatt* %108, i32 %143, i32* %144, i32 %145) #11
...
161:                                              ; preds = %156, %115
  call void @RowPattGet(%struct.RowPatt* %108, i32* nonnull %28, i32** nonnull %29) #11
  %162 = load i32, i32* %28, align 4, !tbaa !3
  %163 = load i32*, i32** %29, align 8, !tbaa !24
  call void @NumberingLocalToGlobal(%struct.numbering* %99, i32 %162, i32* %163, i32* %163) #11
  %164 = load i32, i32* %33, align 4, !tbaa !3
  %165 = sext i32 %164 to i64
  %166 = call noalias align 16 i8* @calloc(i64 %165, i64 4) #11
  %167 = bitcast i8* %166 to i32*
  %168 = load i32, i32* %28, align 4, !tbaa !3
  %169 = load i32*, i32** %29, align 8, !tbaa !24
  call fastcc void @SendRequests(i32 %97, i32 222, %struct.Matrix* %1, i32 %168, i32* %169, i32* nonnull %31, i32* %167) #11
  %170 = bitcast i32* %26 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %170) #11
  %171 = bitcast i32* %27 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %171) #11
  %172 = call i32 @hypre_MPI_Comm_rank(i32 %97, i32* nonnull %27) #11
  %173 = call i32 @hypre_MPI_Comm_size(i32 %97, i32* nonnull %26) #11
  %174 = load i32, i32* %26, align 4, !tbaa !3
  %175 = sext i32 %174 to i64
  %176 = shl nsw i64 %175, 2
  %177 = call noalias align 16 i8* @malloc(i64 %176) #11
  %178 = bitcast i8* %177 to i32*
  %179 = call i32 @hypre_MPI_Allreduce(i8* %166, i8* %177, i32 %174, i32 1275069445, i32 1476395011, i32 %97) #11
...
185:                                              ; preds = %161
  ...
  %188 = call noalias align 16 i8* @malloc(i64 %187) #11
...
193:                                              ; preds = %185, %161
  ...
  %196 = call noalias align 16 dereferenceable_or_null(40) i8* @malloc(i64 40) #11
...
215:                                              ; preds = %298, %206
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %198) #11
  %219 = call i32 @hypre_MPI_Probe(i32 -2, i32 222, i32 %97, %struct.MPI_Status* nonnull %25) #11
  %220 = load i32, i32* %199, align 4, !tbaa !30
  %221 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %25, i32 1275069445, i32* nonnull %32) #11
...
224:                                              ; preds = %215
  ...
  %229 = call noalias align 16 i8* @malloc(i64 %228) #11
...
231:                                              ; preds = %224, %215
  ...
  %236 = call i32 @hypre_MPI_Recv(i8* %234, i32 %235, i32 1275069445, i32 %220, i32 222, i32 %97, %struct.MPI_Status* nonnull %25) #11
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %198) #11
...
243:                                              ; preds = %243, %241
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %99, i32 1, i32* %246, i32* nonnull %24) #11
  %247 = load i32, i32* %24, align 4, !tbaa !3
  call void @StoredRowsGet(%struct.StoredRows* %96, i32 %247, i32* nonnull %21, i32** nonnull %22, double** nonnull %23) #11
...
253:                                              ; preds = %243, %231
  ...
  %255 = shl i32 %254, 2
  %256 = call i8* @MemAlloc(%struct.Mem* %106, i32 %255) #11
  %257 = bitcast i8* %256 to i32*
  %258 = shl i32 %254, 3
  %259 = call i8* @MemAlloc(%struct.Mem* %106, i32 %258) #11
...
277:                                              ; preds = %277, %267
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %99, i32 1, i32* %281, i32* nonnull %24) #11
  %282 = load i32, i32* %24, align 4, !tbaa !3
  call void @StoredRowsGet(%struct.StoredRows* %96, i32 %282, i32* nonnull %21, i32** nonnull %22, double** nonnull %23) #11
  ...
  call void @NumberingLocalToGlobal(%struct.numbering* %99, i32 %285, i32* %286, i32* nonnull %284) #11
  %287 = bitcast double* %279 to i8*
  %288 = load i8*, i8** %204, align 8, !tbaa !24
  %289 = load i32, i32* %21, align 4, !tbaa !3
  %290 = sext i32 %289 to i64
  %291 = shl nsw i64 %290, 3
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %287, i8* align 8 %288, i64 %291, i1 false) #11
...
298:                                              ; preds = %277, %265
  ...
  %306 = call i32 @hypre_MPI_Isend(i8* %256, i32 %305, i32 1275069445, i32 %220, i32 223, i32 %97, i32* %238) #11
  %307 = call i32 @hypre_MPI_Request_free(i32* %238) #11
  %308 = ptrtoint double* %300 to i64
  %309 = ptrtoint i8* %259 to i64
  %310 = sub i64 %308, %309
  %311 = lshr exact i64 %310, 3
  %312 = trunc i64 %311 to i32
  %313 = call i32 @hypre_MPI_Isend(i8* %259, i32 %312, i32 1275070475, i32 %220, i32 224, i32 %97, i32* %238) #11
...
316:                                              ; preds = %208, %351
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %211) #11
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %212) #11
  %318 = call i32 @hypre_MPI_Probe(i32 -2, i32 223, i32 %97, %struct.MPI_Status* nonnull %19) #11
  %319 = load i32, i32* %213, align 4, !tbaa !30
  %320 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %19, i32 1275069445, i32* nonnull %20) #11
  %321 = load i32, i32* %20, align 4, !tbaa !3
  %322 = call i32* @StoredRowsAllocInd(%struct.StoredRows* %96, i32 %321) #11
  %323 = bitcast i32* %322 to i8*
  %324 = load i32, i32* %20, align 4, !tbaa !3
  %325 = call i32 @hypre_MPI_Recv(i8* %323, i32 %324, i32 1275069445, i32 %319, i32 223, i32 %97, %struct.MPI_Status* nonnull %19) #11
  %326 = load i32, i32* %20, align 4, !tbaa !3
  %327 = call double* @StoredRowsAllocVal(%struct.StoredRows* %96, i32 %326) #11
  %328 = bitcast double* %327 to i8*
  %329 = load i32, i32* %20, align 4, !tbaa !3
  %330 = call i32 @hypre_MPI_Recv(i8* %328, i32 %329, i32 1275070475, i32 %319, i32 224, i32 %97, %struct.MPI_Status* nonnull %19) #11
  %331 = getelementptr inbounds i32, i32* %322, i64 1
  %332 = load i32, i32* %322, align 4, !tbaa !3
  call void @NumberingGlobalToLocal(%struct.numbering* %99, i32 %332, i32* nonnull %331, i32* nonnull %331) #11
  %333 = icmp sgt i32 %332, 0
...
338:                                              ; preds = %338, %334
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %99, i32 %343, i32* nonnull %342, i32* nonnull %342) #11
  %344 = getelementptr inbounds i32, i32* %331, i64 %339
  %345 = load i32, i32* %344, align 4, !tbaa !3
  call void @StoredRowsPut(%struct.StoredRows* %96, i32 %345, i32 %343, i32* nonnull %342, double* %340) #11
...
351:                                              ; preds = %338, %316
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %212) #11
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %211) #11
  %352 = add nuw nsw i32 %317, 1
  %353 = icmp eq i32 %352, %210
  br i1 %353, label %354, label %316, !llvm.loop !79

354:                                              ; preds = %351, %208
  %355 = call i32 @hypre_MPI_Waitall(i32 %183, i32* %195, %struct.MPI_Status* %194) #11
  call void @MemDestroy(%struct.Mem* %106) #11
  call void @RowPattDestroy(%struct.RowPatt* %108) #11
...
409:                                              ; preds = %372, %394, %366, %388
  %410 = call double @hypre_MPI_Wtime() #11
  ...
  call void @LoadBalReturn(%struct.LoadBal* %95, i32 %413, %struct.Matrix* %414) #11
  %415 = call i32 @hypre_MPI_Allreduce(i8* nonnull %44, i8* nonnull %45, i32 1, i32 1275069445, i32 1476395011, i32 %43) #11
  %416 = load i32, i32* %38, align 4, !tbaa !3
  %417 = icmp eq i32 %416, 0
  br i1 %417, label %424, label %418

418:                                              ; preds = %409
  %419 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([54 x i8], [54 x i8]* @str, i64 0, i64 0))
  %420 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([59 x i8], [59 x i8]* @str.20, i64 0, i64 0))
  %421 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], [47 x i8]* @str.21, i64 0, i64 0))
  %422 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([54 x i8], [54 x i8]* @str.22, i64 0, i64 0))
...
427:                                              ; preds = %424
  ...
  %429 = call %struct.DiagScale* @DiagScaleCreate(%struct.Matrix* %1, %struct.numbering* %428) #11
  ...
  %435 = call %struct.Matrix* @MatrixCreate(i32 %430, i32 %432, i32 %434) #11
...
438:                                              ; preds = %427
  ...
  %449 = call noalias align 16 dereferenceable_or_null(80) i8* @malloc(i64 80) #11
...
457:                                              ; preds = %438, %505
  ...
  call void @MatrixGetRow(%struct.Matrix* %440, i32 %461, i32* nonnull %13, i32** nonnull %14, double** nonnull %16) #11
...
464:                                              ; preds = %457
  ...
  %469 = call noalias align 16 i8* @malloc(i64 %468) #11
...
474:                                              ; preds = %471
  %475 = call double @DiagScaleGet(%struct.DiagScale* %429, i32 %461) #11
...
481:                                              ; preds = %477, %481
  ...
  %493 = call double @DiagScaleGet(%struct.DiagScale* %429, i32 %492) #11
...
505:                                              ; preds = %481, %477
  ...
  %512 = call double @randomized_select(double* %472, i32 0, i32 %511, i32 %510) #11
...
520:                                              ; preds = %505, %438
  ...
  %522 = call i32 @hypre_MPI_Allreduce(i8* nonnull %447, i8* nonnull %448, i32 1, i32 1275070475, i32 1476395011, i32 %439) #11
  %523 = call i32 @hypre_MPI_Comm_size(i32 %439, i32* nonnull %15) #11
  %524 = bitcast double* %521 to i8*
  call void @free(i8* %524) #11
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %447) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %446) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %445) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %444) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %443) #11
...
540:                                              ; preds = %520, %427
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %544) #11
...
554:                                              ; preds = %540, %604
  ...
  call void @MatrixGetRow(%struct.Matrix* %541, i32 %557, i32* nonnull %10, i32** nonnull %11, double** nonnull %12) #11
...
564:                                              ; preds = %560
  %565 = call double @DiagScaleGet(%struct.DiagScale* %429, i32 %557) #11
...
567:                                              ; preds = %564, %560
  ...
  %579 = call double @DiagScaleGet(%struct.DiagScale* %429, i32 %578) #11
...
604:                                              ; preds = %598, %554
  ...
  call void @MatrixSetRow(%struct.Matrix* %435, i32 %608, i32 %605, i32* %609, double* %610) #11
...
620:                                              ; preds = %604, %540
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %544) #11
  call void @DiagScaleDestroy(%struct.DiagScale* %429) #11
  %622 = load %struct.Matrix*, %struct.Matrix** %47, align 8, !tbaa !19
  call void @MatrixDestroy(%struct.Matrix* %622) #11
...
625:                                              ; preds = %620
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %629) #11
  %630 = bitcast i32** %5 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %630) #11
  %631 = bitcast i32* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %631) #11
  %632 = bitcast i32** %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %632) #11
  %633 = bitcast double** %8 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %633) #11
  %634 = bitcast double** %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %634) #11
  %635 = sext i32 %628 to i64
  %636 = call noalias align 16 i8* @calloc(i64 %635, i64 8) #11
...
642:                                              ; preds = %625, %725
  ...
  call void @MatrixGetRow(%struct.Matrix* %435, i32 %643, i32* nonnull %4, i32** nonnull %5, double** nonnull %8) #11
...
646:                                              ; preds = %642, %705
  ...
  call void @StoredRowsGet(%struct.StoredRows* %96, i32 %651, i32* nonnull %6, i32** nonnull %7, double** nonnull %9) #11
...
709:                                              ; preds = %705, %642
  ...
  %711 = call double @sqrt(double %710) #11
...
731:                                              ; preds = %725, %625
  call void @free(i8* %636) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %634) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %633) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %632) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %631) #11
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %630) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %629) #11
  br label %732
...
744:                                              ; preds = %742, %744
  ...
  call void @MatrixGetRow(%struct.Matrix* %745, i32 %746, i32* nonnull %34, i32** nonnull %35, double** nonnull %36) #11
  ...
  call void @NumberingLocalToGlobal(%struct.numbering* %747, i32 %748, i32* %749, i32* %749) #11
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %752, i32 %753, i32* %754, i32* %754) #11
...
763:                                              ; preds = %743, %763
  ...
  call void @MatrixGetRow(%struct.Matrix* %764, i32 %765, i32* nonnull %34, i32** nonnull %35, double** nonnull %36) #11
  ...
  call void @NumberingLocalToGlobal(%struct.numbering* %766, i32 %767, i32* %768, i32* %768) #11
...
777:                                              ; preds = %763, %743
  ...
  call void @MatrixComplete(%struct.Matrix* %778) #11
  br label %779

779:                                              ; preds = %744, %742, %777
  call void @StoredRowsDestroy(%struct.StoredRows* %96) #11
  br label %780
...
42:                                               ; preds = %37, %42
  ...
  call void @MatrixGetRow(%struct.Matrix* %1, i32 %46, i32* nonnull %7, i32** nonnull %8, double** nonnull %9) #11
...
67:                                               ; preds = %54, %222
  ...
  call void @MatrixGetRow(%struct.Matrix* %1, i32 %71, i32* nonnull %7, i32** nonnull %8, double** nonnull %9) #11
...
86:                                               ; preds = %77, %67
  ...
  %90 = call double @hypre_MPI_Wtime() #11
...
93:                                               ; preds = %86, %121
  ...
  call void @StoredRowsGet(%struct.StoredRows* %0, i32 %98, i32* nonnull %10, i32** nonnull %11, double** nonnull %13) #11
...
162:                                              ; preds = %158, %130, %128
  %163 = call double @hypre_MPI_Wtime() #11
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %3, i32 1, i32* nonnull %6, i32* nonnull %12) #11
...
188:                                              ; preds = %180, %162
  %189 = call double @hypre_MPI_Wtime() #11
  %190 = call i32 @hypre_dpotrf(i8* nonnull %14, i32* nonnull %7, double* %61, i32* nonnull %7, i32* nonnull %16) #11
  %191 = load i32, i32* %16, align 4, !tbaa !3
  %192 = icmp eq i32 %191, 0
  %193 = load double*, double** %9, align 8, !tbaa !24
  %194 = call i32 @hypre_dpotrs(i8* nonnull %14, i32* nonnull %7, i32* nonnull %15, double* %61, i32* nonnull %7, double* %193, i32* nonnull %7, i32* nonnull %16) #11
  %195 = load i32, i32* %16, align 4, !tbaa !3
  %196 = icmp eq i32 %195, 0
  %197 = select i1 %196, i1 %192, i1 false
  %198 = select i1 %197, double %68, double 1.000000e+00
  %199 = call double @hypre_MPI_Wtime() #11
  ...
  %208 = call double @sqrt(double %207) #11
...
define internal fastcc i32 @ComputeValuesNonsym(%struct.StoredRows* %0, %struct.Matrix* %1, i32 %2, %struct.numbering* %3) unnamed_addr #0 {
  ...
  %28 = call noalias align 16 dereferenceable_or_null(4000) i8* @malloc(i64 4000) #11
...
42:                                               ; preds = %39, %4
  %43 = call noalias align 16 dereferenceable_or_null(8000) i8* @malloc(i64 8000) #11
  %44 = bitcast i8* %43 to double*
  %45 = call noalias align 16 dereferenceable_or_null(80000) i8* @malloc(i64 80000) #11
  %46 = bitcast i8* %45 to double*
  %47 = call noalias align 16 dereferenceable_or_null(1024000) i8* @calloc(i64 128000, i64 8) #11
...
53:                                               ; preds = %42, %245
  ...
  %61 = call double @hypre_MPI_Wtime() #11
  %62 = load i32, i32* %6, align 4, !tbaa !3
  %63 = load i32, i32* %50, align 4, !tbaa !23
  %64 = sub nsw i32 %62, %63
  call void @MatrixGetRow(%struct.Matrix* %1, i32 %64, i32* nonnull %7, i32** nonnull %8, double** nonnull %9) #11
...
74:                                               ; preds = %53, %124
  ...
  %80 = load i32, i32* %79, align 4, !tbaa !3
  call void @StoredRowsGet(%struct.StoredRows* %0, i32 %80, i32* nonnull %10, i32** nonnull %11, double** nonnull %13) #11
...
100:                                              ; preds = %94
  ...
  %105 = call align 16 i8* @realloc(i8* %102, i64 %104) #11
...
138:                                              ; preds = %131
  ...
  %145 = call noalias align 16 i8* @malloc(i64 %144) #11
...
158:                                              ; preds = %147, %183
  ...
  call void @StoredRowsGet(%struct.StoredRows* %0, i32 %163, i32* nonnull %10, i32** nonnull %11, double** nonnull %13) #11
...
191:                                              ; preds = %183, %147
  %192 = call double @hypre_MPI_Wtime() #11
...
195:                                              ; preds = %191
  ...
  %200 = call noalias align 16 i8* @malloc(i64 %199) #11
...
227:                                              ; preds = %219, %202
  %228 = call double @hypre_MPI_Wtime() #11
  %229 = call i32 @hypre_dgels(i8* nonnull %16, i32* nonnull %14, i32* nonnull %7, i32* nonnull %17, double* %148, i32* nonnull %14, double* %203, i32* nonnull %14, double* %48, i32* nonnull %5, i32* nonnull %15) #11
...
245:                                              ; preds = %238, %227
  %246 = call double @hypre_MPI_Wtime() #11
...
define dso_local void @ParaSailsApply(%struct.ParaSails* nocapture readonly %0, double* %1, double* %2) local_unnamed_addr #0 {
  ...
  call void @MatrixMatvec(%struct.Matrix* %8, double* %1, double* %2) #11
  br i1 %6, label %11, label %9

9:                                                ; preds = %3
  %10 = load %struct.Matrix*, %struct.Matrix** %7, align 8, !tbaa !19
  call void @MatrixMatvecTrans(%struct.Matrix* %10, double* %2, double* %2) #11
  br label %11
...
11:                                               ; preds = %3
  call void @MatrixMatvecTrans(%struct.Matrix* %8, double* %1, double* %2) #11
  br label %12
...
define dso_local double @ParaSailsStatsPattern(%struct.ParaSails* %0, %struct.Matrix* %1) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %14) #11
  %15 = call i32 @hypre_MPI_Comm_rank(i32 %11, i32* nonnull %3) #11
  %16 = call i32 @hypre_MPI_Comm_size(i32 %11, i32* nonnull %4) #11
  ...
  %19 = call i32 @MatrixNnz(%struct.Matrix* %18) #11
  %20 = call i32 @MatrixNnz(%struct.Matrix* %1) #11
...
40:                                               ; preds = %24, %2
  ...
  %44 = call i32 @hypre_MPI_Allreduce(i8* nonnull %43, i8* nonnull %12, i32 1, i32 1275070475, i32 1476395009, i32 %11) #11
  %45 = getelementptr inbounds %struct.ParaSails, %struct.ParaSails* %0, i64 0, i32 5
  %46 = bitcast double* %45 to i8*
  %47 = call i32 @hypre_MPI_Allreduce(i8* nonnull %46, i8* nonnull %13, i32 1, i32 1275070475, i32 1476395009, i32 %11) #11
  %48 = call i32 @hypre_MPI_Allreduce(i8* nonnull %46, i8* nonnull %14, i32 1, i32 1275070475, i32 1476395011, i32 %11) #11
...
61:                                               ; preds = %58, %55
  %62 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.23, i64 0, i64 0))
  %63 = load i32, i32* %21, align 8, !tbaa !7
  %64 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5, i64 0, i64 0), i32 %63)
  %65 = getelementptr inbounds %struct.ParaSails, %struct.ParaSails* %0, i64 0, i32 1
  %66 = load double, double* %65, align 8, !tbaa !11
  %67 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @.str.6, i64 0, i64 0), double %66)
  %68 = getelementptr inbounds %struct.ParaSails, %struct.ParaSails* %0, i64 0, i32 2
  %69 = load i32, i32* %68, align 8, !tbaa !12
  %70 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @.str.7, i64 0, i64 0), i32 %69)
  %71 = load double, double* %6, align 8, !tbaa !36
  %72 = load double, double* %7, align 8, !tbaa !36
  %73 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([39 x i8], [39 x i8]* @.str.8, i64 0, i64 0), double %71, double %72)
  %74 = sitofp i32 %19 to double
  %75 = sitofp i32 %41 to double
  %76 = fdiv double %74, %75
  %77 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i64 0, i64 0), i32 %19, double %76)
  %78 = load double, double* %5, align 8, !tbaa !36
  %79 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.10, i64 0, i64 0), double %78)
  %80 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.28, i64 0, i64 0))
...
define dso_local void @ParaSailsStatsValues(%struct.ParaSails* %0, %struct.Matrix* %1) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %12) #11
  %13 = call i32 @hypre_MPI_Comm_rank(i32 %10, i32* nonnull %3) #11
  %14 = call i32 @hypre_MPI_Comm_size(i32 %10, i32* nonnull %4) #11
  ...
  %17 = call i32 @MatrixNnz(%struct.Matrix* %16) #11
  %18 = call i32 @MatrixNnz(%struct.Matrix* %1) #11
...
38:                                               ; preds = %22, %2
  ...
  %42 = call i32 @hypre_MPI_Allreduce(i8* nonnull %41, i8* nonnull %11, i32 1, i32 1275070475, i32 1476395009, i32 %10) #11
...
45:                                               ; preds = %38
  ...
  %48 = shl nsw i64 %47, 3
  %49 = call noalias align 16 i8* @malloc(i64 %48) #11
...
51:                                               ; preds = %45, %38
  ...
  %58 = call i32 @hypre_MPI_Gather(i8* nonnull %12, i32 1, i32 1275070475, i8* %57, i32 1, i32 1275070475, i32 0, i32 %10) #11
  %59 = load i32, i32* %3, align 4, !tbaa !3
  %60 = icmp eq i32 %59, 0
  br i1 %60, label %61, label %101

61:                                               ; preds = %51
  %62 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.25, i64 0, i64 0))
  %63 = getelementptr inbounds %struct.ParaSails, %struct.ParaSails* %0, i64 0, i32 3
  %64 = load double, double* %63, align 8, !tbaa !84
  %65 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @.str.13, i64 0, i64 0), double %64)
  %66 = getelementptr inbounds %struct.ParaSails, %struct.ParaSails* %0, i64 0, i32 4
  %67 = load double, double* %66, align 8, !tbaa !65
  %68 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @.str.14, i64 0, i64 0), double %67)
  %69 = sitofp i32 %17 to double
  %70 = sitofp i32 %39 to double
  %71 = fdiv double %69, %70
  %72 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.15, i64 0, i64 0), i32 %17, double %71)
  %73 = load double, double* %5, align 8, !tbaa !36
  %74 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.16, i64 0, i64 0), double %73)
  %75 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.28, i64 0, i64 0))
  %76 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @str.27, i64 0, i64 0))
...
79:                                               ; preds = %61, %79
  ...
  %84 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @.str.18, i64 0, i64 0), i32 %83, double %82)
...
92:                                               ; preds = %79, %61
  ...
  %97 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @.str.19, i64 0, i64 0), double %96)
  %98 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.28, i64 0, i64 0))
...
define internal fastcc void @SendRequests(i32 %0, i32 %1, %struct.Matrix* %2, i32 %3, i32* %4, i32* nocapture %5, i32* %6) unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %9) #11
  call void @shell_sort(i32 %3, i32* %4) #11
...
16:                                               ; preds = %14, %54
  ...
  %21 = call i32 @MatrixRowPe(%struct.Matrix* %2, i32 %20) #11
...
42:                                               ; preds = %30, %37, %26
  ...
  %47 = call i32 @hypre_MPI_Isend(i8* nonnull %45, i32 %46, i32 1275069445, i32 %21, i32 %1, i32 %0, i32* nonnull %8) #11
  %48 = call i32 @hypre_MPI_Request_free(i32* nonnull %8) #11
...
19:                                               ; preds = %17, %19
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %1, i32 1, i32* %22, i32* nonnull %11) #11
  %23 = load i32, i32* %11, align 4, !tbaa !3
  call void @PrunedRowsGet(%struct.PrunedRows* %5, i32 %23, i32* nonnull %9, i32** nonnull %10) #11
...
29:                                               ; preds = %19, %8
  ...
  %31 = shl i32 %30, 2
  %32 = call i8* @MemAlloc(%struct.Mem* %6, i32 %31) #11
...
52:                                               ; preds = %42, %52
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %1, i32 1, i32* %55, i32* nonnull %11) #11
  %56 = load i32, i32* %11, align 4, !tbaa !3
  call void @PrunedRowsGet(%struct.PrunedRows* %5, i32 %56, i32* nonnull %9, i32** nonnull %10) #11
  ...
  call void @NumberingLocalToGlobal(%struct.numbering* %1, i32 %59, i32* %60, i32* nonnull %58) #11
...
66:                                               ; preds = %52, %39
  ...
  %73 = call i32 @hypre_MPI_Isend(i8* %32, i32 %72, i32 1275069445, i32 %2, i32 223, i32 %0, i32* %7) #11
...
define internal fastcc void @ReceiveReplyPrunedRows(i32 %0, %struct.numbering* %1, %struct.PrunedRows* %2, %struct.RowPatt* %3) unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %8) #11
  %9 = call i32 @hypre_MPI_Probe(i32 -2, i32 223, i32 %0, %struct.MPI_Status* nonnull %5) #11
  %10 = getelementptr inbounds %struct.MPI_Status, %struct.MPI_Status* %5, i64 0, i32 2
  %11 = load i32, i32* %10, align 4, !tbaa !30
  %12 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %5, i32 1275069445, i32* nonnull %6) #11
  %13 = load i32, i32* %6, align 4, !tbaa !3
  %14 = call i32* @PrunedRowsAlloc(%struct.PrunedRows* %2, i32 %13) #11
  %15 = bitcast i32* %14 to i8*
  %16 = load i32, i32* %6, align 4, !tbaa !3
  %17 = call i32 @hypre_MPI_Recv(i8* %15, i32 %16, i32 1275069445, i32 %11, i32 223, i32 %0, %struct.MPI_Status* nonnull %5) #11
  %18 = getelementptr inbounds i32, i32* %14, i64 1
  %19 = load i32, i32* %14, align 4, !tbaa !3
  call void @NumberingGlobalToLocal(%struct.numbering* %1, i32 %19, i32* nonnull %18, i32* nonnull %18) #11
...
26:                                               ; preds = %22, %26
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %1, i32 %30, i32* nonnull %29, i32* nonnull %29) #11
  %31 = getelementptr inbounds i32, i32* %18, i64 %27
  %32 = load i32, i32* %31, align 4, !tbaa !3
  call void @PrunedRowsPut(%struct.PrunedRows* %2, i32 %32, i32 %30, i32* nonnull %29) #11
  %33 = load i32, i32* %20, align 4, !tbaa !25
  call void @RowPattMergeExt(%struct.RowPatt* %3, i32 %30, i32* nonnull %29, i32 %33) #11
...
declare dso_local void @shell_sort(i32, i32*) local_unnamed_addr #2

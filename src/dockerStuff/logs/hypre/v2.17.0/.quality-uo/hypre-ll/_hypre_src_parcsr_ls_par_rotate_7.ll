...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateRotate7pt(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, double %7, double %8) local_unnamed_addr #0 {
  ...
  %71 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4
  ...
  %87 = call i8* @hypre_CAlloc(i64 %86, i64 4, i32 2) #4
  %88 = bitcast i8* %87 to i32*
  %89 = call i8* @hypre_CAlloc(i64 %86, i64 4, i32 2) #4
  ...
  %123 = call i8* @hypre_CAlloc(i64 %122, i64 4, i32 1) #4
...
293:                                              ; preds = %274, %512
  %294 = phi i32 [ %516, %512 ], [ %280, %274 ]
  %295 = phi i32 [ %515, %512 ], [ 0, %274 ]
...
403:                                              ; preds = %401
  ...
  %406 = call i32 @hypre_map2(i32 %404, i32 %294, i32 %287, i32 %6, i32 %1, i32* %390, i32* %405) #4
...
429:                                              ; preds = %427
  ...
  %431 = call i32 @hypre_map2(i32 %415, i32 %294, i32 %53, i32 %6, i32 %1, i32* %416, i32* %430) #4
...
512:                                              ; preds = %504, %293
  ...
  %515 = phi i32 [ %295, %293 ], [ %507, %504 ]
  %516 = add nsw i32 %294, 1
...
525:                                              ; preds = %521
  ...
  %527 = call i8* @hypre_CAlloc(i64 %526, i64 4, i32 1) #4
...
576:                                              ; preds = %568, %562
  call void @hypre_Free(i8* %527, i32 1) #4
  %577 = bitcast i32* %275 to i8*
  call void @hypre_Free(i8* %577, i32 1) #4
  br label %578
...
578:                                              ; preds = %576, %521
  ...
  %584 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %583, i64 0, i32 11
  %585 = bitcast i32** %584 to i8**
  store i8* %123, i8** %585, align 8, !tbaa !20
  %586 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %583, i64 0, i32 7
  ...
  %593 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %583, i64 0, i32 8
...
600:                                              ; preds = %597, %578
  %601 = bitcast i32** %10 to i8**
  %602 = load i8*, i8** %601, align 8, !tbaa !7
  call void @hypre_Free(i8* %602, i32 1) #4
  store i32* null, i32** %10, align 8, !tbaa !7
  %603 = bitcast i32** %11 to i8**
  %604 = load i8*, i8** %603, align 8, !tbaa !7
  call void @hypre_Free(i8* %604, i32 1) #4
...
!20 = !{!21, !8, i64 64}
!21 = !{!"hypre_ParCSRMatrix_struct", !10, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16, !10, i64 20, !10, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !10, i64 104, !10, i64 108, !10, i64 112, !10, i64 116, !4, i64 120, !8, i64 128, !8, i64 136, !10, i64 144, !8, i64 152}
!22 = !{!21, !8, i64 32}
!23 = !{!24, !8, i64 0}
!24 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !10, i64 24, !10, i64 28, !10, i64 32, !8, i64 40, !8, i64 48, !10, i64 56, !8, i64 64, !8, i64 72, !10, i64 80}
!25 = !{!24, !8, i64 8}
!26 = !{!24, !8, i64 64}
!27 = !{!21, !8, i64 40}

...
define dso_local void @matvec_euclid_seq(i32 %0, i32* nocapture readonly %1, i32* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture %5) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 15, i32 1) #4
...
13:                                               ; preds = %6
  call void @setError_dh(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 20) #4
  br label %43
...
define dso_local void @Axpy(i32 %0, double %1, double* nocapture readonly %2, double* nocapture %3) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 49, i32 1) #4
  %5 = icmp sgt i32 %0, 0
...
define dso_local void @CopyVec(i32 %0, double* nocapture readonly %1, double* nocapture %2) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 67, i32 1) #4
  %4 = icmp sgt i32 %0, 0
...
define dso_local void @ScaleVec(i32 %0, double %1, double* nocapture %2) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 85, i32 1) #4
  %4 = icmp sgt i32 %0, 0
  br i1 %4, label %5, label %14
...
define dso_local double @InnerProd(i32 %0, double* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  call void @dh_StartFunc(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 102, i32 1) #4
...
define dso_local double @Norm2(i32 %0, double* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %4 = alloca double, align 8
  call void @dh_StartFunc(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 129, i32 1) #4

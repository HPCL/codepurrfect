...
262:                                              ; preds = %254, %153
  ...
  %306 = call i8* @hypre_CAlloc(i64 %305, i64 4, i32 2) #4
...
378:                                              ; preds = %343, %336
  ...
  call void @hypre_Free(i8* %306, i32 2) #4
...
389:                                              ; preds = %382
  ...
  %395 = call i8* @hypre_CAlloc(i64 %394, i64 4, i32 2) #4
...
412:                                              ; preds = %402, %389
  ...
  call void @hypre_Free(i8* %414, i32 2) #4
  br label %415
...
418:                                              ; preds = %415
  ...
  call void @hypre_Free(i8* nonnull %419, i32 1) #4
  br label %420
...
427:                                              ; preds = %424
  ...
  call void @hypre_Free(i8* nonnull %428, i32 1) #4
  store i32* null, i32** %19, align 8, !tbaa !25
  br label %429
...
432:                                              ; preds = %429
  ...
  call void @hypre_Free(i8* nonnull %433, i32 1) #4
  store i32* null, i32** %20, align 8, !tbaa !25
  br label %434
...
13:                                               ; preds = %9
  ...
  call void @hypre_Free(i8* nonnull %14, i32 2) #4

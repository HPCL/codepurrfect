...
define dso_local %struct.hypre_StructMatrix_struct* @hypre_StructMatrixCreate(i32 %0, %struct.hypre_StructGrid_struct* %1, %struct.hypre_StructStencil_struct* %2) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_CAlloc(i64 1, i64 160, i32 1) #10
...
112:                                              ; preds = %110
  ...
  %114 = load double, double* %113, align 8, !tbaa !59
  %115 = load double, double* %111, align 8, !tbaa !59
  %116 = fadd double %114, %115
  store double %116, double* %111, align 8, !tbaa !59
  br label %124
...
118:                                              ; preds = %117
  ...
  %120 = load double, double* %119, align 8, !tbaa !59
  store double %120, double* %111, align 8, !tbaa !59
  br label %124

121:                                              ; preds = %117
  %122 = load double, double* %111, align 8, !tbaa !59
  %123 = getelementptr inbounds double, double* %4, i64 %68
  store double %122, double* %123, align 8, !tbaa !59
  br label %124

124:                                              ; preds = %67, %118, %121, %112
  %125 = add nuw nsw i64 %68, 1
  %126 = icmp eq i64 %125, %52
  br i1 %126, label %127, label %67, !llvm.loop !61

127:                                              ; preds = %124, %65, %53
  %128 = phi i32 [ %55, %53 ], [ %66, %65 ], [ %66, %124 ]
  %129 = add nuw nsw i64 %54, 1
  %130 = icmp eq i64 %129, %51
  br i1 %130, label %131, label %53, !llvm.loop !62
...
65:                                               ; preds = %59, %25
  ...
  %71 = call i8* @hypre_CAlloc(i64 1, i64 160, i32 1) #10

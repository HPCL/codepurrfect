...
116:                                              ; preds = %95
  ...
  %119 = call i8* @hypre_CAlloc(i64 %118, i64 4, i32 1) #9
...
177:                                              ; preds = %174
  ...
  %181 = call i8* @hypre_CAlloc(i64 %180, i64 4, i32 1) #9
  ...
  %187 = call i8* @hypre_CAlloc(i64 %186, i64 4, i32 1) #9
...
204:                                              ; preds = %192
  ...
  %214 = call i8* @hypre_ReAlloc(i8* %211, i64 %213, i32 1) #9
...
244:                                              ; preds = %238, %177
  ...
  call void @hypre_Free(i8* %247, i32 1) #9
  store i32* null, i32** %11, align 8, !tbaa !7
  %248 = add nsw i32 %245, -1
  call void @hypre_qsort0(i32* %246, i32 0, i32 %248) #9
  store i32 0, i32* %9, align 4, !tbaa !3
  %249 = sext i32 %245 to i64
  %250 = call i8* @hypre_CAlloc(i64 %249, i64 4, i32 1) #9
...
279:                                              ; preds = %276, %257
  ...
  call void @hypre_Free(i8* %280, i32 1) #9
  ...
  %297 = call i8* @hypre_CAlloc(i64 %296, i64 4, i32 1) #9
...
401:                                              ; preds = %399, %349
  ...
  %405 = call i8* @hypre_CAlloc(i64 %404, i64 4, i32 1) #9
...
461:                                              ; preds = %456, %461
  ...
  call void @hypre_Memcpy(i8* nonnull %101, i8* %463, i64 4, i32 1, i32 1) #9
...
469:                                              ; preds = %459, %469
  ...
  call void @hypre_Memcpy(i8* nonnull %101, i8* %471, i64 4, i32 1, i32 1) #9
...
491:                                              ; preds = %477, %444
  ...
  call void @hypre_Free(i8* %492, i32 1) #9
  store i8* null, i8** %17, align 8, !tbaa !7
  %493 = load i8*, i8** %320, align 8, !tbaa !7
  call void @hypre_Free(i8* %493, i32 1) #9
  store i32* null, i32** %12, align 8, !tbaa !7
  call void @hypre_Free(i8* %405, i32 1) #9
  call void @hypre_Free(i8* %324, i32 1) #9
  %494 = bitcast i32* %319 to i8*
  call void @hypre_Free(i8* %494, i32 1) #9
  br label %495
...
502:                                              ; preds = %498, %495
  ...
  call void @hypre_Free(i8* %509, i32 1) #9
...
516:                                              ; preds = %502
  ...
  %518 = call i8* @hypre_CAlloc(i64 %517, i64 4, i32 1) #9
  %519 = bitcast i8* %518 to i32*
  %520 = call i8* @hypre_CAlloc(i64 %517, i64 4, i32 1) #9
...
668:                                              ; preds = %662, %620, %617
  ...
  %673 = call i8* @hypre_CAlloc(i64 %672, i64 80, i32 1) #9
  %674 = bitcast i8* %673 to %struct.hypre_BoxManEntry_struct*
  %675 = mul nsw i32 %670, %671
  %676 = sext i32 %675 to i64
  %677 = call i8* @hypre_MAlloc(i64 %676, i32 1) #9
...
740:                                              ; preds = %725, %732, %713
  ...
  call void @hypre_Memcpy(i8* %688, i8* %757, i64 %681, i32 1, i32 1) #9
...
761:                                              ; preds = %740, %668
  ...
  call void @hypre_Free(i8* %762, i32 1) #9
  ...
  call void @hypre_Free(i8* %764, i32 1) #9
...
788:                                              ; preds = %777, %771, %761
  ...
  %796 = call i8* @hypre_CAlloc(i64 %795, i64 4, i32 1) #9
...
835:                                              ; preds = %831, %788
  ...
  call void @hypre_Free(i8* %790, i32 1) #9
  call void @hypre_Free(i8* %789, i32 1) #9
...
883:                                              ; preds = %873, %883
  ...
  %885 = call i8* @hypre_CAlloc(i64 %871, i64 4, i32 1) #9
...
975:                                              ; preds = %973, %960, %958
  ...
  %977 = call i8* @hypre_CAlloc(i64 %976, i64 8, i32 1) #9
...
1206:                                             ; preds = %1203
  ...
  call void @hypre_Free(i8* %1209, i32 1) #9
...
1213:                                             ; preds = %1211, %1213
  ...
  call void @hypre_Free(i8* %1217, i32 1) #9

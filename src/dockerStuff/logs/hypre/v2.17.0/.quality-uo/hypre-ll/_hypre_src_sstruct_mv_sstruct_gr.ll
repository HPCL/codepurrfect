...
define dso_local i32 @hypre_SStructGridAssembleBoxManagers(%struct.hypre_SStructGrid_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %45 = shl nsw i64 %44, 3
  %46 = call i8* @hypre_MAlloc(i64 %45, i32 1) #8
...
57:                                               ; preds = %55, %150
  ...
  %67 = shl nsw i64 %66, 3
  %68 = call i8* @hypre_MAlloc(i64 %67, i32 1) #8
...
17:                                               ; preds = %8, %17
  ...
  br i1 %23, label %12, label %17, !llvm.loop !146
...
36:                                               ; preds = %29, %34
  ...
  %38 = icmp eq i64 %37, 8
  br i1 %38, label %39, label %29, !llvm.loop !147

39:                                               ; preds = %36
  %40 = add nuw nsw i64 %25, 1
  %41 = icmp eq i64 %40, %16
  br i1 %41, label %42, label %24, !llvm.loop !148
...
81:                                               ; preds = %68, %75
  ...
  br i1 %85, label %68, label %86, !llvm.loop !149
...
116:                                              ; preds = %104, %110
  ...
  br i1 %119, label %120, label %104, !llvm.loop !150

120:                                              ; preds = %116, %98
  call void @hypre_Free(i8* %57, i32 1) #8
  %121 = add nuw nsw i64 %45, 1
  %122 = icmp eq i64 %121, %43
  br i1 %122, label %123, label %44, !llvm.loop !151
...
24:                                               ; preds = %4, %24
  ...
  br i1 %33, label %24, label %34, !llvm.loop !152

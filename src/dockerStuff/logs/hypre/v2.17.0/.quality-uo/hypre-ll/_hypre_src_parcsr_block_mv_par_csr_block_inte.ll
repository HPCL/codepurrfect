...
270:                                              ; preds = %264, %263
  ...
  %274 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
  %275 = bitcast i8* %274 to i32*
  %276 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
  %277 = bitcast i8* %276 to i32*
  %278 = sext i32 %56 to i64
  %279 = call i8* @hypre_CAlloc(i64 %278, i64 4, i32 1) #6
...
380:                                              ; preds = %377, %285
  ...
  %385 = call i8* @hypre_CAlloc(i64 %384, i64 4, i32 1) #6
  %386 = bitcast i8* %385 to i32*
  %387 = sext i32 %381 to i64
  %388 = call i8* @hypre_CAlloc(i64 %387, i64 4, i32 1) #6
  %389 = bitcast i8* %388 to i32*
  %390 = mul nsw i32 %381, %30
  %391 = sext i32 %390 to i64
  %392 = call i8* @hypre_CAlloc(i64 %391, i64 8, i32 1) #6
  %393 = bitcast i8* %392 to double*
  %394 = getelementptr inbounds i32, i32* %386, i64 %278
  store i32 %381, i32* %394, align 4, !tbaa !28
  %395 = call i8* @hypre_CAlloc(i64 %384, i64 4, i32 1) #6
  %396 = bitcast i8* %395 to i32*
  %397 = sext i32 %382 to i64
  %398 = call i8* @hypre_CAlloc(i64 %397, i64 4, i32 1) #6
  %399 = bitcast i8* %398 to i32*
  %400 = mul nsw i32 %382, %30
  %401 = sext i32 %400 to i64
  %402 = call i8* @hypre_CAlloc(i64 %401, i64 8, i32 1) #6
...
410:                                              ; preds = %404, %380
  ...
  %413 = call i8* @hypre_CAlloc(i64 %412, i64 8, i32 1) #6
  %414 = bitcast i8* %413 to double*
  %415 = call i8* @hypre_CAlloc(i64 %412, i64 8, i32 1) #6
...
430:                                              ; preds = %420, %410
  %431 = call i8* @hypre_CAlloc(i64 %412, i64 8, i32 1) #6
  %432 = bitcast i8* %431 to double*
  %433 = call i8* @hypre_CAlloc(i64 %412, i64 8, i32 1) #6
  %434 = bitcast i8* %433 to double*
  %435 = call i8* @hypre_CAlloc(i64 %412, i64 8, i32 1) #6
...
439:                                              ; preds = %437, %430
  ...
  %441 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
  %442 = load i32*, i32** %91, align 8, !tbaa !31
  %443 = getelementptr inbounds i32, i32* %442, i64 %93
  %444 = load i32, i32* %443, align 4, !tbaa !28
  %445 = sext i32 %444 to i64
  %446 = call i8* @hypre_CAlloc(i64 %445, i64 4, i32 1) #6
  %447 = bitcast i8* %441 to i32*
  %448 = bitcast i8* %446 to i32*
  %449 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %88, i64 0, i32 4
...
487:                                              ; preds = %456, %439
  %488 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %88, i8* %446, i8* %441) #6
...
497:                                              ; preds = %487, %490
  %498 = call i8* @hypre_CAlloc(i64 %278, i64 4, i32 1) #6
  %499 = bitcast i8* %498 to i32*
  %500 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1013:                                             ; preds = %1006, %511
  call void @hypre_Free(i8* %498, i32 1) #6
  call void @hypre_Free(i8* %500, i32 1) #6
  ...
  %1016 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
1060:                                             ; preds = %1056
  %1061 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1086:                                             ; preds = %1082, %1067
  ...
  %1089 = call i8* @hypre_CAlloc(i64 %1088, i64 4, i32 1) #6
  %1090 = bitcast i8* %1089 to i32*
  %1091 = call i8* @hypre_CAlloc(i64 %1088, i64 4, i32 1) #6
...
1124:                                             ; preds = %1117, %1101
  call void @hypre_Free(i8* %1061, i32 1) #6
  br label %1125
...
430:                                              ; preds = %420, %410
  ...
  %438 = call i8* @hypre_CAlloc(i64 %437, i64 8, i32 1) #6
...
442:                                              ; preds = %440, %430
  ...
  %444 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
  %445 = load i32*, i32** %91, align 8, !tbaa !31
  %446 = getelementptr inbounds i32, i32* %445, i64 %93
  %447 = load i32, i32* %446, align 4, !tbaa !28
  %448 = sext i32 %447 to i64
  %449 = call i8* @hypre_CAlloc(i64 %448, i64 4, i32 1) #6
  %450 = bitcast i8* %444 to i32*
  %451 = bitcast i8* %449 to i32*
  %452 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %88, i64 0, i32 4
...
490:                                              ; preds = %459, %442
  %491 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %88, i8* %449, i8* %444) #6
...
500:                                              ; preds = %490, %493
  %501 = call i8* @hypre_CAlloc(i64 %278, i64 4, i32 1) #6
  %502 = bitcast i8* %501 to i32*
  %503 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1029:                                             ; preds = %1022, %514
  call void @hypre_Free(i8* %501, i32 1) #6
  call void @hypre_Free(i8* %503, i32 1) #6
  ...
  %1032 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
1076:                                             ; preds = %1072
  %1077 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1102:                                             ; preds = %1098, %1083
  ...
  %1105 = call i8* @hypre_CAlloc(i64 %1104, i64 4, i32 1) #6
  %1106 = bitcast i8* %1105 to i32*
  %1107 = call i8* @hypre_CAlloc(i64 %1104, i64 4, i32 1) #6
...
1162:                                             ; preds = %1159, %1157
  ...
  call void @hypre_Free(i8* %438, i32 1) #6
  call void @hypre_Free(i8* %415, i32 1) #6
  call void @hypre_Free(i8* %413, i32 1) #6
  call void @hypre_Free(i8* %431, i32 1) #6
  call void @hypre_Free(i8* %433, i32 1) #6
  ...
  call void @hypre_Free(i8* %1164, i32 1) #6
  call void @hypre_Free(i8* %81, i32 1) #6
  call void @hypre_Free(i8* %97, i32 1) #6
  call void @hypre_Free(i8* %449, i32 1) #6
  call void @hypre_Free(i8* %279, i32 1) #6
  call void @hypre_Free(i8* %444, i32 1) #6
  call void @hypre_Free(i8* %272, i32 1) #6
  call void @hypre_Free(i8* %274, i32 1) #6
  call void @hypre_Free(i8* %276, i32 1) #6
...
86:                                               ; preds = %83, %77
  ...
  %96 = call i8* @hypre_CAlloc(i64 %95, i64 4, i32 1) #6
...
269:                                              ; preds = %263, %262
  ...
  %273 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
  %274 = bitcast i8* %273 to i32*
  %275 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
...
379:                                              ; preds = %376, %284
  ...
  %387 = call i8* @hypre_CAlloc(i64 %386, i64 4, i32 1) #6
  ...
  %394 = call i8* @hypre_CAlloc(i64 %383, i64 4, i32 1) #6
  %395 = bitcast i8* %394 to i32*
  %396 = sext i32 %381 to i64
  %397 = call i8* @hypre_CAlloc(i64 %396, i64 4, i32 1) #6
  %398 = bitcast i8* %397 to i32*
  %399 = mul nsw i32 %381, %29
  %400 = sext i32 %399 to i64
  %401 = call i8* @hypre_CAlloc(i64 %400, i64 8, i32 1) #6
...
409:                                              ; preds = %403, %379
  ...
  %412 = call i8* @hypre_CAlloc(i64 %411, i64 8, i32 1) #6
  %413 = bitcast i8* %412 to double*
  %414 = call i8* @hypre_CAlloc(i64 %411, i64 8, i32 1) #6
...
429:                                              ; preds = %419, %409
  %430 = call i8* @hypre_CAlloc(i64 %411, i64 8, i32 1) #6
  %431 = bitcast i8* %430 to double*
  %432 = call i8* @hypre_CAlloc(i64 %411, i64 8, i32 1) #6
  %433 = bitcast i8* %432 to double*
  %434 = call i8* @hypre_CAlloc(i64 %411, i64 8, i32 1) #6
...
438:                                              ; preds = %436, %429
  ...
  %440 = call i8* @hypre_CAlloc(i64 %79, i64 4, i32 1) #6
  ...
  %448 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %87, i64 0, i32 4
...
486:                                              ; preds = %455, %438
  %487 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %87, i8* %445, i8* %440) #6
...
507:                                              ; preds = %500, %496
  %508 = call i8* @hypre_CAlloc(i64 %277, i64 4, i32 1) #6
  %509 = bitcast i8* %508 to i32*
  %510 = call i8* @hypre_CAlloc(i64 %79, i64 4, i32 1) #6
...
991:                                              ; preds = %984, %521
  call void @hypre_Free(i8* %508, i32 1) #6
  call void @hypre_Free(i8* %510, i32 1) #6
  ...
  %994 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
1038:                                             ; preds = %1034
  %1039 = call i8* @hypre_CAlloc(i64 %79, i64 4, i32 1) #6
...
1064:                                             ; preds = %1060, %1045
  ...
  %1067 = call i8* @hypre_CAlloc(i64 %1066, i64 4, i32 1) #6
  %1068 = bitcast i8* %1067 to i32*
  %1069 = call i8* @hypre_CAlloc(i64 %1066, i64 4, i32 1) #6
...
1124:                                             ; preds = %1121, %1119
  ...
  call void @hypre_Free(i8* %414, i32 1) #6
  call void @hypre_Free(i8* %412, i32 1) #6
  call void @hypre_Free(i8* %430, i32 1) #6
  call void @hypre_Free(i8* %432, i32 1) #6
  call void @hypre_Free(i8* %434, i32 1) #6
  call void @hypre_Free(i8* %80, i32 1) #6
  %1126 = bitcast i32* %1105 to i8*
  call void @hypre_Free(i8* %1126, i32 1) #6
  ...
  call void @hypre_Free(i8* %273, i32 1) #6
...
496:                                              ; preds = %486, %489
  %497 = call i8* @hypre_CAlloc(i64 %277, i64 4, i32 1) #6
  %498 = bitcast i8* %497 to i32*
  %499 = call i8* @hypre_CAlloc(i64 %79, i64 4, i32 1) #6
...
980:                                              ; preds = %973, %510
  ...
  %983 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
1027:                                             ; preds = %1023
  %1028 = call i8* @hypre_CAlloc(i64 %79, i64 4, i32 1) #6
...
1053:                                             ; preds = %1049, %1034
  ...
  %1056 = call i8* @hypre_CAlloc(i64 %1055, i64 4, i32 1) #6
  %1057 = bitcast i8* %1056 to i32*
  %1058 = call i8* @hypre_CAlloc(i64 %1055, i64 4, i32 1) #6
...
1091:                                             ; preds = %1084, %1068
  call void @hypre_Free(i8* %1028, i32 1) #6
  br label %1092
...
1113:                                             ; preds = %1110, %1108
  ...
  call void @hypre_Free(i8* %1115, i32 1) #6
  call void @hypre_Free(i8* %445, i32 1) #6
  call void @hypre_Free(i8* %96, i32 1) #6
  call void @hypre_Free(i8* %278, i32 1) #6
  call void @hypre_Free(i8* %440, i32 1) #6
...
81:                                               ; preds = %78, %72
  ...
  %91 = call i8* @hypre_CAlloc(i64 %90, i64 4, i32 1) #6
...
139:                                              ; preds = %133, %130
  ...
  %143 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
  %144 = bitcast i8* %143 to i32*
  %145 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
  %146 = bitcast i8* %145 to i32*
  %147 = sext i32 %53 to i64
  %148 = call i8* @hypre_CAlloc(i64 %147, i64 4, i32 1) #6
...
249:                                              ; preds = %246, %154
  ...
  %254 = call i8* @hypre_CAlloc(i64 %253, i64 4, i32 1) #6
  %255 = bitcast i8* %254 to i32*
  %256 = sext i32 %250 to i64
  %257 = call i8* @hypre_CAlloc(i64 %256, i64 4, i32 1) #6
  %258 = bitcast i8* %257 to i32*
  %259 = mul nsw i32 %250, %29
  %260 = sext i32 %259 to i64
  %261 = call i8* @hypre_CAlloc(i64 %260, i64 8, i32 1) #6
  %262 = bitcast i8* %261 to double*
  %263 = getelementptr inbounds i32, i32* %255, i64 %147
  store i32 %250, i32* %263, align 4, !tbaa !28
  %264 = call i8* @hypre_CAlloc(i64 %253, i64 4, i32 1) #6
  %265 = bitcast i8* %264 to i32*
  %266 = sext i32 %251 to i64
  %267 = call i8* @hypre_CAlloc(i64 %266, i64 4, i32 1) #6
  %268 = bitcast i8* %267 to i32*
  %269 = mul nsw i32 %251, %29
  %270 = sext i32 %269 to i64
  %271 = call i8* @hypre_CAlloc(i64 %270, i64 8, i32 1) #6
...
279:                                              ; preds = %273, %249
  ...
  %282 = call i8* @hypre_CAlloc(i64 %281, i64 8, i32 1) #6
...
299:                                              ; preds = %289, %279
  %300 = call i8* @hypre_CAlloc(i64 %281, i64 8, i32 1) #6
  %301 = bitcast i8* %300 to double*
  %302 = call i8* @hypre_CAlloc(i64 %281, i64 8, i32 1) #6
  %303 = bitcast i8* %302 to double*
  %304 = call i8* @hypre_CAlloc(i64 %281, i64 8, i32 1) #6
  %305 = bitcast i8* %304 to double*
  %306 = call i8* @hypre_CAlloc(i64 %281, i64 8, i32 1) #6
...
310:                                              ; preds = %308, %299
  ...
  %312 = call i8* @hypre_CAlloc(i64 %74, i64 4, i32 1) #6
  ...
  %319 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %82, i64 0, i32 4
...
357:                                              ; preds = %326, %310
  %358 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %82, i8* %317, i8* %312) #6
...
367:                                              ; preds = %357, %360
  %368 = call i8* @hypre_CAlloc(i64 %147, i64 4, i32 1) #6
  %369 = bitcast i8* %368 to i32*
  %370 = call i8* @hypre_CAlloc(i64 %74, i64 4, i32 1) #6
...
618:                                              ; preds = %612, %381
  call void @hypre_Free(i8* %368, i32 1) #6
  call void @hypre_Free(i8* %370, i32 1) #6
  ...
  %621 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
665:                                              ; preds = %661
  %666 = call i8* @hypre_CAlloc(i64 %74, i64 4, i32 1) #6
...
691:                                              ; preds = %687, %672
  ...
  %694 = call i8* @hypre_CAlloc(i64 %693, i64 4, i32 1) #6
  %695 = bitcast i8* %694 to i32*
  %696 = call i8* @hypre_CAlloc(i64 %693, i64 4, i32 1) #6
...
729:                                              ; preds = %722, %706
  call void @hypre_Free(i8* %666, i32 1) #6
  br label %730
...
751:                                              ; preds = %748, %746
  ...
  call void @hypre_Free(i8* %304, i32 1) #6
  ...
  call void @hypre_Free(i8* %754, i32 1) #6
  call void @hypre_Free(i8* null, i32 1) #6
  call void @hypre_Free(i8* %91, i32 1) #6
  call void @hypre_Free(i8* %317, i32 1) #6
  call void @hypre_Free(i8* %148, i32 1) #6
  call void @hypre_Free(i8* %312, i32 1) #6
  call void @hypre_Free(i8* %141, i32 1) #6
  call void @hypre_Free(i8* %143, i32 1) #6
...
!22 = !{!23, !8, i64 0}
!23 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80}
!24 = !{!23, !8, i64 8}
!25 = !{!21, !8, i64 40}
!26 = !{!13, !5, i64 36}
!27 = !{!4, !5, i64 12}

...
655:                                              ; preds = %650, %615
  ...
  %710 = getelementptr inbounds i8, i8* %698, i64 408
  ...
  %738 = getelementptr inbounds i8, i8* %698, i64 336
  %739 = bitcast i8* %738 to %struct.hypre_ParCSRMatrix_struct***
  %740 = getelementptr inbounds i8, i8* %698, i64 360
  %741 = bitcast i8* %740 to %struct.hypre_ParCSRMatrix_struct***
  %742 = getelementptr inbounds i8, i8* %698, i64 368
  %743 = bitcast i8* %742 to %struct.hypre_ParCSRMatrix_struct***
  %744 = getelementptr inbounds i8, i8* %698, i64 344
  %745 = bitcast i8* %744 to %struct.hypre_ParVector_struct***
  %746 = getelementptr inbounds i8, i8* %698, i64 352
  %747 = bitcast i8* %746 to %struct.hypre_ParVector_struct***
  %748 = getelementptr inbounds i8, i8* %698, i64 376
  %749 = bitcast i8* %748 to i32***
  %750 = getelementptr inbounds i8, i8* %698, i64 248
  %751 = bitcast i8* %750 to double**
  %752 = getelementptr inbounds i8, i8* %698, i64 256

...
define dso_local %struct.hypre_NumbersNode* @hypre_NumbersNewNode() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 88, i32 1) #4
...
9:                                                ; preds = %2
  %10 = call i8* @hypre_CAlloc(i64 1, i64 88, i32 1) #4
...
20:                                               ; preds = %16
  %21 = call i8* @hypre_CAlloc(i64 1, i64 88, i32 1) #4
...
define dso_local i32* @hypre_NumbersArray(%struct.hypre_NumbersNode* %0) local_unnamed_addr #0 {
  ...
  %3 = sext i32 %2 to i64
  %4 = call i8* @hypre_CAlloc(i64 %3, i64 4, i32 1) #4

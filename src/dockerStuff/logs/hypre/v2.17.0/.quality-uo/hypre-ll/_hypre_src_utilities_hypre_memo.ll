...
@.str = private unnamed_addr constant [36 x i8] c"/hypre/src/utilities/hypre_memory.c\00", align 1
@.str.1 = private unnamed_addr constant [143 x i8] c"Wrong HYPRE MEMORY location: \0A Only HYPRE_MEMORY_HOST, HYPRE_MEMORY_DEVICE, HYPRE_MEMORY_SHARED,\0A and HYPRE_MEMORY_HOST_PINNED are supported!\0A\00", align 1
@stdout = external dso_local local_unnamed_addr global %struct._IO_FILE*, align 8
@.str.2 = private unnamed_addr constant [49 x i8] c"Out of memory trying to allocate too many bytes\0A\00", align 1
...
8:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 84, i32 2, i8* getelementptr inbounds ([143 x i8], [143 x i8]* @.str.1, i64 0, i64 0)) #10
...
33:                                               ; preds = %30
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 77, i32 2, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.2, i64 0, i64 0)) #10

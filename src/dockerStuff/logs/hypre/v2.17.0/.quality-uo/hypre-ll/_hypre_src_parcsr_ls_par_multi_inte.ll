...
define dso_local i32 @hypre_BoomerAMGBuildMultipass(%struct.hypre_ParCSRMatrix_struct* %0, i32* nocapture %1, %struct.hypre_ParCSRMatrix_struct* nocapture readonly %2, i32* %3, i32 %4, i32* nocapture readonly %5, i32 %6, double %7, i32 %8, i32 %9, i32* readnone %10, %struct.hypre_ParCSRMatrix_struct** nocapture %11) local_unnamed_addr #0 {
  ...
  %59 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #4
...
120:                                              ; preds = %115
  ...
  %122 = call i8* @hypre_CAlloc(i64 %121, i64 4, i32 1) #4
...
150:                                              ; preds = %144
  ...
  %152 = call i8* @hypre_CAlloc(i64 %151, i64 4, i32 1) #4
  %153 = bitcast i8* %152 to i32*
  br label %154

154:                                              ; preds = %150, %144
  %155 = phi i32* [ %153, %150 ], [ null, %144 ]
  %156 = call i8* @hypre_CAlloc(i64 11, i64 4, i32 1) #4
  %157 = bitcast i8* %156 to i32*
  br i1 %119, label %162, label %158

158:                                              ; preds = %154
  %159 = sext i32 %118 to i64
  %160 = call i8* @hypre_CAlloc(i64 %159, i64 4, i32 1) #4
...
162:                                              ; preds = %158, %154
  ...
  %166 = call i8* @hypre_CAlloc(i64 %165, i64 4, i32 2) #4
  %167 = bitcast i8* %166 to i32*
  %168 = call i8* @hypre_CAlloc(i64 %165, i64 4, i32 2) #4
...
177:                                              ; preds = %175
  ...
  %179 = call i8* @hypre_CAlloc(i64 %178, i64 4, i32 1) #4
  %180 = bitcast i8* %179 to i32*
  %181 = icmp sgt i32 %4, 1
  br i1 %181, label %182, label %185

182:                                              ; preds = %177
  %183 = call i8* @hypre_CAlloc(i64 %178, i64 4, i32 1) #4
...
209:                                              ; preds = %190
  ...
  %215 = call i8* @hypre_CAlloc(i64 %214, i64 4, i32 1) #4
...
264:                                              ; preds = %261
  ...
  %267 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %97, i8* %265, i8* %266) #4
...
309:                                              ; preds = %306
  ...
  %312 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %97, i8* %310, i8* %311) #4
...
330:                                              ; preds = %328
  ...
  %332 = call i8* @hypre_CAlloc(i64 %331, i64 4, i32 1) #4
  %333 = bitcast i8* %332 to i32*
  %334 = call i8* @hypre_CAlloc(i64 %331, i64 4, i32 1) #4
  %335 = bitcast i8* %334 to i32*
  %336 = call i8* @hypre_CAlloc(i64 %331, i64 4, i32 1) #4
  %337 = bitcast i8* %336 to i32*
  %338 = sext i32 %329 to i64
  %339 = call i8* @hypre_CAlloc(i64 %338, i64 4, i32 1) #4
...
428:                                              ; preds = %425
  ...
  %431 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %97, i8* %429, i8* %430) #4
...
433:                                              ; preds = %428, %425
  ...
  %436 = call i8* @hypre_CAlloc(i64 %435, i64 4, i32 1) #4
...
439:                                              ; preds = %433
  ...
  %441 = call i8* @hypre_CAlloc(i64 %440, i64 4, i32 1) #4
...
489:                                              ; preds = %485, %443
  ...
  call void @hypre_Free(i8* %490, i32 1) #4
  br i1 %99, label %518, label %491

491:                                              ; preds = %489
  %492 = sext i32 %37 to i64
  %493 = call i8* @hypre_CAlloc(i64 %492, i64 4, i32 1) #4
...
651:                                              ; preds = %648
  ...
  %654 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %97, i8* %652, i8* %653) #4
...
803:                                              ; preds = %800
  %804 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %97, i8* %660, i8* %661) #4
...
832:                                              ; preds = %813
  %833 = call i8* @hypre_CAlloc(i64 %817, i64 8, i32 1) #4
...
836:                                              ; preds = %832
  ...
  %838 = call i8* @hypre_CAlloc(i64 %837, i64 4, i32 1) #4
...
844:                                              ; preds = %841, %836
  %845 = call i8* @hypre_CAlloc(i64 %817, i64 8, i32 1) #4
  %846 = bitcast i8* %845 to i32**
  %847 = add nuw nsw i32 %814, 1
  %848 = zext i32 %847 to i64
  %849 = call i8* @hypre_CAlloc(i64 %848, i64 4, i32 1) #4
...
947:                                              ; preds = %941
  %948 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #4
  %949 = bitcast i8* %948 to %struct.hypre_ParCSRCommPkg*
  %950 = call i8* @hypre_CAlloc(i64 %817, i64 8, i32 1) #4
  %951 = bitcast i8* %950 to i32**
  %952 = call i8* @hypre_CAlloc(i64 %817, i64 8, i32 1) #4
  %953 = bitcast i8* %952 to i32**
  %954 = call i8* @hypre_CAlloc(i64 %817, i64 8, i32 1) #4
...
960:                                              ; preds = %947
  ...
  %962 = call i8* @hypre_CAlloc(i64 %961, i64 4, i32 1) #4
...
970:                                              ; preds = %964
  ...
  %972 = call i8* @hypre_CAlloc(i64 %971, i64 4, i32 1) #4
...
991:                                              ; preds = %984, %981, %941
  ...
  %998 = phi %struct.hypre_ParCSRCommPkg* [ undef, %941 ], [ %949, %981 ], [ %949, %984 ]
  ...
  %1007 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 0
  %1008 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 1
  %1009 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 2
  %1010 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 3
  %1011 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 5
  %1012 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 6
  %1013 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 7
...
1096:                                             ; preds = %1092, %1046
  ...
  %1098 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %97, i8* %1002, i8* nonnull %1004) #4
...
1101:                                             ; preds = %1096
  ...
  call void @hypre_Free(i8* %1102, i32 1) #4
  %1103 = sext i32 %1097 to i64
  %1104 = call i8* @hypre_CAlloc(i64 %1103, i64 4, i32 1) #4
...
1272:                                             ; preds = %1270
  ...
  %1275 = call i8* @hypre_CAlloc(i64 %1274, i64 4, i32 1) #4
  %1276 = bitcast i8* %1275 to i32*
  %1277 = bitcast i32* %1042 to i8*
  call void @hypre_Free(i8* %1277, i32 1) #4
  %1278 = call i8* @hypre_CAlloc(i64 %1274, i64 4, i32 1) #4
...
1280:                                             ; preds = %1272, %1270
  ...
  %1285 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %998, i8* %1283, i8* %1284) #4
...
1443:                                             ; preds = %1439, %1432
  ...
  %1453 = call i8* @hypre_CAlloc(i64 %1015, i64 4, i32 1) #4
...
1458:                                             ; preds = %1456
  ...
  %1460 = call i8* @hypre_CAlloc(i64 %1459, i64 4, i32 1) #4
...
1467:                                             ; preds = %1466
  %1468 = call i8* @hypre_CAlloc(i64 %1017, i64 4, i32 1) #4
...
1682:                                             ; preds = %1665, %1660
  ...
  %1693 = call i8* @hypre_CAlloc(i64 %1692, i64 4, i32 1) #4
...
1697:                                             ; preds = %1682
  ...
  %1699 = call i8* @hypre_CAlloc(i64 %1698, i64 4, i32 1) #4
...
1905:                                             ; preds = %1901, %991
  ...
  call void @hypre_Free(i8* %1913, i32 1) #4
  %1914 = bitcast i32* %995 to i8*
  call void @hypre_Free(i8* %1914, i32 1) #4
  %1915 = bitcast i32* %1909 to i8*
  call void @hypre_Free(i8* %1915, i32 1) #4
  %1916 = bitcast i32* %1907 to i8*
  call void @hypre_Free(i8* %1916, i32 1) #4
  call void @hypre_Free(i8* %436, i32 1) #4
  call void @hypre_Free(i8* %59, i32 1) #4
  call void @hypre_Free(i8* %63, i32 1) #4
  call void @hypre_Free(i8* %57, i32 1) #4
  %1917 = sext i32 %1910 to i64
  %1918 = call i8* @hypre_CAlloc(i64 %1917, i64 4, i32 2) #4
  %1919 = bitcast i8* %1918 to i32*
  %1920 = call i8* @hypre_CAlloc(i64 %1917, i64 8, i32 2) #4
...
1923:                                             ; preds = %1905
  ...
  %1925 = call i8* @hypre_CAlloc(i64 %1924, i64 4, i32 2) #4
  %1926 = bitcast i8* %1925 to i32*
  %1927 = call i8* @hypre_CAlloc(i64 %1924, i64 8, i32 2) #4
...
1996:                                             ; preds = %1991
  %1997 = call i8* @hypre_CAlloc(i64 %825, i64 4, i32 1) #4
...
2004:                                             ; preds = %2003
  ...
  %2006 = call i8* @hypre_CAlloc(i64 %2005, i64 4, i32 1) #4
...
2286:                                             ; preds = %2283, %2012
  ...
  call void @hypre_Free(i8* %1997, i32 1) #4
...
2293:                                             ; preds = %2291
  ...
  call void @hypre_Free(i8* %2294, i32 1) #4
  br label %2295

2295:                                             ; preds = %2293, %2291
  %2296 = bitcast i32* %444 to i8*
  call void @hypre_Free(i8* %2296, i32 1) #4
  %2297 = load i8*, i8** %824, align 8, !tbaa !55
  call void @hypre_Free(i8* %2297, i32 1) #4
...
2300:                                             ; preds = %2295
  ...
  call void @hypre_Free(i8* %2303, i32 1) #4
...
2304:                                             ; preds = %2300, %2295
  ...
  %2307 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 1
  %2308 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 3
  %2309 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 5
  %2310 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 7
...
2348:                                             ; preds = %2342
  ...
  call void @hypre_Free(i8* %2349, i32 1) #4
  %2350 = sext i32 %2346 to i64
  %2351 = call i8* @hypre_CAlloc(i64 %2350, i64 8, i32 1) #4
...
2438:                                             ; preds = %2430
  ...
  call void @hypre_Free(i8* %2439, i32 1) #4
  %2440 = sext i32 %2436 to i64
  %2441 = call i8* @hypre_CAlloc(i64 %2440, i64 8, i32 1) #4
...
2443:                                             ; preds = %2438, %2430
  ...
  %2447 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %998, i8* %2445, i8* %2446) #4
...
2453:                                             ; preds = %2443, %2331
  ...
  %2464 = call i8* @hypre_CAlloc(i64 %825, i64 4, i32 1) #4
...
2468:                                             ; preds = %2467
  %2469 = call i8* @hypre_CAlloc(i64 %2313, i64 4, i32 1) #4
...
2474:                                             ; preds = %2472
  %2475 = call i8* @hypre_CAlloc(i64 %2315, i64 4, i32 1) #4
...
2479:                                             ; preds = %2477
  %2480 = call i8* @hypre_CAlloc(i64 %2330, i64 4, i32 1) #4
...
2924:                                             ; preds = %2921, %2482
  ...
  call void @hypre_Free(i8* %2927, i32 1) #4
  %2928 = bitcast i32* %2483 to i8*
  call void @hypre_Free(i8* %2928, i32 1) #4
  call void @hypre_Free(i8* %2464, i32 1) #4
  br i1 %111, label %2931, label %2929

2929:                                             ; preds = %2924
  %2930 = bitcast i32* %2473 to i8*
  call void @hypre_Free(i8* %2930, i32 1) #4
  br label %2931
...
2931:                                             ; preds = %2929, %2924
  ...
  call void @hypre_Free(i8* %2935, i32 1) #4
...
2938:                                             ; preds = %2931
  ...
  call void @hypre_Free(i8* %2941, i32 1) #4
  ...
  call void @hypre_Free(i8* %2944, i32 1) #4
...
2948:                                             ; preds = %2947
  %2949 = call i8* @hypre_CAlloc(i64 %825, i64 4, i32 1) #4
...
2954:                                             ; preds = %2951
  ...
  %2956 = call i8* @hypre_CAlloc(i64 %2955, i64 4, i32 1) #4
...
3203:                                             ; preds = %3200, %2970
  ...
  call void @hypre_Free(i8* %3205, i32 1) #4
...
3207:                                             ; preds = %3203
  ...
  call void @hypre_Free(i8* %3208, i32 1) #4
  br label %3209

3209:                                             ; preds = %3207, %3203
  %3210 = bitcast i32* %444 to i8*
  call void @hypre_Free(i8* %3210, i32 1) #4
  %3211 = load i8*, i8** %824, align 8, !tbaa !55
  call void @hypre_Free(i8* %3211, i32 1) #4
  store i32* null, i32** %823, align 8, !tbaa !55
...
3214:                                             ; preds = %3209
  ...
  call void @hypre_Free(i8* %3217, i32 1) #4
...
3218:                                             ; preds = %3214, %3209
  ...
  %3221 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 1
  %3222 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 3
  %3223 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 5
  %3224 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %998, i64 0, i32 7
...
3258:                                             ; preds = %3252
  ...
  call void @hypre_Free(i8* %3259, i32 1) #4
  %3260 = sext i32 %3256 to i64
  %3261 = call i8* @hypre_CAlloc(i64 %3260, i64 8, i32 1) #4
...
3348:                                             ; preds = %3340
  ...
  call void @hypre_Free(i8* %3349, i32 1) #4
  %3350 = sext i32 %3346 to i64
  %3351 = call i8* @hypre_CAlloc(i64 %3350, i64 8, i32 1) #4
...
3353:                                             ; preds = %3348, %3340
  ...
  %3357 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %998, i8* %3355, i8* %3356) #4
...
3374:                                             ; preds = %3363
  %3375 = call i8* @hypre_CAlloc(i64 %825, i64 4, i32 1) #4
...
3380:                                             ; preds = %3377
  %3381 = call i8* @hypre_CAlloc(i64 %3226, i64 4, i32 1) #4
...
3386:                                             ; preds = %3383
  %3387 = call i8* @hypre_CAlloc(i64 %3227, i64 4, i32 1) #4
  %3388 = bitcast i8* %3387 to i32*
  br label %3389

3389:                                             ; preds = %3386, %3383
  %3390 = phi i32* [ %3388, %3386 ], [ null, %3383 ]
  %3391 = call i8* @hypre_CAlloc(i64 %3242, i64 4, i32 1) #4
...
3777:                                             ; preds = %3767
  ...
  call void @hypre_Free(i8* %3780, i32 1) #4
  ...
  call void @hypre_Free(i8* %3783, i32 1) #4
...
3786:                                             ; preds = %2945, %3784, %2304, %3218
  ...
  call void @hypre_Free(i8* %818, i32 1) #4
  ...
  call void @hypre_Free(i8* %826, i32 1) #4
  call void @hypre_Free(i8* %828, i32 1) #4
  ...
  call void @hypre_Free(i8* %3801, i32 1) #4
  call void @hypre_Free(i8* %156, i32 1) #4
  %3802 = bitcast i32* %155 to i8*
  call void @hypre_Free(i8* %3802, i32 1) #4
  %3803 = bitcast i32* %342 to i8*
  call void @hypre_Free(i8* %3803, i32 1) #4
...
3807:                                             ; preds = %3786
  %3808 = bitcast %struct.hypre_ParCSRCommPkg* %998 to i8*
  call void @hypre_Free(i8* %3808, i32 1) #4
  br label %3809
...
3809:                                             ; preds = %3807, %3786
  ...
  %3813 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 13
  ...
  %3832 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3819, i64 0, i32 17
...
3847:                                             ; preds = %3841
  ...
  %3851 = call i8* @hypre_CAlloc(i64 %3850, i64 4, i32 1) #4
...
3876:                                             ; preds = %3872, %3857
  ...
  %3879 = call i8* @hypre_CAlloc(i64 %3878, i64 4, i32 1) #4
  ...
  %3886 = call i8* @hypre_CAlloc(i64 %3885, i64 4, i32 1) #4
  %3887 = bitcast i8* %3886 to i32*
  %3888 = load i32, i32* %3883, align 4, !tbaa !19
  %3889 = sext i32 %3888 to i64
  %3890 = call i8* @hypre_CAlloc(i64 %3889, i64 4, i32 1) #4
...
3971:                                             ; preds = %3962, %3945
  call void @hypre_Free(i8* %3851, i32 1) #4
  br label %3972
...
3989:                                             ; preds = %3982, %3972
  call void @hypre_Free(i8* %3974, i32 1) #4
  call void @hypre_Free(i8* %3975, i32 1) #4
  %3990 = bitcast i32** %855 to i8*
  call void @hypre_Free(i8* %3990, i32 1) #4
  %3991 = bitcast i32* %856 to i8*
  call void @hypre_Free(i8* %3991, i32 1) #4

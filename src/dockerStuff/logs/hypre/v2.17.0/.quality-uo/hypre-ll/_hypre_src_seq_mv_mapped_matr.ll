...
@.str = private unnamed_addr constant [29 x i8] c"Stub for hypre_MappedMatrix\0A\00", align 1
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %5, i32 1) #5
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* nonnull %4, i32 1) #5
  br label %5
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_MappedMatrixPrint(%struct.hypre_MappedMatrix* nocapture readnone %0) local_unnamed_addr #0 {
  %2 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0)) #5
  ret void
}
...
define dso_local i32 @hypre_MappedMatrixSetMatrix(%struct.hypre_MappedMatrix* nocapture %0, i8* %1) local_unnamed_addr #4 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_MappedMatrixSetColMap(%struct.hypre_MappedMatrix* nocapture %0, i32 (i32, i8*)* %1) local_unnamed_addr #4 {
  %3 = getelementptr inbounds %struct.hypre_MappedMatrix, %struct.hypre_MappedMatrix* %0, i64 0, i32 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_MappedMatrixSetMapData(%struct.hypre_MappedMatrix* nocapture %0, i8* %1) local_unnamed_addr #4 {

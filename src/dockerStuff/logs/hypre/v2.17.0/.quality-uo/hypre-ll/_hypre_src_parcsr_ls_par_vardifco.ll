...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateVarDifConv(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, double %10, %struct.hypre_ParVector_struct** nocapture %11) local_unnamed_addr #0 {
  ...
  %56 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4
  ...
  %79 = call i8* @hypre_CAlloc(i64 %78, i64 4, i32 2) #4
  %80 = bitcast i8* %79 to i32*
  %81 = call i8* @hypre_CAlloc(i64 %78, i64 4, i32 2) #4
  %82 = bitcast i8* %81 to i32*
  %83 = sext i32 %55 to i64
  %84 = call i8* @hypre_CAlloc(i64 %83, i64 8, i32 2) #4
...
248:                                              ; preds = %242, %12
  ...
  %252 = call i8* @hypre_CAlloc(i64 %251, i64 4, i32 2) #4
  %253 = bitcast i8* %252 to i32*
  %254 = load i32, i32* %249, align 4, !tbaa !7
  %255 = sext i32 %254 to i64
  %256 = call i8* @hypre_CAlloc(i64 %255, i64 8, i32 2) #4
...
260:                                              ; preds = %248
  ...
  %268 = call i8* @hypre_CAlloc(i64 %267, i64 4, i32 2) #4
  %269 = bitcast i8* %268 to i32*
  %270 = load i32, i32* %261, align 4, !tbaa !7
  %271 = sext i32 %270 to i64
  %272 = call i8* @hypre_CAlloc(i64 %271, i64 8, i32 2) #4
...
859:                                              ; preds = %856, %833
  ...
  call void @hypre_Free(i8* %860, i32 1) #4
  br label %861
...
861:                                              ; preds = %859, %819
  ...
  %865 = bitcast %struct.hypre_Vector** %864 to i8***
  %866 = load i8**, i8*** %865, align 8, !tbaa !24
  store i8* %84, i8** %866, align 8, !tbaa !25
  %867 = load i32, i32* %249, align 4, !tbaa !7
  %868 = getelementptr inbounds i32, i32* %82, i64 %83
  %869 = load i32, i32* %868, align 4, !tbaa !7
  %870 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %0, i32 %23, i32 %23, i32* nonnull %57, i32* nonnull %57, i32 %115, i32 %867, i32 %869) #4
  %871 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %870, i64 0, i32 11
  %872 = bitcast i32** %871 to i8**
  store i8* %117, i8** %872, align 8, !tbaa !27
  %873 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %870, i64 0, i32 7
  %874 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %873, align 8, !tbaa !29
  %875 = bitcast %struct.hypre_CSRMatrix* %874 to i8**
  store i8* %79, i8** %875, align 8, !tbaa !30
  %876 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %874, i64 0, i32 1
  %877 = bitcast i32** %876 to i8**
  store i8* %252, i8** %877, align 8, !tbaa !32
  %878 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %874, i64 0, i32 9
  %879 = bitcast double** %878 to i8**
  store i8* %256, i8** %879, align 8, !tbaa !33
  %880 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %870, i64 0, i32 8
  %881 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %880, align 8, !tbaa !34
  %882 = bitcast %struct.hypre_CSRMatrix* %881 to i8**
  store i8* %81, i8** %882, align 8, !tbaa !30
  %883 = icmp eq i32 %115, 0
  br i1 %883, label %887, label %884

884:                                              ; preds = %861
  %885 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %881, i64 0, i32 1
  store i32* %277, i32** %885, align 8, !tbaa !32
  %886 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %881, i64 0, i32 9
  store double* %275, double** %886, align 8, !tbaa !33
  br label %887

887:                                              ; preds = %884, %861
  %888 = bitcast i32** %13 to i8**
  %889 = load i8*, i8** %888, align 8, !tbaa !3
  call void @hypre_Free(i8* %889, i32 1) #4
  store i32* null, i32** %13, align 8, !tbaa !3
  %890 = bitcast i32** %14 to i8**
  %891 = load i8*, i8** %890, align 8, !tbaa !3
  call void @hypre_Free(i8* %891, i32 1) #4
  store i32* null, i32** %14, align 8, !tbaa !3
  %892 = bitcast i32** %15 to i8**
  %893 = load i8*, i8** %892, align 8, !tbaa !3
  call void @hypre_Free(i8* %893, i32 1) #4
  ...
  ret %struct.hypre_ParCSRMatrix_struct* %870
}
...
!24 = !{!23, !4, i64 32}
!25 = !{!26, !4, i64 0}
!26 = !{!"", !4, i64 0, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28}
!27 = !{!28, !4, i64 64}
!28 = !{!"hypre_ParCSRMatrix_struct", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !4, i64 72, !4, i64 80, !4, i64 88, !4, i64 96, !8, i64 104, !8, i64 108, !8, i64 112, !8, i64 116, !17, i64 120, !4, i64 128, !4, i64 136, !8, i64 144, !4, i64 152}
!29 = !{!28, !4, i64 32}
!30 = !{!31, !4, i64 0}
!31 = !{!"", !4, i64 0, !4, i64 8, !4, i64 16, !8, i64 24, !8, i64 28, !8, i64 32, !4, i64 40, !4, i64 48, !8, i64 56, !4, i64 64, !4, i64 72, !8, i64 80}
!32 = !{!31, !4, i64 8}
!33 = !{!31, !4, i64 64}
!34 = !{!28, !4, i64 40}

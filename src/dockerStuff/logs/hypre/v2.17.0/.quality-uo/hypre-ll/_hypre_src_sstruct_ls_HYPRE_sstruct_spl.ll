...
define dso_local i32 @HYPRE_SStructSplitCreate(i32 %0, %struct.hypre_SStructSolver_struct** nocapture %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_MAlloc(i64 104, i32 1) #6
...
50:                                               ; preds = %45, %31
  ...
  call void @hypre_Free(i8* %54, i32 1) #6
...
69:                                               ; preds = %50, %22
  ...
  call void @hypre_Free(i8* %72, i32 1) #6
...
84:                                               ; preds = %69, %3
  ...
  call void @hypre_Free(i8* %86, i32 1) #6
  ...
  call void @hypre_Free(i8* %89, i32 1) #6
  ...
  call void @hypre_Free(i8* nonnull %93, i32 1) #6
  br label %94
...
define dso_local i32 @HYPRE_SStructSplitSetup(%struct.hypre_SStructSolver_struct* %0, %struct.hypre_SStructMatrix_struct* %1, %struct.hypre_SStructVector_struct* nocapture readonly %2, %struct.hypre_SStructVector_struct* %3) local_unnamed_addr #0 {
  ...
  %23 = shl nsw i64 %22, 2
  %24 = call i8* @hypre_MAlloc(i64 %23, i32 1) #6
  %25 = bitcast i8* %24 to i32*
  %26 = shl nsw i64 %22, 3
  %27 = call i8* @hypre_MAlloc(i64 %26, i32 1) #6
  %28 = bitcast i8* %27 to i8****
  %29 = call i8* @hypre_MAlloc(i64 %26, i32 1) #6
  %30 = bitcast i8* %29 to i32 (...)***
  %31 = call i8* @hypre_MAlloc(i64 %26, i32 1) #6
  %32 = bitcast i8* %31 to i32 (...)***
  %33 = call i8* @hypre_MAlloc(i64 %26, i32 1) #6
...
46:                                               ; preds = %44, %224
  ...
  %69 = shl nsw i64 %68, 3
  %70 = call i8* @hypre_MAlloc(i64 %69, i32 1) #6
  ...
  %81 = shl nsw i64 %80, 3
  %82 = call i8* @hypre_MAlloc(i64 %81, i32 1) #6

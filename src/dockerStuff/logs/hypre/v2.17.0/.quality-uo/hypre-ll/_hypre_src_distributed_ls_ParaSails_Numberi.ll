...
define dso_local %struct.numbering* @NumberingCreate(%struct.Matrix* %0, i32 %1) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 40, i32 1) #5
  ...
  %27 = shl nsw i64 %26, 2
  %28 = call i8* @hypre_MAlloc(i64 %27, i32 1) #5
...
78:                                               ; preds = %75
  ...
  %84 = shl nsw i64 %83, 2
  %85 = call i8* @hypre_ReAlloc(i8* %80, i64 %84, i32 1) #5
...
define dso_local %struct.numbering* @NumberingCreateCopy(%struct.numbering* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_MAlloc(i64 40, i32 1) #5
  ...
  %25 = shl nsw i64 %24, 2
  %26 = call i8* @hypre_MAlloc(i64 %25, i32 1) #5
  ...
  %34 = shl nsw i64 %33, 2
  call void @hypre_Memcpy(i8* %26, i8* %31, i64 %34, i32 1, i32 1) #5

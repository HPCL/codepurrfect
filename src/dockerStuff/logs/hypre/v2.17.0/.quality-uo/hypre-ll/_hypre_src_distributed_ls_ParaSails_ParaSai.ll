...
define dso_local i32 @FindNumReplies(i32 %0, i32* %1) local_unnamed_addr #0 {
  ...
  %11 = shl nsw i64 %10, 2
  %12 = call i8* @hypre_MAlloc(i64 %11, i32 1) #8
...
define dso_local %struct.ParaSails* @ParaSailsCreate(i32 %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  ...
  %8 = call i8* @hypre_MAlloc(i64 112, i32 1) #8
...
88:                                               ; preds = %78, %49
  %89 = call i8* @hypre_MAlloc(i64 40, i32 1) #8
...
96:                                               ; preds = %88, %160
  ...
  %105 = call i8* @hypre_CAlloc(i64 %104, i64 4, i32 1) #8
  ...
  %114 = call i8* @hypre_MAlloc(i64 %113, i32 1) #8
...
139:                                              ; preds = %130
  ...
  %144 = call i8* @hypre_MAlloc(i64 %143, i32 1) #8
...
define internal fastcc double @SelectThresh(i32 %0, %struct.Matrix* %1, %struct.DiagScale* %2, double %3) unnamed_addr #0 {
  ...
  %17 = call i8* @hypre_MAlloc(i64 80, i32 1) #8
...
101:                                              ; preds = %91, %62
  %102 = call i8* @hypre_MAlloc(i64 40, i32 1) #8
...
109:                                              ; preds = %101, %173
  ...
  %127 = call i8* @hypre_MAlloc(i64 %126, i32 1) #8
...
152:                                              ; preds = %143
  ...
  %157 = call i8* @hypre_MAlloc(i64 %156, i32 1) #8
...
177:                                              ; preds = %173, %101
  ...
  %192 = call i8* @hypre_MAlloc(i64 %191, i32 1) #8
  %193 = bitcast i8* %192 to i32*
  %194 = load i32, i32* %18, align 4, !tbaa !3
  %195 = sext i32 %194 to i64
  %196 = mul nsw i64 %195, 20
  %197 = call i8* @hypre_MAlloc(i64 %196, i32 1) #8
...
236:                                              ; preds = %233, %203
  %237 = call i8* @hypre_MAlloc(i64 40, i32 1) #8
  ...
  %255 = call i8* @hypre_MAlloc(i64 %254, i32 1) #8
...
281:                                              ; preds = %272
  ...
  %286 = call i8* @hypre_MAlloc(i64 %285, i32 1) #8
...
161:                                              ; preds = %156, %115
  ...
  %166 = call i8* @hypre_CAlloc(i64 %165, i64 4, i32 1) #8
  ...
  %177 = call i8* @hypre_MAlloc(i64 %176, i32 1) #8
...
186:                                              ; preds = %161
  ...
  %189 = call i8* @hypre_MAlloc(i64 %188, i32 1) #8
...
194:                                              ; preds = %186, %161
  ...
  %197 = call i8* @hypre_MAlloc(i64 40, i32 1) #8
...
225:                                              ; preds = %216
  ...
  %230 = call i8* @hypre_MAlloc(i64 %229, i32 1) #8
...
278:                                              ; preds = %278, %268
  ...
  call void @hypre_Memcpy(i8* %288, i8* %289, i64 %292, i32 1, i32 1) #8
...
439:                                              ; preds = %428
  ...
  %450 = call i8* @hypre_MAlloc(i64 80, i32 1) #8
...
465:                                              ; preds = %458
  ...
  %470 = call i8* @hypre_MAlloc(i64 %469, i32 1) #8
...
626:                                              ; preds = %621
  ...
  %637 = call i8* @hypre_CAlloc(i64 %636, i64 8, i32 1) #8
...
define internal fastcc i32 @ComputeValuesNonsym(%struct.StoredRows* %0, %struct.Matrix* %1, i32 %2, %struct.numbering* %3) unnamed_addr #0 {
  ...
  %28 = call i8* @hypre_MAlloc(i64 4000, i32 1) #8
...
47:                                               ; preds = %40, %4
  %48 = call i8* @hypre_MAlloc(i64 8000, i32 1) #8
  %49 = bitcast i8* %48 to double*
  %50 = call i8* @hypre_MAlloc(i64 80000, i32 1) #8
...
110:                                              ; preds = %103
  ...
  %115 = call i8* @hypre_ReAlloc(i8* %112, i64 %114, i32 1) #8
...
148:                                              ; preds = %141
  ...
  %155 = call i8* @hypre_MAlloc(i64 %154, i32 1) #8
...
205:                                              ; preds = %201
  ...
  %210 = call i8* @hypre_MAlloc(i64 %209, i32 1) #8
...
45:                                               ; preds = %38
  ...
  %48 = shl nsw i64 %47, 3
  %49 = call i8* @hypre_MAlloc(i64 %48, i32 1) #8

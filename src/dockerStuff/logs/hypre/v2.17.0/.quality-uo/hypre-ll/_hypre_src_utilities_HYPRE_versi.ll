...
@.str.1 = private unnamed_addr constant [7 x i8] c"2.17.0\00", align 1
@hypre__global_error = external dso_local local_unnamed_addr global i32, align 4

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_Version(i8** nocapture %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 36, i64 1, i32 1) #5
...
32:                                               ; preds = %21
  ...
  %39 = mul nsw i32 %34, 10000
  %40 = mul nsw i32 %36, 100
  %41 = add nsw i32 %40, %39
  %42 = add nsw i32 %41, %38
  %43 = icmp eq i32* %0, null
  br i1 %43, label %45, label %44

44:                                               ; preds = %32
  store i32 %34, i32* %0, align 4, !tbaa !7
  br label %45

45:                                               ; preds = %44, %32
  %46 = icmp eq i32* %1, null
...
48:                                               ; preds = %47, %45
  %49 = icmp eq i32* %2, null
  br i1 %49, label %51, label %50

50:                                               ; preds = %48
  store i32 %38, i32* %2, align 4, !tbaa !7
  br label %51

51:                                               ; preds = %50, %48
  %52 = icmp eq i32* %3, null
...
54:                                               ; preds = %53, %51
  %55 = load i32, i32* @hypre__global_error, align 4, !tbaa !7

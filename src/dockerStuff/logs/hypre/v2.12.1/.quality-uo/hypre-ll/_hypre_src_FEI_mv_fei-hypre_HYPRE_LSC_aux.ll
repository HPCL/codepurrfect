...
@.str.514 = private unnamed_addr constant [55 x i8] c"HYPRE_RELEASE_NAME Date Compiled: Apr  5 2022 23:00:11\00", align 1
...
define dso_local double @_ZN16HYPRE_LinSysCore17solveUsingSuperLUERi(%class.HYPRE_LinSysCore* nocapture nonnull readonly align 8 dereferenceable(1672) %0, i32* nocapture nonnull align 4 dereferenceable(4) %1) local_unnamed_addr #1 align 2 {
  ...
  store double -1.000000e+00, double* %3, align 8, !tbaa !67
...
46:                                               ; preds = %40
  ...
  %52 = call i32 @HYPRE_ParCSRMatrixGetRowPartitioning(%struct.hypre_ParCSRMatrix_struct* %51, i32** nonnull %6)
  %53 = load i32*, i32** %6, align 8, !tbaa !14
...
62:                                               ; preds = %46, %62
  ...
  %66 = call i32 @HYPRE_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %65, i32 %63, i32* nonnull %4, i32** nonnull %5, double** nonnull %7)
  %67 = load i32, i32* %4, align 4, !tbaa !20
  %68 = add nsw i32 %67, %64
  %69 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %8, align 8, !tbaa !14
  %70 = call i32 @HYPRE_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %69, i32 %63, i32* nonnull %4, i32** nonnull %5, double** nonnull %7)
  %71 = add i32 %63, 1
...
169:                                              ; preds = %166
  ...
  %197 = call i32 @HYPRE_ParVectorInnerProd(%struct.hypre_ParVector_struct* %196, %struct.hypre_ParVector_struct* %196, double* nonnull %3)
  %198 = load double, double* %3, align 8, !tbaa !67
  %199 = call double @sqrt(double %198) #17
  store double %199, double* %3, align 8, !tbaa !67
...
223:                                              ; preds = %206, %44, %38
  %224 = load double, double* %3, align 8, !tbaa !67
...
56:                                               ; preds = %50
  ...
  %62 = call i32 @HYPRE_ParCSRMatrixGetRowPartitioning(%struct.hypre_ParCSRMatrix_struct* %61, i32** nonnull %6)
  %63 = load i32*, i32** %6, align 8, !tbaa !14
...
70:                                               ; preds = %56, %70
  ...
  %74 = call i32 @HYPRE_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %73, i32 %71, i32* nonnull %4, i32** nonnull %5, double** nonnull %7)
  %75 = load i32, i32* %4, align 4, !tbaa !20
  %76 = add nsw i32 %75, %72
  %77 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %8, align 8, !tbaa !14
  %78 = call i32 @HYPRE_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %77, i32 %71, i32* nonnull %4, i32** nonnull %5, double** nonnull %7)
...
228:                                              ; preds = %225
  ...
  %256 = call i32 @HYPRE_ParVectorInnerProd(%struct.hypre_ParVector_struct* %255, %struct.hypre_ParVector_struct* %255, double* nonnull %3)
  %257 = load double, double* %3, align 8, !tbaa !67
  %258 = call double @sqrt(double %257) #17
  store double %258, double* %3, align 8, !tbaa !67
...
282:                                              ; preds = %265, %54, %48
  %283 = load double, double* %3, align 8, !tbaa !67

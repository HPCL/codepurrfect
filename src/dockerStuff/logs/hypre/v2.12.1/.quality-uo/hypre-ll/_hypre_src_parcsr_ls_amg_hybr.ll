...
define dso_local i8* @hypre_AMGHybridCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 256) #4
...
28:                                               ; preds = %23
  ...
  call void @hypre_Free(i8* nonnull %29) #4
...
35:                                               ; preds = %30
  ...
  call void @hypre_Free(i8* nonnull %36) #4
...
60:                                               ; preds = %55
  ...
  call void @hypre_Free(i8* nonnull %61) #4
...
67:                                               ; preds = %62
  ...
  call void @hypre_Free(i8* nonnull %68) #4
...
74:                                               ; preds = %69
  ...
  call void @hypre_Free(i8* nonnull %75) #4
  store i32* null, i32** %71, align 8, !tbaa !41
  br label %76

76:                                               ; preds = %74, %69
  call void @hypre_Free(i8* nonnull %0) #4
  br label %77
...
13:                                               ; preds = %8
  %14 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
...
25:                                               ; preds = %20
  %26 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
  %27 = bitcast i8* %26 to i32*
...
10:                                               ; preds = %5
  %11 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
...
22:                                               ; preds = %17
  %23 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
...
13:                                               ; preds = %5
  ...
  %15 = call i8* @hypre_CAlloc(i64 %14, i64 8) #4
...
24:                                               ; preds = %19
  ...
  %26 = call i8* @hypre_CAlloc(i64 %25, i64 8) #4
...
280:                                              ; preds = %257
  %281 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
...
302:                                              ; preds = %299, %295, %291, %290
  %303 = call i32 @hypre_BoomerAMGSetGridRelaxType(i8* %258, i32* %282) #4
  br label %304
...
320:                                              ; preds = %313, %306
  %321 = call i32 @hypre_BoomerAMGSetRelaxWeight(i8* %258, double* %309) #4
  br label %322
...
324:                                              ; preds = %322
  ...
  %326 = call i8* @hypre_CAlloc(i64 %325, i64 8) #4
...
338:                                              ; preds = %331, %324
  %339 = call i32 @hypre_BoomerAMGSetOmega(i8* %258, double* %327) #4
  br label %340
...
342:                                              ; preds = %340
  %343 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
...
352:                                              ; preds = %345
  %353 = call i32 @hypre_BoomerAMGSetNumGridSweeps(i8* %258, i32* %344) #4
  %354 = icmp eq i32** %102, null
  br i1 %354, label %386, label %355

355:                                              ; preds = %352
  %356 = call i8* @hypre_CAlloc(i64 4, i64 8) #4
...
384:                                              ; preds = %381
  %385 = call i32 @hypre_BoomerAMGSetGridRelaxPoints(i8* %258, i32** %357) #4
  br label %386
...
388:                                              ; preds = %386
  ...
  %390 = call i8* @hypre_CAlloc(i64 %389, i64 4) #4
...
402:                                              ; preds = %395, %388
  %403 = call i32 @hypre_BoomerAMGSetDofFunc(i8* %258, i32* %391) #4
  br label %404
...
409:                                              ; preds = %254
  ...
  %417 = call i32 @hypre_BoomerAMGSetSetupType(i8* %410, i32 %48) #4
  br label %418
...
422:                                              ; preds = %418
  %423 = call i32 @hypre_PCGSetPrecond(i8* %233, i32 (i8*, i8*, i8*, i8*)* %421, i32 (i8*, i8*, i8*, i8*)* %420, i8* %419) #4
  ...
  %427 = call i32 @hypre_PCGSetup(i8* %233, i8* nonnull %424, i8* nonnull %425, i8* nonnull %426) #4
  %428 = call i32 @hypre_PCGSolve(i8* %233, i8* nonnull %424, i8* nonnull %425, i8* nonnull %426) #4
  %429 = call i32 @hypre_PCGGetNumIterations(i8* %233, i32* nonnull %6) #4
...
432:                                              ; preds = %422
  %433 = call i32 @hypre_PCGGetFinalRelativeResidualNorm(i8* %233, double* nonnull %8) #4
...
438:                                              ; preds = %437
  %439 = call i32 @hypre_GMRESSetPrecond(i8* %233, i32 (i8*, i8*, i8*, i8*)* %421, i32 (i8*, i8*, i8*, i8*)* %420, i8* %419) #4
  ...
  %443 = call i32 @hypre_GMRESSetup(i8* %233, i8* nonnull %440, i8* nonnull %441, i8* nonnull %442) #4
  %444 = call i32 @hypre_GMRESSolve(i8* %233, i8* nonnull %440, i8* nonnull %441, i8* nonnull %442) #4
  %445 = call i32 @hypre_GMRESGetNumIterations(i8* %233, i32* nonnull %6) #4
...
448:                                              ; preds = %438
  %449 = call i32 @hypre_GMRESGetFinalRelativeResidualNorm(i8* %233, double* nonnull %8) #4
...
453:                                              ; preds = %437
  %454 = call i32 @hypre_BiCGSTABSetPrecond(i8* %233, i32 (i8*, i8*, i8*, i8*)* %421, i32 (i8*, i8*, i8*, i8*)* %420, i8* %419) #4
  ...
  %458 = call i32 @hypre_BiCGSTABSetup(i8* %233, i8* nonnull %455, i8* nonnull %456, i8* nonnull %457) #4
  %459 = call i32 @hypre_BiCGSTABSolve(i8* %233, i8* nonnull %455, i8* nonnull %456, i8* nonnull %457) #4
  %460 = call i32 @hypre_BiCGSTABGetNumIterations(i8* %233, i32* nonnull %6) #4
...
463:                                              ; preds = %453
  %464 = call i32 @hypre_BiCGSTABGetFinalRelativeResidualNorm(i8* %233, double* nonnull %8) #4

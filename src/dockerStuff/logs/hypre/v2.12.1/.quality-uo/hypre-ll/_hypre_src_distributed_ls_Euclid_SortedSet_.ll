...
define dso_local void @SortedSet_dhCreate(%struct._sortedset_dh** nocapture %0, i32 %1) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 22, i32 1) #3
...
7:                                                ; preds = %2
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 23) #3
  br label %23
...
8:                                                ; preds = %2
  ...
  %13 = shl nsw i64 %12, 2
  %14 = call i8* @Mem_dhMalloc(%struct._mem_dh* %11, i64 %13) #3
...
19:                                               ; preds = %8
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 27) #3
  br label %23
...
define dso_local void @SortedSet_dhDestroy(%struct._sortedset_dh* %0) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 36, i32 1) #3
...
10:                                               ; preds = %5
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 37) #3
  br label %18
...
16:                                               ; preds = %11
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 38) #3
  br label %18

17:                                               ; preds = %11
  call void @dh_EndFunc(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i64 0, i64 0), i32 1) #3
  br label %18
...
define dso_local void @SortedSet_dhInsert(%struct._sortedset_dh* nocapture %0, i32 %1) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 47, i32 1) #3
...
12:                                               ; preds = %14
  ...
  br i1 %13, label %20, label %14, !llvm.loop !13
...
22:                                               ; preds = %20
  ...
  %26 = shl nsw i64 %25, 2
  %27 = call i8* @Mem_dhMalloc(%struct._mem_dh* %23, i64 %26) #3
...
31:                                               ; preds = %22
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 67) #3
  br label %44
...
32:                                               ; preds = %22
  ...
  %35 = shl nsw i64 %34, 2
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %27, i8* align 4 %33, i64 %35, i1 false)
  %36 = load %struct._mem_dh*, %struct._mem_dh** @mem_dh, align 8, !tbaa !3
  call void @Mem_dhFree(%struct._mem_dh* %36, i8* %33) #3
  %37 = load i32, i32* @errFlag_dh, align 4, !tbaa !7
  %38 = icmp eq i32 %37, 0
  br i1 %38, label %40, label %39

39:                                               ; preds = %32
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 69) #3
  br label %44

40:                                               ; preds = %32
  %41 = bitcast i32** %5 to i8**
  store i8* %27, i8** %41, align 8, !tbaa !11
  %42 = load i32, i32* %7, align 8, !tbaa !9
  %43 = shl nsw i32 %42, 1
  store i32 %43, i32* %7, align 8, !tbaa !9
  br label %44
...
47:                                               ; preds = %44, %20
  ...
  %51 = load i32, i32* %3, align 8, !tbaa !12
  %52 = add nsw i32 %51, 1
  store i32 %52, i32* %3, align 8, !tbaa !12
  br label %53

53:                                               ; preds = %14, %47
  call void @dh_EndFunc(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i64 0, i64 0), i32 1) #3
  br label %54
...
define dso_local void @SortedSet_dhGetList(%struct._sortedset_dh* nocapture readonly %0, i32** nocapture %1, i32* nocapture %2) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 85, i32 1) #3
  ...
  call void @shellSort_int(i32 %5, i32* %7) #3
  %8 = load i32*, i32** %6, align 8, !tbaa !11
  store i32* %8, i32** %1, align 8, !tbaa !3
  %9 = load i32, i32* %4, align 8, !tbaa !12
  store i32 %9, i32* %2, align 4, !tbaa !7
  call void @dh_EndFunc(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i64 0, i64 0), i32 1) #3
  ret void
}
...
!8 = !{!"int", !5, i64 0}
!9 = !{!10, !8, i64 0}
!10 = !{!"_sortedset_dh", !8, i64 0, !4, i64 8, !8, i64 16}
!11 = !{!10, !4, i64 8}
!12 = !{!10, !8, i64 16}

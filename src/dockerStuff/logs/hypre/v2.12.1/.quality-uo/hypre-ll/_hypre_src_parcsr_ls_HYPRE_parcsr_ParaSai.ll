...
6:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0), i32 74, i32 2, i8* null) #6
  br label %19
...
17:                                               ; preds = %13, %11
  ...
  %33 = call i32 @hypre_ParaSailsSetup(i8* %19, i8* %20, i32 %22, double %24, i32 %26, double %28, double %30, i32 %32) #6
...
36:                                               ; preds = %13
  ...
  %42 = call i32 @hypre_ParaSailsSetupValues(i8* %38, i8* %39, double 0.000000e+00, double 0.000000e+00, i32 %41) #6
...
45:                                               ; preds = %36, %17
  ...
  %47 = call i32 @HYPRE_DistributedMatrixDestroy(i8* %46) #6
...
6:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0), i32 312, i32 2, i8* null) #6
  br label %19
...
define dso_local i32 @HYPRE_ParaSailsSetup(%struct.hypre_Solver_struct* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readnone %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %6) #6
  %7 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %8 = call i32 (...) @HYPRE_GetError() #6
  %9 = call i32 (...) @HYPRE_ClearAllErrors() #6
  %10 = call i32 @HYPRE_ConvertParCSRMatrixToDistributedMatrix(%struct.hypre_ParCSRMatrix_struct* %1, i8** nonnull %5) #6
...
21:                                               ; preds = %17, %15
  ...
  %37 = call i32 @hypre_ParaSailsSetup(i8* %23, i8* %24, i32 %26, double %28, i32 %30, double %32, double %34, i32 %36) #6
...
42:                                               ; preds = %17
  ...
  %48 = call i32 @hypre_ParaSailsSetupValues(i8* %44, i8* %45, double 0.000000e+00, double 0.000000e+00, i32 %47) #6
...
53:                                               ; preds = %42, %21
  ...
  %55 = call i32 @HYPRE_DistributedMatrixDestroy(i8* %54) #6
...
declare dso_local i32 @HYPRE_GetError(...) local_unnamed_addr #3

declare dso_local i32 @HYPRE_ClearAllErrors(...) local_unnamed_addr #3

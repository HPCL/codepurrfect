...
18:                                               ; preds = %6
  ...
  call void @hypre_Free(i8* nonnull %19) #5
...
44:                                               ; preds = %37
  ...
  call void @hypre_Free(i8* nonnull %45) #5
...
53:                                               ; preds = %46
  ...
  call void @hypre_Free(i8* nonnull %54) #5
...
61:                                               ; preds = %55
  ...
  call void @hypre_Free(i8* nonnull %62) #5
...
69:                                               ; preds = %63
  ...
  call void @hypre_Free(i8* nonnull %70) #5
...
78:                                               ; preds = %71
  ...
  call void @hypre_Free(i8* nonnull %79) #5
...
87:                                               ; preds = %80
  ...
  call void @hypre_Free(i8* nonnull %88) #5
...
95:                                               ; preds = %89
  ...
  call void @hypre_Free(i8* nonnull %96) #5
...
103:                                              ; preds = %97
  ...
  call void @hypre_Free(i8* nonnull %104) #5
...
111:                                              ; preds = %105
  ...
  call void @hypre_Free(i8* nonnull %112) #5

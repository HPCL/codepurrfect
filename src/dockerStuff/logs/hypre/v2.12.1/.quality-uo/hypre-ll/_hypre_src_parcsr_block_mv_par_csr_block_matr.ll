...
define dso_local %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixCreate(i32 %0, i32 %1, i32 %2, i32 %3, i32* %4, i32* %5, i32 %6, i32 %7, i32 %8) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_CAlloc(i64 1, i64 144) #6
...
36:                                               ; preds = %30, %32, %25
  ...
  %55 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %54, i64 0, i32 3
...
17:                                               ; preds = %7
  ...
  call void @hypre_Free(i8* nonnull %18) #6
...
53:                                               ; preds = %51, %47
  ...
  call void @hypre_Free(i8* nonnull %54) #6
  br label %55
...
define dso_local i32 @hypre_ParCSRBlockMatrixInitialize(%struct.hypre_ParCSRBlockMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %9 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %8, i64 0, i32 5
  %10 = load i32, i32* %9, align 8, !tbaa !31
  %11 = sext i32 %10 to i64
  %12 = call i8* @hypre_CAlloc(i64 %11, i64 4) #6
...
define dso_local i32 @hypre_ParCSRBlockMatrixSetNumNonzeros(%struct.hypre_ParCSRBlockMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %14 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %7, i64 0, i32 4
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRBlockMatrixCompress(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %7, i64 0, i32 5
  %17 = load i32, i32* %16, align 8, !tbaa !31
  %18 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %5, i64 0, i32 6
  %19 = load i32, i32* %18, align 4, !tbaa !37
  %20 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %7, i64 0, i32 6
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRBlockMatrixConvertToParCSRMatrix(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %9 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %6, i64 0, i32 3
  ...
  %19 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %8, i64 0, i32 5
  %20 = load i32, i32* %19, align 8, !tbaa !31
  %21 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %6, i64 0, i32 6
  %22 = load i32, i32* %21, align 4, !tbaa !37
  %23 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %8, i64 0, i32 6
  ...
  %27 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
  %28 = bitcast i8* %27 to i32*
  %29 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
...
103:                                              ; preds = %102
  ...
  %107 = call i8* @hypre_CAlloc(i64 %104, i64 4) #6
  ...
  %114 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %109, i64 0, i32 4
...
185:                                              ; preds = %181, %161
  ...
  %189 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %188, i64 0, i32 3
  store i32 %146, i32* %189, align 4, !tbaa !55
  br label %190

190:                                              ; preds = %185, %145
  call void @hypre_Free(i8* %107) #6
...
define dso_local %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixConvertFromParCSRMatrix(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %24 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %9, i64 0, i32 6
  ...
  %28 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
  %29 = bitcast i8* %28 to i32*
  %30 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
...
44:                                               ; preds = %32
  %45 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %9, i64 0, i32 3
  ...
  %48 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %7, i64 0, i32 2
  %49 = load i32, i32* %48, align 8, !tbaa !65
  %50 = sdiv i32 %49, %1
  %51 = add nsw i32 %50, 1
  %52 = sext i32 %51 to i64
  %53 = call i8* @hypre_CAlloc(i64 %52, i64 4) #6
...
79:                                               ; preds = %66, %56
  ...
  %84 = call i8* @hypre_CAlloc(i64 %57, i64 4) #6
...
109:                                              ; preds = %103, %79
  %110 = call i8* @hypre_CAlloc(i64 %81, i64 4) #6
...
186:                                              ; preds = %174
  ...
  %188 = call i8* @hypre_CAlloc(i64 %187, i64 4) #6
  %189 = bitcast i8* %188 to i32*
  %190 = mul i32 %1, %1
  %191 = mul i32 %190, %175
  %192 = sext i32 %191 to i64
  %193 = call i8* @hypre_CAlloc(i64 %192, i64 8) #6
...
282:                                              ; preds = %278, %202, %174
  %283 = sdiv i32 %11, %1
  %284 = sdiv i32 %13, %1
  %285 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %46, i64 0, i32 6
...
define dso_local i32 @hypre_BlockMatvecCommPkgCreate(%struct.hypre_ParCSRBlockMatrix* %0) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 4
  %17 = load i32, i32* %16, align 8, !tbaa !19
  %18 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 6
  ...
  %23 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %22, align 8, !tbaa !13
  ...
  %26 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 2
  %27 = load i32, i32* %26, align 8, !tbaa !17
  %28 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 0
  %29 = load i32, i32* %28, align 8, !tbaa !9
  %30 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 22
  %31 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %30, align 8, !tbaa !23
  %32 = icmp eq %struct.hypre_IJAssumedPart* %31, null
  br i1 %32, label %33, label %35

33:                                               ; preds = %1
  %34 = call i32 @hypre_ParCSRBlockMatrixCreateAssumedPartition(%struct.hypre_ParCSRBlockMatrix* %0) #6
  br label %35

35:                                               ; preds = %33, %1
  %36 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %30, align 8, !tbaa !23
  %37 = call i32 @hypre_NewCommPkgCreate_core(i32 %29, i32* %21, i32 %17, i32 %17, i32 %19, i32 %25, i32 %27, i32* nonnull %2, i32** nonnull %3, i32** nonnull %4, i32* nonnull %5, i32** nonnull %6, i32** nonnull %7, i32** nonnull %8, %struct.hypre_IJAssumedPart* %36) #6
...
51:                                               ; preds = %46, %43
  %52 = call i8* @hypre_CAlloc(i64 1, i64 72) #6
  %53 = bitcast i8* %52 to i32*
  store i32 %29, i32* %53, align 8, !tbaa !76
  %54 = load i32, i32* %2, align 4, !tbaa !7
  %55 = getelementptr inbounds i8, i8* %52, i64 32
  %56 = bitcast i8* %55 to i32*
  store i32 %54, i32* %56, align 8, !tbaa !78
  %57 = load i32*, i32** %3, align 8, !tbaa !3
  %58 = getelementptr inbounds i8, i8* %52, i64 40
  %59 = bitcast i8* %58 to i32**
  store i32* %57, i32** %59, align 8, !tbaa !79
  %60 = load i32*, i32** %4, align 8, !tbaa !3
  %61 = getelementptr inbounds i8, i8* %52, i64 48
  %62 = bitcast i8* %61 to i32**
  store i32* %60, i32** %62, align 8, !tbaa !80
  %63 = load i32, i32* %5, align 4, !tbaa !7
  %64 = getelementptr inbounds i8, i8* %52, i64 4
  %65 = bitcast i8* %64 to i32*
  store i32 %63, i32* %65, align 4, !tbaa !81
  %66 = load i32*, i32** %6, align 8, !tbaa !3
  %67 = getelementptr inbounds i8, i8* %52, i64 8
  %68 = bitcast i8* %67 to i32**
  store i32* %66, i32** %68, align 8, !tbaa !82
  %69 = load i32*, i32** %7, align 8, !tbaa !3
  %70 = getelementptr inbounds i8, i8* %52, i64 16
  %71 = bitcast i8* %70 to i32**
  store i32* %69, i32** %71, align 8, !tbaa !83
  %72 = load i32*, i32** %8, align 8, !tbaa !3
  %73 = getelementptr inbounds i8, i8* %52, i64 24
  %74 = bitcast i8* %73 to i32**
  store i32* %72, i32** %74, align 8, !tbaa !84
  %75 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 12
  %76 = bitcast %struct.hypre_ParCSRCommPkg** %75 to i8**
  store i8* %52, i8** %76, align 8, !tbaa !28
  %77 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
...
define dso_local %struct.hypre_CSRBlockMatrix* @hypre_ParCSRBlockMatrixExtractBExt(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0, %struct.hypre_ParCSRBlockMatrix* nocapture readonly %1, i32 %2) local_unnamed_addr #0 {
  ...
  %14 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %13, i64 0, i32 3
...
121:                                              ; preds = %112
  ...
  %124 = call i8* @hypre_CAlloc(i64 %123, i64 8) #6
...
126:                                              ; preds = %121, %112
  ...
  %130 = call i8* @hypre_CAlloc(i64 %129, i64 4) #6
...
255:                                              ; preds = %249, %126
  %256 = call i8* @hypre_CAlloc(i64 1, i64 72) #6
...
300:                                              ; preds = %277, %255
  ...
  %306 = call i8* @hypre_CAlloc(i64 %305, i64 4) #6
  br i1 %120, label %311, label %307

307:                                              ; preds = %300
  %308 = mul nsw i32 %303, %46
  %309 = sext i32 %308 to i64
  %310 = call i8* @hypre_CAlloc(i64 %309, i64 8) #6
  br label %311
...
326:                                              ; preds = %316, %311
  ...
  %329 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %257, i8* %118, i8* %306) #6
...
331:                                              ; preds = %326
  ...
  %337 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %304, i64 0, i32 2
  %338 = bitcast i32** %337 to i8**
  store i8* %306, i8** %338, align 8, !tbaa !71
...
340:                                              ; preds = %326
  ...
  %343 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %304, i64 0, i32 2
  %344 = bitcast i32** %343 to i8**
  store i8* %306, i8** %344, align 8, !tbaa !71
  br label %345
...
346:                                              ; preds = %345
  ...
  call void @hypre_Free(i8* %347) #6
  br label %348

348:                                              ; preds = %346, %345
  call void @hypre_Free(i8* %130) #6
  call void @hypre_Free(i8* %134) #6
  call void @hypre_Free(i8* %256) #6
...
define dso_local %struct.hypre_ParVector_struct* @hypre_ParVectorCreateFromBlock(i32 %0, i32 %1, i32* readonly %2, i32 %3) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %10) #6
  %11 = mul nsw i32 %3, %1
  %12 = call i8* @hypre_CAlloc(i64 1, i64 56) #6
...
20:                                               ; preds = %4
  %21 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
...
32:                                               ; preds = %24, %16
  ...
  store %struct.hypre_Vector* %51, %struct.hypre_Vector** %53, align 8, !tbaa !103
  %54 = getelementptr inbounds i8, i8* %12, i64 40
  %55 = bitcast i8* %54 to i32*
  store i32 1, i32* %55, align 8, !tbaa !104
  %56 = getelementptr inbounds i8, i8* %12, i64 44
  %57 = bitcast i8* %56 to i32*
  store i32 1, i32* %57, align 4, !tbaa !105
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #6
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %9) #6
...
!13 = !{!10, !4, i64 40}
!14 = !{!15, !8, i64 24}
!15 = !{!"", !4, i64 0, !4, i64 8, !4, i64 16, !8, i64 24, !8, i64 28, !8, i64 32, !8, i64 36, !8, i64 40}
!16 = !{!10, !8, i64 4}
!17 = !{!10, !8, i64 8}
!18 = !{!10, !8, i64 12}
!19 = !{!10, !8, i64 16}
...
!48 = !{!49, !4, i64 8}
!49 = !{!"", !4, i64 0, !4, i64 8, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !4, i64 32, !4, i64 40, !8, i64 48}
!50 = !{!49, !8, i64 24}
...
!97 = !{!98, !8, i64 0}
!98 = !{!"hypre_ParVector_struct", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !4, i64 16, !8, i64 24, !4, i64 32, !8, i64 40, !8, i64 44, !4, i64 48}
!99 = !{!98, !8, i64 4}
!100 = !{!98, !8, i64 8}
!101 = !{!98, !8, i64 12}
!102 = !{!98, !4, i64 16}

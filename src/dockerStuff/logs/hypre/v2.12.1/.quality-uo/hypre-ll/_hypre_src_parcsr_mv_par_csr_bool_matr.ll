...
define dso_local %struct.hypre_CSRBooleanMatrix* @hypre_CSRBooleanMatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_CAlloc(i64 1, i64 32) #8
...
14:                                               ; preds = %10, %3
  ...
  call void @hypre_Free(i8* nonnull %15) #8
  br label %16
...
7:                                                ; preds = %1
  ...
  %12 = call i8* @hypre_CAlloc(i64 %11, i64 4) #8
...
define dso_local %struct.hypre_CSRBooleanMatrix* @hypre_CSRBooleanMatrixRead(i8* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %7 = add nsw i32 %6, 1
  %8 = sext i32 %7 to i64
  %9 = call i8* @hypre_CAlloc(i64 %8, i64 4) #8
...
23:                                               ; preds = %13, %1
  ...
  %28 = call i8* @hypre_CAlloc(i64 1, i64 32) #8
...
define dso_local %struct.hypre_ParCSRBooleanMatrix* @hypre_ParCSRBooleanMatrixCreate(i32 %0, i32 %1, i32 %2, i32* %3, i32* %4, i32 %5, i32 %6, i32 %7) local_unnamed_addr #0 {
  ...
  %15 = call i8* @hypre_CAlloc(i64 1, i64 120) #8
...
33:                                               ; preds = %28, %30, %23
  ...
  %51 = call i8* @hypre_CAlloc(i64 1, i64 32) #8
  %52 = getelementptr inbounds i8, i8* %51, i64 16
  %53 = bitcast i8* %52 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %51, i8 0, i64 16, i1 false) #8
  ...
  %62 = call i8* @hypre_CAlloc(i64 1, i64 32) #8
  %63 = getelementptr inbounds i8, i8* %62, i64 16
  %64 = bitcast i8* %63 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %62, i8 0, i64 16, i1 false) #8
...
39:                                               ; preds = %35, %28
  ...
  call void @hypre_Free(i8* nonnull %40) #8
  br label %41
...
45:                                               ; preds = %41
  ...
  call void @hypre_Free(i8* nonnull %46) #8
...
51:                                               ; preds = %47
  %52 = call i32 @hypre_MatvecCommPkgDestroy(%struct.hypre_ParCSRCommPkg* nonnull %49) #8
  br label %53
...
9:                                                ; preds = %1
  ...
  %14 = call i8* @hypre_CAlloc(i64 %13, i64 4) #8
...
32:                                               ; preds = %24
  ...
  %35 = add nsw i32 %34, 1
  %36 = sext i32 %35 to i64
  %37 = call i8* @hypre_CAlloc(i64 %36, i64 4) #8
...
define dso_local %struct.hypre_ParCSRBooleanMatrix* @hypre_ParCSRBooleanMatrixRead(i32 %0, i8* %1) local_unnamed_addr #0 {
  ...
  %24 = call i8* @hypre_CAlloc(i64 %23, i64 4) #8
  %25 = bitcast i8* %24 to i32*
  %26 = load i32, i32* %4, align 4, !tbaa !14
  %27 = add nsw i32 %26, 1
  %28 = sext i32 %27 to i64
  %29 = call i8* @hypre_CAlloc(i64 %28, i64 4) #8
  %30 = bitcast i8* %29 to i32*
  ...
  %38 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* nonnull %8) #8
  %39 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* nonnull %9) #8
...
43:                                               ; preds = %2, %43
  ...
  %47 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i64 0, i64 0), i32* %45, i32* %46) #8
...
67:                                               ; preds = %52, %67
  ...
  %70 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %69) #8
...
99:                                               ; preds = %92
  ...
  %102 = call i8* @hypre_CAlloc(i64 1, i64 32) #8
  %103 = bitcast i8* %102 to %struct.hypre_CSRBooleanMatrix*
  %104 = getelementptr inbounds i8, i8* %102, i64 16
  %105 = bitcast i8* %104 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %102, i8 0, i64 16, i1 false) #8
...
112:                                              ; preds = %99, %97
  ...
  %114 = call i8* @hypre_CAlloc(i64 1, i64 120) #8
...
48:                                               ; preds = %45, %31
  ...
  %50 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %49, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %11) #8
  %51 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %49, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %13) #8
...
59:                                               ; preds = %48, %59
  ...
  %65 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %49, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i64 0, i64 0), i32 %62, i32 %64) #8
...
70:                                               ; preds = %57, %70
  ...
  %74 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %49, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %73) #8
...
29:                                               ; preds = %26, %2
  ...
  %33 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* nonnull %22, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i64 0, i64 0), i8* %1, i32 %32) #8
...
36:                                               ; preds = %29
  %37 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.10, i64 0, i64 0), i8* nonnull %22) #8
  call void @exit(i32 1) #9
  unreachable

38:                                               ; preds = %29
  %39 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %34, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i64 0, i64 0), i32 %8, i32 %10) #8
...
69:                                               ; preds = %67, %69
  ...
  %74 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %34, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i64 0, i64 0), i32 %60, i32 %73) #8
  %75 = add nsw i64 %70, 1
...
88:                                               ; preds = %86, %88
  ...
  %95 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %34, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.12, i64 0, i64 0), i32 %60, i32 %94) #8
  %96 = add nsw i64 %89, 1
...
63:                                               ; preds = %61, %34
  ...
  %65 = call i8* @hypre_CAlloc(i64 %64, i64 4) #8
...
36:                                               ; preds = %25, %4
  ...
  %46 = call i8* @hypre_CAlloc(i64 %45, i64 4) #8
...
122:                                              ; preds = %120, %114
  ...
  %127 = call i8* @hypre_CAlloc(i64 1, i64 32) #8
  %128 = bitcast i8* %127 to %struct.hypre_CSRBooleanMatrix*
  %129 = getelementptr inbounds i8, i8* %127, i64 16
  %130 = bitcast i8* %129 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %127, i8 0, i64 16, i1 false) #8
...
139:                                              ; preds = %122
  ...
  %143 = call i8* @hypre_CAlloc(i64 %142, i64 4) #8
  %144 = bitcast i8* %143 to i32*
  %145 = load i32, i32* %12, align 4, !tbaa !14
  %146 = add nsw i32 %145, -1
  %147 = sext i32 %146 to i64
  %148 = call i8* @hypre_CAlloc(i64 %147, i64 20) #8
...
193:                                              ; preds = %161, %139
  ...
  call void @hypre_Free(i8* %143) #8
  call void @hypre_Free(i8* %148) #8
...
207:                                              ; preds = %200
  ...
  %213 = call i8* @hypre_CAlloc(i64 %212, i64 4) #8
...
220:                                              ; preds = %215
  ...
  %222 = call i8* @hypre_CAlloc(i64 %221, i64 4) #8
...
275:                                              ; preds = %267
  ...
  call void @hypre_Free(i8* %279) #8
  store i32* null, i32** %277, align 8, !tbaa !13
  br label %280

280:                                              ; preds = %275, %267
  call void @hypre_Free(i8* nonnull %127) #8
  br label %281

281:                                              ; preds = %265, %280
  call void @hypre_Free(i8* %46) #8
...
134:                                              ; preds = %82, %78
  ...
  %141 = call i8* @hypre_CAlloc(i64 %140, i64 4) #8
...
166:                                              ; preds = %163
  ...
  %171 = call i8* @hypre_CAlloc(i64 %170, i64 4) #8
...
176:                                              ; preds = %173
  ...
  %178 = call i8* @hypre_CAlloc(i64 %177, i64 4) #8
...
195:                                              ; preds = %192
  ...
  %197 = call i8* @hypre_CAlloc(i64 %196, i64 4) #8
...
256:                                              ; preds = %252
  ...
  %261 = call i8* @hypre_CAlloc(i64 %260, i64 4) #8
...
267:                                              ; preds = %263
  ...
  %269 = call i8* @hypre_CAlloc(i64 %268, i64 4) #8
...
285:                                              ; preds = %278, %271
  ...
  %288 = call i8* @hypre_CAlloc(i64 %287, i64 4) #8

...
define dso_local i32 @hypre_StructGridCreate(i32 %0, i32 %1, %struct.hypre_StructGrid_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_MAlloc(i64 120) #8
...
define dso_local i32 @hypre_StructGridAssemble(%struct.hypre_StructGrid_struct* %0) local_unnamed_addr #0 {
  ...
  %38 = call i32 @hypre_MPI_Comm_size(i32 %24, i32* nonnull %4) #8
  %39 = call i32 @hypre_MPI_Comm_rank(i32 %24, i32* nonnull %3) #8
...
45:                                               ; preds = %1
  ...
  %47 = call i8* @hypre_CAlloc(i64 %46, i64 4) #8
...
60:                                               ; preds = %1, %58
  %61 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
...
76:                                               ; preds = %65, %60
  %77 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %61) #8
  %78 = sext i32 %77 to i64
  %79 = call i8* @hypre_CAlloc(i64 %78, i64 12) #8
  %80 = bitcast i8* %79 to [3 x i32]*
  %81 = bitcast i8* %79 to i32*
  %82 = call i32 @hypre_SetIndex(i32* %81, i32 0) #8
  %83 = icmp sgt i32 %77, 1
  br i1 %83, label %84, label %200

84:                                               ; preds = %76
  %85 = getelementptr inbounds [3 x i32], [3 x i32]* %10, i64 0, i64 0
  %86 = call i32 @hypre_BoxGetSize(%struct.hypre_Box_struct* %61, i32* nonnull %85) #8
...
149:                                              ; preds = %145, %140
  %150 = call i32 @hypre_AddIndexes(i32* nonnull %144, i32* %117, i32 %26, i32* nonnull %144) #8
...
200:                                              ; preds = %199, %76
  %201 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %61) #8
  ...
  %205 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
...
209:                                              ; preds = %200, %209
  ...
  %217 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %213, %struct.hypre_Box_struct* %205) #8
  %218 = call i32 @hypre_BoxGrowByArray(%struct.hypre_Box_struct* %205, i32* nonnull %35) #8
  %219 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %205) #8
...
225:                                              ; preds = %209, %200
  ...
  %230 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %205) #8
  br i1 %41, label %231, label %392

231:                                              ; preds = %225
  %232 = call i32 @hypre_MPI_Allreduce(i8* nonnull %14, i8* nonnull %17, i32 1, i32 1275069445, i32 1476395011, i32 %24) #8
  ...
  %235 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
...
324:                                              ; preds = %312, %300
  ...
  %326 = call i32 @hypre_MPI_Allreduce(i8* nonnull %18, i8* nonnull %19, i32 %325, i32 1275069445, i32 1476395010, i32 %24) #8
...
343:                                              ; preds = %331, %324
  ...
  %345 = call i32 @hypre_BoxManCreate(i32 %344, i32 0, i32 %26, %struct.hypre_Box_struct* %235, i32 %24, %struct.hypre_BoxManager** nonnull %11) #8
  %346 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
  %347 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
  %348 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
...
359:                                              ; preds = %357, %387
  ...
  %370 = call i32 @hypre_BoxGrowByIndex(%struct.hypre_Box_struct* %346, i32* nonnull %29) #8
...
392:                                              ; preds = %225
  %393 = call i32 @hypre_IndexEqual(i32* nonnull %29, i32 0, i32 %26) #8
  %394 = icmp eq i32 %393, 0
  br i1 %394, label %444, label %395

395:                                              ; preds = %392
  %396 = call i32 @hypre_SetIndex(i32* nonnull %29, i32 2) #8
  %397 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
  %398 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
  %399 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %26) #8
...
410:                                              ; preds = %408, %432
  ...
  %414 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %413, %struct.hypre_Box_struct* %397) #8
  %415 = call i32 @hypre_BoxGrowByIndex(%struct.hypre_Box_struct* %397, i32* nonnull %29) #8
  %416 = load %struct.hypre_BoxManager*, %struct.hypre_BoxManager** %11, align 8, !tbaa !21
  %417 = call i32 @hypre_BoxManGatherEntries(%struct.hypre_BoxManager* %416, i32* %401, i32* nonnull %402) #8
  br i1 %405, label %418, label %432

418:                                              ; preds = %410, %429
  %419 = phi i64 [ %430, %429 ], [ 1, %410 ]
  %420 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %397, %struct.hypre_Box_struct* %399) #8
  %421 = getelementptr inbounds [3 x i32], [3 x i32]* %80, i64 %419, i64 0
  %422 = call i32 @hypre_BoxShiftPos(%struct.hypre_Box_struct* %399, i32* nonnull %421) #8
  %423 = call i32 @hypre_IntersectBoxes(%struct.hypre_Box_struct* %399, %struct.hypre_Box_struct* %31, %struct.hypre_Box_struct* %398) #8
  %424 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %398) #8
  %425 = icmp sgt i32 %424, 0
  br i1 %425, label %426, label %429

426:                                              ; preds = %418
  %427 = load %struct.hypre_BoxManager*, %struct.hypre_BoxManager** %11, align 8, !tbaa !21
  %428 = call i32 @hypre_BoxManGatherEntries(%struct.hypre_BoxManager* %427, i32* %403, i32* nonnull %404) #8
  br label %429
...
437:                                              ; preds = %432, %387, %395, %343
  ...
  %441 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %438) #8
  %442 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %439) #8
  %443 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %440) #8
  br label %444

444:                                              ; preds = %437, %392
  %445 = load %struct.hypre_BoxManager*, %struct.hypre_BoxManager** %11, align 8, !tbaa !21
  %446 = call i32 @hypre_BoxManAssemble(%struct.hypre_BoxManager* %445) #8
...
define dso_local i32 @hypre_GatherAllBoxes(i32 %0, %struct.hypre_BoxArray_struct* nocapture readonly %1, i32 %2, %struct.hypre_BoxArray_struct** nocapture %3, i32** nocapture %4, i32* nocapture %5) local_unnamed_addr #0 {
  ...
  %26 = shl nsw i64 %25, 2
  %27 = call i8* @hypre_MAlloc(i64 %26) #8
  %28 = bitcast i8* %27 to i32*
  %29 = load i32, i32* %9, align 4, !tbaa !17
  %30 = sext i32 %29 to i64
  %31 = shl nsw i64 %30, 2
  %32 = call i8* @hypre_MAlloc(i64 %31) #8
...
55:                                               ; preds = %38, %6
  ...
  %59 = shl nsw i64 %58, 2
  %60 = call i8* @hypre_MAlloc(i64 %59) #8
  %61 = bitcast i8* %60 to i32*
  %62 = sext i32 %56 to i64
  %63 = shl nsw i64 %62, 2
  %64 = call i8* @hypre_MAlloc(i64 %63) #8
...
106:                                              ; preds = %100, %55
  ...
  %113 = call i8* @hypre_MAlloc(i64 %112) #8
...
define dso_local i32 @hypre_ComputeBoxnums(%struct.hypre_BoxArray_struct* nocapture readonly %0, i32* nocapture readonly %1, i32** nocapture %2) local_unnamed_addr #0 {
  ...
  %6 = sext i32 %5 to i64
  %7 = shl nsw i64 %6, 2
  %8 = call i8* @hypre_MAlloc(i64 %7) #8
...
define dso_local i32 @hypre_StructGridRead(i32 %0, %struct._IO_FILE* %1, %struct.hypre_StructGrid_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_MAlloc(i64 120) #8

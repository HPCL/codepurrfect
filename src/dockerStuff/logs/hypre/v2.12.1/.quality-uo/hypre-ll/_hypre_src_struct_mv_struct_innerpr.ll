...
81:                                               ; preds = %64, %310
  %82 = phi i64 [ 0, %64 ], [ %312, %310 ]
  %83 = phi double [ 0.000000e+00, %64 ], [ %311, %310 ]
...
222:                                              ; preds = %220
  %223 = sext i32 %118 to i64
  %224 = sext i32 %159 to i64
  %225 = add i32 %200, -1
...
243:                                              ; preds = %222, %307
  %244 = phi double [ %257, %307 ], [ %83, %222 ]
  %245 = phi i32 [ %290, %307 ], [ %208, %222 ]
  %246 = phi i32 [ %293, %307 ], [ %221, %222 ]
...
254:                                              ; preds = %251, %243
  %255 = phi i32 [ %246, %243 ], [ %252, %251 ]
  %256 = phi i32 [ %245, %243 ], [ %253, %251 ]
  %257 = phi double [ %244, %243 ], [ %270, %251 ]
  br label %275

258:                                              ; preds = %248, %258
  %259 = phi i64 [ %250, %248 ], [ %272, %258 ]
  %260 = phi i64 [ %249, %248 ], [ %271, %258 ]
  %261 = phi double [ %244, %248 ], [ %270, %258 ]
  %262 = phi i32 [ 0, %248 ], [ %273, %258 ]
  %263 = add nsw i64 %260, %99
  %264 = getelementptr inbounds double, double* %95, i64 %263
  %265 = load double, double* %264, align 8, !tbaa !26
  %266 = add nsw i64 %259, %104
...
310:                                              ; preds = %307, %220, %198
  %311 = phi double [ %83, %198 ], [ %83, %220 ], [ %257, %307 ]
  ...
  %312 = add nuw nsw i64 %82, 1
  %313 = load i32, i32* %31, align 8, !tbaa !12
  %314 = sext i32 %313 to i64
  %315 = icmp slt i64 %312, %314
  br i1 %315, label %81, label %316, !llvm.loop !31

316:                                              ; preds = %310, %2
  %317 = phi double [ 0.000000e+00, %2 ], [ %311, %310 ]
  store double %317, double* %4, align 8, !tbaa !26
  %318 = getelementptr inbounds %struct.hypre_StructVector_struct, %struct.hypre_StructVector_struct* %0, i64 0, i32 0
  %319 = load i32, i32* %318, align 8, !tbaa !32
  %320 = call i32 @hypre_MPI_Allreduce(i8* nonnull %18, i8* nonnull %17, i32 1, i32 1275070475, i32 1476395011, i32 %319) #6
  %321 = load double, double* %3, align 8, !tbaa !26

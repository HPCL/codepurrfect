...
define dso_local void @hypre_ParMatmul_RowSizes_Marked(i32** nocapture %0, i32** nocapture %1, i32** nocapture readonly %2, i32* nocapture readonly %3, i32* nocapture readonly %4, i32* nocapture readonly %5, i32* nocapture readonly %6, i32* nocapture readonly %7, i32* nocapture readonly %8, i32* nocapture readonly %9, i32* nocapture readonly %10, i32* nocapture readonly %11, i32* nocapture readonly %12, i32* nocapture readonly %13, i32* nocapture readonly %14, i32* nocapture readonly %15, i32* nocapture %16, i32* nocapture %17, i32 %18, i32 %19, i32 %20, i32 %21, i32 %22, i32 %23, i32* nocapture readonly %24, i32* readonly %25, i32* nocapture readonly %26) local_unnamed_addr #0 {
  ...
  %30 = call i8* @hypre_CAlloc(i64 %29, i64 4) #5
  %31 = bitcast i32** %0 to i8**
  store i8* %30, i8** %31, align 8, !tbaa !3
  %32 = call i8* @hypre_CAlloc(i64 %29, i64 4) #5
...
97:                                               ; preds = %89, %85
  ...
  %104 = call i8* @hypre_CAlloc(i64 %103, i64 4) #5
  %105 = bitcast i8* %104 to i32*
  %106 = call i8* @hypre_CAlloc(i64 %103, i64 4) #5
...
151:                                              ; preds = %147
  ...
  %153 = call i8* @hypre_CAlloc(i64 %152, i64 4) #5
  %154 = bitcast i8* %153 to i32*
  %155 = call i8* @hypre_CAlloc(i64 %152, i64 8) #5
...
161:                                              ; preds = %157
  ...
  %163 = call i8* @hypre_CAlloc(i64 %162, i64 4) #5
  %164 = bitcast i8* %163 to i32*
  %165 = call i8* @hypre_CAlloc(i64 %162, i64 8) #5
...
223:                                              ; preds = %220
  %224 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %101) #5
  br label %225
...
228:                                              ; preds = %225
  ...
  %231 = call i8* @hypre_CAlloc(i64 %230, i64 4) #5
...
263:                                              ; preds = %259
  ...
  call void @hypre_qsort0(i32* %260, i32 0, i32 %264) #5
...
288:                                              ; preds = %285
  ...
  %290 = call i8* @hypre_CAlloc(i64 %289, i64 4) #5
...
311:                                              ; preds = %309, %311
  ...
  %315 = call i32 @hypre_BinarySearch(i32* %293, i32 %314, i32 %286) #5
...
344:                                              ; preds = %335, %340, %319, %318
  ...
  %348 = call i8* @hypre_CAlloc(i64 %347, i64 4) #5
...
357:                                              ; preds = %351, %344
  ...
  %360 = call i8* @hypre_CAlloc(i64 %359, i64 8) #5
  %361 = bitcast i8* %360 to double*
  %362 = call i8* @hypre_CAlloc(i64 %359, i64 4) #5
...
366:                                              ; preds = %357
  ...
  %368 = call i8* @hypre_CAlloc(i64 %367, i64 8) #5
  %369 = bitcast i8* %368 to double*
  %370 = call i8* @hypre_CAlloc(i64 %367, i64 4) #5
...
679:                                              ; preds = %674, %384
  %680 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %13, i32 %73, i32 %79, i32* %31, i32* %59, i32 %286, i32 %358, i32 %364) #5
  %681 = call i32 @hypre_ParCSRMatrixSetRowStartsOwner(%struct.hypre_ParCSRMatrix_struct* %680, i32 0) #5
  %682 = call i32 @hypre_ParCSRMatrixSetColStartsOwner(%struct.hypre_ParCSRMatrix_struct* %680, i32 0) #5
...
699:                                              ; preds = %695, %679
  call void @hypre_Free(i8* %348) #5
  store i32* null, i32** %10, align 8, !tbaa !3
  call void @hypre_Free(i8* %104) #5
  br i1 %150, label %703, label %700

700:                                              ; preds = %699
  %701 = bitcast i32* %159 to i8*
  call void @hypre_Free(i8* %701) #5
  %702 = bitcast double* %158 to i8*
  call void @hypre_Free(i8* %702) #5
  br label %703

703:                                              ; preds = %700, %699
  call void @hypre_Free(i8* %106) #5
  br i1 %160, label %704, label %707

704:                                              ; preds = %703
  %705 = bitcast i32* %169 to i8*
  call void @hypre_Free(i8* %705) #5
  %706 = bitcast double* %168 to i8*
  call void @hypre_Free(i8* %706) #5
  br label %707
...
301:                                              ; preds = %297, %204
  ...
  %304 = call i8* @hypre_CAlloc(i64 %303, i64 4) #5

...
define dso_local i32 @hypre_BoomerAMGBlockRelax(%struct.hypre_ParCSRBlockMatrix* %0, %struct.hypre_ParVector_struct* %1, i32* nocapture readonly %2, i32 %3, i32 %4, double %5, double %6, %struct.hypre_ParVector_struct* nocapture readonly %7, %struct.hypre_ParVector_struct* nocapture readonly %8) local_unnamed_addr #0 {
  ...
  %60 = call i8* @hypre_CAlloc(i64 %59, i64 8) #5
  %61 = bitcast i8* %60 to double*
  %62 = call i8* @hypre_CAlloc(i64 %59, i64 8) #5
  %63 = bitcast i8* %62 to double*
  %64 = call i8* @hypre_CAlloc(i64 %59, i64 8) #5
...
75:                                               ; preds = %72
  ...
  %85 = call i8* @hypre_CAlloc(i64 %84, i64 8) #5
  %86 = bitcast i8* %85 to double*
  %87 = mul nsw i32 %38, %33
  %88 = sext i32 %87 to i64
  %89 = call i8* @hypre_CAlloc(i64 %88, i64 8) #5
...
372:                                              ; preds = %369
  ...
  call void @hypre_Free(i8* %373) #5
  call void @hypre_Free(i8* %149) #5
  br label %1962
...
377:                                              ; preds = %374
  ...
  %387 = call i8* @hypre_CAlloc(i64 %386, i64 8) #5
  %388 = bitcast i8* %387 to double*
  %389 = mul nsw i32 %38, %33
  %390 = sext i32 %389 to i64
  %391 = call i8* @hypre_CAlloc(i64 %390, i64 8) #5
...
667:                                              ; preds = %473
  ...
  %670 = call i8* @hypre_CAlloc(i64 %59, i64 8) #5
  %671 = bitcast i8* %670 to double*
  %672 = call i8* @hypre_CAlloc(i64 %59, i64 8) #5
...
914:                                              ; preds = %911, %800, %679, %687
  call void @hypre_Free(i8* %670) #5
  call void @hypre_Free(i8* %672) #5
  br label %915
...
918:                                              ; preds = %915
  ...
  call void @hypre_Free(i8* %919) #5
  call void @hypre_Free(i8* %451) #5
  br label %1962
...
923:                                              ; preds = %920
  ...
  %933 = call i8* @hypre_CAlloc(i64 %932, i64 8) #5
  %934 = bitcast i8* %933 to double*
  %935 = mul nsw i32 %38, %33
  %936 = sext i32 %935 to i64
  %937 = call i8* @hypre_CAlloc(i64 %936, i64 8) #5
...
1377:                                             ; preds = %997
  ...
  %1379 = call i8* @hypre_CAlloc(i64 %59, i64 8) #5
  %1380 = bitcast i8* %1379 to double*
  %1381 = call i8* @hypre_CAlloc(i64 %59, i64 8) #5
...
1869:                                             ; preds = %1867, %1636, %1638, %1422
  call void @hypre_Free(i8* %1379) #5
  call void @hypre_Free(i8* %1381) #5
  br label %1870
...
1873:                                             ; preds = %1870
  ...
  call void @hypre_Free(i8* %1874) #5
  call void @hypre_Free(i8* %998) #5
  br label %1962
...
1882:                                             ; preds = %1875
  ...
  %1893 = call i8* @hypre_CAlloc(i64 %1892, i64 8) #5
  %1894 = bitcast i8* %1893 to double*
  %1895 = sext i32 %1878 to i64
  %1896 = call i8* @hypre_CAlloc(i64 %1895, i64 8) #5
...
1956:                                             ; preds = %1953, %1930
  call void @hypre_Free(i8* %1893) #5
  call void @hypre_Free(i8* %1896) #5
  br label %1957
...
1962:                                             ; preds = %1870, %1873, %915, %918, %369, %372, %70, %1957
  ...
  call void @hypre_Free(i8* %60) #5
  call void @hypre_Free(i8* %62) #5
  call void @hypre_Free(i8* %64) #5

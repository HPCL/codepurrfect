...
define dso_local i32 @hypre_seqAMGSetup(%struct.hypre_ParAMGData* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  ...
  %10 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 57
  ...
  %19 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 63
  %20 = load i32**, i32*** %19, align 8, !tbaa !13
  %21 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 49
  %22 = load i32, i32* %21, align 4, !tbaa !14
  %23 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 30
...
56:                                               ; preds = %3
  %57 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 31
  ...
  %63 = call i8* @hypre_CAlloc(i64 %62, i64 4) #5
...
74:                                               ; preds = %70
  ...
  %85 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 12
  ...
  %89 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 14
  ...
  %97 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 13
  %98 = load i32, i32* %97, align 4, !tbaa !32
  %99 = call i32 @HYPRE_BoomerAMGSetPMaxElmts(%struct.hypre_Solver_struct* %96, i32 %98) #5
  %100 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 40
...
106:                                              ; preds = %103, %74
  ...
  %108 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 38
  ...
  %112 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 42
  ...
  %115 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 41
...
155:                                              ; preds = %136, %128
  ...
  %164 = call i8* @hypre_CAlloc(i64 %163, i64 4) #5
  %165 = bitcast i8* %164 to i32*
  %166 = call i8* @hypre_CAlloc(i64 %163, i64 8) #5
...
233:                                              ; preds = %172, %155
  ...
  %237 = call i8* @hypre_CAlloc(i64 %236, i64 4) #5
...
262:                                              ; preds = %254
  ...
  %265 = call i8* @hypre_CAlloc(i64 %264, i64 4) #5
  %266 = bitcast i8* %265 to i32*
  %267 = call i8* @hypre_CAlloc(i64 %264, i64 4) #5
...
270:                                              ; preds = %262
  ...
  %272 = call i8* @hypre_CAlloc(i64 %271, i64 4) #5
...
320:                                              ; preds = %316
  ...
  %324 = call i8* @hypre_CAlloc(i64 %323, i64 4) #5
...
402:                                              ; preds = %385, %371
  ...
  %408 = call i8* @hypre_CAlloc(i64 %407, i64 4) #5
  %409 = call i8* @hypre_CAlloc(i64 %407, i64 8) #5
  br label %410
...
421:                                              ; preds = %418, %415
  call void @hypre_Free(i8* %63) #5
  call void @hypre_Free(i8* %237) #5
  call void @hypre_Free(i8* %132) #5
  call void @hypre_Free(i8* %164) #5
  call void @hypre_Free(i8* %166) #5
...
425:                                              ; preds = %421
  ...
  %427 = call i8* @hypre_CAlloc(i64 2, i64 4) #5
  ...
  %452 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 136
  store %struct.hypre_Solver_struct* %451, %struct.hypre_Solver_struct** %452, align 8, !tbaa !51
  %453 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 137
  store %struct.hypre_ParCSRMatrix_struct* %431, %struct.hypre_ParCSRMatrix_struct** %453, align 8, !tbaa !52
  %454 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 138
  store %struct.hypre_ParVector_struct* %442, %struct.hypre_ParVector_struct** %454, align 8, !tbaa !53
  %455 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 139
...
456:                                              ; preds = %421, %425
  ...
  %458 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 140
...
28:                                               ; preds = %3
  ...
  %31 = call i8* @hypre_CAllocHost(i64 %30, i64 4) #5
...
40:                                               ; preds = %28
  ...
  %43 = call i8* @hypre_CAllocHost(i64 %42, i64 4) #5
  %44 = bitcast i8* %43 to i32*
  %45 = call i8* @hypre_CAllocHost(i64 1, i64 4) #5
...
54:                                               ; preds = %53, %47
  ...
  call void @hypre_FreeHost(i8* %45) #5
  call void @hypre_FreeHost(i8* %43) #5
  br label %62
...
62:                                               ; preds = %54, %37
  ...
  call void @hypre_FreeHost(i8* %31) #5
...
define dso_local i32 @hypre_seqAMGCycle(%struct.hypre_ParAMGData* nocapture readonly %0, i32 %1, %struct.hypre_ParVector_struct** nocapture readonly %2, %struct.hypre_ParVector_struct** nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 140
  %9 = load i32, i32* %8, align 8, !tbaa !55
  %10 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 136
  %11 = bitcast %struct.hypre_Solver_struct** %10 to i8**
  %12 = load i8*, i8** %11, align 8, !tbaa !51
  %13 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 137
  %14 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %13, align 8, !tbaa !52
  %15 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 138
  %16 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %15, align 8, !tbaa !53
  %17 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 139
  ...
  %30 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 31
...
33:                                               ; preds = %4
  ...
  %36 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 30
...
154:                                              ; preds = %148
  ...
  call void @hypre_Free(i8* %155) #5
  br label %156

156:                                              ; preds = %154, %148
  %157 = bitcast i32* %116 to i8*
  call void @hypre_Free(i8* %157) #5
  br label %158
...
declare dso_local i8* @hypre_CAllocHost(i64, i64) local_unnamed_addr #2
...
declare dso_local void @hypre_FreeHost(i8*) local_unnamed_addr #2

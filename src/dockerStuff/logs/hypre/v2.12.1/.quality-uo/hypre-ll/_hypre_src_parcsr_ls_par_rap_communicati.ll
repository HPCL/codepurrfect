...
define dso_local i32 @hypre_GetCommPkgRTFromCommPkgA(%struct.hypre_ParCSRMatrix_struct* nocapture %0, %struct.hypre_ParCSRMatrix_struct* nocapture readonly %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %33 = call i8* @hypre_CAlloc(i64 %32, i64 4) #5
...
96:                                               ; preds = %87, %82
  ...
  %98 = call i8* @hypre_CAlloc(i64 %97, i64 4) #5
  %99 = bitcast i8* %98 to i32*
  %100 = add nsw i32 %83, 1
  %101 = sext i32 %100 to i64
  %102 = call i8* @hypre_CAlloc(i64 %101, i64 4) #5
...
129:                                              ; preds = %125, %96
  ...
  %134 = call i8* @hypre_CAlloc(i64 %131, i64 20) #5
...
186:                                              ; preds = %176, %171
  ...
  %189 = call i8* @hypre_CAlloc(i64 %188, i64 4) #5
...
220:                                              ; preds = %216, %186
  ...
  %224 = call i8* @hypre_CAlloc(i64 %223, i64 4) #5
...
287:                                              ; preds = %278, %273
  %288 = call i8* @hypre_CAlloc(i64 1, i64 72) #5
...
define dso_local i32 @hypre_GenerateSendMapAndCommPkg(i32 %0, i32 %1, i32 %2, i32* %3, i32* %4, i32* %5, %struct.hypre_ParCSRMatrix_struct* nocapture %6) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 4) #5
  %17 = bitcast i8* %16 to i32*
  %18 = call i8* @hypre_CAlloc(i64 %15, i64 20) #5
  %19 = bitcast i8* %18 to %struct.MPI_Status*
  %20 = add nsw i32 %1, 1
  %21 = sext i32 %20 to i64
  %22 = call i8* @hypre_CAlloc(i64 %21, i64 4) #5
...
77:                                               ; preds = %69, %62
  ...
  %82 = call i8* @hypre_CAlloc(i64 %81, i64 4) #5
...
145:                                              ; preds = %136, %131
  %146 = call i8* @hypre_CAlloc(i64 1, i64 72) #5
  ...
  call void @hypre_Free(i8* %18) #5
  call void @hypre_Free(i8* %16) #5

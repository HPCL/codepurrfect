...
81:                                               ; preds = %77, %4
  ...
  %105 = call i8* @hypre_MAlloc(i64 %104) #6
  ...
  %115 = call i8* @hypre_MAlloc(i64 %114) #6
...
717:                                              ; preds = %712, %584
  ...
  %720 = call i8* @hypre_CAlloc(i64 %719, i64 8) #6
...
818:                                              ; preds = %813, %717
  ...
  %829 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6
  %830 = bitcast i8* %829 to i8**
  %831 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6
  %832 = bitcast i8* %831 to i8**
  %833 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6
  %834 = bitcast i8* %833 to i8**
  %835 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6
  %836 = bitcast i8* %835 to i8**
  %837 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6
  %838 = bitcast i8* %837 to i8**
  %839 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6
  %840 = bitcast i8* %839 to i8**
  %841 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6
  %842 = bitcast i8* %841 to i8**
  %843 = call i8* @hypre_CAlloc(i64 %97, i64 8) #6

...
24:                                               ; preds = %20, %4
  ...
  %48 = call i8* @hypre_CAlloc(i64 %47, i64 8) #4
  %49 = bitcast i8* %48 to double*
  %50 = call i8* @hypre_CAlloc(i64 %47, i64 4) #4
  ...
  %57 = getelementptr inbounds i8, i8* %0, i64 632
...
118:                                              ; preds = %113, %102
  %119 = getelementptr inbounds i8, i8* %0, i64 656
  %120 = bitcast i8* %119 to double*
  %121 = getelementptr inbounds i8, i8* %0, i64 712
  %122 = bitcast i8* %121 to double*
  %123 = getelementptr inbounds i8, i8* %0, i64 700
...
194:                                              ; preds = %192, %166
  ...
  %197 = getelementptr inbounds i8, i8* %0, i64 656
...
define dso_local i32 @hypre_BoomerAMGCycleT(i8* nocapture %0, %struct.hypre_ParVector_struct** nocapture readonly %1, %struct.hypre_ParVector_struct** nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 632
  ...
  %36 = getelementptr inbounds i8, i8* %0, i64 656
  %37 = bitcast i8* %36 to double*
  %38 = load double, double* %37, align 8, !tbaa !30
  %39 = sext i32 %18 to i64
  %40 = call i8* @hypre_CAlloc(i64 %39, i64 4) #4
  %41 = bitcast i8* %40 to i32*
  %42 = icmp eq i32** %32, null
  %43 = call i8* @hypre_CAlloc(i64 %39, i64 8) #4
...
200:                                              ; preds = %137, %199
  ...
  call void @hypre_Free(i8* %40) #4
  call void @hypre_Free(i8* %43) #4
  ret i32 %201
}
...
56:                                               ; preds = %54
  ...
  %69 = call i8* @hypre_CAlloc(i64 %68, i64 8) #4
  %70 = bitcast i8* %69 to double*
  %71 = sext i32 %16 to i64
  %72 = call i8* @hypre_CAlloc(i64 %71, i64 8) #4
...
106:                                              ; preds = %101, %56
  %107 = call i32 @gselim(double* %70, double* %73, i32 %16) #4
...
120:                                              ; preds = %112, %106
  call void @hypre_Free(i8* %69) #4
  call void @hypre_Free(i8* %72) #4
  %121 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %57) #4
  %122 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %58) #4
  br label %123

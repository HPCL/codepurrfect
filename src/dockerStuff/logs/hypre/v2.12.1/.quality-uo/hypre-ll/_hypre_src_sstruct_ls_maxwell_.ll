...
define dso_local i8* @hypre_MaxwellTVCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 408) #4
  ...
  %24 = call i8* @hypre_MAlloc(i64 12) #4

...
define dso_local i32 @hypre_ParCSRMatrixScaledNorm(%struct.hypre_ParCSRMatrix_struct* %0, double* nocapture %1) local_unnamed_addr #0 {
  ...
  %6 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %5, align 8, !tbaa !3
  ...
  %31 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %18, i64 0, i32 3
...
66:                                               ; preds = %53, %2
  %67 = icmp eq %struct.hypre_ParCSRCommPkg* %6, null
  br i1 %67, label %68, label %71

68:                                               ; preds = %66
  %69 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) #5
  %70 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %5, align 8, !tbaa !3
  br label %71

71:                                               ; preds = %68, %66
  %72 = phi %struct.hypre_ParCSRCommPkg* [ %6, %66 ], [ %70, %68 ]
  %73 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %72, i64 0, i32 1
  %74 = load i32, i32* %73, align 4, !tbaa !30
  %75 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %72, i64 0, i32 3
  %76 = load i32*, i32** %75, align 8, !tbaa !32
  %77 = sext i32 %74 to i64
  %78 = getelementptr inbounds i32, i32* %76, i64 %77
  %79 = load i32, i32* %78, align 4, !tbaa !25
  %80 = sext i32 %79 to i64
  %81 = call i8* @hypre_CAlloc(i64 %80, i64 8) #5
  %82 = bitcast i8* %81 to double*
  %83 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %72, i64 0, i32 4
...
119:                                              ; preds = %90, %71
  ...
  %121 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %72, i8* %81, i8* %120) #5
...
!30 = !{!31, !5, i64 4}
!31 = !{!"", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64}
!32 = !{!31, !8, i64 16}

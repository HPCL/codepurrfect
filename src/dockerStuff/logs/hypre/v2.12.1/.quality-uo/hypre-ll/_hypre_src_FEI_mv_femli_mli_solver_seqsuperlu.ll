...
132:                                              ; preds = %128
  ...
  invoke void @_ZN10MLI_VectorC1EPvPKcP19MLI_Function_Struct(%class.MLI_Vector* nonnull align 8 dereferenceable(120) %170, i8* %171, i8* %1, %struct.MLI_Function_Struct* nonnull %166)

...
596:                                              ; preds = %594
  %597 = sext i32 %521 to i64
  %598 = sext i32 %479 to i64
  br label %610
...
610:                                              ; preds = %596, %679
  %611 = phi i32 [ %665, %679 ], [ %595, %596 ]
  %612 = phi i32 [ %662, %679 ], [ %580, %596 ]
  %613 = phi i32 [ %680, %679 ], [ 0, %596 ]
...
617:                                              ; preds = %623
  %618 = trunc i64 %643 to i32
  %619 = trunc i64 %644 to i32
  br label %620
...
623:                                              ; preds = %614, %623
  ...
  %642 = getelementptr inbounds double, double* %435, i64 %625

...
10:                                               ; preds = %2, %23
  ...
  %14 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* nonnull %4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %1, i32 %13) #11
  %15 = icmp eq i32 %12, 0
...
9:                                                ; preds = %18, %3
  ...
  %12 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* nonnull %7, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %2, i32 %10, i32 %11) #11
...
36:                                               ; preds = %34, %36
  ...
  %39 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* nonnull %7, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %2, i32 %38) #11

...
define dso_local void @iluk_mpi_pilu(%struct._mpi_interface_dh* %0) local_unnamed_addr #0 {
  ...
  call void @dh_StartFunc(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 39, i32 1) #3
...
31:                                               ; preds = %1
  ...
  %33 = call i32 @Parser_dhHasSwitch(%struct._parser_dh* %32, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0)) #3
  %34 = icmp eq i32 %33, 0
  %35 = xor i1 %34, true
...
37:                                               ; preds = %31, %1
  ...
  %41 = call i32 @Parser_dhHasSwitch(%struct._parser_dh* %40, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0)) #3
...
129:                                              ; preds = %118
  ...
  %133 = add i32 %132, 1
  %134 = add i32 %133, %75
  %135 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %130, i8* getelementptr inbounds ([95 x i8], [95 x i8]* @.str.4, i64 0, i64 0), i32 %134, i32 %131) #3
  br label %136

136:                                              ; preds = %129, %118
  %137 = load i8*, i8** %81, align 8, !tbaa !33
  call void @EuclidGetRow(i8* %137, i32 %128, i32* nonnull %12, i32** nonnull %11, double** nonnull %13) #3
  %138 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %139 = icmp eq i32 %138, 0
  br i1 %139, label %141, label %140

140:                                              ; preds = %136
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 93) #3
  br label %679
...
142:                                              ; preds = %141
  ...
  %144 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %143, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.6, i64 0, i64 0)) #3
...
147:                                              ; preds = %142, %147
  ...
  %157 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %149, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.7, i64 0, i64 0), i32 %153, double %156) #3
...
165:                                              ; preds = %162
  ...
  call void @compute_scaling_private(i32 %168, i32 %166, double* %167, %struct._mpi_interface_dh* %0) #3
  %169 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %170 = icmp eq i32 %169, 0
  br i1 %170, label %172, label %171

171:                                              ; preds = %165
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 104) #3
  br label %679

172:                                              ; preds = %165, %162
  %173 = trunc i64 %119 to i32
  call void @SortedList_dhReset(%struct._sortedList_dh* %26, i32 %173) #3
  %174 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %175 = icmp eq i32 %174, 0
  br i1 %175, label %177, label %176

176:                                              ; preds = %172
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 107) #3
  br label %679
...
177:                                              ; preds = %172
  ...
  call void @dh_StartFunc(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.17, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 235, i32 1) #3
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %89) #3
...
213:                                              ; preds = %177, %235
  ...
  %221 = call i32 @SortedList_dhPermuteAndInsert(%struct._sortedList_dh* %26, %struct._srecord* nonnull %9, double %204) #3
  %222 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %223 = icmp eq i32 %222, 0
  br i1 %223, label %225, label %224

224:                                              ; preds = %213
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.17, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 260) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %89) #3
...
229:                                              ; preds = %225
  ...
  %234 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %230, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.18, i64 0, i64 0), i32 %232, double %233) #3
  br label %235
...
240:                                              ; preds = %235, %177
  ...
  %244 = call %struct._srecord* @SortedList_dhFind(%struct._sortedList_dh* %26, %struct._srecord* nonnull %9) #3
  %245 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %246 = icmp eq i32 %245, 0
  br i1 %246, label %248, label %247

247:                                              ; preds = %240
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.17, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 272) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %89) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %88) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %87) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %86) #3
...
253:                                              ; preds = %250
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.17, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 274) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %89) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %88) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %87) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %86) #3
...
256:                                              ; preds = %254
  ...
  %261 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %257, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.19, i64 0, i64 0), i32 %260) #3
  br label %262
...
268:                                              ; preds = %262
  %269 = call %struct._srecord* @SortedList_dhGetSmallestLowerTri(%struct._sortedList_dh* %26) #3
  %270 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %271 = icmp eq i32 %270, 0
  br i1 %271, label %273, label %272

272:                                              ; preds = %341, %268
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.17, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 286) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %89) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %88) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %87) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %86) #3
...
279:                                              ; preds = %276
  ...
  %282 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %280, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.20, i64 0, i64 0), i32 %281) #3
  br label %283
...
307:                                              ; preds = %287
  ...
  call void @ExternalRows_dhGetRow(%struct._extrows_dh* %28, i32 %278, i32* nonnull %6, i32** nonnull %7, i32** nonnull %8, double** nonnull %10) #3
  %308 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %309 = icmp eq i32 %308, 0
  br i1 %309, label %311, label %310

310:                                              ; preds = %307
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.17, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 310) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %89) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %88) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %87) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %86) #3
...
315:                                              ; preds = %311
  ...
  %318 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %316, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.21, i64 0, i64 0), i32 %317) #3
  br label %319
...
336:                                              ; preds = %333
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.17, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 326) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %89) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %88) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %87) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %86) #3
...
341:                                              ; preds = %337, %319, %283
  %342 = call %struct._srecord* @SortedList_dhGetSmallestLowerTri(%struct._sortedList_dh* %26) #3
...
349:                                              ; preds = %346
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 113) #3
  br label %679
...
351:                                              ; preds = %350
  call void @dh_StartFunc(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.22, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 341, i32 1) #3
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %100) #3
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %101) #3
  %368 = getelementptr inbounds %struct._factor_dh, %struct._factor_dh* %361, i64 0, i32 9
  %369 = load double*, double** %368, align 8, !tbaa !23
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %102) #3
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %103) #3
...
372:                                              ; preds = %351
  %373 = call %struct._srecord* @SortedList_dhGetSmallestLowerTri(%struct._sortedList_dh* %26) #3
  %374 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %375 = icmp eq i32 %374, 0
  br i1 %375, label %378, label %377

376:                                              ; preds = %351
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.22, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 354) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %103) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %102) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %101) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %100) #3
  br label %487

377:                                              ; preds = %482, %372
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.22, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 356) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %103) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %102) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %101) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %100) #3
...
401:                                              ; preds = %381
  ...
  call void @ExternalRows_dhGetRow(%struct._extrows_dh* %28, i32 %383, i32* nonnull %2, i32** nonnull %4, i32** null, double** nonnull %3) #3
  %402 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %403 = icmp eq i32 %402, 0
  br i1 %403, label %405, label %404

404:                                              ; preds = %401
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.22, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 373) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %103) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %102) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %101) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %100) #3
...
409:                                              ; preds = %405
  ...
  %412 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %410, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.23, i64 0, i64 0), i32 %411) #3
  br label %413
...
416:                                              ; preds = %413
  ...
  %417 = call %struct._srecord* @SortedList_dhFind(%struct._sortedList_dh* %26, %struct._srecord* nonnull %5) #3
  %418 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %419 = icmp eq i32 %418, 0
  br i1 %419, label %421, label %420

420:                                              ; preds = %416
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.22, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 383) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %103) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %102) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %101) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %100) #3
...
423:                                              ; preds = %421
  ...
  %427 = add i32 %426, 1
  %428 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.24, i64 0, i64 0), i32 %425, i32 %427) #3
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.22, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 386) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %103) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %102) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %101) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %100) #3
...
442:                                              ; preds = %433
  ...
  %447 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %443, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.25, i64 0, i64 0), i32 %446, double %441) #3
  br label %448
...
452:                                              ; preds = %448, %471
  ...
  %459 = call %struct._srecord* @SortedList_dhFind(%struct._sortedList_dh* %26, %struct._srecord* nonnull %5) #3
  %460 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %461 = icmp eq i32 %460, 0
  br i1 %461, label %463, label %462

462:                                              ; preds = %452
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.22, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 406) #3
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %103) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %102) #3
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %101) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %100) #3
...
476:                                              ; preds = %475
  ...
  %481 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %477, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.26, i64 0, i64 0), i32 %480) #3
  br label %482

482:                                              ; preds = %471, %476, %475, %448, %413
  %483 = call %struct._srecord* @SortedList_dhGetSmallestLowerTri(%struct._sortedList_dh* %26) #3
...
490:                                              ; preds = %487
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 120) #3
  br label %679

491:                                              ; preds = %487, %350
  %492 = load i8*, i8** %81, align 8, !tbaa !33
  call void @EuclidRestoreRow(i8* %492, i32 %128, i32* nonnull %12, i32** nonnull %11, double** nonnull %13) #3
  %493 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %494 = icmp eq i32 %493, 0
  br i1 %494, label %496, label %495

495:                                              ; preds = %491
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 123) #3
  br label %679

496:                                              ; preds = %491
  %497 = call i32 @SortedList_dhReadCount(%struct._sortedList_dh* %26) #3
  %498 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %499 = icmp eq i32 %498, 0
  br i1 %499, label %501, label %500

500:                                              ; preds = %496
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 126) #3
  br label %679
...
505:                                              ; preds = %501
  call void @Factor_dhReallocate(%struct._factor_dh* %24, i32 %124, i32 %497) #3
  %506 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %507 = icmp eq i32 %506, 0
  br i1 %507, label %509, label %508

508:                                              ; preds = %505
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 130) #3
  br label %679

509:                                              ; preds = %505
  call void @setInfo_dh(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 131) #3
...
522:                                              ; preds = %517
  %523 = call %struct._srecord* @SortedList_dhGetSmallest(%struct._sortedList_dh* %26) #3
  %524 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %525 = icmp eq i32 %524, 0
  br i1 %525, label %527, label %526

526:                                              ; preds = %522
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 141) #3
  br label %546
...
554:                                              ; preds = %551
  ...
  %556 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %555, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.9, i64 0, i64 0)) #3
  br label %557
...
562:                                              ; preds = %557
  %563 = call %struct._srecord* @SortedList_dhGetSmallest(%struct._sortedList_dh* %26) #3
  %564 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %565 = icmp eq i32 %564, 0
  br i1 %565, label %567, label %566

566:                                              ; preds = %562
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 156) #3
  br label %583
...
567:                                              ; preds = %562
  ...
  %581 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %578, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.10, i64 0, i64 0), i32 %580, i32 %576, double %573) #3
...
585:                                              ; preds = %557
  ...
  %587 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %586, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0)) #3
  br label %612
...
593:                                              ; preds = %588
  %594 = call %struct._srecord* @SortedList_dhGetSmallest(%struct._sortedList_dh* %26) #3
  %595 = load i32, i32* @errFlag_dh, align 4, !tbaa !26
  %596 = icmp eq i32 %595, 0
  br i1 %596, label %598, label %597

597:                                              ; preds = %593
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 168) #3
  br label %610
...
643:                                              ; preds = %639
  ...
  %649 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %641, i8* getelementptr inbounds ([62 x i8], [62 x i8]* @.str.12, i64 0, i64 0), i32 %648, i32 %644, i32 %647) #3
...
654:                                              ; preds = %643, %654
  ...
  %659 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %656, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i64 0, i64 0), i32 %658) #3
...
663:                                              ; preds = %654, %643
  ...
  %665 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %664, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.14, i64 0, i64 0)) #3
  br label %666

666:                                              ; preds = %663, %639
  %667 = trunc i64 %614 to i32
  %668 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.15, i64 0, i64 0), i32 %667) #3
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 201) #3
...
676:                                              ; preds = %669
  ...
  %678 = call i32 (i8*, i8*, ...) @hypre_sprintf(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.16, i64 0, i64 0), i32 %677) #3
  call void @setError_dh(i8* getelementptr inbounds ([1024 x i8], [1024 x i8]* @msgBuf_dh, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 214) #3
  br label %679

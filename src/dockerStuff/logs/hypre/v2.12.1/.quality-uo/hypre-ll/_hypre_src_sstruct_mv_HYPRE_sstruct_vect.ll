...
define dso_local i32 @HYPRE_SStructVectorCreate(i32 %0, %struct.hypre_SStructGrid_struct* %1, %struct.hypre_SStructVector_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_MAlloc(i64 96) #5
  ...
  %20 = shl nsw i64 %19, 3
  %21 = call i8* @hypre_MAlloc(i64 %20) #5
...
define dso_local i32 @HYPRE_SStructVectorInitialize(%struct.hypre_SStructVector_struct* %0) local_unnamed_addr #0 {
  ...
  %14 = call i8* @hypre_CAlloc(i64 %13, i64 8) #5
...
define dso_local i32 @HYPRE_SStructVectorSetBoxValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* %2, i32* %3, i32 %4, double* %5) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %17) #5
  %18 = getelementptr inbounds [3 x i32], [3 x i32]* %7, i64 0, i64 0
  %19 = call i32 @hypre_CopyToCleanIndex(i32* %2, i32 %10, i32* nonnull %18) #5
  %20 = getelementptr inbounds [3 x i32], [3 x i32]* %8, i64 0, i64 0
  %21 = call i32 @hypre_CopyToCleanIndex(i32* %3, i32 %10, i32* nonnull %20) #5
  %22 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %15, i32* nonnull %18, i32* nonnull %20, i32 %4, double* %5, i32 0) #5
  %23 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %17) #5
...
define dso_local i32 @HYPRE_SStructVectorAddToBoxValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* %2, i32* %3, i32 %4, double* %5) local_unnamed_addr #0 {
  ...
  %20 = getelementptr inbounds [3 x i32], [3 x i32]* %8, i64 0, i64 0
  %21 = call i32 @hypre_CopyToCleanIndex(i32* %3, i32 %10, i32* nonnull %20) #5
  %22 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %15, i32* nonnull %18, i32* nonnull %20, i32 %4, double* %5, i32 1) #5
  %23 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %17) #5
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %16) #5
  ret i32 %23
...
define dso_local i32 @HYPRE_SStructVectorGetBoxValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* %2, i32* %3, i32 %4, double* %5) local_unnamed_addr #0 {
  ...
  %20 = getelementptr inbounds [3 x i32], [3 x i32]* %8, i64 0, i64 0
  %21 = call i32 @hypre_CopyToCleanIndex(i32* %3, i32 %10, i32* nonnull %20) #5
  %22 = call i32 @hypre_SStructPVectorGetBoxValues(%struct.hypre_SStructPVector* %15, i32* nonnull %18, i32* nonnull %20, i32 %4, double* %5) #5
  %23 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %17) #5
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %16) #5
  ret i32 %23

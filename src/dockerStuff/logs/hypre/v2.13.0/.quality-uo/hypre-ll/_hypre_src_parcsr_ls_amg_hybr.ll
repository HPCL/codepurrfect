...
257:                                              ; preds = %254
  ...
  %280 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
...
337:                                              ; preds = %335
  %338 = call i8* @hypre_CAlloc(i64 4, i64 4) #4
...
350:                                              ; preds = %347
  %351 = call i8* @hypre_CAlloc(i64 4, i64 8) #4
...
353:                                              ; preds = %350, %376
  ...
  %358 = call i8* @hypre_CAlloc(i64 %357, i64 4) #4
...
383:                                              ; preds = %381
  ...
  %385 = call i8* @hypre_CAlloc(i64 %384, i64 4) #4

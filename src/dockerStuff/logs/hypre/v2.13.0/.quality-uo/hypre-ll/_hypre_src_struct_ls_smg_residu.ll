...
646:                                              ; preds = %631, %719
  %647 = phi i32 [ %705, %719 ], [ %630, %631 ]
  %648 = phi i32 [ %702, %719 ], [ %615, %631 ]
  %649 = phi i32 [ %699, %719 ], [ %600, %631 ]
  %650 = phi i32 [ %720, %719 ], [ 0, %631 ]
...
655:                                              ; preds = %663
  %656 = trunc i64 %679 to i32
  %657 = trunc i64 %680 to i32
  %658 = trunc i64 %681 to i32
  br label %659

659:                                              ; preds = %655, %646
  %660 = phi i32 [ %649, %646 ], [ %656, %655 ]
  %661 = phi i32 [ %648, %646 ], [ %657, %655 ]
  %662 = phi i32 [ %647, %646 ], [ %658, %655 ]
  br label %684

663:                                              ; preds = %651, %663
  %664 = phi i64 [ %654, %651 ], [ %679, %663 ]
  %665 = phi i64 [ %653, %651 ], [ %680, %663 ]
  %666 = phi i64 [ %652, %651 ], [ %681, %663 ]
  %667 = phi i32 [ 0, %651 ], [ %682, %663 ]
  %668 = add nsw i64 %664, %423

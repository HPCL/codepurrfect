...
define dso_local i32 @hypre_SStructPGridCreate(i32 %0, i32 %1, %struct.hypre_SStructPGrid** nocapture %2) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 200) #8
...
define dso_local i32 @hypre_SStructPGridSetVariables(%struct.hypre_SStructPGrid* nocapture %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %7 = sext i32 %1 to i64
  %8 = shl nsw i64 %7, 2
  %9 = call i8* @hypre_MAlloc(i64 %8) #8
...
13:                                               ; preds = %3
  ...
  %18 = call i8* @hypre_ReAlloc(i8* %14, i64 %17) #8
...
57:                                               ; preds = %55, %150
  ...
  %67 = shl nsw i64 %66, 3
  %68 = call i8* @hypre_MAlloc(i64 %67) #8
...
define dso_local i32 @hypre_SStructGridAssembleNborBoxManagers(%struct.hypre_SStructGrid_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %40 = call i8* @hypre_MAlloc(i64 84) #8
  %41 = call i8* @hypre_CAlloc(i64 1, i64 84) #8
...
109:                                              ; preds = %104, %563
  ...
  %118 = call i8* @hypre_MAlloc(i64 %117) #8
...
17:                                               ; preds = %7
  ...
  %41 = sext i32 %40 to i64
  %42 = shl nsw i64 %41, 3
  %43 = call i8* @hypre_ReAlloc(i8* %37, i64 %42) #8
...
55:                                               ; preds = %44, %1
  ...
  %60 = call i8* @hypre_CAlloc(i64 %59, i64 8) #8
...
363:                                              ; preds = %360
  ...
  %388 = call i8* @hypre_CAlloc(i64 1, i64 4) #8
  ...
  %393 = call i8* @hypre_CAlloc(i64 %392, i64 12) #8
  ...
  %398 = call i8* @hypre_CAlloc(i64 %397, i64 12) #8
  %399 = call i8* @hypre_MAlloc(i64 64) #8
  ...
  %421 = call i8* @hypre_MAlloc(i64 64) #8
...
513:                                              ; preds = %510
  ...
  %519 = call i8* @hypre_ReAlloc(i8* %515, i64 %518) #8
  ...
  %527 = call i8* @hypre_ReAlloc(i8* %526, i64 %518) #8
  ...
  %536 = call i8* @hypre_ReAlloc(i8* %535, i64 %518) #8
...
691:                                              ; preds = %687, %55
  ...
  %695 = call i8* @hypre_MAlloc(i64 %694) #8
...
747:                                              ; preds = %740
  %748 = call i8* @hypre_MAlloc(i64 24) #8
...
define dso_local i32 @hypre_SStructBoxNumMap(%struct.hypre_SStructGrid_struct* nocapture readonly %0, i32 %1, i32 %2, i32** nocapture %3, i32*** nocapture %4) local_unnamed_addr #0 {
  ...
  %36 = shl nsw i64 %33, 3
  %37 = call i8* @hypre_MAlloc(i64 %36) #8
...
90:                                               ; preds = %86
  ...
  %92 = shl nsw i64 %91, 2
  %93 = call i8* @hypre_MAlloc(i64 %92) #8
...
define dso_local i32 @hypre_SStructCellGridBoxNumMap(%struct.hypre_SStructGrid_struct* nocapture readonly %0, i32 %1, i32*** nocapture %2, i32**** nocapture %3) local_unnamed_addr #0 {
  ...
  %16 = sext i32 %15 to i64
  %17 = shl nsw i64 %16, 3
  %18 = call i8* @hypre_MAlloc(i64 %17) #8
  %19 = bitcast i8* %18 to i32**
  %20 = call i8* @hypre_MAlloc(i64 %17) #8

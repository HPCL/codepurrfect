...
define dso_local i32 @hypre_BoomerAMGBlockCreateNodalA(%struct.hypre_ParCSRBlockMatrix* %0, i32 %1, i32 %2, %struct.hypre_ParCSRMatrix_struct** nocapture %3) local_unnamed_addr #0 {
  ...
  %15 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %10, i64 0, i32 3
...
41:                                               ; preds = %38, %4
  ...
  %43 = call i8* @hypre_CAlloc(i64 2, i64 4) #4
...
52:                                               ; preds = %45
  ...
  %56 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %10, i64 0, i32 4
...
76:                                               ; preds = %69, %52
  ...
  %78 = call i8* @hypre_CAlloc(i64 %77, i64 4) #4
  %79 = bitcast i8* %78 to i32*
  %80 = call i8* @hypre_CAlloc(i64 %77, i64 8) #4
  ...
  %86 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %82, i64 0, i32 6
...
156:                                              ; preds = %154
  %157 = call i8* @hypre_CAlloc(i64 1, i64 72) #4
...
184:                                              ; preds = %175, %156
  ...
  %189 = call i8* @hypre_CAlloc(i64 %188, i64 4) #4
...
218:                                              ; preds = %211, %204
  ...
  %231 = call i8* @hypre_CAlloc(i64 %230, i64 4) #4
...
234:                                              ; preds = %218
  ...
  %236 = call i8* @hypre_CAlloc(i64 %235, i64 4) #4
...
259:                                              ; preds = %254, %154
  ...
  %261 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %19, i64 0, i32 5
  %262 = load i32, i32* %261, align 8, !tbaa !48
  %263 = sext i32 %262 to i64
  %264 = call i8* @hypre_CAlloc(i64 %263, i64 4) #4
...
276:                                              ; preds = %269, %259
  ...
  %279 = call i8* @hypre_CAlloc(i64 %62, i64 4) #4
...
292:                                              ; preds = %285, %276
  ...
  %294 = call i8* @hypre_CAlloc(i64 %293, i64 4) #4
  %295 = bitcast i8* %294 to i32*
  %296 = call i8* @hypre_CAlloc(i64 %293, i64 8) #4
...
315:                                              ; preds = %301, %292
  ...
  %320 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %316, i64 0, i32 6
...
!10 = !{!4, !8, i64 32}
!11 = !{!12, !8, i64 8}
!12 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !5, i64 36, !5, i64 40}
!13 = !{!12, !8, i64 0}
!14 = !{!12, !5, i64 24}
!15 = !{!4, !8, i64 40}
!16 = !{!12, !8, i64 16}
...
!27 = !{!28, !8, i64 0}
!28 = !{!"", !8, i64 0, !8, i64 8, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !5, i64 48}
!29 = !{!28, !8, i64 8}
!30 = !{!28, !8, i64 32}
!31 = !{!9, !9, i64 0}

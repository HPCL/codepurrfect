...
define dso_local i32 @HYPRE_ParCSRCotreeCreate(i32 %0, %struct.hypre_Solver_struct** nocapture %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_CAlloc(i64 1, i64 96) #8
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* nonnull %4) #8
...
7:                                                ; preds = %3
  %8 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* nonnull %5) #8
...
12:                                               ; preds = %9
  %13 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* nonnull %10) #8
...
17:                                               ; preds = %14
  %18 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* nonnull %15) #8
...
22:                                               ; preds = %19
  %23 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* nonnull %20) #8
...
27:                                               ; preds = %24
  %28 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* nonnull %25) #8
...
32:                                               ; preds = %29
  %33 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* nonnull %30) #8
...
42:                                               ; preds = %39
  %43 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* nonnull %40) #8
...
define dso_local i32 @HYPRE_ParCSRCotreeSetup(%struct.hypre_Solver_struct* nocapture %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readonly %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #0 {
  ...
  call void @hypre_ParCSRMatrixGenSpanningTree(%struct.hypre_ParCSRMatrix_struct* %14, i32** nonnull %6, i32 1) #8
  %15 = call noalias align 16 dereferenceable_or_null(8) i8* @malloc(i64 8) #8
  ...
  call void @hypre_ParCSRMatrixExtractSubmatrices(%struct.hypre_ParCSRMatrix_struct* %17, i32* %18, %struct.hypre_ParCSRMatrix_struct*** nonnull %7) #8
  ...
  call void @hypre_ParCSRMatrixExtractRowSubmatrices(%struct.hypre_ParCSRMatrix_struct* %31, i32* %32, %struct.hypre_ParCSRMatrix_struct*** nonnull %7) #8
  ...
  %42 = call i32 @MPI_Comm_size(i32 %41, i32* nonnull %5) #8
...
55:                                               ; preds = %52, %55
  ...
  br i1 %61, label %62, label %55, !llvm.loop !27
...
62:                                               ; preds = %55, %4
  ...
  %67 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %64, i32 %66, i32* %50) #8
  %68 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %67) #8
...
define dso_local i32 @HYPRE_ParCSRCotreeSolve(%struct.hypre_Solver_struct* nocapture %0, %struct.hypre_ParCSRMatrix_struct* nocapture readnone %1, %struct.hypre_ParVector_struct* nocapture readnone %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #5 {
...
define dso_local i32 @HYPRE_ParCSRCotreeSetTol(%struct.hypre_Solver_struct* nocapture readnone %0, double %1) local_unnamed_addr #6 {
  ret i32 0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone uwtable willreturn
define dso_local i32 @HYPRE_ParCSRCotreeSetMaxIter(%struct.hypre_Solver_struct* nocapture readnone %0, i32 %1) local_unnamed_addr #6 {
  ret i32 0
}

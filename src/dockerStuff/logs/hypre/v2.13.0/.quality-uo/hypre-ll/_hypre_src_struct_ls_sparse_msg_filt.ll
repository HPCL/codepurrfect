...
270:                                              ; preds = %257, %381
  %271 = phi i32 [ %367, %381 ], [ %256, %257 ]
  %272 = phi i32 [ %364, %381 ], [ %241, %257 ]
...
277:                                              ; preds = %327
  %278 = trunc i64 %345 to i32
  %279 = trunc i64 %346 to i32
  br label %280
...
283:                                              ; preds = %274, %327
  %284 = phi i64 [ %276, %274 ], [ %345, %327 ]
  %285 = phi i64 [ %275, %274 ], [ %346, %327 ]
...
292:                                              ; preds = %287, %292
  ...
  %294 = phi double [ 0.000000e+00, %287 ], [ %324, %292 ]
  %295 = phi double [ 0.000000e+00, %287 ], [ %316, %292 ]
  %296 = phi double [ 0.000000e+00, %287 ], [ %308, %292 ]
  ...
  %304 = getelementptr inbounds double, double* %300, i64 %284
  ...
  %312 = getelementptr inbounds double, double* %300, i64 %284

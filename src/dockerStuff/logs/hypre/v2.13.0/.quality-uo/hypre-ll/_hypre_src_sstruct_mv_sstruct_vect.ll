...
define dso_local i32 @hypre_SStructPVectorCreate(i32 %0, %struct.hypre_SStructPGrid* %1, %struct.hypre_SStructPVector** nocapture %2) local_unnamed_addr #1 {
  %4 = call i8* @hypre_MAlloc(i64 64) #8
  ...
  %13 = shl nsw i64 %12, 3
  %14 = call i8* @hypre_MAlloc(i64 %13) #8
...
32:                                               ; preds = %20, %3
  ...
  %35 = call i8* @hypre_MAlloc(i64 %13) #8
  %36 = icmp sgt i32 %9, 0
...
define dso_local i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* nocapture readonly %0, i32* %1, i32* %2, i32 %3, double* %4, i32 %5) local_unnamed_addr #1 {
  ...
  %17 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %16) #8
  %18 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %17, i64 0, i32 0, i64 0
  %19 = call i32 @hypre_CopyIndex(i32* %1, i32* %18) #8
  %20 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %17, i64 0, i32 1, i64 0
  %21 = call i32 @hypre_CopyIndex(i32* %2, i32* nonnull %20) #8
  %22 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* %17, %struct.hypre_Box_struct* %17, double* %4, i32 %5, i32 -1, i32 0) #8
  %23 = icmp eq i32 %5, 0
...
24:                                               ; preds = %6
  ...
  %33 = call i32 @hypre_SStructVariableGetOffset(i32 %31, i32 %16, i32* nonnull %32) #8
  ...
  %37 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 1, i32 %16) #8
  %38 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 2, i32 %16) #8
  %39 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 0, i32 %16) #8
  ...
  %45 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %17, %struct.hypre_Box_struct* %44) #8
  %46 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %37, i32 1) #8
  %47 = call i32 @hypre_SubtractBoxArrays(%struct.hypre_BoxArray_struct* %37, %struct.hypre_BoxArray_struct* %36, %struct.hypre_BoxArray_struct* %39) #8
  %48 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %38, i32 0) #8
...
54:                                               ; preds = %24, %76
  ...
  %56 = call i32 @hypre_SubtractBoxArrays(%struct.hypre_BoxArray_struct* %37, %struct.hypre_BoxArray_struct* %38, %struct.hypre_BoxArray_struct* %39) #8
  %57 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %38, i32 1) #8
  ...
  %60 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %59, %struct.hypre_Box_struct* %41) #8
  %61 = call i32 @hypre_BoxGrowByIndex(%struct.hypre_Box_struct* %41, i32* nonnull %32) #8
...
66:                                               ; preds = %64, %66
  ...
  %70 = call i32 @hypre_IntersectBoxes(%struct.hypre_Box_struct* %69, %struct.hypre_Box_struct* %41, %struct.hypre_Box_struct* nonnull %42) #8
  %71 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* nonnull %42, %struct.hypre_Box_struct* %17, double* %4, i32 %5, i32 %65, i32 1) #8
...
81:                                               ; preds = %76, %24
  %82 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %37) #8
  %83 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %38) #8
  %84 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %39) #8
...
85:                                               ; preds = %6
  ...
  %89 = call %struct.hypre_BoxArray_struct* @hypre_BoxArrayCreate(i32 0, i32 %16) #8
...
96:                                               ; preds = %85, %115
  ...
  %100 = call i32 @hypre_BoxArraySetSize(%struct.hypre_BoxArray_struct* %89, i32 0) #8
  %101 = call i32 @hypre_SubtractBoxes(%struct.hypre_Box_struct* %17, %struct.hypre_Box_struct* %99, %struct.hypre_BoxArray_struct* %89) #8
...
106:                                              ; preds = %104, %106
  ...
  %110 = call i32 @hypre_StructVectorClearBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* %109, i32 %105, i32 1) #8
...
120:                                              ; preds = %115, %85
  %121 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %89) #8
  br label %122

122:                                              ; preds = %120, %81
  %123 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %17) #8
...
define dso_local i32 @hypre_SStructPVectorGetBoxValues(%struct.hypre_SStructPVector* nocapture readonly %0, i32* %1, i32* %2, i32 %3, double* %4) local_unnamed_addr #1 {
  ...
  %31 = call i32 @hypre_StructVectorSetBoxValues(%struct.hypre_StructVector_struct* %12, %struct.hypre_Box_struct* %24, %struct.hypre_Box_struct* %24, double* %4, i32 -1, i32 -1, i32 0) #8
  store %struct.hypre_BoxArray_struct* %30, %struct.hypre_BoxArray_struct** %29, align 8, !tbaa !30
  %32 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %24) #8
...
define dso_local i32 @hypre_SStructPVectorInitializeShell(%struct.hypre_SStructPVector* nocapture %0) local_unnamed_addr #1 {
  ...
  %3 = load i32, i32* %2, align 8, !tbaa !15
  %4 = sext i32 %3 to i64
  %5 = call i8* @hypre_CAlloc(i64 %4, i64 4) #8
...
11:                                               ; preds = %9, %39
  ...
  %19 = sext i32 %18 to i64
  %20 = call i8* @hypre_CAlloc(i64 %19, i64 4) #8

...
define dso_local noalias %struct.Mem* @MemCreate() local_unnamed_addr #0 {
  %1 = call noalias align 16 dereferenceable_or_null(8232) i8* @malloc(i64 8232) #7
...
define dso_local void @MemDestroy(%struct.Mem* nocapture %0) local_unnamed_addr #2 {
...
; Function Attrs: nounwind uwtable
define dso_local i8* @MemAlloc(%struct.Mem* nocapture %0, i32 %1) local_unnamed_addr #2 {
  %3 = add nsw i32 %1, 15
  %4 = sdiv i32 %3, 16
  %5 = shl nsw i32 %4, 4
...
13:                                               ; preds = %9
  %14 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str, i64 0, i64 0), i32 1024) #7
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !10
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %17 = call i32 @fflush(%struct._IO_FILE* null)
  %18 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %19
...
26:                                               ; preds = %19
  %27 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.2, i64 0, i64 0), i32 %21) #7
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !10
  %29 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %30 = call i32 @fflush(%struct._IO_FILE* null)
  %31 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %32
...
; Function Attrs: nounwind uwtable
define dso_local void @MemStat(%struct.Mem* nocapture readonly %0, %struct._IO_FILE* %1, i8* %2) local_unnamed_addr #2 {
  %4 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0), i8* %2) #7
  %5 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 0
  %6 = load i32, i32* %5, align 8, !tbaa !3
  %7 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i64 0, i64 0), i32 %6) #7
  %8 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 4
  %9 = load i32, i32* %8, align 8, !tbaa !18
  %10 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i64 0, i64 0), i32 %9) #7
  %11 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 2
  %12 = load i64, i64* %11, align 8, !tbaa !16
  %13 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.6, i64 0, i64 0), i64 %12) #7
  %14 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 3
  %15 = load i64, i64* %14, align 8, !tbaa !17
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i64 %15) #7
...
19:                                               ; preds = %3
  ...
  %24 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), double %23) #7
  br label %25

25:                                               ; preds = %19, %3
  %26 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.9, i64 0, i64 0)) #7

...
define dso_local %struct.hypre_SStructPMatrix* @hypre_SysPFMGCreateRAPOp(%struct.hypre_SStructPMatrix* nocapture readonly %0, %struct.hypre_SStructPMatrix* nocapture readonly %1, %struct.hypre_SStructPMatrix* nocapture readonly %2, %struct.hypre_SStructPGrid* %3, i32 %4) local_unnamed_addr #0 {
  ...
  %23 = call i8* @hypre_CAlloc(i64 %22, i64 8) #3
  %24 = bitcast i8* %23 to %struct.hypre_SStructStencil_struct**
  %25 = call i8* @hypre_CAlloc(i64 %22, i64 8) #3
  %26 = bitcast i8* %25 to [3 x i32]**
  %27 = call i8* @hypre_CAlloc(i64 %22, i64 4) #3
...
61:                                               ; preds = %46
  ...
  %72 = call i8* @hypre_CAlloc(i64 %71, i64 12) #3
...
!16 = !{!4, !8, i64 48}
!17 = !{!18, !8, i64 24}
!18 = !{!"hypre_StructMatrix_struct", !5, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !5, i64 60, !8, i64 64, !5, i64 72, !5, i64 76, !8, i64 80, !6, i64 88, !5, i64 112, !8, i64 120, !5, i64 128}
!19 = !{!11, !8, i64 0}
!20 = !{!11, !5, i64 8}

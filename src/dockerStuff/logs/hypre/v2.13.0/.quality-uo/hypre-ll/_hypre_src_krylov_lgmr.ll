...
91:                                               ; preds = %86
  ...
  %93 = load i8* (i64, i64)*, i8* (i64, i64)** %92, align 8, !tbaa !3
  %94 = sext i32 %23 to i64
  %95 = call i8* %93(i64 %94, i64 4) #9
...
122:                                              ; preds = %117
  ...
  %124 = load i8* (i64, i64)*, i8* (i64, i64)** %123, align 8, !tbaa !3
  %125 = add nsw i32 %12, 1
  %126 = sext i32 %125 to i64
  %127 = call i8* %124(i64 %126, i64 8) #9
...
108:                                              ; preds = %104, %108
  ...
  %111 = call i8* %110(i64 %92, i64 8) #9

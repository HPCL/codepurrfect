...
define dso_local %struct.hypre_StructVector_struct* @hypre_StructVectorCreate(i32 %0, %struct.hypre_StructGrid_struct* %1) local_unnamed_addr #0 {
  ...
  %5 = call i8* @hypre_CAlloc(i64 1, i64 88) #11
...
16:                                               ; preds = %12, %8
  ...
  call void @hypre_Free(i8* nonnull %26) #11
  br label %27
...
55:                                               ; preds = %51
  ...
  %60 = call i8* @hypre_CAlloc(i64 %59, i64 4) #11
...
38:                                               ; preds = %32
  ...
  %48 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %47, i32* %1) #11
...
17:                                               ; preds = %3
  %18 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %13, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0)) #11
  %19 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %13, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0)) #11
...
29:                                               ; preds = %17, %26
  ...
  %31 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %13, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0)) #11
  ...
  %36 = call i32 @hypre_PrintBoxArrayData(%struct._IO_FILE* nonnull %13, %struct.hypre_BoxArray_struct* %30, %struct.hypre_BoxArray_struct* %24, i32 1, i32 %33, double* %35) #11
...
15:                                               ; preds = %3
  %16 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), i8* nonnull %7) #11
  call void @exit(i32 1) #12
  unreachable

17:                                               ; preds = %3
  %18 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* nonnull %13, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0)) #11
  %19 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* nonnull %13, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0)) #11
  ...
  %24 = call i8* @hypre_CAlloc(i64 1, i64 88) #11
...
71:                                               ; preds = %59, %49
  ...
  %77 = call i8* @hypre_CAlloc(i64 %76, i64 8) #11
  ...
  %89 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* nonnull %13, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i64 0, i64 0)) #11
  ...
  %94 = call i32 @hypre_ReadBoxArrayData(%struct._IO_FILE* nonnull %13, %struct.hypre_BoxArray_struct* %85, %struct.hypre_BoxArray_struct* %88, i32 1, i32 %92, double* %93) #11
...
26:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.7, i64 0, i64 0), i32 1205, i32 1, i8* null) #11
  br label %241

27:                                               ; preds = %4
  %28 = getelementptr inbounds [3 x i32], [3 x i32]* %7, i64 0, i64 0
  %29 = call i32 @hypre_SetIndex(i32* nonnull %28, i32 1) #11
...
75:                                               ; preds = %53, %230
  ...
  %85 = call i32 @hypre_BoxGetSize(%struct.hypre_Box_struct* %78, i32* nonnull %33) #11
  %86 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %78, i64 0, i32 0, i64 0
  %87 = call i32 @hypre_CopyIndex(i32* %86, i32* nonnull %34) #11
  %88 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %78, i32* nonnull %34) #11
  %89 = sext i32 %88 to i64
  %90 = getelementptr inbounds double, double* %84, i64 %89
  %91 = load double, double* %90, align 8, !tbaa !33
  %92 = call i32 @hypre_SetIndex(i32* %3, i32 0) #11
...
143:                                              ; preds = %116, %103
  ...
  %144 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %78, i32* nonnull %34) #11
...
230:                                              ; preds = %227, %152, %143
  ...
  %233 = call i32 @hypre_AddIndexes(i32* %3, i32* nonnull %34, i32 %20, i32* %3) #11
...
define dso_local %struct.hypre_StructVector_struct* @hypre_StructVectorClone(%struct.hypre_StructVector_struct* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_CAlloc(i64 1, i64 88) #11

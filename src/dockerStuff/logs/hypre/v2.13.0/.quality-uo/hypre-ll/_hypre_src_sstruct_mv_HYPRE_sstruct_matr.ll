...
define dso_local i32 @HYPRE_SStructMatrixCreate(i32 %0, %struct.hypre_SStructGraph_struct* %1, %struct.hypre_SStructMatrix_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 120) #6
...
66:                                               ; preds = %62, %125
  ...
  %83 = call i8* @hypre_MAlloc(i64 %58) #6
...
168:                                              ; preds = %164, %131
  ...
  %180 = call i8* @hypre_MAlloc(i64 %179) #6
...
65:                                               ; preds = %53, %8
  ...
  call void @hypre_Free(i8* %67) #6
  %68 = bitcast %struct.hypre_SStructPMatrix** %16 to i8*
  call void @hypre_Free(i8* %68) #6
...
19:                                               ; preds = %17, %123
  ...
  %29 = shl nsw i64 %28, 3
  %30 = call i8* @hypre_MAlloc(i64 %29) #6
...
87:                                               ; preds = %49
  ...
  %99 = shl nsw i64 %98, 2
  %100 = call i8* @hypre_MAlloc(i64 %99) #6
...
125:                                              ; preds = %121, %87
  ...
  %130 = call i8* @hypre_MAlloc(i64 %129) #6
  %131 = bitcast i8* %130 to i32**
  %132 = call i8* @hypre_MAlloc(i64 %99) #6
...
179:                                              ; preds = %176, %145
  %180 = call i8* @hypre_MAlloc(i64 %99) #6

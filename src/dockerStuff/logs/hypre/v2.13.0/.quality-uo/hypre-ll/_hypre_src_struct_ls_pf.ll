...
define dso_local i8* @hypre_PFMGCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 280) #4
...
46:                                               ; preds = %40
  ...
  %50 = call i32 @hypre_PFMGRelaxDestroy(i8* %49) #4
  br label %51
...
51:                                               ; preds = %46, %40
  ...
  %55 = call i32 @hypre_StructMatvecDestroy(i8* %54) #4
...
75:                                               ; preds = %60, %33
  ...
  %96 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %95) #4
  ...
  %101 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %100) #4
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 545, i32 12, i8* null) #4
  br label %30

...
define dso_local %struct.hypre_CSRBlockMatrix* @hypre_ExchangeRAPBlockData(%struct.hypre_CSRBlockMatrix* nocapture readonly %0, %struct.hypre_ParCSRCommPkg* %1, i32 %2) local_unnamed_addr #0 {
  ...
  %22 = call i32 @hypre_MPI_Comm_size(i32 %7, i32* nonnull %4) #6
  %23 = call i32 @hypre_MPI_Comm_rank(i32 %7, i32* nonnull %5) #6
  %24 = mul nsw i32 %2, %2
...
102:                                              ; preds = %99
  ...
  %106 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct.hypre_ParCSRCommPkg* %1, i8* nonnull %104, i8* nonnull %105) #6
  br label %116
...
108:                                              ; preds = %107
  ...
  %111 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct.hypre_ParCSRCommPkg* %1, i8* nonnull %110, i8* null) #6
  br label %116
...
113:                                              ; preds = %112
  ...
  %115 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct.hypre_ParCSRCommPkg* %1, i8* null, i8* nonnull %114) #6
  br label %116

116:                                              ; preds = %108, %113, %112, %102
  %117 = phi %struct.hypre_ParCSRCommHandle* [ %106, %102 ], [ %111, %108 ], [ %115, %113 ], [ null, %112 ]
  %118 = call i8* @hypre_CAlloc(i64 1, i64 72) #6
  ...
  %129 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %117) #6
...
162:                                              ; preds = %156
  ...
  %164 = call i8* @hypre_CAlloc(i64 %163, i64 4) #6
  %165 = mul nsw i32 %160, %24
  %166 = sext i32 %165 to i64
  %167 = call i8* @hypre_CAlloc(i64 %166, i64 8) #6
  br label %168
...
185:                                              ; preds = %175, %168
  ...
  %190 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 1, i32 %24, %struct.hypre_ParCSRCommPkg* %119, i8* %53, i8* %170) #6
  %191 = call i32 @hypre_ParCSRBlockCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %190) #6
  %192 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %119, i8* %54, i8* %169) #6
  %193 = call %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixCreate(i32 %2, i32 %157, i32 %52, i32 %160) #6
...
200:                                              ; preds = %196, %185
  %201 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %192) #6
...
define dso_local i32 @hypre_ParCSRBlockMatrixRAP(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0, %struct.hypre_ParCSRBlockMatrix* %1, %struct.hypre_ParCSRBlockMatrix* %2, %struct.hypre_ParCSRBlockMatrix** nocapture %3) local_unnamed_addr #0 {
  ...
  %71 = call i32 @hypre_MPI_Comm_size(i32 %9, i32* nonnull %7) #6
  %72 = mul nsw i32 %29, %29
  %73 = zext i32 %72 to i64
  %74 = shl nuw nsw i64 %73, 3
  %75 = call noalias align 16 i8* @malloc(i64 %74) #6
  %76 = bitcast i8* %75 to double*
  %77 = call noalias align 16 i8* @malloc(i64 %74) #6
...
89:                                               ; preds = %80, %4
  ...
  %94 = call i32 @hypre_CSRBlockMatrixTranspose(%struct.hypre_CSRBlockMatrix* %11, %struct.hypre_CSRBlockMatrix** nonnull %5, i32 1) #6
  %95 = icmp eq i32 %15, 0
  br i1 %95, label %105, label %96

96:                                               ; preds = %89
  %97 = call i32 @hypre_CSRBlockMatrixTranspose(%struct.hypre_CSRBlockMatrix* %13, %struct.hypre_CSRBlockMatrix** nonnull %6, i32 1) #6
...
121:                                              ; preds = %105
  %122 = call %struct.hypre_CSRBlockMatrix* @hypre_ParCSRBlockMatrixExtractBExt(%struct.hypre_ParCSRBlockMatrix* %2, %struct.hypre_ParCSRBlockMatrix* %1, i32 1) #6
...
129:                                              ; preds = %121, %105
  ...
  %136 = call i8* @hypre_CAlloc(i64 %135, i64 4) #6
  %137 = bitcast i8* %136 to i32*
  %138 = call i8* @hypre_CAlloc(i64 %135, i64 4) #6
...
183:                                              ; preds = %179
  ...
  %185 = call i8* @hypre_CAlloc(i64 %184, i64 4) #6
  %186 = bitcast i8* %185 to i32*
  %187 = mul nsw i32 %180, %72
  %188 = sext i32 %187 to i64
  %189 = call i8* @hypre_CAlloc(i64 %188, i64 8) #6
...
195:                                              ; preds = %191
  ...
  %197 = call i8* @hypre_CAlloc(i64 %196, i64 4) #6
  %198 = bitcast i8* %197 to i32*
  %199 = mul nsw i32 %181, %72
  %200 = sext i32 %199 to i64
  %201 = call i8* @hypre_CAlloc(i64 %200, i64 8) #6
...
288:                                              ; preds = %285
  %289 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %130) #6
  br label %290
...
293:                                              ; preds = %290
  ...
  %296 = call i8* @hypre_CAlloc(i64 %295, i64 4) #6
...
328:                                              ; preds = %324
  ...
  call void @hypre_qsort0(i32* %325, i32 0, i32 %329) #6
...
353:                                              ; preds = %350
  ...
  %355 = call i8* @hypre_CAlloc(i64 %354, i64 4) #6
...
376:                                              ; preds = %374, %376
  ...
  %380 = call i32 @hypre_BinarySearch(i32* %358, i32 %379, i32 %351) #6
...
384:                                              ; preds = %383
  ...
  %386 = call i8* @hypre_CAlloc(i64 %385, i64 4) #6
...
409:                                              ; preds = %400, %405, %384, %383
  ...
  %411 = call i8* @hypre_CAlloc(i64 1, i64 8) #6
  %412 = bitcast i8* %411 to i32**
  %413 = call i8* @hypre_CAlloc(i64 1, i64 8) #6
  %414 = bitcast i8* %413 to i32**
  br i1 %95, label %1237, label %415

415:                                              ; preds = %409
  %416 = call i8* @hypre_CAlloc(i64 1, i64 4) #6
...
426:                                              ; preds = %415
  ...
  %430 = call i8* @hypre_CAlloc(i64 %429, i64 4) #6
...
432:                                              ; preds = %415, %426
  ...
  %434 = call i8* @hypre_CAlloc(i64 %420, i64 4) #6
...
644:                                              ; preds = %453, %450
  ...
  %648 = call i8* @hypre_CAlloc(i64 %647, i64 4) #6
  %649 = bitcast i8* %648 to i32*
  %650 = mul nsw i32 %645, %72
  %651 = sext i32 %650 to i64
  %652 = call i8* @hypre_CAlloc(i64 %651, i64 8) #6
  %653 = bitcast i8* %652 to double*
  %654 = sext i32 %645 to i64
  %655 = call i8* @hypre_CAlloc(i64 %654, i64 4) #6
...
767:                                              ; preds = %765, %976
  ...
  %774 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %756, double* %773, double 0.000000e+00, double* %76, i32 %29) #6
...
790:                                              ; preds = %788, %833
  ...
  %797 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %796, double 0.000000e+00, double* %78, i32 %29) #6
...
848:                                              ; preds = %846, %894
  ...
  %856 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %855, double 0.000000e+00, double* %78, i32 %29) #6
...
910:                                              ; preds = %908, %933
  ...
  %916 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %915, double 0.000000e+00, double* %78, i32 %29) #6
...
946:                                              ; preds = %944, %971
  ...
  %952 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %951, double 0.000000e+00, double* %78, i32 %29) #6
...
991:                                              ; preds = %989, %1214
  ...
  %998 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %756, double* %997, double 0.000000e+00, double* %76, i32 %29) #6
...
1016:                                             ; preds = %1014, %1061
  ...
  %1023 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1022, double 0.000000e+00, double* %78, i32 %29) #6
...
1076:                                             ; preds = %1074, %1127
  ...
  %1087 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1086, double 0.000000e+00, double* %78, i32 %29) #6
...
1144:                                             ; preds = %1142, %1168
  ...
  %1150 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1149, double 0.000000e+00, double* %78, i32 %29) #6
...
1181:                                             ; preds = %1179, %1209
  ...
  %1190 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1189, double 0.000000e+00, double* %78, i32 %29) #6
...
1227:                                             ; preds = %1226
  ...
  call void @hypre_Free(i8* %1228) #6
  store i32* null, i32** %412, align 8, !tbaa !41
  br label %1229

1229:                                             ; preds = %1226, %1227
  %1230 = load i8*, i8** %678, align 8, !tbaa !41
  call void @hypre_Free(i8* %1230) #6
  store i32* null, i32** %414, align 8, !tbaa !41
  %1231 = call %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixCreate(i32 %29, i32 %15, i32 %17, i32 %645) #6
...
1261:                                             ; preds = %1255
  %1262 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %1238) #6
  br label %1263

1263:                                             ; preds = %1261, %1255
  %1264 = add nsw i32 %63, 1
  %1265 = sext i32 %1264 to i64
  %1266 = call i8* @hypre_CAlloc(i64 %1265, i64 4) #6
  %1267 = bitcast i8* %1266 to i32*
  %1268 = call i8* @hypre_CAlloc(i64 %1265, i64 4) #6
...
1272:                                             ; preds = %1263
  ...
  %1275 = call i8* @hypre_CAlloc(i64 %1274, i64 4) #6
...
1316:                                             ; preds = %1313
  ...
  call void @hypre_qsort0(i32* %1276, i32 0, i32 %1317) #6
...
1341:                                             ; preds = %1338
  ...
  %1343 = call i8* @hypre_CAlloc(i64 %1342, i64 4) #6
...
1357:                                             ; preds = %1350, %1345
  call void @hypre_Free(i8* %1275) #6
  br label %1358
...
1361:                                             ; preds = %1358
  ...
  %1363 = call i8* @hypre_CAlloc(i64 %1362, i64 4) #6
...
1388:                                             ; preds = %1386
  ...
  %1390 = call i8* @hypre_CAlloc(i64 %1389, i64 4) #6
...
1425:                                             ; preds = %1418
  %1426 = call i32 @hypre_BinarySearch(i32* %1360, i32 %1421, i32 %1359) #6
...
1754:                                             ; preds = %1746
  ...
  %1757 = call i8* @hypre_CAlloc(i64 %1756, i64 8) #6
  %1758 = bitcast i8* %1757 to double*
  %1759 = sext i32 %1749 to i64
  %1760 = call i8* @hypre_CAlloc(i64 %1759, i64 4) #6
...
1766:                                             ; preds = %1762
  ...
  %1769 = call i8* @hypre_CAlloc(i64 %1768, i64 8) #6
  %1770 = bitcast i8* %1769 to double*
  %1771 = sext i32 %1748 to i64
  %1772 = call i8* @hypre_CAlloc(i64 %1771, i64 4) #6
...
1779:                                             ; preds = %1774
  ...
  call void @hypre_Free(i8* %1780) #6
  br label %1781
...
2062:                                             ; preds = %2060, %2279
  ...
  %2070 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %2050, double* %2069, double 0.000000e+00, double* %76, i32 %29) #6
...
2086:                                             ; preds = %2084, %2130
  ...
  %2093 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2092, double 0.000000e+00, double* %78, i32 %29) #6
...
2145:                                             ; preds = %2143, %2193
  ...
  %2156 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2155, double 0.000000e+00, double* %78, i32 %29) #6
...
2209:                                             ; preds = %2207, %2233
  ...
  %2215 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2214, double 0.000000e+00, double* %78, i32 %29) #6
...
2246:                                             ; preds = %2244, %2274
  ...
  %2255 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2254, double 0.000000e+00, double* %78, i32 %29) #6
...
2299:                                             ; preds = %2297, %2522
  ...
  %2307 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %2050, double* %2306, double 0.000000e+00, double* %76, i32 %29) #6
...
2325:                                             ; preds = %2323, %2370
  ...
  %2332 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2331, double 0.000000e+00, double* %78, i32 %29) #6
...
2386:                                             ; preds = %2384, %2434
  ...
  %2397 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2396, double 0.000000e+00, double* %78, i32 %29) #6
...
2451:                                             ; preds = %2449, %2475
  ...
  %2457 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2456, double 0.000000e+00, double* %78, i32 %29) #6
...
2489:                                             ; preds = %2487, %2517
  ...
  %2498 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2497, double 0.000000e+00, double* %78, i32 %29) #6
...
2536:                                             ; preds = %1878, %1804
  ...
  call void @hypre_Free(i8* %2537) #6
  store i32* null, i32** %412, align 8, !tbaa !41
  %2538 = load i8*, i8** %1446, align 8, !tbaa !41
  call void @hypre_Free(i8* %2538) #6
  store i32* null, i32** %414, align 8, !tbaa !41
  %2539 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
  %2540 = bitcast i8* %2539 to i32*
  %2541 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
...
2551:                                             ; preds = %2543
  %2552 = call %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixCreate(i32 %9, i32 %29, i32 %117, i32 %117, i32* %2540, i32* %2542, i32 %1782, i32 %1749, i32 %1748) #6
...
2573:                                             ; preds = %2570
  %2574 = call i32 @hypre_BlockMatvecCommPkgCreate(%struct.hypre_ParCSRBlockMatrix* %2552) #6
  br label %2575
...
2575:                                             ; preds = %2573, %2570
  ...
  %2577 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %2576) #6
...
2578:                                             ; preds = %2575
  ...
  %2580 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %2579) #6
...
2582:                                             ; preds = %2581
  %2583 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %1260) #6
  br label %2584

2584:                                             ; preds = %2581, %2582
  call void @hypre_Free(i8* %411) #6
  call void @hypre_Free(i8* %413) #6
  call void @hypre_Free(i8* %136) #6
  call void @hypre_Free(i8* %138) #6
  call void @hypre_Free(i8* %1435) #6
  call void @hypre_Free(i8* %1437) #6
  br i1 %291, label %2585, label %2588

2585:                                             ; preds = %2584
  %2586 = bitcast i32* %410 to i8*
  call void @hypre_Free(i8* %2586) #6
  %2587 = bitcast i32* %1387 to i8*
  call void @hypre_Free(i8* %2587) #6
  br label %2588
...
2589:                                             ; preds = %2588
  ...
  call void @hypre_Free(i8* %2590) #6
  %2591 = bitcast i32* %1414 to i8*
  call void @hypre_Free(i8* %2591) #6
  br label %2592
...
2593:                                             ; preds = %2592
  ...
  call void @hypre_Free(i8* %2594) #6
  %2595 = bitcast i32* %193 to i8*
  call void @hypre_Free(i8* %2595) #6
  br label %2596
...
2597:                                             ; preds = %2596
  ...
  call void @hypre_Free(i8* %2598) #6
  %2599 = bitcast i32* %205 to i8*
  call void @hypre_Free(i8* %2599) #6
  br label %2600

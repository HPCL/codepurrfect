...
79:                                               ; preds = %76, %54
  ...
  %83 = call i8* @hypre_CAlloc(i64 %82, i64 8) #5
...
186:                                              ; preds = %147, %145
  ...
  %190 = call i8* @hypre_CAlloc(i64 %103, i64 4) #5
  %191 = bitcast i8* %190 to i32*
  br i1 %75, label %196, label %192

192:                                              ; preds = %186
  %193 = sext i32 %73 to i64
  %194 = call i8* @hypre_CAlloc(i64 %193, i64 4) #5
...
258:                                              ; preds = %207
  %259 = call i8* @hypre_CAlloc(i64 %103, i64 4) #5
...
293:                                              ; preds = %290
  ...
  %295 = call i8* @hypre_CAlloc(i64 %294, i64 4) #5
...
1087:                                             ; preds = %1082, %1060
  call void @hypre_Free(i8* %83) #5
  call void @hypre_Free(i8* %190) #5
  br i1 %75, label %1090, label %1088

1088:                                             ; preds = %1087
  %1089 = bitcast i32* %197 to i8*
  call void @hypre_Free(i8* %1089) #5
  br label %1090
...
1090:                                             ; preds = %1088, %1087
  ...
  call void @hypre_Free(i8* %1091) #5
...
define dso_local i32 @hypre_BoomerAMGCoarsenRuge(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, i32 %2, i32 %3, i32 %4, i32** nocapture %5) local_unnamed_addr #0 {
  ...
  %42 = call i8* @hypre_CAlloc(i64 %41, i64 4) #5
  %43 = bitcast i8* %42 to i32*
  %44 = call i8* @hypre_CAlloc(i64 %41, i64 4) #5
...
76:                                               ; preds = %73, %68
  ...
  %81 = add nsw i32 %26, 1
  %82 = sext i32 %81 to i64
  %83 = call i8* @hypre_CAlloc(i64 %82, i64 4) #5
  %84 = bitcast i8* %83 to i32*
  %85 = sext i32 %79 to i64
  %86 = call i8* @hypre_CAlloc(i64 %85, i64 4) #5
...
170:                                              ; preds = %160, %130
  ...
  %171 = call i8* @hypre_CAlloc(i64 %41, i64 4) #5
...
237:                                              ; preds = %235, %231
  ...
  %239 = call i8* @hypre_CAlloc(i64 %41, i64 4) #5
...
492:                                              ; preds = %483
  %493 = call i8* @hypre_CAlloc(i64 %41, i64 4) #5
...
507:                                              ; preds = %502
  ...
  %509 = call i8* @hypre_CAlloc(i64 %508, i64 4) #5
  ...
  %517 = call i8* @hypre_CAlloc(i64 %516, i64 4) #5
...
562:                                              ; preds = %559, %556
  %563 = call i8* @hypre_CAlloc(i64 %508, i64 4) #5
...
923:                                              ; preds = %921, %920
  ...
  %926 = call i8* @hypre_CAlloc(i64 %925, i64 4) #5
  ...
  %934 = call i8* @hypre_CAlloc(i64 %933, i64 4) #5
...
979:                                              ; preds = %976, %973
  %980 = call i8* @hypre_CAlloc(i64 %925, i64 4) #5
...
1346:                                             ; preds = %1344, %1343
  ...
  %1349 = call i8* @hypre_CAlloc(i64 %1348, i64 4) #5
  ...
  %1357 = call i8* @hypre_CAlloc(i64 %1356, i64 4) #5
...
1402:                                             ; preds = %1399, %1396
  %1403 = call i8* @hypre_CAlloc(i64 %1348, i64 4) #5
...
1546:                                             ; preds = %1540, %1541, %1339
  ...
  call void @hypre_Free(i8* %1552) #5
  call void @hypre_Free(i8* %493) #5
...
80:                                               ; preds = %77, %55
  ...
  %84 = call i8* @hypre_CAlloc(i64 %83, i64 8) #5
...
191:                                              ; preds = %185
  ...
  %193 = call i8* @hypre_CAlloc(i64 %192, i64 4) #5
...
206:                                              ; preds = %200, %195
  ...
  %207 = call i8* @hypre_CAlloc(i64 %104, i64 4) #5
...
259:                                              ; preds = %206
  %260 = call i8* @hypre_CAlloc(i64 %104, i64 4) #5
...
297:                                              ; preds = %294
  ...
  %299 = call i8* @hypre_CAlloc(i64 %298, i64 4) #5
...
359:                                              ; preds = %354, %353
  %360 = call i8* @hypre_CAlloc(i64 %104, i64 4) #5
  %361 = bitcast i8* %360 to i32*
  br i1 %76, label %366, label %362

362:                                              ; preds = %359
  %363 = sext i32 %74 to i64
  %364 = call i8* @hypre_CAlloc(i64 %363, i64 4) #5
...
680:                                              ; preds = %677, %674
  %681 = call i8* @hypre_MAlloc(i64 16) #5
...
784:                                              ; preds = %780, %366
  ...
  call void @hypre_Free(i8* %84) #5
  %789 = bitcast i32* %785 to i8*
  call void @hypre_Free(i8* %789) #5
  %790 = bitcast i32* %787 to i8*
  call void @hypre_Free(i8* %790) #5
  %791 = bitcast i32* %788 to i8*
  call void @hypre_Free(i8* %791) #5
  br i1 %76, label %794, label %792

792:                                              ; preds = %784
  %793 = bitcast i32* %786 to i8*
  call void @hypre_Free(i8* %793) #5
  br label %794

794:                                              ; preds = %792, %784
  call void @hypre_Free(i8* %71) #5
  call void @hypre_Free(i8* %65) #5
  %795 = bitcast i32* %302 to i8*
  call void @hypre_Free(i8* %795) #5

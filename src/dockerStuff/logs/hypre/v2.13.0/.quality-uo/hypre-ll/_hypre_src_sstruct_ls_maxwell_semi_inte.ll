...
define dso_local i32 @hypre_CreatePTopology(i8** nocapture %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 40) #6
...
265:                                              ; preds = %263, %261
  %266 = call i8* @hypre_CAlloc(i64 8, i64 12) #6
  %267 = bitcast i8* %266 to [3 x i32]*
  %268 = call i8* @hypre_CAlloc(i64 8, i64 4) #6
...
438:                                              ; preds = %434, %324
  ...
  %445 = call i8* @hypre_MAlloc(i64 %444) #6
  %446 = bitcast i8* %445 to i32**
  %447 = call i8* @hypre_MAlloc(i64 %444) #6
  %448 = bitcast i8* %447 to i32**
  %449 = call i8* @hypre_MAlloc(i64 %444) #6
  %450 = bitcast i8* %449 to %struct.hypre_BoxArray_struct**
  %451 = call i8* @hypre_MAlloc(i64 %444) #6
  %452 = bitcast i8* %451 to [3 x i32]**
  %453 = call i8* @hypre_MAlloc(i64 %444) #6
  %454 = bitcast i8* %453 to [3 x i32]**
  %455 = call i8* @hypre_MAlloc(i64 %444) #6
...
466:                                              ; preds = %463, %626
  ...
  %479 = call i8* @hypre_CAlloc(i64 %478, i64 4) #6
  ...
  %491 = call i8* @hypre_CAlloc(i64 %490, i64 4) #6
...
529:                                              ; preds = %523, %466
  ...
  %535 = call i8* @hypre_MAlloc(i64 %534) #6
  ...
  %541 = call i8* @hypre_MAlloc(i64 %540) #6
  ...
  %547 = call i8* @hypre_MAlloc(i64 %546) #6
...
630:                                              ; preds = %626, %438
  ...
  %632 = call i8* @hypre_MAlloc(i64 %444) #6
  %633 = bitcast i8* %632 to i32***
  %634 = call i8* @hypre_MAlloc(i64 %444) #6
...
647:                                              ; preds = %639, %630
  %648 = call i8* @hypre_MAlloc(i64 %444) #6
  %649 = bitcast i8* %648 to i32**
  %650 = call i8* @hypre_MAlloc(i64 %444) #6
  %651 = bitcast i8* %650 to i32**
  %652 = call i8* @hypre_MAlloc(i64 %444) #6
  %653 = bitcast i8* %652 to i32**
  %654 = call i8* @hypre_MAlloc(i64 %444) #6
...
1527:                                             ; preds = %1524
  ...
  %1529 = call i8* @hypre_CAlloc(i64 %1528, i64 4) #6
...
1531:                                             ; preds = %1527, %1524
  ...
  %1534 = call i8* @hypre_CAlloc(i64 %1533, i64 4) #6
  %1535 = bitcast i8* %1534 to i32*
  %1536 = sext i32 %440 to i64
  %1537 = call i8* @hypre_CAlloc(i64 %1536, i64 4) #6
  %1538 = bitcast i8* %1537 to i32*
  %1539 = call i8* @hypre_CAlloc(i64 %1536, i64 4) #6
...
1549:                                             ; preds = %1544, %1531
  ...
  %1551 = call i8* @hypre_CAlloc(i64 %1550, i64 4) #6
  %1552 = bitcast i8* %1551 to i32*
  %1553 = call i8* @hypre_CAlloc(i64 %1550, i64 8) #6
...
1921:                                             ; preds = %1915, %1549
  ...
  call void @hypre_Free(i8* %1551) #6
  call void @hypre_Free(i8* %1553) #6
  br i1 %296, label %1930, label %2870

1930:                                             ; preds = %1921
  %1931 = sext i32 %442 to i64
  %1932 = call i8* @hypre_CAlloc(i64 %1931, i64 4) #6
...
2044:                                             ; preds = %2040, %1930
  ...
  %2049 = call i8* @hypre_CAlloc(i64 %2048, i64 4) #6
  %2050 = bitcast i8* %2049 to i32*
  %2051 = load i32, i32* %36, align 4, !tbaa !18
  %2052 = sext i32 %2051 to i64
  %2053 = call i8* @hypre_CAlloc(i64 %2052, i64 8) #6
...
2861:                                             ; preds = %2856, %2059
  ...
  call void @hypre_Free(i8* %1932) #6
  %2869 = bitcast i32* %1532 to i8*
  call void @hypre_Free(i8* %2869) #6
  call void @hypre_Free(i8* %2049) #6
  call void @hypre_Free(i8* %2053) #6
  br label %2870

2870:                                             ; preds = %2861, %1921
  %2871 = phi i32 [ %2862, %2861 ], [ %1923, %1921 ]
  %2872 = phi i32* [ %2863, %2861 ], [ %1924, %1921 ]
  %2873 = call i8* @hypre_CAlloc(i64 %1533, i64 4) #6
...
2943:                                             ; preds = %2937, %2870
  ...
  %2946 = call i8* @hypre_CAlloc(i64 %2945, i64 4) #6
  %2947 = bitcast i8* %2946 to i32*
  %2948 = call i8* @hypre_CAlloc(i64 %2945, i64 8) #6
...
3300:                                             ; preds = %3295, %2953
  ...
  call void @hypre_Free(i8* %2873) #6
  call void @hypre_Free(i8* %1534) #6
  call void @hypre_Free(i8* %2946) #6
  call void @hypre_Free(i8* %2948) #6
  br i1 %296, label %3306, label %3338

3306:                                             ; preds = %3300
  %3307 = sext i32 %1925 to i64
  %3308 = call i8* @hypre_CAlloc(i64 %3307, i64 4) #6
...
3338:                                             ; preds = %3333, %3319, %3300
  ...
  %3343 = call i8* @hypre_CAlloc(i64 %3342, i64 4) #6
...
3356:                                             ; preds = %3351, %3338
  ...
  %3359 = call i8* @hypre_CAlloc(i64 %3358, i64 4) #6
  %3360 = bitcast i8* %3359 to i32*
  %3361 = call i8* @hypre_CAlloc(i64 %3358, i64 8) #6
...
3828:                                             ; preds = %3827
  ...
  call void @hypre_Free(i8* %3833) #6
  %3834 = bitcast i32* %3341 to i8*
  call void @hypre_Free(i8* %3834) #6
  %3835 = bitcast double* %3340 to i8*
  call void @hypre_Free(i8* %3835) #6
  br label %3836
...
3836:                                             ; preds = %3828, %3827
  ...
  call void @hypre_Free(i8* %3343) #6
  call void @hypre_Free(i8* %1537) #6
  call void @hypre_Free(i8* %3359) #6
  call void @hypre_Free(i8* %3361) #6
  %3841 = sext i32 %439 to i64
  %3842 = call i8* @hypre_CAlloc(i64 %3841, i64 4) #6
  %3843 = bitcast i8* %3842 to i32*
  %3844 = call i8* @hypre_CAlloc(i64 %3841, i64 4) #6
  ...
  %3848 = call i8* @hypre_CAlloc(i64 %3841, i64 4) #6
...
3979:                                             ; preds = %3976, %4296
  ...
  %3988 = call i8* @hypre_CAlloc(i64 %3850, i64 12) #6
  %3989 = bitcast i8* %3988 to [3 x i32]*
  %3990 = call i8* @hypre_CAlloc(i64 %3850, i64 12) #6
...
4296:                                             ; preds = %4291, %4098
  call void @hypre_Free(i8* %3988) #6
  call void @hypre_Free(i8* %3990) #6
...
4493:                                             ; preds = %4418, %5830
  ...
  %4505 = call i8* @hypre_MAlloc(i64 36) #6
...
5830:                                             ; preds = %5826, %4507
  ...
  call void @hypre_Free(i8* %4505) #6
...
7031:                                             ; preds = %7027, %7013
  ...
  %7034 = call i8* @hypre_CAlloc(i64 %7033, i64 8) #6
  %7035 = bitcast i8* %7034 to double*
  %7036 = call i8* @hypre_CAlloc(i64 %7033, i64 4) #6
...
7161:                                             ; preds = %7157, %7515
  ...
  %7172 = call i8* @hypre_CAlloc(i64 %7039, i64 12) #6
  %7173 = bitcast i8* %7172 to [3 x i32]*
  %7174 = call i8* @hypre_CAlloc(i64 %7039, i64 12) #6
...
7515:                                             ; preds = %7509, %7289
  ...
  call void @hypre_Free(i8* %7172) #6
  call void @hypre_Free(i8* %7174) #6
...
7539:                                             ; preds = %7529
  ...
  %7541 = call i8* @hypre_CAlloc(i64 %7540, i64 8) #6
  %7542 = bitcast i8* %7541 to double*
  %7543 = call i8* @hypre_CAlloc(i64 %7540, i64 8) #6
  %7544 = bitcast i8* %7543 to double*
  %7545 = call i8* @hypre_CAlloc(i64 %7540, i64 8) #6
  %7546 = bitcast i8* %7545 to double*
  %7547 = call i8* @hypre_CAlloc(i64 %7540, i64 8) #6
  %7548 = bitcast i8* %7547 to double*
  %7549 = call i8* @hypre_CAlloc(i64 %7540, i64 8) #6
  %7550 = bitcast i8* %7549 to double*
  %7551 = add nsw i32 %7536, 1
  %7552 = sext i32 %7551 to i64
  %7553 = call i8* @hypre_CAlloc(i64 %7552, i64 4) #6
...
7754:                                             ; preds = %7680, %9498
  ...
  %7766 = call i8* @hypre_MAlloc(i64 36) #6
...
8012:                                             ; preds = %8003, %8012
  ...
  call void @hypre_Free(i8* nonnull %8028) #6
...
8271:                                             ; preds = %8262, %8271
  ...
  call void @hypre_Free(i8* nonnull %8287) #6
  store double* null, double** %20, align 8, !tbaa !3
...
8562:                                             ; preds = %8553, %8562
  ...
  call void @hypre_Free(i8* nonnull %8578) #6
  store double* null, double** %20, align 8, !tbaa !3
...
8821:                                             ; preds = %8811, %8821
  ...
  call void @hypre_Free(i8* %8838) #6
  store double* null, double** %20, align 8, !tbaa !3
...
9115:                                             ; preds = %9105, %9115
  ...
  call void @hypre_Free(i8* %9132) #6
  store double* null, double** %20, align 8, !tbaa !3
...
9378:                                             ; preds = %9368, %9378
  ...
  call void @hypre_Free(i8* %9395) #6
  store double* null, double** %20, align 8, !tbaa !3
...
9498:                                             ; preds = %9494, %7768
  ...
  call void @hypre_Free(i8* %7766) #6
...
9502:                                             ; preds = %9498, %7539
  ...
  call void @hypre_Free(i8* %7541) #6
  call void @hypre_Free(i8* %7543) #6
  call void @hypre_Free(i8* %7545) #6
  call void @hypre_Free(i8* %7547) #6
  call void @hypre_Free(i8* %7549) #6
...
11010:                                            ; preds = %11006, %9504
  call void @hypre_Free(i8* %3848) #6
  ...
  call void @hypre_Free(i8* %3844) #6
  call void @hypre_Free(i8* %3842) #6
  call void @hypre_Free(i8* %7036) #6
  call void @hypre_Free(i8* %7034) #6
...
11039:                                            ; preds = %11038, %11039
  ...
  call void @hypre_Free(i8* %11048) #6
...
11057:                                            ; preds = %11039, %11038
  ...
  call void @hypre_Free(i8* %11063) #6
  ...
  call void @hypre_Free(i8* %11071) #6
...
11079:                                            ; preds = %11057, %11018
  ...
  call void @hypre_Free(i8* %11082) #6
  ...
  call void @hypre_Free(i8* %11085) #6
...
11088:                                            ; preds = %11079, %11010
  call void @hypre_Free(i8* %632) #6
  call void @hypre_Free(i8* %634) #6
...
11092:                                            ; preds = %11090, %11092
  ...
  call void @hypre_Free(i8* %11099) #6
  ...
  call void @hypre_Free(i8* %11102) #6
  ...
  call void @hypre_Free(i8* %11105) #6
  ...
  call void @hypre_Free(i8* %11108) #6
  ...
  call void @hypre_Free(i8* %11111) #6
  ...
  call void @hypre_Free(i8* %11114) #6
  ...
  call void @hypre_Free(i8* %11117) #6
  ...
  call void @hypre_Free(i8* %11120) #6
  ...
  call void @hypre_Free(i8* %11123) #6
...
11126:                                            ; preds = %11092, %11088
  call void @hypre_Free(i8* %449) #6
  call void @hypre_Free(i8* %451) #6
  call void @hypre_Free(i8* %453) #6
  call void @hypre_Free(i8* %455) #6
  call void @hypre_Free(i8* %445) #6
  call void @hypre_Free(i8* %447) #6
  call void @hypre_Free(i8* %650) #6
  call void @hypre_Free(i8* %648) #6
  call void @hypre_Free(i8* %654) #6
  call void @hypre_Free(i8* %652) #6
  call void @hypre_Free(i8* %266) #6
  call void @hypre_Free(i8* %268) #6
...
define dso_local i32 @hypre_CollapseStencilToStencil(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_SStructGrid_struct* %1, i32 %2, i32 %3, i32* %4, i32 %5, i32 %6, double** nocapture %7) local_unnamed_addr #0 {
  ...
  %27 = call i8* @hypre_CAlloc(i64 3, i64 8) #6
...
39:                                               ; preds = %8
  %40 = call i8* @hypre_MAlloc(i64 36) #6
  %41 = bitcast i8* %40 to i32*
  %42 = call i8* @hypre_MAlloc(i64 36) #6
...
95:                                               ; preds = %93, %87
  ...
  %98 = shl nsw i64 %97, 2
  %99 = call i8* @hypre_MAlloc(i64 %98) #6
  %100 = bitcast i8* %99 to i32*
  %101 = load i32, i32* %12, align 4, !tbaa !18
  %102 = sext i32 %101 to i64
  %103 = shl nsw i64 %102, 2
  %104 = call i8* @hypre_MAlloc(i64 %103) #6
...
define dso_local i32 @hypre_TriDiagSolve(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture %3, i32 %4) local_unnamed_addr #0 {
  ...
  %8 = sext i32 %4 to i64
  %9 = shl nsw i64 %8, 3
  %10 = call i8* @hypre_MAlloc(i64 %9) #6

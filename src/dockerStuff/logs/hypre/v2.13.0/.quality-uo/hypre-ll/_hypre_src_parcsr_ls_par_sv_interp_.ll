...
110:                                              ; preds = %93, %108, %106
  ...
  %120 = call i8* @hypre_CAlloc(i64 %119, i64 4) #7
  %121 = bitcast i8* %120 to i32*
  %122 = load i32, i32* %2, align 4, !tbaa !18
  %123 = call i8* @hypre_CAlloc(i64 %54, i64 4) #7
...
129:                                              ; preds = %126, %110
  ...
  %131 = call i8* @hypre_CAlloc(i64 %130, i64 4) #7
...
152:                                              ; preds = %148, %129
  ...
  %154 = call i8* @hypre_CAlloc(i64 %153, i64 4) #7
...
198:                                              ; preds = %194
  %199 = call i8* @hypre_CAlloc(i64 %153, i64 4) #7
...
205:                                              ; preds = %201
  %206 = call i8* @hypre_CAlloc(i64 %153, i64 4) #7
...
378:                                              ; preds = %377, %374
  %379 = call i8* @hypre_CAlloc(i64 %130, i64 4) #7
...
407:                                              ; preds = %391, %401, %385, %388
  ...
  %416 = call i8* @hypre_CAlloc(i64 %415, i64 4) #7
  %417 = bitcast i8* %416 to i32*
  %418 = call i8* @hypre_CAlloc(i64 %415, i64 8) #7
  %419 = bitcast i8* %418 to double*
  %420 = add nsw i32 %51, 1
  %421 = sext i32 %420 to i64
  %422 = call i8* @hypre_CAlloc(i64 %421, i64 4) #7
  %423 = bitcast i8* %422 to i32*
  %424 = sext i32 %411 to i64
  %425 = call i8* @hypre_CAlloc(i64 %424, i64 4) #7
  %426 = bitcast i8* %425 to i32*
  %427 = call i8* @hypre_CAlloc(i64 %424, i64 8) #7
  %428 = bitcast i8* %427 to double*
  %429 = call i8* @hypre_CAlloc(i64 %421, i64 4) #7
...
458:                                              ; preds = %440, %436
  ...
  %463 = call i8* @hypre_CAlloc(i64 %462, i64 4) #7
  %464 = bitcast i8* %463 to i32*
  %465 = call i8* @hypre_CAlloc(i64 %462, i64 8) #7
  %466 = bitcast i8* %465 to double*
  %467 = call i8* @hypre_CAlloc(i64 %462, i64 4) #7
  %468 = bitcast i8* %467 to i32*
  %469 = call i8* @hypre_CAlloc(i64 %462, i64 4) #7
...
480:                                              ; preds = %471
  ...
  %483 = call i8* @hypre_CAlloc(i64 %482, i64 8) #7
...
491:                                              ; preds = %488, %542
  ...
  %503 = call i8* @hypre_CAlloc(i64 %502, i64 8) #7
...
552:                                              ; preds = %548
  ...
  %555 = call i8* @hypre_CAlloc(i64 %554, i64 8) #7
...
563:                                              ; preds = %561, %621
  ...
  %577 = call i8* @hypre_CAlloc(i64 %576, i64 8) #7
...
3069:                                             ; preds = %3068
  ...
  %3072 = call i8* @hypre_ReAlloc(i8* %79, i64 %3071) #7
...
3097:                                             ; preds = %3093, %3069
  ...
  %3099 = call i8* @hypre_CAlloc(i64 2, i64 4) #7
...
3117:                                             ; preds = %3068
  ...
  %3121 = call i8* @hypre_CAlloc(i64 2, i64 4) #7
...
3163:                                             ; preds = %3160
  ...
  %3165 = call i8* @hypre_CAlloc(i64 %3164, i64 4) #7
  %3166 = bitcast i8* %3165 to i32*
  %3167 = call i8* @hypre_CAlloc(i64 %3164, i64 4) #7
...
3215:                                             ; preds = %3208, %3202
  call void @hypre_Free(i8* %3167) #7
  br label %3216
...
3221:                                             ; preds = %3216, %3128
  ...
  call void @hypre_Free(i8* %131) #7
  call void @hypre_Free(i8* %123) #7
  call void @hypre_Free(i8* %154) #7
  %3225 = bitcast double* %549 to i8*
  call void @hypre_Free(i8* %3225) #7
  call void @hypre_Free(i8* %248) #7
  %3226 = bitcast i32* %209 to i8*
  call void @hypre_Free(i8* %3226) #7
  call void @hypre_Free(i8* %120) #7
  call void @hypre_Free(i8* %379) #7
  call void @hypre_Free(i8* null) #7
  %3227 = bitcast double* %628 to i8*
  call void @hypre_Free(i8* %3227) #7

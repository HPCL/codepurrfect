...
63:                                               ; preds = %58
  ...
  %66 = call i8* @hypre_CAlloc(i64 4, i64 4)
...
90:                                               ; preds = %8
  ...
  %94 = call noalias align 16 dereferenceable_or_null(32) i8* @malloc(i64 32) #21
  %95 = bitcast i8* %94 to i8**
  br label %96

96:                                               ; preds = %90, %96
  %97 = phi i64 [ 0, %90 ], [ %100, %96 ]
  %98 = call noalias align 16 dereferenceable_or_null(50) i8* @malloc(i64 50) #21
...
102:                                              ; preds = %96
  %103 = load i8*, i8** %95, align 16, !tbaa !60
  ...
  %105 = load i8*, i8** %104, align 8, !tbaa !60
  %106 = getelementptr inbounds %struct.HYPRE_Uzawa_PARAMS_Struct, %struct.HYPRE_Uzawa_PARAMS_Struct* %3, i64 0, i32 12
  %107 = load i32, i32* %106, align 8, !tbaa !101
  %108 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull dereferenceable(1) %105, i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.156, i64 0, i64 0), i32 %107) #21
  %109 = getelementptr inbounds i8*, i8** %95, i64 2
  %110 = load i8*, i8** %109, align 16, !tbaa !60
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(9) %110, i8* noundef nonnull align 1 dereferenceable(9) getelementptr inbounds ([9 x i8], [9 x i8]* @.str.157, i64 0, i64 0), i64 9, i1 false) #21
  %111 = getelementptr inbounds i8*, i8** %95, i64 3
  %112 = load i8*, i8** %111, align 8, !tbaa !60
  %113 = getelementptr inbounds %struct.HYPRE_Uzawa_PARAMS_Struct, %struct.HYPRE_Uzawa_PARAMS_Struct* %3, i64 0, i32 13
  %114 = load double, double* %113, align 8, !tbaa !102
  %115 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull dereferenceable(1) %112, i8* nonnull dereferenceable(1) getelementptr inbounds ([3 x i8], [3 x i8]* @.str.158, i64 0, i64 0), double %114) #21
  %116 = load %struct.hypre_Solver_struct*, %struct.hypre_Solver_struct** %1, align 8, !tbaa !60
  %117 = call i32 @HYPRE_EuclidSetParams(%struct.hypre_Solver_struct* %116, i32 4, i8** nonnull %95)
  br label %118

118:                                              ; preds = %102, %118
  %119 = phi i64 [ 0, %102 ], [ %122, %118 ]
  %120 = getelementptr inbounds i8*, i8** %95, i64 %119
  %121 = load i8*, i8** %120, align 8, !tbaa !60
  call void @free(i8* %121) #21
  %122 = add nuw nsw i64 %119, 1
  %123 = icmp eq i64 %122, 4
  br i1 %123, label %124, label %118, !llvm.loop !103
...
125:                                              ; preds = %8
  %126 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @str.241, i64 0, i64 0))
  call void @exit(i32 1) #24
  unreachable

127:                                              ; preds = %11, %73, %76, %124, %8, %4
  ret i32 0
}

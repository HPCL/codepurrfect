...
define dso_local noalias %struct.Hash* @HashCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call noalias align 16 dereferenceable_or_null(32) i8* @malloc(i64 32) #9
  %3 = bitcast i8* %2 to %struct.Hash*
  %4 = getelementptr inbounds %struct.Hash, %struct.Hash* %3, i64 0, i32 0
  store i32 %0, i32* %4, align 16, !tbaa !3
  %5 = getelementptr inbounds %struct.Hash, %struct.Hash* %3, i64 0, i32 1
  store i32 0, i32* %5, align 4, !tbaa !9
  %6 = sext i32 %0 to i64
  %7 = shl nsw i64 %6, 2
  %8 = call noalias align 16 i8* @malloc(i64 %7) #9
  %9 = getelementptr inbounds %struct.Hash, %struct.Hash* %3, i64 0, i32 2
  %10 = bitcast i32** %9 to i8**
  store i8* %8, i8** %10, align 8, !tbaa !10
  %11 = call noalias align 16 i8* @malloc(i64 %7) #9
  %12 = getelementptr inbounds %struct.Hash, %struct.Hash* %3, i64 0, i32 3
  %13 = bitcast i32** %12 to i8**
  store i8* %11, i8** %13, align 16, !tbaa !11
  %14 = call noalias align 16 i8* @malloc(i64 %7) #9
  %15 = getelementptr inbounds %struct.Hash, %struct.Hash* %3, i64 0, i32 4
...
18:                                               ; preds = %1
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %11, i8 -1, i64 %20, i1 false)
  br label %21
...
define dso_local void @HashPrint(%struct.Hash* nocapture readonly %0) local_unnamed_addr #6 {
  %2 = getelementptr inbounds %struct.Hash, %struct.Hash* %0, i64 0, i32 0
  %3 = load i32, i32* %2, align 8, !tbaa !3
  %4 = sdiv i32 %3, 38
  %5 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %3) #9
  %6 = icmp sgt i32 %3, 37
...
13:                                               ; preds = %10, %13
  ...
  %20 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %19) #9
  %21 = add nuw nsw i32 %15, 1
  %22 = icmp eq i32 %21, 38
  br i1 %22, label %23, label %13, !llvm.loop !20

23:                                               ; preds = %13
  %24 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #9
...
declare dso_local i32 @hypre_printf(i8*, ...) local_unnamed_addr #7

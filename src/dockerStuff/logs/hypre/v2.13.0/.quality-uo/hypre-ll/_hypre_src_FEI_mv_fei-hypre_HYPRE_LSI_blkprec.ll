...
35:                                               ; preds = %4
  ...
  %52 = call i8* @hypre_CAlloc(i64 4, i64 4)
...
61:                                               ; preds = %56
  ...
  %63 = call i8* @hypre_CAlloc(i64 4, i64 4)
...
84:                                               ; preds = %4
  ...
  %87 = call noalias align 16 dereferenceable_or_null(32) i8* @malloc(i64 32) #21
  %88 = bitcast i8* %87 to i8**
  br label %89

89:                                               ; preds = %84, %89
  %90 = phi i64 [ 0, %84 ], [ %93, %89 ]
  %91 = call noalias align 16 dereferenceable_or_null(50) i8* @malloc(i64 50) #21
...
95:                                               ; preds = %89
  %96 = load i8*, i8** %88, align 16, !tbaa !76
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(7) %96, i8* noundef nonnull align 1 dereferenceable(7) getelementptr inbounds ([7 x i8], [7 x i8]* @.str.321, i64 0, i64 0), i64 7, i1 false) #21
  %97 = getelementptr inbounds i8*, i8** %88, i64 1
  %98 = load i8*, i8** %97, align 8, !tbaa !76
  %99 = getelementptr inbounds %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct, %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct* %3, i64 0, i32 13
  %100 = load i32, i32* %99, align 8, !tbaa !158
  %101 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull dereferenceable(1) %98, i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.322, i64 0, i64 0), i32 %100) #21
  %102 = getelementptr inbounds i8*, i8** %88, i64 2
  %103 = load i8*, i8** %102, align 16, !tbaa !76
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(9) %103, i8* noundef nonnull align 1 dereferenceable(9) getelementptr inbounds ([9 x i8], [9 x i8]* @.str.323, i64 0, i64 0), i64 9, i1 false) #21
  %104 = getelementptr inbounds i8*, i8** %88, i64 3
  %105 = load i8*, i8** %104, align 8, !tbaa !76
  %106 = getelementptr inbounds %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct, %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct* %3, i64 0, i32 14
  %107 = load double, double* %106, align 8, !tbaa !159
  %108 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull dereferenceable(1) %105, i8* nonnull dereferenceable(1) getelementptr inbounds ([3 x i8], [3 x i8]* @.str.324, i64 0, i64 0), double %107) #21
  %109 = call i32 @HYPRE_EuclidSetParams(%struct.hypre_Solver_struct* undef, i32 4, i8** nonnull %88)
  br label %110

110:                                              ; preds = %95, %110
  %111 = phi i64 [ 0, %95 ], [ %114, %110 ]
  %112 = getelementptr inbounds i8*, i8** %88, i64 %111
  %113 = load i8*, i8** %112, align 8, !tbaa !76
  call void @free(i8* %113) #21
  %114 = add nuw nsw i64 %111, 1
  %115 = icmp eq i64 %114, 4
  br i1 %115, label %116, label %110, !llvm.loop !160
...
117:                                              ; preds = %4
  %118 = load i32, i32* %6, align 4, !tbaa !81
  %119 = call i32 @HYPRE_LSI_DDIlutCreate(i32 %118, %struct.hypre_Solver_struct** null)
  %120 = getelementptr inbounds %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct, %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct* %3, i64 0, i32 15
  %121 = load double, double* %120, align 8, !tbaa !161
  %122 = call i32 @HYPRE_LSI_DDIlutSetFillin(%struct.hypre_Solver_struct* undef, double %121)
  %123 = getelementptr inbounds %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct, %struct.HYPRE_LSI_BLOCKP_PARAMS_Struct* %3, i64 0, i32 16
  %124 = load double, double* %123, align 8, !tbaa !162
  %125 = call i32 @HYPRE_LSI_DDIlutSetDropTolerance(%struct.hypre_Solver_struct* undef, double %124)
  br label %130

126:                                              ; preds = %4
  %127 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([45 x i8], [45 x i8]* @str.496, i64 0, i64 0))
  call void @exit(i32 1) #23
  unreachable

128:                                              ; preds = %4
  %129 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([46 x i8], [46 x i8]* @str.495, i64 0, i64 0))
  call void @exit(i32 1) #23
  unreachable

130:                                              ; preds = %4, %117, %116, %74, %72, %19
...
126:                                              ; preds = %7
  ...
  %154 = call i8* @hypre_CAlloc(i64 4, i64 4)
...
163:                                              ; preds = %158
  ...
  %166 = call i8* @hypre_CAlloc(i64 4, i64 4)

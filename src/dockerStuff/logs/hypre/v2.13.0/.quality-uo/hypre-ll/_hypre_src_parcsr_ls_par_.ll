...
18:                                               ; preds = %6
  ...
  %20 = call i8* @hypre_CAlloc(i64 %19, i64 4) #11
...
define dso_local i32 @hypre_cr(i32* nocapture readonly %0, i32* nocapture readonly %1, double* nocapture readonly %2, i32 %3, i32* nocapture %4, i32 %5, double %6, double %7, i32 %8) local_unnamed_addr #0 {
  ...
  %11 = call i8* @hypre_CAlloc(i64 %10, i64 8) #11
  %12 = bitcast i8* %11 to double*
  %13 = call i8* @hypre_CAlloc(i64 %10, i64 8) #11
...
define dso_local i32 @hypre_IndepSetGreedy(i32* nocapture readonly %0, i32* nocapture readonly %1, i32 %2, i32* nocapture %3) local_unnamed_addr #0 {
  %5 = sext i32 %2 to i64
  %6 = call i8* @hypre_CAlloc(i64 %5, i64 4) #11
...
56:                                               ; preds = %52, %4
  ...
  %63 = call i8* @hypre_CAlloc(i64 %59, i64 4) #11
  %64 = bitcast i8* %63 to i32*
  %65 = getelementptr inbounds i32, i32* %64, i64 %59
  %66 = call i8* @hypre_CAlloc(i64 %5, i64 8) #11
...
54:                                               ; preds = %50, %4
  ...
  %58 = call i8* @hypre_CAlloc(i64 %57, i64 4) #11
  %59 = bitcast i8* %58 to i32*
  %60 = getelementptr inbounds i32, i32* %59, i64 %57
  %61 = call i8* @hypre_CAlloc(i64 %57, i64 4) #11
  %62 = bitcast i8* %61 to i32*
  %63 = getelementptr inbounds i32, i32* %62, i64 %57
  %64 = call i8* @hypre_CAlloc(i64 %5, i64 8) #11
...
define dso_local i32 @hypre_BoomerAMGIndepRS(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32 %2, i32* nocapture %3) local_unnamed_addr #0 {
  ...
  %32 = call i8* @hypre_CAlloc(i64 %31, i64 4) #11
  %33 = bitcast i8* %32 to i32*
  %34 = call i8* @hypre_CAlloc(i64 %31, i64 4) #11
...
60:                                               ; preds = %57, %52
  ...
  %67 = call i8* @hypre_CAlloc(i64 %66, i64 4) #11
  %68 = bitcast i8* %67 to i32*
  %69 = sext i32 %63 to i64
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 4) #11
...
156:                                              ; preds = %154
  %157 = call i8* @hypre_CAlloc(i64 %31, i64 4) #11
...
202:                                              ; preds = %201
  ...
  %204 = call i8* @hypre_CAlloc(i64 %203, i64 4) #11
...
213:                                              ; preds = %209, %206
  ...
  %220 = call i8* @hypre_CAlloc(i64 %219, i64 4) #11
...
266:                                              ; preds = %262, %259
  ...
  %270 = call i8* @hypre_CAlloc(i64 %269, i64 4) #11
...
344:                                              ; preds = %341, %279
  ...
  call void @hypre_Free(i8* %345) #11
...
398:                                              ; preds = %366, %358
  call void @hypre_Free(i8* %220) #11
  br label %399
...
657:                                              ; preds = %526, %464
  ...
  call void @hypre_Free(i8* %658) #11
...
204:                                              ; preds = %203
  ...
  %206 = call i8* @hypre_CAlloc(i64 %205, i64 4) #11
...
215:                                              ; preds = %211, %208
  ...
  %222 = call i8* @hypre_CAlloc(i64 %221, i64 4) #11
...
268:                                              ; preds = %264, %261
  ...
  %272 = call i8* @hypre_CAlloc(i64 %271, i64 4) #11
...
348:                                              ; preds = %345, %281
  ...
  call void @hypre_Free(i8* %349) #11
...
402:                                              ; preds = %370, %362
  call void @hypre_Free(i8* %222) #11
  br label %403
...
667:                                              ; preds = %532, %468
  ...
  call void @hypre_Free(i8* %668) #11
...
71:                                               ; preds = %69
  ...
  %73 = call i8* @hypre_CAlloc(i64 %72, i64 4) #11
...
127:                                              ; preds = %123, %120
  ...
  %131 = call i8* @hypre_CAlloc(i64 %130, i64 8) #11
...
285:                                              ; preds = %284
  ...
  %287 = call i8* @hypre_CAlloc(i64 %286, i64 4) #11
...
300:                                              ; preds = %294, %289
  ...
  %302 = call i8* @hypre_CAlloc(i64 %301, i64 4) #11
...
778:                                              ; preds = %436, %422
  call void @hypre_Free(i8* %131) #11
  call void @hypre_Free(i8* %302) #11
  br i1 %65, label %781, label %779

779:                                              ; preds = %778
  %780 = bitcast i32* %290 to i8*
  call void @hypre_Free(i8* %780) #11
  br label %781
...
781:                                              ; preds = %779, %778
  ...
  call void @hypre_Free(i8* %782) #11
...
287:                                              ; preds = %286
  ...
  %289 = call i8* @hypre_CAlloc(i64 %288, i64 4) #11
...
302:                                              ; preds = %296, %291
  ...
  %304 = call i8* @hypre_CAlloc(i64 %303, i64 4) #11
...
778:                                              ; preds = %438, %424
  call void @hypre_Free(i8* %131) #11
  call void @hypre_Free(i8* %304) #11
  br i1 %65, label %781, label %779
...
59:                                               ; preds = %14
  ...
  %61 = call i8* @hypre_CAlloc(i64 %60, i64 4) #11
  %62 = icmp sgt i32 %45, 0
  br i1 %62, label %69, label %75

63:                                               ; preds = %14
  %64 = sext i32 %50 to i64
  %65 = call i8* @hypre_CAlloc(i64 %64, i64 4) #11
  %66 = call i8* @hypre_CAlloc(i64 %64, i64 8) #11
...
691:                                              ; preds = %681, %677
  ...
  call void @hypre_Free(i8* %694) #11

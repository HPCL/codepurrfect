...
4:                                                ; preds = %1
  %5 = call i8* @hypre_CAlloc(i64 1, i64 80) #7
...
65:                                               ; preds = %62
  ...
  %86 = call i8* @hypre_CAlloc(i64 %79, i64 8) #7
  ...
  %90 = call i8* @hypre_CAlloc(i64 %79, i64 8) #7
  ...
  %94 = call i8* @hypre_CAlloc(i64 %79, i64 4) #7
  ...
  %98 = call i8* @hypre_CAlloc(i64 %79, i64 4) #7
...
144:                                              ; preds = %108, %65
  ...
  call void @hypre_Free(i8* %145) #7
  %146 = bitcast double* %69 to i8*
  call void @hypre_Free(i8* %146) #7
  %147 = bitcast double* %71 to i8*
  call void @hypre_Free(i8* %147) #7
  %148 = bitcast i8** %73 to i8*
  call void @hypre_Free(i8* %148) #7
  %149 = bitcast i32* %75 to i8*
  call void @hypre_Free(i8* %149) #7
  %150 = bitcast i32* %77 to i8*
  call void @hypre_Free(i8* %150) #7
  br label %151

151:                                              ; preds = %144, %62
  %152 = call i8* @hypre_CAlloc(i64 80, i64 1) #7

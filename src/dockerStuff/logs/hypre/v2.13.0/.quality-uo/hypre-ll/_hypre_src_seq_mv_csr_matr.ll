...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_CAllocHost(i64 1, i64 56) #8
...
10:                                               ; preds = %3
  ...
  call void @hypre_Free(i8* nonnull %11) #8
...
23:                                               ; preds = %16, %12
  ...
  call void @hypre_FreeHost(i8* nonnull %24) #8
  br label %25
...
11:                                               ; preds = %1
  ...
  %13 = call i8* @hypre_CAlloc(i64 %12, i64 8) #8
...
23:                                               ; preds = %13, %1
  ...
  %28 = call i8* @hypre_CAllocHost(i64 1, i64 56) #8
...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRMatrixClone(%struct.hypre_CSRMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %8 = call i8* @hypre_CAllocHost(i64 1, i64 56) #8
  %9 = getelementptr inbounds i8, i8* %8, i64 32
  %10 = getelementptr inbounds i8, i8* %8, i64 16
  %11 = bitcast i8* %10 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %8, i8 0, i64 16, i1 false) #8
...
40:                                               ; preds = %36
  ...
  %43 = call i8* @hypre_CAlloc(i64 %42, i64 4) #8
...
177:                                              ; preds = %113, %106
  ...
  %179 = call i8* @hypre_CAllocHost(i64 1, i64 56) #8
  %180 = getelementptr inbounds i8, i8* %179, i64 32
  %181 = getelementptr inbounds i8, i8* %179, i64 16
  %182 = bitcast i8* %181 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %179, i8 0, i64 16, i1 false) #8
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %180, i8 0, i64 16, i1 false) #8
...
203:                                              ; preds = %177
  ...
  %205 = call i8* @hypre_CAlloc(i64 %204, i64 8) #8
...
211:                                              ; preds = %207
  ...
  %214 = call i8* @hypre_CAlloc(i64 %213, i64 4) #8
...
222:                                              ; preds = %216
  ...
  %224 = call i8* @hypre_CAlloc(i64 %223, i64 4) #8
...
328:                                              ; preds = %326
  ...
  call void @hypre_Free(i8* nonnull %329) #8
  br label %330

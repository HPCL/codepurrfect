...
define dso_local %struct.hypre_MultiblockMatrix* @hypre_MultiblockMatrixCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 24) #5
...
5:                                                ; preds = %1
  %6 = sext i32 %3 to i64
  %7 = call i8* @hypre_CAlloc(i64 %6, i64 4) #5
  ...
  %12 = call i8* @hypre_CAlloc(i64 %11, i64 8) #5

...
define dso_local void @hypre_PrintLine(i8* %0, %struct.hypre_PilutSolverGlobals* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %5 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i32 %4, i8* %0, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i64 0, i64 0), i32 39) #3
...
8:                                                ; preds = %4
  ...
  call void (i8*, ...) @hypre_errexit(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.2, i64 0, i64 0), i32 %10, i32 %0, i32 %1, i32 %2, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i64 0, i64 0), i32 51) #3
  br label %11

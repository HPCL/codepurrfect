...
232:                                              ; preds = %226, %11
  ...
  %237 = call i8* @hypre_CAlloc(i64 %236, i64 4, i32 2) #3
  %238 = bitcast i8* %237 to i32*
  %239 = load i32, i32* %234, align 4, !tbaa !7
  %240 = sext i32 %239 to i64
  %241 = call i8* @hypre_CAlloc(i64 %240, i64 8, i32 2) #3
...
246:                                              ; preds = %232
  ...
  %256 = call i8* @hypre_CAlloc(i64 %255, i64 8, i32 2) #3
...
499:                                              ; preds = %497
  ...
  %501 = call i8* @hypre_CAlloc(i64 %500, i64 4, i32 1) #3
...
558:                                              ; preds = %555, %539
  %559 = bitcast i32** %12 to i8**
  %560 = load i8*, i8** %559, align 8, !tbaa !3
  call void @hypre_Free(i8* %560, i32 1) #3
  store i32* null, i32** %12, align 8, !tbaa !3
  %561 = bitcast i32** %13 to i8**
  %562 = load i8*, i8** %561, align 8, !tbaa !3
  call void @hypre_Free(i8* %562, i32 1) #3
  store i32* null, i32** %13, align 8, !tbaa !3
  %563 = bitcast i32** %14 to i8**
  %564 = load i8*, i8** %563, align 8, !tbaa !3
  call void @hypre_Free(i8* %564, i32 1) #3
  store i32* null, i32** %14, align 8, !tbaa !3
  %565 = bitcast i32* %260 to i8*
  call void @hypre_Free(i8* %565, i32 1) #3

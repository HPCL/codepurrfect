...
92:                                               ; preds = %87, %82
  ...
  %97 = call i8* %94(i64 %96, i64 8, i32 1) #7
...
93:                                               ; preds = %77
  ...
  %95 = call i8* %94(i64 %82, i64 8, i32 1) #7
...
97:                                               ; preds = %93, %77
  ...
  %100 = call i8* %99(i64 %82, i64 8, i32 1) #7
...
106:                                              ; preds = %103, %106
  ...
  %109 = call i8* %108(i64 %86, i64 8, i32 1) #7
...
138:                                              ; preds = %131, %132
  call void @hypre_error_handler(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i64 0, i64 0), i32 357, i32 1, i8* null) #7
  br label %834
...
155:                                              ; preds = %148, %149
  call void @hypre_error_handler(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i64 0, i64 0), i32 382, i32 1, i8* null) #7
  br label %834
...
804:                                              ; preds = %798
  call void @hypre_error_handler(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i64 0, i64 0), i32 839, i32 256, i8* null) #7
  br label %805

...
5:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0), i32 79, i32 2, i8* null) #5
  br label %26
...
5:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0), i32 389, i32 2, i8* null) #5
  br label %26

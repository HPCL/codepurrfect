...
define dso_local %struct.RowPatt* @RowPattCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_MAlloc(i64 48, i32 1) #6
  ...
  %13 = call i8* @hypre_MAlloc(i64 %9, i32 1) #6
...
9:                                                ; preds = %3
  ...
  %14 = sext i32 %13 to i64
  %15 = shl nsw i64 %14, 2
  %16 = call i8* @hypre_MAlloc(i64 %15, i32 1) #6
...
17:                                               ; preds = %9, %3
  ...
  %25 = shl nsw i64 %24, 2
  call void @hypre_Memcpy(i8* %20, i8* %23, i64 %25, i32 1, i32 1) #6
...
20:                                               ; preds = %12, %3
  ...
  %31 = shl nsw i64 %30, 2
  call void @hypre_Memcpy(i8* %23, i8* %29, i64 %31, i32 1, i32 1) #6

...
define dso_local void @shellSort_int(i32 %0, i32* nocapture %1) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 23, i32 1) #2
  %3 = icmp sgt i32 %0, 1
...
define dso_local void @shellSort_float(i32 %0, double* nocapture %1) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 46, i32 1) #2
  %3 = icmp sgt i32 %0, 1
  br i1 %3, label %6, label %30

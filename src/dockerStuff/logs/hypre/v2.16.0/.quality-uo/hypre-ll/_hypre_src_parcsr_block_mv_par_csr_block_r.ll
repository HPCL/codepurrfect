...
185:                                              ; preds = %175, %168
  ...
  %192 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %119, i8* %54, i8* %169) #5
...
1243:                                             ; preds = %1238
  %1244 = call %struct.hypre_CSRBlockMatrix* @hypre_ExchangeRAPBlockData(%struct.hypre_CSRBlockMatrix* %1239, %struct.hypre_ParCSRCommPkg* %19, i32 %29)
...
2537:                                             ; preds = %1879, %1805
  ...
  store i32* null, i32** %415, align 8, !tbaa !42
  %2540 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #5
  %2541 = bitcast i8* %2540 to i32*
  %2542 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #5
...
2586:                                             ; preds = %2585
  ...
  call void @hypre_Free(i8* %2588, i32 1) #5
  br label %2589
...
2590:                                             ; preds = %2589
  ...
  call void @hypre_Free(i8* %2592, i32 1) #5
  br label %2593
...
2594:                                             ; preds = %2593
  ...
  call void @hypre_Free(i8* %2596, i32 1) #5
  br label %2597
...
2598:                                             ; preds = %2597
  ...
  call void @hypre_Free(i8* %2600, i32 1) #5
  br label %2601

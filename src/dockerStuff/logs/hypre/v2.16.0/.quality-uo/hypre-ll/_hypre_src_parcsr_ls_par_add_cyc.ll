...
define dso_local i32 @hypre_BoomerAMGAdditiveCycle(i8* readonly %0) local_unnamed_addr #0 {
  ...
  %9 = getelementptr inbounds i8, i8* %0, i64 352
  ...
  %12 = getelementptr inbounds i8, i8* %0, i64 360
  ...
  %15 = getelementptr inbounds i8, i8* %0, i64 368
  ...
  %21 = getelementptr inbounds i8, i8* %0, i64 648
  ...
  %24 = getelementptr inbounds i8, i8* %0, i64 696
  ...
  %27 = getelementptr inbounds i8, i8* %0, i64 408
  %28 = bitcast i8* %27 to i32*
  %29 = load i32, i32* %28, align 8, !tbaa !17
  %30 = getelementptr inbounds i8, i8* %0, i64 1408
  %31 = bitcast i8* %30 to i32*
  %32 = load i32, i32* %31, align 8, !tbaa !18
  %33 = getelementptr inbounds i8, i8* %0, i64 1412
  %34 = bitcast i8* %33 to i32*
  %35 = load i32, i32* %34, align 4, !tbaa !19
  %36 = getelementptr inbounds i8, i8* %0, i64 1416
  %37 = bitcast i8* %36 to i32*
  %38 = load i32, i32* %37, align 8, !tbaa !20
  %39 = getelementptr inbounds i8, i8* %0, i64 1420
  %40 = bitcast i8* %39 to i32*
  %41 = load i32, i32* %40, align 4, !tbaa !21
  %42 = getelementptr inbounds i8, i8* %0, i64 200
  %43 = bitcast i8* %42 to i32**
  %44 = load i32*, i32** %43, align 8, !tbaa !22
  %45 = getelementptr inbounds i8, i8* %0, i64 1456
  ...
  %48 = getelementptr inbounds i8, i8* %0, i64 1464
  ...
  %51 = getelementptr inbounds i8, i8* %0, i64 1480
  ...
  %54 = getelementptr inbounds i8, i8* %0, i64 1472
  ...
  %57 = getelementptr inbounds i8, i8* %0, i64 416
  %58 = bitcast i8* %57 to double***
  %59 = load double**, double*** %58, align 8, !tbaa !27
  %60 = getelementptr inbounds i8, i8* %0, i64 1488
  %61 = bitcast i8* %60 to double**
  %62 = load double*, double** %61, align 8, !tbaa !28
  %63 = getelementptr inbounds i8, i8* %0, i64 248
  %64 = bitcast i8* %63 to double**
  %65 = load double*, double** %64, align 8, !tbaa !29
  %66 = getelementptr inbounds i8, i8* %0, i64 256
  %67 = bitcast i8* %66 to double**
  %68 = load double*, double** %67, align 8, !tbaa !30
  %69 = getelementptr inbounds i8, i8* %0, i64 216
  %70 = bitcast i8* %69 to i32*
  %71 = load i32, i32* %70, align 8, !tbaa !31
  %72 = getelementptr inbounds i8, i8* %0, i64 192
...
define dso_local i32 @hypre_CreateLambda(i8* nocapture %0) local_unnamed_addr #0 {
  ...
  %4 = getelementptr inbounds i8, i8* %0, i64 336
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 1408
  %14 = bitcast i8* %13 to i32*
  %15 = load i32, i32* %14, align 8, !tbaa !18
  %16 = getelementptr inbounds i8, i8* %0, i64 1412
  %17 = bitcast i8* %16 to i32*
  %18 = load i32, i32* %17, align 4, !tbaa !19
  %19 = getelementptr inbounds i8, i8* %0, i64 1420
  ...
  %28 = getelementptr inbounds i8, i8* %0, i64 1440
  %29 = bitcast i8* %28 to i32*
  %30 = load i32, i32* %29, align 8, !tbaa !64
  %31 = getelementptr inbounds i8, i8* %0, i64 1448
...
678:                                              ; preds = %675
  ...
  %680 = call i8* @hypre_CAlloc(i64 %679, i64 4, i32 2) #3
...
750:                                              ; preds = %742
  ...
  call void @hypre_Free(i8* nonnull %751, i32 2) #3
  br label %752
...
770:                                              ; preds = %752
  ...
  call void @hypre_Free(i8* nonnull %771, i32 2) #3
  br label %772
...
782:                                              ; preds = %772, %726
  ...
  %806 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %793, i64 0, i32 9
  %807 = load double*, double** %806, align 8, !tbaa !41
  %808 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %795, i64 0, i32 9
  %809 = load double*, double** %808, align 8, !tbaa !41
  %810 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %793, i64 0, i32 3
...
1234:                                             ; preds = %1215
  %1235 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #3
...
1257:                                             ; preds = %1237
  %1258 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #3
  %1259 = bitcast i8* %1258 to i32*
  br label %1260

1260:                                             ; preds = %1257, %1256
  %1261 = phi i32* [ %591, %1256 ], [ %1259, %1257 ]
  %1262 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #3
  ...
  %1278 = call i8* @hypre_CAlloc(i64 1, i64 160, i32 1) #3
...
1288:                                             ; preds = %1260
  %1289 = call i8* @hypre_CAlloc(i64 1, i64 160, i32 1) #3
...
1314:                                             ; preds = %1312, %1301
  ...
  call void @hypre_Free(i8* %1316, i32 1) #3
...
define dso_local i32 @hypre_CreateDinv(i8* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds i8, i8* %0, i64 336
  ...
  %11 = getelementptr inbounds i8, i8* %0, i64 1416
  %12 = bitcast i8* %11 to i32*
  %13 = load i32, i32* %12, align 8, !tbaa !20
  %14 = getelementptr inbounds i8, i8* %0, i64 1448
  %15 = bitcast i8* %14 to double*
  %16 = load double, double* %15, align 8, !tbaa !65
  %17 = getelementptr inbounds i8, i8* %0, i64 1440
  %18 = bitcast i8* %17 to i32*
  %19 = load i32, i32* %18, align 8, !tbaa !64
  %20 = getelementptr inbounds i8, i8* %0, i64 1420
...
27:                                               ; preds = %1
  %28 = getelementptr inbounds i8, i8* %0, i64 408
  %29 = bitcast i8* %28 to i32*
...
89:                                               ; preds = %81
  ...
  call void @hypre_Free(i8* nonnull %90, i32 2) #3
  br label %91
...
109:                                              ; preds = %91
  ...
  call void @hypre_Free(i8* nonnull %110, i32 2) #3
  br label %111
...
128:                                              ; preds = %121
  ...
  %131 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %125, i64 0, i32 9
...
170:                                              ; preds = %165, %49
  %171 = getelementptr inbounds i8, i8* %0, i64 1488
  %172 = bitcast i8* %171 to i8**
  store i8* %71, i8** %172, align 8, !tbaa !28
  %173 = getelementptr inbounds i8, i8* %0, i64 1472
  %174 = bitcast i8* %173 to i8**
  store i8* %51, i8** %174, align 8, !tbaa !26
  %175 = getelementptr inbounds i8, i8* %0, i64 1480
...
!41 = !{!42, !9, i64 64}
!42 = !{!"", !9, i64 0, !9, i64 8, !9, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !9, i64 40, !9, i64 48, !5, i64 56, !9, i64 64, !9, i64 72, !5, i64 80}
!43 = !{!42, !9, i64 0}
!44 = !{!42, !5, i64 24}
!45 = !{!8, !8, i64 0}

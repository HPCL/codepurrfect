...
294:                                              ; preds = %284, %279
  %295 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #5
  ...
  %299 = getelementptr inbounds i8, i8* %295, i64 32
  ...
  %303 = getelementptr inbounds i8, i8* %295, i64 40
  %304 = bitcast i8* %303 to i8**
  store i8* %100, i8** %304, align 8, !tbaa !13
  %305 = getelementptr inbounds i8, i8* %295, i64 48
  ...
  %312 = bitcast %struct.hypre_ParCSRCommPkg** %311 to i8**

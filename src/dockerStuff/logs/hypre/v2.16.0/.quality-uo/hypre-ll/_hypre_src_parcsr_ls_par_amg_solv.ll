...
24:                                               ; preds = %20, %4
  ...
  %38 = getelementptr inbounds i8, i8* %0, i64 272
  ...
  %57 = getelementptr inbounds i8, i8* %0, i64 648
...
118:                                              ; preds = %113, %102
  %119 = getelementptr inbounds i8, i8* %0, i64 672
  %120 = bitcast i8* %119 to double*
  %121 = getelementptr inbounds i8, i8* %0, i64 728
  %122 = bitcast i8* %121 to double*
  %123 = getelementptr inbounds i8, i8* %0, i64 716
...
194:                                              ; preds = %192, %166
  ...
  %197 = getelementptr inbounds i8, i8* %0, i64 672
...
define dso_local i32 @hypre_BoomerAMGCycleT(i8* nocapture %0, %struct.hypre_ParVector_struct** nocapture readonly %1, %struct.hypre_ParVector_struct** nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %7 = getelementptr inbounds i8, i8* %0, i64 360
  ...
  %10 = getelementptr inbounds i8, i8* %0, i64 368
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 648
...
!47 = !{!4, !8, i64 32}
!48 = !{!49, !8, i64 64}
!49 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80}
!50 = !{!49, !8, i64 0}
!51 = !{!49, !5, i64 24}
!52 = !{!53, !5, i64 8}

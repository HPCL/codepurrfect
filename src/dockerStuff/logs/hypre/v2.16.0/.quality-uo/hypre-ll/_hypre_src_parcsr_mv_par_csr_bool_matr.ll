...
33:                                               ; preds = %28, %30, %23
  ...
  store %struct.hypre_ParCSRCommPkg* null, %struct.hypre_ParCSRCommPkg** %90, align 8, !tbaa !34
...
53:                                               ; preds = %51, %47
  ...
  %55 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %54, align 8, !tbaa !34
  %56 = icmp eq %struct.hypre_ParCSRCommPkg* %55, null
  br i1 %56, label %59, label %57

57:                                               ; preds = %53
  %58 = call i32 @hypre_MatvecCommPkgDestroy(%struct.hypre_ParCSRCommPkg* nonnull %55) #8
  br label %59
...
112:                                              ; preds = %99, %97
  ...
  store %struct.hypre_ParCSRCommPkg* null, %struct.hypre_ParCSRCommPkg** %137, align 8, !tbaa !34

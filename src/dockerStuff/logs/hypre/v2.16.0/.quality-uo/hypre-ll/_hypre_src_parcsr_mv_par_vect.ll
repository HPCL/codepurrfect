...
10:                                               ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 285, i32 12, i8* null) #4
  br label %38
...
47:                                               ; preds = %45, %41
  ...
  store i8* %52, i8** %54, align 8, !tbaa !44
  %55 = load i32, i32* %51, align 4, !tbaa !43
  %56 = add nsw i32 %55, 1
  ...
  store i8* %58, i8** %61, align 8, !tbaa !45
  ...
  store i32 10, i32* %62, align 8, !tbaa !46
  ...
  store %struct.hypre_ProcListElements* %10, %struct.hypre_ProcListElements** %69, align 8, !tbaa !51
...
106:                                              ; preds = %96, %106
  ...
  br i1 %113, label %99, label %106, !llvm.loop !52
...
114:                                              ; preds = %103, %114
  ...
  br i1 %125, label %114, label %228, !llvm.loop !53

126:                                              ; preds = %76
  %127 = load i8*, i8** %61, align 8, !tbaa !45
  call void @hypre_Free(i8* %127, i32 1) #4
  store i32* null, i32** %60, align 8, !tbaa !45
  %128 = load i8*, i8** %54, align 8, !tbaa !44
  call void @hypre_Free(i8* %128, i32 1) #4
  store i32* null, i32** %53, align 8, !tbaa !44
  %129 = load i8*, i8** %65, align 8, !tbaa !47
  call void @hypre_Free(i8* %129, i32 1) #4
  store i32* null, i32** %64, align 8, !tbaa !47
...
139:                                              ; preds = %47
  %140 = load i32, i32* %50, align 8, !tbaa !41
...
182:                                              ; preds = %172, %182
  ...
  br i1 %189, label %175, label %182, !llvm.loop !55
...
190:                                              ; preds = %179, %190
  ...
  br i1 %201, label %190, label %202, !llvm.loop !56
...
215:                                              ; preds = %211, %215
  ...
  br i1 %224, label %225, label %215, !llvm.loop !57
...
228:                                              ; preds = %114, %99, %225
  ...
  %233 = load i8*, i8** %61, align 8, !tbaa !45
  call void @hypre_Free(i8* %233, i32 1) #4
  store i32* null, i32** %60, align 8, !tbaa !45
  %234 = load i8*, i8** %54, align 8, !tbaa !44
  call void @hypre_Free(i8* %234, i32 1) #4
  store i32* null, i32** %53, align 8, !tbaa !44
  %235 = load i8*, i8** %65, align 8, !tbaa !47
...
275:                                              ; preds = %265, %275
  ...
  br i1 %291, label %267, label %275, !llvm.loop !58
...
292:                                              ; preds = %273, %292
  ...
  br i1 %301, label %302, label %292, !llvm.loop !59
...
define dso_local i32 @hypre_FillResponseParToVectorAll(i8* nocapture readonly %0, i32 %1, i32 %2, i8* nocapture readonly %3, i32 %4, i8** nocapture readnone %5, i32* nocapture %6) #0 {
  ...
  %13 = load %struct.hypre_ProcListElements*, %struct.hypre_ProcListElements** %12, align 8, !tbaa !51
...
20:                                               ; preds = %7
  ...
  store i32 %21, i32* %17, align 4, !tbaa !43
  ...
  store i8* %27, i8** %23, align 8, !tbaa !44
  ...
  %31 = load i32, i32* %17, align 4, !tbaa !43
  %32 = add nsw i32 %31, 1
  %33 = sext i32 %32 to i64
  %34 = shl nsw i64 %33, 2
  %35 = call i8* @hypre_ReAlloc(i8* %30, i64 %34, i32 1) #4
  store i8* %35, i8** %29, align 8, !tbaa !45
  br label %36

36:                                               ; preds = %20, %7
  %37 = load i32, i32* %15, align 8, !tbaa !41
  ...
  %44 = load i32*, i32** %43, align 8, !tbaa !44
...
50:                                               ; preds = %36
  ...
  %56 = load i8*, i8** %55, align 8, !tbaa !47
  %57 = sext i32 %53 to i64
  %58 = shl nsw i64 %57, 2
  %59 = call i8* @hypre_ReAlloc(i8* %56, i64 %58, i32 1) #4
  store i8* %59, i8** %55, align 8, !tbaa !47
  store i32 %53, i32* %46, align 8, !tbaa !46
  br label %60
...
62:                                               ; preds = %60
  ...
  %64 = load i32*, i32** %63, align 8, !tbaa !47
...
67:                                               ; preds = %62, %67
  ...
  br i1 %75, label %76, label %67, !llvm.loop !60
...
78:                                               ; preds = %76, %60
  ...
  %80 = load i32*, i32** %38, align 8, !tbaa !45
  %81 = add nsw i32 %37, 1
  %82 = sext i32 %81 to i64
  %83 = getelementptr inbounds i32, i32* %80, i64 %82
  store i32 %79, i32* %83, align 4, !tbaa !7
  %84 = load i32, i32* %15, align 8, !tbaa !41
  %85 = add nsw i32 %84, 1
  store i32 %85, i32* %15, align 8, !tbaa !41
...
11:                                               ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 971, i32 12, i8* null) #4
  br label %69
...
32:                                               ; preds = %25
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 989, i32 1, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.7, i64 0, i64 0)) #4
  br label %69
...
38:                                               ; preds = %33, %38
  ...
  %45 = icmp eq i64 %39, 0
  br i1 %45, label %38, label %46, !llvm.loop !61
...
55:                                               ; preds = %52, %55
  ...
  br i1 %66, label %55, label %67, !llvm.loop !62
...
21:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1057, i32 1, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.7, i64 0, i64 0)) #4
  br label %73
...
27:                                               ; preds = %22, %27
  ...
  %32 = icmp eq i64 %28, 0
  br i1 %32, label %27, label %33, !llvm.loop !63
...
56:                                               ; preds = %46, %56
  ...
  %59 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* nonnull %19, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.13, i64 0, i64 0), i32* nonnull %6, double* %58) #4
  ...
  br i1 %65, label %56, label %66, !llvm.loop !64
...
72:                                               ; preds = %66
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1112, i32 1, i8* null) #4
  br label %73
...
16:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1222, i32 1, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.14, i64 0, i64 0)) #4
  br label %65
...
23:                                               ; preds = %29
  ...
  br i1 %24, label %25, label %29, !llvm.loop !66
...
37:                                               ; preds = %29
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1233, i32 1, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.15, i64 0, i64 0)) #4
  br label %65
...
38:                                               ; preds = %27, %38
  ...
  br i1 %48, label %65, label %38, !llvm.loop !67
...
57:                                               ; preds = %49
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1250, i32 20, i8* null) #4
  br label %65
...
58:                                               ; preds = %55, %58
  ...
  br i1 %64, label %65, label %58, !llvm.loop !68
...
!41 = !{!42, !8, i64 0}
!42 = !{!"", !8, i64 0, !8, i64 4, !4, i64 8, !4, i64 16, !8, i64 24, !4, i64 32, !4, i64 40, !4, i64 48}
!43 = !{!42, !8, i64 4}
!44 = !{!42, !4, i64 8}
!45 = !{!42, !4, i64 16}
!46 = !{!42, !8, i64 24}
!47 = !{!42, !4, i64 32}
!48 = !{!49, !4, i64 0}
!49 = !{!"", !4, i64 0, !8, i64 8, !8, i64 12, !4, i64 16, !4, i64 24}
!50 = !{!49, !4, i64 16}
!51 = !{!49, !4, i64 24}

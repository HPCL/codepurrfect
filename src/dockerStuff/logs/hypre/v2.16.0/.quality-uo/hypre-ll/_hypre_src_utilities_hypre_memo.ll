...
8:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 89, i32 2, i8* getelementptr inbounds ([143 x i8], [143 x i8]* @.str.1, i64 0, i64 0)) #10
...
33:                                               ; preds = %30
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 82, i32 2, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.2, i64 0, i64 0)) #10

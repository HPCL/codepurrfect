...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateLaplacian27pt(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, double* readonly %10) local_unnamed_addr #0 {
  ...
  %55 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #3
  ...
  %78 = call i8* @hypre_CAlloc(i64 %77, i64 4, i32 2) #3
  %79 = bitcast i8* %78 to i32*
  %80 = call i8* @hypre_CAlloc(i64 %77, i64 4, i32 2) #3
  ...
  %175 = call i8* @hypre_CAlloc(i64 %174, i64 4, i32 1) #3
...
790:                                              ; preds = %782, %11
  ...
  %795 = call i8* @hypre_CAlloc(i64 %794, i64 4, i32 2) #3
  %796 = bitcast i8* %795 to i32*
  %797 = load i32, i32* %792, align 4, !tbaa !7
  %798 = sext i32 %797 to i64
  %799 = call i8* @hypre_CAlloc(i64 %798, i64 8, i32 2) #3
...
803:                                              ; preds = %790
  ...
  %807 = call i8* @hypre_CAlloc(i64 %806, i64 4, i32 1) #3
  %808 = bitcast i8* %807 to i32*
  %809 = load i32, i32* %804, align 4, !tbaa !7
  %810 = sext i32 %809 to i64
  %811 = call i8* @hypre_CAlloc(i64 %810, i64 4, i32 2) #3
  %812 = bitcast i8* %811 to i32*
  %813 = load i32, i32* %804, align 4, !tbaa !7
  %814 = sext i32 %813 to i64
  %815 = call i8* @hypre_CAlloc(i64 %814, i64 8, i32 2) #3
...
2549:                                             ; preds = %2545
  ...
  %2551 = call i8* @hypre_CAlloc(i64 %2550, i64 4, i32 1) #3
...
2598:                                             ; preds = %2590, %2569
  call void @hypre_Free(i8* %2551, i32 1) #3
  br label %2599
...
2599:                                             ; preds = %2598, %2545
  ...
  %2604 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2603, i64 0, i32 11
  %2605 = bitcast i32** %2604 to i8**
  store i8* %175, i8** %2605, align 8, !tbaa !22
  %2606 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2603, i64 0, i32 7
  ...
  %2613 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2603, i64 0, i32 8
...
2620:                                             ; preds = %2617, %2599
  %2621 = bitcast i32** %12 to i8**
  %2622 = load i8*, i8** %2621, align 8, !tbaa !3
  call void @hypre_Free(i8* %2622, i32 1) #3
  store i32* null, i32** %12, align 8, !tbaa !3
  %2623 = bitcast i32** %13 to i8**
  %2624 = load i8*, i8** %2623, align 8, !tbaa !3
  call void @hypre_Free(i8* %2624, i32 1) #3
  store i32* null, i32** %13, align 8, !tbaa !3
  %2625 = bitcast i32** %14 to i8**
  %2626 = load i8*, i8** %2625, align 8, !tbaa !3
  call void @hypre_Free(i8* %2626, i32 1) #3
  store i32* null, i32** %14, align 8, !tbaa !3
  %2627 = bitcast i32* %819 to i8*
  call void @hypre_Free(i8* %2627, i32 1) #3

...
@qcmp = internal unnamed_addr global i32 (i8*, i8*)* null, align 8
@thresh = internal unnamed_addr global i32 0, align 4
@mthresh = internal unnamed_addr global i32 0, align 4

; Function Attrs: nounwind uwtable
define dso_local void @hypre_tex_qsort(i8* %0, i32 %1, i32 %2, i32 (i8*, i8*)* %3) local_unnamed_addr #0 {
  %5 = icmp slt i32 %1, 2
  br i1 %5, label %98, label %6

6:                                                ; preds = %4
  store i32 %2, i32* @qsz, align 4, !tbaa !3
  store i32 (i8*, i8*)* %3, i32 (i8*, i8*)** @qcmp, align 8, !tbaa !7
  %7 = shl nsw i32 %2, 2
...
23:                                               ; preds = %17, %23
  ...
  %26 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** @qcmp, align 8, !tbaa !7
  %27 = call i32 %26(i8* %25, i8* %24) #1
...
19:                                               ; preds = %7
  %20 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** @qcmp, align 8, !tbaa !7
  %21 = call i32 %20(i8* %10, i8* %16) #1
  %22 = icmp sgt i32 %21, 0
  %23 = select i1 %22, i8* %10, i8* %16
  %24 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** @qcmp, align 8, !tbaa !7
  %25 = load i32, i32* @qsz, align 4, !tbaa !3
  %26 = sext i32 %25 to i64
  %27 = sub nsw i64 0, %26
  %28 = getelementptr inbounds i8, i8* %8, i64 %27
  %29 = call i32 %24(i8* %23, i8* %28) #1
...
31:                                               ; preds = %19
  ...
  %34 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** @qcmp, align 8, !tbaa !7
  %35 = call i32 %34(i8* %33, i8* %28) #1
...
63:                                               ; preds = %58, %68
  ...
  %65 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** @qcmp, align 8, !tbaa !7
  %66 = call i32 %65(i8* %64, i8* nonnull %61) #1
...
76:                                               ; preds = %73, %83
  ...
  %78 = load i32 (i8*, i8*)*, i32 (i8*, i8*)** @qcmp, align 8, !tbaa !7
  %79 = call i32 %78(i8* %61, i8* nonnull %77) #1

...
317:                                              ; preds = %309
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 217, i32 1, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.1, i64 0, i64 0)) #6
  br label %318
...
427:                                              ; preds = %423
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 255, i32 1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0)) #6
  br label %428
...
515:                                              ; preds = %511
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 287, i32 1, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i64 0, i64 0)) #6
  br label %516
...
182:                                              ; preds = %179
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 1399, i32 1, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4, i64 0, i64 0)) #6
  br label %199
...
143:                                              ; preds = %115, %90
  %144 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* nonnull %17, i8* %101, i8* %108) #6
...
179:                                              ; preds = %151, %143
  %180 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* nonnull %17, i8* %101, i8* %104) #6
...
370:                                              ; preds = %367
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 532, i32 1, i8* null) #6
  br label %371
...
541:                                              ; preds = %538
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 661, i32 1, i8* null) #6
  br label %542
...
579:                                              ; preds = %578
  ...
  %582 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct.hypre_ParCSRCommPkg* nonnull %17, i8* %580, i8* %581) #6
...
133:                                              ; preds = %130
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 796, i32 1, i8* null) #6
  br label %134
...
234:                                              ; preds = %231
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 850, i32 1, i8* null) #6
  br label %235
...
65:                                               ; preds = %36, %18
  ...
  %70 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %6, i8* %27, i8* %69) #6
  %71 = call %struct.hypre_Vector* @hypre_SeqVectorCreate(i32 %16) #6
  %72 = call i32 @hypre_SeqVectorInitialize(%struct.hypre_Vector* %71) #6
  %73 = call i32 @hypre_SeqVectorCopy(%struct.hypre_Vector* %2, %struct.hypre_Vector* %71) #6
  %74 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %70) #6
  %75 = call i32 @hypre_CSRMatrixMatvec(double -1.000000e+00, %struct.hypre_CSRMatrix* %8, %struct.hypre_Vector* %66, double 1.000000e+00, %struct.hypre_Vector* %71) #6
  %76 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %66) #6
  call void @hypre_Free(i8* %27, i32 1) #6
  br label %81

77:                                               ; preds = %4
  %78 = call %struct.hypre_Vector* @hypre_SeqVectorCreate(i32 %16) #6
  %79 = call i32 @hypre_SeqVectorInitialize(%struct.hypre_Vector* %78) #6
  %80 = call i32 @hypre_SeqVectorCopy(%struct.hypre_Vector* %2, %struct.hypre_Vector* %78) #6
  br label %81
...
81:                                               ; preds = %77, %65
  ...
  %86 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %82) #6
  ret i32 0
}
...
143:                                              ; preds = %140
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 959, i32 1, i8* null) #6
  br label %144
...
254:                                              ; preds = %251
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 1017, i32 1, i8* null) #6
  br label %255
...
124:                                              ; preds = %121
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 1120, i32 1, i8* null) #6
  br label %125
...
157:                                              ; preds = %154
  ...
  call void @hypre_Free(i8* %159, i32 1) #6
  store double* null, double** %10, align 8, !tbaa !19
  br label %160
...
136:                                              ; preds = %133
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 1234, i32 1, i8* null) #6
  br label %137
...
173:                                              ; preds = %170
  ...
  call void @hypre_Free(i8* %175, i32 1) #6
  store double* null, double** %12, align 8, !tbaa !19
  br label %176
...
723:                                              ; preds = %604, %600
  ...
  %730 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %727, i64 0, i32 9
...
128:                                              ; preds = %121
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 1947, i32 1, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.5, i64 0, i64 0)) #6
  store i32 1, i32* %13, align 4, !tbaa !12
...
91:                                               ; preds = %88
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 2625, i32 1, i8* null) #6
  br label %92
...
97:                                               ; preds = %94
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 2728, i32 1, i8* null) #6
  br label %98
...
106:                                              ; preds = %78, %53
  %107 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* nonnull %14, i8* %64, i8* %69) #6
...
142:                                              ; preds = %114, %106
  %143 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* nonnull %14, i8* %64, i8* %71) #6
...
207:                                              ; preds = %204
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 2903, i32 1, i8* null) #6
  br label %208
...
254:                                              ; preds = %253
  ...
  %257 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct.hypre_ParCSRCommPkg* nonnull %14, i8* %255, i8* %256) #6
...
937:                                              ; preds = %933
  ...
  %942 = load i32*, i32** %941, align 8, !tbaa !246
...
968:                                              ; preds = %1158, %1152
  ...
  br i1 %969, label %1168, label %970, !llvm.loop !247
...
982:                                              ; preds = %980, %982
  ...
  br i1 %998, label %982, label %999, !llvm.loop !248
...
1022:                                             ; preds = %1016, %1013
  ...
  br i1 %1025, label %1010, label %1013, !llvm.loop !249
...
1060:                                             ; preds = %1045, %1053
  ...
  br i1 %1062, label %1063, label %1045, !llvm.loop !250
...
1089:                                             ; preds = %1073, %1082
  ...
  br i1 %1091, label %1140, label %1073, !llvm.loop !251
...
1135:                                             ; preds = %1119, %1127, %1122
  ...
  br i1 %1139, label %1105, label %1140, !llvm.loop !252
...
1140:                                             ; preds = %1135, %1089, %1092, %1063
  ...
  br i1 %1144, label %1026, label %1145, !llvm.loop !253
...
1158:                                             ; preds = %1152, %1158
  ...
  br i1 %1167, label %1158, label %968, !llvm.loop !254
...
46:                                               ; preds = %59, %48
  %47 = icmp eq i64 %52, %45
  br i1 %47, label %73, label %48, !llvm.loop !255
...
59:                                               ; preds = %56, %59
  ...
  br i1 %72, label %46, label %59, !llvm.loop !256
...
74:                                               ; preds = %73
  ...
  %82 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct.hypre_ParCSRCommPkg* nonnull %12, i8* %81, i8* %79) #6
...
91:                                               ; preds = %89, %94
  ...
  br i1 %93, label %121, label %94, !llvm.loop !257
...
107:                                              ; preds = %103, %107
  ...
  br i1 %120, label %89, label %107, !llvm.loop !258
...
131:                                              ; preds = %129, %131
  ...
  br i1 %137, label %138, label %131, !llvm.loop !259
...
61:                                               ; preds = %54, %61
  ...
  br i1 %65, label %56, label %61, !llvm.loop !260
...
70:                                               ; preds = %98, %72
  ...
  br i1 %71, label %103, label %72, !llvm.loop !261
...
98:                                               ; preds = %82, %93, %87
  ...
  br i1 %102, label %82, label %70, !llvm.loop !262
...
104:                                              ; preds = %103
  ...
  %112 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct.hypre_ParCSRCommPkg* nonnull %12, i8* %111, i8* %109) #6
  ...
  %122 = load i32*, i32** %121, align 8, !tbaa !246
...
128:                                              ; preds = %166, %131
  ...
  br i1 %130, label %172, label %131, !llvm.loop !263
...
166:                                              ; preds = %162, %165, %151
  ...
  br i1 %171, label %143, label %128, !llvm.loop !264
...
202:                                              ; preds = %189, %195
  ...
  %206 = sext i32 %205 to i64
  %207 = icmp slt i64 %204, %206
  br i1 %207, label %189, label %208, !llvm.loop !265
...
223:                                              ; preds = %221, %226
  ...
  br i1 %225, label %253, label %226, !llvm.loop !266
...
239:                                              ; preds = %235, %239
  ...
  br i1 %252, label %221, label %239, !llvm.loop !267
...
264:                                              ; preds = %262, %264
  ...
  br i1 %270, label %271, label %264, !llvm.loop !268

...
171:                                              ; preds = %146
  ...
  %178 = load i32*, i32** %177, align 8, !tbaa !79
  br label %179
...
208:                                              ; preds = %205, %208
  ...
  br i1 %223, label %224, label %208, !llvm.loop !80
...
224:                                              ; preds = %208, %195
  ...
  br i1 %229, label %230, label %195, !llvm.loop !81
...
256:                                              ; preds = %294, %260
  ...
  br i1 %259, label %301, label %260, !llvm.loop !82
...
294:                                              ; preds = %283, %288
  ...
  br i1 %300, label %272, label %256, !llvm.loop !83
...
317:                                              ; preds = %310, %317
  ...
  br i1 %323, label %312, label %317, !llvm.loop !84
...
324:                                              ; preds = %314, %324
  ...
  br i1 %332, label %333, label %324, !llvm.loop !85
...
356:                                              ; preds = %345, %352
  ...
  br i1 %360, label %361, label %345, !llvm.loop !86
...
373:                                              ; preds = %371, %373
  ...
  br i1 %379, label %380, label %373, !llvm.loop !87
...
387:                                              ; preds = %385, %387
  ...
  br i1 %394, label %395, label %387, !llvm.loop !88
...
408:                                              ; preds = %402, %408
  ...
  br i1 %426, label %404, label %408, !llvm.loop !89
...
427:                                              ; preds = %406, %427
  ...
  br i1 %440, label %441, label %427, !llvm.loop !90

441:                                              ; preds = %427, %404
  %442 = call i32 @HYPRE_IJMatrixCreate(i32 %31, i32 %44, i32 %191, i32 %44, i32 %191, %struct.hypre_IJMatrix_struct** nonnull %15) #7
  %443 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
451:                                              ; preds = %449, %451
  ...
  br i1 %471, label %472, label %451, !llvm.loop !91

472:                                              ; preds = %451, %441
  %473 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
  %474 = call i32 @HYPRE_IJMatrixSetRowSizes(%struct.hypre_IJMatrix_struct* %473, i32* %447) #7
  %475 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
505:                                              ; preds = %937, %599
  ...
  br i1 %516, label %952, label %517, !llvm.loop !92
...
634:                                              ; preds = %631
  %635 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
807:                                              ; preds = %800, %807
  ...
  br i1 %815, label %802, label %807, !llvm.loop !93
...
816:                                              ; preds = %805, %816
  ...
  br i1 %824, label %825, label %816, !llvm.loop !94
...
836:                                              ; preds = %830, %860
  ...
  %847 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
849:                                              ; preds = %836
  ...
  %852 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
855:                                              ; preds = %854
  %856 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
  ...
  %858 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
860:                                              ; preds = %854, %855
  ...
  br i1 %862, label %832, label %836, !llvm.loop !95
...
863:                                              ; preds = %834, %888
  ...
  %870 = fneg double %869
  %871 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
875:                                              ; preds = %863
  ...
  %878 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
881:                                              ; preds = %880
  %882 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
  ...
  %885 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
888:                                              ; preds = %880, %881
  ...
  br i1 %890, label %937, label %863, !llvm.loop !96
...
891:                                              ; preds = %794
  ...
  %896 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
898:                                              ; preds = %891
  %899 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
903:                                              ; preds = %901
  ...
  %905 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
926:                                              ; preds = %921
  ...
  br i1 %928, label %931, label %921, !llvm.loop !97
...
937:                                              ; preds = %888, %832, %903, %612, %891, %898, %931, %910, %634
  ...
  br i1 %951, label %612, label %505, !llvm.loop !98
...
976:                                              ; preds = %1401, %1064
  ...
  br i1 %987, label %1416, label %988, !llvm.loop !99
...
1267:                                             ; preds = %1260, %1267
  ...
  br i1 %1275, label %1262, label %1267, !llvm.loop !100
...
1276:                                             ; preds = %1265, %1276
  ...
  br i1 %1284, label %1285, label %1276, !llvm.loop !101
...
1296:                                             ; preds = %1290, %1320
  ...
  %1307 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1309:                                             ; preds = %1296
  ...
  %1312 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1315:                                             ; preds = %1314
  %1316 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
  ...
  %1318 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1320:                                             ; preds = %1314, %1315
  ...
  br i1 %1322, label %1292, label %1296, !llvm.loop !102
...
1323:                                             ; preds = %1294, %1348
  ...
  %1331 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1335:                                             ; preds = %1323
  ...
  %1338 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1341:                                             ; preds = %1340
  %1342 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
  ...
  %1345 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1348:                                             ; preds = %1340, %1341
  ...
  br i1 %1350, label %1401, label %1323, !llvm.loop !103

1351:                                             ; preds = %1254
  %1352 = load double, double* %1090, align 8, !tbaa !10
  %1353 = fmul double %1352, 5.000000e-01
  %1354 = select i1 %486, double %1352, double %1353
  %1355 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1357:                                             ; preds = %1351
  %1358 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1362:                                             ; preds = %1360
  %1363 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1390:                                             ; preds = %1382
  ...
  br i1 %1392, label %1395, label %1382, !llvm.loop !104
...
1401:                                             ; preds = %1348, %1292, %1362, %1076, %1368, %1395, %1357, %1351
  ...
  br i1 %1415, label %1076, label %976, !llvm.loop !105
...
1416:                                             ; preds = %976, %967, %952
  ...
  %1422 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1425:                                             ; preds = %1416
  %1426 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1429:                                             ; preds = %1425, %1416
  %1430 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
  %1431 = call i32 @HYPRE_IJMatrixAssemble(%struct.hypre_IJMatrix_struct* %1430) #7
  %1432 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
1465:                                             ; preds = %1463, %1462
  ...
  %1474 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %13, align 8, !tbaa !60
  %1475 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %1474) #7
  %1476 = add nsw i32 %1473, %1475
  %1477 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
  %1478 = call i32 @HYPRE_IJMatrixSetObjectType(%struct.hypre_IJMatrix_struct* %1477, i32 -1) #7
  %1479 = add nsw i32 %1476, %1478
  %1480 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %15, align 8, !tbaa !60
...
!17 = !{!18, !16, i64 0}
!18 = !{!"", !16, i64 0, !16, i64 8, !16, i64 16, !4, i64 24, !4, i64 28, !4, i64 32, !16, i64 40, !16, i64 48, !4, i64 56, !16, i64 64, !16, i64 72, !4, i64 80}
!19 = !{!18, !16, i64 8}
!20 = !{!18, !16, i64 64}
!21 = !{!15, !16, i64 40}
!22 = !{!18, !4, i64 24}

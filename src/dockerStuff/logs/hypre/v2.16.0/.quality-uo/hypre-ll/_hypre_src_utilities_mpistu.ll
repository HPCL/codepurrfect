...
define dso_local i32 @hypre_MPI_Group_incl(i32 %0, i32 %1, i32* nocapture readonly %2, i32* %3) local_unnamed_addr #1 {
  %5 = sext i32 %1 to i64
  %6 = shl nsw i64 %5, 2
  %7 = call i8* @hypre_MAlloc(i64 %6, i32 1) #4
...
define dso_local i32 @hypre_MPI_Allgatherv(i8* %0, i32 %1, i32 %2, i8* %3, i32* nocapture readonly %4, i32* nocapture readonly %5, i32 %6, i32 %7) local_unnamed_addr #1 {
  ...
  %14 = shl nsw i64 %13, 2
  %15 = call i8* @hypre_MAlloc(i64 %14, i32 1) #4
  %16 = bitcast i8* %15 to i32*
  %17 = load i32, i32* %9, align 4, !tbaa !3
  %18 = sext i32 %17 to i64
  %19 = shl nsw i64 %18, 2
  %20 = call i8* @hypre_MAlloc(i64 %19, i32 1) #4
...
36:                                               ; preds = %24, %8
  ...
  call void @hypre_Free(i8* %15, i32 1) #4
...
18:                                               ; preds = %9
  ...
  %21 = shl nsw i64 %20, 2
  %22 = call i8* @hypre_MAlloc(i64 %21, i32 1) #4
  %23 = bitcast i8* %22 to i32*
  %24 = load i32, i32* %10, align 4, !tbaa !3
  %25 = sext i32 %24 to i64
  %26 = shl nsw i64 %25, 2
  %27 = call i8* @hypre_MAlloc(i64 %26, i32 1) #4
...
define dso_local i32 @hypre_MPI_Type_struct(i32 %0, i32* nocapture readonly %1, i64* %2, i32* %3, i32* %4) local_unnamed_addr #1 {
  %6 = sext i32 %0 to i64
  %7 = shl nsw i64 %6, 2
  %8 = call i8* @hypre_MAlloc(i64 %7, i32 1) #4
...
20:                                               ; preds = %13, %5
  ...
  call void @hypre_Free(i8* %8, i32 1) #4
  ret i32 %21
}

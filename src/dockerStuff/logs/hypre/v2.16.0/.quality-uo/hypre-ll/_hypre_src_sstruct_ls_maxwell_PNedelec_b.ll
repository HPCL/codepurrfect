...
define dso_local i32 @hypre_Maxwell_PNedelec_Bdy(%struct.hypre_StructGrid_struct* %0, %struct.hypre_SStructPGrid* nocapture readonly %1, %struct.hypre_BoxArrayArray_struct**** nocapture %2) local_unnamed_addr #0 {
  ...
  %36 = shl nsw i64 %35, 3
  %37 = call i8* @hypre_MAlloc(i64 %36, i32 1) #3
...
95:                                               ; preds = %89, %742
  ...
  %100 = call i8* @hypre_CAlloc(i64 %42, i64 4, i32 1) #3
...
141:                                              ; preds = %138
  %142 = call i8* @hypre_MAlloc(i64 %46, i32 1) #3
...
731:                                              ; preds = %138
  %732 = call i8* @hypre_MAlloc(i64 %85, i32 1) #3

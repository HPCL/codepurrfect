...
6:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 33, i32 36, i8* null) #2
  br label %9
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 54, i32 44, i8* null) #2
  br label %10
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 93, i32 28, i8* null) #2
  br label %8
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 192, i32 12, i8* null) #2
  br label %11
...
8:                                                ; preds = %6
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 198, i32 20, i8* null) #2
  br label %11
...
6:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 219, i32 36, i8* null) #2
  br label %10
...
6:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 241, i32 12, i8* null) #2
  br label %15
...
9:                                                ; preds = %7
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 246, i32 20, i8* null) #2
  br label %15
...
12:                                               ; preds = %10
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 251, i32 36, i8* null) #2
  br label %15

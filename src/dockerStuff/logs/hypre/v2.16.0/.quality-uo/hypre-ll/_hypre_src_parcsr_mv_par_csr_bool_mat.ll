...
82:                                               ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i64 0, i64 0), i32 102, i32 1, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i64 0, i64 0)) #4
  br label %662
...
93:                                               ; preds = %89
  ...
  %114 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #4
...
define dso_local i32 @hypre_BooleanMatvecCommPkgCreate(%struct.hypre_ParCSRBooleanMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %32 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #4
...
define dso_local %struct.hypre_CSRBooleanMatrix* @hypre_ParCSRBooleanMatrixExtractAExt(%struct.hypre_ParCSRBooleanMatrix* nocapture readonly %0, i32** %1) local_unnamed_addr #0 {
  ...
  %14 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %13, align 8, !tbaa !54
...
54:                                               ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i64 0, i64 0), i32 646, i32 1, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i64 0, i64 0)) #4
  br label %595
...
61:                                               ; preds = %57
  ...
  %75 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #4
...
100:                                              ; preds = %61, %57
  ...
  %105 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %104, align 8, !tbaa !54
...
define dso_local i32 @hypre_BooleanMatTCommPkgCreate(%struct.hypre_ParCSRBooleanMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %44 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #4
  %45 = bitcast i8* %44 to i32*

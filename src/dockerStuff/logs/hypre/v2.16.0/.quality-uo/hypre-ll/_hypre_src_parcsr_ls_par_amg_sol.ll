...
define dso_local i32 @hypre_BoomerAMGSolve(i8* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %3) local_unnamed_addr #0 {
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 744
  %14 = bitcast i8* %13 to i32*
  %15 = load i32, i32* %14, align 8, !tbaa !10
  %16 = getelementptr inbounds i8, i8* %0, i64 712
...
24:                                               ; preds = %20, %4
  ...
  %29 = getelementptr inbounds i8, i8* %0, i64 336
  ...
  %32 = getelementptr inbounds i8, i8* %0, i64 344
  ...
  %59 = getelementptr inbounds i8, i8* %0, i64 448
  %60 = bitcast i8* %59 to i32*
  %61 = load i32, i32* %60, align 8, !tbaa !26
  %62 = getelementptr inbounds i8, i8* %0, i64 424
  ...
  %65 = getelementptr inbounds i8, i8* %0, i64 648
...
139:                                              ; preds = %134, %126
  %140 = getelementptr inbounds i8, i8* %0, i64 672
  ...
  %153 = getelementptr inbounds i8, i8* %0, i64 728
  %154 = bitcast i8* %153 to double*
  %155 = getelementptr inbounds i8, i8* %0, i64 716
  %156 = bitcast i8* %155 to i32*
  %157 = getelementptr inbounds i8, i8* %0, i64 720
...
223:                                              ; preds = %218
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 313, i32 256, i8* null) #4
  br label %224
...
315:                                              ; preds = %306
  %316 = getelementptr inbounds i8, i8* %0, i64 672

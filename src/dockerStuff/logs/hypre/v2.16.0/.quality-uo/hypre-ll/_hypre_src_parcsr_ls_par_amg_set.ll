...
define dso_local i32 @hypre_BoomerAMGSetup(i8* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %3) local_unnamed_addr #0 {
  ...
  %295 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %294, i64 0, i32 3
...
346:                                              ; preds = %343
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 319, i32 1, i8* getelementptr inbounds ([134 x i8], [134 x i8]* @.str.1, i64 0, i64 0)) #7
  br label %347
...
696:                                              ; preds = %690
  ...
  %702 = srem i32 %698, %692
  %703 = load i32, i32* %27, align 4, !tbaa !26
...
1098:                                             ; preds = %967, %2992
  ...
  %1102 = phi i32 [ %403, %967 ], [ %1106, %2992 ]
  %1103 = phi double [ undef, %967 ], [ %2971, %2992 ]
  %1104 = phi double [ 0.000000e+00, %967 ], [ %2962, %2992 ]
  %1105 = icmp slt i64 %1099, %1081
  %1106 = select i1 %1105, i32 %1102, i32 0
...
1120:                                             ; preds = %1119
  ...
  %1131 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %1130, i64 0, i32 4
  ...
  %1145 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %1144, i64 0, i32 4
...
1179:                                             ; preds = %1177, %1176
  %1180 = phi double [ %1178, %1177 ], [ %1103, %1176 ]
...
1199:                                             ; preds = %1198
  ...
  %1204 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %1203, i64 0, i32 5
  br label %1211
...
1205:                                             ; preds = %1198
  ...
  %1210 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1209, i64 0, i32 3
  br label %1211
...
1350:                                             ; preds = %1328
  ...
  %1361 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1360, i64 0, i32 3
...
1653:                                             ; preds = %1652
  ...
  %1657 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1656, i64 0, i32 3
...
2087:                                             ; preds = %2085
  ...
  %2092 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %2091, i64 0, i32 3
...
2142:                                             ; preds = %2128
  ...
  %2147 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %2146, i64 0, i32 3
...
2555:                                             ; preds = %2553
  ...
  %2560 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %2559, i64 0, i32 4
...
2630:                                             ; preds = %2627
  ...
  %2633 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %2632, i64 0, i32 3
  ...
  %2637 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %2632, i64 0, i32 9
...
3026:                                             ; preds = %3024
  ...
  %3037 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %3036, i64 0, i32 4
  ...
  %3051 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %3050, i64 0, i32 4
...
3480:                                             ; preds = %3472
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 2782, i32 1, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.13, i64 0, i64 0)) #7
  br label %3481
...
3525:                                             ; preds = %3515
  ...
  %3529 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3528, i64 0, i32 3
...
3683:                                             ; preds = %3673
  ...
  %3687 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %3686, i64 0, i32 5
  br label %3691

3688:                                             ; preds = %3673
  %3689 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %293, align 8, !tbaa !83
  %3690 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3689, i64 0, i32 3
  br label %3691
...
3710:                                             ; preds = %3705
  ...
  %3715 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %3714, i64 0, i32 5
  br label %3722
...
3716:                                             ; preds = %3705
  ...
  %3721 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3720, i64 0, i32 3
  br label %3722
...
3750:                                             ; preds = %3747
  ...
  %3754 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %3753, i64 0, i32 5
  br label %3758

3755:                                             ; preds = %3747
  %3756 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %293, align 8, !tbaa !83
  %3757 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3756, i64 0, i32 3
  br label %3758
...
!83 = !{!4, !8, i64 32}
!84 = !{!85, !5, i64 24}
!85 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80}
!86 = !{!13, !5, i64 288}
!87 = !{!13, !8, i64 336}
!88 = !{!13, !8, i64 360}
!89 = !{!13, !8, i64 368}
...
!149 = !{!146, !8, i64 32}
!150 = !{!151, !5, i64 32}
!151 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !5, i64 36, !5, i64 40, !5, i64 44, !5, i64 48}

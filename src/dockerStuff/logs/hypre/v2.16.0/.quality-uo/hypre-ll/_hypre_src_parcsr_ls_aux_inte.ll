...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_big_insert_new_nodes(%struct.hypre_ParCSRCommPkg* %0, %struct.hypre_ParCSRCommPkg* %1, i32* nocapture readonly %2, i32 %3, i32 %4, i32* %5) local_unnamed_addr #0 {
  %7 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %0, i64 0, i32 1
  %8 = load i32, i32* %7, align 4, !tbaa !3
  %9 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %0, i64 0, i32 5
  %10 = load i32, i32* %9, align 8, !tbaa !9
  %11 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %0, i64 0, i32 7
  %12 = load i32*, i32** %11, align 8, !tbaa !10
  %13 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %1, i64 0, i32 1
  %14 = load i32, i32* %13, align 4, !tbaa !3
  %15 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %0, i64 0, i32 3
  %16 = load i32*, i32** %15, align 8, !tbaa !11
  %17 = sext i32 %8 to i64
  %18 = getelementptr inbounds i32, i32* %16, i64 %17
  %19 = load i32, i32* %18, align 4, !tbaa !12
  %20 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %1, i64 0, i32 3
...
35:                                               ; preds = %6
  %36 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %0, i64 0, i32 4
...
53:                                               ; preds = %41, %6
  ...
  %55 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %0, i8* %28, i8* %54) #8
...
65:                                               ; preds = %53
  %66 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %1, i64 0, i32 4
...
83:                                               ; preds = %71, %53
  ...
  %87 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct.hypre_ParCSRCommPkg* %1, i8* %28, i8* %86) #8
...
define dso_local i32 @hypre_exchange_interp_data(i32** nocapture %0, i32** nocapture %1, %struct.hypre_CSRMatrix** nocapture %2, i32* nocapture %3, %struct.hypre_CSRMatrix** nocapture %4, %struct.hypre_ParCSRCommPkg** %5, %struct.hypre_ParCSRMatrix_struct* %6, i32* %7, %struct.hypre_ParCSRMatrix_struct* %8, i32 %9, i32* nocapture readonly %10, i32 %11) local_unnamed_addr #0 {
  ...
  %17 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %16, align 8, !tbaa !27
...
278:                                              ; preds = %276
  ...
  %281 = load i8*, i8** %34, align 8, !tbaa !37
  %282 = load i32, i32* %3, align 4, !tbaa !12
  %283 = sext i32 %282 to i64
  %284 = shl nsw i64 %283, 2
  %285 = call i8* @hypre_ReAlloc(i8* %281, i64 %284, i32 1) #8
  %286 = bitcast i8* %285 to i32*
  store i8* %285, i8** %34, align 8, !tbaa !37
  %287 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %5, align 8, !tbaa !37
...
305:                                              ; preds = %305, %301
  ...
  br i1 %315, label %316, label %305, !llvm.loop !26
...
324:                                              ; preds = %321
  ...
  store i8* %326, i8** %327, align 8, !tbaa !37
  br label %328

328:                                              ; preds = %324, %321
  %329 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %5, align 8, !tbaa !37
  %330 = load i32*, i32** %1, align 8, !tbaa !37
...
332:                                              ; preds = %328, %316
  ...
  %333 = load %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %14, align 8, !tbaa !37
...
50:                                               ; preds = %35, %48, %44
  ...
  br i1 %53, label %54, label %35, !llvm.loop !50
...
77:                                               ; preds = %77, %68
  ...
  %81 = icmp eq i32 %80, 0
  %82 = add i64 %78, 1
  br i1 %81, label %77, label %83, !llvm.loop !51
...
83:                                               ; preds = %77
  ...
  br i1 %88, label %73, label %68, !llvm.loop !52
...
93:                                               ; preds = %75, %93
  ...
  br i1 %99, label %89, label %93, !llvm.loop !53
...
109:                                              ; preds = %109, %100
  ...
  %114 = add i64 %110, 1
  br i1 %113, label %109, label %115, !llvm.loop !54
...
115:                                              ; preds = %109
  ...
  br i1 %121, label %105, label %100, !llvm.loop !55
...
122:                                              ; preds = %107, %122
  ...
  br i1 %128, label %129, label %122, !llvm.loop !56
...
187:                                              ; preds = %176, %186
  ...
  br i1 %190, label %176, label %191, !llvm.loop !57

191:                                              ; preds = %187, %173
  %192 = add nuw nsw i64 %174, 1
  %193 = icmp eq i64 %192, %172
  br i1 %193, label %194, label %173, !llvm.loop !58
...
!27 = !{!28, !8, i64 88}
!28 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !5, i64 104, !5, i64 108, !5, i64 112, !5, i64 116, !29, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !8, i64 152}
!29 = !{!"double", !6, i64 0}
!30 = !{!28, !8, i64 32}
!31 = !{!28, !8, i64 40}
!32 = !{!33, !5, i64 28}
!33 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80}
!34 = !{!28, !8, i64 64}
!35 = !{!28, !5, i64 12}
!36 = !{!33, !5, i64 24}
!37 = !{!8, !8, i64 0}
...
!39 = !{!33, !8, i64 16}
!40 = !{!41, !8, i64 8}
!41 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !8, i64 32}

...
define dso_local i32 @hypre_ParCSRMatrixCreateAssumedPartition(%struct.hypre_ParCSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %19 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #3
  ...
  %45 = call i8* @hypre_MAlloc(i64 40, i32 1) #3
  ...
  %50 = shl nsw i64 %49, 2
  %51 = call i8* @hypre_MAlloc(i64 %50, i32 1) #3
  ...
  %56 = shl nsw i64 %55, 2
  %57 = call i8* @hypre_MAlloc(i64 %56, i32 1) #3

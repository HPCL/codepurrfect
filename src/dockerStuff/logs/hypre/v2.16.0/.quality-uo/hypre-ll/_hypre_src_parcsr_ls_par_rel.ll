...
939:                                              ; preds = %913, %936, %910
  ...
  %944 = phi double* [ %925, %936 ], [ %925, %913 ], [ undef, %910 ]
...
1225:                                             ; preds = %1199, %1222, %1196
  ...
  %1230 = phi double* [ %1211, %1222 ], [ %1211, %1199 ], [ undef, %1196 ]
...
1653:                                             ; preds = %1650, %1590
  %1654 = phi i8* [ %1602, %1650 ], [ undef, %1590 ]
...
2054:                                             ; preds = %2051, %1991
  %2055 = phi i8* [ %2003, %2051 ], [ undef, %1991 ]
...
2788:                                             ; preds = %2785, %2725
  %2789 = phi i8* [ %2737, %2785 ], [ undef, %2725 ]
...
3495:                                             ; preds = %3492, %3432
  %3496 = phi i8* [ %3444, %3492 ], [ undef, %3432 ]
...
3896:                                             ; preds = %3893, %3833
  %3897 = phi i8* [ %3845, %3893 ], [ undef, %3833 ]
...
219:                                              ; preds = %216
  call void @hypre_error_handler(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0), i32 4332, i32 1, i8* null) #3
  br label %220

...
; Function Attrs: nofree nosync nounwind uwtable
define dso_local void @hypre_BigQsort1(i32* %0, double* %1, i32 %2, i32 %3) local_unnamed_addr #1 {
  %5 = icmp slt i32 %2, %3
  br i1 %5, label %6, label %51
...
; Function Attrs: nofree nosync nounwind uwtable
define dso_local void @hypre_BigQsort4_abs(double* %0, i32* %1, i32* %2, i32* %3, i32 %4, i32 %5) local_unnamed_addr #1 {
  %7 = icmp slt i32 %4, %5
...
31:                                               ; preds = %16, %26
  ...
  br i1 %33, label %34, label %16, !llvm.loop !19
...
; Function Attrs: nofree nosync nounwind uwtable
define dso_local void @hypre_BigQsortbi(i32* %0, i32* %1, i32 %2, i32 %3) local_unnamed_addr #1 {
  %5 = icmp slt i32 %2, %3
  br i1 %5, label %6, label %51
...
; Function Attrs: nofree nosync nounwind uwtable
define dso_local void @hypre_BigQsortbLoc(i32* %0, i32* %1, i32 %2, i32 %3) local_unnamed_addr #1 {
  %5 = icmp slt i32 %2, %3
...
35:                                               ; preds = %19, %27
  ...
  br i1 %37, label %38, label %19, !llvm.loop !21
...
; Function Attrs: nofree nosync nounwind uwtable
define dso_local void @hypre_BigQsortb2i(i32* %0, i32* %1, i32* %2, i32 %3, i32 %4) local_unnamed_addr #1 {
  %6 = icmp slt i32 %3, %4
  br i1 %6, label %7, label %63
...
47:                                               ; preds = %26, %34
  %48 = phi i32 [ %35, %34 ], [ %28, %26 ]
  %49 = icmp eq i64 %29, %25
  br i1 %49, label %50, label %26, !llvm.loop !22
...
; Function Attrs: nofree nosync nounwind uwtable
define dso_local void @hypre_BigQsort0(i32* %0, i32 %1, i32 %2) local_unnamed_addr #1 {
  %4 = icmp slt i32 %1, %2
  br i1 %4, label %5, label %39
...
29:                                               ; preds = %16, %24
  %30 = phi i32 [ %25, %24 ], [ %18, %16 ]
  %31 = icmp eq i64 %19, %15
  br i1 %31, label %32, label %16, !llvm.loop !23

...
define dso_local void @iluk_mpi_bj(%struct._mpi_interface_dh* %0) local_unnamed_addr #0 {
  ...
  %13 = load %struct._factor_dh*, %struct._factor_dh** %12, align 8, !tbaa !12
  %14 = getelementptr inbounds %struct._mpi_interface_dh, %struct._mpi_interface_dh* %0, i64 0, i32 8
  %15 = load %struct._subdomain_dh*, %struct._subdomain_dh** %14, align 8, !tbaa !13
...
23:                                               ; preds = %18
  ...
  %40 = load %struct._mem_dh*, %struct._mem_dh** @mem_dh, align 8, !tbaa !25
  %41 = add nsw i32 %25, 1
  %42 = sext i32 %41 to i64
  %43 = shl nsw i64 %42, 2
  %44 = call i8* @Mem_dhMalloc(%struct._mem_dh* %40, i64 %43) #4
  %45 = bitcast i8* %44 to i32*
  %46 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
  %47 = icmp eq i8 %46, 0
...
49:                                               ; preds = %23
  %50 = load %struct._mem_dh*, %struct._mem_dh** @mem_dh, align 8, !tbaa !25
  %51 = sext i32 %25 to i64
  %52 = shl nsw i64 %51, 2
  %53 = call i8* @Mem_dhMalloc(%struct._mem_dh* %50, i64 %52) #4
  %54 = bitcast i8* %53 to i32*
  %55 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
  %56 = icmp eq i8 %55, 0
...
58:                                               ; preds = %49
  %59 = load %struct._mem_dh*, %struct._mem_dh** @mem_dh, align 8, !tbaa !25
  %60 = call i8* @Mem_dhMalloc(%struct._mem_dh* %59, i64 %52) #4
  %61 = bitcast i8* %60 to i32*
  %62 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
  %63 = icmp eq i8 %62, 0
...
94:                                               ; preds = %218
  ...
  br i1 %95, label %225, label %96, !llvm.loop !35
...
109:                                              ; preds = %96
  %110 = load i8, i8* %88, align 8, !tbaa !37, !range !27
  %111 = icmp eq i8 %110, 0
  br i1 %111, label %119, label %112

112:                                              ; preds = %109
  %113 = load i32, i32* %3, align 4, !tbaa !28
  %114 = load double*, double** %4, align 8, !tbaa !25
  %115 = trunc i64 %97 to i32
  call void @compute_scaling_private(i32 %115, i32 %113, double* %114, %struct._mpi_interface_dh* %0) #4
  %116 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
...
119:                                              ; preds = %112, %109
  %120 = load i32, i32* %3, align 4, !tbaa !28
  %121 = load i32*, i32** %2, align 8, !tbaa !25
  %122 = load double*, double** %4, align 8, !tbaa !25
  ...
  %125 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
...
128:                                              ; preds = %119
  ...
  %130 = load i32, i32* %89, align 8, !tbaa !38
  %131 = icmp sgt i32 %129, %130
  br i1 %131, label %132, label %140

132:                                              ; preds = %128
  call void @Factor_dhReallocate(%struct._factor_dh* nonnull %13, i32 %100, i32 %124) #4
  %133 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
...
136:                                              ; preds = %132
  ...
  %137 = load i32*, i32** %26, align 8, !tbaa !17
  %138 = load i32*, i32** %28, align 8, !tbaa !18
  %139 = load double*, double** %32, align 8, !tbaa !20
  br label %140
...
147:                                              ; preds = %145, %147
  ...
  store i32 %157, i32* %158, align 4, !tbaa !28
  %159 = add nsw i64 %148, 1
  %160 = icmp eq i32 %153, 0
  br i1 %160, label %161, label %147, !llvm.loop !39
...
163:                                              ; preds = %161, %140
  ...
  store i32 %164, i32* %166, align 4, !tbaa !28
...
171:                                              ; preds = %171, %163
  ...
  %176 = add i64 %172, 1
  br i1 %175, label %177, label %171, !llvm.loop !40

177:                                              ; preds = %171
  %178 = trunc i64 %172 to i32
  %179 = getelementptr inbounds i32, i32* %31, i64 %97
  store i32 %178, i32* %179, align 4, !tbaa !28
  %180 = load i32, i32* %3, align 4, !tbaa !28
  %181 = load i32*, i32** %2, align 8, !tbaa !25
  %182 = load double*, double** %4, align 8, !tbaa !25
  ...
  %184 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
...
192:                                              ; preds = %187
  %193 = load i32, i32* %167, align 4, !tbaa !28
  %194 = load i32, i32* %166, align 4, !tbaa !28
...
199:                                              ; preds = %196, %199
  ...
  %205 = load double, double* %204, align 8, !tbaa !29
  %206 = getelementptr inbounds double, double* %142, i64 %200
  store double %205, double* %206, align 8, !tbaa !29
  store double 0.000000e+00, double* %204, align 8, !tbaa !29
  %207 = add nsw i64 %200, 1
  %208 = icmp eq i64 %207, %198
  br i1 %208, label %209, label %199, !llvm.loop !41

209:                                              ; preds = %199, %192
  %210 = load i32, i32* %179, align 4, !tbaa !28
  %211 = sext i32 %210 to i64
  %212 = getelementptr inbounds double, double* %142, i64 %211
  %213 = load double, double* %212, align 8, !tbaa !29
...
225:                                              ; preds = %94, %75
  %226 = load %struct._mem_dh*, %struct._mem_dh** @mem_dh, align 8, !tbaa !25
  call void @Mem_dhFree(%struct._mem_dh* %226, i8* %44) #4
  %227 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
...
230:                                              ; preds = %225
  %231 = load %struct._mem_dh*, %struct._mem_dh** @mem_dh, align 8, !tbaa !25
  call void @Mem_dhFree(%struct._mem_dh* %231, i8* %60) #4
  %232 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
...
235:                                              ; preds = %230
  %236 = load %struct._mem_dh*, %struct._mem_dh** @mem_dh, align 8, !tbaa !25
  call void @Mem_dhFree(%struct._mem_dh* %236, i8* %53) #4
  %237 = load i8, i8* @errFlag_dh, align 1, !tbaa !26, !range !27
...
define dso_local i32 @symbolic_row_private(i32 %0, i32 %1, i32 %2, i32* nocapture %3, i32* nocapture %4, i32* nocapture %5, i32 %6, i32* nocapture readonly %7, double* nocapture readonly %8, i32* nocapture readonly %9, %struct._mpi_interface_dh* nocapture %10) local_unnamed_addr #0 {
  ...
  %15 = load %struct._factor_dh*, %struct._factor_dh** %14, align 8, !tbaa !12
  ...
  %29 = load double*, double** %28, align 8, !tbaa !44
  ...
  store double %36, double* %34, align 8, !tbaa !29
  %37 = sext i32 %17 to i64
  %38 = getelementptr inbounds i32, i32* %3, i64 %37
  store i32 %17, i32* %38, align 4, !tbaa !28
  %39 = icmp sgt i32 %6, 0
...
40:                                               ; preds = %11, %77
  ...
  %46 = load i32, i32* %41, align 4, !tbaa !28
...
51:                                               ; preds = %40
  %52 = load double, double* %42, align 8, !tbaa !29
...
64:                                               ; preds = %51, %64
  ...
  br i1 %69, label %64, label %70, !llvm.loop !45
...
70:                                               ; preds = %64
  ...
  store i32 %57, i32* %72, align 4, !tbaa !28
  %75 = getelementptr inbounds i32, i32* %5, i64 %73
  store i32 0, i32* %75, align 4, !tbaa !28
...
77:                                               ; preds = %51, %40, %70
  ...
  %80 = icmp eq i32 %79, %6
  br i1 %80, label %81, label %40, !llvm.loop !46
...
86:                                               ; preds = %81, %86
  ...
  br i1 %91, label %86, label %92, !llvm.loop !47

92:                                               ; preds = %86
  %93 = getelementptr inbounds i32, i32* %3, i64 %88
  %94 = getelementptr inbounds i32, i32* %3, i64 %30
  store i32 %90, i32* %94, align 4, !tbaa !28
  store i32 %0, i32* %93, align 4, !tbaa !28
  %95 = getelementptr inbounds i32, i32* %5, i64 %30
  store i32 0, i32* %95, align 4, !tbaa !28
...
97:                                               ; preds = %92, %81
  ...
  %101 = load double, double* %100, align 8, !tbaa !29
  %102 = fadd double %101, %99
  store double %102, double* %100, align 8, !tbaa !29
...
118:                                              ; preds = %109
  ...
  %125 = load i32, i32* %123, align 4, !tbaa !28
...
140:                                              ; preds = %130
  ...
  %143 = load i32, i32* %142, align 4, !tbaa !28
  %144 = icmp slt i32 %143, %0
  br i1 %144, label %145, label %157

145:                                              ; preds = %140
  store i32 %0, i32* %142, align 4, !tbaa !28
  %146 = getelementptr inbounds i32, i32* %5, i64 %141
  store i32 %138, i32* %146, align 4, !tbaa !28
  br label %147
...
147:                                              ; preds = %147, %145
  ...
  br i1 %152, label %147, label %153, !llvm.loop !48

153:                                              ; preds = %147
  %154 = getelementptr inbounds i32, i32* %3, i64 %149
  %155 = getelementptr inbounds i32, i32* %3, i64 %141
  store i32 %151, i32* %155, align 4, !tbaa !28
  store i32 %134, i32* %154, align 4, !tbaa !28
...
define internal fastcc void @numeric_row_private(i32 %0, i32 %1, i32 %2, i32 %3, i32* nocapture readonly %4, double* nocapture readonly %5, double* nocapture %6, i32* nocapture readonly %7, %struct._mpi_interface_dh* nocapture readonly %8) unnamed_addr #0 {
  ...
  %11 = load %struct._factor_dh*, %struct._factor_dh** %10, align 8, !tbaa !12
  ...
  %21 = load double*, double** %20, align 8, !tbaa !44
...
37:                                               ; preds = %32, %37
  ...
  store double 0.000000e+00, double* %42, align 8, !tbaa !29
  %43 = add nsw i64 %38, 1
...
52:                                               ; preds = %35, %71
  ...
  %57 = load i32, i32* %53, align 4, !tbaa !28
...
62:                                               ; preds = %52
  %63 = load double, double* %54, align 8, !tbaa !29
  %64 = sub nsw i32 %57, %1
  ...
  store double %68, double* %70, align 8, !tbaa !29
  br label %71

71:                                               ; preds = %52, %62
  %72 = add nuw nsw i32 %55, 1
  %73 = icmp eq i32 %72, %3
  br i1 %73, label %45, label %52, !llvm.loop !52
...
82:                                               ; preds = %74
  ...
  %87 = load double, double* %86, align 8, !tbaa !29
  %88 = fdiv double %80, %87
  store double %88, double* %79, align 8, !tbaa !29
  %89 = add nsw i32 %77, 1
...
98:                                               ; preds = %95, %98
  ...
  store double %108, double* %106, align 8, !tbaa !29
  %109 = add nsw i64 %99, 1
  %110 = trunc i64 %109 to i32
  %111 = icmp eq i32 %92, %110
  br i1 %111, label %112, label %98, !llvm.loop !53

112:                                              ; preds = %98, %82, %74
  %113 = add nsw i64 %75, 1
  %114 = icmp eq i64 %113, %51
  br i1 %114, label %115, label %74, !llvm.loop !54
...
!13 = !{!4, !10, i64 56}
!14 = !{!15, !10, i64 32}
!15 = !{!"_factor_dh", !9, i64 0, !9, i64 4, !9, i64 8, !9, i64 12, !9, i64 16, !9, i64 20, !5, i64 24, !10, i64 32, !10, i64 40, !10, i64 48, !10, i64 56, !10, i64 64, !9, i64 72, !9, i64 76, !9, i64 80, !9, i64 84, !9, i64 88, !10, i64 96, !10, i64 104, !10, i64 112, !10, i64 120, !10, i64 128, !10, i64 136, !9, i64 144, !9, i64 148, !5, i64 152, !10, i64 160, !6, i64 168, !6, i64 200168, !6, i64 400168, !6, i64 600168, !6, i64 800168, !6, i64 1000168, !5, i64 2000168}
!16 = !{!15, !9, i64 0}
!17 = !{!15, !10, i64 40}
!18 = !{!15, !10, i64 56}
!19 = !{!15, !10, i64 64}
...
!21 = !{!4, !10, i64 80}
!22 = !{!23, !10, i64 136}
!23 = !{!"_subdomain_dh", !9, i64 0, !10, i64 8, !10, i64 16, !10, i64 24, !10, i64 32, !9, i64 40, !5, i64 44, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !10, i64 88, !9, i64 96, !10, i64 104, !9, i64 112, !10, i64 120, !9, i64 128, !9, i64 132, !10, i64 136, !10, i64 144, !10, i64 152, !10, i64 160, !6, i64 168, !5, i64 248}
!24 = !{!23, !10, i64 144}
!25 = !{!10, !10, i64 0}
!26 = !{!5, !5, i64 0}
!27 = !{i8 0, i8 2}

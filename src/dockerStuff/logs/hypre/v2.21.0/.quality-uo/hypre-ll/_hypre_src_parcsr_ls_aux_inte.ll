...
278:                                              ; preds = %276
  ...
  %288 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 15
  %289 = load i32*, i32** %288, align 8, !tbaa !52
  %290 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %6, i64 0, i32 26
  %291 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %290, align 8, !tbaa !53
  %292 = call i32 @hypre_ParCSRFindExtendCommPkg(i32 %281, i32 %283, i32 %285, i32 %287, i32* %289, %struct.hypre_IJAssumedPart* %291, i32 %203, i32* %99, %struct._hypre_ParCSRCommPkg** %5) #9
  %293 = load i8*, i8** %34, align 8, !tbaa !37
  %294 = load i32, i32* %3, align 4, !tbaa !12
  %295 = sext i32 %294 to i64
  %296 = shl nsw i64 %295, 2
  %297 = call i8* @hypre_ReAlloc(i8* %293, i64 %296, i32 0) #9
...
328:                                              ; preds = %317, %278
  ...
  %330 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %299, i8* %310, i8* %329) #9
  %331 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %330) #9
  call void @hypre_Free(i8* %310, i32 0) #9
...
336:                                              ; preds = %333
  ...
  %338 = call i8* @hypre_CAlloc(i64 %337, i64 4, i32 0) #9
...
344:                                              ; preds = %340, %328
  ...
  %348 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %345) #9
  call void @hypre_Free(i8* %347, i32 0) #9
  br label %349
...
55:                                               ; preds = %45, %53
  ...
  br i1 %57, label %58, label %45, !llvm.loop !55
...
106:                                              ; preds = %94, %99
  ...
  br i1 %110, label %94, label %111, !llvm.loop !57
...
120:                                              ; preds = %118, %204
  ...
  %134 = lshr i32 %133, 16
  %135 = xor i32 %134, %133
  %136 = load volatile %struct.hypre_BigHopscotchBucket*, %struct.hypre_BigHopscotchBucket** %115, align 8, !tbaa !58
  %137 = load volatile i32, i32* %116, align 4, !tbaa !60
  %138 = and i32 %135, %137
  %139 = sext i32 %138 to i64
  ...
  %142 = load volatile i32, i32* %141, align 4, !tbaa !61
...
143:                                              ; preds = %120
  ...
  %145 = load volatile i32, i32* %144, align 4, !tbaa !63
...
147:                                              ; preds = %143
  ...
  %149 = load volatile i32, i32* %148, align 4, !tbaa !64
...
157:                                              ; preds = %153
  %158 = call i32 @llvm.cttz.i32(i32 %154, i1 true) #9, !range !65
  ...
  %162 = load volatile i32, i32* %161, align 4, !tbaa !63
...
164:                                              ; preds = %157
  ...
  %166 = load volatile i32, i32* %165, align 4, !tbaa !64
...
168:                                              ; preds = %164
  ...
  %170 = load volatile i32, i32* %169, align 4, !tbaa !66
  br label %175
...
175:                                              ; preds = %171, %168
  ...
  br i1 %176, label %153, label %204, !llvm.loop !67

179:                                              ; preds = %153
  %180 = load volatile %struct.hypre_BigHopscotchBucket*, %struct.hypre_BigHopscotchBucket** %115, align 8, !tbaa !58
  %181 = load volatile i32, i32* %116, align 4, !tbaa !60
  %182 = and i32 %181, %135
...
185:                                              ; preds = %197, %179
  ...
  %189 = load volatile i32, i32* %188, align 4, !tbaa !63
...
191:                                              ; preds = %185
  ...
  %193 = load volatile i32, i32* %192, align 4, !tbaa !64
...
197:                                              ; preds = %191, %185
  ...
  br i1 %200, label %204, label %185, !llvm.loop !68

201:                                              ; preds = %195, %151
  %202 = phi i32* [ %152, %151 ], [ %196, %195 ]
  %203 = load volatile i32, i32* %202, align 4, !tbaa !66
  br label %204
...
204:                                              ; preds = %175, %197, %201, %120, %143, %147
  ...
  br i1 %208, label %209, label %120, !llvm.loop !69
...
217:                                              ; preds = %215, %217
  ...
  br i1 %225, label %226, label %217, !llvm.loop !70
...
!27 = !{!28, !8, i64 96}
!28 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !5, i64 112, !5, i64 116, !5, i64 120, !5, i64 124, !29, i64 128, !8, i64 136, !8, i64 144, !5, i64 152, !8, i64 160, !5, i64 168, !8, i64 176, !5, i64 184, !8, i64 192, !8, i64 200}
!29 = !{!"double", !6, i64 0}
!30 = !{!28, !8, i64 32}
!31 = !{!28, !8, i64 40}
!32 = !{!33, !5, i64 28}

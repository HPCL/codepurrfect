...
define dso_local i32 @hypre_ZeroAMRVectorData(%struct.hypre_SStructVector_struct* %0, i32* nocapture readonly %1, [3 x i32]* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %27 = call i8* @hypre_CAlloc(i64 %26, i64 4, i32 0) #4
  %28 = bitcast i8* %27 to i32*
  %29 = call i8* @hypre_CAlloc(i64 %26, i64 12, i32 0) #4
...
180:                                              ; preds = %175
  ...
  %182 = call i8* @hypre_CAlloc(i64 %181, i64 8, i32 0) #4
  ...
  call void @hypre_Free(i8* %182, i32 0) #4
  br label %186
...
139:                                              ; preds = %133
  ...
  %141 = call i8* @hypre_CAlloc(i64 %140, i64 8, i32 0) #4
  %142 = shl nsw i64 %140, 3
  %143 = call i8* @hypre_MAlloc(i64 %142, i32 0) #4
...
173:                                              ; preds = %153, %146
  call void @hypre_Free(i8* %141, i32 0) #4
  call void @hypre_Free(i8* %143, i32 0) #4
  br label %174
...
!35 = !{!36, !8, i64 8}
!36 = !{!"hypre_SStructMatrix_struct", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !5, i64 64, !8, i64 72, !8, i64 80, !5, i64 88, !8, i64 96, !8, i64 104, !8, i64 112, !8, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !5, i64 148, !5, i64 152, !5, i64 156}
!37 = !{!38, !8, i64 8}

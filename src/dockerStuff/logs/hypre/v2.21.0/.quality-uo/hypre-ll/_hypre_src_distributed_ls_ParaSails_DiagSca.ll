...
define dso_local %struct.DiagScale* @DiagScaleCreate(%struct.Matrix* %0, %struct.numbering* %1) local_unnamed_addr #0 {
  ...
  %14 = call i8* @hypre_MAlloc(i64 24, i32 0) #6
  ...
  %22 = shl nsw i64 %21, 3
  %23 = call i8* @hypre_MAlloc(i64 %22, i32 0) #6
...
30:                                               ; preds = %2, %63
  ...
  call void @MatrixGetRow(%struct.Matrix* %0, i32 %32, i32* nonnull %7, i32** nonnull %8, double** nonnull %9) #6
...
79:                                               ; preds = %70
  ...
  %92 = shl nsw i64 %91, 2
  call void @hypre_Memcpy(i8* %82, i8* %89, i64 %92, i32 0, i32 0) #6
  %93 = load i32, i32* %7, align 4, !tbaa !14
  %94 = sext i32 %93 to i64
  %95 = shl nsw i64 %94, 3
  %96 = call i8* @hypre_MAlloc(i64 %95, i32 0) #6
...
98:                                               ; preds = %79, %70
  ...
  %101 = call i32 @hypre_MPI_Comm_size(i32 %100, i32* nonnull %6) #6
  ...
  call void @hypre_shell_sort(i32 %117, i32* %118) #6
...
127:                                              ; preds = %168, %125
  ...
  %133 = call i32 @MatrixRowPe(%struct.Matrix* %0, i32 %132) #6
  %134 = sext i32 %133 to i64
  %135 = add nsw i64 %130, 1
  %136 = call i64 @llvm.smax.i64(i64 %135, i64 %126) #6
...
154:                                              ; preds = %149, %142, %138
  ...
  %161 = call i32 @hypre_MPI_Irecv(i8* %158, i32 %159, i32 1275070475, i32 %133, i32 225, i32 %116, i32* %160) #6
  %162 = bitcast i32* %131 to i8*
  %163 = call i32 @hypre_MPI_Isend(i8* nonnull %162, i32 %159, i32 1275069445, i32 %133, i32 226, i32 %116, i32* nonnull %5) #6
  %164 = call i32 @hypre_MPI_Request_free(i32* nonnull %5) #6
...
172:                                              ; preds = %170, %98
  ...
  %175 = call i32 @FindNumReplies(i32 %174, i32* %115) #6
  call void @hypre_Free(i8* %114, i32 0) #6
  %176 = call %struct.Mem* (...) @MemCreate() #6
...
178:                                              ; preds = %172
  ...
  %181 = call i8* @hypre_MAlloc(i64 %180, i32 0) #6
...
183:                                              ; preds = %178, %172
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %187) #6
...
193:                                              ; preds = %225, %191
  ...
  %195 = call i32 @hypre_MPI_Probe(i32 -2, i32 226, i32 %185, %struct.MPI_Status* nonnull %3) #6
  %196 = load i32, i32* %189, align 4, !tbaa !30
  %197 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %3, i32 1275069445, i32* nonnull %4) #6
  %198 = load i32, i32* %4, align 4, !tbaa !14
  %199 = shl i32 %198, 2
  %200 = call i8* @MemAlloc(%struct.Mem* %176, i32 %199) #6
  %201 = bitcast i8* %200 to i32*
  %202 = load i32, i32* %4, align 4, !tbaa !14
  %203 = shl i32 %202, 3
  %204 = call i8* @MemAlloc(%struct.Mem* %176, i32 %203) #6
  %205 = bitcast i8* %204 to double*
  %206 = load i32, i32* %4, align 4, !tbaa !14
  %207 = call i32 @hypre_MPI_Recv(i8* %200, i32 %206, i32 1275069445, i32 %196, i32 226, i32 %185, %struct.MPI_Status* nonnull %3) #6
...
225:                                              ; preds = %214, %193
  ...
  %227 = call i32 @hypre_MPI_Irsend(i8* %204, i32 %209, i32 1275070475, i32 %208, i32 225, i32 %185, i32* %226) #6
...
230:                                              ; preds = %225, %183
  ...
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %187) #6
  %231 = call i32 @hypre_MPI_Waitall(i32 %173, i32* %106, %struct.MPI_Status* %111) #6
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %1, i32 %237, i32* %238, i32* %238) #6
...
241:                                              ; preds = %230
  ...
  %244 = call i8* @hypre_MAlloc(i64 %243, i32 0) #6
...
266:                                              ; preds = %255, %246
  ...
  call void @hypre_Free(i8* %269, i32 0) #6
  store i32* null, i32** %8, align 8, !tbaa !15
  ...
  %272 = call i32 @hypre_MPI_Waitall(i32 %175, i32* %184, %struct.MPI_Status* %111) #6
  %273 = bitcast i32* %184 to i8*
  call void @hypre_Free(i8* %273, i32 0) #6
  call void @MemDestroy(%struct.Mem* %176) #6
...
; Function Attrs: nounwind uwtable
define dso_local void @DiagScaleDestroy(%struct.DiagScale* %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.DiagScale, %struct.DiagScale* %0, i64 0, i32 1
  %3 = bitcast double** %2 to i8**
  %4 = load i8*, i8** %3, align 8, !tbaa !10
  call void @hypre_Free(i8* %4, i32 0) #6
  store double* null, double** %2, align 8, !tbaa !10
...
define dso_local double @DiagScaleGet(%struct.DiagScale* nocapture readonly %0, i32 %1) local_unnamed_addr #4 {

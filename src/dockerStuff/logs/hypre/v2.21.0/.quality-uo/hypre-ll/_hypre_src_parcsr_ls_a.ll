...
23:                                               ; preds = %16, %8
  ...
  %34 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %33, i64 0, i32 8
  %35 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %34, align 8, !tbaa !33
  %36 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %35, i64 0, i32 4
  %37 = load i32, i32* %36, align 4, !tbaa !35
  %38 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %35, i64 0, i32 3
  %39 = load i32, i32* %38, align 8, !tbaa !37
  %40 = sext i32 %39 to i64
  %41 = shl nsw i64 %40, 2
  %42 = call i8* @hypre_MAlloc(i64 %41, i32 0) #6
...
48:                                               ; preds = %45, %23
  ...
  %51 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %50, i64 0, i32 8
  ...
  %57 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %52, i64 0, i32 9
  %58 = load double*, double** %57, align 8, !tbaa !41
  %59 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %50, i64 0, i32 9
  ...
  %63 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %60, i64 0, i32 9
...
123:                                              ; preds = %121, %48
  ...
  %127 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %126, i64 0, i32 9
  %128 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %127, align 8, !tbaa !42
  %129 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %128, i64 0, i32 4
  %130 = load i32, i32* %129, align 4, !tbaa !35
  %131 = sext i32 %130 to i64
  %132 = call i8* @hypre_CAlloc(i64 %131, i64 4, i32 0) #6
  ...
  %137 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %136, i64 0, i32 16
  %138 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %137, align 8, !tbaa !50
  %139 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %138, i64 0, i32 1
  %140 = load i32, i32* %139, align 4, !tbaa !51
  %141 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %138, i64 0, i32 3
  ...
  %149 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %138, i64 0, i32 4
...
186:                                              ; preds = %156, %123
  %187 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %138, i8* %147, i8* %132) #6
  ...
  %198 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %189, i64 0, i32 9
  ...
  %204 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %199, i64 0, i32 9
...
299:                                              ; preds = %297, %186
  ...
  %306 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %305, i64 0, i32 16
  %307 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %306, align 8, !tbaa !50
  %308 = icmp eq %struct._hypre_ParCSRCommPkg* %307, null
...
311:                                              ; preds = %309, %299
  ...
  %316 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %315, align 8, !tbaa !50
...
320:                                              ; preds = %318, %311
  ...
  %382 = call i8* @hypre_CAlloc(i64 1, i64 200, i32 0) #6
...
!50 = !{!34, !5, i64 96}
!51 = !{!52, !8, i64 4}
!52 = !{!"_hypre_ParCSRCommPkg", !8, i64 0, !8, i64 4, !5, i64 8, !5, i64 16, !5, i64 24, !5, i64 32, !8, i64 40, !5, i64 48, !5, i64 56, !5, i64 64, !5, i64 72}
!53 = !{!52, !5, i64 16}
...
!64 = !{!34, !8, i64 0}
!65 = !{!66, !5, i64 16}
!66 = !{!"", !8, i64 0, !5, i64 8, !5, i64 16, !8, i64 24, !8, i64 28, !5, i64 32}
!67 = !{!68, !5, i64 32}
!68 = !{!"hypre_ParVector_struct", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !5, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 44, !5, i64 48}
!69 = !{!70, !5, i64 0}
!70 = !{!"", !5, i64 0, !8, i64 8, !8, i64 12, !6, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !8, i64 32}

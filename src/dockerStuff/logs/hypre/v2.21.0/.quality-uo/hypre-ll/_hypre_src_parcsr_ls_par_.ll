...
define dso_local i32 @hypre_BoomerAMGCoarsenCR(%struct.hypre_ParCSRMatrix_struct* %0, i32** nocapture %1, i32* nocapture %2, i32 %3, i32 %4, i32 %5, i32 %6, double %7, double %8, double %9, %struct.hypre_Solver_struct* %10, %struct.hypre_ParCSRMatrix_struct* %11, i32 %12, %struct.hypre_ParCSRMatrix_struct* %13) local_unnamed_addr #0 {
  ...
  %55 = call i32 @hypre_MPI_Comm_size(i32 %25, i32* nonnull %18) #10
  %56 = call i32 @hypre_MPI_Comm_rank(i32 %25, i32* nonnull %19) #10
...
59:                                               ; preds = %14
  ...
  %61 = call i8* @hypre_CAlloc(i64 %60, i64 4, i32 0) #10
  %62 = icmp sgt i32 %45, 0
  br i1 %62, label %69, label %75

63:                                               ; preds = %14
  %64 = sext i32 %50 to i64
  %65 = call i8* @hypre_CAlloc(i64 %64, i64 4, i32 0) #10
  %66 = call i8* @hypre_CAlloc(i64 %64, i64 8, i32 0) #10
...
81:                                               ; preds = %75
  ...
  %83 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %82, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0)) #10
  br label %84

84:                                               ; preds = %81, %75
  %85 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  %86 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %85) #10
  %87 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %85, i32 0) #10
  %88 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  ...
  %91 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  %92 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %91) #10
  %93 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %91, i32 0) #10
  %94 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  %95 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %94) #10
  %96 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %94, i32 0) #10
  ...
  %101 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  %102 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %101) #10
  %103 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %101, i32 0) #10
  ...
  %108 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  %109 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %108) #10
  %110 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %108, i32 0) #10
  %111 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  %112 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %111) #10
  %113 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %111, i32 0) #10
  ...
  %118 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #10
  %119 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %118) #10
  %120 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %118, i32 0) #10
...
135:                                              ; preds = %84
  ...
  %137 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %136, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0)) #10
  %138 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !15
  %139 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %138, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.3, i64 0, i64 0)) #10
  br label %140
...
144:                                              ; preds = %195, %140
  ...
  %167 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %11, i64 0, i32 8
  %168 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %11, i64 0, i32 9
...
275:                                              ; preds = %271, %248
  %276 = call i32 @hypre_SchwarzCFSolve(i8* nonnull %151, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %94, %struct.hypre_ParVector_struct* %88, i32* %78, i32 -1) #10
...
299:                                              ; preds = %296, %286
  %300 = call i32 @hypre_BoomerAMGRelax(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %94, i32* %78, i32 %6, i32 -1, double %7, double %8, double* null, %struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %85, %struct.hypre_ParVector_struct* null) #10
...
315:                                              ; preds = %312, %299
  %316 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %85, %struct.hypre_ParVector_struct* %85) #10
  %317 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %88) #10
  %318 = call double @sqrt(double %317) #10
  %319 = call double @sqrt(double %316) #10
...
355:                                              ; preds = %352, %343
  %356 = call i32 @hypre_ParVectorSetConstantValues(%struct.hypre_ParVector_struct* %118, double 0.000000e+00) #10
  %357 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %88) #10
...
365:                                              ; preds = %361
  %366 = call i32 @hypre_ParCSRMatrixMatvec_FF(double -1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %85, double 0.000000e+00, %struct.hypre_ParVector_struct* %118, i32* %78, i32 -1) #10
  br label %367

367:                                              ; preds = %365, %361
  %368 = call i32 @HYPRE_ParCSRDiagScale(%struct.hypre_Solver_struct* null, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %118, %struct.hypre_ParVector_struct* %111) #10
  %369 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %118, %struct.hypre_ParVector_struct* %111) #10
  br i1 %364, label %370, label %372

370:                                              ; preds = %367
  %371 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %111, %struct.hypre_ParVector_struct* %101) #10
  br label %389
...
389:                                              ; preds = %386, %372, %370
  %390 = call i32 @hypre_ParCSRMatrixMatvec_FF(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %101, double 0.000000e+00, %struct.hypre_ParVector_struct* %108, i32* %78, i32 -1) #10
  %391 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %101, %struct.hypre_ParVector_struct* %108) #10
  %392 = fneg double %369
  %393 = fdiv double %392, %391
  %394 = call i32 @hypre_ParVectorAxpy(double %393, %struct.hypre_ParVector_struct* %108, %struct.hypre_ParVector_struct* %118) #10
...
407:                                              ; preds = %404, %389
  %408 = call i32 @hypre_ParVectorAxpy(double %393, %struct.hypre_ParVector_struct* %101, %struct.hypre_ParVector_struct* %88) #10
  %409 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %88) #10
...
473:                                              ; preds = %470, %435, %438, %426
  %474 = call i32 @hypre_MPI_Allreduce(i8* nonnull %53, i8* nonnull %54, i32 1, i32 1275070475, i32 1476395009, i32 %25) #10
...
507:                                              ; preds = %506
  ...
  %509 = call i32 @hypre_MPI_Comm_size(i32 %508, i32* nonnull %17) #10
  %510 = call i32 @hypre_BoomerAMGIndepRS(%struct.hypre_ParCSRMatrix_struct* %13, i32 2, i32 0, i32* %78) #10
  %511 = load i32, i32* %17, align 4, !tbaa !16
  %512 = icmp sgt i32 %511, 1
  br i1 %512, label %513, label %515

513:                                              ; preds = %507
  %514 = call i32 @hypre_BoomerAMGIndepPMIS(%struct.hypre_ParCSRMatrix_struct* %13, i32 0, i32 0, i32* %78) #10
  br label %515
...
516:                                              ; preds = %506
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %173) #10
  %517 = load i32, i32* %24, align 8, !tbaa !55
  %518 = call i32 @hypre_MPI_Comm_size(i32 %517, i32* nonnull %16) #10
  %519 = call i32 @hypre_BoomerAMGIndepRSa(%struct.hypre_ParCSRMatrix_struct* %0, i32 2, i32 0, i32* %78) #10
  %520 = load i32, i32* %16, align 4, !tbaa !16
  %521 = icmp sgt i32 %520, 1
  br i1 %521, label %522, label %524

522:                                              ; preds = %516
  %523 = call i32 @hypre_BoomerAMGIndepPMISa(%struct.hypre_ParCSRMatrix_struct* %0, i32 0, i32 0, i32* %78) #10
  br label %524

524:                                              ; preds = %516, %522
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %173) #10
  br label %591
...
574:                                              ; preds = %573
  ...
  %576 = call i32 @hypre_MPI_Comm_size(i32 %575, i32* nonnull %15) #10
  %577 = call i32 @hypre_BoomerAMGIndepRS(%struct.hypre_ParCSRMatrix_struct* %11, i32 2, i32 0, i32* %78) #10
  %578 = load i32, i32* %15, align 4, !tbaa !16
  %579 = icmp sgt i32 %578, 1
  br i1 %579, label %580, label %582

580:                                              ; preds = %574
  %581 = call i32 @hypre_BoomerAMGIndepPMIS(%struct.hypre_ParCSRMatrix_struct* %11, i32 0, i32 0, i32* %78) #10
  br label %582
...
594:                                              ; preds = %591
  ...
  %599 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %595, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i64 0, i64 0), i32 %201, double %327, double %598) #10
  br label %600
...
650:                                              ; preds = %646, %621, %601, %602
  ...
  %652 = call i32 @hypre_MPI_Allreduce(i8* nonnull %51, i8* nonnull %52, i32 1, i32 1275069445, i32 1476395009, i32 %25) #10
...
656:                                              ; preds = %653
  ...
  %662 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %657, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i64 0, i64 0), i32 %201, double %327, double %661) #10
  br label %663

663:                                              ; preds = %653, %656
  %664 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %85) #10
  %665 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %88) #10
  %666 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %91) #10
  %667 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %94) #10
  %668 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %101) #10
  %669 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %108) #10
  %670 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %118) #10
  %671 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %111) #10
...
674:                                              ; preds = %663
  ...
  %676 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %675, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0)) #10
  br label %677
...
691:                                              ; preds = %681, %677
  ...
  call void @hypre_Free(i8* %694, i32 0) #10
...
!173 = !{!174, !8, i64 0}
!174 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}

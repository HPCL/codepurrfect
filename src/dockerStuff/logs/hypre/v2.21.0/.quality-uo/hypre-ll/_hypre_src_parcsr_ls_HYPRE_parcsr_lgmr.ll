...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRLGMRESGetResidual(%struct.hypre_Solver_struct* %0, %struct.hypre_ParVector_struct** %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_ParVector_struct** %1 to i8*
  %4 = call i32 @HYPRE_LGMRESGetResidual(%struct.hypre_Solver_struct* %0, i8* %3) #2
  ret i32 %4
}

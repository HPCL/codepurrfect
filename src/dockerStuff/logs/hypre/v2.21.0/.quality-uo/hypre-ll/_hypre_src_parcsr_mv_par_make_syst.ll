...
define dso_local %struct.HYPRE_ParCSR_System_Problem* @HYPRE_Generate2DSystem(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* nocapture readonly %1, %struct.hypre_ParVector_struct* nocapture readonly %2, %struct.hypre_ParVector_struct* nocapture readonly %3, %struct.hypre_ParVector_struct* nocapture readonly %4, %struct.hypre_ParVector_struct* nocapture readonly %5, double* nocapture readonly %6) local_unnamed_addr #0 {
  ...
  %72 = call i8* @hypre_CAlloc(i64 1, i64 24, i32 0) #3
...
88:                                               ; preds = %77
  ...
  %105 = call i8* @hypre_CAlloc(i64 %104, i64 4, i32 0) #3
  %106 = bitcast i8* %105 to i32*
  %107 = call i8* @hypre_CAlloc(i64 %104, i64 8, i32 0) #3
...
304:                                              ; preds = %299, %88
  ...
  %321 = call i8* @hypre_CAlloc(i64 %318, i64 8, i32 0) #3
  %322 = bitcast i8* %321 to double*
  %323 = sext i32 %313 to i64
  %324 = call i8* @hypre_CAlloc(i64 %323, i64 4, i32 0) #3
  %325 = bitcast i8* %324 to i32*
  %326 = sext i32 %49 to i64
  %327 = call i8* @hypre_CAlloc(i64 %326, i64 4, i32 0) #3
  %328 = bitcast i8* %327 to i32*
  %329 = sext i32 %51 to i64
  %330 = call i8* @hypre_CAlloc(i64 %329, i64 4, i32 0) #3
...
595:                                              ; preds = %590, %390
  call void @hypre_Free(i8* %327, i32 0) #3
  call void @hypre_Free(i8* %330, i32 0) #3
  ...
  %597 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %596, i64 0, i32 8
  ...
  %604 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %596, i64 0, i32 9
  ...
  %611 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %596, i64 0, i32 12
  ...
  %626 = call i8* @hypre_CAlloc(i64 %625, i64 8, i32 0) #3
...
643:                                              ; preds = %631, %595
  ...
  call void @hypre_Free(i8* %649, i32 0) #3
  ...
  %667 = call i8* @hypre_CAlloc(i64 %666, i64 8, i32 0) #3
...
!44 = !{!45, !5, i64 8}
!45 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}
!46 = !{!45, !8, i64 0}

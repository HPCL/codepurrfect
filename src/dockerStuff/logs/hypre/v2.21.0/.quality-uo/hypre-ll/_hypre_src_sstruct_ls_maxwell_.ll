...
define dso_local i8* @hypre_MaxwellTVCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 408, i32 0) #4
  ...
  %24 = call i8* @hypre_MAlloc(i64 12, i32 0) #4
...
114:                                              ; preds = %103, %26
  ...
  call void @hypre_Free(i8* %122, i32 0) #4
  ...
  call void @hypre_Free(i8* %126, i32 0) #4
  ...
  call void @hypre_Free(i8* %130, i32 0) #4
  ...
  call void @hypre_Free(i8* %142, i32 0) #4
  ...
  call void @hypre_Free(i8* %146, i32 0) #4
  ...
  call void @hypre_Free(i8* %150, i32 0) #4
  ...
  call void @hypre_Free(i8* %162, i32 0) #4
  ...
  call void @hypre_Free(i8* %166, i32 0) #4
  ...
  call void @hypre_Free(i8* %170, i32 0) #4
...
213:                                              ; preds = %191, %180
  ...
  call void @hypre_Free(i8* %221, i32 0) #4
  ...
  call void @hypre_Free(i8* %241, i32 0) #4
  ...
  call void @hypre_Free(i8* %245, i32 0) #4
  ...
  call void @hypre_Free(i8* %253, i32 0) #4
  ...
  call void @hypre_Free(i8* %257, i32 0) #4
  ...
  call void @hypre_Free(i8* %261, i32 0) #4
  ...
  call void @hypre_Free(i8* %265, i32 0) #4
...
266:                                              ; preds = %213, %175
  ...
  call void @hypre_Free(i8* %273, i32 0) #4

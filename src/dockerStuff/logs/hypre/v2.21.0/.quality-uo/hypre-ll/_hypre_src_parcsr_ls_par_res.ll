...
887:                                              ; preds = %877, %866
  ...
  %891 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 14
  %892 = load i32*, i32** %891, align 8, !tbaa !58
  %893 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %22, i32 %888, i32 %890, i32* %3, i32* %892, i32 %833, i32 %281, i32 %279) #6
  %894 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %893, i64 0, i32 8
  %895 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %894, align 8, !tbaa !11
  %896 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %895, i64 0, i32 9
  %897 = bitcast double** %896 to i8**
  store i8* %289, i8** %897, align 8, !tbaa !12
  %898 = bitcast %struct.hypre_CSRMatrix* %895 to i8**
  store i8* %284, i8** %898, align 8, !tbaa !14
  %899 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %895, i64 0, i32 1
  %900 = bitcast i32** %899 to i8**
  store i8* %287, i8** %900, align 8, !tbaa !15
  %901 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %893, i64 0, i32 9
  %902 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %901, align 8, !tbaa !16
  %903 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %902, i64 0, i32 9
  %904 = bitcast double** %903 to i8**
  store i8* %296, i8** %904, align 8, !tbaa !12
  %905 = bitcast %struct.hypre_CSRMatrix* %902 to i8**
  store i8* %291, i8** %905, align 8, !tbaa !14
  %906 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %902, i64 0, i32 1
  %907 = bitcast i32** %906 to i8**
  store i8* %294, i8** %907, align 8, !tbaa !15
  %908 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %893, i64 0, i32 20
  store i32 0, i32* %908, align 8, !tbaa !59
  %909 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %893, i64 0, i32 12
  store i32* %843, i32** %909, align 8, !tbaa !18
  %910 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 26
  %911 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %910, align 8, !tbaa !60
  %912 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %893, i64 0, i32 26
  store %struct.hypre_IJAssumedPart* %911, %struct.hypre_IJAssumedPart** %912, align 8, !tbaa !60
  %913 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %893, i64 0, i32 27
  store i32 0, i32* %913, align 8, !tbaa !61
  %914 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %893) #6
  %915 = fcmp ogt double %6, 0.000000e+00
  br i1 %915, label %916, label %918

916:                                              ; preds = %887
  %917 = call i32 @hypre_ParCSRMatrixDropSmallEntries(%struct.hypre_ParCSRMatrix_struct* %893, double %6, i32 -1) #6
  br label %918

918:                                              ; preds = %916, %887
  store %struct.hypre_ParCSRMatrix_struct* %893, %struct.hypre_ParCSRMatrix_struct** %8, align 8, !tbaa !37
  %919 = bitcast i32* %842 to i8*
  ...
  %920 = load i32, i32* %17, align 4, !tbaa !19
  %921 = icmp sgt i32 %920, 1
  br i1 %921, label %922, label %924

922:                                              ; preds = %918
  %923 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %312) #6
  br label %924

924:                                              ; preds = %922, %918
  br i1 %340, label %925, label %931

925:                                              ; preds = %924
  %926 = load i8*, i8** bitcast (double** @hypre_fgmresT.V to i8**), align 8, !tbaa !37

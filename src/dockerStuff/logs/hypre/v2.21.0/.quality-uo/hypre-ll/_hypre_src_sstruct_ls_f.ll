...
116:                                              ; preds = %111, %3
  ...
  call void @hypre_Free(i8* %124, i32 0) #4
  ...
  call void @hypre_Free(i8* %132, i32 0) #4
  ...
  call void @hypre_Free(i8* %148, i32 0) #4
...
208:                                              ; preds = %203
  ...
  call void @hypre_Free(i8* %212, i32 0) #4
  ...
  call void @hypre_Free(i8* %216, i32 0) #4
  store double* null, double** %214, align 8, !tbaa !51
  br label %217

217:                                              ; preds = %208, %203
  call void @hypre_Free(i8* %0, i32 0) #4
  br label %218
...
define dso_local i32 @hypre_FACSetPLevels(i8* nocapture %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  %4 = sext i32 %1 to i64
  %5 = call i8* @hypre_CAlloc(i64 %4, i64 4, i32 0) #4
...
define dso_local i32 @hypre_FACSetPRefinements(i8* nocapture %0, i32 %1, [3 x i32]* %2) local_unnamed_addr #0 {
  %4 = sext i32 %1 to i64
  %5 = mul nsw i64 %4, 12
  %6 = call i8* @hypre_MAlloc(i64 %5, i32 0) #4
...
!24 = !{!4, !8, i64 72}
!25 = !{!26, !8, i64 8}
!26 = !{!"hypre_SStructMatrix_struct", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !5, i64 64, !8, i64 72, !8, i64 80, !5, i64 88, !8, i64 96, !8, i64 104, !8, i64 112, !8, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !5, i64 148, !5, i64 152, !5, i64 156}
!27 = !{!4, !8, i64 80}
!28 = !{!8, !8, i64 0}
!29 = !{!4, !8, i64 96}
!30 = !{!4, !8, i64 88}

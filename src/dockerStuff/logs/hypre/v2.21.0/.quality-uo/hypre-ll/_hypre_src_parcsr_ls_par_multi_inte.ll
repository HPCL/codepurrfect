...
3743:                                             ; preds = %3741, %3721
  ...
  %3747 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15
  %3748 = load i32*, i32** %3747, align 8, !tbaa !139
  %3749 = getelementptr inbounds i32, i32* %155, i64 %784
  %3750 = load i32, i32* %3749, align 4, !tbaa !18
  %3751 = getelementptr inbounds i32, i32* %157, i64 %784
  %3752 = load i32, i32* %3751, align 4, !tbaa !18
  %3753 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %18, i32 %3745, i32 %3746, i32* %3748, i32* nonnull %3, i32 0, i32 %3750, i32 %3752) #4
  %3754 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3753, i64 0, i32 8
  %3755 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %3754, align 8, !tbaa !11
  %3756 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3755, i64 0, i32 9
  %3757 = bitcast double** %3756 to i8**
  store i8* %1879, i8** %3757, align 8, !tbaa !12
  %3758 = bitcast %struct.hypre_CSRMatrix* %3755 to i8**
  store i8* %154, i8** %3758, align 8, !tbaa !14
  %3759 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3755, i64 0, i32 1
  %3760 = bitcast i32** %3759 to i8**
  store i8* %1877, i8** %3760, align 8, !tbaa !15
  %3761 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3753, i64 0, i32 9
  %3762 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %3761, align 8, !tbaa !16
  %3763 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3762, i64 0, i32 9
  store double* %1889, double** %3763, align 8, !tbaa !12
  %3764 = bitcast %struct.hypre_CSRMatrix* %3762 to i8**
  store i8* %156, i8** %3764, align 8, !tbaa !14
  %3765 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3762, i64 0, i32 1
  store i32* %1890, i32** %3765, align 8, !tbaa !15
  %3766 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3753, i64 0, i32 19
  store i32 0, i32* %3766, align 4, !tbaa !140
  %3767 = fcmp une double %7, 0.000000e+00
  %3768 = icmp ne i32 %8, 0
  %3769 = select i1 %3767, i1 true, i1 %3768
  br i1 %3769, label %3770, label %3775

3770:                                             ; preds = %3743
  %3771 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3762, i64 0, i32 0
  %3772 = call i32 @hypre_BoomerAMGInterpTruncation(%struct.hypre_ParCSRMatrix_struct* %3753, double %7, i32 %8) #4
  %3773 = load i32*, i32** %3771, align 8, !tbaa !14
  %3774 = load i32*, i32** %3765, align 8, !tbaa !15
  br label %3775

3775:                                             ; preds = %3743, %3770
  %3776 = phi i32* [ %3773, %3770 ], [ %157, %3743 ]
  %3777 = phi i32* [ %3774, %3770 ], [ %1890, %3743 ]
  %3778 = getelementptr inbounds i32, i32* %3776, i64 %784
  %3779 = load i32, i32* %3778, align 4, !tbaa !18
  %3780 = icmp eq i32 %3779, 0
  br i1 %3780, label %3906, label %3781

3781:                                             ; preds = %3775
  %3782 = icmp sgt i32 %1871, %34
  %3783 = select i1 %3782, i32 %1871, i32 %34
  %3784 = sext i32 %3783 to i64
  %3785 = call i8* @hypre_CAlloc(i64 %3784, i64 4, i32 0) #4
  %3786 = bitcast i8* %3785 to i32*
  %3787 = icmp sgt i32 %1871, 0
  br i1 %3787, label %3788, label %3791

3788:                                             ; preds = %3781
  %3789 = zext i32 %1871 to i64
  %3790 = shl nuw nsw i64 %3789, 2
  call void @llvm.memset.p0i8.i64(i8* align 4 %3785, i8 0, i64 %3790, i1 false)
  br label %3791

3791:                                             ; preds = %3788, %3781
  %3792 = icmp sgt i32 %3779, 0
  br i1 %3792, label %3793, label %3810

3793:                                             ; preds = %3791
  %3794 = zext i32 %3779 to i64
  br label %3795

3795:                                             ; preds = %3793, %3806
  %3796 = phi i64 [ 0, %3793 ], [ %3808, %3806 ]
  %3797 = phi i32 [ 0, %3793 ], [ %3807, %3806 ]
  %3798 = getelementptr inbounds i32, i32* %3777, i64 %3796
  %3799 = load i32, i32* %3798, align 4, !tbaa !18
  %3800 = sext i32 %3799 to i64
  %3801 = getelementptr inbounds i32, i32* %3786, i64 %3800
  %3802 = load i32, i32* %3801, align 4, !tbaa !18
  %3803 = icmp eq i32 %3802, 0
  br i1 %3803, label %3804, label %3806

3804:                                             ; preds = %3795
  %3805 = add nsw i32 %3797, 1
  store i32 1, i32* %3801, align 4, !tbaa !18
  br label %3806

3806:                                             ; preds = %3795, %3804
  %3807 = phi i32 [ %3797, %3795 ], [ %3805, %3804 ]
  %3808 = add nuw nsw i64 %3796, 1
  %3809 = icmp eq i64 %3808, %3794
  br i1 %3809, label %3810, label %3795, !llvm.loop !141

3810:                                             ; preds = %3806, %3791
  %3811 = phi i32 [ 0, %3791 ], [ %3807, %3806 ]
  %3812 = sext i32 %3811 to i64
  %3813 = call i8* @hypre_CAlloc(i64 %3812, i64 4, i32 0) #4
  %3814 = bitcast i8* %3813 to i32*
  %3815 = add nsw i32 %773, -1
  %3816 = sext i32 %3815 to i64
  %3817 = getelementptr inbounds i32, i32* %815, i64 %3816
  %3818 = load i32, i32* %3817, align 4, !tbaa !18
  %3819 = sext i32 %3818 to i64
  %3820 = call i8* @hypre_CAlloc(i64 %3819, i64 4, i32 0) #4
  %3821 = bitcast i8* %3820 to i32*
  %3822 = load i32, i32* %3817, align 4, !tbaa !18
  %3823 = sext i32 %3822 to i64
  %3824 = call i8* @hypre_CAlloc(i64 %3823, i64 4, i32 0) #4
  %3825 = bitcast i8* %3824 to i32*
  %3826 = load i32, i32* %3817, align 4, !tbaa !18
  %3827 = icmp sgt i32 %3826, 0
  br i1 %3827, label %3830, label %3828

3828:                                             ; preds = %3830, %3810
  %3829 = zext i32 %3815 to i64
  br label %3840

3830:                                             ; preds = %3810, %3830
  %3831 = phi i64 [ %3833, %3830 ], [ 0, %3810 ]
  %3832 = getelementptr inbounds i32, i32* %3825, i64 %3831
  store i32 -1, i32* %3832, align 4, !tbaa !18
  %3833 = add nuw nsw i64 %3831, 1
  %3834 = load i32, i32* %3817, align 4, !tbaa !18
  %3835 = sext i32 %3834 to i64
  %3836 = icmp slt i64 %3833, %3835
  br i1 %3836, label %3830, label %3828, !llvm.loop !142

3837:                                             ; preds = %3869, %3840
  %3838 = phi i32 [ %3842, %3840 ], [ %3870, %3869 ]
  %3839 = icmp eq i64 %3845, %3829
  br i1 %3839, label %3875, label %3840, !llvm.loop !143

3840:                                             ; preds = %3828, %3837
  %3841 = phi i64 [ 0, %3828 ], [ %3845, %3837 ]
  %3842 = phi i32 [ 0, %3828 ], [ %3838, %3837 ]
  %3843 = getelementptr inbounds i32, i32* %815, i64 %3841
  %3844 = load i32, i32* %3843, align 4, !tbaa !18
  %3845 = add nuw nsw i64 %3841, 1
  %3846 = getelementptr inbounds i32, i32* %815, i64 %3845
  %3847 = getelementptr inbounds i32*, i32** %814, i64 %3841
  %3848 = load i32, i32* %3846, align 4, !tbaa !18
  %3849 = icmp slt i32 %3844, %3848
  br i1 %3849, label %3850, label %3837

3850:                                             ; preds = %3840
  %3851 = sext i32 %3844 to i64
  br label %3852

3852:                                             ; preds = %3850, %3869
  %3853 = phi i64 [ %3851, %3850 ], [ %3871, %3869 ]
  %3854 = phi i32 [ %3842, %3850 ], [ %3870, %3869 ]
  %3855 = getelementptr inbounds i32, i32* %3786, i64 %3853
  %3856 = load i32, i32* %3855, align 4, !tbaa !18
  %3857 = icmp eq i32 %3856, 0
  br i1 %3857, label %3869, label %3858

3858:                                             ; preds = %3852
  %3859 = load i32*, i32** %3847, align 8, !tbaa !53
  %3860 = load i32, i32* %3843, align 4, !tbaa !18
  %3861 = sext i32 %3860 to i64
  %3862 = sub nsw i64 %3853, %3861
  %3863 = getelementptr inbounds i32, i32* %3859, i64 %3862
  %3864 = load i32, i32* %3863, align 4, !tbaa !18
  %3865 = sext i32 %3854 to i64
  %3866 = getelementptr inbounds i32, i32* %3814, i64 %3865
  store i32 %3864, i32* %3866, align 4, !tbaa !18
  %3867 = add nsw i32 %3854, 1
  %3868 = getelementptr inbounds i32, i32* %3825, i64 %3853
  store i32 %3864, i32* %3868, align 4, !tbaa !18
  br label %3869

3869:                                             ; preds = %3852, %3858
  %3870 = phi i32 [ %3867, %3858 ], [ %3854, %3852 ]
  %3871 = add nsw i64 %3853, 1
  %3872 = load i32, i32* %3846, align 4, !tbaa !18
  %3873 = sext i32 %3872 to i64
  %3874 = icmp slt i64 %3871, %3873
  br i1 %3874, label %3852, label %3837, !llvm.loop !144

3875:                                             ; preds = %3837
  %3876 = add nsw i32 %3811, -1
  call void @hypre_BigQsort0(i32* %3814, i32 0, i32 %3876) #4
  %3877 = load i32, i32* %3817, align 4, !tbaa !18
  %3878 = icmp sgt i32 %3877, 0
  br i1 %3878, label %3883, label %3879

3879:                                             ; preds = %3891, %3875
  %3880 = icmp sgt i32 %3779, 0
  br i1 %3880, label %3881, label %3905

3881:                                             ; preds = %3879
  %3882 = zext i32 %3779 to i64
  br label %3896

3883:                                             ; preds = %3875, %3891
  %3884 = phi i64 [ %3892, %3891 ], [ 0, %3875 ]
  %3885 = getelementptr inbounds i32, i32* %3825, i64 %3884
  %3886 = load i32, i32* %3885, align 4, !tbaa !18
  %3887 = icmp eq i32 %3886, -1
  br i1 %3887, label %3891, label %3888

3888:                                             ; preds = %3883
  %3889 = call i32 @hypre_BigBinarySearch(i32* %3814, i32 %3886, i32 %3811) #4
  %3890 = getelementptr inbounds i32, i32* %3821, i64 %3884
  store i32 %3889, i32* %3890, align 4, !tbaa !18
  br label %3891

3891:                                             ; preds = %3883, %3888
  %3892 = add nuw nsw i64 %3884, 1
  %3893 = load i32, i32* %3817, align 4, !tbaa !18
  %3894 = sext i32 %3893 to i64
  %3895 = icmp slt i64 %3892, %3894
  br i1 %3895, label %3883, label %3879, !llvm.loop !145

3896:                                             ; preds = %3881, %3896
  %3897 = phi i64 [ 0, %3881 ], [ %3903, %3896 ]
  %3898 = getelementptr inbounds i32, i32* %3777, i64 %3897
  %3899 = load i32, i32* %3898, align 4, !tbaa !18
  %3900 = sext i32 %3899 to i64
  %3901 = getelementptr inbounds i32, i32* %3821, i64 %3900
  %3902 = load i32, i32* %3901, align 4, !tbaa !18
  store i32 %3902, i32* %3898, align 4, !tbaa !18
  %3903 = add nuw nsw i64 %3897, 1
  %3904 = icmp eq i64 %3903, %3882
  br i1 %3904, label %3905, label %3896, !llvm.loop !146

3905:                                             ; preds = %3896, %3879
  call void @hypre_Free(i8* %3785, i32 0) #4
  br label %3906

3906:                                             ; preds = %3905, %3775
  %3907 = phi i32* [ %3814, %3905 ], [ null, %3775 ]
  %3908 = phi i8* [ %3820, %3905 ], [ null, %3775 ]
  %3909 = phi i8* [ %3824, %3905 ], [ null, %3775 ]
  %3910 = phi i32 [ %3811, %3905 ], [ 0, %3775 ]
  %3911 = load i32, i32* %15, align 4, !tbaa !18
  %3912 = icmp sgt i32 %3911, 1
  br i1 %3912, label %3913, label %3923

3913:                                             ; preds = %3906
  %3914 = add nsw i32 %773, -1
  %3915 = zext i32 %3914 to i64
  br label %3916

3916:                                             ; preds = %3913, %3916
  %3917 = phi i64 [ 0, %3913 ], [ %3921, %3916 ]
  %3918 = getelementptr inbounds i32*, i32** %814, i64 %3917
  %3919 = bitcast i32** %3918 to i8**
  %3920 = load i8*, i8** %3919, align 8, !tbaa !53
  call void @hypre_Free(i8* %3920, i32 0) #4
  store i32* null, i32** %3918, align 8, !tbaa !53
  %3921 = add nuw nsw i64 %3917, 1
  %3922 = icmp eq i64 %3921, %3915
  br i1 %3922, label %3923, label %3916, !llvm.loop !147

3923:                                             ; preds = %3916, %3906
  call void @hypre_Free(i8* %3908, i32 0) #4
  call void @hypre_Free(i8* %3909, i32 0) #4
  %3924 = bitcast i32** %814 to i8*
  call void @hypre_Free(i8* %3924, i32 0) #4
  %3925 = bitcast i32* %815 to i8*
  call void @hypre_Free(i8* %3925, i32 0) #4
  %3926 = icmp eq i32 %3910, 0
  br i1 %3926, label %3930, label %3927

3927:                                             ; preds = %3923
  %3928 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3753, i64 0, i32 12
  store i32* %3907, i32** %3928, align 8, !tbaa !148
  %3929 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %3762, i64 0, i32 4
  store i32 %3910, i32* %3929, align 4, !tbaa !17
  br label %3930

3930:                                             ; preds = %3927, %3923
  %3931 = icmp ne i32 %134, 0
  %3932 = icmp sgt i32 %106, 0
  %3933 = select i1 %3931, i1 %3932, i1 false
  br i1 %3933, label %3934, label %3945

3934:                                             ; preds = %3930
  %3935 = zext i32 %106 to i64
  br label %3936

3936:                                             ; preds = %3934, %3942
  %3937 = phi i64 [ 0, %3934 ], [ %3943, %3942 ]
  %3938 = getelementptr inbounds i32, i32* %1, i64 %3937
  %3939 = load i32, i32* %3938, align 4, !tbaa !18
  %3940 = icmp eq i32 %3939, -3
  br i1 %3940, label %3941, label %3942

3941:                                             ; preds = %3936
  store i32 -1, i32* %3938, align 4, !tbaa !18
  br label %3942

3942:                                             ; preds = %3936, %3941
  %3943 = add nuw nsw i64 %3937, 1
  %3944 = icmp eq i64 %3943, %3935
  br i1 %3944, label %3945, label %3936, !llvm.loop !149

3945:                                             ; preds = %3942, %3930
  %3946 = load i32, i32* %15, align 4, !tbaa !18
  %3947 = icmp sgt i32 %3946, 1
  br i1 %3947, label %3948, label %3950

3948:                                             ; preds = %3945
  %3949 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %3753) #4
  br label %3950

3950:                                             ; preds = %3948, %3945
  store %struct.hypre_ParCSRMatrix_struct* %3753, %struct.hypre_ParCSRMatrix_struct** %10, align 8, !tbaa !53

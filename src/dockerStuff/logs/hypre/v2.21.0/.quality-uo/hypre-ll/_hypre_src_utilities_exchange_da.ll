...
define dso_local i32 @hypre_DataExchangeList(i32 %0, i32* nocapture readonly %1, i8* %2, i32* nocapture readonly %3, i32 %4, i32 %5, %struct.hypre_DataExchangeResponse* %6, i32 %7, i32 %8, i32 %9, i8** nocapture %10, i32** nocapture %11) local_unnamed_addr #0 {
  ...
  %64 = call i8* @hypre_CAlloc(i64 %63, i64 1, i32 0) #4
  ...
  %73 = shl nsw i64 %72, 3
  %74 = call i8* @hypre_MAlloc(i64 %73, i32 0) #4
  %75 = bitcast i8* %74 to i8**
  %76 = call i8* @hypre_MAlloc(i64 %73, i32 0) #4
...
91:                                               ; preds = %89
  ...
  %92 = call i8* @hypre_CAlloc(i64 %72, i64 4, i32 0) #4
  %93 = bitcast i8* %92 to i32*
  %94 = call i8* @hypre_CAlloc(i64 %72, i64 20, i32 0) #4
  %95 = call i8* @hypre_CAlloc(i64 %72, i64 4, i32 0) #4
  %96 = call i8* @hypre_CAlloc(i64 %72, i64 20, i32 0) #4
...
151:                                              ; preds = %145
  ...
  %154 = call i8* @hypre_MAlloc(i64 %153, i32 0) #4
...
176:                                              ; preds = %169, %174
  ...
  %180 = call i8* @hypre_CAlloc(i64 %179, i64 4, i32 0) #4
  %181 = bitcast i8* %180 to i32*
  %182 = call i8* @hypre_CAlloc(i64 %179, i64 20, i32 0) #4
...
238:                                              ; preds = %226
  ...
  %241 = call i8* @hypre_ReAlloc(i8* %232, i64 %240, i32 0) #4
...
257:                                              ; preds = %255
  ...
  %262 = call i8* @hypre_ReAlloc(i8* %259, i64 %261, i32 0) #4
  %263 = bitcast i8* %262 to i8**
  %264 = bitcast i32* %227 to i8*
  %265 = shl nsw i64 %260, 2
  %266 = call i8* @hypre_ReAlloc(i8* %264, i64 %265, i32 0) #4
...
268:                                              ; preds = %257, %255
  ...
  %274 = call i8* @hypre_MAlloc(i64 %273, i32 0) #4
  ...
  call void @hypre_Memcpy(i8* %274, i8* %278, i64 %273, i32 0, i32 0) #4
...
283:                                              ; preds = %268, %243
  ...
  call void @hypre_Memcpy(i8* %289, i8* nonnull %37, i64 4, i32 0, i32 0) #4
...
358:                                              ; preds = %351
  call void @hypre_Free(i8* %352, i32 0) #4
  br label %359

359:                                              ; preds = %358, %351
  %360 = load i8*, i8** %20, align 8, !tbaa !16
  call void @hypre_Free(i8* %360, i32 0) #4
  store i8* null, i8** %20, align 8, !tbaa !16
  call void @hypre_Free(i8* %74, i32 0) #4
...
433:                                              ; preds = %431, %463
  ...
  call void @hypre_Memcpy(i8* %437, i8* %436, i64 %447, i32 0, i32 0) #4
...
468:                                              ; preds = %463, %414
  ...
  %471 = call i8* @hypre_MAlloc(i64 %470, i32 0) #4
  %472 = bitcast i8* %471 to %struct.MPI_Status*
  call void @hypre_Free(i8* %67, i32 0) #4
...
473:                                              ; preds = %468
  ...
  call void @hypre_Free(i8* %476, i32 0) #4
  %477 = bitcast i32* %138 to i8*
  call void @hypre_Free(i8* %477, i32 0) #4
...
481:                                              ; preds = %479
  ...
  call void @hypre_Free(i8* %422, i32 0) #4
...
485:                                              ; preds = %483
  ...
  call void @hypre_Free(i8* %487, i32 0) #4
  call void @hypre_Free(i8* %471, i32 0) #4
...
491:                                              ; preds = %489, %491
  ...
  call void @hypre_Free(i8* %494, i32 0) #4
  store i8* null, i8** %493, align 8, !tbaa !16
...
502:                                              ; preds = %499
  ...
  call void @hypre_Free(i8* %503, i32 0) #4
  %504 = bitcast %struct.MPI_Status* %205 to i8*
  call void @hypre_Free(i8* %504, i32 0) #4
  %505 = bitcast i32* %201 to i8*
  call void @hypre_Free(i8* %505, i32 0) #4
  br label %506

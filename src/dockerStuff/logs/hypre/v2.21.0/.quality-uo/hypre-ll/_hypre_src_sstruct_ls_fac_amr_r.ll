...
define dso_local i32 @hypre_AMR_RAP(%struct.hypre_SStructMatrix_struct* %0, [3 x i32]* %1, %struct.hypre_SStructMatrix_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %59 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 22
  ...
  %98 = call i8* @hypre_CAlloc(i64 %95, i64 4, i32 0) #6
...
118:                                              ; preds = %116, %3
  ...
  %120 = call i8* @hypre_CAlloc(i64 %119, i64 4, i32 0) #6
...
168:                                              ; preds = %164, %118
  %169 = call i8* @hypre_CAlloc(i64 %119, i64 8, i32 0) #6
  ...
  call void @hypre_Free(i8* %120, i32 0) #6
  call void @hypre_Free(i8* %169, i32 0) #6
  %176 = sext i32 %54 to i64
  %177 = call i8* @hypre_CAlloc(i64 %176, i64 8, i32 0) #6
...
189:                                              ; preds = %183, %186
  ...
  %202 = call i8* @hypre_CAlloc(i64 %201, i64 8, i32 0) #6
...
1000:                                             ; preds = %987, %964
  ...
  %1010 = call i8* @hypre_CAlloc(i64 %1009, i64 8, i32 0) #6
...
1338:                                             ; preds = %1331, %1030
  ...
  call void @hypre_Free(i8* %1341, i32 0) #6
...
!56 = !{!57, !8, i64 40}
!57 = !{!"hypre_StructMatrix_struct", !5, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !8, i64 88, !5, i64 96, !5, i64 100, !8, i64 104, !6, i64 112, !5, i64 136, !8, i64 144, !5, i64 152}
!58 = !{!48, !8, i64 0}

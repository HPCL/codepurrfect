...
define dso_local i32 @hypre_AMR_FCoarsen(%struct.hypre_SStructMatrix_struct* nocapture readonly %0, %struct.hypre_SStructMatrix_struct* nocapture readonly %1, %struct.hypre_SStructPMatrix* nocapture readonly %2, i32* %3, i32 %4) local_unnamed_addr #0 {
  ...
  %66 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 22
...
146:                                              ; preds = %140, %128
  ...
  %152 = call i8* @hypre_MAlloc(i64 %151, i32 0) #6
  %153 = bitcast i8* %152 to %struct.hypre_BoxArray_struct***
  %154 = call i8* @hypre_MAlloc(i64 %151, i32 0) #6
  %155 = bitcast i8* %154 to %struct.hypre_BoxArray_struct***
  %156 = call i8* @hypre_MAlloc(i64 %151, i32 0) #6
  %157 = bitcast i8* %156 to %struct.hypre_BoxArrayArray_struct***
  %158 = call i8* @hypre_MAlloc(i64 %151, i32 0) #6
  %159 = bitcast i8* %158 to i32***
  %160 = call i8* @hypre_MAlloc(i64 %151, i32 0) #6
  %161 = bitcast i8* %160 to i32***
  %162 = call i8* @hypre_MAlloc(i64 %151, i32 0) #6
  %163 = bitcast i8* %162 to i32***
  %164 = call i8* @hypre_MAlloc(i64 %151, i32 0) #6
...
202:                                              ; preds = %196, %540
  ...
  %218 = call i8* @hypre_MAlloc(i64 %217, i32 0) #6
  ...
  %224 = call i8* @hypre_MAlloc(i64 %223, i32 0) #6
  ...
  %230 = call i8* @hypre_MAlloc(i64 %229, i32 0) #6
  ...
  %236 = call i8* @hypre_MAlloc(i64 %235, i32 0) #6
  ...
  %242 = call i8* @hypre_MAlloc(i64 %241, i32 0) #6
  ...
  %258 = call i8* @hypre_CAlloc(i64 %257, i64 8, i32 0) #6
...
330:                                              ; preds = %324, %279
  ...
  %342 = call i8* @hypre_CAlloc(i64 %341, i64 4, i32 0) #6
  ...
  %346 = call i8* @hypre_CAlloc(i64 %341, i64 4, i32 0) #6
...
477:                                              ; preds = %474, %458
  ...
  %483 = call i8* @hypre_CAlloc(i64 %482, i64 4, i32 0) #6
...
508:                                              ; preds = %503, %477
  ...
  %514 = call i8* @hypre_MAlloc(i64 %513, i32 0) #6
...
543:                                              ; preds = %540, %146
  ...
  %562 = call i8* @hypre_CAlloc(i64 2, i64 8, i32 0) #6
...
752:                                              ; preds = %543, %752
  ...
  %758 = call i8* @hypre_CAlloc(i64 %757, i64 4, i32 0) #6
...
895:                                              ; preds = %862
  ...
  call void @hypre_Free(i8* %896, i32 0) #6
...
907:                                              ; preds = %905, %895
  ...
  call void @hypre_Free(i8* %910, i32 0) #6
...
917:                                              ; preds = %912
  ...
  call void @hypre_Free(i8* %921, i32 0) #6
...
928:                                              ; preds = %925
  ...
  call void @hypre_Free(i8* %929, i32 0) #6
  %930 = bitcast double** %868 to i8*
  call void @hypre_Free(i8* %930, i32 0) #6
  %931 = bitcast i32* %865 to i8*
  call void @hypre_Free(i8* %931, i32 0) #6
  br label %932
...
958:                                              ; preds = %946
  ...
  %963 = call i8* @hypre_MAlloc(i64 %961, i32 0) #6
  %964 = shl nsw i64 %959, 2
  %965 = call i8* @hypre_MAlloc(i64 %964, i32 0) #6
  %966 = bitcast i8* %965 to i32*
  %967 = call i8* @hypre_MAlloc(i64 108, i32 0) #6
  %968 = bitcast i8* %967 to i32*
  %969 = call i8* @hypre_MAlloc(i64 %961, i32 0) #6
  %970 = call i8* @hypre_MAlloc(i64 %964, i32 0) #6
...
1084:                                             ; preds = %1082
  ...
  %1090 = call i8* @hypre_MAlloc(i64 %1089, i32 0) #6
...
1255:                                             ; preds = %1253
  ...
  %1261 = call i8* @hypre_MAlloc(i64 %1260, i32 0) #6
  ...
  %1267 = call i8* @hypre_MAlloc(i64 %1266, i32 0) #6
...
1426:                                             ; preds = %1424
  ...
  %1432 = call i8* @hypre_MAlloc(i64 %1431, i32 0) #6
  ...
  %1438 = call i8* @hypre_MAlloc(i64 %1437, i32 0) #6
...
1597:                                             ; preds = %1595
  ...
  %1603 = call i8* @hypre_MAlloc(i64 %1602, i32 0) #6
  ...
  %1609 = call i8* @hypre_MAlloc(i64 %1608, i32 0) #6
...
1794:                                             ; preds = %1792
  ...
  %1800 = call i8* @hypre_MAlloc(i64 %1799, i32 0) #6
  ...
  %1806 = call i8* @hypre_MAlloc(i64 %1805, i32 0) #6
...
1902:                                             ; preds = %1900
  ...
  %1908 = call i8* @hypre_MAlloc(i64 %1907, i32 0) #6
  ...
  %1914 = call i8* @hypre_MAlloc(i64 %1913, i32 0) #6
...
2011:                                             ; preds = %2009
  ...
  %2017 = call i8* @hypre_MAlloc(i64 %2016, i32 0) #6
  ...
  %2023 = call i8* @hypre_MAlloc(i64 %2022, i32 0) #6
...
2121:                                             ; preds = %2119
  ...
  %2127 = call i8* @hypre_MAlloc(i64 %2126, i32 0) #6
  ...
  %2133 = call i8* @hypre_MAlloc(i64 %2132, i32 0) #6
...
2231:                                             ; preds = %2229
  ...
  %2237 = call i8* @hypre_MAlloc(i64 %2236, i32 0) #6
  ...
  %2243 = call i8* @hypre_MAlloc(i64 %2242, i32 0) #6
...
2341:                                             ; preds = %2339
  ...
  %2347 = call i8* @hypre_MAlloc(i64 %2346, i32 0) #6
  ...
  %2353 = call i8* @hypre_MAlloc(i64 %2352, i32 0) #6
...
2450:                                             ; preds = %2448
  ...
  %2456 = call i8* @hypre_MAlloc(i64 %2455, i32 0) #6
  ...
  %2462 = call i8* @hypre_MAlloc(i64 %2461, i32 0) #6
...
2558:                                             ; preds = %2556
  ...
  %2564 = call i8* @hypre_MAlloc(i64 %2563, i32 0) #6
  ...
  %2570 = call i8* @hypre_MAlloc(i64 %2569, i32 0) #6
...
2665:                                             ; preds = %2663
  ...
  %2671 = call i8* @hypre_MAlloc(i64 %2670, i32 0) #6
  ...
  %2677 = call i8* @hypre_MAlloc(i64 %2676, i32 0) #6
...
2771:                                             ; preds = %2769
  ...
  %2777 = call i8* @hypre_MAlloc(i64 %2776, i32 0) #6
  ...
  %2783 = call i8* @hypre_MAlloc(i64 %2782, i32 0) #6
...
2878:                                             ; preds = %2876
  ...
  %2884 = call i8* @hypre_MAlloc(i64 %2883, i32 0) #6
  ...
  %2890 = call i8* @hypre_MAlloc(i64 %2889, i32 0) #6
...
2986:                                             ; preds = %2984
  ...
  %2992 = call i8* @hypre_MAlloc(i64 %2991, i32 0) #6
  ...
  %2998 = call i8* @hypre_MAlloc(i64 %2997, i32 0) #6
...
3093:                                             ; preds = %3091
  ...
  %3099 = call i8* @hypre_MAlloc(i64 %3098, i32 0) #6
  ...
  %3105 = call i8* @hypre_MAlloc(i64 %3104, i32 0) #6
...
3199:                                             ; preds = %3197
  ...
  %3205 = call i8* @hypre_MAlloc(i64 %3204, i32 0) #6
  ...
  %3211 = call i8* @hypre_MAlloc(i64 %3210, i32 0) #6
...
3331:                                             ; preds = %3328, %1765
  ...
  %3334 = call i8* @hypre_CAlloc(i64 %3333, i64 8, i32 0) #6
...
3336:                                             ; preds = %3331, %946
  ...
  %3360 = call i8* @hypre_MAlloc(i64 %3359, i32 0) #6
  %3361 = bitcast i8* %3360 to double**
  %3362 = call i8* @hypre_MAlloc(i64 %3359, i32 0) #6
...
4196:                                             ; preds = %4193, %4081
  ...
  %4199 = call i8* @hypre_CAlloc(i64 %676, i64 8, i32 0) #6
...
4268:                                             ; preds = %4267
  %4269 = call i8* @hypre_CAlloc(i64 %676, i64 4, i32 0) #6
...
4369:                                             ; preds = %4364, %4268
  ...
  %4373 = call i8* @hypre_MAlloc(i64 %4372, i32 0) #6
...
4383:                                             ; preds = %4378, %4369
  %4384 = call i8* @hypre_MAlloc(i64 %4372, i32 0) #6
  %4385 = bitcast i8* %4384 to i32*
  %4386 = call i8* @hypre_MAlloc(i64 %4372, i32 0) #6
  %4387 = bitcast i8* %4386 to i32*
  %4388 = call i8* @hypre_CAlloc(i64 %4371, i64 8, i32 0) #6
...
4546:                                             ; preds = %4541, %4479
  call void @hypre_Free(i8* %4373, i32 0) #6
  call void @hypre_Free(i8* %4384, i32 0) #6
  call void @hypre_Free(i8* %4386, i32 0) #6
  call void @hypre_Free(i8* %4388, i32 0) #6
  call void @hypre_Free(i8* %4269, i32 0) #6
  br label %4547
...
4595:                                             ; preds = %4591, %4547
  ...
  call void @hypre_Free(i8* %4199, i32 0) #6
...
4659:                                             ; preds = %4657, %3336
  ...
  call void @hypre_Free(i8* %3360, i32 0) #6
  call void @hypre_Free(i8* %3362, i32 0) #6
  br label %4661
...
4705:                                             ; preds = %4693
  ...
  call void @hypre_Free(i8* nonnull %4706, i32 0) #6
  br label %4707
...
4709:                                             ; preds = %4707
  ...
  call void @hypre_Free(i8* nonnull %4710, i32 0) #6
  br label %4711
...
4713:                                             ; preds = %4711
  ...
  call void @hypre_Free(i8* nonnull %4714, i32 0) #6
  br label %4715
...
4717:                                             ; preds = %4715
  ...
  call void @hypre_Free(i8* nonnull %4718, i32 0) #6
  br label %4719
...
4735:                                             ; preds = %4732, %4721
  ...
  call void @hypre_Free(i8* nonnull %4736, i32 0) #6
  br label %4737
...
4749:                                             ; preds = %4744
  ...
  call void @hypre_Free(i8* nonnull %4750, i32 0) #6
...
4754:                                             ; preds = %4751
  ...
  call void @hypre_Free(i8* nonnull %4755, i32 0) #6
  br label %4756
...
4768:                                             ; preds = %4763
  ...
  call void @hypre_Free(i8* nonnull %4769, i32 0) #6
...
4773:                                             ; preds = %4770
  ...
  call void @hypre_Free(i8* nonnull %4774, i32 0) #6
  br label %4775
...
4777:                                             ; preds = %4775
  ...
  call void @hypre_Free(i8* nonnull %4778, i32 0) #6
  br label %4779
...
4786:                                             ; preds = %4781
  ...
  call void @hypre_Free(i8* nonnull %4787, i32 0) #6
...
4791:                                             ; preds = %4788
  call void @hypre_Free(i8* nonnull %562, i32 0) #6
  br label %4792
...
4818:                                             ; preds = %4816, %6114
  ...
  %4830 = call i8* @hypre_MAlloc(i64 %4829, i32 0) #6
  %4831 = bitcast i8* %4830 to i32*
  %4832 = call i8* @hypre_MAlloc(i64 108, i32 0) #6
...
4862:                                             ; preds = %4838, %4818
  ...
  %4892 = call i8* @hypre_CAlloc(i64 %4891, i64 4, i32 0) #6
  %4893 = bitcast i8* %4892 to i32*
  %4894 = load i32, i32* %4889, align 8, !tbaa !36
  %4895 = sext i32 %4894 to i64
  %4896 = call i8* @hypre_CAlloc(i64 %4895, i64 4, i32 0) #6
  ...
  %4908 = call i8* @hypre_CAlloc(i64 %4907, i64 8, i32 0) #6
  %4909 = bitcast i8* %4908 to i32**
  %4910 = call i8* @hypre_CAlloc(i64 %4907, i64 4, i32 0) #6
  ...
  %4915 = call i8* @hypre_CAlloc(i64 %4914, i64 4, i32 0) #6
...
4956:                                             ; preds = %4950
  ...
  %4964 = call i8* @hypre_MAlloc(i64 %4963, i32 0) #6
...
5158:                                             ; preds = %5150, %5101
  ...
  %5162 = call i8* @hypre_MAlloc(i64 %5161, i32 0) #6
  %5163 = bitcast i8* %5162 to i32*
  %5164 = call i8* @hypre_MAlloc(i64 %5161, i32 0) #6
  %5165 = bitcast i8* %5164 to i32*
  %5166 = call i8* @hypre_CAlloc(i64 %5160, i64 4, i32 0) #6
  %5167 = bitcast i8* %5166 to i32*
  %5168 = shl nsw i64 %5160, 3
  %5169 = call i8* @hypre_MAlloc(i64 %5168, i32 0) #6
  %5170 = bitcast i8* %5169 to i32**
  %5171 = mul nsw i64 %5160, 12
  %5172 = call i8* @hypre_MAlloc(i64 %5171, i32 0) #6
...
5181:                                             ; preds = %5176
  ...
  %5207 = call i8* @hypre_MAlloc(i64 %5206, i32 0) #6
...
5233:                                             ; preds = %5231
  call void @hypre_Free(i8* nonnull %5018, i32 0) #6
  br label %5234
...
5236:                                             ; preds = %5234
  call void @hypre_Free(i8* nonnull %5023, i32 0) #6
  br label %5237
...
5239:                                             ; preds = %5237
  call void @hypre_Free(i8* nonnull %5028, i32 0) #6
  br label %5240

5240:                                             ; preds = %5237, %5239
  call void @hypre_Free(i8* %5033, i32 0) #6
  %5241 = icmp eq i8* %5037, null
  br i1 %5241, label %5243, label %5242

5242:                                             ; preds = %5240
  call void @hypre_Free(i8* nonnull %5037, i32 0) #6
  br label %5243
...
5245:                                             ; preds = %5243
  call void @hypre_Free(i8* nonnull %5042, i32 0) #6
  br label %5246

5246:                                             ; preds = %5245, %5243
  %5247 = call i32 @hypre_SetIndex(i32* nonnull %545, i32 0) #6
  %5248 = call i8* @hypre_CAlloc(i64 %5160, i64 4, i32 0) #6
...
5300:                                             ; preds = %5294, %5246
  ...
  %5304 = call i8* @hypre_MAlloc(i64 %5303, i32 0) #6
...
5314:                                             ; preds = %5309, %5300
  %5315 = call i8* @hypre_MAlloc(i64 %5303, i32 0) #6
  %5316 = bitcast i8* %5315 to i32*
  %5317 = call i8* @hypre_MAlloc(i64 %5303, i32 0) #6
  %5318 = bitcast i8* %5317 to i32*
  %5319 = call i8* @hypre_CAlloc(i64 %5302, i64 8, i32 0) #6
  %5320 = bitcast i8* %5319 to double*
  %5321 = call i8* @hypre_MAlloc(i64 %5168, i32 0) #6
  %5322 = bitcast i8* %5321 to i32**
  %5323 = call i8* @hypre_MAlloc(i64 %5168, i32 0) #6
  %5324 = bitcast i8* %5323 to i32**
  %5325 = call i8* @hypre_MAlloc(i64 %5168, i32 0) #6
  %5326 = bitcast i8* %5325 to i32**
  %5327 = call i8* @hypre_MAlloc(i64 %5168, i32 0) #6
  %5328 = bitcast i8* %5327 to i32**
  %5329 = call i8* @hypre_CAlloc(i64 %5160, i64 4, i32 0) #6
...
5439:                                             ; preds = %5432, %5334
  ...
  call void @hypre_Free(i8* %5443, i32 0) #6
...
5487:                                             ; preds = %5484, %5314
  call void @hypre_Free(i8* %5169, i32 0) #6
  call void @hypre_Free(i8* %5166, i32 0) #6
  call void @hypre_Free(i8* %5172, i32 0) #6
  %5488 = call i32 @HYPRE_IJMatrixGetValues(%struct.hypre_IJMatrix_struct* %65, i32 %5301, i32* %5305, i32* %5316, i32* %5318, double* %5320) #6
  call void @hypre_Free(i8* %5304, i32 0) #6
  call void @hypre_Free(i8* %5315, i32 0) #6
  call void @hypre_Free(i8* %5317, i32 0) #6
...
5492:                                             ; preds = %5490, %6090
  ...
  %5498 = call i8* @hypre_CAlloc(i64 %5497, i64 8, i32 0) #6
...
5535:                                             ; preds = %5533, %5492
  ...
  call void @hypre_Free(i8* %5539, i32 0) #6
  ...
  call void @hypre_Free(i8* %5542, i32 0) #6
  ...
  call void @hypre_Free(i8* %5545, i32 0) #6
...
5568:                                             ; preds = %5564
  ...
  %5571 = call i8* @hypre_MAlloc(i64 %5570, i32 0) #6
...
5583:                                             ; preds = %5575, %5568
  ...
  %5592 = call i8* @hypre_MAlloc(i64 %5591, i32 0) #6
...
5619:                                             ; preds = %5612, %5598
  call void @hypre_Free(i8* %5571, i32 0) #6
  call void @hypre_Free(i8* %5592, i32 0) #6
  br label %5620
...
5620:                                             ; preds = %5564, %5619
  ...
  %5624 = call i8* @hypre_MAlloc(i64 %5623, i32 0) #6
...
5663:                                             ; preds = %5631, %5620
  %5664 = call i8* @hypre_MAlloc(i64 %4829, i32 0) #6
  %5665 = bitcast i8* %5664 to i32*
  %5666 = call i8* @hypre_MAlloc(i64 %4829, i32 0) #6
  %5667 = bitcast i8* %5666 to i32*
  %5668 = call i8* @hypre_MAlloc(i64 %4829, i32 0) #6
...
5781:                                             ; preds = %5771
  ...
  %5784 = call i8* @hypre_MAlloc(i64 8, i32 0) #6
...
5864:                                             ; preds = %5836, %5858, %5812, %5830
  ...
  call void @hypre_Free(i8* %5784, i32 0) #6
  br label %6087
...
5881:                                             ; preds = %5871
  ...
  %5884 = call i8* @hypre_MAlloc(i64 8, i32 0) #6
...
6080:                                             ; preds = %6052, %6074, %6028, %6046
  ...
  call void @hypre_Free(i8* %5975, i32 0) #6
  br label %6087
...
6090:                                             ; preds = %6087, %5726
  ...
  call void @hypre_Free(i8* %6093, i32 0) #6
  store i32* null, i32** %6091, align 8, !tbaa !17
  call void @hypre_Free(i8* %5498, i32 0) #6
  call void @hypre_Free(i8* %5624, i32 0) #6
  call void @hypre_Free(i8* %5664, i32 0) #6
  call void @hypre_Free(i8* %5666, i32 0) #6
  call void @hypre_Free(i8* null, i32 0) #6
  call void @hypre_Free(i8* %5668, i32 0) #6
  %6094 = add nuw nsw i64 %5493, 1
  %6095 = icmp eq i64 %6094, %5491
  br i1 %6095, label %6096, label %5492, !llvm.loop !258

6096:                                             ; preds = %6090, %5487
  call void @hypre_Free(i8* %5248, i32 0) #6
  call void @hypre_Free(i8* %5321, i32 0) #6
  call void @hypre_Free(i8* %5323, i32 0) #6
  call void @hypre_Free(i8* %5325, i32 0) #6
  call void @hypre_Free(i8* %5327, i32 0) #6
  call void @hypre_Free(i8* %5329, i32 0) #6
  call void @hypre_Free(i8* %5164, i32 0) #6
  call void @hypre_Free(i8* %5162, i32 0) #6
  call void @hypre_Free(i8* %5319, i32 0) #6
...
6099:                                             ; preds = %6096, %4937
  ...
  call void @hypre_Free(i8* %4830, i32 0) #6
  call void @hypre_Free(i8* %4832, i32 0) #6
  call void @hypre_Free(i8* %4915, i32 0) #6
  call void @hypre_Free(i8* %4910, i32 0) #6
...
6109:                                             ; preds = %6104
  ...
  call void @hypre_Free(i8* nonnull %6110, i32 0) #6
...
6114:                                             ; preds = %6111, %6099
  call void @hypre_Free(i8* %4908, i32 0) #6
  call void @hypre_Free(i8* %4892, i32 0) #6
  call void @hypre_Free(i8* %4896, i32 0) #6
...
6172:                                             ; preds = %6149, %6438
  ...
  %6188 = call i8* @hypre_MAlloc(i64 %6187, i32 0) #6
  %6189 = bitcast i8* %6188 to double**
  %6190 = call i8* @hypre_MAlloc(i64 108, i32 0) #6
...
6438:                                             ; preds = %6433, %6219
  call void @hypre_Free(i8* %6188, i32 0) #6
  call void @hypre_Free(i8* %6190, i32 0) #6
...
6471:                                             ; preds = %6441, %6471
  ...
  call void @hypre_Free(i8* %6488, i32 0) #6
  ...
  call void @hypre_Free(i8* %6494, i32 0) #6
...
6501:                                             ; preds = %6471, %6441
  ...
  call void @hypre_Free(i8* %6504, i32 0) #6
  ...
  call void @hypre_Free(i8* %6507, i32 0) #6
  ...
  call void @hypre_Free(i8* %6510, i32 0) #6
  ...
  call void @hypre_Free(i8* %6513, i32 0) #6
  ...
  call void @hypre_Free(i8* %6516, i32 0) #6
...
6521:                                             ; preds = %6501, %6521
  ...
  call void @hypre_Free(i8* %6526, i32 0) #6
...
6533:                                             ; preds = %6521, %6501
  ...
  call void @hypre_Free(i8* %6536, i32 0) #6
  ...
  call void @hypre_Free(i8* %6539, i32 0) #6
...
6542:                                             ; preds = %6533, %6166
  call void @hypre_Free(i8* %152, i32 0) #6
  call void @hypre_Free(i8* %154, i32 0) #6
  call void @hypre_Free(i8* %156, i32 0) #6
  call void @hypre_Free(i8* %158, i32 0) #6
  call void @hypre_Free(i8* %160, i32 0) #6
  call void @hypre_Free(i8* %162, i32 0) #6

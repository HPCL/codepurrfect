...
define dso_local i32 @hypre_BoomerAMGCreateSmoothVecs(i8* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, i32 %2, i32 %3, double** nocapture %4) local_unnamed_addr #0 {
  ...
  %16 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 14
  %17 = load i32*, i32** %16, align 8, !tbaa !51
  %18 = getelementptr inbounds i8, i8* %0, i64 796
  %19 = bitcast i8* %18 to i32*
  %20 = load i32, i32* %19, align 4, !tbaa !52
  %21 = getelementptr inbounds i8, i8* %0, i64 1092
...
31:                                               ; preds = %29, %27
  %32 = getelementptr inbounds i8, i8* %0, i64 508
...
36:                                               ; preds = %31
  %37 = getelementptr inbounds i8, i8* %0, i64 512
  %38 = bitcast i8* %37 to i32*
  %39 = load i32, i32* %38, align 8, !tbaa !56
  %40 = getelementptr inbounds i8, i8* %0, i64 520
  ...
  %43 = getelementptr inbounds i8, i8* %0, i64 528
...
46:                                               ; preds = %36, %31
  ...
  %50 = getelementptr inbounds i8, i8* %0, i64 240
...
77:                                               ; preds = %70, %65
  ...
  %86 = sext i32 %85 to i64
  %87 = call i8* @hypre_CAlloc(i64 %86, i64 8, i32 0) #7
...
define dso_local i32 @hypre_BoomerAMGCreateSmoothDirs(i8* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, double* nocapture %2, double %3, i32 %4, i32* nocapture readonly %5, %struct.hypre_ParCSRMatrix_struct** nocapture %6) local_unnamed_addr #0 {
  %8 = getelementptr inbounds i8, i8* %0, i64 1092
  ...
  %12 = getelementptr inbounds i8, i8* %0, i64 796
...
84:                                               ; preds = %79
  call void @hypre_error_handler(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i64 0, i64 0), i32 677, i32 1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i64 0, i64 0)) #7
  br label %85
...
331:                                              ; preds = %328, %260
  ...
  %337 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 15
  ...
  %343 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %342, i64 0, i32 8
  ...
  %350 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %342, i64 0, i32 9
  ...
  %357 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %342, i64 0, i32 19
...
406:                                              ; preds = %401, %384
  ...
  %409 = call i8* @hypre_CAlloc(i64 %408, i64 4, i32 0) #7
  %410 = bitcast i8* %409 to i32*
  %411 = call i8* @hypre_CAlloc(i64 %408, i64 4, i32 0) #7
...
440:                                              ; preds = %435
  %441 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %342, i64 0, i32 12
...
define dso_local i32 @hypre_BoomerAMGBuildInterpGSMG(%struct.hypre_ParCSRMatrix_struct* nocapture readnone %0, i32* nocapture readonly %1, %struct.hypre_ParCSRMatrix_struct* %2, i32* %3, i32 %4, i32* nocapture readonly %5, i32 %6, double %7, %struct.hypre_ParCSRMatrix_struct** nocapture %8) local_unnamed_addr #0 {
  ...
  %41 = load i32, i32* %40, align 8, !tbaa !91
...
735:                                              ; preds = %728, %318
  ...
  %738 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 15
  %739 = load i32*, i32** %738, align 8, !tbaa !84
  %740 = load i32, i32* %289, align 4, !tbaa !27
  %741 = getelementptr inbounds i32, i32* %291, i64 %199
  %742 = load i32, i32* %741, align 4, !tbaa !27
  ...
  %744 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %743, i64 0, i32 8
  ...
  store i8* %287, i8** %747, align 8, !tbaa !14
  ...
  store i8* %285, i8** %750, align 8, !tbaa !13
  %751 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %743, i64 0, i32 9
  %752 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %751, align 8, !tbaa !15
  %753 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %752, i64 0, i32 9
  %754 = bitcast double** %753 to i8**
  store i8* %295, i8** %754, align 8, !tbaa !14
  ...
  store i8* %293, i8** %757, align 8, !tbaa !13
  %758 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %743, i64 0, i32 19
...
760:                                              ; preds = %735
  ...
  %764 = load i32*, i32** %756, align 8, !tbaa !13
...
771:                                              ; preds = %767
  ...
  %773 = call i8* @hypre_CAlloc(i64 %772, i64 4, i32 0) #7
...
778:                                              ; preds = %776, %778
  ...
  %781 = load i32, i32* %780, align 4, !tbaa !27
  %782 = getelementptr inbounds i32, i32* %774, i64 %779
  store i32 %781, i32* %782, align 4, !tbaa !27
...
788:                                              ; preds = %785
  %789 = load i32, i32* %774, align 4, !tbaa !27
...
791:                                              ; preds = %788, %802
  ...
  %796 = load i32, i32* %795, align 4, !tbaa !27
...
798:                                              ; preds = %791
  ...
  store i32 %796, i32* %801, align 4, !tbaa !27
  br label %802
...
807:                                              ; preds = %802, %785
  ...
  %810 = call i8* @hypre_CAlloc(i64 %809, i64 4, i32 0) #7
  %811 = bitcast i8* %810 to i32*
  %812 = call i8* @hypre_CAlloc(i64 %809, i64 4, i32 0) #7
...
821:                                              ; preds = %815, %821
  ...
  %824 = load i32, i32* %823, align 4, !tbaa !27
  %825 = getelementptr inbounds i32, i32* %813, i64 %822
  store i32 %824, i32* %825, align 4, !tbaa !27
...
841:                                              ; preds = %836
  %842 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %743, i64 0, i32 12
  ...
  store i32 %837, i32* %843, align 4, !tbaa !23
  br label %844
...
844:                                              ; preds = %841, %836
  ...
  store %struct.hypre_ParCSRMatrix_struct* %743, %struct.hypre_ParCSRMatrix_struct** %8, align 8, !tbaa !65
  ...
  %847 = load i32, i32* %11, align 4, !tbaa !27
...
!62 = !{!63, !8, i64 0}
!63 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}

...
define dso_local i32 @hypre_BoomerAMGSetupStats(i8* readonly %0, %struct.hypre_ParCSRMatrix_struct* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %48 = getelementptr inbounds i8, i8* %0, i64 1508
...
217:                                              ; preds = %208
  ...
  %223 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %222, i64 0, i32 21
  br label %224
...
249:                                              ; preds = %236
  ...
  %254 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %251, i64 0, i32 21
...
484:                                              ; preds = %321
  ...
  %487 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %486, i64 0, i32 8
...
494:                                              ; preds = %484, %492
  ...
  %501 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %500, i64 0, i32 9
...
508:                                              ; preds = %494, %506
  ...
  %515 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %514, i64 0, i32 14
  ...
  %519 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %514, i64 0, i32 22
...
999:                                              ; preds = %785
  ...
  %1002 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1001, i64 0, i32 8
...
1009:                                             ; preds = %999, %1007
  ...
  %1016 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1015, i64 0, i32 9
...
1023:                                             ; preds = %1009, %1021
  ...
  %1030 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1029, i64 0, i32 14
  ...
  %1038 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1037, i64 0, i32 22
...
1732:                                             ; preds = %1730
  %1733 = getelementptr inbounds i8, i8* %0, i64 544
...
define dso_local i32 @hypre_BoomerAMGWriteSolverParams(i8* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %29 = getelementptr inbounds i8, i8* %0, i64 832

...
define dso_local %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixCreate(i32 %0, i32 %1, i32 %2, i32 %3, i32* %4, i32* %5, i32 %6, i32 %7, i32 %8) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_CAlloc(i64 1, i64 144, i32 0) #6
...
35:                                               ; preds = %31
  ...
  call void @hypre_Free(i8* %38, i32 0) #6
...
53:                                               ; preds = %51, %47
  ...
  call void @hypre_Free(i8* nonnull %54, i32 0) #6
  br label %55
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRBlockMatrixCompress(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %24 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %22, i64 0, i32 8
  ...
  %28 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %22, i64 0, i32 9
...
33:                                               ; preds = %1
  %34 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %22, i64 0, i32 12
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRBlockMatrixConvertToParCSRMatrix(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %27 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
  %28 = bitcast i8* %27 to i32*
  %29 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
...
43:                                               ; preds = %31
  ...
  %53 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %51, i64 0, i32 8
...
62:                                               ; preds = %59, %43
  %63 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %51, i64 0, i32 9
...
72:                                               ; preds = %69, %62
  ...
  %74 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %51, i64 0, i32 12
...
103:                                              ; preds = %102
  ...
  %107 = call i8* @hypre_CAlloc(i64 %104, i64 4, i32 0) #6
  ...
  %112 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %51, i64 0, i32 12
...
161:                                              ; preds = %152, %148
  ...
  %163 = call i8* @hypre_CAlloc(i64 %162, i64 4, i32 0) #6
...
191:                                              ; preds = %190, %102
  ...
  %194 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %51, i64 0, i32 16
  store %struct._hypre_ParCSRCommPkg* null, %struct._hypre_ParCSRCommPkg** %194, align 8, !tbaa !56
...
define dso_local %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixConvertFromParCSRMatrix(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %28 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
  %29 = bitcast i8* %28 to i32*
  %30 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
...
79:                                               ; preds = %66, %56
  ...
  %84 = call i8* @hypre_CAlloc(i64 %57, i64 4, i32 0) #6
...
109:                                              ; preds = %103, %79
  %110 = call i8* @hypre_CAlloc(i64 %81, i64 4, i32 0) #6
...
186:                                              ; preds = %174
  ...
  %188 = call i8* @hypre_CAlloc(i64 %187, i64 4, i32 0) #6
  %189 = bitcast i8* %188 to i32*
  %190 = mul i32 %1, %1
  %191 = mul i32 %190, %175
  %192 = sext i32 %191 to i64
  %193 = call i8* @hypre_CAlloc(i64 %192, i64 8, i32 0) #6
...
282:                                              ; preds = %278, %202, %174
  ...
  store %struct._hypre_ParCSRCommPkg* null, %struct._hypre_ParCSRCommPkg** %295, align 8, !tbaa !28
...
20:                                               ; preds = %4
  %21 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
...
!48 = !{!49, !4, i64 8}
!49 = !{!"", !4, i64 0, !4, i64 8, !4, i64 16, !8, i64 24, !8, i64 28, !8, i64 32, !4, i64 40, !4, i64 48, !8, i64 56, !4, i64 64, !4, i64 72, !8, i64 80, !5, i64 84}
!50 = !{!49, !8, i64 32}

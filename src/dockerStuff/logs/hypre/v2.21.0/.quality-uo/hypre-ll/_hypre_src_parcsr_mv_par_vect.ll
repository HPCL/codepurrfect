...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_ParVectorGetValuesHost(%struct.hypre_ParVector_struct* nocapture readonly %0, i32 %1, i32* readonly %2, double* nocapture %3) local_unnamed_addr #0 {
...
28:                                               ; preds = %18
  ...
  store double %32, double* %33, align 8, !tbaa !28
  br label %34

34:                                               ; preds = %28, %26
  %35 = phi i32 [ %27, %26 ], [ %20, %28 ]
  %36 = add nuw nsw i64 %19, 1
  %37 = icmp eq i64 %36, %17
  br i1 %37, label %38, label %18, !llvm.loop !62

38:                                               ; preds = %34, %14
  %39 = phi i32 [ 0, %14 ], [ %35, %34 ]
  %40 = icmp eq i32 %39, 0
  br i1 %40, label %59, label %41

41:                                               ; preds = %38
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1063, i32 28, i8* null) #4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 1064, i32 1, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.14, i64 0, i64 0)) #4
  %42 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.15, i64 0, i64 0)) #4
  br label %59

43:                                               ; preds = %4
  %44 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %10, i64 0, i32 1
...
52:                                               ; preds = %49, %52
  ...
  %56 = getelementptr inbounds double, double* %3, i64 %53
  store double %55, double* %56, align 8, !tbaa !28
  %57 = add nuw nsw i64 %53, 1
  %58 = icmp eq i64 %57, %50
  br i1 %58, label %59, label %52, !llvm.loop !63

59:                                               ; preds = %52, %47, %41, %38, %51
  %60 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
  ret i32 %60
}
...
define dso_local i32 @hypre_ParVectorGetValues(%struct.hypre_ParVector_struct* nocapture readonly %0, i32 %1, i32* readonly %2, double* nocapture %3) local_unnamed_addr #0 {
  %5 = call i32 @hypre_ParVectorGetValuesHost(%struct.hypre_ParVector_struct* %0, i32 %1, i32* %2, double* %3)

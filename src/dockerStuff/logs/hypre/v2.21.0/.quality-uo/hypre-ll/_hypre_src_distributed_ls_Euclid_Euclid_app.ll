...
define dso_local void @Euclid_dhApply(%struct._mpi_interface_dh* %0, double* %1, double* %2) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 24, i32 1) #3
...
20:                                               ; preds = %18, %20
  ...
  br i1 %26, label %123, label %20, !llvm.loop !14

27:                                               ; preds = %12
  %28 = getelementptr inbounds %struct._mpi_interface_dh, %struct._mpi_interface_dh* %0, i64 0, i32 8
  %29 = load %struct._subdomain_dh*, %struct._subdomain_dh** %28, align 8, !tbaa !17
  %30 = icmp eq %struct._subdomain_dh* %29, null
  br i1 %30, label %56, label %31

31:                                               ; preds = %27
  call void @dh_StartFunc(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 148, i32 1) #3
  %32 = load i32, i32* %6, align 8, !tbaa !11
  %33 = load %struct._subdomain_dh*, %struct._subdomain_dh** %28, align 8, !tbaa !17
...
39:                                               ; preds = %39, %37
  ...
  store double %45, double* %46, align 8, !tbaa !13
  %47 = add nuw nsw i64 %40, 1
  %48 = icmp eq i64 %47, %38
  br i1 %48, label %49, label %39, !llvm.loop !21

49:                                               ; preds = %39, %31
  call void @dh_EndFunc(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 1) #3
  %50 = load i8, i8* @errFlag_dh, align 1, !tbaa !22, !range !23
  %51 = icmp eq i8 %50, 0
  br i1 %51, label %53, label %52

52:                                               ; preds = %49
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 49) #3
  br label %139
...
56:                                               ; preds = %27, %53
  ...
  %60 = load i8, i8* %59, align 8, !tbaa !25, !range !23
  %61 = icmp eq i8 %60, 0
  br i1 %61, label %84, label %62

62:                                               ; preds = %56
  call void @dh_StartFunc(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 117, i32 1) #3
  %63 = load i32, i32* %6, align 8, !tbaa !11
...
71:                                               ; preds = %71, %69
  ...
  store double %77, double* %75, align 8, !tbaa !13
...
80:                                               ; preds = %71, %62
  ...
  %81 = load i8, i8* @errFlag_dh, align 1, !tbaa !22, !range !23
  %82 = icmp eq i8 %81, 0
  br i1 %82, label %84, label %83

83:                                               ; preds = %80
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 62) #3
  br label %139

84:                                               ; preds = %80, %56
  %85 = load i32, i32* @np_dh, align 4, !tbaa !20
  %86 = icmp eq i32 %85, 1
...
90:                                               ; preds = %87, %84
  ...
  %91 = load i8, i8* @errFlag_dh, align 1, !tbaa !22, !range !23
  %92 = icmp eq i8 %91, 0
  br i1 %92, label %98, label %93

93:                                               ; preds = %90
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 76) #3
  br label %139

94:                                               ; preds = %87
  call void @Factor_dhSolve(double* %58, double* %57, %struct._mpi_interface_dh* %0) #3
  %95 = load i8, i8* @errFlag_dh, align 1, !tbaa !22, !range !23
  %96 = icmp eq i8 %95, 0
  br i1 %96, label %98, label %97

97:                                               ; preds = %94
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 82) #3
  br label %139

98:                                               ; preds = %94, %90
  %99 = load %struct._subdomain_dh*, %struct._subdomain_dh** %28, align 8, !tbaa !17
  %100 = icmp eq %struct._subdomain_dh* %99, null
  br i1 %100, label %123, label %101

101:                                              ; preds = %98
  call void @dh_StartFunc(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 136, i32 1) #3
  %102 = load i32, i32* %6, align 8, !tbaa !11
  %103 = load %struct._subdomain_dh*, %struct._subdomain_dh** %28, align 8, !tbaa !17
...
109:                                              ; preds = %109, %107
  ...
  store double %115, double* %116, align 8, !tbaa !13
...
119:                                              ; preds = %109, %101
  ...
  %120 = load i8, i8* @errFlag_dh, align 1, !tbaa !22, !range !23
  %121 = icmp eq i8 %120, 0
  br i1 %121, label %123, label %122

122:                                              ; preds = %119
  call void @setError_dh(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.1, i64 0, i64 0), i32 90) #3
  br label %139
...
123:                                              ; preds = %20, %16, %98, %119
  ...
  store double %128, double* %126, align 8, !tbaa !13
  ...
  store double %131, double* %132, align 8, !tbaa !13
  ...
  store i32 %135, i32* %133, align 8, !tbaa !30
  ...
  store i32 %138, i32* %136, align 4, !tbaa !31
...
!17 = !{!4, !10, i64 56}
!18 = !{!19, !10, i64 136}
!19 = !{!"_subdomain_dh", !9, i64 0, !10, i64 8, !10, i64 16, !10, i64 24, !10, i64 32, !9, i64 40, !5, i64 44, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !10, i64 88, !9, i64 96, !10, i64 104, !9, i64 112, !10, i64 120, !9, i64 128, !9, i64 132, !10, i64 136, !10, i64 144, !10, i64 152, !10, i64 160, !6, i64 168, !5, i64 248}
!20 = !{!9, !9, i64 0}

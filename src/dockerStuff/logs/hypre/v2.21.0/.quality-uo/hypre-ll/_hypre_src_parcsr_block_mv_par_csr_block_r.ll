...
define dso_local i32 @hypre_ParCSRBlockMatrixRAP(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0, %struct.hypre_ParCSRBlockMatrix* %1, %struct.hypre_ParCSRBlockMatrix* %2, %struct.hypre_ParCSRBlockMatrix** nocapture %3) local_unnamed_addr #0 {
  ...
  %71 = call i32 @hypre_MPI_Comm_size(i32 %9, i32* nonnull %7) #4
  %72 = mul nsw i32 %29, %29
  %73 = zext i32 %72 to i64
  %74 = shl nuw nsw i64 %73, 3
  %75 = call i8* @hypre_MAlloc(i64 %74, i32 0) #4
  %76 = bitcast i8* %75 to double*
  %77 = call i8* @hypre_MAlloc(i64 %74, i32 0) #4
...
89:                                               ; preds = %80, %4
  ...
  %94 = call i32 @hypre_CSRBlockMatrixTranspose(%struct.hypre_CSRBlockMatrix* %11, %struct.hypre_CSRBlockMatrix** nonnull %5, i32 1) #4
  %95 = icmp eq i32 %15, 0
  br i1 %95, label %105, label %96

96:                                               ; preds = %89
  %97 = call i32 @hypre_CSRBlockMatrixTranspose(%struct.hypre_CSRBlockMatrix* %13, %struct.hypre_CSRBlockMatrix** nonnull %6, i32 1) #4
...
121:                                              ; preds = %105
  %122 = call %struct.hypre_CSRBlockMatrix* @hypre_ParCSRBlockMatrixExtractBExt(%struct.hypre_ParCSRBlockMatrix* %2, %struct.hypre_ParCSRBlockMatrix* %1, i32 1) #4
...
129:                                              ; preds = %121, %105
  ...
  %136 = call i8* @hypre_CAlloc(i64 %135, i64 4, i32 0) #4
  %137 = bitcast i8* %136 to i32*
  %138 = call i8* @hypre_CAlloc(i64 %135, i64 4, i32 0) #4
...
183:                                              ; preds = %179
  ...
  %185 = call i8* @hypre_CAlloc(i64 %184, i64 4, i32 0) #4
  %186 = bitcast i8* %185 to i32*
  %187 = mul nsw i32 %180, %72
  %188 = sext i32 %187 to i64
  %189 = call i8* @hypre_CAlloc(i64 %188, i64 8, i32 0) #4
...
195:                                              ; preds = %191
  ...
  %197 = call i8* @hypre_CAlloc(i64 %196, i64 4, i32 0) #4
  %198 = bitcast i8* %197 to i32*
  %199 = mul nsw i32 %181, %72
  %200 = sext i32 %199 to i64
  %201 = call i8* @hypre_CAlloc(i64 %200, i64 8, i32 0) #4
...
323:                                              ; preds = %319
  ...
  call void @hypre_BigQsort0(i32* %320, i32 0, i32 %324) #4
...
348:                                              ; preds = %345
  ...
  %350 = call i8* @hypre_CAlloc(i64 %349, i64 4, i32 0) #4
...
365:                                              ; preds = %364
  ...
  call void @hypre_Free(i8* %366, i32 0) #4
  br label %367
...
371:                                              ; preds = %369, %371
  ...
  %375 = call i32 @hypre_BigBinarySearch(i32* %353, i32 %374, i32 %346) #4
...
380:                                              ; preds = %379
  ...
  %382 = call i8* @hypre_CAlloc(i64 %381, i64 4, i32 0) #4
...
409:                                              ; preds = %405
  %410 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %130) #4
  br label %411
...
416:                                              ; preds = %411
  %417 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 0) #4
...
427:                                              ; preds = %416
  ...
  %431 = call i8* @hypre_CAlloc(i64 %430, i64 4, i32 0) #4
...
433:                                              ; preds = %416, %427
  ...
  %435 = call i8* @hypre_CAlloc(i64 %421, i64 4, i32 0) #4
...
645:                                              ; preds = %454, %451
  ...
  %649 = call i8* @hypre_CAlloc(i64 %648, i64 4, i32 0) #4
  %650 = bitcast i8* %649 to i32*
  %651 = mul nsw i32 %646, %72
  %652 = sext i32 %651 to i64
  %653 = call i8* @hypre_CAlloc(i64 %652, i64 8, i32 0) #4
  %654 = bitcast i8* %653 to double*
  %655 = sext i32 %646 to i64
  %656 = call i8* @hypre_CAlloc(i64 %655, i64 4, i32 0) #4
...
768:                                              ; preds = %766, %977
  ...
  %775 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %757, double* %774, double 0.000000e+00, double* %76, i32 %29) #4
...
791:                                              ; preds = %789, %834
  ...
  %798 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %797, double 0.000000e+00, double* %78, i32 %29) #4
...
849:                                              ; preds = %847, %895
  ...
  %857 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %856, double 0.000000e+00, double* %78, i32 %29) #4
...
911:                                              ; preds = %909, %934
  ...
  %917 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %916, double 0.000000e+00, double* %78, i32 %29) #4
...
947:                                              ; preds = %945, %972
  ...
  %953 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %952, double 0.000000e+00, double* %78, i32 %29) #4
...
992:                                              ; preds = %990, %1215
  ...
  %999 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %757, double* %998, double 0.000000e+00, double* %76, i32 %29) #4
...
1017:                                             ; preds = %1015, %1062
  ...
  %1024 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1023, double 0.000000e+00, double* %78, i32 %29) #4
...
1077:                                             ; preds = %1075, %1128
  ...
  %1088 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1087, double 0.000000e+00, double* %78, i32 %29) #4
...
1145:                                             ; preds = %1143, %1169
  ...
  %1151 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1150, double 0.000000e+00, double* %78, i32 %29) #4
...
1182:                                             ; preds = %1180, %1210
  ...
  %1191 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %1190, double 0.000000e+00, double* %78, i32 %29) #4
...
1230:                                             ; preds = %1227, %1228
  ...
  %1232 = call %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixCreate(i32 %29, i32 %15, i32 %17, i32 %646) #4
  ...
  call void @hypre_Free(i8* %417, i32 0) #4
  br label %1238
...
1262:                                             ; preds = %1256
  %1263 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %1239) #4
  br label %1264

1264:                                             ; preds = %1262, %1256
  %1265 = add nsw i32 %63, 1
  %1266 = sext i32 %1265 to i64
  %1267 = call i8* @hypre_CAlloc(i64 %1266, i64 4, i32 0) #4
  %1268 = bitcast i8* %1267 to i32*
  %1269 = call i8* @hypre_CAlloc(i64 %1266, i64 4, i32 0) #4
...
1273:                                             ; preds = %1264
  ...
  %1276 = call i8* @hypre_CAlloc(i64 %1275, i64 4, i32 0) #4
...
1317:                                             ; preds = %1314
  ...
  call void @hypre_BigQsort0(i32* %1277, i32 0, i32 %1318) #4
...
1342:                                             ; preds = %1339
  ...
  %1344 = call i8* @hypre_CAlloc(i64 %1343, i64 4, i32 0) #4
...
1358:                                             ; preds = %1351, %1346
  call void @hypre_Free(i8* %1276, i32 0) #4
  br label %1359
...
1362:                                             ; preds = %1359
  ...
  %1364 = call i8* @hypre_CAlloc(i64 %1363, i64 4, i32 0) #4
...
1389:                                             ; preds = %1387
  ...
  %1391 = call i8* @hypre_CAlloc(i64 %1390, i64 4, i32 0) #4
...
1426:                                             ; preds = %1419
  %1427 = call i32 @hypre_BigBinarySearch(i32* %1361, i32 %1422, i32 %1360) #4
...
1435:                                             ; preds = %1431, %1414
  ...
  %1442 = call i8* @hypre_CAlloc(i64 %1441, i64 4, i32 0) #4
  %1443 = bitcast i8* %412 to i8**
  store i8* %1442, i8** %1443, align 8, !tbaa !42
  %1444 = sext i32 %118 to i64
  %1445 = call i8* @hypre_CAlloc(i64 %1444, i64 4, i32 0) #4
...
1755:                                             ; preds = %1747
  ...
  %1758 = call i8* @hypre_CAlloc(i64 %1757, i64 8, i32 0) #4
  %1759 = bitcast i8* %1758 to double*
  %1760 = sext i32 %1750 to i64
  %1761 = call i8* @hypre_CAlloc(i64 %1760, i64 4, i32 0) #4
...
1767:                                             ; preds = %1763
  ...
  %1770 = call i8* @hypre_CAlloc(i64 %1769, i64 8, i32 0) #4
  %1771 = bitcast i8* %1770 to double*
  %1772 = sext i32 %1749 to i64
  %1773 = call i8* @hypre_CAlloc(i64 %1772, i64 4, i32 0) #4
...
1780:                                             ; preds = %1775
  ...
  call void @hypre_Free(i8* %1781, i32 0) #4
  br label %1782
...
2063:                                             ; preds = %2061, %2280
  ...
  %2071 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %2051, double* %2070, double 0.000000e+00, double* %76, i32 %29) #4
...
2087:                                             ; preds = %2085, %2131
  ...
  %2094 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2093, double 0.000000e+00, double* %78, i32 %29) #4
...
2146:                                             ; preds = %2144, %2194
  ...
  %2157 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2156, double 0.000000e+00, double* %78, i32 %29) #4
...
2210:                                             ; preds = %2208, %2234
  ...
  %2216 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2215, double 0.000000e+00, double* %78, i32 %29) #4
...
2247:                                             ; preds = %2245, %2275
  ...
  %2256 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2255, double 0.000000e+00, double* %78, i32 %29) #4
...
2300:                                             ; preds = %2298, %2523
  ...
  %2308 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %2051, double* %2307, double 0.000000e+00, double* %76, i32 %29) #4
...
2326:                                             ; preds = %2324, %2371
  ...
  %2333 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2332, double 0.000000e+00, double* %78, i32 %29) #4
...
2387:                                             ; preds = %2385, %2435
  ...
  %2398 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2397, double 0.000000e+00, double* %78, i32 %29) #4
...
2452:                                             ; preds = %2450, %2476
  ...
  %2458 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2457, double 0.000000e+00, double* %78, i32 %29) #4
...
2490:                                             ; preds = %2488, %2518
  ...
  %2499 = call i32 @hypre_CSRBlockMatrixBlockMultAdd(double* %76, double* %2498, double 0.000000e+00, double* %78, i32 %29) #4
...
2537:                                             ; preds = %1879, %1805
  ...
  call void @hypre_Free(i8* %2539, i32 0) #4
  store i32* null, i32** %415, align 8, !tbaa !42
  %2540 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #4
  %2541 = bitcast i8* %2540 to i32*
  %2542 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #4
...
2552:                                             ; preds = %2544
  %2553 = call %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixCreate(i32 %9, i32 %29, i32 %117, i32 %117, i32* %2541, i32* %2543, i32 %1783, i32 %1750, i32 %1749) #4
...
2574:                                             ; preds = %2571
  %2575 = call i32 @hypre_BlockMatvecCommPkgCreate(%struct.hypre_ParCSRBlockMatrix* %2553) #4
  br label %2576
...
2576:                                             ; preds = %2574, %2571
  ...
  %2578 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %2577) #4
...
2579:                                             ; preds = %2576
  ...
  %2581 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %2580) #4
...
2583:                                             ; preds = %2582
  %2584 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %1261) #4
  br label %2585
...
2586:                                             ; preds = %2585
  ...
  call void @hypre_Free(i8* %2587, i32 0) #4
  %2588 = bitcast i32* %1388 to i8*
  call void @hypre_Free(i8* %2588, i32 0) #4
  br label %2589
...
2590:                                             ; preds = %2589
  ...
  call void @hypre_Free(i8* %2591, i32 0) #4
  %2592 = bitcast i32* %1415 to i8*
  call void @hypre_Free(i8* %2592, i32 0) #4
  br label %2593
...
2594:                                             ; preds = %2593
  ...
  call void @hypre_Free(i8* %2595, i32 0) #4
  %2596 = bitcast i32* %193 to i8*
  call void @hypre_Free(i8* %2596, i32 0) #4
  br label %2597
...
2598:                                             ; preds = %2597
  ...
  call void @hypre_Free(i8* %2599, i32 0) #4
  %2600 = bitcast i32* %205 to i8*
  call void @hypre_Free(i8* %2600, i32 0) #4
  br label %2601

...
define dso_local i32 @HYPRE_SStructPCGGetResidual(%struct.hypre_SStructSolver_struct* %0, i8** %1) local_unnamed_addr #0 {
  ...
  %5 = call i32 @HYPRE_PCGGetResidual(%struct.hypre_Solver_struct* %3, i8* %4) #2
  ret i32 %5
}
...
!8 = !{!"int", !5, i64 0}
!9 = !{!10, !8, i64 24}
!10 = !{!"hypre_SStructMatrix_struct", !8, i64 0, !8, i64 4, !4, i64 8, !4, i64 16, !8, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !8, i64 64, !4, i64 72, !4, i64 80, !8, i64 88, !4, i64 96, !4, i64 104, !4, i64 112, !4, i64 120, !4, i64 128, !4, i64 136, !8, i64 144, !8, i64 148, !8, i64 152, !8, i64 156}
!11 = !{!10, !4, i64 32}
!12 = !{!13, !4, i64 24}

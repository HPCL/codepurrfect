...
336:                                              ; preds = %330, %175
  ...
  %348 = call i8* @hypre_CAlloc(i64 %345, i64 8, i32 0) #6
  %349 = bitcast i8* %348 to double*
  %350 = call i8* @hypre_CAlloc(i64 %342, i64 4, i32 0) #6
  %351 = bitcast i8* %350 to i32*
  %352 = sext i32 %338 to i64
  %353 = call i8* @hypre_CAlloc(i64 %352, i64 4, i32 0) #6
  %354 = bitcast i8* %353 to i32*
  %355 = call i8* @hypre_CAlloc(i64 %352, i64 8, i32 0) #6

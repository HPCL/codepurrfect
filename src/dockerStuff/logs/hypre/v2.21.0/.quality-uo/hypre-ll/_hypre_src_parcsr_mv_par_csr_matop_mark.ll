...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParMatmul_FC(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, i32* nocapture readonly %2, i32* readonly %3, i32* nocapture readonly %4) local_unnamed_addr #0 {
  ...
  %48 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 12
  ...
  %56 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 5
  %57 = load i32, i32* %56, align 4, !tbaa !31
  %58 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 15
...
97:                                               ; preds = %89, %85
  ...
  %104 = call i8* @hypre_CAlloc(i64 %103, i64 4, i32 0) #5
  %105 = bitcast i8* %104 to i32*
  %106 = call i8* @hypre_CAlloc(i64 %103, i64 4, i32 0) #5
...
151:                                              ; preds = %147
  ...
  %155 = call i8* @hypre_CAlloc(i64 %152, i64 8, i32 0) #5
...
161:                                              ; preds = %157
  ...
  %165 = call i8* @hypre_CAlloc(i64 %162, i64 4, i32 0) #5
  %166 = bitcast i8* %165 to i32*
  %167 = call i8* @hypre_CAlloc(i64 %162, i64 8, i32 0) #5
...
294:                                              ; preds = %291
  ...
  %296 = call i8* @hypre_CAlloc(i64 %295, i64 4, i32 0) #5
...
311:                                              ; preds = %310
  ...
  call void @hypre_Free(i8* %312, i32 0) #5
  br label %313
...
369:                                              ; preds = %363, %357
  ...
  %372 = call i8* @hypre_CAlloc(i64 %371, i64 8, i32 0) #5
  %373 = bitcast i8* %372 to double*
  %374 = call i8* @hypre_CAlloc(i64 %371, i64 4, i32 0) #5
...
378:                                              ; preds = %369
  ...
  %380 = call i8* @hypre_CAlloc(i64 %379, i64 8, i32 0) #5
  %381 = bitcast i8* %380 to double*
  %382 = call i8* @hypre_CAlloc(i64 %379, i64 4, i32 0) #5
...
691:                                              ; preds = %686, %396
  ...
  %695 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %692, i64 0, i32 8
  ...
  %703 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %692, i64 0, i32 9
...
707:                                              ; preds = %691
  ...
  %710 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %692, i64 0, i32 12
  store i32* %299, i32** %710, align 8, !tbaa !30
  br label %711

711:                                              ; preds = %707, %691
  call void @hypre_Free(i8* %360, i32 0) #5
...
716:                                              ; preds = %715
  ...
  call void @hypre_Free(i8* %718, i32 0) #5
  br label %719
...
720:                                              ; preds = %719
  ...
  call void @hypre_Free(i8* %721, i32 0) #5
  br label %722
...
!18 = !{!19, !8, i64 0}
!19 = !{!"hypre_ParCSRMatrix_struct", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !4, i64 72, !4, i64 80, !4, i64 88, !4, i64 96, !4, i64 104, !8, i64 112, !8, i64 116, !8, i64 120, !8, i64 124, !20, i64 128, !4, i64 136, !4, i64 144, !8, i64 152, !4, i64 160, !8, i64 168, !4, i64 176, !8, i64 184, !4, i64 192, !4, i64 200}
!20 = !{!"double", !5, i64 0}
!21 = !{!19, !4, i64 32}
!22 = !{!23, !4, i64 64}

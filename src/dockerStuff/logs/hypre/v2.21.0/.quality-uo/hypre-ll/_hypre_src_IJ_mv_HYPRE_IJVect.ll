...
define dso_local i32 @HYPRE_IJVectorCreate(i32 %0, i32 %1, i32 %2, %struct.hypre_IJVector_struct** nocapture %3) local_unnamed_addr #0 {
  ...
  %13 = call i8* @hypre_CAlloc(i64 1, i64 64, i32 0) #5
  %14 = icmp eq i8* %13, null
  br i1 %14, label %15, label %16

15:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 38, i32 2, i8* null) #5
  br label %61
...
23:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 47, i32 20, i8* null) #5
...
26:                                               ; preds = %24
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 53, i32 28, i8* null) #5
  br label %61

27:                                               ; preds = %24
  %28 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #5
...
3:                                                ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 106, i32 12, i8* null) #5
  br label %31
...
8:                                                ; preds = %4
  ...
  call void @hypre_Free(i8* nonnull %9, i32 0) #5
...
28:                                               ; preds = %17
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 131, i32 12, i8* null) #5
  br label %31

29:                                               ; preds = %17, %20, %25
  %30 = bitcast %struct.hypre_IJVector_struct* %0 to i8*
  call void @hypre_Free(i8* nonnull %30, i32 0) #5
  br label %31
...
3:                                                ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 151, i32 12, i8* null) #5
  br label %19
...
18:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 166, i32 12, i8* null) #5
  br label %19
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 179, i32 12, i8* null) #5
  br label %20
...
13:                                               ; preds = %9
  %14 = getelementptr inbounds %struct.hypre_IJVector_struct, %struct.hypre_IJVector_struct* %0, i64 0, i32 1
  %15 = load i32*, i32** %14, align 8, !tbaa !12
  %16 = call i32 @hypre_IJVectorCreatePar(%struct.hypre_IJVector_struct* nonnull %0, i32* %15) #5
  br label %17

17:                                               ; preds = %13, %9
  %18 = call i32 @hypre_IJVectorInitializePar_v2(%struct.hypre_IJVector_struct* nonnull %0, i32 %1) #5
  br label %20

19:                                               ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 194, i32 12, i8* null) #5
  br label %20
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 212, i32 12, i8* null) #5
  br label %7
...
10:                                               ; preds = %8
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 237, i32 12, i8* null) #5
...
14:                                               ; preds = %12
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 243, i32 20, i8* null) #5
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 249, i32 36, i8* null) #5
...
26:                                               ; preds = %20
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 270, i32 12, i8* null) #5
...
10:                                               ; preds = %8
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 292, i32 12, i8* null) #5
  %11 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
  br label %28
...
14:                                               ; preds = %12
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 298, i32 20, i8* null) #5
  %15 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
  br label %28
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 304, i32 36, i8* null) #5
  %19 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
  br label %28
...
26:                                               ; preds = %20
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 325, i32 12, i8* null) #5
  %27 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
  br label %28
...
3:                                                ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 342, i32 12, i8* null) #5
...
11:                                               ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 363, i32 12, i8* null) #5
...
10:                                               ; preds = %8
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 385, i32 12, i8* null) #5
  %11 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
  br label %28
...
14:                                               ; preds = %12
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 391, i32 20, i8* null) #5
  %15 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
  br label %28
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 397, i32 36, i8* null) #5
  %19 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
  br label %28
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 425, i32 12, i8* null) #5
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 453, i32 12, i8* null) #5
  br label %7
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 474, i32 12, i8* null) #5
  br label %8
...
7:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 499, i32 12, i8* null) #5
  br label %18
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 524, i32 12, i8* null) #5
  br label %8
...
24:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 557, i32 12, i8* null) #5
  br label %93
...
49:                                               ; preds = %45, %41
  %50 = call i32 @hypre_IJVectorInitializePar_v2(%struct.hypre_IJVector_struct* nonnull %30, i32 0) #5
  br label %52
...
57:                                               ; preds = %55
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 576, i32 1, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5, i64 0, i64 0)) #5
  br label %93
...
8:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 616, i32 12, i8* null) #5
  br label %85
...
17:                                               ; preds = %9
  call void @hypre_error_handler(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 627, i32 20, i8* null) #5
  br label %85

18:                                               ; preds = %9
  %19 = getelementptr inbounds %struct.hypre_IJVector_struct, %struct.hypre_IJVector_struct* %0, i64 0, i32 1
  ...
  %26 = add nsw i32 %25, 1
  %27 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %15, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i64 0, i64 0), i32 %21, i32 %24) #5
  %28 = getelementptr inbounds %struct.hypre_IJVector_struct, %struct.hypre_IJVector_struct* %0, i64 0, i32 3
  %29 = load i8*, i8** %28, align 8, !tbaa !18
  %30 = icmp eq i8* %29, null
  br i1 %30, label %41, label %31

31:                                               ; preds = %18
  %32 = getelementptr inbounds %struct.hypre_IJVector_struct, %struct.hypre_IJVector_struct* %0, i64 0, i32 2
...
35:                                               ; preds = %31
  ...
  %37 = bitcast i8* %36 to %struct.hypre_Vector**
  %38 = load %struct.hypre_Vector*, %struct.hypre_Vector** %37, align 8, !tbaa !22
  %39 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %38, i64 0, i32 3
  %40 = load i32, i32* %39, align 8, !tbaa !24
  br label %41

41:                                               ; preds = %18, %31, %35
  %42 = phi i32 [ %40, %35 ], [ -1, %31 ], [ -1, %18 ]
  %43 = sext i32 %26 to i64
  %44 = shl nsw i64 %43, 3
  %45 = call i8* @hypre_MAlloc(i64 %44, i32 %42) #5
  %46 = bitcast i8* %45 to double*
  %47 = icmp eq i32 %26, 0
  br i1 %47, label %61, label %48

48:                                               ; preds = %41
  %49 = icmp slt i32 %25, -1
...
54:                                               ; preds = %51
  %55 = getelementptr inbounds %struct.hypre_IJVector_struct, %struct.hypre_IJVector_struct* %0, i64 0, i32 2
  %56 = load i32, i32* %55, align 8, !tbaa !13
  %57 = icmp eq i32 %56, 5555
  br i1 %57, label %58, label %60

58:                                               ; preds = %54
  %59 = call i32 @hypre_IJVectorGetValuesPar(%struct.hypre_IJVector_struct* nonnull %0, i32 %26, i32* null, double* nonnull %46) #5
  br label %61
...
61:                                               ; preds = %41, %50, %53, %58, %60
  %62 = icmp ult i32 %42, 2
  br i1 %62, label %66, label %63

63:                                               ; preds = %61
  %64 = call i8* @hypre_MAlloc(i64 %44, i32 0) #5
  %65 = bitcast i8* %64 to double*
  call void @hypre_Memcpy(i8* %64, i8* %45, i64 %44, i32 0, i32 %42) #5
  br label %66

66:                                               ; preds = %61, %63
  %67 = phi double* [ %65, %63 ], [ %46, %61 ]
  %68 = phi i8* [ %64, %63 ], [ null, %61 ]
  %69 = icmp slt i32 %21, %23
...
73:                                               ; preds = %70, %73
  ...
  %79 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* nonnull %15, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.8, i64 0, i64 0), i32 %78, double %77) #5
  %80 = add nsw i64 %74, 1
  %81 = trunc i64 %80 to i32
  %82 = icmp eq i32 %23, %81
  br i1 %82, label %83, label %73, !llvm.loop !28

83:                                               ; preds = %73, %66
  call void @hypre_Free(i8* %45, i32 %42) #5
  call void @hypre_Free(i8* %68, i32 0) #5
  %84 = call i32 @fclose(%struct._IO_FILE* nonnull %15)
  br label %85
...
!22 = !{!23, !9, i64 32}
!23 = !{!"hypre_ParVector_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !9, i64 16, !4, i64 24, !9, i64 32, !4, i64 40, !4, i64 44, !9, i64 48}
!24 = !{!25, !5, i64 16}
!25 = !{!"", !9, i64 0, !4, i64 8, !4, i64 12, !5, i64 16, !4, i64 20, !4, i64 24, !4, i64 28, !4, i64 32}
!26 = !{!27, !27, i64 0}
!27 = !{!"double", !5, i64 0}

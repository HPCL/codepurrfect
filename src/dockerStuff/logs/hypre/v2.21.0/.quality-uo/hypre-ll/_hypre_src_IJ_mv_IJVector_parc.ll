...
26:                                               ; preds = %22, %20
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 680, i32 12, i8* null) #3
  %27 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  br label %65

28:                                               ; preds = %15
  %29 = icmp eq i32* %8, null
...
32:                                               ; preds = %30
  %33 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.16, i64 0, i64 0)) #3
  %34 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.23, i64 0, i64 0)) #3
  %35 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.str.17, i64 0, i64 0)) #3
  br label %36

36:                                               ; preds = %32, %30
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 692, i32 12, i8* null) #3
  %37 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  br label %65

38:                                               ; preds = %28
  %39 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %11, i64 0, i32 6
  %40 = load %struct.hypre_Vector*, %struct.hypre_Vector** %39, align 8, !tbaa !17
  %41 = icmp eq %struct.hypre_Vector* %40, null
...
48:                                               ; preds = %44, %42
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 705, i32 12, i8* null) #3
  br label %63
...
56:                                               ; preds = %54
  %57 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.13, i64 0, i64 0)) #3
  %58 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.23, i64 0, i64 0)) #3
  %59 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.14, i64 0, i64 0)) #3
  br label %60

60:                                               ; preds = %56, %54
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 720, i32 12, i8* null) #3
  br label %63

61:                                               ; preds = %49
  %62 = call i32 @hypre_ParVectorGetValues(%struct.hypre_ParVector_struct* nonnull %11, i32 %1, i32* %2, double* %3) #3
  br label %63
...
65:                                               ; preds = %4, %63, %36, %26
  %66 = phi i32 [ %64, %63 ], [ %37, %36 ], [ %27, %26 ], [ 0, %4 ]
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %6) #3
  ret i32 %66
}

declare dso_local i32 @hypre_ParVectorGetValues(%struct.hypre_ParVector_struct*, i32, i32*, double*) local_unnamed_addr #2

...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_AMESetRTol(%struct.hypre_Solver_struct* %0, double %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  %4 = call i32 @hypre_AMESetRTol(i8* %3, double %1) #2
  ret i32 %4
}

declare dso_local i32 @hypre_AMESetRTol(i8*, double) local_unnamed_addr #1

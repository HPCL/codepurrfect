...
define dso_local void @PCG_ParaSails(%struct.Matrix* %0, %struct.ParaSails* %1, double* %2, double* %3, double %4, i32 %5) local_unnamed_addr #0 {
  ...
  %71 = call i32 @hypre_MPI_Comm_rank(i32 %70, i32* nonnull %61) #4
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %74) #4
  %75 = bitcast i32* %60 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %75) #4
  store i32 1, i32* %60, align 4, !tbaa !11
  %76 = call double @hypre_ddot(i32* nonnull %57, double* %2, i32* nonnull %60, double* %2, i32* nonnull %60) #4
  store double %76, double* %58, align 8, !tbaa !12
  %77 = call i32 @hypre_MPI_Allreduce(i8* nonnull %73, i8* nonnull %74, i32 1, i32 1275070475, i32 1476395011, i32 %70) #4
  %78 = load double, double* %59, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %75) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %74) #4
...
82:                                               ; preds = %6
  ...
  %85 = call i32 @hypre_dcopy(i32* nonnull %55, double* %2, i32* nonnull %56, double* %3, i32* nonnull %56) #4
...
86:                                               ; preds = %6
  ...
  %88 = shl nsw i64 %87, 3
  %89 = call i8* @hypre_MAlloc(i64 %88, i32 0) #4
  %90 = bitcast i8* %89 to double*
  %91 = call i8* @hypre_MAlloc(i64 %88, i32 0) #4
  %92 = bitcast i8* %91 to double*
  %93 = call i8* @hypre_MAlloc(i64 %88, i32 0) #4
  %94 = bitcast i8* %93 to double*
  call void @MatrixMatvec(%struct.Matrix* %0, double* %3, double* %94) #4
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %97) #4
  store i32 1, i32* %54, align 4, !tbaa !11
  %98 = call i32 @hypre_dscal(i32* nonnull %52, double* nonnull %53, double* %94, i32* nonnull %54) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %97) #4
  ...
  %102 = call i32 @hypre_daxpy(i32* nonnull %49, double* nonnull %50, double* %2, i32* nonnull %51, double* %94, i32* nonnull %51) #4
...
104:                                              ; preds = %86
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %94, double* %90) #4
  br label %109
...
105:                                              ; preds = %86
  ...
  %108 = call i32 @hypre_dcopy(i32* nonnull %47, double* %94, i32* nonnull %48, double* %90, i32* nonnull %48) #4
...
109:                                              ; preds = %105, %104
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %111) #4
  %112 = bitcast double* %45 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %112) #4
  %113 = bitcast i32* %46 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %113) #4
  store i32 1, i32* %46, align 4, !tbaa !11
  %114 = call double @hypre_ddot(i32* nonnull %43, double* %94, i32* nonnull %46, double* %90, i32* nonnull %46) #4
  store double %114, double* %44, align 8, !tbaa !12
  %115 = call i32 @hypre_MPI_Allreduce(i8* nonnull %111, i8* nonnull %112, i32 1, i32 1275070475, i32 1476395011, i32 %70) #4
  %116 = load double, double* %45, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %113) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %112) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %111) #4
...
144:                                              ; preds = %109, %176
  ...
  %146 = phi i32 [ %145, %176 ], [ 0, %109 ]
  %147 = phi double [ %161, %176 ], [ %116, %109 ]
  call void @MatrixMatvec(%struct.Matrix* %0, double* %90, double* %92) #4
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %117)
  store i32 %68, i32* %39, align 4, !tbaa !11
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %118) #4
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %119) #4
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %120) #4
  store i32 1, i32* %42, align 4, !tbaa !11
  %148 = call double @hypre_ddot(i32* nonnull %39, double* %92, i32* nonnull %42, double* %90, i32* nonnull %42) #4
  store double %148, double* %40, align 8, !tbaa !12
  %149 = call i32 @hypre_MPI_Allreduce(i8* nonnull %118, i8* nonnull %119, i32 1, i32 1275070475, i32 1476395011, i32 %70) #4
  %150 = load double, double* %41, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %120) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %119) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %118) #4
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %123) #4
  store i32 1, i32* %38, align 4, !tbaa !11
  %152 = call i32 @hypre_daxpy(i32* nonnull %36, double* nonnull %37, double* %90, i32* nonnull %38, double* %3, i32* nonnull %38) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %123) #4
  ...
  %154 = call i32 @hypre_daxpy(i32* nonnull %33, double* nonnull %34, double* %92, i32* nonnull %35, double* %94, i32* nonnull %35) #4
...
155:                                              ; preds = %144
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %94, double* %92) #4
  br label %158

156:                                              ; preds = %144
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %127)
  store i32 %68, i32* %31, align 4, !tbaa !11
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %128) #4
  store i32 1, i32* %32, align 4, !tbaa !11
  %157 = call i32 @hypre_dcopy(i32* nonnull %31, double* %94, i32* nonnull %32, double* %92, i32* nonnull %32) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %128) #4
...
158:                                              ; preds = %156, %155
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %130) #4
  ...
  %159 = call double @hypre_ddot(i32* nonnull %27, double* %94, i32* nonnull %30, double* %92, i32* nonnull %30) #4
  store double %159, double* %28, align 8, !tbaa !12
  %160 = call i32 @hypre_MPI_Allreduce(i8* nonnull %130, i8* nonnull %131, i32 1, i32 1275070475, i32 1476395011, i32 %70) #4
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %130) #4
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %134) #4
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %135) #4
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %136) #4
  store i32 1, i32* %26, align 4, !tbaa !11
  %162 = call double @hypre_ddot(i32* nonnull %23, double* %94, i32* nonnull %26, double* %94, i32* nonnull %26) #4
  store double %162, double* %24, align 8, !tbaa !12
  %163 = call i32 @hypre_MPI_Allreduce(i8* nonnull %134, i8* nonnull %135, i32 1, i32 1275070475, i32 1476395011, i32 %70) #4
  %164 = load double, double* %25, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %136) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %135) #4
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %134) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %133)
  %165 = fcmp olt double %164, %80
  br i1 %165, label %182, label %166

166:                                              ; preds = %158
  %167 = icmp ugt i32 %146, 998
...
174:                                              ; preds = %171
  %175 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str, i64 0, i64 0)) #4
  br label %182

176:                                              ; preds = %166
  %177 = fdiv double %161, %147
  ...
  %178 = call i32 @hypre_dscal(i32* nonnull %20, double* nonnull %21, double* %90, i32* nonnull %22) #4
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %142) #4
  store i32 1, i32* %19, align 4, !tbaa !11
  %179 = call i32 @hypre_daxpy(i32* nonnull %17, double* nonnull %18, double* %92, i32* nonnull %19, double* %90, i32* nonnull %19) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %142) #4
...
182:                                              ; preds = %176, %158, %109, %171, %174
  ...
  call void @hypre_Free(i8* %91, i32 0) #4
  call void @MatrixMatvec(%struct.Matrix* %0, double* %3, double* %94) #4
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %186) #4
  store i32 1, i32* %16, align 4, !tbaa !11
  %187 = call i32 @hypre_dscal(i32* nonnull %14, double* nonnull %15, double* %94, i32* nonnull %16) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %186) #4
  ...
  %191 = call i32 @hypre_daxpy(i32* nonnull %11, double* nonnull %12, double* %2, i32* nonnull %13, double* %94, i32* nonnull %13) #4
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %195) #4
  store i32 1, i32* %10, align 4, !tbaa !11
  %196 = call double @hypre_ddot(i32* nonnull %7, double* %94, i32* nonnull %10, double* %94, i32* nonnull %10) #4
  store double %196, double* %8, align 8, !tbaa !12
  %197 = call i32 @hypre_MPI_Allreduce(i8* nonnull %193, i8* nonnull %194, i32 1, i32 1275070475, i32 1476395011, i32 %70) #4
  %198 = load double, double* %9, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %195) #4
  ...
  call void @hypre_Free(i8* %93, i32 0) #4
...
201:                                              ; preds = %182
  ...
  %204 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.1, i64 0, i64 0), i32 %183, double %203) #4
  br label %205

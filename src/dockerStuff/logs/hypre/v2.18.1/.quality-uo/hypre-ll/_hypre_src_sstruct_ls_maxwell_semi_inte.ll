...
264:                                              ; preds = %262, %260
  %265 = call i8* @hypre_CAlloc(i64 8, i64 12, i32 1) #6
  %266 = bitcast i8* %265 to [3 x i32]*
  %267 = call i8* @hypre_CAlloc(i64 8, i64 4, i32 1) #6
...
437:                                              ; preds = %433, %323
  ...
  %444 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %445 = bitcast i8* %444 to i32**
  %446 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %447 = bitcast i8* %446 to i32**
  %448 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %449 = bitcast i8* %448 to %struct.hypre_BoxArray_struct**
  %450 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %451 = bitcast i8* %450 to [3 x i32]**
  %452 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %453 = bitcast i8* %452 to [3 x i32]**
  %454 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
...
465:                                              ; preds = %462, %607
  ...
  %478 = call i8* @hypre_CAlloc(i64 %477, i64 4, i32 1) #6
  ...
  %490 = call i8* @hypre_CAlloc(i64 %489, i64 4, i32 1) #6
...
525:                                              ; preds = %519, %465
  ...
  %531 = call i8* @hypre_MAlloc(i64 %530, i32 1) #6
  ...
  %537 = call i8* @hypre_MAlloc(i64 %536, i32 1) #6
  ...
  %543 = call i8* @hypre_MAlloc(i64 %542, i32 1) #6
...
611:                                              ; preds = %607, %437
  ...
  %613 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %614 = bitcast i8* %613 to i32***
  %615 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
...
628:                                              ; preds = %620, %611
  %629 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %630 = bitcast i8* %629 to i32**
  %631 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %632 = bitcast i8* %631 to i32**
  %633 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
  %634 = bitcast i8* %633 to i32**
  %635 = call i8* @hypre_MAlloc(i64 %443, i32 1) #6
...
3798:                                             ; preds = %3790, %3789
  ...
  %3810 = call i8* @hypre_CAlloc(i64 %3803, i64 4, i32 1) #6
...
3942:                                             ; preds = %3939, %4261
  ...
  %3952 = call i8* @hypre_CAlloc(i64 %3812, i64 12, i32 1) #6
  %3953 = bitcast i8* %3952 to [3 x i32]*
  %3954 = call i8* @hypre_CAlloc(i64 %3812, i64 12, i32 1) #6
...
4261:                                             ; preds = %4255, %4062
  ...
  call void @hypre_Free(i8* %3952, i32 1) #6
  call void @hypre_Free(i8* %3954, i32 1) #6
...
4460:                                             ; preds = %4386, %5833
  ...
  %4473 = call i8* @hypre_MAlloc(i64 36, i32 1) #6
...
5833:                                             ; preds = %5828, %4475
  ...
  call void @hypre_Free(i8* %4473, i32 1) #6
...
7218:                                             ; preds = %7214, %7559
  ...
  %7229 = call i8* @hypre_CAlloc(i64 %7093, i64 12, i32 1) #6
  %7230 = bitcast i8* %7229 to [3 x i32]*
  %7231 = call i8* @hypre_CAlloc(i64 %7093, i64 12, i32 1) #6
...
7559:                                             ; preds = %7553, %7346
  ...
  call void @hypre_Free(i8* %7229, i32 1) #6
  call void @hypre_Free(i8* %7231, i32 1) #6
...
7583:                                             ; preds = %7573
  ...
  %7585 = call i8* @hypre_CAlloc(i64 %7584, i64 8, i32 1) #6
  %7586 = bitcast i8* %7585 to double*
  %7587 = call i8* @hypre_CAlloc(i64 %7584, i64 8, i32 1) #6
  %7588 = bitcast i8* %7587 to double*
  %7589 = call i8* @hypre_CAlloc(i64 %7584, i64 8, i32 1) #6
  %7590 = bitcast i8* %7589 to double*
  %7591 = call i8* @hypre_CAlloc(i64 %7584, i64 8, i32 1) #6
  %7592 = bitcast i8* %7591 to double*
  %7593 = call i8* @hypre_CAlloc(i64 %7584, i64 8, i32 1) #6
  %7594 = bitcast i8* %7593 to double*
  %7595 = add nsw i32 %7580, 1
  %7596 = sext i32 %7595 to i64
  %7597 = call i8* @hypre_CAlloc(i64 %7596, i64 4, i32 1) #6
...
7798:                                             ; preds = %7724, %9532
  ...
  %7810 = call i8* @hypre_MAlloc(i64 36, i32 1) #6
...
8056:                                             ; preds = %8047, %8056
  ...
  call void @hypre_Free(i8* nonnull %8072, i32 1) #6
...
8315:                                             ; preds = %8306, %8315
  ...
  call void @hypre_Free(i8* nonnull %8331, i32 1) #6
  store double* null, double** %20, align 8, !tbaa !3
...
8606:                                             ; preds = %8597, %8606
  ...
  call void @hypre_Free(i8* nonnull %8622, i32 1) #6
  store double* null, double** %20, align 8, !tbaa !3
...
8865:                                             ; preds = %8855, %8865
  ...
  call void @hypre_Free(i8* nonnull %8881, i32 1) #6
  store double* null, double** %20, align 8, !tbaa !3
...
9155:                                             ; preds = %9146, %9155
  ...
  call void @hypre_Free(i8* nonnull %9171, i32 1) #6
  store double* null, double** %20, align 8, !tbaa !3
...
9414:                                             ; preds = %9405, %9414
  ...
  call void @hypre_Free(i8* nonnull %9430, i32 1) #6
  store double* null, double** %20, align 8, !tbaa !3
...
9532:                                             ; preds = %9528, %7812
  ...
  call void @hypre_Free(i8* %7810, i32 1) #6
...
9536:                                             ; preds = %9532, %7583
  ...
  call void @hypre_Free(i8* %7585, i32 1) #6
  call void @hypre_Free(i8* %7587, i32 1) #6
  call void @hypre_Free(i8* %7589, i32 1) #6
  call void @hypre_Free(i8* %7591, i32 1) #6
  call void @hypre_Free(i8* %7593, i32 1) #6
  call void @hypre_Free(i8* %7597, i32 1) #6
  br label %9538
...
11044:                                            ; preds = %11040, %9538
  call void @hypre_Free(i8* %3810, i32 1) #6
...
11074:                                            ; preds = %11072, %11074
  ...
  call void @hypre_Free(i8* %11081, i32 1) #6
...
11088:                                            ; preds = %11074, %11072
  ...
  call void @hypre_Free(i8* %11092, i32 1) #6
  ...
  call void @hypre_Free(i8* %11098, i32 1) #6
...
11114:                                            ; preds = %11105, %11044
  call void @hypre_Free(i8* %613, i32 1) #6
  call void @hypre_Free(i8* %615, i32 1) #6
...
11118:                                            ; preds = %11116, %11118
  ...
  call void @hypre_Free(i8* %11125, i32 1) #6
  ...
  call void @hypre_Free(i8* %11128, i32 1) #6
  ...
  call void @hypre_Free(i8* %11131, i32 1) #6
  ...
  call void @hypre_Free(i8* %11134, i32 1) #6
  ...
  call void @hypre_Free(i8* %11137, i32 1) #6
  ...
  call void @hypre_Free(i8* %11140, i32 1) #6
  ...
  call void @hypre_Free(i8* %11143, i32 1) #6
  ...
  call void @hypre_Free(i8* %11146, i32 1) #6
  ...
  call void @hypre_Free(i8* %11149, i32 1) #6
...
11152:                                            ; preds = %11118, %11114
  call void @hypre_Free(i8* %448, i32 1) #6
  call void @hypre_Free(i8* %450, i32 1) #6
  call void @hypre_Free(i8* %452, i32 1) #6
  call void @hypre_Free(i8* %454, i32 1) #6
  call void @hypre_Free(i8* %444, i32 1) #6
  call void @hypre_Free(i8* %446, i32 1) #6
  call void @hypre_Free(i8* %631, i32 1) #6
  call void @hypre_Free(i8* %629, i32 1) #6
  call void @hypre_Free(i8* %635, i32 1) #6
  call void @hypre_Free(i8* %633, i32 1) #6
  call void @hypre_Free(i8* %265, i32 1) #6
...
!414 = !{!415, !15, i64 12}
!415 = !{!"hypre_ParCSRMatrix_struct", !15, i64 0, !15, i64 4, !15, i64 8, !15, i64 12, !15, i64 16, !15, i64 20, !15, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !4, i64 72, !4, i64 80, !4, i64 88, !4, i64 96, !4, i64 104, !15, i64 112, !15, i64 116, !15, i64 120, !15, i64 124, !66, i64 128, !4, i64 136, !4, i64 144, !15, i64 152, !4, i64 160, !15, i64 168, !4, i64 176, !15, i64 184, !4, i64 192, !4, i64 200}
!416 = !{!415, !15, i64 20}

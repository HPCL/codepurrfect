...
define dso_local i32 @hypre_FacSemiRestrictCreate2(i8** nocapture %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 64, i32 1) #6
...
104:                                              ; preds = %101, %62
  ...
  %125 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
...
234:                                              ; preds = %231, %142
  ...
  %238 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %239 = bitcast i8* %238 to %struct.hypre_CommPkg_struct**
  %240 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %241 = bitcast i8* %240 to %struct.hypre_BoxArrayArray_struct**
  %242 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %243 = bitcast i8* %242 to %struct.hypre_BoxArrayArray_struct**
  %244 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %245 = bitcast i8* %244 to i32***
  %246 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %247 = bitcast i8* %246 to %struct.hypre_BoxArrayArray_struct**
  %248 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %249 = bitcast i8* %248 to i32***
  %250 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
...
266:                                              ; preds = %264, %435
  ...
  %300 = call i8* @hypre_CAlloc(i64 %299, i64 8, i32 1) #6
  ...
  %305 = call i8* @hypre_CAlloc(i64 %304, i64 8, i32 1) #6
...
341:                                              ; preds = %321, %311
  ...
  %345 = call i8* @hypre_CAlloc(i64 %344, i64 4, i32 1) #6
  ...
  %349 = call i8* @hypre_CAlloc(i64 %344, i64 4, i32 1) #6
...
438:                                              ; preds = %435, %234
  ...
  %445 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %446 = bitcast i8* %445 to %struct.hypre_BoxArrayArray_struct**
  %447 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
  %448 = bitcast i8* %447 to i32***
  %449 = call i8* @hypre_CAlloc(i64 %124, i64 8, i32 1) #6
...
469:                                              ; preds = %462, %586
  ...
  %492 = call i8* @hypre_CAlloc(i64 %491, i64 8, i32 1) #6
  ...
  %497 = call i8* @hypre_CAlloc(i64 %496, i64 8, i32 1) #6
...
529:                                              ; preds = %513, %503
  ...
  %532 = call i8* @hypre_CAlloc(i64 %531, i64 4, i32 1) #6
  ...
  %536 = call i8* @hypre_CAlloc(i64 %531, i64 4, i32 1) #6
...
629:                                              ; preds = %589, %464
  call void @hypre_Free(i8* %246, i32 1) #6
  call void @hypre_Free(i8* %445, i32 1) #6
  call void @hypre_Free(i8* %248, i32 1) #6
  call void @hypre_Free(i8* %447, i32 1) #6
  call void @hypre_Free(i8* %250, i32 1) #6
...
97:                                               ; preds = %91, %87
  ...
  %100 = call i8* @hypre_CAlloc(i64 %99, i64 8, i32 1) #6
...
122:                                              ; preds = %113
  ...
  %128 = call i8* @hypre_MAlloc(i64 %125, i32 1) #6
...
142:                                              ; preds = %113
  %143 = call i8* @hypre_MAlloc(i64 8, i32 1) #6
  %144 = bitcast i8* %143 to double***
  %145 = call i8* @hypre_MAlloc(i64 8, i32 1) #6
  %146 = bitcast i8* %145 to double***
  %147 = call i8* @hypre_MAlloc(i64 8, i32 1) #6
  %148 = bitcast i8* %143 to i8**
  store i8* %147, i8** %148, align 8, !tbaa !3
  %149 = call i8* @hypre_MAlloc(i64 8, i32 1) #6
...
252:                                              ; preds = %151, %252
  ...
  %257 = call i8* @hypre_MAlloc(i64 %256, i32 1) #6
...
1064:                                             ; preds = %1061, %1064
  ...
  call void @hypre_Free(i8* %1068, i32 1) #6
  ...
  call void @hypre_Free(i8* %1071, i32 1) #6
...
62:                                               ; preds = %42, %26
  ...
  call void @hypre_Free(i8* %66, i32 1) #6

...
define dso_local i32 @hypre_MatTCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* nocapture %0) local_unnamed_addr #2 {
  ...
  %44 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 1) #5
  ...
  %67 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 16

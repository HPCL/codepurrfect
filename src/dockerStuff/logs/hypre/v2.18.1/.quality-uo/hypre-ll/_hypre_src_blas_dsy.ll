...
define dso_local i32 @hypre_dsyrk(i8* %0, i8* %1, i32* nocapture readonly %2, i32* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, i32* nocapture readonly %6, double* nocapture readonly %7, double* nocapture %8, i32* nocapture readonly %9) local_unnamed_addr #0 {
  %11 = call i64 @hypre_blas_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  %12 = icmp eq i64 %11, 0
  %13 = select i1 %12, i32* %3, i32* %2
  %14 = load i32, i32* %13, align 4, !tbaa !3
  store i32 %14, i32* @hypre_dsyrk.nrowa, align 4, !tbaa !3
  %15 = call i64 @hypre_blas_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
...
17:                                               ; preds = %10
  %18 = call i64 @hypre_blas_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #3
  %19 = icmp eq i64 %18, 0
  br i1 %19, label %46, label %20

20:                                               ; preds = %17, %10
  %21 = call i64 @hypre_blas_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  %22 = icmp eq i64 %21, 0
  br i1 %22, label %23, label %29

23:                                               ; preds = %20
  %24 = call i64 @hypre_blas_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #3
  %25 = icmp eq i64 %24, 0
  br i1 %25, label %26, label %29

26:                                               ; preds = %23
  %27 = call i64 @hypre_blas_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #3
  %28 = icmp eq i64 %27, 0
...
51:                                               ; preds = %48
  %52 = call i32 @hypre_blas_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0), i32* nonnull @hypre_dsyrk.info) #3
  br label %472
...
168:                                              ; preds = %65
  %169 = call i64 @hypre_blas_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3

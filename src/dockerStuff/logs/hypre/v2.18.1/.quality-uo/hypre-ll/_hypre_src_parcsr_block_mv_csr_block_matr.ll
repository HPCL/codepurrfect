...
define dso_local %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixCreate(i32 %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  %5 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 1) #9
  ...
  %9 = getelementptr inbounds i8, i8* %5, i64 36
  ...
  %15 = getelementptr inbounds i8, i8* %5, i64 48
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %6, i32 1) #9
  store i32* null, i32** %4, align 8, !tbaa !13
  %7 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 8
...
10:                                               ; preds = %3
  ...
  call void @hypre_Free(i8* %16, i32 1) #9
  store i32* null, i32** %14, align 8, !tbaa !15
  %17 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 3
  %18 = bitcast i32** %17 to i8**
  %19 = load i8*, i8** %18, align 8, !tbaa !16
  call void @hypre_Free(i8* %19, i32 1) #9
  store i32* null, i32** %17, align 8, !tbaa !16
  br label %20

20:                                               ; preds = %10, %3
  %21 = bitcast %struct.hypre_CSRBlockMatrix* %0 to i8*
...
define dso_local i32 @hypre_CSRBlockMatrixInitialize(%struct.hypre_CSRBlockMatrix* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 4
  %3 = load i32, i32* %2, align 8, !tbaa !3
  %4 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 5
  %5 = load i32, i32* %4, align 4, !tbaa !9
  %6 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 7
...
11:                                               ; preds = %1
  call void @hypre_Free(i8* null, i32 1) #9
...
17:                                               ; preds = %16, %12
  %18 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 3
...
21:                                               ; preds = %17
  call void @hypre_Free(i8* null, i32 1) #9
  store i32* null, i32** %18, align 8, !tbaa !16
  br label %22

22:                                               ; preds = %21, %17
  %23 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 0
...
26:                                               ; preds = %22
  call void @hypre_Free(i8* null, i32 1) #9
  store double* null, double** %23, align 8, !tbaa !14
  br label %27
...
27:                                               ; preds = %26, %22
  ...
  %32 = call i8* @hypre_CAlloc(i64 %31, i64 4, i32 1) #9
  %33 = bitcast i32** %8 to i8**
  store i8* %32, i8** %33, align 8, !tbaa !13
  %34 = icmp eq i32 %29, 0
  br i1 %34, label %42, label %35

35:                                               ; preds = %27
  %36 = sext i32 %29 to i64
  %37 = call i8* @hypre_CAlloc(i64 %36, i64 8, i32 1) #9
  %38 = bitcast %struct.hypre_CSRBlockMatrix* %0 to i8**
  store i8* %37, i8** %38, align 8, !tbaa !14
  %39 = sext i32 %7 to i64
  %40 = call i8* @hypre_CAlloc(i64 %39, i64 4, i32 1) #9
...
43:                                               ; preds = %42, %35
  ...
  store i32* %44, i32** %13, align 8, !tbaa !15
  ret i32 0
}

; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_CSRBlockMatrixBigInitialize(%struct.hypre_CSRBlockMatrix* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 4
  %3 = load i32, i32* %2, align 8, !tbaa !3
  %4 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 5
  %5 = load i32, i32* %4, align 4, !tbaa !9
...
define dso_local i32 @hypre_CSRBlockMatrixSetDataOwner(%struct.hypre_CSRBlockMatrix* nocapture %0, i32 %1) local_unnamed_addr #2 {
  %3 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 8
...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRBlockMatrixCompress(%struct.hypre_CSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %8 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 7
  ...
  %22 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %16, i64 0, i32 9
...
36:                                               ; preds = %26, %36
  ...
  br i1 %42, label %29, label %36, !llvm.loop !22
...
43:                                               ; preds = %32, %62
  ...
  store i32 %46, i32* %47, align 4, !tbaa !21
...
52:                                               ; preds = %48, %52
  ...
  br i1 %61, label %62, label %52, !llvm.loop !27
...
62:                                               ; preds = %52, %43
  ...
  br i1 %67, label %68, label %43, !llvm.loop !28
...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRBlockMatrixConvertToCSRMatrix(%struct.hypre_CSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %26 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %20, i64 0, i32 9
...
42:                                               ; preds = %38, %42
  ...
  %44 = load i32, i32* %35, align 4, !tbaa !21
  ...
  store i32 %51, i32* %53, align 4, !tbaa !21
  %54 = add nuw nsw i64 %43, 1
  %55 = icmp eq i64 %54, %32
  br i1 %55, label %56, label %42, !llvm.loop !29

56:                                               ; preds = %42, %33
  %57 = icmp eq i64 %36, %31
  br i1 %57, label %58, label %33, !llvm.loop !30
...
80:                                               ; preds = %74, %132
  ...
  %83 = load i32, i32* %77, align 4, !tbaa !21
  %84 = mul nsw i64 %81, %70
  %85 = load i32, i32* %79, align 4, !tbaa !21
...
90:                                               ; preds = %87, %126
  ...
  store i32 %96, i32* %98, align 4, !tbaa !21
...
110:                                              ; preds = %106
  %111 = load i32, i32* %93, align 4, !tbaa !21
  ...
  %119 = load double, double* %118, align 8, !tbaa !25
  %120 = getelementptr inbounds double, double* %27, i64 %115
  store double %119, double* %120, align 8, !tbaa !25
...
122:                                              ; preds = %106, %110
  ...
  br i1 %125, label %126, label %106, !llvm.loop !31

126:                                              ; preds = %122, %90
  %127 = phi i32 [ %105, %90 ], [ %123, %122 ]
  %128 = add nsw i64 %91, 1
  %129 = load i32, i32* %79, align 4, !tbaa !21
  %130 = sext i32 %129 to i64
  %131 = icmp slt i64 %128, %130
  br i1 %131, label %90, label %132, !llvm.loop !32

132:                                              ; preds = %126, %80
  %133 = phi i32 [ %82, %80 ], [ %127, %126 ]
  %134 = add nuw nsw i64 %81, 1
  %135 = icmp eq i64 %134, %72
  br i1 %135, label %136, label %80, !llvm.loop !33

136:                                              ; preds = %132, %74
  %137 = phi i32 [ %76, %74 ], [ %133, %132 ]
  %138 = icmp eq i64 %78, %71
  br i1 %138, label %139, label %74, !llvm.loop !34
...
define dso_local %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixConvertFromCSRMatrix(%struct.hypre_CSRMatrix* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %11 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %0, i64 0, i32 9
  %12 = load double*, double** %11, align 8, !tbaa !20
  %13 = sdiv i32 %4, %1
  %14 = sdiv i32 %6, %1
  %15 = sext i32 %14 to i64
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 4, i32 1) #9
...
58:                                               ; preds = %47
  store i32 %34, i32* %54, align 4, !tbaa !21
  %59 = add nsw i32 %49, 1
  br label %60
...
60:                                               ; preds = %47, %58
  ...
  %62 = add nsw i64 %48, 1
  %63 = load i32, i32* %42, align 4, !tbaa !21
  %64 = sext i32 %63 to i64
  %65 = icmp slt i64 %62, %64
  br i1 %65, label %47, label %66, !llvm.loop !37

66:                                               ; preds = %60, %35
  %67 = phi i32 [ %37, %35 ], [ %61, %60 ]
  %68 = add nuw nsw i64 %36, 1
  %69 = icmp eq i64 %68, %28
  br i1 %69, label %70, label %35, !llvm.loop !38

70:                                               ; preds = %66, %29
  %71 = phi i32 [ %31, %29 ], [ %67, %66 ]
  %72 = add nuw nsw i64 %30, 1
  %73 = icmp eq i64 %72, %27
  br i1 %73, label %74, label %29, !llvm.loop !39

74:                                               ; preds = %70, %22
  %75 = phi i32 [ 0, %22 ], [ %71, %70 ]
  %76 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 1) #9
  %77 = bitcast i8* %76 to %struct.hypre_CSRBlockMatrix*
  %78 = getelementptr inbounds i8, i8* %76, i64 32
  %79 = bitcast i8* %78 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(32) %76, i8 0, i64 32, i1 false) #9
  ...
  %84 = getelementptr inbounds i8, i8* %76, i64 44
  %85 = bitcast i8* %84 to i32*
  store i32 %75, i32* %85, align 4, !tbaa !11
  %86 = getelementptr inbounds i8, i8* %76, i64 48
...
138:                                              ; preds = %128
  store i32 %130, i32* %135, align 4, !tbaa !21
  %139 = load i32, i32* %131, align 4, !tbaa !21
  %140 = sdiv i32 %139, %1
...
144:                                              ; preds = %138, %128
  ...
  %146 = load i32, i32* %131, align 4, !tbaa !21
  %147 = sdiv i32 %146, %1
...
10:                                               ; preds = %7, %10
  ...
  store double %16, double* %17, align 8, !tbaa !25
  %18 = add nuw nsw i64 %11, 1
  %19 = icmp eq i64 %18, %9
  br i1 %19, label %20, label %10, !llvm.loop !43
...
9:                                                ; preds = %6, %9
  ...
  %17 = icmp eq i64 %16, %8
  br i1 %17, label %18, label %9, !llvm.loop !44
...
7:                                                ; preds = %5, %7
  ...
  store double %17, double* %15, align 8, !tbaa !25
  %18 = add nuw nsw i64 %8, 1
  %19 = add nuw nsw i32 %9, 1
  %20 = icmp eq i64 %18, %6
  br i1 %20, label %21, label %7, !llvm.loop !45
...
21:                                               ; preds = %8
  ...
  store double %24, double* %22, align 8, !tbaa !25
  br label %25
...
25:                                               ; preds = %8, %21
  ...
  %28 = icmp eq i64 %26, %7
  br i1 %28, label %29, label %8, !llvm.loop !46
...
7:                                                ; preds = %5, %7
  ...
  store double %18, double* %17, align 8, !tbaa !25
  %19 = add nuw nsw i64 %8, 1
  %20 = add nuw nsw i32 %9, 1
  %21 = icmp eq i64 %19, %6
  br i1 %21, label %22, label %7, !llvm.loop !47
...
9:                                                ; preds = %6, %9
  %10 = phi i64 [ 0, %6 ], [ %12, %9 ]
  %11 = getelementptr inbounds double, double* %0, i64 %10
  store double %1, double* %11, align 8, !tbaa !25
  %12 = add nuw nsw i64 %10, 1
  %13 = icmp eq i64 %12, %8
  br i1 %13, label %14, label %9, !llvm.loop !48
...
10:                                               ; preds = %7, %10
  ...
  store double %14, double* %15, align 8, !tbaa !25
  %16 = add nuw nsw i64 %11, 1
  %17 = icmp eq i64 %16, %9
  br i1 %17, label %18, label %10, !llvm.loop !49
...
16:                                               ; preds = %14, %16
  ...
  store double %24, double* %25, align 8, !tbaa !25
  %26 = add nuw nsw i64 %17, 1
  %27 = add nuw nsw i32 %18, 1
  %28 = icmp eq i64 %26, %15
  br i1 %28, label %29, label %16, !llvm.loop !50
...
14:                                               ; preds = %11, %14
  ...
  store double %19, double* %21, align 8, !tbaa !25
  %22 = add nuw nsw i64 %15, 1
  %23 = icmp eq i64 %22, %10
  br i1 %23, label %24, label %14, !llvm.loop !51

24:                                               ; preds = %14, %11
  %25 = add nuw nsw i64 %12, 1
  %26 = icmp eq i64 %25, %9
  br i1 %26, label %27, label %11, !llvm.loop !52
...
21:                                               ; preds = %13, %21
  ...
  br i1 %28, label %155, label %21, !llvm.loop !53

29:                                               ; preds = %4
  %30 = sext i32 %3 to i64
  %31 = call i8* @hypre_CAlloc(i64 %30, i64 8, i32 1) #9
...
42:                                               ; preds = %39, %42
  ...
  %46 = load double, double* %45, align 8, !tbaa !25
  %47 = call double @llvm.fabs.f64(double %46)
  %48 = getelementptr inbounds double, double* %32, i64 %43
  %49 = load double, double* %48, align 8, !tbaa !25
  %50 = fadd double %49, %47
  store double %50, double* %48, align 8, !tbaa !25
  %51 = add nuw nsw i64 %43, 1
  %52 = icmp eq i64 %51, %38
  br i1 %52, label %53, label %42, !llvm.loop !54

53:                                               ; preds = %42, %39
  %54 = add nuw nsw i64 %40, 1
  %55 = icmp eq i64 %54, %37
  br i1 %55, label %56, label %39, !llvm.loop !55

56:                                               ; preds = %53, %29
  %57 = load double, double* %32, align 8, !tbaa !25
  %58 = icmp sgt i32 %3, 1
...
72:                                               ; preds = %4
  ...
  %74 = call i8* @hypre_CAlloc(i64 %73, i64 8, i32 1) #9
...
88:                                               ; preds = %84, %88
  ...
  %94 = load double, double* %83, align 8, !tbaa !25
  %95 = fadd double %94, %93
  store double %95, double* %83, align 8, !tbaa !25
...
98:                                               ; preds = %88, %81
  ...
  br i1 %100, label %101, label %81, !llvm.loop !58

101:                                              ; preds = %98, %72
  %102 = load double, double* %75, align 8, !tbaa !25
...
106:                                              ; preds = %104, %106
  ...
  br i1 %114, label %115, label %106, !llvm.loop !59

115:                                              ; preds = %106, %101
  %116 = phi double [ %102, %101 ], [ %112, %106 ]
  call void @hypre_Free(i8* %74, i32 1) #9
  br label %155

117:                                              ; preds = %4
  %118 = load double, double* %1, align 8, !tbaa !25
  %119 = icmp eq i32 %5, 0
...
155:                                              ; preds = %134, %123, %21, %6, %117, %11, %152, %115, %70
  ...
  store double %156, double* %2, align 8, !tbaa !25
  ret i32 0
}
...
24:                                               ; preds = %22, %24
  ...
  br i1 %37, label %38, label %24, !llvm.loop !63

38:                                               ; preds = %24, %22
  %39 = phi double [ 0.000000e+00, %22 ], [ %35, %24 ]
  %40 = add nsw i64 %23, %21
  %41 = getelementptr inbounds double, double* %3, i64 %40
  store double %39, double* %41, align 8, !tbaa !25
  %42 = add nuw nsw i64 %23, 1
  %43 = icmp eq i64 %42, %16
  br i1 %43, label %44, label %22, !llvm.loop !64

44:                                               ; preds = %38, %18
  %45 = add nuw nsw i64 %19, 1
  %46 = icmp eq i64 %45, %15
  br i1 %46, label %125, label %18, !llvm.loop !65
...
74:                                               ; preds = %69, %74
  ...
  %83 = load double, double* %82, align 8, !tbaa !25
  %84 = fmul double %79, %83
  %85 = fadd double %76, %84
  %86 = add nuw nsw i64 %75, 1
  %87 = icmp eq i64 %86, %65
  br i1 %87, label %88, label %74, !llvm.loop !66

88:                                               ; preds = %74, %69
  %89 = phi double [ %73, %69 ], [ %85, %74 ]
  store double %89, double* %72, align 8, !tbaa !25
  %90 = add nuw nsw i64 %70, 1
  %91 = icmp eq i64 %90, %64
  br i1 %91, label %92, label %69, !llvm.loop !67

92:                                               ; preds = %88, %66
  %93 = add nuw nsw i64 %67, 1
  %94 = icmp eq i64 %93, %63
  br i1 %94, label %125, label %66, !llvm.loop !68
...
11:                                               ; preds = %9, %11
  ...
  store double %21, double* %22, align 8, !tbaa !25
  %23 = add nuw nsw i64 %12, 1
  %24 = add nuw nsw i32 %13, 1
  %25 = icmp eq i64 %23, %10
  br i1 %25, label %70, label %11, !llvm.loop !72
...
35:                                               ; preds = %33, %35
  ...
  store double %48, double* %41, align 8, !tbaa !25
  %49 = add nuw nsw i64 %36, 1
  %50 = add nuw nsw i32 %37, 1
  %51 = icmp eq i64 %49, %34
  br i1 %51, label %70, label %35, !llvm.loop !73
...
52:                                               ; preds = %30, %52
  ...
  store double %66, double* %58, align 8, !tbaa !25
  %67 = add nuw nsw i64 %53, 1
  %68 = add nuw nsw i32 %54, 1
  %69 = icmp eq i64 %67, %31
  br i1 %69, label %70, label %52, !llvm.loop !74
...
25:                                               ; preds = %12
  ...
  store double %28, double* %29, align 8, !tbaa !25
  br label %30
...
30:                                               ; preds = %12, %25
  ...
  br i1 %33, label %92, label %12, !llvm.loop !75
...
43:                                               ; preds = %41, %63
  ...
  %51 = load double, double* %50, align 8, !tbaa !25
...
56:                                               ; preds = %43
  ...
  store double %62, double* %57, align 8, !tbaa !25
  br label %63
...
63:                                               ; preds = %43, %56
  ...
  br i1 %66, label %92, label %43, !llvm.loop !76
...
80:                                               ; preds = %67
  ...
  %85 = load double, double* %84, align 8, !tbaa !25
  %86 = fmul double %75, %85
  %87 = fadd double %83, %86
  store double %87, double* %81, align 8, !tbaa !25
  br label %88
...
88:                                               ; preds = %67, %80
  ...
  br i1 %91, label %92, label %67, !llvm.loop !77
...
17:                                               ; preds = %14, %17
  ...
  br i1 %32, label %33, label %17, !llvm.loop !78

33:                                               ; preds = %17, %14
  %34 = add nuw nsw i64 %15, 1
  %35 = icmp eq i64 %34, %12
  br i1 %35, label %99, label %14, !llvm.loop !79
...
53:                                               ; preds = %50, %53
  ...
  store double %67, double* %57, align 8, !tbaa !25
  %68 = add nuw nsw i64 %54, 1
  %69 = add nuw nsw i32 %55, 1
  %70 = icmp eq i64 %68, %49
  br i1 %70, label %71, label %53, !llvm.loop !80

71:                                               ; preds = %53, %50
  %72 = add nuw nsw i64 %51, 1
  %73 = icmp eq i64 %72, %48
  br i1 %73, label %99, label %50, !llvm.loop !81
...
77:                                               ; preds = %74, %77
  ...
  store double %92, double* %81, align 8, !tbaa !25
  %93 = add nuw nsw i64 %78, 1
  %94 = add nuw nsw i32 %79, 1
  %95 = icmp eq i64 %93, %44
  br i1 %95, label %96, label %77, !llvm.loop !82

96:                                               ; preds = %77, %74
  %97 = add nuw nsw i64 %75, 1
  %98 = icmp eq i64 %97, %43
  br i1 %98, label %99, label %74, !llvm.loop !83
...
define dso_local i32 @hypre_CSRBlockMatrixBlockMultAddDiag3(double* nocapture readonly %0, double* nocapture readonly %1, double %2, double* nocapture %3, i32 %4) local_unnamed_addr #0 {
  %6 = sext i32 %4 to i64
  %7 = call i8* @hypre_CAlloc(i64 %6, i64 8, i32 1) #9
...
21:                                               ; preds = %17, %21
  ...
  %25 = load double, double* %24, align 8, !tbaa !25
  %26 = load double, double* %16, align 8, !tbaa !25
  %27 = fadd double %25, %26
  store double %27, double* %16, align 8, !tbaa !25
  %28 = add nuw nsw i64 %22, 1
  %29 = icmp eq i64 %28, %13
  br i1 %29, label %30, label %21, !llvm.loop !84

30:                                               ; preds = %21, %14
  %31 = add nuw nsw i64 %15, 1
  %32 = icmp eq i64 %31, %12
  br i1 %32, label %33, label %14, !llvm.loop !85
...
45:                                               ; preds = %42, %45
  ...
  br i1 %55, label %56, label %45, !llvm.loop !86

56:                                               ; preds = %45, %42
  %57 = add nuw nsw i64 %43, 1
  %58 = icmp eq i64 %57, %40
  br i1 %58, label %112, label %42, !llvm.loop !87
...
76:                                               ; preds = %73, %76
  ...
  store double %86, double* %79, align 8, !tbaa !25
  %87 = add nuw nsw i64 %77, 1
  %88 = icmp eq i64 %87, %72
  br i1 %88, label %89, label %76, !llvm.loop !88

89:                                               ; preds = %76, %73
  %90 = add nuw nsw i64 %74, 1
  %91 = icmp eq i64 %90, %71
  br i1 %91, label %112, label %73, !llvm.loop !89
...
95:                                               ; preds = %92, %95
  ...
  store double %106, double* %98, align 8, !tbaa !25
  %107 = add nuw nsw i64 %96, 1
  %108 = icmp eq i64 %107, %67
  br i1 %108, label %109, label %95, !llvm.loop !90

109:                                              ; preds = %95, %92
  %110 = add nuw nsw i64 %93, 1
  %111 = icmp eq i64 %110, %66
  br i1 %111, label %112, label %92, !llvm.loop !91

112:                                              ; preds = %109, %89, %56, %63, %68, %35
  call void @hypre_Free(i8* %7, i32 1) #9
  ret i32 0
}
...
13:                                               ; preds = %11, %13
  ...
  br i1 %19, label %83, label %13, !llvm.loop !92
...
33:                                               ; preds = %27, %33
  ...
  store double %37, double* %35, align 8, !tbaa !25
  %38 = add nuw nsw i64 %34, 1
  %39 = icmp eq i64 %38, %28
  br i1 %39, label %40, label %33, !llvm.loop !93
...
66:                                               ; preds = %54, %46
  ...
  store double %67, double* %48, align 8, !tbaa !25
  %68 = add nuw nsw i64 %47, 1
  %69 = icmp eq i64 %68, %44
  br i1 %69, label %70, label %46, !llvm.loop !95
...
76:                                               ; preds = %74, %76
  ...
  %79 = load double, double* %78, align 8, !tbaa !25
  %80 = fmul double %79, %0
  store double %80, double* %78, align 8, !tbaa !25
  %81 = add nuw nsw i64 %77, 1
  %82 = icmp eq i64 %81, %75
  br i1 %82, label %83, label %76, !llvm.loop !96
...
16:                                               ; preds = %4
  %17 = load double, double* %0, align 8, !tbaa !25
  %18 = call double @llvm.fabs.f64(double %17)
  %19 = fcmp ogt double %18, 1.000000e-10
  br i1 %19, label %20, label %23

20:                                               ; preds = %16
  %21 = load double, double* %1, align 8, !tbaa !25
  %22 = fdiv double %21, %17
  store double %22, double* %2, align 8, !tbaa !25
  call void @hypre_Free(i8* %7, i32 1) #9
  br label %207
...
39:                                               ; preds = %13, %56
  ...
  store double %42, double* %43, align 8, !tbaa !25
...
48:                                               ; preds = %44, %48
  ...
  br i1 %55, label %56, label %48, !llvm.loop !97

56:                                               ; preds = %48, %39
  %57 = add nuw nsw i64 %40, 1
  %58 = icmp eq i64 %57, %14
  br i1 %58, label %24, label %39, !llvm.loop !98

59:                                               ; preds = %149, %122
  %60 = add nuw nsw i64 %64, 1
  %61 = icmp eq i64 %72, %34
  br i1 %61, label %159, label %62, !llvm.loop !99
...
62:                                               ; preds = %28, %59
  ...
  %71 = load double, double* %70, align 8, !tbaa !25
...
78:                                               ; preds = %76, %78
  ...
  br i1 %93, label %94, label %78, !llvm.loop !100
...
103:                                              ; preds = %100, %103
  ...
  %110 = load double, double* %109, align 8, !tbaa !25
  store double %110, double* %106, align 8, !tbaa !25
  store double %107, double* %109, align 8, !tbaa !25
  %111 = add nuw nsw i64 %104, 1
  %112 = icmp eq i64 %111, %36
  br i1 %112, label %113, label %103, !llvm.loop !101

113:                                              ; preds = %103, %99
  %114 = getelementptr inbounds double, double* %2, i64 %63
  %115 = load double, double* %114, align 8, !tbaa !25
  %116 = sext i32 %95 to i64
  %117 = getelementptr inbounds double, double* %2, i64 %116
  %118 = load double, double* %117, align 8, !tbaa !25
  store double %118, double* %114, align 8, !tbaa !25
  store double %115, double* %117, align 8, !tbaa !25
  br label %119
...
172:                                              ; preds = %169, %200
  ...
  %180 = load double, double* %179, align 8, !tbaa !25
  %181 = getelementptr inbounds double, double* %2, i64 %175
  %182 = load double, double* %181, align 8, !tbaa !25
  %183 = fdiv double %182, %180
  store double %183, double* %181, align 8, !tbaa !25
  br label %184
...
191:                                              ; preds = %184
  %192 = load double, double* %181, align 8, !tbaa !25
  ...
  store double %196, double* %194, align 8, !tbaa !25
  br label %197

197:                                              ; preds = %184, %191
  %198 = add nuw nsw i64 %185, 1
  %199 = icmp eq i64 %198, %175
  br i1 %199, label %200, label %184, !llvm.loop !104

200:                                              ; preds = %197
  %201 = add nsw i32 %174, -1
  %202 = icmp sgt i64 %173, 2
  br i1 %202, label %172, label %203, !llvm.loop !105

203:                                              ; preds = %200, %167
  %204 = load double, double* %8, align 8, !tbaa !25
  %205 = load double, double* %2, align 8, !tbaa !25
  %206 = fdiv double %205, %204
  store double %206, double* %2, align 8, !tbaa !25
  br label %207
...
211:                                              ; preds = %207
  call void @hypre_Free(i8* %208, i32 1) #9
  br label %212
...
15:                                               ; preds = %4
  %16 = load double, double* %8, align 8, !tbaa !25
  %17 = call double @llvm.fabs.f64(double %16)
  %18 = fcmp ogt double %17, 1.000000e-10
  br i1 %18, label %19, label %207

19:                                               ; preds = %15
  %20 = load double, double* %1, align 8, !tbaa !25
  %21 = load double, double* %0, align 8, !tbaa !25
...
41:                                               ; preds = %12, %41
  ...
  store double %44, double* %45, align 8, !tbaa !25
  ...
  store double %47, double* %48, align 8, !tbaa !25
  %49 = add nuw nsw i64 %42, 1
  %50 = icmp eq i64 %49, %14
  br i1 %50, label %23, label %41, !llvm.loop !106

51:                                               ; preds = %146, %112
  %52 = add nuw nsw i64 %56, 1
  %53 = icmp eq i64 %64, %35
  br i1 %53, label %149, label %54, !llvm.loop !107
...
70:                                               ; preds = %68, %70
  ...
  br i1 %85, label %86, label %70, !llvm.loop !108
...
95:                                               ; preds = %92, %95
  ...
  %102 = load double, double* %101, align 8, !tbaa !25
  store double %102, double* %98, align 8, !tbaa !25
  store double %99, double* %101, align 8, !tbaa !25
  ...
  store double %106, double* %103, align 8, !tbaa !25
  store double %104, double* %105, align 8, !tbaa !25
  %107 = add nuw nsw i64 %96, 1
  %108 = icmp eq i64 %107, %37
  br i1 %108, label %109, label %95, !llvm.loop !109
...
122:                                              ; preds = %114, %122
  ...
  store double %131, double* %129, align 8, !tbaa !25
  %132 = add nuw nsw i64 %123, 1
  %133 = icmp eq i64 %132, %39
  br i1 %133, label %121, label %122, !llvm.loop !110
...
134:                                              ; preds = %121, %134
  ...
  %142 = load double, double* %141, align 8, !tbaa !25
  %143 = fsub double %142, %139
  store double %143, double* %141, align 8, !tbaa !25
  %144 = add nuw nsw i64 %135, 1
  %145 = icmp eq i64 %144, %40
  br i1 %145, label %146, label %134, !llvm.loop !111

146:                                              ; preds = %134, %121
  %147 = add nuw nsw i64 %115, 1
  %148 = icmp eq i64 %147, %38
  br i1 %148, label %51, label %114, !llvm.loop !112
...
149:                                              ; preds = %51, %23
  ...
  %154 = load double, double* %153, align 8, !tbaa !25
...
166:                                              ; preds = %164, %197
  ...
  store double %179, double* %177, align 8, !tbaa !25
  br label %180
...
187:                                              ; preds = %180
  %188 = load double, double* %177, align 8, !tbaa !25
  ...
  store double %193, double* %191, align 8, !tbaa !25
  br label %194

194:                                              ; preds = %180, %187
  %195 = add nuw nsw i64 %181, 1
  %196 = icmp eq i64 %195, %169
  br i1 %196, label %197, label %180, !llvm.loop !113

197:                                              ; preds = %194
  %198 = add nsw i32 %168, -1
  %199 = icmp sgt i64 %167, 2
  br i1 %199, label %166, label %200, !llvm.loop !114

200:                                              ; preds = %197, %164
  %201 = load double, double* %8, align 8, !tbaa !25
  %202 = getelementptr inbounds double, double* %2, i64 %165
  %203 = load double, double* %202, align 8, !tbaa !25
  %204 = fdiv double %203, %201
  store double %204, double* %202, align 8, !tbaa !25
  %205 = add nuw nsw i64 %165, 1
  %206 = icmp eq i64 %205, %163
  br i1 %206, label %209, label %164, !llvm.loop !115
...
213:                                              ; preds = %209
  call void @hypre_Free(i8* %210, i32 1) #9
  br label %214
...
6:                                                ; preds = %4
  %7 = load double, double* %0, align 8, !tbaa !25
  %8 = call double @llvm.fabs.f64(double %7)
  %9 = fcmp ogt double %8, 0x3D719799812DEA11
  br i1 %9, label %10, label %87

10:                                               ; preds = %6
  %11 = load double, double* %1, align 8, !tbaa !25
  %12 = fdiv double %11, %7
  store double %12, double* %2, align 8, !tbaa !25
  br label %87
...
13:                                               ; preds = %4
  ...
  %18 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 1) #9
  %19 = bitcast i8* %18 to double*
  %20 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 1) #9
...
29:                                               ; preds = %29, %26
  ...
  store double %34, double* %36, align 8, !tbaa !25
  %37 = add nuw nsw i64 %30, 1
  %38 = icmp eq i64 %37, %25
  br i1 %38, label %39, label %29, !llvm.loop !51

39:                                               ; preds = %29
  %40 = add nuw nsw i64 %27, 1
  %41 = icmp eq i64 %40, %25
  br i1 %41, label %42, label %26, !llvm.loop !52
...
49:                                               ; preds = %49, %46
  ...
  store double %54, double* %56, align 8, !tbaa !25
  %57 = add nuw nsw i64 %50, 1
  %58 = icmp eq i64 %57, %45
  br i1 %58, label %59, label %49, !llvm.loop !51

59:                                               ; preds = %49
  %60 = add nuw nsw i64 %47, 1
  %61 = icmp eq i64 %60, %45
  br i1 %61, label %62, label %46, !llvm.loop !52
...
73:                                               ; preds = %73, %70
  ...
  store double %78, double* %80, align 8, !tbaa !25
  %81 = add nuw nsw i64 %74, 1
  %82 = icmp eq i64 %81, %69
  br i1 %82, label %83, label %73, !llvm.loop !51

83:                                               ; preds = %73
  %84 = add nuw nsw i64 %71, 1
  %85 = icmp eq i64 %84, %69
  br i1 %85, label %86, label %70, !llvm.loop !52

86:                                               ; preds = %83, %62
  call void @hypre_Free(i8* %16, i32 1) #9
  call void @hypre_Free(i8* %18, i32 1) #9
  call void @hypre_Free(i8* %20, i32 1) #9
  br label %87
...
26:                                               ; preds = %16
  ...
  store double %29, double* %30, align 8, !tbaa !25
  %31 = add nuw nsw i64 %17, 1
  %32 = add nuw nsw i32 %18, 1
  %33 = icmp eq i64 %31, %15
  br i1 %33, label %34, label %16, !llvm.loop !116
...
23:                                               ; preds = %11, %23
  ...
  br i1 %32, label %33, label %23, !llvm.loop !117

33:                                               ; preds = %23, %11
  %34 = add nuw nsw i64 %12, 1
  %35 = add nuw nsw i32 %13, 1
  %36 = icmp eq i64 %34, %9
  br i1 %36, label %37, label %11, !llvm.loop !118
...
17:                                               ; preds = %14, %17
  ...
  br i1 %25, label %26, label %17, !llvm.loop !119
...
32:                                               ; preds = %26, %32
  ...
  %37 = load double, double* %36, align 8, !tbaa !25
  %38 = fmul double %31, %37
  %39 = getelementptr inbounds double, double* %2, i64 %35
  store double %38, double* %39, align 8, !tbaa !25
  %40 = add nuw nsw i64 %33, 1
  %41 = icmp eq i64 %40, %13
  br i1 %41, label %42, label %32, !llvm.loop !120

42:                                               ; preds = %32, %26
  %43 = add nuw nsw i64 %15, 1
  %44 = icmp eq i64 %43, %11
  br i1 %44, label %45, label %14, !llvm.loop !121
...
define dso_local i32 @hypre_CSRBlockMatrixTranspose(%struct.hypre_CSRBlockMatrix* nocapture readonly %0, %struct.hypre_CSRBlockMatrix** nocapture %1, i32 %2) local_unnamed_addr #0 {
  ...
  %10 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 5
  %11 = load i32, i32* %10, align 4, !tbaa !9
  %12 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 6
  %13 = load i32, i32* %12, align 8, !tbaa !10
  %14 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 7
  %15 = load i32, i32* %14, align 4, !tbaa !11
  %16 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %0, i64 0, i32 4
...
32:                                               ; preds = %47, %35
  ...
  br i1 %34, label %56, label %35, !llvm.loop !122
...
47:                                               ; preds = %44, %47
  ...
  br i1 %55, label %32, label %47, !llvm.loop !123
...
59:                                               ; preds = %56, %23
  ...
  %62 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 1) #9
  %63 = getelementptr inbounds i8, i8* %62, i64 32
  %64 = bitcast i8* %63 to i32*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(32) %62, i8 0, i64 32, i1 false) #9
  store i32 %17, i32* %64, align 8, !tbaa !3
  %65 = getelementptr inbounds i8, i8* %62, i64 36
  %66 = bitcast i8* %65 to i32*
  store i32 %60, i32* %66, align 4, !tbaa !9
  %67 = getelementptr inbounds i8, i8* %62, i64 40
  %68 = bitcast i8* %67 to i32*
  store i32 %11, i32* %68, align 8, !tbaa !10
  %69 = getelementptr inbounds i8, i8* %62, i64 44
  ...
  store i8* %62, i8** %73, align 8, !tbaa !124
  %74 = add nsw i32 %60, 1
  %75 = sext i32 %74 to i64
  %76 = call i8* @hypre_CAlloc(i64 %75, i64 4, i32 1) #9
  %77 = bitcast i8* %76 to i32*
  %78 = sext i32 %24 to i64
  %79 = call i8* @hypre_CAlloc(i64 %78, i64 4, i32 1) #9
  %80 = bitcast i8* %79 to i32*
  %81 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %1, align 8, !tbaa !124
  ...
  %84 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %1, align 8, !tbaa !124
...
88:                                               ; preds = %59
  ...
  %91 = call i8* @hypre_CAlloc(i64 %90, i64 8, i32 1) #9
  %92 = bitcast i8* %91 to double*
  %93 = bitcast %struct.hypre_CSRBlockMatrix** %1 to i8***
  %94 = load i8**, i8*** %93, align 8, !tbaa !124
...
108:                                              ; preds = %98, %108
  ...
  br i1 %118, label %100, label %108, !llvm.loop !125
...
129:                                              ; preds = %102, %129
  ...
  store i32 %134, i32* %132, align 4, !tbaa !21
  %135 = add nuw nsw i64 %131, 1
  %136 = icmp eq i64 %135, %104
  br i1 %136, label %119, label %129, !llvm.loop !126

137:                                              ; preds = %193, %143
  %138 = icmp eq i64 %147, %125
  br i1 %138, label %139, label %143, !llvm.loop !127
...
154:                                              ; preds = %151, %193
  ...
  store i32 %153, i32* %162, align 4, !tbaa !21
  br i1 %126, label %193, label %163

163:                                              ; preds = %154
  %164 = load i32, i32* %156, align 4, !tbaa !21
...
178:                                              ; preds = %172, %178
  ...
  store double %185, double* %187, align 8, !tbaa !25
  %188 = add nuw nsw i64 %179, 1
  %189 = icmp eq i64 %188, %128
  br i1 %189, label %190, label %178, !llvm.loop !128

190:                                              ; preds = %178, %172
  %191 = add nuw nsw i64 %173, 1
  %192 = icmp eq i64 %191, %127
  br i1 %192, label %193, label %172, !llvm.loop !129

193:                                              ; preds = %190, %154
  %194 = load i32, i32* %156, align 4, !tbaa !21
  %195 = sext i32 %194 to i64
  %196 = getelementptr inbounds i32, i32* %77, i64 %195
  %197 = load i32, i32* %196, align 4, !tbaa !21
  %198 = add nsw i32 %197, 1
  store i32 %198, i32* %196, align 4, !tbaa !21
  %199 = add nsw i64 %155, 1
  %200 = load i32, i32* %148, align 4, !tbaa !21
  %201 = sext i32 %200 to i64
  %202 = icmp slt i64 %199, %201
  br i1 %202, label %154, label %137, !llvm.loop !130
...
203:                                              ; preds = %141, %203
  ...
  br i1 %211, label %203, label %213, !llvm.loop !131
...
!3 = !{!4, !8, i64 32}
!4 = !{!"", !5, i64 0, !5, i64 8, !5, i64 16, !5, i64 24, !8, i64 32, !8, i64 36, !8, i64 40, !8, i64 44, !8, i64 48}
...
!16 = !{!4, !5, i64 24}
!17 = !{!18, !5, i64 0}
!18 = !{!"", !5, i64 0, !5, i64 8, !5, i64 16, !8, i64 24, !8, i64 28, !8, i64 32, !5, i64 40, !5, i64 48, !8, i64 56, !5, i64 64, !5, i64 72, !8, i64 80, !8, i64 84}
!19 = !{!18, !5, i64 8}
!20 = !{!18, !5, i64 64}
!21 = !{!8, !8, i64 0}

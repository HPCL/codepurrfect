...
define dso_local void @hypre_PrintLine(i8* %0, %struct.hypre_PilutSolverGlobals* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %5 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i32 %4, i8* %0, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i64 0, i64 0), i32 31) #3
...
8:                                                ; preds = %4
  ...
  call void (i8*, ...) @hypre_errexit(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.2, i64 0, i64 0), i32 %10, i32 %0, i32 %1, i32 %2, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i64 0, i64 0), i32 43) #3
  br label %11
...
20:                                               ; preds = %9, %5
  ...
  %25 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i64 0, i64 0), i32 %23, i32 %24, i8* %2, i32 %3, i64 %21, i32 %1) #3
...
20:                                               ; preds = %9, %5
  ...
  %25 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.4, i64 0, i64 0), i32 %23, i32 %24, i8* %2, i32 %3, i64 %21, i32 %1) #3
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !10
  %27 = call i32 @fflush(%struct._IO_FILE* %26)
...
21:                                               ; preds = %10, %5
  ...
  %26 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.5, i64 0, i64 0), i32 %24, i32 %25, i8* %2, i32 %3, i64 %22, i32 %1) #3
...
20:                                               ; preds = %16, %12, %8, %4, %2
  ...
  %24 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.6, i64 0, i64 0), i32 %22, i32 %23) #3
...
29:                                               ; preds = %16
  ...
  %39 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.7, i64 0, i64 0), i32 %31, i32 %32, i32 %34, i32 %36, i32 %38) #3
...
59:                                               ; preds = %48, %29
  ...
  %63 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i64 0, i64 0), i32 %61, i32 %62, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.8, i64 0, i64 0), i32 %44, i64 %60, i32 %43) #3
  %64 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !10
  %65 = call i32 @fflush(%struct._IO_FILE* %64) #3
...
85:                                               ; preds = %74, %59
  ...
  %88 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i64 0, i64 0), i32 %87, i32 %67, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.9, i64 0, i64 0), i32 %70, i64 %86, i32 %69) #3
  %89 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !10
  %90 = call i32 @fflush(%struct._IO_FILE* %89) #3
...
117:                                              ; preds = %106, %95
  ...
  %122 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i64 0, i64 0), i32 %119, i32 %120, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.10, i64 0, i64 0), i32 %121, i64 %118, i32 %102) #3
  %123 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !10
  %124 = call i32 @fflush(%struct._IO_FILE* %123) #3
...
148:                                              ; preds = %137, %117
  ...
  %153 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.5, i64 0, i64 0), i32 %150, i32 %151, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.11, i64 0, i64 0), i32 %152, i64 %149, i32 %133) #3
  %154 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !10
  %155 = call i32 @fflush(%struct._IO_FILE* %154) #3
...
48:                                               ; preds = %38, %34, %30, %26, %22, %18, %14, %10, %6, %2
  ...
  %51 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12, i64 0, i64 0), i32 %50, i32 0) #3
...
121:                                              ; preds = %117, %42
  ...
  %130 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.13, i64 0, i64 0), i32 %129, i32 0, i64 %122, i64 %123, i64 %126, i64 %124, i64 %125) #3
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_PrintVector(i32* nocapture readonly %0, i32 %1, i8* %2, %struct.hypre_PilutSolverGlobals* nocapture readonly %3) local_unnamed_addr #0 {
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.15, i64 0, i64 0), i32 %15, i8* %2) #3
...
19:                                               ; preds = %17, %19
  ...
  %23 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.16, i64 0, i64 0), i32 %22) #3
  %24 = add nuw nsw i64 %20, 1
  %25 = icmp eq i64 %24, %12
  br i1 %25, label %26, label %19, !llvm.loop !44

26:                                               ; preds = %19, %17
  %27 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.17, i64 0, i64 0)) #3
  br label %28

28:                                               ; preds = %26, %13
  %29 = load i32, i32* %8, align 8, !tbaa !45
  %30 = call i32 @hypre_MPI_Barrier(i32 %29) #3

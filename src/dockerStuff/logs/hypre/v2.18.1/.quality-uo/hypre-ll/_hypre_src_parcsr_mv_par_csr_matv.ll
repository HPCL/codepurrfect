...
70:                                               ; preds = %68, %70
  ...
  %72 = load i32*, i32** %65, align 8, !tbaa !25
  %73 = getelementptr inbounds i32, i32* %72, i64 %66
  %74 = load i32, i32* %73, align 4, !tbaa !26
  %75 = sext i32 %74 to i64
  %76 = shl nsw i64 %75, 3
  %77 = call i8* @hypre_MAlloc(i64 %76, i32 0) #3
  %78 = getelementptr inbounds double*, double** %64, i64 %71
  %79 = bitcast double** %78 to i8**
  store i8* %77, i8** %79, align 8, !tbaa !27
  %80 = add nuw nsw i64 %71, 1
  %81 = icmp eq i64 %80, %69
  br i1 %81, label %82, label %70, !llvm.loop !28

82:                                               ; preds = %70, %53
  %83 = call i32 @hypre_SeqVectorPrefetch(%struct.hypre_Vector* %14, i32 0) #3
  %84 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %54, i64 0, i32 4
  %85 = icmp sgt i32 %30, 0
  br i1 %85, label %86, label %97

86:                                               ; preds = %82
  %87 = sext i32 %56 to i64
  %88 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %54, i64 0, i32 3
  %89 = load i32*, i32** %88, align 8, !tbaa !25
  %90 = load i32, i32* %89, align 4, !tbaa !26
  %91 = getelementptr inbounds i32, i32* %89, i64 %87
...
101:                                              ; preds = %86, %121
  %102 = phi i64 [ 0, %86 ], [ %122, %121 ]
  %103 = getelementptr inbounds double*, double** %64, i64 %102
  %104 = load double*, double** %103, align 8, !tbaa !27
  %105 = trunc i64 %102 to i32
  %106 = mul nsw i32 %34, %105
  %107 = sext i32 %106 to i64
  br i1 %93, label %108, label %121

108:                                              ; preds = %101
  %109 = load i32*, i32** %84, align 8, !tbaa !31
  br label %110

110:                                              ; preds = %108, %110
  %111 = phi i64 [ %94, %108 ], [ %119, %110 ]
  %112 = getelementptr inbounds i32, i32* %109, i64 %111
  %113 = load i32, i32* %112, align 4, !tbaa !26
  %114 = sext i32 %113 to i64
  %115 = add nsw i64 %114, %107
  %116 = getelementptr inbounds double, double* %36, i64 %115
  %117 = load double, double* %116, align 8, !tbaa !32
  %118 = getelementptr inbounds double, double* %104, i64 %111
  store double %117, double* %118, align 8, !tbaa !32
  %119 = add nsw i64 %111, 1
  %120 = icmp eq i64 %119, %96
  br i1 %120, label %121, label %110, !llvm.loop !33

121:                                              ; preds = %110, %101
  %122 = add nuw nsw i64 %102, 1
  %123 = icmp eq i64 %122, %95
  br i1 %123, label %97, label %101, !llvm.loop !34

124:                                              ; preds = %99, %124
  %125 = phi i64 [ 0, %99 ], [ %136, %124 ]
  %126 = getelementptr inbounds double*, double** %64, i64 %125
  ...
  %134 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate_v2(i32 1, %struct._hypre_ParCSRCommPkg* %54, i32 0, i8* %128, i32 0, i8* %133) #3
  %135 = getelementptr inbounds %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %59, i64 %125
  store %struct.hypre_ParCSRCommHandle* %134, %struct.hypre_ParCSRCommHandle** %135, align 8, !tbaa !27
  %136 = add nuw nsw i64 %125, 1
  %137 = icmp eq i64 %136, %100
  br i1 %137, label %138, label %124, !llvm.loop !35

138:                                              ; preds = %124, %97
  %139 = call i32 @hypre_CSRMatrixMatvecOutOfPlace(double %0, %struct.hypre_CSRMatrix* %10, %struct.hypre_Vector* %14, double %3, %struct.hypre_Vector* %16, %struct.hypre_Vector* %18, i32 0) #3
...
143:                                              ; preds = %141, %143
  ...
  %145 = getelementptr inbounds %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %59, i64 %144
  %146 = load %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %145, align 8, !tbaa !27
  %147 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %146) #3
  store %struct.hypre_ParCSRCommHandle* null, %struct.hypre_ParCSRCommHandle** %145, align 8, !tbaa !27
  %148 = add nuw nsw i64 %144, 1
  %149 = icmp eq i64 %148, %142
  br i1 %149, label %150, label %143, !llvm.loop !36

150:                                              ; preds = %143, %138
  call void @hypre_Free(i8* %58, i32 1) #3
  %151 = icmp eq i32 %32, 0
  br i1 %151, label %154, label %152

152:                                              ; preds = %150
  %153 = call i32 @hypre_CSRMatrixMatvec(double %0, %struct.hypre_CSRMatrix* %12, %struct.hypre_Vector* %48, double 1.000000e+00, %struct.hypre_Vector* %18) #3
  br label %154

154:                                              ; preds = %152, %150
  %155 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %48) #3
...
159:                                              ; preds = %157, %159
  ...
  call void @hypre_Free(i8* %163, i32 0) #3
  store double* null, double** %161, align 8, !tbaa !27
  %164 = add nuw nsw i64 %160, 1
  %165 = icmp eq i64 %164, %158
  br i1 %165, label %166, label %159, !llvm.loop !37

166:                                              ; preds = %159, %154
  %167 = select i1 %41, i32 %38, i32 12
  %168 = select i1 %41, i32 %38, i32 13
  %169 = select i1 %37, i32 %167, i32 %168
  call void @hypre_Free(i8* %63, i32 1) #3
  ret i32 %169
}
...
68:                                               ; preds = %66, %68
  ...
  %74 = shl nsw i64 %73, 3
  %75 = call i8* @hypre_MAlloc(i64 %74, i32 0) #3
...
92:                                               ; preds = %90, %92
  ...
  %102 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate_v2(i32 2, %struct._hypre_ParCSRCommPkg* %52, i32 0, i8* %98, i32 0, i8* %101) #3
...
123:                                              ; preds = %116, %112
  call void @hypre_Free(i8* %56, i32 1) #3
...
167:                                              ; preds = %165, %167
  ...
  call void @hypre_Free(i8* %171, i32 0) #3
...
174:                                              ; preds = %167, %162
  ...
  call void @hypre_Free(i8* %61, i32 1) #3
  ret i32 %177
}
...
59:                                               ; preds = %54
  ...
  %66 = call i8* @hypre_CAlloc(i64 %65, i64 8, i32 1) #3
...
122:                                              ; preds = %119
  ...
  %129 = call i8* @hypre_CAlloc(i64 %128, i64 4, i32 1) #3
...
134:                                              ; preds = %131
  ...
  %136 = call i8* @hypre_CAlloc(i64 %135, i64 4, i32 1) #3
...
185:                                              ; preds = %183, %178
  ...
  call void @hypre_Free(i8* %187, i32 1) #3
  call void @hypre_Free(i8* %179, i32 1) #3
  call void @hypre_Free(i8* %180, i32 1) #3
  br label %188
...
!16 = !{!13, !5, i64 4}
!17 = !{!18, !5, i64 20}
!18 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}
!19 = !{!20, !5, i64 28}
!20 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80, !5, i64 84}
!21 = !{!18, !5, i64 28}
!22 = !{!18, !8, i64 0}
!23 = !{!24, !5, i64 4}

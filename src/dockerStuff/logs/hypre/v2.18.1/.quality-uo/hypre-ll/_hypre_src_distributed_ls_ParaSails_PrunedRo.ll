...
define dso_local %struct.PrunedRows* @PrunedRowsCreate(%struct.Matrix* %0, i32 %1, %struct.DiagScale* %2, double %3) local_unnamed_addr #0 {
  ...
  %11 = call i8* @hypre_MAlloc(i64 32, i32 1) #5
  %12 = call %struct.Mem* (...) @MemCreate() #5
  ...
  %32 = shl nsw i64 %31, 3
  %33 = call i8* @hypre_MAlloc(i64 %32, i32 1) #5
...
40:                                               ; preds = %4, %128
  ...
  call void @MatrixGetRow(%struct.Matrix* %0, i32 %42, i32* nonnull %5, i32** nonnull %6, double** nonnull %7) #5
...
47:                                               ; preds = %45, %72
  ...
  %50 = call double @DiagScaleGet(%struct.DiagScale* %2, i32 %46) #5
  ...
  %61 = call double @DiagScaleGet(%struct.DiagScale* %2, i32 %60) #5
...
78:                                               ; preds = %72, %40
  ...
  %81 = shl i32 %79, 2
  %82 = call i8* @MemAlloc(%struct.Mem* %80, i32 %81) #5
...
97:                                               ; preds = %94, %122
  ...
  %100 = call double @DiagScaleGet(%struct.DiagScale* %2, i32 %96) #5
  ...
  %111 = call double @DiagScaleGet(%struct.DiagScale* %2, i32 %110) #5
...
define dso_local void @PrunedRowsDestroy(%struct.PrunedRows* nocapture %0) local_unnamed_addr #0 {
  ...
  call void @MemDestroy(%struct.Mem* %3) #5
...
define dso_local i32* @PrunedRowsAlloc(%struct.PrunedRows* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %5 = shl i32 %1, 2
  %6 = call i8* @MemAlloc(%struct.Mem* %4, i32 %5) #5
...
8:                                                ; preds = %4
  ...
  %14 = shl nsw i64 %13, 2
  %15 = call i8* @hypre_ReAlloc(i8* %12, i64 %14, i32 1) #5
  ...
  %21 = shl nsw i64 %20, 3
  %22 = call i8* @hypre_ReAlloc(i8* %18, i64 %21, i32 1) #5
...
define dso_local void @PrunedRowsGet(%struct.PrunedRows* nocapture readonly %0, i32 %1, i32* nocapture %2, i32** nocapture %3) local_unnamed_addr #4 {

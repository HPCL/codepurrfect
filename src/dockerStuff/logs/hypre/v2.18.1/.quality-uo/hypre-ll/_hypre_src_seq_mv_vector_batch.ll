...
37:                                               ; preds = %33, %37
  ...
  br i1 %53, label %54, label %37, !llvm.loop !62

54:                                               ; preds = %37, %27
  %55 = phi double [ %32, %27 ], [ %51, %37 ]
  %56 = phi double [ %30, %27 ], [ %47, %37 ]
  store double %56, double* %29, align 8, !tbaa !11
  store double %55, double* %31, align 8, !tbaa !11
  %57 = add nuw nsw i64 %28, 1
  %58 = icmp eq i64 %57, %21
  br i1 %58, label %59, label %27, !llvm.loop !63

59:                                               ; preds = %54, %17, %25, %23
  %60 = load i32, i32* @hypre__global_error, align 4, !tbaa !24
  ret i32 %60
}
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !4, i64 0}
!8 = !{!"", !4, i64 0, !9, i64 8, !9, i64 12, !9, i64 16, !9, i64 20, !9, i64 24, !9, i64 28, !9, i64 32}
!9 = !{!"int", !5, i64 0}
!10 = !{!8, !9, i64 8}
!11 = !{!12, !12, i64 0}
!12 = !{!"double", !5, i64 0}

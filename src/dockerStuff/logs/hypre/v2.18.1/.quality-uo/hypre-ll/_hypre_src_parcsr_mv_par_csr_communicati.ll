...
define dso_local %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 %0, %struct._hypre_ParCSRCommPkg* %1, i8* %2, i8* %3) local_unnamed_addr #0 {
  %5 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate_v2(i32 %0, %struct._hypre_ParCSRCommPkg* %1, i32 1, i8* %2, i32 1, i8* %3)
...
414:                                              ; preds = %394, %339, %284, %229, %174, %119, %369, %314, %259, %204, %149, %94, %75
  %415 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #3
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %11 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 4
  %12 = load i32, i32* %11, align 8, !tbaa !60
  %13 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 11
  ...
  %16 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %15, align 8, !tbaa !62
  %17 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %16, i64 0, i32 4
  ...
  %22 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %21, align 8, !tbaa !66
  %23 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %22, i64 0, i32 4
  %24 = load i32, i32* %23, align 4, !tbaa !63
  %25 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 1) #3
  %26 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15
  %27 = bitcast %struct._hypre_ParCSRCommPkg** %26 to i8**
  store i8* %25, i8** %27, align 8, !tbaa !67
  ...
  call void @hypre_ParCSRCommPkgCreate_core(i32 %10, i32* %14, i32 %12, i32* %20, i32 %24, i32 %18, i32* nonnull %6, i32** nonnull %7, i32** nonnull %8, i32* nonnull %2, i32** nonnull %3, i32** nonnull %4, i32** nonnull %5) #3
  %35 = bitcast i8* %25 to i32*
  store i32 %10, i32* %35, align 8, !tbaa !10
  %36 = load i32, i32* %6, align 4, !tbaa !12
  %37 = getelementptr inbounds i8, i8* %25, i64 40
  %38 = bitcast i8* %37 to i32*
  store i32 %36, i32* %38, align 8, !tbaa !9
  %39 = load i32*, i32** %7, align 8, !tbaa !14
  %40 = getelementptr inbounds i8, i8* %25, i64 48
  %41 = bitcast i8* %40 to i32**
  store i32* %39, i32** %41, align 8, !tbaa !15
  %42 = load i32*, i32** %8, align 8, !tbaa !14
  %43 = getelementptr inbounds i8, i8* %25, i64 56
  ...
  %48 = load i32*, i32** %3, align 8, !tbaa !14
  %49 = getelementptr inbounds i8, i8* %25, i64 8
  %50 = bitcast i8* %49 to i32**
  store i32* %48, i32** %50, align 8, !tbaa !19
  %51 = load i32*, i32** %4, align 8, !tbaa !14
  %52 = getelementptr inbounds i8, i8* %25, i64 16
  %53 = bitcast i8* %52 to i32**
  store i32* %51, i32** %53, align 8, !tbaa !11
  %54 = load i32*, i32** %5, align 8, !tbaa !14
  %55 = getelementptr inbounds i8, i8* %25, i64 24
  %56 = bitcast i8* %55 to i32**
  store i32* %54, i32** %56, align 8, !tbaa !56
...
5:                                                ; preds = %1
  ...
  %14 = load i8*, i8** %13, align 8, !tbaa !68
...
22:                                               ; preds = %15
  ...
  call void @hypre_Free(i8* %25, i32 1) #3
...
26:                                               ; preds = %22, %15
  ...
  call void @hypre_Free(i8* %29, i32 1) #3
  store i32* null, i32** %27, align 8, !tbaa !13
  %30 = bitcast %struct._hypre_ParCSRCommPkg* %0 to i8*
  call void @hypre_Free(i8* %30, i32 1) #3
  %31 = load i32, i32* @hypre__global_error, align 4, !tbaa !12
  ret i32 %31
}

; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_ParCSRFindExtendCommPkg(i32 %0, i32 %1, i32 %2, i32 %3, i32* nocapture readonly %4, %struct.hypre_IJAssumedPart* nocapture readnone %5, i32 %6, i32* %7, %struct._hypre_ParCSRCommPkg** nocapture %8) local_unnamed_addr #0 {
  ...
  %17 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 1) #3
  %18 = bitcast %struct._hypre_ParCSRCommPkg** %8 to i8**
  ...
  call void @hypre_ParCSRCommPkgCreate_core(i32 %0, i32* %7, i32 %2, i32* %4, i32 %3, i32 %6, i32* nonnull %14, i32** nonnull %15, i32** nonnull %16, i32* nonnull %10, i32** nonnull %11, i32** nonnull %12, i32** nonnull %13) #3
  ...
  %31 = getelementptr inbounds i8, i8* %17, i64 48
  %32 = bitcast i8* %31 to i32**
  store i32* %30, i32** %32, align 8, !tbaa !15
  %33 = load i32*, i32** %16, align 8, !tbaa !14
  %34 = getelementptr inbounds i8, i8* %17, i64 56
  %35 = bitcast i8* %34 to i32**
  store i32* %33, i32** %35, align 8, !tbaa !13
  %36 = load i32, i32* %10, align 4, !tbaa !12
  %37 = getelementptr inbounds i8, i8* %17, i64 4
  %38 = bitcast i8* %37 to i32*
  store i32 %36, i32* %38, align 4, !tbaa !3
  %39 = load i32*, i32** %11, align 8, !tbaa !14
  %40 = getelementptr inbounds i8, i8* %17, i64 8
  %41 = bitcast i8* %40 to i32**
  store i32* %39, i32** %41, align 8, !tbaa !19
  %42 = load i32*, i32** %12, align 8, !tbaa !14
  %43 = getelementptr inbounds i8, i8* %17, i64 16
  %44 = bitcast i8* %43 to i32**
  store i32* %42, i32** %44, align 8, !tbaa !11
  %45 = load i32*, i32** %13, align 8, !tbaa !14
  %46 = getelementptr inbounds i8, i8* %17, i64 24
  %47 = bitcast i8* %46 to i32**
  store i32* %45, i32** %47, align 8, !tbaa !56
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %20) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %19) #3
  %48 = load i32, i32* @hypre__global_error, align 4, !tbaa !12
  ret i32 %48
}
...
!31 = !{!32, !8, i64 0}
!32 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64}
!33 = !{!32, !5, i64 8}
!34 = !{!32, !5, i64 12}
!35 = !{!32, !5, i64 16}
!36 = !{!32, !5, i64 20}
...
!56 = !{!4, !8, i64 24}
!57 = !{!58, !5, i64 0}
!58 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !5, i64 112, !5, i64 116, !5, i64 120, !5, i64 124, !59, i64 128, !8, i64 136, !8, i64 144, !5, i64 152, !8, i64 160, !5, i64 168, !8, i64 176, !5, i64 184, !8, i64 192, !8, i64 200}
!59 = !{!"double", !6, i64 0}
!60 = !{!58, !5, i64 16}
!61 = !{!58, !8, i64 64}
!62 = !{!58, !8, i64 40}
!63 = !{!64, !5, i64 28}
!64 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80, !5, i64 84}
!65 = !{!58, !8, i64 88}
!66 = !{!58, !8, i64 32}
!67 = !{!58, !8, i64 96}
!68 = !{!4, !8, i64 32}

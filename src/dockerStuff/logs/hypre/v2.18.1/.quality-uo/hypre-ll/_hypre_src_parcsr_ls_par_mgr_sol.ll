...
145:                                              ; preds = %140, %138
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 159, i32 1, i8* null) #4
  br label %311
...
285:                                              ; preds = %280
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 276, i32 256, i8* null) #4
  br label %286
...
define dso_local i32 @hypre_MGRFrelaxVcycle(i8* %0, %struct.hypre_ParVector_struct* nocapture readnone %1, %struct.hypre_ParVector_struct* nocapture readnone %2) local_unnamed_addr #0 {
  ...
  %11 = getelementptr inbounds i8, i8* %0, i64 368
  %12 = bitcast i8* %11 to %struct.hypre_ParCSRMatrix_struct***
  ...
  %20 = getelementptr inbounds i8, i8* %0, i64 680
  ...
  %23 = getelementptr inbounds i8, i8* %0, i64 728
...
!73 = !{!74, !5, i64 8}
!74 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}

...
define dso_local %struct.hypre_CSRMatrix_struct* @HYPRE_CSRMatrixCreate(i32 %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  %4 = add nsw i32 %0, 1
  %5 = sext i32 %4 to i64
  %6 = call i8* @hypre_CAlloc(i64 %5, i64 4, i32 1) #4
...
21:                                               ; preds = %12, %3
  ...
  %25 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %0, i32 %1, i32 %24) #4
...
define dso_local i32 @HYPRE_CSRMatrixDestroy(%struct.hypre_CSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %3 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %2) #4
  ret i32 %3
}
...
define dso_local i32 @HYPRE_CSRMatrixInitialize(%struct.hypre_CSRMatrix_struct* %0) local_unnamed_addr #0 {
  %2 = bitcast %struct.hypre_CSRMatrix_struct* %0 to %struct.hypre_CSRMatrix*
  %3 = call i32 @hypre_CSRMatrixInitialize(%struct.hypre_CSRMatrix* %2) #4
  ret i32 %3
}
...
define dso_local %struct.hypre_CSRMatrix_struct* @HYPRE_CSRMatrixRead(i8* %0) local_unnamed_addr #0 {
  %2 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixRead(i8* %0) #4
...
define dso_local void @HYPRE_CSRMatrixPrint(%struct.hypre_CSRMatrix_struct* %0, i8* %1) local_unnamed_addr #0 {
  ...
  %4 = call i32 @hypre_CSRMatrixPrint(%struct.hypre_CSRMatrix* %3, i8* %1) #4
  ret void
}
...
define dso_local i32 @HYPRE_CSRMatrixDeviceSpGemmSetRownnzEstimateMethod(i32 %0) local_unnamed_addr #3 {
  ret i32 0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone uwtable willreturn
define dso_local i32 @HYPRE_CSRMatrixDeviceSpGemmSetRownnzEstimateNSamples(i32 %0) local_unnamed_addr #3 {
  ret i32 0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone uwtable willreturn
define dso_local i32 @HYPRE_CSRMatrixDeviceSpGemmSetRownnzEstimateMultFactor(double %0) local_unnamed_addr #3 {
  ret i32 0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone uwtable willreturn
define dso_local i32 @HYPRE_CSRMatrixDeviceSpGemmSetHashType(i8 signext %0) local_unnamed_addr #3 {
  ret i32 0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone uwtable willreturn
define dso_local i32 @HYPRE_CSRMatrixDeviceSpGemmSetUseCusparse(i32 %0) local_unnamed_addr #3 {
  ret i32 0
}
...
!10 = !{!11, !12, i64 0}
!11 = !{!"", !12, i64 0, !12, i64 8, !12, i64 16, !4, i64 24, !4, i64 28, !4, i64 32, !12, i64 40, !12, i64 48, !4, i64 56, !12, i64 64, !12, i64 72, !4, i64 80, !4, i64 84}

...
8:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 40, i32 2, i8* getelementptr inbounds ([143 x i8], [143 x i8]* @.str.3, i64 0, i64 0)) #11
...
14:                                               ; preds = %11
  call fastcc void @hypre_OutOfMemory() #11
...
15:                                               ; preds = %14
  %16 = call noalias align 16 i8* @malloc(i64 %1) #11
  br label %20

17:                                               ; preds = %14
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 40, i32 2, i8* getelementptr inbounds ([143 x i8], [143 x i8]* @.str.3, i64 0, i64 0)) #11
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !3
  %19 = call i32 @fflush(%struct._IO_FILE* %18) #11
  br label %20
...
25:                                               ; preds = %24
  %26 = call align 16 i8* @realloc(i8* nonnull %0, i64 %1) #11
  br label %30

27:                                               ; preds = %24
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 40, i32 2, i8* getelementptr inbounds ([143 x i8], [143 x i8]* @.str.3, i64 0, i64 0)) #11
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !3
  %29 = call i32 @fflush(%struct._IO_FILE* %28) #11
  br label %30
...
33:                                               ; preds = %30
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 33, i32 2, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.4, i64 0, i64 0)) #11
  %34 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !3
  %35 = call i32 @fflush(%struct._IO_FILE* %34) #11
  br label %36
...
11:                                               ; preds = %9
  %12 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str, i64 0, i64 0), i64 %2, i8* %1, i8* %0) #11
  br label %14
...
8:                                                ; preds = %6
  %9 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.1, i64 0, i64 0), i64 %2, i8* null) #11
  br label %17
...
define dso_local i32 @hypre_GetMemoryLocation(i8* nocapture readnone %0, i32* nocapture %1) local_unnamed_addr #5 {
...
; Function Attrs: inaccessiblemem_or_argmemonly mustprogress nounwind willreturn
declare dso_local noalias noundef align 16 i8* @realloc(i8* nocapture, i64 noundef) local_unnamed_addr #9

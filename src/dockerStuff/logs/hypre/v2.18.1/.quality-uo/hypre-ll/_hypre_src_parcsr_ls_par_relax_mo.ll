...
define dso_local i32 @hypre_ParCSRMaxEigEstimateCG(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32 %2, double* nocapture %3, double* nocapture %4) local_unnamed_addr #0 {
  ...
  %71 = call i8* @hypre_CAlloc(i64 %70, i64 8, i32 1) #8
  %72 = bitcast i8* %71 to double*
  %73 = call i8* @hypre_CAlloc(i64 %70, i64 8, i32 1) #8
...
190:                                              ; preds = %188, %113
  ...
  call void @hypre_Free(i8* %71, i32 1) #8
...
define dso_local i32 @hypre_ParCSRRelax_Cheby(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, double %2, double %3, double %4, i32 %5, i32 %6, i32 %7, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* %10) local_unnamed_addr #0 {
  ...
  %35 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %14, i64 0, i32 3
...
196:                                              ; preds = %136, %139, %149, %168, %135, %53, %56, %66, %93, %52
  ...
  %198 = call i8* @hypre_CAlloc(i64 %197, i64 8, i32 1) #8
...
258:                                              ; preds = %196
  ...
  %263 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 13
...
395:                                              ; preds = %249, %226, %392
  call void @hypre_Free(i8* %198, i32 1) #8
...
12:                                               ; preds = %6, %12
  ...
  %16 = call i32 @hypre_BoomerAMGRelax(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* %2, i32 0, i32 %15, double %3, double 0.000000e+00, double* null, %struct.hypre_ParVector_struct* %4, %struct.hypre_ParVector_struct* %5, %struct.hypre_ParVector_struct* null) #8
  %17 = add nuw nsw i64 %13, 1
  %18 = icmp eq i64 %17, 3
  br i1 %18, label %19, label %12, !llvm.loop !51
...
define dso_local i32 @hypre_ParCSRRelax_L1_Jacobi(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, %struct.hypre_ParVector_struct* nocapture readonly %1, i32* nocapture readonly %2, i32 %3, double %4, double* nocapture readonly %5, %struct.hypre_ParVector_struct* nocapture readonly %6, %struct.hypre_ParVector_struct* nocapture readonly %7) local_unnamed_addr #0 {
  ...
  %30 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %29, align 8, !tbaa !53
...
53:                                               ; preds = %8
  %54 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %30, i64 0, i32 1
  %55 = load i32, i32* %54, align 4, !tbaa !55
  %56 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %30, i64 0, i32 3
  %57 = load i32*, i32** %56, align 8, !tbaa !57
  %58 = sext i32 %55 to i64
  %59 = getelementptr inbounds i32, i32* %57, i64 %58
  %60 = load i32, i32* %59, align 4, !tbaa !16
  %61 = sext i32 %60 to i64
  %62 = call i8* @hypre_CAlloc(i64 %61, i64 8, i32 1) #8
  %63 = bitcast i8* %62 to double*
  %64 = sext i32 %34 to i64
  %65 = call i8* @hypre_CAlloc(i64 %64, i64 8, i32 1) #8
...
110:                                              ; preds = %81, %71
  %111 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct._hypre_ParCSRCommPkg* %30, i8* %62, i8* %65) #8
  br label %112
...
285:                                              ; preds = %282
  ...
  call void @hypre_Free(i8* %286, i32 1) #8
  call void @hypre_Free(i8* %114, i32 1) #8
  br label %287
...
!27 = !{!28, !8, i64 0}
!28 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}
...
!54 = !{!11, !5, i64 28}
!55 = !{!56, !5, i64 4}
!56 = !{!"_hypre_ParCSRCommPkg", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !5, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72}
!57 = !{!56, !8, i64 16}

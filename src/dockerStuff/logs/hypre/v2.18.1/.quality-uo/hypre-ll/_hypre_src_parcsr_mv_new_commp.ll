...
define dso_local i32 @hypre_PrintCommpkg(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i8* %1) local_unnamed_addr #0 {
  ...
  %7 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15
...
385:                                              ; preds = %382
  ...
  call void @hypre_Free(i8* %388, i32 1) #4
...
389:                                              ; preds = %382
  ...
  %395 = call i8* @hypre_CAlloc(i64 %394, i64 4, i32 1) #4
...
define dso_local i32 @hypre_NewCommPkgDestroy(%struct.hypre_ParCSRMatrix_struct* nocapture %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15

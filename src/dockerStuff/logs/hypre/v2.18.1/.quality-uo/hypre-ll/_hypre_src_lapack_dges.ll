...
define dso_local i32 @hypre_dgesvd(i8* %0, i8* %1, i32* %2, i32* %3, double* %4, i32* %5, double* %6, double* %7, i32* %8, double* %9, i32* %10, double* %11, i32* readonly %12, i32* %13) local_unnamed_addr #0 {
  ...
  %48 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #4
  store i64 %48, i64* @hypre_dgesvd.wntua, align 8, !tbaa !9
  %49 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #4
  ...
  %55 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #4
  store i64 %55, i64* @hypre_dgesvd.wntuo, align 8, !tbaa !9
  %56 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4
  store i64 %56, i64* @hypre_dgesvd.wntun, align 8, !tbaa !9
  %57 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #4
  store i64 %57, i64* @hypre_dgesvd.wntva, align 8, !tbaa !9
  %58 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #4
  ...
  %64 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #4
  store i64 %64, i64* @hypre_dgesvd.wntvo, align 8, !tbaa !9
  %65 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #4
...
1158:                                             ; preds = %1155
  ...
  %1160 = call i32 @hypre_lapack_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* nonnull %17) #4
  br label %4816

...
118:                                              ; preds = %105, %98
  ...
  %126 = call i8* @hypre_CAlloc(i64 %125, i64 4) #5
  %127 = bitcast i8* %126 to i32*
  %128 = call i8* @hypre_CAlloc(i64 %125, i64 4) #5
...
188:                                              ; preds = %183, %156
  %189 = call i8* @hypre_CAlloc(i64 2, i64 4) #5
  %190 = bitcast i8* %189 to i32*
  %191 = call i8* @hypre_CAlloc(i64 2, i64 4) #5
  %192 = bitcast i8* %191 to i32*
  br i1 %130, label %197, label %193

193:                                              ; preds = %188
  %194 = sext i32 %46 to i64
  %195 = call i8* @hypre_CAlloc(i64 %194, i64 4) #5
...
207:                                              ; preds = %204
  ...
  %209 = call i8* @hypre_CAlloc(i64 %208, i64 4) #5
...
445:                                              ; preds = %444
  ...
  %449 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0), i32 %448, double %447)
...
469:                                              ; preds = %455
  ...
  %471 = call i8* @hypre_CAlloc(i64 %470, i64 4) #5
  %472 = bitcast i8* %471 to i32*
  %473 = call i8* @hypre_CAlloc(i64 %470, i64 8) #5
...
479:                                              ; preds = %475
  ...
  %481 = call i8* @hypre_CAlloc(i64 %480, i64 4) #5
  %482 = bitcast i8* %481 to i32*
  %483 = call i8* @hypre_CAlloc(i64 %480, i64 8) #5
...
1181:                                             ; preds = %1174, %526
  ...
  call void @hypre_Free(i8* %1182) #5
  %1183 = bitcast i32* %212 to i8*
  call void @hypre_Free(i8* %1183) #5
...
1184:                                             ; preds = %1181
  ...
  %1188 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.1, i64 0, i64 0), i32 %1187, double %1186)
...
1235:                                             ; preds = %1232, %1221
  ...
  call void @hypre_Free(i8* %1236) #5
  %1237 = bitcast i32* %140 to i8*
  call void @hypre_Free(i8* %1237) #5
  call void @hypre_Free(i8* %189) #5
  call void @hypre_Free(i8* %191) #5
...
1240:                                             ; preds = %1235
  ...
  call void @hypre_Free(i8* %1245) #5
  %1246 = bitcast i32** %16 to i8**
  %1247 = load i8*, i8** %1246, align 8, !tbaa !19
  call void @hypre_Free(i8* %1247) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  %1248 = bitcast i32* %153 to i8*
  call void @hypre_Free(i8* %1248) #5
...
1250:                                             ; preds = %1240
  ...
  call void @hypre_Free(i8* %1252) #5
  store i32* null, i32** %17, align 8, !tbaa !19
  br label %1253
...
119:                                              ; preds = %106, %99
  ...
  %127 = call i8* @hypre_CAlloc(i64 %126, i64 4) #5
  %128 = bitcast i8* %127 to i32*
  %129 = call i8* @hypre_CAlloc(i64 %126, i64 4) #5
...
132:                                              ; preds = %119
  ...
  %139 = call i8* @hypre_CAlloc(i64 %136, i64 4) #5
...
147:                                              ; preds = %141
  ...
  %157 = call i8* @hypre_CAlloc(i64 %156, i64 4) #5
...
444:                                              ; preds = %441
  ...
  %446 = call i8* @hypre_CAlloc(i64 %445, i64 4) #5
  %447 = bitcast i8* %446 to i32*
  %448 = call i8* @hypre_CAlloc(i64 %445, i64 8) #5
...
454:                                              ; preds = %450
  ...
  %456 = call i8* @hypre_CAlloc(i64 %455, i64 4) #5
  %457 = bitcast i8* %456 to i32*
  %458 = call i8* @hypre_CAlloc(i64 %455, i64 8) #5
...
494:                                              ; preds = %493
  ...
  %496 = call i8* @hypre_CAlloc(i64 %495, i64 8) #5
  %497 = bitcast i8* %496 to double*
  %498 = call i8* @hypre_CAlloc(i64 %495, i64 4) #5
  %499 = bitcast i8* %498 to i32*
  %500 = call i8* @hypre_CAlloc(i64 %495, i64 4) #5
...
1545:                                             ; preds = %1541
  ...
  %1547 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], [47 x i8]* @.str.2, i64 0, i64 0), i32 %1546, double %1542, double %1543, double %1544)
...
1594:                                             ; preds = %1591, %1580
  ...
  call void @hypre_Free(i8* %1595) #5
  ...
  call void @hypre_Free(i8* %1598) #5
  %1599 = bitcast i32* %503 to i8*
  call void @hypre_Free(i8* %1599) #5
  %1600 = bitcast i32* %504 to i8*
  call void @hypre_Free(i8* %1600) #5
...
1603:                                             ; preds = %1594
  ...
  call void @hypre_Free(i8* %1604) #5
  %1605 = bitcast i32* %521 to i8*
  call void @hypre_Free(i8* %1605) #5
  %1606 = bitcast i32* %522 to i8*
  call void @hypre_Free(i8* %1606) #5
  br label %1607
...
1621:                                             ; preds = %1610
  ...
  call void @hypre_Free(i8* %1623) #5
  store i32* null, i32** %18, align 8, !tbaa !19
  br label %1624
...
427:                                              ; preds = %424
  ...
  %431 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0), i32 %430, double %429)
...
440:                                              ; preds = %437
  ...
  %442 = call i8* @hypre_CAlloc(i64 %441, i64 4) #5
  %443 = bitcast i8* %442 to i32*
  %444 = call i8* @hypre_CAlloc(i64 %441, i64 8) #5
...
1136:                                             ; preds = %1135
  ...
  %1140 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.1, i64 0, i64 0), i32 %1139, double %1138)
...
1187:                                             ; preds = %1184, %1173
  ...
  call void @hypre_Free(i8* %1188) #5
  %1189 = bitcast i32* %143 to i8*
  call void @hypre_Free(i8* %1189) #5
  %1190 = bitcast i32* %141 to i8*
  call void @hypre_Free(i8* %1190) #5
...
1193:                                             ; preds = %1187
  ...
  call void @hypre_Free(i8* %1198) #5
  %1199 = bitcast i32* %160 to i8*
  call void @hypre_Free(i8* %1199) #5
  %1200 = bitcast i32** %16 to i8**
  %1201 = load i8*, i8** %1200, align 8, !tbaa !19
  call void @hypre_Free(i8* %1201) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  %1202 = bitcast i32* %161 to i8*
  call void @hypre_Free(i8* %1202) #5
...
1204:                                             ; preds = %1193
  ...
  call void @hypre_Free(i8* %1206) #5
  store i32* null, i32** %17, align 8, !tbaa !19
  br label %1207

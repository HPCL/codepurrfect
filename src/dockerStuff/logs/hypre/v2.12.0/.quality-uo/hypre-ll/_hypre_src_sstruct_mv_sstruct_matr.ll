...
23:                                               ; preds = %15
  ...
  %27 = call i32 @HYPRE_StructMatrixSetSymmetric(%struct.hypre_StructMatrix_struct* nonnull %21, i32 %26) #9
  %28 = call i32 @hypre_StructMatrixInitialize(%struct.hypre_StructMatrix_struct* nonnull %21) #9
  %29 = call i32 @hypre_StructMatrixClearGhostValues(%struct.hypre_StructMatrix_struct* nonnull %21) #9
  br label %30
...
57:                                               ; preds = %54
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.1, i64 0, i64 0), i32 837, i32 12, i8* null) #9
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.1, i64 0, i64 0), i32 838, i32 20, i8* null) #9
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.1, i64 0, i64 0), i32 839, i32 28, i8* null) #9
  br label %140
...
define dso_local i32 @hypre_SStructUMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* nocapture readonly %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* nocapture readonly %6, double* %7, i32 %8) local_unnamed_addr #1 {
  ...
  %73 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %35) #9
  %74 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %35) #9
  %75 = call i32 @hypre_BoxSetExtents(%struct.hypre_Box_struct* %74, i32* %2, i32* %3) #9
  %76 = load i32, i32* %6, align 4, !tbaa !10
  %77 = icmp slt i32 %76, %59
  br i1 %77, label %78, label %470

78:                                               ; preds = %9
  %79 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %35) #9
  %80 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %35) #9
  %81 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 %35) #9
  %82 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %74) #9
  %83 = mul nsw i32 %82, %5
  %84 = sext i32 %83 to i64
  %85 = call i8* @hypre_CAlloc(i64 %84, i64 4) #9
...
96:                                               ; preds = %91, %78
  %97 = call i8* @hypre_CAlloc(i64 %84, i64 4) #9
  %98 = bitcast i8* %97 to i32*
  %99 = call i8* @hypre_CAlloc(i64 %84, i64 4) #9
  %100 = bitcast i8* %99 to i32*
  %101 = call i8* @hypre_CAlloc(i64 %84, i64 8) #9
  %102 = bitcast i8* %101 to double*
  %103 = getelementptr inbounds [3 x i32], [3 x i32]* %15, i64 0, i64 0
  %104 = call i32 @hypre_SetIndex(i32* nonnull %103, i32 1) #9
  %105 = call i32 @hypre_SStructGridIntersect(%struct.hypre_SStructGrid_struct* %41, i32 %1, i32 %4, %struct.hypre_Box_struct* %74, i32 -1, %struct.hypre_BoxManEntry_struct*** nonnull %10, i32* nonnull %11) #9
...
175:                                              ; preds = %148, %459
  ...
  %180 = call i32 @hypre_SStructBoxManEntryGetStrides(%struct.hypre_BoxManEntry_struct* %179, i32* nonnull %106, i32 %72) #9
  %181 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %74, %struct.hypre_Box_struct* %73) #9
  ...
  %185 = call i32 @hypre_BoxManEntryGetExtents(%struct.hypre_BoxManEntry_struct* %184, i32* %107, i32* nonnull %108) #9
  %186 = call i32 @hypre_IntersectBoxes(%struct.hypre_Box_struct* %73, %struct.hypre_Box_struct* %80, %struct.hypre_Box_struct* %81) #9
  %187 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %81, %struct.hypre_Box_struct* %73) #9
...
188:                                              ; preds = %175, %445
  ...
  %193 = call i32 @hypre_CopyBox(%struct.hypre_Box_struct* %73, %struct.hypre_Box_struct* %79) #9
  %194 = sext i32 %192 to i64
  %195 = getelementptr inbounds [3 x i32], [3 x i32]* %57, i64 %194, i64 0
  %196 = call i32 @hypre_BoxShiftPos(%struct.hypre_Box_struct* %79, i32* %195) #9
  %197 = getelementptr inbounds i32, i32* %53, i64 %194
  %198 = load i32, i32* %197, align 4, !tbaa !10
  %199 = call i32 @hypre_SStructGridIntersect(%struct.hypre_SStructGrid_struct* %43, i32 %1, i32 %198, %struct.hypre_Box_struct* %79, i32 -1, %struct.hypre_BoxManEntry_struct*** nonnull %12, i32* nonnull %13) #9
...
202:                                              ; preds = %188, %438
  ...
  %208 = call i32 @hypre_SStructBoxManEntryGetStrides(%struct.hypre_BoxManEntry_struct* %207, i32* nonnull %109, i32 %72) #9
  ...
  %212 = call i32 @hypre_BoxManEntryGetExtents(%struct.hypre_BoxManEntry_struct* %211, i32* %107, i32* nonnull %108) #9
  %213 = call i32 @hypre_IntersectBoxes(%struct.hypre_Box_struct* %79, %struct.hypre_Box_struct* %80, %struct.hypre_Box_struct* %81) #9
  %214 = call i32 @hypre_CopyIndex(i32* %110, i32* nonnull %111) #9
  ...
  %218 = call i32 @hypre_SStructBoxManEntryGetGlobalRank(%struct.hypre_BoxManEntry_struct* %217, i32* nonnull %111, i32* nonnull %20, i32 %72) #9
  %219 = call i32 @hypre_BoxShiftNeg(%struct.hypre_Box_struct* %81, i32* %195) #9
  %220 = call i32 @hypre_CopyIndex(i32* %110, i32* nonnull %111) #9
  ...
  %224 = call i32 @hypre_SStructBoxManEntryGetGlobalRank(%struct.hypre_BoxManEntry_struct* %223, i32* nonnull %111, i32* nonnull %19, i32 %72) #9
  %225 = call i32 @hypre_BoxGetSize(%struct.hypre_Box_struct* %81, i32* nonnull %112) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %117) #9
...
275:                                              ; preds = %248, %236
  ...
  %276 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %81, i32* nonnull %110) #9
...
314:                                              ; preds = %287, %275
  ...
  %315 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %74, i32* nonnull %110) #9
...
366:                                              ; preds = %357, %393
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %138) #9
...
393:                                              ; preds = %377, %371
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %138) #9
  %399 = add i64 %367, %340
  %400 = add i64 %368, %339
...
438:                                              ; preds = %435, %336, %314
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %117) #9
  ...
  %439 = call i32 @hypre_BoxVolume(%struct.hypre_Box_struct* %81) #9
...
452:                                              ; preds = %450
  %453 = call i32 @HYPRE_IJMatrixAddToValues(%struct.hypre_IJMatrix_struct* %37, i32 %451, i32* %86, i32* %98, i32* %100, double* %102) #9
  br label %459
...
455:                                              ; preds = %454
  %456 = call i32 @HYPRE_IJMatrixSetValues(%struct.hypre_IJMatrix_struct* %37, i32 %451, i32* %86, i32* %98, i32* %100, double* %102) #9
  br label %459

457:                                              ; preds = %454
  %458 = call i32 @HYPRE_IJMatrixGetValues(%struct.hypre_IJMatrix_struct* %37, i32 %451, i32* %86, i32* %98, i32* %100, double* %7) #9
  br label %459
...
464:                                              ; preds = %459, %96
  ...
  call void @hypre_Free(i8* %466) #9
  store %struct.hypre_BoxManEntry_struct** null, %struct.hypre_BoxManEntry_struct*** %10, align 8, !tbaa !9
  call void @hypre_Free(i8* %85) #9
  call void @hypre_Free(i8* %97) #9
  call void @hypre_Free(i8* %99) #9
  call void @hypre_Free(i8* %101) #9
  %467 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %79) #9
  %468 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %80) #9
  %469 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %81) #9
  br label %568

470:                                              ; preds = %9
  %471 = getelementptr inbounds [3 x i32], [3 x i32]* %16, i64 0, i64 0
  %472 = call i32 @hypre_BoxGetSize(%struct.hypre_Box_struct* %74, i32* nonnull %471) #9
  %473 = bitcast [4 x i32]* %32 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %473) #9
...
532:                                              ; preds = %531, %528
  %533 = call i32 @hypre_AddIndexes(i32* nonnull %502, i32* %504, i32 %35, i32* nonnull %502) #9
...
567:                                              ; preds = %564, %514
  ...
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %473) #9
  br label %568

568:                                              ; preds = %567, %464
  %569 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %73) #9
  %570 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %74) #9

...
define dso_local i8* @hypre_SMGCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 232) #10
  %3 = bitcast i8* %2 to i32*
  store i32 %0, i32* %3, align 8, !tbaa !3
  %4 = getelementptr inbounds i8, i8* %2, i64 204
  ...
  %36 = getelementptr inbounds i8, i8* %2, i64 212
...
8:                                                ; preds = %3
  ...
  %13 = getelementptr inbounds i8, i8* %0, i64 224
  %14 = bitcast i8* %13 to double**
  %15 = bitcast i8* %13 to i8**
  %16 = load i8*, i8** %15, align 8, !tbaa !25
  call void @hypre_Free(i8* %16) #10
...
22:                                               ; preds = %17
  %23 = getelementptr inbounds i8, i8* %0, i64 168
  %24 = bitcast i8* %23 to i8***
  %25 = getelementptr inbounds i8, i8* %0, i64 176
  %26 = bitcast i8* %25 to i8***
  %27 = getelementptr inbounds i8, i8* %0, i64 184
...
58:                                               ; preds = %56, %22
  ...
  %66 = call i32 @hypre_SMGRelaxDestroy(i8* %65) #10
  %67 = icmp eq i32 %59, 0
  br i1 %67, label %68, label %75

68:                                               ; preds = %58
  %69 = getelementptr inbounds i8, i8* %0, i64 176
  %70 = bitcast i8* %69 to i8***
  %71 = load i8**, i8*** %70, align 8, !tbaa !28
  %72 = getelementptr inbounds i8*, i8** %71, i64 %63
  %73 = load i8*, i8** %72, align 8, !tbaa !27
  %74 = call i32 @hypre_SMGResidualDestroy(i8* %73) #10
  br label %75
...
75:                                               ; preds = %68, %58
  ...
  %78 = getelementptr inbounds i8, i8* %0, i64 176
  ...
  %82 = getelementptr inbounds i8, i8* %0, i64 184
  ...
  call void @hypre_Free(i8* %89) #10
  store i8** null, i8*** %87, align 8, !tbaa !30
  %90 = getelementptr inbounds i8, i8* %0, i64 136
  ...
  %94 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %93) #10
  %95 = getelementptr inbounds i8, i8* %0, i64 144
  ...
  %99 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %98) #10
  ...
  %104 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %103) #10
  ...
  %109 = call i32 @hypre_StructMatrixDestroy(%struct.hypre_StructMatrix_struct* %108) #10
  ...
  %114 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %113) #10
  %115 = getelementptr inbounds i8, i8* %0, i64 128
  ...
  %119 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %118) #10
  %120 = getelementptr inbounds i8, i8* %0, i64 80
  %121 = bitcast i8* %120 to %struct.hypre_StructGrid_struct***
  %122 = getelementptr inbounds i8, i8* %0, i64 104
  %123 = bitcast i8* %122 to %struct.hypre_StructMatrix_struct***
  %124 = getelementptr inbounds i8, i8* %0, i64 112
...
128:                                              ; preds = %75, %156
  ...
  %134 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %133) #10
  ...
  %138 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %137) #10
  ...
  %142 = call i32 @hypre_StructMatrixDestroy(%struct.hypre_StructMatrix_struct* %141) #10
  ...
  %150 = call i32 @hypre_StructMatrixDestroy(%struct.hypre_StructMatrix_struct* %145) #10
...
151:                                              ; preds = %128
  ...
  %155 = call i32 @hypre_StructMatrixDestroy(%struct.hypre_StructMatrix_struct* %154) #10
  br label %156
...
156:                                              ; preds = %128, %151
  ...
  %160 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %159) #10
  ...
  %164 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %163) #10
  ...
  %168 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %167) #10
  ...
  %172 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %171) #10
...
177:                                              ; preds = %156, %75
  ...
  call void @hypre_Free(i8* %183) #10
  ...
  call void @hypre_Free(i8* %201) #10
  ...
  call void @hypre_Free(i8* %203) #10
...
define dso_local i32 @hypre_SMGSetLogging(i8* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = getelementptr inbounds i8, i8* %0, i64 212
  %4 = bitcast i8* %3 to i32*
...
define dso_local i32 @hypre_SMGPrintLogging(i8* nocapture readonly %0, i32 %1) local_unnamed_addr #5 {
  %3 = getelementptr inbounds i8, i8* %0, i64 200
  %4 = bitcast i8* %3 to i32*
  %5 = load i32, i32* %4, align 8, !tbaa !47
  ...
  %12 = getelementptr inbounds i8, i8* %0, i64 216
...
36:                                               ; preds = %29, %196
  ...
  %50 = call i32 @hypre_BoxGetStrideSize(%struct.hypre_Box_struct* %39, i32* %3, i32* nonnull %18) #10
...
114:                                              ; preds = %87, %69
  ...
  %116 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %44, i32* %40) #10

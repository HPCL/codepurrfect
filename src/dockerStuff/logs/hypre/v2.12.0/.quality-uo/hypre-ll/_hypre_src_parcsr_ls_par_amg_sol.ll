...
84:                                               ; preds = %82
  %85 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %83, %struct.hypre_ParVector_struct* %25) #6
...
86:                                               ; preds = %84
  ...
  %89 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %87, %struct.hypre_ParVector_struct* %88, double -1.000000e+00, %struct.hypre_ParVector_struct* %25) #6
  br label %90

90:                                               ; preds = %86, %84
  %91 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %25, %struct.hypre_ParVector_struct* %25) #6
  br label %100

92:                                               ; preds = %82
  %93 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %83, %struct.hypre_ParVector_struct* %64) #6
...
94:                                               ; preds = %92
  ...
  %97 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %95, %struct.hypre_ParVector_struct* %96, double -1.000000e+00, %struct.hypre_ParVector_struct* %64) #6
  br label %98

98:                                               ; preds = %94, %92
  %99 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %64, %struct.hypre_ParVector_struct* %64) #6
  br label %100
...
109:                                              ; preds = %107
  %110 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([37 x i8], [37 x i8]* @str.22, i64 0, i64 0))
  %111 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([67 x i8], [67 x i8]* @str.23, i64 0, i64 0))
  %112 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([60 x i8], [60 x i8]* @str.24, i64 0, i64 0))
  %113 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([35 x i8], [35 x i8]* @str.25, i64 0, i64 0))
  br label %114

114:                                              ; preds = %109, %107
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 196, i32 1, i8* null) #6
  br label %327

115:                                              ; preds = %100
  %116 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %2) #6
...
129:                                              ; preds = %121
  %130 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([53 x i8], [53 x i8]* @str.19, i64 0, i64 0))
  %131 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([53 x i8], [53 x i8]* @str.20, i64 0, i64 0))
  %132 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([53 x i8], [53 x i8]* @str.21, i64 0, i64 0))
  %133 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([38 x i8], [38 x i8]* @.str.9, i64 0, i64 0), double %123, double %124)
  br label %134

134:                                              ; preds = %129, %121
  %135 = getelementptr inbounds i8, i8* %0, i64 632
...
212:                                              ; preds = %207
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 291, i32 256, i8* null) #6
  br label %213

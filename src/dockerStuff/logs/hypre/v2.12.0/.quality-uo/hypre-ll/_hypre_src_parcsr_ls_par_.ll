...
18:                                               ; preds = %6
  ...
  %20 = call i8* @hypre_CAlloc(i64 %19, i64 4) #13
...
define dso_local i32 @hypre_cr(i32* nocapture readonly %0, i32* nocapture readonly %1, double* nocapture readonly %2, i32 %3, i32* nocapture %4, i32 %5, double %6, double %7, i32 %8) local_unnamed_addr #0 {
  ...
  %11 = call i8* @hypre_CAlloc(i64 %10, i64 8) #13
  %12 = bitcast i8* %11 to double*
  %13 = call i8* @hypre_CAlloc(i64 %10, i64 8) #13
...
217:                                              ; preds = %203, %202
  ...
  %220 = call double @sqrt(double %219) #13
  %221 = call double @sqrt(double %218) #13
...
228:                                              ; preds = %224, %228
  ...
  %233 = call double @llvm.fabs.f64(double %232) #13
...
243:                                              ; preds = %238
  ...
  %246 = call double @llvm.fabs.f64(double %245) #13
...
define dso_local i32 @hypre_fptjaccr(i32* nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture readonly %2, double* nocapture readonly %3, i32 %4, double* nocapture %5, double %6, double* nocapture %7) local_unnamed_addr #4 {
  %9 = icmp sgt i32 %4, 0
...
; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local i32 @hypre_fptgscr(i32* nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture readonly %2, double* nocapture readonly %3, i32 %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #4 {
  %8 = icmp sgt i32 %4, 0
...
define dso_local i32 @hypre_formu(i32* nocapture %0, i32 %1, double* nocapture readonly %2, i32* nocapture readonly %3, double %4) local_unnamed_addr #6 {
...
define dso_local i32 @hypre_IndepSetGreedy(i32* nocapture readonly %0, i32* nocapture readonly %1, i32 %2, i32* nocapture %3) local_unnamed_addr #0 {
  %5 = sext i32 %2 to i64
  %6 = call i8* @hypre_CAlloc(i64 %5, i64 4) #13
...
56:                                               ; preds = %52, %4
  ...
  %60 = call i8* @hypre_CAlloc(i64 %59, i64 4) #13
  %61 = bitcast i8* %60 to i32*
  %62 = getelementptr inbounds i32, i32* %61, i64 %59
  %63 = call i8* @hypre_CAlloc(i64 %59, i64 4) #13
  %64 = bitcast i8* %63 to i32*
  %65 = getelementptr inbounds i32, i32* %64, i64 %59
  %66 = call i8* @hypre_CAlloc(i64 %5, i64 8) #13
...
define dso_local i32 @hypre_GraphAdd(%struct.Link* nocapture %0, i32* nocapture %1, i32* nocapture %2, i32 %3, i32 %4) local_unnamed_addr #8 {
  %6 = sub nsw i32 0, %4
  %7 = sext i32 %6 to i64
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @hypre_GraphRemove(%struct.Link* nocapture %0, i32* nocapture %1, i32* nocapture %2, i32 %3) local_unnamed_addr #8 {
  %5 = sext i32 %3 to i64
...
54:                                               ; preds = %50, %4
  ...
  %58 = call i8* @hypre_CAlloc(i64 %57, i64 4) #13
  %59 = bitcast i8* %58 to i32*
  %60 = getelementptr inbounds i32, i32* %59, i64 %57
  %61 = call i8* @hypre_CAlloc(i64 %57, i64 4) #13
  %62 = bitcast i8* %61 to i32*
  %63 = getelementptr inbounds i32, i32* %62, i64 %57
  %64 = call i8* @hypre_CAlloc(i64 %5, i64 8) #13
...
define dso_local i32 @hypre_BoomerAMGIndepRS(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32 %2, i32* nocapture %3) local_unnamed_addr #0 {
  ...
  %32 = call i8* @hypre_CAlloc(i64 %31, i64 4) #13
  %33 = bitcast i8* %32 to i32*
  %34 = call i8* @hypre_CAlloc(i64 %31, i64 4) #13
  %35 = bitcast i8* %34 to i32*
  %36 = icmp eq i32 %2, 3
  br i1 %36, label %37, label %39

37:                                               ; preds = %4
  %38 = call double @time_getWallclockSeconds() #13
  br label %39

39:                                               ; preds = %37, %4
  %40 = phi double [ %38, %37 ], [ undef, %4 ]
  %41 = call i32 @hypre_MPI_Comm_size(i32 %10, i32* nonnull %5) #13
  %42 = call i32 @hypre_MPI_Comm_rank(i32 %10, i32* nonnull %6) #13
...
49:                                               ; preds = %46
  %50 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) #13
...
60:                                               ; preds = %57, %52
  ...
  %64 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %24, i32 %24, i32 %63) #13
  %65 = add nsw i32 %24, 1
  %66 = sext i32 %65 to i64
  %67 = call i8* @hypre_CAlloc(i64 %66, i64 4) #13
  %68 = bitcast i8* %67 to i32*
  %69 = sext i32 %63 to i64
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 4) #13
...
156:                                              ; preds = %154
  %157 = call i8* @hypre_CAlloc(i64 %31, i64 4) #13
...
202:                                              ; preds = %201
  ...
  %204 = call i8* @hypre_CAlloc(i64 %203, i64 4) #13
...
213:                                              ; preds = %209, %206
  ...
  %220 = call i8* @hypre_CAlloc(i64 %219, i64 4) #13
...
262:                                              ; preds = %259
  ...
  %264 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %53, i8* %220, i8* %263) #13
  %265 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %264) #13
  br label %266
...
266:                                              ; preds = %262, %259
  ...
  %270 = call i8* @hypre_CAlloc(i64 %269, i64 4) #13
...
344:                                              ; preds = %341, %279
  ...
  call void @hypre_Free(i8* %345) #13
...
348:                                              ; preds = %344
  ...
  %351 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct.hypre_ParCSRCommPkg* %53, i8* %350, i8* %220) #13
  br label %352
...
356:                                              ; preds = %352
  %357 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %353) #13
  br label %358
...
398:                                              ; preds = %366, %358
  call void @hypre_Free(i8* %220) #13
  br label %399
...
457:                                              ; preds = %455
  %458 = call double @time_getWallclockSeconds() #13
  br label %459
...
477:                                              ; preds = %475
  ...
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %471, i32 %478, i32* %33, i32* %35) #13
  br label %522
...
509:                                              ; preds = %507
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %506, i32 %495, i32* %33, i32* %35) #13
  br label %510
...
510:                                              ; preds = %509, %507
  ...
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %512, i32 %495, i32* %33, i32* %35) #13
  br label %515
...
529:                                              ; preds = %464, %526
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %537, i32 %533, i32* %33, i32* %35) #13
...
557:                                              ; preds = %548
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %559, i32 %552, i32* %33, i32* %35) #13
...
580:                                              ; preds = %572
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %582, i32 %575, i32* %33, i32* %35) #13
  %583 = load i32, i32* %581, align 4, !tbaa !16
  %584 = add nsw i32 %583, 1
  store i32 %584, i32* %581, align 4, !tbaa !16
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %584, i32 %575, i32* %33, i32* %35) #13
  br label %585
...
614:                                              ; preds = %605
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %616, i32 %609, i32* %33, i32* %35) #13
...
619:                                              ; preds = %614
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %617, i32 %609, i32* %33, i32* %35) #13
  br label %651
...
641:                                              ; preds = %633
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %643, i32 %636, i32* %33, i32* %35) #13
  %644 = load i32, i32* %642, align 4, !tbaa !16
  %645 = add nsw i32 %644, 1
  store i32 %645, i32* %642, align 4, !tbaa !16
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %645, i32 %636, i32* %33, i32* %35) #13
  br label %646
...
657:                                              ; preds = %526, %464
  ...
  call void @hypre_Free(i8* %658) #13
  %659 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %64) #13
  br i1 %36, label %660, label %665

660:                                              ; preds = %657
  %661 = call double @time_getWallclockSeconds() #13
...
204:                                              ; preds = %203
  ...
  %206 = call i8* @hypre_CAlloc(i64 %205, i64 4) #13
...
215:                                              ; preds = %211, %208
  ...
  %222 = call i8* @hypre_CAlloc(i64 %221, i64 4) #13
...
264:                                              ; preds = %261
  ...
  %266 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %53, i8* %222, i8* %265) #13
  %267 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %266) #13
  br label %268
...
268:                                              ; preds = %264, %261
  ...
  %272 = call i8* @hypre_CAlloc(i64 %271, i64 4) #13
...
348:                                              ; preds = %345, %281
  ...
  call void @hypre_Free(i8* %349) #13
...
352:                                              ; preds = %348
  ...
  %355 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct.hypre_ParCSRCommPkg* %53, i8* %354, i8* %222) #13
  br label %356
...
360:                                              ; preds = %356
  %361 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %357) #13
  br label %362
...
402:                                              ; preds = %370, %362
  call void @hypre_Free(i8* %222) #13
  br label %403
...
461:                                              ; preds = %459
  %462 = call double @time_getWallclockSeconds() #13
  br label %463
...
481:                                              ; preds = %479
  ...
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %475, i32 %482, i32* %33, i32* %35) #13
  br label %528
...
515:                                              ; preds = %513
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %512, i32 %501, i32* %33, i32* %35) #13
  br label %516
...
516:                                              ; preds = %515, %513
  ...
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %518, i32 %501, i32* %33, i32* %35) #13
  br label %521
...
535:                                              ; preds = %468, %532
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %543, i32 %539, i32* %33, i32* %35) #13
...
565:                                              ; preds = %556
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %567, i32 %560, i32* %33, i32* %35) #13
...
588:                                              ; preds = %580
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %590, i32 %583, i32* %33, i32* %35) #13
  %591 = load i32, i32* %589, align 4, !tbaa !16
  %592 = add nsw i32 %591, 1
  store i32 %592, i32* %589, align 4, !tbaa !16
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %592, i32 %583, i32* %33, i32* %35) #13
  br label %593
...
624:                                              ; preds = %615
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %626, i32 %619, i32* %33, i32* %35) #13
...
629:                                              ; preds = %624
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %627, i32 %619, i32* %33, i32* %35) #13
  br label %661
...
651:                                              ; preds = %643
  ...
  call void @hypre_remove_point(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %653, i32 %646, i32* %33, i32* %35) #13
  %654 = load i32, i32* %652, align 4, !tbaa !16
  %655 = add nsw i32 %654, 1
  store i32 %655, i32* %652, align 4, !tbaa !16
  call void @hypre_enter_on_lists(%struct.double_linked_list** nonnull %7, %struct.double_linked_list** nonnull %8, i32 %655, i32 %646, i32* %33, i32* %35) #13
  br label %656
...
667:                                              ; preds = %532, %468
  ...
  call void @hypre_Free(i8* %668) #13
  %669 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %64) #13
  br i1 %36, label %670, label %675

670:                                              ; preds = %667
  %671 = call double @time_getWallclockSeconds() #13
...
define dso_local i32 @hypre_BoomerAMGIndepHMIS(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32 %2, i32* nocapture %3) local_unnamed_addr #0 {
  ...
  %9 = call i32 @hypre_MPI_Comm_size(i32 %8, i32* nonnull %5) #13
...
29:                                               ; preds = %4
  %30 = call double @time_getWallclockSeconds() #13
  br label %31

31:                                               ; preds = %29, %4
  %32 = phi double [ %30, %29 ], [ undef, %4 ]
  %33 = call i32 @hypre_MPI_Comm_size(i32 %10, i32* nonnull %8) #13
  %34 = call i32 @hypre_MPI_Comm_rank(i32 %10, i32* nonnull %7) #13
...
41:                                               ; preds = %38
  %42 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) #13
...
71:                                               ; preds = %69
  ...
  %73 = call i8* @hypre_CAlloc(i64 %72, i64 4) #13
...
123:                                              ; preds = %120
  ...
  %125 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %45, i8* %54, i8* %124) #13
  %126 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %125) #13
  br label %127
...
127:                                              ; preds = %123, %120
  ...
  %131 = call i8* @hypre_CAlloc(i64 %130, i64 8) #13
...
206:                                              ; preds = %203
  ...
  %210 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct.hypre_ParCSRCommPkg* %45, i8* %209, i8* %60) #13
  br label %211
...
215:                                              ; preds = %211
  %216 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %212) #13
  br label %217
...
270:                                              ; preds = %230, %228
  ...
  call void @hypre_SeedRand(i32 %272) #13
...
285:                                              ; preds = %284
  ...
  %287 = call i8* @hypre_CAlloc(i64 %286, i64 4) #13
...
300:                                              ; preds = %294, %289
  ...
  %302 = call i8* @hypre_CAlloc(i64 %301, i64 4) #13
...
411:                                              ; preds = %408
  ...
  %414 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %45, i8* %60, i8* %413) #13
  %415 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %414) #13
  br label %416
...
417:                                              ; preds = %416
  %418 = call double @time_getWallclockSeconds() #13
...
422:                                              ; preds = %417, %416
  ...
  %430 = call i32 @hypre_MPI_Allreduce(i8* nonnull %24, i8* nonnull %25, i32 1, i32 1275069445, i32 1476395011, i32 %10) #13
...
436:                                              ; preds = %773, %727
  ...
  %438 = call i32 @hypre_MPI_Allreduce(i8* nonnull %24, i8* nonnull %25, i32 1, i32 1275069445, i32 1476395011, i32 %10) #13
...
560:                                              ; preds = %557
  %561 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct.hypre_ParCSRCommPkg* %45, i8* %423, i8* %54) #13
  %562 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %561) #13
  br label %563
...
611:                                              ; preds = %608
  %612 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %45, i8* %54, i8* %426) #13
  %613 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %612) #13
  br label %614
...
721:                                              ; preds = %718
  %722 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %45, i8* %54, i8* %429) #13
  %723 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %722) #13
  br label %724
...
778:                                              ; preds = %436, %422
  call void @hypre_Free(i8* %131) #13
  call void @hypre_Free(i8* %302) #13
  br i1 %65, label %781, label %779

779:                                              ; preds = %778
  %780 = bitcast i32* %290 to i8*
  call void @hypre_Free(i8* %780) #13
  br label %781

781:                                              ; preds = %779, %778
  call void @hypre_Free(i8* %60) #13
  call void @hypre_Free(i8* %54) #13
  %782 = bitcast i32* %76 to i8*
  call void @hypre_Free(i8* %782) #13
...
208:                                              ; preds = %205
  ...
  %212 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct.hypre_ParCSRCommPkg* %45, i8* %211, i8* %60) #13
  br label %213
...
217:                                              ; preds = %213
  %218 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %214) #13
  br label %219
...
272:                                              ; preds = %232, %230
  ...
  call void @hypre_SeedRand(i32 %274) #13
...
287:                                              ; preds = %286
  ...
  %289 = call i8* @hypre_CAlloc(i64 %288, i64 4) #13
...
302:                                              ; preds = %296, %291
  ...
  %304 = call i8* @hypre_CAlloc(i64 %303, i64 4) #13
...
413:                                              ; preds = %410
  ...
  %416 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %45, i8* %60, i8* %415) #13
  %417 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %416) #13
  br label %418
...
419:                                              ; preds = %418
  %420 = call double @time_getWallclockSeconds() #13
...
424:                                              ; preds = %419, %418
  ...
  %432 = call i32 @hypre_MPI_Allreduce(i8* nonnull %24, i8* nonnull %25, i32 1, i32 1275069445, i32 1476395011, i32 %10) #13
...
438:                                              ; preds = %773, %727
  ...
  %440 = call i32 @hypre_MPI_Allreduce(i8* nonnull %24, i8* nonnull %25, i32 1, i32 1275069445, i32 1476395011, i32 %10) #13
...
564:                                              ; preds = %561
  %565 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct.hypre_ParCSRCommPkg* %45, i8* %425, i8* %54) #13
  %566 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %565) #13
  br label %567
...
615:                                              ; preds = %612
  %616 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %45, i8* %54, i8* %428) #13
  %617 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %616) #13
  br label %618
...
721:                                              ; preds = %718
  %722 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %45, i8* %54, i8* %431) #13
  %723 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %722) #13
  br label %724
...
778:                                              ; preds = %438, %424
  call void @hypre_Free(i8* %131) #13
  call void @hypre_Free(i8* %304) #13
  br i1 %65, label %781, label %779
...
define dso_local i32 @hypre_BoomerAMGCoarsenCR(%struct.hypre_ParCSRMatrix_struct* %0, i32** nocapture %1, i32* nocapture %2, i32 %3, i32 %4, i32 %5, i32 %6, double %7, double %8, double %9, %struct.hypre_Solver_struct* %10, %struct.hypre_ParCSRMatrix_struct* %11, i32 %12, %struct.hypre_ParCSRMatrix_struct* %13) local_unnamed_addr #0 {
  ...
  %55 = call i32 @hypre_MPI_Comm_size(i32 %25, i32* nonnull %18) #13
  %56 = call i32 @hypre_MPI_Comm_rank(i32 %25, i32* nonnull %19) #13
...
59:                                               ; preds = %14
  ...
  %61 = call i8* @hypre_CAlloc(i64 %60, i64 4) #13
  %62 = icmp sgt i32 %45, 0
  br i1 %62, label %69, label %75

63:                                               ; preds = %14
  %64 = sext i32 %50 to i64
  %65 = call i8* @hypre_CAlloc(i64 %64, i64 4) #13
  %66 = call i8* @hypre_CAlloc(i64 %64, i64 8) #13
...
84:                                               ; preds = %81, %75
  %85 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %86 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %85) #13
  %87 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %85, i32 0) #13
  %88 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %89 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %88) #13
  %90 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %88, i32 0) #13
  %91 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %92 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %91) #13
  %93 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %91, i32 0) #13
  %94 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %95 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %94) #13
  %96 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %94, i32 0) #13
  ...
  %101 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %102 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %101) #13
  %103 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %101, i32 0) #13
  ...
  %108 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %109 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %108) #13
  %110 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %108, i32 0) #13
  %111 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %112 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %111) #13
  %113 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %111, i32 0) #13
  ...
  %118 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %25, i32 %33, i32* %35) #13
  %119 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %118) #13
  %120 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %118, i32 0) #13
...
275:                                              ; preds = %271, %248
  %276 = call i32 @hypre_SchwarzCFSolve(i8* nonnull %151, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %94, %struct.hypre_ParVector_struct* %88, i32* %78, i32 -1) #13
...
299:                                              ; preds = %296, %286
  %300 = call i32 @hypre_BoomerAMGRelax(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %94, i32* %78, i32 %6, i32 -1, double %7, double %8, double* null, %struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %85, %struct.hypre_ParVector_struct* null) #13
...
315:                                              ; preds = %312, %299
  %316 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %85, %struct.hypre_ParVector_struct* %85) #13
  %317 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %88) #13
  %318 = call double @sqrt(double %317) #13
  %319 = call double @sqrt(double %316) #13
...
355:                                              ; preds = %352, %343
  %356 = call i32 @hypre_ParVectorSetConstantValues(%struct.hypre_ParVector_struct* %118, double 0.000000e+00) #13
  %357 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %88) #13
...
365:                                              ; preds = %361
  %366 = call i32 @hypre_ParCSRMatrixMatvec_FF(double -1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %85, double 0.000000e+00, %struct.hypre_ParVector_struct* %118, i32* %78, i32 -1) #13
  br label %367

367:                                              ; preds = %365, %361
  %368 = call i32 @HYPRE_ParCSRDiagScale(%struct.hypre_Solver_struct* null, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %118, %struct.hypre_ParVector_struct* %111) #13
  %369 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %118, %struct.hypre_ParVector_struct* %111) #13
  br i1 %364, label %370, label %372

370:                                              ; preds = %367
  %371 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %111, %struct.hypre_ParVector_struct* %101) #13
  br label %389
...
389:                                              ; preds = %386, %372, %370
  %390 = call i32 @hypre_ParCSRMatrixMatvec_FF(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %101, double 0.000000e+00, %struct.hypre_ParVector_struct* %108, i32* %78, i32 -1) #13
  %391 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %101, %struct.hypre_ParVector_struct* %108) #13
  %392 = fneg double %369
  %393 = fdiv double %392, %391
  %394 = call i32 @hypre_ParVectorAxpy(double %393, %struct.hypre_ParVector_struct* %108, %struct.hypre_ParVector_struct* %118) #13
...
407:                                              ; preds = %404, %389
  %408 = call i32 @hypre_ParVectorAxpy(double %393, %struct.hypre_ParVector_struct* %101, %struct.hypre_ParVector_struct* %88) #13
  %409 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %88, %struct.hypre_ParVector_struct* %88) #13
...
473:                                              ; preds = %470, %435, %438, %426
  %474 = call i32 @hypre_MPI_Allreduce(i8* nonnull %53, i8* nonnull %54, i32 1, i32 1275070475, i32 1476395009, i32 %25) #13
...
507:                                              ; preds = %506
  ...
  %509 = call i32 @hypre_MPI_Comm_size(i32 %508, i32* nonnull %17) #13
  %510 = call i32 @hypre_BoomerAMGIndepRS(%struct.hypre_ParCSRMatrix_struct* %13, i32 2, i32 0, i32* %78) #13
  %511 = load i32, i32* %17, align 4, !tbaa !16
  %512 = icmp sgt i32 %511, 1
  br i1 %512, label %513, label %515

513:                                              ; preds = %507
  %514 = call i32 @hypre_BoomerAMGIndepPMIS(%struct.hypre_ParCSRMatrix_struct* %13, i32 0, i32 0, i32* %78) #13
  br label %515
...
516:                                              ; preds = %506
  ...
  %518 = call i32 @hypre_MPI_Comm_size(i32 %517, i32* nonnull %16) #13
  %519 = call i32 @hypre_BoomerAMGIndepRSa(%struct.hypre_ParCSRMatrix_struct* %0, i32 2, i32 0, i32* %78) #13
  %520 = load i32, i32* %16, align 4, !tbaa !16
  %521 = icmp sgt i32 %520, 1
  br i1 %521, label %522, label %524

522:                                              ; preds = %516
  %523 = call i32 @hypre_BoomerAMGIndepPMISa(%struct.hypre_ParCSRMatrix_struct* %0, i32 0, i32 0, i32* %78) #13
  br label %524
...
574:                                              ; preds = %573
  ...
  %576 = call i32 @hypre_MPI_Comm_size(i32 %575, i32* nonnull %15) #13
  %577 = call i32 @hypre_BoomerAMGIndepRS(%struct.hypre_ParCSRMatrix_struct* %11, i32 2, i32 0, i32* %78) #13
  %578 = load i32, i32* %15, align 4, !tbaa !16
  %579 = icmp sgt i32 %578, 1
  br i1 %579, label %580, label %582

580:                                              ; preds = %574
  %581 = call i32 @hypre_BoomerAMGIndepPMIS(%struct.hypre_ParCSRMatrix_struct* %11, i32 0, i32 0, i32* %78) #13
  br label %582
...
650:                                              ; preds = %646, %621, %601, %602
  ...
  %652 = call i32 @hypre_MPI_Allreduce(i8* nonnull %51, i8* nonnull %52, i32 1, i32 1275069445, i32 1476395009, i32 %25) #13
...
663:                                              ; preds = %653, %656
  %664 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %85) #13
  %665 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %88) #13
  %666 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %91) #13
  %667 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %94) #13
  %668 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %101) #13
  %669 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %108) #13
  %670 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %118) #13
  %671 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %111) #13
...
691:                                              ; preds = %681, %677
  ...
  call void @hypre_Free(i8* %694) #13

...
define dso_local noalias %struct.mv_MultiVector* @mv_MultiVectorWrap(%struct.mv_InterfaceInterpreter* %0, i8* %1, i32 %2) local_unnamed_addr #1 {
  %4 = call noalias align 16 dereferenceable_or_null(24) i8* @malloc(i64 24) #5
  %5 = bitcast i8* %4 to %struct.mv_MultiVector*
  %6 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %5, i64 0, i32 2
  store %struct.mv_InterfaceInterpreter* %0, %struct.mv_InterfaceInterpreter** %6, align 16, !tbaa !9
  %7 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %5, i64 0, i32 0
  store i8* %1, i8** %7, align 16, !tbaa !3
  %8 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %5, i64 0, i32 1
  store i32 %2, i32* %8, align 8, !tbaa !10
...
define dso_local %struct.mv_MultiVector* @mv_MultiVectorCreateFromSampleVector(i8* %0, i32 %1, i8* %2) local_unnamed_addr #3 {
  %4 = call noalias align 16 dereferenceable_or_null(24) i8* @malloc(i64 24) #5
  %5 = bitcast i8* %4 to %struct.mv_MultiVector*
  %6 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %5, i64 0, i32 2
  %7 = bitcast %struct.mv_InterfaceInterpreter** %6 to i8**
  store i8* %0, i8** %7, align 16, !tbaa !9
  %8 = getelementptr inbounds i8, i8* %0, i64 72
  %9 = bitcast i8* %8 to i8* (i8*, i32, i8*)**
  %10 = load i8* (i8*, i32, i8*)*, i8* (i8*, i32, i8*)** %9, align 8, !tbaa !11
  %11 = call i8* %10(i8* %0, i32 %1, i8* %2) #5
  %12 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %5, i64 0, i32 0
  store i8* %11, i8** %12, align 16, !tbaa !3
  %13 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %5, i64 0, i32 1
  store i32 1, i32* %13, align 8, !tbaa !10
  ret %struct.mv_MultiVector* %5
}

; Function Attrs: nounwind uwtable
define dso_local %struct.mv_MultiVector* @mv_MultiVectorCreateCopy(%struct.mv_MultiVector* nocapture readonly %0, i32 %1) local_unnamed_addr #3 {
  ...
  %11 = call i8* %8(i8* %10, i32 %1) #5
  %12 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %6, i64 0, i32 2
  store %struct.mv_InterfaceInterpreter* %4, %struct.mv_InterfaceInterpreter** %12, align 16, !tbaa !9
  %13 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %6, i64 0, i32 0
  store i8* %11, i8** %13, align 16, !tbaa !3
  %14 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %6, i64 0, i32 1
  store i32 1, i32* %14, align 8, !tbaa !10
  ret %struct.mv_MultiVector* %6
}

; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorDestroy(%struct.mv_MultiVector* %0) local_unnamed_addr #3 {
...
; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorSetMask(%struct.mv_MultiVector* nocapture readonly %0, i32* %1) local_unnamed_addr #3 {
  %3 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %0, i64 0, i32 2
  %4 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %3, align 8, !tbaa !9
  ...
  call void %6(i8* %8, i32* %1) #5
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local i32 @mv_MultiVectorWidth(%struct.mv_MultiVector* readonly %0) local_unnamed_addr #3 {
  %2 = icmp eq %struct.mv_MultiVector* %0, null
...
; Function Attrs: nounwind uwtable
define dso_local i32 @mv_MultiVectorHeight(%struct.mv_MultiVector* readonly %0) local_unnamed_addr #3 {
  %2 = icmp eq %struct.mv_MultiVector* %0, null
  br i1 %2, label %11, label %3
...
; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorClear(%struct.mv_MultiVector* nocapture readonly %0) local_unnamed_addr #3 {
...
; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorSetRandom(%struct.mv_MultiVector* nocapture readonly %0, i32 %1) local_unnamed_addr #3 {
  %3 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %0, i64 0, i32 2
  %4 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %3, align 8, !tbaa !9
...
; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorCopy(%struct.mv_MultiVector* nocapture readonly %0, %struct.mv_MultiVector* nocapture readonly %1) local_unnamed_addr #3 {
  %3 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %0, i64 0, i32 2
  %4 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %3, align 8, !tbaa !9
  ...
  %10 = load i8*, i8** %9, align 8, !tbaa !3
  call void %6(i8* %8, i8* %10) #5
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorAxpy(double %0, %struct.mv_MultiVector* nocapture readonly %1, %struct.mv_MultiVector* nocapture readonly %2) local_unnamed_addr #3 {
  ...
  call void %7(double %0, i8* %9, i8* %11) #5
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorByMultiVector(%struct.mv_MultiVector* nocapture readonly %0, %struct.mv_MultiVector* nocapture readonly %1, i32 %2, i32 %3, i32 %4, double* %5) local_unnamed_addr #3 {
  ...
  call void %10(i8* %12, i8* %14, i32 %2, i32 %3, i32 %4, double* %5) #5
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorByMultiVectorDiag(%struct.mv_MultiVector* nocapture readonly %0, %struct.mv_MultiVector* nocapture readonly %1, i32* %2, i32 %3, double* %4) local_unnamed_addr #3 {
  ...
  %13 = load i8*, i8** %12, align 8, !tbaa !3
  call void %9(i8* %11, i8* %13, i32* %2, i32 %3, double* %4) #5
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorByMatrix(%struct.mv_MultiVector* nocapture readonly %0, i32 %1, i32 %2, i32 %3, double* %4, %struct.mv_MultiVector* nocapture readonly %5) local_unnamed_addr #3 {
  %7 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %0, i64 0, i32 2
  %8 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %7, align 8, !tbaa !9
  ...
  %14 = load i8*, i8** %13, align 8, !tbaa !3
  call void %10(i8* %12, i32 %1, i32 %2, i32 %3, double* %4, i8* %14) #5
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorXapy(%struct.mv_MultiVector* nocapture readonly %0, i32 %1, i32 %2, i32 %3, double* %4, %struct.mv_MultiVector* nocapture readonly %5) local_unnamed_addr #3 {
  %7 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %0, i64 0, i32 2
  %8 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %7, align 8, !tbaa !9
...
; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorByDiagonal(%struct.mv_MultiVector* nocapture readonly %0, i32* %1, i32 %2, double* %3, %struct.mv_MultiVector* nocapture readonly %4) local_unnamed_addr #3 {
  %6 = getelementptr inbounds %struct.mv_MultiVector, %struct.mv_MultiVector* %0, i64 0, i32 2
  %7 = load %struct.mv_InterfaceInterpreter*, %struct.mv_InterfaceInterpreter** %6, align 8, !tbaa !9
  ...
  %13 = load i8*, i8** %12, align 8, !tbaa !3
  call void %9(i8* %11, i32* %1, i32 %2, double* %3, i8* %13) #5
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @mv_MultiVectorEval(void (i8*, i8*, i8*)* %0, i8* %1, %struct.mv_MultiVector* nocapture readonly %2, %struct.mv_MultiVector* nocapture readonly %3) local_unnamed_addr #3 {
  ...
  %12 = load i8*, i8** %11, align 8, !tbaa !3
  call void %8(void (i8*, i8*, i8*)* %0, i8* %1, i8* %10, i8* %12) #5
  ret void
}

...
define dso_local void @hypre_RowsWithColumn_original(i32* nocapture %0, i32* nocapture %1, i32 %2, %struct.hypre_ParCSRMatrix_struct* nocapture readonly %3) local_unnamed_addr #0 {
  %5 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3, i64 0, i32 7
  %6 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %5, align 8, !tbaa !3
  %7 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3, i64 0, i32 8
  ...
  %15 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3, i64 0, i32 4
...
53:                                               ; preds = %51, %4
  ...
  %58 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %8, i64 0, i32 2
  %59 = load i32, i32* %58, align 8, !tbaa !14
  %60 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3, i64 0, i32 11
...
define dso_local void @hypre_MatTCommPkgCreate_core(i32 %0, i32* nocapture readonly %1, i32 %2, i32* nocapture readonly %3, i32 %4, i32 %5, i32 %6, i32* nocapture readonly %7, i32 %8, i32* nocapture readonly %9, i32* nocapture readonly %10, i32* nocapture readonly %11, i32* nocapture readonly %12, i32* nocapture readonly %13, i32 %14, i32* nocapture %15, i32** nocapture %16, i32** nocapture %17, i32* nocapture %18, i32** nocapture %19, i32** nocapture %20, i32** nocapture %21) local_unnamed_addr #2 {
  ...
  %35 = call i8* @hypre_CAlloc(i64 %34, i64 4) #5
  ...
  %45 = call i8* @hypre_CAlloc(i64 %44, i64 4) #5
...
64:                                               ; preds = %49, %22
  ...
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 4) #5
  %71 = bitcast i8* %70 to i32*
  %72 = load i32, i32* %26, align 4, !tbaa !16
  %73 = sext i32 %72 to i64
  %74 = call i8* @hypre_CAlloc(i64 %73, i64 4) #5
...
146:                                              ; preds = %140, %64
  ...
  %160 = call i8* @hypre_CAlloc(i64 %159, i64 4) #5
...
492:                                              ; preds = %484, %146
  ...
  %495 = call i8* @hypre_CAlloc(i64 %494, i64 4) #5
  %496 = bitcast i8* %495 to i32*
  %497 = sext i32 %37 to i64
  %498 = call i8* @hypre_CAlloc(i64 %497, i64 4) #5
...
517:                                              ; preds = %511, %492
  ...
  %520 = call i8* @hypre_CAlloc(i64 %519, i64 4) #5
  %521 = bitcast i8* %520 to i32*
  %522 = load i32, i32* %24, align 4, !tbaa !16
  %523 = sext i32 %522 to i64
  %524 = call i8* @hypre_CAlloc(i64 %523, i64 4) #5
...
541:                                              ; preds = %529, %517
  ...
  %547 = call i8* @hypre_CAlloc(i64 %546, i64 4) #5
...
616:                                              ; preds = %607, %575
  ...
  call void @hypre_Free(i8* %520) #5
  call void @hypre_Free(i8* %524) #5
  call void @hypre_Free(i8* %74) #5
  call void @hypre_Free(i8* %70) #5
  call void @hypre_Free(i8* %45) #5
  call void @hypre_Free(i8* %35) #5
  call void @hypre_Free(i8* %547) #5
  call void @hypre_Free(i8* %163) #5
...
define dso_local i32 @hypre_MatTCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* nocapture %0) local_unnamed_addr #2 {
  ...
  %20 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 4
  ...
  %26 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %25, i64 0, i32 2
  ...
  %44 = call i8* @hypre_CAlloc(i64 1, i64 72) #5
  ...
  %67 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15
...
!47 = !{!4, !8, i64 72}
!48 = !{!49, !5, i64 0}
!49 = !{!"", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64}
!50 = !{!49, !5, i64 32}
!51 = !{!49, !8, i64 40}
!52 = !{!49, !8, i64 48}
!53 = !{!49, !5, i64 4}

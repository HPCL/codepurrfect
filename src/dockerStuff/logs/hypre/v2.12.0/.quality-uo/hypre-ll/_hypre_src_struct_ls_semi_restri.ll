...
412:                                              ; preds = %399, %478
  %413 = phi i32 [ %464, %478 ], [ %398, %399 ]
  %414 = phi i32 [ %461, %478 ], [ %383, %399 ]
...
419:                                              ; preds = %425
  %420 = trunc i64 %442 to i32
  %421 = trunc i64 %443 to i32
  br label %422
...
691:                                              ; preds = %678, %768
  %692 = phi i32 [ %754, %768 ], [ %677, %678 ]
  %693 = phi i32 [ %751, %768 ], [ %662, %678 ]
  %694 = phi i32 [ %748, %768 ], [ %647, %678 ]
...
700:                                              ; preds = %708
  %701 = trunc i64 %728 to i32
  %702 = trunc i64 %729 to i32
  %703 = trunc i64 %730 to i32
  br label %704
...
708:                                              ; preds = %696, %708
  ...
  %720 = getelementptr inbounds double, double* %220, i64 %709
  ...
  %727 = getelementptr inbounds double, double* %238, i64 %711
  store double %726, double* %727, align 8, !tbaa !45
  %728 = add nsw i64 %709, 1
  %729 = add i64 %710, %679
  %730 = add nsw i64 %711, 1

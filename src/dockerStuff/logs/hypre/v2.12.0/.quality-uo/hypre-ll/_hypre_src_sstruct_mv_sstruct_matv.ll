...
define dso_local i32 @hypre_SStructPMatvecCreate(i8** nocapture %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 16) #3
...
define dso_local i32 @hypre_SStructPMatvecSetup(i8* nocapture %0, %struct.hypre_SStructPMatrix* nocapture readonly %1, %struct.hypre_SStructPVector* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %6 = sext i32 %5 to i64
  %7 = shl nsw i64 %6, 3
  %8 = call i8* @hypre_MAlloc(i64 %7) #3
...
17:                                               ; preds = %14, %46
  ...
  %19 = call i8* @hypre_MAlloc(i64 %7) #3
...
34:                                               ; preds = %28, %3
  ...
  call void @hypre_Free(i8* nonnull %0) #3
  br label %36
...
define dso_local i32 @hypre_SStructPMatvec(double %0, %struct.hypre_SStructPMatrix* nocapture readonly %1, %struct.hypre_SStructPVector* nocapture readonly %2, double %3, %struct.hypre_SStructPVector* nocapture readonly %4) local_unnamed_addr #0 {
  %6 = call i8* @hypre_CAlloc(i64 1, i64 16) #3
...
22:                                               ; preds = %30, %19
  ...
  %24 = load i8**, i8*** %21, align 8, !tbaa !3
...
28:                                               ; preds = %22
  %29 = call i32 @hypre_StructMatvecDestroy(i8* nonnull %26) #3
  br label %30

30:                                               ; preds = %28, %22
  %31 = add nuw nsw i64 %23, 1
  %32 = icmp eq i64 %31, %18
  br i1 %32, label %33, label %22, !llvm.loop !23

33:                                               ; preds = %30
  %34 = bitcast i8*** %21 to i8**
  %35 = load i8*, i8** %34, align 8, !tbaa !3
  call void @hypre_Free(i8* %35) #3
  store i8** null, i8*** %21, align 8, !tbaa !3
  %36 = add nuw nsw i64 %20, 1
  %37 = icmp eq i64 %36, %18
  br i1 %37, label %38, label %19, !llvm.loop !24

38:                                               ; preds = %33, %10
  %39 = bitcast i8*** %15 to i8*
  call void @hypre_Free(i8* %39) #3
  call void @hypre_Free(i8* nonnull %6) #3
  br label %40

40:                                               ; preds = %5, %38
  %41 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
  ret i32 %41
}
...
15:                                               ; preds = %13, %15
  ...
  %18 = call i8* @hypre_CAlloc(i64 1, i64 16) #3
...
35:                                               ; preds = %29
  %36 = call i32 @hypre_StructMatvecDestroy(i8* nonnull %33) #3
  br label %37
...
40:                                               ; preds = %37
  %41 = bitcast i8*** %28 to i8**
  %42 = load i8*, i8** %41, align 8, !tbaa !3
  call void @hypre_Free(i8* %42) #3
  store i8** null, i8*** %28, align 8, !tbaa !3
  %43 = add nuw nsw i64 %27, 1
  %44 = icmp eq i64 %43, %25
  br i1 %44, label %45, label %26, !llvm.loop !24

45:                                               ; preds = %40, %17
  %46 = bitcast i8*** %22 to i8*
  call void @hypre_Free(i8* %46) #3
  call void @hypre_Free(i8* nonnull %15) #3
  br label %47

47:                                               ; preds = %12, %45
  %48 = add nuw nsw i64 %13, 1
  %49 = icmp eq i64 %48, %11
  br i1 %49, label %50, label %12, !llvm.loop !35
...
define dso_local i32 @hypre_SStructMatvec(double %0, %struct.hypre_SStructMatrix_struct* nocapture readonly %1, %struct.hypre_SStructVector_struct* %2, double %3, %struct.hypre_SStructVector_struct* %4) local_unnamed_addr #0 {
  ...
  %9 = sext i32 %8 to i64
  %10 = shl nsw i64 %9, 3
  %11 = call i8* @hypre_MAlloc(i64 %10) #3
  %12 = bitcast i8* %11 to i8**
...
18:                                               ; preds = %18, %16
  ...
  %21 = call i8* @hypre_CAlloc(i64 1, i64 16) #3
...
31:                                               ; preds = %18, %5
  ...
  %36 = call i32 @hypre_SStructMatvecDestroy(i8* %6)
  %37 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
  ret i32 %37
}

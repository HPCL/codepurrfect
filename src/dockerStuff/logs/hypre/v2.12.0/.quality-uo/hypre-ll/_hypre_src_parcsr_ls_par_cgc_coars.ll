...
294:                                              ; preds = %292
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0), i32 297, i32 1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0)) #7
  br label %295
...
495:                                              ; preds = %492
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0), i32 447, i32 1, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i64 0, i64 0)) #7
  br label %496
...
503:                                              ; preds = %499
  ...
  %507 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.3, i64 0, i64 0), i32 %506, double %505)
  br label %508
...
522:                                              ; preds = %519
  ...
  %526 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i32 %525, double %524)
  br label %535
...
659:                                              ; preds = %656
  ...
  %663 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.5, i64 0, i64 0), i32 %662, double %661)
  br label %664
...
726:                                              ; preds = %724
  ...
  %730 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.6, i64 0, i64 0), i32 %729, double %728)
  br label %731
...
define dso_local i32 @hypre_AmgCGCGraphAssemble(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture readonly %2, i32* nocapture readonly %3, i32 %4, %struct.hypre_IJMatrix_struct** nocapture %5) local_unnamed_addr #0 {
  ...
  %47 = call i8* @hypre_CAlloc(i64 %46, i64 4) #7
  %48 = bitcast i8* %47 to i32*
  %49 = call i8* @hypre_CAlloc(i64 %46, i64 4) #7
...
82:                                               ; preds = %76, %82
  ...
  %90 = call i32 @hypre_MPI_Irecv(i8* %86, i32 2, i32 1275069445, i32 %88, i32 301, i32 %20, i32* %89) #7
  ...
  %96 = call i32 @hypre_MPI_Irecv(i8* %92, i32 2, i32 1275069445, i32 %93, i32 302, i32 %20, i32* nonnull %95) #7
...
99:                                               ; preds = %80, %99
  ...
  %111 = call i32 @hypre_MPI_Isend(i8* nonnull %107, i32 2, i32 1275069445, i32 %109, i32 301, i32 %20, i32* %110) #7
  %112 = bitcast i32* %105 to i8*
  %113 = load i32, i32* %108, align 4, !tbaa !21
  %114 = getelementptr inbounds i32, i32* %73, i64 %103
  %115 = call i32 @hypre_MPI_Isend(i8* nonnull %112, i32 2, i32 1275069445, i32 %113, i32 302, i32 %20, i32* nonnull %114) #7
  %116 = add nuw nsw i64 %100, 1
  %117 = icmp eq i64 %116, %81
  br i1 %117, label %118, label %99, !llvm.loop !71

118:                                              ; preds = %99, %78
  %119 = call i32 @hypre_MPI_Waitall(i32 %70, i32* %73, %struct.MPI_Status* nonnull inttoptr (i64 1 to %struct.MPI_Status*)) #7
...
219:                                              ; preds = %215, %140, %118
  ...
  %227 = call i8* @hypre_CAlloc(i64 %226, i64 4) #7
...
261:                                              ; preds = %251, %234
  ...
  %263 = call i32 @HYPRE_IJMatrixCreate(i32 %20, i32 %64, i32 %262, i32 %64, i32 %262, %struct.hypre_IJMatrix_struct** nonnull %12) #7
  %264 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %12, align 8, !tbaa !18
  %265 = call i32 @HYPRE_IJMatrixSetObjectType(%struct.hypre_IJMatrix_struct* %264, i32 5555) #7
  %266 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %12, align 8, !tbaa !18
  %267 = call i32 @HYPRE_IJMatrixSetDiagOffdSizes(%struct.hypre_IJMatrix_struct* %266, i32* %228, i32* %230) #7
  %268 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %12, align 8, !tbaa !18
  %269 = call i32 @HYPRE_IJMatrixInitialize(%struct.hypre_IJMatrix_struct* %268) #7
  call void @hypre_Free(i8* %227) #7
...
291:                                              ; preds = %282, %291
  ...
  %293 = call i32 @HYPRE_IJMatrixAddToValues(%struct.hypre_IJMatrix_struct* %292, i32 1, i32* nonnull %13, i32* nonnull %7, i32* nonnull %8, double* nonnull %11) #7
...
388:                                              ; preds = %386, %387, %370
  ...
  %390 = call i32 @HYPRE_IJMatrixAddToValues(%struct.hypre_IJMatrix_struct* %389, i32 1, i32* nonnull %13, i32* nonnull %7, i32* nonnull %8, double* nonnull %11) #7
...
404:                                              ; preds = %305, %275
  ...
  %406 = call i32 @HYPRE_IJMatrixAssemble(%struct.hypre_IJMatrix_struct* %405) #7
  call void @hypre_Free(i8* %221) #7
  %407 = bitcast i32* %223 to i8*
  call void @hypre_Free(i8* %407) #7
  %408 = bitcast i32* %222 to i8*
  call void @hypre_Free(i8* %408) #7

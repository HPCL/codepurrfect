...
define dso_local i32 @HYPRE_SStructGridCreate(i32 %0, i32 %1, i32 %2, %struct.hypre_SStructGrid_struct** nocapture %3) local_unnamed_addr #0 {
  ...
  %9 = call i8* @hypre_MAlloc(i64 176) #7
  ...
  %22 = call i8* @hypre_MAlloc(i64 %16) #7
  %23 = bitcast i8* %22 to %struct.hypre_SStructNeighbor**
  %24 = call i8* @hypre_MAlloc(i64 %16) #7
  %25 = bitcast i8* %24 to [3 x i32]**
  %26 = call i8* @hypre_MAlloc(i64 %19) #7
  %27 = bitcast i8* %26 to i32*
  %28 = call i8* @hypre_MAlloc(i64 %16) #7
  %29 = bitcast i8* %28 to i32**
  %30 = call i8* @hypre_MAlloc(i64 %16) #7
...
116:                                              ; preds = %105, %42
  ...
  call void @hypre_Free(i8* %117) #7
  %118 = bitcast %struct.hypre_SStructPGrid** %12 to i8*
  call void @hypre_Free(i8* %118) #7
...
51:                                               ; preds = %48
  ...
  %55 = shl nsw i64 %54, 2
  %56 = call i8* @hypre_MAlloc(i64 %55) #7
...
151:                                              ; preds = %147, %51, %48
  ...
  %155 = call i8* @hypre_MAlloc(i64 %154) #7
  %156 = bitcast i8* %155 to i32*
  %157 = mul nsw i64 %153, 12
  %158 = call i8* @hypre_MAlloc(i64 %157) #7
...
27:                                               ; preds = %9
  ...
  %34 = call i8* @hypre_ReAlloc(i8* %30, i64 %33) #7
  ...
  %42 = call i8* @hypre_ReAlloc(i8* %37, i64 %41) #7
...
29:                                               ; preds = %11
  ...
  %36 = call i8* @hypre_ReAlloc(i8* %32, i64 %35) #7
  ...
  %44 = call i8* @hypre_ReAlloc(i8* %39, i64 %43) #7
...
136:                                              ; preds = %133, %101
  ...
  %141 = call i8* @hypre_MAlloc(i64 %140) #7
  %142 = bitcast i8* %141 to i32**
  %143 = call i8* @hypre_MAlloc(i64 %140) #7
...
278:                                              ; preds = %273, %177
  ...
  %284 = call i8* @hypre_MAlloc(i64 %283) #7

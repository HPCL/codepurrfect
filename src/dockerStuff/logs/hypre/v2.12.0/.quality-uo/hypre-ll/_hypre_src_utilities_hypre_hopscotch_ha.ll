...
23:                                               ; preds = %19
  ...
  %32 = call i8* @hypre_MAlloc(i64 %28) #4
  ...
  %35 = call i8* @hypre_MAlloc(i64 %28) #4
...
8:                                                ; preds = %4
  ...
  store volatile i32 %9, i32* %10, align 8, !tbaa !18
  %11 = load volatile i32, i32* %10, align 8, !tbaa !18
  %12 = icmp slt i32 %11, %1
  br i1 %12, label %16, label %13

13:                                               ; preds = %8
  %14 = load volatile i32, i32* %10, align 8, !tbaa !18
  %15 = add nsw i32 %14, 1
  br label %16
...
23:                                               ; preds = %19
  ...
  store volatile i32 %25, i32* %26, align 4, !tbaa !20
  %27 = sext i32 %24 to i64
  %28 = shl nsw i64 %27, 4
  %29 = call i8* @hypre_MAlloc(i64 %28) #4
  ...
  store volatile %struct.hypre_HopscotchBucket* %30, %struct.hypre_HopscotchBucket** %31, align 8, !tbaa !21
...
define dso_local void @hypre_UnorderedIntMapDestroy(%struct.hypre_UnorderedIntMap* %0) local_unnamed_addr #0 {
  ...
  %3 = load volatile %struct.hypre_HopscotchBucket*, %struct.hypre_HopscotchBucket** %2, align 8, !tbaa !21
  %4 = bitcast %struct.hypre_HopscotchBucket* %3 to i8*
  call void @hypre_Free(i8* %4) #4
  store volatile %struct.hypre_HopscotchBucket* null, %struct.hypre_HopscotchBucket** %2, align 8, !tbaa !21
  ret void
}
...
define dso_local i32* @hypre_UnorderedIntSetCopyToArray(%struct.hypre_UnorderedIntSet* %0, i32* %1) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 8) #4
...
30:                                               ; preds = %21, %27
  ...
  br i1 %32, label %33, label %21, !llvm.loop !26
...
33:                                               ; preds = %30, %2
  ...
  %36 = shl nsw i64 %35, 2
  %37 = call i8* @hypre_MAlloc(i64 %36) #4
...
60:                                               ; preds = %46, %52
  ...
  br i1 %64, label %46, label %65, !llvm.loop !27

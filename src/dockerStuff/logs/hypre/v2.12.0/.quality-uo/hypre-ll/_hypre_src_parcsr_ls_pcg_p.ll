...
define dso_local i8* @hypre_ParKrylovCAlloc(i32 %0, i32 %1) local_unnamed_addr #0 {
  %3 = sext i32 %0 to i64
  %4 = sext i32 %1 to i64
  %5 = call i8* @hypre_CAlloc(i64 %3, i64 %4) #3
  ret i8* %5
}
...
define dso_local i8* @hypre_ParKrylovCreateVectorArray(i32 %0, i8* nocapture readonly %1) local_unnamed_addr #0 {
  %3 = sext i32 %0 to i64
  %4 = call i8* @hypre_CAlloc(i64 %3, i64 8) #3
...
14:                                               ; preds = %12, %14
  ...
  %18 = load i32*, i32** %10, align 8, !tbaa !10
  %19 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %16, i32 %17, i32* %18) #3
  %20 = getelementptr inbounds %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %5, i64 %15
  store %struct.hypre_ParVector_struct* %19, %struct.hypre_ParVector_struct** %20, align 8, !tbaa !11
  %21 = call i32 @hypre_ParVectorSetPartitioningOwner(%struct.hypre_ParVector_struct* %19, i32 0) #3
  %22 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %20, align 8, !tbaa !11
  %23 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %22) #3
...
!15 = !{!16, !5, i64 0}
!16 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !5, i64 104, !5, i64 108, !5, i64 112, !5, i64 116, !17, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !8, i64 152}
!17 = !{!"double", !6, i64 0}

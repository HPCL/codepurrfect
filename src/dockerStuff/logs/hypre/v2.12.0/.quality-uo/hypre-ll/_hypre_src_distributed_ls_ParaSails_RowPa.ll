...
define dso_local noalias %struct.RowPatt* @RowPattCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call noalias align 16 dereferenceable_or_null(48) i8* @malloc(i64 48) #8
  %3 = bitcast i8* %2 to %struct.RowPatt*
  %4 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %3, i64 0, i32 0
  store i32 %0, i32* %4, align 16, !tbaa !3
  %5 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %3, i64 0, i32 1
  store i32 0, i32* %5, align 4, !tbaa !9
  %6 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %3, i64 0, i32 2
  store i32 0, i32* %6, align 8, !tbaa !10
  %7 = sext i32 %0 to i64
  %8 = shl nsw i64 %7, 2
  %9 = call noalias align 16 i8* @malloc(i64 %8) #8
  %10 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %3, i64 0, i32 3
  %11 = bitcast i32** %10 to i8**
  store i8* %9, i8** %11, align 16, !tbaa !11
  %12 = call noalias align 16 i8* @malloc(i64 %8) #8
  %13 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %3, i64 0, i32 4
  %14 = bitcast i32** %13 to i8**
  store i8* %12, i8** %14, align 8, !tbaa !12
  %15 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %3, i64 0, i32 5
  store i32* null, i32** %15, align 16, !tbaa !13
  %16 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %3, i64 0, i32 6
...
define dso_local void @RowPattDestroy(%struct.RowPatt* nocapture %0) local_unnamed_addr #2 {
...
define dso_local void @RowPattReset(%struct.RowPatt* nocapture %0) local_unnamed_addr #4 {
...
define dso_local void @RowPattMerge(%struct.RowPatt* nocapture %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #5 {
...
; Function Attrs: nounwind uwtable
define dso_local void @RowPattMergeExt(%struct.RowPatt* nocapture %0, i32 %1, i32* nocapture readonly %2, i32 %3) local_unnamed_addr #5 {
...
24:                                               ; preds = %21
  ...
  %33 = shl nsw i64 %32, 2
  %34 = call align 16 i8* @realloc(i8* %30, i64 %33) #8
...
; Function Attrs: mustprogress nounwind uwtable willreturn
define dso_local void @RowPattGet(%struct.RowPatt* nocapture %0, i32* nocapture %1, i32** nocapture %2) local_unnamed_addr #2 {
...
17:                                               ; preds = %9, %3
  ...
  %25 = shl nsw i64 %24, 2
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %20, i8* align 4 %23, i64 %25, i1 false)
...
; Function Attrs: mustprogress nounwind uwtable willreturn
define dso_local void @RowPattPrevLevel(%struct.RowPatt* nocapture %0, i32* nocapture %1, i32** nocapture %2) local_unnamed_addr #2 {
  %4 = getelementptr inbounds %struct.RowPatt, %struct.RowPatt* %0, i64 0, i32 1
  %5 = load i32, i32* %4, align 4, !tbaa !9
...
20:                                               ; preds = %12, %3
  ...
  %31 = shl nsw i64 %30, 2
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %23, i8* align 4 %29, i64 %31, i1 false)

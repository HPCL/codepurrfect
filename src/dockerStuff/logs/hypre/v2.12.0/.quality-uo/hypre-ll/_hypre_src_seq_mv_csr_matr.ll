...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_CAllocHost(i64 1, i64 56) #10
...
23:                                               ; preds = %16, %12
  ...
  call void @hypre_FreeHost(i8* nonnull %24) #10
  br label %25
...
23:                                               ; preds = %13, %1
  ...
  %28 = call i8* @hypre_CAllocHost(i64 1, i64 56) #10
...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRMatrixClone(%struct.hypre_CSRMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %8 = call i8* @hypre_CAllocHost(i64 1, i64 56) #10
...
177:                                              ; preds = %113, %106
  ...
  %179 = call i8* @hypre_CAllocHost(i64 1, i64 56) #10

...
@str = private unnamed_addr constant [46 x i8] c"Aborting solve due to slow or no convergence.\00", align 1
...
define dso_local void @PCG_ParaSails(%struct.Matrix* %0, %struct.ParaSails* %1, double* %2, double* %3, double %4, i32 %5) local_unnamed_addr #0 {
  ...
  %71 = call i32 @hypre_MPI_Comm_rank(i32 %70, i32* nonnull %61) #8
  ...
  %76 = call double @hypre_ddot(i32* nonnull %57, double* %2, i32* nonnull %60, double* %2, i32* nonnull %60) #8
  store double %76, double* %58, align 8, !tbaa !12
  %77 = call i32 @hypre_MPI_Allreduce(i8* nonnull %73, i8* nonnull %74, i32 1, i32 1275070475, i32 1476395011, i32 %70) #8
...
82:                                               ; preds = %6
  ...
  %85 = call i32 @hypre_dcopy(i32* nonnull %55, double* %2, i32* nonnull %56, double* %3, i32* nonnull %56) #8
...
86:                                               ; preds = %6
  ...
  %88 = shl nsw i64 %87, 3
  %89 = call noalias align 16 i8* @malloc(i64 %88) #8
  %90 = bitcast i8* %89 to double*
  %91 = call noalias align 16 i8* @malloc(i64 %88) #8
  %92 = bitcast i8* %91 to double*
  %93 = call noalias align 16 i8* @malloc(i64 %88) #8
  %94 = bitcast i8* %93 to double*
  call void @MatrixMatvec(%struct.Matrix* %0, double* %3, double* %94) #8
  ...
  %98 = call i32 @hypre_dscal(i32* nonnull %52, double* nonnull %53, double* %94, i32* nonnull %54) #8
  ...
  %102 = call i32 @hypre_daxpy(i32* nonnull %49, double* nonnull %50, double* %2, i32* nonnull %51, double* %94, i32* nonnull %51) #8
...
104:                                              ; preds = %86
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %94, double* %90) #8
  br label %109
...
105:                                              ; preds = %86
  ...
  %108 = call i32 @hypre_dcopy(i32* nonnull %47, double* %94, i32* nonnull %48, double* %90, i32* nonnull %48) #8
...
109:                                              ; preds = %105, %104
  ...
  %114 = call double @hypre_ddot(i32* nonnull %43, double* %94, i32* nonnull %46, double* %90, i32* nonnull %46) #8
  store double %114, double* %44, align 8, !tbaa !12
  %115 = call i32 @hypre_MPI_Allreduce(i8* nonnull %111, i8* nonnull %112, i32 1, i32 1275070475, i32 1476395011, i32 %70) #8
...
144:                                              ; preds = %109, %176
  ...
  call void @MatrixMatvec(%struct.Matrix* %0, double* %90, double* %92) #8
  ...
  %148 = call double @hypre_ddot(i32* nonnull %39, double* %92, i32* nonnull %42, double* %90, i32* nonnull %42) #8
  store double %148, double* %40, align 8, !tbaa !12
  %149 = call i32 @hypre_MPI_Allreduce(i8* nonnull %118, i8* nonnull %119, i32 1, i32 1275070475, i32 1476395011, i32 %70) #8
  ...
  %152 = call i32 @hypre_daxpy(i32* nonnull %36, double* nonnull %37, double* %90, i32* nonnull %38, double* %3, i32* nonnull %38) #8
  ...
  %154 = call i32 @hypre_daxpy(i32* nonnull %33, double* nonnull %34, double* %92, i32* nonnull %35, double* %94, i32* nonnull %35) #8
...
155:                                              ; preds = %144
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %94, double* %92) #8
  br label %158
...
156:                                              ; preds = %144
  ...
  %157 = call i32 @hypre_dcopy(i32* nonnull %31, double* %94, i32* nonnull %32, double* %92, i32* nonnull %32) #8
...
158:                                              ; preds = %156, %155
  ...
  %159 = call double @hypre_ddot(i32* nonnull %27, double* %94, i32* nonnull %30, double* %92, i32* nonnull %30) #8
  store double %159, double* %28, align 8, !tbaa !12
  %160 = call i32 @hypre_MPI_Allreduce(i8* nonnull %130, i8* nonnull %131, i32 1, i32 1275070475, i32 1476395011, i32 %70) #8
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %136) #8
  store i32 1, i32* %26, align 4, !tbaa !11
  %162 = call double @hypre_ddot(i32* nonnull %23, double* %94, i32* nonnull %26, double* %94, i32* nonnull %26) #8
  store double %162, double* %24, align 8, !tbaa !12
  %163 = call i32 @hypre_MPI_Allreduce(i8* nonnull %134, i8* nonnull %135, i32 1, i32 1275070475, i32 1476395011, i32 %70) #8
  %164 = load double, double* %25, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %136) #8
...
174:                                              ; preds = %171
  %175 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([46 x i8], [46 x i8]* @str, i64 0, i64 0))
  br label %182
...
176:                                              ; preds = %166
  ...
  %178 = call i32 @hypre_dscal(i32* nonnull %20, double* nonnull %21, double* %90, i32* nonnull %22) #8
  ...
  %179 = call i32 @hypre_daxpy(i32* nonnull %17, double* nonnull %18, double* %92, i32* nonnull %19, double* %90, i32* nonnull %19) #8
...
182:                                              ; preds = %176, %158, %109, %171, %174
  ...
  %187 = call i32 @hypre_dscal(i32* nonnull %14, double* nonnull %15, double* %94, i32* nonnull %16) #8
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %190) #8
  store i32 1, i32* %13, align 4, !tbaa !11
  %191 = call i32 @hypre_daxpy(i32* nonnull %11, double* nonnull %12, double* %2, i32* nonnull %13, double* %94, i32* nonnull %13) #8
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %190) #8
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %195) #8
  store i32 1, i32* %10, align 4, !tbaa !11
  %196 = call double @hypre_ddot(i32* nonnull %7, double* %94, i32* nonnull %10, double* %94, i32* nonnull %10) #8
  store double %196, double* %8, align 8, !tbaa !12
  %197 = call i32 @hypre_MPI_Allreduce(i8* nonnull %193, i8* nonnull %194, i32 1, i32 1275070475, i32 1476395011, i32 %70) #8
  %198 = load double, double* %9, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %195) #8
...
201:                                              ; preds = %182
  ...
  %204 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @.str.1, i64 0, i64 0), i32 %183, double %203)
  br label %205

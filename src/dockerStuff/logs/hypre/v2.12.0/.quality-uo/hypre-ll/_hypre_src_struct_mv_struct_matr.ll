...
45:                                               ; preds = %28, %16
  ...
  %51 = call i32 @hypre_BoxArrayDestroy(%struct.hypre_BoxArray_struct* %50) #11
  ...
  %57 = call i32 @hypre_StructStencilDestroy(%struct.hypre_StructStencil_struct* %56) #11
  ...
  %60 = call i32 @hypre_StructStencilDestroy(%struct.hypre_StructStencil_struct* %59) #11
  ...
  %63 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %62) #11
  %64 = bitcast %struct.hypre_StructMatrix_struct* %0 to i8*
  call void @hypre_Free(i8* nonnull %64) #11
  br label %65
...
79:                                               ; preds = %76, %75
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 533, i32 1, i8* null) #11
...
215:                                              ; preds = %212, %203
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 683, i32 1, i8* null) #11
...
119:                                              ; preds = %114
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 850, i32 1, i8* null) #11
...
165:                                              ; preds = %160
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 875, i32 1, i8* null) #11
...
198:                                              ; preds = %193
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 900, i32 1, i8* null) #11
...
224:                                              ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 922, i32 1, i8* null) #11

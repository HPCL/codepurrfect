...
25:                                               ; preds = %8
  ...
  %28 = call i8* @hypre_CAlloc(i64 %27, i64 4) #10
...
33:                                               ; preds = %25
  %34 = call i8* @hypre_CAlloc(i64 %30, i64 4) #10
  %35 = bitcast i8* %34 to i32*
  %36 = getelementptr inbounds i32, i32* %15, i64 %30
  %37 = load i32, i32* %36, align 4, !tbaa !12
  %38 = sext i32 %37 to i64
  %39 = call i8* @hypre_CAlloc(i64 %38, i64 4) #10
  %40 = bitcast i8* %39 to i32*
  %41 = call i8* @hypre_CAlloc(i64 %30, i64 4) #10
...
70:                                               ; preds = %46, %33
  ...
  call void @hypre_Free(i8* %34) #10
  call void @hypre_Free(i8* %41) #10
...
98:                                               ; preds = %97
  ...
  %102 = call i8* @hypre_CAlloc(i64 %101, i64 4) #10
  %103 = bitcast i8* %102 to i32*
  %104 = call i8* @hypre_CAlloc(i64 %30, i64 4) #10
...
110:                                              ; preds = %107, %98
  %111 = call i8* @hypre_CAlloc(i64 %30, i64 4) #10
...
222:                                              ; preds = %143, %118
  ...
  %227 = call i8* @hypre_CAlloc(i64 %226, i64 4) #10
...
319:                                              ; preds = %97
  ...
  %321 = add nsw i32 %320, 1
  %322 = sext i32 %321 to i64
  %323 = call i8* @hypre_CAlloc(i64 %322, i64 4) #10
  %324 = bitcast i8* %323 to i32*
  %325 = call i8* @hypre_CAlloc(i64 %30, i64 4) #10
...
438:                                              ; preds = %340, %337
  ...
  %442 = call i8* @hypre_CAlloc(i64 %441, i64 4) #10
...
546:                                              ; preds = %447, %438, %318
  ...
  call void @hypre_Free(i8* %548) #10
  call void @hypre_Free(i8* %549) #10
  br label %552
...
579:                                              ; preds = %576, %552
  ...
  %583 = call i8* @hypre_CAlloc(i64 %581, i64 8) #10
  %584 = bitcast i8* %583 to double*
  %585 = icmp eq i32 %7, 0
  br i1 %585, label %589, label %586

586:                                              ; preds = %579
  %587 = call i8* @hypre_CAlloc(i64 %582, i64 4) #10
...
589:                                              ; preds = %586, %579
  ...
  %592 = call i8* @hypre_CAlloc(i64 %591, i64 4) #10
  %593 = bitcast i8* %592 to i32*
  %594 = call i8* @hypre_CAlloc(i64 %30, i64 4) #10
...
701:                                              ; preds = %700
  %702 = call i32 @hypre_dgetrf(i32* nonnull %11, i32* nonnull %11, double* %637, i32* nonnull %11, i32* %639, i32* nonnull %10) #10
  %703 = load i32, i32* %11, align 4, !tbaa !12
  %704 = add nsw i32 %703, %608
  br label %707

705:                                              ; preds = %700
  %706 = call i32 @hypre_dpotrf(i8* nonnull %12, i32* nonnull %11, double* %637, i32* nonnull %11, i32* nonnull %10) #10
  br label %707
...
723:                                              ; preds = %604, %600
  ...
  %727 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %555, i32 %580, i32 %726) #10
...
128:                                              ; preds = %121
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 2328, i32 1, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.5, i64 0, i64 0)) #10
  store i32 1, i32* %13, align 4, !tbaa !12
...
91:                                               ; preds = %88
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 3066, i32 1, i8* null) #10
  br label %92
...
97:                                               ; preds = %94
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 3197, i32 1, i8* null) #10
  br label %98
...
207:                                              ; preds = %204
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i64 0, i64 0), i32 3403, i32 1, i8* null) #10
  br label %208
...
48:                                               ; preds = %8
  ...
  %51 = call i32 @hypre_MPI_Comm_size(i32 %50, i32* nonnull %13) #10
  %52 = load i32, i32* %49, align 8, !tbaa !62
  %53 = call i32 @hypre_MPI_Comm_size(i32 %52, i32* nonnull %14) #10
  %54 = add nsw i32 %25, 1
  %55 = sext i32 %54 to i64
  %56 = call i8* @hypre_CAlloc(i64 %55, i64 4) #10
  %57 = bitcast i8* %56 to i32*
  %58 = sext i32 %25 to i64
  %59 = call i8* @hypre_CAlloc(i64 %58, i64 4) #10
...
61:                                               ; preds = %48
  %62 = call i8* @hypre_CAlloc(i64 %58, i64 4) #10
  %63 = bitcast i8* %62 to i32*
  %64 = getelementptr inbounds i32, i32* %19, i64 %58
  %65 = load i32, i32* %64, align 4, !tbaa !12
  %66 = sext i32 %65 to i64
  %67 = call i8* @hypre_CAlloc(i64 %66, i64 4) #10
...
96:                                               ; preds = %72, %61
  %97 = call i8* @hypre_CAlloc(i64 %58, i64 4) #10
  ...
  call void @hypre_Free(i8* %62) #10
  call void @hypre_Free(i8* %97) #10
  call void @hypre_Free(i8* %67) #10
  br label %125
...
126:                                              ; preds = %125
  ...
  %130 = call i8* @hypre_CAlloc(i64 %129, i64 4) #10
  %131 = bitcast i8* %130 to i32*
  %132 = call i8* @hypre_CAlloc(i64 %58, i64 4) #10
...
160:                                              ; preds = %137, %126
  ...
  %162 = call i8* @hypre_CAlloc(i64 %161, i64 4) #10
...
173:                                              ; preds = %170
  %174 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) #10
...
208:                                              ; preds = %188, %182
  %209 = call i8* @hypre_CAlloc(i64 %58, i64 4) #10
  %210 = bitcast i8* %209 to i32*
  %211 = call i8* @hypre_CAlloc(i64 %161, i64 4) #10
...
356:                                              ; preds = %353, %351
  ...
  %360 = call i8* @hypre_CAlloc(i64 %359, i64 4) #10
...
491:                                              ; preds = %125
  ...
  %493 = add nsw i32 %492, 1
  %494 = sext i32 %493 to i64
  %495 = call i8* @hypre_CAlloc(i64 %494, i64 4) #10
  %496 = bitcast i8* %495 to i32*
  %497 = call i8* @hypre_CAlloc(i64 %58, i64 4) #10
...
525:                                              ; preds = %502, %491
  %526 = call i8* @hypre_CAlloc(i64 %58, i64 4) #10
  %527 = bitcast i8* %526 to i32*
  %528 = sext i32 %38 to i64
  %529 = call i8* @hypre_CAlloc(i64 %528, i64 4) #10
...
714:                                              ; preds = %711, %709
  ...
  %718 = call i8* @hypre_CAlloc(i64 %717, i64 4) #10
...
888:                                              ; preds = %723, %714, %490
  ...
  call void @hypre_Free(i8* %892) #10
  call void @hypre_Free(i8* %893) #10
  br label %896
...
923:                                              ; preds = %920, %896
  ...
  %927 = call i8* @hypre_CAlloc(i64 %925, i64 8) #10
  %928 = bitcast i8* %927 to double*
  %929 = icmp eq i32 %7, 0
  br i1 %929, label %933, label %930

930:                                              ; preds = %923
  %931 = call i8* @hypre_CAlloc(i64 %926, i64 4) #10
...
937:                                              ; preds = %933
  %938 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixExtractBExt(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %0, i32 1) #10
...
945:                                              ; preds = %933, %937
  ...
  %951 = call i8* @hypre_CAlloc(i64 %950, i64 4) #10
  %952 = bitcast i8* %951 to i32*
  %953 = add nsw i32 %38, %25
  %954 = sext i32 %953 to i64
  %955 = call i8* @hypre_CAlloc(i64 %954, i64 4) #10
...
1114:                                             ; preds = %1105
  %1115 = call i32 @hypre_BinarySearch(i32* %40, i32 %1108, i32 %38) #10
...
1146:                                             ; preds = %1145
  %1147 = call i32 @hypre_dgetrf(i32* nonnull %11, i32* nonnull %11, double* %1001, i32* nonnull %11, i32* %1003, i32* nonnull %10) #10
  %1148 = load i32, i32* %11, align 4, !tbaa !12
  %1149 = add nsw i32 %1148, %972
  br label %1152

1150:                                             ; preds = %1145
  %1151 = call i32 @hypre_dpotrf(i8* nonnull %12, i32* nonnull %11, double* %1001, i32* nonnull %11, i32* nonnull %10) #10
  br label %1152
...
1168:                                             ; preds = %968, %964
  call void @hypre_Free(i8* %951) #10
  call void @hypre_Free(i8* %955) #10
  %1169 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %946) #10
  %1170 = sext i32 %899 to i64
  %1171 = getelementptr inbounds i32, i32* %898, i64 %1170
  %1172 = load i32, i32* %1171, align 4, !tbaa !12
  %1173 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %899, i32 %924, i32 %1172) #10

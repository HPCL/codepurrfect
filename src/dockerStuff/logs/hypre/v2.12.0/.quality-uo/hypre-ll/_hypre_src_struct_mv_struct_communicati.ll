...
36:                                               ; preds = %26, %16
  ...
  %62 = call i8* @hypre_CAlloc(i64 1, i64 176) #7
...
77:                                               ; preds = %36
  ...
  %79 = shl nsw i64 %78, 3
  %80 = call i8* @hypre_MAlloc(i64 %79) #7
...
89:                                               ; preds = %86, %105
  ...
  %91 = call i8* @hypre_MAlloc(i64 %83) #7
...
110:                                              ; preds = %108, %36
  ...
  %120 = call i8* @hypre_MAlloc(i64 %119) #7
...
148:                                              ; preds = %142, %131
  ...
  %153 = call i8* @hypre_MAlloc(i64 %152) #7
...
203:                                              ; preds = %196, %148
  ...
  %208 = call i8* @hypre_MAlloc(i64 %207) #7
  %209 = bitcast i8* %208 to i32*
  %210 = call i8* @hypre_MAlloc(i64 %207) #7
  %211 = bitcast i8* %210 to i32*
  %212 = call i8* @hypre_MAlloc(i64 %207) #7
...
255:                                              ; preds = %249, %203
  ...
  %260 = call i8* @hypre_CAlloc(i64 %259, i64 40) #7
  %261 = bitcast i8* %260 to %struct.hypre_CommType_struct*
  %262 = sext i32 %205 to i64
  %263 = mul nsw i64 %262, 48
  %264 = call i8* @hypre_MAlloc(i64 %263) #7
  %265 = shl nsw i64 %262, 2
  %266 = call i8* @hypre_MAlloc(i64 %265) #7
  %267 = mul nsw i64 %262, 28
  %268 = call i8* @hypre_MAlloc(i64 %267) #7
...
432:                                              ; preds = %429, %284
  ...
  %438 = call i8* @hypre_ReAlloc(i8* %260, i64 %437) #7
  ...
  %452 = call i8* @hypre_MAlloc(i64 %451) #7
...
485:                                              ; preds = %479, %432
  ...
  %494 = call i8* @hypre_ReAlloc(i8* %208, i64 %493) #7
  %495 = bitcast i8* %494 to i32*
  %496 = call i8* @hypre_ReAlloc(i8* %210, i64 %493) #7
  %497 = bitcast i8* %496 to i32*
  %498 = call i8* @hypre_ReAlloc(i8* %212, i64 %493) #7
...
541:                                              ; preds = %535, %485
  ...
  %546 = call i8* @hypre_CAlloc(i64 %545, i64 40) #7
...
636:                                              ; preds = %615, %552
  ...
  %641 = call i8* @hypre_ReAlloc(i8* %546, i64 %640) #7
...
695:                                              ; preds = %655, %694, %636
  ...
  call void @hypre_Free(i8* %496) #7
  call void @hypre_Free(i8* %498) #7
...
define dso_local i32 @hypre_InitializeCommunication(%struct.hypre_CommPkg_struct* %0, double* %1, double* %2, i32 %3, i32 %4, %struct.hypre_CommHandle_struct** nocapture %5) local_unnamed_addr #0 {
  ...
  %32 = call i8* @hypre_CAlloc(i64 %31, i64 4) #7
  %33 = bitcast i8* %32 to i32*
  %34 = call i8* @hypre_CAlloc(i64 %31, i64 20) #7
...
40:                                               ; preds = %6
  ...
  %44 = shl nsw i64 %43, 3
  %45 = call i8* @hypre_MAlloc(i64 %44) #7
...
64:                                               ; preds = %52, %40, %6
  ...
  %66 = shl nsw i64 %65, 3
  %67 = call i8* @hypre_MAlloc(i64 %66) #7
...
70:                                               ; preds = %64
  ...
  %74 = shl nsw i64 %73, 3
  %75 = call i8* @hypre_MAlloc(i64 %74) #7
...
408:                                              ; preds = %401
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 %413, i8* align 4 %416, i64 %418, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 %420, i8* align 4 %423, i64 %424, i1 false)
...
513:                                              ; preds = %509
  ...
  %523 = call i8* @hypre_MAlloc(i64 %522) #7
...
566:                                              ; preds = %559, %509
  ...
  %568 = call i8* @hypre_MAlloc(i64 88) #7
...
define dso_local i32 @hypre_ExchangeLocalData(%struct.hypre_CommPkg_struct* nocapture readonly %0, double* readonly %1, double* %2, i32 %3) local_unnamed_addr #5 {
...
52:                                               ; preds = %43, %13
  ...
  call void @hypre_Free(i8* nonnull %57) #7
  br label %58

...
define dso_local i32 @HYPRE_NewDistributedMatrixPilutSolver(i32 %0, i8* %1, i8** nocapture %2) local_unnamed_addr #0 {
  ...
  %8 = call i8* @hypre_CAlloc(i64 1, i64 64) #7
  %9 = bitcast i8* %8 to i32*
  store i32 %0, i32* %9, align 8, !tbaa !3
  %10 = call i8* @hypre_CAlloc(i64 1, i64 16) #7
  ...
  %14 = call i8* @hypre_CAlloc(i64 1, i64 3216) #7
  ...
  %38 = call i8* @hypre_CAlloc(i64 1, i64 2296) #7
...
21:                                               ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([69 x i8], [69 x i8]* @.str, i64 0, i64 0), i32 337, i32 12, i8* null) #7
  br label %22
...
63:                                               ; preds = %22
  call void @hypre_error_handler(i8* getelementptr inbounds ([69 x i8], [69 x i8]* @.str, i64 0, i64 0), i32 392, i32 1, i8* null) #7
  br label %64
...
71:                                               ; preds = %64
  call void @hypre_error_handler(i8* getelementptr inbounds ([69 x i8], [69 x i8]* @.str, i64 0, i64 0), i32 418, i32 1, i8* null) #7
  br label %72

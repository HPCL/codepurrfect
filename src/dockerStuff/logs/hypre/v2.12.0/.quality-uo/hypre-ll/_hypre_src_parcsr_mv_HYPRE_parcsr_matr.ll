...
11:                                               ; preds = %9
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 38, i32 76, i8* null) #3
  br label %14
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 81, i32 28, i8* null) #3
  br label %8
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 111, i32 12, i8* null) #3
  br label %8
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 129, i32 12, i8* null) #3
  br label %11
...
6:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 151, i32 12, i8* null) #3
...
15:                                               ; preds = %8
  ...
  %19 = call i8* @hypre_CAlloc(i64 %18, i64 4) #3
...
6:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 180, i32 12, i8* null) #3
  %7 = load i32, i32* @hypre__global_error, align 4, !tbaa !7
  br label %35
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 225, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 247, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 269, i32 12, i8* null) #3
  br label %10
...
7:                                                ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 297, i32 44, i8* null) #3
  br label %11
...
5:                                                ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0), i32 321, i32 28, i8* null) #3
  br label %9

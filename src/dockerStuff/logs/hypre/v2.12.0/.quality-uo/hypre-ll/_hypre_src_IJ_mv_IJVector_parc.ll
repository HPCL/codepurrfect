...
@str = private unnamed_addr constant [28 x i8] c"hypre_IJVectorInitializePar\00", align 1
@str.28 = private unnamed_addr constant [28 x i8] c"hypre_IJVectorDistributePar\00", align 1
@str.29 = private unnamed_addr constant [40 x i8] c"**** Vector storage is unallocated ****\00", align 1
@str.33 = private unnamed_addr constant [64 x i8] c"**** Vector partitioning is either unallocated or orphaned ****\00", align 1
@str.36 = private unnamed_addr constant [28 x i8] c"hypre_IJVectorZeroValuesPar\00", align 1
@str.45 = private unnamed_addr constant [27 x i8] c"hypre_IJVectorSetValuesPar\00", align 1
@str.53 = private unnamed_addr constant [40 x i8] c"Off processor values have been ignored!\00", align 1
@str.54 = private unnamed_addr constant [29 x i8] c"hypre_IJVectorAddToValuesPar\00", align 1
@str.57 = private unnamed_addr constant [67 x i8] c"**** ParVector partitioning is either unallocated or orphaned ****\00", align 1
@str.60 = private unnamed_addr constant [26 x i8] c"hypre_IJVectorAssemblePar\00", align 1
@str.63 = private unnamed_addr constant [59 x i8] c"**** Vector storage is either unallocated or orphaned ****\00", align 1
@str.65 = private unnamed_addr constant [66 x i8] c"**** IJVector partitioning is either unallocated or orphaned ****\00", align 1
@str.67 = private unnamed_addr constant [62 x i8] c"**** Vector local data is either unallocated or orphaned ****\00", align 1
@str.69 = private unnamed_addr constant [41 x i8] c"**** Indices specified are unusable ****\00", align 1
@str.70 = private unnamed_addr constant [27 x i8] c"hypre_IJVectorGetValuesPar\00", align 1
@str.71 = private unnamed_addr constant [52 x i8] c"**** This vector partitioning should not occur ****\00", align 1
...
define dso_local i32 @hypre_IJVectorCreatePar(%struct.hypre_IJVector_struct* nocapture %0, i32* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %7 = call i32 @hypre_MPI_Comm_size(i32 %5, i32* nonnull %3) #6
  ...
  %12 = call i8* @hypre_CAlloc(i64 2, i64 4) #6
...
22:                                               ; preds = %14
  %23 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %5, i32 %11, i32* %13) #6
...
define dso_local i32 @hypre_IJVectorDestroyPar(%struct.hypre_IJVector_struct* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %5 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %4) #6
  ret i32 %5
}
...
define dso_local i32 @hypre_IJVectorInitializePar(%struct.hypre_IJVector_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %20 = call i32 @hypre_MPI_Comm_rank(i32 %19, i32* nonnull %3) #6
...
24:                                               ; preds = %22
  %25 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([49 x i8], [49 x i8]* @.str, i64 0, i64 0))
  %26 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str, i64 0, i64 0))
  br label %27

27:                                               ; preds = %24, %22
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 111, i32 12, i8* null) #6
  br label %44
...
28:                                               ; preds = %1
  ...
  %34 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %6) #6
...
37:                                               ; preds = %28
  %38 = call i32 @hypre_AuxParVectorCreate(%struct.hypre_AuxParVector** nonnull %2) #6
...
41:                                               ; preds = %37, %28
  ...
  %43 = call i32 @hypre_AuxParVectorInitialize(%struct.hypre_AuxParVector* %42) #6
  br label %44
...
9:                                                ; preds = %2
  %10 = call i32 @hypre_AuxParVectorCreate(%struct.hypre_AuxParVector** nonnull %3) #6
...
11:                                               ; preds = %9
  %12 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0))
  %13 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str.28, i64 0, i64 0))
  %14 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([59 x i8], [59 x i8]* @str.63, i64 0, i64 0))
  br label %15

15:                                               ; preds = %11, %9
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 181, i32 12, i8* null) #6
  br label %32
...
16:                                               ; preds = %2
  ...
  %21 = call %struct.hypre_ParVector_struct* @hypre_VectorToParVector(i32 %18, %struct.hypre_Vector* %20, i32* %1) #6
...
25:                                               ; preds = %23
  %26 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.6, i64 0, i64 0))
  %27 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str.28, i64 0, i64 0))
  %28 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([40 x i8], [40 x i8]* @str.29, i64 0, i64 0))
  br label %29

29:                                               ; preds = %25, %23
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 196, i32 12, i8* null) #6
  br label %30

30:                                               ; preds = %29, %16
  %31 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* nonnull %5) #6
...
define dso_local i32 @hypre_IJVectorZeroValuesPar(%struct.hypre_IJVector_struct* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %11 = call i32 @hypre_MPI_Comm_rank(i32 %8, i32* nonnull %2) #6
...
15:                                               ; preds = %13
  %16 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.6, i64 0, i64 0))
  %17 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str.36, i64 0, i64 0))
  %18 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([59 x i8], [59 x i8]* @str.63, i64 0, i64 0))
  br label %19

19:                                               ; preds = %15, %13
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 240, i32 12, i8* null) #6
  br label %64
...
28:                                               ; preds = %26
  %29 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.9, i64 0, i64 0))
  %30 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str.36, i64 0, i64 0))
  %31 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([64 x i8], [64 x i8]* @str.33, i64 0, i64 0))
  br label %32

32:                                               ; preds = %28, %26
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 253, i32 12, i8* null) #6
  br label %64
...
37:                                               ; preds = %35
  %38 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.11, i64 0, i64 0))
  %39 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str.36, i64 0, i64 0))
  %40 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([62 x i8], [62 x i8]* @str.67, i64 0, i64 0))
  br label %41

41:                                               ; preds = %37, %35
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 264, i32 12, i8* null) #6
  br label %64
...
49:                                               ; preds = %47
  %50 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.13, i64 0, i64 0))
  %51 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @str.36, i64 0, i64 0))
  %52 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([52 x i8], [52 x i8]* @str.71, i64 0, i64 0))
  br label %53

53:                                               ; preds = %49, %47
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 284, i32 12, i8* null) #6
  br label %64
...
18:                                               ; preds = %4
  ...
  %21 = call i32 @hypre_MPI_Comm_rank(i32 %20, i32* nonnull %5) #6
...
25:                                               ; preds = %23
  %26 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.6, i64 0, i64 0))
  %27 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.45, i64 0, i64 0))
  %28 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([59 x i8], [59 x i8]* @str.63, i64 0, i64 0))
  br label %29

29:                                               ; preds = %25, %23
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 339, i32 12, i8* null) #6
...
37:                                               ; preds = %35
  %38 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @.str.16, i64 0, i64 0))
  %39 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.45, i64 0, i64 0))
  %40 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([66 x i8], [66 x i8]* @str.65, i64 0, i64 0))
  br label %41

41:                                               ; preds = %37, %35
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 351, i32 12, i8* null) #6
...
47:                                               ; preds = %45
  %48 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.11, i64 0, i64 0))
  %49 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.45, i64 0, i64 0))
  %50 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([62 x i8], [62 x i8]* @str.67, i64 0, i64 0))
  br label %51

51:                                               ; preds = %47, %45
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 362, i32 12, i8* null) #6
...
60:                                               ; preds = %58
  %61 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.13, i64 0, i64 0))
  %62 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.45, i64 0, i64 0))
  %63 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([52 x i8], [52 x i8]* @str.71, i64 0, i64 0))
  br label %64

64:                                               ; preds = %60, %58
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 382, i32 12, i8* null) #6
  %65 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  br label %137
...
120:                                              ; preds = %118
  %121 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([55 x i8], [55 x i8]* @.str.18, i64 0, i64 0))
  %122 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([40 x i8], [40 x i8]* @str.53, i64 0, i64 0))
  br label %123
...
25:                                               ; preds = %23
  %26 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.6, i64 0, i64 0))
  %27 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([29 x i8], [29 x i8]* @str.54, i64 0, i64 0))
  %28 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([59 x i8], [59 x i8]* @str.63, i64 0, i64 0))
  br label %29

29:                                               ; preds = %25, %23
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 485, i32 12, i8* null) #6
  %30 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  br label %166
...
37:                                               ; preds = %35
  %38 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @.str.16, i64 0, i64 0))
  %39 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([29 x i8], [29 x i8]* @str.54, i64 0, i64 0))
  %40 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([66 x i8], [66 x i8]* @str.65, i64 0, i64 0))
  br label %41

41:                                               ; preds = %37, %35
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 497, i32 12, i8* null) #6
  %42 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  br label %166
...
47:                                               ; preds = %45
  %48 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.11, i64 0, i64 0))
  %49 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([29 x i8], [29 x i8]* @str.54, i64 0, i64 0))
  %50 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([62 x i8], [62 x i8]* @str.67, i64 0, i64 0))
  br label %51

51:                                               ; preds = %47, %45
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 508, i32 12, i8* null) #6
  %52 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  br label %166
...
60:                                               ; preds = %58
  %61 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.13, i64 0, i64 0))
  %62 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([29 x i8], [29 x i8]* @str.54, i64 0, i64 0))
  %63 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([52 x i8], [52 x i8]* @str.71, i64 0, i64 0))
  br label %64

64:                                               ; preds = %60, %58
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 528, i32 12, i8* null) #6
  %65 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  br label %166
...
99:                                               ; preds = %97
  ...
  %100 = call i8* @hypre_CAlloc(i64 100, i64 4) #6
  store i8* %100, i8** %77, align 8, !tbaa !30
  %101 = call i8* @hypre_CAlloc(i64 100, i64 8) #6
...
106:                                              ; preds = %104
  ...
  %111 = call i8* @hypre_ReAlloc(i8* %108, i64 %110) #6
  %112 = bitcast i8* %111 to i32*
  %113 = bitcast double* %88 to i8*
  %114 = shl nsw i64 %109, 3
  %115 = call i8* @hypre_ReAlloc(i8* %113, i64 %114) #6
...
147:                                              ; preds = %145
  %148 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([55 x i8], [55 x i8]* @.str.18, i64 0, i64 0))
  %149 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([40 x i8], [40 x i8]* @str.53, i64 0, i64 0))
  br label %150
...
19:                                               ; preds = %17
  %20 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.6, i64 0, i64 0))
  %21 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([26 x i8], [26 x i8]* @str.60, i64 0, i64 0))
  %22 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([59 x i8], [59 x i8]* @str.63, i64 0, i64 0))
  br label %23

23:                                               ; preds = %19, %17
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 631, i32 12, i8* null) #6
  br label %24
...
30:                                               ; preds = %28
  %31 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @.str.16, i64 0, i64 0))
  %32 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([26 x i8], [26 x i8]* @str.60, i64 0, i64 0))
  %33 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([66 x i8], [66 x i8]* @str.65, i64 0, i64 0))
  br label %34

34:                                               ; preds = %30, %28
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 642, i32 12, i8* null) #6
  br label %35
...
39:                                               ; preds = %37
  %40 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.9, i64 0, i64 0))
  %41 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([26 x i8], [26 x i8]* @str.60, i64 0, i64 0))
  %42 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([67 x i8], [67 x i8]* @str.57, i64 0, i64 0))
  br label %43

43:                                               ; preds = %39, %37
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 652, i32 12, i8* null) #6
  br label %44
...
82:                                               ; preds = %80, %46
  %83 = call i32 @hypre_MPI_Allreduce(i8* nonnull %48, i8* nonnull %47, i32 1, i32 1275069445, i32 1476395011, i32 %13) #6
...
define dso_local i32 @hypre_IJVectorAssembleOffProcValsPar(%struct.hypre_IJVector_struct* %0, i32 %1, i32 %2, i32* nocapture readonly %3, double* nocapture readonly %4) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 56, i8* nonnull %23) #6
  ...
  %29 = call i32 @hypre_MPI_Comm_rank(i32 %25, i32* nonnull %6) #6
...
37:                                               ; preds = %5
  %38 = call i32 @hypre_IJVectorCreateAssumedPartition(%struct.hypre_IJVector_struct* %0) #6
  br label %39
...
39:                                               ; preds = %37, %5
  ...
  %46 = call i8* @hypre_CAlloc(i64 %41, i64 4) #6
  %47 = bitcast i8* %46 to i32*
  %48 = call i8* @hypre_CAlloc(i64 %41, i64 4) #6
...
53:                                               ; preds = %51, %53
  ...
  %58 = call i32 @hypre_GetAssumedPartitionProcFromRow(i32 %25, i32 %56, i32 %33, i32 %31, i32* nonnull %7) #6
...
65:                                               ; preds = %53
  %66 = add nsw i32 %2, -1
  call void @hypre_qsort3i(i32* %49, i32* %43, i32* %45, i32 0, i32 %66) #6
  %67 = icmp sgt i32 %2, 1
...
83:                                               ; preds = %71, %65, %39
  ...
  %86 = call i8* @hypre_CAlloc(i64 %85, i64 4) #6
...
118:                                              ; preds = %110, %106
  ...
  %129 = call i32 @hypre_GetAssumedPartitionRowRange(i32 %25, i32 %128, i32 %33, i32 %31, i32* nonnull %8, i32* nonnull %9) #6
  br label %130
...
148:                                              ; preds = %140, %134
  ...
  %153 = call i32 @hypre_DataExchangeList(i32 %84, i32* %87, i8* %94, i32* %91, i32 4, i32 4, %struct.hypre_DataExchangeResponse* nonnull %12, i32 6, i32 4, i32 %25, i8** nonnull %152, i32** nonnull %11) #6
  call void @hypre_Free(i8* %86) #6
  call void @hypre_Free(i8* %94) #6
  call void @hypre_Free(i8* %90) #6
...
200:                                              ; preds = %190, %148
  ...
  %203 = call i8* @hypre_CAlloc(i64 %202, i64 4) #6
  %204 = bitcast i8* %203 to i32*
  %205 = call i8* @hypre_CAlloc(i64 %202, i64 4) #6
...
235:                                              ; preds = %231, %208, %200
  ...
  %238 = call i8* @hypre_CAlloc(i64 %237, i64 4) #6
...
255:                                              ; preds = %243, %235
  ...
  %259 = call i8* @hypre_MAlloc(i64 %258) #6
  %260 = call i8* @hypre_CAlloc(i64 %41, i64 4) #6
...
265:                                              ; preds = %263, %265
  %266 = phi i64 [ 0, %263 ], [ %273, %265 ]
  %267 = getelementptr inbounds i32, i32* %47, i64 %266
  %268 = load i32, i32* %267, align 4, !tbaa !11
  %269 = getelementptr inbounds i32, i32* %45, i64 %266
  %270 = load i32, i32* %269, align 4, !tbaa !11
  %271 = sext i32 %270 to i64
  %272 = getelementptr inbounds i32, i32* %261, i64 %271
  store i32 %268, i32* %272, align 4, !tbaa !11
  %273 = add nuw nsw i64 %266, 1
  %274 = icmp eq i64 %273, %264
  br i1 %274, label %275, label %265, !llvm.loop !53

275:                                              ; preds = %265, %255
  call void @hypre_Free(i8* %46) #6
...
279:                                              ; preds = %277, %303
  %280 = phi i64 [ 0, %277 ], [ %312, %303 ]
  %281 = getelementptr inbounds i32, i32* %261, i64 %280
  %282 = load i32, i32* %281, align 4, !tbaa !11
  store i32 %282, i32* %7, align 4, !tbaa !11
  %283 = getelementptr inbounds i32, i32* %3, i64 %280
  %284 = load i32, i32* %283, align 4, !tbaa !11
  %285 = call i32 @hypre_BinarySearch(i32* %204, i32 %282, i32 %201) #6
  %286 = sext i32 %285 to i64
  %287 = getelementptr inbounds i32, i32* %239, i64 %286
  %288 = load i32, i32* %287, align 4, !tbaa !11
  %289 = shl nsw i32 %288, 3
  %290 = sext i32 %289 to i64
  %291 = getelementptr inbounds i8, i8* %259, i64 %290
  %292 = icmp slt i32 %288, 0
  br i1 %292, label %293, label %303

293:                                              ; preds = %279
  %294 = sub nsw i32 0, %288
  %295 = xor i32 %288, -1
  %296 = shl nsw i32 %295, 3
  %297 = sext i32 %296 to i64
  %298 = getelementptr inbounds i8, i8* %259, i64 %297
  %299 = getelementptr inbounds i32, i32* %206, i64 %286
  %300 = load i32, i32* %299, align 4, !tbaa !11
  %301 = bitcast i8* %298 to i32*
  store i32 %300, i32* %301, align 1
  %302 = getelementptr inbounds i8, i8* %298, i64 8
  br label %303

303:                                              ; preds = %293, %279
  %304 = phi i8* [ %302, %293 ], [ %291, %279 ]
  %305 = phi i32 [ %294, %293 ], [ %288, %279 ]
  %306 = bitcast i8* %304 to i32*
  store i32 %284, i32* %306, align 1
  %307 = getelementptr inbounds i8, i8* %304, i64 8
  %308 = getelementptr inbounds double, double* %4, i64 %280
  %309 = load double, double* %308, align 8, !tbaa !33
  %310 = bitcast i8* %307 to double*
  store double %309, double* %310, align 1
  %311 = add nsw i32 %305, 2
  store i32 %311, i32* %287, align 4, !tbaa !11
  %312 = add nuw nsw i64 %280, 1
  %313 = icmp eq i64 %312, %278
  br i1 %313, label %314, label %279, !llvm.loop !54

314:                                              ; preds = %303, %275
  %315 = load i8*, i8** %152, align 8, !tbaa !17
  call void @hypre_Free(i8* %315) #6
  store i32* null, i32** %10, align 8, !tbaa !17
  %316 = bitcast i32** %11 to i8**
  %317 = load i8*, i8** %316, align 8, !tbaa !17
  call void @hypre_Free(i8* %317) #6
  store i32* null, i32** %11, align 8, !tbaa !17
  call void @hypre_Free(i8* %260) #6
  call void @hypre_Free(i8* %44) #6
  call void @hypre_Free(i8* %48) #6
  call void @hypre_Free(i8* %205) #6
  %318 = icmp sgt i32 %201, 0
  br i1 %318, label %319, label %331

319:                                              ; preds = %314
  %320 = zext i32 %201 to i64
  br label %321

321:                                              ; preds = %319, %321
  %322 = phi i64 [ %320, %319 ], [ %330, %321 ]
  %323 = phi i32 [ %201, %319 ], [ %324, %321 ]
  %324 = add nsw i32 %323, -1
  %325 = zext i32 %324 to i64
  %326 = getelementptr inbounds i32, i32* %239, i64 %325
  %327 = load i32, i32* %326, align 4, !tbaa !11
  %328 = getelementptr inbounds i32, i32* %239, i64 %322
  store i32 %327, i32* %328, align 4, !tbaa !11
  %329 = icmp sgt i64 %322, 1
  %330 = add nsw i64 %322, -1
  br i1 %329, label %321, label %331, !llvm.loop !55

331:                                              ; preds = %321, %314
  store i32 0, i32* %239, align 4, !tbaa !11
  store i32* null, i32** %10, align 8, !tbaa !17
  store i32* null, i32** %11, align 8, !tbaa !17
  %332 = getelementptr inbounds %struct.hypre_ProcListElements, %struct.hypre_ProcListElements* %14, i64 0, i32 0
  store i32 0, i32* %332, align 8, !tbaa !56
  %333 = add nuw nsw i32 %201, 5
  %334 = getelementptr inbounds %struct.hypre_ProcListElements, %struct.hypre_ProcListElements* %14, i64 0, i32 1
  store i32 %333, i32* %334, align 4, !tbaa !58
  %335 = getelementptr inbounds %struct.hypre_ProcListElements, %struct.hypre_ProcListElements* %14, i64 0, i32 2
  store i32* null, i32** %335, align 8, !tbaa !59
  %336 = add nuw nsw i32 %201, 6
  %337 = zext i32 %336 to i64
  %338 = call i8* @hypre_CAlloc(i64 %337, i64 4) #6
  %339 = bitcast i8* %338 to i32*
  %340 = getelementptr inbounds %struct.hypre_ProcListElements, %struct.hypre_ProcListElements* %14, i64 0, i32 3
  %341 = bitcast i32** %340 to i8**
  store i8* %338, i8** %341, align 8, !tbaa !60
  store i32 0, i32* %339, align 4, !tbaa !11
  %342 = add nsw i32 %256, 20
  %343 = getelementptr inbounds %struct.hypre_ProcListElements, %struct.hypre_ProcListElements* %14, i64 0, i32 4
  store i32 %342, i32* %343, align 8, !tbaa !61
  %344 = shl nsw i32 %342, 3
  %345 = sext i32 %344 to i64
  %346 = call i8* @hypre_MAlloc(i64 %345) #6
  %347 = getelementptr inbounds %struct.hypre_ProcListElements, %struct.hypre_ProcListElements* %14, i64 0, i32 7
  store i8* %346, i8** %347, align 8, !tbaa !62
  %348 = getelementptr inbounds %struct.hypre_DataExchangeResponse, %struct.hypre_DataExchangeResponse* %13, i64 0, i32 0
  store i32 (i8*, i32, i32, i8*, i32, i8**, i32*)* @hypre_FillResponseIJOffProcVals, i32 (i8*, i32, i32, i8*, i32, i8**, i32*)** %348, align 8, !tbaa !45
  %349 = getelementptr inbounds %struct.hypre_DataExchangeResponse, %struct.hypre_DataExchangeResponse* %13, i64 0, i32 3
  store i8* null, i8** %349, align 8, !tbaa !47
  %350 = getelementptr inbounds %struct.hypre_DataExchangeResponse, %struct.hypre_DataExchangeResponse* %13, i64 0, i32 4
  %351 = bitcast i8** %350 to %struct.hypre_ProcListElements**
  store %struct.hypre_ProcListElements* %14, %struct.hypre_ProcListElements** %351, align 8, !tbaa !48
  %352 = call i32 @hypre_DataExchangeList(i32 %201, i32* %204, i8* %259, i32* nonnull %239, i32 8, i32 0, %struct.hypre_DataExchangeResponse* nonnull %13, i32 0, i32 5, i32 %25, i8** nonnull %152, i32** nonnull %11) #6
  %353 = load i8*, i8** %152, align 8, !tbaa !17
  call void @hypre_Free(i8* %353) #6
  store i32* null, i32** %10, align 8, !tbaa !17
  %354 = load i8*, i8** %316, align 8, !tbaa !17
  call void @hypre_Free(i8* %354) #6
  store i32* null, i32** %11, align 8, !tbaa !17
  call void @hypre_Free(i8* %203) #6
  call void @hypre_Free(i8* %259) #6
  call void @hypre_Free(i8* %238) #6
  %355 = load i32, i32* %332, align 8, !tbaa !56
  %356 = load i8*, i8** %347, align 8, !tbaa !62
  %357 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %28, i64 0, i32 6
  %358 = load %struct.hypre_Vector*, %struct.hypre_Vector** %357, align 8, !tbaa !20
  %359 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %358, i64 0, i32 0
  %360 = load double*, double** %359, align 8, !tbaa !27
  %361 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %28, i64 0, i32 2
  %362 = load i32, i32* %361, align 8, !tbaa !63
  %363 = add i32 %362, %33
  %364 = icmp sgt i32 %355, 0
  br i1 %364, label %365, label %393

365:                                              ; preds = %331, %389
  %366 = phi i32 [ %391, %389 ], [ 0, %331 ]
  %367 = phi i8* [ %390, %389 ], [ %356, %331 ]
  %368 = bitcast i8* %367 to i32*
  %369 = load i32, i32* %368, align 1
  %370 = getelementptr inbounds i8, i8* %367, i64 8
  %371 = icmp sgt i32 %369, 0
  br i1 %371, label %372, label %389

372:                                              ; preds = %365, %372
  %373 = phi i8* [ %387, %372 ], [ %370, %365 ]
  %374 = phi i32 [ %386, %372 ], [ 0, %365 ]
  %375 = phi i8* [ %378, %372 ], [ %367, %365 ]
  ...
  %383 = getelementptr inbounds double, double* %360, i64 %382
  %384 = load double, double* %383, align 8, !tbaa !33
  %385 = fadd double %380, %384
  store double %385, double* %383, align 8, !tbaa !33
  %386 = add nuw nsw i32 %374, 1
  %387 = getelementptr inbounds i8, i8* %375, i64 24
  %388 = icmp eq i32 %386, %369
  br i1 %388, label %389, label %372, !llvm.loop !64

389:                                              ; preds = %372, %365
  %390 = phi i8* [ %370, %365 ], [ %387, %372 ]
  %391 = add nuw nsw i32 %366, 1
  %392 = icmp eq i32 %391, %355
  br i1 %392, label %393, label %365, !llvm.loop !65

393:                                              ; preds = %389, %331
  call void @hypre_Free(i8* %356) #6
  store i8* null, i8** %347, align 8, !tbaa !62
  %394 = load i8*, i8** %341, align 8, !tbaa !60
  call void @hypre_Free(i8* %394) #6
  store i32* null, i32** %340, align 8, !tbaa !60
  %395 = load i32, i32* @hypre__global_error, align 4, !tbaa !11
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %23) #6
...
15:                                               ; preds = %4
  ...
  %18 = call i32 @hypre_MPI_Comm_rank(i32 %17, i32* nonnull %5) #6
...
22:                                               ; preds = %20
  %23 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.6, i64 0, i64 0))
  %24 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.70, i64 0, i64 0))
  %25 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([59 x i8], [59 x i8]* @str.63, i64 0, i64 0))
  br label %26

26:                                               ; preds = %22, %20
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 740, i32 12, i8* null) #6
...
34:                                               ; preds = %32
  %35 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @.str.16, i64 0, i64 0))
  %36 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.70, i64 0, i64 0))
  %37 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([66 x i8], [66 x i8]* @str.65, i64 0, i64 0))
  br label %38

38:                                               ; preds = %34, %32
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 752, i32 12, i8* null) #6
...
44:                                               ; preds = %42
  %45 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.11, i64 0, i64 0))
  %46 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.70, i64 0, i64 0))
  %47 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([62 x i8], [62 x i8]* @str.67, i64 0, i64 0))
  br label %48

48:                                               ; preds = %44, %42
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 763, i32 12, i8* null) #6
...
57:                                               ; preds = %55
  %58 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @.str.13, i64 0, i64 0))
  %59 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.70, i64 0, i64 0))
  %60 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([52 x i8], [52 x i8]* @str.71, i64 0, i64 0))
  br label %61

61:                                               ; preds = %57, %55
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 783, i32 12, i8* null) #6
...
87:                                               ; preds = %85
  %88 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.24, i64 0, i64 0))
  %89 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @str.70, i64 0, i64 0))
  %90 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([41 x i8], [41 x i8]* @str.69, i64 0, i64 0))
  br label %91

91:                                               ; preds = %87, %85
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 809, i32 28, i8* null) #6
...
118:                                              ; preds = %111
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i32 830, i32 20, i8* null) #6

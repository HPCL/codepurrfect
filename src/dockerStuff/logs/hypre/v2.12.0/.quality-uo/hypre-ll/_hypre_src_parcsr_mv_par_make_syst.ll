...
define dso_local %struct.HYPRE_ParCSR_System_Problem* @HYPRE_Generate2DSystem(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* nocapture readonly %1, %struct.hypre_ParVector_struct* nocapture readonly %2, %struct.hypre_ParVector_struct* nocapture readonly %3, %struct.hypre_ParVector_struct* nocapture readonly %4, %struct.hypre_ParVector_struct* nocapture readonly %5, double* nocapture readonly %6) local_unnamed_addr #0 {
  ...
  %30 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %21, i64 0, i32 6
  ...
  %36 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %19, i64 0, i32 6
  ...
  %42 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %23, i64 0, i32 6
  ...
  %50 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %23, i64 0, i32 3
  %51 = load i32, i32* %50, align 4, !tbaa !18
  %52 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %17, i64 0, i32 4
  %53 = load i32, i32* %52, align 8, !tbaa !19
  %54 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %19, i64 0, i32 4
  %55 = load i32, i32* %54, align 8, !tbaa !19
  %56 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %21, i64 0, i32 4
  %57 = load i32, i32* %56, align 8, !tbaa !19
  %58 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %23, i64 0, i32 4
  ...
  %72 = call i8* @hypre_CAlloc(i64 1, i64 24) #3
  %73 = call i8* @hypre_CAlloc(i64 2, i64 4) #3
  %74 = bitcast i8* %73 to i32*
  %75 = call i8* @hypre_CAlloc(i64 2, i64 4) #3
...
88:                                               ; preds = %77
  %89 = shl nsw i32 %12, 1
  %90 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %17, i64 0, i32 2
  ...
  %102 = call i8* @hypre_CAlloc(i64 %101, i64 4) #3
  %103 = bitcast i8* %102 to i32*
  %104 = sext i32 %99 to i64
  %105 = call i8* @hypre_CAlloc(i64 %104, i64 4) #3
  %106 = bitcast i8* %105 to i32*
  %107 = call i8* @hypre_CAlloc(i64 %104, i64 8) #3
...
304:                                              ; preds = %299, %88
  %305 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %19, i64 0, i32 2
  ...
  %321 = call i8* @hypre_CAlloc(i64 %318, i64 8) #3
  %322 = bitcast i8* %321 to double*
  %323 = sext i32 %313 to i64
  %324 = call i8* @hypre_CAlloc(i64 %323, i64 4) #3
  %325 = bitcast i8* %324 to i32*
  %326 = sext i32 %49 to i64
  %327 = call i8* @hypre_CAlloc(i64 %326, i64 4) #3
  %328 = bitcast i8* %327 to i32*
  %329 = sext i32 %51 to i64
  %330 = call i8* @hypre_CAlloc(i64 %329, i64 4) #3
...
384:                                              ; preds = %374
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0), i32 314, i32 1, i8* null) #3
  br label %385
...
595:                                              ; preds = %590, %390
  call void @hypre_Free(i8* %327) #3
  call void @hypre_Free(i8* %330) #3
  ...
  %599 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %598, i64 0, i32 6
  ...
  %626 = call i8* @hypre_CAlloc(i64 %625, i64 8) #3
...
643:                                              ; preds = %631, %595
  ...
  %667 = call i8* @hypre_CAlloc(i64 %666, i64 8) #3
...
!13 = !{!4, !8, i64 40}
!14 = !{!15, !8, i64 32}
!15 = !{!"", !8, i64 0, !8, i64 8, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !5, i64 48}
!16 = !{!15, !8, i64 0}
!17 = !{!15, !8, i64 8}
!18 = !{!15, !5, i64 20}
!19 = !{!15, !5, i64 24}

...
define dso_local i32 @hypre_StructVectorClearAllValues(%struct.hypre_StructVector_struct* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %12 = call %struct.hypre_Box_struct* @hypre_BoxCreate(i32 1) #12
  ...
  %15 = call i32 @hypre_BoxSetExtents(%struct.hypre_Box_struct* %12, i32* nonnull %13, i32* nonnull %14) #12
  ...
  %22 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %12, i32* nonnull %13) #12
...
62:                                               ; preds = %51, %45
  ...
  %63 = call i32 @hypre_BoxDestroy(%struct.hypre_Box_struct* %12) #12
...
124:                                              ; preds = %97, %79
  ...
  %126 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %49, i32* nonnull %45) #12
...
170:                                              ; preds = %161, %170
  ...
  %176 = call double %1(i32 %172, i32 %173, i32 %175) #12
...
26:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.7, i64 0, i64 0), i32 1205, i32 1, i8* null) #12
  br label %241
...
75:                                               ; preds = %53, %230
  ...
  %88 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %78, i32* nonnull %34) #12
  %89 = sext i32 %88 to i64
  %90 = getelementptr inbounds double, double* %84, i64 %89
  %91 = load double, double* %90, align 8, !tbaa !33
  %92 = call i32 @hypre_SetIndex(i32* %3, i32 0) #12
  ...
  %93 = load i32, i32* %33, align 4, !tbaa !14
  store i32 %93, i32* %39, align 16, !tbaa !14
  br i1 %40, label %94, label %103
...
95:                                               ; preds = %94, %95
  %96 = phi i64 [ 1, %94 ], [ %101, %95 ]
  %97 = phi i32 [ 1, %94 ], [ %100, %95 ]
  %98 = getelementptr inbounds [3 x i32], [3 x i32]* %6, i64 0, i64 %96
  %99 = load i32, i32* %98, align 4, !tbaa !14
  %100 = mul nsw i32 %99, %97
  %101 = add nuw nsw i64 %96, 1
  %102 = icmp eq i64 %101, %72
  br i1 %102, label %103, label %95, !llvm.loop !117

103:                                              ; preds = %95, %75
  %104 = phi i32 [ 1, %75 ], [ %100, %95 ]
  store i32 2, i32* %42, align 4, !tbaa !14
  %105 = load i32, i32* %28, align 4, !tbaa !14
  store i32 %105, i32* %43, align 4, !tbaa !14
  store i32 0, i32* %44, align 16, !tbaa !14
  %106 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %77, i64 %76, i32 1, i64 0
  %107 = load i32, i32* %106, align 4, !tbaa !14
  %108 = load i32, i32* %86, align 4, !tbaa !14
  %109 = sub nsw i32 %107, %108
  br i1 %45, label %110, label %143

110:                                              ; preds = %103
  %111 = icmp slt i32 %109, 0
  %112 = add nsw i32 %109, 1
  %113 = select i1 %111, i32 0, i32 %112
  %114 = load i32, i32* %13, align 16
  %115 = load i32, i32* %11, align 4
  br label %116

116:                                              ; preds = %110, %116
  %117 = phi i32 [ %115, %110 ], [ %123, %116 ]
  %118 = phi i32 [ %114, %110 ], [ %130, %116 ]
  %119 = phi i64 [ 1, %110 ], [ %141, %116 ]
  %120 = phi i32 [ %113, %110 ], [ %140, %116 ]
  %121 = getelementptr inbounds [3 x i32], [3 x i32]* %7, i64 0, i64 %119
  %122 = load i32, i32* %121, align 4, !tbaa !14
  %123 = mul nsw i32 %122, %120
  %124 = getelementptr inbounds [3 x i32], [3 x i32]* %10, i64 0, i64 %119
  store i32 %123, i32* %124, align 4, !tbaa !14
  %125 = add nsw i64 %119, -1
  %126 = add nsw i32 %118, %123
  %127 = getelementptr inbounds [4 x i32], [4 x i32]* %9, i64 0, i64 %125
  %128 = load i32, i32* %127, align 4, !tbaa !14
  %129 = mul nsw i32 %117, %128
  %130 = sub i32 %126, %129
  %131 = getelementptr inbounds [4 x i32], [4 x i32]* %12, i64 0, i64 %119
  store i32 %130, i32* %131, align 4, !tbaa !14
  %132 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %77, i64 %76, i32 1, i64 %119
  %133 = load i32, i32* %132, align 4, !tbaa !14
  %134 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %77, i64 %76, i32 0, i64 %119
  %135 = load i32, i32* %134, align 4, !tbaa !14
  %136 = sub nsw i32 %133, %135
  %137 = add nsw i32 %136, 1
  %138 = icmp slt i32 %136, 0
  ...
  br i1 %142, label %143, label %116, !llvm.loop !118

143:                                              ; preds = %116, %103
  store i32 0, i32* %46, align 4, !tbaa !14
  %144 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %78, i32* nonnull %34) #12
...
157:                                              ; preds = %151, %157
  ...
  br i1 %167, label %152, label %157, !llvm.loop !119

168:                                              ; preds = %154, %227
  %169 = phi i32 [ %213, %227 ], [ %153, %154 ]
  %170 = phi double [ %179, %227 ], [ %91, %154 ]
  %171 = phi i32 [ %228, %227 ], [ 0, %154 ]
  %172 = phi i32 [ %178, %227 ], [ %88, %154 ]
...
192:                                              ; preds = %191, %189, %181
  ...
  %194 = phi double [ %183, %181 ], [ %187, %189 ], [ %187, %191 ]
  %195 = add i64 %182, %155
  %196 = add nuw nsw i32 %184, 1
  %197 = icmp eq i32 %196, %145
  br i1 %197, label %175, label %181, !llvm.loop !120
...
198:                                              ; preds = %198, %177
  ...
  br i1 %205, label %198, label %207, !llvm.loop !121
...
227:                                              ; preds = %216, %207
  %228 = add nuw nsw i32 %171, 1
  %229 = icmp eq i32 %228, %104
  br i1 %229, label %230, label %168, !llvm.loop !122

230:                                              ; preds = %227, %152, %143
  %231 = phi i32 [ %88, %143 ], [ %88, %152 ], [ %178, %227 ]
  %232 = phi double [ %91, %143 ], [ %91, %152 ], [ %179, %227 ]
  ...
  %236 = sext i32 %235 to i64
  %237 = icmp slt i64 %234, %236
  br i1 %237, label %75, label %238, !llvm.loop !123
...
75:                                               ; preds = %71, %75
  ...
  br i1 %81, label %82, label %75, !llvm.loop !125

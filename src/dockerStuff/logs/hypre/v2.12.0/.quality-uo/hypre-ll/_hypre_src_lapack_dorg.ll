...
define dso_local i32 @hypre_dorgtr(i8* %0, i32* nocapture readonly %1, double* %2, i32* %3, double* %4, double* %5, i32* %6, i32* nocapture %7) local_unnamed_addr #0 {
  ...
  %22 = call i64 @hypre_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #5
  store i64 %22, i64* @hypre_dorgtr.upper, align 8, !tbaa !7
  %23 = icmp eq i64 %22, 0
  br i1 %23, label %24, label %27

24:                                               ; preds = %8
  %25 = call i64 @hypre_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #5
  %26 = icmp eq i64 %25, 0
...
65:                                               ; preds = %62
  ...
  %67 = call i32 @hypre_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0), i32* nonnull %9) #5
  br label %199

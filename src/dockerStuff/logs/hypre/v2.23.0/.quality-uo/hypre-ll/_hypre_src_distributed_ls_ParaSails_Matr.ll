...
define dso_local %struct.Matrix* @MatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  ...
  %10 = call i8* @hypre_MAlloc(i64 152, i32 0) #7
  ...
  %19 = call %struct.Mem* (...) @MemCreate() #7
  ...
  %25 = add nsw i32 %24, 1
  %26 = shl i32 %25, 2
  %27 = call i8* @MemAlloc(%struct.Mem* %19, i32 %26) #7
  ...
  %31 = shl i32 %25, 3
  %32 = call i8* @MemAlloc(%struct.Mem* %30, i32 %31) #7
  ...
  %36 = call i8* @MemAlloc(%struct.Mem* %35, i32 %31) #7
  %37 = getelementptr inbounds i8, i8* %10, i64 56
  %38 = bitcast i8* %37 to i8**
  store i8* %36, i8** %38, align 8, !tbaa !15
  %39 = call i32 @hypre_MPI_Comm_rank(i32 %0, i32* nonnull %6) #7
  %40 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %7) #7
  %41 = load %struct.Mem*, %struct.Mem** %21, align 8, !tbaa !12
  %42 = load i32, i32* %7, align 4, !tbaa !3
  %43 = shl i32 %42, 2
  %44 = call i8* @MemAlloc(%struct.Mem* %41, i32 %43) #7
  ...
  %49 = shl i32 %48, 2
  %50 = call i8* @MemAlloc(%struct.Mem* %47, i32 %49) #7
  ...
  %55 = call i32 @hypre_MPI_Allgather(i8* nonnull %53, i32 1, i32 1275069445, i8* %54, i32 1, i32 1275069445, i32 %0) #7
  %56 = bitcast i32* %5 to i8*
  %57 = load i8*, i8** %52, align 8, !tbaa !17
  %58 = call i32 @hypre_MPI_Allgather(i8* nonnull %56, i32 1, i32 1275069445, i8* %57, i32 1, i32 1275069445, i32 %0) #7
...
define dso_local %struct.Matrix* @MatrixCreateLocal(i32 %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_MAlloc(i64 152, i32 0) #7
  ...
  %10 = call %struct.Mem* (...) @MemCreate() #7
  ...
  %16 = add nsw i32 %15, 1
  %17 = shl i32 %16, 2
  %18 = call i8* @MemAlloc(%struct.Mem* %10, i32 %17) #7
  ...
  %22 = shl i32 %16, 3
  %23 = call i8* @MemAlloc(%struct.Mem* %21, i32 %22) #7
  ...
  %27 = call i8* @MemAlloc(%struct.Mem* %26, i32 %22) #7
...
; Function Attrs: nounwind uwtable
define dso_local void @MatrixDestroy(%struct.Matrix* %0) local_unnamed_addr #0 {
...
12:                                               ; preds = %1, %12
  ...
  %16 = call i32 @hypre_MPI_Request_free(i32* %15) #7
...
26:                                               ; preds = %6, %26
  ...
  %30 = call i32 @hypre_MPI_Request_free(i32* %29) #7
...
39:                                               ; preds = %21, %39
  ...
  %43 = call i32 @hypre_MPI_Request_free(i32* %42) #7
...
48:                                               ; preds = %35, %48
  ...
  %52 = call i32 @hypre_MPI_Request_free(i32* %51) #7
...
57:                                               ; preds = %48, %35
  ...
  store i32* null, i32** %64, align 8, !tbaa !26
  ...
  store i32* null, i32** %67, align 8, !tbaa !28
  ...
  store %struct.MPI_Status* null, %struct.MPI_Status** %70, align 8, !tbaa !30
  ...
  store i32* null, i32** %73, align 8, !tbaa !31
  ...
  store double* null, double** %76, align 8, !tbaa !32
...
87:                                               ; preds = %57
  call void @NumberingDestroy(%struct.numbering* nonnull %85) #7
  br label %88
...
define dso_local void @MatrixSetRow(%struct.Matrix* nocapture readonly %0, i32 %1, i32 %2, i32* %3, double* %4) local_unnamed_addr #0 {
  ...
  %18 = call i8* @MemAlloc(%struct.Mem* %14, i32 %17) #7
  ...
  %26 = call i8* @MemAlloc(%struct.Mem* %23, i32 %25) #7
...
32:                                               ; preds = %5
  ...
  call void @hypre_Memcpy(i8* %36, i8* nonnull %37, i64 %16, i32 0, i32 0) #7
  br label %38
...
40:                                               ; preds = %38
  ...
  call void @hypre_Memcpy(i8* %44, i8* nonnull %45, i64 %24, i32 0, i32 0) #7
  br label %46
...
define dso_local void @MatrixGetRow(%struct.Matrix* nocapture readonly %0, i32 %1, i32* nocapture %2, i32** nocapture %3, double** nocapture %4) local_unnamed_addr #3 {
...
define dso_local i32 @MatrixRowPe(%struct.Matrix* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %11 = call i32 @hypre_MPI_Comm_size(i32 %10, i32* nonnull %3) #7
...
28:                                               ; preds = %25, %2
  %29 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 %1) #7
  %30 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %31 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %30, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %32 = call i32 @fflush(%struct._IO_FILE* null)
  %33 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %36
...
25:                                               ; preds = %17, %1
  ...
  %28 = call i32 @hypre_MPI_Allreduce(i8* nonnull %4, i8* nonnull %5, i32 1, i32 1275069445, i32 1476395011, i32 %27) #7
...
define dso_local void @MatrixPrint(%struct.Matrix* nocapture readonly %0, i8* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %9 = call i32 @hypre_MPI_Comm_rank(i32 %8, i32* nonnull %3) #7
  %10 = load i32, i32* %7, align 8, !tbaa !7
  %11 = call i32 @hypre_MPI_Comm_size(i32 %10, i32* nonnull %4) #7
...
20:                                               ; preds = %2, %74
  ...
  %23 = call i32 @hypre_MPI_Barrier(i32 %22) #7
...
48:                                               ; preds = %45, %48
  ...
  %62 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %29, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i64 0, i64 0), i32 %51, i32 %59, double %61) #7
...
define dso_local void @MatrixRead(%struct.Matrix* %0, i8* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %27 = call i32 @hypre_MPI_Comm_rank(i32 %26, i32* nonnull %23) #7
  %28 = call double @hypre_MPI_Wtime() #7
...
32:                                               ; preds = %2
  ...
  call void @llvm.lifetime.start.p0i8(i64 4000, i8* nonnull %40) #7
  %41 = bitcast [1000 x double]* %19 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8000, i8* nonnull %41) #7
  %42 = getelementptr inbounds [100 x i8], [100 x i8]* %20, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 100, i8* nonnull %42) #7
  %43 = bitcast i32* %21 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %43) #7
  %44 = bitcast %struct.MPI_Status* %22 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %44) #7
  %45 = call i32 @hypre_MPI_Comm_size(i32 %31, i32* nonnull %12) #7
  %46 = load i32, i32* %25, align 8, !tbaa !7
  %47 = call i32 @hypre_MPI_Comm_rank(i32 %46, i32* nonnull %11) #7
  %48 = call %struct._IO_FILE* @fopen(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0)) #7
  %49 = call i8* @fgets(i8* nonnull %42, i32 100, %struct._IO_FILE* %48) #7
  %50 = icmp eq i8* %49, null
  br i1 %50, label %51, label %58

51:                                               ; preds = %32
  %52 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %53 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %52, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.7, i64 0, i64 0)) #7
  %54 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %55 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %54, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %56 = call i32 @fflush(%struct._IO_FILE* null) #7
  %57 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %58

58:                                               ; preds = %51, %32
  %59 = call i32 (i8*, i8*, ...) @hypre_sscanf(i8* nonnull %42, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %13) #7
  %60 = call i64 @ftell(%struct._IO_FILE* %48) #7
  %61 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.12, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #7
...
74:                                               ; preds = %65
  %75 = call i32 @hypre_MPI_Wait(i32* nonnull %21, %struct.MPI_Status* nonnull %22) #7
  store i64 %66, i64* %17, align 8, !tbaa !45
  %76 = call i32 @hypre_MPI_Isend(i8* nonnull %39, i32 1, i32 1275070471, i32 %67, i32 0, i32 %31, i32* nonnull %21) #7
  %77 = add nsw i32 %67, 1
  br label %78

78:                                               ; preds = %74, %65
  %79 = phi i32 [ %77, %74 ], [ %67, %65 ]
  %80 = call i64 @ftell(%struct._IO_FILE* %48) #7
  %81 = load i32, i32* %14, align 4, !tbaa !3
  %82 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.12, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #7
...
85:                                               ; preds = %78
  ...
  %87 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %86, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.13, i64 0, i64 0)) #7
  %88 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %89 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %88, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %90 = call i32 @fflush(%struct._IO_FILE* null) #7
  %91 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %92
...
95:                                               ; preds = %92, %58
  call void @rewind(%struct._IO_FILE* %48) #7
  %96 = call i8* @fgets(i8* nonnull %42, i32 100, %struct._IO_FILE* %48) #7
  %97 = icmp eq i8* %96, null
  br i1 %97, label %98, label %105

98:                                               ; preds = %95
  %99 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %100 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %99, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.7, i64 0, i64 0)) #7
  %101 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %102 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %101, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %103 = call i32 @fflush(%struct._IO_FILE* null) #7
  %104 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %105

105:                                              ; preds = %98, %95
  %106 = call i32 (i8*, i8*, ...) @hypre_sscanf(i8* nonnull %42, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.11, i64 0, i64 0), i32* nonnull %13) #7
  %107 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.12, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #7
...
125:                                              ; preds = %123
  ...
  %135 = call i8* @MemAlloc(%struct.Mem* %131, i32 %134) #7
  ...
  %142 = call i8* @MemAlloc(%struct.Mem* %139, i32 %141) #7
  ...
  call void @hypre_Memcpy(i8* %149, i8* nonnull %40, i64 %133, i32 0, i32 0) #7
  ...
  call void @hypre_Memcpy(i8* %153, i8* nonnull %41, i64 %140, i32 0, i32 0) #7
...
159:                                              ; preds = %155
  ...
  %161 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %160, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.14, i64 0, i64 0), i32 1000) #7
  %162 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %163 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %162, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.15, i64 0, i64 0)) #7
  %164 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %165 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %164, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.16, i64 0, i64 0)) #7
  %166 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %167 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %166, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %168 = call i32 @fflush(%struct._IO_FILE* null) #7
  %169 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %170
...
170:                                              ; preds = %159, %155
  ...
  %177 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.12, i64 0, i64 0), i32* nonnull %14, i32* nonnull %15, double* nonnull %16) #7
...
179:                                              ; preds = %117, %170, %105
  ...
  %191 = call i8* @MemAlloc(%struct.Mem* %187, i32 %190) #7
  ...
  %198 = call i8* @MemAlloc(%struct.Mem* %195, i32 %197) #7
  ...
  call void @hypre_Memcpy(i8* %205, i8* nonnull %40, i64 %189, i32 0, i32 0) #7
  ...
  call void @hypre_Memcpy(i8* %209, i8* nonnull %41, i64 %196, i32 0, i32 0) #7
  %210 = call i32 @fclose(%struct._IO_FILE* %48) #7
  %211 = call i32 @hypre_MPI_Wait(i32* nonnull %21, %struct.MPI_Status* nonnull %22) #7
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %44) #7
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %43) #7
  call void @llvm.lifetime.end.p0i8(i64 100, i8* nonnull %42) #7
  call void @llvm.lifetime.end.p0i8(i64 8000, i8* nonnull %41) #7
  call void @llvm.lifetime.end.p0i8(i64 4000, i8* nonnull %40) #7
...
212:                                              ; preds = %2
  ...
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %213) #7
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %216) #7
  %217 = bitcast double* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %217) #7
  %218 = bitcast i64* %8 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %218) #7
  %219 = bitcast [1000 x i32]* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4000, i8* nonnull %219) #7
  %220 = bitcast [1000 x double]* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8000, i8* nonnull %220) #7
  %221 = call %struct._IO_FILE* @fopen(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0)) #7
  %222 = load i32, i32* %25, align 8, !tbaa !7
  %223 = call i32 @hypre_MPI_Comm_rank(i32 %222, i32* nonnull %4) #7
  %224 = call i32 @hypre_MPI_Recv(i8* nonnull %218, i32 1, i32 1275070471, i32 0, i32 0, i32 %31, %struct.MPI_Status* nonnull %3) #7
  %225 = call double @hypre_MPI_Wtime() #7
  %226 = load i64, i64* %8, align 8, !tbaa !45
  %227 = call i32 @fseek(%struct._IO_FILE* %221, i64 %226, i32 0) #7
  %228 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %221, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.12, i64 0, i64 0), i32* nonnull %5, i32* nonnull %6, double* nonnull %7) #7
...
246:                                              ; preds = %244
  ...
  %256 = call i8* @MemAlloc(%struct.Mem* %252, i32 %255) #7
  ...
  %263 = call i8* @MemAlloc(%struct.Mem* %260, i32 %262) #7
  ...
  call void @hypre_Memcpy(i8* %270, i8* nonnull %219, i64 %254, i32 0, i32 0) #7
  ...
  call void @hypre_Memcpy(i8* %274, i8* nonnull %220, i64 %261, i32 0, i32 0) #7
...
280:                                              ; preds = %276
  ...
  %282 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %281, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.14, i64 0, i64 0), i32 1000) #7
  %283 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %284 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %283, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.15, i64 0, i64 0)) #7
  %285 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %286 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %285, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.16, i64 0, i64 0)) #7
  %287 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %288 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %287, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %289 = call i32 @fflush(%struct._IO_FILE* null) #7
  %290 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %291
...
291:                                              ; preds = %280, %276
  ...
  %298 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %221, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.12, i64 0, i64 0), i32* nonnull %5, i32* nonnull %6, double* nonnull %7) #7
...
300:                                              ; preds = %238, %291, %212
  ...
  %312 = call i8* @MemAlloc(%struct.Mem* %308, i32 %311) #7
  ...
  %319 = call i8* @MemAlloc(%struct.Mem* %316, i32 %318) #7
  ...
  call void @hypre_Memcpy(i8* %326, i8* nonnull %219, i64 %310, i32 0, i32 0) #7
  ...
  call void @hypre_Memcpy(i8* %330, i8* nonnull %220, i64 %317, i32 0, i32 0) #7
  %331 = call i32 @fclose(%struct._IO_FILE* %221) #7
  %332 = call double @hypre_MPI_Wtime() #7
  %333 = load i32, i32* %4, align 4, !tbaa !3
  %334 = fsub double %332, %225
  %335 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.17, i64 0, i64 0), i32 %333, double %334) #7
  call void @llvm.lifetime.end.p0i8(i64 8000, i8* nonnull %220) #7
  call void @llvm.lifetime.end.p0i8(i64 4000, i8* nonnull %219) #7
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %218) #7
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %217) #7
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %216) #7
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %215) #7
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %214) #7
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %213) #7
  br label %336

336:                                              ; preds = %300, %179
  %337 = call double @hypre_MPI_Wtime() #7
  %338 = load i32, i32* %23, align 4, !tbaa !3
  %339 = fsub double %337, %28
  %340 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.5, i64 0, i64 0), i32 %338, double %339) #7
...
define dso_local void @MatrixComplete(%struct.Matrix* %0) local_unnamed_addr #0 {
  ...
  %12 = call i32 @hypre_MPI_Comm_rank(i32 %11, i32* nonnull %6) #7
  %13 = load i32, i32* %10, align 8, !tbaa !7
  %14 = call i32 @hypre_MPI_Comm_size(i32 %13, i32* nonnull %7) #7
  %15 = load i32, i32* %7, align 4, !tbaa !3
  %16 = sext i32 %15 to i64
  %17 = shl nsw i64 %16, 2
  %18 = call i8* @hypre_MAlloc(i64 %17, i32 0) #7
  ...
  %42 = call i8* @hypre_MAlloc(i64 %41, i32 0) #7
  ...
  %46 = sext i32 %45 to i64
  %47 = call i8* @hypre_CAlloc(i64 %46, i64 4, i32 0) #7
  %48 = bitcast i8* %47 to i32*
  %49 = load i32, i32* %7, align 4, !tbaa !3
  %50 = sext i32 %49 to i64
  %51 = call i8* @hypre_CAlloc(i64 %50, i64 4, i32 0) #7
  %52 = bitcast i8* %51 to i32*
  %53 = call %struct.numbering* @NumberingCreate(%struct.Matrix* %0, i32 300000) #7
  ...
  %72 = add nsw i32 %71, 1
  %73 = call i32 @hypre_MPI_Comm_rank(i32 %66, i32* nonnull %4) #7
...
87:                                               ; preds = %113, %85
  ...
  %92 = call i32 @MatrixRowPe(%struct.Matrix* %0, i32 %91) #7
  %93 = sext i32 %92 to i64
  %94 = add nsw i64 %89, 1
  %95 = call i64 @llvm.smax.i64(i64 %94, i64 %86) #7
  %96 = add nsw i64 %95, -1
  br label %97
...
113:                                              ; preds = %108, %101, %97
  ...
  %118 = call i32 @hypre_MPI_Isend(i8* nonnull %116, i32 %117, i32 1275069445, i32 %92, i32 444, i32 %66, i32* nonnull %5) #7
  %119 = call i32 @hypre_MPI_Request_free(i32* nonnull %5) #7
  ...
  %130 = call i32 @hypre_MPI_Recv_init(i8* %125, i32 %117, i32 1275070475, i32 %92, i32 555, i32 %66, i32* %129) #7
  ...
  %138 = call i32 @hypre_MPI_Send_init(i8* %133, i32 %117, i32 1275070475, i32 %92, i32 666, i32 %66, i32* %137) #7
...
142:                                              ; preds = %113, %1
  ...
  %144 = call i32 @hypre_MPI_Alltoall(i8* %47, i32 1, i32 1275069445, i8* %51, i32 1, i32 1275069445, i32 %143) #7
  ...
  %148 = call i32 @hypre_MPI_Comm_rank(i32 %147, i32* nonnull %2) #7
  %149 = call i32 @hypre_MPI_Comm_size(i32 %147, i32* nonnull %3) #7
  %150 = load i32, i32* %3, align 4, !tbaa !3
  %151 = sext i32 %150 to i64
  %152 = shl nsw i64 %151, 2
  %153 = call i8* @hypre_MAlloc(i64 %152, i32 0) #7
  %154 = bitcast i8* %153 to i32*
  %155 = load i32, i32* %3, align 4, !tbaa !3
  %156 = sext i32 %155 to i64
  %157 = mul nsw i64 %156, 20
  %158 = call i8* @hypre_MAlloc(i64 %157, i32 0) #7
...
173:                                              ; preds = %165, %142
  ...
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %176, i8 0, i64 16, i1 false) #7
...
179:                                              ; preds = %173
  ...
  %182 = call i8* @hypre_MAlloc(i64 %181, i32 0) #7
...
199:                                              ; preds = %193
  ...
  %208 = call i32 @hypre_MPI_Irecv(i8* %203, i32 %197, i32 1275069445, i32 %207, i32 444, i32 %147, i32* %206) #7
  ...
  %217 = call i32 @hypre_MPI_Send_init(i8* %211, i32 %212, i32 1275070475, i32 %207, i32 555, i32 %147, i32* %216) #7
  ...
  %226 = call i32 @hypre_MPI_Recv_init(i8* %220, i32 %221, i32 1275070475, i32 %207, i32 666, i32 %147, i32* %225) #7
...
237:                                              ; preds = %231, %189
  ...
  %239 = call i32 @hypre_MPI_Waitall(i32 %238, i32* %154, %struct.MPI_Status* %159) #7
...
260:                                              ; preds = %254, %260
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %268, i32 %264, i32* %267, i32* %267) #7
...
define dso_local void @RhsRead(double* %0, %struct.Matrix* nocapture readonly %1, i8* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %18 = call i32 @hypre_MPI_Comm_size(i32 %17, i32* nonnull %6) #7
  %19 = load i32, i32* %16, align 8, !tbaa !7
  %20 = call i32 @hypre_MPI_Comm_rank(i32 %19, i32* nonnull %5) #7
...
28:                                               ; preds = %3
  ...
  %32 = call i32 @hypre_MPI_Recv(i8* %30, i32 %29, i32 1275070475, i32 0, i32 0, i32 %31, %struct.MPI_Status* nonnull %4) #7
  br label %112
...
37:                                               ; preds = %33
  ...
  %39 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %38, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.7, i64 0, i64 0)) #7
  %40 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !35
  %41 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %40, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #7
  %42 = call i32 @fflush(%struct._IO_FILE* null)
  %43 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #7
  br label %44

44:                                               ; preds = %37, %33
  %45 = call i32 (i8*, i8*, ...) @hypre_sscanf(i8* nonnull %14, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i64 0, i64 0), i32* nonnull %7, i32* nonnull %9) #7
  %46 = icmp eq i32 %45, 1
  %47 = icmp slt i32 %25, 0
...
48:                                               ; preds = %44
  ...
  %52 = select i1 %46, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.10, i64 0, i64 0)
  br label %61

53:                                               ; preds = %61, %44
  %54 = getelementptr inbounds %struct.Matrix, %struct.Matrix* %1, i64 0, i32 4
...
61:                                               ; preds = %48, %61
  %62 = phi i64 [ 0, %48 ], [ %65, %61 ]
  %63 = getelementptr inbounds double, double* %0, i64 %62
  %64 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %34, i8* %52, double* %63) #7
  %65 = add nuw nsw i64 %62, 1
  %66 = icmp eq i64 %65, %51
  br i1 %66, label %53, label %61, !llvm.loop !60

67:                                               ; preds = %59, %100
  %68 = phi i64 [ %105, %100 ], [ 1, %59 ]
  %69 = phi i32 [ %88, %100 ], [ 0, %59 ]
  %70 = phi double* [ %87, %100 ], [ null, %59 ]
  %71 = load i32*, i32** %54, align 8, !tbaa !17
...
94:                                               ; preds = %90, %94
  ...
  %97 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %34, i8* %60, double* %96) #7
...
100:                                              ; preds = %94, %86
  ...
  %104 = call i32 @hypre_MPI_Send(i8* %101, i32 %78, i32 1275070475, i32 %103, i32 0, i32 %102) #7
...
109:                                              ; preds = %100, %53
  %110 = phi double* [ null, %53 ], [ %87, %100 ]
  %111 = bitcast double* %110 to i8*
  call void @hypre_Free(i8* %111, i32 0) #7
  br label %112
...
27:                                               ; preds = %17, %3
  ...
  %32 = call i32 @hypre_MPI_Startall(i32 %29, i32* %31) #7
  ...
  %37 = call i32 @hypre_MPI_Startall(i32 %34, i32* %36) #7
  %38 = icmp slt i32 %5, %7
...
52:                                               ; preds = %45, %27
  ...
  %57 = call i32 @hypre_MPI_Waitall(i32 %53, i32* %54, %struct.MPI_Status* %56) #7
...
103:                                              ; preds = %98, %52
  ...
  %107 = call i32 @hypre_MPI_Waitall(i32 %104, i32* %105, %struct.MPI_Status* %106) #7
  ret void
}
...
define dso_local void @MatrixMatvecTrans(%struct.Matrix* nocapture readonly %0, double* nocapture readonly %1, double* nocapture %2) local_unnamed_addr #0 {
  ...
  %14 = call i32 @hypre_MPI_Startall(i32 %11, i32* %13) #7
...
73:                                               ; preds = %70, %28
  ...
  %78 = call i32 @hypre_MPI_Startall(i32 %75, i32* %77) #7
  %79 = icmp slt i32 %8, 0
...
93:                                               ; preds = %86, %73
  ...
  %98 = call i32 @hypre_MPI_Waitall(i32 %94, i32* %95, %struct.MPI_Status* %97) #7
...
120:                                              ; preds = %108, %93
  ...
  %124 = call i32 @hypre_MPI_Waitall(i32 %121, i32* %122, %struct.MPI_Status* %123) #7
  ret void
}

; Function Attrs: nofree nounwind
declare dso_local noundef i64 @ftell(%struct._IO_FILE* nocapture noundef) local_unnamed_addr #4

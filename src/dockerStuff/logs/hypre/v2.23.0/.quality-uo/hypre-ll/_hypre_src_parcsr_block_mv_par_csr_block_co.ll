...
define dso_local %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 %0, i32 %1, %struct._hypre_ParCSRCommPkg* %2, i8* %3, i8* %4) local_unnamed_addr #0 {
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 1
  %9 = load i32, i32* %8, align 4, !tbaa !3
  %10 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 6
  %11 = load i32, i32* %10, align 8, !tbaa !9
  %12 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 0
...
24:                                               ; preds = %5
  %25 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 3
  %26 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 2
  %27 = icmp sgt i32 %9, 0
...
30:                                               ; preds = %5
  %31 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 7
  %32 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 8
...
38:                                               ; preds = %36, %30
  ...
  %40 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 3
  %41 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 2
  %42 = icmp sgt i32 %9, 0
...
89:                                               ; preds = %87, %24
  ...
  %91 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 7
  %92 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %2, i64 0, i32 8
...
138:                                              ; preds = %116, %65, %89, %38, %5
  %139 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 0) #3
  %140 = bitcast i8* %139 to %struct.hypre_ParCSRCommHandle*
  %141 = bitcast i8* %139 to %struct._hypre_ParCSRCommPkg**
  store %struct._hypre_ParCSRCommPkg* %2, %struct._hypre_ParCSRCommPkg** %141, align 8, !tbaa !22
  ...
  %146 = getelementptr inbounds i8, i8* %139, i64 56
  %147 = bitcast i8* %146 to i32*
  store i32 %18, i32* %147, align 8, !tbaa !26
  %148 = getelementptr inbounds i8, i8* %139, i64 64
...
define dso_local i32 @hypre_ParCSRBlockMatrixCreateAssumedPartition(%struct.hypre_ParCSRBlockMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %13 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 0) #3
  ...
  %24 = call i8* @hypre_MAlloc(i64 40, i32 0) #3
  ...
  %29 = shl nsw i64 %28, 2
  %30 = call i8* @hypre_MAlloc(i64 %29, i32 0) #3
  ...
  %35 = shl nsw i64 %34, 2
  %36 = call i8* @hypre_MAlloc(i64 %35, i32 0) #3
  %37 = getelementptr inbounds i8, i8* %13, i64 32
  %38 = bitcast i8* %37 to i8**
  store i8* %36, i8** %38, align 8, !tbaa !39
  %39 = load i32, i32* %2, align 4, !tbaa !12
  %40 = call i32 @hypre_LocateAssumedPartition(i32 %7, i32 %9, i32 %11, i32 0, i32 %5, %struct.hypre_IJAssumedPart* %14, i32 %39) #3
  %41 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 20
...
define dso_local i32 @hypre_ParCSRBlockMatrixDestroyAssumedPartition(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 20
...
7:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %13, i32 0) #3
  ...
  call void @hypre_Free(i8* %16, i32 0) #3
...
20:                                               ; preds = %7, %1
  ...
  call void @hypre_Free(i8* %21, i32 0) #3
  ret i32 0
}
...
!22 = !{!23, !8, i64 0}
!23 = !{!"", !8, i64 0, !6, i64 8, !6, i64 12, !5, i64 16, !5, i64 20, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64}
!24 = !{!23, !8, i64 24}
!25 = !{!23, !8, i64 32}
!26 = !{!23, !5, i64 56}
!27 = !{!23, !8, i64 64}
!28 = !{!29, !5, i64 8}
!29 = !{!"", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !6, i64 56, !6, i64 64, !8, i64 72, !8, i64 80, !5, i64 88, !5, i64 92, !30, i64 96, !8, i64 104, !8, i64 112, !5, i64 120, !8, i64 128}
!30 = !{!"double", !6, i64 0}
!31 = !{!29, !5, i64 0}
!32 = !{!29, !5, i64 16}
!33 = !{!29, !5, i64 24}

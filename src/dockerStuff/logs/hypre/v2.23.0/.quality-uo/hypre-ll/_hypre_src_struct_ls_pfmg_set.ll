...
111:                                              ; preds = %109, %111
  %112 = phi i64 [ %114, %111 ], [ 0, %109 ]
  %113 = getelementptr inbounds [3 x double], [3 x double]* %5, i64 0, i64 %112
  store double 1.000000e+00, double* %113, align 8, !tbaa !24
  %114 = add nuw nsw i64 %112, 1
  %115 = icmp eq i64 %114, 3
  br i1 %115, label %116, label %111, !llvm.loop !80

116:                                              ; preds = %111, %109
  %117 = phi double [ %106, %109 ], [ 1.000000e+00, %111 ]
  %118 = fdiv double %117, 0x7F50624DD2F1A9FB
  br label %119

119:                                              ; preds = %116, %128
  %120 = phi i64 [ 0, %116 ], [ %131, %128 ]
  %121 = getelementptr inbounds [3 x double], [3 x double]* %5, i64 0, i64 %120
  %122 = load double, double* %121, align 8, !tbaa !24
  %123 = fcmp ogt double %122, %118
  br i1 %123, label %124, label %128

124:                                              ; preds = %119
  %125 = fdiv double %122, %117
  store double %125, double* %121, align 8, !tbaa !24
  %126 = fdiv double 1.000000e+00, %125
  %127 = call double @sqrt(double %126) #8
  br label %128

128:                                              ; preds = %119, %124
  %129 = phi double [ %127, %124 ], [ 0x5FA030DC4EA03A72, %119 ]
  %130 = getelementptr inbounds double, double* %1, i64 %120
  store double %129, double* %130, align 8, !tbaa !24
  %131 = add nuw nsw i64 %120, 1
  %132 = icmp eq i64 %131, 3
  br i1 %132, label %133, label %119, !llvm.loop !81

133:                                              ; preds = %128
  %134 = load i32, i32* @hypre__global_error, align 4, !tbaa !3
...
47:                                               ; preds = %40, %219
  ...
  %50 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %27, align 8, !tbaa !82
  ...
  %53 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %28, align 8, !tbaa !83
  %54 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %53, i64 0, i32 0
  %55 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %54, align 8, !tbaa !82
...
75:                                               ; preds = %70, %75
  ...
  br i1 %82, label %83, label %75, !llvm.loop !84
...
101:                                              ; preds = %94, %101
  ...
  br i1 %127, label %128, label %101, !llvm.loop !85
...
151:                                              ; preds = %144, %151
  ...
  br i1 %161, label %146, label %151, !llvm.loop !86
...
173:                                              ; preds = %166, %173
  ...
  br i1 %184, label %168, label %173, !llvm.loop !87
...
214:                                              ; preds = %203, %194
  ...
  br i1 %216, label %217, label %162, !llvm.loop !89
...
219:                                              ; preds = %60, %217
  ...
  br i1 %225, label %47, label %226, !llvm.loop !90
...
define dso_local i32 @hypre_PFMGComputeDxyz_CS(i32 %0, %struct.hypre_StructMatrix_struct* nocapture readonly %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #2 {
  ...
  %10 = load [3 x i32]*, [3 x i32]** %9, align 8, !tbaa !91
...
31:                                               ; preds = %18, %23, %27
  ...
  br i1 %33, label %34, label %18, !llvm.loop !92
...
34:                                               ; preds = %31, %27, %4
  ...
  %42 = load double**, double*** %41, align 8, !tbaa !93
  ...
  %47 = load i32**, i32*** %46, align 8, !tbaa !94
...
64:                                               ; preds = %59
  %65 = load double**, double*** %41, align 8, !tbaa !93
  %66 = load i32**, i32*** %46, align 8, !tbaa !94
...
106:                                              ; preds = %97, %102
  ...
  br i1 %109, label %110, label %70, !llvm.loop !95
...
define dso_local i32 @hypre_PFMGComputeDxyz_SS5(i32 %0, %struct.hypre_StructMatrix_struct* %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #2 {
  ...
  %25 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %24, align 8, !tbaa !82
  ...
  %29 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %28, align 8, !tbaa !83
  %30 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %29, i64 0, i32 0
  %31 = load %struct.hypre_Box_struct*, %struct.hypre_Box_struct** %30, align 8, !tbaa !82
...
69:                                               ; preds = %60, %69
  ...
  br i1 %76, label %77, label %69, !llvm.loop !96
...
97:                                               ; preds = %90, %97
  ...
  br i1 %123, label %124, label %97, !llvm.loop !97
...
148:                                              ; preds = %144, %148
  ...
  br i1 %158, label %146, label %148, !llvm.loop !98
...
176:                                              ; preds = %166, %176
  ...
  br i1 %208, label %168, label %176, !llvm.loop !99
...
209:                                              ; preds = %209, %170
  ...
  br i1 %216, label %209, label %218, !llvm.loop !100
...
238:                                              ; preds = %227, %218
  ...
  br i1 %240, label %241, label %159, !llvm.loop !101
...
73:                                               ; preds = %64, %73
  ...
  br i1 %80, label %81, label %73, !llvm.loop !102
...
101:                                              ; preds = %94, %101
  ...
  %126 = add nuw nsw i64 %104, 1
  %127 = icmp eq i64 %126, %98
  br i1 %127, label %128, label %101, !llvm.loop !103
...
152:                                              ; preds = %148, %152
  ...
  br i1 %162, label %150, label %152, !llvm.loop !104
...
180:                                              ; preds = %170, %180
  ...
  br i1 %228, label %172, label %180, !llvm.loop !105
...
229:                                              ; preds = %229, %174
  ...
  br i1 %236, label %229, label %238, !llvm.loop !106
...
258:                                              ; preds = %247, %238
  ...
  br i1 %260, label %261, label %163, !llvm.loop !107
...
75:                                               ; preds = %66, %75
  ...
  %81 = add nuw nsw i64 %76, 1
  %82 = icmp eq i64 %81, %74
  br i1 %82, label %83, label %75, !llvm.loop !108
...
103:                                              ; preds = %96, %103
  ...
  br i1 %129, label %130, label %103, !llvm.loop !109
...
154:                                              ; preds = %150, %154
  ...
  br i1 %164, label %152, label %154, !llvm.loop !110
...
186:                                              ; preds = %174, %186
  ...
  br i1 %229, label %176, label %186, !llvm.loop !111
...
230:                                              ; preds = %230, %178
  ...
  br i1 %237, label %230, label %239, !llvm.loop !112
...
259:                                              ; preds = %248, %239
  ...
  br i1 %261, label %262, label %165, !llvm.loop !113
...
87:                                               ; preds = %78, %87
  ...
  br i1 %94, label %95, label %87, !llvm.loop !114
...
115:                                              ; preds = %108, %115
  ...
  br i1 %141, label %142, label %115, !llvm.loop !115
...
166:                                              ; preds = %162, %166
  ...
  br i1 %176, label %164, label %166, !llvm.loop !116
...
198:                                              ; preds = %186, %198
  ...
  br i1 %289, label %188, label %198, !llvm.loop !117
...
290:                                              ; preds = %290, %190
  ...
  br i1 %297, label %290, label %299, !llvm.loop !118
...
319:                                              ; preds = %308, %299
  ...
  br i1 %321, label %322, label %177, !llvm.loop !119
...
95:                                               ; preds = %86, %95
  ...
  br i1 %102, label %103, label %95, !llvm.loop !120
...
174:                                              ; preds = %170, %174
  ...
  br i1 %184, label %172, label %174, !llvm.loop !122
...
206:                                              ; preds = %194, %206
  ...
  br i1 %326, label %196, label %206, !llvm.loop !123
...
327:                                              ; preds = %327, %198
  ...
  br i1 %334, label %327, label %336, !llvm.loop !124
...
356:                                              ; preds = %345, %336
  ...
  br i1 %358, label %359, label %185, !llvm.loop !125

...
define dso_local void @hypre_errexit(i8* nocapture readonly %0, ...) local_unnamed_addr #0 {
  ...
  %8 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #8
...
define dso_local void @hypre_my_abort(i32 %0, %struct.hypre_PilutSolverGlobals* nocapture readonly %1) local_unnamed_addr #6 {
  ...
  %5 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 %4, i32 %0) #8
  ...
  %10 = call i32 @hypre_MPI_Abort(i32 %9, i32 %0) #8
  ret void
}
...
; Function Attrs: nounwind uwtable
define dso_local i32* @hypre_idx_malloc(i32 %0, i8* %1) local_unnamed_addr #6 {
  %3 = icmp eq i32 %0, 0
...
4:                                                ; preds = %2
  %5 = sext i32 %0 to i64
  %6 = shl nsw i64 %5, 2
  %7 = call i8* @hypre_MAlloc(i64 %6, i32 0) #8
...
; Function Attrs: nounwind uwtable
define dso_local i32* @hypre_idx_malloc_init(i32 %0, i32 %1, i8* %2) local_unnamed_addr #6 {
  %4 = icmp eq i32 %0, 0
...
; Function Attrs: nounwind uwtable
define dso_local double* @hypre_fp_malloc(i32 %0, i8* %1) local_unnamed_addr #6 {
  %3 = icmp eq i32 %0, 0
  br i1 %3, label %11, label %4
...
; Function Attrs: nounwind uwtable
define dso_local double* @hypre_fp_malloc_init(i32 %0, double %1, i8* %2) local_unnamed_addr #6 {
  %4 = icmp eq i32 %0, 0
  br i1 %4, label %21, label %5
...
; Function Attrs: nounwind uwtable
define dso_local i8* @hypre_mymalloc(i32 %0, i8* %1) local_unnamed_addr #6 {
  %3 = icmp eq i32 %0, 0
  br i1 %3, label %9, label %4

4:                                                ; preds = %2
  %5 = sext i32 %0 to i64
  %6 = call i8* @hypre_MAlloc(i64 %5, i32 0) #8
  %7 = icmp eq i8* %6, null
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_memcpy_int(i32* %0, i32* %1, i64 %2) local_unnamed_addr #6 {
...
5:                                                ; preds = %3
  ...
  %8 = shl i64 %2, 2
  call void @hypre_Memcpy(i8* nonnull %6, i8* %7, i64 %8, i32 0, i32 0) #8
  br label %9
...
declare dso_local void @hypre_Memcpy(i8*, i8*, i64, i32, i32) local_unnamed_addr #4

; Function Attrs: nounwind uwtable
define dso_local void @hypre_memcpy_idx(i32* %0, i32* %1, i64 %2) local_unnamed_addr #6 {
  %4 = icmp eq i32* %0, null
  br i1 %4, label %9, label %5
...
define dso_local void @hypre_memcpy_fp(double* nocapture %0, double* nocapture readonly %1, i64 %2) local_unnamed_addr #7 {
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !9, i64 4}
!8 = !{!"", !9, i64 0, !9, i64 4, !9, i64 8, !10, i64 16, !9, i64 24, !4, i64 32, !4, i64 40, !9, i64 48, !4, i64 56, !9, i64 64, !4, i64 72, !9, i64 80, !9, i64 84, !10, i64 88, !10, i64 96, !9, i64 104, !9, i64 108, !9, i64 112, !9, i64 116, !9, i64 120, !9, i64 124, !4, i64 128, !4, i64 136, !9, i64 144, !5, i64 148, !5, i64 1172, !5, i64 2196}
!9 = !{!"int", !5, i64 0}
!10 = !{!"double", !5, i64 0}
!11 = !{!8, !9, i64 0}
!12 = !{!9, !9, i64 0}

...
define dso_local i32 @hypre_SchwarzSetup(i8* nocapture %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readnone %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #0 {
  ...
  %37 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 14, i64 0
  %38 = call %struct.hypre_ParVector_struct* @hypre_ParVectorCreate(i32 %34, i32 %36, i32* nonnull %37) #6
  %39 = call i32 @hypre_ParVectorInitialize(%struct.hypre_ParVector_struct* %38) #6
  %40 = getelementptr inbounds i8, i8* %0, i64 48
  %41 = bitcast i8* %40 to %struct.hypre_ParVector_struct**
  store %struct.hypre_ParVector_struct* %38, %struct.hypre_ParVector_struct** %41, align 8, !tbaa !20
  %42 = icmp sgt i32 %14, 1
  br i1 %42, label %43, label %71

43:                                               ; preds = %4
  %44 = call i32 @hypre_ParAMGCreateDomainDof(%struct.hypre_ParCSRMatrix_struct* %1, i32 %17, i32 %20, i32 %23, i32* %32, %struct.hypre_CSRMatrix** nonnull %6, i32** nonnull %8, i32 %29) #6
  %45 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %6, align 8, !tbaa !22
  %46 = icmp eq %struct.hypre_CSRMatrix* %45, null
...
49:                                               ; preds = %47
  %50 = call i32 @hypre_ParGenerateScale(%struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_CSRMatrix* nonnull %45, double %26, double** nonnull %5) #6
...
54:                                               ; preds = %47
  %55 = call i32 @hypre_ParGenerateHybridScale(%struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_CSRMatrix* nonnull %45, %struct.hypre_CSRMatrix** nonnull %7, double** nonnull %5) #6
  ...
  %59 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 9
  %60 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %59, align 8, !tbaa !26
  %61 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %60, i64 0, i32 4
...
71:                                               ; preds = %4
  ...
  %73 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %72, align 8, !tbaa !29
  ...
  %75 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %6, align 8, !tbaa !22
  %76 = icmp ne %struct.hypre_CSRMatrix* %75, null
  %77 = icmp eq i32 %14, 1
  %78 = select i1 %76, i1 %77, i1 false
  br i1 %78, label %79, label %87

79:                                               ; preds = %71
  %80 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %72, align 8, !tbaa !29
  %81 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %80, i64 0, i32 3
  %82 = load i32, i32* %81, align 8, !tbaa !30
  %83 = call i32 @hypre_GenerateScale(%struct.hypre_CSRMatrix* nonnull %75, i32 %82, double %26, double** nonnull %5) #6
  %84 = load double*, double** %5, align 8, !tbaa !22
  %85 = getelementptr inbounds i8, i8* %0, i64 56
  %86 = bitcast i8* %85 to double**
  store double* %84, double** %86, align 8, !tbaa !16
  br label %87

87:                                               ; preds = %71, %79, %43, %64, %68, %49
  %88 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %6, align 8, !tbaa !22
  %89 = getelementptr inbounds i8, i8* %0, i64 32
  %90 = bitcast i8* %89 to %struct.hypre_CSRMatrix**
  store %struct.hypre_CSRMatrix* %88, %struct.hypre_CSRMatrix** %90, align 8, !tbaa !18
  %91 = load i32*, i32** %8, align 8, !tbaa !22
  %92 = getelementptr inbounds i8, i8* %0, i64 72
  %93 = bitcast i8* %92 to i32**
  store i32* %91, i32** %93, align 8, !tbaa !21
  %94 = load i32, i32* @hypre__global_error, align 4, !tbaa !15
...
36:                                               ; preds = %27
  ...
  %38 = load %struct.hypre_Vector*, %struct.hypre_Vector** %37, align 8, !tbaa !31
  %39 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %16, i64 0, i32 6
  %40 = load %struct.hypre_Vector*, %struct.hypre_Vector** %39, align 8, !tbaa !31
...
42:                                               ; preds = %27
  ...
  %44 = load %struct.hypre_Vector*, %struct.hypre_Vector** %43, align 8, !tbaa !31
...
29:                                               ; preds = %6
  ...
  %31 = load %struct.hypre_Vector*, %struct.hypre_Vector** %30, align 8, !tbaa !31
  %32 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %12, i64 0, i32 6
  %33 = load %struct.hypre_Vector*, %struct.hypre_Vector** %32, align 8, !tbaa !31
...
35:                                               ; preds = %6
  ...
  %37 = load %struct.hypre_Vector*, %struct.hypre_Vector** %36, align 8, !tbaa !31
  %38 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %12, i64 0, i32 6
  %39 = load %struct.hypre_Vector*, %struct.hypre_Vector** %38, align 8, !tbaa !31
...
10:                                               ; preds = %8, %10
  ...
  %14 = fmul double %13, %2
  store double %14, double* %12, align 8, !tbaa !33
  %15 = add nuw nsw i64 %11, 1
  %16 = icmp eq i64 %15, %9
  br i1 %16, label %17, label %10, !llvm.loop !34
...
!22 = !{!9, !9, i64 0}
!23 = !{!24, !5, i64 0}
!24 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !9, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !9, i64 72, !6, i64 80, !6, i64 88, !9, i64 96, !9, i64 104, !5, i64 112, !5, i64 116, !8, i64 120, !9, i64 128, !9, i64 136, !5, i64 144, !9, i64 152, !5, i64 160, !9, i64 168, !5, i64 176, !9, i64 184, !9, i64 192}
!25 = !{!24, !5, i64 4}
!26 = !{!24, !9, i64 40}
!27 = !{!28, !5, i64 28}
!28 = !{!"", !9, i64 0, !9, i64 8, !9, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !9, i64 40, !9, i64 48, !5, i64 56, !9, i64 64, !9, i64 72, !5, i64 80, !6, i64 84}
!29 = !{!24, !9, i64 32}
!30 = !{!28, !5, i64 24}
!31 = !{!32, !9, i64 32}
!32 = !{!"hypre_ParVector_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 24, !9, i64 32, !5, i64 40, !9, i64 48}
!33 = !{!8, !8, i64 0}

...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRBlockMatrixConvertToParCSRMatrix(%struct.hypre_ParCSRBlockMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %8 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %7, align 8, !tbaa !12
  ...
  %15 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %8, i64 0, i32 6
  %16 = load i32, i32* %15, align 8, !tbaa !26
  %17 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %6, i64 0, i32 7
  ...
  %22 = call i32 @hypre_MPI_Comm_size(i32 %4, i32* nonnull %2) #6
  %23 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
  %24 = bitcast i8* %23 to i32*
  %25 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
...
27:                                               ; preds = %1, %27
  ...
  %36 = getelementptr inbounds i32, i32* %26, i64 %28
...
39:                                               ; preds = %27
  ...
  %45 = mul i32 %10, %10
  %46 = mul i32 %45, %20
  %47 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %4, i32 %40, i32 %41, i32* %24, i32* %26, i32 %42, i32 %44, i32 %46) #6
  %48 = call i32 @hypre_ParCSRMatrixInitialize(%struct.hypre_ParCSRMatrix_struct* %47) #6
  call void @hypre_Free(i8* %23, i32 0) #6
  call void @hypre_Free(i8* %25, i32 0) #6
  %49 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %47, i64 0, i32 8
  %50 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %49, align 8, !tbaa !33
  %51 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %50) #6
  %52 = call %struct.hypre_CSRMatrix* @hypre_CSRBlockMatrixConvertToCSRMatrix(%struct.hypre_CSRBlockMatrix* %6) #6
  store %struct.hypre_CSRMatrix* %52, %struct.hypre_CSRMatrix** %49, align 8, !tbaa !33
  %53 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixDeleteZeros(%struct.hypre_CSRMatrix* %52, double 0x3D06849B86A12B9B) #6
  %54 = icmp eq %struct.hypre_CSRMatrix* %53, null
  br i1 %54, label %58, label %55

55:                                               ; preds = %39
  %56 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %49, align 8, !tbaa !33
  %57 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %56) #6
  store %struct.hypre_CSRMatrix* %53, %struct.hypre_CSRMatrix** %49, align 8, !tbaa !33
  br label %58

58:                                               ; preds = %55, %39
  %59 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %47, i64 0, i32 9
  %60 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %59, align 8, !tbaa !35
  %61 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %60) #6
  %62 = call %struct.hypre_CSRMatrix* @hypre_CSRBlockMatrixConvertToCSRMatrix(%struct.hypre_CSRBlockMatrix* %8) #6
  store %struct.hypre_CSRMatrix* %62, %struct.hypre_CSRMatrix** %59, align 8, !tbaa !35
  %63 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixDeleteZeros(%struct.hypre_CSRMatrix* %62, double 0x3D06849B86A12B9B) #6
  %64 = icmp eq %struct.hypre_CSRMatrix* %63, null
  br i1 %64, label %68, label %65

65:                                               ; preds = %58
  %66 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %59, align 8, !tbaa !35
  %67 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %66) #6
  store %struct.hypre_CSRMatrix* %63, %struct.hypre_CSRMatrix** %59, align 8, !tbaa !35
  br label %68

68:                                               ; preds = %65, %58
  %69 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %0, i64 0, i32 9
  %70 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %47, i64 0, i32 12
...
76:                                               ; preds = %73, %95
  %77 = phi i64 [ 0, %73 ], [ %96, %95 ]
  br i1 %71, label %78, label %95

78:                                               ; preds = %76
  %79 = trunc i64 %77 to i32
  %80 = mul nsw i32 %10, %79
  %81 = load i32*, i32** %69, align 8, !tbaa !21
  %82 = getelementptr inbounds i32, i32* %81, i64 %77
  %83 = load i32*, i32** %70, align 8, !tbaa !36
  %84 = sext i32 %80 to i64
  br label %85

85:                                               ; preds = %78, %85
  %86 = phi i64 [ 0, %78 ], [ %93, %85 ]
  %87 = load i32, i32* %82, align 4, !tbaa !3
...
95:                                               ; preds = %85, %76
  ...
  br i1 %97, label %98, label %76, !llvm.loop !42

98:                                               ; preds = %95, %68
  br i1 %64, label %187, label %99

99:                                               ; preds = %98
  %100 = sext i32 %42 to i64
  %101 = call i8* @hypre_CAlloc(i64 %100, i64 4, i32 0) #6
  %102 = bitcast i8* %101 to i32*
  %103 = call i8* @hypre_CAlloc(i64 %100, i64 4, i32 0) #6
  %104 = bitcast i8* %103 to i32*
  %105 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %59, align 8, !tbaa !35
  %106 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %105, i64 0, i32 1
  %107 = load i32*, i32** %106, align 8, !tbaa !43
  %108 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %47, i64 0, i32 12
  %109 = load i32*, i32** %108, align 8, !tbaa !36
  %110 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %105, i64 0, i32 5
  %111 = load i32, i32* %110, align 8, !tbaa !45
...
120:                                              ; preds = %113, %120
  %121 = phi i64 [ 0, %113 ], [ %126, %120 ]
  %122 = getelementptr inbounds i32, i32* %107, i64 %121
  %123 = load i32, i32* %122, align 4, !tbaa !3
  %124 = sext i32 %123 to i64
  %125 = getelementptr inbounds i32, i32* %102, i64 %124
  store i32 1, i32* %125, align 4, !tbaa !3
  %126 = add nuw nsw i64 %121, 1
  %127 = icmp eq i64 %126, %114
  br i1 %127, label %115, label %120, !llvm.loop !46

128:                                              ; preds = %117, %137
  %129 = phi i64 [ 0, %117 ], [ %139, %137 ]
  %130 = phi i32 [ 0, %117 ], [ %138, %137 ]
  %131 = getelementptr inbounds i32, i32* %102, i64 %129
...
134:                                              ; preds = %128
  ...
  %136 = getelementptr inbounds i32, i32* %104, i64 %129
  store i32 %130, i32* %136, align 4, !tbaa !3
  br label %137
...
137:                                              ; preds = %128, %134
  ...
  br i1 %140, label %141, label %128, !llvm.loop !47

141:                                              ; preds = %137, %115
  %142 = phi i32 [ 0, %115 ], [ %138, %137 ]
  %143 = icmp eq i32 %142, %42
  br i1 %143, label %186, label %144

144:                                              ; preds = %141
  %145 = icmp sgt i32 %111, 0
...
148:                                              ; preds = %146, %148
  %149 = phi i64 [ 0, %146 ], [ %155, %148 ]
  %150 = getelementptr inbounds i32, i32* %107, i64 %149
  %151 = load i32, i32* %150, align 4, !tbaa !3
  %152 = sext i32 %151 to i64
  %153 = getelementptr inbounds i32, i32* %104, i64 %152
  %154 = load i32, i32* %153, align 4, !tbaa !3
  store i32 %154, i32* %150, align 4, !tbaa !3
  %155 = add nuw nsw i64 %149, 1
  %156 = icmp eq i64 %155, %147
  br i1 %156, label %157, label %148, !llvm.loop !48

157:                                              ; preds = %148, %144
  %158 = sext i32 %142 to i64
  %159 = call i8* @hypre_CAlloc(i64 %158, i64 4, i32 0) #6
...
165:                                              ; preds = %162, %177
  %166 = phi i64 [ 0, %162 ], [ %179, %177 ]
  %167 = phi i32 [ 0, %162 ], [ %178, %177 ]
  %168 = getelementptr inbounds i32, i32* %102, i64 %166
  %169 = load i32, i32* %168, align 4, !tbaa !3
  %170 = icmp eq i32 %169, 0
  br i1 %170, label %177, label %171

171:                                              ; preds = %165
  %172 = getelementptr inbounds i32, i32* %109, i64 %166
  %173 = load i32, i32* %172, align 4, !tbaa !3
  %174 = add nsw i32 %167, 1
  %175 = sext i32 %167 to i64
  %176 = getelementptr inbounds i32, i32* %160, i64 %175
  store i32 %173, i32* %176, align 4, !tbaa !3
  br label %177

177:                                              ; preds = %165, %171
  %178 = phi i32 [ %174, %171 ], [ %167, %165 ]
  %179 = add nuw nsw i64 %166, 1
  %180 = icmp eq i64 %179, %164
  br i1 %180, label %181, label %165, !llvm.loop !49

181:                                              ; preds = %177, %157
  %182 = bitcast i32* %109 to i8*
  call void @hypre_Free(i8* %182, i32 0) #6
  %183 = bitcast i32** %108 to i8**
  store i8* %159, i8** %183, align 8, !tbaa !36
  %184 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %59, align 8, !tbaa !35
  %185 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %184, i64 0, i32 4
  store i32 %142, i32* %185, align 4, !tbaa !50
  br label %186
...
187:                                              ; preds = %186, %98
  %188 = call i32 @hypre_ParCSRMatrixSetNumNonzeros(%struct.hypre_ParCSRMatrix_struct* %47) #6
  %189 = call i32 @hypre_ParCSRMatrixSetDNumNonzeros(%struct.hypre_ParCSRMatrix_struct* %47) #6
  %190 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %47, i64 0, i32 16
  store %struct._hypre_ParCSRCommPkg* null, %struct._hypre_ParCSRCommPkg** %190, align 8, !tbaa !51
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %21) #6
  ret %struct.hypre_ParCSRMatrix_struct* %47
}
...
define dso_local %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixConvertFromParCSRMatrix(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %7 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %6, align 8, !tbaa !33
  %8 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 9
  %9 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %8, align 8, !tbaa !35
  ...
  %16 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %9, i64 0, i32 0
  %17 = load i32*, i32** %16, align 8, !tbaa !55
  %18 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %9, i64 0, i32 1
  %19 = load i32*, i32** %18, align 8, !tbaa !43
  %20 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %9, i64 0, i32 9
  %21 = load double*, double** %20, align 8, !tbaa !56
  %22 = bitcast i32* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %22) #6
  %23 = call i32 @hypre_MPI_Comm_size(i32 %5, i32* nonnull %3) #6
  %24 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
  %25 = bitcast i8* %24 to i32*
  %26 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #6
...
28:                                               ; preds = %2, %28
  ...
  %31 = load i32, i32* %30, align 4, !tbaa !3
  %32 = sdiv i32 %31, %1
  %33 = getelementptr inbounds i32, i32* %25, i64 %29
...
40:                                               ; preds = %28
  %41 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %9, i64 0, i32 4
  %42 = call %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixConvertFromCSRMatrix(%struct.hypre_CSRMatrix* %7, i32 %1) #6
...
52:                                               ; preds = %40
  ...
  %56 = load i32, i32* %15, align 4, !tbaa !3
  %57 = sdiv i32 %56, %1
...
137:                                              ; preds = %135, %152
  ...
  %140 = getelementptr inbounds i32, i32* %19, i64 %138
...
223:                                              ; preds = %219, %264
  ...
  %226 = getelementptr inbounds i32, i32* %19, i64 %224
...
235:                                              ; preds = %223
  ...
  %247 = getelementptr inbounds double, double* %21, i64 %224
...
252:                                              ; preds = %223
  ...
  %254 = add i32 %253, %221
  %255 = mul i32 %254, %1
  %256 = getelementptr inbounds i32, i32* %15, i64 %228
  %257 = load i32, i32* %256, align 4, !tbaa !3
  %258 = srem i32 %257, %1
  %259 = add nsw i32 %258, %255
  %260 = getelementptr inbounds double, double* %21, i64 %224
...
278:                                              ; preds = %274, %198, %170
  %279 = sdiv i32 %11, %1
  %280 = sdiv i32 %13, %1
  %281 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %42, i64 0, i32 7
  %282 = load i32, i32* %281, align 4, !tbaa !32
  %283 = call %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixCreate(i32 %5, i32 %1, i32 %279, i32 %280, i32* %25, i32* %27, i32 %172, i32 %282, i32 %171)
  %284 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %283, i64 0, i32 7
  %285 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %284, align 8, !tbaa !11
  %286 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %285) #6
  store %struct.hypre_CSRBlockMatrix* %42, %struct.hypre_CSRBlockMatrix** %284, align 8, !tbaa !11
  %287 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %283, i64 0, i32 8
  %288 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %287, align 8, !tbaa !12
  %289 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %288) #6
  store %struct.hypre_CSRBlockMatrix* %178, %struct.hypre_CSRBlockMatrix** %287, align 8, !tbaa !12
  %290 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %283, i64 0, i32 9
  store i32* %173, i32** %290, align 8, !tbaa !21
  %291 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %283, i64 0, i32 12
  store %struct._hypre_ParCSRCommPkg* null, %struct._hypre_ParCSRCommPkg** %291, align 8, !tbaa !24
  call void @hypre_Free(i8* %176, i32 0) #6
  %292 = bitcast i32* %174 to i8*
  call void @hypre_Free(i8* %292, i32 0) #6
  %293 = bitcast i32* %175 to i8*
  call void @hypre_Free(i8* %293, i32 0) #6
  call void @hypre_Free(i8* %24, i32 0) #6
  call void @hypre_Free(i8* %26, i32 0) #6
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %22) #6
  ret %struct.hypre_ParCSRBlockMatrix* %283
}

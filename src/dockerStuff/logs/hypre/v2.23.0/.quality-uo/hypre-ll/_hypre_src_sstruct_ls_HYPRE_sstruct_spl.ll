...
define dso_local i32 @HYPRE_SStructSplitCreate(i32 %0, %struct.hypre_SStructSolver_struct** nocapture %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_MAlloc(i64 104, i32 0) #6
...
69:                                               ; preds = %50, %22
  ...
  call void @hypre_Free(i8* %72, i32 0) #6
...
84:                                               ; preds = %69, %3
  ...
  call void @hypre_Free(i8* %88, i32 0) #6
  ...
  call void @hypre_Free(i8* nonnull %93, i32 0) #6
  br label %94
...
define dso_local i32 @HYPRE_SStructSplitSetup(%struct.hypre_SStructSolver_struct* %0, %struct.hypre_SStructMatrix_struct* %1, %struct.hypre_SStructVector_struct* nocapture readonly %2, %struct.hypre_SStructVector_struct* %3) local_unnamed_addr #0 {
  ...
  %29 = call i8* @hypre_MAlloc(i64 %26, i32 0) #6
  %30 = bitcast i8* %29 to i32 (...)***
  %31 = call i8* @hypre_MAlloc(i64 %26, i32 0) #6
  %32 = bitcast i8* %31 to i32 (...)***
  %33 = call i8* @hypre_MAlloc(i64 %26, i32 0) #6
...
46:                                               ; preds = %44, %224
  ...
  %69 = shl nsw i64 %68, 3
  %70 = call i8* @hypre_MAlloc(i64 %69, i32 0) #6
...
147:                                              ; preds = %135
  call void @hypre_error_handler(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str, i64 0, i64 0), i32 231, i32 1, i8* null) #6
  br label %148
...
161:                                              ; preds = %142, %161
  ...
  %181 = call i32 %166(i8* %169, %struct.hypre_StructMatrix_struct* %174, %struct.hypre_StructVector_struct* %180, %struct.hypre_StructVector_struct* %177) #6
...
!32 = !{!31, !5, i64 8}
!33 = !{!34, !8, i64 24}
!34 = !{!"hypre_SStructMatrix_struct", !8, i64 0, !8, i64 4, !5, i64 8, !5, i64 16, !8, i64 24, !5, i64 32, !5, i64 40, !5, i64 48, !5, i64 56, !8, i64 64, !5, i64 72, !5, i64 80, !8, i64 88, !5, i64 96, !5, i64 104, !5, i64 112, !5, i64 120, !5, i64 128, !5, i64 136, !8, i64 144, !8, i64 148, !8, i64 152, !8, i64 156}
!35 = !{!34, !5, i64 32}
!36 = !{!31, !5, i64 24}
!37 = !{!38, !8, i64 24}

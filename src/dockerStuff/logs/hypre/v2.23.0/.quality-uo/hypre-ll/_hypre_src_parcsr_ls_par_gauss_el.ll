...
108:                                              ; preds = %89, %46
  ...
  %112 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 164
...
215:                                              ; preds = %212, %185
  %216 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 162
...
218:                                              ; preds = %182
  %219 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 162
...
305:                                              ; preds = %302, %259
  ...
  %306 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 163
...
308:                                              ; preds = %182, %218, %305, %215
  %309 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 165
  %310 = bitcast i32** %309 to i8**
  store i8* %71, i8** %310, align 8, !tbaa !41
  %311 = load i32, i32* %6, align 4, !tbaa !16
  %312 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 160
...
321:                                              ; preds = %320, %3
  %322 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 161
...
define dso_local i32 @hypre_GaussElimSolve(%struct.hypre_ParAMGData* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  ...
  %22 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 161
...
30:                                               ; preds = %27
  %31 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 160
  ...
  %41 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 164
  ...
  %51 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 165
...
102:                                              ; preds = %101, %101
  %103 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 162
...
266:                                              ; preds = %101
  %267 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 163
...
288:                                              ; preds = %285
  call void @hypre_error_handler(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1, i64 0, i64 0), i32 320, i32 1, i8* null) #3
  br label %289

...
316:                                              ; preds = %300, %471
  ...
  %319 = phi i32 [ %474, %471 ], [ %302, %300 ]
  %320 = phi i32 [ %473, %471 ], [ %303, %300 ]
  %321 = phi i32 [ %472, %471 ], [ %304, %300 ]
  %322 = sext i32 %320 to i64
  %323 = getelementptr inbounds i32, i32* %238, i64 %322
  store i32 %319, i32* %323, align 4, !tbaa !7
...
479:                                              ; preds = %471, %300
  ...
  %481 = phi i32 [ %303, %300 ], [ %473, %471 ]
  %482 = phi i32 [ %302, %300 ], [ %474, %471 ]
...
539:                                              ; preds = %536, %513, %497
  ...
  %544 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %543, i64 0, i32 12
  store i32* %540, i32** %544, align 8, !tbaa !22
  %545 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %543, i64 0, i32 8
  ...
  %552 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %543, i64 0, i32 9

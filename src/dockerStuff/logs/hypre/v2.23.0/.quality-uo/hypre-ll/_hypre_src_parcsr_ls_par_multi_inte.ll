...
150:                                              ; preds = %146, %142
  ...
  %156 = call i8* @hypre_CAlloc(i64 %153, i64 4, i32 0) #4
...
1864:                                             ; preds = %1860, %950
  ...
  %1877 = call i8* @hypre_CAlloc(i64 %1876, i64 4, i32 0) #4
  %1878 = bitcast i8* %1877 to i32*
  %1879 = call i8* @hypre_CAlloc(i64 %1876, i64 8, i32 0) #4
...
1882:                                             ; preds = %1864
  ...
  %1884 = call i8* @hypre_CAlloc(i64 %1883, i64 4, i32 0) #4
  %1885 = bitcast i8* %1884 to i32*
  %1886 = call i8* @hypre_CAlloc(i64 %1883, i64 8, i32 0) #4

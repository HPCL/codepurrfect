...
336:                                              ; preds = %335, %277, %274
  %337 = load i32, i32* %11, align 4, !tbaa !18
  %338 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %230, i64 0, i32 4
  store i32 %337, i32* %338, align 4, !tbaa !12
  %339 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %209) #3
  %340 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %51, i64 0, i32 4
  %341 = load i32*, i32** %340, align 8, !tbaa !35
  %342 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %15, align 8, !tbaa !17
  %343 = icmp eq %struct.hypre_CSRMatrix* %342, null
  br i1 %343, label %349, label %344

344:                                              ; preds = %336
  %345 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAddPartial(%struct.hypre_CSRMatrix* %220, %struct.hypre_CSRMatrix* nonnull %342, i32* %341) #3
  %346 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %220) #3
  %347 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %15, align 8, !tbaa !17
  %348 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %347) #3
  br label %349

349:                                              ; preds = %336, %344
  %350 = phi %struct.hypre_CSRMatrix* [ %345, %344 ], [ %220, %336 ]
  %351 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %16, align 8, !tbaa !17
  %352 = icmp eq %struct.hypre_CSRMatrix* %351, null
  br i1 %352, label %358, label %353

353:                                              ; preds = %349
  %354 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAddPartial(%struct.hypre_CSRMatrix* %230, %struct.hypre_CSRMatrix* nonnull %351, i32* %341) #3
  %355 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %230) #3
  %356 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %16, align 8, !tbaa !17
  %357 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %356) #3
  br label %358

358:                                              ; preds = %349, %353
  %359 = phi %struct.hypre_CSRMatrix* [ %354, %353 ], [ %230, %349 ]
...
360:                                              ; preds = %90
  %361 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %21, %struct.hypre_CSRMatrix* %32) #3
  %362 = call i32 @hypre_CSRMatrixTranspose(%struct.hypre_CSRMatrix* %53, %struct.hypre_CSRMatrix** nonnull %9, i32 1) #3
  %363 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %9, align 8, !tbaa !17
  %364 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %363, %struct.hypre_CSRMatrix* %361) #3
  %365 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %60, i32 0, i32 0) #3
  %366 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %364, i64 0, i32 12
  %367 = load i32, i32* %366, align 4, !tbaa !27
  %368 = call i32 @hypre_CSRMatrixInitialize_v2(%struct.hypre_CSRMatrix* %365, i32 0, i32 %367) #3
  %369 = icmp eq i32 %3, 0
  %370 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %9, align 8, !tbaa !17
  br i1 %369, label %373, label %371

371:                                              ; preds = %360
  %372 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 10
  store %struct.hypre_CSRMatrix* %370, %struct.hypre_CSRMatrix** %372, align 8, !tbaa !29
  br label %375

373:                                              ; preds = %360
  %374 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %370) #3
  br label %375

375:                                              ; preds = %373, %371
  %376 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %361) #3
  br label %377

377:                                              ; preds = %375, %358
  %378 = phi %struct.hypre_CSRMatrix* [ %359, %358 ], [ %365, %375 ]
  %379 = phi %struct.hypre_CSRMatrix* [ %350, %358 ], [ %364, %375 ]
  %380 = load i32, i32* %11, align 4, !tbaa !18
  %381 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %19, i32 %71, i32 %79, i32* nonnull %63, i32* nonnull %39, i32 %380, i32 0, i32 0) #3
  %382 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %381, i64 0, i32 8
  %383 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %382, align 8, !tbaa !10
  %384 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %383) #3
  %385 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %381, i64 0, i32 9
  %386 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %385, align 8, !tbaa !11
  %387 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %386) #3
  store %struct.hypre_CSRMatrix* %379, %struct.hypre_CSRMatrix** %382, align 8, !tbaa !10
  %388 = icmp eq %struct.hypre_CSRMatrix* %378, null
  br i1 %388, label %389, label %392

389:                                              ; preds = %377
  %390 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %60, i32 0, i32 0) #3
  %391 = call i32 @hypre_CSRMatrixInitialize(%struct.hypre_CSRMatrix* %390) #3
  br label %392

392:                                              ; preds = %377, %389
  %393 = phi %struct.hypre_CSRMatrix* [ %390, %389 ], [ %378, %377 ]
  store %struct.hypre_CSRMatrix* %393, %struct.hypre_CSRMatrix** %385, align 8, !tbaa !11
  %394 = load i32*, i32** %10, align 8, !tbaa !17
  %395 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %381, i64 0, i32 12
  store i32* %394, i32** %395, align 8, !tbaa !15
  %396 = load i32, i32* %12, align 4, !tbaa !18
  %397 = icmp sgt i32 %396, 1
  br i1 %397, label %398, label %400

398:                                              ; preds = %392
  %399 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %381) #3
  br label %400

400:                                              ; preds = %392, %398, %89
  %401 = phi %struct.hypre_ParCSRMatrix_struct* [ null, %89 ], [ %381, %398 ], [ %381, %392 ]
  ...
  ret %struct.hypre_ParCSRMatrix_struct* %401
}

...
14:                                               ; preds = %7
  %15 = call i32 @hypre_MPI_Comm_rank(i32 %0, i32* nonnull %9) #4
  %16 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %10) #4
  ...
  %23 = call i32 @hypre_MPI_Allgather(i8* nonnull %22, i32 1, i32 1275070475, i8* %20, i32 1, i32 1275070475, i32 %0) #4
...
26:                                               ; preds = %26, %22
  ...
  call void @MatrixGetRow(%struct.Matrix* %1, i32 %32, i32* nonnull %10, i32** nonnull %11, double** nonnull %12) #4
...
42:                                               ; preds = %26
  ...
  %50 = shl nsw i64 %49, 2
  %51 = call i8* @hypre_MAlloc(i64 %50, i32 0) #4
...
61:                                               ; preds = %58, %61
  ...
  call void @MatrixGetRow(%struct.Matrix* %1, i32 %65, i32* nonnull %10, i32** nonnull %11, double** nonnull %12) #4
  ...
  call void @NumberingLocalToGlobal(%struct.numbering* %2, i32 %68, i32* %69, i32* nonnull %67) #4
...
75:                                               ; preds = %61, %42
  ...
  %79 = call i32 @hypre_MPI_Isend(i8* %76, i32 %39, i32 1275069445, i32 %77, i32 888, i32 %0, i32* %78) #4
...
13:                                               ; preds = %11, %47
  ...
  %15 = call i32 @hypre_MPI_Probe(i32 -2, i32 888, i32 %0, %struct.MPI_Status* nonnull %6) #4
  ...
  %18 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %6, i32 1275069445, i32* nonnull %5) #4
  ...
  %26 = call i32 @hypre_MPI_Recv(i8* %22, i32 %24, i32 1275069445, i32 %25, i32 888, i32 %0, %struct.MPI_Status* nonnull %6) #4
  %27 = getelementptr inbounds i8, i8* %22, i64 4
  %28 = bitcast i8* %27 to i32*
  %29 = load i32, i32* %23, align 4, !tbaa !7
  %30 = load i32, i32* %28, align 4, !tbaa !7
  %31 = call %struct.Matrix* @MatrixCreateLocal(i32 %29, i32 %30) #4
...
37:                                               ; preds = %34, %37
  ...
  call void @NumberingGlobalToLocal(%struct.numbering* %1, i32 %41, i32* nonnull %40, i32* nonnull %40) #4
  %42 = load %struct.Matrix*, %struct.Matrix** %32, align 8, !tbaa !30
  call void @MatrixSetRow(%struct.Matrix* %42, i32 %38, i32 %41, i32* nonnull %40, double* null) #4
...
47:                                               ; preds = %37, %13
  call void @hypre_Free(i8* %22, i32 0) #4
...
24:                                               ; preds = %15, %24
  ...
  call void @MatrixGetRow(%struct.Matrix* %18, i32 %26, i32* nonnull %5, i32** nonnull %6, double** nonnull %7) #4
...
34:                                               ; preds = %24, %15
  ...
  %39 = shl nsw i64 %38, 3
  %40 = call i8* @hypre_MAlloc(i64 %39, i32 0) #4
...
48:                                               ; preds = %46, %48
  ...
  call void @MatrixGetRow(%struct.Matrix* %18, i32 %50, i32* nonnull %5, i32** nonnull %6, double** nonnull %7) #4
  %51 = bitcast double* %49 to i8*
  %52 = load i8*, i8** %11, align 8, !tbaa !23
  %53 = load i32, i32* %5, align 4, !tbaa !7
  %54 = sext i32 %53 to i64
  %55 = shl nsw i64 %54, 3
  call void @hypre_Memcpy(i8* %51, i8* %52, i64 %55, i32 0, i32 0) #4
...
64:                                               ; preds = %48, %34
  ...
  %69 = call i32 @hypre_MPI_Isend(i8* %65, i32 %35, i32 1275070475, i32 %67, i32 889, i32 %0, i32* %68) #4
  call void @MatrixDestroy(%struct.Matrix* %18) #4
...
22:                                               ; preds = %20, %68
  ...
  %24 = call i32 @hypre_MPI_Probe(i32 -2, i32 889, i32 %0, %struct.MPI_Status* nonnull %6) #4
  %25 = load i32, i32* %15, align 4, !tbaa !26
  %26 = call i32 @hypre_MPI_Get_count(%struct.MPI_Status* nonnull %6, i32 1275070475, i32* nonnull %5) #4
  %27 = load i32, i32* %5, align 4, !tbaa !7
  %28 = sext i32 %27 to i64
  %29 = shl nsw i64 %28, 3
  %30 = call i8* @hypre_MAlloc(i64 %29, i32 0) #4
  %31 = bitcast i8* %30 to double*
  %32 = load i32, i32* %5, align 4, !tbaa !7
  %33 = call i32 @hypre_MPI_Recv(i8* %30, i32 %32, i32 1275070475, i32 %25, i32 889, i32 %0, %struct.MPI_Status* nonnull %6) #4
...
52:                                               ; preds = %44, %52
  ...
  call void @MatrixGetRow(%struct.Matrix* %1, i32 %56, i32* nonnull %7, i32** nonnull %8, double** nonnull %9) #4
  %57 = load i8*, i8** %18, align 8, !tbaa !23
  %58 = bitcast double* %53 to i8*
  %59 = load i32, i32* %7, align 4, !tbaa !7
  %60 = sext i32 %59 to i64
  %61 = shl nsw i64 %60, 3
  call void @hypre_Memcpy(i8* %57, i8* %58, i64 %61, i32 0, i32 0) #4
...
68:                                               ; preds = %52, %44
  call void @hypre_Free(i8* %30, i32 0) #4
...
define dso_local %struct.LoadBal* @LoadBalDonate(i32 %0, %struct.Matrix* %1, %struct.numbering* %2, double %3, double %4) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %7) #4
  %8 = call i8* @hypre_MAlloc(i64 32, i32 0) #4
  %9 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %6) #4
  %10 = load i32, i32* %6, align 4, !tbaa !7
  %11 = sext i32 %10 to i64
  %12 = shl nsw i64 %11, 2
  %13 = call i8* @hypre_MAlloc(i64 %12, i32 0) #4
  %14 = bitcast i8* %13 to i32*
  %15 = load i32, i32* %6, align 4, !tbaa !7
  %16 = sext i32 %15 to i64
  %17 = shl nsw i64 %16, 3
  %18 = call i8* @hypre_MAlloc(i64 %17, i32 0) #4
...
29:                                               ; preds = %5
  ...
  %32 = call i8* @hypre_MAlloc(i64 %31, i32 0) #4
...
37:                                               ; preds = %34
  ...
  %44 = shl nsw i64 %43, 2
  %45 = call i8* @hypre_MAlloc(i64 %44, i32 0) #4
  %46 = bitcast i8* %45 to i32*
  %47 = load i32, i32* %20, align 8, !tbaa !44
  %48 = sext i32 %47 to i64
  %49 = mul nsw i64 %48, 20
  %50 = call i8* @hypre_MAlloc(i64 %49, i32 0) #4
...
52:                                               ; preds = %37, %34
  ...
  call void @hypre_Free(i8* %13, i32 0) #4
  ...
  %62 = call i32 @hypre_MPI_Waitall(i32 %61, i32* %53, %struct.MPI_Status* %54) #4
...
67:                                               ; preds = %52, %67
  ...
  %73 = load %struct.DonorData*, %struct.DonorData** %26, align 8, !tbaa !45
  %74 = getelementptr inbounds %struct.DonorData, %struct.DonorData* %73, i64 %68, i32 3
  store i32* null, i32** %74, align 8, !tbaa !22
  %75 = add nuw nsw i64 %68, 1
  %76 = load i32, i32* %20, align 8, !tbaa !44
  %77 = sext i32 %76 to i64
  %78 = icmp slt i64 %75, %77
  br i1 %78, label %67, label %79, !llvm.loop !46

79:                                               ; preds = %67, %52
  %80 = bitcast i8* %8 to %struct.LoadBal*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %7) #4
  ret %struct.LoadBal* %80
}

declare dso_local i32 @hypre_MPI_Waitall(i32, i32*, %struct.MPI_Status*) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local void @LoadBalReturn(%struct.LoadBal* %0, i32 %1, %struct.Matrix* %2) local_unnamed_addr #0 {
...
17:                                               ; preds = %7, %3
  ...
  %28 = call i32 @hypre_MPI_Waitall(i32 %27, i32* %18, %struct.MPI_Status* %19) #4
  %29 = bitcast i32* %18 to i8*
  call void @hypre_Free(i8* %29, i32 0) #4
...
33:                                               ; preds = %17, %33
  ...
  %39 = load %struct.RecipData*, %struct.RecipData** %21, align 8, !tbaa !43
  %40 = getelementptr inbounds %struct.RecipData, %struct.RecipData* %39, i64 %34, i32 2
  store double* null, double** %40, align 8, !tbaa !35
  %41 = add nuw nsw i64 %34, 1
  %42 = load i32, i32* %4, align 4, !tbaa !41
  %43 = sext i32 %42 to i64
  %44 = icmp slt i64 %41, %43
  br i1 %44, label %33, label %45, !llvm.loop !47

45:                                               ; preds = %33, %17
  %46 = bitcast %struct.DonorData** %25 to i8**
  %47 = load i8*, i8** %46, align 8, !tbaa !45
  call void @hypre_Free(i8* %47, i32 0) #4
  store %struct.DonorData* null, %struct.DonorData** %25, align 8, !tbaa !45
  %48 = bitcast %struct.RecipData** %21 to i8**
  %49 = load i8*, i8** %48, align 8, !tbaa !43
  call void @hypre_Free(i8* %49, i32 0) #4
  store %struct.RecipData* null, %struct.RecipData** %21, align 8, !tbaa !43
  %50 = bitcast %struct.LoadBal* %0 to i8*

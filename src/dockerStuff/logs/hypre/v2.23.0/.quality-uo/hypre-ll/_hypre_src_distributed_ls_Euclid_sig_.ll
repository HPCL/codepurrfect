...
define dso_local void @sigRegister_dh() local_unnamed_addr #0 {
  ...
  %2 = call zeroext i1 @Parser_dhHasSwitch(%struct._parser_dh* %1, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0)) #3
  %3 = load i32, i32* @euclid_signals_len, align 4
  %4 = icmp sgt i32 %3, 0
...
6:                                                ; preds = %0, %6
  %7 = phi i64 [ %11, %6 ], [ 0, %0 ]
  %8 = getelementptr inbounds [3 x i32], [3 x i32]* @euclid_signals, i64 0, i64 %7
  %9 = load i32, i32* %8, align 4, !tbaa !7
  %10 = call void (i32)* @signal(i32 %9, void (i32)* nonnull @sigHandler_dh) #3
  %11 = add nuw nsw i64 %7, 1
  %12 = load i32, i32* @euclid_signals_len, align 4, !tbaa !7

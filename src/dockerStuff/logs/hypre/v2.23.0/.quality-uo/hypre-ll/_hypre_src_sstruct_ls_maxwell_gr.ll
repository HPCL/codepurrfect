...
68:                                               ; preds = %64, %1
  ...
  %72 = shl nsw i64 %71, 2
  %73 = call i8* @hypre_MAlloc(i64 %72, i32 0) #6
...
624:                                              ; preds = %618, %498
  ...
  %632 = call i8* @hypre_MAlloc(i64 8, i32 0) #6
...
874:                                              ; preds = %870, %624
  ...
  call void @hypre_Free(i8* %632, i32 0) #6
...
900:                                              ; preds = %895, %878
  ...
  %902 = call i8* @hypre_MAlloc(i64 %901, i32 0) #6
  %903 = bitcast i8* %902 to [3 x i32]*
  %904 = call i8* @hypre_MAlloc(i64 %901, i32 0) #6
...
1357:                                             ; preds = %1352, %909
  ...
  call void @hypre_Free(i8* %904, i32 0) #6
  ...
  call void @hypre_Free(i8* %360, i32 0) #6
...
!72 = !{!73, !8, i64 24}
!73 = !{!"hypre_IJMatrix_struct", !5, i64 0, !6, i64 4, !6, i64 12, !5, i64 20, !8, i64 24, !8, i64 32, !8, i64 40, !5, i64 48, !5, i64 52, !5, i64 56, !5, i64 60, !5, i64 64, !5, i64 68, !5, i64 72}

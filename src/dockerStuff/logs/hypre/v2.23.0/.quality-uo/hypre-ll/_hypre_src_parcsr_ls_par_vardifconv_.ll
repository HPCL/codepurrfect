...
724:                                              ; preds = %722, %682
  ...
  %726 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %725, i64 0, i32 6
  %727 = bitcast %struct.hypre_Vector** %726 to i8***
  %728 = load i8**, i8*** %727, align 8, !tbaa !22
  store i8* %92, i8** %728, align 8, !tbaa !24
  %729 = load i32, i32* %257, align 4, !tbaa !3
  %730 = getelementptr inbounds i32, i32* %90, i64 %91
  %731 = load i32, i32* %730, align 4, !tbaa !3
  %732 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %0, i32 %31, i32 %31, i32* nonnull %65, i32* nonnull %65, i32 %123, i32 %729, i32 %731) #5
  %733 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %732, i64 0, i32 12
  %734 = bitcast i32** %733 to i8**
  store i8* %125, i8** %734, align 8, !tbaa !26
  %735 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %732, i64 0, i32 8
  %736 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %735, align 8, !tbaa !28
  %737 = bitcast %struct.hypre_CSRMatrix* %736 to i8**
  store i8* %87, i8** %737, align 8, !tbaa !29
  %738 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %736, i64 0, i32 1
  %739 = bitcast i32** %738 to i8**
  store i8* %260, i8** %739, align 8, !tbaa !31
  %740 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %736, i64 0, i32 9
  %741 = bitcast double** %740 to i8**
  store i8* %264, i8** %741, align 8, !tbaa !32
  %742 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %732, i64 0, i32 9
  %743 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %742, align 8, !tbaa !33
  %744 = bitcast %struct.hypre_CSRMatrix* %743 to i8**
  store i8* %89, i8** %744, align 8, !tbaa !29
  %745 = icmp eq i32 %123, 0
  br i1 %745, label %749, label %746

746:                                              ; preds = %724
  %747 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %743, i64 0, i32 1
  store i32* %285, i32** %747, align 8, !tbaa !31
  %748 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %743, i64 0, i32 9
  store double* %283, double** %748, align 8, !tbaa !32
  br label %749

749:                                              ; preds = %746, %724
  %750 = bitcast i32** %14 to i8**
  %751 = load i8*, i8** %750, align 8, !tbaa !7
  call void @hypre_Free(i8* %751, i32 0) #5
  store i32* null, i32** %14, align 8, !tbaa !7
  %752 = bitcast i32** %15 to i8**
  %753 = load i8*, i8** %752, align 8, !tbaa !7
  call void @hypre_Free(i8* %753, i32 0) #5
  store i32* null, i32** %15, align 8, !tbaa !7
  %754 = bitcast i32** %16 to i8**
  %755 = load i8*, i8** %754, align 8, !tbaa !7
  call void @hypre_Free(i8* %755, i32 0) #5
  ...
  ret %struct.hypre_ParCSRMatrix_struct* %732
}

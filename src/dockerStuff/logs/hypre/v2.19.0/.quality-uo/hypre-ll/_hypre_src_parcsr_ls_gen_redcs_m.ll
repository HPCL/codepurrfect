...
define dso_local i32 @hypre_seqAMGSetup(%struct.hypre_ParAMGData* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  ...
  %10 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 68
  ...
  %19 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 74
...
425:                                              ; preds = %421
  ...
  %452 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 147
  store %struct.hypre_Solver_struct* %451, %struct.hypre_Solver_struct** %452, align 8, !tbaa !51
  %453 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 148
  store %struct.hypre_ParCSRMatrix_struct* %431, %struct.hypre_ParCSRMatrix_struct** %453, align 8, !tbaa !52
  %454 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 149
  store %struct.hypre_ParVector_struct* %442, %struct.hypre_ParVector_struct** %454, align 8, !tbaa !53
  %455 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 150
...
456:                                              ; preds = %421, %425
  ...
  %458 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 151
...
define dso_local i32 @hypre_seqAMGCycle(%struct.hypre_ParAMGData* nocapture readonly %0, i32 %1, %struct.hypre_ParVector_struct** nocapture readonly %2, %struct.hypre_ParVector_struct** nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 151
  %9 = load i32, i32* %8, align 8, !tbaa !55
  %10 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 147
  %11 = bitcast %struct.hypre_Solver_struct** %10 to i8**
  %12 = load i8*, i8** %11, align 8, !tbaa !51
  %13 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 148
  %14 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %13, align 8, !tbaa !52
  %15 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 149
  %16 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %15, align 8, !tbaa !53
  %17 = getelementptr inbounds %struct.hypre_ParAMGData, %struct.hypre_ParAMGData* %0, i64 0, i32 150

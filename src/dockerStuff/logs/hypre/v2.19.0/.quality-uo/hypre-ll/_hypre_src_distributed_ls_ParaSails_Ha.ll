...
define dso_local %struct.Hash* @HashCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_MAlloc(i64 32, i32 0) #7
...
24:                                               ; preds = %22, %20
  ...
  %27 = getelementptr inbounds %struct.Hash, %struct.Hash* %0, i64 0, i32 1
  %28 = load i32, i32* %27, align 4, !tbaa !9
  %29 = getelementptr inbounds %struct.Hash, %struct.Hash* %0, i64 0, i32 2
...
define dso_local void @HashRehash(%struct.Hash* nocapture readonly %0, %struct.Hash* nocapture %1) local_unnamed_addr #5 {
  ...
  %7 = getelementptr inbounds %struct.Hash, %struct.Hash* %1, i64 0, i32 1
  %8 = getelementptr inbounds %struct.Hash, %struct.Hash* %1, i64 0, i32 2
...
67:                                               ; preds = %65, %63
  ...
  %71 = load i32*, i32** %8, align 8, !tbaa !10
  %72 = add nsw i32 %70, 1

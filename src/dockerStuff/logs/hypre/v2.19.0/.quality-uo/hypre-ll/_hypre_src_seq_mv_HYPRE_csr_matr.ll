...
define dso_local %struct.hypre_CSRMatrix_struct* @HYPRE_CSRMatrixCreate(i32 %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  %4 = add nsw i32 %0, 1
  %5 = sext i32 %4 to i64
  %6 = call i8* @hypre_CAlloc(i64 %5, i64 4, i32 0) #4
...
!10 = !{!11, !12, i64 0}
!11 = !{!"", !12, i64 0, !12, i64 8, !12, i64 16, !4, i64 24, !4, i64 28, !4, i64 32, !12, i64 40, !12, i64 48, !4, i64 56, !12, i64 64, !12, i64 72, !4, i64 80, !5, i64 84}

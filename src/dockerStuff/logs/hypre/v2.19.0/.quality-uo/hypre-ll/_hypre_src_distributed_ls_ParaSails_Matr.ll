...
107:                                              ; preds = %105
  ...
  call void @hypre_Memcpy(i8* %131, i8* nonnull %40, i64 %115, i32 0, i32 0) #8
  ...
  call void @hypre_Memcpy(i8* %135, i8* nonnull %41, i64 %122, i32 0, i32 0) #8
...
161:                                              ; preds = %99, %152, %86
  ...
  call void @hypre_Memcpy(i8* %187, i8* nonnull %40, i64 %171, i32 0, i32 0) #8
  ...
  call void @hypre_Memcpy(i8* %191, i8* nonnull %41, i64 %178, i32 0, i32 0) #8
...
228:                                              ; preds = %226
  ...
  call void @hypre_Memcpy(i8* %252, i8* nonnull %201, i64 %236, i32 0, i32 0) #8
  ...
  call void @hypre_Memcpy(i8* %256, i8* nonnull %202, i64 %243, i32 0, i32 0) #8
...
282:                                              ; preds = %220, %273, %194
  ...
  call void @hypre_Memcpy(i8* %308, i8* nonnull %201, i64 %292, i32 0, i32 0) #8
  ...
  call void @hypre_Memcpy(i8* %312, i8* nonnull %202, i64 %299, i32 0, i32 0) #8
...
33:                                               ; preds = %3
  ...
  %37 = getelementptr inbounds %struct.Matrix, %struct.Matrix* %1, i64 0, i32 4
  %38 = icmp eq i32 %36, 1
...
40:                                               ; preds = %33
  ...
  %44 = select i1 %38, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.9, i64 0, i64 0)
  br label %52
...
52:                                               ; preds = %40, %52
  %53 = phi i64 [ 0, %40 ], [ %56, %52 ]
  %54 = getelementptr inbounds double, double* %0, i64 %53
  %55 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %34, i8* %44, double* %54) #8
  %56 = add nuw nsw i64 %53, 1
  %57 = icmp eq i64 %56, %43
  br i1 %57, label %45, label %52, !llvm.loop !60

58:                                               ; preds = %50, %91
  %59 = phi i64 [ %96, %91 ], [ 1, %50 ]
  %60 = phi i32 [ %79, %91 ], [ 0, %50 ]
  %61 = phi double* [ %78, %91 ], [ null, %50 ]
  %62 = load i32*, i32** %37, align 8, !tbaa !17
...
71:                                               ; preds = %58
  ...
  %74 = shl nsw i64 %73, 3
  %75 = call i8* @hypre_MAlloc(i64 %74, i32 0) #8

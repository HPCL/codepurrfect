...
define dso_local i8* @hypre_PFMGCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 288, i32 0) #4
  %3 = bitcast i8* %2 to i32*
  store i32 %0, i32* %3, align 8, !tbaa !3
  %4 = getelementptr inbounds i8, i8* %2, i64 260
  ...
  %26 = getelementptr inbounds i8, i8* %2, i64 268
  %27 = bitcast i8* %26 to i32*
  store i32 0, i32* %27, align 4, !tbaa !20
  %28 = getelementptr inbounds i8, i8* %2, i64 264
...
define dso_local i32 @hypre_PFMGDestroy(i8* %0) local_unnamed_addr #0 {
  %2 = icmp eq i8* %0, null
  br i1 %2, label %196, label %3

3:                                                ; preds = %1
  %4 = getelementptr inbounds i8, i8* %0, i64 268
  %5 = bitcast i8* %4 to i32*
...
22:                                               ; preds = %17
  ...
  %25 = getelementptr inbounds i8, i8* %0, i64 224
  %26 = bitcast i8* %25 to i8***
  %27 = getelementptr inbounds i8, i8* %0, i64 232
  %28 = bitcast i8* %27 to i8***
  %29 = load i32, i32* %19, align 8, !tbaa !22
...
31:                                               ; preds = %49, %22
  ...
  %34 = getelementptr inbounds i8, i8* %0, i64 248
  %35 = bitcast i8* %34 to i8***
  %36 = load i32, i32* %19, align 8, !tbaa !22
  %37 = icmp sgt i32 %36, 1
  br i1 %37, label %58, label %73

38:                                               ; preds = %22, %49
  %39 = phi i64 [ %54, %49 ], [ 0, %22 ]
  %40 = load i32*, i32** %24, align 8, !tbaa !25
...
44:                                               ; preds = %38
  %45 = load i8**, i8*** %26, align 8, !tbaa !27
  %46 = getelementptr inbounds i8*, i8** %45, i64 %39
  %47 = load i8*, i8** %46, align 8, !tbaa !28
  %48 = call i32 @hypre_PFMGRelaxDestroy(i8* %47) #4
  br label %49

49:                                               ; preds = %44, %38
  %50 = load i8**, i8*** %28, align 8, !tbaa !29
  %51 = getelementptr inbounds i8*, i8** %50, i64 %39
  %52 = load i8*, i8** %51, align 8, !tbaa !28
  %53 = call i32 @hypre_StructMatvecDestroy(i8* %52) #4
  %54 = add nuw nsw i64 %39, 1
  %55 = load i32, i32* %19, align 8, !tbaa !22
  %56 = sext i32 %55 to i64
  %57 = icmp slt i64 %54, %56
  br i1 %57, label %38, label %31, !llvm.loop !30

58:                                               ; preds = %31, %58
  %59 = phi i64 [ %68, %58 ], [ 0, %31 ]
  %60 = load i8**, i8*** %33, align 8, !tbaa !33
  %61 = getelementptr inbounds i8*, i8** %60, i64 %59
  %62 = load i8*, i8** %61, align 8, !tbaa !28
  %63 = call i32 @hypre_SemiRestrictDestroy(i8* %62) #4
  %64 = load i8**, i8*** %35, align 8, !tbaa !34
  %65 = getelementptr inbounds i8*, i8** %64, i64 %59
  %66 = load i8*, i8** %65, align 8, !tbaa !28
  %67 = call i32 @hypre_SemiInterpDestroy(i8* %66) #4
  %68 = add nuw nsw i64 %59, 1
  %69 = load i32, i32* %19, align 8, !tbaa !22
  %70 = add nsw i32 %69, -1
  %71 = sext i32 %70 to i64
  %72 = icmp slt i64 %68, %71
  br i1 %72, label %58, label %73, !llvm.loop !35
...
73:                                               ; preds = %58, %31
  ...
  store i8** null, i8*** %75, align 8, !tbaa !27
  %78 = getelementptr inbounds i8, i8* %0, i64 232
  %79 = bitcast i8* %78 to i8***
  %80 = bitcast i8* %78 to i8**
  %81 = load i8*, i8** %80, align 8, !tbaa !29
  call void @hypre_Free(i8* %81, i32 0) #4
  store i8** null, i8*** %79, align 8, !tbaa !29
  %82 = getelementptr inbounds i8, i8* %0, i64 240
  %83 = bitcast i8* %82 to i8***
  %84 = bitcast i8* %82 to i8**
  %85 = load i8*, i8** %84, align 8, !tbaa !33
  call void @hypre_Free(i8* %85, i32 0) #4
  store i8** null, i8*** %83, align 8, !tbaa !33
  %86 = getelementptr inbounds i8, i8* %0, i64 248
  %87 = bitcast i8* %86 to i8***
  %88 = bitcast i8* %86 to i8**
  %89 = load i8*, i8** %88, align 8, !tbaa !34
  call void @hypre_Free(i8* %89, i32 0) #4
  store i8** null, i8*** %87, align 8, !tbaa !34
  %90 = getelementptr inbounds i8, i8* %0, i64 200
  %91 = bitcast i8* %90 to %struct.hypre_StructVector_struct***
  %92 = load %struct.hypre_StructVector_struct**, %struct.hypre_StructVector_struct*** %91, align 8, !tbaa !36
  %93 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %92, align 8, !tbaa !28
  %94 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %93) #4
  %95 = getelementptr inbounds i8, i8* %0, i64 128
  %96 = bitcast i8* %95 to %struct.hypre_StructGrid_struct***
  %97 = load %struct.hypre_StructGrid_struct**, %struct.hypre_StructGrid_struct*** %96, align 8, !tbaa !37
  %98 = load %struct.hypre_StructGrid_struct*, %struct.hypre_StructGrid_struct** %97, align 8, !tbaa !28
  %99 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %98) #4
  %100 = getelementptr inbounds i8, i8* %0, i64 160
  %101 = bitcast i8* %100 to %struct.hypre_StructMatrix_struct***
  %102 = load %struct.hypre_StructMatrix_struct**, %struct.hypre_StructMatrix_struct*** %101, align 8, !tbaa !38
  %103 = load %struct.hypre_StructMatrix_struct*, %struct.hypre_StructMatrix_struct** %102, align 8, !tbaa !28
  %104 = call i32 @hypre_StructMatrixDestroy(%struct.hypre_StructMatrix_struct* %103) #4
  %105 = getelementptr inbounds i8, i8* %0, i64 184
  ...
  %109 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %108) #4
  %110 = getelementptr inbounds i8, i8* %0, i64 192
  ...
  %114 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %113) #4
  %115 = getelementptr inbounds i8, i8* %0, i64 136
  %116 = bitcast i8* %115 to %struct.hypre_StructGrid_struct***
  %117 = getelementptr inbounds i8, i8* %0, i64 168
...
121:                                              ; preds = %73, %121
  %122 = phi i64 [ %124, %121 ], [ 0, %73 ]
  %123 = load %struct.hypre_StructGrid_struct**, %struct.hypre_StructGrid_struct*** %96, align 8, !tbaa !37
  ...
  %127 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %126) #4
  ...
  %131 = call i32 @hypre_StructGridDestroy(%struct.hypre_StructGrid_struct* %130) #4
  %132 = load %struct.hypre_StructMatrix_struct**, %struct.hypre_StructMatrix_struct*** %101, align 8, !tbaa !38
  ...
  %135 = call i32 @hypre_StructMatrixDestroy(%struct.hypre_StructMatrix_struct* %134) #4
  ...
  %139 = call i32 @hypre_StructMatrixDestroy(%struct.hypre_StructMatrix_struct* %138) #4
  ...
  %143 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %142) #4
  ...
  %147 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %146) #4
  %148 = load %struct.hypre_StructVector_struct**, %struct.hypre_StructVector_struct*** %91, align 8, !tbaa !36
  ...
  %151 = call i32 @hypre_StructVectorDestroy(%struct.hypre_StructVector_struct* %150) #4
...
156:                                              ; preds = %121, %73
  ...
  call void @hypre_Free(i8* %164, i32 0) #4
  store double* null, double** %162, align 8, !tbaa !45
  %165 = getelementptr inbounds i8, i8* %0, i64 112
  %166 = bitcast i8* %165 to i32**
  %167 = bitcast i8* %165 to i8**
  %168 = load i8*, i8** %167, align 8, !tbaa !46
  call void @hypre_Free(i8* %168, i32 0) #4
  store i32* null, i32** %166, align 8, !tbaa !46
  %169 = getelementptr inbounds i8, i8* %0, i64 120
  %170 = bitcast i8* %169 to i32**
  %171 = bitcast i8* %169 to i8**
  %172 = load i8*, i8** %171, align 8, !tbaa !25
  call void @hypre_Free(i8* %172, i32 0) #4
  store i32* null, i32** %170, align 8, !tbaa !25
  %173 = bitcast i8* %95 to i8**
  %174 = load i8*, i8** %173, align 8, !tbaa !37
  call void @hypre_Free(i8* %174, i32 0) #4
  store %struct.hypre_StructGrid_struct** null, %struct.hypre_StructGrid_struct*** %96, align 8, !tbaa !37
  %175 = getelementptr inbounds i8, i8* %0, i64 136
  %176 = bitcast i8* %175 to %struct.hypre_StructGrid_struct***
  %177 = bitcast i8* %175 to i8**
  %178 = load i8*, i8** %177, align 8, !tbaa !41
  call void @hypre_Free(i8* %178, i32 0) #4
  store %struct.hypre_StructGrid_struct** null, %struct.hypre_StructGrid_struct*** %176, align 8, !tbaa !41
  %179 = bitcast i8* %100 to i8**
  %180 = load i8*, i8** %179, align 8, !tbaa !38
  call void @hypre_Free(i8* %180, i32 0) #4
  store %struct.hypre_StructMatrix_struct** null, %struct.hypre_StructMatrix_struct*** %101, align 8, !tbaa !38
  %181 = getelementptr inbounds i8, i8* %0, i64 168
  %182 = bitcast i8* %181 to %struct.hypre_StructMatrix_struct***
  %183 = bitcast i8* %181 to i8**
  %184 = load i8*, i8** %183, align 8, !tbaa !42
  call void @hypre_Free(i8* %184, i32 0) #4
  store %struct.hypre_StructMatrix_struct** null, %struct.hypre_StructMatrix_struct*** %182, align 8, !tbaa !42
  %185 = getelementptr inbounds i8, i8* %0, i64 176
  %186 = bitcast i8* %185 to %struct.hypre_StructMatrix_struct***
  %187 = bitcast i8* %185 to i8**
  %188 = load i8*, i8** %187, align 8, !tbaa !47
  call void @hypre_Free(i8* %188, i32 0) #4
  store %struct.hypre_StructMatrix_struct** null, %struct.hypre_StructMatrix_struct*** %186, align 8, !tbaa !47
  %189 = bitcast i8* %105 to i8**
  %190 = load i8*, i8** %189, align 8, !tbaa !39
  call void @hypre_Free(i8* %190, i32 0) #4
  store %struct.hypre_StructVector_struct** null, %struct.hypre_StructVector_struct*** %106, align 8, !tbaa !39
  %191 = bitcast i8* %110 to i8**
  %192 = load i8*, i8** %191, align 8, !tbaa !40
  call void @hypre_Free(i8* %192, i32 0) #4
  store %struct.hypre_StructVector_struct** null, %struct.hypre_StructVector_struct*** %111, align 8, !tbaa !40
  %193 = bitcast i8* %90 to i8**
  %194 = load i8*, i8** %193, align 8, !tbaa !36
  call void @hypre_Free(i8* %194, i32 0) #4
  store %struct.hypre_StructVector_struct** null, %struct.hypre_StructVector_struct*** %91, align 8, !tbaa !36
  br label %195
...
196:                                              ; preds = %195, %1
  %197 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  ret i32 %197
}
...
define dso_local i32 @hypre_PFMGSetJacobiWeight(i8* nocapture %0, double %1) local_unnamed_addr #2 {
  ...
  store i32 1, i32* %6, align 8, !tbaa !50
...
define dso_local i32 @hypre_PFMGSetDxyz(i8* nocapture %0, double* nocapture readonly %1) local_unnamed_addr #2 {
  %3 = load double, double* %1, align 8, !tbaa !48
  ...
  store double %7, double* %9, align 8, !tbaa !48
  %10 = getelementptr inbounds double, double* %1, i64 2
  %11 = load double, double* %10, align 8, !tbaa !48
  %12 = getelementptr inbounds i8, i8* %0, i64 96
  %13 = bitcast i8* %12 to double*
  store double %11, double* %13, align 8, !tbaa !48
...
define dso_local i32 @hypre_PFMGSetLogging(i8* nocapture %0, i32 %1) local_unnamed_addr #2 {
  %3 = getelementptr inbounds i8, i8* %0, i64 268
  %4 = bitcast i8* %3 to i32*
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_PFMGPrintLogging(i8* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds i8, i8* %0, i64 256
  %4 = bitcast i8* %3 to i32*
  %5 = load i32, i32* %4, align 8, !tbaa !52
  %6 = getelementptr inbounds i8, i8* %0, i64 268
  ...
  %15 = getelementptr inbounds i8, i8* %0, i64 280
...
27:                                               ; preds = %25, %27
  ...
  %34 = load double, double* %33, align 8, !tbaa !48
  ...
  br i1 %38, label %39, label %27, !llvm.loop !53
...
define dso_local i32 @hypre_PFMGGetFinalRelativeResidualNorm(i8* nocapture readonly %0, double* nocapture %1) local_unnamed_addr #0 {
  ...
  %9 = getelementptr inbounds i8, i8* %0, i64 268
  %10 = bitcast i8* %9 to i32*
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 538, i32 12, i8* null) #4
  br label %30
...
21:                                               ; preds = %19
  ...
  store double %25, double* %1, align 8, !tbaa !48
  br label %30

26:                                               ; preds = %19
  %27 = sext i32 %8 to i64
  %28 = getelementptr inbounds double, double* %14, i64 %27
  %29 = load double, double* %28, align 8, !tbaa !48
  store double %29, double* %1, align 8, !tbaa !48
  br label %30

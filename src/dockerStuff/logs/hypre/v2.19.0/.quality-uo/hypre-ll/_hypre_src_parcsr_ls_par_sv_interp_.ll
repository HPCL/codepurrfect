...
define dso_local i32 @hypre_BoomerAMG_LNExpandInterp(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct** nocapture %1, i32* nocapture readonly %2, i32* nocapture %3, i32* nocapture readonly %4, i32** nocapture %5, i32* nocapture readonly %6, i32 %7, double* readonly %8, i32 %9, %struct.hypre_ParVector_struct** nocapture readonly %10, double %11, i32 %12, i32 %13) local_unnamed_addr #0 {
  ...
  %71 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %41, i64 0, i32 14
  %72 = load i32*, i32** %71, align 8, !tbaa !20
  %73 = load i32, i32* %3, align 4, !tbaa !18
  %74 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %41, i64 0, i32 15
  %75 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %74, align 8, !tbaa !21
  %76 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15
  %77 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %76, align 8, !tbaa !21
  ...
  %87 = icmp eq %struct._hypre_ParCSRCommPkg* %75, null
...
88:                                               ; preds = %14
  ...
  %91 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %90, i64 0, i32 15
  %92 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %91, align 8, !tbaa !21
  br label %93

93:                                               ; preds = %88, %14
  %94 = phi %struct._hypre_ParCSRCommPkg* [ %75, %14 ], [ %92, %88 ]
  %95 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %77, i64 0, i32 0
...
110:                                              ; preds = %93, %108, %106
  ...
  %112 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %77, i64 0, i32 1
  %113 = load i32, i32* %112, align 4, !tbaa !24
  %114 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %77, i64 0, i32 3
...
158:                                              ; preds = %154, %135
  ...
  %162 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %77, i64 0, i32 4
...
200:                                              ; preds = %169, %158
  %201 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct._hypre_ParCSRCommPkg* %77, i8* %126, i8* %160) #7
...
214:                                              ; preds = %211, %207
  ...
  %216 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %77, i64 0, i32 4
...
253:                                              ; preds = %223, %214
  ...
  %255 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %77, i8* %120, i8* %254) #7
  %256 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %255) #7
  br i1 %209, label %257, label %299

257:                                              ; preds = %253
  %258 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %77, i64 0, i32 4
...
295:                                              ; preds = %265, %257
  ...
  %297 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %77, i8* %120, i8* %296) #7
...
488:                                              ; preds = %479
  ...
  %493 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %77, i64 0, i32 4
...
550:                                              ; preds = %521, %499
  ...
  %552 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct._hypre_ParCSRCommPkg* %77, i8* %511, i8* %551) #7
...
3077:                                             ; preds = %3076
  ...
  %3080 = call i8* @hypre_ReAlloc(i8* %79, i64 %3079, i32 0) #7
...
3105:                                             ; preds = %3101, %3077
  ...
  %3107 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #7
...
3125:                                             ; preds = %3076
  ...
  %3129 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #7
...
3136:                                             ; preds = %3125, %3123
  ...
  %3141 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 14
  ...
  %3164 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3147, i64 0, i32 18
  store i32 0, i32* %3164, align 4, !tbaa !141
  %3165 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %3147, i64 0, i32 19
...
3171:                                             ; preds = %3168
  ...
  %3173 = call i8* @hypre_CAlloc(i64 %3172, i64 4, i32 0) #7
  %3174 = bitcast i8* %3173 to i32*
  %3175 = call i8* @hypre_CAlloc(i64 %3172, i64 4, i32 0) #7
...
3224:                                             ; preds = %3216, %3210
  call void @hypre_Free(i8* %3175, i32 0) #7
  br label %3225
...
3230:                                             ; preds = %3225, %3136
  ...
  call void @hypre_Free(i8* %3234, i32 0) #7
  call void @hypre_Free(i8* %254, i32 0) #7
  %3235 = bitcast i32* %215 to i8*
  call void @hypre_Free(i8* %3235, i32 0) #7
  ...
  call void @hypre_Free(i8* %3236, i32 0) #7
...
!47 = !{!48, !8, i64 0}
!48 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}

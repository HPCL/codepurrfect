...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_MGRBuildAffNew(%struct.hypre_ParCSRMatrix_struct* %0, i32* %1, i32 %2, %struct.hypre_ParCSRMatrix_struct** %3) local_unnamed_addr #0 {
  %5 = call i32 @hypre_MGRBuildAffNew(%struct.hypre_ParCSRMatrix_struct* %0, i32* %1, i32 %2, %struct.hypre_ParCSRMatrix_struct** %3) #2
  ret i32 %5
}

declare dso_local i32 @hypre_MGRBuildAffNew(%struct.hypre_ParCSRMatrix_struct*, i32*, i32, %struct.hypre_ParCSRMatrix_struct**) local_unnamed_addr #1

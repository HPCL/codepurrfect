...
define dso_local %struct.StoredRows* @StoredRowsCreate(%struct.Matrix* %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_MAlloc(i64 56, i32 0) #4
...
12:                                               ; preds = %5
  ...
  %18 = shl nsw i64 %17, 2
  %19 = call i8* @hypre_ReAlloc(i8* %16, i64 %18, i32 0) #4
  ...
  %23 = shl nsw i64 %17, 3
  %24 = call i8* @hypre_ReAlloc(i8* %22, i64 %23, i32 0) #4
  ...
  %28 = call i8* @hypre_ReAlloc(i8* %27, i64 %23, i32 0) #4

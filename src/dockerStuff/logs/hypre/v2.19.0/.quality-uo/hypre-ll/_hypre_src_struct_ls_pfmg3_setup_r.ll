...
define dso_local i32 @hypre_PFMG3BuildRAPSym(%struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6) local_unnamed_addr #0 {
  ...
  %24 = icmp eq i32 %23, 1
  %25 = getelementptr inbounds %struct.hypre_BoxArray_struct, %struct.hypre_BoxArray_struct* %19, i64 0, i32 1
  %26 = load i32, i32* %25, align 8, !tbaa !27
  %27 = icmp sgt i32 %26, 0
  br i1 %27, label %28, label %66

28:                                               ; preds = %7, %61
  %29 = phi i64 [ %62, %61 ], [ 0, %7 ]
  %30 = phi i64 [ %36, %61 ], [ 0, %7 ]
  %31 = getelementptr inbounds i32, i32* %21, i64 %29
...
45:                                               ; preds = %43
  %46 = call i32 @hypre_PFMG3BuildRAPSym_onebox_FSS07_CC1(i32 %44, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

47:                                               ; preds = %43
  %48 = call i32 @hypre_PFMG3BuildRAPSym_onebox_FSS07_CC0(i32 %44, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

49:                                               ; preds = %41
  %50 = trunc i64 %29 to i32
  br i1 %24, label %51, label %53

51:                                               ; preds = %49
  %52 = call i32 @hypre_PFMG3BuildRAPSym_onebox_FSS19_CC1(i32 %50, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

53:                                               ; preds = %49
  %54 = call i32 @hypre_PFMG3BuildRAPSym_onebox_FSS19_CC0(i32 %50, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61
...
57:                                               ; preds = %55
  %58 = call i32 @hypre_PFMG3BuildRAPSym_onebox_FSS27_CC1(i32 %56, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

59:                                               ; preds = %55
  %60 = call i32 @hypre_PFMG3BuildRAPSym_onebox_FSS27_CC0(i32 %56, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

61:                                               ; preds = %47, %45, %53, %51, %59, %57
  %62 = add nuw nsw i64 %29, 1
  %63 = load i32, i32* %25, align 8, !tbaa !27
  %64 = sext i32 %63 to i64
  %65 = icmp slt i64 %62, %64
  br i1 %65, label %28, label %66, !llvm.loop !30

66:                                               ; preds = %61, %7
  %67 = load i32, i32* @hypre__global_error, align 4, !tbaa !12
  ret i32 %67
}
...
35:                                               ; preds = %35, %28
  ...
  %39 = icmp eq i32 %38, %32
  %40 = add i64 %36, 1
  br i1 %39, label %41, label %35, !llvm.loop !108
...
45:                                               ; preds = %43
  %46 = call i32 @hypre_PFMG3BuildRAPNoSym_onebox_FSS07_CC1(i32 %44, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

47:                                               ; preds = %43
  %48 = call i32 @hypre_PFMG3BuildRAPNoSym_onebox_FSS07_CC0(i32 %44, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61
...
51:                                               ; preds = %49
  %52 = call i32 @hypre_PFMG3BuildRAPNoSym_onebox_FSS19_CC1(i32 %50, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

53:                                               ; preds = %49
  %54 = call i32 @hypre_PFMG3BuildRAPNoSym_onebox_FSS19_CC0(i32 %50, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61
...
57:                                               ; preds = %55
  %58 = call i32 @hypre_PFMG3BuildRAPNoSym_onebox_FSS27_CC1(i32 %56, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61

59:                                               ; preds = %55
  %60 = call i32 @hypre_PFMG3BuildRAPNoSym_onebox_FSS27_CC0(i32 %56, i32 %42, %struct.hypre_StructMatrix_struct* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructMatrix_struct* %2, i32 %3, i32* %4, i32* %5, %struct.hypre_StructMatrix_struct* %6)
  br label %61
...
61:                                               ; preds = %47, %45, %53, %51, %59, %57
  ...
  %64 = sext i32 %63 to i64
  %65 = icmp slt i64 %62, %64
  br i1 %65, label %28, label %66, !llvm.loop !109

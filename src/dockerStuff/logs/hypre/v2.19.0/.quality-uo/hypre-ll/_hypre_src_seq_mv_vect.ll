...
define dso_local %struct.hypre_Vector* @hypre_SeqVectorCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #7
  ...
  %13 = call %struct.hypre_Handle* (...) @hypre_handle() #7
...
define dso_local %struct.hypre_Vector* @hypre_SeqMultiVectorCreate(i32 %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #7
  ...
  %14 = call %struct.hypre_Handle* (...) @hypre_handle() #7
...
13:                                               ; preds = %2
  ...
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 %1) #7
...
11:                                               ; preds = %1
  ...
  %14 = mul nsw i32 %5, %3
  %15 = sext i32 %14 to i64
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 %13) #7
  %17 = bitcast %struct.hypre_Vector* %0 to i8**
  store i8* %16, i8** %17, align 8, !tbaa !3
  br label %18
...
define dso_local %struct.hypre_Vector* @hypre_SeqVectorRead(i8* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %7 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #7
  ...
  %17 = call %struct.hypre_Handle* (...) @hypre_handle() #7
...
36:                                               ; preds = %1
  ...
  %39 = call i8* @hypre_CAlloc(i64 %38, i64 8, i32 0) #7
...
54:                                               ; preds = %50, %54
  ...
  %57 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fscanf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %56) #7
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SeqVectorSetConstantValues(%struct.hypre_Vector* nocapture readonly %0, double %1) local_unnamed_addr #0 {
...
19:                                               ; preds = %14, %2
  %20 = call %struct.hypre_Handle* (...) @hypre_handle() #7
  ret i32 0
}
...
43:                                               ; preds = %35, %26
  ...
  call void @hypre_Memcpy(i8* %44, i8* %29, i64 %28, i32 %45, i32 0) #7
...
define dso_local i32 @hypre_SeqVectorCopy(%struct.hypre_Vector* nocapture readonly %0, %struct.hypre_Vector* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  call void @hypre_Memcpy(i8* %14, i8* %16, i64 %17, i32 %19, i32 %21) #7
  ret i32 0
}
...
55:                                               ; preds = %52, %50
  ...
  call void @hypre_Memcpy(i8* %65, i8* %67, i64 %68, i32 %69, i32 %71) #7
...
define dso_local %struct.hypre_Vector* @hypre_SeqVectorCloneShallow(%struct.hypre_Vector* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %4 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %0, i64 0, i32 4
  %5 = load i32, i32* %4, align 4, !tbaa !10
  %6 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #7
  ...
  %16 = call %struct.hypre_Handle* (...) @hypre_handle() #7
...
49:                                               ; preds = %1
  ...
  %52 = call i8* @hypre_CAlloc(i64 %51, i64 8, i32 %34) #7
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SeqVectorScale(double %0, %struct.hypre_Vector* nocapture readonly %1) local_unnamed_addr #0 {
...
14:                                               ; preds = %11, %14
  ...
  %18 = fmul double %17, %0
  store double %18, double* %16, align 8, !tbaa !22
  %19 = add nuw nsw i64 %15, 1
  %20 = icmp eq i64 %19, %13
  br i1 %20, label %21, label %14, !llvm.loop !30

21:                                               ; preds = %14, %2
  %22 = call %struct.hypre_Handle* (...) @hypre_handle() #7
  ret i32 0
}

; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_SeqVectorAxpy(double %0, %struct.hypre_Vector* nocapture readonly %1, %struct.hypre_Vector* nocapture readonly %2) local_unnamed_addr #0 {
...
27:                                               ; preds = %17, %3
  %28 = call %struct.hypre_Handle* (...) @hypre_handle() #7
  ret i32 0
}

; Function Attrs: nounwind uwtable
define dso_local double @hypre_SeqVectorInnerProd(%struct.hypre_Vector* nocapture readonly %0, %struct.hypre_Vector* nocapture readonly %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %0, i64 0, i32 0
  %4 = load double*, double** %3, align 8, !tbaa !3
...
27:                                               ; preds = %16, %2
  ...
  %29 = call %struct.hypre_Handle* (...) @hypre_handle() #7
  ret double %28
}

; Function Attrs: nofree norecurse nosync nounwind readonly uwtable
define dso_local double @hypre_SeqVectorSumElts(%struct.hypre_Vector* nocapture readonly %0) local_unnamed_addr #5 {
...
!12 = !{!4, !8, i64 12}
!13 = !{!14, !6, i64 4}
!14 = !{!"", !8, i64 0, !6, i64 4, !5, i64 8, !5, i64 16, !8, i64 24, !8, i64 28}
!15 = !{!4, !6, i64 16}
!16 = !{!4, !8, i64 28}
!17 = !{!4, !8, i64 32}
!18 = !{!8, !8, i64 0}

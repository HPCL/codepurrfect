...
define dso_local i32 @hypre_dgels(i8* %0, i32* %1, i32* %2, i32* %3, double* %4, i32* %5, double* %6, i32* %7, double* %8, i32* nocapture readonly %9, i32* %10) local_unnamed_addr #0 {
  ...
  %26 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #4
  %27 = icmp eq i64 %26, 0
  br i1 %27, label %28, label %31

28:                                               ; preds = %11
  %29 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #4
  %30 = icmp eq i64 %29, 0
...
66:                                               ; preds = %64, %64
  ...
  %67 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #4
  %68 = icmp eq i64 %67, 0
...
114:                                              ; preds = %111
  ...
  %116 = call i32 @hypre_lapack_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.9, i64 0, i64 0), i32* nonnull %12) #4
  br label %296

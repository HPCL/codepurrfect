...
18:                                               ; preds = %6
  ...
  %20 = call i8* @hypre_CAlloc(i64 %19, i64 4, i32 0) #11
...
define dso_local i32 @hypre_cr(i32* nocapture readonly %0, i32* nocapture readonly %1, double* nocapture readonly %2, i32 %3, i32* nocapture %4, i32 %5, double %6, double %7, i32 %8) local_unnamed_addr #0 {
  ...
  %11 = call i8* @hypre_CAlloc(i64 %10, i64 8, i32 0) #11
  %12 = bitcast i8* %11 to double*
  %13 = call i8* @hypre_CAlloc(i64 %10, i64 8, i32 0) #11
...
define dso_local i32 @hypre_IndepSetGreedy(i32* nocapture readonly %0, i32* nocapture readonly %1, i32 %2, i32* nocapture %3) local_unnamed_addr #0 {
  %5 = sext i32 %2 to i64
  %6 = call i8* @hypre_CAlloc(i64 %5, i64 4, i32 0) #11
...
56:                                               ; preds = %52, %4
  ...
  %63 = call i8* @hypre_CAlloc(i64 %59, i64 4, i32 0) #11
  %64 = bitcast i8* %63 to i32*
  %65 = getelementptr inbounds i32, i32* %64, i64 %59
  %66 = call i8* @hypre_CAlloc(i64 %5, i64 8, i32 0) #11
...
54:                                               ; preds = %50, %4
  ...
  %58 = call i8* @hypre_CAlloc(i64 %57, i64 4, i32 0) #11
  %59 = bitcast i8* %58 to i32*
  %60 = getelementptr inbounds i32, i32* %59, i64 %57
  %61 = call i8* @hypre_CAlloc(i64 %57, i64 4, i32 0) #11
  %62 = bitcast i8* %61 to i32*
  %63 = getelementptr inbounds i32, i32* %62, i64 %57
  %64 = call i8* @hypre_CAlloc(i64 %5, i64 8, i32 0) #11
...
define dso_local i32 @hypre_BoomerAMGIndepRS(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32 %2, i32* nocapture %3) local_unnamed_addr #0 {
  ...
  %32 = call i8* @hypre_CAlloc(i64 %31, i64 4, i32 0) #11
  %33 = bitcast i8* %32 to i32*
  %34 = call i8* @hypre_CAlloc(i64 %31, i64 4, i32 0) #11
...
60:                                               ; preds = %57, %52
  ...
  %67 = call i8* @hypre_CAlloc(i64 %66, i64 4, i32 0) #11
  %68 = bitcast i8* %67 to i32*
  %69 = sext i32 %63 to i64
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 4, i32 0) #11
...
156:                                              ; preds = %154
  %157 = call i8* @hypre_CAlloc(i64 %31, i64 4, i32 0) #11
...
202:                                              ; preds = %201
  ...
  %204 = call i8* @hypre_CAlloc(i64 %203, i64 4, i32 0) #11
...
213:                                              ; preds = %209, %206
  ...
  %220 = call i8* @hypre_CAlloc(i64 %219, i64 4, i32 0) #11
...
262:                                              ; preds = %259
  ...
  %264 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %53, i8* %220, i8* %263) #11
...
266:                                              ; preds = %262, %259
  ...
  %270 = call i8* @hypre_CAlloc(i64 %269, i64 4, i32 0) #11
...
344:                                              ; preds = %341, %279
  ...
  call void @hypre_Free(i8* %345, i32 0) #11
...
348:                                              ; preds = %344
  ...
  %351 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct._hypre_ParCSRCommPkg* %53, i8* %350, i8* %220) #11
  br label %352
...
398:                                              ; preds = %366, %358
  call void @hypre_Free(i8* %220, i32 0) #11
  br label %399
...
657:                                              ; preds = %526, %464
  ...
  call void @hypre_Free(i8* %658, i32 0) #11
...
204:                                              ; preds = %203
  ...
  %206 = call i8* @hypre_CAlloc(i64 %205, i64 4, i32 0) #11
...
215:                                              ; preds = %211, %208
  ...
  %222 = call i8* @hypre_CAlloc(i64 %221, i64 4, i32 0) #11
...
264:                                              ; preds = %261
  ...
  %266 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %53, i8* %222, i8* %265) #11
...
268:                                              ; preds = %264, %261
  ...
  %272 = call i8* @hypre_CAlloc(i64 %271, i64 4, i32 0) #11
...
348:                                              ; preds = %345, %281
  ...
  call void @hypre_Free(i8* %349, i32 0) #11
...
352:                                              ; preds = %348
  ...
  %355 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct._hypre_ParCSRCommPkg* %53, i8* %354, i8* %222) #11
  br label %356
...
402:                                              ; preds = %370, %362
  call void @hypre_Free(i8* %222, i32 0) #11
  br label %403
...
667:                                              ; preds = %532, %468
  ...
  call void @hypre_Free(i8* %668, i32 0) #11
...
43:                                               ; preds = %40, %37
  ...
  %59 = call i8* @hypre_CAlloc(i64 %58, i64 8, i32 0) #11
...
70:                                               ; preds = %68
  ...
  %72 = call i8* @hypre_CAlloc(i64 %71, i64 4, i32 0) #11
...
122:                                              ; preds = %119
  ...
  %124 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %44, i8* %53, i8* %123) #11
...
126:                                              ; preds = %122, %119
  ...
  %130 = call i8* @hypre_CAlloc(i64 %129, i64 8, i32 0) #11
...
205:                                              ; preds = %202
  ...
  %209 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct._hypre_ParCSRCommPkg* %44, i8* %208, i8* %59) #11
  br label %210
...
284:                                              ; preds = %283
  ...
  %286 = call i8* @hypre_CAlloc(i64 %285, i64 4, i32 0) #11
...
299:                                              ; preds = %293, %288
  ...
  %301 = call i8* @hypre_CAlloc(i64 %300, i64 4, i32 0) #11
...
410:                                              ; preds = %407
  ...
  %413 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct._hypre_ParCSRCommPkg* %44, i8* %59, i8* %412) #11
...
554:                                              ; preds = %551
  %555 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct._hypre_ParCSRCommPkg* %44, i8* %423, i8* %53) #11
...
605:                                              ; preds = %602
  %606 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %44, i8* %53, i8* %426) #11
...
714:                                              ; preds = %711
  %715 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %44, i8* %53, i8* %429) #11
...
771:                                              ; preds = %768
  call void @hypre_Free(i8* %130, i32 0) #11
  call void @hypre_Free(i8* %301, i32 0) #11
  br i1 %64, label %774, label %772

772:                                              ; preds = %771
  %773 = bitcast i32* %289 to i8*
  call void @hypre_Free(i8* %773, i32 0) #11
  br label %774

774:                                              ; preds = %772, %771
  call void @hypre_Free(i8* %59, i32 0) #11
  call void @hypre_Free(i8* %53, i32 0) #11
  %775 = bitcast i32* %75 to i8*
  call void @hypre_Free(i8* %775, i32 0) #11
...
207:                                              ; preds = %204
  ...
  %211 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 2, %struct._hypre_ParCSRCommPkg* %44, i8* %210, i8* %59) #11
  br label %212
...
286:                                              ; preds = %285
  ...
  %288 = call i8* @hypre_CAlloc(i64 %287, i64 4, i32 0) #11
...
301:                                              ; preds = %295, %290
  ...
  %303 = call i8* @hypre_CAlloc(i64 %302, i64 4, i32 0) #11
...
412:                                              ; preds = %409
  ...
  %415 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct._hypre_ParCSRCommPkg* %44, i8* %59, i8* %414) #11
...
558:                                              ; preds = %555
  %559 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 12, %struct._hypre_ParCSRCommPkg* %44, i8* %425, i8* %53) #11
...
609:                                              ; preds = %606
  %610 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %44, i8* %53, i8* %428) #11
...
714:                                              ; preds = %711
  %715 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct._hypre_ParCSRCommPkg* %44, i8* %53, i8* %431) #11
  %716 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %715) #11
  br label %717
...
771:                                              ; preds = %768
  call void @hypre_Free(i8* %130, i32 0) #11
  call void @hypre_Free(i8* %303, i32 0) #11
  br i1 %64, label %774, label %772
...
59:                                               ; preds = %14
  ...
  %61 = call i8* @hypre_CAlloc(i64 %60, i64 4, i32 0) #11
  %62 = icmp sgt i32 %45, 0
  br i1 %62, label %69, label %75

63:                                               ; preds = %14
  %64 = sext i32 %50 to i64
  %65 = call i8* @hypre_CAlloc(i64 %64, i64 4, i32 0) #11
  %66 = call i8* @hypre_CAlloc(i64 %64, i64 8, i32 0) #11
...
691:                                              ; preds = %681, %677
  ...
  call void @hypre_Free(i8* %694, i32 0) #11

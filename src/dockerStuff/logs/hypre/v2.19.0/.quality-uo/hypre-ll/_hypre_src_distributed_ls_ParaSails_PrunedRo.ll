...
define dso_local %struct.PrunedRows* @PrunedRowsCreate(%struct.Matrix* %0, i32 %1, %struct.DiagScale* %2, double %3) local_unnamed_addr #0 {
  ...
  %11 = call i8* @hypre_MAlloc(i64 32, i32 0) #5
  ...
  %32 = shl nsw i64 %31, 3
  %33 = call i8* @hypre_MAlloc(i64 %32, i32 0) #5
...
8:                                                ; preds = %4
  ...
  %14 = shl nsw i64 %13, 2
  %15 = call i8* @hypre_ReAlloc(i8* %12, i64 %14, i32 0) #5
  ...
  %21 = shl nsw i64 %20, 3
  %22 = call i8* @hypre_ReAlloc(i8* %18, i64 %21, i32 0) #5

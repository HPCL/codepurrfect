...
131:                                              ; preds = %127, %98
  ...
  %136 = call i8* @hypre_CAlloc(i64 %133, i64 20, i32 0) #5
...
188:                                              ; preds = %178, %173
  ...
  %191 = call i8* @hypre_CAlloc(i64 %190, i64 4, i32 0) #5
...
222:                                              ; preds = %218, %188
  ...
  %226 = call i8* @hypre_CAlloc(i64 %225, i64 4, i32 0) #5
  %227 = bitcast i8* %226 to i32*
  %228 = load i32, i32* %223, align 4, !tbaa !22
  %229 = sext i32 %228 to i64
  %230 = call i8* @hypre_CAlloc(i64 %229, i64 4, i32 0) #5
...
294:                                              ; preds = %284, %279
  %295 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #5
  ...
  call void @hypre_Free(i8* %226, i32 0) #5
  ...
  call void @hypre_Free(i8* %139, i32 0) #5

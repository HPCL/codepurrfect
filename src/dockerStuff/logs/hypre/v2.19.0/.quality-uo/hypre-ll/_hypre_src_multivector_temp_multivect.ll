...
define dso_local i8* @mv_TempMultiVectorCreateFromSampleVector(i8* %0, i32 %1, i8* %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_MAlloc(i64 40, i32 0) #5
  ...
  %8 = sext i32 %1 to i64
  %9 = call i8* @hypre_CAlloc(i64 %8, i64 8, i32 0) #5
...
define dso_local i8* @mv_TempMultiVectorCreateCopy(i8* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %12 = call i8* @hypre_MAlloc(i64 40, i32 0) #5
  ...
  %17 = call i8* @hypre_CAlloc(i64 %16, i64 8, i32 0) #5
...
45:                                               ; preds = %35, %23, %31
  ...
  %48 = call i8* @hypre_CAlloc(i64 %47, i64 8, i32 0) #5
  %49 = bitcast i8* %48 to i8**
  %50 = sext i32 %46 to i64
  %51 = call i8* @hypre_CAlloc(i64 %50, i64 8, i32 0) #5
...
136:                                              ; preds = %134, %136
  ...
  %145 = call i32 %140(i8* %142, i8* %144) #5
...
46:                                               ; preds = %36, %24, %32
  ...
  %49 = call i8* @hypre_CAlloc(i64 %48, i64 8, i32 0) #5
  %50 = bitcast i8* %49 to i8**
  %51 = sext i32 %47 to i64
  %52 = call i8* @hypre_CAlloc(i64 %51, i64 8, i32 0) #5
...
137:                                              ; preds = %135, %137
  ...
  %146 = call i32 %141(double %0, i8* %143, i8* %145) #5
...
49:                                               ; preds = %39, %27, %35
  ...
  %55 = call i8* @hypre_CAlloc(i64 %54, i64 8, i32 0) #5
...
148:                                              ; preds = %144, %148
  ...
  %157 = call double %153(i8* %155, i8* %156) #5
...
65:                                               ; preds = %55, %48, %51
  ...
  %68 = call i8* @hypre_CAlloc(i64 %67, i64 8, i32 0) #5
  %69 = bitcast i8* %68 to i8**
  %70 = sext i32 %49 to i64
  %71 = call i8* @hypre_CAlloc(i64 %70, i64 8, i32 0) #5
...
189:                                              ; preds = %187, %189
  ...
  %198 = call double %193(i8* %195, i8* %197) #5
...
153:                                              ; preds = %144, %153
  ...
  %163 = call i32 %158(double %159, i8* %161, i8* %162) #5
...
148:                                              ; preds = %144, %148
  ...
  %158 = call i32 %153(double %154, i8* %156, i8* %157) #5
...
68:                                               ; preds = %65
  ...
  %76 = call i8* @hypre_CAlloc(i64 %75, i64 4, i32 0) #5
...
191:                                              ; preds = %189, %191
  ...
  %211 = call i32 %201(double %207, i8* %209, i8* %210) #5
...
50:                                               ; preds = %40, %28, %36
  ...
  %53 = call i8* @hypre_CAlloc(i64 %52, i64 8, i32 0) #5
  %54 = bitcast i8* %53 to i8**
  %55 = sext i32 %51 to i64
  %56 = call i8* @hypre_CAlloc(i64 %55, i64 8, i32 0) #5
...
139:                                              ; preds = %137, %139
  ...
  %144 = load i8*, i8** %143, align 8, !tbaa !16
  call void %0(i8* %1, i8* %142, i8* %144) #5

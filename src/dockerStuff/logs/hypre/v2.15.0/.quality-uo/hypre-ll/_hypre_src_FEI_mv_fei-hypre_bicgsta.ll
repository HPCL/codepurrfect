...
define dso_local i8* @hypre_BiCGSTABLCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 208, i32 1) #9
...
8:                                                ; preds = %3
  ...
  call void @hypre_Free(i8* %12, i32 1) #9
...
13:                                               ; preds = %8, %3
  ...
  call void @hypre_Free(i8* nonnull %0, i32 1) #9
  br label %74
...
120:                                              ; preds = %118, %113
  %121 = call i32 %10(i8* %13, i8* %1, i8* %2, i8* %3) #9
...
131:                                              ; preds = %126
  ...
  %134 = call i8* @hypre_CAlloc(i64 %133, i64 8, i32 1) #9
...
define dso_local i32 @hypre_BiCGSTABLSolve(i8* %0, i8* %1, i8* %2, i8* %3) local_unnamed_addr #0 {
  ...
  %62 = bitcast i8* %61 to i32 (i8*, i8*, i8*, i8*)**
  %63 = load i32 (i8*, i8*, i8*, i8*)*, i32 (i8*, i8*, i8*, i8*)** %62, align 8, !tbaa !13
...
98:                                               ; preds = %88, %96, %79
  ...
  %107 = call i32 %63(i8* %66, i8* %1, i8* %24, i8* %30) #9
...
138:                                              ; preds = %132
  %139 = call i32 %63(i8* %66, i8* %1, i8* %36, i8* %30) #9
...
156:                                              ; preds = %132
  ...
  %159 = call i32 %63(i8* %66, i8* %1, i8* %36, i8* %30) #9
...
205:                                              ; preds = %156, %138
  ...
  %217 = call i32 %63(i8* %66, i8* %1, i8* %24, i8* %30) #9
  ...
  %221 = call i32 %63(i8* %66, i8* %1, i8* %3, i8* %30) #9
...
233:                                              ; preds = %229, %98
  ...
  %238 = call i32 %63(i8* %66, i8* %1, i8* %3, i8* %30) #9
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_BiCGSTABLSetPrecond(i8* nocapture %0, i32 (i8*, i8*, i8*, i8*)* %1, i32 (i8*, i8*, i8*, i8*)* %2, i8* %3) local_unnamed_addr #5 {

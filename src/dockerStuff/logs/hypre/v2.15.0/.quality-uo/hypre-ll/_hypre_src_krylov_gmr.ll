...
793:                                              ; preds = %790, %788
  %794 = icmp slt i32 %774, %17
  br i1 %794, label %800, label %795

795:                                              ; preds = %793
  %796 = fcmp ogt double %775, %171
  %797 = fcmp ogt double %171, 0.000000e+00
  %798 = and i1 %797, %796
  br i1 %798, label %799, label %800

799:                                              ; preds = %795
  call void @hypre_error_handler(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i64 0, i64 0), i32 836, i32 256, i8* null) #7
  br label %800

800:                                              ; preds = %799, %795, %793
  %801 = getelementptr inbounds %struct.hypre_GMRESFunctions, %struct.hypre_GMRESFunctions* %9, i64 0, i32 1
  %802 = load i32 (i8*)*, i32 (i8*)** %801, align 8, !tbaa !8
  %803 = call i32 %802(i8* %84) #7
  %804 = load i32 (i8*)*, i32 (i8*)** %801, align 8, !tbaa !8
  %805 = call i32 %804(i8* %87) #7
  %806 = load i32 (i8*)*, i32 (i8*)** %801, align 8, !tbaa !8
  %807 = call i32 %806(i8* %80) #7
  br i1 %89, label %808, label %812

808:                                              ; preds = %800
  %809 = load i32 (i8*)*, i32 (i8*)** %801, align 8, !tbaa !8
  %810 = bitcast double* %95 to i8*
  %811 = call i32 %809(i8* %810) #7
  br label %812

812:                                              ; preds = %808, %800
  %813 = icmp slt i32 %11, 0
...
817:                                              ; preds = %814, %817
  %818 = phi i64 [ 0, %814 ], [ %824, %817 ]
  %819 = load i32 (i8*)*, i32 (i8*)** %801, align 8, !tbaa !8
  %820 = getelementptr inbounds double*, double** %98, i64 %818
  %821 = bitcast double** %820 to i8**
  %822 = load i8*, i8** %821, align 8, !tbaa !39
  %823 = call i32 %819(i8* %822) #7
  store double* null, double** %820, align 8, !tbaa !39
  %824 = add nuw nsw i64 %818, 1
  %825 = icmp eq i64 %824, %816
  br i1 %825, label %826, label %817, !llvm.loop !70

826:                                              ; preds = %817, %812
  %827 = load i32 (i8*)*, i32 (i8*)** %801, align 8, !tbaa !8
  %828 = call i32 %827(i8* %97) #7
  br label %829

829:                                              ; preds = %826, %235, %152, %135
  %830 = load i32, i32* @hypre__global_error, align 4, !tbaa !43

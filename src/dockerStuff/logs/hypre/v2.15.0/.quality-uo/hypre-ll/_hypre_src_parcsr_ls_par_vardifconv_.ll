...
29:                                               ; preds = %28, %13
  ...
  %39 = call i8* @hypre_CAlloc(i64 %38, i64 4, i32 1) #5
...
100:                                              ; preds = %49, %29
  ...
  %141 = call i8* @hypre_CAlloc(i64 %140, i64 8, i32 1) #5
...
305:                                              ; preds = %299, %100
  ...
  %309 = call i8* @hypre_CAlloc(i64 %308, i64 4, i32 1) #5
  %310 = bitcast i8* %309 to i32*
  %311 = load i32, i32* %306, align 4, !tbaa !3
  %312 = sext i32 %311 to i64
  %313 = call i8* @hypre_CAlloc(i64 %312, i64 8, i32 1) #5
...
766:                                              ; preds = %763, %740, %726
  ...
  call void @hypre_Free(i8* %39, i32 1) #5
  %775 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #5

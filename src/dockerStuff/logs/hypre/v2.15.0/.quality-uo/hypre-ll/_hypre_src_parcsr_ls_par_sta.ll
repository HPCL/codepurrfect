...
@.str.60 = private unnamed_addr constant [30 x i8] c"%2d %7d %8.0f  %0.3f  %4d %4d\00", align 1
...
@.str.70 = private unnamed_addr constant [23 x i8] c"%2d %5d x %-5d %3d %3d\00", align 1
...
233:                                              ; preds = %229
  ...
  %248 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %237, i64 0, i32 3
  ...
  %263 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %237, i64 0, i32 4
...
392:                                              ; preds = %229
  ...
  %397 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %396, i64 0, i32 6
  ...
  %403 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %402, i64 0, i32 6
...
429:                                              ; preds = %425, %415, %419
  ...
  %434 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %396, i64 0, i32 2
...
636:                                              ; preds = %634
  ...
  %662 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %640, i64 0, i32 4
  %663 = load i32, i32* %662, align 4, !tbaa !57
  %664 = icmp eq i32 %663, 0
  br i1 %664, label %1010, label %665

665:                                              ; preds = %636
  %666 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %640, i64 0, i32 5
...
836:                                              ; preds = %634
  ...
  %841 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %840, i64 0, i32 6
  ...
  %847 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %846, i64 0, i32 6
  ...
  %864 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %840, i64 0, i32 2
...
!48 = !{!49, !8, i64 0}
!49 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !5, i64 36, !5, i64 40}
!50 = !{!49, !8, i64 8}
!51 = !{!47, !8, i64 40}
!52 = !{!49, !5, i64 24}
!53 = !{!47, !8, i64 56}
...
!65 = !{!4, !8, i64 32}
!66 = !{!67, !8, i64 32}
!67 = !{!"", !8, i64 0, !8, i64 8, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !5, i64 48}
!68 = !{!67, !8, i64 0}
!69 = !{!4, !8, i64 40}
!70 = !{!4, !8, i64 72}
!71 = !{!4, !5, i64 4}

...
define dso_local i8* @hypre_TFQmrCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 168, i32 1) #9
...
91:                                               ; preds = %89, %84
  %92 = call i32 %9(i8* %12, i8* %1, i8* %2, i8* %3) #9
...
102:                                              ; preds = %97
  ...
  %105 = call i8* @hypre_CAlloc(i64 %104, i64 8, i32 1) #9
...
define dso_local i32 @hypre_TFQmrSolve(i8* %0, i8* %1, i8* %2, i8* %3) local_unnamed_addr #0 {
  ...
  %50 = load i32 (i8*, i8*, i8*, i8*)*, i32 (i8*, i8*, i8*, i8*)** %49, align 8, !tbaa !12
...
84:                                               ; preds = %74, %82, %66
  ...
  %95 = call i32 %50(i8* %53, i8* %1, i8* %26, i8* %47) #9
...
140:                                              ; preds = %104, %138
  %141 = call i32 %50(i8* %53, i8* %1, i8* %29, i8* %47) #9
...
169:                                              ; preds = %167, %140
  ...
  %174 = call i32 %50(i8* %53, i8* %1, i8* %26, i8* %47) #9
...
183:                                              ; preds = %169, %84
  ...
  %188 = call i32 %50(i8* %53, i8* %1, i8* %3, i8* %47) #9
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_TFQmrSetPrecond(i8* nocapture %0, i32 (i8*, i8*, i8*, i8*)* %1, i32 (i8*, i8*, i8*, i8*)* %2, i8* %3) local_unnamed_addr #5 {

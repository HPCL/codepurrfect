...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateRotate7pt(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, double %7, double %8) local_unnamed_addr #0 {
  ...
  %20 = mul nsw i32 %2, %1
  %21 = call i8* @hypre_CAlloc(i64 4, i64 8, i32 1) #4
...
287:                                              ; preds = %281, %103
  ...
  %292 = call i8* @hypre_CAlloc(i64 %291, i64 4, i32 2) #4
  %293 = bitcast i8* %292 to i32*
  %294 = load i32, i32* %289, align 4, !tbaa !7
  %295 = sext i32 %294 to i64
  %296 = call i8* @hypre_CAlloc(i64 %295, i64 8, i32 2) #4
...
580:                                              ; preds = %578, %593
  ...
  %586 = getelementptr inbounds i32, i32* %164, i64 %585
...
589:                                              ; preds = %580
  ...
  store i32 %584, i32* %592, align 4, !tbaa !7
  br label %593
...
597:                                              ; preds = %593, %574
  ...
  %601 = icmp sgt i32 %557, 0
  br i1 %601, label %602, label %625

602:                                              ; preds = %597
  %603 = add i32 %598, 1
  %604 = zext i32 %557 to i64
  %605 = zext i32 %603 to i64
  br label %606

606:                                              ; preds = %602, %622
  %607 = phi i64 [ 0, %602 ], [ %623, %622 ]
  br i1 %600, label %622, label %608

608:                                              ; preds = %606
  %609 = getelementptr inbounds i32, i32* %312, i64 %607
  %610 = load i32, i32* %609, align 4, !tbaa !7
  br label %611

611:                                              ; preds = %608, %619
  %612 = phi i64 [ 0, %608 ], [ %620, %619 ]
  %613 = getelementptr inbounds i32, i32* %164, i64 %612
...
616:                                              ; preds = %611
  ...
  %618 = getelementptr inbounds i32, i32* %312, i64 %607
  store i32 %617, i32* %618, align 4, !tbaa !7
  br label %622

619:                                              ; preds = %611
  %620 = add nuw nsw i64 %612, 1
  %621 = icmp eq i64 %620, %605
  br i1 %621, label %622, label %611, !llvm.loop !21

622:                                              ; preds = %619, %606, %616
  %623 = add nuw nsw i64 %607, 1
  %624 = icmp eq i64 %623, %604
  br i1 %624, label %625, label %606, !llvm.loop !22
...
626:                                              ; preds = %625, %556
  %627 = phi i32 [ %599, %625 ], [ %161, %556 ]
  %628 = load i32, i32* %13, align 4, !tbaa !7
  ...
  %636 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4
  %637 = bitcast i8* %636 to i32*
  store i32 %631, i32* %637, align 4, !tbaa !7
  %638 = getelementptr inbounds i8, i8* %636, i64 4
  %639 = bitcast i8* %638 to i32*
  store i32 %635, i32* %639, align 4, !tbaa !7
  %640 = load i32, i32* %289, align 4, !tbaa !7
  %641 = getelementptr inbounds i32, i32* %130, i64 %288
  %642 = load i32, i32* %641, align 4, !tbaa !7
  %643 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %0, i32 %20, i32 %20, i32* nonnull %637, i32* nonnull %637, i32 %627, i32 %640, i32 %642) #4
  %644 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %643, i64 0, i32 11
  %645 = bitcast i32** %644 to i8**
  store i8* %163, i8** %645, align 8, !tbaa !23
  %646 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %643, i64 0, i32 7
  %647 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %646, align 8, !tbaa !25
  %648 = bitcast %struct.hypre_CSRMatrix* %647 to i8**
  store i8* %127, i8** %648, align 8, !tbaa !26
  %649 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %647, i64 0, i32 1
  %650 = bitcast i32** %649 to i8**
  store i8* %292, i8** %650, align 8, !tbaa !28
  %651 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %647, i64 0, i32 6
  %652 = bitcast double** %651 to i8**
  store i8* %296, i8** %652, align 8, !tbaa !29
  %653 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %643, i64 0, i32 8
  %654 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %653, align 8, !tbaa !30
  %655 = bitcast %struct.hypre_CSRMatrix* %654 to i8**
  store i8* %129, i8** %655, align 8, !tbaa !26
  %656 = icmp eq i32 %627, 0
  br i1 %656, label %660, label %657

657:                                              ; preds = %626
  %658 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %654, i64 0, i32 1
  store i32* %312, i32** %658, align 8, !tbaa !28
  %659 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %654, i64 0, i32 6
  store double* %311, double** %659, align 8, !tbaa !29
  br label %660

660:                                              ; preds = %657, %626
  %661 = bitcast i32** %10 to i8**
  %662 = load i8*, i8** %661, align 8, !tbaa !13
  call void @hypre_Free(i8* %662, i32 1) #4
  store i32* null, i32** %10, align 8, !tbaa !13
  %663 = bitcast i32** %11 to i8**
  %664 = load i8*, i8** %663, align 8, !tbaa !13
  call void @hypre_Free(i8* %664, i32 1) #4
  store i32* null, i32** %11, align 8, !tbaa !13
  call void @hypre_Free(i8* %21, i32 1) #4
  ...
  ret %struct.hypre_ParCSRMatrix_struct* %643
}

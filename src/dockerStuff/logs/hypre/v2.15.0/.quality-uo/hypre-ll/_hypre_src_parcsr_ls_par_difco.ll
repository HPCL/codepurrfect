...
94:                                               ; preds = %43, %11
  ...
  %130 = call i8* @hypre_CAlloc(i64 %129, i64 4, i32 2) #3
  %131 = bitcast i8* %130 to i32*
  %132 = call i8* @hypre_CAlloc(i64 %129, i64 4, i32 2) #3
...
287:                                              ; preds = %281, %94
  ...
  %292 = call i8* @hypre_CAlloc(i64 %291, i64 4, i32 2) #3
  %293 = bitcast i8* %292 to i32*
  %294 = load i32, i32* %289, align 4, !tbaa !3
  %295 = sext i32 %294 to i64
  %296 = call i8* @hypre_CAlloc(i64 %295, i64 8, i32 2) #3
...
300:                                              ; preds = %287
  ...
  %304 = call i8* @hypre_CAlloc(i64 %303, i64 4, i32 2) #3
  %305 = bitcast i8* %304 to i32*
  %306 = load i32, i32* %301, align 4, !tbaa !3
  %307 = sext i32 %306 to i64
  %308 = call i8* @hypre_CAlloc(i64 %307, i64 8, i32 2) #3
...
588:                                              ; preds = %585, %562, %548
  ...
  %597 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #3

...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 1) #8
...
16:                                               ; preds = %12
  ...
  call void @hypre_Free(i8* %22, i32 2) #8
...
23:                                               ; preds = %13, %1
  ...
  %28 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 1) #8
...
define dso_local %struct.hypre_CSRMatrix* @hypre_CSRMatrixClone(%struct.hypre_CSRMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %8 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 1) #8
...
177:                                              ; preds = %113, %106
  ...
  %179 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 1) #8
...
203:                                              ; preds = %177
  ...
  %205 = call i8* @hypre_CAlloc(i64 %204, i64 8, i32 2) #8
...
211:                                              ; preds = %207
  ...
  %214 = call i8* @hypre_CAlloc(i64 %213, i64 4, i32 2) #8
...
328:                                              ; preds = %326
  ...
  call void @hypre_Free(i8* nonnull %329, i32 2) #8
  br label %330

...
179:                                              ; preds = %169, %173
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 441, i32 1, i8* null) #7
  br label %455
...
389:                                              ; preds = %385
  ...
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 652, i32 256, i8* null) #7
  br label %427
...
393:                                              ; preds = %392
  ...
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 679, i32 256, i8* null) #7
  br label %427
...
435:                                              ; preds = %433, %427
  %436 = icmp slt i32 %429, %26
  br i1 %436, label %443, label %437

437:                                              ; preds = %435
  %438 = fdiv double %428, %151
  %439 = fcmp oge double %438, %150
  %440 = fcmp ogt double %150, 0.000000e+00
  %441 = and i1 %440, %439
  br i1 %441, label %442, label %443

442:                                              ; preds = %437
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 719, i32 256, i8* null) #7
  br label %443

443:                                              ; preds = %442, %437, %435
  %444 = getelementptr inbounds i8, i8* %0, i64 136
  %445 = bitcast i8* %444 to i32*
  store i32 %429, i32* %445, align 8, !tbaa !55
  %446 = fcmp ogt double %151, 0.000000e+00
  br i1 %446, label %447, label %452

447:                                              ; preds = %443
  %448 = fdiv double %428, %151
  %449 = call double @sqrt(double %448) #7
  %450 = getelementptr inbounds i8, i8* %0, i64 144
  %451 = bitcast i8* %450 to double*
  store double %449, double* %451, align 8, !tbaa !56
  br label %455

452:                                              ; preds = %443
  %453 = getelementptr inbounds i8, i8* %0, i64 144
  %454 = bitcast i8* %453 to double*
  store double 0.000000e+00, double* %454, align 8, !tbaa !56
  br label %455

455:                                              ; preds = %447, %452, %148, %141, %179, %119
  %456 = load i32, i32* @hypre__global_error, align 4, !tbaa !35

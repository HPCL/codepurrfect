...
define dso_local i32 @hypre_BoomerAMGRelax(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* readonly %2, i32 %3, i32 %4, double %5, double %6, double* nocapture readonly %7, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* nocapture readnone %10) local_unnamed_addr #0 {
  ...
  %62 = call i32 @hypre_MPI_Comm_size(i32 %18, i32* nonnull %13) #3
  %63 = call i32 @hypre_MPI_Comm_rank(i32 %18, i32* nonnull %14) #3
  switch i32 %3, label %4502 [
    i32 0, label %64
    i32 5, label %305
    i32 3, label %520
    i32 1, label %911
...
67:                                               ; preds = %64
  ...
  %76 = call i8* @hypre_CAlloc(i64 %75, i64 8, i32 1) #3
...
124:                                              ; preds = %95, %85
  %125 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %76, i8* %79) #3
  br label %126
...
145:                                              ; preds = %142
  %146 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %129) #3
  br label %147
...
300:                                              ; preds = %297, %223, %150, %153
  ...
  br i1 %302, label %303, label %4502

303:                                              ; preds = %300
  %304 = bitcast double* %128 to i8*
  call void @hypre_Free(i8* %304, i32 1) #3
  call void @hypre_Free(i8* %127, i32 1) #3
  br label %4502
...
308:                                              ; preds = %305
  ...
  %317 = call i8* @hypre_CAlloc(i64 %316, i64 8, i32 1) #3
...
365:                                              ; preds = %336, %326
  %366 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %317, i8* %320) #3
  %367 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %366) #3
  br label %368
...
515:                                              ; preds = %512, %443, %375, %378
  ...
  br i1 %517, label %518, label %4502

518:                                              ; preds = %515
  %519 = bitcast double* %370 to i8*
  call void @hypre_Free(i8* %519, i32 1) #3
  call void @hypre_Free(i8* %369, i32 1) #3
  br label %4502
...
523:                                              ; preds = %520
  ...
  %532 = call i8* @hypre_CAlloc(i64 %531, i64 8, i32 1) #3
...
566:                                              ; preds = %555, %541
  %567 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %532, i8* %535) #3
  %568 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %567) #3
  br label %569
...
906:                                              ; preds = %903, %819, %721, %652, %736, %739, %584, %587
  ...
  br i1 %908, label %909, label %4502

909:                                              ; preds = %906
  %910 = bitcast double* %571 to i8*
  call void @hypre_Free(i8* %910, i32 1) #3
  call void @hypre_Free(i8* %570, i32 1) #3
  br label %4502
...
914:                                              ; preds = %911
  ...
  %925 = call i8* @hypre_CAlloc(i64 %924, i64 8, i32 1) #3
  ...
  %932 = call i8* @hypre_CAlloc(i64 %931, i64 20, i32 1) #3
  %933 = bitcast i8* %932 to %struct.MPI_Status*
  %934 = call i8* @hypre_CAlloc(i64 %931, i64 4, i32 1) #3
...
1002:                                             ; preds = %992, %979
  ...
  %1009 = call i32 @hypre_MPI_Isend(i8* %1005, i32 %986, i32 1275070475, i32 %977, i32 0, i32 %18, i32* %1008) #3
  br label %1010
...
1014:                                             ; preds = %1010, %971
  ...
  %1016 = call i32 @hypre_MPI_Waitall(i32 %1015, i32* %944, %struct.MPI_Status* %943) #3
  br label %1183
...
1020:                                             ; preds = %1019, %1020
  ...
  %1036 = call i32 @hypre_MPI_Irecv(i8* %1034, i32 %1031, i32 1275070475, i32 %1024, i32 0, i32 %18, i32* %1035) #3
...
1040:                                             ; preds = %1038, %1019
  ...
  %1042 = call i32 @hypre_MPI_Waitall(i32 %1041, i32* %944, %struct.MPI_Status* %943) #3
  br label %1043
...
1183:                                             ; preds = %1180, %1014
  %1184 = call i32 @hypre_MPI_Barrier(i32 %18) #3
  br label %1185
...
1189:                                             ; preds = %1185, %940
  ...
  br i1 %1191, label %1192, label %4502
...
1200:                                             ; preds = %1197
  ...
  %1211 = call i8* @hypre_CAlloc(i64 %1210, i64 8, i32 1) #3
  ...
  %1218 = call i8* @hypre_CAlloc(i64 %1217, i64 20, i32 1) #3
  %1219 = bitcast i8* %1218 to %struct.MPI_Status*
  %1220 = call i8* @hypre_CAlloc(i64 %1217, i64 4, i32 1) #3
...
1393:                                             ; preds = %1383, %1370
  ...
  %1400 = call i32 @hypre_MPI_Isend(i8* %1396, i32 %1377, i32 1275070475, i32 %1368, i32 0, i32 %18, i32* %1399) #3
  br label %1401
...
1405:                                             ; preds = %1401, %1362
  ...
  %1407 = call i32 @hypre_MPI_Waitall(i32 %1406, i32* %1230, %struct.MPI_Status* %1229) #3
  br label %1577
...
1411:                                             ; preds = %1410, %1411
  ...
  %1427 = call i32 @hypre_MPI_Irecv(i8* %1425, i32 %1422, i32 1275070475, i32 %1415, i32 0, i32 %18, i32* %1426) #3
...
1431:                                             ; preds = %1429, %1410
  ...
  %1433 = call i32 @hypre_MPI_Waitall(i32 %1432, i32* %1230, %struct.MPI_Status* %1229) #3
  br label %1434
...
1577:                                             ; preds = %1574, %1405
  %1578 = call i32 @hypre_MPI_Barrier(i32 %18) #3
  br label %1579
...
1583:                                             ; preds = %1579, %1340
  ...
  br i1 %1585, label %1586, label %4502
...
1594:                                             ; preds = %1591
  ...
  %1603 = call i8* @hypre_CAlloc(i64 %1602, i64 8, i32 1) #3
...
1651:                                             ; preds = %1622, %1612
  %1652 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %1603, i8* %1606) #3
  %1653 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %1652) #3
  br label %1654
...
1987:                                             ; preds = %1985, %1902, %1805, %1737, %1819, %1822, %1669, %1672
  ...
  br i1 %1989, label %1990, label %4502

1990:                                             ; preds = %1987
  %1991 = bitcast double* %1656 to i8*
  call void @hypre_Free(i8* %1991, i32 1) #3
  call void @hypre_Free(i8* %1655, i32 1) #3
  br label %4502
...
1995:                                             ; preds = %1992
  ...
  %2004 = call i8* @hypre_CAlloc(i64 %2003, i64 8, i32 1) #3
...
2052:                                             ; preds = %2023, %2013
  %2053 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %2004, i8* %2007) #3
  %2054 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %2053) #3
  br label %2055
...
2702:                                             ; preds = %2700, %2529, %2348, %2207, %2531, %2368, %2209, %2076
  ...
  br i1 %2704, label %2705, label %4502

2705:                                             ; preds = %2702
  %2706 = bitcast double* %2057 to i8*
  call void @hypre_Free(i8* %2706, i32 1) #3
  call void @hypre_Free(i8* %2056, i32 1) #3
  br label %4502

2707:                                             ; preds = %11
  %2708 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %1, %struct.hypre_ParVector_struct* %9) #3
  %2709 = fneg double %5
  %2710 = call i32 @hypre_ParCSRMatrixMatvec(double %2709, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %8, double %5, %struct.hypre_ParVector_struct* %9) #3
  %2711 = icmp sgt i32 %41, 0
  br i1 %2711, label %2712, label %4502
...
2714:                                             ; preds = %2712, %2714
  ...
  br i1 %2725, label %4502, label %2714, !llvm.loop !134
...
2729:                                             ; preds = %2726
  ...
  %2738 = call i8* @hypre_CAlloc(i64 %2737, i64 8, i32 1) #3
  %2739 = bitcast i8* %2738 to double*
  %2740 = sext i32 %43 to i64
  %2741 = call i8* @hypre_CAlloc(i64 %2740, i64 8, i32 1) #3
...
2786:                                             ; preds = %2757, %2747
  %2787 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %2738, i8* %2741) #3
  %2788 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %2787) #3
  br label %2789
...
3428:                                             ; preds = %3426, %3257, %3078, %2939, %3259, %3098, %2941, %2810
  ...
  br i1 %3430, label %3431, label %4502

3431:                                             ; preds = %3428
  %3432 = bitcast double* %2791 to i8*
  call void @hypre_Free(i8* %3432, i32 1) #3
  call void @hypre_Free(i8* %2790, i32 1) #3
  br label %4502
...
3436:                                             ; preds = %3433
  ...
  %3445 = call i8* @hypre_CAlloc(i64 %3444, i64 8, i32 1) #3
  %3446 = bitcast i8* %3445 to double*
  %3447 = sext i32 %43 to i64
  %3448 = call i8* @hypre_CAlloc(i64 %3447, i64 8, i32 1) #3
...
3493:                                             ; preds = %3464, %3454
  %3494 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %3445, i8* %3448) #3
  %3495 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %3494) #3
  br label %3496
...
3829:                                             ; preds = %3826, %3743, %3646, %3578, %3661, %3664, %3511, %3514
  ...
  br i1 %3831, label %3832, label %4502

3832:                                             ; preds = %3829
  %3833 = bitcast double* %3498 to i8*
  call void @hypre_Free(i8* %3833, i32 1) #3
  call void @hypre_Free(i8* %3497, i32 1) #3
  br label %4502
...
3837:                                             ; preds = %3834
  ...
  %3846 = call i8* @hypre_CAlloc(i64 %3845, i64 8, i32 1) #3
  %3847 = bitcast i8* %3846 to double*
  %3848 = sext i32 %43 to i64
  %3849 = call i8* @hypre_CAlloc(i64 %3848, i64 8, i32 1) #3
...
3894:                                             ; preds = %3865, %3855
  %3895 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 1, %struct.hypre_ParCSRCommPkg* %36, i8* %3846, i8* %3849) #3
  %3896 = call i32 @hypre_ParCSRCommHandleDestroy(%struct.hypre_ParCSRCommHandle* %3895) #3
  br label %3897
...
4226:                                             ; preds = %4224, %4142, %4046, %3979, %4060, %4063, %3912, %3915
  ...
  br i1 %4228, label %4229, label %4502

4229:                                             ; preds = %4226
  %4230 = bitcast double* %3899 to i8*
  call void @hypre_Free(i8* %4230, i32 1) #3
  call void @hypre_Free(i8* %3898, i32 1) #3
  br label %4502

4231:                                             ; preds = %11
  %4232 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixToCSRMatrixAll(%struct.hypre_ParCSRMatrix_struct* %0) #3
  %4233 = call %struct.hypre_Vector* @hypre_ParVectorToVectorAll(%struct.hypre_ParVector_struct* %1) #3
  %4234 = icmp eq i32 %41, 0
  br i1 %4234, label %4420, label %4235
...
4235:                                             ; preds = %4231
  ...
  %4247 = call i8* @hypre_CAlloc(i64 %4246, i64 8, i32 1) #3
  %4248 = bitcast i8* %4247 to double*
  %4249 = load i32, i32* %12, align 4, !tbaa !18
  %4250 = sext i32 %4249 to i64
  %4251 = call i8* @hypre_CAlloc(i64 %4250, i64 8, i32 1) #3
...
4286:                                             ; preds = %4281, %4235
  %4287 = icmp eq i32 %4253, 1
  br i1 %4287, label %4297, label %4288

4288:                                             ; preds = %4286
  %4289 = icmp sgt i32 %4253, 1
  br i1 %4289, label %4290, label %4300

4290:                                             ; preds = %4288
  %4291 = sext i32 %4253 to i64
  %4292 = sext i32 %4253 to i64
  %4293 = add i32 %4253, -1
  %4294 = zext i32 %4293 to i64
  %4295 = zext i32 %4253 to i64
  %4296 = zext i32 %4253 to i64
  br label %4304

4297:                                             ; preds = %4286
  %4298 = load double, double* %4248, align 8, !tbaa !33
  %4299 = fcmp une double %4298, 0.000000e+00
  br i1 %4299, label %4399, label %4403

4300:                                             ; preds = %4358, %4288
  %4301 = icmp sgt i32 %4253, 1
  br i1 %4301, label %4302, label %4396

4302:                                             ; preds = %4300
  %4303 = sext i32 %4253 to i64
  br label %4363

4304:                                             ; preds = %4290, %4358
  %4305 = phi i64 [ 0, %4290 ], [ %4359, %4358 ]
  %4306 = phi i64 [ 1, %4290 ], [ %4361, %4358 ]
  %4307 = phi i32 [ 0, %4290 ], [ %4360, %4358 ]
  %4308 = mul nsw i64 %4305, %4291
  %4309 = mul nsw i32 %4307, %4253
  %4310 = trunc i64 %4305 to i32
  %4311 = add nsw i32 %4309, %4310
  %4312 = sext i32 %4311 to i64
  %4313 = getelementptr inbounds double, double* %4248, i64 %4312
  %4314 = load double, double* %4313, align 8, !tbaa !33
  %4315 = fcmp une double %4314, 0.000000e+00
  br i1 %4315, label %4316, label %4358

4316:                                             ; preds = %4304
  %4317 = fdiv double 1.000000e+00, %4314
  %4318 = add nuw nsw i64 %4305, 1
  %4319 = getelementptr inbounds double, double* %4252, i64 %4305
  %4320 = icmp slt i64 %4318, %4292
  br i1 %4320, label %4321, label %4358

4321:                                             ; preds = %4316
  %4322 = trunc i64 %4318 to i32
  %4323 = trunc i64 %4305 to i32
  br label %4324

4324:                                             ; preds = %4321, %4354
  %4325 = phi i64 [ %4306, %4321 ], [ %4355, %4354 ]
  %4326 = phi i32 [ %4322, %4321 ], [ %4356, %4354 ]
  %4327 = mul nsw i32 %4326, %4253
  %4328 = add nsw i32 %4327, %4323
  %4329 = sext i32 %4328 to i64
  %4330 = getelementptr inbounds double, double* %4248, i64 %4329
  %4331 = load double, double* %4330, align 8, !tbaa !33
  %4332 = fcmp une double %4331, 0.000000e+00
  br i1 %4332, label %4333, label %4354

4333:                                             ; preds = %4324
  %4334 = fmul double %4317, %4331
  %4335 = sext i32 %4327 to i64
  br label %4336

4336:                                             ; preds = %4333, %4336
  %4337 = phi i64 [ %4306, %4333 ], [ %4346, %4336 ]
  %4338 = add nsw i64 %4337, %4308
  %4339 = getelementptr inbounds double, double* %4248, i64 %4338
  %4340 = load double, double* %4339, align 8, !tbaa !33
  %4341 = fmul double %4334, %4340
  %4342 = add nsw i64 %4337, %4335
  %4343 = getelementptr inbounds double, double* %4248, i64 %4342
  %4344 = load double, double* %4343, align 8, !tbaa !33
  %4345 = fsub double %4344, %4341
  store double %4345, double* %4343, align 8, !tbaa !33
  %4346 = add nuw nsw i64 %4337, 1
  %4347 = icmp eq i64 %4346, %4296
  br i1 %4347, label %4348, label %4336, !llvm.loop !194

4348:                                             ; preds = %4336
  %4349 = load double, double* %4319, align 8, !tbaa !33
  %4350 = fmul double %4334, %4349
  %4351 = getelementptr inbounds double, double* %4252, i64 %4325
  %4352 = load double, double* %4351, align 8, !tbaa !33
  %4353 = fsub double %4352, %4350
  store double %4353, double* %4351, align 8, !tbaa !33
  br label %4354

4354:                                             ; preds = %4324, %4348
  %4355 = add nuw nsw i64 %4325, 1
  %4356 = add nuw nsw i32 %4326, 1
  %4357 = icmp eq i64 %4355, %4295
  br i1 %4357, label %4358, label %4324, !llvm.loop !195

4358:                                             ; preds = %4354, %4316, %4304
  %4359 = add nuw nsw i64 %4305, 1
  %4360 = add nuw nsw i32 %4307, 1
  %4361 = add nuw nsw i64 %4306, 1
  %4362 = icmp eq i64 %4359, %4294
  br i1 %4362, label %4300, label %4304, !llvm.loop !196

4363:                                             ; preds = %4302, %4394
  %4364 = phi i64 [ %4303, %4302 ], [ %4367, %4394 ]
  %4365 = phi i32 [ %4253, %4302 ], [ %4366, %4394 ]
  %4366 = add nsw i32 %4365, -1
  %4367 = add nsw i64 %4364, -1
  %4368 = mul nsw i32 %4366, %4253
  %4369 = sext i32 %4368 to i64
  %4370 = add nsw i64 %4367, %4369
  %4371 = getelementptr inbounds double, double* %4248, i64 %4370
  %4372 = load double, double* %4371, align 8, !tbaa !33
  %4373 = fcmp une double %4372, 0.000000e+00
  br i1 %4373, label %4374, label %4394

4374:                                             ; preds = %4363
  %4375 = getelementptr inbounds double, double* %4252, i64 %4367
  %4376 = load double, double* %4375, align 8, !tbaa !33
  %4377 = fdiv double %4376, %4372
  store double %4377, double* %4375, align 8, !tbaa !33
  br label %4378

4378:                                             ; preds = %4374, %4391
  %4379 = phi i64 [ 0, %4374 ], [ %4392, %4391 ]
  %4380 = mul nsw i64 %4379, %4303
  %4381 = add nsw i64 %4380, %4367
  %4382 = getelementptr inbounds double, double* %4248, i64 %4381
  %4383 = load double, double* %4382, align 8, !tbaa !33
  %4384 = fcmp une double %4383, 0.000000e+00
  br i1 %4384, label %4385, label %4391

4385:                                             ; preds = %4378
  %4386 = load double, double* %4375, align 8, !tbaa !33
  %4387 = fmul double %4383, %4386
  %4388 = getelementptr inbounds double, double* %4252, i64 %4379
  %4389 = load double, double* %4388, align 8, !tbaa !33
  %4390 = fsub double %4389, %4387
  store double %4390, double* %4388, align 8, !tbaa !33
  br label %4391

4391:                                             ; preds = %4378, %4385
  %4392 = add nuw nsw i64 %4379, 1
  %4393 = icmp eq i64 %4392, %4367
  br i1 %4393, label %4394, label %4378, !llvm.loop !197

4394:                                             ; preds = %4391, %4363
  %4395 = icmp sgt i64 %4364, 2
  br i1 %4395, label %4363, label %4396, !llvm.loop !198

4396:                                             ; preds = %4394, %4300
  %4397 = load double, double* %4248, align 8, !tbaa !33
  %4398 = fcmp une double %4397, 0.000000e+00
  br i1 %4398, label %4399, label %4403

4399:                                             ; preds = %4396, %4297
  %4400 = phi double [ %4298, %4297 ], [ %4397, %4396 ]
  %4401 = load double, double* %4252, align 8, !tbaa !33
  %4402 = fdiv double %4401, %4400
  store double %4402, double* %4252, align 8, !tbaa !33
  br label %4403

4403:                                             ; preds = %4399, %4297, %4396
  %4404 = phi i32 [ 0, %4396 ], [ 1, %4297 ], [ 0, %4399 ]
  %4405 = icmp sgt i32 %41, 0
  br i1 %4405, label %4406, label %4417

4406:                                             ; preds = %4403
  %4407 = sext i32 %45 to i64
  %4408 = zext i32 %41 to i64
  br label %4409

4409:                                             ; preds = %4406, %4409
  %4410 = phi i64 [ 0, %4406 ], [ %4415, %4409 ]
  %4411 = add nsw i64 %4410, %4407
  %4412 = getelementptr inbounds double, double* %4252, i64 %4411
  %4413 = load double, double* %4412, align 8, !tbaa !33
  %4414 = getelementptr inbounds double, double* %49, i64 %4410
  store double %4413, double* %4414, align 8, !tbaa !33
  %4415 = add nuw nsw i64 %4410, 1
  %4416 = icmp eq i64 %4415, %4408
  br i1 %4416, label %4417, label %4409, !llvm.loop !199

4417:                                             ; preds = %4409, %4403
  call void @hypre_Free(i8* %4247, i32 1) #3
  call void @hypre_Free(i8* %4251, i32 1) #3
  %4418 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %4232) #3
  %4419 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %4233) #3
  br label %4502

4420:                                             ; preds = %4231
  %4421 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %4232) #3
  %4422 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %4233) #3
  br label %4502

4423:                                             ; preds = %11
  %4424 = bitcast i32* %15 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4424) #3
  %4425 = bitcast i32* %16 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4425) #3
  store i32 1, i32* %16, align 4, !tbaa !18
  %4426 = call %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixToCSRMatrixAll(%struct.hypre_ParCSRMatrix_struct* %0) #3
  %4427 = call %struct.hypre_Vector* @hypre_ParVectorToVectorAll(%struct.hypre_ParVector_struct* %1) #3
  %4428 = icmp eq i32 %41, 0
  br i1 %4428, label %4499, label %4429

4429:                                             ; preds = %4423
  %4430 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %4426, i64 0, i32 0
  %4431 = load i32*, i32** %4430, align 8, !tbaa !13
  %4432 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %4426, i64 0, i32 1
  %4433 = load i32*, i32** %4432, align 8, !tbaa !14
  %4434 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %4426, i64 0, i32 6
  %4435 = load double*, double** %4434, align 8, !tbaa !11
  %4436 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %4427, i64 0, i32 0
  %4437 = load double*, double** %4436, align 8, !tbaa !24
  %4438 = load i32, i32* %12, align 4, !tbaa !18
  %4439 = mul nsw i32 %4438, %4438
  %4440 = zext i32 %4439 to i64
  %4441 = call i8* @hypre_CAlloc(i64 %4440, i64 8, i32 1) #3
  %4442 = bitcast i8* %4441 to double*
  %4443 = load i32, i32* %12, align 4, !tbaa !18
  %4444 = sext i32 %4443 to i64
  %4445 = call i8* @hypre_CAlloc(i64 %4444, i64 8, i32 1) #3
  %4446 = bitcast i8* %4445 to double*
  %4447 = load i32, i32* %12, align 4, !tbaa !18
  %4448 = icmp sgt i32 %4447, 0
  br i1 %4448, label %4449, label %4480

4449:                                             ; preds = %4429
  %4450 = zext i32 %4447 to i64
  br label %4451

4451:                                             ; preds = %4449, %4475
  %4452 = phi i64 [ 0, %4449 ], [ %4455, %4475 ]
  %4453 = getelementptr inbounds i32, i32* %4431, i64 %4452
  %4454 = load i32, i32* %4453, align 4, !tbaa !18
  %4455 = add nuw nsw i64 %4452, 1
  %4456 = getelementptr inbounds i32, i32* %4431, i64 %4455
  %4457 = load i32, i32* %4456, align 4, !tbaa !18
  %4458 = icmp slt i32 %4454, %4457
  br i1 %4458, label %4459, label %4475

4459:                                             ; preds = %4451
  %4460 = sext i32 %4454 to i64
  %4461 = sext i32 %4457 to i64
  %4462 = trunc i64 %4452 to i32
  br label %4463

4463:                                             ; preds = %4459, %4463
  %4464 = phi i64 [ %4460, %4459 ], [ %4473, %4463 ]
  %4465 = getelementptr inbounds i32, i32* %4433, i64 %4464
  %4466 = load i32, i32* %4465, align 4, !tbaa !18
  %4467 = getelementptr inbounds double, double* %4435, i64 %4464
  %4468 = load double, double* %4467, align 8, !tbaa !33
  %4469 = mul nsw i32 %4466, %4447
  %4470 = add nsw i32 %4469, %4462
  %4471 = sext i32 %4470 to i64
  %4472 = getelementptr inbounds double, double* %4442, i64 %4471
  store double %4468, double* %4472, align 8, !tbaa !33
  %4473 = add nsw i64 %4464, 1
  %4474 = icmp eq i64 %4473, %4461
  br i1 %4474, label %4475, label %4463, !llvm.loop !200

4475:                                             ; preds = %4463, %4451
  %4476 = getelementptr inbounds double, double* %4437, i64 %4452
  %4477 = load double, double* %4476, align 8, !tbaa !33
  %4478 = getelementptr inbounds double, double* %4446, i64 %4452
  store double %4477, double* %4478, align 8, !tbaa !33
  %4479 = icmp eq i64 %4455, %4450
  br i1 %4479, label %4480, label %4451, !llvm.loop !201

4480:                                             ; preds = %4475, %4429
  %4481 = sext i32 %4447 to i64
  %4482 = call i8* @hypre_CAlloc(i64 %4481, i64 4, i32 1) #3
  %4483 = bitcast i8* %4482 to i32*
  %4484 = call i32 @hypre_dgetrf(i32* nonnull %12, i32* nonnull %12, double* %4442, i32* nonnull %12, i32* %4483, i32* nonnull %15) #3
  %4485 = call i32 @hypre_dgetrs(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i32* nonnull %12, i32* nonnull %16, double* %4442, i32* nonnull %12, i32* %4483, double* %4446, i32* nonnull %12, i32* nonnull %15) #3
  call void @hypre_Free(i8* %4482, i32 1) #3
  %4486 = icmp sgt i32 %41, 0
  br i1 %4486, label %4487, label %4498

4487:                                             ; preds = %4480
  %4488 = sext i32 %45 to i64
  %4489 = zext i32 %41 to i64
  br label %4490

4490:                                             ; preds = %4487, %4490
  %4491 = phi i64 [ 0, %4487 ], [ %4496, %4490 ]
  %4492 = add nsw i64 %4491, %4488
  %4493 = getelementptr inbounds double, double* %4446, i64 %4492
  %4494 = load double, double* %4493, align 8, !tbaa !33
  %4495 = getelementptr inbounds double, double* %49, i64 %4491
  store double %4494, double* %4495, align 8, !tbaa !33
  %4496 = add nuw nsw i64 %4491, 1
  %4497 = icmp eq i64 %4496, %4489
  br i1 %4497, label %4498, label %4490, !llvm.loop !202

4498:                                             ; preds = %4490, %4480
  call void @hypre_Free(i8* %4441, i32 1) #3
  call void @hypre_Free(i8* %4445, i32 1) #3
  br label %4499

4499:                                             ; preds = %4423, %4498
  %4500 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %4426) #3
  %4501 = call i32 @hypre_SeqVectorDestroy(%struct.hypre_Vector* %4427) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4425) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4424) #3
  br label %4502

4502:                                             ; preds = %2714, %2707, %4417, %4420, %4226, %4229, %3829, %3832, %3428, %3431, %2702, %2705, %1987, %1990, %1583, %1586, %1189, %1192, %906, %909, %515, %518, %300, %303, %11, %4499
  %4503 = phi i32 [ 0, %11 ], [ 0, %4499 ], [ %4404, %4417 ], [ 0, %4420 ], [ 0, %4229 ], [ 0, %4226 ], [ 0, %3832 ], [ 0, %3829 ], [ 0, %3431 ], [ 0, %3428 ], [ 0, %2705 ], [ 0, %2702 ], [ 0, %1990 ], [ 0, %1987 ], [ 0, %1586 ], [ 0, %1583 ], [ 0, %1192 ], [ 0, %1189 ], [ 0, %909 ], [ 0, %906 ], [ 0, %518 ], [ 0, %515 ], [ 0, %303 ], [ 0, %300 ], [ 0, %2707 ], [ 0, %2714 ]
...
219:                                              ; preds = %216
  call void @hypre_error_handler(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0), i32 4329, i32 1, i8* null) #3
  br label %220

220:                                              ; preds = %219, %216
  %221 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
  ret i32 %221
}

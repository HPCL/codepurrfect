...
define dso_local i32 @hypre_IJMatrixCreateAssumedPartition(%struct.hypre_IJMatrix_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %17 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #3
  ...
  %28 = call i8* @hypre_MAlloc(i64 40, i32 1) #3
  ...
  %33 = shl nsw i64 %32, 2
  %34 = call i8* @hypre_MAlloc(i64 %33, i32 1) #3
  ...
  %39 = shl nsw i64 %38, 2
  %40 = call i8* @hypre_MAlloc(i64 %39, i32 1) #3

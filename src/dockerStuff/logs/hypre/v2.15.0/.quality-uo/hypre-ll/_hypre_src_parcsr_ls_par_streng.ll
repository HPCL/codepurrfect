...
385:                                              ; preds = %382, %353
  %386 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #6
...
193:                                              ; preds = %182, %173
  ...
  %200 = call i8* @hypre_MAlloc(i64 %199, i32 1) #6
  ...
  %207 = call i8* @hypre_CAlloc(i64 %206, i64 4, i32 1) #6
...
286:                                              ; preds = %283
  ...
  %289 = call i8* @hypre_MAlloc(i64 %288, i32 1) #6
...
291:                                              ; preds = %286, %283
  ...
  %295 = call i8* @hypre_CAlloc(i64 %294, i64 4, i32 1) #6
  %296 = bitcast i8* %295 to i32*
  %297 = add nsw i32 %145, 1
  %298 = sext i32 %297 to i64
  %299 = call i8* @hypre_CAlloc(i64 %298, i64 4, i32 1) #6
...
392:                                              ; preds = %388, %291
  %393 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #6
...
430:                                              ; preds = %424
  ...
  %433 = call i8* @hypre_MAlloc(i64 %432, i32 1) #6
...
450:                                              ; preds = %440, %435
  ...
  call void @hypre_Free(i8* %299, i32 1) #6
  call void @hypre_Free(i8* %393, i32 1) #6
...
493:                                              ; preds = %460, %450
  ...
  %498 = call i8* @hypre_CAlloc(i64 %497, i64 4, i32 1) #6
  %499 = bitcast i8* %498 to i32*
  %500 = call i8* @hypre_CAlloc(i64 %497, i64 4, i32 1) #6
...
503:                                              ; preds = %493
  ...
  %505 = call i8* @hypre_CAlloc(i64 %504, i64 4, i32 1) #6
...
510:                                              ; preds = %507
  ...
  %512 = call i8* @hypre_CAlloc(i64 %511, i64 4, i32 1) #6
...
569:                                              ; preds = %563, %514
  ...
  call void @hypre_Free(i8* %207, i32 1) #6
...
573:                                              ; preds = %569
  ...
  %575 = sext i32 %574 to i64
  %576 = call i8* @hypre_CAlloc(i64 %575, i64 4, i32 1) #6
...
637:                                              ; preds = %634
  ...
  %639 = call i8* @hypre_CAlloc(i64 %638, i64 4, i32 1) #6
...
654:                                              ; preds = %653
  ...
  call void @hypre_Free(i8* %655, i32 1) #6
  br label %656
...
668:                                              ; preds = %667
  ...
  %671 = call i8* @hypre_MAlloc(i64 %670, i32 1) #6
...
721:                                              ; preds = %709
  ...
  %724 = call i8* @hypre_MAlloc(i64 %723, i32 1) #6
...
729:                                              ; preds = %726
  ...
  %732 = call i8* @hypre_MAlloc(i64 %731, i32 1) #6
...
738:                                              ; preds = %734
  ...
  %742 = call i8* @hypre_MAlloc(i64 %741, i32 1) #6
  ...
  %751 = call i8* @hypre_MAlloc(i64 %750, i32 1) #6
  %752 = bitcast i8* %751 to i32*
  %753 = call i8* @hypre_MAlloc(i64 %745, i32 1) #6
...
755:                                              ; preds = %738, %734
  ...
  %763 = call i8* @hypre_CAlloc(i64 %762, i64 4, i32 1) #6
  %764 = bitcast i8* %763 to i32*
  %765 = load i32, i32* %8, align 4, !tbaa !20
  %766 = add nsw i32 %765, 1
  %767 = sext i32 %766 to i64
  %768 = call i8* @hypre_CAlloc(i64 %767, i64 4, i32 1) #6
...
1345:                                             ; preds = %1339
  ...
  %1348 = call i8* @hypre_MAlloc(i64 %1347, i32 1) #6
...
1357:                                             ; preds = %1350
  ...
  %1360 = call i8* @hypre_MAlloc(i64 %1359, i32 1) #6
...
2002:                                             ; preds = %2000, %1990
  ...
  call void @hypre_Free(i8* %2003, i32 1) #6
  %2004 = bitcast i32* %759 to i8*
  call void @hypre_Free(i8* %2004, i32 1) #6
...
2021:                                             ; preds = %2020
  ...
  call void @hypre_Free(i8* %2023, i32 1) #6

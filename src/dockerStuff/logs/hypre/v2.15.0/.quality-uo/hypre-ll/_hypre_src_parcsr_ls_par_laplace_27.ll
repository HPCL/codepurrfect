...
94:                                               ; preds = %43, %11
  ...
  %227 = call i8* @hypre_CAlloc(i64 %226, i64 4, i32 1) #4
...
842:                                              ; preds = %834, %94
  ...
  %847 = call i8* @hypre_CAlloc(i64 %846, i64 4, i32 2) #4
  %848 = bitcast i8* %847 to i32*
  %849 = load i32, i32* %844, align 4, !tbaa !3
  %850 = sext i32 %849 to i64
  %851 = call i8* @hypre_CAlloc(i64 %850, i64 8, i32 2) #4
...
855:                                              ; preds = %842
  ...
  %859 = call i8* @hypre_CAlloc(i64 %858, i64 4, i32 2) #4
  %860 = bitcast i8* %859 to i32*
  %861 = load i32, i32* %856, align 4, !tbaa !3
  %862 = sext i32 %861 to i64
  %863 = call i8* @hypre_CAlloc(i64 %862, i64 8, i32 2) #4
...
4030:                                             ; preds = %4026
  ...
  %4032 = call i8* @hypre_CAlloc(i64 %4031, i64 4, i32 1) #4
...
4092:                                             ; preds = %4089, %4050
  call void @hypre_Free(i8* %4032, i32 1) #4
  br label %4093
...
4093:                                             ; preds = %4092, %4026
  ...
  %4102 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4

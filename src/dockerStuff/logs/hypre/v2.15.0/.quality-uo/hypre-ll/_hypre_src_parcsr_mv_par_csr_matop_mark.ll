...
161:                                              ; preds = %157
  ...
  %165 = call i8* @hypre_CAlloc(i64 %162, i64 8, i32 1) #5
...
228:                                              ; preds = %225
  ...
  %231 = call i8* @hypre_CAlloc(i64 %230, i64 4, i32 1) #5
...
305:                                              ; preds = %304
  ...
  call void @hypre_Free(i8* %306, i32 1) #5
  br label %307
...
344:                                              ; preds = %335, %340, %319, %318
  ...
  %348 = call i8* @hypre_CAlloc(i64 %347, i64 4, i32 1) #5
...
357:                                              ; preds = %351, %344
  ...
  %360 = call i8* @hypre_CAlloc(i64 %359, i64 8, i32 1) #5
  %361 = bitcast i8* %360 to double*
  %362 = call i8* @hypre_CAlloc(i64 %359, i64 4, i32 1) #5
...
366:                                              ; preds = %357
  ...
  %368 = call i8* @hypre_CAlloc(i64 %367, i64 8, i32 1) #5
  %369 = bitcast i8* %368 to double*
  %370 = call i8* @hypre_CAlloc(i64 %367, i64 4, i32 1) #5
...
699:                                              ; preds = %695, %679
  call void @hypre_Free(i8* %348, i32 1) #5
...
700:                                              ; preds = %699
  ...
  call void @hypre_Free(i8* %701, i32 1) #5
  %702 = bitcast double* %158 to i8*
  call void @hypre_Free(i8* %702, i32 1) #5
  br label %703
...
704:                                              ; preds = %703
  ...
  call void @hypre_Free(i8* %705, i32 1) #5
  %706 = bitcast double* %168 to i8*
  call void @hypre_Free(i8* %706, i32 1) #5
  br label %707
...
708:                                              ; preds = %707
  ...
  call void @hypre_Free(i8* %709, i32 1) #5
  br label %710

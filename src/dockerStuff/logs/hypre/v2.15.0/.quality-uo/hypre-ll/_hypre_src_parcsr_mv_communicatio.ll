...
define dso_local void @hypre_MatTCommPkgCreate_core(i32 %0, i32* nocapture readonly %1, i32 %2, i32* nocapture readonly %3, i32 %4, i32 %5, i32 %6, i32* nocapture readonly %7, i32 %8, i32* nocapture readonly %9, i32* nocapture readonly %10, i32* nocapture readonly %11, i32* nocapture readonly %12, i32* nocapture readonly %13, i32 %14, i32* nocapture %15, i32** nocapture %16, i32** nocapture %17, i32* nocapture %18, i32** nocapture %19, i32** nocapture %20, i32** nocapture %21) local_unnamed_addr #2 {
  ...
  %45 = call i8* @hypre_CAlloc(i64 %44, i64 4, i32 1) #5
...
64:                                               ; preds = %49, %22
  ...
  %74 = call i8* @hypre_CAlloc(i64 %73, i64 4, i32 1) #5
...
492:                                              ; preds = %484, %146
  ...
  %495 = call i8* @hypre_CAlloc(i64 %494, i64 4, i32 1) #5
  %496 = bitcast i8* %495 to i32*
  %497 = sext i32 %37 to i64
  %498 = call i8* @hypre_CAlloc(i64 %497, i64 4, i32 1) #5
...
517:                                              ; preds = %511, %492
  ...
  %520 = call i8* @hypre_CAlloc(i64 %519, i64 4, i32 1) #5
  %521 = bitcast i8* %520 to i32*
  %522 = load i32, i32* %24, align 4, !tbaa !16
  %523 = sext i32 %522 to i64
  %524 = call i8* @hypre_CAlloc(i64 %523, i64 4, i32 1) #5
...
541:                                              ; preds = %529, %517
  ...
  %547 = call i8* @hypre_CAlloc(i64 %546, i64 4, i32 1) #5
...
616:                                              ; preds = %607, %575
  ...
  call void @hypre_Free(i8* %520, i32 1) #5
  call void @hypre_Free(i8* %524, i32 1) #5
  call void @hypre_Free(i8* %74, i32 1) #5
  call void @hypre_Free(i8* %70, i32 1) #5
  call void @hypre_Free(i8* %45, i32 1) #5
  call void @hypre_Free(i8* %35, i32 1) #5
  call void @hypre_Free(i8* %547, i32 1) #5
  call void @hypre_Free(i8* %163, i32 1) #5
...
define dso_local i32 @hypre_MatTCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* nocapture %0) local_unnamed_addr #2 {
  ...
  %44 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #5

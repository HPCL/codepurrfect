...
define dso_local %struct.utilities_FortranMatrix* @utilities_FortranMatrixCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_MAlloc(i64 40, i32 1) #12
...
13:                                               ; preds = %11, %7, %3
  %14 = mul nsw i64 %1, %0
  %15 = call i8* @hypre_CAlloc(i64 %14, i64 8, i32 1) #12
...
; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local void @utilities_FortranMatrixAdd(double %0, %struct.utilities_FortranMatrix* nocapture readonly %1, %struct.utilities_FortranMatrix* nocapture readonly %2, %struct.utilities_FortranMatrix* nocapture readonly %3) local_unnamed_addr #5 {
...
; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local void @utilities_FortranMatrixMultiply(%struct.utilities_FortranMatrix* nocapture readonly %0, i32 %1, %struct.utilities_FortranMatrix* nocapture readonly %2, i32 %3, %struct.utilities_FortranMatrix* nocapture readonly %4) local_unnamed_addr #5 {
...
define dso_local void @utilities_FortranMatrixUpperInv(%struct.utilities_FortranMatrix* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.utilities_FortranMatrix, %struct.utilities_FortranMatrix* %0, i64 0, i32 1
  %3 = load i64, i64* %2, align 8, !tbaa !12
  %4 = call i8* @hypre_CAlloc(i64 %3, i64 8, i32 1) #12

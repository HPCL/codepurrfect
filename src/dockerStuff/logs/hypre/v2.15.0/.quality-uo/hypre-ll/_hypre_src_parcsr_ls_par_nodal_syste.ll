...
631:                                              ; preds = %608
  ...
  %638 = call i8* @hypre_CAlloc(i64 %637, i64 4, i32 1) #7
...
761:                                              ; preds = %759
  ...
  %763 = call i8* @hypre_CAlloc(i64 %762, i64 4, i32 1) #7
...
789:                                              ; preds = %786
  ...
  %791 = call i8* @hypre_CAlloc(i64 %790, i64 4, i32 1) #7
...
793:                                              ; preds = %789, %786
  ...
  %797 = call i8* @hypre_CAlloc(i64 %796, i64 4, i32 1) #7
  %798 = bitcast i8* %797 to i32*
  %799 = zext i32 %787 to i64
  %800 = call i8* @hypre_CAlloc(i64 %799, i64 4, i32 1) #7
...
917:                                              ; preds = %906
  ...
  %919 = call i8* @hypre_CAlloc(i64 %918, i64 4, i32 1) #7
  %920 = bitcast i8* %919 to i32*
  %921 = call i8* @hypre_CAlloc(i64 %918, i64 8, i32 1) #7
...
1157:                                             ; preds = %931
  ...
  %1160 = call i8* @hypre_CAlloc(i64 %1159, i64 8, i32 1) #7
...
1258:                                             ; preds = %1255, %1170
  call void @hypre_Free(i8* %1160, i32 1) #7
  br label %1320
...
1320:                                             ; preds = %1315, %1152, %1086, %1011, %932, %935, %1024, %950, %931, %1258
  ...
  call void @hypre_Free(i8* %1321, i32 1) #7
  br label %1322
...
1368:                                             ; preds = %1356
  ...
  %1370 = call i8* @hypre_CAlloc(i64 %1369, i64 4, i32 1) #7
...
1459:                                             ; preds = %1450
  ...
  %1461 = call i8* @hypre_CAlloc(i64 %1460, i64 4, i32 2) #7
...
1511:                                             ; preds = %1508, %1450
  ...
  call void @hypre_Free(i8* %1512, i32 1) #7
  br label %1513
...
236:                                              ; preds = %214
  ...
  %244 = call i8* @hypre_CAlloc(i64 %243, i64 4, i32 1) #7

...
53:                                               ; preds = %13, %37, %44
  ...
  %64 = call i8* @hypre_CAlloc(i64 %63, i64 4, i32 1) #4
...
83:                                               ; preds = %80
  ...
  %87 = shl nsw i64 %86, 2
  %88 = call i8* @hypre_ReAlloc(i8* %85, i64 %87, i32 1) #4
  %89 = bitcast i8* %88 to i32*
  %90 = bitcast i32* %73 to i8*
  %91 = add nsw i32 %71, 21
  %92 = sext i32 %91 to i64
  %93 = shl nsw i64 %92, 2
  %94 = call i8* @hypre_ReAlloc(i8* %90, i64 %93, i32 1) #4
  %95 = bitcast i8* %94 to i32*
  %96 = bitcast i32* %72 to i8*
  %97 = shl nsw i32 %84, 1
  %98 = sext i32 %97 to i64
  %99 = shl nsw i64 %98, 2
  %100 = call i8* @hypre_ReAlloc(i8* %96, i64 %99, i32 1) #4
...
153:                                              ; preds = %145, %136
  ...
  %167 = call i8* @hypre_CAlloc(i64 %166, i64 4, i32 1) #4
...
177:                                              ; preds = %173, %254
  ...
  %181 = phi i32 [ -1, %173 ], [ %258, %254 ]
  %182 = phi i32* [ %168, %173 ], [ %257, %254 ]
  %183 = phi i32* [ %164, %173 ], [ %256, %254 ]
  %184 = phi i32 [ 0, %173 ], [ %255, %254 ]
...
214:                                              ; preds = %209
  %215 = icmp eq i32 %211, %181
  br i1 %215, label %239, label %216

216:                                              ; preds = %214
  %217 = icmp eq i32 %184, %180
...
218:                                              ; preds = %216
  ...
  %223 = call i8* @hypre_ReAlloc(i8* %220, i64 %222, i32 1) #4
  %224 = bitcast i8* %223 to i32*
  %225 = bitcast i32* %182 to i8*
  %226 = add nsw i32 %180, 21
  %227 = sext i32 %226 to i64
  %228 = shl nsw i64 %227, 2
  %229 = call i8* @hypre_ReAlloc(i8* %225, i64 %228, i32 1) #4
  %230 = bitcast i8* %229 to i32*
  br label %231

231:                                              ; preds = %218, %216
  %232 = phi i32* [ %224, %218 ], [ %183, %216 ]
  %233 = phi i32* [ %230, %218 ], [ %182, %216 ]
  %234 = phi i32 [ %219, %218 ], [ %180, %216 ]
  %235 = add nsw i32 %184, 1
...
239:                                              ; preds = %214, %231
  %240 = phi i32* [ %232, %231 ], [ %182, %214 ]
  %241 = phi i32 [ %238, %231 ], [ %207, %214 ]
  %242 = phi i32 [ %235, %231 ], [ %184, %214 ]
  %243 = phi i32* [ %232, %231 ], [ %183, %214 ]
  %244 = phi i32* [ %233, %231 ], [ %182, %214 ]
...
254:                                              ; preds = %205, %248
  ...
  %257 = phi i32* [ %251, %248 ], [ %182, %205 ]
  %258 = phi i32 [ %253, %248 ], [ %181, %205 ]
...
262:                                              ; preds = %254, %153
  %263 = phi i32 [ 0, %153 ], [ %255, %254 ]
  %264 = phi i32* [ %164, %153 ], [ %256, %254 ]
  %265 = phi i32* [ %168, %153 ], [ %257, %254 ]
  %266 = load i8*, i8** %159, align 8, !tbaa !25
  call void @hypre_Free(i8* %266, i32 1) #4
  store i32* null, i32** %19, align 8, !tbaa !25
  %267 = bitcast i32** %20 to i8**
  %268 = load i8*, i8** %267, align 8, !tbaa !25
  call void @hypre_Free(i8* %268, i32 1) #4
  store i32* null, i32** %20, align 8, !tbaa !25
  store i32* null, i32** %19, align 8, !tbaa !25
  store i32* null, i32** %20, align 8, !tbaa !25
  ...
  %273 = call i8* @hypre_CAlloc(i64 %272, i64 4, i32 1) #4
  ...
  %293 = call i32 @hypre_DataExchangeList(i32 %263, i32* %264, i8* %292, i32* %265, i32 4, i32 4, %struct.hypre_DataExchangeResponse* nonnull %22, i32 0, i32 2, i32 %0, i8** nonnull %159, i32** nonnull %20) #4
  %294 = load i32, i32* %269, align 8, !tbaa !36
  %295 = sext i32 %294 to i64
  %296 = call i8* @hypre_CAlloc(i64 %295, i64 4, i32 1) #4
  %297 = bitcast i8* %296 to i32*
  %298 = add nsw i32 %294, 1
  %299 = sext i32 %298 to i64
  %300 = call i8* @hypre_CAlloc(i64 %299, i64 4, i32 1) #4
  ...
  %306 = call i8* @hypre_CAlloc(i64 %305, i64 4, i32 1) #4
...
378:                                              ; preds = %343, %336
  call void @hypre_Free(i8* %296, i32 1) #4
  call void @hypre_Free(i8* %306, i32 1) #4
  call void @hypre_Free(i8* %300, i32 1) #4
  %379 = icmp eq i32 %263, 0
  br i1 %379, label %380, label %382

380:                                              ; preds = %378
  %381 = bitcast i32* %264 to i8*
  call void @hypre_Free(i8* %381, i32 1) #4
  br label %382

382:                                              ; preds = %380, %378
  %383 = phi i32* [ %264, %378 ], [ null, %380 ]
  %384 = icmp eq i32 %294, 0
  br i1 %384, label %385, label %389

385:                                              ; preds = %382
  %386 = load i8*, i8** %275, align 8, !tbaa !39
  call void @hypre_Free(i8* %386, i32 1) #4
  store i32* null, i32** %274, align 8, !tbaa !39
  store i32 %263, i32* %5, align 4, !tbaa !19
  store i32* %383, i32** %6, align 8, !tbaa !25
  store i32* %265, i32** %7, align 8, !tbaa !25
  ...
  call void @hypre_Free(i8* %388, i32 2) #4
...
389:                                              ; preds = %382
  ...
  %393 = load i32*, i32** %286, align 8
  %394 = load i32, i32* %392, align 4, !tbaa !19
  %395 = icmp sgt i32 %394, 0
  br i1 %395, label %396, label %405

396:                                              ; preds = %389, %396
  %397 = phi i64 [ %401, %396 ], [ 0, %389 ]
  %398 = getelementptr inbounds i32, i32* %393, i64 %397
  %399 = load i32, i32* %398, align 4, !tbaa !19
  %400 = sub nsw i32 %399, %2
  store i32 %400, i32* %398, align 4, !tbaa !19
  %401 = add nuw nsw i64 %397, 1
  %402 = load i32, i32* %392, align 4, !tbaa !19
  %403 = sext i32 %402 to i64
  %404 = icmp slt i64 %401, %403
  br i1 %404, label %396, label %405, !llvm.loop !47

405:                                              ; preds = %396, %389, %385
  %406 = load i32*, i32** %286, align 8, !tbaa !42
  store i32* %406, i32** %11, align 8, !tbaa !25
  %407 = icmp eq i32* %138, null
  br i1 %407, label %410, label %408

408:                                              ; preds = %405
  %409 = bitcast i32* %138 to i8*
  call void @hypre_Free(i8* nonnull %409, i32 1) #4
  br label %410

410:                                              ; preds = %408, %405
  %411 = icmp eq i32* %139, null
  br i1 %411, label %414, label %412

412:                                              ; preds = %410
  %413 = bitcast i32* %139 to i8*
  call void @hypre_Free(i8* nonnull %413, i32 1) #4
  br label %414

414:                                              ; preds = %412, %410
  call void @hypre_Free(i8* %158, i32 1) #4
  %415 = load i32*, i32** %19, align 8, !tbaa !25
  %416 = icmp eq i32* %415, null
  br i1 %416, label %419, label %417

417:                                              ; preds = %414
  %418 = bitcast i32* %415 to i8*
  call void @hypre_Free(i8* nonnull %418, i32 1) #4
  store i32* null, i32** %19, align 8, !tbaa !25
  br label %419

419:                                              ; preds = %417, %414
  %420 = load i32*, i32** %20, align 8, !tbaa !25
  %421 = icmp eq i32* %420, null
  br i1 %421, label %424, label %422

422:                                              ; preds = %419
  %423 = bitcast i32* %420 to i8*
  call void @hypre_Free(i8* nonnull %423, i32 1) #4
  store i32* null, i32** %20, align 8, !tbaa !25
  br label %424

424:                                              ; preds = %422, %419
  %425 = load i32, i32* @hypre__global_error, align 4, !tbaa !19
...
39:                                               ; preds = %7
  ...
  %44 = shl nsw i64 %43, 2
  %45 = call i8* @hypre_ReAlloc(i8* %10, i64 %44, i32 1) #4
...
50:                                               ; preds = %36
  ...
  %58 = shl nsw i64 %57, 2
  %59 = call i8* @hypre_ReAlloc(i8* %56, i64 %58, i32 2) #4
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_ParCSRCommPkgCreateApart(i32 %0, i32* %1, i32 %2, i32 %3, i32 %4, %struct.hypre_IJAssumedPart* %5, %struct.hypre_ParCSRCommPkg* nocapture %6) local_unnamed_addr #0 {
  %8 = alloca i32, align 4
  ...
  %23 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 0
  store i32 %0, i32* %23, align 8, !tbaa !10
  %24 = load i32, i32* %11, align 4, !tbaa !19
  %25 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 5
  store i32 %24, i32* %25, align 8, !tbaa !12
  %26 = load i32*, i32** %12, align 8, !tbaa !25
  %27 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 6
  store i32* %26, i32** %27, align 8, !tbaa !13
  %28 = load i32*, i32** %13, align 8, !tbaa !25
  %29 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 7
  store i32* %28, i32** %29, align 8, !tbaa !14
  %30 = load i32, i32* %8, align 4, !tbaa !19
  %31 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 1
  store i32 %30, i32* %31, align 4, !tbaa !15
  %32 = load i32*, i32** %9, align 8, !tbaa !25
  %33 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 2
  store i32* %32, i32** %33, align 8, !tbaa !16
  %34 = load i32*, i32** %10, align 8, !tbaa !25
  %35 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 3
  store i32* %34, i32** %35, align 8, !tbaa !17
  %36 = load i32*, i32** %14, align 8, !tbaa !25
  %37 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %6, i64 0, i32 4
...
19:                                               ; preds = %15
  ...
  call void @hypre_Free(i8* nonnull %20, i32 1) #4
...
31:                                               ; preds = %27
  ...
  call void @hypre_Free(i8* nonnull %32, i32 1) #4

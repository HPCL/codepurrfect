...
define dso_local i32 @hypre_BoomerAMGBlockRelax(%struct.hypre_ParCSRBlockMatrix* %0, %struct.hypre_ParVector_struct* %1, i32* nocapture readonly %2, i32 %3, i32 %4, double %5, double %6, %struct.hypre_ParVector_struct* nocapture readonly %7, %struct.hypre_ParVector_struct* nocapture readonly %8) local_unnamed_addr #0 {
  ...
  %31 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %30, align 8, !tbaa !20
  %32 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %15, i64 0, i32 3
  %33 = load i32, i32* %32, align 8, !tbaa !21
  %34 = mul nsw i32 %33, %33
  %35 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %15, i64 0, i32 4
  %36 = load i32, i32* %35, align 4, !tbaa !22
  %37 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %23, i64 0, i32 5
  ...
  %60 = call i8* @hypre_CAlloc(i64 %59, i64 8, i32 1) #5
  %61 = bitcast i8* %60 to double*
  %62 = call i8* @hypre_CAlloc(i64 %59, i64 8, i32 1) #5
  %63 = bitcast i8* %62 to double*
  %64 = call i8* @hypre_CAlloc(i64 %59, i64 8, i32 1) #5
  %65 = bitcast i8* %64 to double*
  %66 = icmp eq %struct.hypre_ParCSRCommPkg* %31, null
  br i1 %66, label %67, label %70

67:                                               ; preds = %9
  %68 = call i32 @hypre_BlockMatvecCommPkgCreate(%struct.hypre_ParCSRBlockMatrix* %0) #5
  %69 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %30, align 8, !tbaa !20
  br label %70

70:                                               ; preds = %67, %9
  %71 = phi %struct.hypre_ParCSRCommPkg* [ %31, %9 ], [ %69, %67 ]
...
75:                                               ; preds = %72
  %76 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 1
  %77 = load i32, i32* %76, align 4, !tbaa !29
  %78 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 3
  ...
  %85 = call i8* @hypre_CAlloc(i64 %84, i64 8, i32 1) #5
  %86 = bitcast i8* %85 to double*
  %87 = mul nsw i32 %38, %33
  %88 = sext i32 %87 to i64
  %89 = call i8* @hypre_CAlloc(i64 %88, i64 8, i32 1) #5
...
95:                                               ; preds = %92, %75
  ...
  %98 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 4
...
146:                                              ; preds = %105, %95
  %147 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 1, i32 %33, %struct.hypre_ParCSRCommPkg* %71, i8* %85, i8* %89) #5
  br label %148
...
372:                                              ; preds = %369
  ...
  call void @hypre_Free(i8* %373, i32 1) #5
...
377:                                              ; preds = %374
  %378 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 1
  %379 = load i32, i32* %378, align 4, !tbaa !29
  %380 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 3
  ...
  %387 = call i8* @hypre_CAlloc(i64 %386, i64 8, i32 1) #5
  %388 = bitcast i8* %387 to double*
  %389 = mul nsw i32 %38, %33
  %390 = sext i32 %389 to i64
  %391 = call i8* @hypre_CAlloc(i64 %390, i64 8, i32 1) #5
...
397:                                              ; preds = %394, %377
  ...
  %400 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 4
...
448:                                              ; preds = %407, %397
  %449 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 1, i32 %33, %struct.hypre_ParCSRCommPkg* %71, i8* %387, i8* %391) #5
  br label %450
...
667:                                              ; preds = %473
  ...
  %670 = call i8* @hypre_CAlloc(i64 %59, i64 8, i32 1) #5
  %671 = bitcast i8* %670 to double*
  %672 = call i8* @hypre_CAlloc(i64 %59, i64 8, i32 1) #5
...
914:                                              ; preds = %911, %800, %679, %687
  call void @hypre_Free(i8* %670, i32 1) #5
  call void @hypre_Free(i8* %672, i32 1) #5
  br label %915
...
918:                                              ; preds = %915
  ...
  call void @hypre_Free(i8* %919, i32 1) #5
  call void @hypre_Free(i8* %451, i32 1) #5
  br label %1962
...
923:                                              ; preds = %920
  %924 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 1
  %925 = load i32, i32* %924, align 4, !tbaa !29
  %926 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 3
  ...
  %933 = call i8* @hypre_CAlloc(i64 %932, i64 8, i32 1) #5
  %934 = bitcast i8* %933 to double*
  %935 = mul nsw i32 %38, %33
  %936 = sext i32 %935 to i64
  %937 = call i8* @hypre_CAlloc(i64 %936, i64 8, i32 1) #5
...
943:                                              ; preds = %940, %923
  ...
  %946 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %71, i64 0, i32 4
...
994:                                              ; preds = %953, %943
  %995 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRBlockCommHandleCreate(i32 1, i32 %33, %struct.hypre_ParCSRCommPkg* %71, i8* %933, i8* %937) #5
...
1377:                                             ; preds = %997
  ...
  %1379 = call i8* @hypre_CAlloc(i64 %59, i64 8, i32 1) #5
  %1380 = bitcast i8* %1379 to double*
  %1381 = call i8* @hypre_CAlloc(i64 %59, i64 8, i32 1) #5
...
1869:                                             ; preds = %1867, %1636, %1638, %1422
  call void @hypre_Free(i8* %1379, i32 1) #5
  call void @hypre_Free(i8* %1381, i32 1) #5
  br label %1870
...
1873:                                             ; preds = %1870
  ...
  call void @hypre_Free(i8* %1874, i32 1) #5
  call void @hypre_Free(i8* %998, i32 1) #5
  br label %1962
...
1882:                                             ; preds = %1875
  ...
  %1887 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1879, i64 0, i32 6
  ...
  %1893 = call i8* @hypre_CAlloc(i64 %1892, i64 8, i32 1) #5
  %1894 = bitcast i8* %1893 to double*
  %1895 = sext i32 %1878 to i64
  %1896 = call i8* @hypre_CAlloc(i64 %1895, i64 8, i32 1) #5
...
1956:                                             ; preds = %1953, %1930
  call void @hypre_Free(i8* %1893, i32 1) #5
  call void @hypre_Free(i8* %1896, i32 1) #5
  br label %1957
...
1962:                                             ; preds = %1870, %1873, %915, %918, %369, %372, %70, %1957
  ...
  call void @hypre_Free(i8* %60, i32 1) #5
  call void @hypre_Free(i8* %62, i32 1) #5
...
!14 = !{!11, !12, i64 32}
!15 = !{!16, !12, i64 0}
!16 = !{!"", !12, i64 0, !12, i64 8, !12, i64 16, !4, i64 24, !4, i64 28, !4, i64 32, !4, i64 36, !4, i64 40}
!17 = !{!16, !12, i64 8}
!18 = !{!16, !12, i64 16}
!19 = !{!11, !12, i64 40}
!20 = !{!11, !12, i64 72}
...
!26 = !{!25, !12, i64 32}
!27 = !{!28, !12, i64 0}
!28 = !{!"", !12, i64 0, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28}
!29 = !{!30, !4, i64 4}
!30 = !{!"", !4, i64 0, !4, i64 4, !12, i64 8, !12, i64 16, !12, i64 24, !4, i64 32, !12, i64 40, !12, i64 48, !12, i64 56, !12, i64 64}
!31 = !{!30, !12, i64 16}
!32 = distinct !{!32, !8, !9}
!33 = !{!30, !12, i64 24}
!34 = !{!13, !13, i64 0}
...
!122 = !{!123, !4, i64 4}
!123 = !{!"hypre_ParCSRMatrix_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !12, i64 32, !12, i64 40, !12, i64 48, !12, i64 56, !12, i64 64, !12, i64 72, !12, i64 80, !12, i64 88, !12, i64 96, !4, i64 104, !4, i64 108, !4, i64 112, !4, i64 116, !13, i64 120, !12, i64 128, !12, i64 136, !4, i64 144, !12, i64 152}
!124 = !{!125, !12, i64 0}
!125 = !{!"", !12, i64 0, !12, i64 8, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28, !12, i64 32, !12, i64 40, !4, i64 48}
!126 = !{!125, !12, i64 8}
!127 = !{!125, !12, i64 32}

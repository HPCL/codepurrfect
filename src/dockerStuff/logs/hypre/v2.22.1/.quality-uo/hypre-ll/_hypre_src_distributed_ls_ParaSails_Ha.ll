...
define dso_local %struct.Hash* @HashCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_MAlloc(i64 32, i32 0) #5
...
; Function Attrs: nounwind uwtable
define dso_local void @HashDestroy(%struct.Hash* %0) local_unnamed_addr #0 {
  %2 = getelementptr inbounds %struct.Hash, %struct.Hash* %0, i64 0, i32 2
  %3 = bitcast i32** %2 to i8**
  %4 = load i8*, i8** %3, align 8, !tbaa !10
  call void @hypre_Free(i8* %4, i32 0) #5
  ...
  store i32* null, i32** %5, align 8, !tbaa !11
  %8 = getelementptr inbounds %struct.Hash, %struct.Hash* %0, i64 0, i32 4
  %9 = bitcast i32** %8 to i8**
  %10 = load i8*, i8** %9, align 8, !tbaa !12
  call void @hypre_Free(i8* %10, i32 0) #5
  store i32* null, i32** %8, align 8, !tbaa !12
  %11 = bitcast %struct.Hash* %0 to i8*
  call void @hypre_Free(i8* %11, i32 0) #5
  ret void
}
...
define dso_local i32 @HashLookup(%struct.Hash* nocapture readonly %0, i32 %1) local_unnamed_addr #2 {
...
define dso_local void @HashInsert(%struct.Hash* nocapture %0, i32 %1, i32 %2) local_unnamed_addr #3 {
...
; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local void @HashRehash(%struct.Hash* nocapture readonly %0, %struct.Hash* nocapture %1) local_unnamed_addr #3 {
...
; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local void @HashReset(%struct.Hash* nocapture %0) local_unnamed_addr #3 {
...
define dso_local void @HashPrint(%struct.Hash* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %4 = sdiv i32 %3, 38
  %5 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %3) #5
  %6 = icmp sgt i32 %3, 37
...
13:                                               ; preds = %10, %13
  ...
  %20 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %19) #5
  %21 = add nuw nsw i32 %15, 1
  %22 = icmp eq i32 %21, 38
  br i1 %22, label %23, label %13, !llvm.loop !20

23:                                               ; preds = %13
  %24 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #5

...
define dso_local i32 @HYPRE_ParCSRParaSailsCreate(i32 %0, %struct.hypre_Solver_struct** nocapture %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_MAlloc(i64 64, i32 0) #4
  %4 = icmp eq i8* %3, null
  br i1 %4, label %5, label %6

5:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0), i32 74, i32 2, i8* null) #4
  br label %26
...
6:                                                ; preds = %2
  ...
  %24 = call i32 @hypre_ParaSailsCreate(i32 %0, i8** nonnull %23) #4
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRParaSailsDestroy(%struct.hypre_Solver_struct* %0) local_unnamed_addr #0 {
  %2 = bitcast %struct.hypre_Solver_struct* %0 to i8**
  %3 = load i8*, i8** %2, align 8, !tbaa !19
  %4 = call i32 @hypre_ParaSailsDestroy(i8* %3) #4
  %5 = bitcast %struct.hypre_Solver_struct* %0 to i8*
  call void @hypre_Free(i8* %5, i32 0) #4
...
define dso_local i32 @HYPRE_ParCSRParaSailsSetup(%struct.hypre_Solver_struct* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readnone %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #0 {
  ...
  %8 = call i32 @HYPRE_ConvertParCSRMatrixToDistributedMatrix(%struct.hypre_ParCSRMatrix_struct* %1, i8** nonnull %5) #4
...
17:                                               ; preds = %13, %11
  ...
  %33 = call i32 @hypre_ParaSailsSetup(i8* %19, i8* %20, i32 %22, double %24, i32 %26, double %28, double %30, i32 %32) #4
...
36:                                               ; preds = %13
  ...
  %42 = call i32 @hypre_ParaSailsSetupValues(i8* %38, i8* %39, double 0.000000e+00, double 0.000000e+00, i32 %41) #4
...
45:                                               ; preds = %36, %17
  ...
  %47 = call i32 @HYPRE_DistributedMatrixDestroy(i8* %46) #4
...
define dso_local i32 @HYPRE_ParCSRParaSailsSolve(%struct.hypre_Solver_struct* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* nocapture readnone %1, %struct.hypre_ParVector_struct* nocapture readonly %2, %struct.hypre_ParVector_struct* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %15 = call i32 @hypre_ParaSailsApply(i8* %14, double* %8, double* %12) #4
...
define dso_local i32 @HYPRE_ParCSRParaSailsSetParams(%struct.hypre_Solver_struct* nocapture %0, double %1, i32 %2) local_unnamed_addr #3 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParCSRParaSailsSetFilter(%struct.hypre_Solver_struct* nocapture %0, double %1) local_unnamed_addr #3 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParCSRParaSailsGetFilter(%struct.hypre_Solver_struct* nocapture readonly %0, double* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 4
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParCSRParaSailsSetSym(%struct.hypre_Solver_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParCSRParaSailsSetLoadbal(%struct.hypre_Solver_struct* nocapture %0, double %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParCSRParaSailsGetLoadbal(%struct.hypre_Solver_struct* nocapture readonly %0, double* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 5
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParCSRParaSailsSetReuse(%struct.hypre_Solver_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParCSRParaSailsSetLogging(%struct.hypre_Solver_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
...
5:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0), i32 384, i32 2, i8* null) #4
  br label %26
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParaSailsDestroy(%struct.hypre_Solver_struct* %0) local_unnamed_addr #0 {
  %2 = bitcast %struct.hypre_Solver_struct* %0 to i8**
  %3 = load i8*, i8** %2, align 8, !tbaa !19
  %4 = call i32 @hypre_ParaSailsDestroy(i8* %3) #4
  %5 = bitcast %struct.hypre_Solver_struct* %0 to i8*
...
define dso_local i32 @HYPRE_ParaSailsSetup(%struct.hypre_Solver_struct* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readnone %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %6) #4
  %7 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %8 = call i32 (...) @HYPRE_GetError() #4
  %9 = call i32 (...) @HYPRE_ClearAllErrors() #4
  %10 = call i32 @HYPRE_ConvertParCSRMatrixToDistributedMatrix(%struct.hypre_ParCSRMatrix_struct* %1, i8** nonnull %5) #4
...
21:                                               ; preds = %17, %15
  ...
  %37 = call i32 @hypre_ParaSailsSetup(i8* %23, i8* %24, i32 %26, double %28, i32 %30, double %32, double %34, i32 %36) #4
...
42:                                               ; preds = %17
  ...
  %48 = call i32 @hypre_ParaSailsSetupValues(i8* %44, i8* %45, double 0.000000e+00, double 0.000000e+00, i32 %47) #4
...
53:                                               ; preds = %42, %21
  ...
  %55 = call i32 @HYPRE_DistributedMatrixDestroy(i8* %54) #4
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetParams(%struct.hypre_Solver_struct* nocapture %0, double %1, i32 %2) local_unnamed_addr #3 {
  %4 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %5 = getelementptr inbounds %struct.Secret, %struct.Secret* %4, i64 0, i32 2
  store double %1, double* %5, align 8, !tbaa !10
  %6 = getelementptr inbounds %struct.Secret, %struct.Secret* %4, i64 0, i32 3
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetThresh(%struct.hypre_Solver_struct* nocapture %0, double %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsGetThresh(%struct.hypre_Solver_struct* nocapture readonly %0, double* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 2
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetNlevels(%struct.hypre_Solver_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsGetNlevels(%struct.hypre_Solver_struct* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 3
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetFilter(%struct.hypre_Solver_struct* nocapture %0, double %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 4
  store double %1, double* %4, align 8, !tbaa !12
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsGetFilter(%struct.hypre_Solver_struct* nocapture readonly %0, double* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 4
  %5 = load double, double* %4, align 8, !tbaa !12
  store double %5, double* %1, align 8, !tbaa !24
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetSym(%struct.hypre_Solver_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 1
  store i32 %1, i32* %4, align 8, !tbaa !3
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsGetSym(%struct.hypre_Solver_struct* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetLoadbal(%struct.hypre_Solver_struct* nocapture %0, double %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 5
  store double %1, double* %4, align 8, !tbaa !13
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsGetLoadbal(%struct.hypre_Solver_struct* nocapture readonly %0, double* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 5
  %5 = load double, double* %4, align 8, !tbaa !13
  store double %5, double* %1, align 8, !tbaa !24
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetReuse(%struct.hypre_Solver_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 6
  store i32 %1, i32* %4, align 8, !tbaa !14
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsGetReuse(%struct.hypre_Solver_struct* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 6
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsSetLogging(%struct.hypre_Solver_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 8
  store i32 %1, i32* %4, align 8, !tbaa !16
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @HYPRE_ParaSailsGetLogging(%struct.hypre_Solver_struct* nocapture readonly %0, i32* nocapture %1) local_unnamed_addr #3 {
  %3 = bitcast %struct.hypre_Solver_struct* %0 to %struct.Secret*
  %4 = getelementptr inbounds %struct.Secret, %struct.Secret* %3, i64 0, i32 8
...
define dso_local i32 @HYPRE_ParaSailsBuildIJMatrix(%struct.hypre_Solver_struct* nocapture readonly %0, %struct.hypre_IJMatrix_struct** %1) local_unnamed_addr #0 {
  ...
  %5 = call i32 @hypre_ParaSailsBuildIJMatrix(i8* %4, %struct.hypre_IJMatrix_struct** %1) #4
  %6 = load i32, i32* @hypre__global_error, align 4, !tbaa !18
  ret i32 %6
}
...
!19 = !{!4, !5, i64 0}
!20 = !{!21, !5, i64 32}
!21 = !{!"hypre_ParVector_struct", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !6, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !5, i64 48}
!22 = !{!23, !5, i64 0}
!23 = !{!"", !5, i64 0, !8, i64 8, !8, i64 12, !6, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !8, i64 32}
!24 = !{!9, !9, i64 0}

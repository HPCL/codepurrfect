; ModuleID = '/hypre/src/utilities/hopscotch_hash.c'
source_filename = "/hypre/src/utilities/hopscotch_hash.c"
...
23:                                               ; preds = %19
  ...
  %28 = shl nsw i64 %27, 2
  %29 = call i8* @hypre_MAlloc(i64 %28, i32 0) #4
  ...
  %32 = call i8* @hypre_MAlloc(i64 %28, i32 0) #4
  ...
  %35 = call i8* @hypre_MAlloc(i64 %28, i32 0) #4
...
define dso_local i32* @hypre_UnorderedIntSetCopyToArray(%struct.hypre_UnorderedIntSet* %0, i32* %1) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 8, i32 0) #4
...
33:                                               ; preds = %30, %2
  ...
  %36 = shl nsw i64 %35, 2
  %37 = call i8* @hypre_MAlloc(i64 %36, i32 0) #4

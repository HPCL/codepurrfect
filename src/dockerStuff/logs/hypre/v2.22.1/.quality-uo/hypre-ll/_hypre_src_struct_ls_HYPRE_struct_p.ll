...
declare dso_local i8* @hypre_StructKrylovCAlloc(i64, i64, i32) #2
...
301:                                              ; preds = %299
  %302 = sext i32 %208 to i64
  %303 = sext i32 %164 to i64
  %304 = sext i32 %120 to i64
  br label %316
...
316:                                              ; preds = %301, %386
  %317 = phi i32 [ %372, %386 ], [ %300, %301 ]
  %318 = phi i32 [ %369, %386 ], [ %285, %301 ]
  %319 = phi i32 [ %366, %386 ], [ %270, %301 ]
...
325:                                              ; preds = %333
  %326 = trunc i64 %346 to i32
  %327 = trunc i64 %347 to i32
  %328 = trunc i64 %348 to i32
  br label %329

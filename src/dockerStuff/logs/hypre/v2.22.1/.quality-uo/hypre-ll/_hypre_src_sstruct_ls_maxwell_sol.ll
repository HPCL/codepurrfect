; ModuleID = '/hypre/src/sstruct_ls/maxwell_solve.c'
source_filename = "/hypre/src/sstruct_ls/maxwell_solve.c"
...
158:                                              ; preds = %4
  ...
  br i1 %159, label %1049, label %160
...
170:                                              ; preds = %165
  ...
  br i1 %173, label %174, label %1049
...
175:                                              ; preds = %165, %163
  %176 = phi double [ %167, %165 ], [ 0.000000e+00, %163 ]
  %177 = phi double [ %168, %165 ], [ 0.000000e+00, %163 ]
  %178 = icmp sgt i32 %23, 0
  %179 = icmp sgt i32 %131, 0
  %180 = fcmp ogt double %176, 0.000000e+00
...
393:                                              ; preds = %390, %381
  %394 = fdiv double %383, %176
  %395 = fcmp olt double %394, %177
...
1040:                                             ; preds = %1036, %398, %175
  ...
  %1048 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* null) #4
  br label %1049

1049:                                             ; preds = %170, %174, %158, %160, %1040
  %1050 = load i32, i32* @hypre__global_error, align 4, !tbaa !53
...
!59 = !{!60, !9, i64 24}
!60 = !{!"hypre_IJMatrix_struct", !5, i64 0, !6, i64 4, !6, i64 12, !5, i64 20, !9, i64 24, !9, i64 32, !9, i64 40, !5, i64 48, !5, i64 52, !5, i64 56, !5, i64 60, !5, i64 64, !5, i64 68, !5, i64 72}

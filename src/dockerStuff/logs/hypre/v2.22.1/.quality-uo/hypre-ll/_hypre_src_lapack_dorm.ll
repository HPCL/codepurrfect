...
define dso_local i32 @hypre_dormqr(i8* %0, i8* %1, i32* %2, i32* %3, i32* %4, double* %5, i32* %6, double* %7, double* %8, i32* %9, double* %10, i32* nocapture readonly %11, i32* nocapture %12) local_unnamed_addr #0 {
  ...
  %31 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  store i64 %31, i64* @hypre_dormqr.left, align 8, !tbaa !7
  %32 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
...
42:                                               ; preds = %13
  %43 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #3
  %44 = icmp eq i64 %43, 0
...
48:                                               ; preds = %45
  %49 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #3
  %50 = icmp eq i64 %49, 0
...
105:                                              ; preds = %102
  ...
  %107 = call i32 @hypre_lapack_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0), i32* nonnull %15) #3
  br label %232

; ModuleID = '/hypre/src/blas/xerbla.c'
source_filename = "/hypre/src/blas/xerbla.c"
...
define dso_local i32 @hypre_blas_xerbla(i8* %0, i32* nocapture readonly %1) local_unnamed_addr #0 {

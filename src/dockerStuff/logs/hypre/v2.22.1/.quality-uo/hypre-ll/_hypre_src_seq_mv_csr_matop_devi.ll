...
@.str.1 = private unnamed_addr constant [55 x i8] c"hypre_CSRMatrixSortRow only implemented for cuSPARSE!\0A\00", align 1
...
define dso_local i32 @hypre_CSRMatrixSortRow(%struct.hypre_CSRMatrix* nocapture readnone %0) local_unnamed_addr #0 {
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 1506, i32 1, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i64 0, i64 0)) #2

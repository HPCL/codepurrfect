...
56:                                               ; preds = %54, %28
  ...
  %58 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #3
  ...
  %67 = load i32*, i32** %6, align 8, !tbaa !11
  %68 = icmp eq i32* %67, null
  br i1 %68, label %71, label %69

69:                                               ; preds = %56
  %70 = bitcast i32* %67 to i8*
  call void @hypre_Free(i8* nonnull %70, i32 0) #3
  store i32* null, i32** %6, align 8, !tbaa !11
  br label %71

71:                                               ; preds = %69, %56
  %72 = bitcast i32** %6 to i8**
  store i8* %58, i8** %72, align 8, !tbaa !11

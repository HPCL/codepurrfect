...
5:                                                ; preds = %4
  %6 = call noalias align 16 i8* @malloc(i64 %0) #11
  br label %10

7:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i64 0, i64 0), i32 41, i32 2, i8* getelementptr inbounds ([118 x i8], [118 x i8]* @.str.3, i64 0, i64 0)) #11
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !3
  %9 = call i32 @fflush(%struct._IO_FILE* %8) #11
  br label %10
...
13:                                               ; preds = %10
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i64 0, i64 0), i32 33, i32 2, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.5, i64 0, i64 0)) #11
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !3
  %15 = call i32 @fflush(%struct._IO_FILE* %14) #11
  %16 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #11
  br label %17
...
6:                                                ; preds = %4
  ...
  %8 = call i32 @fflush(%struct._IO_FILE* %7) #11
  br label %9
...
8:                                                ; preds = %6
  %9 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str, i64 0, i64 0), i64 %2, i8* null) #11
  br label %17
...
12:                                               ; preds = %10
  ...
  call void @llvm.memset.p0i8.i64(i8* nonnull align 1 %0, i8 %13, i64 %2, i1 false) #11
  br label %17

14:                                               ; preds = %10
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i64 0, i64 0), i32 41, i32 2, i8* getelementptr inbounds ([118 x i8], [118 x i8]* @.str.3, i64 0, i64 0)) #11
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !3
  %16 = call i32 @fflush(%struct._IO_FILE* %15) #11
  br label %17
...
6:                                                ; preds = %4
  %7 = call noalias align 16 i8* @malloc(i64 %0) #11
  br label %11
...
14:                                               ; preds = %11
  ...
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !3
  %16 = call i32 @fflush(%struct._IO_FILE* %15) #11
  %17 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #11
  br label %18
...
8:                                                ; preds = %6
  %9 = call noalias align 16 i8* @calloc(i64 %4, i64 1) #11
  br label %13
...
16:                                               ; preds = %13
  ...
  %18 = call i32 @fflush(%struct._IO_FILE* %17) #11
  %19 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #11
  br label %20
...
11:                                               ; preds = %9
  %12 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i64 0, i64 0), i64 %2, i8* %1, i8* %0) #11
  br label %16
...
15:                                               ; preds = %13
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %0, i8* align 1 %1, i64 %2, i1 false) #11
  br label %16
...
18:                                               ; preds = %16
  %19 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([82 x i8], [82 x i8]* @.str.1, i64 0, i64 0)) #11
  %20 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #11
  br label %27

21:                                               ; preds = %16
  %22 = call align 16 i8* @realloc(i8* nonnull %0, i64 %1) #11
...
24:                                               ; preds = %21
  ...
  %26 = call i32 @fflush(%struct._IO_FILE* %25) #11
  br label %27
...
11:                                               ; preds = %8
  ...
  %13 = call i32 @fflush(%struct._IO_FILE* %12) #11
  br label %37
...
22:                                               ; preds = %20
  %23 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i64 0, i64 0), i64 %18, i8* nonnull %0, i8* %15) #11
  br label %27
...
26:                                               ; preds = %24
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %15, i8* nonnull align 1 %0, i64 %18, i1 false) #11
  br label %27
...
30:                                               ; preds = %27
  ...
  %32 = call i32 @fflush(%struct._IO_FILE* %31) #11
  br label %33
...
34:                                               ; preds = %33
  ...
  %36 = call i32 @fflush(%struct._IO_FILE* %35) #11
  br label %37
...
3:                                                ; preds = %1
  ...
  %5 = call i32 @fflush(%struct._IO_FILE* %4) #11
  br label %6
...
define dso_local i32 @hypre_SetCubMemPoolSize(i32 %0, i32 %1, i32 %2, i64 %3) local_unnamed_addr #5 {
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !8
  ret i32 %5
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local i32 @HYPRE_SetGPUMemoryPoolSize(i32 %0, i32 %1, i32 %2, i64 %3) local_unnamed_addr #5 {
  %5 = load i32, i32* @hypre__global_error, align 4, !tbaa !8
  ret i32 %5
}

...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateLaplacian9pt(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, double* nocapture readonly %7) local_unnamed_addr #0 {
  ...
  %38 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #4
  ...
  %54 = call i8* @hypre_CAlloc(i64 %53, i64 4, i32 0) #4
  %55 = bitcast i8* %54 to i32*
  %56 = call i8* @hypre_CAlloc(i64 %53, i64 4, i32 0) #4
  ...
  %90 = call i8* @hypre_CAlloc(i64 %89, i64 4, i32 0) #4
...
255:                                              ; preds = %242
  ...
  %267 = call i8* @hypre_CAlloc(i64 %266, i64 4, i32 0) #4
...
353:                                              ; preds = %341, %776
  ...
  %355 = phi i32 [ %779, %776 ], [ %343, %341 ]
  %356 = phi i32 [ %778, %776 ], [ %344, %341 ]
  %357 = phi i32 [ %777, %776 ], [ %345, %341 ]
  %358 = sext i32 %356 to i64
  %359 = getelementptr inbounds i32, i32* %248, i64 %358
  store i32 %355, i32* %359, align 4, !tbaa !7
...
782:                                              ; preds = %776, %341
  ...
  %784 = phi i32 [ %344, %341 ], [ %778, %776 ]
  %785 = phi i32 [ %343, %341 ], [ %779, %776 ]
...
842:                                              ; preds = %834, %813
  ...
  call void @hypre_Free(i8* %843, i32 0) #4
...
844:                                              ; preds = %842, %789
  ...
  %849 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %848, i64 0, i32 12
  %850 = bitcast i32** %849 to i8**
  store i8* %90, i8** %850, align 8, !tbaa !20
  %851 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %848, i64 0, i32 8
  ...
  %858 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %848, i64 0, i32 9
...
865:                                              ; preds = %862, %844
  %866 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %852, i64 0, i32 12
  store i32 0, i32* %866, align 4, !tbaa !28
  %867 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %859, i64 0, i32 12
  store i32 0, i32* %867, align 4, !tbaa !28
  %868 = call %struct.hypre_Handle* (...) @hypre_handle() #4
  %869 = getelementptr inbounds %struct.hypre_Handle, %struct.hypre_Handle* %868, i64 0, i32 1
  %870 = load i32, i32* %869, align 4, !tbaa !29
  %871 = call i32 @hypre_ParCSRMatrixMigrate(%struct.hypre_ParCSRMatrix_struct* %848, i32 %870) #4
  %872 = bitcast i32** %9 to i8**
  %873 = load i8*, i8** %872, align 8, !tbaa !3
  call void @hypre_Free(i8* %873, i32 0) #4
  store i32* null, i32** %9, align 8, !tbaa !3
  %874 = bitcast i32** %10 to i8**
  %875 = load i8*, i8** %874, align 8, !tbaa !3
  call void @hypre_Free(i8* %875, i32 0) #4
...
!28 = !{!24, !5, i64 84}
!29 = !{!30, !5, i64 4}
!30 = !{!"", !8, i64 0, !5, i64 4, !5, i64 8, !5, i64 12}

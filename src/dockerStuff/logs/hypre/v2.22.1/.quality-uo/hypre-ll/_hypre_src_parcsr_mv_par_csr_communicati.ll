...
define dso_local i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %4 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 24
  %5 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %4, align 8, !tbaa !60
  %6 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 5
  ...
  %11 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %10, align 8, !tbaa !63
  ...
  %16 = icmp eq %struct.hypre_IJAssumedPart* %5, null
  br i1 %16, label %17, label %21

17:                                               ; preds = %1
  %18 = call i32 @hypre_ParCSRMatrixCreateAssumedPartition(%struct.hypre_ParCSRMatrix_struct* %0) #3
  %19 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 25
  store i32 1, i32* %19, align 8, !tbaa !67
  %20 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %4, align 8, !tbaa !60
  br label %21

21:                                               ; preds = %17, %1
  %22 = phi %struct.hypre_IJAssumedPart* [ %20, %17 ], [ %5, %1 ]
  %23 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #3
  %24 = bitcast i8* %23 to %struct._hypre_ParCSRCommPkg*
  %25 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 16
  %26 = bitcast %struct._hypre_ParCSRCommPkg** %25 to i8**
  store i8* %23, i8** %26, align 8, !tbaa !68
  %27 = call i32 @hypre_ParCSRCommPkgCreateApart(i32 %3, i32* %9, i32 %7, i32 %13, i32 %15, %struct.hypre_IJAssumedPart* %22, %struct._hypre_ParCSRCommPkg* %24) #3
...
!56 = !{!4, !8, i64 24}
!57 = !{!58, !5, i64 0}
!58 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !6, i64 80, !6, i64 88, !8, i64 96, !8, i64 104, !5, i64 112, !5, i64 116, !59, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !8, i64 152, !5, i64 160, !8, i64 168, !5, i64 176, !8, i64 184, !8, i64 192}
!59 = !{!"double", !6, i64 0}
!60 = !{!58, !8, i64 152}
!61 = !{!58, !5, i64 20}
!62 = !{!58, !8, i64 64}
!63 = !{!58, !8, i64 40}
!64 = !{!65, !5, i64 28}
!65 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80, !6, i64 84}
!66 = !{!58, !5, i64 8}
!67 = !{!58, !5, i64 160}
!68 = !{!58, !8, i64 96}
!69 = !{!4, !8, i64 32}

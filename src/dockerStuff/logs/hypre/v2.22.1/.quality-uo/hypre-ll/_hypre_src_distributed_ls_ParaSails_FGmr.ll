...
define dso_local void @FGMRES_ParaSails(%struct.Matrix* %0, %struct.ParaSails* %1, double* %2, double* %3, i32 %4, double %5, i32 %6) local_unnamed_addr #0 {
  ...
  %59 = shl nsw i64 %58, 3
  %60 = call i8* @hypre_MAlloc(i64 %59, i32 0) #5
  %61 = bitcast i8* %60 to double*
  %62 = sext i32 %4 to i64
  %63 = shl nsw i64 %62, 3
  %64 = call i8* @hypre_MAlloc(i64 %63, i32 0) #5
  %65 = bitcast i8* %64 to double*
  %66 = call i8* @hypre_MAlloc(i64 %63, i32 0) #5
  %67 = bitcast i8* %66 to double*
  %68 = mul nsw i32 %57, %46
  %69 = sext i32 %68 to i64
  %70 = shl nsw i64 %69, 3
  %71 = call i8* @hypre_MAlloc(i64 %70, i32 0) #5
  %72 = bitcast i8* %71 to double*
  %73 = mul nsw i32 %57, %4
  %74 = sext i32 %73 to i64
  %75 = shl nsw i64 %74, 3
  %76 = call i8* @hypre_MAlloc(i64 %75, i32 0) #5
  ...
  %80 = call i32 @hypre_MPI_Comm_rank(i32 %79, i32* nonnull %44) #5
...
125:                                              ; preds = %335, %7
  ...
  call void @MatrixMatvec(%struct.Matrix* %0, double* %3, double* %72) #5
  ...
  %128 = call i32 @hypre_daxpy(i32* nonnull %41, double* nonnull %42, double* %2, i32* nonnull %43, double* %72, i32* nonnull %43) #5
  ...
  %129 = call double @hypre_ddot(i32* nonnull %37, double* %72, i32* nonnull %40, double* %72, i32* nonnull %40) #5
  store double %129, double* %38, align 8, !tbaa !12
  %130 = call i32 @hypre_MPI_Allreduce(i8* nonnull %85, i8* nonnull %86, i32 1, i32 1275070475, i32 1476395011, i32 %79) #5
  ...
  %134 = call i32 @hypre_dscal(i32* nonnull %34, double* nonnull %35, double* %72, i32* nonnull %36) #5
...
151:                                              ; preds = %139
  ...
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %153, double* %154) #5
  br label %160
...
155:                                              ; preds = %139
  ...
  %159 = call i32 @hypre_dcopy(i32* nonnull %32, double* %157, i32* nonnull %33, double* %158, i32* nonnull %33) #5
...
160:                                              ; preds = %155, %151
  ...
  call void @MatrixMatvec(%struct.Matrix* %0, double* %162, double* %165) #5
...
167:                                              ; preds = %160, %167
  ...
  %171 = call double @hypre_ddot(i32* nonnull %28, double* %165, i32* nonnull %31, double* %170, i32* nonnull %31) #5
  store double %171, double* %29, align 8, !tbaa !12
  %172 = call i32 @hypre_MPI_Allreduce(i8* nonnull %96, i8* nonnull %97, i32 1, i32 1275070475, i32 1476395011, i32 %79) #5
  ...
  %177 = call i32 @hypre_daxpy(i32* nonnull %25, double* nonnull %26, double* %170, i32* nonnull %27, double* %165, i32* nonnull %27) #5
...
180:                                              ; preds = %167
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %103) #5
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %104) #5
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %105) #5
  store i32 1, i32* %24, align 4, !tbaa !11
  %181 = call double @hypre_ddot(i32* nonnull %21, double* %165, i32* nonnull %24, double* %165, i32* nonnull %24) #5
  store double %181, double* %22, align 8, !tbaa !12
  %182 = call i32 @hypre_MPI_Allreduce(i8* nonnull %103, i8* nonnull %104, i32 1, i32 1275070475, i32 1476395011, i32 %79) #5
  %183 = load double, double* %23, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %105) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %104) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %103) #5
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %108) #5
  store i32 1, i32* %20, align 4, !tbaa !11
  %190 = call i32 @hypre_dscal(i32* nonnull %18, double* nonnull %19, double* %165, i32* nonnull %20) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %108) #5
...
242:                                              ; preds = %227
  ...
  %246 = call double @sqrt(double %245) #5
...
324:                                              ; preds = %292, %324
  ...
  %332 = call i32 @hypre_daxpy(i32* nonnull %15, double* nonnull %16, double* %331, i32* nonnull %17, double* %3, i32* nonnull %17) #5
...
340:                                              ; preds = %335
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %343) #5
  store i32 1, i32* %14, align 4, !tbaa !11
  %344 = call i32 @hypre_daxpy(i32* nonnull %12, double* nonnull %13, double* %2, i32* nonnull %14, double* %72, i32* nonnull %14) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %343) #5
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %346) #5
  %347 = bitcast double* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %347) #5
  %348 = bitcast i32* %11 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %348) #5
  store i32 1, i32* %11, align 4, !tbaa !11
  %349 = call double @hypre_ddot(i32* nonnull %8, double* %72, i32* nonnull %11, double* %72, i32* nonnull %11) #5
  store double %349, double* %9, align 8, !tbaa !12
  %350 = call i32 @hypre_MPI_Allreduce(i8* nonnull %346, i8* nonnull %347, i32 1, i32 1275070475, i32 1476395011, i32 %79) #5
  %351 = load double, double* %10, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %348) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %347) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %346) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %345)
  %352 = call double @sqrt(double %351) #5
...
355:                                              ; preds = %340
  ...
  %357 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0), i32 %150, double %356) #5
  br label %358
...
358:                                              ; preds = %355, %340
  ...
  call void @hypre_Free(i8* %66, i32 0) #5
  call void @hypre_Free(i8* %71, i32 0) #5

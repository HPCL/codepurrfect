...
17:                                               ; preds = %34, %11
  ...
  %20 = call i32 @hypre_multmod(i32 %18, i32 %16, i32 %6) #2
  %21 = add nsw i32 %20, %9
  %22 = srem i32 %21, %6
...
define dso_local void @Hash_dhInsert(%struct._hash_dh* nocapture %0, i32 %1, %struct._hash_node* %2) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 130, i32 1) #2
...
14:                                               ; preds = %3
  call void @setError_dh(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 140) #2
  br label %41
...
26:                                               ; preds = %18, %24
  ...
  %28 = call i32 @hypre_multmod(i32 %27, i32 %23, i32 %5) #2
...
define dso_local void @Hash_dhPrint(%struct._hash_dh* nocapture readonly %0, %struct._IO_FILE* %1) local_unnamed_addr #0 {
  call void @dh_StartFunc(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i64 0, i64 0), i32 165, i32 1) #2

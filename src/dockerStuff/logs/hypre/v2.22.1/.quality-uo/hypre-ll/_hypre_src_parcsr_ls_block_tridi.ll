...
define dso_local i8* @hypre_BlockTridiagCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 112, i32 0) #5
...
34:                                               ; preds = %29
  ...
  call void @hypre_Free(i8* nonnull %35, i32 0) #5
...
41:                                               ; preds = %36
  ...
  call void @hypre_Free(i8* nonnull %42, i32 0) #5
...
78:                                               ; preds = %76, %71
  call void @hypre_Free(i8* %0, i32 0) #5
  ret i32 0
}
...
98:                                               ; preds = %91, %82
  %99 = call i8* @hypre_CAlloc(i64 4, i64 8, i32 0) #5
  ...
  %113 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %102, i64 0, i32 4
  %114 = load i32, i32* %113, align 8, !tbaa !35
  %115 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %108, i64 0, i32 4
  ...
  call void @hypre_Free(i8* %266, i32 0) #5
...
define dso_local i32 @hypre_BlockTridiagSetIndexSet(i8* nocapture %0, i32 %1, i32* readonly %2) local_unnamed_addr #0 {
  %4 = add nsw i32 %1, 1
  %5 = sext i32 %4 to i64
  %6 = call i8* @hypre_CAlloc(i64 %5, i64 4, i32 0) #5
...
!23 = !{!5, !5, i64 0}
!24 = !{!25, !8, i64 32}
!25 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !6, i64 80, !6, i64 88, !8, i64 96, !8, i64 104, !5, i64 112, !5, i64 116, !9, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !8, i64 152, !5, i64 160, !8, i64 168, !5, i64 176, !8, i64 184, !8, i64 192}
!26 = !{!27, !5, i64 24}
!27 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80, !6, i64 84}
...
!36 = !{!4, !5, i64 24}
!37 = !{!38, !8, i64 32}
!38 = !{!"hypre_ParVector_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !6, i64 16, !5, i64 24, !8, i64 32, !5, i64 40, !8, i64 48}
!39 = !{!40, !8, i64 0}

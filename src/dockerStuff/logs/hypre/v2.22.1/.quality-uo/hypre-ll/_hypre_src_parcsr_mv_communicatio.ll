...
define dso_local i32 @hypre_MatTCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* nocapture %0) local_unnamed_addr #2 {
  ...
  %22 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15, i64 0
  ...
  %25 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %24, i64 0, i32 3
  %26 = load i32, i32* %25, align 8, !tbaa !14
  %27 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %24, i64 0, i32 4
  ...
  %31 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %30, i64 0, i32 4
  %32 = load i32, i32* %31, align 4, !tbaa !45
  %33 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 14, i64 0
  %34 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %24, i64 0, i32 0
  %35 = load i32*, i32** %34, align 8, !tbaa !11
  %36 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %24, i64 0, i32 1
  %37 = load i32*, i32** %36, align 8, !tbaa !13
  %38 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %30, i64 0, i32 0
  %39 = load i32*, i32** %38, align 8, !tbaa !11
  %40 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %30, i64 0, i32 1
  %41 = load i32*, i32** %40, align 8, !tbaa !13
  call void @hypre_MatTCommPkgCreate_core(i32 %10, i32* %19, i32 %21, i32* nonnull %22, i32 %26, i32 %28, i32 %32, i32* nonnull %33, i32 %21, i32* %19, i32* %35, i32* %37, i32* %39, i32* %41, i32 undef, i32* nonnull %6, i32** nonnull %7, i32** nonnull %8, i32* nonnull %2, i32** nonnull %3, i32** nonnull %4, i32** nonnull %5)
  %42 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #5
  %43 = bitcast i8* %42 to i32*
  store i32 %10, i32* %43, align 8, !tbaa !46
  %44 = load i32, i32* %6, align 4, !tbaa !16
  ...
  store i32* %47, i32** %49, align 8, !tbaa !49
  %50 = load i32*, i32** %8, align 8, !tbaa !43
  %51 = getelementptr inbounds i8, i8* %42, i64 56
  %52 = bitcast i8* %51 to i32**
  store i32* %50, i32** %52, align 8, !tbaa !50
  %53 = load i32, i32* %2, align 4, !tbaa !16
  %54 = getelementptr inbounds i8, i8* %42, i64 4
  %55 = bitcast i8* %54 to i32*
  store i32 %53, i32* %55, align 4, !tbaa !51
  %56 = load i32*, i32** %3, align 8, !tbaa !43
  %57 = getelementptr inbounds i8, i8* %42, i64 8
  %58 = bitcast i8* %57 to i32**
  store i32* %56, i32** %58, align 8, !tbaa !52
  %59 = load i32*, i32** %4, align 8, !tbaa !43
  %60 = getelementptr inbounds i8, i8* %42, i64 16
  %61 = bitcast i8* %60 to i32**
  store i32* %59, i32** %61, align 8, !tbaa !53
  %62 = load i32*, i32** %5, align 8, !tbaa !43
  %63 = getelementptr inbounds i8, i8* %42, i64 24
  %64 = bitcast i8* %63 to i32**
  store i32* %62, i32** %64, align 8, !tbaa !54
  %65 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 17
  %66 = bitcast %struct._hypre_ParCSRCommPkg** %65 to i8**
  store i8* %42, i8** %66, align 8, !tbaa !55
...
!45 = !{!12, !5, i64 28}
!46 = !{!47, !5, i64 0}
!47 = !{!"_hypre_ParCSRCommPkg", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !5, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72}
!48 = !{!47, !5, i64 40}
!49 = !{!47, !8, i64 48}
!50 = !{!47, !8, i64 56}
!51 = !{!47, !5, i64 4}

...
231:                                              ; preds = %229, %227
  %232 = call i8* @hypre_CAlloc(i64 8, i64 12, i32 0) #6
  %233 = bitcast i8* %232 to [3 x i32]*
  %234 = call i8* @hypre_CAlloc(i64 8, i64 4, i32 0) #6
...
303:                                              ; preds = %299, %250
  ...
  %307 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
  %308 = bitcast i8* %307 to i32**
  %309 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
...
317:                                              ; preds = %315, %376
  ...
  %329 = call i8* @hypre_CAlloc(i64 %328, i64 4, i32 0) #6
  ...
  %341 = call i8* @hypre_CAlloc(i64 %340, i64 4, i32 0) #6
...
379:                                              ; preds = %376, %303
  %380 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
  %381 = bitcast i8* %380 to i32***
  %382 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
...
395:                                              ; preds = %387, %379
  %396 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
  %397 = bitcast i8* %396 to i32**
  %398 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
...
463:                                              ; preds = %460, %395
  ...
  %533 = call i8* @hypre_CAlloc(i64 %532, i64 4, i32 0) #6
  %534 = bitcast i8* %533 to i32*
  %535 = call i8* @hypre_CAlloc(i64 %532, i64 4, i32 0) #6
  %536 = bitcast i8* %535 to i32*
  %537 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
  %538 = bitcast i8* %537 to %struct.hypre_BoxArray_struct**
  %539 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
  %540 = bitcast i8* %539 to [3 x i32]**
  %541 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
  %542 = bitcast i8* %541 to [3 x i32]**
  %543 = call i8* @hypre_MAlloc(i64 %306, i32 0) #6
...
660:                                              ; preds = %547, %751
  ...
  %675 = call i8* @hypre_MAlloc(i64 %674, i32 0) #6
  ...
  %681 = call i8* @hypre_MAlloc(i64 %680, i32 0) #6
  ...
  %687 = call i8* @hypre_MAlloc(i64 %686, i32 0) #6
...
776:                                              ; preds = %773, %1092
  ...
  %786 = call i8* @hypre_CAlloc(i64 %552, i64 12, i32 0) #6
  %787 = bitcast i8* %786 to [3 x i32]*
  %788 = call i8* @hypre_CAlloc(i64 %552, i64 12, i32 0) #6
...
1092:                                             ; preds = %1086, %896
  ...
  call void @hypre_Free(i8* %788, i32 0) #6
...
1292:                                             ; preds = %1218, %2587
  ...
  %1304 = call i8* @hypre_MAlloc(i64 36, i32 0) #6
...
2587:                                             ; preds = %2583, %1306
  ...
  call void @hypre_Free(i8* %1304, i32 0) #6
...
3844:                                             ; preds = %3842, %2855
  ...
  %3847 = call i8* @hypre_CAlloc(i64 %3845, i64 8, i32 0) #6
  %3848 = bitcast i8* %3847 to double*
  %3849 = call i8* @hypre_CAlloc(i64 %3845, i64 4, i32 0) #6
...
3976:                                             ; preds = %3972, %4317
  ...
  %3987 = call i8* @hypre_CAlloc(i64 %3852, i64 12, i32 0) #6
  %3988 = bitcast i8* %3987 to [3 x i32]*
  %3989 = call i8* @hypre_CAlloc(i64 %3852, i64 12, i32 0) #6
...
4317:                                             ; preds = %4311, %4104
  ...
  call void @hypre_Free(i8* %3987, i32 0) #6
  call void @hypre_Free(i8* %3989, i32 0) #6
...
4526:                                             ; preds = %4452, %6052
  ...
  %4538 = call i8* @hypre_MAlloc(i64 36, i32 0) #6
...
6052:                                             ; preds = %6048, %4540
  ...
  call void @hypre_Free(i8* %4538, i32 0) #6
...
7489:                                             ; preds = %7485, %6056
  ...
  call void @hypre_Free(i8* %535, i32 0) #6
  call void @hypre_Free(i8* %533, i32 0) #6
  call void @hypre_Free(i8* %3849, i32 0) #6
  call void @hypre_Free(i8* %3847, i32 0) #6
  call void @hypre_Free(i8* %232, i32 0) #6
  call void @hypre_Free(i8* %234, i32 0) #6
...
7519:                                             ; preds = %7517, %7519
  ...
  call void @hypre_Free(i8* %7526, i32 0) #6
...
7533:                                             ; preds = %7519, %7517
  ...
  call void @hypre_Free(i8* %7537, i32 0) #6
  ...
  call void @hypre_Free(i8* %7543, i32 0) #6
...
7550:                                             ; preds = %7533, %7497
  ...
  call void @hypre_Free(i8* %7553, i32 0) #6
  ...
  call void @hypre_Free(i8* %7556, i32 0) #6
...
7559:                                             ; preds = %7550, %7489
  call void @hypre_Free(i8* %380, i32 0) #6
  call void @hypre_Free(i8* %382, i32 0) #6
...
7563:                                             ; preds = %7561, %7563
  ...
  call void @hypre_Free(i8* %7570, i32 0) #6
  ...
  call void @hypre_Free(i8* %7573, i32 0) #6
  ...
  call void @hypre_Free(i8* %7576, i32 0) #6
  ...
  call void @hypre_Free(i8* %7579, i32 0) #6
  ...
  call void @hypre_Free(i8* %7582, i32 0) #6
  ...
  call void @hypre_Free(i8* %7588, i32 0) #6
...
7591:                                             ; preds = %7563, %7559
  call void @hypre_Free(i8* %537, i32 0) #6
  call void @hypre_Free(i8* %539, i32 0) #6
  call void @hypre_Free(i8* %541, i32 0) #6
  call void @hypre_Free(i8* %543, i32 0) #6
  call void @hypre_Free(i8* %307, i32 0) #6
  call void @hypre_Free(i8* %309, i32 0) #6
  call void @hypre_Free(i8* %398, i32 0) #6

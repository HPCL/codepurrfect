...
define dso_local i32 @hypre_LocateAssumedPartition(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, %struct.hypre_IJAssumedPart* %5, i32 %6) local_unnamed_addr #0 {
...
46:                                               ; preds = %32, %44, %37, %7
  ...
  %48 = call i8* @hypre_MAlloc(i64 60, i32 0) #3
...
107:                                              ; preds = %105
  ...
  %113 = call i8* @hypre_ReAlloc(i8* %109, i64 %112, i32 0) #3
...
161:                                              ; preds = %130
  ...
  %167 = call i8* @hypre_ReAlloc(i8* %163, i64 %166, i32 0) #3
...
188:                                              ; preds = %182, %46
  ...
  %194 = call i8* @hypre_CAlloc(i64 %191, i64 20, i32 0) #3
...
272:                                              ; preds = %266
  ...
  %277 = call i8* @hypre_ReAlloc(i8* %274, i64 %276, i32 0) #3
  ...
  %282 = call i8* @hypre_ReAlloc(i8* %278, i64 %281, i32 0) #3
  ...
  %287 = call i8* @hypre_ReAlloc(i8* %283, i64 %286, i32 0) #3
...
312:                                              ; preds = %288, %250
  ...
  %316 = call i8* @hypre_CAlloc(i64 %315, i64 4, i32 0) #3
...
338:                                              ; preds = %327, %312
  ...
  call void @hypre_BigQsortbi(i32* %321, i32* %317, i32 0, i32 %341) #3
  ...
  call void @hypre_Free(i8* %194, i32 0) #3
  call void @hypre_Free(i8* %192, i32 0) #3
  call void @hypre_Free(i8* %320, i32 0) #3
  %345 = bitcast i32* %190 to i8*
  call void @hypre_Free(i8* %345, i32 0) #3
...
; Function Attrs: nounwind uwtable
define dso_local %struct.hypre_IJAssumedPart* @hypre_AssumedPartitionCreate(i32 %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = bitcast i32* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %7) #3
  %8 = call i32 @hypre_MPI_Comm_rank(i32 %0, i32* nonnull %6) #3
  %9 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 0) #3
  %10 = bitcast i8* %9 to %struct.hypre_IJAssumedPart*
  ...
  %17 = call i32 @hypre_MPI_Comm_size(i32 %0, i32* nonnull %5) #3
  %18 = load i32, i32* %5, align 4, !tbaa !3
  %19 = sdiv i32 %1, %18
  %20 = mul nsw i32 %19, %18
  %21 = srem i32 %1, %18
  %22 = mul nsw i32 %19, %11
  %23 = icmp sgt i32 %21, %11
  %24 = select i1 %23, i32 %11, i32 %21
  %25 = add nsw i32 %24, %22
  store i32 %25, i32* %13, align 4, !tbaa !3
  %26 = add nsw i32 %11, 1
  %27 = mul nsw i32 %19, %26
  %28 = icmp slt i32 %26, %21
  %29 = select i1 %28, i32 %26, i32 %21
  %30 = add i32 %27, -1
  %31 = add i32 %30, %29
  store i32 %31, i32* %15, align 4, !tbaa !3
  ...
  store i32 10, i32* %34, align 4, !tbaa !20
  %35 = call i8* @hypre_MAlloc(i64 40, i32 0) #3
  %36 = getelementptr inbounds i8, i8* %9, i64 16
  %37 = bitcast i8* %36 to i8**
  store i8* %35, i8** %37, align 8, !tbaa !16
  %38 = load i32, i32* %34, align 4, !tbaa !20
  %39 = sext i32 %38 to i64
  %40 = shl nsw i64 %39, 2
  %41 = call i8* @hypre_MAlloc(i64 %40, i32 0) #3
  %42 = getelementptr inbounds i8, i8* %9, i64 24
  %43 = bitcast i8* %42 to i8**
  store i8* %41, i8** %43, align 8, !tbaa !17
  %44 = load i32, i32* %34, align 4, !tbaa !20
  %45 = sext i32 %44 to i64
  %46 = shl nsw i64 %45, 2
  %47 = call i8* @hypre_MAlloc(i64 %46, i32 0) #3
  %48 = getelementptr inbounds i8, i8* %9, i64 32
  %49 = bitcast i8* %48 to i8**
  store i8* %47, i8** %49, align 8, !tbaa !18
  %50 = load i32, i32* %6, align 4, !tbaa !3
  %51 = call i32 @hypre_LocateAssumedPartition(i32 %0, i32 %2, i32 %3, i32 0, i32 %1, %struct.hypre_IJAssumedPart* %10, i32 %50)
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %7) #3
  ret %struct.hypre_IJAssumedPart* %10
}
...
define dso_local i32 @hypre_ParCSRMatrixCreateAssumedPartition(%struct.hypre_ParCSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %14 = call i32 @hypre_ParCSRMatrixGetLocalRange(%struct.hypre_ParCSRMatrix_struct* %0, i32* nonnull %2, i32* nonnull %3, i32* nonnull %4, i32* nonnull %5) #3
  %15 = load i32, i32* %4, align 4, !tbaa !3
  %16 = load i32, i32* %5, align 4, !tbaa !3
  %17 = call %struct.hypre_IJAssumedPart* @hypre_AssumedPartitionCreate(i32 %13, i32 %11, i32 %15, i32 %16)
  %18 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 24
  store %struct.hypre_IJAssumedPart* %17, %struct.hypre_IJAssumedPart** %18, align 8, !tbaa !30
...
5:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %17, i32 0) #3
...
define dso_local i32 @hypre_ParVectorCreateAssumedPartition(%struct.hypre_ParVector_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %14 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 0) #3
  ...
  %40 = call i8* @hypre_MAlloc(i64 40, i32 0) #3
  ...
  %45 = shl nsw i64 %44, 2
  %46 = call i8* @hypre_MAlloc(i64 %45, i32 0) #3
  ...
  %56 = call i32 @hypre_LocateAssumedPartition(i32 %8, i32 %10, i32 %12, i32 0, i32 %6, %struct.hypre_IJAssumedPart* %15, i32 %55)
  %57 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %0, i64 0, i32 8
...
!25 = !{!8, !9, i64 40}
!26 = !{!27, !4, i64 8}
!27 = !{!"hypre_ParCSRMatrix_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28, !9, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !9, i64 72, !5, i64 80, !5, i64 88, !9, i64 96, !9, i64 104, !4, i64 112, !4, i64 116, !28, i64 120, !9, i64 128, !9, i64 136, !4, i64 144, !9, i64 152, !4, i64 160, !9, i64 168, !4, i64 176, !9, i64 184, !9, i64 192}
!28 = !{!"double", !5, i64 0}
!29 = !{!27, !4, i64 0}
!30 = !{!27, !9, i64 152}
!31 = !{!32, !4, i64 4}
!32 = !{!"hypre_ParVector_struct", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !5, i64 16, !4, i64 24, !9, i64 32, !4, i64 40, !9, i64 48}
!33 = !{!32, !4, i64 0}
!34 = !{!32, !4, i64 8}
!35 = !{!32, !4, i64 12}
!36 = !{!32, !9, i64 48}

...
define dso_local double @hypre_p_dnrm2(%struct.distdef* %0, double* %1, %struct.hypre_PilutSolverGlobals* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %7 = call double @hypre_dnrm2(i32* nonnull %6, double* %1, i32* nonnull %4) #6
  %8 = fmul double %7, %7
  ...
  %11 = call double @hypre_GlobalSESumDouble(double %8, i32 %10) #6
...
define dso_local double @hypre_p_ddot(%struct.distdef* %0, double* %1, double* %2, %struct.hypre_PilutSolverGlobals* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %8 = call double @hypre_ddot(i32* nonnull %7, double* %1, i32* nonnull %5, double* %2, i32* nonnull %5) #6
...
18:                                               ; preds = %15, %18
  ...
  %29 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32 %26, double %28) #6
...
38:                                               ; preds = %34
  %39 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6
  br label %40

40:                                               ; preds = %34, %38, %11
  %41 = load i32, i32* %8, align 8, !tbaa !7
  %42 = call i32 @hypre_MPI_Barrier(i32 %41) #6
...
46:                                               ; preds = %40, %3
  ...
  %51 = call i32 @hypre_MPI_Barrier(i32 %50) #6
  ret i32 0
}
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !4, i64 0}
!8 = !{!"", !4, i64 0, !4, i64 4, !4, i64 8, !9, i64 16, !4, i64 24, !10, i64 32, !10, i64 40, !4, i64 48, !10, i64 56, !4, i64 64, !10, i64 72, !4, i64 80, !4, i64 84, !9, i64 88, !9, i64 96, !4, i64 104, !4, i64 108, !4, i64 112, !4, i64 116, !4, i64 120, !4, i64 124, !10, i64 128, !10, i64 136, !4, i64 144, !5, i64 148, !5, i64 1172, !5, i64 2196}
!9 = !{!"double", !5, i64 0}

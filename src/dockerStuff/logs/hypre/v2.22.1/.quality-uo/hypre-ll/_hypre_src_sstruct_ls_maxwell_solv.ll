; ModuleID = '/hypre/src/sstruct_ls/maxwell_solve2.c'
source_filename = "/hypre/src/sstruct_ls/maxwell_solve2.c"
...
160:                                              ; preds = %150, %148
  %161 = phi double [ %152, %150 ], [ 0.000000e+00, %148 ]
  %162 = phi double [ %153, %150 ], [ 0.000000e+00, %148 ]
  %163 = icmp sgt i32 %119, 0
  %164 = fcmp ogt double %161, 0.000000e+00
...
238:                                              ; preds = %235, %226
  %239 = fdiv double %228, %161
  %240 = fcmp olt double %239, %162
...
538:                                              ; preds = %523, %243, %160
  %539 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* null) #4
  br label %540

540:                                              ; preds = %155, %159, %143, %145, %538
  %541 = load i32, i32* @hypre__global_error, align 4, !tbaa !49
...
!60 = !{!61, !9, i64 24}
!61 = !{!"hypre_IJMatrix_struct", !5, i64 0, !6, i64 4, !6, i64 12, !5, i64 20, !9, i64 24, !9, i64 32, !9, i64 40, !5, i64 48, !5, i64 52, !5, i64 56, !5, i64 60, !5, i64 64, !5, i64 68, !5, i64 72}

...
define dso_local i8* @hypre_SMGRelaxCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 216, i32 0) #6
  ...
  %39 = call i8* @hypre_MAlloc(i64 4, i32 0) #6
...
52:                                               ; preds = %4, %47
  ...
  %64 = shl nsw i64 %63, 2
  %65 = call i8* @hypre_MAlloc(i64 %64, i32 0) #6
...
87:                                               ; preds = %83, %52
  ...
  call void @hypre_Free(i8* %65, i32 0) #6
  %90 = sext i32 %9 to i64
  %91 = shl nsw i64 %90, 3
  %92 = call i8* @hypre_MAlloc(i64 %91, i32 0) #6
...
68:                                               ; preds = %64, %4
  ...
  %76 = shl nsw i64 %75, 3
  %77 = call i8* @hypre_MAlloc(i64 %76, i32 0) #6
...
define dso_local i32 @hypre_SMGRelaxSetNumSpaces(i8* nocapture %0, i32 %1) local_unnamed_addr #0 {
  ...
  call void @hypre_Free(i8* %12, i32 0) #6
  ...
  call void @hypre_Free(i8* %16, i32 0) #6
  ...
  %24 = call i8* @hypre_MAlloc(i64 %22, i32 0) #6
  ...
  store i32* null, i32** %14, align 8, !tbaa !25
  %29 = call i8* @hypre_MAlloc(i64 %22, i32 0) #6
...
define dso_local i32 @hypre_SMGRelaxSetNumPreSpaces(i8* nocapture %0, i32 %1) local_unnamed_addr #0 {
  ...
  %9 = sext i32 %1 to i64
  %10 = shl nsw i64 %9, 2
  %11 = call i8* @hypre_MAlloc(i64 %10, i32 0) #6
...
!48 = !{!49, !9, i64 24}
!49 = !{!"hypre_StructMatrix_struct", !5, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !5, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !9, i64 88, !5, i64 96, !5, i64 100, !9, i64 104, !6, i64 112, !5, i64 136, !9, i64 144, !5, i64 152}
!50 = !{!51, !5, i64 12}

; ModuleID = '/hypre/src/parcsr_ls/HYPRE_parcsr_bicgstab.c'
source_filename = "/hypre/src/parcsr_ls/HYPRE_parcsr_bicgstab.c"
...
@.str = private unnamed_addr constant [45 x i8] c"/hypre/src/parcsr_ls/HYPRE_parcsr_bicgstab.c\00", align 1
@hypre__global_error = external dso_local local_unnamed_addr global i32, align 4

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABCreate(i32 %0, %struct.hypre_Solver_struct** %1) local_unnamed_addr #0 {
  %3 = icmp eq %struct.hypre_Solver_struct** %1, null
  br i1 %3, label %4, label %5

4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str, i64 0, i64 0), i32 21, i32 20, i8* null) #2
  br label %9

5:                                                ; preds = %2
  %6 = call %struct.hypre_BiCGSTABFunctions* @hypre_BiCGSTABFunctionsCreate(i8* (i8*)* nonnull @hypre_ParKrylovCreateVector, i32 (i8*)* nonnull @hypre_ParKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_ParKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_ParKrylovMatvec, i32 (i8*)* nonnull @hypre_ParKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_ParKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_ParKrylovCopyVector, i32 (i8*)* nonnull @hypre_ParKrylovClearVector, i32 (double, i8*)* nonnull @hypre_ParKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_ParKrylovAxpy, i32 (i8*, i32*, i32*)* nonnull @hypre_ParKrylovCommInfo, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentity) #2
  %7 = call i8* @hypre_BiCGSTABCreate(%struct.hypre_BiCGSTABFunctions* %6) #2
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABDestroy(%struct.hypre_Solver_struct* %0) local_unnamed_addr #0 {
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetup(%struct.hypre_Solver_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %3) local_unnamed_addr #0 {
  ...
  %8 = call i32 @HYPRE_BiCGSTABSetup(%struct.hypre_Solver_struct* %0, %struct.hypre_Matrix_struct* %5, %struct.hypre_Vector_struct* %6, %struct.hypre_Vector_struct* %7) #2
  ret i32 %8
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSolve(%struct.hypre_Solver_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %3) local_unnamed_addr #0 {
  %5 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to %struct.hypre_Matrix_struct*
  %6 = bitcast %struct.hypre_ParVector_struct* %2 to %struct.hypre_Vector_struct*
  %7 = bitcast %struct.hypre_ParVector_struct* %3 to %struct.hypre_Vector_struct*
  %8 = call i32 @HYPRE_BiCGSTABSolve(%struct.hypre_Solver_struct* %0, %struct.hypre_Matrix_struct* %5, %struct.hypre_Vector_struct* %6, %struct.hypre_Vector_struct* %7) #2
  ret i32 %8
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetTol(%struct.hypre_Solver_struct* %0, double %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABSetTol(%struct.hypre_Solver_struct* %0, double %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetAbsoluteTol(%struct.hypre_Solver_struct* %0, double %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABSetAbsoluteTol(%struct.hypre_Solver_struct* %0, double %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetMinIter(%struct.hypre_Solver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABSetMinIter(%struct.hypre_Solver_struct* %0, i32 %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetMaxIter(%struct.hypre_Solver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABSetMaxIter(%struct.hypre_Solver_struct* %0, i32 %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetStopCrit(%struct.hypre_Solver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABSetStopCrit(%struct.hypre_Solver_struct* %0, i32 %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABGetPrecond(%struct.hypre_Solver_struct* %0, %struct.hypre_Solver_struct** %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABGetPrecond(%struct.hypre_Solver_struct* %0, %struct.hypre_Solver_struct** %1) #2
  ret i32 %3
}

declare dso_local i32 @HYPRE_BiCGSTABGetPrecond(%struct.hypre_Solver_struct*, %struct.hypre_Solver_struct**) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetLogging(%struct.hypre_Solver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABSetLogging(%struct.hypre_Solver_struct* %0, i32 %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABSetPrintLevel(%struct.hypre_Solver_struct* %0, i32 %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABSetPrintLevel(%struct.hypre_Solver_struct* %0, i32 %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABGetNumIterations(%struct.hypre_Solver_struct* %0, i32* %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABGetNumIterations(%struct.hypre_Solver_struct* %0, i32* %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABGetFinalRelativeResidualNorm(%struct.hypre_Solver_struct* %0, double* %1) local_unnamed_addr #0 {
  %3 = call i32 @HYPRE_BiCGSTABGetFinalRelativeResidualNorm(%struct.hypre_Solver_struct* %0, double* %1) #2
  ret i32 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_ParCSRBiCGSTABGetResidual(%struct.hypre_Solver_struct* %0, %struct.hypre_ParVector_struct** %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_ParVector_struct** %1 to i8*
  %4 = call i32 @HYPRE_BiCGSTABGetResidual(%struct.hypre_Solver_struct* %0, i8* %3) #2
  ret i32 %4
}

...
20:                                               ; preds = %6
  %21 = call i64 @hypre_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #6
  %22 = icmp eq i64 %21, 0
  br i1 %22, label %94, label %23

23:                                               ; preds = %20
  store double 0.000000e+00, double* @hypre_dlansy.value, align 8, !tbaa !7
  %24 = call i64 @hypre_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6
  %25 = icmp eq i64 %24, 0
...
94:                                               ; preds = %20
  %95 = call i64 @hypre_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #6
  %96 = icmp eq i64 %95, 0
  br i1 %96, label %97, label %103

97:                                               ; preds = %94
  %98 = call i64 @hypre_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #6
  %99 = icmp eq i64 %98, 0
...
103:                                              ; preds = %100, %97, %94
  store double 0.000000e+00, double* @hypre_dlansy.value, align 8, !tbaa !7
  %104 = call i64 @hypre_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6
...
244:                                              ; preds = %100
  %245 = call i64 @hypre_lsame(i8* nonnull %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #6
  %246 = icmp eq i64 %245, 0
  br i1 %246, label %247, label %250

247:                                              ; preds = %244
  %248 = call i64 @hypre_lsame(i8* nonnull %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0)) #6
...
250:                                              ; preds = %247, %244
  ...
  %251 = call i64 @hypre_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6

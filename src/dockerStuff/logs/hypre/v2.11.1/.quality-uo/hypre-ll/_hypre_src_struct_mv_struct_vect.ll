...
66:                                               ; preds = %61, %66
  ...
  %72 = add nuw nsw i64 %67, 1
  %73 = icmp eq i64 %72, %65
  br i1 %73, label %74, label %66, !llvm.loop !84
...
92:                                               ; preds = %85, %92
  ...
  %117 = add nuw nsw i64 %95, 1
  %118 = icmp eq i64 %117, %89
  br i1 %118, label %119, label %92, !llvm.loop !85

119:                                              ; preds = %92, %74
  %120 = getelementptr inbounds [4 x i32], [4 x i32]* %9, i64 0, i64 %76
  store i32 0, i32* %120, align 4, !tbaa !14
  %121 = call i32 @hypre_BoxIndexRank(%struct.hypre_Box_struct* %49, i32* %45) #12
  %122 = load i32, i32* %45, align 4, !tbaa !14
  %123 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %43, i64 %42, i32 0, i64 1
  %124 = load i32, i32* %123, align 4, !tbaa !14
  %125 = getelementptr inbounds %struct.hypre_Box_struct, %struct.hypre_Box_struct* %43, i64 %42, i32 0, i64 2
  %126 = load i32, i32* %125, align 4, !tbaa !14
  %127 = load i32, i32* %29, align 16
  %128 = icmp sgt i32 %58, 1
  %129 = getelementptr inbounds [4 x i32], [4 x i32]* %5, i64 0, i64 %76
  %130 = icmp sgt i32 %58, 1
  %131 = icmp sgt i32 %127, 0
  %132 = icmp sgt i32 %75, 0
...
138:                                              ; preds = %137
  %139 = zext i32 %58 to i64
  br label %144

140:                                              ; preds = %144, %137
  %141 = phi i32 [ %121, %137 ], [ %152, %144 ]
  br i1 %132, label %142, label %217

142:                                              ; preds = %140
  %143 = sext i32 %78 to i64
  br label %155

144:                                              ; preds = %138, %144
  %145 = phi i64 [ 1, %138 ], [ %153, %144 ]
  %146 = phi i32 [ %121, %138 ], [ %152, %144 ]
  ...
  br i1 %154, label %140, label %144, !llvm.loop !86

155:                                              ; preds = %142, %214
  %156 = phi i32 [ %200, %214 ], [ %141, %142 ]
  %157 = phi i32 [ %168, %214 ], [ %122, %142 ]
  %158 = phi i32 [ %215, %214 ], [ 0, %142 ]
  %159 = phi i32 [ %167, %214 ], [ %124, %142 ]
  %160 = phi i32 [ %166, %214 ], [ %126, %142 ]
...
165:                                              ; preds = %163, %155
  %166 = phi i32 [ %160, %155 ], [ %181, %163 ]
  %167 = phi i32 [ %159, %155 ], [ %180, %163 ]
  %168 = phi i32 [ %157, %155 ], [ %179, %163 ]
  %169 = phi i32 [ %156, %155 ], [ %164, %163 ]
  br label %185

170:                                              ; preds = %161, %170
  %171 = phi i64 [ %162, %161 ], [ %182, %170 ]
  %172 = phi i32 [ %157, %161 ], [ %179, %170 ]
  %173 = phi i32 [ 0, %161 ], [ %183, %170 ]
  %174 = phi i32 [ %159, %161 ], [ %180, %170 ]
  %175 = phi i32 [ %160, %161 ], [ %181, %170 ]
  %176 = call double %1(i32 %172, i32 %174, i32 %175) #12
  ...
  br i1 %184, label %163, label %170, !llvm.loop !87
...
185:                                              ; preds = %185, %165
  ...
  br i1 %192, label %185, label %194, !llvm.loop !88
...
214:                                              ; preds = %203, %194
  ...
  br i1 %216, label %217, label %155, !llvm.loop !89
...
217:                                              ; preds = %214, %140
  ...
  br i1 %221, label %41, label %222, !llvm.loop !90

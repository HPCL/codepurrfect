...
define dso_local i8* @hypre_MaxwellTVCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 408) #6
  ...
  %24 = call i8* @hypre_MAlloc(i64 12) #6
...
51:                                               ; preds = %26, %103
  ...
  %56 = call i32 @HYPRE_SStructGridDestroy(%struct.hypre_SStructGrid_struct* %55) #6
  ...
  %60 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %59) #6
  ...
  %64 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %63) #6
  ...
  %68 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %67) #6
...
80:                                               ; preds = %51
  ...
  %84 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %83) #6
  ...
  %88 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %87) #6
  ...
  %92 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %91) #6
  br label %93
...
98:                                               ; preds = %93
  ...
  %102 = call i32 @HYPRE_IJMatrixDestroy(%struct.hypre_IJMatrix_struct* %101) #6
  br label %103
...
191:                                              ; preds = %180, %191
  ...
  %196 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %195) #6
  ...
  %200 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %199) #6
  ...
  %204 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %203) #6
  ...
  %208 = call i32 @hypre_ParVectorDestroy(%struct.hypre_ParVector_struct* %207) #6
...
213:                                              ; preds = %191, %180
  ...
  %217 = call i32 @hypre_BoomerAMGDestroy(i8* %216) #6
...
266:                                              ; preds = %213, %175
  ...
  %271 = call i32 @HYPRE_SStructStencilDestroy(%struct.hypre_SStructStencil_struct* %270) #6
...
283:                                              ; preds = %278, %283
  ...
  %288 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %287) #6
...
293:                                              ; preds = %283, %278, %266
  ...
  %301 = call i32 @HYPRE_SStructVectorDestroy(%struct.hypre_SStructVector_struct* %300) #6
  ...
  %305 = call i32 @HYPRE_SStructVectorDestroy(%struct.hypre_SStructVector_struct* %304) #6
  ...
  %309 = call i32 @HYPRE_SStructMatrixDestroy(%struct.hypre_SStructMatrix_struct* %308) #6
  ...
  %313 = call i32 @HYPRE_IJMatrixDestroy(%struct.hypre_IJMatrix_struct* %312) #6
  ...
  %317 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %316) #6
...
define dso_local i32 @hypre_MaxwellSetRfactors(i8* nocapture readonly %0, i32* %1) local_unnamed_addr #0 {
  ...
  %7 = call i32 @hypre_CopyIndex(i32* %1, i32* %6) #6
  ret i32 0
}
...
define dso_local i32 @hypre_MaxwellPrintLogging(i8* nocapture readonly %0, i32 %1) local_unnamed_addr #4 {
  %3 = getelementptr inbounds i8, i8* %0, i64 372
  %4 = bitcast i8* %3 to i32*
  %5 = load i32, i32* %4, align 4, !tbaa !69

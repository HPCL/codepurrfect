...
define dso_local void @FGMRES_ParaSails(%struct.Matrix* %0, %struct.ParaSails* %1, double* %2, double* %3, i32 %4, double %5, i32 %6) local_unnamed_addr #0 {
  ...
  %49 = shl nsw i64 %48, 3
  %50 = call noalias align 16 i8* @malloc(i64 %49) #8
  ...
  %66 = call noalias align 16 i8* @malloc(i64 %63) #8
  ...
  %75 = shl nsw i64 %74, 3
  %76 = call noalias align 16 i8* @malloc(i64 %75) #8
  ...
  %80 = call i32 @hypre_MPI_Comm_rank(i32 %79, i32* nonnull %44) #8
...
125:                                              ; preds = %331, %7
  ...
  call void @MatrixMatvec(%struct.Matrix* %0, double* %3, double* %72) #8
  ...
  %128 = call i32 @hypre_daxpy(i32* nonnull %41, double* nonnull %42, double* %2, i32* nonnull %43, double* %72, i32* nonnull %43) #8
  ...
  %129 = call double @hypre_ddot(i32* nonnull %37, double* %72, i32* nonnull %40, double* %72, i32* nonnull %40) #8
  store double %129, double* %38, align 8, !tbaa !12
  %130 = call i32 @hypre_MPI_Allreduce(i8* nonnull %85, i8* nonnull %86, i32 1, i32 1275070475, i32 1476395011, i32 %79) #8
  ...
  %132 = call double @sqrt(double %131) #8
  ...
  %134 = call i32 @hypre_dscal(i32* nonnull %34, double* nonnull %35, double* %72, i32* nonnull %36) #8
...
151:                                              ; preds = %139
  ...
  call void @ParaSailsApply(%struct.ParaSails* nonnull %1, double* %153, double* %154) #8
  br label %160
...
155:                                              ; preds = %139
  ...
  %159 = call i32 @hypre_dcopy(i32* nonnull %32, double* %157, i32* nonnull %33, double* %158, i32* nonnull %33) #8
...
160:                                              ; preds = %155, %151
  ...
  call void @MatrixMatvec(%struct.Matrix* %0, double* %162, double* %165) #8
...
167:                                              ; preds = %160, %167
  ...
  %171 = call double @hypre_ddot(i32* nonnull %28, double* %165, i32* nonnull %31, double* %170, i32* nonnull %31) #8
  store double %171, double* %29, align 8, !tbaa !12
  %172 = call i32 @hypre_MPI_Allreduce(i8* nonnull %96, i8* nonnull %97, i32 1, i32 1275070475, i32 1476395011, i32 %79) #8
  ...
  %177 = call i32 @hypre_daxpy(i32* nonnull %25, double* nonnull %26, double* %170, i32* nonnull %27, double* %165, i32* nonnull %27) #8
...
180:                                              ; preds = %167
  ...
  %181 = call double @hypre_ddot(i32* nonnull %21, double* %165, i32* nonnull %24, double* %165, i32* nonnull %24) #8
  store double %181, double* %22, align 8, !tbaa !12
  %182 = call i32 @hypre_MPI_Allreduce(i8* nonnull %103, i8* nonnull %104, i32 1, i32 1275070475, i32 1476395011, i32 %79) #8
  ...
  %184 = call double @sqrt(double %183) #8
  ...
  %190 = call i32 @hypre_dscal(i32* nonnull %18, double* nonnull %19, double* %165, i32* nonnull %20) #8
...
320:                                              ; preds = %288, %320
  ...
  %328 = call i32 @hypre_daxpy(i32* nonnull %15, double* nonnull %16, double* %327, i32* nonnull %17, double* %3, i32* nonnull %17) #8
...
336:                                              ; preds = %331
  ...
  %340 = call i32 @hypre_daxpy(i32* nonnull %12, double* nonnull %13, double* %2, i32* nonnull %14, double* %72, i32* nonnull %14) #8
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %342) #8
  %343 = bitcast double* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %343) #8
  %344 = bitcast i32* %11 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %344) #8
  store i32 1, i32* %11, align 4, !tbaa !11
  %345 = call double @hypre_ddot(i32* nonnull %8, double* %72, i32* nonnull %11, double* %72, i32* nonnull %11) #8
  store double %345, double* %9, align 8, !tbaa !12
  %346 = call i32 @hypre_MPI_Allreduce(i8* nonnull %342, i8* nonnull %343, i32 1, i32 1275070475, i32 1476395011, i32 %79) #8
  %347 = load double, double* %10, align 8, !tbaa !12
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %344) #8
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %343) #8
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %342) #8
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %341)
  %348 = call double @sqrt(double %347) #8
...
351:                                              ; preds = %336
  ...
  %353 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0), i32 %150, double %352)
  br label %354

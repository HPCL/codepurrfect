...
68:                                               ; preds = %64, %1
  ...
  %72 = shl nsw i64 %71, 2
  %73 = call i8* @hypre_MAlloc(i64 %72) #6
...
356:                                              ; preds = %352, %150
  ...
  %360 = call i8* @hypre_CAlloc(i64 %359, i64 4) #6
  %361 = bitcast i8* %360 to i32*
  %362 = sext i32 %357 to i64
  %363 = call i8* @hypre_CAlloc(i64 %362, i64 4) #6
...
624:                                              ; preds = %618, %498
  ...
  %632 = call i8* @hypre_MAlloc(i64 8) #6
...
878:                                              ; preds = %874, %383
  %879 = call i8* @hypre_CAlloc(i64 %359, i64 4) #6
  %880 = bitcast i8* %879 to i32*
  %881 = call i8* @hypre_CAlloc(i64 %359, i64 4) #6
  %882 = bitcast i8* %881 to i32*
  %883 = shl nsw i32 %358, 1
  %884 = sext i32 %883 to i64
  %885 = call i8* @hypre_CAlloc(i64 %884, i64 4) #6
  %886 = bitcast i8* %885 to i32*
  %887 = shl nsw i64 %884, 3
  %888 = call i8* @hypre_MAlloc(i64 %887) #6
...
900:                                              ; preds = %895, %878
  ...
  %902 = call i8* @hypre_MAlloc(i64 %901) #6
  %903 = bitcast i8* %902 to [3 x i32]*
  %904 = call i8* @hypre_MAlloc(i64 %901) #6
...
1357:                                             ; preds = %1352, %909
  ...
  call void @hypre_Free(i8* %360) #6
  call void @hypre_Free(i8* %363) #6
  call void @hypre_Free(i8* %881) #6
  call void @hypre_Free(i8* %879) #6
  call void @hypre_Free(i8* %885) #6
  call void @hypre_Free(i8* %888) #6

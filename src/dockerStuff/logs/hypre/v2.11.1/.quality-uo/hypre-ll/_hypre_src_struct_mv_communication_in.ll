...
define dso_local i32 @hypre_CommInfoCreate(%struct.hypre_BoxArrayArray_struct* %0, %struct.hypre_BoxArrayArray_struct* %1, i32** %2, i32** %3, i32** %4, i32** %5, %struct.hypre_BoxArrayArray_struct* %6, %struct.hypre_BoxArrayArray_struct* %7, i32 %8, %struct.hypre_CommInfo_struct** nocapture %9) local_unnamed_addr #0 {
  %11 = call i8* @hypre_MAlloc(i64 152) #8
...
35:                                               ; preds = %28, %24
  ...
  call void @hypre_Free(i8* nonnull %36) #8
  br label %37
...
55:                                               ; preds = %48, %44
  ...
  call void @hypre_Free(i8* nonnull %56) #8
  br label %57
...
91:                                               ; preds = %84, %80
  ...
  call void @hypre_Free(i8* nonnull %92) #8
  br label %93
...
111:                                              ; preds = %104, %100
  ...
  call void @hypre_Free(i8* nonnull %112) #8
  br label %113
...
define dso_local i32 @hypre_CreateCommInfoFromStencil(%struct.hypre_StructGrid_struct* nocapture readonly %0, %struct.hypre_StructStencil_struct* nocapture readonly %1, %struct.hypre_CommInfo_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %62 = call i8* @hypre_CAlloc(i64 %61, i64 4) #8
...
264:                                              ; preds = %259, %74
  ...
  %268 = call i8* @hypre_CAlloc(i64 %267, i64 8) #8
  %269 = bitcast i8* %268 to i32**
  %270 = call i8* @hypre_CAlloc(i64 %267, i64 8) #8
  %271 = bitcast i8* %270 to i32**
  %272 = call i8* @hypre_CAlloc(i64 %267, i64 8) #8
  %273 = bitcast i8* %272 to i32**
  %274 = call %struct.hypre_BoxArrayArray_struct* @hypre_BoxArrayArrayCreate(i32 %47, i32 %22) #8
  %275 = call i8* @hypre_CAlloc(i64 %267, i64 8) #8
  ...
  %287 = call i8* @hypre_CAlloc(i64 30, i64 4) #8
  %288 = bitcast i8* %287 to i32*
  %289 = call i8* @hypre_CAlloc(i64 30, i64 4) #8
  %290 = bitcast i8* %289 to i32*
  %291 = call i8* @hypre_CAlloc(i64 30, i64 4) #8
  ...
  %296 = call i8* @hypre_CAlloc(i64 %295, i64 4) #8
  %297 = bitcast i8* %296 to i32*
  %298 = call i8* @hypre_CAlloc(i64 %295, i64 8) #8
  %299 = bitcast i8* %298 to %struct.hypre_Box_struct**
  %300 = call i8* @hypre_CAlloc(i64 %295, i64 28) #8
...
393:                                              ; preds = %378
  ...
  %398 = call i8* @hypre_ReAlloc(i8* %395, i64 %397) #8
  %399 = bitcast i8* %398 to i32*
  %400 = bitcast i32* %381 to i8*
  %401 = call i8* @hypre_ReAlloc(i8* %400, i64 %397) #8
  %402 = bitcast i8* %401 to i32*
  %403 = bitcast i32* %382 to i8*
  %404 = call i8* @hypre_ReAlloc(i8* %403, i64 %397) #8
...
714:                                              ; preds = %711, %264
  ...
  %734 = call i8* @hypre_MAlloc(i64 152) #8
...
define dso_local i32 @hypre_CreateCommInfoFromNumGhost(%struct.hypre_StructGrid_struct* nocapture readonly %0, i32* nocapture readonly %1, %struct.hypre_CommInfo_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %17 = call i8* @hypre_CAlloc(i64 %16, i64 12) #8
...
30:                                               ; preds = %16, %29, %28
  ...
  %52 = call i8* @hypre_CAlloc(i64 %51, i64 8) #8
...
59:                                               ; preds = %30, %115
  ...
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 4) #8
...
152:                                              ; preds = %141
  %153 = call i8* @hypre_MAlloc(i64 152) #8

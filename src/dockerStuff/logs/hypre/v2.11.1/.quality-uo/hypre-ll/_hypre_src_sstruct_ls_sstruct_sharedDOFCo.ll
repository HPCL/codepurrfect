...
define dso_local %struct.hypre_MaxwellOffProcRow* @hypre_MaxwellOffProcRowCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 24) #6
  ...
  %6 = sext i32 %0 to i64
  %7 = shl nsw i64 %6, 2
  %8 = call i8* @hypre_MAlloc(i64 %7) #6
  %9 = shl nsw i64 %6, 3
...
define dso_local i32 @hypre_SStructSharedDOF_ParcsrMatRowsComm(%struct.hypre_SStructGrid_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, i32* nocapture %2, %struct.hypre_MaxwellOffProcRow*** nocapture %3) local_unnamed_addr #0 {
  ...
  %59 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 3
  %60 = load i32, i32* %59, align 4, !tbaa !18
  %61 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 5
  ...
  %64 = call i8* @hypre_CAlloc(i64 1, i64 4) #6
...
102:                                              ; preds = %96, %4
  ...
  %135 = call i8* @hypre_CAlloc(i64 %134, i64 4) #6
...
193:                                              ; preds = %102, %193
  ...
  %195 = call i8* @hypre_MAlloc(i64 4000) #6
  ...
  %199 = call i8* @hypre_MAlloc(i64 16000) #6
...
207:                                              ; preds = %169, %1038
  ...
  %225 = call i8* @hypre_MAlloc(i64 %224) #6
...
836:                                              ; preds = %813
  ...
  %846 = call i8* @hypre_ReAlloc(i8* %841, i64 %845) #6
...
929:                                              ; preds = %889
  ...
  %940 = call i8* @hypre_ReAlloc(i8* %935, i64 %939) #6
...
1021:                                             ; preds = %1016, %795
  ...
  call void @hypre_Free(i8* %1022) #6
  store %struct.hypre_BoxManEntry_struct** null, %struct.hypre_BoxManEntry_struct*** %14, align 8, !tbaa !22
...
1044:                                             ; preds = %1038, %143
  ...
  %1050 = call i8* @hypre_CAlloc(i64 %1049, i64 4) #6
...
1079:                                             ; preds = %1054, %1044
  ...
  %1085 = call i8* @hypre_MAlloc(i64 %1084) #6
  ...
  %1089 = call i8* @hypre_CAlloc(i64 %1088, i64 4) #6
  %1090 = bitcast i8* %1089 to i32*
  %1091 = call i8* @hypre_CAlloc(i64 %1088, i64 20) #6
  ...
  %1101 = call i8* @hypre_MAlloc(i64 %1100) #6
...
1116:                                             ; preds = %1109
  ...
  %1120 = call i8* @hypre_MAlloc(i64 %1119) #6
...
1179:                                             ; preds = %1173, %1179
  ...
  %1188 = call i8* @hypre_CAlloc(i64 1, i64 24) #6
  ...
  %1193 = call i8* @hypre_MAlloc(i64 %1192) #6
  %1194 = shl nsw i64 %1191, 3
  %1195 = call i8* @hypre_MAlloc(i64 %1194) #6
...
1237:                                             ; preds = %1179, %1173
  ...
  %1245 = call i8* @hypre_MAlloc(i64 %1244) #6
  ...
  call void @hypre_Free(i8* %1252) #6
...
1261:                                             ; preds = %1256, %1159
  call void @hypre_Free(i8* %1096) #6
  call void @hypre_Free(i8* %1089) #6
  call void @hypre_Free(i8* %1091) #6
  %1262 = call i8* @hypre_CAlloc(i64 %1088, i64 4) #6
  %1263 = bitcast i8* %1262 to i32*
  %1264 = call i8* @hypre_CAlloc(i64 %1088, i64 20) #6
...
1388:                                             ; preds = %1380, %1328
  ...
  call void @hypre_Free(i8* %1393) #6
...
1402:                                             ; preds = %1397, %1317
  call void @hypre_Free(i8* %1101) #6
  call void @hypre_Free(i8* %1262) #6
  call void @hypre_Free(i8* %1264) #6
  store i32 0, i32* %20, align 4, !tbaa !20
...
1405:                                             ; preds = %1402, %1405
  ...
  call void @hypre_Free(i8* %1410) #6
  ...
  call void @hypre_Free(i8* %1416) #6
...
1423:                                             ; preds = %1405, %1402
  call void @hypre_Free(i8* %116) #6
  call void @hypre_Free(i8* %131) #6
  call void @hypre_Free(i8* %139) #6
  call void @hypre_Free(i8* %135) #6
  call void @hypre_Free(i8* %126) #6
  call void @hypre_Free(i8* %121) #6
  call void @hypre_Free(i8* %107) #6
  call void @hypre_Free(i8* %111) #6
  call void @hypre_Free(i8* %1050) #6
...
!10 = !{!4, !8, i64 16}
!11 = !{!12, !5, i64 0}
!12 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !5, i64 104, !5, i64 108, !5, i64 112, !5, i64 116, !13, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !8, i64 152}
!13 = !{!"double", !6, i64 0}
!14 = !{!15, !5, i64 0}
!15 = !{!"hypre_SStructGrid_struct", !5, i64 0, !5, i64 4, !5, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !8, i64 112, !8, i64 120, !5, i64 128, !5, i64 132, !5, i64 136, !5, i64 140, !5, i64 144, !5, i64 148}
!16 = !{!15, !5, i64 8}
!17 = !{!15, !5, i64 4}
!18 = !{!12, !5, i64 12}
!19 = !{!12, !5, i64 20}

...
55:                                               ; preds = %53, %4
  ...
  %59 = call i8* @hypre_CAlloc(i64 %58, i64 8) #10
  %60 = bitcast i8* %59 to double*
  %61 = sext i32 %9 to i64
  %62 = call i8* @hypre_CAlloc(i64 %61, i64 8) #10
  %63 = bitcast i8* %62 to double*
  %64 = call i8* @hypre_CAlloc(i64 %61, i64 8) #10
  %65 = bitcast i8* %64 to double*
  %66 = call i8* @hypre_CAlloc(i64 %58, i64 8) #10
...
72:                                               ; preds = %69, %72
  ...
  %74 = call i8* @hypre_CAlloc(i64 %61, i64 8) #10

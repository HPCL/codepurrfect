...
define dso_local noalias %struct.StoredRows* @StoredRowsCreate(%struct.Matrix* %0, i32 %1) local_unnamed_addr #0 {
  %3 = call noalias align 16 dereferenceable_or_null(56) i8* @malloc(i64 56) #6
  %4 = bitcast i8* %3 to %struct.StoredRows*
  %5 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 0
  store %struct.Matrix* %0, %struct.Matrix** %5, align 16, !tbaa !3
  %6 = call %struct.Mem* (...) @MemCreate() #6
  %7 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 1
  store %struct.Mem* %6, %struct.Mem** %7, align 8, !tbaa !9
  %8 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 2
  store i32 %1, i32* %8, align 16, !tbaa !10
  %9 = getelementptr inbounds %struct.Matrix, %struct.Matrix* %0, i64 0, i32 2
  %10 = load i32, i32* %9, align 8, !tbaa !11
  %11 = getelementptr inbounds %struct.Matrix, %struct.Matrix* %0, i64 0, i32 1
  %12 = load i32, i32* %11, align 4, !tbaa !13
  %13 = add i32 %10, 1
  %14 = sub i32 %13, %12
  %15 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 3
  store i32 %14, i32* %15, align 4, !tbaa !14
  %16 = sext i32 %1 to i64
  %17 = call noalias align 16 i8* @calloc(i64 %16, i64 4) #6
  %18 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 4
  %19 = bitcast i32** %18 to i8**
  store i8* %17, i8** %19, align 8, !tbaa !15
  %20 = shl nsw i64 %16, 3
  %21 = call noalias align 16 i8* @malloc(i64 %20) #6
  %22 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 5
  %23 = bitcast i32*** %22 to i8**
  store i8* %21, i8** %23, align 16, !tbaa !16
  %24 = call noalias align 16 i8* @malloc(i64 %20) #6
  %25 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 6
  %26 = bitcast double*** %25 to i8**
  store i8* %24, i8** %26, align 8, !tbaa !17
  %27 = getelementptr inbounds %struct.StoredRows, %struct.StoredRows* %4, i64 0, i32 7
  store i32 0, i32* %27, align 16, !tbaa !18
...
declare dso_local noalias noundef align 16 i8* @calloc(i64 noundef, i64 noundef) local_unnamed_addr #3
...
define dso_local void @StoredRowsDestroy(%struct.StoredRows* nocapture %0) local_unnamed_addr #0 {
  ...
  call void @MemDestroy(%struct.Mem* %3) #6
...
define dso_local i32* @StoredRowsAllocInd(%struct.StoredRows* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %5 = shl i32 %1, 2
  %6 = call i8* @MemAlloc(%struct.Mem* %4, i32 %5) #6
...
12:                                               ; preds = %5
  ...
  %18 = shl nsw i64 %17, 2
  %19 = call align 16 i8* @realloc(i8* %16, i64 %18) #6
  ...
  %23 = shl nsw i64 %17, 3
  %24 = call align 16 i8* @realloc(i8* %22, i64 %23) #6
  ...
  %28 = call align 16 i8* @realloc(i8* %27, i64 %23) #6
...
9:                                                ; preds = %5
  ...
  call void @MatrixGetRow(%struct.Matrix* %11, i32 %1, i32* %2, i32** %3, double** %4) #6
  br label %27

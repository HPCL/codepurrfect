...
define dso_local i32 @HYPRE_SStructGraphCreate(i32 %0, %struct.hypre_SStructGrid_struct* %1, %struct.hypre_SStructGraph_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_MAlloc(i64 144) #5
  ...
  %23 = shl nsw i64 %22, 3
  %24 = call i8* @hypre_MAlloc(i64 %23) #5
  %25 = bitcast i8* %24 to %struct.hypre_SStructStencil_struct***
  %26 = shl nsw i64 %22, 2
  %27 = call i8* @hypre_MAlloc(i64 %26) #5
  %28 = bitcast i8* %27 to i32*
  %29 = call i8* @hypre_MAlloc(i64 %23) #5
  %30 = bitcast i8* %29 to i32**
  %31 = call i8* @hypre_MAlloc(i64 %23) #5
  %32 = bitcast i8* %31 to i32**
  %33 = call i8* @hypre_MAlloc(i64 %23) #5
...
38:                                               ; preds = %36, %62
  ...
  %45 = shl nsw i64 %44, 3
  %46 = call i8* @hypre_MAlloc(i64 %45) #5
...
73:                                               ; preds = %55, %8
  ...
  call void @hypre_Free(i8* %79) #5
  call void @hypre_Free(i8* %19) #5
  %80 = bitcast i32** %21 to i8*
  call void @hypre_Free(i8* %80) #5
  %81 = bitcast i32** %23 to i8*
  call void @hypre_Free(i8* %81) #5
  %82 = bitcast i32** %25 to i8*
  call void @hypre_Free(i8* %82) #5
...
94:                                               ; preds = %86
  ...
  call void @hypre_Free(i8* nonnull %98) #5
  br label %99
...
105:                                              ; preds = %99, %73
  ...
  call void @hypre_Free(i8* %107) #5
  %108 = bitcast i32** %33 to i8*
  call void @hypre_Free(i8* %108) #5
  %109 = bitcast %struct.hypre_SStructGraph_struct* %0 to i8*
  call void @hypre_Free(i8* nonnull %109) #5
  br label %110
...
define dso_local i32 @HYPRE_SStructGraphSetFEMSparsity(%struct.hypre_SStructGraph_struct* nocapture readonly %0, i32 %1, i32 %2, i32* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %9 = sext i32 %2 to i64
  %10 = shl nsw i64 %9, 2
  %11 = call i8* @hypre_MAlloc(i64 %10) #5
  %12 = bitcast i8* %11 to i32*
  %13 = call i8* @hypre_MAlloc(i64 %10) #5
...
19:                                               ; preds = %7
  %20 = call i8* @hypre_CAlloc(i64 1000, i64 8) #5
  br label %29
...
23:                                               ; preds = %21
  ...
  %27 = shl nsw i64 %26, 3
  %28 = call i8* @hypre_ReAlloc(i8* %25, i64 %27) #5
  br label %29
...
34:                                               ; preds = %29, %21
  ...
  %36 = call i8* @hypre_MAlloc(i64 40) #5
...
53:                                               ; preds = %1
  ...
  %55 = shl nsw i64 %54, 3
  %56 = call i8* @hypre_MAlloc(i64 %55) #5
  %57 = bitcast i8* %56 to %struct.hypre_BoxManager***
  %58 = call i8* @hypre_MAlloc(i64 %55) #5
...
74:                                               ; preds = %62, %136
  ...
  %82 = shl nsw i64 %81, 3
  %83 = call i8* @hypre_MAlloc(i64 %82) #5
  ...
  %86 = call i8* @hypre_MAlloc(i64 %82) #5
...
300:                                              ; preds = %297, %1
  ...
  %306 = call i8* @hypre_MAlloc(i64 %305) #5
...
314:                                              ; preds = %311, %377
  ...
  %324 = call i8* @hypre_MAlloc(i64 %323) #5
...
381:                                              ; preds = %377, %300
  ...
  %389 = call i8* @hypre_MAlloc(i64 %388) #5
  %390 = bitcast i8* %389 to i32*
  %391 = sext i32 %382 to i64
  %392 = call i8* @hypre_CAlloc(i64 %391, i64 8) #5
...
428:                                              ; preds = %420
  %429 = call i8* @hypre_MAlloc(i64 40) #5
  ...
  %443 = call i8* @hypre_MAlloc(i64 32) #5
  br label %454
...
444:                                              ; preds = %420
  ...
  %453 = call i8* @hypre_ReAlloc(i8* %450, i64 %452) #5
  br label %454
...
547:                                              ; preds = %525
  ...
  %551 = call i8* @hypre_MAlloc(i64 %550) #5
  %552 = bitcast i8* %551 to i32*
  %553 = call i8* @hypre_MAlloc(i64 %550) #5
...
585:                                              ; preds = %576, %525
  ...
  %600 = call i8* @hypre_CAlloc(i64 %595, i64 8) #5
...
751:                                              ; preds = %741, %703
  call void @hypre_Free(i8* %596) #5
  call void @hypre_Free(i8* %598) #5
  call void @hypre_Free(i8* %600) #5

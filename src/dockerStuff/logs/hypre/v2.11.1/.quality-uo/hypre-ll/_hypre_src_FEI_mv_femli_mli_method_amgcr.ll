...
349:                                              ; preds = %344
  ...
  invoke void @_ZN10MLI_VectorC1EPvPKcP19MLI_Function_Struct(%class.MLI_Vector* nonnull align 8 dereferenceable(120) %364, i8* %365, i8* nonnull %32, %struct.MLI_Function_Struct* null)
...
366:                                              ; preds = %349
  ...
  invoke void @_ZN10MLI_VectorC1EPvPKcP19MLI_Function_Struct(%class.MLI_Vector* nonnull align 8 dereferenceable(120) %390, i8* %391, i8* nonnull %32, %struct.MLI_Function_Struct* null)

...
define dso_local i32 @hypre_BoomerAMGCGRelaxWt(i8* nocapture readonly %0, i32 %1, i32 %2, double* nocapture %3) local_unnamed_addr #0 {
  ...
  %20 = call i8* @hypre_CAlloc(i64 %19, i64 8) #6
  %21 = bitcast i8* %20 to double*
  %22 = call i8* @hypre_CAlloc(i64 %19, i64 8) #6
...
34:                                               ; preds = %28, %4
  %35 = getelementptr inbounds i8, i8* %0, i64 608
...
66:                                               ; preds = %34, %63
  ...
  %68 = getelementptr inbounds i8, i8* %0, i64 192
  %69 = bitcast i8* %68 to i32**
  %70 = load i32*, i32** %69, align 8, !tbaa !23
  %71 = getelementptr inbounds i8, i8* %0, i64 440
  %72 = bitcast i8* %71 to i32*
  %73 = load i32, i32* %72, align 8, !tbaa !24
  %74 = getelementptr inbounds i8, i8* %0, i64 436

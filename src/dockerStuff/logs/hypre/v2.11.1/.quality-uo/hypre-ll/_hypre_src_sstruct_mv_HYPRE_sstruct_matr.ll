...
define dso_local i32 @HYPRE_SStructMatrixCreate(i32 %0, %struct.hypre_SStructGraph_struct* %1, %struct.hypre_SStructMatrix_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 120) #7
...
168:                                              ; preds = %164, %131
  ...
  %172 = call i8* @hypre_MAlloc(i64 %171) #7
  ...
  %180 = call i8* @hypre_MAlloc(i64 %179) #7
  ...
  %185 = getelementptr inbounds i8, i8* %6, i64 88
  %186 = getelementptr inbounds i8, i8* %6, i64 112
  ...
  %188 = getelementptr inbounds i8, i8* %6, i64 116
...
3:                                                ; preds = %1
  %4 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 16
...
65:                                               ; preds = %53, %8
  ...
  call void @hypre_Free(i8* %78) #7
  store i32* null, i32** %76, align 8, !tbaa !41
  %79 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 12
  %80 = bitcast i32** %79 to i8**
  %81 = load i8*, i8** %80, align 8, !tbaa !49
  call void @hypre_Free(i8* %81) #7
  store i32* null, i32** %79, align 8, !tbaa !49
  %82 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 13
  %83 = bitcast double** %82 to i8**
  %84 = load i8*, i8** %83, align 8, !tbaa !50
  call void @hypre_Free(i8* %84) #7
  store double* null, double** %82, align 8, !tbaa !50
  %85 = bitcast %struct.hypre_SStructMatrix_struct* %0 to i8*
  call void @hypre_Free(i8* nonnull %85) #7
  br label %86

86:                                               ; preds = %3, %65, %1
  %87 = load i32, i32* @hypre__global_error, align 4, !tbaa !30
  ret i32 %87
}
...
define dso_local i32 @HYPRE_SStructMatrixInitialize(%struct.hypre_SStructMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %12 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 17
...
19:                                               ; preds = %17, %123
  ...
  %29 = shl nsw i64 %28, 3
  %30 = call i8* @hypre_MAlloc(i64 %29) #7
...
36:                                               ; preds = %34, %90
  ...
  %51 = load [3 x i32]*, [3 x i32]** %50, align 8, !tbaa !51
...
108:                                              ; preds = %106, %108
  ...
  br i1 %119, label %120, label %108, !llvm.loop !57

120:                                              ; preds = %108, %104
  %121 = add nuw nsw i64 %105, 1
  %122 = icmp eq i64 %121, %102
  br i1 %122, label %123, label %104, !llvm.loop !58
...
123:                                              ; preds = %120, %93
  ...
  br i1 %127, label %128, label %19, !llvm.loop !59
...
define dso_local i32 @HYPRE_SStructMatrixAddFEMValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* nocapture readonly %2, double* %3) local_unnamed_addr #0 {
  ...
  %22 = load i32**, i32*** %21, align 8, !tbaa !66
  ...
  %30 = load [3 x i32]**, [3 x i32]*** %29, align 8, !tbaa !68
...
45:                                               ; preds = %40, %45
  ...
  br i1 %54, label %55, label %45, !llvm.loop !69
...
55:                                               ; preds = %45, %40
  ...
  br i1 %63, label %64, label %40, !llvm.loop !70
...
45:                                               ; preds = %40, %45
  ...
  %53 = add nuw nsw i64 %46, 1
  %54 = icmp eq i64 %53, %39
  br i1 %54, label %55, label %45, !llvm.loop !71
...
55:                                               ; preds = %45, %40
  ...
  %62 = add nuw nsw i64 %41, 1
  %63 = icmp eq i64 %62, %38
  br i1 %63, label %64, label %40, !llvm.loop !72
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7) local_unnamed_addr #0 {
  %9 = call i32 @hypre_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7, i32 0) #7
  %10 = load i32, i32* @hypre__global_error, align 4, !tbaa !30
  ret i32 %10
}

declare dso_local i32 @hypre_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct*, i32, i32*, i32*, i32, i32, i32*, double*, i32) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_SStructMatrixAddToBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7) local_unnamed_addr #0 {
  %9 = call i32 @hypre_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7, i32 1) #7
  %10 = load i32, i32* @hypre__global_error, align 4, !tbaa !30
  ret i32 %10
}

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_SStructMatrixGetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7) local_unnamed_addr #0 {
  %9 = call i32 @hypre_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7, i32 -1) #7
  %10 = load i32, i32* @hypre__global_error, align 4, !tbaa !30
  ret i32 %10
}
...
define dso_local i32 @HYPRE_SStructMatrixAssemble(%struct.hypre_SStructMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %19 = load %struct.hypre_SStructCommInfo**, %struct.hypre_SStructCommInfo*** %18, align 8, !tbaa !73
...
38:                                               ; preds = %25, %38
  ...
  br i1 %44, label %27, label %38, !llvm.loop !75
...
49:                                               ; preds = %35, %235
  ...
  %54 = load %struct.hypre_CommInfo_struct*, %struct.hypre_CommInfo_struct** %53, align 8, !tbaa !76
  ...
  %60 = load i32, i32* %59, align 8, !tbaa !80
  ...
  %68 = load %struct.hypre_StructMatrix_struct***, %struct.hypre_StructMatrix_struct**** %67, align 8, !tbaa !82
  ...
  %78 = load %struct.hypre_StructMatrix_struct***, %struct.hypre_StructMatrix_struct**** %77, align 8, !tbaa !82
...
87:                                               ; preds = %49
  ...
  %89 = load %struct.hypre_StructStencil_struct*, %struct.hypre_StructStencil_struct** %88, align 8, !tbaa !84
  %90 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %83, i64 0, i32 3
  %91 = load %struct.hypre_StructStencil_struct*, %struct.hypre_StructStencil_struct** %90, align 8, !tbaa !84
  ...
  %93 = load i32, i32* %92, align 8, !tbaa !86
  %94 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %83, i64 0, i32 12
  %95 = load i32*, i32** %94, align 8, !tbaa !87
  ...
  %99 = shl nsw i64 %98, 2
  %100 = call i8* @hypre_MAlloc(i64 %99) #7
...
121:                                              ; preds = %109, %116
  ...
  br i1 %124, label %125, label %109, !llvm.loop !88
...
125:                                              ; preds = %121, %87
  ...
  %130 = call i8* @hypre_MAlloc(i64 %129) #7
  %131 = bitcast i8* %130 to i32**
  %132 = call i8* @hypre_MAlloc(i64 %99) #7
...
147:                                              ; preds = %145, %176
  ...
  %151 = load [3 x i32]*, [3 x i32]** %134, align 8, !tbaa !51
...
155:                                              ; preds = %147, %155
  ...
  br i1 %167, label %168, label %155, !llvm.loop !89
...
176:                                              ; preds = %168, %172
  ...
  br i1 %178, label %179, label %147, !llvm.loop !90

179:                                              ; preds = %176, %145
  %180 = call i8* @hypre_MAlloc(i64 %99) #7
...
197:                                              ; preds = %187, %192
  ...
  br i1 %199, label %200, label %187, !llvm.loop !91
...
225:                                              ; preds = %205, %225
  ...
  br i1 %233, label %225, label %234, !llvm.loop !96

234:                                              ; preds = %225, %205
  call void @hypre_Free(i8* %130) #7
...
235:                                              ; preds = %49, %234
  ...
  br i1 %237, label %45, label %49, !llvm.loop !97
...
238:                                              ; preds = %47, %238
  ...
  br i1 %244, label %245, label %238, !llvm.loop !98
...
61:                                               ; preds = %57, %61
  ...
  br i1 %65, label %66, label %61, !llvm.loop !99

66:                                               ; preds = %61, %55
  %67 = add nsw i64 %56, 1
  %68 = icmp eq i64 %67, %53
  br i1 %68, label %69, label %55, !llvm.loop !100

69:                                               ; preds = %66, %44
  %70 = add nsw i64 %28, 1
  %71 = icmp eq i64 %70, %26
  br i1 %71, label %72, label %27, !llvm.loop !101
...
define dso_local i32 @HYPRE_SStructMatrixSetNSSymmetric(%struct.hypre_SStructMatrix_struct* nocapture %0, i32 %1) local_unnamed_addr #4 {
  %3 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 14
  store i32 %1, i32* %3, align 8, !tbaa !102
...
define dso_local i32 @HYPRE_SStructMatrixSetObjectType(%struct.hypre_SStructMatrix_struct* nocapture %0, i32 %1) local_unnamed_addr #3 {
  ...
  %11 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 17
...
48:                                               ; preds = %41, %32
  ...
  br i1 %50, label %51, label %32, !llvm.loop !103

51:                                               ; preds = %48, %20
  %52 = add nuw nsw i64 %21, 1
  %53 = icmp eq i64 %52, %19
  br i1 %53, label %54, label %20, !llvm.loop !104
...
define dso_local i32 @HYPRE_SStructMatrixGetObject(%struct.hypre_SStructMatrix_struct* %0, i8** nocapture %1) local_unnamed_addr #4 {
  %3 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 17
...
12:                                               ; preds = %10, %12
  ...
  %15 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %7, i8* nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* %0, i32 %14) #7
  ...
  %19 = call i32 @hypre_SStructPMatrixPrint(i8* nonnull %7, %struct.hypre_SStructPMatrix* %18, i32 %2) #7
  %20 = add nuw nsw i64 %13, 1
  %21 = icmp eq i64 %20, %11
  br i1 %21, label %22, label %12, !llvm.loop !106

22:                                               ; preds = %12, %3
  %23 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %7, i8* nonnull dereferenceable(1) getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i8* %0) #7
  ...
  %26 = call i32 @HYPRE_IJMatrixPrint(%struct.hypre_IJMatrix_struct* %25, i8* nonnull %7) #7
...
!9 = !{!10, !5, i64 0}
!10 = !{!"hypre_SStructMatrix_struct", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !5, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !5, i64 104, !5, i64 108, !5, i64 112, !5, i64 116}
!11 = !{!4, !5, i64 4}
!12 = !{!10, !5, i64 4}
!13 = !{!4, !5, i64 24}
!14 = !{!10, !5, i64 24}
...
!19 = !{!4, !8, i64 16}
!20 = !{!21, !8, i64 16}
!21 = !{!"hypre_SStructGrid_struct", !5, i64 0, !5, i64 4, !5, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !8, i64 112, !8, i64 120, !5, i64 128, !5, i64 132, !5, i64 136, !5, i64 140, !5, i64 144, !5, i64 148}
!22 = !{!8, !8, i64 0}
!23 = !{!24, !5, i64 8}
...
!76 = !{!77, !8, i64 0}
!77 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20}
!78 = !{!77, !5, i64 8}
!79 = !{!77, !5, i64 12}
!80 = !{!77, !5, i64 16}
!81 = !{!77, !5, i64 20}
!82 = !{!83, !8, i64 48}
!83 = !{!"", !5, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !5, i64 64, !8, i64 72, !5, i64 80, !5, i64 84}
!84 = !{!85, !8, i64 24}
!85 = !{!"hypre_StructMatrix_struct", !5, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !5, i64 60, !8, i64 64, !5, i64 72, !5, i64 76, !8, i64 80, !6, i64 88, !5, i64 112, !8, i64 120, !5, i64 128}
!86 = !{!85, !5, i64 32}
!87 = !{!85, !8, i64 80}

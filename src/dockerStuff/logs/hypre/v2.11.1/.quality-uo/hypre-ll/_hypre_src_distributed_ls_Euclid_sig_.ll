...
define dso_local void @sigHandler_dh(i32 %0) #0 {
  ...
  %7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %2, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 %3, i8* %6) #5
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !3
  %9 = load i32, i32* @myid_dh, align 4, !tbaa !7
  %10 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.1, i64 0, i64 0), i32 %9) #5
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !3
  %12 = load i32, i32* @myid_dh, align 4, !tbaa !7
  %13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %11, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.2, i64 0, i64 0), i32 %12) #5
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !3
  %15 = load i32, i32* @myid_dh, align 4, !tbaa !7
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.1, i64 0, i64 0), i32 %15) #5
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !3
  call void @printFunctionStack(%struct._IO_FILE* %17) #6
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !3
  %19 = call i64 @fwrite(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i64 2, i64 1, %struct._IO_FILE* %18) #5
...
22:                                               ; preds = %1
  ...
  %24 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* nonnull %20, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 %23, i8* %6)
  %25 = load %struct._IO_FILE*, %struct._IO_FILE** @logFile, align 8, !tbaa !3
  %26 = load i32, i32* @myid_dh, align 4, !tbaa !7
  %27 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %25, i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.1, i64 0, i64 0), i32 %26)
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @logFile, align 8, !tbaa !3
  %29 = load i32, i32* @myid_dh, align 4, !tbaa !7
  %30 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.2, i64 0, i64 0), i32 %29)
  %31 = load %struct._IO_FILE*, %struct._IO_FILE** @logFile, align 8, !tbaa !3
  %32 = load i32, i32* @myid_dh, align 4, !tbaa !7
  %33 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %31, i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.1, i64 0, i64 0), i32 %32)
  %34 = load %struct._IO_FILE*, %struct._IO_FILE** @logFile, align 8, !tbaa !3
  call void @printFunctionStack(%struct._IO_FILE* %34) #6
  %35 = load %struct._IO_FILE*, %struct._IO_FILE** @logFile, align 8, !tbaa !3
  %36 = call i64 @fwrite(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i64 2, i64 1, %struct._IO_FILE* %35)
  br label %37

37:                                               ; preds = %22, %1
  %38 = load i32, i32* @comm_dh, align 4, !tbaa !7
  %39 = call i32 @hypre_MPI_Abort(i32 %38, i32 -1) #6
  ret void
}
...
declare dso_local void @printFunctionStack(%struct._IO_FILE*) local_unnamed_addr #2
...
define dso_local void @sigRegister_dh() local_unnamed_addr #0 {
  ...
  %2 = call i32 @Parser_dhHasSwitch(%struct._parser_dh* %1, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0)) #6
  %3 = icmp ne i32 %2, 0
...
7:                                                ; preds = %0, %7
  ...
  %11 = call void (i32)* @signal(i32 %10, void (i32)* nonnull @sigHandler_dh) #6

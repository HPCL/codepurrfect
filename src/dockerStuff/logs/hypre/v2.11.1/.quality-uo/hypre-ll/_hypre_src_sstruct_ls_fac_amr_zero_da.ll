...
define dso_local i32 @hypre_ZeroAMRVectorData(%struct.hypre_SStructVector_struct* %0, i32* nocapture readonly %1, [3 x i32]* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %27 = call i8* @hypre_CAlloc(i64 %26, i64 4) #4
  %28 = bitcast i8* %27 to i32*
  %29 = call i8* @hypre_CAlloc(i64 %26, i64 12) #4
...
180:                                              ; preds = %175
  ...
  %182 = call i8* @hypre_CAlloc(i64 %181, i64 8) #4
...
139:                                              ; preds = %133
  ...
  %141 = call i8* @hypre_CAlloc(i64 %140, i64 8) #4
  %142 = shl nsw i64 %140, 3
  %143 = call i8* @hypre_MAlloc(i64 %142) #4
...
173:                                              ; preds = %153, %146
  call void @hypre_Free(i8* %141) #4
  call void @hypre_Free(i8* %143) #4
  br label %174

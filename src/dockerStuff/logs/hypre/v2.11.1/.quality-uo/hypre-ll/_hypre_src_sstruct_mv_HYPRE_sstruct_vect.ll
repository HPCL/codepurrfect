...
define dso_local i32 @HYPRE_SStructVectorCreate(i32 %0, %struct.hypre_SStructGrid_struct* %1, %struct.hypre_SStructVector_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_MAlloc(i64 96) #6
  ...
  %20 = shl nsw i64 %19, 3
  %21 = call i8* @hypre_MAlloc(i64 %20) #6
...
define dso_local i32 @HYPRE_SStructVectorInitialize(%struct.hypre_SStructVector_struct* %0) local_unnamed_addr #0 {
  ...
  %14 = call i8* @hypre_CAlloc(i64 %13, i64 8) #6
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_SStructVectorSetBoxValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* %2, i32* %3, i32 %4, double* %5) local_unnamed_addr #0 {
  %7 = alloca [3 x i32], align 4
  %8 = alloca [3 x i32], align 4
  %9 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %0, i64 0, i32 1
  %10 = load i32, i32* %9, align 4, !tbaa !11
  %11 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %0, i64 0, i32 5
  %12 = load %struct.hypre_SStructPVector**, %struct.hypre_SStructPVector*** %11, align 8, !tbaa !22
  %13 = sext i32 %1 to i64
  %14 = getelementptr inbounds %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %12, i64 %13
  %15 = load %struct.hypre_SStructPVector*, %struct.hypre_SStructPVector** %14, align 8, !tbaa !16
  ...
  %19 = call i32 @hypre_CopyToCleanIndex(i32* %2, i32 %10, i32* nonnull %18) #6
  %20 = getelementptr inbounds [3 x i32], [3 x i32]* %8, i64 0, i64 0
  %21 = call i32 @hypre_CopyToCleanIndex(i32* %3, i32 %10, i32* nonnull %20) #6
  %22 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %15, i32* nonnull %18, i32* nonnull %20, i32 %4, double* %5, i32 0) #6
  %23 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
...
declare dso_local i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector*, i32*, i32*, i32, double*, i32) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_SStructVectorAddToBoxValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* %2, i32* %3, i32 %4, double* %5) local_unnamed_addr #0 {
  %7 = alloca [3 x i32], align 4
  %8 = alloca [3 x i32], align 4
  %9 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %0, i64 0, i32 1
  %10 = load i32, i32* %9, align 4, !tbaa !11
  ...
  %20 = getelementptr inbounds [3 x i32], [3 x i32]* %8, i64 0, i64 0
  %21 = call i32 @hypre_CopyToCleanIndex(i32* %3, i32 %10, i32* nonnull %20) #6
  %22 = call i32 @hypre_SStructPVectorSetBoxValues(%struct.hypre_SStructPVector* %15, i32* nonnull %18, i32* nonnull %20, i32 %4, double* %5, i32 1) #6
  %23 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %17) #6
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %16) #6
  ret i32 %23
...
; Function Attrs: nounwind uwtable
define dso_local i32 @HYPRE_SStructVectorGetBoxValues(%struct.hypre_SStructVector_struct* nocapture readonly %0, i32 %1, i32* %2, i32* %3, i32 %4, double* %5) local_unnamed_addr #0 {
  %7 = alloca [3 x i32], align 4
  %8 = alloca [3 x i32], align 4
  %9 = getelementptr inbounds %struct.hypre_SStructVector_struct, %struct.hypre_SStructVector_struct* %0, i64 0, i32 1
  %10 = load i32, i32* %9, align 4, !tbaa !11
  ...
  %20 = getelementptr inbounds [3 x i32], [3 x i32]* %8, i64 0, i64 0
  %21 = call i32 @hypre_CopyToCleanIndex(i32* %3, i32 %10, i32* nonnull %20) #6
  %22 = call i32 @hypre_SStructPVectorGetBoxValues(%struct.hypre_SStructPVector* %15, i32* nonnull %18, i32* nonnull %20, i32 %4, double* %5) #6
  %23 = load i32, i32* @hypre__global_error, align 4, !tbaa !26
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %17) #6
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %16) #6
  ret i32 %23
...
declare dso_local i32 @hypre_SStructPVectorGetBoxValues(%struct.hypre_SStructPVector*, i32*, i32*, i32, double*) local_unnamed_addr #2
...
define dso_local i32 @HYPRE_SStructVectorAssemble(%struct.hypre_SStructVector_struct* %0) local_unnamed_addr #0 {
  ...
  %11 = load %struct.hypre_SStructCommInfo**, %struct.hypre_SStructCommInfo*** %10, align 8, !tbaa !59
...
25:                                               ; preds = %18, %25
  ...
  br i1 %32, label %20, label %25, !llvm.loop !61
...
38:                                               ; preds = %23, %38
  ...
  %43 = load %struct.hypre_CommInfo_struct*, %struct.hypre_CommInfo_struct** %42, align 8, !tbaa !62
  %44 = getelementptr inbounds %struct.hypre_SStructCommInfo, %struct.hypre_SStructCommInfo* %41, i64 0, i32 1
  %45 = load i32, i32* %44, align 8, !tbaa !64
  ...
  br i1 %87, label %33, label %38, !llvm.loop !71
...
88:                                               ; preds = %36, %88
  ...
  br i1 %95, label %96, label %88, !llvm.loop !72
...
define dso_local i32 @HYPRE_SStructVectorGather(%struct.hypre_SStructVector_struct* %0) local_unnamed_addr #0 {
  ...
  %9 = load %struct.hypre_SStructCommInfo**, %struct.hypre_SStructCommInfo*** %8, align 8, !tbaa !59
...
17:                                               ; preds = %1
  ...
  %19 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %18, align 8, !tbaa !73
...
31:                                               ; preds = %24, %31
  ...
  br i1 %38, label %26, label %31, !llvm.loop !74
...
39:                                               ; preds = %29, %39
  ...
  %44 = load %struct.hypre_CommInfo_struct*, %struct.hypre_CommInfo_struct** %43, align 8, !tbaa !62
  %45 = getelementptr inbounds %struct.hypre_SStructCommInfo, %struct.hypre_SStructCommInfo* %42, i64 0, i32 1
  %46 = load i32, i32* %45, align 8, !tbaa !64
  ...
  %50 = load i32, i32* %49, align 8, !tbaa !66
  ...
  %71 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %70, align 8, !tbaa !68
  %72 = getelementptr inbounds %struct.hypre_StructVector_struct, %struct.hypre_StructVector_struct* %69, i64 0, i32 2
  %73 = load %struct.hypre_BoxArray_struct*, %struct.hypre_BoxArray_struct** %72, align 8, !tbaa !68
  ...
  store i32 1, i32* %87, align 8, !tbaa !75
  %88 = add nuw nsw i64 %40, 1
  %89 = icmp eq i64 %88, %30
  br i1 %89, label %90, label %39, !llvm.loop !76
...
12:                                               ; preds = %10, %12
  ...
  %15 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %7, i8* nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* %0, i32 %14) #6
  ...
  %19 = call i32 @hypre_SStructPVectorPrint(i8* nonnull %7, %struct.hypre_SStructPVector* %18, i32 %2) #6
  %20 = add nuw nsw i64 %13, 1
  %21 = icmp eq i64 %20, %11
  br i1 %21, label %22, label %12, !llvm.loop !78
...
!9 = !{!10, !5, i64 4}
!10 = !{!"hypre_SStructGrid_struct", !5, i64 0, !5, i64 4, !5, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !8, i64 112, !8, i64 120, !5, i64 128, !5, i64 132, !5, i64 136, !5, i64 140, !5, i64 144, !5, i64 148}
!11 = !{!4, !5, i64 4}
!12 = !{!4, !5, i64 16}
!13 = !{!10, !5, i64 8}
!14 = !{!4, !5, i64 20}
...
!62 = !{!63, !8, i64 0}
!63 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20}
!64 = !{!63, !5, i64 8}
!65 = !{!63, !5, i64 12}
!66 = !{!63, !5, i64 16}
!67 = !{!63, !5, i64 20}

...
define dso_local i8* @hypre_PFMGRelaxCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 32) #4
...
12:                                               ; preds = %4, %4
  %13 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %1, i64 0, i32 10
...
!13 = !{!8, !8, i64 0}
!14 = !{!15, !8, i64 72}
!15 = !{!"hypre_StructMatrix_struct", !8, i64 0, !5, i64 8, !5, i64 16, !5, i64 24, !8, i64 32, !5, i64 40, !5, i64 48, !8, i64 56, !8, i64 60, !5, i64 64, !8, i64 72, !8, i64 76, !5, i64 80, !6, i64 88, !8, i64 112, !5, i64 120, !8, i64 128}

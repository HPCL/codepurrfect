...
26:                                               ; preds = %5
  call void @hypre_error_handler(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i64 0, i64 0), i32 2489, i32 12, i8* null) #9
  br label %322
...
234:                                              ; preds = %221, %304
  %235 = phi i32 [ %290, %304 ], [ %220, %221 ]
  %236 = phi i32 [ %305, %304 ], [ 0, %221 ]

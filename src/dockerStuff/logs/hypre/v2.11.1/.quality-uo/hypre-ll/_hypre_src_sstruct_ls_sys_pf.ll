...
define dso_local i8* @hypre_SysPFMGCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 264) #6
...
65:                                               ; preds = %50, %29
  ...
  %86 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %85) #6
  ...
  %91 = call i32 @hypre_SStructPMatrixDestroy(%struct.hypre_SStructPMatrix* %90) #6
  ...
  %96 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %95) #6
  ...
  %101 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %100) #6
...
110:                                              ; preds = %65, %110
  ...
  %116 = call i32 @hypre_SStructPGridDestroy(%struct.hypre_SStructPGrid* %115) #6
  ...
  %124 = call i32 @hypre_SStructPMatrixDestroy(%struct.hypre_SStructPMatrix* %123) #6
  ...
  %128 = call i32 @hypre_SStructPMatrixDestroy(%struct.hypre_SStructPMatrix* %127) #6
  ...
  %132 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %131) #6
  ...
  %136 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %135) #6
  ...
  %140 = call i32 @hypre_SStructPVectorDestroy(%struct.hypre_SStructPVector* %139) #6
...
define dso_local i32 @hypre_SysPFMGPrintLogging(i8* nocapture readonly %0, i32 %1) local_unnamed_addr #3 {
  %3 = getelementptr inbounds i8, i8* %0, i64 232
  %4 = bitcast i8* %3 to i32*
  %5 = load i32, i32* %4, align 8, !tbaa !50
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2, i64 0, i64 0), i32 358, i32 12, i8* null) #6
  br label %30

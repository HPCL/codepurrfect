...
@str = private unnamed_addr constant [17 x i8] c"here the mistake\00", align 1
...
define dso_local i32 @hypre_ND1AMGeInterpolation(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParCSRMatrix_struct* %2, %struct.hypre_ParCSRMatrix_struct* %3, %struct.hypre_ParCSRMatrix_struct* %4, %struct.hypre_ParCSRMatrix_struct* %5, i32 %6, %struct.hypre_MaxwellOffProcRow** nocapture readonly %7, %struct.hypre_IJMatrix_struct* %8) local_unnamed_addr #0 {
  ...
  %33 = call i32 @hypre_MPI_Comm_rank(i32 %31, i32* nonnull %10) #6
  %34 = icmp eq i32 %6, 0
...
35:                                               ; preds = %9
  ...
  %37 = shl nsw i64 %36, 2
  %38 = call i8* @hypre_MAlloc(i64 %37) #6
  %39 = bitcast i8* %38 to i32*
  %40 = call i8* @hypre_MAlloc(i64 %37) #6
...
60:                                               ; preds = %56
  %61 = add nsw i32 %6, -1
  call void @hypre_qsort2i(i32* %58, i32* %57, i32 0, i32 %61) #6
  br label %62
...
64:                                               ; preds = %62
  %65 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParMatmul(%struct.hypre_ParCSRMatrix_struct* %4, %struct.hypre_ParCSRMatrix_struct* %2) #6
  br label %66

66:                                               ; preds = %64, %62
  %67 = phi %struct.hypre_ParCSRMatrix_struct* [ %65, %64 ], [ undef, %62 ]
  %68 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParMatmul(%struct.hypre_ParCSRMatrix_struct* %5, %struct.hypre_ParCSRMatrix_struct* %3) #6
...
101:                                              ; preds = %92, %504
  ...
  %105 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %5, i32 %103, i32* nonnull %14, i32** nonnull %15, double** nonnull %18) #6
  %106 = load i32, i32* %14, align 4, !tbaa !18
  %107 = sext i32 %106 to i64
  %108 = shl nsw i64 %107, 2
  %109 = call i8* @hypre_MAlloc(i64 %108) #6
...
123:                                              ; preds = %114, %101
  %124 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %5, i32 %103, i32* nonnull %14, i32** nonnull %15, double** nonnull %18) #6
  %125 = load i32, i32* %14, align 4, !tbaa !18
  %126 = add nsw i32 %125, -1
  call void @hypre_qsort0(i32* %110, i32 0, i32 %126) #6
  %127 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %1, i32 %103, i32* nonnull %16, i32** nonnull %17, double** nonnull %18) #6
  %128 = load i32, i32* %16, align 4, !tbaa !18
  %129 = sext i32 %128 to i64
  %130 = shl nsw i64 %129, 2
  %131 = call i8* @hypre_MAlloc(i64 %130) #6
...
145:                                              ; preds = %136, %123
  %146 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %1, i32 %103, i32* nonnull %16, i32** nonnull %17, double** nonnull %18) #6
  %147 = load i32, i32* %16, align 4, !tbaa !18
  %148 = add nsw i32 %147, -1
  call void @hypre_qsort0(i32* %132, i32 0, i32 %148) #6
  br i1 %63, label %170, label %149

149:                                              ; preds = %145
  %150 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %67, i32 %103, i32* nonnull %11, i32** nonnull %13, double** nonnull %18) #6
...
168:                                              ; preds = %159, %149
  %169 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %67, i32 %103, i32* nonnull %11, i32** nonnull %13, double** nonnull %18) #6
  br label %171
...
171:                                              ; preds = %170, %168
  ...
  %173 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %68, i32 %103, i32* nonnull %12, i32** nonnull %13, double** nonnull %18) #6
  %174 = load i32, i32* %12, align 4, !tbaa !18
  %175 = sext i32 %174 to i64
  %176 = shl nsw i64 %175, 2
  %177 = call i8* @hypre_MAlloc(i64 %176) #6
...
191:                                              ; preds = %182, %171
  %192 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %68, i32 %103, i32* nonnull %12, i32** nonnull %13, double** nonnull %18) #6
...
203:                                              ; preds = %199, %191
  ...
  call void @hypre_qsort0(i32* %198, i32 0, i32 %211) #6
  %212 = load i32, i32* %16, align 4, !tbaa !18
  %213 = add nsw i32 %212, %195
  %214 = mul nsw i32 %213, %212
  %215 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %212, i32 %213, i32 %214) #6
  %216 = call i32 @hypre_CSRMatrixInitialize(%struct.hypre_CSRMatrix* %215) #6
...
225:                                              ; preds = %203, %238
  ...
  %233 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %0, i32 %230, i32* nonnull %232, i32** nonnull %19, double** nonnull %20) #6
  %234 = icmp slt i32 %233, 0
  br i1 %234, label %235, label %238

235:                                              ; preds = %225
  %236 = load i32, i32* %10, align 4, !tbaa !18
  %237 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i32 %236)
  br label %238
...
238:                                              ; preds = %235, %225
  ...
  %254 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %0, i32 %253, i32* nonnull %232, i32** nonnull %19, double** nonnull %20) #6
...
262:                                              ; preds = %238, %203
  ...
  %267 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %264, i32 %265, i32 %266) #6
  %268 = call i32 @hypre_CSRMatrixInitialize(%struct.hypre_CSRMatrix* %267) #6
...
288:                                              ; preds = %262, %358
  ...
  %296 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %25, i32 %293, i32* nonnull %295, i32** nonnull %21, double** nonnull %22) #6
...
298:                                              ; preds = %288
  ...
  %311 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %25, i32 %310, i32* nonnull %295, i32** nonnull %21, double** nonnull %22) #6
...
314:                                              ; preds = %288
  ...
  %316 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %25, i32 %315, i32* nonnull %295, i32** nonnull %21, double** nonnull %22) #6
...
370:                                              ; preds = %286, %467
  ...
  %382 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %25, i32 %379, i32* nonnull %381, i32** nonnull %21, double** nonnull %22) #6
...
384:                                              ; preds = %370
  ...
  %402 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %25, i32 %401, i32* nonnull %381, i32** nonnull %21, double** nonnull %22) #6
...
405:                                              ; preds = %370
  ...
  %412 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %25, i32 %411, i32* nonnull %381, i32** nonnull %21, double** nonnull %22) #6
...
435:                                              ; preds = %426, %405, %432
  ...
  %437 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([17 x i8], [17 x i8]* @str, i64 0, i64 0))
  br label %438
...
480:                                              ; preds = %467, %279
  ...
  %486 = call i8* @hypre_CAlloc(i64 %485, i64 4) #6
...
498:                                              ; preds = %490, %480
  ...
  %502 = call i32 @hypre_IJMatrixAddToValuesParCSR(%struct.hypre_IJMatrix_struct* %8, i32 %499, i32* %487, i32* %132, i32* %500, double* %501) #6
  call void @hypre_Free(i8* %486) #6
  call void @hypre_Free(i8* %109) #6
  call void @hypre_Free(i8* %131) #6
  br i1 %63, label %504, label %503

503:                                              ; preds = %498
  call void @hypre_Free(i8* %172) #6
  br label %504

504:                                              ; preds = %503, %498
  %505 = phi i8* [ null, %503 ], [ %172, %498 ]
  call void @hypre_Free(i8* %177) #6
  call void @hypre_Free(i8* %197) #6
  %506 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %215) #6
  %507 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %267) #6
...
512:                                              ; preds = %511
  %513 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %67) #6
  br label %514

514:                                              ; preds = %512, %511
  %515 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %68) #6
  br i1 %34, label %519, label %516

516:                                              ; preds = %514
  %517 = bitcast i32* %58 to i8*
  call void @hypre_Free(i8* %517) #6
...
define dso_local i32 @hypre_HarmonicExtension(%struct.hypre_CSRMatrix* nocapture readonly %0, %struct.hypre_CSRMatrix* nocapture readonly %1, i32 %2, i32* %3, i32 %4, i32* %5, i32 %6, i32* %7) local_unnamed_addr #0 {
  ...
  %23 = call i8* @hypre_CAlloc(i64 %22, i64 8) #6
  %24 = bitcast i8* %23 to double*
  %25 = mul nsw i32 %4, %2
  %26 = sext i32 %25 to i64
  %27 = call i8* @hypre_CAlloc(i64 %26, i64 8) #6
...
62:                                               ; preds = %60, %112
  ...
  %66 = call i32 @hypre_BinarySearch(i32* %5, i32 %65, i32 %4) #6
  %67 = icmp eq i32 %66, -1
  br i1 %67, label %68, label %106

68:                                               ; preds = %62
  %69 = load i32, i32* %64, align 4, !tbaa !18
  %70 = call i32 @hypre_BinarySearch(i32* %7, i32 %69, i32 %6) #6
...
85:                                               ; preds = %83, %101
  ...
  %89 = call i32 @hypre_BinarySearch(i32* %3, i32 %88, i32 %2) #6

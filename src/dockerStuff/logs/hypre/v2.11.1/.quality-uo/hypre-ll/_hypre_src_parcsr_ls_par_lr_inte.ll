...
107:                                              ; preds = %93, %89
  ...
  %115 = call i8* @hypre_CAlloc(i64 %114, i64 4) #5
  %116 = bitcast i8* %115 to i32*
  %117 = call i8* @hypre_CAlloc(i64 %114, i64 4) #5
...
120:                                              ; preds = %107
  ...
  %122 = call i8* @hypre_CAlloc(i64 %121, i64 4) #5
  %123 = bitcast i8* %122 to i32*
  %124 = call i8* @hypre_CAlloc(i64 %121, i64 4) #5
...
131:                                              ; preds = %126
  ...
  %141 = call i8* @hypre_CAlloc(i64 %140, i64 4) #5
...
394:                                              ; preds = %391
  ...
  %398 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0), i32 %397, double %396)
...
403:                                              ; preds = %400
  ...
  %405 = call i8* @hypre_CAlloc(i64 %404, i64 4) #5
  %406 = bitcast i8* %405 to i32*
  %407 = call i8* @hypre_CAlloc(i64 %404, i64 8) #5
...
413:                                              ; preds = %409
  ...
  %415 = call i8* @hypre_CAlloc(i64 %414, i64 4) #5
  %416 = bitcast i8* %415 to i32*
  %417 = call i8* @hypre_CAlloc(i64 %414, i64 8) #5
...
453:                                              ; preds = %452
  %454 = call i8* @hypre_CAlloc(i64 %422, i64 8) #5
  %455 = bitcast i8* %454 to double*
  %456 = call i8* @hypre_CAlloc(i64 %422, i64 4) #5
  %457 = bitcast i8* %456 to i32*
  %458 = call i8* @hypre_CAlloc(i64 %422, i64 4) #5
...
1503:                                             ; preds = %1499
  ...
  %1505 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], [47 x i8]* @.str.1, i64 0, i64 0), i32 %1504, double %1500, double %1501, double %1502)
...
1555:                                             ; preds = %1552, %1541
  ...
  call void @hypre_Free(i8* %1556) #5
  %1557 = bitcast i32* %127 to i8*
  call void @hypre_Free(i8* %1557) #5
...
1570:                                             ; preds = %1567
  ...
  call void @hypre_Free(i8* %1575) #5
  ...
  call void @hypre_Free(i8* %1579) #5
...
1581:                                             ; preds = %1570
  ...
  call void @hypre_Free(i8* %1583) #5
  store i32* null, i32** %17, align 8, !tbaa !19
  br label %1584
...
129:                                              ; preds = %125
  ...
  %131 = call i8* @hypre_CAlloc(i64 %130, i64 4) #5
...
137:                                              ; preds = %129, %125
  ...
  %141 = call i8* @hypre_CAlloc(i64 1, i64 4) #5
  %142 = bitcast i8* %141 to i32*
  %143 = load i32, i32* %67, align 4, !tbaa !20
  %144 = sext i32 %143 to i64
  %145 = call i8* @hypre_CAlloc(i64 %144, i64 4) #5
  %146 = bitcast i8* %145 to i32*
  %147 = load i32, i32* %67, align 4, !tbaa !20
  %148 = sext i32 %147 to i64
  %149 = call i8* @hypre_CAlloc(i64 %148, i64 4) #5
...
163:                                              ; preds = %162
  ...
  %165 = call i8* @hypre_CAlloc(i64 %164, i64 4) #5
...
176:                                              ; preds = %171
  ...
  %178 = call i8* @hypre_CAlloc(i64 %177, i64 4) #5
...
433:                                              ; preds = %426
  ...
  %437 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0), i32 %436, double %435)
...
448:                                              ; preds = %443
  ...
  %450 = call i8* @hypre_CAlloc(i64 %449, i64 4) #5
  %451 = bitcast i8* %450 to i32*
  %452 = call i8* @hypre_CAlloc(i64 %449, i64 8) #5
...
458:                                              ; preds = %454
  ...
  %460 = call i8* @hypre_CAlloc(i64 %459, i64 4) #5
  %461 = bitcast i8* %460 to i32*
  %462 = call i8* @hypre_CAlloc(i64 %459, i64 8) #5
...
1155:                                             ; preds = %1154
  ...
  call void @hypre_Free(i8* %1156) #5
  br label %1157
...
1160:                                             ; preds = %1157
  ...
  call void @hypre_Free(i8* %1161) #5
  br label %1162
...
1163:                                             ; preds = %1162
  ...
  %1167 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 %1166, double %1165)
...
1217:                                             ; preds = %1214, %1203
  ...
  call void @hypre_Free(i8* %1218) #5
  call void @hypre_Free(i8* %141) #5
  call void @hypre_Free(i8* %149) #5
  call void @hypre_Free(i8* %145) #5
...
1231:                                             ; preds = %1221
  ...
  call void @hypre_Free(i8* %1233) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  br label %1234
...
101:                                              ; preds = %87, %83
  ...
  %111 = call i8* @hypre_CAlloc(i64 %108, i64 4) #5
...
126:                                              ; preds = %120
  ...
  %128 = call i8* @hypre_CAlloc(i64 %127, i64 4) #5
  %129 = bitcast i8* %128 to i32*
  %130 = load i32, i32* %18, align 4, !tbaa !20
  %131 = sext i32 %130 to i64
  %132 = call i8* @hypre_CAlloc(i64 %131, i64 4) #5
...
1547:                                             ; preds = %1544, %1533
  ...
  call void @hypre_Free(i8* %1548) #5
  %1549 = bitcast i32* %121 to i8*
  call void @hypre_Free(i8* %1549) #5
...
584:                                              ; preds = %580
  ...
  %586 = call i8* @hypre_CAlloc(i64 %585, i64 4) #5
  %587 = bitcast i8* %586 to i32*
  %588 = call i8* @hypre_CAlloc(i64 %585, i64 8) #5
...
594:                                              ; preds = %590
  ...
  %596 = call i8* @hypre_CAlloc(i64 %595, i64 4) #5
  %597 = bitcast i8* %596 to i32*
  %598 = call i8* @hypre_CAlloc(i64 %595, i64 8) #5
...
1516:                                             ; preds = %1513, %1502
  ...
  call void @hypre_Free(i8* %1517) #5
...
1532:                                             ; preds = %1521
  ...
  call void @hypre_Free(i8* %1534) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  br label %1535
...
580:                                              ; preds = %576
  ...
  %582 = call i8* @hypre_CAlloc(i64 %581, i64 4) #5
  %583 = bitcast i8* %582 to i32*
  %584 = call i8* @hypre_CAlloc(i64 %581, i64 8) #5
...
590:                                              ; preds = %586
  ...
  %592 = call i8* @hypre_CAlloc(i64 %591, i64 4) #5
  %593 = bitcast i8* %592 to i32*
  %594 = call i8* @hypre_CAlloc(i64 %591, i64 8) #5
...
106:                                              ; preds = %92, %88
  ...
  %114 = call i8* @hypre_CAlloc(i64 %113, i64 4) #5
  %115 = bitcast i8* %114 to i32*
  %116 = call i8* @hypre_CAlloc(i64 %113, i64 4) #5
  %117 = bitcast i8* %116 to i32*
...
119:                                              ; preds = %106
  ...
  %121 = call i8* @hypre_CAlloc(i64 %120, i64 4) #5
  %122 = bitcast i8* %121 to i32*
  %123 = call i8* @hypre_CAlloc(i64 %120, i64 4) #5
  %124 = bitcast i8* %123 to i32*
  br label %125
...
386:                                              ; preds = %383
  ...
  %390 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0), i32 %389, double %388)
...
399:                                              ; preds = %396
  ...
  %401 = call i8* @hypre_CAlloc(i64 %400, i64 4) #5
  %402 = bitcast i8* %401 to i32*
  %403 = call i8* @hypre_CAlloc(i64 %400, i64 8) #5
...
409:                                              ; preds = %405
  ...
  %411 = call i8* @hypre_CAlloc(i64 %410, i64 4) #5
  %412 = bitcast i8* %411 to i32*
  %413 = call i8* @hypre_CAlloc(i64 %410, i64 8) #5
...
1073:                                             ; preds = %1072
  ...
  %1077 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 %1076, double %1075)
...
1127:                                             ; preds = %1124, %1113
  ...
  call void @hypre_Free(i8* %1128) #5
  %1129 = bitcast i32* %126 to i8*
  call void @hypre_Free(i8* %1129) #5
...
1143:                                             ; preds = %1132
  ...
  call void @hypre_Free(i8* %1145) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  br label %1146

...
define dso_local i8* @hypre_AMECreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 136) #6
...
18:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i32 91, i32 12, i8* null) #6
  br label %73
...
define dso_local i32 @hypre_AMESolve(i8* %0) local_unnamed_addr #0 {
  ...
  %18 = shl nsw i64 %17, 3
  %19 = call i8* @hypre_MAlloc(i64 %18) #6

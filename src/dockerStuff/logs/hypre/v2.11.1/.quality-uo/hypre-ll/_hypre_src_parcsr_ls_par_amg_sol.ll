...
@str.19 = private unnamed_addr constant [53 x i8] c"                                            relative\00", align 1
@str.20 = private unnamed_addr constant [53 x i8] c"               residual        factor       residual\00", align 1
@str.21 = private unnamed_addr constant [53 x i8] c"               --------        ------       --------\00", align 1
@str.22 = private unnamed_addr constant [37 x i8] c"\0A\0AERROR detected by Hypre ...  BEGIN\00", align 1
@str.23 = private unnamed_addr constant [67 x i8] c"ERROR -- hypre_BoomerAMGSolve: INFs and/or NaNs detected in input.\00", align 1
@str.24 = private unnamed_addr constant [60 x i8] c"User probably placed non-numerics in supplied A, x_0, or b.\00", align 1
@str.25 = private unnamed_addr constant [35 x i8] c"ERROR detected by Hypre ...  END\0A\0A\00", align 1
@str.26 = private unnamed_addr constant [21 x i8] c"\0A\0AAMG SOLUTION INFO:\00", align 1
...
24:                                               ; preds = %20, %4
  ...
  %47 = getelementptr inbounds i8, i8* %0, i64 1368
  %48 = bitcast i8* %47 to i32*
  %49 = load i32, i32* %48, align 8, !tbaa !21
  %50 = getelementptr inbounds i8, i8* %0, i64 1376
  %51 = bitcast i8* %50 to i32*
  %52 = load i32, i32* %51, align 8, !tbaa !22
  %53 = getelementptr inbounds i8, i8* %0, i64 1372
  ...
  %62 = getelementptr inbounds i8, i8* %0, i64 608
...
69:                                               ; preds = %24
  %70 = call i32 @hypre_BoomerAMGWriteSolverParams(i8* %0) #6
  br label %71
...
77:                                               ; preds = %71
  %78 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @str.26, i64 0, i64 0))
  br label %79
...
81:                                               ; preds = %79
  %82 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %34, align 8, !tbaa !24
  br i1 %19, label %83, label %91

83:                                               ; preds = %81
  %84 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %82, %struct.hypre_ParVector_struct* %25) #6
  br i1 %75, label %85, label %89

85:                                               ; preds = %83
  %86 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %31, align 8, !tbaa !24
  %87 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %37, align 8, !tbaa !24
  %88 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %86, %struct.hypre_ParVector_struct* %87, double -1.000000e+00, %struct.hypre_ParVector_struct* %25) #6
  br label %89

89:                                               ; preds = %85, %83
  %90 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %25, %struct.hypre_ParVector_struct* %25) #6
  br label %99

91:                                               ; preds = %81
  %92 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %82, %struct.hypre_ParVector_struct* %64) #6
  br i1 %75, label %93, label %97

93:                                               ; preds = %91
  %94 = load %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParCSRMatrix_struct** %31, align 8, !tbaa !24
  %95 = load %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct** %37, align 8, !tbaa !24
  %96 = call i32 @hypre_ParCSRMatrixMatvec(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %94, %struct.hypre_ParVector_struct* %95, double -1.000000e+00, %struct.hypre_ParVector_struct* %64) #6
  br label %97

97:                                               ; preds = %93, %91
  %98 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %64, %struct.hypre_ParVector_struct* %64) #6
  br label %99

99:                                               ; preds = %97, %89
  %100 = phi double [ %98, %97 ], [ %90, %89 ]
  %101 = call double @sqrt(double %100) #6
  %102 = fcmp une double %101, 0.000000e+00
  %103 = fdiv double %101, %101
  %104 = select i1 %102, double %103, double 0.000000e+00
  %105 = fcmp uno double %104, 0.000000e+00
  br i1 %105, label %106, label %114

106:                                              ; preds = %99
  %107 = icmp sgt i32 %15, 0
  br i1 %107, label %108, label %113

108:                                              ; preds = %106
  %109 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([37 x i8], [37 x i8]* @str.22, i64 0, i64 0))
  %110 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([67 x i8], [67 x i8]* @str.23, i64 0, i64 0))
  %111 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([60 x i8], [60 x i8]* @str.24, i64 0, i64 0))
  %112 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([35 x i8], [35 x i8]* @str.25, i64 0, i64 0))
  br label %113

113:                                              ; preds = %108, %106
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 195, i32 1, i8* null) #6
  br label %327

114:                                              ; preds = %99
  %115 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %2) #6
  %116 = call double @sqrt(double %115) #6
  %117 = fcmp une double %116, 0.000000e+00
  br i1 %117, label %118, label %120

118:                                              ; preds = %114
  %119 = fdiv double %101, %116
  br label %120

120:                                              ; preds = %79, %114, %118
  %121 = phi double [ %101, %118 ], [ %101, %114 ], [ 1.000000e+00, %79 ]
  %122 = phi double [ %101, %118 ], [ %101, %114 ], [ 0.000000e+00, %79 ]
  %123 = phi double [ %119, %118 ], [ %101, %114 ], [ 1.000000e+00, %79 ]
  %124 = phi double [ %116, %118 ], [ %116, %114 ], [ 0.000000e+00, %79 ]
  %125 = load i32, i32* %6, align 4, !tbaa !28
  %126 = icmp eq i32 %125, 0
  %127 = select i1 %126, i1 %67, i1 false
  br i1 %127, label %128, label %133

128:                                              ; preds = %120
  %129 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([53 x i8], [53 x i8]* @str.19, i64 0, i64 0))
  %130 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([53 x i8], [53 x i8]* @str.20, i64 0, i64 0))
  %131 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([53 x i8], [53 x i8]* @str.21, i64 0, i64 0))
  %132 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([38 x i8], [38 x i8]* @.str.9, i64 0, i64 0), double %122, double %123)
  br label %133

133:                                              ; preds = %128, %120
  %134 = getelementptr inbounds i8, i8* %0, i64 632
  %135 = bitcast i8* %134 to double*
  %136 = icmp sgt i32 %49, -1
  %137 = icmp slt i32 %49, %28
  %138 = select i1 %136, i1 %137, i1 false
  %139 = icmp sgt i32 %55, -1
  %140 = icmp slt i32 %55, %28
  %141 = select i1 %139, i1 %140, i1 false
  %142 = icmp sgt i32 %52, -1
  %143 = icmp slt i32 %52, %28
  %144 = select i1 %142, i1 %143, i1 false
  %145 = select i1 %80, i1 true, i1 %75
  %146 = fcmp une double %124, 0.000000e+00
  %147 = getelementptr inbounds i8, i8* %0, i64 688
  %148 = bitcast i8* %147 to double*
  %149 = getelementptr inbounds i8, i8* %0, i64 676
  %150 = bitcast i8* %149 to i32*
  %151 = getelementptr inbounds i8, i8* %0, i64 680
  %152 = bitcast i8* %151 to i32*
  %153 = fcmp oge double %123, %40
...
158:                                              ; preds = %133
  %159 = select i1 %138, i1 true, i1 %141
  %160 = select i1 %159, i1 true, i1 %144
  br label %161

161:                                              ; preds = %158, %201
  %162 = phi i32 [ %193, %201 ], [ 0, %158 ]
  %163 = phi double [ %192, %201 ], [ %123, %158 ]
  %164 = phi double [ %191, %201 ], [ %121, %158 ]
  %165 = phi double [ %190, %201 ], [ 0.000000e+00, %158 ]
  store double 0.000000e+00, double* %135, align 8, !tbaa !29
  br i1 %160, label %168, label %166

166:                                              ; preds = %161
  %167 = call i32 @hypre_BoomerAMGCycle(i8* %0, %struct.hypre_ParVector_struct** nonnull %34, %struct.hypre_ParVector_struct** nonnull %37) #6
  br label %170

168:                                              ; preds = %161
  %169 = call i32 @hypre_BoomerAMGAdditiveCycle(i8* %0) #6
  br label %170

170:                                              ; preds = %168, %166
  br i1 %145, label %171, label %189
...
175:                                              ; preds = %171
  %176 = call i32 @hypre_ParCSRMatrixMatvecOutOfPlace(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %172, %struct.hypre_ParVector_struct* %173, double -1.000000e+00, %struct.hypre_ParVector_struct* %174, %struct.hypre_ParVector_struct* %25) #6
  %177 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %25, %struct.hypre_ParVector_struct* %25) #6
  br label %181

178:                                              ; preds = %171
  %179 = call i32 @hypre_ParCSRMatrixMatvecOutOfPlace(double 1.000000e+00, %struct.hypre_ParCSRMatrix_struct* %172, %struct.hypre_ParVector_struct* %173, double -1.000000e+00, %struct.hypre_ParVector_struct* %174, %struct.hypre_ParVector_struct* %64) #6
  %180 = call double @hypre_ParVectorInnerProd(%struct.hypre_ParVector_struct* %64, %struct.hypre_ParVector_struct* %64) #6
  br label %181
...
199:                                              ; preds = %189
  %200 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @.str.10, i64 0, i64 0), i32 %193, double %191, double %190, double %192)
  br label %201
...
207:                                              ; preds = %201, %133
  %208 = phi double [ %121, %133 ], [ %191, %201 ]
  %209 = phi i32 [ 0, %133 ], [ %193, %201 ]
  %210 = icmp eq i32 %209, %46
  %211 = select i1 %210, i1 %75, i1 false
  br i1 %211, label %212, label %213

212:                                              ; preds = %207
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 289, i32 256, i8* null) #6
  br label %213

213:                                              ; preds = %212, %207
  %214 = icmp ne i32 %209, 0
  %215 = fcmp une double %122, 0.000000e+00
  %216 = select i1 %214, i1 %215, i1 false
  br i1 %216, label %217, label %222

217:                                              ; preds = %213
  %218 = fdiv double %208, %122
  %219 = sitofp i32 %209 to double
  %220 = fdiv double 1.000000e+00, %219
  %221 = call double @pow(double %218, double %220) #6
  br label %222
...
224:                                              ; preds = %222
  ...
  %226 = call i8* @hypre_CAlloc(i64 %225, i64 8) #6
  %227 = bitcast i8* %226 to double*
  %228 = call i8* @hypre_CAlloc(i64 %225, i64 8) #6
...
316:                                              ; preds = %315
  %317 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([49 x i8], [49 x i8]* @.str.11, i64 0, i64 0))
  %318 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], [47 x i8]* @str, i64 0, i64 0))
  %319 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([38 x i8], [38 x i8]* @.str.13, i64 0, i64 0), i32 %46)
  %320 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([47 x i8], [47 x i8]* @.str.14, i64 0, i64 0))
  br label %321

321:                                              ; preds = %316, %315
  %322 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([35 x i8], [35 x i8]* @.str.15, i64 0, i64 0), double %223)
  %323 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([33 x i8], [33 x i8]* @.str.16, i64 0, i64 0), double %301)
  %324 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([31 x i8], [31 x i8]* @.str.17, i64 0, i64 0), double %312)
  %325 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @.str.18, i64 0, i64 0), double %311)
  br label %326

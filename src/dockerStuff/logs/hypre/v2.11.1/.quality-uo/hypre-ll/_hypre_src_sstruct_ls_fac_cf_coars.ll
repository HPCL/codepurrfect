...
200:                                              ; preds = %127, %290
  ...
  %226 = call i8* @hypre_MAlloc(i64 %225) #6
...
317:                                              ; preds = %298
  ...
  %322 = call i8* @hypre_MAlloc(i64 %321) #6
  %323 = bitcast i8* %322 to i32*
  %324 = call i8* @hypre_MAlloc(i64 108) #6
...
365:                                              ; preds = %341, %327
  ...
  %373 = call i8* @hypre_MAlloc(i64 %372) #6
...
578:                                              ; preds = %570
  ...
  %582 = call i8* @hypre_CAlloc(i64 %581, i64 4) #6
...
609:                                              ; preds = %605, %578
  ...
  %613 = call i8* @hypre_MAlloc(i64 %612) #6
  %614 = bitcast i8* %613 to i32*
  %615 = call i8* @hypre_MAlloc(i64 %612) #6
  %616 = bitcast i8* %615 to i32*
  %617 = call i8* @hypre_MAlloc(i64 %612) #6
  %618 = bitcast i8* %617 to i32*
  %619 = call i8* @hypre_MAlloc(i64 %612) #6
  %620 = bitcast i8* %619 to i32*
  %621 = call i8* @hypre_CAlloc(i64 %611, i64 8) #6
...
687:                                              ; preds = %679, %672
  call void @hypre_Free(i8* %613) #6
  call void @hypre_Free(i8* %615) #6
  call void @hypre_Free(i8* %617) #6
...
713:                                              ; preds = %710, %687
  call void @hypre_Free(i8* %621) #6
  call void @hypre_Free(i8* %619) #6
...
782:                                              ; preds = %776, %365
  ...
  call void @hypre_Free(i8* %373) #6
  call void @hypre_Free(i8* %322) #6
  call void @hypre_Free(i8* %324) #6
  br label %784
...
!17 = !{!5, !5, i64 0}
!18 = !{!19, !5, i64 148}
!19 = !{!"hypre_SStructGrid_struct", !5, i64 0, !5, i64 4, !5, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !8, i64 112, !8, i64 120, !5, i64 128, !5, i64 132, !5, i64 136, !5, i64 140, !5, i64 144, !5, i64 148}
!20 = !{!19, !5, i64 128}

...
15:                                               ; preds = %9
  ...
  call void @hypre_Free(i8* nonnull %16) #3
  store i32* null, i32** %10, align 8, !tbaa !3
  br label %17
...
14:                                               ; preds = %4
  ...
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 4) #3
...
84:                                               ; preds = %32, %4
  ...
  %98 = call i8* @hypre_CAlloc(i64 %97, i64 4) #3

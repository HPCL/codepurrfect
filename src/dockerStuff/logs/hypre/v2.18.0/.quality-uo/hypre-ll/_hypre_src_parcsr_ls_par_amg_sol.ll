...
24:                                               ; preds = %20, %4
  ...
  %50 = getelementptr inbounds i8, i8* %0, i64 1440
  %51 = bitcast i8* %50 to i32*
  %52 = load i32, i32* %51, align 8, !tbaa !22
  %53 = getelementptr inbounds i8, i8* %0, i64 1448
  %54 = bitcast i8* %53 to i32*
  %55 = load i32, i32* %54, align 8, !tbaa !23
  %56 = getelementptr inbounds i8, i8* %0, i64 1444
...
223:                                              ; preds = %218
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 311, i32 256, i8* null) #4
  br label %224

...
define dso_local i32 @hypre_ParaSailsCreate(i32 %0, i8** nocapture %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_CAlloc(i64 1, i64 16, i32 1) #3
...
33:                                               ; preds = %31
  call void @hypre_error_handler(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str, i64 0, i64 0), i32 238, i32 1, i8* null) #3
  br label %34
...
define internal fastcc %struct.Matrix* @convert_matrix(i32 %0, i8* %1) unnamed_addr #0 {
  ...
  %15 = call i32 @HYPRE_DistributedMatrixGetLocalRange(i8* %1, i32* nonnull %3, i32* nonnull %4, i32* nonnull %5, i32* nonnull %5) #3
  %16 = load i32, i32* %3, align 4, !tbaa !11
  %17 = load i32, i32* %4, align 4, !tbaa !11
  %18 = call %struct.Matrix* @MatrixCreate(i32 %0, i32 %16, i32 %17) #3
...
22:                                               ; preds = %2, %22
  %23 = phi i32 [ %29, %22 ], [ %19, %2 ]
  %24 = call i32 @HYPRE_DistributedMatrixGetRow(i8* %1, i32 %23, i32* nonnull %6, i32** nonnull %7, double** nonnull %8) #3
  %25 = load i32, i32* %6, align 4, !tbaa !11
  %26 = load i32*, i32** %7, align 8, !tbaa !10
  %27 = load double*, double** %8, align 8, !tbaa !10
  call void @MatrixSetRow(%struct.Matrix* %18, i32 %23, i32 %25, i32* %26, double* %27) #3
  %28 = call i32 @HYPRE_DistributedMatrixRestoreRow(i8* %1, i32 %23, i32* nonnull %6, i32** nonnull %7, double** nonnull %8) #3
  %29 = add nsw i32 %23, 1
  %30 = load i32, i32* %4, align 4, !tbaa !11
  %31 = icmp slt i32 %23, %30
  br i1 %31, label %22, label %32, !llvm.loop !18

32:                                               ; preds = %22, %2
  call void @MatrixComplete(%struct.Matrix* %18) #3
...
20:                                               ; preds = %18
  call void @hypre_error_handler(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str, i64 0, i64 0), i32 298, i32 1, i8* null) #3
  br label %21
...
define dso_local i32 @hypre_ParaSailsBuildIJMatrix(i8* nocapture readonly %0, %struct.hypre_IJMatrix_struct** %1) local_unnamed_addr #0 {
  ...
  %30 = call i8* @hypre_CAlloc(i64 %29, i64 4, i32 1) #3
  ...
  %37 = call i8* @hypre_CAlloc(i64 %36, i64 4, i32 1) #3
...
78:                                               ; preds = %72, %2
  ...
  call void @hypre_Free(i8* %37, i32 1) #3

...
56:                                               ; preds = %53, %46
  ...
  %67 = call i8* @hypre_CAlloc(i64 %66, i64 8, i32 1) #3
...
131:                                              ; preds = %129, %126
  ...
  call void @hypre_Free(i8* %121, i32 1) #3
  br label %133
...
41:                                               ; preds = %38, %5
  ...
  %52 = call i8* @hypre_CAlloc(i64 %51, i64 8, i32 1) #3
...
!20 = !{!19, !5, i64 4}
!21 = !{!22, !8, i64 0}
!22 = !{!"", !8, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !5, i64 32}
!23 = !{!5, !5, i64 0}
!24 = !{!25, !5, i64 4}

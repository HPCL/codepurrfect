...
68:                                               ; preds = %6, %160
  ...
  %81 = call i32 @hypre_MPI_Barrier(i32 %80) #10
  ...
  %85 = call i32 @hypre_MPI_Barrier(i32 %84) #10
...
167:                                              ; preds = %165, %6
  ...
  call void @hypre_Free(i8* %172, i32 1) #10
  ...
  call void @hypre_Free(i8* %175, i32 1) #10
  ...
  call void @hypre_Free(i8* %178, i32 1) #10
  ...
  call void @hypre_Free(i8* %181, i32 1) #10
  ...
  call void @hypre_Free(i8* %184, i32 1) #10
  ...
  call void @hypre_Free(i8* %187, i32 1) #10
  ...
  call void @hypre_Free(i8* %190, i32 1) #10
  ...
  call void @hypre_Free(i8* %193, i32 1) #10
  ...
  call void @hypre_Free(i8* %196, i32 1) #10
  ...
  call void @hypre_Free(i8* %199, i32 1) #10
  ...
  call void @hypre_Free(i8* %202, i32 1) #10
  ...
  call void @hypre_Free(i8* %205, i32 1) #10
  ...
  call void @hypre_Free(i8* %208, i32 1) #10
  ...
  call void @hypre_Free(i8* %211, i32 1) #10
  ...
  call void @hypre_Free(i8* %214, i32 1) #10
  ...
  call void @hypre_Free(i8* %220, i32 1) #10
  ...
  call void @hypre_Free(i8* %224, i32 1) #10
  %225 = bitcast i32* %53 to i8*
  call void @hypre_Free(i8* %225, i32 1) #10
  ...
  call void @hypre_Free(i8* %228, i32 1) #10
...
74:                                               ; preds = %72, %66
  ...
  %108 = call i8* @hypre_CAlloc(i64 %107, i64 8, i32 1) #10
...
226:                                              ; preds = %219, %195
  ...
  %231 = call i8* @hypre_CAlloc(i64 %230, i64 4, i32 1) #10
...
299:                                              ; preds = %293, %273
  call void @hypre_Free(i8* %231, i32 1) #10
...
50:                                               ; preds = %48, %289
  ...
  call void @hypre_CheckBounds(i32 0, i32 %53, i32 %54, %struct.hypre_PilutSolverGlobals* %10) #10
  ...
  call void @hypre_CheckBounds(i32 0, i32 %64, i32 %65, %struct.hypre_PilutSolverGlobals* %10) #10
...
88:                                               ; preds = %50, %116
  ...
  call void @hypre_CheckBounds(i32 0, i32 %92, i32 %93, %struct.hypre_PilutSolverGlobals* %10) #10
...
138:                                              ; preds = %85, %165
  %139 = call i32 @hypre_ExtractMinLR(%struct.hypre_PilutSolverGlobals* %10) #10
  %140 = load i32, i32* %26, align 4, !tbaa !14
  call void @hypre_CheckBounds(i32 0, i32 %139, i32 %140, %struct.hypre_PilutSolverGlobals* %10) #10
  ...
  call void @hypre_CheckBounds(i32 0, i32 %143, i32 %146, %struct.hypre_PilutSolverGlobals* %10) #10
  %147 = load i32*, i32** %31, align 8, !tbaa !45
  %148 = sext i32 %145 to i64
  %149 = getelementptr inbounds i32, i32* %147, i64 %148
  %150 = load i32, i32* %149, align 4, !tbaa !17
  %151 = load i32, i32* %35, align 8, !tbaa !91
  call void @hypre_CheckBounds(i32 0, i32 %150, i32 %151, %struct.hypre_PilutSolverGlobals* %10) #10
...
177:                                              ; preds = %175, %235
  ...
  call void @hypre_CheckBounds(i32 0, i32 %180, i32 %181, %struct.hypre_PilutSolverGlobals* %10) #10
...
248:                                              ; preds = %240, %248
  ...
  call void @hypre_CheckBounds(i32 0, i32 %252, i32 %253, %struct.hypre_PilutSolverGlobals* %10) #10
...
264:                                              ; preds = %285, %246
  ...
  %270 = call double @llvm.fabs.f64(double %269) #10
...
define dso_local void @hypre_SendFactoredRows(%struct.factormatdef* nocapture readonly %0, %struct.comminfodef* nocapture readonly %1, i32* nocapture readonly %2, i32 %3, %struct.hypre_PilutSolverGlobals* %4) local_unnamed_addr #0 {
  ...
  %38 = call i8* @hypre_CAlloc(i64 %37, i64 4, i32 1) #10
  %39 = bitcast i8* %38 to i32*
  %40 = call i8* @hypre_CAlloc(i64 %37, i64 4, i32 1) #10
...
263:                                              ; preds = %252, %214
  call void @hypre_Free(i8* %38, i32 1) #10
...
61:                                               ; preds = %57, %402
  ...
  call void @hypre_CheckBounds(i32 0, i32 %66, i32 %63, %struct.hypre_PilutSolverGlobals* %10) #10
  %67 = sext i32 %66 to i64
  ...
  call void @hypre_CheckBounds(i32 0, i32 %74, i32 %75, %struct.hypre_PilutSolverGlobals* %10) #10
...
101:                                              ; preds = %61, %137
  ...
  call void @hypre_CheckBounds(i32 0, i32 %105, i32 %106, %struct.hypre_PilutSolverGlobals* %10) #10
...
159:                                              ; preds = %98, %350
  %160 = call i32 @hypre_ExtractMinLR(%struct.hypre_PilutSolverGlobals* %10) #10
  %161 = and i32 %160, 1
...
164:                                              ; preds = %159
  ...
  call void @hypre_CheckBounds(i32 0, i32 %163, i32 %165, %struct.hypre_PilutSolverGlobals* %10) #10
  ...
  call void @hypre_CheckBounds(i32 0, i32 %168, i32 %171, %struct.hypre_PilutSolverGlobals* %10) #10
  %172 = load i32*, i32** %37, align 8, !tbaa !45
  %173 = sext i32 %170 to i64
  %174 = getelementptr inbounds i32, i32* %172, i64 %173
  %175 = load i32, i32* %174, align 4, !tbaa !17
  %176 = load i32, i32* %41, align 8, !tbaa !91
  call void @hypre_CheckBounds(i32 0, i32 %175, i32 %176, %struct.hypre_PilutSolverGlobals* %10) #10
...
199:                                              ; preds = %197, %257
  ...
  call void @hypre_CheckBounds(i32 0, i32 %202, i32 %203, %struct.hypre_PilutSolverGlobals* %10) #10
...
262:                                              ; preds = %159
  ...
  call void @hypre_CheckBounds(i32 0, i32 %270, i32 %271, %struct.hypre_PilutSolverGlobals* %10) #10
  ...
  call void @hypre_CheckBounds(i32 0, i32 %275, i32 %276, %struct.hypre_PilutSolverGlobals* %10) #10
...
295:                                              ; preds = %292, %347
  ...
  call void @hypre_CheckBounds(i32 0, i32 %298, i32 %299, %struct.hypre_PilutSolverGlobals* %10) #10
...
361:                                              ; preds = %353, %361
  ...
  call void @hypre_CheckBounds(i32 0, i32 %365, i32 %366, %struct.hypre_PilutSolverGlobals* %10) #10
...
377:                                              ; preds = %398, %359
  ...
  %383 = call double @llvm.fabs.f64(double %382) #10
...
16:                                               ; preds = %8
  ...
  call void @hypre_Free(i8* %17, i32 1) #10
  %18 = bitcast double* %6 to i8*
  call void @hypre_Free(i8* %18, i32 1) #10
  %19 = call i32* @hypre_idx_malloc(i32 %14, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.6, i64 0, i64 0)) #10
  %20 = call double* @hypre_fp_malloc(i32 %14, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.7, i64 0, i64 0)) #10
  br label %21

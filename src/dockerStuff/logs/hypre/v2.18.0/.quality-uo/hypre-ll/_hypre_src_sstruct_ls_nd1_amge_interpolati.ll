...
480:                                              ; preds = %467, %279
  ...
  %490 = call i8* @hypre_CAlloc(i64 %489, i64 4, i32 1) #3
...
506:                                              ; preds = %494, %480
  ...
  call void @hypre_Free(i8* %490, i32 1) #3
...
524:                                              ; preds = %522
  ...
  call void @hypre_Free(i8* %525, i32 1) #3
  %526 = bitcast i32* %57 to i8*
  call void @hypre_Free(i8* %526, i32 1) #3
  br label %527

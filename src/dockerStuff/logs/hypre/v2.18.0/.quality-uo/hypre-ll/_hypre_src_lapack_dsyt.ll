...
define dso_local i32 @hypre_dsytrd(i8* %0, i32* %1, double* %2, i32* %3, double* %4, double* %5, double* %6, double* %7, i32* nocapture readonly %8, i32* nocapture %9) local_unnamed_addr #0 {
  ...
  %22 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
...
27:                                               ; preds = %10
  %28 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
  %29 = icmp eq i64 %28, 0
...
57:                                               ; preds = %54
  ...
  %59 = call i32 @hypre_lapack_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32* nonnull %11) #3
  br label %251

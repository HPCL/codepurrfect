...
define dso_local i8* @hypre_BiCGSTABCreate(%struct.hypre_BiCGSTABFunctions* %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 168, i32 1) #7
...
96:                                               ; preds = %91
  ...
  call void @hypre_Free(i8* nonnull %97, i32 1) #7
...
98:                                               ; preds = %96, %91
  ...
  %101 = call i8* @hypre_CAlloc(i64 %100, i64 8, i32 1) #7
...
104:                                              ; preds = %97, %98
  call void @hypre_error_handler(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i64 0, i64 0), i32 285, i32 1, i8* null) #7
  br label %334
...
120:                                              ; preds = %113, %114
  call void @hypre_error_handler(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i64 0, i64 0), i32 312, i32 1, i8* null) #7
  br label %334
...
229:                                              ; preds = %186
  call void @hypre_error_handler(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i64 0, i64 0), i32 412, i32 1, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.19, i64 0, i64 0)) #7
  br label %334
...
299:                                              ; preds = %288
  call void @hypre_error_handler(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i64 0, i64 0), i32 483, i32 1, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.22, i64 0, i64 0)) #7
  br label %334
...
310:                                              ; preds = %292
  call void @hypre_error_handler(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i64 0, i64 0), i32 493, i32 1, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.23, i64 0, i64 0)) #7
  br label %334
...
333:                                              ; preds = %327
  call void @hypre_error_handler(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i64 0, i64 0), i32 505, i32 256, i8* null) #7
  br label %334

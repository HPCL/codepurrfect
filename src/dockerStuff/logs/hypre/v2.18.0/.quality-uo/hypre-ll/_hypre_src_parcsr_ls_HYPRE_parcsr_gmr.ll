...
define dso_local i32 @HYPRE_ParCSROnProcTriSetup(%struct.hypre_Solver_struct* nocapture readnone %0, %struct.hypre_ParCSRMatrix_struct* nocapture %1, %struct.hypre_ParVector_struct* nocapture readnone %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #0 {
  %5 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 27
...
8:                                                ; preds = %4
  ...
  %20 = shl nsw i64 %19, 2
  %21 = call i8* @hypre_MAlloc(i64 %20, i32 1) #2
...
!12 = !{!10, !4, i64 32}
!13 = !{!14, !4, i64 64}
!14 = !{!"", !4, i64 0, !4, i64 8, !4, i64 16, !8, i64 24, !8, i64 28, !8, i64 32, !4, i64 40, !4, i64 48, !8, i64 56, !4, i64 64, !4, i64 72, !8, i64 80, !8, i64 84}
!15 = !{!14, !4, i64 0}
!16 = !{!14, !4, i64 8}
!17 = !{!14, !8, i64 24}

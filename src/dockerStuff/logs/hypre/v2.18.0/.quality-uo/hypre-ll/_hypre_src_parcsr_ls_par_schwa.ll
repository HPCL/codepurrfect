...
define dso_local i8* @hypre_SchwarzCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 1) #6
...
13:                                               ; preds = %8
  ...
  call void @hypre_Free(i8* nonnull %14, i32 1) #6
...
37:                                               ; preds = %28
  ...
  call void @hypre_Free(i8* nonnull %38, i32 1) #6
...
define dso_local i32 @hypre_SchwarzSetup(i8* nocapture %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* nocapture readnone %2, %struct.hypre_ParVector_struct* nocapture readnone %3) local_unnamed_addr #0 {
  ...
  %37 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 13
...
73:                                               ; preds = %4
  %74 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 7
...
!22 = !{!9, !9, i64 0}
!23 = !{!24, !5, i64 0}
!24 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !9, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !9, i64 72, !9, i64 80, !9, i64 88, !9, i64 96, !9, i64 104, !5, i64 112, !5, i64 116, !5, i64 120, !5, i64 124, !8, i64 128, !9, i64 136, !9, i64 144, !5, i64 152, !9, i64 160, !5, i64 168, !9, i64 176, !5, i64 184, !9, i64 192, !9, i64 200}
!25 = !{!24, !5, i64 4}
!26 = !{!24, !9, i64 80}
!27 = !{!24, !9, i64 40}
!28 = !{!29, !5, i64 28}
!29 = !{!"", !9, i64 0, !9, i64 8, !9, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !9, i64 40, !9, i64 48, !5, i64 56, !9, i64 64, !9, i64 72, !5, i64 80, !5, i64 84}
!30 = !{!24, !9, i64 32}
!31 = !{!29, !5, i64 24}
!32 = !{!33, !9, i64 32}

...
define dso_local %struct.hypre_COGMRESFunctions* @hypre_COGMRESFunctionsCreate(i8* (i64, i64, i32)* %0, i32 (i8*)* %1, i32 (i8*, i32*, i32*)* %2, i8* (i8*)* %3, i8* (i32, i8*)* %4, i32 (i8*)* %5, i8* (i8*, i8*)* %6, i32 (i8*, double, i8*, i8*, double, i8*)* %7, i32 (i8*)* %8, double (i8*, i8*)* %9, i32 (i8*, i8**, i32, i32, i8*)* %10, i32 (i8*, i8*, i8**, i32, i32, i8*, i8*)* %11, i32 (i8*, i8*)* %12, i32 (i8*)* %13, i32 (double, i8*)* %14, i32 (double, i8*, i8*)* %15, i32 (double*, i8**, i8*, i32, i32)* %16, i32 (i8*, i8*, i8*, i8*)* %17, i32 (i8*, i8*, i8*, i8*)* %18) local_unnamed_addr #0 {
  %20 = call i8* %0(i64 1, i64 160, i32 1) #7
...
define dso_local i8* @hypre_COGMRESCreate(%struct.hypre_COGMRESFunctions* %0) local_unnamed_addr #0 {
  ...
  %4 = call i8* %3(i64 1, i64 168, i32 1) #7
...
96:                                               ; preds = %80
  ...
  %98 = call i8* %97(i64 %85, i64 8, i32 1) #7
...
136:                                              ; preds = %129, %130
  call void @hypre_error_handler(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.6, i64 0, i64 0), i32 355, i32 1, i8* null) #7
  br label %900
...
153:                                              ; preds = %146, %147
  call void @hypre_error_handler(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.6, i64 0, i64 0), i32 380, i32 1, i8* null) #7
  br label %900
...
880:                                              ; preds = %876
  call void @hypre_error_handler(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.6, i64 0, i64 0), i32 824, i32 256, i8* null) #7
  br label %881

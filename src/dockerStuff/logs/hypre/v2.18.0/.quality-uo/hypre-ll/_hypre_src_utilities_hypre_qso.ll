...
; Function Attrs: nofree nosync nounwind uwtable
define dso_local void @hypre_qsort2abs(i32* %0, double* %1, i32 %2, i32 %3) local_unnamed_addr #2 {
  %5 = icmp slt i32 %2, %3
...
43:                                               ; preds = %40
  ...
  %51 = add nsw i32 %41, -1
  call void @hypre_qsort2abs(i32* %0, double* %1, i32 %2, i32 %51)
  %52 = add nsw i32 %41, 1
  call void @hypre_qsort2abs(i32* %0, double* %1, i32 %52, i32 %3)
  br label %53
...
47:                                               ; preds = %26, %34
  ...
  br i1 %49, label %50, label %26, !llvm.loop !17
...
49:                                               ; preds = %26, %36
  ...
  br i1 %51, label %52, label %26, !llvm.loop !18
...
38:                                               ; preds = %21, %29
  %39 = phi i32 [ %30, %29 ], [ %23, %21 ]
  %40 = icmp eq i64 %24, %20
  br i1 %40, label %41, label %21, !llvm.loop !21
...
35:                                               ; preds = %19, %27
  ...
  br i1 %37, label %38, label %19, !llvm.loop !22
...
47:                                               ; preds = %26, %34
  %48 = phi i32 [ %35, %34 ], [ %28, %26 ]
  %49 = icmp eq i64 %29, %25
  br i1 %49, label %50, label %26, !llvm.loop !23
...
define dso_local void @hypre_topo_sort(i32* nocapture readonly %0, i32* nocapture readonly %1, double* nocapture readnone %2, i32* nocapture %3, i32 %4) local_unnamed_addr #4 {
  ...
  %7 = sext i32 %4 to i64
  %8 = call i8* @hypre_CAlloc(i64 %7, i64 4, i32 1) #6
...
define dso_local void @hypre_dense_topo_sort(double* nocapture readonly %0, i32* nocapture %1, i32 %2, i32 %3) local_unnamed_addr #4 {
  ...
  %6 = sext i32 %2 to i64
  %7 = call i8* @hypre_CAlloc(i64 %6, i64 4, i32 1) #6
...
11:                                               ; preds = %4, %11
  ...
  br i1 %17, label %11, label %18, !llvm.loop !27
...
28:                                               ; preds = %27, %16
  ...
  %30 = icmp eq i32 %29, %5
  br i1 %30, label %31, label %16, !llvm.loop !28

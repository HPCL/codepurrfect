...
define dso_local i32 @hypre_AuxParCSRMatrixCreate(%struct.hypre_AuxParCSRMatrix** nocapture %0, i32 %1, i32 %2, i32* %3) local_unnamed_addr #0 {
  %5 = call i8* @hypre_CAlloc(i64 1, i64 104, i32 1) #4
...
9:                                                ; preds = %3
  ...
  call void @hypre_Free(i8* nonnull %10, i32 1) #4
...
35:                                               ; preds = %25, %21
  ...
  call void @hypre_Free(i8* %37, i32 1) #4
...
46:                                               ; preds = %44, %46
  ...
  call void @hypre_Free(i8* %51, i32 1) #4
...
63:                                               ; preds = %59
  ...
  call void @hypre_Free(i8* nonnull %64, i32 1) #4
...
69:                                               ; preds = %65
  ...
  call void @hypre_Free(i8* nonnull %70, i32 1) #4
...
75:                                               ; preds = %71
  ...
  call void @hypre_Free(i8* nonnull %76, i32 1) #4
...
81:                                               ; preds = %77
  ...
  call void @hypre_Free(i8* nonnull %82, i32 1) #4
...
13:                                               ; preds = %11
  ...
  %23 = call i8* @hypre_CAlloc(i64 %19, i64 8, i32 1) #4
...
31:                                               ; preds = %26
  %32 = call i8* @hypre_CAlloc(i64 %30, i64 8, i32 1) #4
  %33 = bitcast i8* %32 to i32**
  %34 = call i8* @hypre_CAlloc(i64 %30, i64 8, i32 1) #4
...
39:                                               ; preds = %31
  %40 = call i8* @hypre_CAlloc(i64 %30, i64 4, i32 1) #4
...
48:                                               ; preds = %46, %48
  ...
  %53 = call i8* @hypre_CAlloc(i64 %52, i64 4, i32 1) #4
...
63:                                               ; preds = %42
  %64 = call i8* @hypre_CAlloc(i64 %30, i64 4, i32 1) #4
...
69:                                               ; preds = %67, %69
  ...
  %72 = call i8* @hypre_CAlloc(i64 30, i64 4, i32 1) #4
  %73 = getelementptr inbounds i32*, i32** %33, i64 %70
  %74 = bitcast i32** %73 to i8**
  store i8* %72, i8** %74, align 8, !tbaa !13
  %75 = call i8* @hypre_CAlloc(i64 30, i64 8, i32 1) #4
...
87:                                               ; preds = %26
  %88 = call i8* @hypre_CAlloc(i64 %30, i64 4, i32 1) #4
  ...
  %91 = call i8* @hypre_CAlloc(i64 %30, i64 4, i32 1) #4
...
!3 = !{!4, !5, i64 0}
!4 = !{!"", !5, i64 0, !5, i64 4, !5, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !5, i64 64, !5, i64 68, !5, i64 72, !8, i64 80, !8, i64 88, !8, i64 96}
!5 = !{!"int", !6, i64 0}

...
14:                                               ; preds = %7
  ...
  %19 = shl nsw i64 %18, 3
  %20 = call i8* @hypre_MAlloc(i64 %19, i32 1) #5
...
42:                                               ; preds = %26
  ...
  %50 = shl nsw i64 %49, 2
  %51 = call i8* @hypre_MAlloc(i64 %50, i32 1) #5
...
13:                                               ; preds = %11, %47
  ...
  %21 = shl nsw i64 %20, 2
  %22 = call i8* @hypre_MAlloc(i64 %21, i32 1) #5
...
34:                                               ; preds = %24, %15
  ...
  %39 = shl nsw i64 %38, 3
  %40 = call i8* @hypre_MAlloc(i64 %39, i32 1) #5
...
48:                                               ; preds = %46, %48
  ...
  %55 = shl nsw i64 %54, 3
  call void @hypre_Memcpy(i8* %51, i8* %52, i64 %55, i32 1, i32 1) #5
...
22:                                               ; preds = %20, %68
  ...
  %29 = shl nsw i64 %28, 3
  %30 = call i8* @hypre_MAlloc(i64 %29, i32 1) #5
...
52:                                               ; preds = %44, %52
  ...
  %61 = shl nsw i64 %60, 3
  call void @hypre_Memcpy(i8* %57, i8* %58, i64 %61, i32 1, i32 1) #5
...
29:                                               ; preds = %5
  ...
  %32 = call i8* @hypre_MAlloc(i64 %31, i32 1) #5
...
37:                                               ; preds = %34
  ...
  %44 = shl nsw i64 %43, 2
  %45 = call i8* @hypre_MAlloc(i64 %44, i32 1) #5
  %46 = bitcast i8* %45 to i32*
  %47 = load i32, i32* %20, align 8, !tbaa !44
  %48 = sext i32 %47 to i64
  %49 = mul nsw i64 %48, 20
  %50 = call i8* @hypre_MAlloc(i64 %49, i32 1) #5
...
7:                                                ; preds = %3
  %8 = sext i32 %5 to i64
  %9 = shl nsw i64 %8, 2
  %10 = call i8* @hypre_MAlloc(i64 %9, i32 1) #5
  %11 = bitcast i8* %10 to i32*
  %12 = load i32, i32* %4, align 4, !tbaa !41
  %13 = sext i32 %12 to i64
  %14 = mul nsw i64 %13, 20
  %15 = call i8* @hypre_MAlloc(i64 %14, i32 1) #5

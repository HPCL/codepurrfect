...
116:                                              ; preds = %108, %113, %112, %102
  ...
  %118 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 1) #5
...
348:                                              ; preds = %345
  ...
  %350 = call i8* @hypre_CAlloc(i64 %349, i64 4, i32 1) #5
...
365:                                              ; preds = %364
  ...
  call void @hypre_Free(i8* %366, i32 1) #5
  br label %367
...
380:                                              ; preds = %379
  ...
  %382 = call i8* @hypre_CAlloc(i64 %381, i64 4, i32 1) #5
...
411:                                              ; preds = %409, %405
  %412 = call i8* @hypre_CAlloc(i64 1, i64 8, i32 1) #5
  %413 = bitcast i8* %412 to i32**
  %414 = call i8* @hypre_CAlloc(i64 1, i64 8, i32 1) #5
  %415 = bitcast i8* %414 to i32**
  br i1 %95, label %1238, label %416

416:                                              ; preds = %411
  %417 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #5
...
427:                                              ; preds = %416
  ...
  %431 = call i8* @hypre_CAlloc(i64 %430, i64 4, i32 1) #5
...
433:                                              ; preds = %416, %427
  ...
  %435 = call i8* @hypre_CAlloc(i64 %421, i64 4, i32 1) #5
...
645:                                              ; preds = %454, %451
  ...
  %653 = call i8* @hypre_CAlloc(i64 %652, i64 8, i32 1) #5
  %654 = bitcast i8* %653 to double*
  %655 = sext i32 %646 to i64
  %656 = call i8* @hypre_CAlloc(i64 %655, i64 4, i32 1) #5
...
1230:                                             ; preds = %1227, %1228
  ...
  call void @hypre_Free(i8* %417, i32 1) #5
  br label %1238
...
1264:                                             ; preds = %1262, %1256
  ...
  %1267 = call i8* @hypre_CAlloc(i64 %1266, i64 4, i32 1) #5
  %1268 = bitcast i8* %1267 to i32*
  %1269 = call i8* @hypre_CAlloc(i64 %1266, i64 4, i32 1) #5
...
1273:                                             ; preds = %1264
  ...
  %1276 = call i8* @hypre_CAlloc(i64 %1275, i64 4, i32 1) #5
...
1342:                                             ; preds = %1339
  ...
  %1344 = call i8* @hypre_CAlloc(i64 %1343, i64 4, i32 1) #5
...
1358:                                             ; preds = %1351, %1346
  call void @hypre_Free(i8* %1276, i32 1) #5
  br label %1359
...
1362:                                             ; preds = %1359
  ...
  %1364 = call i8* @hypre_CAlloc(i64 %1363, i64 4, i32 1) #5
...
1389:                                             ; preds = %1387
  ...
  %1391 = call i8* @hypre_CAlloc(i64 %1390, i64 4, i32 1) #5
...
1435:                                             ; preds = %1431, %1414
  %1436 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #5
  %1437 = bitcast i8* %1436 to i32*
  %1438 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #5
  %1439 = bitcast i8* %1438 to i32*
  %1440 = add nsw i32 %1360, %63
  %1441 = sext i32 %1440 to i64
  %1442 = call i8* @hypre_CAlloc(i64 %1441, i64 4, i32 1) #5
  %1443 = bitcast i8* %412 to i8**
  store i8* %1442, i8** %1443, align 8, !tbaa !42
  %1444 = sext i32 %118 to i64
  %1445 = call i8* @hypre_CAlloc(i64 %1444, i64 4, i32 1) #5
...
1755:                                             ; preds = %1747
  ...
  %1758 = call i8* @hypre_CAlloc(i64 %1757, i64 8, i32 1) #5
  %1759 = bitcast i8* %1758 to double*
  %1760 = sext i32 %1750 to i64
  %1761 = call i8* @hypre_CAlloc(i64 %1760, i64 4, i32 1) #5
...
1767:                                             ; preds = %1763
  ...
  %1770 = call i8* @hypre_CAlloc(i64 %1769, i64 8, i32 1) #5
  %1771 = bitcast i8* %1770 to double*
  %1772 = sext i32 %1749 to i64
  %1773 = call i8* @hypre_CAlloc(i64 %1772, i64 4, i32 1) #5
...
1780:                                             ; preds = %1775
  ...
  call void @hypre_Free(i8* %1781, i32 1) #5
  br label %1782
...
2537:                                             ; preds = %1879, %1805
  ...
  call void @hypre_Free(i8* %2539, i32 1) #5
  store i32* null, i32** %415, align 8, !tbaa !42
  %2540 = load i32, i32* %7, align 4, !tbaa !15
  %2541 = add nsw i32 %2540, 1
  %2542 = sext i32 %2541 to i64
  %2543 = call i8* @hypre_CAlloc(i64 %2542, i64 4, i32 1) #5
  %2544 = bitcast i8* %2543 to i32*
  %2545 = load i32, i32* %7, align 4, !tbaa !15
  %2546 = add nsw i32 %2545, 1
  %2547 = sext i32 %2546 to i64
  %2548 = call i8* @hypre_CAlloc(i64 %2547, i64 4, i32 1) #5
  %2549 = bitcast i8* %2548 to i32*
  %2550 = load i32, i32* %7, align 4, !tbaa !15
  %2551 = icmp slt i32 %2550, 0
  br i1 %2551, label %2562, label %2552

2552:                                             ; preds = %2537, %2552
  %2553 = phi i64 [ %2558, %2552 ], [ 0, %2537 ]
  %2554 = getelementptr inbounds i32, i32* %67, i64 %2553
  %2555 = load i32, i32* %2554, align 4, !tbaa !15
  %2556 = getelementptr inbounds i32, i32* %2549, i64 %2553
  store i32 %2555, i32* %2556, align 4, !tbaa !15
  %2557 = getelementptr inbounds i32, i32* %2544, i64 %2553
  store i32 %2555, i32* %2557, align 4, !tbaa !15
  %2558 = add nuw nsw i64 %2553, 1
  %2559 = load i32, i32* %7, align 4, !tbaa !15
  %2560 = sext i32 %2559 to i64
  %2561 = icmp slt i64 %2553, %2560
  br i1 %2561, label %2552, label %2562, !llvm.loop !138

2562:                                             ; preds = %2552, %2537
  %2563 = call %struct.hypre_ParCSRBlockMatrix* @hypre_ParCSRBlockMatrixCreate(i32 %9, i32 %29, i32 %117, i32 %117, i32* %2544, i32* %2549, i32 %1783, i32 %1750, i32 %1749) #5
  %2564 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %2563, i64 0, i32 7
  %2565 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %2564, align 8, !tbaa !32
  %2566 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %2565, i64 0, i32 1
  %2567 = bitcast i32** %2566 to i8**
  store i8* %1267, i8** %2567, align 8, !tbaa !16
  br i1 %1754, label %2571, label %2568

2568:                                             ; preds = %2562
  %2569 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %2565, i64 0, i32 0
  store double* %1765, double** %2569, align 8, !tbaa !19
  %2570 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %2565, i64 0, i32 2
  store i32* %1764, i32** %2570, align 8, !tbaa !36
  br label %2571

2571:                                             ; preds = %2568, %2562
  %2572 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %2563, i64 0, i32 8
  %2573 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %2572, align 8, !tbaa !33
  %2574 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %2573, i64 0, i32 1
  %2575 = bitcast i32** %2574 to i8**
  store i8* %1269, i8** %2575, align 8, !tbaa !16
  %2576 = icmp eq i32 %1783, 0
  br i1 %2576, label %2581, label %2577

2577:                                             ; preds = %2571
  %2578 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %2573, i64 0, i32 0
  store double* %1777, double** %2578, align 8, !tbaa !19
  %2579 = getelementptr inbounds %struct.hypre_CSRBlockMatrix, %struct.hypre_CSRBlockMatrix* %2573, i64 0, i32 2
  store i32* %1776, i32** %2579, align 8, !tbaa !36
  %2580 = getelementptr inbounds %struct.hypre_ParCSRBlockMatrix, %struct.hypre_ParCSRBlockMatrix* %2563, i64 0, i32 9
  store i32* %1784, i32** %2580, align 8, !tbaa !38
  br label %2581

2581:                                             ; preds = %2577, %2571
  %2582 = load i32, i32* %7, align 4, !tbaa !15
  %2583 = icmp sgt i32 %2582, 1
  br i1 %2583, label %2584, label %2586

2584:                                             ; preds = %2581
  %2585 = call i32 @hypre_BlockMatvecCommPkgCreate(%struct.hypre_ParCSRBlockMatrix* %2563) #5
  br label %2586

2586:                                             ; preds = %2584, %2581
  store %struct.hypre_ParCSRBlockMatrix* %2563, %struct.hypre_ParCSRBlockMatrix** %3, align 8, !tbaa !42
  %2587 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %5, align 8, !tbaa !42
  %2588 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %2587) #5
  store %struct.hypre_CSRBlockMatrix* null, %struct.hypre_CSRBlockMatrix** %5, align 8, !tbaa !42
  br i1 %95, label %2592, label %2589

2589:                                             ; preds = %2586
  %2590 = load %struct.hypre_CSRBlockMatrix*, %struct.hypre_CSRBlockMatrix** %6, align 8, !tbaa !42
  %2591 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %2590) #5
  store %struct.hypre_CSRBlockMatrix* null, %struct.hypre_CSRBlockMatrix** %6, align 8, !tbaa !42
  br label %2592

2592:                                             ; preds = %2589, %2586
  br i1 %1242, label %2593, label %2595

2593:                                             ; preds = %2592
  %2594 = call i32 @hypre_CSRBlockMatrixDestroy(%struct.hypre_CSRBlockMatrix* %1261) #5
  br label %2595

2595:                                             ; preds = %2592, %2593
  call void @hypre_Free(i8* %412, i32 1) #5
  call void @hypre_Free(i8* %414, i32 1) #5
  call void @hypre_Free(i8* %136, i32 1) #5
  call void @hypre_Free(i8* %138, i32 1) #5
  call void @hypre_Free(i8* %1436, i32 1) #5
  call void @hypre_Free(i8* %1438, i32 1) #5
  br i1 %286, label %2596, label %2599

2596:                                             ; preds = %2595
  %2597 = bitcast i32* %406 to i8*
  call void @hypre_Free(i8* %2597, i32 1) #5
  %2598 = bitcast i32* %1388 to i8*
  call void @hypre_Free(i8* %2598, i32 1) #5
  br label %2599

2599:                                             ; preds = %2596, %2595
  br i1 %347, label %2600, label %2603

2600:                                             ; preds = %2599
  %2601 = bitcast i32* %353 to i8*
  call void @hypre_Free(i8* %2601, i32 1) #5
  %2602 = bitcast i32* %1415 to i8*
  call void @hypre_Free(i8* %2602, i32 1) #5
  br label %2603

2603:                                             ; preds = %2600, %2599
  br i1 %182, label %2607, label %2604

2604:                                             ; preds = %2603
  %2605 = bitcast double* %192 to i8*
  call void @hypre_Free(i8* %2605, i32 1) #5
  %2606 = bitcast i32* %193 to i8*
  call void @hypre_Free(i8* %2606, i32 1) #5
  br label %2607

2607:                                             ; preds = %2604, %2603
  br i1 %194, label %2608, label %2611

2608:                                             ; preds = %2607
  %2609 = bitcast double* %204 to i8*
  call void @hypre_Free(i8* %2609, i32 1) #5
  %2610 = bitcast i32* %205 to i8*
  call void @hypre_Free(i8* %2610, i32 1) #5
  br label %2611

2611:                                             ; preds = %2608, %2607

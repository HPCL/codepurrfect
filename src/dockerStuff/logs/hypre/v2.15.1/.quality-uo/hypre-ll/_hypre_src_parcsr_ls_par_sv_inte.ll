...
123:                                              ; preds = %107, %117, %101, %104
  ...
  %143 = call i8* @hypre_CAlloc(i64 %140, i64 8, i32 2) #7
  %144 = bitcast i8* %143 to double*
  %145 = call i8* @hypre_CAlloc(i64 %137, i64 4, i32 2) #7
...
203:                                              ; preds = %175, %149, %123
  ...
  %216 = call i8* @hypre_CAlloc(i64 %94, i64 4, i32 1) #7
...
1307:                                             ; preds = %1306
  ...
  %1310 = call i8* @hypre_ReAlloc(i8* %59, i64 %1309, i32 1) #7
...
1335:                                             ; preds = %1331, %1307
  ...
  %1337 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #7
...
1355:                                             ; preds = %1306
  ...
  %1359 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #7
...
1459:                                             ; preds = %1454, %1366
  ...
  call void @hypre_Free(i8* %1465, i32 1) #7
...
66:                                               ; preds = %64, %7
  ...
  %82 = call i8* @hypre_CAlloc(i64 %39, i64 4, i32 1) #7
...
105:                                              ; preds = %101, %88
  ...
  %107 = call i8* @hypre_CAlloc(i64 %106, i64 4, i32 1) #7
...
151:                                              ; preds = %147
  %152 = call i8* @hypre_CAlloc(i64 %106, i64 4, i32 1) #7
...
158:                                              ; preds = %154
  %159 = call i8* @hypre_CAlloc(i64 %106, i64 4, i32 1) #7
...
332:                                              ; preds = %331, %328
  ...
  %334 = call i8* @hypre_CAlloc(i64 %333, i64 8, i32 2) #7
  %335 = bitcast i8* %334 to double*
  %336 = sext i32 %47 to i64
  %337 = call i8* @hypre_CAlloc(i64 %336, i64 8, i32 2) #7
...
986:                                              ; preds = %982, %332
  ...
  call void @hypre_Free(i8* %987, i32 1) #7
  %988 = bitcast double* %49 to i8*
  call void @hypre_Free(i8* %988, i32 1) #7
  ...
  call void @hypre_Free(i8* %991, i32 1) #7

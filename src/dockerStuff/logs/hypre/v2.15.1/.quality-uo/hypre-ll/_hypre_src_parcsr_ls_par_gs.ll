...
84:                                               ; preds = %79
  call void @hypre_error_handler(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i64 0, i64 0), i32 725, i32 1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i64 0, i64 0)) #7
  br label %85
...
46:                                               ; preds = %44, %11
  ...
  %49 = call i8* @hypre_CAlloc(i64 %48, i64 4, i32 1) #7
  %50 = icmp sgt i32 %4, 1
  %51 = icmp ne i32 %28, 0
...
53:                                               ; preds = %46
  %54 = call i8* @hypre_CAlloc(i64 %48, i64 4, i32 1) #7
  br label %55
...
61:                                               ; preds = %58, %55
  ...
  %71 = call i8* @hypre_CAlloc(i64 %70, i64 4, i32 1) #7
...
179:                                              ; preds = %173, %171
  ...
  %183 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #7
  %184 = bitcast i8* %183 to i32*
  %185 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #7
  %186 = bitcast i8* %185 to i32*
  %187 = sext i32 %30 to i64
  %188 = call i8* @hypre_CAlloc(i64 %187, i64 4, i32 1) #7
...
238:                                              ; preds = %235, %194
  ...
  %243 = call i8* @hypre_CAlloc(i64 %242, i64 4, i32 1) #7
  ...
  %251 = call i8* @hypre_CAlloc(i64 %242, i64 4, i32 1) #7
  %252 = bitcast i8* %251 to i32*
  %253 = sext i32 %240 to i64
  %254 = call i8* @hypre_CAlloc(i64 %253, i64 4, i32 1) #7
  %255 = bitcast i8* %254 to i32*
  %256 = call i8* @hypre_CAlloc(i64 %253, i64 8, i32 1) #7
...
267:                                              ; preds = %265, %263
  ...
  %269 = call i8* @hypre_CAlloc(i64 %48, i64 4, i32 1) #7
...
449:                                              ; preds = %445
  ...
  %451 = call i8* @hypre_CAlloc(i64 %450, i64 4, i32 1) #7
...
485:                                              ; preds = %480, %463
  ...
  %488 = call i8* @hypre_CAlloc(i64 %487, i64 4, i32 1) #7
...
511:                                              ; preds = %504, %493
  call void @hypre_Free(i8* %451, i32 1) #7
  br label %512
...
519:                                              ; preds = %516, %512
  ...
  call void @hypre_Free(i8* %269, i32 1) #7
  call void @hypre_Free(i8* %181, i32 1) #7
  call void @hypre_Free(i8* %183, i32 1) #7
  call void @hypre_Free(i8* %185, i32 1) #7
...
57:                                               ; preds = %49
  %58 = call i8* @hypre_CAlloc(i64 %51, i64 4, i32 1) #7
  br label %59
...
65:                                               ; preds = %62, %59
  ...
  %75 = call i8* @hypre_CAlloc(i64 %74, i64 4, i32 1) #7
...
192:                                              ; preds = %186, %181
  ...
  %194 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #7
  %195 = bitcast i8* %194 to i32*
  %196 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #7
  %197 = bitcast i8* %196 to i32*
  %198 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #7
...
278:                                              ; preds = %275, %207
  ...
  %283 = call i8* @hypre_CAlloc(i64 %282, i64 4, i32 1) #7
  %284 = bitcast i8* %283 to i32*
  %285 = sext i32 %279 to i64
  %286 = call i8* @hypre_CAlloc(i64 %285, i64 4, i32 1) #7
  %287 = bitcast i8* %286 to i32*
  %288 = call i8* @hypre_CAlloc(i64 %285, i64 8, i32 1) #7
  %289 = bitcast i8* %288 to double*
  %290 = getelementptr inbounds i32, i32* %284, i64 %200
  store i32 %279, i32* %290, align 4, !tbaa !17
  %291 = call i8* @hypre_CAlloc(i64 %282, i64 4, i32 1) #7
  %292 = bitcast i8* %291 to i32*
  %293 = sext i32 %280 to i64
  %294 = call i8* @hypre_CAlloc(i64 %293, i64 4, i32 1) #7
  %295 = bitcast i8* %294 to i32*
  %296 = call i8* @hypre_CAlloc(i64 %293, i64 8, i32 1) #7
...
308:                                              ; preds = %306, %304
  ...
  %310 = call i8* @hypre_CAlloc(i64 %51, i64 4, i32 1) #7
...
381:                                              ; preds = %374, %370
  %382 = call i8* @hypre_CAlloc(i64 %200, i64 4, i32 1) #7
  %383 = bitcast i8* %382 to i32*
  %384 = call i8* @hypre_CAlloc(i64 %51, i64 4, i32 1) #7
...
812:                                              ; preds = %805, %395
  ...
  call void @hypre_Free(i8* %384, i32 1) #7
...
848:                                              ; preds = %844
  ...
  %850 = call i8* @hypre_CAlloc(i64 %849, i64 4, i32 1) #7
...
884:                                              ; preds = %879, %862
  ...
  %887 = call i8* @hypre_CAlloc(i64 %886, i64 4, i32 1) #7
...
918:                                              ; preds = %915, %911
  ...
  call void @hypre_Free(i8* %310, i32 1) #7
  call void @hypre_Free(i8* %194, i32 1) #7
  call void @hypre_Free(i8* %196, i32 1) #7
  call void @hypre_Free(i8* %198, i32 1) #7

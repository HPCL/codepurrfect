...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateLaplacian(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, double* nocapture readonly %10) local_unnamed_addr #0 {
  ...
  %33 = call i8* @hypre_CAlloc(i64 %32, i64 4, i32 1) #4
...
94:                                               ; preds = %43, %11
  ...
  %130 = call i8* @hypre_CAlloc(i64 %129, i64 4, i32 2) #4
  %131 = bitcast i8* %130 to i32*
  %132 = call i8* @hypre_CAlloc(i64 %129, i64 4, i32 2) #4
...
688:                                              ; preds = %685, %662, %648
  ...
  call void @hypre_Free(i8* %33, i32 1) #4
  %697 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateSysLaplacian(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, double* nocapture readonly %11, double* nocapture readonly %12) local_unnamed_addr #0 {
  ...
  %35 = call i8* @hypre_CAlloc(i64 %34, i64 4, i32 1) #4
...
96:                                               ; preds = %45, %13
  ...
  %133 = call i8* @hypre_CAlloc(i64 %132, i64 4, i32 2) #4
  %134 = bitcast i8* %133 to i32*
  %135 = call i8* @hypre_CAlloc(i64 %132, i64 4, i32 2) #4
...
312:                                              ; preds = %307, %96
  ...
  %317 = call i8* @hypre_CAlloc(i64 %316, i64 4, i32 2) #4
  %318 = bitcast i8* %317 to i32*
  %319 = load i32, i32* %314, align 4, !tbaa !3
  %320 = sext i32 %319 to i64
  %321 = call i8* @hypre_CAlloc(i64 %320, i64 8, i32 2) #4
...
325:                                              ; preds = %312
  ...
  %329 = call i8* @hypre_CAlloc(i64 %328, i64 4, i32 2) #4
  %330 = bitcast i8* %329 to i32*
  %331 = load i32, i32* %326, align 4, !tbaa !3
  %332 = sext i32 %331 to i64
  %333 = call i8* @hypre_CAlloc(i64 %332, i64 8, i32 2) #4
...
1170:                                             ; preds = %1167, %1130
  ...
  %1179 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @GenerateSysLaplacianVCoef(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, double* nocapture readonly %11, double* nocapture readonly %12) local_unnamed_addr #0 {
  ...
  %36 = call i8* @hypre_CAlloc(i64 %35, i64 4, i32 1) #4
...
97:                                               ; preds = %46, %13
  ...
  %134 = call i8* @hypre_CAlloc(i64 %133, i64 4, i32 1) #4
  %135 = bitcast i8* %134 to i32*
  %136 = call i8* @hypre_CAlloc(i64 %133, i64 4, i32 1) #4
  ...
  %170 = call i8* @hypre_CAlloc(i64 %169, i64 4, i32 1) #4
...
313:                                              ; preds = %308, %97
  ...
  %318 = call i8* @hypre_CAlloc(i64 %317, i64 4, i32 1) #4
  %319 = bitcast i8* %318 to i32*
  %320 = load i32, i32* %315, align 4, !tbaa !3
  %321 = sext i32 %320 to i64
  %322 = call i8* @hypre_CAlloc(i64 %321, i64 8, i32 1) #4
...
326:                                              ; preds = %313
  ...
  %330 = call i8* @hypre_CAlloc(i64 %329, i64 4, i32 1) #4
  %331 = bitcast i8* %330 to i32*
  %332 = load i32, i32* %327, align 4, !tbaa !3
  %333 = sext i32 %332 to i64
  %334 = call i8* @hypre_CAlloc(i64 %333, i64 8, i32 1) #4
...
1240:                                             ; preds = %1237, %1200
  ...
  call void @hypre_Free(i8* %36, i32 1) #4
  %1249 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4

...
define dso_local %struct.DiagScale* @DiagScaleCreate(%struct.Matrix* %0, %struct.numbering* %1) local_unnamed_addr #0 {
  ...
  %14 = call i8* @hypre_MAlloc(i64 24, i32 1) #8
...
79:                                               ; preds = %70
  ...
  %92 = shl nsw i64 %91, 2
  call void @hypre_Memcpy(i8* %82, i8* %89, i64 %92, i32 1, i32 1) #8
...
241:                                              ; preds = %230
  ...
  %244 = call i8* @hypre_MAlloc(i64 %243, i32 1) #8

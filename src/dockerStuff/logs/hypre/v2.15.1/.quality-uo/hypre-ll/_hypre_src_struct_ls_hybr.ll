...
define dso_local i8* @hypre_HybridCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 120, i32 1) #6
...
define dso_local i32 @hypre_HybridSetPrecond(i8* nocapture %0, i32 (i8*, i8*, i8*, i8*)* %1, i32 (i8*, i8*, i8*, i8*)* %2, i8* %3) local_unnamed_addr #3 {
  ...
  store i32 (i8*, i8*, i8*, i8*)* %2, i32 (i8*, i8*, i8*, i8*)** %10, align 8, !tbaa !26
...
89:                                               ; preds = %87
  ...
  %101 = call i32 @hypre_GMRESSetPrecond(i8* %91, i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_StructSolver_struct*, %struct.hypre_StructMatrix_struct*, %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct*)* @HYPRE_StructDiagScale to i32 (i8*, i8*, i8*, i8*)*), i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_StructSolver_struct*, %struct.hypre_StructMatrix_struct*, %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct*)* @HYPRE_StructDiagScaleSetup to i32 (i8*, i8*, i8*, i8*)*), i8* null) #6
...
113:                                              ; preds = %87
  ...
  %122 = call i32 @hypre_BiCGSTABSetPrecond(i8* %115, i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_StructSolver_struct*, %struct.hypre_StructMatrix_struct*, %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct*)* @HYPRE_StructDiagScale to i32 (i8*, i8*, i8*, i8*)*), i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_StructSolver_struct*, %struct.hypre_StructMatrix_struct*, %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct*)* @HYPRE_StructDiagScaleSetup to i32 (i8*, i8*, i8*, i8*)*), i8* null) #6
...
165:                                              ; preds = %163
  ...
  %167 = call %struct.hypre_GMRESFunctions* @hypre_GMRESFunctionsCreate(i8* (i64, i64, i32)* nonnull @hypre_CAlloc, i32 (i8*)* nonnull @hypre_StructKrylovFree, i32 (i8*, i32*, i32*)* nonnull @hypre_StructKrylovCommInfo, i8* (i8*)* nonnull @hypre_StructKrylovCreateVector, i8* (i32, i8*)* nonnull @hypre_StructKrylovCreateVectorArray, i32 (i8*)* nonnull @hypre_StructKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_StructKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_StructKrylovMatvec, i32 (i8*)* nonnull @hypre_StructKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_StructKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_StructKrylovCopyVector, i32 (i8*)* nonnull @hypre_StructKrylovClearVector, i32 (double, i8*)* nonnull @hypre_StructKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_StructKrylovAxpy, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_StructKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_StructKrylovIdentity) #6
...
197:                                              ; preds = %187
  ...
  %202 = bitcast i8* %201 to i32 (i8*, i8*, i8*, i8*)**
  %203 = load i32 (i8*, i8*, i8*, i8*)*, i32 (i8*, i8*, i8*, i8*)** %202, align 8, !tbaa !25
  %204 = getelementptr inbounds i8, i8* %0, i64 72
  %205 = bitcast i8* %204 to i32 (i8*, i8*, i8*, i8*)**
  %206 = load i32 (i8*, i8*, i8*, i8*)*, i32 (i8*, i8*, i8*, i8*)** %205, align 8, !tbaa !26
  br label %207

207:                                              ; preds = %197, %190
  %208 = phi i32 (i8*, i8*, i8*, i8*)* [ bitcast (i32 (i8*, %struct.hypre_StructMatrix_struct*, %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct*)* @hypre_SMGSolve to i32 (i8*, i8*, i8*, i8*)*), %190 ], [ %203, %197 ]
  %209 = phi i32 (i8*, i8*, i8*, i8*)* [ bitcast (i32 (i8*, %struct.hypre_StructMatrix_struct*, %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct*)* @hypre_SMGSetup to i32 (i8*, i8*, i8*, i8*)*), %190 ], [ %206, %197 ]
  %210 = phi i8* [ %191, %190 ], [ %200, %197 ]
  br i1 %56, label %211, label %233

211:                                              ; preds = %207
  %212 = call i32 @hypre_PCGSetPrecond(i8* %188, i32 (i8*, i8*, i8*, i8*)* %208, i32 (i8*, i8*, i8*, i8*)* %209, i8* %210) #6
...
235:                                              ; preds = %233
  %236 = call i32 @hypre_GMRESSetPrecond(i8* %188, i32 (i8*, i8*, i8*, i8*)* %208, i32 (i8*, i8*, i8*, i8*)* %209, i8* %210) #6
...
251:                                              ; preds = %233
  %252 = call i32 @hypre_BiCGSTABSetPrecond(i8* %188, i32 (i8*, i8*, i8*, i8*)* %208, i32 (i8*, i8*, i8*, i8*)* %209, i8* %210) #6

...
define dso_local %struct.hypre_CSRBooleanMatrix* @hypre_CSRBooleanMatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_CAlloc(i64 1, i64 32, i32 1) #8
...
14:                                               ; preds = %10, %3
  ...
  call void @hypre_Free(i8* nonnull %15, i32 1) #8
  br label %16
...
23:                                               ; preds = %13, %1
  ...
  %28 = call i8* @hypre_CAlloc(i64 1, i64 32, i32 1) #8
...
33:                                               ; preds = %28, %30, %23
  ...
  %51 = call i8* @hypre_CAlloc(i64 1, i64 32, i32 1) #8
  ...
  %62 = call i8* @hypre_CAlloc(i64 1, i64 32, i32 1) #8
...
22:                                               ; preds = %18, %11
  ...
  call void @hypre_Free(i8* nonnull %23, i32 1) #8
  br label %24
...
69:                                               ; preds = %65, %61
  ...
  call void @hypre_Free(i8* nonnull %73, i32 1) #8
  br label %74
...
99:                                               ; preds = %92
  ...
  %102 = call i8* @hypre_CAlloc(i64 1, i64 32, i32 1) #8
...
122:                                              ; preds = %120, %114
  ...
  %127 = call i8* @hypre_CAlloc(i64 1, i64 32, i32 1) #8

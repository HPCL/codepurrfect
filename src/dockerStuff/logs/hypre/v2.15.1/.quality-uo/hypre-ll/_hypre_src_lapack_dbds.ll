...
define dso_local i32 @hypre_dbdsqr(i8* %0, i32* %1, i32* %2, i32* %3, i32* %4, double* %5, double* %6, double* %7, i32* %8, double* %9, i32* %10, double* %11, i32* %12, double* %13, i32* %14) local_unnamed_addr #0 {
  ...
  %37 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #4
  store i64 %37, i64* @hypre_dbdsqr.lower, align 8, !tbaa !7
  %38 = call i64 @hypre_lapack_lsame(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #4
  %39 = icmp ne i64 %38, 0
...
89:                                               ; preds = %86
  ...
  %91 = call i32 @hypre_lapack_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32* nonnull %16) #4
  br label %1400

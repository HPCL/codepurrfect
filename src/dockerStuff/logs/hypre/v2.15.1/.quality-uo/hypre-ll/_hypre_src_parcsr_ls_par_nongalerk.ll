...
309:                                              ; preds = %306
  ...
  %312 = call i8* @hypre_CAlloc(i64 %311, i64 4, i32 1) #7
...
369:                                              ; preds = %366
  ...
  %371 = call i8* @hypre_CAlloc(i64 %370, i64 4, i32 1) #7
...
386:                                              ; preds = %385
  ...
  call void @hypre_Free(i8* %387, i32 1) #7
  br label %388
...
440:                                              ; preds = %426, %403
  ...
  %445 = call i8* @hypre_CAlloc(i64 %444, i64 4, i32 1) #7
...
553:                                              ; preds = %541
  ...
  call void @hypre_Free(i8* %554, i32 1) #7
  %555 = sext i32 %551 to i64
  %556 = call i8* @hypre_CAlloc(i64 %555, i64 4, i32 1) #7
...
650:                                              ; preds = %640
  ...
  call void @hypre_Free(i8* %651, i32 1) #7
...
680:                                              ; preds = %676
  ...
  call void @hypre_Free(i8* %681, i32 1) #7
  %682 = bitcast double* %621 to i8*
  call void @hypre_Free(i8* %682, i32 1) #7
  %683 = sext i32 %678 to i64
  %684 = call i8* @hypre_CAlloc(i64 %683, i64 4, i32 1) #7
  %685 = bitcast i8* %684 to i32*
  %686 = call i8* @hypre_CAlloc(i64 %683, i64 8, i32 1) #7
...
740:                                              ; preds = %730
  ...
  call void @hypre_Free(i8* %741, i32 1) #7
  %742 = bitcast double* %619 to i8*
  call void @hypre_Free(i8* %742, i32 1) #7
  %743 = sext i32 %738 to i64
  %744 = call i8* @hypre_CAlloc(i64 %743, i64 4, i32 1) #7
  %745 = bitcast i8* %744 to i32*
  %746 = call i8* @hypre_CAlloc(i64 %743, i64 8, i32 1) #7
...
1110:                                             ; preds = %1101
  ...
  call void @hypre_Free(i8* %1111, i32 1) #7
  %1112 = sext i32 %1108 to i64
  %1113 = call i8* @hypre_CAlloc(i64 %1112, i64 4, i32 1) #7
...
1140:                                             ; preds = %1136
  ...
  call void @hypre_Free(i8* %1141, i32 1) #7
  %1142 = bitcast double* %1085 to i8*
  call void @hypre_Free(i8* %1142, i32 1) #7
  %1143 = sext i32 %1138 to i64
  %1144 = call i8* @hypre_CAlloc(i64 %1143, i64 4, i32 1) #7
  %1145 = bitcast i8* %1144 to i32*
  %1146 = call i8* @hypre_CAlloc(i64 %1143, i64 8, i32 1) #7
...
1200:                                             ; preds = %1190
  ...
  call void @hypre_Free(i8* %1201, i32 1) #7
  %1202 = bitcast double* %1083 to i8*
  call void @hypre_Free(i8* %1202, i32 1) #7
  %1203 = sext i32 %1198 to i64
  %1204 = call i8* @hypre_CAlloc(i64 %1203, i64 4, i32 1) #7
  %1205 = bitcast i8* %1204 to i32*
  %1206 = call i8* @hypre_CAlloc(i64 %1203, i64 8, i32 1) #7
...
1447:                                             ; preds = %1438, %1428
  ...
  call void @hypre_Free(i8* %1448, i32 1) #7
...
1454:                                             ; preds = %1447
  ...
  call void @hypre_Free(i8* %1455, i32 1) #7
...
1458:                                             ; preds = %1457
  ...
  call void @hypre_Free(i8* %1459, i32 1) #7
...
1462:                                             ; preds = %1461
  ...
  call void @hypre_Free(i8* %1463, i32 1) #7
  br label %1464

...
define dso_local i32 @hypre_ParCSRMatrixEliminateRowsCols(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %11 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %8, i64 0, i32 2
  %12 = load i32, i32* %11, align 8, !tbaa !12
  %13 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %10, i64 0, i32 3
  ...
  %23 = call i8* @hypre_CAlloc(i64 %22, i64 4, i32 1) #4
  %24 = bitcast i8* %23 to i32*
  %25 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 14
  %26 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %25, align 8, !tbaa !15
  %27 = icmp eq %struct.hypre_ParCSRCommPkg* %26, null
  br i1 %27, label %28, label %31

28:                                               ; preds = %3
  %29 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) #4
  %30 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %25, align 8, !tbaa !15
  br label %31

31:                                               ; preds = %28, %3
  %32 = phi %struct.hypre_ParCSRCommPkg* [ %26, %3 ], [ %30, %28 ]
...
49:                                               ; preds = %41, %37
  %50 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %32, i64 0, i32 1
  %51 = load i32, i32* %50, align 4, !tbaa !20
  %52 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %32, i64 0, i32 3
  ...
  %60 = getelementptr inbounds %struct.hypre_ParCSRCommPkg, %struct.hypre_ParCSRCommPkg* %32, i64 0, i32 4
...
97:                                               ; preds = %67, %49
  %98 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 11, %struct.hypre_ParCSRCommPkg* %32, i8* %58, i8* %23) #4
...
137:                                              ; preds = %133, %115
  ...
  call void @hypre_Free(i8* %23, i32 1) #4
  %139 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %10, i64 0, i32 4
  ...
  %143 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %10, i64 0, i32 6
...
159:                                              ; preds = %156, %137
  call void @hypre_Free(i8* %117, i32 1) #4
...
define dso_local i32 @hypre_CSRMatrixEliminateRowsColsDiag(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %20 = shl nsw i64 %19, 2
  %21 = call i8* @hypre_MAlloc(i64 %20, i32 1) #4
...
define dso_local i32 @hypre_CSRMatrixEliminateRowsOffd(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32 %1, i32* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %16 = shl nsw i64 %15, 2
  %17 = call i8* @hypre_MAlloc(i64 %16, i32 1) #4
...
57:                                               ; preds = %54, %22
  call void @hypre_Free(i8* %17, i32 1) #4
...
!20 = !{!21, !5, i64 4}
!21 = !{!"", !5, i64 0, !5, i64 4, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64}
!22 = !{!21, !8, i64 16}

...
122:                                              ; preds = %112, %116
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 372, i32 1, i8* null) #7
  br label %460
...
182:                                              ; preds = %172, %176
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 443, i32 1, i8* null) #7
  br label %460
...
392:                                              ; preds = %388
  ...
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 655, i32 256, i8* null) #7
  br label %430
...
396:                                              ; preds = %395
  ...
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 682, i32 256, i8* null) #7
  br label %430
...
447:                                              ; preds = %440
  call void @hypre_error_handler(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i64 0, i64 0), i32 722, i32 256, i8* null) #7
  br label %448

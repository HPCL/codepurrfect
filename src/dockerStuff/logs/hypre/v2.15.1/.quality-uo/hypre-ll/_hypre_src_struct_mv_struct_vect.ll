...
define dso_local %struct.hypre_StructVector_struct* @hypre_StructVectorCreate(i32 %0, %struct.hypre_StructGrid_struct* %1) local_unnamed_addr #0 {
  ...
  %5 = call i8* @hypre_CAlloc(i64 1, i64 88, i32 1) #11
...
16:                                               ; preds = %12, %8
  ...
  call void @hypre_Free(i8* %19, i32 1) #11
  ...
  call void @hypre_Free(i8* nonnull %26, i32 1) #11
  br label %27
...
define dso_local i32 @hypre_StructVectorInitialize(%struct.hypre_StructVector_struct* nocapture %0) local_unnamed_addr #0 {
  ...
  %5 = sext i32 %4 to i64
  %6 = call i8* @hypre_CAlloc(i64 %5, i64 8, i32 0) #11
...
17:                                               ; preds = %3
  ...
  %24 = call i8* @hypre_CAlloc(i64 1, i64 88, i32 1) #11
...
71:                                               ; preds = %59, %49
  ...
  %77 = call i8* @hypre_CAlloc(i64 %76, i64 8, i32 0) #11
...
define dso_local %struct.hypre_StructVector_struct* @hypre_StructVectorClone(%struct.hypre_StructVector_struct* nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_CAlloc(i64 1, i64 88, i32 1) #11
...
41:                                               ; preds = %34, %1
  ...
  %49 = call i8* @hypre_CAlloc(i64 %48, i64 8, i32 0) #11

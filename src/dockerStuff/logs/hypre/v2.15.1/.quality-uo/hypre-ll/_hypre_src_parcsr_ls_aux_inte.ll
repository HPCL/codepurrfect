...
10:                                               ; preds = %10, %6
  ...
  %22 = icmp eq i64 %21, %7
  br i1 %22, label %23, label %10, !llvm.loop !18
...
33:                                               ; preds = %23, %26
  ...
  %35 = icmp sgt i64 %7, 2
  %36 = add nsw i64 %7, -1
  br i1 %35, label %6, label %37, !llvm.loop !19
...
35:                                               ; preds = %32, %33
  ...
  br i1 %37, label %19, label %25, !llvm.loop !20
...
43:                                               ; preds = %38, %41
  ...
  br i1 %45, label %74, label %38, !llvm.loop !21
...
62:                                               ; preds = %59, %60
  ...
  br i1 %64, label %46, label %52, !llvm.loop !22
...
71:                                               ; preds = %65, %69
  ...
  br i1 %73, label %74, label %65, !llvm.loop !23
...
22:                                               ; preds = %16, %22
  ...
  br i1 %32, label %33, label %22, !llvm.loop !24
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_exchange_interp_data(i32** nocapture %0, i32** nocapture %1, %struct.hypre_CSRMatrix** nocapture %2, i32* nocapture %3, %struct.hypre_CSRMatrix** nocapture %4, %struct.hypre_ParCSRCommPkg** %5, %struct.hypre_ParCSRMatrix_struct* %6, i32* %7, %struct.hypre_ParCSRMatrix_struct* %8, i32 %9, i32* nocapture readonly %10, i32 %11) local_unnamed_addr #0 {
  ...
  %17 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %16, align 8, !tbaa !25
  ...
  store i8* %33, i8** %34, align 8, !tbaa !35
...
62:                                               ; preds = %51, %12
  ...
  %67 = load i32*, i32** %0, align 8, !tbaa !35
  ...
  store %struct.hypre_CSRMatrix* %68, %struct.hypre_CSRMatrix** %2, align 8, !tbaa !35
  ...
  %76 = load i32*, i32** %0, align 8, !tbaa !35
  ...
  store %struct.hypre_CSRMatrix* %77, %struct.hypre_CSRMatrix** %4, align 8, !tbaa !35
  ...
  %82 = load %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %15, align 8, !tbaa !35
  ...
  %86 = load %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %13, align 8, !tbaa !35
  ...
  %90 = load i32*, i32** %0, align 8, !tbaa !35
...
135:                                              ; preds = %133, %129, %118
  ...
  br i1 %140, label %118, label %141, !llvm.loop !40
...
197:                                              ; preds = %193, %186
  ...
  br i1 %201, label %202, label %186, !llvm.loop !43
...
237:                                              ; preds = %231, %227, %221
  ...
  br i1 %242, label %221, label %243, !llvm.loop !44
...
278:                                              ; preds = %276
  ...
  %280 = call i32 @hypre_ParCSRFindExtendCommPkg(%struct.hypre_ParCSRMatrix_struct* %6, i32 %203, i32* %99, %struct.hypre_ParCSRCommPkg** %5) #8
  %281 = load i8*, i8** %34, align 8, !tbaa !35
  %282 = load i32, i32* %3, align 4, !tbaa !12
  %283 = sext i32 %282 to i64
  %284 = shl nsw i64 %283, 2
  %285 = call i8* @hypre_ReAlloc(i8* %281, i64 %284, i32 1) #8
  %286 = bitcast i8* %285 to i32*
  store i8* %285, i8** %34, align 8, !tbaa !35
  %287 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %5, align 8, !tbaa !35
  ...
  %298 = call i8* @hypre_CAlloc(i64 %297, i64 4, i32 1) #8
...
305:                                              ; preds = %305, %301
  ...
  br i1 %315, label %316, label %305, !llvm.loop !24
...
316:                                              ; preds = %305, %278
  ...
  call void @hypre_Free(i8* %298, i32 1) #8
...
324:                                              ; preds = %321
  ...
  %326 = call i8* @hypre_CAlloc(i64 %325, i64 4, i32 1) #8
  %327 = bitcast i32** %1 to i8**
  store i8* %326, i8** %327, align 8, !tbaa !35
  br label %328

328:                                              ; preds = %324, %321
  %329 = load %struct.hypre_ParCSRCommPkg*, %struct.hypre_ParCSRCommPkg** %5, align 8, !tbaa !35
  %330 = load i32*, i32** %1, align 8, !tbaa !35
...
332:                                              ; preds = %328, %316
  ...
  %333 = load %struct.hypre_ParCSRCommHandle*, %struct.hypre_ParCSRCommHandle** %14, align 8, !tbaa !35
  ...
  call void @hypre_Free(i8* %335, i32 1) #8
  br label %337
...
define dso_local void @hypre_build_interp_colmap(%struct.hypre_ParCSRMatrix_struct* nocapture %0, i32 %1, i32* nocapture readonly %2, i32* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %6 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %5, align 8, !tbaa !28
...
75:                                               ; preds = %75, %66
  ...
  %79 = icmp eq i32 %78, 0
  %80 = add i64 %76, 1
  br i1 %79, label %75, label %81, !llvm.loop !48
...
81:                                               ; preds = %75
  ...
  br i1 %86, label %71, label %66, !llvm.loop !49
...
91:                                               ; preds = %73, %91
  ...
  br i1 %97, label %87, label %91, !llvm.loop !50
...
107:                                              ; preds = %107, %98
  ...
  %112 = add i64 %108, 1
  br i1 %111, label %107, label %113, !llvm.loop !51
...
113:                                              ; preds = %107
  ...
  br i1 %119, label %103, label %98, !llvm.loop !52
...
120:                                              ; preds = %105, %120
  ...
  br i1 %126, label %127, label %120, !llvm.loop !53
...
136:                                              ; preds = %136, %132
  ...
  br i1 %148, label %149, label %136, !llvm.loop !18
...
159:                                              ; preds = %153, %149
  ...
  br i1 %161, label %132, label %163, !llvm.loop !19
...
185:                                              ; preds = %174, %184
  ...
  br i1 %188, label %174, label %189, !llvm.loop !54

189:                                              ; preds = %185, %171
  %190 = add nuw nsw i64 %172, 1
  %191 = icmp eq i64 %190, %170
  br i1 %191, label %192, label %171, !llvm.loop !55

192:                                              ; preds = %189, %166, %163
  %193 = bitcast i32* %25 to i8*
  call void @hypre_Free(i8* %193, i32 1) #8
...
194:                                              ; preds = %192
  ...
  store i32* %62, i32** %195, align 8, !tbaa !32
  %196 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %9, align 8, !tbaa !29
  %197 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %196, i64 0, i32 3
  store i32 %55, i32* %197, align 4, !tbaa !30
  br label %198
...
!25 = !{!26, !8, i64 88}
!26 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !5, i64 104, !5, i64 108, !5, i64 112, !5, i64 116, !27, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !8, i64 152}
!27 = !{!"double", !6, i64 0}
!28 = !{!26, !8, i64 32}
!29 = !{!26, !8, i64 40}
!30 = !{!31, !5, i64 20}
!31 = !{!"", !8, i64 0, !8, i64 8, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !5, i64 48}
!32 = !{!26, !8, i64 64}
!33 = !{!26, !5, i64 12}
!34 = !{!31, !5, i64 16}
!35 = !{!8, !8, i64 0}
...
!37 = !{!31, !8, i64 8}
!38 = !{!39, !8, i64 8}
!39 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !8, i64 32}

...
512:                                              ; preds = %505, %501
  %513 = call i8* @hypre_CAlloc(i64 %278, i64 4, i32 1) #6
  %514 = bitcast i8* %513 to i32*
  %515 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1028:                                             ; preds = %1021, %526
  call void @hypre_Free(i8* %513, i32 1) #6
  ...
  %1031 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
1075:                                             ; preds = %1071
  %1076 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1101:                                             ; preds = %1097, %1082
  ...
  %1104 = call i8* @hypre_CAlloc(i64 %1103, i64 4, i32 1) #6
...
1137:                                             ; preds = %1130, %1114
  call void @hypre_Free(i8* %1076, i32 1) #6
  br label %1138
...
515:                                              ; preds = %508, %504
  %516 = call i8* @hypre_CAlloc(i64 %278, i64 4, i32 1) #6
  %517 = bitcast i8* %516 to i32*
  %518 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1044:                                             ; preds = %1037, %529
  call void @hypre_Free(i8* %516, i32 1) #6
  call void @hypre_Free(i8* %518, i32 1) #6
  ...
  %1047 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
1091:                                             ; preds = %1087
  %1092 = call i8* @hypre_CAlloc(i64 %80, i64 4, i32 1) #6
...
1117:                                             ; preds = %1113, %1098
  ...
  %1120 = call i8* @hypre_CAlloc(i64 %1119, i64 4, i32 1) #6
...
511:                                              ; preds = %504, %500
  %512 = call i8* @hypre_CAlloc(i64 %277, i64 4, i32 1) #6
  %513 = bitcast i8* %512 to i32*
  %514 = call i8* @hypre_CAlloc(i64 %79, i64 4, i32 1) #6
...
995:                                              ; preds = %988, %525
  call void @hypre_Free(i8* %512, i32 1) #6
  call void @hypre_Free(i8* %514, i32 1) #6
  ...
  %998 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
1042:                                             ; preds = %1038
  %1043 = call i8* @hypre_CAlloc(i64 %79, i64 4, i32 1) #6
...
1068:                                             ; preds = %1064, %1049
  ...
  %1071 = call i8* @hypre_CAlloc(i64 %1070, i64 4, i32 1) #6
...
1104:                                             ; preds = %1097, %1081
  call void @hypre_Free(i8* %1043, i32 1) #6
  br label %1105
...
382:                                              ; preds = %375, %371
  %383 = call i8* @hypre_CAlloc(i64 %147, i64 4, i32 1) #6
  %384 = bitcast i8* %383 to i32*
  %385 = call i8* @hypre_CAlloc(i64 %74, i64 4, i32 1) #6
  %386 = bitcast i8* %385 to i32*
...
633:                                              ; preds = %627, %396
  call void @hypre_Free(i8* %383, i32 1) #6
  call void @hypre_Free(i8* %385, i32 1) #6
  ...
  %636 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #6
...
680:                                              ; preds = %676
  %681 = call i8* @hypre_CAlloc(i64 %74, i64 4, i32 1) #6

...
define dso_local i32 @hypre_SysPFMGSetup(i8* %0, %struct.hypre_SStructMatrix_struct* nocapture readonly %1, %struct.hypre_SStructVector_struct* nocapture readonly %2, %struct.hypre_SStructVector_struct* nocapture readonly %3) local_unnamed_addr #0 {
  ...
  %51 = shl nsw i64 %50, 3
  %52 = call i8* @hypre_MAlloc(i64 %51, i32 1) #4
...
57:                                               ; preds = %55, %57
  ...
  %59 = call i8* @hypre_MAlloc(i64 24, i32 1) #4
...
128:                                              ; preds = %123, %118, %64
  %129 = call i8* @hypre_CAlloc(i64 3, i64 8, i32 1) #4
  %130 = bitcast i8* %129 to double*
  %131 = call i8* @hypre_CAlloc(i64 3, i64 8, i32 1) #4
...
184:                                              ; preds = %181, %128
  ...
  call void @hypre_Free(i8* %131, i32 1) #4
  br label %186
...
186:                                              ; preds = %184, %123
  ...
  %190 = call i8* @hypre_MAlloc(i64 %189, i32 1) #4
  ...
  %192 = call i8* @hypre_MAlloc(i64 %189, i32 1) #4
  ...
  %195 = call i8* @hypre_MAlloc(i64 %194, i32 1) #4
  %196 = bitcast i8* %195 to i32*
  %197 = call i8* @hypre_MAlloc(i64 %194, i32 1) #4
  %198 = bitcast i8* %197 to i32*
  %199 = call i8* @hypre_CAlloc(i64 %188, i64 8, i32 1) #4
...
385:                                              ; preds = %383, %385
  ...
  call void @hypre_Free(i8* %389, i32 1) #4
...
502:                                              ; preds = %489, %482
  ...
  %519 = call i8* @hypre_MAlloc(i64 %415, i32 1) #4
  %520 = bitcast i8* %519 to i8**
  %521 = call i8* @hypre_MAlloc(i64 %415, i32 1) #4
  %522 = bitcast i8* %521 to i8**
  %523 = call i8* @hypre_MAlloc(i64 %415, i32 1) #4
  %524 = bitcast i8* %523 to i8**
  %525 = call i8* @hypre_MAlloc(i64 %415, i32 1) #4
...
647:                                              ; preds = %634, %622, %586
  call void @hypre_Free(i8* %199, i32 1) #4
...
define dso_local i32 @hypre_SysStructCoarsen(%struct.hypre_SStructPGrid* nocapture readonly %0, i32* %1, i32* %2, i32 %3, %struct.hypre_SStructPGrid** nocapture %4) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_MAlloc(i64 200, i32 1) #4
  ...
  %24 = shl nsw i64 %23, 2
  %25 = call i8* @hypre_MAlloc(i64 %24, i32 1) #4

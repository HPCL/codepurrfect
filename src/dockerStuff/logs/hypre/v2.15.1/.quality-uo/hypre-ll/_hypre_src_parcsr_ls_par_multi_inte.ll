...
325:                                              ; preds = %323
  ...
  %329 = call i8* @hypre_CAlloc(i64 %326, i64 4, i32 1) #4
  %330 = bitcast i8* %329 to i32*
  %331 = call i8* @hypre_CAlloc(i64 %326, i64 4, i32 1) #4
  %332 = bitcast i8* %331 to i32*
  %333 = sext i32 %324 to i64
  %334 = call i8* @hypre_CAlloc(i64 %333, i64 4, i32 1) #4
...
428:                                              ; preds = %423, %420
  ...
  %431 = call i8* @hypre_CAlloc(i64 %430, i64 4, i32 1) #4
...
484:                                              ; preds = %480, %438
  ...
  call void @hypre_Free(i8* %485, i32 1) #4
  br i1 %99, label %513, label %486

486:                                              ; preds = %484
  %487 = sext i32 %37 to i64
  %488 = call i8* @hypre_CAlloc(i64 %487, i64 4, i32 1) #4
...
808:                                              ; preds = %806, %651
  ...
  %812 = call i8* @hypre_CAlloc(i64 %811, i64 8, i32 1) #4
  %813 = bitcast i8* %812 to i32**
  %814 = sext i32 %605 to i64
  %815 = call i8* @hypre_CAlloc(i64 %814, i64 4, i32 1) #4
  ...
  %820 = call i8* @hypre_CAlloc(i64 %819, i64 4, i32 1) #4
  %821 = bitcast i8* %820 to i32*
  %822 = call i8* @hypre_CAlloc(i64 %819, i64 4, i32 1) #4
...
826:                                              ; preds = %808
  %827 = call i8* @hypre_CAlloc(i64 %811, i64 8, i32 1) #4
...
830:                                              ; preds = %826
  ...
  %832 = call i8* @hypre_CAlloc(i64 %831, i64 4, i32 1) #4
...
838:                                              ; preds = %835, %830
  %839 = call i8* @hypre_CAlloc(i64 %811, i64 8, i32 1) #4
  %840 = bitcast i8* %839 to i32**
  %841 = add nuw nsw i32 %809, 1
  %842 = zext i32 %841 to i64
  %843 = call i8* @hypre_CAlloc(i64 %842, i64 4, i32 1) #4
...
941:                                              ; preds = %935
  %942 = call i8* @hypre_CAlloc(i64 1, i64 72, i32 1) #4
  %943 = bitcast i8* %942 to %struct.hypre_ParCSRCommPkg*
  %944 = call i8* @hypre_CAlloc(i64 %811, i64 8, i32 1) #4
  %945 = bitcast i8* %944 to i32**
  %946 = call i8* @hypre_CAlloc(i64 %811, i64 8, i32 1) #4
  %947 = bitcast i8* %946 to i32**
  %948 = call i8* @hypre_CAlloc(i64 %811, i64 8, i32 1) #4
  %949 = bitcast i8* %948 to i32**
  %950 = add nsw i32 %100, 1
  %951 = sext i32 %950 to i64
  %952 = call i8* @hypre_CAlloc(i64 %951, i64 4, i32 1) #4
  %953 = bitcast i8* %952 to i32*
  br i1 %111, label %958, label %954

954:                                              ; preds = %941
  %955 = sext i32 %100 to i64
  %956 = call i8* @hypre_CAlloc(i64 %955, i64 4, i32 1) #4
...
964:                                              ; preds = %958
  ...
  %966 = call i8* @hypre_CAlloc(i64 %965, i64 4, i32 1) #4
...
1094:                                             ; preds = %1089
  ...
  call void @hypre_Free(i8* %1095, i32 1) #4
  %1096 = sext i32 %1090 to i64
  %1097 = call i8* @hypre_CAlloc(i64 %1096, i64 4, i32 1) #4
...
1432:                                             ; preds = %1428, %1421
  ...
  %1442 = call i8* @hypre_CAlloc(i64 %1009, i64 4, i32 1) #4
...
1447:                                             ; preds = %1445
  ...
  %1449 = call i8* @hypre_CAlloc(i64 %1448, i64 4, i32 1) #4
...
1456:                                             ; preds = %1455
  %1457 = call i8* @hypre_CAlloc(i64 %1011, i64 4, i32 1) #4
...
1671:                                             ; preds = %1654, %1649
  ...
  %1682 = call i8* @hypre_CAlloc(i64 %1681, i64 4, i32 1) #4
...
1686:                                             ; preds = %1671
  ...
  %1688 = call i8* @hypre_CAlloc(i64 %1687, i64 4, i32 1) #4
...
1894:                                             ; preds = %1890, %985
  ...
  call void @hypre_Free(i8* %1901, i32 1) #4
  %1902 = bitcast i32* %989 to i8*
  call void @hypre_Free(i8* %1902, i32 1) #4
  %1903 = bitcast i32* %1897 to i8*
  call void @hypre_Free(i8* %1903, i32 1) #4
  call void @hypre_Free(i8* %431, i32 1) #4
  ...
  %1905 = call i8* @hypre_CAlloc(i64 %1904, i64 4, i32 2) #4
  %1906 = bitcast i8* %1905 to i32*
  %1907 = call i8* @hypre_CAlloc(i64 %1904, i64 8, i32 2) #4
...
1910:                                             ; preds = %1894
  ...
  %1912 = call i8* @hypre_CAlloc(i64 %1911, i64 4, i32 2) #4
  %1913 = bitcast i8* %1912 to i32*
  %1914 = call i8* @hypre_CAlloc(i64 %1911, i64 8, i32 2) #4
...
1983:                                             ; preds = %1978
  %1984 = call i8* @hypre_CAlloc(i64 %819, i64 4, i32 1) #4
...
1991:                                             ; preds = %1990
  ...
  %1993 = call i8* @hypre_CAlloc(i64 %1992, i64 4, i32 1) #4
...
2273:                                             ; preds = %2270, %1999
  ...
  call void @hypre_Free(i8* %1984, i32 1) #4
  br i1 %111, label %2278, label %2276

2276:                                             ; preds = %2273
  %2277 = bitcast i32* %2000 to i8*
  call void @hypre_Free(i8* %2277, i32 1) #4
  br label %2278
...
2280:                                             ; preds = %2278
  ...
  call void @hypre_Free(i8* %2281, i32 1) #4
  br label %2282

2282:                                             ; preds = %2280, %2278
  %2283 = bitcast i32* %439 to i8*
  call void @hypre_Free(i8* %2283, i32 1) #4
  %2284 = load i8*, i8** %818, align 8, !tbaa !55
  call void @hypre_Free(i8* %2284, i32 1) #4
...
2335:                                             ; preds = %2329
  ...
  call void @hypre_Free(i8* %2336, i32 1) #4
  %2337 = sext i32 %2333 to i64
  %2338 = call i8* @hypre_CAlloc(i64 %2337, i64 8, i32 1) #4
...
2425:                                             ; preds = %2417
  ...
  call void @hypre_Free(i8* %2426, i32 1) #4
  %2427 = sext i32 %2423 to i64
  %2428 = call i8* @hypre_CAlloc(i64 %2427, i64 8, i32 1) #4
...
2430:                                             ; preds = %2425, %2417
  ...
  call void @hypre_Free(i8* %2437, i32 1) #4
...
2440:                                             ; preds = %2430, %2318
  ...
  %2451 = call i8* @hypre_CAlloc(i64 %819, i64 4, i32 1) #4
...
2455:                                             ; preds = %2454
  %2456 = call i8* @hypre_CAlloc(i64 %2300, i64 4, i32 1) #4
...
2461:                                             ; preds = %2459
  %2462 = call i8* @hypre_CAlloc(i64 %2302, i64 4, i32 1) #4
...
2466:                                             ; preds = %2464
  %2467 = call i8* @hypre_CAlloc(i64 %2317, i64 4, i32 1) #4
...
2911:                                             ; preds = %2908, %2469
  ...
  call void @hypre_Free(i8* %2914, i32 1) #4
  %2915 = bitcast i32* %2470 to i8*
  call void @hypre_Free(i8* %2915, i32 1) #4
  call void @hypre_Free(i8* %2451, i32 1) #4
  br i1 %111, label %2918, label %2916

2916:                                             ; preds = %2911
  %2917 = bitcast i32* %2460 to i8*
  call void @hypre_Free(i8* %2917, i32 1) #4
  br label %2918
...
2918:                                             ; preds = %2916, %2911
  ...
  call void @hypre_Free(i8* %2922, i32 1) #4
...
2935:                                             ; preds = %2934
  %2936 = call i8* @hypre_CAlloc(i64 %819, i64 4, i32 1) #4
...
2941:                                             ; preds = %2938
  ...
  %2943 = call i8* @hypre_CAlloc(i64 %2942, i64 4, i32 1) #4
...
3190:                                             ; preds = %3187, %2957
  ...
  call void @hypre_Free(i8* %3192, i32 1) #4
  %3193 = bitcast i32* %2946 to i8*
  call void @hypre_Free(i8* %3193, i32 1) #4
  br i1 %170, label %3196, label %3194

3194:                                             ; preds = %3190
  %3195 = bitcast i32* %176 to i8*
  call void @hypre_Free(i8* %3195, i32 1) #4
  br label %3196

3196:                                             ; preds = %3194, %3190
  %3197 = bitcast i32* %439 to i8*
  call void @hypre_Free(i8* %3197, i32 1) #4
  %3198 = load i8*, i8** %818, align 8, !tbaa !55
  call void @hypre_Free(i8* %3198, i32 1) #4
  store i32* null, i32** %817, align 8, !tbaa !55
...
3245:                                             ; preds = %3239
  ...
  call void @hypre_Free(i8* %3246, i32 1) #4
  %3247 = sext i32 %3243 to i64
  %3248 = call i8* @hypre_CAlloc(i64 %3247, i64 8, i32 1) #4
...
3335:                                             ; preds = %3327
  ...
  call void @hypre_Free(i8* %3336, i32 1) #4
  %3337 = sext i32 %3333 to i64
  %3338 = call i8* @hypre_CAlloc(i64 %3337, i64 8, i32 1) #4
...
3340:                                             ; preds = %3335, %3327
  ...
  call void @hypre_Free(i8* %3347, i32 1) #4
...
3361:                                             ; preds = %3350
  %3362 = call i8* @hypre_CAlloc(i64 %819, i64 4, i32 1) #4
...
3367:                                             ; preds = %3364
  %3368 = call i8* @hypre_CAlloc(i64 %3213, i64 4, i32 1) #4
...
3373:                                             ; preds = %3370
  %3374 = call i8* @hypre_CAlloc(i64 %3214, i64 4, i32 1) #4
  %3375 = bitcast i8* %3374 to i32*
  br label %3376

3376:                                             ; preds = %3373, %3370
  %3377 = phi i32* [ %3375, %3373 ], [ null, %3370 ]
  %3378 = call i8* @hypre_CAlloc(i64 %3229, i64 4, i32 1) #4
...
3754:                                             ; preds = %3751, %3383
  ...
  call void @hypre_Free(i8* %3756, i32 1) #4
  %3757 = bitcast i32* %3371 to i8*
  call void @hypre_Free(i8* %3757, i32 1) #4
  %3758 = bitcast i32* %3377 to i8*
  call void @hypre_Free(i8* %3758, i32 1) #4
  call void @hypre_Free(i8* %3378, i32 1) #4
  %3759 = getelementptr inbounds i32*, i32** %813, i64 %3231
  %3760 = bitcast i32** %3759 to i8**
  %3761 = load i8*, i8** %3760, align 8, !tbaa !55
  call void @hypre_Free(i8* %3761, i32 1) #4
...
3773:                                             ; preds = %2932, %3771, %2291, %3205
  ...
  call void @hypre_Free(i8* %3777, i32 1) #4
  %3778 = bitcast i32** %987 to i8*
  call void @hypre_Free(i8* %3778, i32 1) #4
...
3834:                                             ; preds = %3828
  ...
  %3838 = call i8* @hypre_CAlloc(i64 %3837, i64 4, i32 1) #4
...
3863:                                             ; preds = %3859, %3844
  ...
  %3866 = call i8* @hypre_CAlloc(i64 %3865, i64 4, i32 1) #4
  ...
  %3873 = call i8* @hypre_CAlloc(i64 %3872, i64 4, i32 1) #4
...
3953:                                             ; preds = %3944, %3928
  call void @hypre_Free(i8* %3838, i32 1) #4
  br label %3954
...
3963:                                             ; preds = %3960, %3963
  ...
  call void @hypre_Free(i8* %3967, i32 1) #4
...
3970:                                             ; preds = %3963, %3954
  call void @hypre_Free(i8* %3956, i32 1) #4
  %3971 = bitcast i32** %849 to i8*
  call void @hypre_Free(i8* %3971, i32 1) #4
  %3972 = bitcast i32* %850 to i8*
  call void @hypre_Free(i8* %3972, i32 1) #4

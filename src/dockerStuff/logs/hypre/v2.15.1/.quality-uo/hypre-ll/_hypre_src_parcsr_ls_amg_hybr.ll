...
158:                                              ; preds = %156
  ...
  %169 = call i32 @hypre_PCGSetHybrid(i8* %160, i32 -1) #4
  br label %170

170:                                              ; preds = %158, %156
  %171 = phi i8* [ %160, %158 ], [ %141, %156 ]
  %172 = call i32 @hypre_PCGSetConvergenceFactorTol(i8* %171, double %24) #4
  %173 = call i32 @hypre_PCGSetPrecond(i8* %171, i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScale to i32 (i8*, i8*, i8*, i8*)*), i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScaleSetup to i32 (i8*, i8*, i8*, i8*)*), i8* null) #4
  %174 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to i8*
  %175 = bitcast %struct.hypre_ParVector_struct* %2 to i8*
  %176 = bitcast %struct.hypre_ParVector_struct* %3 to i8*
  %177 = call i32 @hypre_PCGSetup(i8* %171, i8* nonnull %174, i8* nonnull %175, i8* nonnull %176) #4
  store i8* %171, i8** %140, align 8, !tbaa !42
  %178 = call i32 @hypre_PCGSolve(i8* %171, i8* nonnull %174, i8* nonnull %175, i8* nonnull %176) #4
  %179 = call i32 @hypre_PCGGetNumIterations(i8* %171, i32* nonnull %5) #4
  %180 = load i32, i32* %5, align 4, !tbaa !53
  store i32 %180, i32* %146, align 8, !tbaa !65
  %181 = call i32 @hypre_PCGGetFinalRelativeResidualNorm(i8* %171, double* nonnull %8) #4
  %182 = call i32 @hypre_PCGGetConverged(i8* %171, i32* nonnull %7) #4
  br label %235

183:                                              ; preds = %155
  %184 = icmp eq i8* %141, null
  br i1 %184, label %185, label %197

185:                                              ; preds = %183
  %186 = call %struct.hypre_GMRESFunctions* @hypre_GMRESFunctionsCreate(i8* (i64, i64, i32)* nonnull @hypre_CAlloc, i32 (i8*)* nonnull @hypre_ParKrylovFree, i32 (i8*, i32*, i32*)* nonnull @hypre_ParKrylovCommInfo, i8* (i8*)* nonnull @hypre_ParKrylovCreateVector, i8* (i32, i8*)* nonnull @hypre_ParKrylovCreateVectorArray, i32 (i8*)* nonnull @hypre_ParKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_ParKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_ParKrylovMatvec, i32 (i8*)* nonnull @hypre_ParKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_ParKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_ParKrylovCopyVector, i32 (i8*)* nonnull @hypre_ParKrylovClearVector, i32 (double, i8*)* nonnull @hypre_ParKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_ParKrylovAxpy, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentity) #4
  %187 = call i8* @hypre_GMRESCreate(%struct.hypre_GMRESFunctions* %186) #4
  %188 = call i32 @hypre_GMRESSetMaxIter(i8* %187, i32 %27) #4
  %189 = call i32 @hypre_GMRESSetTol(i8* %187, double %18) #4
  %190 = call i32 @hypre_GMRESSetAbsoluteTol(i8* %187, double %21) #4
  %191 = call i32 @hypre_GMRESSetKDim(i8* %187, i32 %54) #4
  %192 = call i32 @hypre_GMRESSetStopCrit(i8* %187, i32 %36) #4
  %193 = call i32 @hypre_GMRESSetRelChange(i8* %187, i32 %39) #4
  %194 = call i32 @hypre_GMRESSetLogging(i8* %187, i32 %42) #4
  %195 = call i32 @hypre_GMRESSetPrintLevel(i8* %187, i32 %138) #4
  %196 = call i32 @hypre_GMRESSetHybrid(i8* %187, i32 -1) #4
  br label %197

197:                                              ; preds = %185, %183
  %198 = phi i8* [ %187, %185 ], [ %141, %183 ]
  %199 = call i32 @hypre_GMRESSetConvergenceFactorTol(i8* %198, double %24) #4
  %200 = call i32 @hypre_GMRESSetPrecond(i8* %198, i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScale to i32 (i8*, i8*, i8*, i8*)*), i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScaleSetup to i32 (i8*, i8*, i8*, i8*)*), i8* null) #4
  %201 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to i8*
  %202 = bitcast %struct.hypre_ParVector_struct* %2 to i8*
  %203 = bitcast %struct.hypre_ParVector_struct* %3 to i8*
  %204 = call i32 @hypre_GMRESSetup(i8* %198, i8* nonnull %201, i8* nonnull %202, i8* nonnull %203) #4
  store i8* %198, i8** %140, align 8, !tbaa !42
  %205 = call i32 @hypre_GMRESSolve(i8* %198, i8* nonnull %201, i8* nonnull %202, i8* nonnull %203) #4
  %206 = call i32 @hypre_GMRESGetNumIterations(i8* %198, i32* nonnull %5) #4
  %207 = load i32, i32* %5, align 4, !tbaa !53
  store i32 %207, i32* %146, align 8, !tbaa !65
  %208 = call i32 @hypre_GMRESGetFinalRelativeResidualNorm(i8* %198, double* nonnull %8) #4
  %209 = call i32 @hypre_GMRESGetConverged(i8* %198, i32* nonnull %7) #4
  br label %235
...
212:                                              ; preds = %210
  %213 = call %struct.hypre_BiCGSTABFunctions* @hypre_BiCGSTABFunctionsCreate(i8* (i8*)* nonnull @hypre_ParKrylovCreateVector, i32 (i8*)* nonnull @hypre_ParKrylovDestroyVector, i8* (i8*, i8*)* nonnull @hypre_ParKrylovMatvecCreate, i32 (i8*, double, i8*, i8*, double, i8*)* nonnull @hypre_ParKrylovMatvec, i32 (i8*)* nonnull @hypre_ParKrylovMatvecDestroy, double (i8*, i8*)* nonnull @hypre_ParKrylovInnerProd, i32 (i8*, i8*)* nonnull @hypre_ParKrylovCopyVector, i32 (i8*)* nonnull @hypre_ParKrylovClearVector, i32 (double, i8*)* nonnull @hypre_ParKrylovScaleVector, i32 (double, i8*, i8*)* nonnull @hypre_ParKrylovAxpy, i32 (i8*, i32*, i32*)* nonnull @hypre_ParKrylovCommInfo, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentitySetup, i32 (i8*, i8*, i8*, i8*)* nonnull @hypre_ParKrylovIdentity) #4
  %214 = call i8* @hypre_BiCGSTABCreate(%struct.hypre_BiCGSTABFunctions* %213) #4
  %215 = call i32 @hypre_BiCGSTABSetMaxIter(i8* %214, i32 %27) #4
  %216 = call i32 @hypre_BiCGSTABSetTol(i8* %214, double %18) #4
  %217 = call i32 @hypre_BiCGSTABSetAbsoluteTol(i8* %214, double %21) #4
  %218 = call i32 @hypre_BiCGSTABSetStopCrit(i8* %214, i32 %36) #4
  %219 = call i32 @hypre_BiCGSTABSetLogging(i8* %214, i32 %42) #4
  %220 = call i32 @hypre_BiCGSTABSetPrintLevel(i8* %214, i32 %138) #4
  %221 = call i32 @hypre_BiCGSTABSetHybrid(i8* %214, i32 -1) #4
  br label %222

222:                                              ; preds = %212, %210
  %223 = phi i8* [ %214, %212 ], [ %141, %210 ]
  %224 = call i32 @hypre_BiCGSTABSetConvergenceFactorTol(i8* %223, double %24) #4
  %225 = call i32 @hypre_BiCGSTABSetPrecond(i8* %223, i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScale to i32 (i8*, i8*, i8*, i8*)*), i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (%struct.hypre_Solver_struct*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @HYPRE_ParCSRDiagScaleSetup to i32 (i8*, i8*, i8*, i8*)*), i8* null) #4
  %226 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to i8*
  %227 = bitcast %struct.hypre_ParVector_struct* %2 to i8*
  %228 = bitcast %struct.hypre_ParVector_struct* %3 to i8*
  %229 = call i32 @hypre_BiCGSTABSetup(i8* %223, i8* nonnull %226, i8* nonnull %227, i8* nonnull %228) #4
  store i8* %223, i8** %140, align 8, !tbaa !42
  %230 = call i32 @hypre_BiCGSTABSolve(i8* %223, i8* nonnull %226, i8* nonnull %227, i8* nonnull %228) #4
  %231 = call i32 @hypre_BiCGSTABGetNumIterations(i8* %223, i32* nonnull %5) #4
  %232 = load i32, i32* %5, align 4, !tbaa !53
  store i32 %232, i32* %146, align 8, !tbaa !65
  %233 = call i32 @hypre_BiCGSTABGetFinalRelativeResidualNorm(i8* %223, double* nonnull %8) #4
  %234 = call i32 @hypre_BiCGSTABGetConverged(i8* %223, i32* nonnull %7) #4
  br label %235

235:                                              ; preds = %155, %170, %222, %197, %135
  %236 = phi i8* [ %171, %170 ], [ %198, %197 ], [ %223, %222 ], [ %141, %135 ], [ %141, %155 ]
  %237 = load i32, i32* %7, align 4, !tbaa !53
  %238 = icmp eq i32 %237, 0
  br i1 %238, label %245, label %239

239:                                              ; preds = %235
  %240 = icmp eq i32 %42, 0
  br i1 %240, label %469, label %241

241:                                              ; preds = %239
  %242 = load double, double* %8, align 8, !tbaa !60
  %243 = getelementptr inbounds i8, i8* %0, i64 96
  %244 = bitcast i8* %243 to double*
  store double %242, double* %244, align 8, !tbaa !67
  br label %469

245:                                              ; preds = %235
  %246 = icmp eq i32 %51, 1
  br i1 %246, label %247, label %251

247:                                              ; preds = %245
  %248 = call i32 @hypre_PCGSetMaxIter(i8* %236, i32 %30) #4
  %249 = call i32 @hypre_PCGSetConvergenceFactorTol(i8* %236, double 0.000000e+00) #4
  %250 = call i32 @hypre_PCGSetHybrid(i8* %236, i32 0) #4
  br label %260

251:                                              ; preds = %245
  switch i32 %51, label %260 [
    i32 2, label %252
    i32 3, label %256
  ]

252:                                              ; preds = %251
  %253 = call i32 @hypre_GMRESSetMaxIter(i8* %236, i32 %30) #4
  %254 = call i32 @hypre_GMRESSetConvergenceFactorTol(i8* %236, double 0.000000e+00) #4
  %255 = call i32 @hypre_GMRESSetHybrid(i8* %236, i32 0) #4
  br label %260

256:                                              ; preds = %251
  %257 = call i32 @hypre_BiCGSTABSetMaxIter(i8* %236, i32 %30) #4
  %258 = call i32 @hypre_BiCGSTABSetConvergenceFactorTol(i8* %236, double 0.000000e+00) #4
  %259 = call i32 @hypre_BiCGSTABSetHybrid(i8* %236, i32 0) #4
  br label %260

260:                                              ; preds = %251, %252, %256, %247
  %261 = icmp ne i32 %123, 0
  %262 = select i1 %149, i1 %261, i1 false
  br i1 %262, label %263, label %410

263:                                              ; preds = %260
  %264 = call i8* @hypre_BoomerAMGCreate() #4
  %265 = call i32 @hypre_BoomerAMGSetMaxIter(i8* %264, i32 1) #4
  %266 = call i32 @hypre_BoomerAMGSetTol(i8* %264, double 0.000000e+00) #4
  %267 = call i32 @hypre_BoomerAMGSetCoarsenType(i8* %264, i32 %75) #4
  %268 = call i32 @hypre_BoomerAMGSetInterpType(i8* %264, i32 %78) #4
  %269 = call i32 @hypre_BoomerAMGSetSetupType(i8* %264, i32 %48) #4
  %270 = call i32 @hypre_BoomerAMGSetMeasureType(i8* %264, i32 %72) #4
  %271 = call i32 @hypre_BoomerAMGSetStrongThreshold(i8* %264, double %57) #4
  %272 = call i32 @hypre_BoomerAMGSetTruncFactor(i8* %264, double %63) #4
  %273 = call i32 @hypre_BoomerAMGSetPMaxElmts(i8* %264, i32 %66) #4
  %274 = call i32 @hypre_BoomerAMGSetCycleType(i8* %264, i32 %81) #4
  %275 = call i32 @hypre_BoomerAMGSetPrintLevel(i8* %264, i32 %136) #4
  %276 = call i32 @hypre_BoomerAMGSetMaxLevels(i8* %264, i32 %69) #4
  %277 = call i32 @hypre_BoomerAMGSetMaxRowSum(i8* %264, double %60) #4
  %278 = call i32 @hypre_BoomerAMGSetMaxCoarseSize(i8* %264, i32 %111) #4
  %279 = call i32 @hypre_BoomerAMGSetMinCoarseSize(i8* %264, i32 %114) #4
  %280 = call i32 @hypre_BoomerAMGSetSeqThreshold(i8* %264, i32 %117) #4
  %281 = call i32 @hypre_BoomerAMGSetAggNumLevels(i8* %264, i32 %87) #4
  %282 = call i32 @hypre_BoomerAMGSetNumPaths(i8* %264, i32 %84) #4
  %283 = call i32 @hypre_BoomerAMGSetNumFunctions(i8* %264, i32 %90) #4
  %284 = call i32 @hypre_BoomerAMGSetNodal(i8* %264, i32 %93) #4
  %285 = icmp eq i32* %99, null
  %286 = call i8* @hypre_CAlloc(i64 4, i64 4, i32 1) #4
  %287 = bitcast i8* %286 to i32*
  br i1 %285, label %297, label %288

288:                                              ; preds = %263, %288
  %289 = phi i64 [ %293, %288 ], [ 0, %263 ]
  %290 = getelementptr inbounds i32, i32* %99, i64 %289
  %291 = load i32, i32* %290, align 4, !tbaa !53
  %292 = getelementptr inbounds i32, i32* %287, i64 %289
  store i32 %291, i32* %292, align 4, !tbaa !53
  %293 = add nuw nsw i64 %289, 1
  %294 = icmp eq i64 %293, 4
  br i1 %294, label %295, label %288, !llvm.loop !72

295:                                              ; preds = %288
  %296 = call i32 @hypre_BoomerAMGSetGridRelaxType(i8* %264, i32* %287) #4
  br label %305

297:                                              ; preds = %263
  store i32 3, i32* %287, align 4, !tbaa !53
  %298 = getelementptr inbounds i8, i8* %286, i64 4
  %299 = bitcast i8* %298 to i32*
  store i32 13, i32* %299, align 4, !tbaa !53
  %300 = getelementptr inbounds i8, i8* %286, i64 8
  %301 = bitcast i8* %300 to i32*
  store i32 14, i32* %301, align 4, !tbaa !53
  %302 = getelementptr inbounds i8, i8* %286, i64 12
  %303 = bitcast i8* %302 to i32*
  store i32 9, i32* %303, align 4, !tbaa !53
  %304 = call i32 @hypre_BoomerAMGSetGridRelaxType(i8* %264, i32* nonnull %287) #4
  br label %305

305:                                              ; preds = %297, %295
  %306 = icmp eq double* %105, null
  br i1 %306, label %323, label %307

307:                                              ; preds = %305
  %308 = sext i32 %69 to i64
  %309 = call i8* @hypre_CAlloc(i64 %308, i64 8, i32 1) #4
  %310 = bitcast i8* %309 to double*
  %311 = icmp sgt i32 %69, 0
  br i1 %311, label %312, label %321

312:                                              ; preds = %307
  %313 = zext i32 %69 to i64
  br label %314

314:                                              ; preds = %312, %314
  %315 = phi i64 [ 0, %312 ], [ %319, %314 ]
  %316 = getelementptr inbounds double, double* %105, i64 %315
  %317 = load double, double* %316, align 8, !tbaa !60
  %318 = getelementptr inbounds double, double* %310, i64 %315
  store double %317, double* %318, align 8, !tbaa !60
  %319 = add nuw nsw i64 %315, 1
  %320 = icmp eq i64 %319, %313
  br i1 %320, label %321, label %314, !llvm.loop !73

321:                                              ; preds = %314, %307
  %322 = call i32 @hypre_BoomerAMGSetRelaxWeight(i8* %264, double* %310) #4
  br label %323

323:                                              ; preds = %321, %305
  %324 = icmp eq double* %108, null
  br i1 %324, label %341, label %325

325:                                              ; preds = %323
  %326 = sext i32 %69 to i64
  %327 = call i8* @hypre_CAlloc(i64 %326, i64 8, i32 1) #4
  %328 = bitcast i8* %327 to double*
  %329 = icmp sgt i32 %69, 0
  br i1 %329, label %330, label %339

330:                                              ; preds = %325
  %331 = zext i32 %69 to i64
  br label %332

332:                                              ; preds = %330, %332
  %333 = phi i64 [ 0, %330 ], [ %337, %332 ]
  %334 = getelementptr inbounds double, double* %108, i64 %333
  %335 = load double, double* %334, align 8, !tbaa !60
  %336 = getelementptr inbounds double, double* %328, i64 %333
  store double %335, double* %336, align 8, !tbaa !60
  %337 = add nuw nsw i64 %333, 1
  %338 = icmp eq i64 %337, %331
  br i1 %338, label %339, label %332, !llvm.loop !74

339:                                              ; preds = %332, %325
  %340 = call i32 @hypre_BoomerAMGSetOmega(i8* %264, double* %328) #4
  br label %341

341:                                              ; preds = %339, %323
  %342 = icmp eq i32* %96, null
  br i1 %342, label %387, label %343

343:                                              ; preds = %341
  %344 = call i8* @hypre_CAlloc(i64 4, i64 4, i32 1) #4
  %345 = bitcast i8* %344 to i32*
  br label %346

346:                                              ; preds = %343, %346
  %347 = phi i64 [ 0, %343 ], [ %351, %346 ]
  %348 = getelementptr inbounds i32, i32* %96, i64 %347
  %349 = load i32, i32* %348, align 4, !tbaa !53
  %350 = getelementptr inbounds i32, i32* %345, i64 %347
  store i32 %349, i32* %350, align 4, !tbaa !53
  %351 = add nuw nsw i64 %347, 1
  %352 = icmp eq i64 %351, 4
  br i1 %352, label %353, label %346, !llvm.loop !75

353:                                              ; preds = %346
  %354 = call i32 @hypre_BoomerAMGSetNumGridSweeps(i8* %264, i32* %345) #4
  %355 = icmp eq i32** %102, null
  br i1 %355, label %387, label %356

356:                                              ; preds = %353
  %357 = call i8* @hypre_CAlloc(i64 4, i64 8, i32 1) #4
  %358 = bitcast i8* %357 to i32**
  br label %359

359:                                              ; preds = %356, %382
  %360 = phi i64 [ 0, %356 ], [ %383, %382 ]
  %361 = getelementptr inbounds i32, i32* %96, i64 %360
  %362 = load i32, i32* %361, align 4, !tbaa !53
  %363 = sext i32 %362 to i64
  %364 = call i8* @hypre_CAlloc(i64 %363, i64 4, i32 1) #4
  %365 = getelementptr inbounds i32*, i32** %358, i64 %360
  %366 = bitcast i32** %365 to i8**
  store i8* %364, i8** %366, align 8, !tbaa !47
  %367 = load i32, i32* %361, align 4, !tbaa !53
  %368 = icmp sgt i32 %367, 0
  br i1 %368, label %369, label %382

369:                                              ; preds = %359
  %370 = getelementptr inbounds i32*, i32** %102, i64 %360
  %371 = load i32*, i32** %370, align 8, !tbaa !47
  %372 = load i32*, i32** %365, align 8, !tbaa !47
  br label %373

373:                                              ; preds = %369, %373
  %374 = phi i64 [ 0, %369 ], [ %378, %373 ]
  %375 = getelementptr inbounds i32, i32* %371, i64 %374
  %376 = load i32, i32* %375, align 4, !tbaa !53
  %377 = getelementptr inbounds i32, i32* %372, i64 %374
  store i32 %376, i32* %377, align 4, !tbaa !53
  %378 = add nuw nsw i64 %374, 1
  %379 = load i32, i32* %361, align 4, !tbaa !53
  %380 = sext i32 %379 to i64
  %381 = icmp slt i64 %378, %380
  br i1 %381, label %373, label %382, !llvm.loop !76

382:                                              ; preds = %373, %359
  %383 = add nuw nsw i64 %360, 1
  %384 = icmp eq i64 %383, 4
  br i1 %384, label %385, label %359, !llvm.loop !77

385:                                              ; preds = %382
  %386 = call i32 @hypre_BoomerAMGSetGridRelaxPoints(i8* %264, i32** %358) #4
  br label %387

387:                                              ; preds = %353, %385, %341
  %388 = icmp eq i32* %120, null
  br i1 %388, label %405, label %389

389:                                              ; preds = %387
  %390 = sext i32 %129 to i64
  %391 = call i8* @hypre_CAlloc(i64 %390, i64 4, i32 1) #4
  %392 = bitcast i8* %391 to i32*
  %393 = icmp sgt i32 %129, 0
  br i1 %393, label %394, label %403

394:                                              ; preds = %389
  %395 = zext i32 %129 to i64
  br label %396

396:                                              ; preds = %394, %396
  %397 = phi i64 [ 0, %394 ], [ %401, %396 ]
  %398 = getelementptr inbounds i32, i32* %120, i64 %397
  ...
  br i1 %402, label %403, label %396, !llvm.loop !78

403:                                              ; preds = %396, %389
  %404 = call i32 @hypre_BoomerAMGSetDofFunc(i8* %264, i32* %392) #4
  br label %405

405:                                              ; preds = %403, %387
  %406 = getelementptr inbounds i8, i8* %0, i64 64
  %407 = bitcast i8* %406 to i32 (i8*, i8*, i8*, i8*)**
  store i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSetup to i32 (i8*, i8*, i8*, i8*)*), i32 (i8*, i8*, i8*, i8*)** %407, align 8, !tbaa !55
  %408 = getelementptr inbounds i8, i8* %0, i64 56
  %409 = bitcast i8* %408 to i32 (i8*, i8*, i8*, i8*)**
  store i32 (i8*, i8*, i8*, i8*)* bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSolve to i32 (i8*, i8*, i8*, i8*)*), i32 (i8*, i8*, i8*, i8*)** %409, align 8, !tbaa !54
  store i8* %264, i8** %143, align 8, !tbaa !43
  br label %419

410:                                              ; preds = %260
  %411 = load i8*, i8** %143, align 8, !tbaa !43
  %412 = getelementptr inbounds i8, i8* %0, i64 56
  %413 = bitcast i8* %412 to i32 (i8*, i8*, i8*, i8*)**
  %414 = load i32 (i8*, i8*, i8*, i8*)*, i32 (i8*, i8*, i8*, i8*)** %413, align 8, !tbaa !54
  %415 = getelementptr inbounds i8, i8* %0, i64 64
  %416 = bitcast i8* %415 to i32 (i8*, i8*, i8*, i8*)**
  %417 = load i32 (i8*, i8*, i8*, i8*)*, i32 (i8*, i8*, i8*, i8*)** %416, align 8, !tbaa !55
  %418 = call i32 @hypre_BoomerAMGSetSetupType(i8* %411, i32 %48) #4
  br label %419

419:                                              ; preds = %410, %405
  %420 = phi i8* [ %264, %405 ], [ %411, %410 ]
  %421 = phi i32 (i8*, i8*, i8*, i8*)* [ bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSetup to i32 (i8*, i8*, i8*, i8*)*), %405 ], [ %417, %410 ]
  %422 = phi i32 (i8*, i8*, i8*, i8*)* [ bitcast (i32 (i8*, %struct.hypre_ParCSRMatrix_struct*, %struct.hypre_ParVector_struct*, %struct.hypre_ParVector_struct*)* @hypre_BoomerAMGSolve to i32 (i8*, i8*, i8*, i8*)*), %405 ], [ %414, %410 ]
  br i1 %246, label %423, label %438

423:                                              ; preds = %419
  %424 = call i32 @hypre_PCGSetPrecond(i8* %236, i32 (i8*, i8*, i8*, i8*)* %422, i32 (i8*, i8*, i8*, i8*)* %421, i8* %420) #4
  %425 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to i8*
  %426 = bitcast %struct.hypre_ParVector_struct* %2 to i8*
  %427 = bitcast %struct.hypre_ParVector_struct* %3 to i8*
  %428 = call i32 @hypre_PCGSetup(i8* %236, i8* nonnull %425, i8* nonnull %426, i8* nonnull %427) #4
  %429 = call i32 @hypre_PCGSolve(i8* %236, i8* nonnull %425, i8* nonnull %426, i8* nonnull %427) #4
  %430 = call i32 @hypre_PCGGetNumIterations(i8* %236, i32* nonnull %6) #4
  %431 = load i32, i32* %6, align 4, !tbaa !53
  store i32 %431, i32* %148, align 4, !tbaa !66
  %432 = icmp eq i32 %42, 0
  br i1 %432, label %469, label %433

433:                                              ; preds = %423
  %434 = call i32 @hypre_PCGGetFinalRelativeResidualNorm(i8* %236, double* nonnull %8) #4
  %435 = load double, double* %8, align 8, !tbaa !60
  %436 = getelementptr inbounds i8, i8* %0, i64 96
  %437 = bitcast i8* %436 to double*
  store double %435, double* %437, align 8, !tbaa !67
  br label %469
...
439:                                              ; preds = %438
  %440 = call i32 @hypre_GMRESSetPrecond(i8* %236, i32 (i8*, i8*, i8*, i8*)* %422, i32 (i8*, i8*, i8*, i8*)* %421, i8* %420) #4
  %441 = bitcast %struct.hypre_ParCSRMatrix_struct* %1 to i8*
  %442 = bitcast %struct.hypre_ParVector_struct* %2 to i8*
  %443 = bitcast %struct.hypre_ParVector_struct* %3 to i8*
  %444 = call i32 @hypre_GMRESSetup(i8* %236, i8* nonnull %441, i8* nonnull %442, i8* nonnull %443) #4
  %445 = call i32 @hypre_GMRESSolve(i8* %236, i8* nonnull %441, i8* nonnull %442, i8* nonnull %443) #4
  %446 = call i32 @hypre_GMRESGetNumIterations(i8* %236, i32* nonnull %6) #4
  %447 = load i32, i32* %6, align 4, !tbaa !53
  store i32 %447, i32* %148, align 4, !tbaa !66
  %448 = icmp eq i32 %42, 0
  br i1 %448, label %469, label %449

449:                                              ; preds = %439
  %450 = call i32 @hypre_GMRESGetFinalRelativeResidualNorm(i8* %236, double* nonnull %8) #4
  %451 = load double, double* %8, align 8, !tbaa !60
  %452 = getelementptr inbounds i8, i8* %0, i64 96
  %453 = bitcast i8* %452 to double*
  store double %451, double* %453, align 8, !tbaa !67
  br label %469

454:                                              ; preds = %438
  %455 = call i32 @hypre_BiCGSTABSetPrecond(i8* %236, i32 (i8*, i8*, i8*, i8*)* %422, i32 (i8*, i8*, i8*, i8*)* %421, i8* %420) #4
  ...
  %459 = call i32 @hypre_BiCGSTABSetup(i8* %236, i8* nonnull %456, i8* nonnull %457, i8* nonnull %458) #4
  %460 = call i32 @hypre_BiCGSTABSolve(i8* %236, i8* nonnull %456, i8* nonnull %457, i8* nonnull %458) #4
  %461 = call i32 @hypre_BiCGSTABGetNumIterations(i8* %236, i32* nonnull %6) #4
  %462 = load i32, i32* %6, align 4, !tbaa !53
  store i32 %462, i32* %148, align 4, !tbaa !66
  %463 = icmp eq i32 %42, 0
  br i1 %463, label %469, label %464

464:                                              ; preds = %454
  %465 = call i32 @hypre_BiCGSTABGetFinalRelativeResidualNorm(i8* %236, double* nonnull %8) #4
  %466 = load double, double* %8, align 8, !tbaa !60
  %467 = getelementptr inbounds i8, i8* %0, i64 96
  %468 = bitcast i8* %467 to double*
  store double %466, double* %468, align 8, !tbaa !67
  br label %469

469:                                              ; preds = %241, %239, %449, %439, %454, %464, %423, %433, %438, %134, %131, %125, %15
  %470 = load i32, i32* @hypre__global_error, align 4, !tbaa !53

...
define dso_local %struct.Mem* @MemCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_MAlloc(i64 8232, i32 1) #5
...
; Function Attrs: nounwind uwtable
define dso_local void @MemDestroy(%struct.Mem* nocapture %0) local_unnamed_addr #0 {
...
13:                                               ; preds = %9
  %14 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str, i64 0, i64 0), i32 1024) #5
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !10
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #5
  %17 = call i32 @fflush(%struct._IO_FILE* null)
  %18 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #5
  br label %19
...
19:                                               ; preds = %13, %9
  ...
  %23 = call i8* @hypre_MAlloc(i64 %22, i32 1) #5
...
26:                                               ; preds = %19
  %27 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.2, i64 0, i64 0), i32 %21) #5
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !10
  %29 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)) #5
  %30 = call i32 @fflush(%struct._IO_FILE* null)
  %31 = call i32 @hypre_MPI_Abort(i32 1140850688, i32 -1) #5
  br label %32
...
define dso_local void @MemStat(%struct.Mem* nocapture readonly %0, %struct._IO_FILE* %1, i8* %2) local_unnamed_addr #0 {
  %4 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0), i8* %2) #5
  %5 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 0
  %6 = load i32, i32* %5, align 8, !tbaa !3
  %7 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i64 0, i64 0), i32 %6) #5
  %8 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 4
  %9 = load i32, i32* %8, align 8, !tbaa !18
  %10 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i64 0, i64 0), i32 %9) #5
  %11 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 2
  %12 = load i64, i64* %11, align 8, !tbaa !16
  %13 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.6, i64 0, i64 0), i64 %12) #5
  %14 = getelementptr inbounds %struct.Mem, %struct.Mem* %0, i64 0, i32 3
  %15 = load i64, i64* %14, align 8, !tbaa !17
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i64 %15) #5
...
19:                                               ; preds = %3
  ...
  %24 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), double %23) #5
  br label %25

25:                                               ; preds = %19, %3
  %26 = call i32 (%struct._IO_FILE*, i8*, ...) @hypre_fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.9, i64 0, i64 0)) #5

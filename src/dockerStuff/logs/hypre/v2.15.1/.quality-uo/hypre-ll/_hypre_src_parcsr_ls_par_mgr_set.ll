...
define dso_local i32 @hypre_MGRSetup(i8* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParVector_struct* %2, %struct.hypre_ParVector_struct* %3) local_unnamed_addr #0 {
  ...
  %113 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %112, i64 0, i32 2
...
580:                                              ; preds = %576
  ...
  %587 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %586, i64 0, i32 2
...
!36 = !{!4, !8, i64 32}
!37 = !{!38, !5, i64 16}
!38 = !{!"", !8, i64 0, !8, i64 8, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !5, i64 48}
!39 = !{!12, !5, i64 0}
!40 = !{!12, !8, i64 384}
!41 = !{!12, !5, i64 380}
!42 = !{!12, !8, i64 16}

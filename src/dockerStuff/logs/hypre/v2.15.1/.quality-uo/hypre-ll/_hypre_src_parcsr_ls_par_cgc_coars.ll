...
define dso_local i32 @hypre_AmgCGCGraphAssemble(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32* nocapture readonly %1, i32* nocapture readonly %2, i32* nocapture readonly %3, i32 %4, %struct.hypre_IJMatrix_struct** nocapture %5) local_unnamed_addr #0 {
  ...
  %37 = call i32 @hypre_MPI_Comm_size(i32 %20, i32* nonnull %9) #5
  %38 = call i32 @hypre_MPI_Comm_rank(i32 %20, i32* nonnull %10) #5
...
261:                                              ; preds = %251, %234
  ...
  %263 = call i32 @HYPRE_IJMatrixCreate(i32 %20, i32 %64, i32 %262, i32 %64, i32 %262, %struct.hypre_IJMatrix_struct** nonnull %12) #5
  %264 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %12, align 8, !tbaa !18
  %265 = call i32 @HYPRE_IJMatrixSetObjectType(%struct.hypre_IJMatrix_struct* %264, i32 5555) #5
  %266 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %12, align 8, !tbaa !18
  %267 = call i32 @HYPRE_IJMatrixSetDiagOffdSizes(%struct.hypre_IJMatrix_struct* %266, i32* %228, i32* %230) #5
  %268 = load %struct.hypre_IJMatrix_struct*, %struct.hypre_IJMatrix_struct** %12, align 8, !tbaa !18
  %269 = call i32 @HYPRE_IJMatrixInitialize(%struct.hypre_IJMatrix_struct* %268) #5
...
291:                                              ; preds = %282, %291
  ...
  %293 = call i32 @HYPRE_IJMatrixAddToValues(%struct.hypre_IJMatrix_struct* %292, i32 1, i32* nonnull %13, i32* nonnull %7, i32* nonnull %8, double* nonnull %11) #5
...
388:                                              ; preds = %386, %387, %370
  ...
  %390 = call i32 @HYPRE_IJMatrixAddToValues(%struct.hypre_IJMatrix_struct* %389, i32 1, i32* nonnull %13, i32* nonnull %7, i32* nonnull %8, double* nonnull %11) #5
...
404:                                              ; preds = %305, %275
  ...
  call void @hypre_Free(i8* %221, i32 1) #5

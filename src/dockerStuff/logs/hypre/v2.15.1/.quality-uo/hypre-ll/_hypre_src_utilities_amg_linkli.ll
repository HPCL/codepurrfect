...
29:                                               ; preds = %28
  ...
  call void @hypre_Free(i8* %33, i32 1) #3
...
37:                                               ; preds = %34
  ...
  call void @hypre_Free(i8* %39, i32 1) #3
...
40:                                               ; preds = %34
  ...
  call void @hypre_Free(i8* %46, i32 1) #3
  store %struct.double_linked_list* %7, %struct.double_linked_list** %0, align 8, !tbaa !3
  store %struct.double_linked_list* %8, %struct.double_linked_list** %1, align 8, !tbaa !3
  br label %82
...
81:                                               ; preds = %77
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 135, i32 1, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0)) #3
  br label %82
...
define dso_local %struct.double_linked_list* @hypre_create_elt(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_MAlloc(i64 32, i32 1) #3
  %3 = icmp eq i8* %2, null
  br i1 %3, label %4, label %5

4:                                                ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 154, i32 1, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0)) #3
  br label %12
...
10:                                               ; preds = %6
  %11 = call i8* @hypre_MAlloc(i64 32, i32 1) #3
...
36:                                               ; preds = %31
  %37 = call i8* @hypre_MAlloc(i64 32, i32 1) #3
...
89:                                               ; preds = %85
  %90 = call i8* @hypre_MAlloc(i64 32, i32 1) #3

...
121:                                              ; preds = %114, %101
  %122 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAdd(double 1.000000e+00, %struct.hypre_CSRMatrix* %36, double 1.000000e+00, %struct.hypre_CSRMatrix* %106) #9
...
227:                                              ; preds = %220, %211
  ...
  %229 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAdd(double 1.000000e+00, %struct.hypre_CSRMatrix* %103, double 1.000000e+00, %struct.hypre_CSRMatrix* %146) #9

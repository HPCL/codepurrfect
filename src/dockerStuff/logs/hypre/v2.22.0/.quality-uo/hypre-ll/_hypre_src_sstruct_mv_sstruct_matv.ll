...
define dso_local i32 @hypre_SStructPMatvecSetup(i8* nocapture %0, %struct.hypre_SStructPMatrix* nocapture readonly %1, %struct.hypre_SStructPVector* nocapture readonly %2) local_unnamed_addr #0 {
  ...
  %6 = sext i32 %5 to i64
  %7 = shl nsw i64 %6, 3
  %8 = call i8* @hypre_MAlloc(i64 %7, i32 0) #3
...
17:                                               ; preds = %14, %46
  ...
  %19 = call i8* @hypre_MAlloc(i64 %7, i32 0) #3
...
34:                                               ; preds = %28, %3
  ...
  call void @hypre_Free(i8* %35, i32 0) #3
...
define dso_local i32 @hypre_SStructPMatvec(double %0, %struct.hypre_SStructPMatrix* nocapture readonly %1, %struct.hypre_SStructPVector* nocapture readonly %2, double %3, %struct.hypre_SStructPVector* nocapture readonly %4) local_unnamed_addr #0 {
  %6 = call i8* @hypre_CAlloc(i64 1, i64 16, i32 0) #3
...
15:                                               ; preds = %13, %15
  ...
  %18 = call i8* @hypre_CAlloc(i64 1, i64 16, i32 0) #3
...
define dso_local i32 @hypre_SStructMatvecCompute(i8* nocapture readonly %0, double %1, %struct.hypre_SStructMatrix_struct* nocapture readonly %2, %struct.hypre_SStructVector_struct* %3, double %4, %struct.hypre_SStructVector_struct* %5) local_unnamed_addr #0 {
  ...
  %20 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %2, i64 0, i32 22
  %21 = load i32, i32* %20, align 4, !tbaa !33
  %22 = icmp eq i32 %19, %21
  br i1 %22, label %24, label %23

23:                                               ; preds = %6
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0), i32 288, i32 20, i8* null) #3
  call void @hypre_error_handler(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0), i32 289, i32 28, i8* null) #3
  br label %68
...
19:                                               ; preds = %12, %3
  ...
  call void @hypre_Free(i8* %20, i32 0) #3
  call void @hypre_Free(i8* nonnull %0, i32 0) #3
  br label %21
...
define dso_local i32 @hypre_SStructMatvec(double %0, %struct.hypre_SStructMatrix_struct* nocapture readonly %1, %struct.hypre_SStructVector_struct* %2, double %3, %struct.hypre_SStructVector_struct* %4) local_unnamed_addr #0 {
  ...
  %9 = sext i32 %8 to i64
  %10 = shl nsw i64 %9, 3
  %11 = call i8* @hypre_MAlloc(i64 %10, i32 0) #3
  %12 = bitcast i8* %11 to i8**
...
18:                                               ; preds = %18, %16
  ...
  %21 = call i8* @hypre_CAlloc(i64 1, i64 16, i32 0) #3
...
51:                                               ; preds = %44, %37
  ...
  call void @hypre_Free(i8* nonnull %6, i32 0) #3
  br label %53
...
!25 = !{!26, !8, i64 24}
!26 = !{!"hypre_SStructMatrix_struct", !8, i64 0, !8, i64 4, !4, i64 8, !4, i64 16, !8, i64 24, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !8, i64 64, !4, i64 72, !4, i64 80, !8, i64 88, !4, i64 96, !4, i64 104, !4, i64 112, !4, i64 120, !4, i64 128, !4, i64 136, !8, i64 144, !8, i64 148, !8, i64 152, !8, i64 156}
!27 = !{!26, !4, i64 32}
!28 = !{!29, !4, i64 24}

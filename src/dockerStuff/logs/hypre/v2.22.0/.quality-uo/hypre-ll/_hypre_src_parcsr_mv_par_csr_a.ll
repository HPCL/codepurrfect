...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRAAt(%struct.hypre_ParCSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %42 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 4
  %43 = load i32, i32* %42, align 8, !tbaa !36
  %44 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 5
...
54:                                               ; preds = %52
  %55 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 16
  %56 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %55, align 8, !tbaa !40
  %57 = icmp eq %struct._hypre_ParCSRCommPkg* %56, null
...
60:                                               ; preds = %58, %54
  ...
  %62 = load i32, i32* %44, align 4, !tbaa !37
  %63 = load i32*, i32** %29, align 8, !tbaa !32
  %64 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 17
  %65 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %64, align 8, !tbaa !41
  %66 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %65, i64 0, i32 6
  %67 = load i32, i32* %66, align 8, !tbaa !42
  %68 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %65, i64 0, i32 8
  %69 = load i32*, i32** %68, align 8, !tbaa !44
  %70 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %65, i64 0, i32 1
  %71 = load i32, i32* %70, align 4, !tbaa !45
  %72 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %65, i64 0, i32 3
  %73 = load i32*, i32** %72, align 8, !tbaa !46
  %74 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %65, i64 0, i32 4
  ...
  call void @hypre_ParCSRMatrixExtractBExt_Arrays(i32** nonnull %3, i32** nonnull %4, double** nonnull %5, i32** nonnull %6, i32* nonnull %2, i32 1, i32 1, i32 %61, %struct._hypre_ParCSRCommPkg* %65, i32 %94, i32 %67, i32 %71, i32 %62, i32* %98, i32* %69, i32* %73, i32* %75, i32* %78, i32* %80, i32* %85, i32* %87, i32* %63, double* %82, double* %89) #4
...
127:                                              ; preds = %121, %110
  ...
  %132 = call i8* @hypre_CAlloc(i64 %131, i64 8, i32 0) #4
  %133 = bitcast i8* %132 to double*
  %134 = call i8* @hypre_CAlloc(i64 %131, i64 4, i32 0) #4
...
138:                                              ; preds = %127
  ...
  %140 = call i8* @hypre_CAlloc(i64 %139, i64 8, i32 0) #4
  %141 = bitcast i8* %140 to double*
  %142 = call i8* @hypre_CAlloc(i64 %139, i64 4, i32 0) #4
...
560:                                              ; preds = %557
  ...
  %562 = call i8* @hypre_CAlloc(i64 %561, i64 4, i32 0) #4
  %563 = bitcast i8* %562 to i32*
  %564 = sext i32 %136 to i64
  %565 = call i8* @hypre_CAlloc(i64 %564, i64 4, i32 0) #4
...
587:                                              ; preds = %571, %560
  ...
  call void @hypre_Free(i8* %588, i32 0) #4
  br label %589
...
589:                                              ; preds = %587, %557
  ...
  %595 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %592, i64 0, i32 8
...
603:                                              ; preds = %589
  %604 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %592, i64 0, i32 9
  ...
  %610 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %592, i64 0, i32 12
...
611:                                              ; preds = %589
  ...
  call void @hypre_Free(i8* %613, i32 0) #4
  store i32* null, i32** %8, align 8, !tbaa !3
  br label %614
...
619:                                              ; preds = %618
  ...
  call void @hypre_Free(i8* %621, i32 0) #4
...
define dso_local %struct.hypre_CSRMatrix* @hypre_ParCSRMatrixExtractAExt(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, i32 %1, i32** %2) local_unnamed_addr #0 {
  ...
  %51 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 14
  %52 = load i32*, i32** %51, align 8, !tbaa !33
  call void @hypre_ParCSRMatrixExtractBExt_Arrays(i32** nonnull %5, i32** nonnull %6, double** nonnull %7, i32** %2, i32* nonnull %4, i32 %1, i32 1, i32 %9, %struct._hypre_ParCSRCommPkg* %15, i32 %47, i32 %17, i32 %21, i32 %11, i32* %52, i32* %19, i32* %23, i32* %25, i32* %29, i32* %31, i32* %37, i32* %39, i32* %13, double* %33, double* %41) #4
...
!23 = !{!24, !8, i64 0}
!24 = !{!"hypre_ParCSRMatrix_struct", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !4, i64 32, !4, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !4, i64 72, !4, i64 80, !4, i64 88, !4, i64 96, !4, i64 104, !8, i64 112, !8, i64 116, !8, i64 120, !8, i64 124, !25, i64 128, !4, i64 136, !4, i64 144, !8, i64 152, !4, i64 160, !8, i64 168, !4, i64 176, !8, i64 184, !4, i64 192, !4, i64 200}
!25 = !{!"double", !5, i64 0}
!26 = !{!24, !4, i64 32}
!27 = !{!28, !4, i64 64}
...
!41 = !{!24, !4, i64 104}
!42 = !{!43, !8, i64 40}
!43 = !{!"_hypre_ParCSRCommPkg", !8, i64 0, !8, i64 4, !4, i64 8, !4, i64 16, !4, i64 24, !4, i64 32, !8, i64 40, !4, i64 48, !4, i64 56, !4, i64 64, !4, i64 72}
!44 = !{!43, !4, i64 56}
!45 = !{!43, !8, i64 4}
!46 = !{!43, !4, i64 16}
!47 = !{!43, !4, i64 24}

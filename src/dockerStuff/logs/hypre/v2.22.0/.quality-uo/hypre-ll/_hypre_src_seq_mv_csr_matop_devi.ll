...
define dso_local i32 @hypre_CSRMatrixSortRow(%struct.hypre_CSRMatrix* nocapture readnone %0) local_unnamed_addr #0 {
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i32 1475, i32 1, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i64 0, i64 0)) #2

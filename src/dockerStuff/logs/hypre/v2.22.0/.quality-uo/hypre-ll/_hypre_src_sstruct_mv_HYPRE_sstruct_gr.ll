...
define dso_local i32 @HYPRE_SStructGridCreate(i32 %0, i32 %1, i32 %2, %struct.hypre_SStructGrid_struct** nocapture %3) local_unnamed_addr #0 {
  ...
  %9 = call i8* @hypre_MAlloc(i64 176, i32 0) #7
  ...
  %22 = call i8* @hypre_MAlloc(i64 %16, i32 0) #7
  %23 = bitcast i8* %22 to %struct.hypre_SStructNeighbor**
  %24 = call i8* @hypre_MAlloc(i64 %16, i32 0) #7
  %25 = bitcast i8* %24 to [3 x i32]**
  %26 = call i8* @hypre_MAlloc(i64 %19, i32 0) #7
  %27 = bitcast i8* %26 to i32*
  %28 = call i8* @hypre_MAlloc(i64 %16, i32 0) #7
  %29 = bitcast i8* %28 to i32**
  %30 = call i8* @hypre_MAlloc(i64 %16, i32 0) #7
...
76:                                               ; preds = %58, %46
  ...
  call void @hypre_Free(i8* %79, i32 0) #7
  ...
  call void @hypre_Free(i8* %85, i32 0) #7
  ...
  call void @hypre_Free(i8* %88, i32 0) #7
...
116:                                              ; preds = %105, %42
  ...
  call void @hypre_Free(i8* %15, i32 0) #7
  ...
  call void @hypre_Free(i8* nonnull %127, i32 0) #7
  br label %128
...
14:                                               ; preds = %5
  ...
  %18 = shl nsw i64 %17, 3
  %19 = call i8* @hypre_ReAlloc(i8* %15, i64 %18, i32 0) #7
  %20 = bitcast i8* %19 to %struct.hypre_SStructUCVar**
  br label %21

21:                                               ; preds = %14, %5
  %22 = phi %struct.hypre_SStructUCVar** [ %20, %14 ], [ %11, %5 ]
  %23 = call i8* @hypre_MAlloc(i64 32, i32 0) #7
  %24 = sext i32 %3 to i64
  %25 = mul nsw i64 %24, 12
  %26 = call i8* @hypre_MAlloc(i64 %25, i32 0) #7
...
51:                                               ; preds = %48
  ...
  %55 = shl nsw i64 %54, 2
  %56 = call i8* @hypre_MAlloc(i64 %55, i32 0) #7
...
200:                                              ; preds = %188
  ...
  call void @hypre_Free(i8* %201, i32 0) #7
  br label %202
...
27:                                               ; preds = %9
  ...
  %34 = call i8* @hypre_ReAlloc(i8* %30, i64 %33, i32 0) #7
  ...
  %42 = call i8* @hypre_ReAlloc(i8* %37, i64 %41, i32 0) #7
...
29:                                               ; preds = %11
  ...
  %36 = call i8* @hypre_ReAlloc(i8* %32, i64 %35, i32 0) #7
  ...
  %44 = call i8* @hypre_ReAlloc(i8* %39, i64 %43, i32 0) #7
...
37:                                               ; preds = %25
  ...
  call void @hypre_Free(i8* %41, i32 0) #7
  ...
  call void @hypre_Free(i8* %44, i32 0) #7
  store [3 x i32]* null, [3 x i32]** %42, align 8, !tbaa !11
  br label %45
...
136:                                              ; preds = %133, %101
  ...
  %141 = call i8* @hypre_MAlloc(i64 %140, i32 0) #7
  %142 = bitcast i8* %141 to i32**
  %143 = call i8* @hypre_MAlloc(i64 %140, i32 0) #7
...
278:                                              ; preds = %273, %177
  ...
  %284 = call i8* @hypre_MAlloc(i64 %283, i32 0) #7
...
341:                                              ; preds = %335, %278
  ...
  call void @hypre_Free(i8* %189, i32 0) #7

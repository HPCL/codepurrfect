...
define dso_local i32 @hypre_FacSemiInterpCreate2(i8** nocapture %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 88, i32 0) #6
...
110:                                              ; preds = %79, %110
  ...
  call void @hypre_Free(i8* %115, i32 0) #6
...
define dso_local i32 @hypre_FacSemiInterpSetup2(i8* %0, %struct.hypre_SStructVector_struct* nocapture readonly %1, %struct.hypre_SStructPVector* nocapture readonly %2, i32* %3) local_unnamed_addr #0 {
  ...
  %57 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
...
83:                                               ; preds = %63, %4
  ...
  %92 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
...
218:                                              ; preds = %215, %109
  ...
  %222 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
  %223 = bitcast i8* %222 to %struct.hypre_BoxArrayArray_struct**
  %224 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
  %225 = bitcast i8* %224 to i32***
  %226 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
  %227 = bitcast i8* %226 to %struct.hypre_BoxArrayArray_struct**
  %228 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
  %229 = bitcast i8* %228 to i32***
  %230 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
...
255:                                              ; preds = %247, %425
  ...
  %279 = call i8* @hypre_CAlloc(i64 %278, i64 8, i32 0) #6
  ...
  %287 = call i8* @hypre_CAlloc(i64 %286, i64 8, i32 0) #6
...
343:                                              ; preds = %323, %317
  ...
  %347 = call i8* @hypre_CAlloc(i64 %346, i64 4, i32 0) #6
  ...
  %352 = call i8* @hypre_CAlloc(i64 %351, i64 4, i32 0) #6
  ...
  %356 = call i8* @hypre_CAlloc(i64 %351, i64 4, i32 0) #6
...
428:                                              ; preds = %425, %236
  ...
  %439 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
...
552:                                              ; preds = %544, %541
  ...
  %581 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
  %582 = bitcast i8* %581 to %struct.hypre_BoxArrayArray_struct**
  %583 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
  %584 = bitcast i8* %583 to i32***
  %585 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
...
607:                                              ; preds = %600, %732
  ...
  %631 = call i8* @hypre_CAlloc(i64 %630, i64 8, i32 0) #6
  ...
  %636 = call i8* @hypre_CAlloc(i64 %635, i64 8, i32 0) #6
...
667:                                              ; preds = %651, %642
  ...
  %670 = call i8* @hypre_CAlloc(i64 %669, i64 4, i32 0) #6
  ...
  %674 = call i8* @hypre_CAlloc(i64 %669, i64 4, i32 0) #6
...
735:                                              ; preds = %732, %591
  ...
  %738 = call i8* @hypre_CAlloc(i64 %56, i64 8, i32 0) #6
...
784:                                              ; preds = %744, %735
  ...
  call void @hypre_Free(i8* %226, i32 0) #6
  call void @hypre_Free(i8* %583, i32 0) #6
  call void @hypre_Free(i8* %228, i32 0) #6
  call void @hypre_Free(i8* %585, i32 0) #6
  ...
  %789 = call i8* @hypre_MAlloc(i64 %788, i32 0) #6
...
794:                                              ; preds = %792, %794
  ...
  %800 = call i8* @hypre_CAlloc(i64 %799, i64 8, i32 0) #6
...
147:                                              ; preds = %144, %111
  ...
  %164 = call i8* @hypre_MAlloc(i64 %163, i32 0) #6
...
173:                                              ; preds = %147, %173
  ...
  %178 = call i8* @hypre_MAlloc(i64 %177, i32 0) #6
...
378:                                              ; preds = %169, %378
  ...
  %380 = call i8* @hypre_MAlloc(i64 %171, i32 0) #6
...
1828:                                             ; preds = %385, %1828
  ...
  call void @hypre_Free(i8* %1832, i32 0) #6
...
1838:                                             ; preds = %1835, %1838
  ...
  call void @hypre_Free(i8* %1842, i32 0) #6

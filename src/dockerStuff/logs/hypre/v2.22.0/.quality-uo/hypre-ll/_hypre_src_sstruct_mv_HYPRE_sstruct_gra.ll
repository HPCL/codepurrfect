...
105:                                              ; preds = %99, %73
  ...
  call void @hypre_Free(i8* nonnull %109, i32 0) #5
  br label %110
...
428:                                              ; preds = %420
  %429 = call i8* @hypre_MAlloc(i64 40, i32 0) #5
  ...
  %443 = call i8* @hypre_MAlloc(i64 32, i32 0) #5
  br label %454
...
444:                                              ; preds = %420
  ...
  %453 = call i8* @hypre_ReAlloc(i8* %450, i64 %452, i32 0) #5
  br label %454
...
492:                                              ; preds = %454, %402
  ...
  call void @hypre_Free(i8* %494, i32 0) #5
...
499:                                              ; preds = %492, %381
  ...
  call void @hypre_Free(i8* %501, i32 0) #5
...
547:                                              ; preds = %525
  ...
  %551 = call i8* @hypre_MAlloc(i64 %550, i32 0) #5
  %552 = bitcast i8* %551 to i32*
  %553 = call i8* @hypre_MAlloc(i64 %550, i32 0) #5
...
585:                                              ; preds = %576, %525
  ...
  %590 = call i8* @hypre_CAlloc(i64 %589, i64 4, i32 0) #5
  ...
  %596 = call i8* @hypre_CAlloc(i64 %595, i64 4, i32 0) #5
  %597 = bitcast i8* %596 to i32*
  %598 = call i8* @hypre_CAlloc(i64 %595, i64 8, i32 0) #5
  %599 = bitcast i8* %598 to [3 x i32]**
  %600 = call i8* @hypre_CAlloc(i64 %595, i64 8, i32 0) #5
...
741:                                              ; preds = %705, %741
  ...
  call void @hypre_Free(i8* %745, i32 0) #5
  ...
  call void @hypre_Free(i8* %748, i32 0) #5
...
751:                                              ; preds = %741, %703
  ...
  call void @hypre_Free(i8* %600, i32 0) #5

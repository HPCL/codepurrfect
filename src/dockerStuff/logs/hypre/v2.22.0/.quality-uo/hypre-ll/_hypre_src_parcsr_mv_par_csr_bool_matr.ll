...
define dso_local %struct.hypre_CSRBooleanMatrix* @hypre_CSRBooleanMatrixCreate(i32 %0, i32 %1, i32 %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #8
...
17:                                               ; preds = %10, %3
  ...
  call void @hypre_Free(i8* nonnull %18, i32 0) #8
  br label %19
...
7:                                                ; preds = %1
  ...
  %12 = call i8* @hypre_CAlloc(i64 %11, i64 4, i32 0) #8
...
23:                                               ; preds = %13, %1
  ...
  %28 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #8
...
42:                                               ; preds = %23
  ...
  %48 = call i8* @hypre_CAlloc(i64 %47, i64 4, i32 0) #8
...
54:                                               ; preds = %49
  ...
  %56 = call i8* @hypre_CAlloc(i64 %55, i64 4, i32 0) #8
...
define dso_local %struct.hypre_ParCSRBooleanMatrix* @hypre_ParCSRBooleanMatrixCreate(i32 %0, i32 %1, i32 %2, i32* %3, i32* %4, i32 %5, i32 %6, i32 %7) local_unnamed_addr #0 {
  ...
  %15 = call i8* @hypre_CAlloc(i64 1, i64 120, i32 0) #8
...
33:                                               ; preds = %28, %30, %23
  ...
  %51 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #8
  ...
  %62 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #8
...
18:                                               ; preds = %11
  ...
  call void @hypre_Free(i8* %21, i32 0) #8
...
51:                                               ; preds = %47
  ...
  call void @hypre_Free(i8* nonnull %52, i32 0) #8
...
9:                                                ; preds = %1
  ...
  %14 = call i8* @hypre_CAlloc(i64 %13, i64 4, i32 0) #8
...
20:                                               ; preds = %16
  ...
  %22 = call i8* @hypre_CAlloc(i64 %21, i64 4, i32 0) #8
...
43:                                               ; preds = %39
  ...
  %45 = call i8* @hypre_CAlloc(i64 %44, i64 4, i32 0) #8
...
define dso_local %struct.hypre_ParCSRBooleanMatrix* @hypre_ParCSRBooleanMatrixRead(i32 %0, i8* %1) local_unnamed_addr #0 {
  ...
  %24 = call i8* @hypre_CAlloc(i64 %23, i64 4, i32 0) #8
...
99:                                               ; preds = %92
  ...
  %102 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #8
...
112:                                              ; preds = %99, %97
  ...
  %114 = call i8* @hypre_CAlloc(i64 1, i64 120, i32 0) #8
...
122:                                              ; preds = %120, %114
  ...
  %127 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 0) #8
...
139:                                              ; preds = %122
  ...
  %143 = call i8* @hypre_CAlloc(i64 %142, i64 4, i32 0) #8
  %144 = bitcast i8* %143 to i32*
  %145 = load i32, i32* %12, align 4, !tbaa !15
  %146 = add nsw i32 %145, -1
  %147 = sext i32 %146 to i64
  %148 = call i8* @hypre_CAlloc(i64 %147, i64 20, i32 0) #8
...
193:                                              ; preds = %161, %139
  ...
  call void @hypre_Free(i8* %143, i32 0) #8
  call void @hypre_Free(i8* %148, i32 0) #8
...
220:                                              ; preds = %215
  ...
  %222 = call i8* @hypre_CAlloc(i64 %221, i64 4, i32 0) #8
...
267:                                              ; preds = %265
  ...
  call void @hypre_Free(i8* %270, i32 0) #8
...
275:                                              ; preds = %267
  ...
  call void @hypre_Free(i8* %283, i32 0) #8
  store i32* null, i32** %281, align 8, !tbaa !14
  br label %284

284:                                              ; preds = %275, %267
  call void @hypre_Free(i8* nonnull %127, i32 0) #8
  br label %285

285:                                              ; preds = %265, %284
  call void @hypre_Free(i8* %46, i32 0) #8
...
69:                                               ; preds = %61, %65
  ...
  %72 = call i8* @hypre_CAlloc(i64 %71, i64 4, i32 0) #8
...
134:                                              ; preds = %82, %78
  ...
  %141 = call i8* @hypre_CAlloc(i64 %140, i64 4, i32 0) #8
...
166:                                              ; preds = %163
  ...
  %171 = call i8* @hypre_CAlloc(i64 %170, i64 4, i32 0) #8
...
176:                                              ; preds = %173
  ...
  %178 = call i8* @hypre_CAlloc(i64 %177, i64 4, i32 0) #8
...
185:                                              ; preds = %180
  ...
  %190 = call i8* @hypre_CAlloc(i64 %189, i64 4, i32 0) #8
...
195:                                              ; preds = %192
  ...
  %197 = call i8* @hypre_CAlloc(i64 %196, i64 4, i32 0) #8
...
256:                                              ; preds = %252
  ...
  %261 = call i8* @hypre_CAlloc(i64 %260, i64 4, i32 0) #8
...
267:                                              ; preds = %263
  ...
  %269 = call i8* @hypre_CAlloc(i64 %268, i64 4, i32 0) #8
...
285:                                              ; preds = %278, %271
  ...
  %288 = call i8* @hypre_CAlloc(i64 %287, i64 4, i32 0) #8

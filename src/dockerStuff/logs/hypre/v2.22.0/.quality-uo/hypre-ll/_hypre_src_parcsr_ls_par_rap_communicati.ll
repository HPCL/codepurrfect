...
89:                                               ; preds = %51, %81, %46
  ...
  %99 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15
  %100 = load i32*, i32** %99, align 8, !tbaa !28
  %101 = load i32, i32* %100, align 4, !tbaa !23
  %102 = bitcast i8* %92 to i32*
  %103 = bitcast i8* %97 to i32*
  %104 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %10, i64 0, i32 4
...
142:                                              ; preds = %111, %89
  %143 = call %struct.hypre_ParCSRCommHandle* @hypre_ParCSRCommHandleCreate(i32 21, %struct._hypre_ParCSRCommPkg* %10, i8* %97, i8* %92) #5
...
191:                                              ; preds = %187, %158
  ...
  %196 = call i8* @hypre_CAlloc(i64 %193, i64 20, i32 0) #5
  %197 = bitcast i8* %196 to %struct.MPI_Status*
  %198 = call i8* @hypre_CAlloc(i64 %93, i64 4, i32 0) #5
...
247:                                              ; preds = %237, %232
  ...
  %250 = call i8* @hypre_CAlloc(i64 %249, i64 4, i32 0) #5
  %251 = bitcast i8* %250 to i32*
  %252 = add nuw nsw i32 %248, 1
  %253 = zext i32 %252 to i64
  %254 = call i8* @hypre_CAlloc(i64 %253, i64 4, i32 0) #5
...
281:                                              ; preds = %277, %247
  ...
  %285 = call i8* @hypre_CAlloc(i64 %284, i64 4, i32 0) #5
  %286 = bitcast i8* %285 to i32*
  %287 = load i32, i32* %282, align 4, !tbaa !23
  %288 = sext i32 %287 to i64
  %289 = call i8* @hypre_CAlloc(i64 %288, i64 4, i32 0) #5
...
353:                                              ; preds = %343, %338
  %354 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #5
  ...
  %358 = getelementptr inbounds i8, i8* %354, i64 40
  ...
  %362 = getelementptr inbounds i8, i8* %354, i64 48
  %363 = bitcast i8* %362 to i8**
  store i8* %160, i8** %363, align 8, !tbaa !13
  %364 = getelementptr inbounds i8, i8* %354, i64 56
  ...
  call void @hypre_Free(i8* %196, i32 0) #5
  call void @hypre_Free(i8* %194, i32 0) #5
  call void @hypre_Free(i8* %289, i32 0) #5
  %370 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 16
  %371 = bitcast %struct._hypre_ParCSRCommPkg** %370 to i8**
  store i8* %354, i8** %371, align 8, !tbaa !10
  call void @hypre_Free(i8* %198, i32 0) #5

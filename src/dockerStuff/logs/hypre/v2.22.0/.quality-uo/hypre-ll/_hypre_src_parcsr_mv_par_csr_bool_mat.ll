...
82:                                               ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i64 0, i64 0), i32 98, i32 1, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i64 0, i64 0)) #4
  br label %662
...
93:                                               ; preds = %89
  ...
  %114 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #4
...
182:                                              ; preds = %138, %83
  ...
  %188 = call i8* @hypre_CAlloc(i64 %187, i64 4, i32 0) #4
  %189 = bitcast i8* %188 to i32*
  %190 = call i8* @hypre_CAlloc(i64 %187, i64 4, i32 0) #4
...
235:                                              ; preds = %231
  ...
  %237 = call i8* @hypre_CAlloc(i64 %236, i64 4, i32 0) #4
...
242:                                              ; preds = %239
  ...
  %244 = call i8* @hypre_CAlloc(i64 %243, i64 4, i32 0) #4
  %245 = bitcast i8* %244 to i32*
  %246 = call i8* @hypre_CAlloc(i64 %243, i64 4, i32 0) #4
...
304:                                              ; preds = %301
  ...
  %307 = call i8* @hypre_CAlloc(i64 %306, i64 4, i32 0) #4
...
364:                                              ; preds = %361
  ...
  %366 = call i8* @hypre_CAlloc(i64 %365, i64 4, i32 0) #4
...
396:                                              ; preds = %395
  ...
  call void @hypre_Free(i8* %397, i32 0) #4
  br label %398
...
399:                                              ; preds = %398
  ...
  %401 = call i8* @hypre_CAlloc(i64 %400, i64 4, i32 0) #4
...
424:                                              ; preds = %415, %420, %399, %398
  ...
  call void @hypre_ParMatmul_RowSizes(i32 1, i32** nonnull %15, i32** nonnull %16, i32* null, i32* %25, i32* %27, i32* %31, i32* %33, i32* %45, i32* %47, i32* %53, i32* %55, i32* %189, i32* %240, i32* %191, i32* %249, i32* %425, i32* nonnull %17, i32* nonnull %18, i32 %37, i32 %37, i32 %41, i32 %85, i32 %63, i32 %65, i32 %362) #4
  %426 = load i32, i32* %17, align 4, !tbaa !23
  %427 = sext i32 %426 to i64
  %428 = call i8* @hypre_CAlloc(i64 %427, i64 4, i32 0) #4
...
432:                                              ; preds = %424
  ...
  %434 = call i8* @hypre_CAlloc(i64 %433, i64 4, i32 0) #4
...
436:                                              ; preds = %432, %424
  ...
  %440 = call i8* @hypre_CAlloc(i64 %439, i64 4, i32 0) #4
...
657:                                              ; preds = %656
  ...
  call void @hypre_Free(i8* %658, i32 0) #4
  br label %659
...
660:                                              ; preds = %659
  ...
  call void @hypre_Free(i8* %661, i32 0) #4
  br label %662
...
define dso_local i32 @hypre_BooleanMatvecCommPkgCreate(%struct.hypre_ParCSRBooleanMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %32 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #4
...
declare dso_local void @hypre_ParMatmul_RowSizes(i32, i32**, i32**, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32, i32, i32, i32, i32, i32, i32) local_unnamed_addr #2
...
54:                                               ; preds = %1
  call void @hypre_error_handler(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i64 0, i64 0), i32 643, i32 1, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i64 0, i64 0)) #4
  br label %595
...
61:                                               ; preds = %57
  ...
  %75 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #4
...
144:                                              ; preds = %100, %55
  ...
  %151 = call i8* @hypre_CAlloc(i64 %150, i64 4, i32 0) #4
...
160:                                              ; preds = %154, %144
  ...
  %165 = call i8* @hypre_CAlloc(i64 %164, i64 4, i32 0) #4
...
532:                                              ; preds = %529
  ...
  %534 = call i8* @hypre_CAlloc(i64 %533, i64 4, i32 0) #4
  %535 = bitcast i8* %534 to i32*
  %536 = load i32, i32* %17, align 4, !tbaa !23
  %537 = sext i32 %536 to i64
  %538 = call i8* @hypre_CAlloc(i64 %537, i64 4, i32 0) #4
...
561:                                              ; preds = %543, %532
  ...
  call void @hypre_Free(i8* %562, i32 0) #4
  br label %563
...
592:                                              ; preds = %591
  ...
  call void @hypre_Free(i8* %594, i32 0) #4
...
define dso_local i32 @hypre_BooleanMatTCommPkgCreate(%struct.hypre_ParCSRBooleanMatrix* nocapture %0) local_unnamed_addr #0 {
  ...
  %44 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #4
  %45 = bitcast i8* %44 to i32*

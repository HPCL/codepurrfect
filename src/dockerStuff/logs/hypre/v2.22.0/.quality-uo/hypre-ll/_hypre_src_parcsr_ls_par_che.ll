...
186:                                              ; preds = %183
  ...
  %188 = call i8* @hypre_CAlloc(i64 %187, i64 8, i32 0) #3
...
97:                                               ; preds = %10
  ...
  %102 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 14

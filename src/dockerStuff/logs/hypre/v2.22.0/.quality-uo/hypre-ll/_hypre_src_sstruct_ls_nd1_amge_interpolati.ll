...
92:                                               ; preds = %66
  %93 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %5, i64 0, i32 4
...
101:                                              ; preds = %92, %512
  %102 = phi i32 [ %516, %512 ], [ 0, %92 ]
  %103 = phi i32 [ %517, %512 ], [ %94, %92 ]
  %104 = phi i8* [ %513, %512 ], [ undef, %92 ]
  ...
  %105 = call i32 @hypre_ParCSRMatrixGetRow(%struct.hypre_ParCSRMatrix_struct* %5, i32 %103, i32* nonnull %15, i32** nonnull %14, double** nonnull %18) #3
  %106 = load i32, i32* %15, align 4, !tbaa !18
  %107 = sext i32 %106 to i64
  %108 = shl nsw i64 %107, 2
  %109 = call i8* @hypre_MAlloc(i64 %108, i32 0) #3
  %110 = bitcast i8* %109 to i32*
  %111 = load i32*, i32** %14, align 8
  %112 = load i32, i32* %15, align 4, !tbaa !18
...
114:                                              ; preds = %101, %114
  ...
  %120 = load i32, i32* %15, align 4, !tbaa !18
  %121 = sext i32 %120 to i64
  %122 = icmp slt i64 %119, %121
  br i1 %122, label %114, label %123, !llvm.loop !23

123:                                              ; preds = %114, %101
  %124 = call i32 @hypre_ParCSRMatrixRestoreRow(%struct.hypre_ParCSRMatrix_struct* %5, i32 %103, i32* nonnull %15, i32** nonnull %14, double** nonnull %18) #3
  %125 = load i32, i32* %15, align 4, !tbaa !18
  %126 = add nsw i32 %125, -1
  call void @hypre_BigQsort0(i32* %110, i32 0, i32 %126) #3
  ...
  %131 = call i8* @hypre_MAlloc(i64 %130, i32 0) #3
...
145:                                              ; preds = %136, %123
  ...
  call void @hypre_BigQsort0(i32* %132, i32 0, i32 %148) #3
...
149:                                              ; preds = %145
  ...
  %154 = call i8* @hypre_MAlloc(i64 %153, i32 0) #3
...
171:                                              ; preds = %170, %168
  ...
  %177 = call i8* @hypre_MAlloc(i64 %176, i32 0) #3
...
191:                                              ; preds = %182, %171
  ...
  %197 = call i8* @hypre_CAlloc(i64 %196, i64 4, i32 0) #3
...
199:                                              ; preds = %191
  ...
  call void @hypre_Memcpy(i8* %197, i8* %172, i64 %202, i32 0, i32 0) #3
  br label %203
...
203:                                              ; preds = %199, %191
  ...
  call void @hypre_Memcpy(i8* %207, i8* %177, i64 %210, i32 0, i32 0) #3
  %211 = add nsw i32 %195, -1
  call void @hypre_BigQsort0(i32* %198, i32 0, i32 %211) #3
  ...
  %216 = call i32 @hypre_CSRMatrixBigInitialize(%struct.hypre_CSRMatrix* %215) #3
  ...
  %219 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %215, i64 0, i32 2
  %220 = load i32*, i32** %219, align 8, !tbaa !28
  %221 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %215, i64 0, i32 9
...
238:                                              ; preds = %235, %225
  ...
  call void @hypre_Memcpy(i8* %239, i8* %240, i64 %243, i32 0, i32 0) #3
  ...
  call void @hypre_Memcpy(i8* %244, i8* %245, i64 %248, i32 0, i32 0) #3
...
262:                                              ; preds = %238, %203
  ...
  %265 = load i32, i32* %15, align 4, !tbaa !18
  %266 = mul nsw i32 %265, %264
  %267 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixCreate(i32 %264, i32 %265, i32 %266) #3
  %268 = call i32 @hypre_CSRMatrixBigInitialize(%struct.hypre_CSRMatrix* %267) #3
  ...
  %271 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %267, i64 0, i32 2
  %272 = load i32*, i32** %271, align 8, !tbaa !28
  %273 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %267, i64 0, i32 9
...
298:                                              ; preds = %288
  ...
  call void @hypre_Memcpy(i8* %299, i8* %300, i64 %303, i32 0, i32 0) #3
  ...
  call void @hypre_Memcpy(i8* %304, i8* %305, i64 %308, i32 0, i32 0) #3
...
329:                                              ; preds = %327, %324, %314
  ...
  call void @hypre_Memcpy(i8* %347, i8* %348, i64 %350, i32 0, i32 0) #3
  ...
  call void @hypre_Memcpy(i8* %351, i8* %352, i64 %355, i32 0, i32 0) #3
...
384:                                              ; preds = %370
  ...
  call void @hypre_Memcpy(i8* %385, i8* %386, i64 %389, i32 0, i32 0) #3
  ...
  call void @hypre_Memcpy(i8* %390, i8* %391, i64 %394, i32 0, i32 0) #3
...
438:                                              ; preds = %435, %432
  ...
  call void @hypre_Memcpy(i8* %456, i8* %457, i64 %459, i32 0, i32 0) #3
  ...
  call void @hypre_Memcpy(i8* %460, i8* %461, i64 %464, i32 0, i32 0) #3
...
480:                                              ; preds = %467, %279
  ...
  %482 = load i32, i32* %15, align 4, !tbaa !18
  ...
  %486 = call i8* @hypre_CAlloc(i64 %485, i64 4, i32 0) #3
  %487 = bitcast i8* %486 to i32*
  %488 = load i32, i32* %16, align 4, !tbaa !18
  %489 = sext i32 %488 to i64
  %490 = call i8* @hypre_CAlloc(i64 %489, i64 4, i32 0) #3
  %491 = bitcast i8* %490 to i32*
  %492 = load i32, i32* %16, align 4, !tbaa !18
  %493 = icmp sgt i32 %492, 0
  br i1 %493, label %494, label %506

494:                                              ; preds = %480, %494
  %495 = phi i64 [ %502, %494 ], [ 0, %480 ]
  %496 = load i32, i32* %15, align 4, !tbaa !18
  %497 = getelementptr inbounds i32, i32* %487, i64 %495
  store i32 %496, i32* %497, align 4, !tbaa !18
  %498 = load i32, i32* %15, align 4, !tbaa !18
  %499 = trunc i64 %495 to i32
  %500 = mul nsw i32 %498, %499
  %501 = getelementptr inbounds i32, i32* %491, i64 %495
  store i32 %500, i32* %501, align 4, !tbaa !18
  %502 = add nuw nsw i64 %495, 1
  %503 = load i32, i32* %16, align 4, !tbaa !18
  %504 = sext i32 %503 to i64
  %505 = icmp slt i64 %502, %504
  br i1 %505, label %494, label %506, !llvm.loop !38

506:                                              ; preds = %494, %480
  %507 = phi i32 [ %492, %480 ], [ %503, %494 ]
  %508 = load i32*, i32** %271, align 8, !tbaa !28
  %509 = load double*, double** %273, align 8, !tbaa !29
  %510 = call i32 @hypre_IJMatrixAddToValuesParCSR(%struct.hypre_IJMatrix_struct* %8, i32 %507, i32* %487, i32* %132, i32* %491, i32* %508, double* %509) #3
  call void @hypre_Free(i8* %486, i32 0) #3
  call void @hypre_Free(i8* %490, i32 0) #3
  call void @hypre_Free(i8* %109, i32 0) #3
  call void @hypre_Free(i8* %131, i32 0) #3
  br i1 %63, label %512, label %511

511:                                              ; preds = %506
  call void @hypre_Free(i8* %172, i32 0) #3
  br label %512

512:                                              ; preds = %511, %506
  %513 = phi i8* [ null, %511 ], [ %172, %506 ]
  call void @hypre_Free(i8* %177, i32 0) #3
  call void @hypre_Free(i8* %197, i32 0) #3
  %514 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %215) #3
  %515 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %267) #3
  ...
  %516 = add nuw nsw i32 %102, 1
  %517 = add nsw i32 %103, 1
  %518 = icmp eq i32 %516, %29
  br i1 %518, label %519, label %101, !llvm.loop !39

519:                                              ; preds = %512, %66
  br i1 %63, label %522, label %520

520:                                              ; preds = %519
  %521 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %67) #3
  br label %522

522:                                              ; preds = %520, %519
  %523 = call i32 @hypre_ParCSRMatrixDestroy(%struct.hypre_ParCSRMatrix_struct* %68) #3
  br i1 %34, label %527, label %524

524:                                              ; preds = %522
  %525 = bitcast i32* %58 to i8*
  call void @hypre_Free(i8* %525, i32 0) #3
  %526 = bitcast i32* %57 to i8*
  call void @hypre_Free(i8* %526, i32 0) #3
  br label %527
...
!9 = !{!10, !8, i64 32}
!10 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !5, i64 112, !5, i64 116, !5, i64 120, !5, i64 124, !11, i64 128, !8, i64 136, !8, i64 144, !5, i64 152, !8, i64 160, !5, i64 168, !8, i64 176, !5, i64 184, !8, i64 192, !8, i64 200}
!11 = !{!"double", !6, i64 0}
!12 = !{!13, !5, i64 24}

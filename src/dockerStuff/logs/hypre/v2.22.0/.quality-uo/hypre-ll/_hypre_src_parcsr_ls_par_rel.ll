...
define dso_local i32 @hypre_BoomerAMGRelax(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* nocapture readonly %2, i32 %3, i32 %4, double %5, double %6, double* %7, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* nocapture readnone %10) local_unnamed_addr #0 {
...
30:                                               ; preds = %11
  ...
  %48 = call i32 @hypre_ParVectorElmdivpy(%struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* nonnull %15, %struct.hypre_ParVector_struct* %8) #3
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %36) #3
  call void @llvm.lifetime.end.p0i8(i64 40, i8* nonnull %35) #3
  br label %102

49:                                               ; preds = %11
  %50 = fcmp une double %5, 1.000000e+00
  %51 = fcmp une double %6, 1.000000e+00
  %52 = select i1 %50, i1 true, i1 %51
  %53 = zext i1 %52 to i32
  %54 = call i32 @hypre_BoomerAMGRelaxHybridGaussSeidel_core(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* %2, i32 %4, double %5, double %6, double* %7, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* undef, i32 1, i32 1, i32 %53, i32 0, i32 0) #3
  br label %102

55:                                               ; preds = %11
  %56 = call i32 @hypre_BoomerAMGRelaxHybridGaussSeidel_core(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* %2, i32 %4, double %5, double %6, double* null, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* undef, i32 1, i32 0, i32 1, i32 1, i32 1) #3
  br label %102

57:                                               ; preds = %11
  %58 = call i32 @hypre_BoomerAMGRelaxTwoStageGaussSeidelHost(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, double %5, double undef, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, i32 1) #3
  br label %102

59:                                               ; preds = %11
  %60 = call i32 @hypre_BoomerAMGRelaxTwoStageGaussSeidelHost(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, double %5, double undef, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, i32 2) #3
  br label %102

61:                                               ; preds = %11
  %62 = fcmp une double %5, 1.000000e+00
  %63 = fcmp une double %6, 1.000000e+00
  %64 = select i1 %62, i1 true, i1 %63
  %65 = zext i1 %64 to i32
  %66 = call i32 @hypre_BoomerAMGRelaxHybridGaussSeidel_core(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* %2, i32 %4, double %5, double %6, double* %7, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* undef, i32 1, i32 0, i32 %65, i32 0, i32 0) #3
  br label %102

67:                                               ; preds = %11
  %68 = fcmp une double %5, 1.000000e+00
  %69 = fcmp une double %6, 1.000000e+00
  %70 = select i1 %68, i1 true, i1 %69
  %71 = zext i1 %70 to i32
  %72 = call i32 @hypre_BoomerAMGRelaxHybridGaussSeidel_core(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* %2, i32 %4, double %5, double %6, double* %7, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* undef, i32 -1, i32 0, i32 %71, i32 0, i32 0) #3
  br label %102
...
75:                                               ; preds = %73
  %76 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 8
  %77 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %76, align 8, !tbaa !3
  %78 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %77, i64 0, i32 3
  %79 = load i32, i32* %78, align 8, !tbaa !10
  %80 = bitcast %struct.hypre_Vector* %12 to i8*
  call void @llvm.lifetime.start.p0i8(i64 40, i8* nonnull %80) #3
  %81 = bitcast %struct.hypre_ParVector_struct* %13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 56, i8* nonnull %81) #3
  %82 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %12, i64 0, i32 0
  store double* %7, double** %82, align 8, !tbaa !12
  %83 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %12, i64 0, i32 1
  store i32 %79, i32* %83, align 8, !tbaa !14
  %84 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %1, i64 0, i32 6
  %85 = load %struct.hypre_Vector*, %struct.hypre_Vector** %84, align 8, !tbaa !15
  %86 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %85, i64 0, i32 3
  %87 = load i32, i32* %86, align 8, !tbaa !17
  %88 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %12, i64 0, i32 3
  store i32 %87, i32* %88, align 8, !tbaa !17
  %89 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %13, i64 0, i32 6
  store %struct.hypre_Vector* %12, %struct.hypre_Vector** %89, align 8, !tbaa !15
  %90 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %1, %struct.hypre_ParVector_struct* %9) #3
  %91 = fneg double %5
  %92 = call i32 @hypre_ParCSRMatrixMatvec(double %91, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %8, double %5, %struct.hypre_ParVector_struct* %9) #3
  %93 = call i32 @hypre_ParVectorElmdivpy(%struct.hypre_ParVector_struct* %9, %struct.hypre_ParVector_struct* nonnull %13, %struct.hypre_ParVector_struct* %8) #3
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %81) #3
  call void @llvm.lifetime.end.p0i8(i64 40, i8* nonnull %80) #3
  br label %102

94:                                               ; preds = %73
  %95 = call i32 @hypre_BoomerAMGRelaxWeightedJacobi_core(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32* %2, i32 %4, double %5, double* %7, %struct.hypre_ParVector_struct* %8, %struct.hypre_ParVector_struct* %9, i32 0) #3
  br label %102

96:                                               ; preds = %11
  %97 = call i32 @hypre_BoomerAMGRelax19GaussElim(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, %struct.hypre_ParVector_struct* %8)
  br label %102

98:                                               ; preds = %11
  %99 = call i32 @hypre_BoomerAMGRelaxKaczmarz(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, double %6, double* %7, %struct.hypre_ParVector_struct* %8)
  br label %102

100:                                              ; preds = %11
  %101 = call i32 @hypre_BoomerAMGRelax98GaussElimPivot(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, %struct.hypre_ParVector_struct* %8)
  br label %102

102:                                              ; preds = %94, %75, %11, %100, %98, %96, %67, %61, %59, %57, %55, %49, %30, %28, %26, %24, %22, %20, %18, %16
  %103 = phi i32 [ 0, %11 ], [ 0, %100 ], [ 0, %98 ], [ %97, %96 ], [ 0, %67 ], [ 0, %61 ], [ 0, %59 ], [ 0, %57 ], [ 0, %55 ], [ 0, %49 ], [ 0, %30 ], [ 0, %28 ], [ 0, %26 ], [ 0, %24 ], [ 0, %22 ], [ 0, %20 ], [ 0, %18 ], [ 0, %16 ], [ 0, %75 ], [ 0, %94 ]
  ret i32 %103
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_BoomerAMGRelax7Jacobi(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %1, i32 %2, double %3, double* %4, %struct.hypre_ParVector_struct* %5, %struct.hypre_ParVector_struct* %6) local_unnamed_addr #0 {
  ...
  %14 = bitcast %struct.hypre_Vector* %8 to i8*
  ...
  %16 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %8, i64 0, i32 0
  store double* %4, double** %16, align 8, !tbaa !12
  %17 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %8, i64 0, i32 1
  store i32 %13, i32* %17, align 8, !tbaa !14
  %18 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %1, i64 0, i32 6
  %19 = load %struct.hypre_Vector*, %struct.hypre_Vector** %18, align 8, !tbaa !15
  %20 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %19, i64 0, i32 3
  %21 = load i32, i32* %20, align 8, !tbaa !17
  %22 = getelementptr inbounds %struct.hypre_Vector, %struct.hypre_Vector* %8, i64 0, i32 3
  store i32 %21, i32* %22, align 8, !tbaa !17
  %23 = getelementptr inbounds %struct.hypre_ParVector_struct, %struct.hypre_ParVector_struct* %9, i64 0, i32 6
  store %struct.hypre_Vector* %8, %struct.hypre_Vector** %23, align 8, !tbaa !15
  %24 = call i32 @hypre_ParVectorCopy(%struct.hypre_ParVector_struct* %1, %struct.hypre_ParVector_struct* %6) #3
  %25 = fneg double %3
  %26 = call i32 @hypre_ParCSRMatrixMatvec(double %25, %struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParVector_struct* %5, double %3, %struct.hypre_ParVector_struct* %6) #3
  %27 = call i32 @hypre_ParVectorElmdivpy(%struct.hypre_ParVector_struct* %6, %struct.hypre_ParVector_struct* nonnull %9, %struct.hypre_ParVector_struct* %5) #3
  %28 = load i32, i32* @hypre__global_error, align 4, !tbaa !25
...
127:                                              ; preds = %123
  %128 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 28
...
37:                                               ; preds = %29
  call void @hypre_error_handler(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0), i32 1581, i32 12, i8* null) #3
  br label %38
...
!14 = !{!13, !5, i64 8}
!15 = !{!16, !8, i64 32}
!16 = !{!"hypre_ParVector_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !8, i64 16, !5, i64 24, !8, i64 32, !5, i64 40, !5, i64 44, !8, i64 48}
!17 = !{!13, !6, i64 16}
!18 = !{!4, !5, i64 0}
!19 = !{!11, !8, i64 64}
!20 = !{!11, !8, i64 0}

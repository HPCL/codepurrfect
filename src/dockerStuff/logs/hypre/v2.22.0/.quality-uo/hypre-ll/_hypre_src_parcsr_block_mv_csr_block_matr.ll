...
define dso_local %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixCreate(i32 %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  %5 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 0) #9
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %6, i32 0) #9
...
11:                                               ; preds = %1
  call void @hypre_Free(i8* null, i32 0) #9
...
27:                                               ; preds = %26, %22
  ...
  %32 = call i8* @hypre_CAlloc(i64 %31, i64 4, i32 0) #9
...
35:                                               ; preds = %27
  ...
  %37 = call i8* @hypre_CAlloc(i64 %36, i64 8, i32 0) #9
...
define dso_local %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixConvertFromCSRMatrix(%struct.hypre_CSRMatrix* nocapture readonly %0, i32 %1) local_unnamed_addr #0 {
  ...
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 4, i32 0) #9
...
74:                                               ; preds = %70, %22
  ...
  %76 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 0) #9
...
29:                                               ; preds = %4
  ...
  %31 = call i8* @hypre_CAlloc(i64 %30, i64 8, i32 0) #9
...
72:                                               ; preds = %4
  ...
  %74 = call i8* @hypre_CAlloc(i64 %73, i64 8, i32 0) #9
...
define dso_local i32 @hypre_CSRBlockMatrixBlockMultAddDiag3(double* nocapture readonly %0, double* nocapture readonly %1, double %2, double* nocapture %3, i32 %4) local_unnamed_addr #0 {
  %6 = sext i32 %4 to i64
  %7 = call i8* @hypre_CAlloc(i64 %6, i64 8, i32 0) #9
...
112:                                              ; preds = %109, %89, %56, %63, %68, %35
  call void @hypre_Free(i8* %7, i32 0) #9
  ret i32 0
}
...
213:                                              ; preds = %209
  call void @hypre_Free(i8* %210, i32 0) #9
  br label %214
...
13:                                               ; preds = %4
  %14 = mul nsw i32 %3, %3
  %15 = zext i32 %14 to i64
  %16 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 0) #9
  %17 = bitcast i8* %16 to double*
  %18 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 0) #9
  %19 = bitcast i8* %18 to double*
  %20 = call i8* @hypre_CAlloc(i64 %15, i64 8, i32 0) #9
...
59:                                               ; preds = %56, %23
  ...
  %62 = call i8* @hypre_CAlloc(i64 1, i64 56, i32 0) #9
  ...
  %79 = call i8* @hypre_CAlloc(i64 %78, i64 4, i32 0) #9
...
88:                                               ; preds = %59
  ...
  %91 = call i8* @hypre_CAlloc(i64 %90, i64 8, i32 0) #9
...
!16 = !{!4, !5, i64 24}
!17 = !{!18, !5, i64 0}
!18 = !{!"", !5, i64 0, !5, i64 8, !5, i64 16, !8, i64 24, !8, i64 28, !8, i64 32, !5, i64 40, !5, i64 48, !8, i64 56, !5, i64 64, !5, i64 72, !8, i64 80, !6, i64 84}
!19 = !{!18, !5, i64 8}
!20 = !{!18, !5, i64 64}
!21 = !{!8, !8, i64 0}

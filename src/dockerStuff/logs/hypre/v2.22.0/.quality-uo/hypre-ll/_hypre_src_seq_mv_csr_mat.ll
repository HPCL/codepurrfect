...
31:                                               ; preds = %3
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i32 1629, i32 1, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0)) #10
  br label %277
...
25:                                               ; preds = %28
  ...
  br i1 %27, label %43, label %28, !llvm.loop !85
...
43:                                               ; preds = %25, %15, %35, %36, %39
  ...
  br i1 %46, label %47, label %15, !llvm.loop !86
...
20:                                               ; preds = %17, %20
  ...
  br i1 %24, label %25, label %20, !llvm.loop !87

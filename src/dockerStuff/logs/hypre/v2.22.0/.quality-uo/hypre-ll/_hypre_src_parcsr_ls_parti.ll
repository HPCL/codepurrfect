...
101:                                              ; preds = %97
  ...
  br i1 %103, label %104, label %1208
...
1140:                                             ; preds = %1134, %1131
  ...
  %1156 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1145, i64 0, i32 19
  store i32 0, i32* %1156, align 4, !tbaa !51
  %1157 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1147, i64 0, i32 12
  store i32 0, i32* %1157, align 4, !tbaa !52
  %1158 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1152, i64 0, i32 12
...
1162:                                             ; preds = %1140
  %1163 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1152, i64 0, i32 0
  %1164 = call i32 @hypre_BoomerAMGInterpTruncation(%struct.hypre_ParCSRMatrix_struct* %1145, double %8, i32 %9) #5
  %1165 = load i32*, i32** %1163, align 8, !tbaa !14
  %1166 = getelementptr inbounds i32, i32* %1165, i64 %473
  %1167 = load i32, i32* %1166, align 4, !tbaa !20
  br label %1168

1168:                                             ; preds = %1140, %1162
  %1169 = phi i32 [ %1167, %1162 ], [ %451, %1140 ]
  %1170 = icmp eq i32 %1169, 0
  br i1 %1170, label %1173, label %1171

1171:                                             ; preds = %1168
  %1172 = load i32, i32* %18, align 4, !tbaa !20
  call void @hypre_build_interp_colmap(%struct.hypre_ParCSRMatrix_struct* %1145, i32 %1172, i32* %152, i32* %151) #5
  br label %1173

1173:                                             ; preds = %1171, %1168
  %1174 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %1145) #5
  %1175 = icmp sgt i32 %45, 0
  br i1 %1175, label %1176, label %1187

1176:                                             ; preds = %1173
  %1177 = zext i32 %45 to i64
  br label %1178
...
1184:                                             ; preds = %1178, %1183
  ...
  br i1 %1186, label %1187, label %1178, !llvm.loop !53

1187:                                             ; preds = %1184, %1173
  store %struct.hypre_ParCSRMatrix_struct* %1145, %struct.hypre_ParCSRMatrix_struct** %10, align 8, !tbaa !19
  %1188 = bitcast i32* %138 to i8*
  call void @hypre_Free(i8* %1188, i32 0) #5
  %1189 = bitcast i32* %139 to i8*
  call void @hypre_Free(i8* %1189, i32 0) #5
  call void @hypre_Free(i8* %188, i32 0) #5
  call void @hypre_Free(i8* %190, i32 0) #5
  %1190 = load i32, i32* %13, align 4, !tbaa !20
  %1191 = icmp sgt i32 %1190, 1
  br i1 %1191, label %1192, label %1208

1192:                                             ; preds = %1187
  %1193 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %19, align 8, !tbaa !19
  %1194 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %1193) #5
  %1195 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %17, align 8, !tbaa !19
  %1196 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %1195) #5
  %1197 = bitcast i32* %151 to i8*
  call void @hypre_Free(i8* %1197, i32 0) #5
  %1198 = bitcast i32** %15 to i8**
  %1199 = load i8*, i8** %1198, align 8, !tbaa !19
  call void @hypre_Free(i8* %1199, i32 0) #5
  store i32* null, i32** %15, align 8, !tbaa !19
  %1200 = bitcast i32* %152 to i8*
  call void @hypre_Free(i8* %1200, i32 0) #5
  %1201 = icmp sgt i32 %5, 1
  br i1 %1201, label %1202, label %1205

1202:                                             ; preds = %1192
  %1203 = bitcast i32** %16 to i8**
  %1204 = load i8*, i8** %1203, align 8, !tbaa !19
  call void @hypre_Free(i8* %1204, i32 0) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  br label %1205

1205:                                             ; preds = %1202, %1192
  %1206 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %21, align 8, !tbaa !19
  %1207 = call i32 @hypre_MatvecCommPkgDestroy(%struct._hypre_ParCSRCommPkg* %1206) #5
  br label %1208

1208:                                             ; preds = %1187, %1205, %101
  %1209 = load i32, i32* @hypre__global_error, align 4, !tbaa !20
...
102:                                              ; preds = %98
  ...
  br i1 %104, label %105, label %1579
...
186:                                              ; preds = %180, %171
  ...
  br i1 %190, label %166, label %171, !llvm.loop !54
...
267:                                              ; preds = %251, %265, %260
  ...
  br i1 %272, label %251, label %273, !llvm.loop !55
...
303:                                              ; preds = %286, %300, %295
  ...
  br i1 %308, label %286, label %309, !llvm.loop !56
...
309:                                              ; preds = %303, %277, %237, %232, %273, %239
  ...
  br i1 %315, label %222, label %316, !llvm.loop !57
...
398:                                              ; preds = %377, %382, %371, %390, %395, %384
  ...
  br i1 %404, label %362, label %405, !llvm.loop !58
...
405:                                              ; preds = %398, %352, %347, %342, %350
  ...
  br i1 %411, label %332, label %412, !llvm.loop !59
...
412:                                              ; preds = %405, %321, %207, %316, %209
  ...
  br i1 %416, label %417, label %191, !llvm.loop !60
...
494:                                              ; preds = %489, %494
  ...
  br i1 %500, label %491, label %494, !llvm.loop !61
...
509:                                              ; preds = %491, %509
  ...
  br i1 %517, label %509, label %501, !llvm.loop !62
...
609:                                              ; preds = %591, %604, %600
  ...
  br i1 %614, label %591, label %615, !llvm.loop !63
...
646:                                              ; preds = %628, %641, %637
  ...
  br i1 %651, label %628, label %652, !llvm.loop !64
...
652:                                              ; preds = %646, %619, %573, %569, %615, %578
  ...
  br i1 %658, label %559, label %659, !llvm.loop !65
...
744:                                              ; preds = %720, %724, %714, %735, %739, %729
  ...
  br i1 %750, label %705, label %751, !llvm.loop !66
...
751:                                              ; preds = %744, %694, %687, %683, %692
  ...
  br i1 %757, label %673, label %758, !llvm.loop !67
...
873:                                              ; preds = %859, %869, %865
  ...
  br i1 %886, label %849, label %887, !llvm.loop !68
...
942:                                              ; preds = %932, %911
  ...
  br i1 %948, label %902, label %958, !llvm.loop !69
...
958:                                              ; preds = %942, %949, %892, %817, %887, %826
  ...
  br i1 %966, label %793, label %967, !llvm.loop !70
...
1118:                                             ; preds = %1107, %1079
  ...
  br i1 %1126, label %1043, label %1136, !llvm.loop !71
...
1136:                                             ; preds = %1118, %1127, %1023, %1009, %1018
  ...
  br i1 %1144, label %985, label %1145, !llvm.loop !72
...
1172:                                             ; preds = %1170, %1172
  ...
  br i1 %1184, label %1185, label %1172, !llvm.loop !73
...
1194:                                             ; preds = %1192, %1194
  ...
  br i1 %1206, label %1207, label %1194, !llvm.loop !74
...
1215:                                             ; preds = %1212, %1215
  ...
  br i1 %1228, label %1229, label %1215, !llvm.loop !75
...
1237:                                             ; preds = %1234, %1237
  ...
  br i1 %1249, label %1250, label %1237, !llvm.loop !76
...
1275:                                             ; preds = %1268, %1275
  ...
  br i1 %1293, label %1271, label %1275, !llvm.loop !77
...
1294:                                             ; preds = %1273, %1294
  ...
  br i1 %1301, label %1302, label %1294, !llvm.loop !78
...
1314:                                             ; preds = %1307, %1314
  ...
  br i1 %1330, label %1310, label %1314, !llvm.loop !79
...
1331:                                             ; preds = %1312, %1331
  ...
  br i1 %1338, label %1471, label %1331, !llvm.loop !80
...
1339:                                             ; preds = %1167, %1339
  ...
  br i1 %1346, label %1347, label %1339, !llvm.loop !81
...
1355:                                             ; preds = %1353, %1355
  ...
  br i1 %1362, label %1363, label %1355, !llvm.loop !82
...
1370:                                             ; preds = %1367, %1370
  ...
  br i1 %1378, label %1379, label %1370, !llvm.loop !83
...
1386:                                             ; preds = %1383, %1386
  ...
  br i1 %1393, label %1394, label %1386, !llvm.loop !84
...
1412:                                             ; preds = %1405, %1412
  ...
  br i1 %1427, label %1408, label %1412, !llvm.loop !85
...
1428:                                             ; preds = %1410, %1428
  ...
  br i1 %1435, label %1436, label %1428, !llvm.loop !86
...
1449:                                             ; preds = %1442, %1449
  ...
  br i1 %1462, label %1445, label %1449, !llvm.loop !87
...
1463:                                             ; preds = %1447, %1463
  ...
  br i1 %1470, label %1471, label %1463, !llvm.loop !88
...
1479:                                             ; preds = %535, %1471, %1474, %542
  ...
  br i1 %1490, label %1491, label %518, !llvm.loop !89
...
1499:                                             ; preds = %1495, %1491
  ...
  %1515 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1504, i64 0, i32 19
  ...
  store i32 0, i32* %1516, align 4, !tbaa !52
  %1517 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1511, i64 0, i32 12
  store i32 0, i32* %1517, align 4, !tbaa !52
  %1518 = fcmp une double %8, 0.000000e+00
  %1519 = icmp sgt i32 %9, 0
...
1521:                                             ; preds = %1499
  ...
  %1523 = call i32 @hypre_BoomerAMGInterpTruncation(%struct.hypre_ParCSRMatrix_struct* %1504, double %8, i32 %9) #5
  %1524 = load i32*, i32** %1522, align 8, !tbaa !14
  %1525 = getelementptr inbounds i32, i32* %1524, i64 %448
  %1526 = load i32, i32* %1525, align 4, !tbaa !20
  br label %1527

1527:                                             ; preds = %1499, %1521
  %1528 = phi i32 [ %1526, %1521 ], [ %419, %1499 ]
  %1529 = icmp eq i32 %1528, 0
  br i1 %1529, label %1532, label %1530

1530:                                             ; preds = %1527
  %1531 = load i32, i32* %19, align 4, !tbaa !20
  call void @hypre_build_interp_colmap(%struct.hypre_ParCSRMatrix_struct* %1504, i32 %1531, i32* %160, i32* %161) #5
  br label %1532

1532:                                             ; preds = %1530, %1527
  %1533 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %1504) #5
  %1534 = icmp sgt i32 %46, 0
  br i1 %1534, label %1535, label %1546

1535:                                             ; preds = %1532
  %1536 = zext i32 %46 to i64
  br label %1537

1537:                                             ; preds = %1535, %1543
  %1538 = phi i64 [ 0, %1535 ], [ %1544, %1543 ]
  %1539 = getelementptr inbounds i32, i32* %1, i64 %1538
  %1540 = load i32, i32* %1539, align 4, !tbaa !20
  %1541 = icmp slt i32 %1540, -1
  br i1 %1541, label %1542, label %1543

1542:                                             ; preds = %1537
  store i32 -1, i32* %1539, align 4, !tbaa !20
  br label %1543

1543:                                             ; preds = %1537, %1542
  %1544 = add nuw nsw i64 %1538, 1
  %1545 = icmp eq i64 %1544, %1536
  br i1 %1545, label %1546, label %1537, !llvm.loop !90

1546:                                             ; preds = %1543, %1532
  store %struct.hypre_ParCSRMatrix_struct* %1504, %struct.hypre_ParCSRMatrix_struct** %11, align 8, !tbaa !19
  %1547 = bitcast i32* %142 to i8*
  call void @hypre_Free(i8* %1547, i32 0) #5
  %1548 = bitcast i32* %143 to i8*
  call void @hypre_Free(i8* %1548, i32 0) #5
  %1549 = bitcast i32* %141 to i8*
  call void @hypre_Free(i8* %1549, i32 0) #5
  %1550 = bitcast double* %469 to i8*
  call void @hypre_Free(i8* %1550, i32 0) #5
  %1551 = bitcast i32* %467 to i8*
  call void @hypre_Free(i8* %1551, i32 0) #5
  %1552 = bitcast i32* %468 to i8*
  call void @hypre_Free(i8* %1552, i32 0) #5
  %1553 = load i32, i32* %19, align 4, !tbaa !20
  %1554 = icmp eq i32 %1553, 0
  br i1 %1554, label %1559, label %1555

1555:                                             ; preds = %1546
  %1556 = bitcast double* %487 to i8*
  call void @hypre_Free(i8* %1556, i32 0) #5
  %1557 = bitcast i32* %485 to i8*
  call void @hypre_Free(i8* %1557, i32 0) #5
  %1558 = bitcast i32* %486 to i8*
  call void @hypre_Free(i8* %1558, i32 0) #5
  br label %1559

1559:                                             ; preds = %1555, %1546
  %1560 = load i32, i32* %14, align 4, !tbaa !20
  %1561 = icmp sgt i32 %1560, 1
  br i1 %1561, label %1562, label %1579

1562:                                             ; preds = %1559
  %1563 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %20, align 8, !tbaa !19
  %1564 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %1563) #5
  %1565 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %18, align 8, !tbaa !19
  %1566 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %1565) #5
  %1567 = bitcast i32* %161 to i8*
  call void @hypre_Free(i8* %1567, i32 0) #5
  %1568 = bitcast i32* %159 to i8*
  call void @hypre_Free(i8* %1568, i32 0) #5
  %1569 = bitcast i32** %16 to i8**
  %1570 = load i8*, i8** %1569, align 8, !tbaa !19
  call void @hypre_Free(i8* %1570, i32 0) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  %1571 = bitcast i32* %160 to i8*
  call void @hypre_Free(i8* %1571, i32 0) #5
  %1572 = icmp sgt i32 %5, 1
  br i1 %1572, label %1573, label %1576

1573:                                             ; preds = %1562
  %1574 = bitcast i32** %17 to i8**
  %1575 = load i8*, i8** %1574, align 8, !tbaa !19
  call void @hypre_Free(i8* %1575, i32 0) #5
  store i32* null, i32** %17, align 8, !tbaa !19
  br label %1576

1576:                                             ; preds = %1573, %1562
  %1577 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %22, align 8, !tbaa !19
  %1578 = call i32 @hypre_MatvecCommPkgDestroy(%struct._hypre_ParCSRCommPkg* %1577) #5
  br label %1579

1579:                                             ; preds = %1559, %1576, %102
  %1580 = load i32, i32* @hypre__global_error, align 4, !tbaa !20
...
186:                                              ; preds = %180, %171
  ...
  %189 = add nuw nsw i64 %172, 1
  %190 = icmp eq i64 %189, %165
  br i1 %190, label %166, label %171, !llvm.loop !91
...
267:                                              ; preds = %251, %265, %260
  ...
  %271 = sext i32 %270 to i64
  %272 = icmp slt i64 %269, %271
  br i1 %272, label %251, label %273, !llvm.loop !92
...
303:                                              ; preds = %286, %300, %295
  ...
  %307 = sext i32 %306 to i64
  %308 = icmp slt i64 %305, %307
  br i1 %308, label %286, label %309, !llvm.loop !93
...
309:                                              ; preds = %303, %277, %237, %232, %273, %239
  ...
  %314 = sext i32 %313 to i64
  %315 = icmp slt i64 %312, %314
  br i1 %315, label %222, label %316, !llvm.loop !94
...
390:                                              ; preds = %378, %371, %387, %380
  ...
  br i1 %396, label %362, label %397, !llvm.loop !95
...
397:                                              ; preds = %390, %352, %347, %342, %350
  ...
  br i1 %403, label %332, label %404, !llvm.loop !96
...
404:                                              ; preds = %397, %321, %207, %316, %209
  ...
  br i1 %408, label %409, label %191, !llvm.loop !97
...
468:                                              ; preds = %458, %468
  ...
  br i1 %474, label %468, label %461, !llvm.loop !98
...
561:                                              ; preds = %541, %554, %550
  ...
  br i1 %566, label %541, label %567, !llvm.loop !99
...
598:                                              ; preds = %580, %593, %589
  ...
  br i1 %603, label %580, label %604, !llvm.loop !100
...
604:                                              ; preds = %598, %571, %521, %517, %567, %528
  ...
  br i1 %610, label %507, label %611, !llvm.loop !101
...
690:                                              ; preds = %672, %666, %685, %679
  ...
  br i1 %696, label %657, label %697, !llvm.loop !102
...
697:                                              ; preds = %690, %646, %639, %635, %644
  ...
  br i1 %703, label %625, label %704, !llvm.loop !103
...
775:                                              ; preds = %759, %768, %773
  ...
  br i1 %779, label %780, label %759, !llvm.loop !104
...
808:                                              ; preds = %792, %801, %806
  ...
  br i1 %811, label %812, label %792, !llvm.loop !105
...
844:                                              ; preds = %825, %833, %838
  ...
  br i1 %847, label %848, label %825, !llvm.loop !106
...
878:                                              ; preds = %859, %867, %872
  ...
  br i1 %880, label %897, label %859, !llvm.loop !107
...
897:                                              ; preds = %878, %849, %732, %883, %893, %888, %881, %848
  ...
  br i1 %902, label %903, label %722, !llvm.loop !108
...
981:                                              ; preds = %964, %958, %979, %974, %968
  ...
  br i1 %984, label %985, label %950, !llvm.loop !109
...
1025:                                             ; preds = %1015, %1003, %1009
  ...
  br i1 %1027, label %1044, label %996, !llvm.loop !110
...
1044:                                             ; preds = %1025, %990, %930, %1030, %1040, %1035, %1028
  ...
  br i1 %1047, label %1048, label %921, !llvm.loop !111
...
1063:                                             ; preds = %1054, %1063
  ...
  br i1 %1069, label %1057, label %1063, !llvm.loop !112
...
1070:                                             ; preds = %1060, %1070
  ...
  br i1 %1076, label %1077, label %1070, !llvm.loop !113
...
1077:                                             ; preds = %1070, %1057, %494, %1048, %487
  ...
  br i1 %1084, label %1085, label %475, !llvm.loop !114
...
1092:                                             ; preds = %1086, %1085
  ...
  %1108 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1097, i64 0, i32 19
  store i32 0, i32* %1108, align 4, !tbaa !51
  %1109 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1099, i64 0, i32 12
  store i32 0, i32* %1109, align 4, !tbaa !52
  %1110 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1104, i64 0, i32 12
  store i32 0, i32* %1110, align 4, !tbaa !52
  %1111 = fcmp une double %8, 0.000000e+00
  %1112 = icmp sgt i32 %9, 0
  %1113 = select i1 %1111, i1 true, i1 %1112
  br i1 %1113, label %1114, label %1120

1114:                                             ; preds = %1092
  %1115 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %1104, i64 0, i32 0
  %1116 = call i32 @hypre_BoomerAMGInterpTruncation(%struct.hypre_ParCSRMatrix_struct* %1097, double %8, i32 %9) #5
  %1117 = load i32*, i32** %1115, align 8, !tbaa !14
  %1118 = getelementptr inbounds i32, i32* %1117, i64 %444
  %1119 = load i32, i32* %1118, align 4, !tbaa !20
  br label %1120

1120:                                             ; preds = %1092, %1114
  %1121 = phi i32 [ %1119, %1114 ], [ %411, %1092 ]
  %1122 = icmp eq i32 %1121, 0
  br i1 %1122, label %1125, label %1123

1123:                                             ; preds = %1120
  %1124 = load i32, i32* %18, align 4, !tbaa !20
  call void @hypre_build_interp_colmap(%struct.hypre_ParCSRMatrix_struct* %1097, i32 %1124, i32* %160, i32* %161) #5
  br label %1125

1125:                                             ; preds = %1123, %1120
  %1126 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %1097) #5
  %1127 = icmp sgt i32 %45, 0
  br i1 %1127, label %1128, label %1139

1128:                                             ; preds = %1125
  %1129 = zext i32 %45 to i64
  br label %1130

1130:                                             ; preds = %1128, %1136
  %1131 = phi i64 [ 0, %1128 ], [ %1137, %1136 ]
  %1132 = getelementptr inbounds i32, i32* %1, i64 %1131
  %1133 = load i32, i32* %1132, align 4, !tbaa !20
  %1134 = icmp slt i32 %1133, -1
  br i1 %1134, label %1135, label %1136

1135:                                             ; preds = %1130
  store i32 -1, i32* %1132, align 4, !tbaa !20
  br label %1136

1136:                                             ; preds = %1130, %1135
  %1137 = add nuw nsw i64 %1131, 1
  %1138 = icmp eq i64 %1137, %1129
  br i1 %1138, label %1139, label %1130, !llvm.loop !115

1139:                                             ; preds = %1136, %1125
  store %struct.hypre_ParCSRMatrix_struct* %1097, %struct.hypre_ParCSRMatrix_struct** %10, align 8, !tbaa !19
  %1140 = bitcast i32* %141 to i8*
  call void @hypre_Free(i8* %1140, i32 0) #5
  %1141 = bitcast i32* %142 to i8*
  call void @hypre_Free(i8* %1141, i32 0) #5
  %1142 = bitcast i32* %140 to i8*
  call void @hypre_Free(i8* %1142, i32 0) #5
  %1143 = load i32, i32* %13, align 4, !tbaa !20
  %1144 = icmp sgt i32 %1143, 1
  br i1 %1144, label %1145, label %1162

1145:                                             ; preds = %1139
  %1146 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %19, align 8, !tbaa !19
  %1147 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %1146) #5
  %1148 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %17, align 8, !tbaa !19
  %1149 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %1148) #5
  %1150 = bitcast i32* %161 to i8*
  call void @hypre_Free(i8* %1150, i32 0) #5
  %1151 = bitcast i32* %159 to i8*
  call void @hypre_Free(i8* %1151, i32 0) #5
  %1152 = bitcast i32** %15 to i8**
  %1153 = load i8*, i8** %1152, align 8, !tbaa !19
  call void @hypre_Free(i8* %1153, i32 0) #5
  store i32* null, i32** %15, align 8, !tbaa !19
  %1154 = bitcast i32* %160 to i8*
  call void @hypre_Free(i8* %1154, i32 0) #5
  %1155 = icmp sgt i32 %5, 1
  br i1 %1155, label %1156, label %1159

1156:                                             ; preds = %1145
  %1157 = bitcast i32** %16 to i8**
  %1158 = load i8*, i8** %1157, align 8, !tbaa !19
  call void @hypre_Free(i8* %1158, i32 0) #5
  store i32* null, i32** %16, align 8, !tbaa !19
  br label %1159

1159:                                             ; preds = %1156, %1145
  %1160 = load %struct._hypre_ParCSRCommPkg*, %struct._hypre_ParCSRCommPkg** %21, align 8, !tbaa !19
  %1161 = call i32 @hypre_MatvecCommPkgDestroy(%struct._hypre_ParCSRCommPkg* %1160) #5
  br label %1162

1162:                                             ; preds = %1139, %1159, %101
  %1163 = load i32, i32* @hypre__global_error, align 4, !tbaa !20
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %68) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %67) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %66) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %65) #5

...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatMatHost(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1) local_unnamed_addr #0 {
  ...
  %23 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 9
  %24 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %23, align 8, !tbaa !11
  %25 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 12
  %26 = load i32*, i32** %25, align 8, !tbaa !16
  %27 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 5
  %28 = load i32, i32* %27, align 4, !tbaa !17
  %29 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 15
...
61:                                               ; preds = %56
  ...
  %67 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %12, %struct.hypre_CSRMatrix* %22) #3
  %68 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %12, %struct.hypre_CSRMatrix* %24) #3
  ...
  %72 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %14, %struct.hypre_CSRMatrix* %71) #3
...
126:                                              ; preds = %124, %123
  ...
  %132 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAdd(double 1.000000e+00, %struct.hypre_CSRMatrix* %67, double 1.000000e+00, %struct.hypre_CSRMatrix* %70) #3
  %133 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAdd(double 1.000000e+00, %struct.hypre_CSRMatrix* %68, double 1.000000e+00, %struct.hypre_CSRMatrix* %72) #3
...
138:                                              ; preds = %56
  %139 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %12, %struct.hypre_CSRMatrix* %22) #3
...
144:                                              ; preds = %138, %126
  ...
  %155 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %152, i64 0, i32 8
  ...
  %158 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %152, i64 0, i32 9
...
163:                                              ; preds = %144
  ...
  %165 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %152, i64 0, i32 12
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRTMatMatKTHost(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, i32 %2) local_unnamed_addr #0 {
  ...
  %40 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 15
...
64:                                               ; preds = %60
  ...
  %66 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %65, %struct.hypre_CSRMatrix* %20) #3
...
73:                                               ; preds = %64
  %74 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 10
...
77:                                               ; preds = %60
  ...
  %84 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %83, %struct.hypre_CSRMatrix* %20) #3
  %85 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %9, align 8, !tbaa !19
  %86 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %85, %struct.hypre_CSRMatrix* %22) #3
  ...
  %88 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 16
...
93:                                               ; preds = %91, %77
  ...
  %102 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %101, %struct.hypre_CSRMatrix* %20) #3
  %103 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %4, align 8, !tbaa !19
  %104 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %103, %struct.hypre_CSRMatrix* %22) #3
  %105 = icmp eq i32 %2, 0
  %106 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %4, align 8, !tbaa !19
  br i1 %105, label %109, label %107

107:                                              ; preds = %93
  %108 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 10
...
113:                                              ; preds = %111
  %114 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 11
...
194:                                              ; preds = %73, %75, %179
  ...
  %205 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %202, i64 0, i32 8
  ...
  %208 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %202, i64 0, i32 9
  ...
  %212 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %202, i64 0, i32 12
...
define dso_local %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixRAPKTHost(%struct.hypre_ParCSRMatrix_struct* %0, %struct.hypre_ParCSRMatrix_struct* %1, %struct.hypre_ParCSRMatrix_struct* %2, i32 %3) local_unnamed_addr #0 {
  ...
  %24 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 14
  ...
  %31 = load i32, i32* %30, align 4, !tbaa !13
  %32 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 8
  %33 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %32, align 8, !tbaa !10
  %34 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 9
  %35 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %34, align 8, !tbaa !11
  %36 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 12
  %37 = load i32*, i32** %36, align 8, !tbaa !16
  %38 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 5
  %39 = load i32, i32* %38, align 4, !tbaa !17
  %40 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %2, i64 0, i32 15
  %41 = load i32*, i32** %40, align 8, !tbaa !18
  ...
  %54 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 8
  ...
  store %struct.hypre_CSRMatrix* null, %struct.hypre_CSRMatrix** %9, align 8, !tbaa !19
  %57 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 9
  ...
  %65 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 15
...
92:                                               ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0), i32 599, i32 1, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i64 0, i64 0)) #3
  br label %406
...
103:                                              ; preds = %96
  ...
  %108 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %23, %struct.hypre_CSRMatrix* %107) #3
  %109 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %8, align 8, !tbaa !19
  %110 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %23, %struct.hypre_CSRMatrix* %109) #3
...
130:                                              ; preds = %123, %115, %103
  ...
  %134 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %21, %struct.hypre_CSRMatrix* %33) #3
  %135 = icmp ne i32 %47, 0
  br i1 %135, label %136, label %187

136:                                              ; preds = %130
  %137 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %21, %struct.hypre_CSRMatrix* %35) #3
...
189:                                              ; preds = %187
  %190 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAdd(double 1.000000e+00, %struct.hypre_CSRMatrix* %134, double 1.000000e+00, %struct.hypre_CSRMatrix* %132) #3
...
196:                                              ; preds = %193
  %197 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixAdd(double 1.000000e+00, %struct.hypre_CSRMatrix* %188, double 1.000000e+00, %struct.hypre_CSRMatrix* %131) #3
...
205:                                              ; preds = %200, %203, %196
  ...
  %215 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %212, i64 0, i32 8
  ...
  %218 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %212, i64 0, i32 9
  ...
  %222 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %212, i64 0, i32 12
  ...
  %225 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %224, %struct.hypre_CSRMatrix* %194) #3
...
228:                                              ; preds = %205
  ...
  %230 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %229, %struct.hypre_CSRMatrix* %206) #3
  br label %234
...
238:                                              ; preds = %234
  %239 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 10
...
244:                                              ; preds = %242
  ...
  %247 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %246, %struct.hypre_CSRMatrix* %194) #3
  %248 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %14, align 8, !tbaa !19
  %249 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %248, %struct.hypre_CSRMatrix* %206) #3
...
266:                                              ; preds = %262
  %267 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 11
...
364:                                              ; preds = %93
  %365 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %21, %struct.hypre_CSRMatrix* %33) #3
  ...
  %368 = call %struct.hypre_CSRMatrix* @hypre_CSRMatrixMultiplyHost(%struct.hypre_CSRMatrix* %367, %struct.hypre_CSRMatrix* %365) #3
...
375:                                              ; preds = %364
  %376 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 10
...
381:                                              ; preds = %379, %362
  ...
  %388 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %385, i64 0, i32 8
  ...
  %391 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %385, i64 0, i32 9
...
398:                                              ; preds = %381, %395
  ...
  %401 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %385, i64 0, i32 12

...
755:                                              ; preds = %655, %755
  ...
  %783 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %778, i64 0, i32 14
  ...
  %803 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %798, i64 0, i32 14
  ...
  %823 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %818, i64 0, i32 14
  ...
  %843 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %838, i64 0, i32 14
...
871:                                              ; preds = %755, %655
  ...
  %921 = call i8* @hypre_CAlloc(i64 %920, i64 4, i32 0) #6
...
975:                                              ; preds = %926, %871
  ...
  %986 = call i8* @hypre_MAlloc(i64 %985, i32 0) #6
...
1000:                                             ; preds = %975
  ...
  %1002 = call i8* @hypre_CAlloc(i64 %992, i64 4, i32 0) #6
...
1041:                                             ; preds = %1037, %1024
  ...
  %1044 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 0) #6
...
1099:                                             ; preds = %1095, %1041
  ...
  %1102 = call i8* @hypre_MAlloc(i64 %985, i32 0) #6
  ...
  %1107 = call i8* @hypre_MAlloc(i64 %985, i32 0) #6
...
1110:                                             ; preds = %1099
  ...
  %1113 = call i8* @hypre_MAlloc(i64 %985, i32 0) #6
...
1313:                                             ; preds = %1301, %1308
  ...
  call void @hypre_Free(i8* %993, i32 0) #6
  call void @hypre_Free(i8* %1044, i32 0) #6
  br i1 %185, label %1324, label %1326

1324:                                             ; preds = %1313
  %1325 = bitcast i32* %1042 to i8*
  call void @hypre_Free(i8* %1325, i32 0) #6
  br label %1326
...
1326:                                             ; preds = %1324, %1313
  ...
  %1374 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1369, i64 0, i32 14
  ...
  %1385 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1380, i64 0, i32 14
  ...
  %1396 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1391, i64 0, i32 14
  ...
  %1407 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1402, i64 0, i32 14
...
1542:                                             ; preds = %1530, %1525
  ...
  call void @hypre_Free(i8* %1543, i32 0) #6
...
1552:                                             ; preds = %1544, %1542
  ...
  %1598 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1593, i64 0, i32 14
  ...
  %1610 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1605, i64 0, i32 14
  ...
  %1622 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1617, i64 0, i32 14
  ...
  %1634 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1629, i64 0, i32 14
  ...
  %1646 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1641, i64 0, i32 14
  ...
  %1658 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1653, i64 0, i32 14
...
1777:                                             ; preds = %1765, %1760
  ...
  call void @hypre_Free(i8* %1778, i32 0) #6
  store %struct.hypre_MaxwellOffProcRow** null, %struct.hypre_MaxwellOffProcRow*** %23, align 8, !tbaa !26
...
1787:                                             ; preds = %1779, %1777
  ...
  %1813 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1808, i64 0, i32 14
  ...
  %1825 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1820, i64 0, i32 14
  ...
  %1837 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1832, i64 0, i32 14
  ...
  %1849 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1844, i64 0, i32 14
  ...
  %1861 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1856, i64 0, i32 14
  ...
  %1873 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1868, i64 0, i32 14
...
1896:                                             ; preds = %1893
  call void @hypre_Free(i8* %1102, i32 0) #6
  call void @hypre_Free(i8* %1107, i32 0) #6
  br i1 %185, label %1897, label %1899

1897:                                             ; preds = %1896
  %1898 = bitcast %struct.hypre_SStructGrid_struct** %1117 to i8*
  call void @hypre_Free(i8* %1898, i32 0) #6
  br label %1899
...
1899:                                             ; preds = %1897, %1896
  ...
  %1920 = call i8* @hypre_MAlloc(i64 %1334, i32 0) #6
  %1921 = bitcast i8* %1920 to double*
  %1922 = call i8* @hypre_MAlloc(i64 %1334, i32 0) #6
  %1923 = bitcast i8* %1922 to double*
  %1924 = call i8* @hypre_MAlloc(i64 %1334, i32 0) #6
...
1948:                                             ; preds = %1935
  ...
  %1954 = call i8* @hypre_MAlloc(i64 %1953, i32 0) #6
  ...
  %1960 = call i8* @hypre_MAlloc(i64 %1959, i32 0) #6
...
!74 = !{!69, !8, i64 408}
!75 = !{!76, !5, i64 0}
!76 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !5, i64 112, !5, i64 116, !5, i64 120, !5, i64 124, !14, i64 128, !8, i64 136, !8, i64 144, !5, i64 152, !8, i64 160, !5, i64 168, !8, i64 176, !5, i64 184, !8, i64 192, !8, i64 200}
!77 = !{!76, !5, i64 4}
!78 = !{!76, !8, i64 80}
!79 = !{!69, !8, i64 432}
!80 = !{!69, !8, i64 288}

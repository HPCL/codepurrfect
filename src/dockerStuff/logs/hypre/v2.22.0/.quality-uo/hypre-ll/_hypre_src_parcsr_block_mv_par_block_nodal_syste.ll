...
41:                                               ; preds = %38, %4
  ...
  %43 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 0) #4
...
76:                                               ; preds = %69, %52
  ...
  %80 = call i8* @hypre_CAlloc(i64 %77, i64 8, i32 0) #4
...
154:                                              ; preds = %144, %132, %107, %138
  %155 = icmp eq %struct._hypre_ParCSRCommPkg* %42, null
  br i1 %155, label %259, label %156

156:                                              ; preds = %154
  %157 = call i8* @hypre_CAlloc(i64 1, i64 80, i32 0) #4
  %158 = bitcast i8* %157 to %struct._hypre_ParCSRCommPkg*
  %159 = bitcast i8* %157 to i32*
  store i32 %8, i32* %159, align 8, !tbaa !36
  %160 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 1
  %161 = load i32, i32* %160, align 4, !tbaa !38
  %162 = getelementptr inbounds i8, i8* %157, i64 4
  %163 = bitcast i8* %162 to i32*
  store i32 %161, i32* %163, align 4, !tbaa !38
  %164 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 6
  ...
  %168 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 2
  %169 = load i32*, i32** %168, align 8, !tbaa !40
  %170 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 3
  %171 = load i32*, i32** %170, align 8, !tbaa !41
  %172 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 4
...
175:                                              ; preds = %156
  ...
  %177 = call i8* @hypre_CAlloc(i64 %176, i64 4, i32 0) #4
  %178 = bitcast i8* %177 to i32*
  %179 = getelementptr inbounds i32, i32* %171, i64 %176
  %180 = load i32, i32* %179, align 4, !tbaa !20
  %181 = sext i32 %180 to i64
  %182 = call i8* @hypre_CAlloc(i64 %181, i64 4, i32 0) #4
...
184:                                              ; preds = %175, %156
  ...
  %189 = call i8* @hypre_CAlloc(i64 %188, i64 4, i32 0) #4
...
218:                                              ; preds = %211, %204
  ...
  %225 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 7
  %226 = load i32*, i32** %225, align 8, !tbaa !45
  %227 = getelementptr inbounds %struct._hypre_ParCSRCommPkg, %struct._hypre_ParCSRCommPkg* %42, i64 0, i32 8
...
234:                                              ; preds = %218
  ...
  %236 = call i8* @hypre_CAlloc(i64 %235, i64 4, i32 0) #4
...
254:                                              ; preds = %244, %238
  %255 = getelementptr inbounds i8, i8* %157, i64 48
...
259:                                              ; preds = %254, %154
  %260 = phi %struct._hypre_ParCSRCommPkg* [ %158, %254 ], [ null, %154 ]
...
276:                                              ; preds = %269, %259
  ...
  %279 = call i8* @hypre_CAlloc(i64 %62, i64 4, i32 0) #4
...
292:                                              ; preds = %285, %276
  ...
  %294 = call i8* @hypre_CAlloc(i64 %293, i64 4, i32 0) #4
  %295 = bitcast i8* %294 to i32*
  %296 = call i8* @hypre_CAlloc(i64 %293, i64 8, i32 0) #4
...
354:                                              ; preds = %345, %315
  ...
  %356 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %355, i64 0, i32 8
  ...
  %359 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %355, i64 0, i32 9
  ...
  %362 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %82, i64 0, i32 12
  store i32 0, i32* %362, align 4, !tbaa !57
  %363 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %316, i64 0, i32 12
  store i32 0, i32* %363, align 4, !tbaa !57
  %364 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %355, i64 0, i32 12
  %365 = bitcast i32** %364 to i8**
  store i8* %264, i8** %365, align 8, !tbaa !58
  %366 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %355, i64 0, i32 16
  store %struct._hypre_ParCSRCommPkg* %260, %struct._hypre_ParCSRCommPkg** %366, align 8, !tbaa !59
  store %struct.hypre_ParCSRMatrix_struct* %355, %struct.hypre_ParCSRMatrix_struct** %3, align 8, !tbaa !60
...
!27 = !{!28, !8, i64 0}
!28 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !5, i64 24, !5, i64 28, !5, i64 32, !8, i64 40, !8, i64 48, !5, i64 56, !8, i64 64, !8, i64 72, !5, i64 80, !6, i64 84}
!29 = !{!28, !8, i64 8}
!30 = !{!28, !8, i64 64}
!31 = !{!9, !9, i64 0}

...
223:                                              ; preds = %218
  call void @hypre_error_handler(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i64 0, i64 0), i32 322, i32 256, i8* null) #4
  br label %224
...
235:                                              ; preds = %233
  ...
  %241 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %1, i64 0, i32 22
...
275:                                              ; preds = %252, %275
  ...
  %279 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %278, i64 0, i32 21

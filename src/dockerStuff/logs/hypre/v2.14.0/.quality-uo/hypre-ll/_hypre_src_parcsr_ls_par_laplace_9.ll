...
70:                                               ; preds = %35, %8
  ...
  %94 = call i8* @hypre_CAlloc(i64 %93, i64 4, i32 1) #4
  %95 = bitcast i8* %94 to i32*
  %96 = call i8* @hypre_CAlloc(i64 %93, i64 4, i32 1) #4
  ...
  %130 = call i8* @hypre_CAlloc(i64 %129, i64 4, i32 1) #4
...
282:                                              ; preds = %276, %70
  ...
  %287 = call i8* @hypre_CAlloc(i64 %286, i64 4, i32 1) #4
  %288 = bitcast i8* %287 to i32*
  %289 = load i32, i32* %284, align 4, !tbaa !3
  %290 = sext i32 %289 to i64
  %291 = call i8* @hypre_CAlloc(i64 %290, i64 8, i32 1) #4
...
816:                                              ; preds = %812
  ...
  %818 = call i8* @hypre_CAlloc(i64 %817, i64 4, i32 1) #4
...
879:                                              ; preds = %878, %812
  ...
  call void @hypre_Free(i8* %25, i32 1) #4
  %888 = call i8* @hypre_CAlloc(i64 2, i64 4, i32 1) #4

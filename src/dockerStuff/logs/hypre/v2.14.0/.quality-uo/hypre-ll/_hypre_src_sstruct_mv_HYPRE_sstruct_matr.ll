...
define dso_local i32 @HYPRE_SStructMatrixCreate(i32 %0, %struct.hypre_SStructGraph_struct* %1, %struct.hypre_SStructMatrix_struct** nocapture %2) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_MAlloc(i64 120, i32 1) #6
...
168:                                              ; preds = %164, %131
  ...
  %172 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
  ...
  %180 = call i8* @hypre_MAlloc(i64 %179, i32 1) #6
...
53:                                               ; preds = %37, %23
  ...
  call void @hypre_Free(i8* %59, i32 1) #6
...
65:                                               ; preds = %53, %8
  ...
  call void @hypre_Free(i8* %68, i32 1) #6
  %69 = bitcast i32*** %18 to i8*
  call void @hypre_Free(i8* %69, i32 1) #6
  ...
  call void @hypre_Free(i8* %78, i32 1) #6
...
19:                                               ; preds = %17, %123
  ...
  %29 = shl nsw i64 %28, 3
  %30 = call i8* @hypre_MAlloc(i64 %29, i32 1) #6
...
define dso_local i32 @HYPRE_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7) local_unnamed_addr #0 {
  %9 = call i32 @hypre_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7, i32 0) #6
...
define dso_local i32 @HYPRE_SStructMatrixAddToBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7) local_unnamed_addr #0 {
  %9 = call i32 @hypre_SStructMatrixSetBoxValues(%struct.hypre_SStructMatrix_struct* %0, i32 %1, i32* %2, i32* %3, i32 %4, i32 %5, i32* %6, double* %7, i32 1) #6
  %10 = load i32, i32* @hypre__global_error, align 4, !tbaa !30
  ret i32 %10
}
...
125:                                              ; preds = %121, %87
  ...
  %130 = call i8* @hypre_MAlloc(i64 %129, i32 1) #6
  %131 = bitcast i8* %130 to i32**
  %132 = call i8* @hypre_MAlloc(i64 %99, i32 1) #6
...
179:                                              ; preds = %176, %145
  %180 = call i8* @hypre_MAlloc(i64 %99, i32 1) #6
...
225:                                              ; preds = %205, %225
  ...
  call void @hypre_Free(i8* %229, i32 1) #6
...
!84 = !{!85, !8, i64 24}
!85 = !{!"hypre_StructMatrix_struct", !5, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !8, i64 88, !5, i64 96, !5, i64 100, !8, i64 104, !6, i64 112, !5, i64 136, !8, i64 144, !5, i64 152, !8, i64 160}
!86 = !{!85, !5, i64 32}
!87 = !{!85, !8, i64 104}

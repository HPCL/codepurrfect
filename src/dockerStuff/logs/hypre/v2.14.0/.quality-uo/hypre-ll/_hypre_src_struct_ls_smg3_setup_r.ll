...
16:                                               ; preds = %15
  %17 = call i8* @hypre_CAlloc(i64 15, i64 12, i32 1) #6
...
46:                                               ; preds = %15
  %47 = call i8* @hypre_CAlloc(i64 27, i64 12, i32 1) #6
...
73:                                               ; preds = %72
  %74 = call i8* @hypre_CAlloc(i64 8, i64 12, i32 1) #6
...
107:                                              ; preds = %72
  %108 = call i8* @hypre_CAlloc(i64 14, i64 12, i32 1) #6

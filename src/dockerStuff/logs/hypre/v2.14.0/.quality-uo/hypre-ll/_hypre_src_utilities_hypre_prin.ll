...
31:                                               ; preds = %24, %24, %24, %24, %24, %24, %24, %24, %24
  br label %32

32:                                               ; preds = %9, %14, %24, %31, %29, %28
  %33 = phi i8* [ %10, %24 ], [ %10, %31 ], [ %30, %29 ], [ %10, %28 ], [ %10, %14 ], [ %10, %9 ]
  %34 = phi i8* [ %25, %24 ], [ %25, %31 ], [ %25, %29 ], [ %25, %28 ], [ %11, %14 ], [ %11, %9 ]
  %35 = phi i32 [ 1, %24 ], [ 0, %31 ], [ 0, %29 ], [ 0, %28 ], [ 0, %14 ], [ 1, %9 ]
  %36 = load i8, i8* %34, align 1, !tbaa !3
  store i8 %36, i8* %33, align 1, !tbaa !3
...
define dso_local i32 @hypre_printf(i8* nocapture readonly %0, ...) local_unnamed_addr #0 {
  ...
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !9, !noalias !11
  %10 = call i32 @vfprintf(%struct._IO_FILE* %9, i8* %8, %struct.__va_list_tag* nonnull %6) #8
  call void @hypre_Free(i8* %8, i32 1) #8
...
declare dso_local noundef i32 @vfprintf(%struct._IO_FILE* nocapture noundef, i8* nocapture noundef readonly, %struct.__va_list_tag* noundef) local_unnamed_addr #5
...
define dso_local i32 @hypre_sprintf(i8* nocapture %0, i8* nocapture readonly %1, ...) local_unnamed_addr #0 {
  ...
  %8 = call i32 @new_format(i8* %1, i8** nonnull %4)
  %9 = load i8*, i8** %4, align 8, !tbaa !9
  %10 = call i32 @vsprintf(i8* %0, i8* %9, %struct.__va_list_tag* nonnull %7) #8
  call void @hypre_Free(i8* %9, i32 1) #8
  call void @llvm.va_end(i8* %5)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %6) #8
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #8
...
define dso_local i32 @hypre_scanf(i8* nocapture readonly %0, ...) local_unnamed_addr #0 {
  ...
  %7 = call i32 @new_format(i8* %0, i8** nonnull %3)
  %8 = load i8*, i8** %3, align 8, !tbaa !9
  %9 = call i32 @__isoc99_vscanf(i8* %8, %struct.__va_list_tag* nonnull %6) #8
  call void @hypre_Free(i8* %8, i32 1) #8
  call void @llvm.va_end(i8* %4)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #8
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #8
...
define dso_local i32 @hypre_fscanf(%struct._IO_FILE* %0, i8* nocapture readonly %1, ...) local_unnamed_addr #0 {
  ...
  %8 = call i32 @new_format(i8* %1, i8** nonnull %4)
  %9 = load i8*, i8** %4, align 8, !tbaa !9
  %10 = call i32 @__isoc99_vfscanf(%struct._IO_FILE* %0, i8* %9, %struct.__va_list_tag* nonnull %7) #8
  call void @hypre_Free(i8* %9, i32 1) #8
  call void @llvm.va_end(i8* %5)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %6) #8
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #8
...
define dso_local i32 @hypre_sscanf(i8* %0, i8* nocapture readonly %1, ...) local_unnamed_addr #0 {
  ...
  %8 = call i32 @new_format(i8* %1, i8** nonnull %4)
  %9 = load i8*, i8** %4, align 8, !tbaa !9
  %10 = call i32 @__isoc99_vsscanf(i8* %0, i8* %9, %struct.__va_list_tag* nonnull %7) #8
  call void @hypre_Free(i8* %9, i32 1) #8
  call void @llvm.va_end(i8* %5)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %6) #8
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #8
...
declare dso_local i32 @__isoc99_vsscanf(i8*, i8*, %struct.__va_list_tag*) local_unnamed_addr #6
...
!11 = !{!12}
!12 = distinct !{!12, !13, !"vprintf: argument 0"}
!13 = distinct !{!13, !"vprintf"}

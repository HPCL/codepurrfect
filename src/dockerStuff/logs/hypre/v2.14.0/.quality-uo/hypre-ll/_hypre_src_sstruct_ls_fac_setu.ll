...
116:                                              ; preds = %104, %4
  ...
  %120 = call i8* @hypre_CAlloc(i64 %117, i64 4, i32 1) #6
  %121 = bitcast i8* %120 to i32*
  %122 = call i8* @hypre_CAlloc(i64 %117, i64 12, i32 1) #6
...
318:                                              ; preds = %311, %177
  ...
  %321 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
...
425:                                              ; preds = %421, %326
  ...
  %432 = call i8* @hypre_CAlloc(i64 %170, i64 4, i32 1) #6
...
563:                                              ; preds = %519, %502
  ...
  %582 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
...
726:                                              ; preds = %722, %674
  ...
  %730 = call i8* @hypre_MAlloc(i64 %729, i32 1) #6
...
1049:                                             ; preds = %1045, %1002
  ...
  %1053 = call i8* @hypre_MAlloc(i64 %1052, i32 1) #6
...
1323:                                             ; preds = %1320, %1049
  call void @hypre_Free(i8* %1053, i32 1) #6
  br label %1324
...
1327:                                             ; preds = %1324, %563
  ...
  %1331 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
  %1332 = bitcast i8* %1331 to i32**
  %1333 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
  %1334 = bitcast i8* %1333 to i32**
  %1335 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
  %1336 = bitcast i8* %1335 to i32**
  %1337 = call i8* @hypre_CAlloc(i64 %170, i64 4, i32 1) #6
...
1346:                                             ; preds = %1340, %1367
  ...
  %1352 = call i8* @hypre_MAlloc(i64 %1351, i32 1) #6
...
1367:                                             ; preds = %1359, %1346
  ...
  %1371 = call i8* @hypre_MAlloc(i64 %1370, i32 1) #6
  ...
  %1377 = call i8* @hypre_MAlloc(i64 %1376, i32 1) #6
...
1530:                                             ; preds = %1522, %1446
  ...
  call void @hypre_Free(i8* %1451, i32 1) #6
  call void @hypre_Free(i8* %1456, i32 1) #6
  call void @hypre_Free(i8* %1461, i32 1) #6
  %1544 = add nuw nsw i64 %1447, 1
  %1545 = icmp eq i64 %1544, %1445
  br i1 %1545, label %1546, label %1446, !llvm.loop !129

1546:                                             ; preds = %1530, %1440
  call void @hypre_Free(i8* %1331, i32 1) #6
  call void @hypre_Free(i8* %1333, i32 1) #6
  call void @hypre_Free(i8* %1335, i32 1) #6
  call void @hypre_Free(i8* %432, i32 1) #6
  %1547 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
  %1548 = bitcast i8* %1547 to i8**
  %1549 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
  %1550 = bitcast i8* %1549 to i8**
  %1551 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
  %1552 = bitcast i8* %1551 to i8**
  %1553 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
...
1723:                                             ; preds = %1710, %1696
  ...
  %1728 = call i8* @hypre_MAlloc(i64 %1727, i32 1) #6
...
1972:                                             ; preds = %1968, %1723
  call void @hypre_Free(i8* %1728, i32 1) #6
...
1975:                                             ; preds = %1972, %1636
  ...
  %2013 = call i8* @hypre_MAlloc(i64 %171, i32 1) #6
...
!93 = !{!89, !8, i64 0}
!94 = !{!95, !8, i64 40}
!95 = !{!"hypre_StructMatrix_struct", !5, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !8, i64 88, !5, i64 96, !5, i64 100, !8, i64 104, !6, i64 112, !5, i64 136, !8, i64 144, !5, i64 152, !8, i64 160}

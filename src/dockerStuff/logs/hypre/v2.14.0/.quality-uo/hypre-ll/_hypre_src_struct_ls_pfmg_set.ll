...
84:                                               ; preds = %79, %74, %63
  %85 = call i8* @hypre_CAlloc(i64 3, i64 8, i32 1) #8
  %86 = bitcast i8* %85 to double*
  %87 = call i8* @hypre_CAlloc(i64 3, i64 8, i32 1) #8
...
108:                                              ; preds = %93, %95, %84
  ...
  call void @hypre_Free(i8* %87, i32 1) #8
  br label %110
...
110:                                              ; preds = %108, %79
  ...
  %117 = call i8* @hypre_MAlloc(i64 %113, i32 1) #8
  ...
  %120 = call i8* @hypre_MAlloc(i64 %119, i32 1) #8
  %121 = bitcast i8* %120 to i32*
  %122 = call i8* @hypre_MAlloc(i64 %119, i32 1) #8
  %123 = bitcast i8* %122 to i32*
  %124 = call i8* @hypre_CAlloc(i64 %112, i64 8, i32 1) #8
...
404:                                              ; preds = %343, %309
  ...
  %411 = call i8* @hypre_CAlloc(i64 %410, i64 8, i32 1) #8
...
487:                                              ; preds = %429, %404
  ...
  %504 = call i8* @hypre_MAlloc(i64 %314, i32 1) #8
  %505 = bitcast i8* %504 to i8**
  %506 = call i8* @hypre_MAlloc(i64 %314, i32 1) #8
  %507 = bitcast i8* %506 to i8**
  %508 = call i8* @hypre_MAlloc(i64 %314, i32 1) #8
  %509 = bitcast i8* %508 to i8**
  %510 = call i8* @hypre_MAlloc(i64 %314, i32 1) #8
...
654:                                              ; preds = %651, %578
  call void @hypre_Free(i8* %124, i32 1) #8
  %655 = add i64 %153, 1
...
162:                                              ; preds = %148, %214
  ...
  %164 = phi i32 [ %215, %214 ], [ 0, %148 ]
  %165 = phi double [ %171, %214 ], [ %49, %148 ]
...
170:                                              ; preds = %168, %162
  %171 = phi double [ %165, %162 ], [ %181, %168 ]
  %172 = phi i32 [ %163, %162 ], [ %169, %168 ]
  br label %185

173:                                              ; preds = %166, %173
  %174 = phi i64 [ %167, %166 ], [ %182, %173 ]
  %175 = phi i32 [ 0, %166 ], [ %183, %173 ]
  %176 = phi double [ %165, %166 ], [ %181, %173 ]
...
57:                                               ; preds = %34
  ...
  call void @hypre_Memcpy(i8* nonnull %6, i8* %58, i64 8, i32 1, i32 0) #8
  br label %59
...
!14 = !{!8, !4, i64 64}
!15 = !{!16, !10, i64 8}
!16 = !{!"hypre_StructMatrix_struct", !4, i64 0, !10, i64 8, !10, i64 16, !10, i64 24, !4, i64 32, !10, i64 40, !10, i64 48, !10, i64 56, !10, i64 64, !4, i64 72, !4, i64 76, !4, i64 80, !10, i64 88, !4, i64 96, !4, i64 100, !10, i64 104, !5, i64 112, !4, i64 136, !10, i64 144, !4, i64 152, !10, i64 160}
!17 = !{!18, !4, i64 4}

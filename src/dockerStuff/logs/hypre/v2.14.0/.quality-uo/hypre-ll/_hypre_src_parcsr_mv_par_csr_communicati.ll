...
241:                                              ; preds = %221, %166, %111, %56, %196, %141, %86, %31, %4
  %242 = call i8* @hypre_CAlloc(i64 1, i64 40, i32 1) #3
...
36:                                               ; preds = %13, %36
  ...
  br i1 %42, label %36, label %43, !llvm.loop !32
...
68:                                               ; preds = %68, %65
  ...
  %73 = add i64 %69, -1
  br i1 %72, label %68, label %74, !llvm.loop !33
...
77:                                               ; preds = %74, %77
  ...
  br i1 %82, label %83, label %77, !llvm.loop !34
...
92:                                               ; preds = %90, %92
  ...
  br i1 %105, label %92, label %106, !llvm.loop !35
...
108:                                              ; preds = %106, %83
  ...
  br i1 %116, label %54, label %117, !llvm.loop !36
...
130:                                              ; preds = %119, %130
  ...
  br i1 %142, label %130, label %143, !llvm.loop !37
...
172:                                              ; preds = %170, %172
  ...
  br i1 %190, label %191, label %172, !llvm.loop !38
...
230:                                              ; preds = %210
  ...
  br i1 %232, label %210, label %233, !llvm.loop !39
...
233:                                              ; preds = %230, %197, %215
  ...
  br i1 %237, label %197, label %238, !llvm.loop !40
...
241:                                              ; preds = %238
  ...
  %248 = call i8* @hypre_CAlloc(i64 %247, i64 4, i32 1) #3
  %249 = bitcast i8* %248 to i32*
  br label %250

250:                                              ; preds = %241, %238
  %251 = phi i32* [ %244, %241 ], [ null, %238 ]
  %252 = phi i32* [ %249, %241 ], [ null, %238 ]
  %253 = add nsw i32 %239, 1
  %254 = sext i32 %253 to i64
  %255 = call i8* @hypre_CAlloc(i64 %254, i64 4, i32 1) #3
  %256 = bitcast i8* %255 to i32*
  %257 = add nsw i32 %239, %120
  %258 = icmp eq i32 %257, 0
  br i1 %258, label %265, label %259

259:                                              ; preds = %250
  %260 = sext i32 %257 to i64
  %261 = call i8* @hypre_CAlloc(i64 %260, i64 4, i32 1) #3
  %262 = bitcast i8* %261 to i32*
  %263 = call i8* @hypre_CAlloc(i64 %260, i64 20, i32 1) #3
  %264 = bitcast i8* %263 to %struct.MPI_Status*
  br label %265

265:                                              ; preds = %259, %250
  %266 = phi i32* [ %262, %259 ], [ undef, %250 ]
  %267 = phi %struct.MPI_Status* [ %264, %259 ], [ undef, %250 ]
  br i1 %240, label %269, label %268

268:                                              ; preds = %265
  store i32 0, i32* %256, align 4, !tbaa !12
  br label %269

269:                                              ; preds = %268, %265
  %270 = icmp sgt i32 %239, 0
  br i1 %270, label %271, label %273

271:                                              ; preds = %269
  %272 = zext i32 %239 to i64
  br label %277
...
275:                                              ; preds = %273
  %276 = zext i32 %239 to i64
  br label %294

277:                                              ; preds = %271, %277
  %278 = phi i64 [ 0, %271 ], [ %279, %277 ]
  %279 = add nuw nsw i64 %278, 1
  %280 = getelementptr inbounds i32, i32* %29, i64 %279
  %281 = load i32, i32* %280, align 4, !tbaa !12
  %282 = getelementptr inbounds i32, i32* %256, i64 %279
  store i32 %281, i32* %282, align 4, !tbaa !12
  %283 = getelementptr inbounds i32, i32* %25, i64 %278
  %284 = load i32, i32* %283, align 4, !tbaa !12
  %285 = getelementptr inbounds i32, i32* %251, i64 %278
  store i32 %284, i32* %285, align 4, !tbaa !12
  %286 = icmp eq i64 %279, %272
  br i1 %286, label %273, label %277, !llvm.loop !41

287:                                              ; preds = %294
  %288 = and i64 %298, 4294967295
  br label %289

289:                                              ; preds = %287, %273
  %290 = phi i64 [ 0, %273 ], [ %288, %287 ]
  %291 = icmp eq i32 %120, 0
  br i1 %291, label %328, label %292

292:                                              ; preds = %289
  %293 = zext i32 %120 to i64
  br label %310

294:                                              ; preds = %275, %294
  %295 = phi i64 [ 0, %275 ], [ %298, %294 ]
  %296 = getelementptr inbounds i32, i32* %256, i64 %295
  %297 = load i32, i32* %296, align 4, !tbaa !12
  %298 = add nuw nsw i64 %295, 1
  %299 = getelementptr inbounds i32, i32* %256, i64 %298
  %300 = load i32, i32* %299, align 4, !tbaa !12
  %301 = sub nsw i32 %300, %297
  %302 = getelementptr inbounds i32, i32* %251, i64 %295
  %303 = load i32, i32* %302, align 4, !tbaa !12
  %304 = sext i32 %297 to i64
  %305 = getelementptr inbounds i32, i32* %252, i64 %304
  %306 = bitcast i32* %305 to i8*
  %307 = getelementptr inbounds i32, i32* %266, i64 %295
  %308 = call i32 @hypre_MPI_Irecv(i8* %306, i32 %301, i32 1275069445, i32 %303, i32 0, i32 %0, i32* %307) #3
  %309 = icmp eq i64 %298, %276
  br i1 %309, label %287, label %294, !llvm.loop !42

310:                                              ; preds = %292, %310
  %311 = phi i64 [ %290, %292 ], [ %324, %310 ]
  %312 = phi i64 [ 0, %292 ], [ %315, %310 ]
  %313 = getelementptr inbounds i32, i32* %166, i64 %312
  %314 = load i32, i32* %313, align 4, !tbaa !12
  %315 = add nuw nsw i64 %312, 1
  %316 = getelementptr inbounds i32, i32* %166, i64 %315
  %317 = load i32, i32* %316, align 4, !tbaa !12
  %318 = sub nsw i32 %317, %314
  %319 = getelementptr inbounds i32, i32* %162, i64 %312
  %320 = load i32, i32* %319, align 4, !tbaa !12
  %321 = sext i32 %314 to i64
  %322 = getelementptr inbounds i32, i32* %1, i64 %321
  %323 = bitcast i32* %322 to i8*
  %324 = add nuw nsw i64 %311, 1
  %325 = getelementptr inbounds i32, i32* %266, i64 %311
  %326 = call i32 @hypre_MPI_Isend(i8* %323, i32 %318, i32 1275069445, i32 %320, i32 0, i32 %0, i32* %325) #3
  %327 = icmp eq i64 %315, %293
  br i1 %327, label %328, label %310, !llvm.loop !43

328:                                              ; preds = %310, %289
  br i1 %258, label %333, label %329

329:                                              ; preds = %328
  %330 = call i32 @hypre_MPI_Waitall(i32 %257, i32* %266, %struct.MPI_Status* %267) #3
  %331 = bitcast i32* %266 to i8*
  call void @hypre_Free(i8* %331, i32 1) #3
  %332 = bitcast %struct.MPI_Status* %267 to i8*
  call void @hypre_Free(i8* %332, i32 1) #3
  br label %333

333:                                              ; preds = %329, %328
  br i1 %240, label %348, label %334

334:                                              ; preds = %333
  %335 = sext i32 %239 to i64
  %336 = getelementptr inbounds i32, i32* %256, i64 %335
  %337 = load i32, i32* %336, align 4, !tbaa !12
  %338 = icmp sgt i32 %337, 0
  br i1 %338, label %339, label %348

339:                                              ; preds = %334, %339
  %340 = phi i64 [ %344, %339 ], [ 0, %334 ]
  %341 = getelementptr inbounds i32, i32* %252, i64 %340
  %342 = load i32, i32* %341, align 4, !tbaa !12
  %343 = sub nsw i32 %342, %2
  store i32 %343, i32* %341, align 4, !tbaa !12
  %344 = add nuw nsw i64 %340, 1
  %345 = load i32, i32* %336, align 4, !tbaa !12
  %346 = sext i32 %345 to i64
  %347 = icmp slt i64 %344, %346
  br i1 %347, label %339, label %348, !llvm.loop !44

348:                                              ; preds = %339, %334, %333
  ...
  store i32* %162, i32** %7, align 8, !tbaa !45
  %349 = bitcast i32** %8 to i8**
  store i8* %165, i8** %349, align 8, !tbaa !45
  store i32 %239, i32* %9, align 4, !tbaa !12
  store i32* %251, i32** %10, align 8, !tbaa !45
  %350 = bitcast i32** %11 to i8**
  store i8* %255, i8** %350, align 8, !tbaa !45
  store i32* %252, i32** %12, align 8, !tbaa !45
...
define dso_local i32 @hypre_ParCSRCommPkgCreate(i32 %0, i32* %1, i32 %2, i32* nocapture readonly %3, i32 %4, i32 %5, %struct.hypre_ParCSRCommPkg* nocapture %6) local_unnamed_addr #0 {
  ...
  %25 = load i32*, i32** %13, align 8, !tbaa !45
  ...
  %27 = load i32*, i32** %14, align 8, !tbaa !45
  ...
  %31 = load i32*, i32** %9, align 8, !tbaa !45
  ...
  %33 = load i32*, i32** %10, align 8, !tbaa !45
...
define dso_local i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %0) local_unnamed_addr #0 {
  ...
  %9 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %8, align 8, !tbaa !52
  ...
  %15 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %14, align 8, !tbaa !56
...
19:                                               ; preds = %17, %1
  %20 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %14, align 8, !tbaa !56
  ...
  store i8* %21, i8** %24, align 8, !tbaa !57
...
5:                                                ; preds = %1
  ...
  store i32* null, i32** %9, align 8, !tbaa !46
  br label %12
...
define dso_local i32 @hypre_ParCSRFindExtendCommPkg(%struct.hypre_ParCSRMatrix_struct* %0, i32 %1, i32* %2, %struct.hypre_ParCSRCommPkg** nocapture %3) local_unnamed_addr #0 {
  ...
  %12 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %11, align 8, !tbaa !56
...
16:                                               ; preds = %14, %4
  %17 = load %struct.hypre_IJAssumedPart*, %struct.hypre_IJAssumedPart** %11, align 8, !tbaa !56
  ...
  store i8* %18, i8** %20, align 8, !tbaa !45
...
!46 = !{!4, !8, i64 24}
!47 = !{!48, !5, i64 0}
!48 = !{!"hypre_ParCSRMatrix_struct", !5, i64 0, !5, i64 4, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !5, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !5, i64 104, !5, i64 108, !5, i64 112, !5, i64 116, !49, i64 120, !8, i64 128, !8, i64 136, !5, i64 144, !8, i64 152}
!49 = !{!"double", !6, i64 0}
!50 = !{!48, !5, i64 16}
!51 = !{!48, !8, i64 64}
!52 = !{!48, !8, i64 40}
!53 = !{!54, !5, i64 20}
!54 = !{!"", !8, i64 0, !8, i64 8, !5, i64 16, !5, i64 20, !5, i64 24, !5, i64 28, !8, i64 32, !8, i64 40, !5, i64 48}
!55 = !{!48, !5, i64 8}
!56 = !{!48, !8, i64 152}
!57 = !{!48, !8, i64 88}

...
@.str = private unnamed_addr constant [33 x i8] c"Stub for hypre_MultiblockMatrix\0A\00", align 1

; Function Attrs: nounwind uwtable
define dso_local %struct.hypre_MultiblockMatrix* @hypre_MultiblockMatrixCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 24, i32 1) #5
...
8:                                                ; preds = %3, %8
  ...
  call void @hypre_Free(i8* %12, i32 1) #5
...
19:                                               ; preds = %8, %3
  ...
  call void @hypre_Free(i8* %22, i32 1) #5
  ...
  call void @hypre_Free(i8* nonnull %26, i32 1) #5
  br label %27
...
3:                                                ; preds = %1
  ...
  call void @hypre_Free(i8* %6, i32 1) #5
...
5:                                                ; preds = %1
  %6 = sext i32 %3 to i64
  %7 = call i8* @hypre_CAlloc(i64 %6, i64 4, i32 1) #5
  ...
  %12 = call i8* @hypre_CAlloc(i64 %11, i64 8, i32 1) #5
...
; Function Attrs: nounwind uwtable
define dso_local void @hypre_MultiblockMatrixPrint(%struct.hypre_MultiblockMatrix* nocapture readnone %0) local_unnamed_addr #0 {
  %2 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0)) #5
  ret void
}
...
define dso_local i32 @hypre_MultiblockMatrixSetNumSubmatrices(%struct.hypre_MultiblockMatrix* nocapture %0, i32 %1) local_unnamed_addr #3 {
...
define dso_local i32 @hypre_MultiblockMatrixSetSubmatrixType(%struct.hypre_MultiblockMatrix* nocapture readonly %0, i32 %1, i32 %2) local_unnamed_addr #4 {
  %4 = icmp slt i32 %1, 0
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local i32 @hypre_MultiblockMatrixSetSubmatrix(%struct.hypre_MultiblockMatrix* nocapture readonly %0, i32 %1, i8* %2) local_unnamed_addr #4 {
  %4 = icmp slt i32 %1, 0
  br i1 %4, label %14, label %5

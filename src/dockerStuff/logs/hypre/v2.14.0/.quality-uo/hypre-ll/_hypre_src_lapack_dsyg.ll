...
define dso_local i32 @hypre_dsygst(i32* %0, i8* %1, i32* %2, double* %3, i32* %4, double* %5, i32* %6, i32* %7) local_unnamed_addr #0 {
  ...
  %21 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
...
27:                                               ; preds = %25
  %28 = call i64 @hypre_lapack_lsame(i8* %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
  %29 = icmp eq i64 %28, 0
...
46:                                               ; preds = %43
  ...
  %48 = call i32 @hypre_lapack_xerbla(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32* nonnull %9) #3
  br label %475

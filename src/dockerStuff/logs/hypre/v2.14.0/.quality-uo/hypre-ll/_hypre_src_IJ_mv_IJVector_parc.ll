...
86:                                               ; preds = %82
  ...
  call void @hypre_Free(i8* %95, i32 1) #4
...
49:                                               ; preds = %47, %5
  %50 = load i8*, i8** %44, align 8, !tbaa !41
...
63:                                               ; preds = %61, %63
  ...
  br i1 %75, label %76, label %63, !llvm.loop !42

76:                                               ; preds = %63
  %77 = add nsw i32 %2, -1
  call void @hypre_qsort3i(i32* %59, i32* %53, i32* %55, i32 0, i32 %77) #4
  %78 = icmp sgt i32 %2, 1
...
82:                                               ; preds = %79, %82
  ...
  br i1 %93, label %94, label %82, !llvm.loop !43
...
141:                                              ; preds = %110, %129
  ...
  br i1 %144, label %145, label %110, !llvm.loop !44
...
194:                                              ; preds = %188
  ...
  br i1 %198, label %201, label %188, !llvm.loop !49
...
201:                                              ; preds = %199, %194, %174
  ...
  br i1 %210, label %211, label %174, !llvm.loop !50
...
242:                                              ; preds = %233, %237
  ...
  br i1 %245, label %246, label %224, !llvm.loop !51
...
276:                                              ; preds = %274, %276
  ...
  br i1 %285, label %286, label %276, !llvm.loop !53
...
313:                                              ; preds = %304, %290
  ...
  %318 = load double, double* %317, align 8, !tbaa !33
  store double %318, double* %15, align 8, !tbaa !33
  ...
  br i1 %321, label %322, label %290, !llvm.loop !54
...
329:                                              ; preds = %327, %329
  ...
  br i1 %337, label %329, label %339, !llvm.loop !55
...
339:                                              ; preds = %329, %322
  ...
  store i32 0, i32* %340, align 8, !tbaa !56
  ...
  store i8* %346, i8** %349, align 8, !tbaa !60
  ...
  store i32 %350, i32* %351, align 8, !tbaa !61
  ...
  store %struct.hypre_ProcListElements* %19, %struct.hypre_ProcListElements** %359, align 8, !tbaa !48
  ...
  %363 = load i32, i32* %340, align 8, !tbaa !56
  ...
  %369 = load i32, i32* %368, align 8, !tbaa !63
  %370 = add i32 %369, %43
  %371 = icmp sgt i32 %363, 0
  br i1 %371, label %372, label %400

372:                                              ; preds = %339
  %373 = load i8*, i8** %355, align 8, !tbaa !62
  br label %374
...
380:                                              ; preds = %374, %380
  ...
  %386 = sub i32 %385, %370
  %387 = load double, double* %16, align 8, !tbaa !33
  ...
  store double %391, double* %389, align 8, !tbaa !33
  ...
  br i1 %395, label %380, label %396, !llvm.loop !64

396:                                              ; preds = %380, %374
  %397 = phi i8* [ %377, %374 ], [ %393, %380 ]
  %398 = add nuw nsw i32 %375, 1
  %399 = icmp eq i32 %398, %363
  br i1 %399, label %400, label %374, !llvm.loop !65

400:                                              ; preds = %396, %339
  %401 = load i8*, i8** %355, align 8, !tbaa !62
  call void @hypre_Free(i8* %401, i32 1) #4
  store i8* null, i8** %355, align 8, !tbaa !62
  %402 = load i8*, i8** %349, align 8, !tbaa !60
  call void @hypre_Free(i8* %402, i32 1) #4
  store i32* null, i32** %348, align 8, !tbaa !60

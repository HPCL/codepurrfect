...
define dso_local %struct.hypre_LGMRESFunctions* @hypre_LGMRESFunctionsCreate(i8* (i64, i64, i32)* %0, i32 (i8*)* %1, i32 (i8*, i32*, i32*)* %2, i8* (i8*)* %3, i8* (i32, i8*)* %4, i32 (i8*)* %5, i8* (i8*, i8*)* %6, i32 (i8*, double, i8*, i8*, double, i8*)* %7, i32 (i8*)* %8, double (i8*, i8*)* %9, i32 (i8*, i8*)* %10, i32 (i8*)* %11, i32 (double, i8*)* %12, i32 (double, i8*, i8*)* %13, i32 (i8*, i8*, i8*, i8*)* %14, i32 (i8*, i8*, i8*, i8*)* %15) local_unnamed_addr #0 {
  %17 = call i8* %0(i64 1, i64 128, i32 1) #9
...
define dso_local i8* @hypre_LGMRESCreate(%struct.hypre_LGMRESFunctions* %0) local_unnamed_addr #0 {
  ...
  %4 = call i8* %3(i64 1, i64 184, i32 1) #9
...
91:                                               ; preds = %86
  ...
  %95 = call i8* %93(i64 %94, i64 4, i32 1) #9
...
122:                                              ; preds = %117
  ...
  %127 = call i8* %124(i64 %126, i64 8, i32 1) #9
...
108:                                              ; preds = %104, %108
  ...
  %111 = call i8* %110(i64 %92, i64 8, i32 1) #9
...
140:                                              ; preds = %133, %134
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 401, i32 1, i8* null) #9
  br label %834
...
157:                                              ; preds = %150, %151
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 426, i32 1, i8* null) #9
  br label %834
...
805:                                              ; preds = %802, %800
  %806 = icmp sge i32 %786, %17
  %807 = fcmp ogt double %787, %176
  %808 = select i1 %806, i1 %807, i1 false
  br i1 %808, label %809, label %810

809:                                              ; preds = %805
  call void @hypre_error_handler(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.6, i64 0, i64 0), i32 850, i32 256, i8* null) #9
  br label %810

810:                                              ; preds = %809, %805
  %811 = getelementptr inbounds %struct.hypre_LGMRESFunctions, %struct.hypre_LGMRESFunctions* %9, i64 0, i32 1
  %812 = load i32 (i8*)*, i32 (i8*)** %811, align 8, !tbaa !8
  %813 = call i32 %812(i8* %93) #9
  %814 = load i32 (i8*)*, i32 (i8*)** %811, align 8, !tbaa !8
  %815 = call i32 %814(i8* %96) #9
  %816 = load i32 (i8*)*, i32 (i8*)** %811, align 8, !tbaa !8
  %817 = call i32 %816(i8* %88) #9
  %818 = icmp ult i32 %85, 2147483647
  br i1 %818, label %819, label %831

819:                                              ; preds = %810
  %820 = call i32 @llvm.smax.i32(i32 %86, i32 1)
  %821 = zext i32 %820 to i64
  br label %822

822:                                              ; preds = %819, %822
  %823 = phi i64 [ 0, %819 ], [ %829, %822 ]
  %824 = load i32 (i8*)*, i32 (i8*)** %811, align 8, !tbaa !8
  %825 = getelementptr inbounds double*, double** %102, i64 %823
  %826 = bitcast double** %825 to i8**
  %827 = load i8*, i8** %826, align 8, !tbaa !44
  %828 = call i32 %824(i8* %827) #9
  store double* null, double** %825, align 8, !tbaa !44
  %829 = add nuw nsw i64 %823, 1
  %830 = icmp eq i64 %829, %821
  br i1 %830, label %831, label %822, !llvm.loop !79

831:                                              ; preds = %822, %810
  %832 = load i32 (i8*)*, i32 (i8*)** %811, align 8, !tbaa !8
  %833 = call i32 %832(i8* %101) #9
  br label %834

834:                                              ; preds = %831, %246, %157, %140
  %835 = load i32, i32* @hypre__global_error, align 4, !tbaa !53

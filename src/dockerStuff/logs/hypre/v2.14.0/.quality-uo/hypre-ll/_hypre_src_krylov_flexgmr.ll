...
define dso_local %struct.hypre_FlexGMRESFunctions* @hypre_FlexGMRESFunctionsCreate(i8* (i64, i64, i32)* %0, i32 (i8*)* %1, i32 (i8*, i32*, i32*)* %2, i8* (i8*)* %3, i8* (i32, i8*)* %4, i32 (i8*)* %5, i8* (i8*, i8*)* %6, i32 (i8*, double, i8*, i8*, double, i8*)* %7, i32 (i8*)* %8, double (i8*, i8*)* %9, i32 (i8*, i8*)* %10, i32 (i8*)* %11, i32 (double, i8*)* %12, i32 (double, i8*, i8*)* %13, i32 (i8*, i8*, i8*, i8*)* %14, i32 (i8*, i8*, i8*, i8*)* %15) local_unnamed_addr #0 {
  %17 = call i8* %0(i64 1, i64 136, i32 1) #8
...
define dso_local i8* @hypre_FlexGMRESCreate(%struct.hypre_FlexGMRESFunctions* %0) local_unnamed_addr #0 {
  ...
  %4 = call i8* %3(i64 1, i64 160, i32 1) #8
...
93:                                               ; preds = %88
  ...
  %98 = call i8* %95(i64 %97, i64 8, i32 1) #8
...
92:                                               ; preds = %89, %92
  ...
  %95 = call i8* %94(i64 %79, i64 8, i32 1) #8
...
124:                                              ; preds = %117, %118
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.6, i64 0, i64 0), i32 370, i32 1, i8* null) #8
  br label %641
...
141:                                              ; preds = %134, %135
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.6, i64 0, i64 0), i32 395, i32 1, i8* null) #8
  br label %641
...
612:                                              ; preds = %609, %607
  %613 = icmp sge i32 %593, %17
  %614 = fcmp ogt double %594, %160
  %615 = select i1 %613, i1 %614, i1 false
  br i1 %615, label %616, label %617

616:                                              ; preds = %612
  call void @hypre_error_handler(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.6, i64 0, i64 0), i32 693, i32 256, i8* null) #8
  br label %617

617:                                              ; preds = %616, %612
  %618 = getelementptr inbounds %struct.hypre_FlexGMRESFunctions, %struct.hypre_FlexGMRESFunctions* %9, i64 0, i32 1
  %619 = load i32 (i8*)*, i32 (i8*)** %618, align 8, !tbaa !8
  %620 = call i32 %619(i8* %80) #8
  %621 = load i32 (i8*)*, i32 (i8*)** %618, align 8, !tbaa !8
  %622 = call i32 %621(i8* %83) #8
  %623 = load i32 (i8*)*, i32 (i8*)** %618, align 8, !tbaa !8
  %624 = call i32 %623(i8* %76) #8
  %625 = icmp slt i32 %11, 0
...
629:                                              ; preds = %626, %629
  %630 = phi i64 [ 0, %626 ], [ %636, %629 ]
  %631 = load i32 (i8*)*, i32 (i8*)** %618, align 8, !tbaa !8
  %632 = getelementptr inbounds double*, double** %87, i64 %630
  %633 = bitcast double** %632 to i8**
  %634 = load i8*, i8** %633, align 8, !tbaa !43
  %635 = call i32 %631(i8* %634) #8
  store double* null, double** %632, align 8, !tbaa !43
  %636 = add nuw nsw i64 %630, 1
  %637 = icmp eq i64 %636, %628
  br i1 %637, label %638, label %629, !llvm.loop !69

638:                                              ; preds = %629, %617
  %639 = load i32 (i8*)*, i32 (i8*)** %618, align 8, !tbaa !8
  %640 = call i32 %639(i8* %86) #8
  br label %641

641:                                              ; preds = %638, %209, %141, %124
  %642 = load i32, i32* @hypre__global_error, align 4, !tbaa !49

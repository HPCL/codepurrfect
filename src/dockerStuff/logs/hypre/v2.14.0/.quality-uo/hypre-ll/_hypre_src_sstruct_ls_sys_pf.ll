...
define dso_local i8* @hypre_SysPFMGCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 264, i32 1) #4
...
65:                                               ; preds = %50, %29
  ...
  call void @hypre_Free(i8* %73, i32 1) #4
...
145:                                              ; preds = %110, %65
  ...
  call void @hypre_Free(i8* %149, i32 1) #4
  ...
  call void @hypre_Free(i8* %161, i32 1) #4
  ...
  call void @hypre_Free(i8* %165, i32 1) #4
  ...
  call void @hypre_Free(i8* %167, i32 1) #4
  ...
  call void @hypre_Free(i8* %171, i32 1) #4
  ...
  call void @hypre_Free(i8* %175, i32 1) #4
  ...
  call void @hypre_Free(i8* %177, i32 1) #4
  ...
  call void @hypre_Free(i8* %181, i32 1) #4
...
18:                                               ; preds = %16
  call void @hypre_error_handler(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2, i64 0, i64 0), i32 358, i32 12, i8* null) #4
  br label %30

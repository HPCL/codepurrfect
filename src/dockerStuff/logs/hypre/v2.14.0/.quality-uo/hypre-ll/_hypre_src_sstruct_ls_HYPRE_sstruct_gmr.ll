...
define dso_local i32 @HYPRE_SStructGMRESGetResidual(%struct.hypre_SStructSolver_struct* %0, i8** %1) local_unnamed_addr #0 {
  %3 = bitcast %struct.hypre_SStructSolver_struct* %0 to %struct.hypre_Solver_struct*
  %4 = call i32 @HYPRE_GMRESGetResidual(%struct.hypre_Solver_struct* %3, i8** %1) #2
  ret i32 %4
}

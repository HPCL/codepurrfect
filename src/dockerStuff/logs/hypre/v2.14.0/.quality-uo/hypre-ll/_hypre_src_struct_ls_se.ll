...
105:                                              ; preds = %102
  %106 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %1, i64 0, i32 18
...
111:                                              ; preds = %109, %105
  ...
  %123 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %1, i64 0, i32 8
  %124 = load double**, double*** %123, align 8, !tbaa !34
  %125 = load double*, double** %124, align 8, !tbaa !16
  %126 = call i32 @hypre_InitializeCommunication(%struct.hypre_CommPkg_struct* %122, double* %125, double* %125, i32 0, i32 0, %struct.hypre_CommHandle_struct** nonnull %9) #4
  %127 = load %struct.hypre_CommHandle_struct*, %struct.hypre_CommHandle_struct** %9, align 8, !tbaa !16
  %128 = call i32 @hypre_FinalizeCommunication(%struct.hypre_CommHandle_struct* %127) #4
  br label %129

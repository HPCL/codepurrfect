...
define dso_local i32 @HYPRE_FEVectorCreate(i32 %0, %struct.hypre_FEMesh_struct* %1, %struct.hypre_FEVector_struct** nocapture %2) local_unnamed_addr #0 {
  %4 = call i8* @hypre_MAlloc(i64 8, i32 1)
  %5 = getelementptr inbounds i8, i8* %4, i64 8
  %6 = bitcast i8* %5 to %struct.hypre_FEMesh_struct**
...
define dso_local i32 @HYPRE_FEVectorGetRHS(%struct.hypre_FEVector_struct* readonly %0, i8** nocapture %1) local_unnamed_addr #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %8, i8 0, i64 16, i1 false) #11
...
define linkonce_odr dso_local void @_ZN4DataD2Ev(%class.Data* nonnull align 8 dereferenceable(24) %0) unnamed_addr #6 comdat align 2 {
...
define dso_local i32 @HYPRE_FEVectorSetSol(%struct.hypre_FEVector_struct* readonly %0, i8* %1) local_unnamed_addr #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %9, i8 0, i64 16, i1 false) #11
  %10 = icmp eq %struct.hypre_FEVector_struct* %0, null
...
26:                                               ; preds = %25, %22
  %27 = invoke noalias nonnull dereferenceable(11) i8* @_Znam(i64 11) #13
          to label %28 unwind label %44

28:                                               ; preds = %26
  store i8* %27, i8** %8, align 8, !tbaa !17
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(11) %27, i8* noundef nonnull align 1 dereferenceable(11) getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i64 11, i1 false) #11
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN4DataD0Ev(%class.Data* nonnull align 8 dereferenceable(24) %0) unnamed_addr #6 comdat align 2 {
  %2 = getelementptr inbounds %class.Data, %class.Data* %0, i64 0, i32 0
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [4 x i8*] }, { [4 x i8*] }* @_ZTV4Data, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %2, align 8, !tbaa !11
  %3 = getelementptr inbounds %class.Data, %class.Data* %0, i64 0, i32 1
  %4 = load i8*, i8** %3, align 8, !tbaa !17

...
define dso_local i8* @hypre_SMGCreate(i32 %0) local_unnamed_addr #0 {
  %2 = call i8* @hypre_CAlloc(i64 1, i64 240, i32 1) #8
...
177:                                              ; preds = %156, %75
  ...
  call void @hypre_Free(i8* %187, i32 1) #8
  ...
  call void @hypre_Free(i8* %189, i32 1) #8
  ...
  call void @hypre_Free(i8* %199, i32 1) #8
  ...
  call void @hypre_Free(i8* %201, i32 1) #8
  ...
  call void @hypre_Free(i8* %203, i32 1) #8
  ...
  call void @hypre_Free(i8* %205, i32 1) #8

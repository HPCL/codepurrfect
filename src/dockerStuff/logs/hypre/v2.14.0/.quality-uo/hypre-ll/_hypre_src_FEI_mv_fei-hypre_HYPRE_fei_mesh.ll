...
define dso_local i32 @HYPRE_FEMeshCreate(i32 %0, %struct.hypre_FEMesh_struct** nocapture %1) local_unnamed_addr #0 {
  %3 = call i8* @hypre_MAlloc(i64 8, i32 1)
  ...
  %8 = bitcast %struct.hypre_FEMesh_struct** %1 to i8**
  store i8* %3, i8** %8, align 8, !tbaa !10
  ret i32 0
}
...
11:                                               ; preds = %7
  ...
  call void @_ZN13LLNL_FEI_ImplD1Ev(%class.LLNL_FEI_Impl* nonnull align 8 dereferenceable(48) %12) #11
...
21:                                               ; preds = %17
  ...
  call void %26(%class.LinearSystemCore* nonnull align 8 dereferenceable(8) %22) #11
  br label %27
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshSetFEIObject(%struct.hypre_FEMesh_struct* %0, i8* nocapture readnone %1, i8* nocapture readnone %2) local_unnamed_addr #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
7:                                                ; preds = %3
  %8 = call noalias nonnull dereferenceable(48) i8* @_Znwm(i64 48) #13
...
12:                                               ; preds = %7
  %13 = call noalias nonnull dereferenceable(100) i8* @_Znam(i64 100) #13
  %14 = getelementptr inbounds [1 x i8*], [1 x i8*]* %4, i64 0, i64 0
  store i8* %13, i8** %14, align 8, !tbaa !10
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(21) %13, i8* noundef nonnull align 1 dereferenceable(21) getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i64 21, i1 false) #11
...
declare dso_local void @_ZN13LLNL_FEI_ImplC1Ei(%class.LLNL_FEI_Impl* nonnull align 8 dereferenceable(48), i32) unnamed_addr #2
...
declare dso_local i32 @_ZN13LLNL_FEI_Impl10parametersEiPPc(%class.LLNL_FEI_Impl* nonnull align 8 dereferenceable(48), i32, i8**) local_unnamed_addr #2

; Function Attrs: nobuiltin nounwind
declare dso_local void @_ZdaPv(i8*) local_unnamed_addr #5

; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshParameters(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i8** %2) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshInitFields(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32* %2, i32* %3) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshInitElemBlock(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32 %2, i32 %3, i32* %4, i32** %5, i32 %6, i32* %7, i32 %8) local_unnamed_addr #0 {
...
define dso_local i32 @HYPRE_FEMeshInitElem(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32 %2, i32* nocapture readnone %3) local_unnamed_addr #8 {
  %5 = icmp eq %struct.hypre_FEMesh_struct* %0, null
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshInitSharedNodes(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32* %2, i32* %3, i32** %4) local_unnamed_addr #0 {
  %6 = icmp eq %struct.hypre_FEMesh_struct* %0, null
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local i32 @HYPRE_FEMeshInitComplete(%struct.hypre_FEMesh_struct* readonly %0) local_unnamed_addr #8 {
  %2 = icmp eq %struct.hypre_FEMesh_struct* %0, null
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshLoadNodeBCs(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32* %2, i32 %3, double** %4, double** %5, double** %6) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshSumInElem(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32 %2, i32* %3, double** %4, double* %5, i32 %6) local_unnamed_addr #0 {
  %8 = icmp eq %struct.hypre_FEMesh_struct* %0, null
  br i1 %8, label %18, label %9
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshSumInElemMatrix(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32 %2, i32* %3, double** %4, i32 %5) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshSumInElemRHS(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32 %2, i32* %3, double* %4) local_unnamed_addr #0 {
  %6 = icmp eq %struct.hypre_FEMesh_struct* %0, null
  br i1 %6, label %16, label %7
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshLoadComplete(%struct.hypre_FEMesh_struct* readonly %0) local_unnamed_addr #0 {
  %2 = icmp eq %struct.hypre_FEMesh_struct* %0, null
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshSolve(%struct.hypre_FEMesh_struct* readonly %0) local_unnamed_addr #0 {
...
declare dso_local i32 @_ZN13LLNL_FEI_Impl5solveEPi(%class.LLNL_FEI_Impl* nonnull align 8 dereferenceable(48), i32*) local_unnamed_addr #2

; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshGetBlockNodeIDList(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32 %2, i32* %3) local_unnamed_addr #0 {
  %5 = icmp eq %struct.hypre_FEMesh_struct* %0, null
  br i1 %5, label %15, label %6
...
; Function Attrs: mustprogress uwtable
define dso_local i32 @HYPRE_FEMeshGetBlockNodeSolution(%struct.hypre_FEMesh_struct* readonly %0, i32 %1, i32 %2, i32* %3, i32* %4, double* %5) local_unnamed_addr #0 {
  %7 = icmp eq %struct.hypre_FEMesh_struct* %0, null
  br i1 %7, label %17, label %8
...
declare dso_local i32 @_ZN12LLNL_FEI_Fei10initFieldsEiPiS0_(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32*, i32*) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei13initElemBlockEiiiPiPS0_iS0_i(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32, i32, i32*, i32**, i32, i32*, i32) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei15initSharedNodesEiPiS0_PS0_(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32*, i32*, i32**) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei11loadNodeBCsEiPiiPPdS2_S2_(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32*, i32, double**, double**, double**) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei9sumInElemEiiPiPPdS1_i(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32, i32*, double**, double*, i32) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei15sumInElemMatrixEiiPiPPdi(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32, i32*, double**, i32) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei12sumInElemRHSEiiPiPd(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32, i32*, double*) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei12loadCompleteEv(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312)) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei18getBlockNodeIDListEiiPi(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32, i32*) local_unnamed_addr #2

declare dso_local i32 @_ZN12LLNL_FEI_Fei20getBlockNodeSolutionEiiPiS0_Pd(%class.LLNL_FEI_Fei* nonnull align 8 dereferenceable(312), i32, i32, i32*, i32*, double*) local_unnamed_addr #2

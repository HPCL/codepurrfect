...
@.str.6 = private unnamed_addr constant [69 x i8] c" Coarse grid matrix is NULL. Please make sure MGRSetup() is called \0A\00", align 1
@.str.7 = private unnamed_addr constant [85 x i8] c" MGR solution array is NULL. Please make sure MGRSetup() and MGRSolve() are called \0A\00", align 1
@.str.8 = private unnamed_addr constant [80 x i8] c" MGR RHS array is NULL. Please make sure MGRSetup() and MGRSolve() are called \0A\00", align 1
@.str.9 = private unnamed_addr constant [24 x i8] c"MGR Setup parameters: \0A\00", align 1
@.str.10 = private unnamed_addr constant [33 x i8] c"Max number of coarse levels: %d\0A\00", align 1
@.str.11 = private unnamed_addr constant [16 x i8] c"Block size: %d\0A\00", align 1
@.str.12 = private unnamed_addr constant [30 x i8] c"Number of coarse indexes: %d\0A\00", align 1
@.str.13 = private unnamed_addr constant [32 x i8] c"reserved coarse nodes size: %d\0A\00", align 1
@.str.14 = private unnamed_addr constant [27 x i8] c"\0A MGR Solver Parameters: \0A\00", align 1
@.str.15 = private unnamed_addr constant [25 x i8] c"F-relaxation Method: %d\0A\00", align 1
@.str.16 = private unnamed_addr constant [16 x i8] c"Relax type: %d\0A\00", align 1
@.str.17 = private unnamed_addr constant [28 x i8] c"Number of relax sweeps: %d\0A\00", align 1
@.str.18 = private unnamed_addr constant [24 x i8] c"Interpolation type: %d\0A\00", align 1
@.str.19 = private unnamed_addr constant [36 x i8] c"Number of interpolation sweeps: %d\0A\00", align 1
@.str.20 = private unnamed_addr constant [22 x i8] c"Restriction type: %d\0A\00", align 1
@.str.21 = private unnamed_addr constant [34 x i8] c"Number of restriction sweeps: %d\0A\00", align 1
@.str.22 = private unnamed_addr constant [26 x i8] c"Global smoother type: %d\0A\00", align 1
@.str.23 = private unnamed_addr constant [38 x i8] c"Number of global smoother sweeps: %d\0A\00", align 1
@.str.24 = private unnamed_addr constant [30 x i8] c"Max number of iterations: %d\0A\00", align 1
@.str.25 = private unnamed_addr constant [24 x i8] c"Stopping tolerance: %e\0A\00", align 1

; Function Attrs: nounwind uwtable
define dso_local i8* @hypre_MGRCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 400, i32 1) #8
...
20:                                               ; preds = %14
  ...
  call void @hypre_Free(i8* nonnull %21, i32 1) #8
...
37:                                               ; preds = %32
  ...
  call void @hypre_Free(i8* nonnull %38, i32 1) #8
...
110:                                              ; preds = %104
  ...
  call void @hypre_Free(i8* nonnull %111, i32 1) #8
...
117:                                              ; preds = %114, %100
  ...
  call void @hypre_Free(i8* %119, i32 1) #8
...
135:                                              ; preds = %129
  ...
  call void @hypre_Free(i8* nonnull %136, i32 1) #8
...
142:                                              ; preds = %139, %125
  ...
  call void @hypre_Free(i8* %144, i32 1) #8
...
208:                                              ; preds = %206, %201
  ...
  call void @hypre_Free(i8* %212, i32 1) #8
...
233:                                              ; preds = %228
  ...
  call void @hypre_Free(i8* nonnull %234, i32 1) #8
...
240:                                              ; preds = %235
  ...
  call void @hypre_Free(i8* nonnull %241, i32 1) #8
...
245:                                              ; preds = %242
  ...
  call void @hypre_Free(i8* nonnull %246, i32 1) #8
...
252:                                              ; preds = %247
  ...
  call void @hypre_Free(i8* nonnull %253, i32 1) #8
...
259:                                              ; preds = %254
  ...
  call void @hypre_Free(i8* nonnull %260, i32 1) #8
...
266:                                              ; preds = %261
  ...
  call void @hypre_Free(i8* nonnull %267, i32 1) #8
...
273:                                              ; preds = %268
  ...
  call void @hypre_Free(i8* nonnull %274, i32 1) #8
...
298:                                              ; preds = %295, %280
  ...
  call void @hypre_Free(i8* %300, i32 1) #8
...
306:                                              ; preds = %301
  ...
  call void @hypre_Free(i8* nonnull %307, i32 1) #8
...
320:                                              ; preds = %315
  ...
  call void @hypre_Free(i8* nonnull %321, i32 1) #8
...
65:                                               ; preds = %58, %56
  ...
  call void @hypre_Free(i8* %69, i32 1) #8
  ...
  call void @hypre_Free(i8* %73, i32 1) #8
...
97:                                               ; preds = %92
  ...
  call void @hypre_Free(i8* nonnull %98, i32 1) #8
...
104:                                              ; preds = %99
  ...
  call void @hypre_Free(i8* nonnull %105, i32 1) #8
...
define dso_local i8* @hypre_MGRCreateFrelaxVcycleData() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 1520, i32 1) #8
...
21:                                               ; preds = %15
  ...
  call void @hypre_Free(i8* nonnull %22, i32 1) #8
...
42:                                               ; preds = %40, %35
  ...
  %44 = call i8* @hypre_CAlloc(i64 %43, i64 8, i32 1) #8
...
55:                                               ; preds = %49, %55
  ...
  %57 = call i8* @hypre_CAlloc(i64 %46, i64 4, i32 1) #8
...
87:                                               ; preds = %85
  %88 = call i8* @hypre_CAlloc(i64 %43, i64 4, i32 1) #8
...
5:                                                ; preds = %3
  ...
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 461, i32 12, i8* null) #8
  br label %35
...
9:                                                ; preds = %7
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 467, i32 20, i8* null) #8
  br label %35
...
15:                                               ; preds = %10
  ...
  call void @hypre_Free(i8* nonnull %16, i32 1) #8
  store i32* null, i32** %12, align 8, !tbaa !68
  br label %17
...
19:                                               ; preds = %17
  ...
  %21 = call i8* @hypre_CAlloc(i64 %20, i64 4, i32 1) #8
...
24:                                               ; preds = %19, %24
  ...
  %27 = load i32, i32* %26, align 4, !tbaa !70
  %28 = getelementptr inbounds i32, i32* %22, i64 %25
  store i32 %27, i32* %28, align 4, !tbaa !70
  %29 = add nuw nsw i64 %25, 1
  %30 = icmp eq i64 %29, %23
  br i1 %30, label %31, label %24, !llvm.loop !94

31:                                               ; preds = %24, %17
  %32 = phi i32* [ null, %17 ], [ %22, %24 ]
  %33 = getelementptr inbounds i8, i8* %0, i64 352
  %34 = bitcast i8* %33 to i32*
  store i32 %1, i32* %34, align 8, !tbaa !34
  store i32* %32, i32** %12, align 8, !tbaa !68
  br label %35

35:                                               ; preds = %31, %9, %5
  %36 = load i32, i32* @hypre__global_error, align 4, !tbaa !70
  ret i32 %36
}
...
18:                                               ; preds = %15
  ...
  call void @hypre_Free(i8* nonnull %19, i32 1) #8
...
56:                                               ; preds = %53
  ...
  %58 = call i8* @hypre_CAlloc(i64 %57, i64 4, i32 1) #8
...
125:                                              ; preds = %119, %115
  ...
  %127 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #8
  %128 = bitcast i8* %127 to i32*
  %129 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #8
  %130 = bitcast i8* %129 to i32*
  %131 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #8
  %132 = bitcast i8* %131 to i32*
  %133 = sext i32 %33 to i64
  %134 = call i8* @hypre_CAlloc(i64 %133, i64 4, i32 1) #8
...
211:                                              ; preds = %208, %140
  ...
  %216 = call i8* @hypre_CAlloc(i64 %215, i64 4, i32 2) #8
  %217 = bitcast i8* %216 to i32*
  %218 = sext i32 %212 to i64
  %219 = call i8* @hypre_CAlloc(i64 %218, i64 4, i32 2) #8
  %220 = bitcast i8* %219 to i32*
  %221 = call i8* @hypre_CAlloc(i64 %218, i64 8, i32 2) #8
  %222 = bitcast i8* %221 to double*
  %223 = getelementptr inbounds i32, i32* %217, i64 %133
  store i32 %212, i32* %223, align 4, !tbaa !70
  %224 = call i8* @hypre_CAlloc(i64 %215, i64 4, i32 2) #8
  %225 = bitcast i8* %224 to i32*
  %226 = sext i32 %213 to i64
  %227 = call i8* @hypre_CAlloc(i64 %226, i64 4, i32 2) #8
  %228 = bitcast i8* %227 to i32*
  %229 = call i8* @hypre_CAlloc(i64 %226, i64 8, i32 2) #8
...
314:                                              ; preds = %307, %303
  %315 = call i8* @hypre_CAlloc(i64 %133, i64 8, i32 1) #8
...
347:                                              ; preds = %320, %314
  %348 = call i8* @hypre_CAlloc(i64 %133, i64 4, i32 1) #8
  %349 = bitcast i8* %348 to i32*
  br i1 %55, label %353, label %350

350:                                              ; preds = %347
  %351 = call i8* @hypre_CAlloc(i64 %243, i64 4, i32 1) #8
...
484:                                              ; preds = %478, %365
  call void @hypre_Free(i8* %348, i32 1) #8
  %485 = bitcast i32* %354 to i8*
  call void @hypre_Free(i8* %485, i32 1) #8
  call void @hypre_Free(i8* %315, i32 1) #8
...
511:                                              ; preds = %484
  %512 = call i8* @hypre_CAlloc(i64 %243, i64 4, i32 1) #8
...
537:                                              ; preds = %533, %518
  ...
  %540 = call i8* @hypre_CAlloc(i64 %539, i64 4, i32 1) #8
...
573:                                              ; preds = %566, %550
  call void @hypre_Free(i8* %512, i32 1) #8
  br label %574
...
594:                                              ; preds = %591, %589
  ...
  call void @hypre_Free(i8* %76, i32 1) #8
  call void @hypre_Free(i8* %134, i32 1) #8
  call void @hypre_Free(i8* %244, i32 1) #8
  call void @hypre_Free(i8* %127, i32 1) #8
  call void @hypre_Free(i8* %129, i32 1) #8
...
126:                                              ; preds = %120, %116
  ...
  %128 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #8
  %129 = bitcast i8* %128 to i32*
  %130 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #8
  %131 = bitcast i8* %130 to i32*
  %132 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #8
  %133 = bitcast i8* %132 to i32*
  %134 = sext i32 %34 to i64
  %135 = call i8* @hypre_CAlloc(i64 %134, i64 4, i32 1) #8
...
212:                                              ; preds = %209, %141
  ...
  %220 = call i8* @hypre_CAlloc(i64 %219, i64 4, i32 1) #8
  %221 = bitcast i8* %220 to i32*
  %222 = call i8* @hypre_CAlloc(i64 %219, i64 8, i32 1) #8
  %223 = bitcast i8* %222 to double*
  %224 = getelementptr inbounds i32, i32* %218, i64 %134
  store i32 %213, i32* %224, align 4, !tbaa !70
  %225 = call i8* @hypre_CAlloc(i64 %216, i64 4, i32 1) #8
  %226 = bitcast i8* %225 to i32*
  %227 = sext i32 %214 to i64
  %228 = call i8* @hypre_CAlloc(i64 %227, i64 4, i32 1) #8
  %229 = bitcast i8* %228 to i32*
  %230 = call i8* @hypre_CAlloc(i64 %227, i64 8, i32 1) #8
...
315:                                              ; preds = %308, %304
  %316 = call i8* @hypre_CAlloc(i64 %134, i64 8, i32 1) #8
  %317 = bitcast i8* %316 to double*
...
348:                                              ; preds = %321, %315
  %349 = call i8* @hypre_CAlloc(i64 %134, i64 4, i32 1) #8
  %350 = bitcast i8* %349 to i32*
  br i1 %56, label %354, label %351

351:                                              ; preds = %348
  %352 = call i8* @hypre_CAlloc(i64 %244, i64 4, i32 1) #8
...
469:                                              ; preds = %463, %366
  call void @hypre_Free(i8* %349, i32 1) #8
  %470 = bitcast i32* %355 to i8*
  call void @hypre_Free(i8* %470, i32 1) #8
  call void @hypre_Free(i8* %316, i32 1) #8
...
496:                                              ; preds = %469
  %497 = call i8* @hypre_CAlloc(i64 %244, i64 4, i32 1) #8
...
522:                                              ; preds = %518, %503
  ...
  %525 = call i8* @hypre_CAlloc(i64 %524, i64 4, i32 1) #8
...
558:                                              ; preds = %551, %535
  call void @hypre_Free(i8* %497, i32 1) #8
  br label %559
...
579:                                              ; preds = %576, %574
  ...
  call void @hypre_Free(i8* %117, i32 1) #8
  call void @hypre_Free(i8* %77, i32 1) #8
  call void @hypre_Free(i8* %135, i32 1) #8
  call void @hypre_Free(i8* %245, i32 1) #8
  call void @hypre_Free(i8* %128, i32 1) #8
  call void @hypre_Free(i8* %130, i32 1) #8
  call void @hypre_Free(i8* %132, i32 1) #8
...
24:                                               ; preds = %20
  %25 = call i32 @hypre_BoomerAMGBuildInterp(%struct.hypre_ParCSRMatrix_struct* %0, i32* %1, %struct.hypre_ParCSRMatrix_struct* %2, i32* %3, i32 1, i32* null, i32 %6, double %7, i32 %8, i32* %9, %struct.hypre_ParCSRMatrix_struct** nonnull %15) #8
  br label %26
...
124:                                              ; preds = %122, %1
  ...
  store double %258, double* %0, align 8, !tbaa !123
  %259 = fmul double %256, %257
  store double %259, double* %3, align 8, !tbaa !123
  %260 = fmul double %245, %257
  store double %260, double* %5, align 8, !tbaa !123
  %261 = fmul double %234, %257
  store double %261, double* %7, align 8, !tbaa !123
  %262 = fmul double %76, %257
  store double %262, double* %9, align 8, !tbaa !123
  %263 = fmul double %223, %257
  store double %263, double* %11, align 8, !tbaa !123
  %264 = fmul double %212, %257
  store double %264, double* %13, align 8, !tbaa !123
  %265 = fmul double %201, %257
  store double %265, double* %15, align 8, !tbaa !123
  %266 = fmul double %97, %257
  store double %266, double* %17, align 8, !tbaa !123
  %267 = fmul double %190, %257
  store double %267, double* %19, align 8, !tbaa !123
  %268 = fmul double %179, %257
  store double %268, double* %21, align 8, !tbaa !123
  %269 = fmul double %168, %257
  store double %269, double* %23, align 8, !tbaa !123
  %270 = fmul double %112, %257
  store double %270, double* %25, align 8, !tbaa !123
  %271 = fmul double %157, %257
  store double %271, double* %27, align 8, !tbaa !123
  %272 = fmul double %146, %257
  store double %272, double* %29, align 8, !tbaa !123
  %273 = fmul double %135, %257
  store double %273, double* %31, align 8, !tbaa !123
  ret void
}
...
define dso_local i32 @hypre_block_jacobi_scaling(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, %struct.hypre_ParCSRMatrix_struct** nocapture %1, i8* nocapture %2, i32 %3) local_unnamed_addr #0 {
  ...
  %50 = call i8* @hypre_CAlloc(i64 %47, i64 8, i32 1) #8
  ...
  %55 = call i8* @hypre_CAlloc(i64 %54, i64 8, i32 1) #8
...
39:                                               ; preds = %4, %37
  ...
  %41 = call i8* @hypre_CAlloc(i64 %40, i64 8, i32 1) #8
...
define dso_local i32 @hypre_block_jacobi(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, %struct.hypre_ParVector_struct* nocapture readonly %1, %struct.hypre_ParVector_struct* nocapture readonly %2, double %3, i32 %4, i32 %5, double* nocapture readonly %6, %struct.hypre_ParVector_struct* nocapture readonly %7) local_unnamed_addr #0 {
  ...
  %54 = call i8* @hypre_CAlloc(i64 %53, i64 8, i32 1) #8
...
58:                                               ; preds = %8
  ...
  %67 = call i8* @hypre_CAlloc(i64 %66, i64 8, i32 1) #8
  %68 = bitcast i8* %67 to double*
  %69 = sext i32 %34 to i64
  %70 = call i8* @hypre_CAlloc(i64 %69, i64 8, i32 1) #8
...
define dso_local i32 @hypre_blockRelax(%struct.hypre_ParCSRMatrix_struct* nocapture readonly %0, %struct.hypre_ParVector_struct* nocapture readonly %1, %struct.hypre_ParVector_struct* nocapture readonly %2, i32 %3, i32 %4, %struct.hypre_ParVector_struct* nocapture readonly %5, %struct.hypre_ParVector_struct* nocapture readnone %6) local_unnamed_addr #0 {
  ...
  %39 = call i8* @hypre_CAlloc(i64 %38, i64 8, i32 1) #8
...
202:                                              ; preds = %192, %172, %188
  ...
  call void @hypre_Free(i8* %39, i32 1) #8
...
6:                                                ; preds = %4
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 2480, i32 12, i8* null) #8
  br label %16
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 2644, i32 12, i8* null) #8
  br label %9
...
4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 2660, i32 12, i8* null) #8
  br label %9
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_MGRGetCoarseGridMatrix(i8* readonly %0, %struct.hypre_ParCSRMatrix_struct** nocapture readnone %1) local_unnamed_addr #0 {
  %3 = icmp eq i8* %0, null
  br i1 %3, label %4, label %5

4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 2695, i32 12, i8* null) #8
  br label %12
...
10:                                               ; preds = %5
  %11 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([69 x i8], [69 x i8]* @.str.6, i64 0, i64 0)) #8
  br label %12
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_MGRGetCoarseGridSolution(i8* readonly %0, %struct.hypre_ParVector_struct** nocapture readnone %1) local_unnamed_addr #0 {
  %3 = icmp eq i8* %0, null
  br i1 %3, label %4, label %5

4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 2716, i32 12, i8* null) #8
  br label %12
...
10:                                               ; preds = %5
  %11 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([85 x i8], [85 x i8]* @.str.7, i64 0, i64 0)) #8
  br label %12
...
; Function Attrs: nounwind uwtable
define dso_local i32 @hypre_MGRGetCoarseGridRHS(i8* readonly %0, %struct.hypre_ParVector_struct** nocapture readnone %1) local_unnamed_addr #0 {
  %3 = icmp eq i8* %0, null
  br i1 %3, label %4, label %5

4:                                                ; preds = %2
  call void @hypre_error_handler(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i32 2737, i32 12, i8* null) #8
  br label %12
...
10:                                               ; preds = %5
  %11 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.8, i64 0, i64 0)) #8
  br label %12
...
define dso_local i32 @hypre_MGRWriteSolverParams(i8* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.9, i64 0, i64 0)) #8
  %3 = getelementptr inbounds i8, i8* %0, i64 48
  %4 = bitcast i8* %3 to i32*
  %5 = load i32, i32* %4, align 8, !tbaa !11
  %6 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.10, i64 0, i64 0), i32 %5) #8
  %7 = bitcast i8* %0 to i32*
  %8 = load i32, i32* %7, align 8, !tbaa !3
  %9 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.11, i64 0, i64 0), i32 %8) #8
  %10 = getelementptr inbounds i8, i8* %0, i64 4
  %11 = bitcast i8* %10 to i32*
  %12 = load i32, i32* %11, align 4, !tbaa !10
  %13 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.12, i64 0, i64 0), i32 %12) #8
  %14 = getelementptr inbounds i8, i8* %0, i64 352
  %15 = bitcast i8* %14 to i32*
  %16 = load i32, i32* %15, align 8, !tbaa !34
  %17 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.13, i64 0, i64 0), i32 %16) #8
  %18 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.14, i64 0, i64 0)) #8
  %19 = getelementptr inbounds i8, i8* %0, i64 380
  %20 = bitcast i8* %19 to i32*
  %21 = load i32, i32* %20, align 4, !tbaa !201
  %22 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.15, i64 0, i64 0), i32 %21) #8
  %23 = getelementptr inbounds i8, i8* %0, i64 224
  %24 = bitcast i8* %23 to i32*
  %25 = load i32, i32* %24, align 8, !tbaa !25
  %26 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.16, i64 0, i64 0), i32 %25) #8
  %27 = getelementptr inbounds i8, i8* %0, i64 244
  %28 = bitcast i8* %27 to i32*
  %29 = load i32, i32* %28, align 4, !tbaa !29
  %30 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.17, i64 0, i64 0), i32 %29) #8
  %31 = getelementptr inbounds i8, i8* %0, i64 152
  %32 = bitcast i8* %31 to i32*
  %33 = load i32, i32* %32, align 8, !tbaa !27
  %34 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.18, i64 0, i64 0), i32 %33) #8
  %35 = getelementptr inbounds i8, i8* %0, i64 144
  %36 = bitcast i8* %35 to i32*
  %37 = load i32, i32* %36, align 8, !tbaa !13
  %38 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.19, i64 0, i64 0), i32 %37) #8
  %39 = getelementptr inbounds i8, i8* %0, i64 156
  %40 = bitcast i8* %39 to i32*
  %41 = load i32, i32* %40, align 4, !tbaa !28
  %42 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.20, i64 0, i64 0), i32 %41) #8
  %43 = getelementptr inbounds i8, i8* %0, i64 148
  %44 = bitcast i8* %43 to i32*
  %45 = load i32, i32* %44, align 4, !tbaa !14
  %46 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.21, i64 0, i64 0), i32 %45) #8
  %47 = getelementptr inbounds i8, i8* %0, i64 340
  %48 = bitcast i8* %47 to i32*
  %49 = load i32, i32* %48, align 4, !tbaa !37
  %50 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.22, i64 0, i64 0), i32 %49) #8
  %51 = getelementptr inbounds i8, i8* %0, i64 336
  %52 = bitcast i8* %51 to i32*
  %53 = load i32, i32* %52, align 8, !tbaa !36
  %54 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.23, i64 0, i64 0), i32 %53) #8
  %55 = getelementptr inbounds i8, i8* %0, i64 236
  %56 = bitcast i8* %55 to i32*
  %57 = load i32, i32* %56, align 4, !tbaa !23
  %58 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.24, i64 0, i64 0), i32 %57) #8
  %59 = getelementptr inbounds i8, i8* %0, i64 208
  %60 = bitcast i8* %59 to double*
  %61 = load double, double* %60, align 8, !tbaa !24
  %62 = call i32 (i8*, ...) @hypre_printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.25, i64 0, i64 0), double %61) #8

...
define dso_local i32 @hypre_BoomerAMGBuildRestrAIR(%struct.hypre_ParCSRMatrix_struct* %0, i32* nocapture readonly %1, %struct.hypre_ParCSRMatrix_struct* nocapture readonly %2, i32* %3, i32 %4, i32* nocapture readonly %5, i32 %6, double %7, i32 %8, i32* readonly %9, %struct.hypre_ParCSRMatrix_struct** nocapture %10) local_unnamed_addr #0 {
  ...
  %61 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %24, i64 0, i32 2
...
305:                                              ; preds = %281
  ...
  %310 = load i32*, i32** %309, align 8, !tbaa !15
...
313:                                              ; preds = %305, %281
  %314 = phi i32* [ %310, %305 ], [ null, %281 ]
  %315 = phi i32* [ %308, %305 ], [ null, %281 ]
...
383:                                              ; preds = %371, %379
  ...
  br i1 %387, label %371, label %388, !llvm.loop !36
...
418:                                              ; preds = %407, %414
  ...
  br i1 %422, label %400, label %423, !llvm.loop !37
...
508:                                              ; preds = %440, %506
  ...
  br i1 %511, label %512, label %440, !llvm.loop !41
...
539:                                              ; preds = %532
  %540 = getelementptr inbounds i32, i32* %315, i64 %535
  %541 = load i32, i32* %540, align 4, !tbaa !19
  %542 = add nsw i32 %534, 1
  %543 = sext i32 %542 to i64
  %544 = getelementptr inbounds i32, i32* %315, i64 %543
...
549:                                              ; preds = %547, %583
  ...
  %551 = getelementptr inbounds i32, i32* %314, i64 %550
...
565:                                              ; preds = %549
  %566 = call i32 @hypre_BinarySearch(i32* %42, i32 %552, i32 %40) #4
...
576:                                              ; preds = %573, %562
  ...
  %579 = load double, double* %578, align 8, !tbaa !38
  %580 = add nsw i32 %577, %526
  %581 = sext i32 %580 to i64
  %582 = getelementptr inbounds double, double* %337, i64 %581
  store double %579, double* %582, align 8, !tbaa !38
  br label %583
...
583:                                              ; preds = %576, %556, %568, %565
  ...
  br i1 %587, label %549, label %588, !llvm.loop !42
...
590:                                              ; preds = %532, %588
  ...
  br i1 %595, label %524, label %596, !llvm.loop !43
...
613:                                              ; preds = %605
  ...
  %615 = load double, double* %614, align 8, !tbaa !38
  %616 = fneg double %615
  %617 = sext i32 %611 to i64
  %618 = getelementptr inbounds double, double* %340, i64 %617
  store double %616, double* %618, align 8, !tbaa !38
  br label %619

619:                                              ; preds = %605, %613
  %620 = add nsw i64 %606, 1
  %621 = icmp eq i64 %620, %604
  br i1 %621, label %622, label %605, !llvm.loop !44
...
642:                                              ; preds = %634
  ...
  %644 = load double, double* %643, align 8, !tbaa !38
  %645 = fneg double %644
  %646 = sext i32 %640 to i64
  %647 = getelementptr inbounds double, double* %340, i64 %646
  store double %645, double* %647, align 8, !tbaa !38
  br label %648

648:                                              ; preds = %634, %642
  %649 = add nsw i64 %635, 1
  %650 = icmp eq i64 %649, %633
  br i1 %650, label %651, label %634, !llvm.loop !45
...
676:                                              ; preds = %666
  ...
  %682 = load double, double* %681, align 8, !tbaa !38
  %683 = add nsw i32 %668, 1
  %684 = getelementptr inbounds double, double* %295, i64 %677
  store double %682, double* %684, align 8, !tbaa !38
  br label %685
...
685:                                              ; preds = %666, %676
  ...
  br i1 %691, label %666, label %692, !llvm.loop !46
...
692:                                              ; preds = %685, %660
  ...
  store double 1.000000e+00, double* %699, align 8, !tbaa !38
...
729:                                              ; preds = %722
  ...
  store double %735, double* %737, align 8, !tbaa !38
  br label %738
...
738:                                              ; preds = %722, %729
  ...
  br i1 %744, label %713, label %745, !llvm.loop !47
...
763:                                              ; preds = %753, %761
  ...
  br i1 %767, label %753, label %768, !llvm.loop !48
...
795:                                              ; preds = %786, %793
  ...
  br i1 %799, label %779, label %800, !llvm.loop !49
...
800:                                              ; preds = %795, %771, %768, %354
  ...
  br i1 %805, label %350, label %354, !llvm.loop !50
...
817:                                              ; preds = %806, %815
  ...
  br i1 %820, label %821, label %806, !llvm.loop !51

821:                                              ; preds = %817, %350
  %822 = phi i32 [ 0, %350 ], [ %818, %817 ]
  %823 = sext i32 %822 to i64
  %824 = call i8* @hypre_CAlloc(i64 %823, i64 4, i32 1) #4
  %825 = bitcast i8* %824 to i32*
  %826 = icmp sgt i32 %40, 0
...
829:                                              ; preds = %844, %821
  %830 = icmp sgt i32 %284, 0
  br i1 %830, label %831, label %848

831:                                              ; preds = %829
  %832 = zext i32 %284 to i64
  br label %852

833:                                              ; preds = %827, %844
  %834 = phi i64 [ 0, %827 ], [ %846, %844 ]
  %835 = phi i32 [ 0, %827 ], [ %845, %844 ]
  %836 = getelementptr inbounds i32, i32* %328, i64 %834
...
839:                                              ; preds = %833
  ...
  %842 = getelementptr inbounds i32, i32* %825, i64 %841
  %843 = trunc i64 %834 to i32
  store i32 %843, i32* %842, align 4, !tbaa !19
  br label %844

844:                                              ; preds = %833, %839
  %845 = phi i32 [ %840, %839 ], [ %835, %833 ]
  %846 = add nuw nsw i64 %834, 1
  %847 = icmp eq i64 %846, %828
  br i1 %847, label %829, label %833, !llvm.loop !52

848:                                              ; preds = %852, %829
  %849 = icmp sgt i32 %822, 0
  br i1 %849, label %850, label %868

850:                                              ; preds = %848
  %851 = zext i32 %822 to i64
  br label %859

852:                                              ; preds = %831, %852
  %853 = phi i64 [ 0, %831 ], [ %857, %852 ]
  %854 = getelementptr inbounds i32, i32* %300, i64 %853
  %855 = load i32, i32* %854, align 4, !tbaa !19
  %856 = call i32 @hypre_BinarySearch(i32* %825, i32 %855, i32 %822) #4
  store i32 %856, i32* %854, align 4, !tbaa !19
  %857 = add nuw nsw i64 %853, 1
  %858 = icmp eq i64 %857, %832
  br i1 %858, label %848, label %852, !llvm.loop !53

859:                                              ; preds = %850, %859
  %860 = phi i64 [ 0, %850 ], [ %866, %859 ]
  %861 = getelementptr inbounds i32, i32* %825, i64 %860
  %862 = load i32, i32* %861, align 4, !tbaa !19
  %863 = sext i32 %862 to i64
  %864 = getelementptr inbounds i32, i32* %42, i64 %863
  %865 = load i32, i32* %864, align 4, !tbaa !19
  store i32 %865, i32* %861, align 4, !tbaa !19
  %866 = add nuw nsw i64 %860, 1
  %867 = icmp eq i64 %866, %851
  br i1 %867, label %868, label %859, !llvm.loop !54

868:                                              ; preds = %859, %848
  %869 = load i32, i32* %18, align 4, !tbaa !19
  %870 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 1
  %871 = load i32, i32* %870, align 4, !tbaa !55
  %872 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %0, i64 0, i32 12
  %873 = load i32*, i32** %872, align 8, !tbaa !56
  %874 = call %struct.hypre_ParCSRMatrix_struct* @hypre_ParCSRMatrixCreate(i32 %20, i32 %869, i32 %871, i32* %3, i32* %873, i32 %822, i32 %286, i32 %284) #4
  %875 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %874, i64 0, i32 7
  %876 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %875, align 8, !tbaa !11
  %877 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %876, i64 0, i32 6
  %878 = bitcast double** %877 to i8**
  store i8* %294, i8** %878, align 8, !tbaa !12
  %879 = bitcast %struct.hypre_CSRMatrix* %876 to i8**
  store i8* %289, i8** %879, align 8, !tbaa !14
  %880 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %876, i64 0, i32 1
  %881 = bitcast i32** %880 to i8**
  store i8* %292, i8** %881, align 8, !tbaa !15
  %882 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %874, i64 0, i32 8
  %883 = load %struct.hypre_CSRMatrix*, %struct.hypre_CSRMatrix** %882, align 8, !tbaa !16
  %884 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %883, i64 0, i32 6
  %885 = bitcast double** %884 to i8**
  store i8* %301, i8** %885, align 8, !tbaa !12
  %886 = bitcast %struct.hypre_CSRMatrix* %883 to i8**
  store i8* %296, i8** %886, align 8, !tbaa !14
  %887 = getelementptr inbounds %struct.hypre_CSRMatrix, %struct.hypre_CSRMatrix* %883, i64 0, i32 1
  %888 = bitcast i32** %887 to i8**
  store i8* %299, i8** %888, align 8, !tbaa !15
  %889 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %874, i64 0, i32 18
  store i32 0, i32* %889, align 8, !tbaa !57
  %890 = getelementptr inbounds %struct.hypre_ParCSRMatrix_struct, %struct.hypre_ParCSRMatrix_struct* %874, i64 0, i32 11
  %891 = bitcast i32** %890 to i8**
  store i8* %824, i8** %891, align 8, !tbaa !18
  %892 = call i32 @hypre_MatvecCommPkgCreate(%struct.hypre_ParCSRMatrix_struct* %874) #4
  store %struct.hypre_ParCSRMatrix_struct* %874, %struct.hypre_ParCSRMatrix_struct** %10, align 8, !tbaa !58
  ...
  %893 = load i32, i32* %17, align 4, !tbaa !19
  %894 = icmp sgt i32 %893, 1
  br i1 %894, label %895, label %897

895:                                              ; preds = %868
  %896 = call i32 @hypre_CSRMatrixDestroy(%struct.hypre_CSRMatrix* %317) #4
  br label %897

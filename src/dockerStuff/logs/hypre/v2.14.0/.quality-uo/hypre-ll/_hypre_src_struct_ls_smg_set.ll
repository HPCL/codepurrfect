...
define dso_local i32 @hypre_SMGSetup(i8* %0, %struct.hypre_StructMatrix_struct* %1, %struct.hypre_StructVector_struct* %2, %struct.hypre_StructVector_struct* %3) local_unnamed_addr #0 {
  ...
  %69 = call i8* @hypre_MAlloc(i64 %66, i32 1) #4
...
248:                                              ; preds = %183, %161
  ...
  %255 = call i8* @hypre_CAlloc(i64 %254, i64 8, i32 1) #4
...
348:                                              ; preds = %282, %248
  ...
  %367 = call i8* @hypre_MAlloc(i64 %130, i32 1) #4
  %368 = bitcast i8* %367 to i8**
  %369 = call i8* @hypre_MAlloc(i64 %130, i32 1) #4
  %370 = bitcast i8* %369 to i8**
  %371 = call i8* @hypre_MAlloc(i64 %130, i32 1) #4
  %372 = bitcast i8* %371 to i8**
  %373 = call i8* @hypre_MAlloc(i64 %130, i32 1) #4
...
!12 = !{!5, !5, i64 0}
!13 = !{!14, !9, i64 24}
!14 = !{!"hypre_StructMatrix_struct", !5, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !5, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !9, i64 88, !5, i64 96, !5, i64 100, !9, i64 104, !6, i64 112, !5, i64 136, !9, i64 144, !5, i64 152, !9, i64 160}
!15 = !{!16, !5, i64 12}

...
123:                                              ; preds = %116, %4
  ...
  %130 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
...
179:                                              ; preds = %173, %169
  ...
  %182 = call i8* @hypre_CAlloc(i64 1, i64 8, i32 1) #6
...
403:                                              ; preds = %387, %379
  ...
  %408 = call i8* @hypre_CAlloc(i64 %405, i64 4, i32 1) #6
...
613:                                              ; preds = %602, %461
  ...
  %616 = call i8* @hypre_CAlloc(i64 %615, i64 4, i32 1) #6
  %617 = bitcast i8* %616 to i32*
  %618 = call i8* @hypre_CAlloc(i64 %615, i64 4, i32 1) #6
  %619 = bitcast i8* %618 to i32*
  %620 = call i8* @hypre_CAlloc(i64 %615, i64 4, i32 1) #6
  %621 = bitcast i8* %620 to i32*
  %622 = shl nuw nsw i64 %615, 3
  %623 = call i8* @hypre_MAlloc(i64 %622, i32 1) #6
...
653:                                              ; preds = %648, %613
  ...
  call void @hypre_Free(i8* %406, i32 1) #6
  ...
  call void @hypre_Free(i8* %616, i32 1) #6
  call void @hypre_Free(i8* %620, i32 1) #6
  call void @hypre_Free(i8* %623, i32 1) #6
  ...
  %708 = getelementptr inbounds i8, i8* %696, i64 408
  %709 = bitcast i8* %708 to i32*
  %710 = load i32, i32* %709, align 8, !tbaa !68
  %711 = sext i32 %710 to i64
  %712 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %713 = bitcast i8* %712 to %struct.hypre_ParCSRMatrix_struct**
  %714 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %715 = bitcast i8* %714 to %struct.hypre_ParCSRMatrix_struct**
  %716 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %717 = bitcast i8* %716 to %struct.hypre_ParCSRMatrix_struct**
  %718 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %719 = bitcast i8* %718 to %struct.hypre_ParVector_struct**
  %720 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %721 = bitcast i8* %720 to %struct.hypre_ParVector_struct**
  %722 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %723 = bitcast i8* %722 to %struct.hypre_ParVector_struct**
  %724 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %725 = bitcast i8* %724 to %struct.hypre_ParVector_struct**
  %726 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %727 = bitcast i8* %726 to %struct.hypre_ParVector_struct**
  %728 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %729 = bitcast i8* %728 to %struct.hypre_ParVector_struct**
  %730 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %731 = bitcast i8* %730 to i32**
  %732 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %733 = bitcast i8* %732 to double*
  %734 = call i8* @hypre_CAlloc(i64 %711, i64 8, i32 1) #6
  %735 = bitcast i8* %734 to double*
  %736 = getelementptr inbounds i8, i8* %696, i64 336
  %737 = bitcast i8* %736 to %struct.hypre_ParCSRMatrix_struct***
  %738 = getelementptr inbounds i8, i8* %696, i64 360
  %739 = bitcast i8* %738 to %struct.hypre_ParCSRMatrix_struct***
  %740 = getelementptr inbounds i8, i8* %696, i64 368
  %741 = bitcast i8* %740 to %struct.hypre_ParCSRMatrix_struct***
  %742 = getelementptr inbounds i8, i8* %696, i64 344
  %743 = bitcast i8* %742 to %struct.hypre_ParVector_struct***
  %744 = getelementptr inbounds i8, i8* %696, i64 352
  %745 = bitcast i8* %744 to %struct.hypre_ParVector_struct***
  %746 = getelementptr inbounds i8, i8* %696, i64 376
  %747 = bitcast i8* %746 to i32***
  %748 = getelementptr inbounds i8, i8* %696, i64 248
  %749 = bitcast i8* %748 to double**
  %750 = getelementptr inbounds i8, i8* %696, i64 256
...
869:                                              ; preds = %753, %653
  ...
  %919 = call i8* @hypre_CAlloc(i64 %918, i64 4, i32 1) #6
...
973:                                              ; preds = %924, %869
  ...
  %984 = call i8* @hypre_MAlloc(i64 %983, i32 1) #6
  ...
  %991 = call i8* @hypre_CAlloc(i64 %990, i64 4, i32 1) #6
...
998:                                              ; preds = %973
  ...
  %1000 = call i8* @hypre_CAlloc(i64 %990, i64 4, i32 1) #6
...
1039:                                             ; preds = %1035, %1022
  ...
  %1042 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #6
...
1097:                                             ; preds = %1093, %1039
  ...
  %1100 = call i8* @hypre_MAlloc(i64 %983, i32 1) #6
  ...
  %1105 = call i8* @hypre_MAlloc(i64 %983, i32 1) #6
...
1108:                                             ; preds = %1097
  ...
  %1111 = call i8* @hypre_MAlloc(i64 %983, i32 1) #6
...
1540:                                             ; preds = %1528, %1523
  ...
  call void @hypre_Free(i8* %1541, i32 1) #6
...
1775:                                             ; preds = %1763, %1758
  ...
  call void @hypre_Free(i8* %1776, i32 1) #6
  store %struct.hypre_MaxwellOffProcRow** null, %struct.hypre_MaxwellOffProcRow*** %23, align 8, !tbaa !26
...
1894:                                             ; preds = %1891
  call void @hypre_Free(i8* %1100, i32 1) #6
  call void @hypre_Free(i8* %1105, i32 1) #6
  br i1 %185, label %1895, label %1897

1895:                                             ; preds = %1894
  %1896 = bitcast %struct.hypre_SStructGrid_struct** %1115 to i8*
  call void @hypre_Free(i8* %1896, i32 1) #6
  br label %1897
...
1897:                                             ; preds = %1895, %1894
  ...
  %1918 = call i8* @hypre_MAlloc(i64 %1332, i32 1) #6
  %1919 = bitcast i8* %1918 to double*
  %1920 = call i8* @hypre_MAlloc(i64 %1332, i32 1) #6
  %1921 = bitcast i8* %1920 to double*
  %1922 = call i8* @hypre_MAlloc(i64 %1332, i32 1) #6
...
1946:                                             ; preds = %1933
  ...
  %1952 = call i8* @hypre_MAlloc(i64 %1951, i32 1) #6
  ...
  %1958 = call i8* @hypre_MAlloc(i64 %1957, i32 1) #6
...
!68 = !{!69, !5, i64 408}
!69 = !{!"", !5, i64 0, !14, i64 8, !14, i64 16, !14, i64 24, !14, i64 32, !14, i64 40, !14, i64 48, !14, i64 56, !14, i64 64, !14, i64 72, !14, i64 80, !5, i64 88, !5, i64 92, !5, i64 96, !5, i64 100, !5, i64 104, !5, i64 108, !5, i64 112, !5, i64 116, !5, i64 120, !5, i64 124, !5, i64 128, !5, i64 132, !5, i64 136, !5, i64 140, !5, i64 144, !5, i64 148, !5, i64 152, !5, i64 156, !5, i64 160, !5, i64 164, !5, i64 168, !5, i64 172, !5, i64 176, !5, i64 180, !5, i64 184, !8, i64 192, !8, i64 200, !8, i64 208, !5, i64 216, !5, i64 220, !5, i64 224, !5, i64 228, !14, i64 232, !14, i64 240, !8, i64 248, !8, i64 256, !5, i64 264, !14, i64 272, !8, i64 280, !5, i64 288, !5, i64 292, !5, i64 296, !5, i64 300, !5, i64 304, !5, i64 308, !8, i64 312, !8, i64 320, !8, i64 328, !8, i64 336, !8, i64 344, !8, i64 352, !8, i64 360, !8, i64 368, !8, i64 376, !8, i64 384, !8, i64 392, !8, i64 400, !5, i64 408, !8, i64 416, !8, i64 424, !8, i64 432, !8, i64 440, !5, i64 448, !5, i64 452, !5, i64 456, !8, i64 464, !5, i64 472, !5, i64 476, !5, i64 480, !5, i64 484, !14, i64 488, !5, i64 496, !5, i64 500, !5, i64 504, !5, i64 508, !5, i64 512, !5, i64 516, !14, i64 520, !14, i64 528, !14, i64 536, !14, i64 544, !8, i64 552, !8, i64 560, !8, i64 568, !5, i64 576, !5, i64 580, !5, i64 584, !5, i64 588, !14, i64 592, !8, i64 600, !8, i64 608, !5, i64 616, !8, i64 624, !14, i64 632, !8, i64 640, !8, i64 648, !8, i64 656, !8, i64 664, !14, i64 672, !8, i64 680, !8, i64 688, !8, i64 696, !5, i64 704, !5, i64 708, !5, i64 712, !5, i64 716, !5, i64 720, !14, i64 728, !8, i64 736, !5, i64 744, !6, i64 748, !5, i64 1004, !5, i64 1008, !6, i64 1012, !5, i64 1264, !8, i64 1272, !5, i64 1280, !5, i64 1284, !8, i64 1288, !8, i64 1296, !5, i64 1304, !5, i64 1308, !14, i64 1312, !5, i64 1320, !5, i64 1324, !5, i64 1328, !8, i64 1336, !8, i64 1344, !8, i64 1352, !8, i64 1360, !8, i64 1368, !5, i64 1376, !8, i64 1384, !8, i64 1392, !8, i64 1400, !5, i64 1408, !5, i64 1412, !5, i64 1416, !5, i64 1420, !5, i64 1424, !14, i64 1432, !5, i64 1440, !14, i64 1448, !8, i64 1456, !8, i64 1464, !8, i64 1472, !8, i64 1480, !8, i64 1488, !5, i64 1496, !5, i64 1500, !5, i64 1504, !5, i64 1508, !8, i64 1512}
!70 = !{!69, !8, i64 336}
!71 = !{!69, !8, i64 360}
!72 = !{!69, !8, i64 368}
!73 = !{!69, !8, i64 344}

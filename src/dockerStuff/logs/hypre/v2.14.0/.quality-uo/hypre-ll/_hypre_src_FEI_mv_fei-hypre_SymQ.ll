...
define dso_local i8* @hypre_SymQMRCreate() local_unnamed_addr #0 {
  %1 = call i8* @hypre_CAlloc(i64 1, i64 136, i32 1) #10
...
63:                                               ; preds = %61, %56
  %64 = call i32 %9(i8* %12, i8* %1, i8* %2, i8* %3) #10
...
74:                                               ; preds = %69
  ...
  %77 = call i8* @hypre_CAlloc(i64 %76, i64 8, i32 1) #10
...
85:                                               ; preds = %83, %75
  %86 = call i32 %38(i8* %41, i8* %1, i8* %20, i8* %23) #10
...
106:                                              ; preds = %95
  ...
  %126 = call i32 %38(i8* %41, i8* %1, i8* %20, i8* %26) #10
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn writeonly
define dso_local i32 @hypre_SymQMRSetPrecond(i8* nocapture %0, i32 (i8*, i8*, i8*, i8*)* %1, i32 (i8*, i8*, i8*, i8*)* %2, i8* %3) local_unnamed_addr #6 {

...
define dso_local %struct.hypre_CSRBlockMatrix* @hypre_CSRBlockMatrixCreate(i32 %0, i32 %1, i32 %2, i32 %3) local_unnamed_addr #0 {
  %5 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #9
...
17:                                               ; preds = %10, %3
  ...
  call void @hypre_Free(i8* nonnull %18, i32 1) #9
  br label %19
...
22:                                               ; preds = %21, %17
  ...
  %27 = call i8* @hypre_CAlloc(i64 %26, i64 4, i32 1) #9
...
74:                                               ; preds = %70, %22
  ...
  %76 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #9
...
59:                                               ; preds = %56, %23
  ...
  %62 = call i8* @hypre_CAlloc(i64 1, i64 48, i32 1) #9

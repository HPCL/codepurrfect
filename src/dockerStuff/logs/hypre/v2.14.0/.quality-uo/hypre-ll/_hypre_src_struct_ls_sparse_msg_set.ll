...
81:                                               ; preds = %77, %4
  ...
  %105 = call i8* @hypre_MAlloc(i64 %104, i32 1) #6
...
717:                                              ; preds = %712, %584
  ...
  %720 = call i8* @hypre_CAlloc(i64 %719, i64 8, i32 0) #6
...
818:                                              ; preds = %813, %717
  ...
  %829 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
  %830 = bitcast i8* %829 to i8**
  %831 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
  %832 = bitcast i8* %831 to i8**
  %833 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
  %834 = bitcast i8* %833 to i8**
  %835 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
  %836 = bitcast i8* %835 to i8**
  %837 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
  %838 = bitcast i8* %837 to i8**
  %839 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
  %840 = bitcast i8* %839 to i8**
  %841 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
  %842 = bitcast i8* %841 to i8**
  %843 = call i8* @hypre_CAlloc(i64 %97, i64 8, i32 1) #6
...
!13 = !{!4, !8, i64 40}
!14 = !{!15, !9, i64 8}
!15 = !{!"hypre_StructMatrix_struct", !5, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !5, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !9, i64 88, !5, i64 96, !5, i64 100, !9, i64 104, !6, i64 112, !5, i64 136, !9, i64 144, !5, i64 152, !9, i64 160}
!16 = !{!17, !5, i64 4}

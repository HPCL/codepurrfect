...
378:                                              ; preds = %377
  ...
  call void @hypre_Free(i8* %379, i32 1) #4
  br label %380
...
392:                                              ; preds = %391
  ...
  %394 = call i8* @hypre_CAlloc(i64 %393, i64 4, i32 1) #4
...
425:                                              ; preds = %417
  ...
  %427 = call i8* @hypre_CAlloc(i64 %426, i64 4, i32 1) #4
...
429:                                              ; preds = %425, %417
  ...
  %433 = call i8* @hypre_CAlloc(i64 %432, i64 4, i32 1) #4
...
647:                                              ; preds = %646
  ...
  call void @hypre_Free(i8* %648, i32 1) #4
  br label %649
...
650:                                              ; preds = %649
  ...
  call void @hypre_Free(i8* %651, i32 1) #4
  br label %652
...
653:                                              ; preds = %652
  ...
  call void @hypre_Free(i8* %654, i32 1) #4
  br label %655

...
define dso_local i8* @hypre_PointRelaxCreate(i32 %0) local_unnamed_addr #0 {
  ...
  %6 = call i8* @hypre_CAlloc(i64 1, i64 152, i32 1) #8
  ...
  %40 = call i8* @hypre_MAlloc(i64 12, i32 1) #8
...
21:                                               ; preds = %9, %2
  ...
  %40 = shl nsw i64 %39, 2
  %41 = call i8* @hypre_MAlloc(i64 %40, i32 1) #8
  store i8* %41, i8** %25, align 8, !tbaa !20
  %42 = call i8* @hypre_MAlloc(i64 %40, i32 1) #8
...
define dso_local i32 @hypre_PointRelaxSetPointset(i8* nocapture readonly %0, i32 %1, i32 %2, i32* %3, [3 x i32]* %4) local_unnamed_addr #0 {
  ...
  call void @hypre_Free(i8* %12, i32 1) #8
...
10:                                               ; preds = %3, %10
  ...
  call void @hypre_Free(i8* %15, i32 1) #8
...
41:                                               ; preds = %31, %28, %22
  ...
  call void @hypre_Free(i8* %45, i32 1) #8
  ...
  call void @hypre_Free(i8* %49, i32 1) #8
  ...
  call void @hypre_Free(i8* %53, i32 1) #8
  ...
  call void @hypre_Free(i8* %75, i32 1) #8
...
190:                                              ; preds = %172, %155
  ...
  %192 = getelementptr inbounds %struct.hypre_StructMatrix_struct, %struct.hypre_StructMatrix_struct* %1, i64 0, i32 17
...
!33 = !{!4, !9, i64 112}
!34 = !{!35, !9, i64 8}
!35 = !{!"hypre_StructMatrix_struct", !5, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !5, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !9, i64 88, !5, i64 96, !5, i64 100, !9, i64 104, !6, i64 112, !5, i64 136, !9, i64 144, !5, i64 152, !9, i64 160}
!36 = !{!37, !5, i64 4}

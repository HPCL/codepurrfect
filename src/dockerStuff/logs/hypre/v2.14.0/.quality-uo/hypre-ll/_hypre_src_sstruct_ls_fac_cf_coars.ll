...
define dso_local i32 @hypre_AMR_CFCoarsen(%struct.hypre_SStructMatrix_struct* nocapture readonly %0, %struct.hypre_SStructMatrix_struct* nocapture readonly %1, i32* %2, i32 %3) local_unnamed_addr #0 {
  ...
  %42 = getelementptr inbounds %struct.hypre_SStructMatrix_struct, %struct.hypre_SStructMatrix_struct* %0, i64 0, i32 17
...
99:                                               ; preds = %93, %89
  ...
  %109 = call i8* @hypre_MAlloc(i64 %108, i32 1) #6
...
200:                                              ; preds = %127, %290
  ...
  %226 = call i8* @hypre_MAlloc(i64 %225, i32 1) #6
...
317:                                              ; preds = %298
  ...
  %322 = call i8* @hypre_MAlloc(i64 %321, i32 1) #6
  %323 = bitcast i8* %322 to i32*
  %324 = call i8* @hypre_MAlloc(i64 108, i32 1) #6
...
365:                                              ; preds = %341, %327
  ...
  %373 = call i8* @hypre_MAlloc(i64 %372, i32 1) #6
...
578:                                              ; preds = %570
  ...
  %582 = call i8* @hypre_CAlloc(i64 %581, i64 4, i32 1) #6
...
609:                                              ; preds = %605, %578
  ...
  %613 = call i8* @hypre_MAlloc(i64 %612, i32 1) #6
  %614 = bitcast i8* %613 to i32*
  %615 = call i8* @hypre_MAlloc(i64 %612, i32 1) #6
  %616 = bitcast i8* %615 to i32*
  %617 = call i8* @hypre_MAlloc(i64 %612, i32 1) #6
  %618 = bitcast i8* %617 to i32*
  %619 = call i8* @hypre_MAlloc(i64 %612, i32 1) #6
  %620 = bitcast i8* %619 to i32*
  %621 = call i8* @hypre_CAlloc(i64 %611, i64 8, i32 1) #6
...
672:                                              ; preds = %669, %609
  call void @hypre_Free(i8* %582, i32 1) #6
...
687:                                              ; preds = %679, %672
  ...
  call void @hypre_Free(i8* %617, i32 1) #6
...
713:                                              ; preds = %710, %687
  ...
  call void @hypre_Free(i8* %619, i32 1) #6
...
782:                                              ; preds = %776, %365
  ...
  call void @hypre_Free(i8* %373, i32 1) #6
  call void @hypre_Free(i8* %322, i32 1) #6
  call void @hypre_Free(i8* %324, i32 1) #6
  br label %784
...
814:                                              ; preds = %804, %788
  ...
  call void @hypre_Free(i8* %817, i32 1) #6
...
820:                                              ; preds = %814, %293
  call void @hypre_Free(i8* %109, i32 1) #6
...
!49 = !{!27, !8, i64 48}
!50 = !{!51, !8, i64 40}
!51 = !{!"hypre_StructMatrix_struct", !5, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !5, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !8, i64 88, !5, i64 96, !5, i64 100, !8, i64 104, !6, i64 112, !5, i64 136, !8, i64 144, !5, i64 152, !8, i64 160}
!52 = !{!40, !5, i64 8}

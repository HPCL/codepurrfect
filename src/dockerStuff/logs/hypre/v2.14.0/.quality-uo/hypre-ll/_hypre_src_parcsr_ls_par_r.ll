...
215:                                              ; preds = %210
  ...
  %221 = call i8* @hypre_CAlloc(i64 %220, i64 8, i32 1) #4
...
355:                                              ; preds = %352
  ...
  %357 = call i8* @hypre_CAlloc(i64 %356, i64 4, i32 1) #4
...
375:                                              ; preds = %371
  ...
  call void @hypre_Free(i8* %376, i32 1) #4
  br label %377
...
390:                                              ; preds = %389
  ...
  %392 = call i8* @hypre_CAlloc(i64 %391, i64 4, i32 1) #4
...
415:                                              ; preds = %406, %411, %390, %389
  ...
  %417 = call i8* @hypre_CAlloc(i64 1, i64 8, i32 1) #4
  %418 = bitcast i8* %417 to i32**
  %419 = call i8* @hypre_CAlloc(i64 1, i64 8, i32 1) #4
  %420 = bitcast i8* %419 to i32**
  br i1 %107, label %1067, label %421

421:                                              ; preds = %415
  %422 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #4
...
438:                                              ; preds = %421, %432
  ...
  %440 = call i8* @hypre_CAlloc(i64 %426, i64 4, i32 1) #4
...
650:                                              ; preds = %459, %456
  ...
  %654 = call i8* @hypre_CAlloc(i64 %653, i64 4, i32 1) #4
  %655 = bitcast i8* %654 to i32*
  %656 = sext i32 %651 to i64
  %657 = call i8* @hypre_CAlloc(i64 %656, i64 8, i32 1) #4
  %658 = bitcast i8* %657 to double*
  %659 = call i8* @hypre_CAlloc(i64 %656, i64 4, i32 1) #4
...
1093:                                             ; preds = %1091, %1085
  ...
  %1097 = call i8* @hypre_MAlloc(i64 %1096, i32 2) #4
  %1098 = bitcast i8* %1097 to i32*
  %1099 = call i8* @hypre_MAlloc(i64 %1096, i32 2) #4
...
1103:                                             ; preds = %1093
  ...
  %1106 = call i8* @hypre_CAlloc(i64 %1105, i64 4, i32 1) #4
...
1172:                                             ; preds = %1169
  ...
  %1174 = call i8* @hypre_CAlloc(i64 %1173, i64 4, i32 1) #4
...
1188:                                             ; preds = %1181, %1176
  call void @hypre_Free(i8* %1106, i32 1) #4
  br label %1189
...
1192:                                             ; preds = %1189
  ...
  %1195 = call i8* @hypre_MAlloc(i64 %1194, i32 1) #4
...
1220:                                             ; preds = %1218
  ...
  %1223 = call i8* @hypre_MAlloc(i64 %1222, i32 1) #4
...
1267:                                             ; preds = %1263, %1246
  %1268 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #4
  %1269 = bitcast i8* %1268 to i32*
  %1270 = call i8* @hypre_CAlloc(i64 1, i64 4, i32 1) #4
  ...
  %1277 = call i8* @hypre_CAlloc(i64 %1276, i64 4, i32 1) #4
...
1590:                                             ; preds = %1582
  ...
  %1592 = call i8* @hypre_CAlloc(i64 %1591, i64 8, i32 2) #4
  %1593 = bitcast i8* %1592 to double*
  %1594 = call i8* @hypre_CAlloc(i64 %1591, i64 4, i32 2) #4
...
1600:                                             ; preds = %1596
  ...
  %1602 = call i8* @hypre_CAlloc(i64 %1601, i64 8, i32 2) #4
  %1603 = bitcast i8* %1602 to double*
  %1604 = call i8* @hypre_CAlloc(i64 %1601, i64 4, i32 2) #4
...
1611:                                             ; preds = %1606
  ...
  call void @hypre_Free(i8* %1612, i32 1) #4
  br label %1613
...
1613:                                             ; preds = %1611, %1606
  ...
  %1618 = call i8* @hypre_MAlloc(i64 %1617, i32 1) #4
  %1619 = bitcast i8* %1618 to double*
  %1620 = shl nsw i64 %1616, 2
  %1621 = call i8* @hypre_MAlloc(i64 %1620, i32 1) #4
...
1624:                                             ; preds = %1613
  ...
  %1627 = call i8* @hypre_MAlloc(i64 %1626, i32 1) #4
  %1628 = bitcast i8* %1627 to double*
  %1629 = shl nsw i64 %1625, 2
  %1630 = call i8* @hypre_MAlloc(i64 %1629, i32 1) #4
...
2087:                                             ; preds = %1663, %1659
  ...
  call void @hypre_Free(i8* %2088, i32 1) #4
  store i32* null, i32** %418, align 8, !tbaa !40
  %2089 = load i8*, i8** %1279, align 8, !tbaa !40
  call void @hypre_Free(i8* %2089, i32 1) #4
  store i32* null, i32** %420, align 8, !tbaa !40
  %2090 = sext i32 %1614 to i64
  %2091 = call i8* @hypre_CAlloc(i64 %2090, i64 4, i32 1) #4
...
2119:                                             ; preds = %2116
  ...
  %2121 = call i8* @hypre_CAlloc(i64 %2120, i64 4, i32 1) #4
...
2206:                                             ; preds = %2205
  ...
  call void @hypre_Free(i8* %2207, i32 1) #4
  %2208 = bitcast i32* %1247 to i8*
  call void @hypre_Free(i8* %2208, i32 1) #4
  br label %2209
...
2212:                                             ; preds = %2209
  ...
  call void @hypre_Free(i8* %2213, i32 1) #4
...
2221:                                             ; preds = %2218, %2215
  call void @hypre_Free(i8* %1618, i32 1) #4
  call void @hypre_Free(i8* %1621, i32 1) #4
  br i1 %1623, label %2223, label %2222

2222:                                             ; preds = %2221
  call void @hypre_Free(i8* %1636, i32 1) #4
  call void @hypre_Free(i8* %1635, i32 1) #4
  br label %2223
